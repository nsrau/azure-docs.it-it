...
-   Vantaggi in termini di costo: consente di pagare solo per il servizio utilizzato. Può rivelarsi una soluzione economica per il backup e l'archiviazione fuori sede. Per ulteriori informazioni, vedere il [Calcolatore dei costi di Azure][] e l'articolo [Panoramica dei prezzi di Azure][].

Per ulteriori informazioni, vedere [Backup e ripristino di SQL Server con il servizio di archiviazione BLOB di Azure][].
...
Per una procedura dettagliata completa sulla creazione di un account di archiviazione e sull'esecuzione di una semplice attività di ripristino, vedere [Introduzione al servizio di archiviazione di Azure per il backup e ripristino di SQL Server][]
...
-   Account di archiviazione: l'account di archiviazione è il punto di partenza per tutti i servizi di archiviazione. Per accedere a un servizio di archiviazione BLOB di Azure, è innanzitutto necessario creare un account di archiviazione di Azure. Il nome dell'account di archiviazione e le proprietà della relativa chiave di accesso sono elementi necessari per l'autenticazione con il servizio di archiviazione BLOB di Azure e con i relativi componenti.
    Per altre informazioni sul servizio di archiviazione BLOB di Azure, vedere [Come usare il servizio di archiviazione BLOB di Azure][].
...
[Introduzione al backup e ripristino di SQL Server nel servizio di archiviazione BLOB di Azure][]

**Procedure consigliate e risoluzione dei problemi:**

[Procedure consigliate relative al backup e al ripristino (servizio di archiviazione BLOB di Azure)][]

  [Calcolatore dei costi di Azure]: http://go.microsoft.com/fwlink/?LinkId=277060 "Calcolatore dei costi"
  [Panoramica dei prezzi di Azure]: http://go.microsoft.com/fwlink/?LinkId=277059 "Panoramica dei prezzi di Azure"
  ...
  [Come usare il servizio di archiviazione BLOB di Azure]: http://www.windowsazure.com/en-us/develop/net/how-to-guides/blob-storage/
  [Informazioni sui Blob in blocchi e sui Blob di pagine]: http://msdn.microsoft.com/en-us/library/windowsazure/ee691964.aspx
  [Chiavi di accesso dell'account di archiviazione]: http://msdn.microsoft.com/en-us/library/windowsazure/hh531566.aspx
