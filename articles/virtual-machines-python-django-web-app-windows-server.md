<properties pageTitle="App Web Python con Django - Esercitazione di Azure" description="Questa esercitazione illustra come ospitare un sito Web basato su Django in Azure usando una macchina virtuale Windows Server 2012 R2 Datacenter." services="virtual-machines" documentationCenter="python" authors="huguesv" manager="wpickett" editor=""/>
...
Seguendo questa esercitazione, verrà creata una semplice applicazione Web
Hello World. L'applicazione verrà ospitata in una macchina virtuale di Azure.
...
[portal-vm]: /it-it/manage/windows/tutorials/virtual-machine-from-gallery/
