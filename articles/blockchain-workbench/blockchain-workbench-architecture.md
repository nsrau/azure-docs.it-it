...
Azure AD viene usato anche per assegnare utenti a un gruppo di amministratori speciale. Gli utenti associati al gruppo di amministratori ottengono azioni/diritti di amministratore in Blockchain Workbench, ad esempio la distribuzione di contratti e la concessione di autorizzazioni a un utente per accedere a un contratto. Gli utenti esterni a questo gruppo non hanno accesso alle azioni degli amministratori.
