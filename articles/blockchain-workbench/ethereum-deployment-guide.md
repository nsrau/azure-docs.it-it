...
![Dimensioni e prestazioni della rete](./media/ethereum-deployment-guide/network-size-performance.png)
...
Dimensioni della macchina virtuale dei nodi di mining|Le dimensioni della macchina virtuale utilizzata per i nodi di mining.|Standard A, <br />Standard D, <br />Standard D-v2, <br />Standard F series, <br />Standard DS, <br />e Standard FS|Standard D1v2
...
Dimensioni della macchina virtuale dei nodi di transazione|Le dimensioni della macchina virtuale utilizzata per i nodi di transazione.|Standard A, <br />Standard D, <br />Standard D-v2, <br />Standard F series, <br />Standard DS, <br />e Standard FS|Standard D1v2
...
![Impostazioni Ethereum](./media/ethereum-deployment-guide/standalone-leader-deployment.png)
...
![Invio transazione MetaMask](./media/ethereum-deployment-guide/metamask-send.png)
