...
-   [Procedura: Configurare il monitoraggio per un account di archiviazione][Procedura: Configurare il monitoraggio per un account di archiviazione]
-   [Procedura: Personalizzare il dashboard per il monitoraggio][Procedura: Personalizzare il dashboard per il monitoraggio]
-   [Procedura: Personalizzare la pagina Monitor][Procedura: Personalizzare la pagina Monitor]
-   [Procedura: Aggiungere metriche alla relativa tabella][Procedura: Aggiungere metriche alla relativa tabella]
-   [Procedura: Personalizzare il grafico delle metriche nella pagina Monitor][Procedura: Personalizzare il grafico delle metriche nella pagina Monitor]
-   [Procedura: Configurare la registrazione][Procedura: Configurare la registrazione]
