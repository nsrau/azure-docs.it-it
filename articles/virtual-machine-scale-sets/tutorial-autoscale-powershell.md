...
Impostare nome utente e password dell'amministratore per le istanze di VM con [Get-Credential](https://msdn.microsoft.com/powershell/reference/5.1/microsoft.powershell.security/Get-Credential):
