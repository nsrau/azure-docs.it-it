...
È possibile distribuire il modello precedente seguendo questa [documentazione](../azure-resource-manager/resource-group-template-deploy.md).

Per informazioni più generali sui set di scalabilità, è possibile fare riferimento alla [relativa panoramica](./virtual-machine-scale-sets-overview.md)
