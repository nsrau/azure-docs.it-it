<properties
	pageTitle="Creazione rapida di set di scalabilità dall'interfaccia della riga di comando | Microsoft Azure"
...
# Creare rapidamente un set di scalabilità tramite l'interfaccia della riga di comando di Azure
