...
* Per alcuni esempi delle funzionalità di monitoraggio di Azure Insights, vedere [Esempi di avvio rapido dell'interfaccia della riga di comando multipiattaforma di Azure Insights](../monitoring-and-diagnostics/insights-cli-samples.md)
