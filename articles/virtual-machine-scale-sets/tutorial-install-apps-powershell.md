...
description: Informazioni su come usare Azure PowerShell per installare applicazioni nei set di scalabilità di macchine virtuali con l'estensione per script personalizzati
...
> * Usare l'estensione per script personalizzati di Azure
...
## <a name="create-custom-script-extension-definition"></a>Creare una definizione di estensione per script personalizzati
