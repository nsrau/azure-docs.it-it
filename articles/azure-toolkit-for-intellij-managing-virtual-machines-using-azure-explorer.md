---
title: Gestione delle macchine virtuali con Azure Explorer per IntelliJ | Microsoft Docs
...
# <a name="managing-virtual-machines-using-the-azure-explorer-for-intellij"></a>Gestione delle macchine virtuali con Azure Explorer per IntelliJ

Azure Explorer, che fa parte del Toolkit di Azure per IntelliJ, offre agli sviluppatori Java una soluzione di facile uso per la gestione delle macchine virtuali con il proprio account Azure nell'ambiente IDE di IntelliJ.

[!INCLUDE [azure-toolkit-for-intellij-prerequisites](../includes/azure-toolkit-for-intellij-prerequisites.md)]

[!INCLUDE [azure-toolkit-for-intellij-show-azure-explorer](../includes/azure-toolkit-for-intellij-show-azure-explorer.md)]

## <a name="creating-a-virtual-machine-in-intellij"></a>Creazione di una macchina virtuale in IntelliJ
...
1. Nella finestra degli strumenti **Azure Explorer** espandere il nodo **Azure**, fare clic con il pulsante destro del mouse su **Macchine virtuali** e quindi fare clic su **Crea macchina virtuale**.
...
1. Nella schermata successiva della procedura guidata specificare le opzioni seguenti e quindi fare clic su **Avanti**: ![Creare una nuova macchina virtuale][CR03]
   ...
   b. **Recommended Image** (Immagine consigliata): specifica che si sceglie un'immagine da un elenco abbreviato di immagini di uso comune.

   c. **Immagine personalizzata**: specifica che si sceglie un'immagine personalizzata, per cui sarà necessario specificare le opzioni indicate di seguito.
      ...
      * **Versione #**(N. versione): specifica la versione da usare della SKU selezionata.
...
1. Nella schermata successiva della procedura guidata specificare le opzioni seguenti e quindi fare clic su **Fine**: ![Creare una nuova macchina virtuale][CR07]
...
## <a name="restarting-a-virtual-machine-in-intellij"></a>Riavvio di una macchina virtuale in IntelliJ

Per riavviare una macchina virtuale con Azure Explorer in IntelliJ, eseguire queste operazioni:

1. Nella finestra degli strumenti **Azure Explorer** fare clic con il pulsante destro del mouse sulla macchina virtuale e quindi scegliere **Riavvia**.
...
## <a name="shutting-down-a-virtual-machine-in-intellij"></a>Arresto di una macchina virtuale in IntelliJ

Per arrestare una macchina virtuale in esecuzione con Azure Explorer in IntelliJ, eseguire queste operazioni:

1. Nella finestra degli strumenti **Azure Explorer** fare clic con il pulsante destro del mouse sulla macchina virtuale e quindi scegliere **Chiudi**.
...
## <a name="deleting-a-virtual-machine-in-intellij"></a>Eliminazione di una macchina virtuale in IntelliJ

Per eliminare una macchina virtuale con Azure Explorer in IntelliJ, eseguire queste operazioni:

1. Nella finestra degli strumenti **Azure Explorer** fare clic con il pulsante destro del mouse sulla macchina virtuale e quindi scegliere **Elimina**.
