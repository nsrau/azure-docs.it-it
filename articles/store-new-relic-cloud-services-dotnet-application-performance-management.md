...
In questa guida viene illustrata l'aggiunta di New Relic per un monitoraggio di qualità superiore delle prestazioni delle applicazioni ospitate in Azure. Verrà illustrato un processo semplice e rapido per aggiungere New Relic all'applicazione e ne verranno presentate alcune funzionalità. Per altre informazioni sull'uso di New Relic, vedere [Uso di New Relic](#using-new-relic).
...
2. Se nella soluzione non esiste ancora un progetto di servizio cloud di Azure, aggiungerne uno facendo clic con il pulsante destro del mouse sull'app in Esplora soluzioni, quindi selezionando **Aggiungi progetto di servizio cloud di Azure**.
...
7. In Esplora soluzioni fare clic con il pulsante destro del mouse sul progetto di servizio cloud di Azure e scegliere **Pubblica**.
