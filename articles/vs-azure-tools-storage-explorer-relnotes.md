...
Questo articolo contiene le note sulla versione per la versione di Azure Storage Explorer 1.8.1 e note sulla versione per le versioni precedenti.
...
### <a name="download-azure-storage-explorer-181"></a>Scaricare Azure Storage Explorer 1.8.1
- [Azure Storage Explorer, 1.8.1 per Windows](https://go.microsoft.com/fwlink/?LinkId=708343)
- [Azure Storage Explorer, 1.8.1 per Mac](https://go.microsoft.com/fwlink/?LinkId=708342)
- [Azure Storage Explorer, 1.8.1 per Linux](https://go.microsoft.com/fwlink/?LinkId=722418)
