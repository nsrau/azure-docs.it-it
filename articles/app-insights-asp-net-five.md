...
![Fare clic su Nuovo, Servizi per gli sviluppatori, Application Insights](./media/app-insights-asp-net/01-new-asp.png)
...
![Fare clic su Proprietà, selezionare il tasto e premere CTRL+C](./media/app-insights-asp-net/02-props-asp.png)
