<properties
   ...
   description="È possibile usare la soluzione Change Tracking in Microsoft Azure Operational Insights per identificare facilmente le modifiche apportate al software e ai servizi Windows nel proprio ambiente."
...
![immagine del riquadro Change Tracking](./media/operational-insights-change-tracking/overview-change-track.png)
