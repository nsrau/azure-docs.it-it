...
ms.locfileid: "69880241"
---
# <a name="device-connectivity-in-azure-iot-central-preview-features"></a>Connettività del dispositivo in IoT Central di Azure (funzionalità di anteprima)
...
1. [Connettere i dispositivi usando le funzionalità Plug and Play](howto-connect-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
...
1. Nell'applicazione IoT Central _aggiungere e verificare il certificato X. 509 intermedio o radice_ che si sta usando per generare i certificati del dispositivo:
    ...
    - Passare ad **amministrazione > connessione del dispositivo > certificati (X. 509)** e aggiungere la radice X. 509 o il certificato intermedio che si sta usando per generare i certificati del dispositivo foglia.
      ...
      ![Impostazioni di connessione](media/concepts-connectivity-pnp/connection-settings.png)
    ...
    - La verifica della proprietà del certificato garantisce che l'Uploader del certificato disponga della chiave privata del certificato. Per verificare il certificato:
        ...
        - Caricare il certificato di verifica firmato e selezionare **Verifica**.
          ...
          ![Impostazioni di connessione](media/concepts-connectivity-pnp/verify-cert.png)
...
![Impostazioni di connessione](media/concepts-connectivity-pnp/device-connection-flow1.png)
...
1. Configurare le impostazioni di connessione:
    ...
    ![Firma di accesso condiviso per le impostazioni di connessione](media/concepts-connectivity-pnp/connection-settings-sas.png)
...
Per altre informazioni sulla connessione di un dispositivo Plug and Play, vedere la pagina relativa alla modalità di [connessione di un dispositivo Plug and Play](howto-connect-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
- [Connettere un dispositivo Plug and Play](howto-connect-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
