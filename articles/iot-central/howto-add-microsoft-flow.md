...
1. Verrà richiesto di accedere ai connettori nel modello scelto. 
    ...
    > [!NOTE]
    > Per usare Azure IoT Central Connector, è necessario accedere con un account di Azure Active Directory (account aziendale o dell'Istituto di istruzione). Un account personale, ad abc@outlook.com esempio abc@live.com o, non è supportato dal connettore Azure IOT Central.
