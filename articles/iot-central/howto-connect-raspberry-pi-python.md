...
Per i dettagli completi sulla configurazione del modello del dispositivo, vedere [Dettagli del modello del dispositivo di Raspberry PI](howto-connect-raspberry-pi-python.md#raspberry-pi-device-template-details)
