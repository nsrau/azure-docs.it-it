...
1. Usare questi dettagli di connessione, **identità del dispositivo, nome del dispositivo e chiave primaria del dispositivo**, nel codice del dispositivo per il provisioning e la connessione del dispositivo e per iniziare a vedere istantaneamente il flusso di dati. Se si usa il dispositivo MxChip, seguire [queste istruzioni dettagliate](howto-connect-devkit-experimental.md#add-a-real-device) iniziando dalla sezione **Preparare il dispositivo DevKit**.   
    ...
    *   **Node.js:**  se si vuole usare Node.js [seguire queste istruzioni dettagliate](tutorial-add-device-experimental.md#prepare-the-client-code) iniziando dalla sezione **Preparare il codice client**.
...
Se per connettersi si usa il dispositivo **MxChip**, seguire [queste istruzioni dettagliate](howto-connect-devkit-experimental.md#add-a-real-device) iniziando dalla sezione **Preparare il dispositivo DevKit**.   
...
- [Connettere un'applicazione client Node.js generica all'applicazione Azure IoT Central](howto-connect-nodejs-experimental.md)
- [Connettere un dispositivo Raspberry Pi all'applicazione Azure IoT Central](howto-connect-raspberry-pi-python.md)
- [Connettere un dispositivo DevDiv kit all'applicazione Azure IoT Central](howto-connect-devkit-experimental.md).
...
- [Preparare e connettere un dispositivo DevKit](howto-connect-devkit-experimental.md)
