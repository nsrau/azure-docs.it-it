...
1. Nella finestra popup immettere l' **ID del dispositivo** come `SampleDevKit` e il nome del **dispositivo** come `MXChip IoT DevKit - Sample`. Assicurarsi che l'opzione **simulata** sia disattivata. Selezionare quindi **Crea**.
