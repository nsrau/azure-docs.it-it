...
1. Aprire **Program.cs** e sostituire il contenuto con il codice seguente. Aggiornare i `{your Scope ID}`, `{your Device ID}`e `{your Device Primary Key}` con i valori annotati in precedenza:
