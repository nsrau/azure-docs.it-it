...
> [!NOTE] 
> I processi per i dispositivi Azure IoT Edge non sono attualmente supportati. 
...
| Running              | Questo processo è attualmente in esecuzione sui dispositivi.             |
