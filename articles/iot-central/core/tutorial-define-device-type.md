---
title: 'Esercitazione: Definire un nuovo tipo di dispositivo in Azure IoT Central'
...
Per completare questa esercitazione, è necessario disporre di un'applicazione Azure IoT Central creata dal modello **Applicazione personalizzata**. Se non si dispone di un'applicazione, completare l'avvio rapido [Creare un'applicazione Azure IoT Central](quick-deploy-iot-central.md), assicurandosi di scegliere il modello **Applicazione personalizzata**.
...
Per aggiungere un nuovo modello di dispositivo all'applicazione, è necessario passare alla pagina **Modelli di dispositivo**. A tale scopo, selezionare **Modelli di dispositivo** nel riquadro sinistro.
