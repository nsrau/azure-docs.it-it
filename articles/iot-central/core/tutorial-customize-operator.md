---
title: "Esercitazione: Personalizzare le visualizzazioni dell'operatore in Azure IoT Central"
description: "Esercitazione: Come creatore, l'utente può personalizzare le visualizzazioni dell'operatore nell'applicazione Azure IoT Central."
author: sandeeppujar
ms.author: sandeepu
ms.date: 11/13/2019
ms.topic: tutorial
...
1. Per modificare il modello di dispositivo **Connected Air Conditioner** (Condizionatore connesso), scegliere **Modelli di dispositivo** nel riquadro sinistro:
