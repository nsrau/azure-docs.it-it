...
1. Nell'applicazione IoT Central _aggiungere e verificare il certificato X. 509 intermedio o radice_ che si sta usando per generare i certificati del dispositivo:
    ...
    - Passare ad **amministrazione > connessione del dispositivo > certificati (X. 509)** e aggiungere la radice X. 509 o il certificato intermedio che si sta usando per generare i certificati del dispositivo foglia.
      ...
      ![Impostazioni di connessione](media/overview-iot-central-get-connected-pnp/connection-settings.png)
    ...
    - La verifica della proprietà del certificato garantisce che l'Uploader del certificato disponga della chiave privata del certificato. Per verificare il certificato:
        ...
        - Caricare il certificato di verifica firmato e selezionare **Verifica**.
          ...
          ![Impostazioni di connessione](media/overview-iot-central-get-connected-pnp/verify-cert.png)
...
![Impostazioni di connessione](media/overview-iot-central-get-connected-pnp/device-connection-flow1.png)
...
1. Configurare le impostazioni di connessione:
    ...
    ![Firma di accesso condiviso per le impostazioni di connessione](media/overview-iot-central-get-connected-pnp/connection-settings-sas.png)
...
Per altre informazioni sull'uso degli SDK per dispositivi, vedere [connettere un dispositivo DevDiv Kit all'applicazione IoT Central di Azure per un](howto-connect-devkit-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) esempio di codice.
...
- [Preparare e connettere un dispositivo DevKit](howto-connect-devkit-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
