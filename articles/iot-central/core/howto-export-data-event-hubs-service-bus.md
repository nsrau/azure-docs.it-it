...
2. Scegliere una sottoscrizione. 
    ...
    > [!Note] 
    > È ora possibile esportare i dati in altre sottoscrizioni che non sono uguali a quelle dell'applicazione IoT Central standard. In questo caso ci si connetterà con una stringa di connessione.
...
2. Nel riquadro sinistro selezionare **esportazione dati continua**.

    > [!Note]
    > Se non viene visualizzata l'esportazione continua dei dati nel riquadro sinistro, l'utente non è un amministratore nell'app. Chiedere a un amministratore di configurare l'esportazione dei dati.
