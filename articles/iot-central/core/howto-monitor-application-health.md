...
La procedura seguente presuppone che si disponga di un' [applicazione IoT Central](./quick-deploy-iot-central.md) con alcuni [dispositivi connessi](./tutorial-connect-device.md).
