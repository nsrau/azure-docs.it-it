...
1. Se non è ancora stata creata nessuna regola viene visualizzata la schermata seguente:
    ...
    ![Nessuna regola](media/howto-create-event-rules-experimental/Rules_Landing_Page.png)
...
1. Fare clic sul riquadro **Evento** per creare una regola di monitoraggio eventi.
    ...
    ![Tipi di regola](media/howto-create-event-rules-experimental/Rule_Types.png)
...
1. Per attivare immediatamente la regola per tutti i dispositivi creati da questo modello, attivare o disattivare **Abilita regola** per tutti i dispositivi di questo modello.
    ...
    ![Dettagli regola](media/howto-create-event-rules-experimental/Rule_Detail.png)
...
1. Scegliere l2’evento che si vuole monitorare nell'elenco a discesa Misura. In questo esempio è stato selezionato l'evento **Errore motore ventola**.
   ...
   ![Condizione](media/howto-create-event-rules-experimental/Condition_Filled_Out.png)
...
1. Facoltativamente, è possibile impostare anche **conteggio** come **aggregazione** e specificare la soglia corrispondente.
    ...
    ![Aggiungere una condizione evento](media/howto-create-event-rules-experimental/Aggregate_Condition_Filled_Out.png)
...
1. Scegliere **+** accanto ad **Actions** (Azioni). Viene visualizzato l'elenco delle azioni disponibili.
    ...
    ![Aggiungere un'azione](media/howto-create-event-rules-experimental/Add_Action.png)
...
- [Azione di Microsoft Flow](howto-add-microsoft-flow-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) per avviare un flusso di lavoro in Microsoft Flow quando viene attivata una regola 
- [Azione webhook](howto-create-webhooks-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) per inviare una notifica agli altri servizi quando viene attivata una regola
...
- [Aggiungere azione di Microsoft Flow nelle regole](howto-add-microsoft-flow-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
- [Aggiungere azione di Webhook nelle regole](howto-create-webhooks-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
- [Come gestire i dispositivi](howto-manage-devices-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
