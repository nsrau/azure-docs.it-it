...
È possibile creare una copia di una qualsiasi applicazione, senza tuttavia includere eventuali istanze di dispositivi, la cronologia dei dati dei dispositivi e i dati degli utenti. La copia è un'applicazione standard per la fatturazione. Non è possibile creare un'applicazione di valutazione copiando un'applicazione.

Selezionare **copia**. Nella finestra di dialogo immettere i dettagli per la nuova applicazione standard. Quindi selezionare **copia** per confermare che si vuole continuare. Per ulteriori informazioni sui campi nel modulo, vedere la Guida introduttiva alla [creazione di un'applicazione](quick-deploy-iot-central.md) .
