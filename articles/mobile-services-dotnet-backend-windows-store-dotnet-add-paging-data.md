<properties pageTitle="Usare il paging per ridefinire le query di Servizi mobili (Windows Store) | Mobile Dev Center" description="Informazioni su come usare il paging per gestire la quantità di dati restituiti all'app per Windows Store da Servizi mobili." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
