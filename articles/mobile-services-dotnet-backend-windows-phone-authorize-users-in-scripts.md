<properties pageTitle="Autorizzazione lato servizio (Windows Phone) | Mobile Dev Center" description="Informazioni su come autorizzare gli utenti nel back-end .NET di Servizi mobili di Azure." services="" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
...
1. In Visual Studio 2013 per Windows Phone aprire il progetto modificato dopo avere completato l'esercitazione [Introduzione all'autenticazione].
