...
PTVS semplifica, inoltre, la distribuzione in Microsoft Azure e supporta la distribuzione in [Servizi cloud][Servizi cloud] e [Siti Web][Siti Web].
...
* [Distribuzione Python per l'analisi di una sequenza di valori][Distribuzione Python per l'analisi di una sequenza di valori]
...
* [IPython: REPL/Notebook avanzato per Python][IPython: REPL/Notebook avanzato per Python]
* [IPython Notebook in Azure][IPython Notebook in Azure]
* [Python Tools per Visual Studio su GitHub][Python Tools per Visual Studio su GitHub]
