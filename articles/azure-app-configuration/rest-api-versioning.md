...
ms.locfileid: "93424265"
---
# <a name="versioning"></a>Controllo delle versioni

API-Version: 1,0

Ogni richiesta client deve fornire la versione API esplicita come parametro della stringa di query. ad esempio `https://{myconfig}.azconfig.io/kv?api-version=1.0`
...
Si verifica quando un client effettua una richiesta senza fornire una versione API.
...
Si verifica quando una versione API richiesta dal client non corrisponde ad alcuna versione API supportata dal server.
...
Si verifica quando un client effettua una richiesta con una versione API, ma il valore non è valido o non può essere analizzato dal server.
...
Si verifica quando un client richiede una versione API ambigua per il server. Ad esempio, più valori diversi.
