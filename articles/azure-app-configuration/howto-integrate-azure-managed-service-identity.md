...
1. Facoltativo: se si vuole concedere l'accesso anche a Key Vault, seguire le istruzioni riportate in [assegnare un criterio di accesso key Vault](/azure/key-vault/general/assign-access-policy-portal).
