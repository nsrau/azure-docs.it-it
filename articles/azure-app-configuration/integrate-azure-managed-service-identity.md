...
description: In questa esercitazione viene illustrato come usare le identità gestite di Azure per eseguire l'autenticazione e accedere a Configurazione app di Azure
