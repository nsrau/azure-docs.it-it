...
1. In *Program.cs* aggiornare il metodo `CreateWebHostBuilder` in modo da usare Configurazione app chiamando il metodo `config.AddAzureAppConfiguration()`.
