...
> Se si usa Servizi mobili come servizio back-end, vedere la [versione per Servizi mobili](mobile-services-javascript-backend-windows-store-dotnet-push-notifications-app-users.md).
