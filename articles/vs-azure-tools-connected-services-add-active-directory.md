---
title: Aggiunta di Azure Active Directory mediante servizi connessi in Visual Studio | Microsoft Docs
...
2. In Visual Studio, aprire il menu di scelta rapida di **riferimenti** nodo del progetto e scegliere **Aggiungi servizi connessi**.
3. Selezionare **Autenticazione AD Azure** e poi scegliere **Configurazione**.
...
4. Nella prima pagina della **Configurazione dell’Autenticazione AD Azure**, controllare **Configurazione Single Sign-on con Azure AD**.
