...
![Funzionamento del modulo Azure IoT Edge in Azure Stack Edge](./media/azure-stack-edge-j-series-create-iot-edge-module/how-module-works-1.png)
...
- Un dispositivo Azure Stack Edge che esegue.
    ...
    Per altre informazioni, vedere [configurare il calcolo](azure-stack-edge-j-series-deploy-configure-compute.md#configure-compute) per il Azure stack Edge.
...
Per distribuire ed eseguire questo modulo in Azure Stack Edge, vedere la procedura descritta in [aggiungere un modulo](azure-stack-edge-j-series-deploy-configure-compute.md#add-a-module).
