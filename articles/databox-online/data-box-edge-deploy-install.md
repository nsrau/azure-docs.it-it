...
- Verificare i requisiti di rete per distribuire Data Box Edge e configurare la rete del data center in base ai requisiti. Per altre informazioni, vedere i [requisiti di rete di Data Box Edge](data-box-gateway-system-requirements.md#networking-requirements).
