...
---
# <a name="develop-a-c-iot-edge-module-to-move-files-on-data-box-edge"></a>Sviluppare un modulo di IoT Edge C# per spostare i file in Data Box Edge
...
3. Specificare:
   ...
   4. Selezionare una **località**. È consigliabile inserire la stessa posizione associata alla risorsa Data Box Edge.
