...
ms.locfileid: "60755037"
---
# <a name="monitor-your-azure-data-box-gateway"></a>Monitorare Azure Data Box Gateway

Questo articolo descrive come monitorare Azure Data Box Gateway. Per monitorare il dispositivo, è possibile usare il portale di Azure o l'interfaccia utente locale. Usare il portale di Azure per visualizzare gli eventi del dispositivo, configurare e gestire gli avvisi e visualizzare le metriche.
