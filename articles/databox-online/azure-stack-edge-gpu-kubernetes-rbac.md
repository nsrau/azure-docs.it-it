...
Questo articolo fornisce una panoramica del sistema Kubernetes RBAC fornito da Kubernetes e come viene implementato il controllo degli accessi in base al ruolo di Kubernetes nel dispositivo Azure Stack Edge Pro. 
...
## <a name="kubernetes-rbac-on-azure-stack-edge-pro"></a>Kubernetes RBAC in Azure Stack Edge Pro

Nell'implementazione corrente di Kubernetes RBAC, Azure Stack Edge Pro consente di eseguire le azioni seguenti da un spazio di PowerShell con restrizioni:
...
Di seguito è riportato un diagramma che illustra l'implementazione di Kubernetes RBAC sul dispositivo Azure Stack Edge Pro.

![Kubernetes RBAC sul dispositivo Azure Stack Edge Pro](./media/azure-stack-edge-gpu-kubernetes-rbac/rbac-view-1.png)
