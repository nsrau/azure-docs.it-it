...
| Dimensioni | La dimensione massima del payload del metodo diretto è 128 KB. | Le dimensioni massime delle proprietà desiderate sono pari a 32 KB. | Fino a 64 KB per i messaggi. |
