...
| Dimensione | Fino a 8 KB per le richieste e 8 KB per le risposte. | Le dimensioni massime per le proprietà desiderate sono 8 KB. | Fino a 64 KB per i messaggi. |
