...
| Destinazioni | Singolo dispositivo che usa **deviceId** o più dispositivi che usano [processi](iot-hub-devguide-jobs.md). | Singolo dispositivo che usa **deviceId** o più dispositivi che usano [processi](iot-hub-devguide-jobs.md). | Singolo dispositivo in base a **deviceId**. |
