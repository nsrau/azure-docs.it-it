...
> [AZURE.NOTE] Gli [SDK dell'hub IoT di Azure][lnk-sdks] generano automaticamente i token durante la connessione al servizio. In alcuni casi, gli SDK non supportano tutti i protocolli o tutti i metodi di autenticazione.
...
> [AZURE.NOTE] È possibile generare un token di sicurezza usando lo strumento .NET [Device Explorer][lnk-device-explorer].
...
| Autorizzazione            | Note |
| --------------------- | ----- |
| **RegistryRead**      | Concede l'accesso in lettura al registro delle identità dei dispositivi. Per altre informazioni, vedere [Device identity registry][Ink-identity-registry] (Registro delle identità dei dispositivi). |
| **RegistryReadWrite** | Concede l'accesso in lettura e scrittura al registro delle identità dei dispositivi. Per altre informazioni, vedere [Device identity registry][Ink-identity-registry] (Registro delle identità dei dispositivi). |
