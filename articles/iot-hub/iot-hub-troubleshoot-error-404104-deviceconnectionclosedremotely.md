...
- Il dispositivo ha inviato una reimpostazione a livello di TCP/IP, ma non ha inviato un `MQTT DISCONNECT`a livello di applicazione. Fondamentalmente, il dispositivo ha chiuso improvvisamente la connessione socket sottostante. Questo problema è talvolta causato da bug nelle versioni precedenti dell'SDK di Azure.
