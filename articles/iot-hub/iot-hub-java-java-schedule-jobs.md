...
2. Nella cartella **iot-java-schedule-jobs,** creare un progetto Maven denominato **schedule-jobs** utilizzando il comando seguente al prompt dei comandi. Si noti che si tratta di un lungo comando singolo:
...
7. Utilizzando un editor di testo, aprire il file **schedule-jobs.**
...
15. Per eseguire e monitorare due processi in sequenza, sostituire il codice nel metodo main con il codice seguente:To run and monitor two jobs sequentially, replace the code in the **main** method with the following code:
...
16. Salvare e chiudere il file **schedule-jobs**
...
17. Salvare e chiudere il file **simulated-device, src, main, java, microsoft azienda e app, app e app.java.**

18. Compilare l'app **simulated-device** e correggere eventuali errori. Al prompt dei comandi passare alla cartella **del dispositivo simulato** ed eseguire il comando seguente:
...
1. Al prompt dei comandi nella cartella **del dispositivo simulato,** eseguire il comando seguente per avviare l'app del dispositivo in ascolto delle modifiche alle proprietà desiderate e le chiamate dirette al metodo:
