...
Se gli obiettivi di uptime aziendali non sono soddisfatti dal RTO che forniscono le opzioni di failover manuale o di failover avviate da Microsoft, si dovrebbe prendere in considerazione l'implementazione di un meccanismo di failover automatico per regione trasversale per dispositivo.
...
* [Introduzione agli hub IoT (esercitazione)](quickstart-send-telemetry-dotnet.md)
