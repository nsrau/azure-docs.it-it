---
title: Come generare i token di sicurezza hub IoT | Microsoft Docs
...
> [!NOTE]
> È possibile generare un token di sicurezza tramite lo strumento .NET [Device Explorer][lnk-device-explorer].
> 
> 
