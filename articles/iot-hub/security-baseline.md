...
- [Configurare i log degli eventi di Azure](iot-hub-monitor-resource-health.md)
...
- [Configurare i log dell'hub Azure](iot-hub-monitor-resource-health.md)
...
- [Monitorare l'integrità di Azure](iot-hub-monitor-resource-health.md)
- [Come eseguire l'onboarding di Azure Sentinel](../sentinel/quickstart-onboard.md)
