...
* Per altre informazioni sulle funzionalità di Azure Resource Manager, vedere [Azure Resource Manager Overview](../azure-resource-manager/management/overview.md) .
