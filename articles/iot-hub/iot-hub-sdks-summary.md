---
title: Elenco degli SDK hub IoT Azure | Microsoft Docs
...
---
# SDK hub IoT
In questo articolo vengono fornite informazioni sui vari [SDK IoT di Microsoft Azure][SDK IoT di Microsoft Azure] con collegamenti a risorse aggiuntive.
...
* [SDK per dispositivi IoT Azure per C][SDK per dispositivi IoT Azure per C] scritto in ANSI C (C99) per la portabilità e la compatibilità multipiattaforma.
* [SDK per dispositivi IoT Azure per .NET][SDK per dispositivi IoT Azure per .NET]
* [SDK per dispositivi IoT Azure per Java][SDK per dispositivi IoT Azure per Java]
* [SDK per dispositivi IoT Azure per Node.js][SDK per dispositivi IoT Azure per Node.js]
* [Microsoft Azure IoT SDK per dispositivi per Python 2.7][Microsoft Azure IoT SDK per dispositivi per Python 2.7]
...
* [Programma Microsoft Azure Certified per IoT][Programma Microsoft Azure Certified per IoT].
...
* [SDK del servizio IoT Azure SDK per Node.js][SDK del servizio IoT Azure SDK per Node.js]
* [SDK del servizio IoT Azure SDK per Java][SDK del servizio IoT Azure SDK per Java]
...
L'[SDK per gateway IoT di Azure][SDK per gateway IoT di Azure] può essere scaricato da GitHub.
...
* [REST hub IoT][REST hub IoT]
* [SDK per dispositivi Microsoft Azure IoT per C][SDK per dispositivi Microsoft Azure IoT per C]
* [SDK per dispositivi Microsoft Azure IoT per Java][SDK per dispositivi Microsoft Azure IoT per Java]
* [SDK del servizio IoT di Microsoft Azure per Java][SDK del servizio IoT di Microsoft Azure per Java]
* [SDK per dispositivi Microsoft Azure IoT per Node.js][SDK per dispositivi Microsoft Azure IoT per Node.js]
* [SDK del servizio IoT di Microsoft Azure per Node.js][SDK del servizio IoT di Microsoft Azure per Node.js]
* [IoT Gateway SDK di Microsoft Azure][IoT Gateway SDK di Microsoft Azure]
