<properties
 ...
 description="Informazioni e collegamenti ai vari SDK per dispositivi e servizi hub IoT"
 services="iot-hub"
...
In questo [documento][OS Platforms and hardware compatibility] viene descritta la compatibilità degli SDK dei dispositivi con diverse piattaforme del sistema operativo, nonché le configurazioni di dispositivi specifici incluse nel [programma Microsoft Azure Certified per IoT][].
...
Di seguito è un elenco di collegamenti alla documentazione di riferimento API online per le librerie di servizio IoT Azure:
...
[SDK per dispositivi IoT Azure per .NET]: https://github.com/Azure/azure-iot-sdks/blob/master/csharp/readme.md
...
[programma Microsoft Azure Certified per IoT]: https://github.com/Azure/azure-iot-sdks/blob/master/doc/tested_configurations.md#certified
...
[SDK per dispositivi Microsoft Azure IoT per Java]: http://azure.github.io/azure-iot-sdks/java/api_reference/index.html
