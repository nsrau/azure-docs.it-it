...
Il pacchetto Azure IoT Gateway SDK contiene i file binari preinstallati dell'SDK e le relative dipendenze. Tali file binari corrispondono a Azure IoT Gateway SDK, Azure IoT SDK e agli strumenti corrispondenti. Il pacchetto contiene anche un'applicazione di esempio "hello_world" usata per convalidare la funzionalità del gateway. L'SDK è la parte principale del gateway. Per installare il pacchetto, seguire questi passaggi:
