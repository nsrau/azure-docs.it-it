...
* *URI della richiesta* specifico del dispositivo con la [versione dell'API](https://docs.aws.amazon.com/cli/latest/reference/iot1click-devices/invoke-device-method.html):
