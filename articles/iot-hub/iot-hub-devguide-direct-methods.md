...
La chiamata a metodi diretti tramite un ID modulo è supportata nella versione di anteprima dell'SDK per C# (disponibile [qui](https://www.nuget.org/packages/Microsoft.Azure.Devices/1.16.0-preview-004)).
