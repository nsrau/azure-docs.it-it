...
* *URI della richiesta* specifico del dispositivo con la [versione dell'API](https://docs.microsoft.com/rest/api/iothub/service/devices/invokemethod):
