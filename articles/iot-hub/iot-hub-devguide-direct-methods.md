...
La chiamata di metodi diretti mediante un ID modulo è supportata nell'SDK per C#, disponibile [qui](https://www.nuget.org/packages/Microsoft.Azure.Devices/).
