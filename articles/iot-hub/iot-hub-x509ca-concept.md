...
![Flusso per la generazione di un certificati X509CA](./media/iot-hub-x509ca-concept/csr-flow.png)
...
![Gerarchia di catena di certificati](./media/iot-hub-x509ca-concept/cert-chain-hierarchy.png)
