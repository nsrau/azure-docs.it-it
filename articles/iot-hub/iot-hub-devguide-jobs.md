...
Usando il [linguaggio di query dell'hub IoT per dispositivi gemelli, processi e routing di messaggi][lnk-query], è possibile eseguire query sullo stato di esecuzione dei processi su ogni dispositivo.
