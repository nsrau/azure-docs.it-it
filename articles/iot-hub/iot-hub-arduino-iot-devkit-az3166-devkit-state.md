...
- Configurare l'ambiente di sviluppo seguendo la [Guida introduttiva](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-arduino-iot-devkit-az3166-get-started).
...
4. Selezionare o scegliere un gruppo di risorse. 
    ...
    > [!NOTE]
    > Se si dispone già di un hub IoT gratuito, questo passaggio verrà ignorato.
...
1. Immettere il nome dell'app per le funzioni annotato in precedenza.
2. Scegliere il pulsante **Connetti**
3. Entro pochi secondi la pagina viene aggiornata e mostra lo stato della connessione WiFi del dispositivo DevKit e lo stato di ognuno dei sensori onboard.
