...
# Attività iniziali
## Introduzione ai dispositivi simulati
### [Introduzione all'hub IoT (.NET)](iot-hub-csharp-csharp-getstarted.md)
### [Introduzione all'hub IoT (Java)](iot-hub-java-java-getstarted.md)
### [Introduzione all'hub IoT (Node)](iot-hub-node-node-getstarted.md)

## Introduzione a Raspberry Pi (Node)
...
## Introduzione a Intel Edison (Node)
### [Introduzione a Intel Edison](iot-hub-intel-edison-kit-node-get-started.md)
### Lezione 1: Configurare il dispositivo
...
## Introduzione a Intel Edison (C)
### [Introduzione a Intel Edison](iot-hub-intel-edison-kit-c-get-started.md)
### Lezione 1: Configurare il dispositivo
...
## Introduzione allo starter kit per il gateway IoT
### Dispositivo simulato

#### [Introduzione ai dispositivi simulati](iot-hub-gateway-kit-c-sim-get-started.md)
...
#### [Introduzione ai dispositivi SensorTag](iot-hub-gateway-kit-c-get-started.md)
#### Lezione 1: Configurare NUC
...
## Introduzione a IoT SDK per dispositivi
### [Introduzione ad Azure IoT SDK per dispositivi per C](iot-hub-device-sdk-c-intro.md)
### [IoT SDK per dispositivi per C: altre informazioni su IoTHubClient](iot-hub-device-sdk-c-iothubclient.md)
### [IoT SDK per dispositivi per C: altre informazioni sul serializzatore](iot-hub-device-sdk-c-serializer.md)
# Procedure
## [Esercitazione sull'elaborazione dei messaggi da dispositivo a cloud (.NET)](iot-hub-csharp-csharp-process-d2c.md)
## [Esercitazione sull'elaborazione dei messaggi da dispositivo a cloud (Java)](iot-hub-java-java-process-d2c.md)
## [Esercitazione sul caricamento di file da dispositivi](iot-hub-csharp-csharp-file-upload.md)
## [Inviare messaggi da cloud a dispositivo (.NET)](iot-hub-csharp-csharp-c2d.md)
## [Inviare messaggi da cloud a dispositivo (Java)](iot-hub-java-java-c2d.md)
## [Inviare messaggi da cloud a dispositivo (Node)](iot-hub-node-node-c2d.md)
## [Introduzione ai dispositivi gemelli (Node)](iot-hub-node-node-twin-getstarted.md)
## [Introduzione ai dispositivi gemelli (.NET/Node)](iot-hub-csharp-node-twin-getstarted.md)
## [Usare metodi diretti per Node.js](iot-hub-node-node-direct-methods.md)
## [Usare metodi diretti per .NET/Node](iot-hub-csharp-node-direct-methods.md)
## [Introduzione alla gestione dei dispositivi per Node.js](iot-hub-node-node-device-management-get-started.md)
## [Introduzione alla gestione dei dispositivi per .NET/Node](iot-hub-csharp-node-device-management-get-started.md)
## [Come usare le proprietà dei dispositivi gemelli (Node)](iot-hub-node-node-twin-how-to-configure.md)
## [Come usare le proprietà dei dispositivi gemelli (.NET/Node)](iot-hub-csharp-node-twin-how-to-configure.md)
## [Usare i processi del dispositivo per aggiornare il firmware del dispositivo per Node.js](iot-hub-node-node-firmware-update.md)
## [Usare i processi del dispositivo per aggiornare il firmware del dispositivo per .NET/Node](iot-hub-csharp-node-firmware-update.md)
## [Pianificare e trasmettere processi per Node.js](iot-hub-node-node-schedule-jobs.md)
## [Pianificare e trasmettere processi per .NET/Node](iot-hub-csharp-node-schedule-jobs.md)
## Pianificare
...
## Sviluppare
### [Introduzione](iot-hub-devguide.md)
...
## Manage
### [Creare un hub IoT usando il portale](iot-hub-create-through-portal.md)
### [Creare un hub IoT usando l'anteprima dell'interfaccia della riga di comando 2.0](iot-hub-create-using-cli.md)
### [Creare un hub IoT usando l'interfaccia della riga di comando](iot-hub-create-using-cli-nodejs.md)
### [Creare un hub IoT usando REST](iot-hub-rm-rest.md)
### [Creare un hub IoT tramite PowerShell](iot-hub-rm-template-powershell.md)
### [Creare un hub IoT usando un modello](iot-hub-rm-template.md)
...
## Gateway SDK
### [Esercitazione sulla simulazione di un dispositivo con Gateway SDK (Linux)](iot-hub-linux-gateway-sdk-simulated-device.md)
### [Esercitazione sulla simulazione di un dispositivo con Gateway SDK (Windows)](iot-hub-windows-gateway-sdk-simulated-device.md)
### [Esercitazione sull'invio di messaggi da un dispositivo reale con Gateway SDK](iot-hub-gateway-sdk-physical-device.md)
## Proteggere
