...
* Tutte le chiavi negli oggetti JSON sono stringhe UTF-8 UNICODE da 64 caratteri con distinzione tra maiuscole e minuscole. I caratteri consentiti escludono i caratteri di controllo UNICODE (segmenti C0 e C1) e `.`, `$` e SP.
...
* [Gestione dei dispositivi con il toolkit dell'hub IoT di Azure per Visual Studio Code](iot-hub-device-management-iot-toolkit.md)
