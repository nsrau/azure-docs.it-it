---
title: Guida per gli sviluppatori - Informazioni sui dispositivi gemelli | Microsoft Docs
...
> [!NOTE]
> Al momento i dispositivi gemelli sono accessibili solo dai dispositivi che si connettono all'hub IoT tramite il protocollo MQTT. Per istruzioni su come convertire l'app del dispositivo esistente affinché usi MQTT, leggere l'articolo [Supporto di MQTT][lnk-devguide-mqtt].
> 
> 
...
> [!NOTE]
> I frammenti di codice precedenti sono esempi ottimizzati per una migliore leggibilità, di un possibile modo per codificare una configurazione del dispositivo e il relativo stato. L'hub IoT non impone uno schema specifico per l'uso delle proprietà desiderate e segnalate nei dispositivi gemelli.
> 
> 
