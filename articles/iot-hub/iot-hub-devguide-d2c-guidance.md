...
| Dimensione | Fino a messaggi di 256 KB. | La dimensione massima delle proprietà segnalate è 32 KB. | Dimensioni di file massime supportate dall'Archiviazione BLOB di Azure. |
