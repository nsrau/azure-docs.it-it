...
| ---- | ------- | ---------- | ---- |
| Scenario | Serie temporali di telemetria e avvisi, ad esempio batch di dati dei sensori da 256 KB inviati ogni 5 minuti. | Funzionalità disponibili e condizioni, ad esempio la modalità di connessione attuale del dispositivo (rete cellulare o WiFi). Sincronizzazione di flussi di lavoro a esecuzione prolungata, ad esempio aggiornamenti della configurazione e del software. | File multimediali. Batch di dati di telemetria di grandi dimensioni, in genere compressi. |
