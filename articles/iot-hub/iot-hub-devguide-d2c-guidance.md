...
| Dimensioni | Fino a messaggi di 256 KB. | Le dimensioni massime delle proprietà segnalate sono 32 KB. | Dimensioni di file massime supportate dall'Archiviazione BLOB di Azure. |
