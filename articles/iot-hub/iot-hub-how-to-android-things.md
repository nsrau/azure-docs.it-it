...
2.  Usare lo strumento [adb](https://developer.android.com/studio/command-line/adb) per connettere il dispositivo Android Things all'indirizzo IP annotato in precedenza.  Verificare la connessione usando il comando seguente dal terminale.  I dispositivi dovrebbero essere elencati come "connessi"
    ```
    adb devices
    ```
