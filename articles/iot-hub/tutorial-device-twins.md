...
In questa esercitazione si è appreso come sincronizzare le informazioni sullo stato tra i dispositivi e l'hub IoT eseguendo le attività seguenti:
...
Passare all'esercitazione successiva per imparare a usare i dispositivi gemelli per implementare un processo di aggiornamento del firmware.
