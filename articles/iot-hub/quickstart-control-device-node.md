...
ms.locfileid: "56674107"
---
# <a name="quickstart-control-a-device-connected-to-an-iot-hub-nodejs"></a>Avvio rapido: Controllare un dispositivo connesso a un hub IoT (Node.js)
