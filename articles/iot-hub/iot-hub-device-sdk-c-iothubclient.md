<properties
	pageTitle="Azure IoT device SDK per C: altre informazioni su IoTHubClient"
	description="Altri dettagli sulla libreria IoTHubClient in Azure IoT device SDK per C"
	services="iot-hub"
...
L'applicazione **iothub\_client\_sample\_http** inclusa nell'SDK espone le API di livello inferiore. In questo esempio, si inviano eventi all'hub IoT con il codice seguente:
