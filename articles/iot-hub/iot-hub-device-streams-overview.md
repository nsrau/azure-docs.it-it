...
Il nome host dell'endpoint di streaming del dispositivo è reperibile nel portale dell'hub Azure Internet all'interno della scheda Panoramica. !["endpoint del flusso del dispositivo"](./media/iot-hub-device-streams-overview/device-stream-in-portal.png)
...
* [C#servizio e programma di servizio](quickstart-device-streams-proxy-csharp.md)
