...
* [Inviare e ricevere messaggi con l'hub IoT][devguide-messaging], che descrive le funzionalità di messaggistica da dispositivo a cloud e da cloud a dispositivo esposte dall'hub IoT. Questo articolo contiene anche informazioni su argomenti come il routing e i formati dei messaggi, i protocolli di comunicazione supportati e i numeri delle porte in uso.
