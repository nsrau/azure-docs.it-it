...
| **Eventi del dispositivo** | Sì, il routing dei messaggi può segnalare le modifiche del dispositivo gemello e gli eventi del ciclo di vita del dispositivo. | Sì, Griglia di eventi può segnalare quando i dispositivi vengono creati, eliminati, connessi e disconnessi dall'hub IoT |
