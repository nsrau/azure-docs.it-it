...
description: Questa guida di avvio rapido illustra come eseguire un'applicazione Xamarin.Forms di esempio per inviare dati di telemetria simulati a un hub IoT e leggere i dati di telemetria dall'hub IoT per l'elaborazione nel cloud.
author: cmaneu
manager: philmea
ms.author: chmaneu
ms.service: iot-hub
