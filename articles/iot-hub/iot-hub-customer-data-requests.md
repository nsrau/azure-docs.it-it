...
La documentazione completa per le API del servizio Hub IoT di Azure si trova in [IoT Hub Service APIs](/rest/api/iothub/service/configuration) (API del servizio Hub IoT).