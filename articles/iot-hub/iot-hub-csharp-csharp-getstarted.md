...
---
# <a name="connect-your-simulated-device-to-your-iot-hub-using-net"></a>Connettere il dispositivo simulato all'hub IoT usando .NET
...
* [Introduzione a IoT Edge][lnk-gateway-SDK]
