---
title: Come eseguire un aggiornamento del firmware | Microsoft Docs
...
Node.js 0.12.x o versione successiva. <br/>  [Prepare your development environment](Preparare l'ambiente di sviluppo.md)[lnk-dev-setup] descrive come installare Node.js per questa esercitazione in Windows o Linux.
