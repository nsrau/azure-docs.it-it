...
- [Gestire l'hub IoT tramite il portale di anteprima di Azure][lnk-manage-portal] descrive come usare il portale di anteprima di Azure per gestire l'hub IoT.
