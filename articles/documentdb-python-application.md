...
per la creazione di un'applicazione Web di voto usando Azure Document
DB.
...
e fare clic su Crea. Questo configurerà l'ambiente virtuale Python per
il progetto.
...
**Nota:** in rari cari è possibile che venga visualizzato un errore nella finestra di output. In
...
<a name="verify-the-virtual-environment"></a> Se si verifica questa situazione, è possibile
continuare.

</h1>
# <a name="_Toc395888522"></a><a name="_Toc395809331">Verifica dell'ambiente virtuale</a>

È importante verificare che tutti i componenti siano stati installati correttamente. Avviare il sito
...
certi che verrà install'ata la versione stabile più recente. Notare che sarà necessario
immettere per intero il nome "--pre pydocumentdb".
...
in un file di configurazione anziché nell'applicazione. Per semplicità, in questa esercitazione verranno
inserite nel codice sorgente. Creare una nuova funzione in views.py e denominarla
"create". Aggiungere il codice seguente a **views.py**, senza eliminare alcuna parte
...
### <a name="_Toc395809338">Registrare il voto e modificare il documento</a>
...
Aggiungere i seguenti file HTML nella cartella templates:
...
## <a name="_Toc395888532"></a><a name="_Toc395809341">Aggiungere un file di configurazione ed eliminare \_\_init\_\_.py</a>.

Fare clic con il pulsante destro del mouse sul nome di progetto "tutorial" e aggiungere un file **config.py**.
Questa configurazione è richiesta dai moduli in Flask. È possibile usarla anche per fornire una
...
# <a name="_Toc395888534"></a><a name="_Toc395809343"></a><a name="_Toc395637774">Esecuzione dell'applicazione in locale</a>
