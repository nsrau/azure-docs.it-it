<properties urlDisplayName="Get Started with Mobile Analytics" pageTitle="Introduzione a Mobile Analytics | Dev Center di Servizi mobili" metaKeywords="" description="Get Started with Mobile Analytics." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Get Started with Mobile Analytics" authors="mahender" manager="dwrede"/>
...
## Passaggi successivi
Per altre informazioni su cosa può fare Capptain per la propria app, visitare [http://www.capptain.com](http://www.capptain.com)
