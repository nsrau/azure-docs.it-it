<properties pageTitle="Informazioni su Chef e macchine virtuali di Azure" description="Descrive come installare e configurare Chef in una macchina virtuale in Azure." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
...
- Usare il portale di gestione di Azure per installare il client Chef quando si crea una macchina virtuale che esegue Windows Server 2012 o Windows Server 2012 R2. Per le istruzioni, vedere [Microsoft Azure Portal](https://docs.chef.io/azure_portal.html).
