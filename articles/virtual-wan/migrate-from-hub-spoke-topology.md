...
![topologia di rete esistente contoso](./media/migrate-from-hub-spoke-topology/contoso-pre-migration.png)
**Figura: topologia di rete esistente contoso**
...
## <a name="architecture"></a>Architettura WAN virtuale di Azure
...
![architettura WAN virtuale di Contoso](./media/migrate-from-hub-spoke-topology/vwan-architecture.png)
...
![topologia a singola area](./media/migrate-from-hub-spoke-topology/figure1.png)
**Figura 1: area singola hub-and-spoke DC**
...
- [Esercitazione: creare una connessione da sito a sito usando la rete WAN virtuale di Azure](virtual-wan-site-to-site-portal.md)
...
![distribuire Hub WAN virtuali](./media/migrate-from-hub-spoke-topology/figure2.png)
**Figura 2: Hub-and-spoke per la migrazione WAN virtuale**
...
![connettere siti remoti a una rete WAN virtuale](./media/migrate-from-hub-spoke-topology/figure3.png)
**Figura 3: Hub di rete virtuale-e-spoke alla migrazione WAN virtuale**
...
![testare la connettività ibrida tramite una rete WAN virtuale](./media/migrate-from-hub-spoke-topology/figure4.png)
**Figura 4: Hub e spoke di data center virtuale a migrazione WAN virtuale**
...
![la connettività di transizione all'hub WAN virtuale](./media/migrate-from-hub-spoke-topology/figure5.png)
**Figura 5: Hub e spoke di data center virtuale a migrazione WAN virtuale**

**a**. Eliminare le connessioni peering esistenti dalle reti virtuali spoke all'hub Data Center precedente. L'accesso alle applicazioni nelle reti virtuali spoke non è disponibile finché non vengono completati i passaggi a-c.
...
![Hub precedente diventa servizi condivisi spoke](./media/migrate-from-hub-spoke-topology/figure6.png)
**Figura 6: Hub di rete virtuale-e-spoke alla migrazione della rete WAN virtuale**

Poiché l'hub WAN virtuale è un'entità gestita e non consente la distribuzione di risorse personalizzate, ad esempio macchine virtuali, il blocco dei servizi condivisi ora esiste come rete virtuale spoke e ospita funzioni come l'ingresso Internet tramite applicazione Azure gateway o Appliance virtualizzata di rete. Il traffico tra l'ambiente di servizi condivisi e le macchine virtuali back-end ora transita attraverso l'hub gestito dalla rete WAN virtuale.
...
![ottimizzare la connettività locale per usare completamente la rete WAN virtuale](./media/migrate-from-hub-spoke-topology/figure7.png)
**Figura 7: Hub-and-spoke virtuale per la migrazione della rete WAN virtuale**
...
![architettura di stato e percorsi di traffico](./media/migrate-from-hub-spoke-topology/figure8.png)
...
![sicurezza e controllo dei criteri tramite il firewall **di azure](./media/migrate-from-hub-spoke-topology/security-policy.png)
