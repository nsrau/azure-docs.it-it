...
## <a name="verify-registration"></a><a name="verify"></a>Verifica registrazione

```azurepowershell-interactive
Get-AzProviderFeature -FeatureName AllowCortexGlobalVnetPeering -ProviderNamespace Microsoft.Network
```

## <a name="connect-a-vnet-to-the-hub"></a><a name="hub"></a>Connettere un VNet all'hub
