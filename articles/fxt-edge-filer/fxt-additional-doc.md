...
[VFXT per Azure](../avere-vfxt/index.yml) è un prodotto di cache del cluster simile che usa nodi virtuali in Microsoft Azure. Viene creato con il portale di Azure, ma usa lo stesso software di configurazione del pannello di controllo della cache hardware del filer di Azure FXT Edge.
