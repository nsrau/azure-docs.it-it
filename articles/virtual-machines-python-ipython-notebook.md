<properties pageTitle="IPython Notebook - Esercitazione in Azure" description="Esercitazione che mostra come distribuire IPython Notebook in Azure usando macchine virtuali (VM) Linux o Windows." services="virtual-machines" documentationCenter="python" authors="huguesv" manager="wpickett" editor=""/>
