<properties
	pageTitle="Introduzione alle app mobili di Azure per app per Xamarin Android - app mobile di Azure"
	description="Seguire questa esercitazione per iniziare a usare le app mobili di Azure per lo sviluppo per Xamarin Android."
...
In questa esercitazione viene illustrato come aggiungere un servizio back-end basato sul cloud a un'app per Xamarin Android con il servizio per app mobili di Azure. In questa esercitazione si creeranno un nuovo servizio .NET e una semplice app _To do list_ che archivia i dati dell'app nel back-end .NET.

Di seguito è riportata una schermata dell'app completata:

![][0]

Il completamento di questa esercitazione è un prerequisito per tutte le altre esercitazioni per app mobili di Azure per Xamarin Android.
...
## Creare un nuovo back-end per app mobili

[AZURE.INCLUDE [app-service-mobile-dotnet-backend-create-new-service-preview](../includes/app-service-mobile-dotnet-backend-create-new-service-preview.md)]

## Creare una nuova app per Xamarin Android

Dopo aver creato il back-end per app mobili, è possibile seguire una facile guida introduttiva nel [portale di Azure] per creare una nuova app o modificare un'app esistente per connettersi al back-end per app mobili.

In questa esercitazione si scaricherà una nuova app per Xamarin Android e un progetto di servizio back-end .NET per l'app mobile.

1. Nel portale di Azure fare clic su **Sfoglia**, quindi su **App mobili** e selezionare l'app mobile appena creata.

2. Nella parte superiore del pannello fare clic su **Aggiungi client** ed espandere **Xamarin.Android**.

    ![][6]

    Vengono visualizzati i tre semplici passaggi per creare un'app per Xamarin Android connessa al back-end per app mobili.
...
5. In **Scaricare e pubblicare il servizio nel cloud**, fare clic su**Scarica**.
  	...
  	Verrà scaricata una soluzione che contiene progetti sia per il codice del back-end per app mobili, sia per l'applicazione client _To do list di esempio connessa al back-end per app mobili. Salvare il file del progetto compresso nel computer locale e prendere nota del percorso.
...
## Testare il back-end per app mobili

[AZURE.INCLUDE [app-service-mobile-dotnet-backend-test-local-service-preview](../includes/app-service-mobile-dotnet-backend-test-local-service-preview.md)]

## Pubblicare il back-end per app mobili
...
1. Passare al progetto client nella soluzione dell'app mobile, in Visual Studio o in Xamarin Studio.
...
3. Nell'app digitare un testo significativo, ad esempio _Complete the tutorial_, quindi fare clic sull'icona con il segno PIÙ (**+**).
	...
	Verrà inviata una richiesta POST al nuovo back-end per app mobili ospitato in Azure. I dati della richiesta vengono inseriti nella tabella TodoItem. Gli elementi archiviati nella tabella vengono restituiti dal back-end per app mobili e i dati vengono visualizzati nell'elenco.
