...
1. Eseguire questo comando per accettare le condizioni d'uso e abilitare l'accesso a livello di codice per le immagini software di Avere vFXT per Azure: 
