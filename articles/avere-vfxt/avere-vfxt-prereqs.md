...
description: Informazioni sulle attività da eseguire prima di creare un cluster in vFXT per Azure, inclusa la gestione delle sottoscrizioni, delle quote e degli endpoint del servizio di archiviazione.
author: ekpgh
...
Verificare di disporre di una quota sufficiente per i componenti di Azure seguenti. Se necessario, [richiedere un aumento della quota](../azure-portal/supportability/resource-manager-core-quotas-request.md).
