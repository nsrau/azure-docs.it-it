...
* La [guida alla creazione di cluster FXT](<https://azure.github.io/Avere/#fxt_cluster>) è pensata per i cluster costituiti da nodi hardware fisici, ma alcune informazioni nel documento sono pertinenti anche per i cluster vFXT. In particolare, i nuovi amministratori di cluster vFXT possono trarre vantaggio dalla lettura di queste sezioni:
  ...
  * Aggiunta di documenti [di archiviazione back-end](<https://azure.github.io/Avere/legacy/create_cluster/4_8/html/config_core_filer.html#add-core-filer>) su come aggiungere filer di base.
...
Una guida completa per l'utilizzo di vfxt.py, un'utilità di creazione e gestione di cluster cloud basata su script, viene fornita su GitHub: [gestione cluster cloud con vfxt.py](https://github.com/Azure/AvereSDK/blob/master/docs/README.md).
