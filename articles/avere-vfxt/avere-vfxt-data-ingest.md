...
* [Esempio di automazione parziale (msrsync)](#use-the-msrsync-utility-to-populate-cloud-volumes) 
...
## <a name="use-the-msrsync-utility-to-populate-cloud-volumes"></a>Usare l'utilità msrsync per popolare i volumi cloud
...
Si noti che ``msrsync`` può scrivere solo da e verso i volumi locali. L'origine e la destinazione devono essere accessibili montaggi locali nella rete virtuale del cluster.

Per usare msrsync per popolare un volume cloud di Azure con un cluster di Avere, seguire queste istruzioni:
