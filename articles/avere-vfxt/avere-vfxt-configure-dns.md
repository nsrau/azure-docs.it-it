...
Specificare il server DNS usato dal cluster vFXT nella **Cluster**  >  pagina delle impostazioni di**rete amministrativa** del cluster. Le impostazioni in questa pagina includono:
