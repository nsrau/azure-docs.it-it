<properties 
   pageTitle="Configurazione delle credenziali per l'autenticazione denominate"
	description="Configurazione delle credenziali per l'autenticazione denominate"
...
1. Per caricare il certificato nel portale di gestione, selezionare il collegamento **Portale di Azure**.

    Verrà aperto il portale di gestione.
...
1. Scegliere il servizio cloud desiderato. Viene visualizzata la pagina del servizio.
