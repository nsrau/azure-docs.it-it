...
Per aggiungere un'assegnazione di ruolo, usare [AZ Role Assignment create](/cli/azure/role/assignment#az-role-assignment-create), specificare `--assignee-object-id`un valore per e `--assignee-principal-type` quindi `ServicePrincipal`impostare su.
