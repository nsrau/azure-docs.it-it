...
- Informazioni su come [creare un ruolo personalizzato](custom-roles.md).
- [Ruoli RBAC incorporati](built-in-roles.md).
- Informazioni sulla gestione delle assegnazioni di accesso [per utente](role-assignments-users.md) o [per risorsa](role-assignments-portal.md) 
