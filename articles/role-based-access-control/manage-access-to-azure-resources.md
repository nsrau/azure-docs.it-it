...
|||
|---|---|
| [Relazione tra i tenant di Azure AD e le sottoscrizioni](rbac-and-directory-admin-roles.md) | Informazioni sui motivi per cui Azure AD è l'origine attendibile di utenti e gruppi per una sottoscrizione di Azure. |
| [Controllo degli accessi in base al ruolo](overview.md) | È possibile offrire la gestione granulare dell'accesso tramite i ruoli assegnati a utenti, gruppi o entità servizio. |
...
| [Identità del servizio gestito](../active-directory/pp/msi-overview.md) | È possibile concedere alle risorse di Azure, ad esempio alle macchine virtuali, un'identità specifica, in modo che non sia necessario inserire le credenziali nel codice. |
