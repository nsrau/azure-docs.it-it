...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-lboi"; width=55%>-È necessario abilitare la sicurezza dei dati avanzata nel database SQL<br>- È necessario correggere le vulnerabilità nelle immagini del Registro Azure Container<br>- È necessario correggere le vulnerabilità dei database SQL<br>- È necessario correggere le vulnerabilità tramite una soluzione di valutazione della vulnerabilità<br>-È necessario abilitare la valutazione della vulnerabilità in SQL Istanza gestita<br>- È necessario abilitare la valutazione della vulnerabilità nei server SQL<br>- È necessario installare una soluzione di valutazione della vulnerabilità nelle macchine virtuali</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-lboi"; width=55%>- È necessario abilitare lo standard di protezione DDoS</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-lboi"; width=55%>- È necessario designare al massimo tre proprietari per la sottoscrizione<br>- È necessario rimuovere dalla sottoscrizione gli account esterni con autorizzazioni di lettura<br>- È necessario abilitare l'autenticazione a più fattori negli account con autorizzazioni di lettura per la sottoscrizione<br>- È necessario limitare l'accesso agli account di archiviazione con configurazioni del firewall e di rete virtuale<br>- È necessario rimuovere tutte le regole di autorizzazione, ad eccezione di RootManageSharedAccessKey, dallo spazio dei nomi dell'hub eventi<br>- È necessario effettuare il provisioning di un amministratore di Azure Active Directory per i server SQL<br>- È necessario definire le regole di autorizzazione nell'istanza dell'hub eventi<br>- È necessario eseguire la migrazione degli account di archiviazione alle nuove risorse di Azure Resource Manager<br>- È necessario eseguire la migrazione delle macchine virtuali alle nuove risorse di Azure Resource Manager<br>-Le impostazioni avanzate di sicurezza dei dati per il database SQL devono contenere un indirizzo di posta elettronica per ricevere gli avvisi di sicurezza<br>- È necessario abilitare la sicurezza dei dati avanzata nelle istanze gestite<br>-Tutti i tipi di protezione avanzata dalle minacce devono essere abilitati in SQL Istanza gestita impostazioni avanzate di sicurezza dei dati<br>- È necessario abilitare le notifiche tramite posta elettronica agli amministratori e ai proprietari della sottoscrizione nelle impostazioni di Sicurezza dei dati avanzata di SQL Server<br>- È necessario impostare i tipi di protezione di Advanced Threat Protection su "Tutti" nelle impostazioni di Sicurezza dei dati avanzata di SQL Server<br>- È necessario associare le subnet a un gruppo di sicurezza di rete<br>-Tutti i tipi di protezione avanzata dalle minacce devono essere abilitati nel database SQL impostazioni avanzate di sicurezza dei dati per il server<br>- [Anteprima] È necessario abilitare Windows Exploit Guard <br>- [Anteprima] È necessario installare l'agente di configurazione guest<br>-Le macchine virtuali non con connessione Internet devono essere protette con i gruppi di sicurezza di rete</td>
  </tr>
</tbody>
</table>
