...
Per altre informazioni sull'Archiviazione di Azure e sui relativi account di archiviazione, vedere [Documentazione di Archiviazione](https://azure.microsoft.com/documentation/services/storage/) e [Informazioni sugli account di archiviazione di Azure](../storage/storage-create-storage-account.md).
