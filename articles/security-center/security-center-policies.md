...
3. Il pannello **Criteri di sicurezza** per la sottoscrizione viene aperto con un set di opzioni simile a quello indicato di seguito:
...
9. Nel pannello **Criteri di sicurezza** fare clic su **Attivo** per abilitare i suggerimenti per la sicurezza da usare per la sottoscrizione. Fare clic sull'opzione **Criteri di prevenzione**. Verrà aperto il pannello **Criteri di sicurezza**, come illustrato di seguito.
