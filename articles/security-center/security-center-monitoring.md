...
![Integrità delle risorse](./media/security-center-monitoring/security-center-monitoring-fig1-ga.png)
...
Il pannello **Aggiornamenti di sistema mancanti** visualizza una tabella con le informazioni seguenti:
