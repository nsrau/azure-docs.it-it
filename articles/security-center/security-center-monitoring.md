...
###Macchine virtuali
Quando si fa clic su **Macchine virtuali** nel riquadro **Integrità delle risorse**, si aprirà il pannello **Macchine virtuali** con ulteriori dettagli sulle operazioni di caricamento e prevenzione, nonché un elenco di tutte le macchine virtuali monitorate dal Centro sicurezza di Azure, come illustrato di seguito:
...
Ad esempio, se si fa clic su **Aggiornamenti di sistema mancanti** in **Procedura di prevenzione**, si aprirà il pannello **Aggiornamenti di sistema mancanti** con l'elenco delle macchine virtuali in cui mancano le patch e il livello di gravità per ciascuna di esse come illustrato di seguito:
...
Nella sezione dei dettagli sullo stato della rete, sono elencate le procedure di prevenzione, ad esempio [ACL sugli endpoint](virtual-machines-set-up-endpoints.md) non abilitati, [Gruppi di sicurezza di rete](virtual-networks-nsg.md) non abilitati e le subnet integre. È possibile fare clic su una di queste e visualizzare maggiori dettagli, nonché eseguire ulteriori azioni per risolvere il problema.
