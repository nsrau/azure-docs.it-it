---
title: Installare Endpoint Protection nel Centro sicurezza di Azure | Microsoft Docs
description: 'In questo documento è illustrato come implementare la raccomandazione '
;**installa: ''
endpoint: ''
protection**";: ''
del: ''
...
[Microsoft Antimalware](../security/azure-security-antimalware.md) è ora attivo nelle macchina virtuali selezionate.
