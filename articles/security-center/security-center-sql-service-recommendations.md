...
1. Nella sezione **igiene della sicurezza delle risorse** fare clic su **risorse di archiviazione e dati**.
    ...
    ![Risorse di archiviazione e dati](./media/security-center-monitoring/click-data.png)

    Verrà visualizzata la pagina **sicurezza dati** con le raccomandazioni per le risorse di dati.

    [Risorse di dati ![](./media/security-center-monitoring/sql-overview.png)](./media/security-center-monitoring/sql-overview.png#lightbox)
