...
* Attacchi basati sulla rete (questa funzionalità è disponibile solo nella [versione Standard](https://azure.microsoft.com/pricing/details/security-center/))
...
* Per informazioni relative al supporto dei sistemi operativi, vedere [Domande frequenti sul Centro sicurezza di Azure](faq-vms.md). 
...
Se si fa clic su questa raccomandazione, verranno visualizzati altri dettagli sulle azioni specifiche da eseguire per risolvere tali problemi. I dettagli saranno riportati nella sezione **Raccomandazioni** nella parte inferiore del pannello. 
