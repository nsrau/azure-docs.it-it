...
Informazioni su come usare le funzionalità del Centro sicurezza di Azure per gestire e rispondere agli avvisi di sicurezza usando questa procedura dettagliata.
...
## In che modo il Centro sicurezza di Azure gestisce gli avvisi di sicurezza?
...
- **Rilevamento attacco di forza bruta sui dati di rete**: questi rilevamenti sono basati su modelli di apprendimento automatico che apprendono dai dati del traffico di rete. 
...
- **Macchine virtuali che comunicano con indirizzi IP dannosi**: questi rilevamenti sono basati sull'individuazione di computer compromessi con bot che comunicano con i rispettivi server di comando e di controllo e viceversa. 

## Passaggi successivi
In questo documento è stato descritto come configurare i criteri di sicurezza nel Centro sicurezza di Azure. Per altre informazioni sul Centro sicurezza di Azure, vedere:
