...
Per altre informazioni sull'installazione e configurazione dell'agente, vedere [Connettere computer Windows al servizio Log Analytics in Azure](../azure-monitor/platform/agent-windows.md#install-agent-using-setup-wizard).
