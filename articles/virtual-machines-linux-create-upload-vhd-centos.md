<properties urlDisplayName="Upload a CentOS-based VHD" pageTitle="Creare e caricare un VHD Linux basato su CentOS in Azure" metaKeywords="Azure VHD, uploading Linux VHD, CentOS" description="Come creare e caricare un disco rigido virtuale Azure (VHD) che contiene un sistema operativo Linux basato su CentOS." metaCanonical="" services="virtual-machines" documentationCenter="" title="Creazione e caricamento di un disco rigido virtuale che contiene un sistema operativo Linux basato su CentOS" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
-   [Preparare una macchina virtuale CentOS 6.x per Azure][Preparare una macchina virtuale CentOS 6.x per Azure]
-   [Preparare una macchina virtuale CentOS 7.0+ per Azure][Preparare una macchina virtuale CentOS 7.0+ per Azure]

## Prerequisiti

In questo articolo si presuppone che l'utente abbia già installato un sistema operativo Linux CentOS (o un sistema derivato simile) in un disco rigido virtuale. Sono disponibili vari strumenti per la creazione di file .vhd, ad esempio una soluzione di virtualizzazione come Hyper-V. Per istruzioni, vedere [Installare il ruolo Hyper-V e configurare una macchina virtuale][Installare il ruolo Hyper-V e configurare una macchina virtuale].
...
8.  **Solo CentOS 6.3**: installare i driver per Linux Integration Services.
    ...
    **Importante: questo passaggio è valido solo per CentOS 6.3 e versioni precedenti.** In CentOS 6.4+ Linux Integration Services è *già disponibile nel kernel*.
    ...
    a) Scaricare il file ISO contenente i driver per Linux Integration Services dall'[Area download Microsoft][Area download Microsoft].
...
16. Fare clic su **Azione -\> Arresta** nella console di gestione di Hyper-V. Il file VHD Linux è ora pronto per il caricamento in Azure.
  ...
  [Area download Microsoft]: http://www.microsoft.com/it-it/download/details.aspx?id=41554
