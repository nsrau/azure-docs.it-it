...
-	Derivare metriche per quattro categorie fondamentali:
	...
	-	**Dati commerciali e competitivi**. Ottenere tutte le informazioni possibili in merito al cliente (possono essere non disponibili o difficili da tracciare).
...
Un'altra entusiasmante funzionalità in Cloud ML di Azure è la possibilità di aggiungere un modulo personalizzato nell'archivio dei moduli predefiniti già disponibili. Essenzialmente, tale capacità consente di creare un'opportunità per selezionare raccolte e creare modelli per mercati verticali. Si tratta di un importante elemento di differenziazione per Cloud ML di Azure nel mercato.  
