<properties urlDisplayName="Web App with Blob Storage" pageTitle="App Web Python con archiviazione tabelle | Microsoft Azure" metaKeywords="Azure table storage Python, Azure Python application, Azure Python tutorial, Azure Python example" description="Un'esercitazione che spiega come creare un'applicazione Web Python usando le librerie client di Azure. Verr&agrave; usato Django come framework Web." metaCanonical="" services="storage" documentationCenter="Python" title="Applicazione Web Python con Archiviazione tabelle" authors="huvalo" solutions="" videoId="" scriptId="" manager="wpickett" editor="mollybos" />
...
In questa esercitazione si apprenderà come creare un'applicazione che usa Archiviazione tabelle con le librerie client di Azure per Python. Se questa è la prima applicazione Azure per Python è consigliabile consultare prima l'articolo [Applicazione Web Hello World Django][Applicazione Web Hello World Django].

Per questa guida verrà creata un'applicazione elenco di attività basata sul Web che sarà possibile distribuire in Azure. L'elenco di attività consente a un utente di recuperare le attività, aggiungerne di nuove e contrassegnarle come completate. Verrà usato Django come framework Web.
...
-   Usare il servizio di archiviazione tabelle di Azure
...
*Nota per Windows*: se è stato usato il programma di installazione WebPI di Windows sono stati già installati Django e le librerie client.
