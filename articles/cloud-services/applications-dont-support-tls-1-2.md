...
Usare il codice seguente come esempio per creare uno script che Abilita i protocolli e i pacchetti di crittografia precedenti.   Ai fini di questa documentazione, questo script verrà denominato: TLSsettings. ps1. 
  
```Powershell
...
Creare un file CMD con le informazioni seguenti. 
...
## <a name="step-4-validation"></a>Passaggio 4: convalida 
