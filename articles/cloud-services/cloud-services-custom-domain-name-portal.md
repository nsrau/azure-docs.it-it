...
> [!NOTE]
> Un visitatore del **www\.contoso.com** non vedranno mai l'host reale (contoso.cloudapp.net), in modo che il processo di inoltro è invisibile all'utente finale.
> 
