---
title: Recapito continuo con Visual Studio Team Services in Azure | Microsoft Docs
...
2. Nella procedura guidata digitare il nome del proprio account di Visual Studio Team Services nella casella di testo e fare clic sul collegamento **Autorizza ora**. È possibile che venga richiesto di effettuare l'accesso.
    ...
    ![][11]
3. Nella finestra di dialogo popup **Richiesta di connessione** scegliere il pulsante per **Accetta** per autorizzare Azure a configurare il progetto team in VS Team Services.
...
2. Passare al file della soluzione e aprirlo.
    ...
    ![][16]
3. In **Esplora soluzioni** aprire un file e modificarlo. Ad esempio, modificare il file `_Layout.cshtml` nella cartella Views\\Shared in un ruolo Web MVC.
