...
ms.locfileid: "60337324"
---
# <a name="deployment-issues-for-azure-cloud-services-frequently-asked-questions-faqs"></a>Problemi di distribuzione per servizi Cloud di Azure: Domande frequenti (FAQ)
...
Per informazioni su come mitigare gli errori di allocazione, vedere [errori di allocazione del servizio Cloud: Soluzioni](cloud-services-allocation-failures.md#solutions).
...
È anche possibile rilevare l'utilizzo o della quota corrente per la sottoscrizione nel portale di: Portale di Azure = > sottoscrizioni = > \<sottoscrizione appropriata > = > "Utilizzo + quote".
