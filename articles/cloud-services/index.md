        ...
        <div class="cardSize"><p />
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Lingue</h3>
                        <p><a href="https://msdn.microsoft.com/library/azure/ee758711">XML Schema CSDEF</a></p>
                        <p><a href="https://msdn.microsoft.com/library/azure/ee758710">XML Schema CSCFG</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="downloadHolder">
    <a href="https://opbuildstorageprod.blob.core.windows.net/output-pdf-files/en-us/Azure.azure-documents/live/cloud-services.pdf">
        <div class="img"></div>
        <div class="text">
Scaricare la documentazione di Servizi cloud </div>
    </a>
</div>
