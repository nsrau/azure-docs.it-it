---
title: Distribuire le associazioni per l'applicazione gestita di Azure usando i criteri
...
![Assegnare i criteri predefiniti](media/builtin-policy/assign-builtin-policy-managedapp.png)
