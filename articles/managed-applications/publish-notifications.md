...
PATCH | Operazione riuscita | Dopo la corretta correzione dell'istanza dell'applicazione gestita per aggiornare i tag, i criteri di accesso JIT o l'identità gestita.
