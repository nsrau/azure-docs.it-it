...
> [!NOTE]
> Se si vuole imparare a creare un'app Web ma non è necessario farlo in un ambiente del servizio app, vedere [Creare un'app Web .NET](web-sites-dotnet-get-started.md) o una delle esercitazioni correlate per altri linguaggi e framework.
> 
> 
...
## <a name="a-namecreateplana-create-an-app-service-plan"></a><a name="createplan"></a> Creare un piano di servizio app
