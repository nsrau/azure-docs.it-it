...
Una volta inizializzata app web Java in [servizio App Azure][servizio App Azure] come descritto in [creare un'applicazione web Java nel servizio di Azure App](web-sites-java-get-started.md), è possibile caricare l'applicazione inserendo il file WAR nel **webapps** cartella.
