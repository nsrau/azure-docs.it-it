---
title: Creazione e uso di un servizio di bilanciamento del carico interno con un ambiente del servizio app | Microsoft Docs
...
Se si vuole testare l'accesso HTTP e HTTPS per l'ambiente del servizio app:
