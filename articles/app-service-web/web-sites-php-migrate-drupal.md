...
Se si usa FTP, ottenere il nome host e il nome utente per FTP dal pannello dell'app Web nel [portale di anteprima di Azure](https://portal.azure.com). Utilizzare quindi un client FTP per caricare i file di Drupal nella cartella **/site/wwwroot** del sito remoto.
...
- [App Web del servizio app di Azure, una prospettiva PHP][]
- [Confronto tra servizio app di Azure, servizi cloud e macchine virtuali][]
- [Configurazione di PHP in App Web del servizio app di Azure con file con estensione user.ini][]
...
* Per una guida relativa al passaggio dal portale precedente al portale di anteprima, vedere [Informazioni di riferimento per l'esplorazione del portale di anteprima](http://go.microsoft.com/fwlink/?LinkId=529715)
  ...
  [App Web del servizio app di Azure, una prospettiva PHP]: http://blogs.msdn.com/b/silverlining/archive/2012/06/12/windows-azure-websites-a-php-perspective.aspx
  [Confronto tra servizio app di Azure, servizi cloud e macchine virtuali]: http://go.microsoft.com/fwlink/?LinkId=310123
  [Configurazione di PHP in App Web del servizio app di Azure con file con estensione user.ini]: http://blogs.msdn.com/b/silverlining/archive/2012/07/10/configuring-php-in-windows-azure-websites-with-user-ini-files.aspx
