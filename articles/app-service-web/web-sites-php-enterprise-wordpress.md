<properties
	pageTitle="WordPress di livello aziendale nel servizio app di Azure"
...
Per | Opzione
------------- | -----------
**Impostare la modalità del piano e le dimensioni del servizio app e abilitare la scalabilità** | [Scalare un'app Web nel servizio app di Azure][websitescale]
