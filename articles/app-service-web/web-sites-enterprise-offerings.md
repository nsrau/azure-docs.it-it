...
ms.openlocfilehash: 8cfe5c397c5e89dd9fdef792c7494775ee35f7f5
...
#### <a name="items-to-consider"></a>Elementi da considerare ###
...
### <a name="alternatives-to-using-azure-sql-database"></a>Alternative all'utilizzo del Database SQL di Azure ###
La piattaforma Azure offre diverse alternative all'uso di Database SQL di Azure come database primario delle applicazioni Web per abilitare carichi di lavoro differenti, ad esempio l'uso di una soluzione NoSQL, o per abilitare la piattaforma in modo da adattarsi alle esigenze dei dati aziendali. Ad esempio, un'azienda può contenere dati che non devono essere archiviati fuori sede o in un ambiente cloud pubblico e pertanto sarebbe per mantenere l'utilizzo dei propri database locale.

#### <a name="connectivity-to-on-premises-resources"></a>Connettività alle risorse locali ###
