...
Utilizzo di un ambiente del servizio app: ![](./media/web-sites-enterprise-offerings/on-premise-connectivity-solutions-ASE.png "Utilizzo di un ambiente del servizio app")
