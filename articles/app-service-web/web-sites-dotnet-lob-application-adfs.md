...
3.	Aprire la soluzione, quindi aprire Controllers\AccountController.cs in **Esplora soluzioni**.
...
11.	Incollare il seguente linguaggio di ruolo nella casella **Custom rule**, denominare il ruolo **Per Session Identifier** e fare clic su **Finish**.  
	<pre class="prettyprint">
