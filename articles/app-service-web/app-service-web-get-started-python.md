<properties 
	pageTitle="Distribuire la prima app Web Python in Azure in cinque minuti | Microsoft Azure" 
...
1. Nel terminale della riga di comando passare a una directory di lavoro (`CD`) e clonare l'app di esempio come segue:
    ...
    ![Clonare il codice dell'app di esempio per la prima app Web in Azure](./media/app-service-web-get-started-languages/python-git-clone.png)
