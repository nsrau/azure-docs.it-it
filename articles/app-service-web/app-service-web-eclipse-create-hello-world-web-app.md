...
1. Dal menu di scelta rapida selezionare **Azure**, quindi fare clic su **Publish as Azure Web App** (Pubblica come App Web di Azure).
    ...
    ![Pubblicare come app Web di Azure][03]
    ...
    ![Pubblicare come app Web di Azure][14]
