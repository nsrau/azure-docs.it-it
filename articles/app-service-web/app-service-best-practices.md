...
## <a name="a-namecolocationacolocation"></a><a name="colocation"></a>Condivisione dell'area
...
## <a name="a-namememoryresourcesawhen-apps-consume-more-memory-than-expected"></a><a name="memoryresources"></a>Quando le app usano più memoria del previsto
...
## <a name="a-namecpuresourcesawhen-apps-consume-more-cpu-than-expected"></a><a name="CPUresources"></a>Quando le app usano più CPU del previsto
...
## <a name="a-namesocketresourcesawhen-socket-resources-are-exhausted"></a><a name="socketresources"></a>Quando si esauriscono le risorse socket
...
## <a name="a-nameappbackupawhen-your-app-backup-starts-failing"></a><a name="appbackup"></a>Quando il backup dell'applicazione non viene più eseguito
