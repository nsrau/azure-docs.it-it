...
Inoltre, Azure App Service dispone di una nuova funzionalità di anteprima per le API REST: app per le API. Per altre informazioni sulle app per le API, vedere [Informazioni sulle app per le API](../app-service-api/app-service-api-apps-why-best-platform.md).
...
Per altre informazioni sulle tre opzioni di hosting Web, vedere [Introduzione ad Azure](../fundamentals-introduction-to-azure.md).
