<properties 
	pageTitle="Eseguire il backup dell'app in Azure" 
...
2. Nel [portale di Azure](https://portal.azure.com) passare al pannello dell'app, selezionare **Impostazioni**, quindi **Backup**. Viene visualizzato il pannello **Backup**.
	
	![Pagina Backups][ChooseBackupsPage]

	>[AZURE.NOTE] Se viene visualizzato il messaggio seguente, fare clic per aggiornare il piano di servizio app prima di procedere con i backup. Per altre informazioni, vedere [Scalare un'app Web in Servizio app di Azure](web-sites-scale.md). ![Scelta dell'account di archiviazione](./media/web-sites-backup/01UpgradePlan.png)
