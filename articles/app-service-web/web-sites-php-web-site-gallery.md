---
title: Creare un'app web WordPress nel servizio App Azure | Microsoft Docs
...
3. Nel pannello dell'app Web fare clic su **Sfoglia**.
    ...
    ![URL sito][browse]
4. Nella pagina **iniziale** di WordPress immettere le informazioni di configurazione richieste da WordPress, quindi fare clic su **Install WordPress**.
