---
title: Come creare un ambiente del servizio app
...
### <a name="creating-an-app-service-environment"></a>Creazione di un ambiente del servizio app
È possibile accedere all'interfaccia utente di creazione dell'ambiente del servizio app in due modi.  Per trovarla, cercare ***Ambiente del servizio app*** in Azure Marketplace oppure scegliere Nuovo -> Web e dispositivi mobili -> Ambiente del servizio app.  Per creare un ambiente del servizio app:
...
### <a name="after-app-service-environment-creation"></a>Dopo la creazione dell'ambiente del servizio app
...
Per altre informazioni sulla scalabilità manuale, sulla gestione e sul monitoraggio degli ambienti del servizio app, vedere [Come configurare un ambiente del servizio app][ASEConfig] 

Per informazioni sulla scalabilità automatica, vedere [Come configurare la scalabilità automatica per un ambiente del servizio app][ASEAutoscale]
