...
- [Interfaccia della riga di comando di Azure 2.0](app-service-web-get-started-php.md): interfaccia della riga di comando di prossima generazione per il modello di distribuzione di Gestione risorsa
