...
3. Aprire config/config.js e cambiare la porta di produzione impostandola su `process.env.port`. L'oggetto JSON di produzione dovrebbe essere simile al seguente:
