<properties 
	pageTitle="Eseguire attività in background con processi Web" 
...
2. In **Name** indicare un nome per il processo Web. Il nome deve iniziare con una lettera o un numero e non può contenere caratteri speciali diversi da "-" e "_".
...
3. Nella finestra di dialogo **Crea processo** scegliere il tipo di **Ricorrenza** desiderata: **Processo con singola occorrenza** o **Processo ricorrente**.
	
	![Pianificare la ricorrenza][SchdRecurrence]
	
4. Scegliere un'ora di **inizio**: **Ora** o **A un orario specifico**.
...
11. Dopo avere creato uno o più processi, i relativi nomi verranno visualizzati nella scheda WebJobs insieme a stato, tipo di pianificazione e altre informazioni. Vengono mantenute le informazioni cronologiche sugli ultimi 30 processi Web.
