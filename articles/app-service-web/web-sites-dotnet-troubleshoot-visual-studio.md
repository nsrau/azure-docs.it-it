...
6. Nell'elenco a discesa **Profilo** selezionare il nome del profilo utilizzato in [Introduzione ad Azure e ASP.NET][GetStarted].
...
2. Impostare l'opzione **Application Logging (File System)** su **Verbose**, quindi fare clic su **Save**.
...
6. Nel scheda **Configure** del portale classico scorrere verso il basso fino alla sezione di diagnostica applicazioni, quindi impostare **Application Logging (Archiviazione tabelle)** su **On**.
7. Impostare **Logging Level** su **Information**.
...
4. Nel pannello **Impostazioni** del [portale di Azure](https://portal.azure.com) per l'app Web fare clic su **Credenziali per la distribuzione** e quindi immettere un nuovo nome utente e una nuova password.
