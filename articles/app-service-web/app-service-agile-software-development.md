...
5. Quando richiesto, digitare il nome utente e la password desiderati per l'accesso al database.
   ...
   > [!TIP]
   > Esaminare *&lt;radice\_repository>*\\ARMTemplates\\Deploy.ps1, per osservare come le risorse vengano generate con ID univoci. È possibile usare lo stesso approccio per creare cloni della stessa distribuzione senza doversi preoccupare dei conflitti tra i nomi di risorse.
   > 
   > 
