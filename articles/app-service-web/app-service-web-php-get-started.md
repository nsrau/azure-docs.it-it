...
>[AZURE.NOTE] Verificare il funzionamento di un'app Web. [provare il servizio app](http://go.microsoft.com/fwlink/?LinkId=523751) immediatamente e creare un'app iniziale temporanea, senza necessità di fornire una carta di credito e senza impegni.
...
4. A partire dal menu a sinistra, fare clic su **Servizi app** > **&lt;nome_app >** > **Strumenti**.

    ![Abilitare Composer per l'app PHP (Laravel) in Azure](./media/app-service-web-php-get-started/configure-composer-tools.png)
    
    >[AZURE.TIP] Se si fa clic su **Impostazioni** anziché su **Strumenti**, sarà possibile accedere al pannello **Impostazioni applicazione** 
...
4. Selezionare **Composer** nel pannello [blade](../azure-portal-overview.md) **Scegli estensione** (*pannello*: una pagina del portale visualizzata in orizzontale).
