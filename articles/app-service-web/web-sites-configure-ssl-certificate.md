...
8. Selezionare **Scambio informazioni personali - PKCS #12**, **Se possibile, includi tutti i certificati nel percorso certificazione** ed **Esporta tutte le proprietà estese**. Quindi fare clic su **Avanti**.
...
4. Fare clic con il pulsante destro del mouse sul certificato e scegliere **Tutte le attività** > **Esporta**. In **Esportazione guidata certificati** fare clic su **Avanti**, quindi selezionare **Sì, Esporta la chiave privata** e fare di nuovo clic su **Avanti**.
    ...
    ![Esportazione della chiave privata][certwiz1]
5. Selezionare **Scambio informazioni personali - PKCS #12**, **Se possibile, includi tutti i certificati nel percorso certificazione** ed **Esporta tutte le proprietà estese**. Quindi fare clic su **Avanti**.
...
## Passaggio 4. Testare HTTPS per il dominio personalizzato
