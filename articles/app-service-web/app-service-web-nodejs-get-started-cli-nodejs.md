---
title: Introduzione alle app Web Node.js nel servizio app di Azure | Documentazione Microsoft
...
---
# <a name="get-started-with-nodejs-web-apps-in-azure-app-service"></a>Introduzione alle app Web Node.js nel servizio app di Azure
...
- [Interfaccia della riga di comando di Azure 2.0](app-service-web-nodejs-get-started.md): l'interfaccia della riga di comando di nuova generazione per il modello di distribuzione di gestione delle risorse
...
## <a name="create-and-deploy-a-simple-nodejs-web-app"></a>Creare e distribuire una semplice app Web Node.js
...
4. Passare alla modalità ASM e accedere ad Azure (è necessaria l' [interfaccia della riga di comando di Azure](#prereq)):
...
5. Verificare di essere ancora nella directory radice dell'app e quindi con il comando successivo creare la risorsa dell'app del servizio app con un nome di app univoco. Ad esempio: http://{appname}.azurewebsites.net
   
        azure site create --git {appname}
   
    Seguire le istruzioni e selezionare un'area di Azure in cui eseguire la distribuzione. 
...
8. Salvare le modifiche e usare Git per distribuire l'app in Azure. Quando richiesto, usare le credenziali utente create in precedenza.
