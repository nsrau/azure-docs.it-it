...
2. Nella parte inferiore del riquadro di spostamento fare clic su **NUOVO**, **Dati + archiviazione** > **Database SQL**.
...
6. Nel pannello **Impostazioni firewall ** aggiungere una regola firewall con **IP INIZIALE** e **IP FINALE** impostati sull'indirizzo IP pubblico del computer di sviluppo. Fare clic su **Salva**.
