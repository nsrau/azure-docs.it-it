...
3. Fare clic sul pulsante **Installa strumento** per installare Migration Assistant di App Web nel computer.
   ...
   > 
   > 
4. Nella schermata **Installazione applicazione**, fare clic su **Installa** per avviare l'installazione nel computer. Verranno installate anche le dipendenze corrispondenti come distribuzione Web, DacFX e IIS, se necessario.
...
6. La seguente screenshot mostra tre siti Web: **sito Web predefinito**, **TimeTracker** e **CommerceNet4**. A tutti e tre è associato un database di cui si vuole eseguire la migrazione. Selezionare tutti i siti che si voglio valutare, quindi fare clic su **Avanti**.
