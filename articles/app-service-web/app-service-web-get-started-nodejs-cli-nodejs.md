---
title: Distribuire un&quot;app Web Node.js in Azure in cinque minuti | Microsoft Azure
...
- [Interfaccia della riga di comando di Azure 2.0](app-service-web-get-started-nodejs.md): interfaccia della riga di comando di prossima generazione per il modello di distribuzione di Gestione risorsa
...
4. Passare alla directory di lavoro `CD` e clonare l'app di esempio Node.js come segue:
...
6. Creare la risorsa app del servizio app in Azure con un nome app univoco e l'utente della distribuzione configurato prima. Quando richiesto, specificare il numero dell'area desiderata.
    ...
    ![Creare la risorsa di Azure per la prima app Web in Azure](./media/app-service-web-get-started-languages/node-site-create.png)
...
[Creare, configurare e distribuire un'app Web Node.js Express in Azure](app-service-web-nodejs-get-started-cli-nodejs.md). Seguendo questa esercitazione è possibile acquisire le competenze di base necessarie per eseguire qualsiasi app Web Node.js in Azure, ad esempio:
