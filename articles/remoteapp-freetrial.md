...
<properties 
    ...
    description="Controllare la versione di valutazione gratuita di 30 giorni per RemoteApp." 
    services="remoteapp" 
...
Se si ha una sottoscrizione di Azure, è possibile provare gratuitamente RemoteApp per 30 giorni. Per iniziare, è sufficiente accedere al portale di gestione di Azure, passare al nodo RemoteApp e creare una raccolta. Si tratta di un modo eccellente per provare tutte le funzionalità amministrative prima di effettuare la conversione a una sottoscrizione a pagamento di Azure RemoteApp.  
