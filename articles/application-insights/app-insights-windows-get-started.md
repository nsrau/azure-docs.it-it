<properties
	pageTitle="Analisi per app di Windows Phone e Windows Store"
...
È anche possibile usare [Application Insights per app per Windows Desktop](app-insights-windows-desktop.md).
