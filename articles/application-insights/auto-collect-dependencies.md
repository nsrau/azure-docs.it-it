...
- Impostare il rilevamento personalizzato delle dipendenze per [.NET](app-insights-asp-net-dependencies.md).
- Impostare il rilevamento personalizzato delle dipendenze per [Java](app-insights-java-agent.md).
