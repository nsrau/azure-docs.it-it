...
![Screenshot di spostamento nelle cartelle di lavoro](./media/app-insights-usage-workbooks/001-workbooks.png)
...
![Screenshot della raccolta di cartelle di lavoro](./media/app-insights-usage-workbooks/002-workbook-gallery.png)

Si inizierà con il **Modello predefinito**, che si trova sotto l'intestazione **Avvio rapido**.

![Screenshot della raccolta di cartelle di lavoro](./media/app-insights-usage-workbooks/003-default-template.png)
...
![Controlli di modifica delle sezioni delle cartelle di controllo di Application Insights](./media/app-insights-usage-workbooks/editing-controls-new.png)
...
![Sezione di query nelle cartelle di lavoro](./media/app-insights-usage-workbooks/analytics-section-new.png)
...
Per eseguire il pull dei dati da un'area di lavoro di Log Analytics esterna, usare l'identificatore **workspace**.
...
Ogni sezione ha impostazioni avanzate specifiche, accessibili tramite l'icona delle impostazioni ![Controlli di modifica delle sezioni delle cartelle di lavoro di Application Insights](./media/app-insights-usage-workbooks/005-settings.png) che si trova a destra del pulsante **Aggiungi parametri**.

![Controlli di modifica delle sezioni delle cartelle di controllo di Application Insights](./media/app-insights-usage-workbooks/0006-settings-expanded.png)
...
![Controlli di modifica delle sezioni delle cartelle di controllo di Application Insights](./media/app-insights-usage-workbooks/003-active-users.png)
...
![Controlli di modifica delle sezioni delle cartelle di controllo di Application Insights](./media/app-insights-usage-workbooks/004-active-users-trend.png)
...
![Controlli di modifica delle sezioni delle cartelle di controllo di Application Insights](./media/app-insights-usage-workbooks/007-settings-export.png)
...
![Controlli di modifica delle sezioni delle cartelle di controllo di Application Insights](./media/app-insights-usage-workbooks/008-metrics-grid.png)
...
![Controlli di modifica delle sezioni delle cartelle di controllo di Application Insights](./media/app-insights-usage-workbooks/009-time-range.png)

Verrà avviata la voce di menu Modifica parametro:

![Controlli di modifica delle sezioni delle cartelle di controllo di Application Insights](./media/app-insights-usage-workbooks/010-time-range-edit.png)
...
![Controlli di modifica delle sezioni delle cartelle di controllo di Application Insights](./media/app-insights-usage-workbooks/011-data-table.png)
...
![Elenco a discesa dei paesi](./media/app-insights-usage-workbooks/012-country-dropdown.png)
...
![Elenco a discesa dei paesi](./media/app-insights-usage-workbooks/013-resource-picker.png)
