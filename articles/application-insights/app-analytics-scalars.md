...
Le espressioni scalari differiscono dalle [query](app-analytics-queries.md) i cui risultati sono tabelle.
...
* *roundTo:* dimensioni del contenitore. Numero, data o intervallo di tempo per cui viene diviso *value*. 
...
* `rand(n)` - intero compreso tra 0 e n-1
...
Recupera una corrispondenza di un'[espressione regolare](app-analytics-reference.md#regular-expressions) da una stringa di testo. Facoltativamente, converte la sottostringa estratta nel tipo indicato.
...
* *regex:* [espressione regolare](app-analytics-reference.md#regular-expressions).
