...
![Individuare la risorsa dell'applicazione in portal.azure.com](./media/app-insights-web-track-usage-custom-events-metrics/01-custom.png)
...
![Selezionare il grafico e impostare Raggruppamento](./media/app-insights-web-track-usage-custom-events-metrics/02-segment.png)

Nell'elenco sotto il grafico selezionare un nome evento. Fare clic per visualizzare le singole occorrenze dell'evento.

![Eseguire il drill-through degli eventi](./media/app-insights-web-track-usage-custom-events-metrics/03-instances.png)
...
![Aprire Esplora metrica, selezionare il grafico e selezionare la metrica](./media/app-insights-web-track-usage-custom-events-metrics/03-track-custom.png)
...
![Impostare Raggruppamento e quindi selezionare la proprietà in Raggruppa per](./media/app-insights-web-track-usage-custom-events-metrics/04-segment-metric-event.png)
...
![Selezionare un'istanza e quindi scegliere '...'](./media/app-insights-web-track-usage-custom-events-metrics/appinsights-23-customevents-4.png)


Usare il campo Ricerca per visualizzare le occorrenze di eventi con un valore della proprietà particolare.


![Digitare un termine in Ricerca](./media/app-insights-web-track-usage-custom-events-metrics/appinsights-23-customevents-5.png)
...
![Aggiungere un nuovo grafico o selezionare un grafico e selezionare le metriche in Personalizzato](./media/app-insights-web-track-usage-custom-events-metrics/03-track-custom.png)
...
![Utilizzo di filtri nel pannello Panoramica](./media/app-insights-web-track-usage-custom-events-metrics/appinsights-47usage-2.png)
