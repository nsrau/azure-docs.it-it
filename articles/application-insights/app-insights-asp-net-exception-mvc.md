...
![Selezionare gli errori](./media/app-insights-asp-net-exception-mvc/012-start.png)
...
![Selezionare un'istanza di una richiesta non riuscita e nei dettagli dell'eccezione visualizzare le istanze dell'eccezione.](./media/app-insights-asp-net-exception-mvc/030-req-drill.png)
...
![Eseguire il drill-through](./media/app-insights-asp-net-exception-mvc/040-exception-drill.png)
...
![Eseguire il drill-through](./media/app-insights-asp-net-exception-mvc/050-exception-properties.png)
...
![Eseguire il drill-through](./media/app-insights-asp-net-exception-mvc/viewCustomEvents.png)
...
![Eseguire il drill-through](./media/app-insights-asp-net-exception-mvc/060-req-related.png)
