---
title: Annotazioni sulla versione per Application Insights | Microsoft Docs
...
5. Nel Pannello di accesso all'API, creare una nuova chiave API e richiedere una copia.
