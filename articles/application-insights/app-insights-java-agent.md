...
Nella risorsa di Application Insights verranno visualizzate le dipendenze remote aggregate e i tempi di esecuzione dei metodi nel [riquadro Prestazioni][metrics].
