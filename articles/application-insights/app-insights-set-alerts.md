...
![Nel pannello Regole avvisi scegliere Aggiungi avviso. Impostare l'app come risorsa per misurare, specificare un nome per l'avviso e scegliere una metrica.](./media/app-insights-set-alerts/01-set-metric.png)
...
![Nella parte inferiore del pannello Panoramica fare clic su 'Eventi nell'ultima settimana'](./media/app-insights-set-alerts/09-alerts.png)
