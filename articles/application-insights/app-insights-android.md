...
Usare [Application Insights SDK per Android](https://github.com/Microsoft/ApplicationInsights-Android) per l'analisi di utilizzo. Se l'app ha un lato server, è possibile inviare i dati client e server alla stessa risorsa di Application Insights.

* [Introduzione ad Application Insights per Android](https://github.com/Microsoft/ApplicationInsights-Android).
