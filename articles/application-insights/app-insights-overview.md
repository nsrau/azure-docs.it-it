...
* **[Analizzare l'utilizzo di app per dispositivi mobili](app-insights-mobile-center-quickstart.md)** tramite l'integrazione con Visual Studio Mobile Center.
