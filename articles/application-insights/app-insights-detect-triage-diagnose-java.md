<properties
	pageTitle="Rilevare, valutare e diagnosticare le app web di J2EE"
	description="Analizzare gli arresti anomali e rilevare e diagnosticare i problemi di prestazioni nelle applicazioni web Java."
...
# Rilevare, valutare e diagnosticare le app J2EE con Application Insights
...
![Rilevare-Valutare-Diagnosticare](./media/app-insights-detect-triage-diagnose-java/01-pipe1.png)
...
![Ripristinare-Convalidare](./media/app-insights-detect-triage-diagnose-java/02-pipe2.png)


Ora verrà descritto come funziona Application Insights in ogni fase della pipeline.

Application Insights funziona per le app di dispositivi e le applicazioni Web. In questa procedura dettagliata, verrà illustrata in dettaglio su un'applicazione Web. Verrà descritto il team OBS nella banca Fabrikam, responsabile del sistema bancario online. Hanno [aggiunto Application Insights ai progetti Web](app-insights-java-get-started.md).


![Sito Web di una banca di esempio](./media/app-insights-detect-triage-diagnose-java/03-bank.png)
...
![Visualizzazione dei test Web eseguiti nel periodo precedente](./media/app-insights-detect-triage-diagnose-java/04-webtests.png)
...
![Alcuni criteri di misurazione](./media/app-insights-detect-triage-diagnose-java/05-perfMetrics.png)
...
![Grafico dei tempi di risposta e griglia dei tempi di risposta del server.](./media/app-insights-detect-triage-diagnose-java/09-dependencies.png)
...
Sono inoltre disponibili i grafici per le dipendenze, i contatori delle prestazioni, le eccezioni, i dati sull'utilizzo e molte altre metriche ed eventi.
...
Con gli avvisi di disponibilità si avrà la sicurezza di venire informati sulle situazioni insolite non appena si verificano.
...
![Pannello Aggiungi avviso](./media/app-insights-detect-triage-diagnose-java/07-alerts.png)
...
Le eccezioni non rilevate vengono segnalate automaticamente ad Application Insights.


Inoltre, è possibile inviare i report delle eccezioni che si intercettano inserendo le chiamate a [trackException()](app-insights-api-custom-events-metrics.md#track-exception) nel gestore:
...
Di solito collegano le proprietà che potrebbero essere utili nella diagnosi.
...
![In Ricerca diagnostica usare i filtri per visualizzare determinati tipi di dati](./media/app-insights-detect-triage-diagnose-java/appinsights-333facets.png)
...
![Grafici delle sessioni e richieste non riuscite](./media/app-insights-detect-triage-diagnose-java/10-failureRate.png)
...
![Grafici degli errori di dipendenza e delle chiamate di durata alle dipendenze](./media/app-insights-detect-triage-diagnose-java/11-dependencies.png)
...
Qualunque sia il motivo, i dati consentono al team di valutare l'attività degli utenti. Si possono inserire più chiamate di rilevamento per scoprire ulteriori dettagli. Si può utilizzare trackEvent() per contare tutte le azioni utente, dai piccoli dettagli come i singoli clic sui pulsanti, ai risultati più significativi come il pagamento di un prestito.
