...
description: Questa esercitazione illustra come disimballare il dispositivo Azure Data Box Disk, connettersi ai dischi, ottenere la passkey e sbloccare i dischi nei client Windows e Linux.
services: databox
author: alkohli
ms.service: databox
ms.subservice: disk
...
2. Nel portale di Azure passare all'ordine di Data Box Disk. Per cercarlo, passare a **Generale > Tutte le risorse**, quindi selezionare l'ordine di Data Box Disk. Fare clic sull'icona di copia per copiare la passkey. Questa passkey verrà usata per sbloccare i dischi.
...
1. Nel portale di Azure passare all'ordine di Data Box Disk. Per cercarlo, passare a **Generale > Tutte le risorse**, quindi selezionare l'ordine di Data Box Disk.
...
8. Dopo aver sbloccato il disco, è possibile passare al punto di montaggio e visualizzare il contenuto del disco. Ora si è pronti per copiare i dati nelle cartelle *BlockBlob* o *PageBlob*. 
    ...
    ![Contenuto del Data Box Disk - 2](media/data-box-disk-deploy-set-up/data-box-disk-content-linux.png)
