...
description: Questa esercitazione fornisce informazioni su Azure Data Box Heavy, una soluzione ibrida che consente di importare dati locali in Azure, e illustra come ordinare il dispositivo Data Box Heavy.
services: databox
author: alkohli
ms.service: databox
ms.subservice: heavy
