...
description: Questa esercitazione illustra le operazioni da eseguire per restituire il dispositivo Azure Data Box Heavy, tra cui la preparazione per la spedizione, la spedizione del dispositivo, la verifica del caricamento dei dati e la cancellazione dei dati.
services: databox
author: alkohli
ms.service: databox
ms.subservice: heavy
