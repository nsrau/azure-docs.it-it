...
- [Data Box Heavy](https://docs.microsoft.com/azure/databox/data-box-heavy-overview) con 770 TB di capacità utilizzabile per ordine per set di dati grandi. Data Box Heavy è attualmente disponibile in anteprima.
