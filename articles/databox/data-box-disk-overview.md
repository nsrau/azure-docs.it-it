...
Per informazioni sulla disponibilità a livello di area, vedere [Prodotti Azure disponibili in base all'area](https://azure.microsoft.com/global-infrastructure/services/?products=databox&regions=all).
