...
description: Questa esercitazione illustra come cablare il dispositivo Azure Data Box Heavy, nonché connettersi ad esso e accenderlo.
services: databox
author: alkohli
ms.service: databox
ms.subservice: heavy
