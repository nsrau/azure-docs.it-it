...
Sì, è possibile. Per informazioni dettagliate su come abilitarlo, vedere l'articolo [usare l'emulatore Azure Cosmos DB per lo sviluppo e il test locali](local-emulator.md#cassandra-api) .
