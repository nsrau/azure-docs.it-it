...
Fino a quando un predicato del filtro usa uno dei tipi di indice, il motore di query lo valuterà prima di analizzare il resto. Ad esempio, se si dispone di una query SQL come`SELECT * FROM c WHERE c.firstName = "Andrew" and CONTAINS(c.lastName, "Liu")`
