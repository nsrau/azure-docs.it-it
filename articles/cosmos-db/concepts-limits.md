...
| Numero massimo di contenitori per database o account con velocità effettiva dedicata  |senza limiti |
...
| Tempo massimo di esecuzione per le operazioni MongoDB| 30s |
