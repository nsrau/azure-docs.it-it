...
* **Archiviazione consumata**: viene fatturata una tariffa forfettaria per la quantità totale di spazio di archiviazione (GB) utilizzata per i dati e gli indici per una determinata ora.
