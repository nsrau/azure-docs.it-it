...
* [Scegliere il livello di coerenza ottimale per la propria applicazione](./consistency-levels.md)
* [Livelli di coerenza nelle API di Azure Cosmos DB](./consistency-levels.md)
