...
Un database si può creare usando la funzione [**CreateDatabaseIfNotExistsAsync**](https://aka.ms/CosmosDotnetAPIDocs) o [**CreateDatabaseAsync**](https://aka.ms/CosmosDotnetAPIDocs) della classe ``Databases``. Un database è un contenitore logico di elementi partizionati tra contenitori.
