...
L'esempio seguente illustra come registrare un stored procedure usando Python SDK:
...
Il codice seguente illustra come chiamare un stored procedure usando Python SDK:
