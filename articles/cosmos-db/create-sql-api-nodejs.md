...
ms.locfileid: "56585493"
---
# <a name="quickstart-build-a-nodejs-app-using-azure-cosmos-db-sql-api-account"></a>Avvio rapido: Compilare un'app Node.js usando un account API SQL di Azure Cosmos DB
