...
Un elemento viene inserito in Azure Cosmos DB con un [carattere non valido](https://docs.microsoft.com/dotnet/api/microsoft.azure.documents.resource.id?view=azure-dotnet#remarks) nell'ID elemento.
