...
ms.locfileid: "53793141"
---
# <a name="build-a-web-app-using-azure-cosmos-dbs-api-for-mongodb-and-java-sdk"></a>Creare un'app Web usando l'API Azure Cosmos DB per MongoDB e Java SDK
