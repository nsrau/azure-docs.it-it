...
Per gli account con singola area di scrittura, tutte le operazioni di scrittura vengono sempre indirizzate all'area di scrittura, quindi l'elenco delle aree preferite è applicabile solo alle operazioni di lettura. Per gli account di più aree di scrittura, l'elenco delle preferenze influiscono sulle operazioni di lettura e scrittura.

Se non si imposta un'area preferita, l'ordine delle preferenze internazionali viene definito dall' [ordine dell'elenco dell'area Azure Cosmos DB](distribute-data-globally.md).
...
Se si rimuove un'area e la si aggiunge di nuovo all'account, se l'area aggiunta ha una preferenza superiore, l'SDK tornerà a usare questa area in modo permanente. Dopo che l'area aggiunta è stata rilevata, tutte le richieste future verranno indirizzate a tale area.
