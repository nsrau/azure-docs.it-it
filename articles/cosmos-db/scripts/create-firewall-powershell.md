...
[!code-powershell[principale](../../../powershell_scripts/cosmosdb/create-firewall/create-firewall.ps1?highlight=35-36,39-43 "Creare un firewall per Azure Cosmos DB")]
