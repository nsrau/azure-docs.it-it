---
title: Azure PowerShell script - creare un database di Azure Cosmos
description: Script di Azure PowerShell di esempio - creare un database di Azure Cosmos
author: markjbrown
...
---
# <a name="create-an-azure-cosmos-database-using-powershell"></a>Creare un database Cosmos Azure usando PowerShell
