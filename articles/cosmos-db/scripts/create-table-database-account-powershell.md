---
title: 'Script di Azure PowerShell: creare un account di API di tabella di Azure Cosmos DB | Microsoft Docs'
...
ms.locfileid: "41919129"
---
# <a name="azure-cosmos-db-create-a-table-api-account-using-powershell"></a>Azure Cosmos DB: creare un account di API di tabella con PowerShell
