...
> [!Note]
> L'interfaccia della riga di comando di Azure non supporta direttamente la creazione di una tabella Cassandra. Usare il portale di Azure o la shell CQL.
