---
title: 'Script di Azure PowerShell: creare un account API Gremlin di Azure Cosmos DB | Microsoft Docs'
...
ms.locfileid: "34795704"
---
# <a name="azure-cosmos-db-create-a-gremlin-api-account-using-powershell"></a>Azure Cosmos DB: creare un account API Gremlin con PowerShell
