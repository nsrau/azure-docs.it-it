...
ms.locfileid: "71275028"
---
# <a name="create-an-azure-cosmos-sql-core-api-account-database-and-container-using-azure-cli"></a>Creare un account, un database e un contenitore dell'API SQL (Core) per Azure Cosmos tramite l'interfaccia della riga di comando di Azure
