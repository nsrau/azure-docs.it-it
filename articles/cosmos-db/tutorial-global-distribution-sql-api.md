...
description: "Esercitazione: Informazioni su come configurare la distribuzione globale in Azure Cosmos DB usando l'API SQL con .NET, Java, Python e vari altri SDK"
author: markjbrown
ms.author: mjbrown
