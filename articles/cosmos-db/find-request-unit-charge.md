...
Quando si usa il [driver Java MongoDB ufficiale](http://mongodb.github.io/mongo-java-driver/), è possibile eseguire i comandi chiamando il metodo `runCommand` per un oggetto `MongoDatabase`:
