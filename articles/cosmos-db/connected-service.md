...
* [Sviluppare con l'API di DocumentDB in .NET](tutorial-develop-documentdb-dotnet.md).
* [Azure Cosmos DB: Esercitazione introduttiva per l'API DocumentDB](documentdb-get-started.md).
