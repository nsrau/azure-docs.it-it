...
![Architettura di riferimento per un catalogo di vendita al dettaglio per Azure Cosmos DB](./media/use-cases/product-catalog.png)
 ...
 I dati archiviati in Cosmos DB possono anche essere integrati con HDInsight per analisi di Big Data tramite processi Pig, Hive o Map/Reduce. Per altre informazioni sul connettore Hadoop per Cosmos DB, vedere [Eseguire un processo Hadoop con Cosmos DB e HDInsight](run-hadoop-with-hdinsight.md).
