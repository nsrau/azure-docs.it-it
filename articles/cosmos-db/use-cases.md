...
:::image type="content" source="./media/use-cases/apps-with-global-reach.png" alt-text="Architettura di riferimento per app Web per Azure Cosmos DB" border="false":::
