...
5. Aggiornare quindi il valore del database in base al nome del database creato in precedenza. L'app è stata aggiornata con tutte le informazioni necessarie per comunicare con Azure Cosmos DB. 
