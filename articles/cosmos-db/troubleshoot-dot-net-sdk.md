...
### <a name="high-network-latency"></a>Latenza di rete elevata
...
Se non è presente alcun [timeout](#request-timeouts) e la diagnostica Mostra singole richieste in cui la latenza elevata è evidente sulla differenza tra `ResponseTime` e `RequestStartTime`, come in questo caso (> 300 millisecondi in questo esempio):
...
### <a name="request-rate-too-large"></a>Frequenza delle richieste troppo grande
