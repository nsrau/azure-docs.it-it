...
## <a name="frequently-asked-questions-about-sql-api"></a><a id="sql-api-faq"></a>Domande frequenti sull'API SQL
...
* Domande frequenti su [API Cassandra in Azure Cosmos DB](cassandra-faq.md)
* Domande frequenti su [API tabella in Azure Cosmos DB](table-api-faq.md)
