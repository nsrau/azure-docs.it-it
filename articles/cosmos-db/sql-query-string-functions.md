---
title: Funzioni stringa nel linguaggio di query Azure Cosmos DB
description: Informazioni sulle funzioni di sistema di stringa SQL in Azure Cosmos DB.
author: ginamr
...
ms.locfileid: "71349291"
---
# <a name="string-functions-azure-cosmos-db"></a>Funzioni stringa (Azure Cosmos DB)

Le funzioni di stringa consentono di eseguire operazioni sulle stringhe in Azure Cosmos DB.
...
||||  
|-|-|-|  
|[CONCAT](sql-query-concat.md)|[CONTIENE](sql-query-contains.md)|[ENDSWITH](sql-query-endswith.md)|  
...
|[StringToObject](sql-query-stringtoobject.md)|[SOTTOSTRINGA](sql-query-substring.md)|[ToString](sql-query-tostring.md)|
