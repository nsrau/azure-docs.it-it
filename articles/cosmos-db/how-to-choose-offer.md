...
|  | Utilizzo |Unità di scalabilità automatica fatturate/sec  |Opzione 1: manuale 30.000 UR/sec  | Opzione 2: ridimensionamento automatico tra 3000-30.000 UR/sec |
|---------|---------|---------|---------|---------|
