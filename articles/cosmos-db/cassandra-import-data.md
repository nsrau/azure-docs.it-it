...
## <a name="migrate-data-by-using-cqlsh-copy"></a>Eseguire la migrazione dei dati con cqlsh COPY
...
### <a name="steps-to-move-data-with-cqlsh"></a>Passaggi per spostare i dati con cqlsh
