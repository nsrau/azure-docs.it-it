...
L'[API per MongoDB](../documentdb/documentdb-protocol-mongodb.md) supporta l'esecuzione di [query nella shell di MongoDB](https://docs.mongodb.com/manual/tutorial/query-documents/). 
