...
|---------|---------|---------|
|API SQL    | .NET    |[azure-cosmosdb-dotnet/samples/MultiMaster/](https://github.com/Azure/azure-cosmosdb-dotnet/tree/master/samples/MultiMaster)  |
...
|API SQL    | Java    |[azure-cosmosdb-java-examples/src/main](https://github.com/Azure/azure-cosmosdb-java/tree/master/examples/src/main)  |
...
|API Gremlin | .NET | [azure-cosmos-db-gremlin-dotnet-multi-master](https://github.com/Azure-Samples/azure-cosmos-db-gremlin-dotnet-multi-master)|
