...
:::image type="content" source="media/mobile-apps-with-xamarin/cosmos-db-xamarin-replicate.png" alt-text="Capacità di Azure Cosmos DB per le app per dispositivi mobili" border="false":::
