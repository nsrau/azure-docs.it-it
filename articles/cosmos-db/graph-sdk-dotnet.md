...
È consigliabile usare il driver Gremlin open source per .NET, Gremlin.Net. Per informazioni sulle operazioni iniziali, vedere [Azure Cosmos DB: Creare un'app Graph tramite .NET e l'API Graph](create-graph-dotnet.md).
