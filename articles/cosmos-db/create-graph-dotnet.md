...
3. Copiare il valore di **CHIAVE PRIMARIA** dal portale e impostarlo come valore della chiave AuthKey in App.config, quindi salvare le modifiche. 

    `"authkey": "FILLME"`

4. Salvare il file appsettings.json. 
