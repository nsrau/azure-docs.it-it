...
| | |
|---|---|
|[Creare un account, un database e una raccolta](scripts/powershell/mongodb/ps-mongodb-create.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Crea un account, un database e una raccolta Azure Cosmos DB. |
...
|[Bloccare le risorse per impedirne l'eliminazione](scripts/powershell/mongodb/powershell-mongodb-lock.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Impedire l'eliminazione delle risorse tramite blocchi. |
|||
