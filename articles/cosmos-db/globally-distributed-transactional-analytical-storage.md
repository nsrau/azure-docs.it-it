...
|---------|---------|---------|
|Archiviazione massima per ogni contenitore di Azure Cosmos |   Nessuna limitazione      |    Nessuna limitazione     |
|Spazio di archiviazione massimo per chiave di partizione logica   |   20 GB      |   Nessuna limitazione      |
...
|Conservazione (TTL (time-to-Live)   |  Basato sui criteri, configurato nel contenitore Azure Cosmos usando la `DefaultTimeToLive` proprietà.       |   Basato sui criteri, configurato nel contenitore Azure Cosmos usando la `ColumnStoreTimeToLive` proprietà.      |
