...
ms.locfileid: "53263366"
---
# <a name="optimize-the-cost-required-to-run-queries-in-azure-cosmos-db"></a>Ottimizzare il costo necessario per eseguire query in Azure Cosmos DB
