---
title: 'Azure Cosmos DB: API Java asincrona SQL, risorse & SDKAzure Cosmos DB: SQL Async Java API, SDK & resources'
...
|**Documentazione API** |[Documentazione di riferimento API Java](https://docs.microsoft.com/java/api/com.microsoft.azure.cosmosdb.rx.asyncdocumentclient?view=azure-java-stable) | 
...
| **Suggerimenti per incrementare le prestazioni**| [File Leggimi gitHub](https://github.com/Azure/azure-cosmosdb-java#guide-for-prod)| 
