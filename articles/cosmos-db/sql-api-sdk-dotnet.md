...
ms.locfileid: "91802549"
---
# <a name="azure-cosmos-db-net-sdk-v2-for-sql-api-download-and-release-notes"></a>Azure Cosmos DB .NET SDK v2 per l'API SQL: download e note sulla versione
...
|**Documentazione sull'API**|[Documentazione di riferimento API .NET](/dotnet/api/overview/azure/cosmosdb?view=azure-dotnet&preserve-view=true)|
|**Esempi**|[Esempi di codice .NET](https://github.com/Azure/azure-cosmos-dotnet-v2/tree/master/samples)|
|**Operazioni preliminari**|[Introduzione ad Azure Cosmos DB .NET SDK](sql-api-get-started.md)|
...
> [!NOTE]
> Se si usa .NET Framework, vedere la versione 3.x più recente di [.NET SDK](sql-api-sdk-dotnet-standard.md), destinata a .NET Standard.
