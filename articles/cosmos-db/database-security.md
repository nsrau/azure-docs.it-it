...
|Crittografia HTTPS/SSL/TLS|Tutte le interazioni Azure Cosmos DB da client a servizio supportano SSL/TLS 1.2. Inoltre, tutte le repliche intra Data Center e tra Data Center sono applicate a SSL/TLS 1,2.|
