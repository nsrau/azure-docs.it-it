---
title: Eseguire l'upsert dei dati all'API Cassandra di Azure Cosmos DB da Spark
description: Questo articolo descrive come eseguire l'upsert dei dati nelle tabelle nell'API Cassandra di Azure Cosmos DB da Spark
author: rockboyfor
ms.author: v-yeche
ms.reviewer: sngun
...
ms.locfileid: "60893416"
---
<!--Verify sucessfully-->
# <a name="upsert-data-into-azure-cosmos-db-cassandra-api-from-spark"></a>Eseguire l'upsert dei dati all'API Cassandra di Azure Cosmos DB da Spark

Questo articolo descrive come eseguire l'upsert dei dati nell'API Cassandra di Azure Cosmos DB da Spark.
...
### <a name="create-a-dataframe"></a>Crea un dataframe 
...
Passare agli articoli seguenti per eseguire altre operazioni sui dati archiviati nelle tabelle dell'API Cassandra di Azure Cosmos DB:
