...
* Nel portale di funzioni di Azure è possibile creare un trigger. Per istruzioni introduttive, vedere [creare un trigger di funzioni di Azure per Cosmos DB nel portale di Azure](https://aka.ms/cosmosdbtriggerportalfunc).
