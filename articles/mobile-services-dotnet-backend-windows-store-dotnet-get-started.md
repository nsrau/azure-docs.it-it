...
<!-- URLs. -->
[Introduzione ai dati]: mobile-services-dotnet-backend-windows-universal-dotnet-get-started-data.md
...
[Versione per back-end JavaScript]: mobile-services-windows-store-get-started.md
