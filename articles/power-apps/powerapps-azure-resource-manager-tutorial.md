...
4. In **URL accesso** immettere: *http://login.windows.net*. In **URI ID app** immettere un URI univoco. Selezionare quindi **Completa**: ![](./media/powerapps-azure-resource-manager-tutorial/newapplication2.png "Nuova seconda applicazione")
