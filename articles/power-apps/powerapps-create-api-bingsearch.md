...
> [AZURE.SELECTOR]
- [App per la logica](../articles/connectors/create-api-bingsearch.md)
...
Informazioni di riferimento sull'[API di Ricerca di Bing](../connectors/create-api-bingsearch.md).
