...
In questa esercitazione si userà il plug-in di Archiviazione di Azure per l'Integrazione continuata Jenkins reso disponibile da Microsoft Open Technologies, Inc.
...
## <a name="howtouse"></a>Come usare il servizio BLOB con l'Integrazione continuata Jenkins ##
...
11. In **Common virtual path for uploaded artifacts**, ai fini di questa esercitazione immettere **${BUILD_ID}/${BUILD_NUMBER}**.
