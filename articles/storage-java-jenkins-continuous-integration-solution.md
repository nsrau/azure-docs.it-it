...
## <a name="overview"></a>Panoramica su Jenkins ##
...
Per altre informazioni su Jenkins, vedere [Meet Jenkins][].

## <a name="benefits"></a>Vantaggi dell'uso del servizio BLOB ##
...
## <a name="howtouse"></a>Uso del servizio BLOB con l'Integrazione continuata Jenkins ##
...
## <a name="howtoinstall"></a>Come installare il plug-in di Archiviazione di Azure ##
...
## <a name="howtoconfigure"></a>Come configurare il plug-in di Archiviazione di Azure per usare l'account di archiviazione ##
...
3. Nella sezione **Microsoft Azure Storage Account Configuration**:
    ...
    5. [Facoltativo] Se si dispone di account di archiviazione aggiuntivi che si desidera rendere disponibili per l'Integrazione continuata Jenkins, fare clic su **Add more Storage Accounts**.
    6. Per salvare le impostazioni, fare clic su **Save**.

## <a name="howtocreatepostbuild"></a>Come creare un'operazione post-compilazione per il caricamento degli elementi di compilazione nell'account di archiviazione ##
...
## <a name="components"></a>Componenti usati dal servizio BLOB ##
...
- **Formato dell'URL**: I BLOB sono indirizzabili usando il formato di URL seguente:
  ...
  [Panoramica su Jenkins]: #overview
  [Vantaggi dell'uso del servizio BLOB]: #benefits
  [Prerequisiti]: #prerequisites
  [Come usare il servizio BLOB con l'Integrazione continuata Jenkins]: #howtouse
