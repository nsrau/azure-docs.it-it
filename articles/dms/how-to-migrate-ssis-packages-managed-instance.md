...
* Per configurare la [Windows Firewall per l'accesso al motore di database di origine](/sql/database-engine/configure-windows/configure-a-windows-firewall-for-database-engine-access?view=sql-server-2017).
