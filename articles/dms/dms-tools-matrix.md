...
| Origine | Destinazione | Individuare<br/>Inventario | Destinazione e SKU<br/>Suggerimento | TCO/ROI e<br/>Business case |
| --- | --- | --- | --- | --- |
...
| Origine | Destinazione | Accesso ai dati dell'app<br/>Valutazione livello | Database<br/>OMS | Prestazioni<br/>OMS |
| --- | --- | --- | --- | --- |
...
| Origine | Destinazione | Schema | Data<br/>Offline | Data<br/>Online |
| --- | --- | --- | --- | --- |
...
| Origine | Destinazione | Ottimizzazione |
| --- | --- | --- |
