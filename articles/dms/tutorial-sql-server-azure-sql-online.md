---
title: Usare il Servizio Migrazione del database di Azure per eseguire la migrazione online di SQL Server nel database SQL di Azure | Microsoft Docs
...
ms.locfileid: "49945536"
---
# <a name="migrate-sql-server-to-azure-sql-database-online-using-dms"></a>Eseguire la migrazione di SQL Server al database SQL di Azure online con Servizio Migrazione del database
