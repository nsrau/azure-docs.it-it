...
* Un'istanza di [Database di Azure per PostgreSQL](https://docs.microsoft.com/azure/postgresql/) versione 10 e successive con il database **DVD Rental** . 
