...
Per altre informazioni, vedere l'articolo [Tabelle temporali](/sql/relational-databases/tables/temporal-tables?view=sql-server-2017).
...
2. Disabilitare i trigger nel database di origine eseguendo i passaggi illustrati nell'articolo [DISABLE TRIGGER (Transact-SQL)](/sql/t-sql/statements/disable-trigger-transact-sql?view=sql-server-2017).
