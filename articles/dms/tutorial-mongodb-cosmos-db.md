...
- Al termine della migrazione è possibile verificare l'account API MongoDB di Cosmos DB per accertarsi che sia stata eseguita la migrazione di tutte le raccolte.
