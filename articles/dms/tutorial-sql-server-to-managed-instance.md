...
- Se si eseguono più istanze di SQL Server denominate usando le porte dinamiche, si consiglia di abilitare il Servizio browser SQL e di consentire l'accesso alla porta UDP 1434 attraverso i firewall in modo che il Servizio Migrazione del database di Azure possa connettersi a un'istanza denominata nel server di origine.
