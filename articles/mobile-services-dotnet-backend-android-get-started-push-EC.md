...
8. [Abilitare le notifiche push per i test locali](#local-testing)
9. [Testare l'app sul servizio mobile pubblicato](#test-app)
...
<h2><a name="test-app"></a>Testare l'app sul servizio mobile pubblicato</h2>
