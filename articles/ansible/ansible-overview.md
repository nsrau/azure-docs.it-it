...
- [Avvio rapido: Distribuire il modello di soluzione Ansible per Azure in CentOS](./ansible-deploy-solution-template.md)
- [Avvio rapido: Configurare macchine virtuali Linux in Azure tramite Ansible](./ansible-install-configure.md)