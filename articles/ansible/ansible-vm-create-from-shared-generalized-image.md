...
Nel [portale di Azure ](https://portol.azure.com) verificare il gruppo di risorse specificato in `vars.yml` per visualizzare la nuova macchina virtuale e le varie risorse create.
