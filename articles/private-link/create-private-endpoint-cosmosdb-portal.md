...
1. Per includere l'indirizzo IP e il mapping DNS, accedere alla macchina virtuale *myVM*, aprire il `c:\Windows\System32\Drivers\etc\hosts` file e includere le informazioni DNS del passaggio precedente nel formato seguente:
