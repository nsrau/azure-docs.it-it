<properties 
	pageTitle="Aggiungere paging ai dati (Windows Phone) | Mobile Dev Center" 
	description="Informazioni su come usare il paging per gestire la quantità di dati restituiti all'app per Windows Phone da Servizi mobili." 
