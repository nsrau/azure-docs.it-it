...
-   **Utente FTP/distribuzione**: indica l'account usato per la distribuzione del sito Web in Microsoft Azure tramite FTP o Git (vedere [Credenziali FTP][Credenziali FTP]).
