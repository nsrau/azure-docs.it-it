<properties 
    pageTitle="Note sulla versione di StorSimple - Luglio 2014"
    description="Vengono descritte le nuove funzionalità, i problemi e le soluzioni alternative per la versione di luglio 2014 di Microsoft Azure StorSimple."
    services="storsimple"
...
# Note sulla versione di StorSimple - Luglio 2014 

## Panoramica

Le seguenti note sulla versione identificano i problemi critici aperti per la versione di disponibilità generale \(GA\) di luglio 2014 di StorSimple di Microsoft Azure. Questa versione corrisponde alla versione del software 6.3.9600.17215.
