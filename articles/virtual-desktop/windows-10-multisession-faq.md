...
- [Opzioni della riga di comando per la manutenzione del pacchetto dell'app DISM](/windows-hardware/manufacture/desktop/dism-app-package--appx-or-appxbundle--servicing-command-line-options)
...
- Leggi la [documentazione sul desktop virtuale Windows](overview.md)
...
- Configurare la distribuzione di desktop virtuali Windows con le [esercitazioni sul desktop virtuale di Windows](./virtual-desktop-fall-2019/tenant-setup-azure-active-directory.md)