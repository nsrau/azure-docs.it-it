...
Prima di iniziare, [scaricare e importare il modulo PowerShell per desktop virtuale di Windows](https://docs.microsoft.com/powershell/windows-virtual-desktop/overview) , se non è già stato fatto. 
