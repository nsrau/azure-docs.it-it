...
6. Selezionare **Avanti: Configura macchine virtuali >** .
...
4. Selezionare **Avanti: informazioni sul desktop virtuale di Windows**.
...
5. Selezionare **Avanti: verifica + crea**.
