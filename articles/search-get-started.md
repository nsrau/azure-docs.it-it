<properties title="Introduzione a Ricerca di Azure" pageTitle="Introduzione a Ricerca di Azure" description="Introduzione a Ricerca di Azure" metaKeywords="" services="Azure Search" solutions="" documentationCenter="" authors="Heidist" manager="mblythe" videoId="" scriptId="" />
...
-   [Esplorare il dashboard del servizio di ricerca][Esplorare il dashboard del servizio di ricerca]
...
1.  Accedere al [portale di anteprima di Azure][portale di anteprima di Azure] con la sottoscrizione esistente. Si noti che questo URL reindirizzerà l'utente al portale di anteprima. Il portale di anteprima costituisce un requisito.
...
1.  Specificare l'intestazione della richiesta sostituendo i valori di host e chiave api con valori validi per il servizio corrente.
...
-   [Creare un esempio di ricerca geografica in Ricerca di Azure][Creare un esempio di ricerca geografica in Ricerca di Azure]
...
-   [Video di Channel 9: Introduzione a Ricerca di Azure][Video di Channel 9: Introduzione a Ricerca di Azure]

-   [Video di Channel 9: Ricerca di Azure e dati geospaziali][Video di Channel 9: Ricerca di Azure e dati geospaziali]

-   [Cloud Cover episodio 152: Generare un indice in Ricerca di Azure][Cloud Cover episodio 152: Generare un indice in Ricerca di Azure]

<!--Anchors-->
<!--Image references-->
<!--Link references-->

  [scenari e le funzionalità di Ricerca di Azure]: http://azure.microsoft.com/blog/2014/08/28/azure-search-scenarios-and-capabilities/
