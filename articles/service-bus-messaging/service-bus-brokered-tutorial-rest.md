...
1. Creare un nuovo progetto di applicazione console. Fare clic sul menu **File**, selezionare **Nuovo** e fare clic su **Progetto**. Nella finestra di dialogo **Nuovo progetto** fare clic su **Visual C#**. Se **Visual C#** non è visibile, cercare in **Altri linguaggi**, selezionare il modello **Applicazione console** e denominarlo **Microsoft.ServiceBus.Samples**. Utilizzare il Percorso predefinito. Fare clic su **OK** per creare il progetto.
