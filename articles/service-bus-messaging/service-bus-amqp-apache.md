...
Il primo passaggio viene eseguito tramite il [portale di Azure classico][]. La schermata seguente illustra la modalità di creazione di una macchina virtuale CentOS denominata "scott-centos":
