...
-   [Procedure consigliate per il miglioramento delle prestazioni tramite la messaggistica negoziata del bus di servizio][]: questo articolo descrive come ottimizzare le prestazioni durante lo scambio di messaggi negoziati.

-   [Procedure consigliate per isolare le applicazioni del bus di servizio da interruzioni ed emergenze del servizio][]: questo articolo illustra le procedure migliori per proteggere endpoint di inoltro, code, argomenti e replica attiva e passiva da guasti del data center.
...
Per un elenco di limiti e quote del bus di servizio, vedere [Quote del bus di servizio][].
