---
title: Code di archiviazione di Azure e code del bus di servizio - Analogie e differenze | Documentazione Microsoft
...
Microsoft Azure supporta due tipi di meccanismi di code: **code di archiviazione** e **code del bus di servizio**.
...
Le tabelle nelle sezioni seguenti forniscono un raggruppamento logico delle funzionalità relative alle code e offrono la possibilità di un confronto immediato delle funzionalità disponibili sia nelle code di archiviazione sia in quelle del bus di servizio.
...
* I nomi delle code di archiviazione possono avere una lunghezza compresa tra 3 e 63 caratteri e contenere lettere minuscole, numeri e trattini. Per altre informazioni, vedere [Naming Queues and Metadata](https://msdn.microsoft.com/library/azure/dd179349.aspx) (Denominazione di code e metadati).
