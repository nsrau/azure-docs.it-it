...
Se si esegue un codice esterno oltre a Application Insights SDK, è previsto **un periodo di tempo più** lungo per la visualizzazione di Application Insights log. 
