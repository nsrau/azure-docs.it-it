...
-   Esempi relativi al bus di servizio: è possibile scaricarli dagli [esempi di Azure][] oppure vedere la [panoramica](../service-bus/service-bus-samples.md).
  ...
  [Topic filters sample (Esempio di filtri di argomento).]: https://github.com/Azure-Samples/azure-servicebus-messaging-samples/tree/master/TopicFilters
