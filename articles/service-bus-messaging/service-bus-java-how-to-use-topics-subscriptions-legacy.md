...
> [!WARNING]
>  Questa guida di avvio rapido usa il pacchetto azure-servicebus corrente disponibile a livello generale. Per una guida di avvio rapido che usa il nuovo pacchetto azure-messaging-servicebus disponibile in **anteprima**, vedere [Inviare e ricevere messaggi con azure-messaging-servicebus](service-bus-java-how-to-use-topics-subscriptions.md).
