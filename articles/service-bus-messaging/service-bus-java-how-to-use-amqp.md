<properties 
    ...
    description="Informazioni su come usare Java Message Service (JMS) con il bus di servizio di Azure e Advanced Message Queueing"
...
> [AZURE.NOTE] è necessario applicare manualmente la codifica URL alla password. Sul sito [http://www.w3schools.com/tags/ref_urlencode.asp](http://www.w3schools.com/tags/ref_urlencode.asp) è disponibile un'utilità per codificare facilmente l'URL.
...
Questo articolo ha illustrato come usare le funzionalità di messaggistica del bus di servizio, ad esempio code e pubblicazione/sottoscrizione di argomenti, da Java usando la API JMS più richiesta e AMQP 1.0.
