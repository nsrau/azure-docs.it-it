...
-   Comunicazione tra app locali e app Azure ospitate in una soluzione [ibrida](service-bus-dotnet-hybrid-app-using-service-bus-relay.md).
...
> [AZURE.NOTE] È anche possibile trovare questa chiave se si accede al [portale di Azure](https://portal.azure.com/) e si visualizzano le informazioni di connessione per lo spazio dei nomi del bus di servizio.
