...
Nelle interfacce API del bus di servizio le proprietà dell'applicazione di messaggi vengono inserite nella raccolta **Properties** di [BrokeredMessage][]. Il seguente codice mostra come leggere le proprietà dell'applicazione di un messaggio ricevuto da un client PHP.
