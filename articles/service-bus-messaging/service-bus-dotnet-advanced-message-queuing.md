...
# <a name="how-to-use-amqp-1.0-with-the-service-bus-.net-api"></a>Come usare AMQP 1.0 con l'API .NET del bus di servizio
...
### <a name="configure-via-app.config"></a>Configurare tramite App.config
