...
Questo articolo illustra come usare le code del bus di servizio. Gli esempi sono scritti in Python e usano il [pacchetto Python del bus di servizio di Azure][]. Gli scenari presentati includono **creazione di code, invio e ricezione di messaggi**, nonché **eliminazione di code**.

[AZURE.INCLUDE [howto-service-bus-queues](../../includes/howto-service-bus-queues.md)]

> [AZURE.NOTE] Per installare Python o il [pacchetto Python del bus di servizio di Azure][], vedere la [guida all'installazione di Python](../python-how-to-install.md).
...
[pacchetto Python del bus di servizio di Azure]: https://pypi.python.org/pypi/azure-servicebus
