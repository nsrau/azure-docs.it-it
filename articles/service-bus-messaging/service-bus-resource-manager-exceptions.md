...
| Codice errore | Codice di errore | Messaggio di errore | Descrizione | Recommendation |
| ---------- | ------------- | ------------- | ----------- | -------------- |
| Non autorizzata | none | Operazione non valida nello spazio dei nomi secondario. Lo spazio dei nomi secondario è di sola lettura. | L'operazione è stata eseguita sullo spazio dei nomi secondario, che è configurato come spazio dei nomi di sola lettura. | Ripetere il comando con lo spazio dei nomi primario. Altre informazioni sullo [spazio dei nomi secondario](service-bus-geo-dr.md) |
| Non autorizzata | none | MissingToken: l'intestazione dell'autorizzazione non è stata trovata. | Questo errore si verifica quando l'autorizzazione contiene valori null o non corretti. | Verificare che il valore del token indicato nell'intestazione dell'autorizzazione sia corretto e non null. |