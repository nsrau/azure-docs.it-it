...
Per altre informazioni sui limiti delle sottoscrizioni CDN, vedere [Limiti relativi alla rete CDN](../azure-resource-manager/management/azure-subscription-service-limits.md).
