---
title: Uso della rete CDN di Azure | Microsoft Docs
...
> [!IMPORTANT]
> Per un'introduzione al funzionamento della rete CDN e per un elenco delle funzionalità, vedere [Panoramica della rete per la distribuzione di contenuti (rete CDN) di Azure](cdn-overview.md).
> 
> 
