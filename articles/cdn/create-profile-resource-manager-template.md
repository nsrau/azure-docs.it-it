...
Usare i dati specificati per HostName per visualizzare il contenuto. Ad esempio, accedere a https:\//cdndemo-azurewebsites-net.azureedge.net con il browser.
