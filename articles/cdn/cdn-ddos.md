...
ms.locfileid: "58373091"
---
# <a name="azure-cdn-ddos-protection"></a>Protezione DDoS di Azure della rete CDN

Una rete di distribuzione di contenuti offre la protezione DDoS per impostazione predefinita. Oltre a capactiy globale assorbire gli attacchi volumentric, rete CDN di Azure dispone di protezione DDoS aggiuntiva come indicato di seguito, per no costi aggiuntivi.
