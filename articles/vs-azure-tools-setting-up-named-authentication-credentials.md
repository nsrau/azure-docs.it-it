---
title: Configurazione delle credenziali per l'autenticazione denominate | Microsoft Docs
...
2. Fare clic su **Copia il percorso completo**. Il percorso del certificato (file con estensione cer) viene copiato negli Appunti.
