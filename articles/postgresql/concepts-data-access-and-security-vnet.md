---
title: Regole della rete virtuale - Database di Azure per PostgreSQL - Server singoloVirtual network rules - Azure Database for PostgreSQL - Single Server
description: Informazioni su come usare gli endpoint del servizio di rete virtuale (vnet) per connettersi al database di Azure per PostgreSQL - Server singolo.
author: rachel-msft
ms.author: raagyema
...
---
# <a name="use-virtual-network-service-endpoints-and-rules-for-azure-database-for-postgresql---single-server"></a>Usare gli endpoint del servizio di rete virtuale e le regole per il database di Azure per PostgreSQL - Server singoloUse Virtual Network service endpoints and rules for Azure Database for PostgreSQL - Single Server
