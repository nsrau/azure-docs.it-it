...
11. Specificare un nome per la regola di avviso, una descrizione e il livello di gravità.
    ...
    :::image type="content" source="./media/howto-hyperscale-alert-on-metric/11-name-description-severity.png" alt-text="Selezionare le regole di avviso"::: 
...
* Si consiglia di [aumentare la capacità](howto-hyperscale-scaling.md#increase-or-decrease-vcores-on-nodes) dei nodi del ruolo di lavoro. Ogni thread di lavoro può avere fino a 2 TiB di archiviazione. Tuttavia, l'aggiunta di nodi deve essere tentata prima di ridimensionare i nodi perché l'aggiunta di nodi viene completata più velocemente.
