...
## <a name="postgresql-version-956"></a>PostgreSQL versione 9.5.6
Consultare la [documentazione di PostgreSQL](https://www.postgresql.org/docs/9.6/static/release-9-5-6.html) per le informazioni sui miglioramenti e sulle correzioni presenti in PostgreSQL 9.5.6.
