---
title: 'Creare e gestire gli endpoint e le regole del servizio VNet nel database di Azure per PostgreSQL: server singolo usando il portale di Azure'
