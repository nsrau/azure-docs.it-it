...
# Database di Azure per PostgreSQL: usare .NET (C#) per connettersi ai dati ed eseguire query
...
## Installare Visual Studio e .NET
...
### **Windows .NET Framework e .NET Core**
...
## Installare i riferimenti Npgsql nella soluzione di Visual Studio
