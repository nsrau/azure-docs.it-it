---
title: "Guida introduttiva: Creare un'istanza di server singolo Database di Azure per PostgreSQL con un comando dell'interfaccia della riga di comando di Azure az postgres up"
