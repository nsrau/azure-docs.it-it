---
title: Baseline di sicurezza di Azure per Database di Azure per PostgreSQL - Server singolo
description: Baseline di sicurezza di Azure per Database di Azure per PostgreSQL - Server singolo
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 03/23/2020
...
La baseline di sicurezza di Azure per Database di Azure per PostgreSQL - Server singolo contiene raccomandazioni utili per migliorare il comportamento di sicurezza della distribuzione.
...
Come creare e gestire gli endpoint di servizio e le regole di rete virtuale in Database di Azure per PostgreSQL: https://docs.microsoft.com/azure/postgresql/howto-manage-vnet-using-portal
...
Informazioni sull'uso dei tag di servizio per Database di Azure per PostgreSQL: https://docs.microsoft.com/azure/postgresql/concepts-data-access-and-security-vnet#terminology-and-description
...
Come creare altri account per Database di Azure per PostgreSQL: https://docs.microsoft.com/azure/postgresql/howto-create-users
...
Informazioni su come creare utenti amministratore in Database di Azure per PostgreSQL: https://docs.microsoft.com/azure/postgresql/howto-create-users#the-server-admin-account
...
Come impostare Advanced Threat Protection per Database di Azure per PostgreSQL: https://docs.microsoft.com/azure/postgresql/howto-database-threat-protection-portal
...
Esaminare gli utenti PostgreSQL e i ruoli assegnati: https://www.postgresql.org/docs/current/database-roles.html
...
Come visualizzare gli accessi rischiosi per Azure AD: https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-risk-events
...
Come attenuare l'esfiltrazione di dati per Database di Azure per PostgreSQL: https://docs.microsoft.com/azure/postgresql/concepts-data-access-and-security-private-link
...
**Indicazioni**: attualmente non disponibile; il Centro sicurezza di Azure ancora non supporta la valutazione della vulnerabilità per Database di Azure per PostgreSQL.
...
**Indicazioni**: usare Azure Resource Graph per eseguire query e individuare tutte le risorse (incluse le istanze di Database di Azure per PostgreSQL) nelle sottoscrizioni. Assicurarsi di disporre delle autorizzazioni (di lettura) appropriate nel tenant e di poter enumerare tutte le sottoscrizioni di Azure e le risorse all'interno delle sottoscrizioni.
...
Informazioni sul backup e sul ripristino in Database di Azure per PostgreSQL: https://docs.microsoft.com/azure/postgresql/concepts-backup
...
È possibile trovare qui altre informazioni sulla strategia Microsoft e sull'esecuzione dei test di penetrazione del sito live e Red Teaming sull'infrastruttura cloud gestita da Microsoft, sui servizi e sulle applicazioni: https://gallery.technet.microsoft.com/Cloud-Red-Teaming-b837392e
