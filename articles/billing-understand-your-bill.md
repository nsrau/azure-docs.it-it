...
N/D | Gruppo di risorse | _**Aggiunta nuova colonna.**_ Il gruppo di risorse in cui la risorsa distribuita è in esecuzione. Vedere [Panoramica di Azure Resource Manager](resource-group-overview.md)
...
N/D | Tag | _**Aggiunta nuova colonna.**_ Nuovi tipi di risorse in Azure consentono di aggiungere tag alle risorse. Vedere [Organize your Azure resources with tags](http://azure.microsoft.com/updates/organize-your-azure-resources-with-tags/) (Organizzare le risorse di Azure con i tag)
