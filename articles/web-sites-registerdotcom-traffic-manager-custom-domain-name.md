<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Register.com" pageTitle="Configurare un nome di dominio Register.com per un sito Web di Azure che usa Gestione traffico" metaKeywords="Windows Azure, Windows Azure Web Sites, domain name" description=""services""web-sites" documentationCenter="" authors="larryfr, jroth" manager="wpickett" />
