...
In **URL ID app** immettere il dominio predefinito un dominio personalizzato per Azure Active Directory e aggiungervi una stringa univoca. In questo esempio il dominio predefinito **https://contoso5api.onmicrosoft.com** viene usato con il suffisso **/api** specificato.
