---
title: Usare le identità gestite in Gestione API di Azure. Documenti Microsoft
...
---
# <a name="use-managed-identities-in-azure-api-management"></a>Usare le identità gestite in Gestione API di AzureUse managed identities in Azure API Management

Questo articolo illustra come creare un'identità gestita per un'istanza del servizio Gestione API e come accedere ad altre risorse. Un'identità gestita generata da Azure Active Directory (Azure AD) consente all'istanza di Gestione API di accedere in modo semplice e sicuro ad altre risorse protette da Azure AD, ad esempio L'insieme di credenziali delle chiavi di Azure.A managed identity generated by Azure Active Directory (Azure AD) allows your API Management instance to easily and securely access other Azure AD-protected resources, such as Azure Key Vault. Questa identità è gestita da Azure e non richiede il provisioning o la rotazione di segreti. Per altre informazioni sulle identità gestite, vedere Che cos'è la gestione delle identità per le risorse di Azure.For more information about managed [identities, see What is managed identities for Azure resources](../active-directory/managed-identities-azure-resources/overview.md).

## <a name="create-a-managed-identity-for-an-api-management-instance"></a>Creare un'identità gestita per un'istanza di Gestione APICreate a managed identity for an API Management instance
...
2. Selezionare **Identità servizio gestito**.
...
> [!NOTE]
> Attualmente, le identità gestite possono essere usate per ottenere certificati da Archiviazione delle chiavi di Azure per i nomi di dominio personalizzati di Gestione API. Altri scenari saranno supportati a breve.
>
>
...
Altre informazioni sulle identità gestite per le risorse di Azure:Learn more about managed identities for Azure resources:

* [Informazioni sulle identità gestite per le risorse di AzureWhat is managed identities for Azure resources](../active-directory/managed-identities-azure-resources/overview.md)
* [Modelli di Gestione risorse di Azure](https://github.com/Azure/azure-quickstart-templates)
* [Eseguire l'autenticazione con un'identità gestita in un criterioAuthenticate with a managed identity in a policy](./api-management-authentication-policies.md#ManagedIdentity)
