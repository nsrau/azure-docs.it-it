...
description: Informazioni su come importare una rappresentazione XML standard di un'API SOAP e quindi testare l'API nel portale di Azure e nel portale per sviluppatori.
