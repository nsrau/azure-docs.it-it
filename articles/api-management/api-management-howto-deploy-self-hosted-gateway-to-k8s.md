...
- Creare un cluster Kubernetes. [Minikube](https://kubernetes.io/docs/tasks/tools/install-minikube/) è una soluzione efficace per scopi di sviluppo e valutazione. Per i carichi di lavoro di produzione, è possibile usare il [servizio Kubernetes di Azure](https://azure.microsoft.com/services/kubernetes-service/) o un cluster Kubernetes in un cloud esterno.
