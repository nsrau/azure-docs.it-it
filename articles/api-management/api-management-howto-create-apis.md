...
La scheda **Sicurezza** può essere usata anche per configurare l'**Autorizzazione utente** con OAuth 2.0. Per altre informazioni, vedere [Come autorizzare gli account per sviluppatori usando OAuth 2.0 in Gestione API di Azure][Come autorizzare gli account per sviluppatori usando OAuth 2.0 in Gestione API di Azure].
