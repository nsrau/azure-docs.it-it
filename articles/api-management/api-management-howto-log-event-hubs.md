...
description: Informazioni su come registrare eventi nell'Hub eventi di Azure in Gestione API di Azure. Hub eventi è un servizio di ingresso dati a scalabilità elevata.
