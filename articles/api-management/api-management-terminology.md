...
* **Frontend API**API front-end API Gestione API: un'API Gestione API non ospita le API, ma crea le facciate per le API per personalizzare la facciata in base alle esigenze senza toccare l'API back-end.**APIM API** / Per altre informazioni, vedere [Importare e pubblicare un'API](import-and-publish.md).
