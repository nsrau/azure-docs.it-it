...
-   [Gestione API di Azure: backup e ripristino della configurazione](https://docs.microsoft.com/archive/blogs/stuartleeks/azure-api-management-backing-up-and-restoring-configuration) 
