...
description: Informazioni sul concetto di sottoscrizione in Gestione API di Azure. I consumer ottengono l'accesso alle API usando le sottoscrizioni in gestione API di Azure.
