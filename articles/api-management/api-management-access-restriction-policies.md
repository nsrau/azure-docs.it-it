...
|query-parameter-name|Nome di parametro di query che contiene il token.|È necessario specificare `header-name` o `query-parameter-name`, ma non entrambi.|N/D|  
