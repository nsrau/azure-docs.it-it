...
8. A seconda dello scenario, potrebbe essere necessario modificare il tipo di [servizio](https://docs.microsoft.com/azure/aks/concepts-network#services). Il valore predefinito è `NodePort`.
