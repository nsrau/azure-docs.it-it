...
|Archiviazione di allegati per ogni account di database      |2 GB
|Numero massimo di unità di capacità per ogni account di database       |50
|Numero di raccolte per unità di capacità      |3
|Archiviazione minima allocata per ogni raccolta con un minimo di 1 documento    |3,3 GB
|Velocità effettiva minima allocata per ogni raccolta con un minimo di 1 documento |667 unità riservate
|Elasticità di una raccolta    |0-10 GB
|Numero massimo di unità di richiesta/secondo per ogni raccolta   |2000
|Numero di stored procedure, trigger e funzioni definite dall'utente per ogni raccolta       |25 ognuna
|Tempo di esecuzione massimo per ogni stored procedure e trigger     |5 secondi
|Archiviazione di documenti con provisioning/unità di capacità |10 GB
|Unità di richiesta con provisioning/secondo/unità di capacità     |2000
|Archiviazione di documenti massima per ogni database (5 unità di capacità)    |500 GB
...
|Dimensioni massime della richiesta di stored procedure, trigger e funzioni definite dall'utente        |256 KB
|Dimensioni massime della risposta |1 MB
...
|Numero massimo di funzioni definite dall'utente per ogni query     |1
