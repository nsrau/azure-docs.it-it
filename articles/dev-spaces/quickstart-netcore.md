...
---
# <a name="quickstart-develop-with-net-core-on-kubernetes-using-azure-dev-spaces-visual-studio-code"></a>Avvio rapido: Sviluppare con .NET Core in Kubernetes con Azure Dev Spaces (Visual Studio Code)
