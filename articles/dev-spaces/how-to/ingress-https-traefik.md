...
> [!NOTE]
> Se nel cluster AKS non è abilitato il controllo degli accessi in base al ruolo Kubernetes, rimuovere il parametro *--set RBAC. Enabled = true* .
