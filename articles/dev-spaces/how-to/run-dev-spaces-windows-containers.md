...
L'applicazione di esempio usa [Helm 2][helm-installed] per eseguire il servizio Windows nel cluster. Installare Helm nel cluster e concedere a tale utente le autorizzazioni corrette:
