---
title: Come condividere gli spazi di sviluppo di AzureHow to share Azure Dev Spaces
services: azure-dev-spaces
ms.date: 05/11/2018
ms.topic: conceptual
description: Informazioni su come usare Azure Dev Spaces per condividere uno spazio di sviluppo nel servizio Azure Kubernetes con altri membri del team
...
1. Verificare che ogni membro del team disponga delle autorizzazioni appropriate per accedere al controller Spazi di sviluppo di [Azure.](../troubleshooting.md#incorrect-rbac-permissions-for-calling-dev-spaces-controller-and-apis) Ad esempio, è possibile configurare il gruppo di **risorse** di Azure Dev Space per [concedere l'accesso di collaboratore](/azure/active-directory/role-based-access-control-configure) per ogni membro del team. È possibile controllare il gruppo di risorse di uno spazio di sviluppo eseguendo questo comando: `azds show-context`
