...
---
# <a name="connect-your-development-computer-to-an-aks-cluster-preview"></a>Connettere il computer di sviluppo a un cluster del servizio Azure Kubernetes (anteprima)
...
## <a name="connect-your-development-computer"></a>Connettere il computer di sviluppo
...
Per usare l'estensione Azure Dev Spaces, aprire il riquadro comandi in Visual Studio Code facendo clic su *Visualizza* e quindi su *tavolozza comandi*. Iniziare a `Azure Dev Spaces: Redirect` Digitare e fare clic `Azure Dev Spaces: Redirect an existing Kubernetes service to my machine [Preview]`su `Azure Dev Spaces: Redirect an existing Kubernetes pod to my machine [Preview]`, o `Azure Dev Spaces: Redirect a new Kubernetes pod to my machine [Preview]`.
...
Fare clic su *debug* e quindi *aprire configurazioni*. Se viene richiesto di selezionare un ambiente, scegliere *node. js*. Viene creato un `.vscode/launch.json` file. Sostituire il contenuto del file con il codice seguente:
...
### <a name="start-your-application-on-your-development-computer"></a>Avviare l'applicazione nel computer di sviluppo
...
Rimuovere il punto di interruzione inserendo il cursore alla riga 233 `server.js` in e premendo *F9*.
...
Inoltre, è possibile trovare i log di diagnostica `Azure Dev Spaces` in directory nella [directory *temporanea* del computer di sviluppo][azds-tmp-dir].
