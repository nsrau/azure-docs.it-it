...
Fare clic su *Debug* e quindi su *Arresta debug* per arrestare il debugger. Click on the Azure Dev Spaces status bar to disconnect from the AKS cluster.
