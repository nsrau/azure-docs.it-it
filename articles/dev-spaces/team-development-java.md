...
ms.date: 08/01/2018
ms.topic: tutorial
description: Questa esercitazione illustra come usare Azure Dev Spaces e Visual Studio Code per lo sviluppo in team di un'applicazione Java nel servizio Azure Kubernetes
...
* Di conseguenza, l'esecuzione di qualsiasi tipo di test di integrazione diventa difficile. I test di integrazione possono avvenire in modo realistico solo dopo il commit, il che significa che i problemi verranno riscontrati più avanti nel ciclo di sviluppo.
    ...
    ![Diagramma che illustra i problemi da affrontare durante lo sviluppo di microservizi.](media/common/microservices-challenges.png)
...
![Diagramma che illustra una semplice configurazione dello spazio CI/CD.](media/common/ci-cd-space-setup.png)
