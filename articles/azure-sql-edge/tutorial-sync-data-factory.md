---
title: Sincronizzare i dati da SQL Edge di Azure (anteprima) con Azure Data Factory
description: Informazioni sulla sincronizzazione dei dati tra SQL Edge di Azure (anteprima) e l'archivio BLOB di Azure
