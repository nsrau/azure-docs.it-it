---
title: sys.external_streaming_jobs (Transact-SQL) - SQL Edge di Azure (anteprima)
description: Informazioni sull'uso di sys.external_streaming_jobs in SQL Edge di Azure (anteprima)
