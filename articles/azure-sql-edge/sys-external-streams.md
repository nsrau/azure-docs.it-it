---
title: sys.external_streams (Transact-SQL) - SQL Edge di Azure (anteprima)
description: Informazioni sull'uso di sys.external_streams in SQL Edge di Azure (anteprima)
