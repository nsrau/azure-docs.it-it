---
title: DROP EXTERNAL STREAM (Transact-SQL) - SQL Edge di Azure (anteprima)
description: Informazioni sull'istruzione DROP EXTERNAL STREAM in SQL Edge di Azure (anteprima)
keywords: ''
services: sql-edge
ms.service: sql-edge
ms.topic: conceptual
