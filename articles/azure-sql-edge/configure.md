...
|**Contratti di licenza con l'utente finale di MLServices** | Accettare i contratti di licenza R e Python per i pacchetti Azure Machine Learning. Si applica solo a SQL Server 2019.|
