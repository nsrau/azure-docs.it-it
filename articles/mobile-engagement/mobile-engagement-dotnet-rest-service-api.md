...
1. Aggiungere il codice seguente per il metodo `Main` per generare un token di autenticazione con i parametri di autenticazione raccolti:
...
4. Compilare ed eseguire l'app console. L'output dovrebbe essere simile al seguente:
