...
10. `setTestLogEnabled` è un'istruzione facoltativa che consente ai registri SDK di identificare i problemi.
...
1. In **AppDeletegate.m** file, importare il modulo Reach di Engagement.
