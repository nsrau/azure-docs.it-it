...
> [!NOTE]
> Gli utenti per i quali l'info app user\_name non è impostata non riceveranno notifiche. Se si esegue una campagna di notifica in modalità di test, e se le informazioni sull’app non sono impostate, verrà inviato un carattere '?' per sostituire il segnaposto.
> 
> 
