...
<li>Se non si dispone di un account Azure, <a href="http://azure.microsoft.com/pricing/free-trial/">iscriversi per una versione di prova gratuita</a>.</li>
</ul>
</li>
...
<li>Per aggiungere un server Web o un server applicazioni alla farm, vedere <a href="http://technet.microsoft.com/library/cc261752.aspx">Aggiungere server Web o server applicazioni a farm in SharePoint 2013</a>.</li>
<li>
...
<ol>
<li><em>Provision</em>: eseguire innanzitutto il provisioning di una connessione VPN tra l'ambiente locale e Azure tramite Rete virtuale di Azure. Poiché in questo caso non si usa Active Directory, è necessario un tunnel VPN. For more information, go to <a href="http://msdn.microsoft.com/library/windowsazure/jj156007.aspx">Azure Virtual Network (Design Considerations and Secure Connection Scenarios)</a>. Usare quindi il portale di gestione per eseguire il provisioning di una nuova macchina virtuale da un'immagine della raccolta.
<ul>
