	<properties title="Web service: Forecasting - Autoregressive Integrated Moving Average (ARIMA)" pageTitle="Previsioni - Modello autoregressivo integrato a media mobile (ARIMA) | Azure" description="Previsioni - Modello autoregressivo integrato a media mobile (ARIMA)" metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="jaymathe" manager="paulettm" editor="cgronlun" videoId="" scriptId="" />

<tags ms.service="machine-learning" ms.workload="data-services" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="10/08/2014" ms.author="jaymathe" /> 

 
#Previsioni - Modello autoregressivo integrato a media mobile (ARIMA)
...
In Azure ML è stato creato un nuovo esperimento vuoto. Sono stati caricati dati di input di esempio con uno schema dati predefinito. Un modulo "Execute R Script" è collegato allo schema dati e genera il modello di previsione ARIMA usando le funzioni 'auto.arima' e 'forecast' di R. 
