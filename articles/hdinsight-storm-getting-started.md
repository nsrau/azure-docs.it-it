<properties
	pageTitle="Esercitazione di Apache Storm: Provare esempi Storm Starter | Microsoft Azure"
	description="Introduzione all'analisi di Big Data mediante Apache Storm eseguendo esempi di Storm Starter in HDInsight. Informazioni su come usare Apache Storm per elaborare i dati in tempo reale."
	services="hdinsight"
	documentationCenter=""
	authors="Blackmist"
	manager="paulettm"
...
# Esercitazione di Apache Storm in HDInsight: Introduzione all'analisi di Big Data mediante esempi di Storm Starter 
...
2. Fare clic su **NUOVO** nell'angolo inferiore sinistro, selezionare **SERVIZI DATI**, quindi **ARCHIVIAZIONE** e infine su **CREAZIONE RAPIDA**.
	...
	![Portale di Azure dove è possibile usare la funzione di creazione rapida per configurare un nuovo account di archiviazione.](./media/hdinsight-storm-getting-started/HDI.StorageAccount.QuickCreate.png)
...
![Portale di Azure con collegamento a Storm Dashboard](./media/hdinsight-storm-getting-started/dashboard-link.png)
...
![Storm Dashboard con modulo per l'invio della topologia](./media/hdinsight-storm-getting-started/submit.png)
...
1. Selezionare **StormStarter - WordCount** dall'elenco a discesa **Jar File**. Nei campi **Class Name** e **Additional Parameters** verranno inseriti i parametri relativi a questo esempio.
	...
	![Storm Dashboard con WordCount selezionato](./media/hdinsight-storm-getting-started/submit.png)
...
2. Fare clic sul pulsante **Submit**. Dopo qualche secondo, nel campo **Result** verrà visualizzato il comando usato per inviare il processo nonché i risultati di tale comando. Il campo **Error** visualizzerà eventuali errori verificatisi nella topologia di invio.
	...
	![Pulsante Submit e risultati](./media/hdinsight-storm-getting-started/submit-results.png)
...
1. Selezionare **Storm UI** nella parte superiore di Storm Dashboard. Verranno visualizzate informazioni di riepilogo relative al cluster e a tutte le topologie in esecuzione.
	...
	![Interfaccia utente Storm con riepilogo della topologia](./media/hdinsight-storm-getting-started/stormui.png)
...
4. Nella sezione **Topology summary** selezionare la voce **wordcount** nella colonna **Name**. Verranno visualizzate altre informazioni sulla topologia.
	...
	![Interfaccia utente Storm](./media/hdinsight-storm-getting-started/topology-summary.png)
...
5. In questa pagina selezionare una voce nella sezione **Spouts** o **Bolts**. Verranno visualizzate informazioni relative al componente selezionato.
	...
	![Interfaccia utente Storm](./media/hdinsight-storm-getting-started/component-summary.png)
