...
* Se non si ha familiarità con Apache Storm, leggere la [panoramica su HDInsight Storm](/it-it/documentation/articles/hdinsight-storm-overview) prima di iniziare.
