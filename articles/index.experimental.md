        ...
        <ul class="pivots">
            ...
            <li>
                ...
                <ul id="services">
                    <li>
                        ...
                        <ul id="all" class="directory">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/bing-spell-check/proof-text">
                                                ...
                                                <p>Controllo ortografico Bing</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/custom-speech-service/cognitive-services-custom-speech-home">
                                                ...
                                                <p>Servizio di riconoscimento vocale personalizzato</p>
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="https://azure.microsoft.com/develop/iot/">
                                                ...
                                                <p>Centro per sviluppatori IoT</p>
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <div class="group">
                                    <h3>Web e dispositivi mobili</h3>
                                    <ul>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/active-directory-domain-services">
                                                <img src="media/index/ActiveDirectory.svg" alt="" />
                                                <p>Servizi di dominio Azure Active Directory</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Macchine virtuali Linux</h3>
                                                    <p>Effettuare il provisioning di macchine virtuali di Ubuntu, Red Hat e molto altro</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Macchine virtuali Windows</h3>
                                                    <p>Effettuare il provisioning di macchine virtuali per SQL Server, SharePoint e molto altro</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Funzioni</h3>
                                                    <p>Elaborare eventi con codice senza server</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Servizi cloud</h3>
                                                    <p>Creare API e applicazioni cloud a elevata disponibilità e scalabilità infinita</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Panoramica delle reti</h3>
                                                    <p>Visualizzazione integrata dei servizi di rete in Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Rete virtuale</h3>
                                                    <p>Effettuare il provisioning di reti private, con connessione facoltativa a data center locali</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>DNS di Azure</h3>
                                                    <p>Ospitare il dominio DNS in Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#storage">Archiviazione</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Archiviazione</h3>
                                                    <p>Archiviazione cloud durevole, con scalabilità e disponibilità elevate</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#web">Web e dispositivi mobili</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>App per dispositivi mobili</h3>
                                                    <p>Sviluppare e ospitare il back-end per qualsiasi app per dispositivi mobili</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>App per la logica</h3>
                                                    <p>Automatizzare l'accesso e l'uso dei dati tra cloud senza scrivere codice</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Servizi multimediali</h3>
                                                    <p>Codifica, archiviazione e distribuzione in streaming di audio e video scalabili</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#containers">Contenitori</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>PostgreSQL</h3>
                                                    <p>Servizio di database PostgreSQL gestito per gli sviluppatori di app</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MySQL</h3>
                                                    <p>Servizio di database MySQL gestito per gli sviluppatori di app</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Estrarre informazioni di utilità pratica dalle immagini</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Viso</h3>
                                                    <p>Rilevare, identificare, analizzare, organizzare e contrassegnare con tag i visi nelle foto</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Ricerca Web Bing</h3>
                                                    <p>Connettere funzionalità di ricerca Web avanzate alle app</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Servizio di riconoscimento vocale personalizzato</h3>
                                                    <p>Superare le barriere del riconoscimento vocale</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>LUIS (Language Understanding Intelligent Service)</h3>
                                                    <p>Insegnare alle app a riconoscere i comandi degli utenti</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Ricerca personalizzata Bing</h3>
                                                    <p>Compilare i risultati della ricerca desiderati</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HDInsight</h3>
                                                    <p>Effettuare il provisioning di cluster cloud Hadoop, Spark, R Server, Hbase e Storm</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Servizio di analisi distribuito che semplifica l'uso di Big Data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Integrare straordinarie visualizzazioni interattive dei dati nelle app</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Centro per sviluppatori IoT</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Hub eventi</h3>
                                                    <p>Ricevere dati di telemetria da milioni di dispositivi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#integration">Integrazione aziendale</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bus di servizio</h3>
                                                    <p>Connessione tra ambienti cloud privati e pubblici</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#security">Sicurezza e identità</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gestione di identità e accessi degli utenti nel cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rilevare, valutare e diagnosticare i problemi nelle app e nei servizi Web</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HockeyApp</h3>
                                                    <p>Distribuire app per dispositivi mobili, raccogliere commenti, suggerimenti e report sugli arresti anomali e monitorare l'utilizzo</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Automazione</h3>
                                                    <p>Semplificare la gestione del cloud grazie all'automazione dei processi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Utilità di pianificazione</h3>
                                                    <p>Esecuzione dei processi in base a una pianificazione semplice o complessa</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Monitoraggio di Azure</h3>
                                                    <p>Dati di monitoraggio altamente granulari e in tempo reale per qualsiasi risorsa di Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Microsoft Azure Germania</h3>
                                                    <p>Compilare e ospitare applicazioni nel rispetto delle normative tedesche nonché dei principali standard internazionali, con un controllo aggiuntivo da parte di un trustee dei dati</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://azure.github.io/azure-sdk-for-node/">Introduzione</a>
                                                </p>
                                                <p>
                                                    <a href="https://azure.github.io/azure-sdk-for-node/">Informazioni di riferimento sulle API</a>
                                                </p>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/powershell/azure/azurerm/install-azurerm-ps">Scaricare PowerShell</a>
                                                </p>
                                                <p>
                ...
                <ul id="architecture">
                    <li>
                        ...
                        <ul id="architecture1" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>Set di architetture consigliate per le applicazioni cloud. Ogni architettura include procedure consigliate, passaggi esaustivi e un componente eseguibile che incorpora i suggerimenti.</p>
                                </div>
                            </li>
                            <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Set di architetture consigliate per il cloud. Ogni architettura include procedure consigliate, passaggi esaustivi e una soluzione distribuibile.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Set di procedure consigliate per le applicazioni cloud, che illustra aspetti come la scalabilità automatica, la memorizzazione nella cache, il partizionamento dei dati, la progettazione di API e il monitoraggio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
