<properties title="How to make a phone call from Twilio (PHP) - Azure" pageTitle="Come effettuare una chiamata da Twilio (PHP) - Azure" metaKeywords="Twilio in Azure con PHP, Twilio in Azure, telefonate in Azure, Twilio in Azure, SMS in Azure, SMS in Azure, chiamate vocali in Azure, chiamate vocali in Azure, messaggi di testo in Azure, messaggi di testo in Azure, Twilio in Azure con PHP" description="Learn how to make a phone call and send a SMS message with the Twilio API service on Azure. Samples are for PHP application." documentationCenter="PHP" services="" solutions="" videoId="" scriptId="" authors="MicrosoftHelp@twilio.com; robmcm" manager="twilio" editor="mollybos" />
