...
-   Anziché utilizzare un modulo Web, è possibile utilizzare l'archiviazione BLOB o un database SQL di Azure per l'archiviazione di numeri di telefono e testo delle chiamate. Per informazioni sull'utilizzo dei BLOB di archiviazione di Azure in PHP, vedere [Utilizzo dell'archiviazione di Azure con applicazioni PHP](http://msdn.microsoft.com/en-us/library/windowsazure/hh674502(v=vs.103).aspx). Per informazioni sull'utilizzo di database SQL in PHP, vedere [Utilizzo del database SQL di Azure con applicazioni PHP](http://msdn.microsoft.com/en-us/library/windowsazure/hh674500(v=vs.103).aspx).
