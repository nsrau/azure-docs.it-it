---
title: Uso dell'emulatore Express per l'esecuzione e il debug di un servizio cloud in un computer locale | Microsoft Docs
...
3. In **Emulatore**, scegliere il pulsante di opzione **Usa Emulator Express**.
