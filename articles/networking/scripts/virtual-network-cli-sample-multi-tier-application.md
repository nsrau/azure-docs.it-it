---
title: Esempio di script dell'interfaccia della riga di comando di Azure- Creare una rete per applicazioni multilivelloAzure CLI script sample - Create a network for multi-tier applications
