...
Questo articolo descrive l'analisi del piano di controllo della [configurazione di test][Setup]. È anche possibile esaminare la [configurazione di test][Configuration] e l' [analisi del piano dati][Data-Analysis] della configurazione del test.
