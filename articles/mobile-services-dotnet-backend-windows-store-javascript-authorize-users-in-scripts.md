...
1.  In Visual Studio aprire il progetto modificato dopo aver completato l'esercitazione di [Introduzione all'autenticazione](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started-users).
...
-   [Introduzione ai dati](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started-data)
...
-   [Come utilizzare un client HTML/JavaScript per Servizi mobili di Azure](/en-us/documentation/articles/mobile-services-html-how-to-use-client-library)
