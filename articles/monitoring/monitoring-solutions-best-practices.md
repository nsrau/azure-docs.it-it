...
Questo articolo riporta le procedure consigliate per la [creazione di una soluzione di gestione](monitoring-solutions-solution-file.md) in Azure.  Queste informazioni verranno aggiornate quando saranno identificate procedure consigliate aggiuntive.
...
- Configurare la soluzione in modo che [contenga](monitoring-solutions-solution-file.md#solution-resource) la vista, affinché venga rimossa se la soluzione viene rimossa.
...
* Illustra il processo di base di [progettazione e creazione di una soluzione di gestione](monitoring-solutions-creating.md).
* Informazioni su come [creare un file di soluzione](monitoring-solutions-solution-file.md).
