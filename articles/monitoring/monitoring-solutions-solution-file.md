...
Quando un utente [installa la soluzione di gestione](monitoring-solutions.md#install-a-management-solution) tramite Azure Marketplace o i modelli di avvio rapido di Azure, viene chiesto di selezionare un'[area di lavoro di Log Analytics e un account di Automazione](monitoring-solutions.md#log-analytics-workspace-and-automation-account).  Questi elementi vengono usati per popolare i valori di ognuno dei parametri standard.  All'utente non viene chiesto di fornire direttamente i valori per i parametri standard, ma viene chiesto di fornire i valori per eventuali parametri aggiuntivi.
...
- [Risorse di Automazione](monitoring-solutions-resources-automation.md#sample)
- [Risorse di ricerca e di avviso](monitoring-solutions-resources-searches-alerts.md#sample)


## <a name="next-steps"></a>Passaggi successivi
* [Aggiungere ricerche salvate e avvisi](monitoring-solutions-resources-searches-alerts.md) alla soluzione di gestione.
* [Aggiungere viste](monitoring-solutions-resources-views.md) alla soluzione di gestione.
* [Aggiungere runbook e altre risorse di automazione](monitoring-solutions-resources-automation.md) alla soluzione di gestione.
