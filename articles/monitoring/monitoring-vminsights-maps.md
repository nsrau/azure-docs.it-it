...
![Proprietà di sistema del computer](./media/monitoring-vminsights-maps/properties-pane-01.png)
...
![Elenco di ricerca log nel riquadro Proprietà](./media/monitoring-vminsights-maps/properties-pane-logs-01.png)
...
![Avvisi del computer nel riquadro Proprietà](./media/monitoring-vminsights-maps/properties-pane-alerts-01.png)
...
![Esempio di riquadro dei grafici di connettività di rete](./media/monitoring-vminsights-maps/map-group-network-conn-pane-01.png)  
...
![Esempio di connessione non riuscita sulla mappa](./media/monitoring-vminsights-maps/map-group-failed-connection-01.png)
...
![Esempio di gruppi di client sulla mappa](./media/monitoring-vminsights-maps/map-group-client-groups-01.png)
...
![Esempio di elenco di indirizzi IP del gruppo di client sulla mappa](./media/monitoring-vminsights-maps/map-group-client-group-iplist-01.png)
...
![Esempio di gruppo di porte di server sulla mappa](./media/monitoring-vminsights-maps/map-group-server-port-groups-01.png)  
...
![Panoramica di mappe direttamente da macchina virtuale](./media/monitoring-vminsights-maps/map-direct-vm-01.png)
