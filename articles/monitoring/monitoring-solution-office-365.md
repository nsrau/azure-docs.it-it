...
Per iniziare, aggiungere la [soluzione di Office 365 alla sottoscrizione](monitoring-solutions.md#install-a-management-solution). Dopo aver aggiunto la soluzione, è necessario eseguire i passaggi di configurazione descritti in questa sezione per consentire l'accesso alla sottoscrizione di Office 365.
...
1. Fare clic su **Registrazione nuova applicazione**.
    ...
    ![Aggiungere la registrazione per l'app](media/monitoring-solution-office-365/add-app-registration.png)
1. Impostare **Nome** e **URL di accesso** per l'applicazione.  Il nome deve essere descrittivo.  Usare _http://localhost_ per l'URL e lasciare _App Web/API_ come **Tipo di applicazione**.
    ...
    ![Creare l'applicazione](media/monitoring-solution-office-365/create-application.png)
1. Fare clic su **Crea** e convalidare le informazioni dell'applicazione.

    ![App registrata](media/monitoring-solution-office-365/registered-app.png)
...
1. Selezionare **Proprietà**. Impostare **Multi-tenant** su _Sì_.
    ...
    ![Impostazioni multi-tenant](media/monitoring-solution-office-365/settings-multitenant.png)
...
1. Fare clic su **Selezionare un'API** e quindi **Office 365 Management APIs** (API di gestione di Office 365). Fare clic su **Office 365 Management APIs** (API di gestione di Office 365). Fare clic su **Seleziona**.
    ...
    ![Selezionare l'API](media/monitoring-solution-office-365/select-api.png)
...
1. In **Selezionare le autorizzazioni** selezionare le opzioni seguenti per **Autorizzazioni applicazione** e **Autorizzazioni delegate**:
    ...
    ![Selezionare l'API](media/monitoring-solution-office-365/select-permissions.png)
...
1. Fare clic su **Concedi autorizzazioni** e quindi su **Sì** quando viene chiesto di confermare.
    ...
    ![Concedere le autorizzazioni](media/monitoring-solution-office-365/grant-permissions.png)
...
1. Fare clic su **Salva** e quindi copiare il **valore** che viene generato.
    ...
    ![Chiavi](media/monitoring-solution-office-365/keys.png)
...
1. Verrà visualizzata una finestra simile alla seguente. Fare clic **Accept**.
    ...
    ![Consenso dell'amministratore](media/monitoring-solution-office-365/admin-consent.png)
...
![Riquadro di riepilogo di Office 365](media/monitoring-solution-office-365/tile.png)  

Fare clic sul riquadro **Office 365** per aprire la dashboard di **Office 365**.

![Dashboard di Office 365](media/monitoring-solution-office-365/dashboard.png)  
