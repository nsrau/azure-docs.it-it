...
* Identificare i contenitori AKS in esecuzione nel nodo e il relativo uso medio del processore e della memoria, in modo da individuare facilmente i colli di bottiglia delle risorse.
...
Per iniziare a monitorare un cluster AKS, esaminare [Come eseguire l'onboarding di Monitoraggio di Azure per contenitori](monitoring-container-insights-onboard.md) per conoscere i requisiti e i metodi disponibili per abilitare il monitoraggio.  