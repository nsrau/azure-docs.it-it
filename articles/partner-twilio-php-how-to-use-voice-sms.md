...
Per altre informazioni, vedere [][2]<https://github.com/twilio/twilio-php/blob/master/README.md></a>.
...
-   **Nota**: Per la risoluzione dei problemi relativi a errori di convalida del certificato SSL, vedere [][3]<http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html></a>
...
Per altre informazioni su TwiML, vedere [][6]<https://www.twilio.com/docs/api/twiml></a>.
...
-   [Contattare il supporto di Twilio][Contattare il supporto di Twilio]
  ...
  [Come effettuare una chiamata tramite Twilio in un'applicazione PHP in Azure]: ../partner-twilio-php-make-phone-call
