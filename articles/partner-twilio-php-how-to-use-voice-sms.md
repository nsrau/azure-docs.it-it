<properties 
	pageTitle="Come usare Twilio per le funzionalità voce e SMS (PHP) - Azure" 
...
Per ulteriori informazioni sull'utilizzo di Twilio in Azure con PHP, vedere [Come effettuare una chiamata tramite Twilio in un'applicazione PHP in Azure][howto_phonecall_php].
