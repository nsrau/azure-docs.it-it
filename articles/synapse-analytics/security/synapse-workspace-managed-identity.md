---
title: Identità gestita nell'area di lavoro di Azure Synapse
...
[Concessione delle autorizzazioni all'identità gestita dell'area di lavoro di Azure Synapse](./how-to-grant-workspace-managed-identity-permissions.md)
