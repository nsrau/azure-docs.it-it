...
Questo articolo illustra come scrivere una query usando SQL su richiesta (anteprima) in Azure sinapsi Analytics. L'obiettivo della query è leggere i file JSON.
