...
- Se viene chiamata senza un parametro, restituisce il percorso completo del file da cui ha origine la riga. Quando DATA_SOURCE viene utilizzato in OPENROWSET, restituisce il percorso relativo DATA_SOURCE. 
