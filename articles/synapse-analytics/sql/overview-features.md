...
|   | Sottoposto a provisioning | Senza server |
| --- | --- | --- |
| Logins | N/A (sono supportati solo gli utenti contenuti nei database) | Sì |
...
| Azure Data Studio | Sì | Sì, versione 1.14 o successiva. Gli script SQL e i notebook SQL sono supportati. |
| SQL Server Management Studio | Sì | Sì, versione 18.4 o successiva |
