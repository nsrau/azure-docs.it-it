---
title: Inserire in Azure Data Lake Storage Gen2 in Azure sinapsi Analytics
description: Informazioni su come inserire dati in Azure Data Lake Storage Gen2 in Azure sinapsi Analytics
...
---
# <a name="ingesting-data-into-azure-data-lake-storage-gen2"></a>Inserimento di dati in Azure Data Lake Storage Gen2 

In questo articolo si apprenderà come inserire dati da una posizione a un'altra in un account di archiviazione Azure Data Lake generazione 2 (Azure Data Lake gen 2) usando Azure sinapsi Analytics.
...
Una pipeline contiene il flusso logico per l'esecuzione di un set di attività. In questa sezione verrà creata una pipeline contenente un'attività di copia che inserisce i dati da Azure Data Lake generazione 2 in un pool SQL.
...
1. Selezionare Azure Data Lake Storage Gen2 come archivio dati e fare clic su continua.
1. Selezionare DelimitedText come formato e fare clic su continue (continua).
1. Nel riquadro imposta proprietà selezionare il servizio collegato ADLS creato. Specificare il percorso della cartella in cui si desidera scrivere i dati. Al termine, fare clic su OK.
...
Per altre informazioni sull'integrazione dei dati per l'analisi delle sinapsi, vedere l'articolo inserimento di [dati in un pool SQL](data-integration-sql-pool.md) .
