...
Per altre informazioni sull'integrazione dei dati per Azure sinapsi Analytics, vedere l'articolo inserimento di [dati in un pool SQL dedicato](data-integration-sql-pool.md) .
