...
Per sviluppare altre informazioni sull'endpoint privato gestito in Azure sinapsi Analytics, vedere [endpoint privati gestiti](../security/synapse-workspace-managed-private-endpoints.md).


Per altre informazioni sull'integrazione dei dati per Azure sinapsi Analytics, vedere l'articolo inserimento di [dati in un data Lake](data-integration-data-lake.md) .
