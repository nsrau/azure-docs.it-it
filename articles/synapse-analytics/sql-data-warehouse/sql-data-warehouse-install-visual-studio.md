...
- Alcune funzionalità T-SQL, ad esempio:
   - Clausola *within Group* nella funzione [STRING_AGG](/sql/t-sql/functions/string-agg-transact-sql?view=sqlallproducts-allversions) String.
