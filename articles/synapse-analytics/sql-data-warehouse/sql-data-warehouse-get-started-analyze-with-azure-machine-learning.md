...
Per pulire i dati, eliminare alcune colonne non rilevanti per il modello. Per eseguire questa operazione:
...
Si suddivideranno i dati 80-20: 80% per il training di un modello di Machine Learning e 20% per testare il modello. Per questo problema di classificazione binaria verrà usato l'algoritmo a due classi.
