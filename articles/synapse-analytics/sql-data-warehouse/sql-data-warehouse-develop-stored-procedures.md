...
Il pool SQL non supporta attualmente [.@NESTLEVEL](/sql/t-sql/functions/nestlevel-transact-sql?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest) Come tale, è necessario monitorare il livello del nido. È improbabile che superi il limite di otto anni di nidificazione. Tuttavia, in tal caso, è necessario rielaborare il codice per adattarlo ai livelli di annidamento entro questo limite.
