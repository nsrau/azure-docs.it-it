...
* SQL Server Management Studio (SSMS) installato. [Installare SSMS](https://msdn.microsoft.com/library/hh213248.aspx) gratuitamente se non è già stato installato.
