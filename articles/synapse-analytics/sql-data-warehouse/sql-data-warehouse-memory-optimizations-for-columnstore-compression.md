...
DMV sys.dm_pdw_nodes_db_column_store_row_group_physical_stats ([sys.dm_db_column_store_row_group_physical_stats](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-db-column-store-row-group-physical-stats-transact-sql) contiene la definizione della vista corrispondente al db SQL) che espone informazioni utili, ad esempio il numero di righe nei gruppi di righe e il motivo del taglio, se è stato eseguito il taglio. 
