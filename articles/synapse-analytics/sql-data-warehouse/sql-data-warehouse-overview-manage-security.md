...
Azure Synapse Analytics usa le regole del firewall IP a livello di server. Non supporta le regole del firewall IP a livello di database. Per altre informazioni, vedere Regole del firewall del database SQL di AzureFor more [information,](../../sql-database/sql-database-firewall-configure.md) see Azure SQL Database firewall rules
