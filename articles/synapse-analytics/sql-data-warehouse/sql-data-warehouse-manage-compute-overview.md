---
title: Gestire le risorse di calcolo per il pool SQLManage compute resource for SQL pool
description: Informazioni sulle funzionalità di scalabilità orizzontale delle prestazioni in un pool SQL di Azure Synapse Analytics.Learn about performance scale out capabilities in an Azure Synapse Analytics SQL pool. Applicare la scalabilità orizzontale modificando le DWU o ridurre i costi tramite la sospensione delle funzioni di data warehouse.
