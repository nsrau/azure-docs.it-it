...
description: Suggerimenti per la progettazione di tabelle replicate in ANALISI SQLRecommendations for designing replicated tables in SQL Analytics
...
- [CREA TABELLA (SQL Analytics)](/sql/t-sql/statements/create-table-azure-sql-data-warehouse)
- [CREA TABELLA COME SELEZIONE (SQL Analytics)](/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse)
