...
| Come implementare le procedure consigliate                              | Il punto migliore per iniziare a scoprire come migliorare le prestazioni delle query è l'articolo delle procedure consigliate di [SQL Analytics.](sql-data-warehouse-best-practices.md) |
...
| Analisi dell'uso dello spazio                              | Per comprendere l'uso dello spazio nel sistema, vedere [Dimensioni delle tabelle]( ../../sql-data-warehouse/sql-data-warehouse-tables-overview.md#table-size-queries) . |
