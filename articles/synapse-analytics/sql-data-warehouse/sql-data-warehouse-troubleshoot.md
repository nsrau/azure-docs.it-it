---
title: Risoluzione dei problemi relativi al pool SQL dedicato
description: Risoluzione dei problemi relativi al pool SQL dedicato in Azure sinapsi Analytics.
...
| Come implementare le procedure consigliate                              | Per informazioni su come migliorare le prestazioni delle query, vedere l'articolo procedure consigliate per il [pool SQL dedicato](sql-data-warehouse-best-practices.md) . |
| Come migliorare le prestazioni con la scalabilità                      | A volte la soluzione per migliorare le prestazioni consiste nel aggiungere semplicemente una maggiore potenza di calcolo alle query [scalando il pool SQL dedicato](sql-data-warehouse-manage-compute-overview.md). |
