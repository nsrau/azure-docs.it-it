---
title: Risolvere i problemi di connettività tra sinapsi studio e archiviazione
description: Risolvere i problemi di connettività tra sinapsi studio e archiviazione
author: saveenr
...
ms.locfileid: "94557869"
---
# <a name="troubleshoot-connectivity-between-azure-synapse-analytics-synapse-studio-and-storage"></a>Risolvere i problemi di connettività tra l'analisi sinapsi di Azure sinapsi studio e archiviazione

In sinapsi Studio (anteprima) è possibile esplorare le risorse dei dati presenti nella risorsa di archiviazione collegata. Questa guida consente di risolvere i problemi di connettività quando si tenta di accedere alle risorse di dati. 
