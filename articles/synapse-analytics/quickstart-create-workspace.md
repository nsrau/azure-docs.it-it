...
1. Confermare l'eliminazione e premere il pulsante **Elimina**.
...
Successivamente, è possibile [creare pool SQL](quickstart-create-sql-pool.md) o [pool di Apache Spark](quickstart-create-apache-spark-pool.md) per iniziare ad analizzare ed esplorare i dati.
