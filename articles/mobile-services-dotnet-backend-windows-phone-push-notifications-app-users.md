...
Questa esercitazione supporta app per Windows Phone 8.0 e Windows Phone 8.1 ("Silverlight"). Per le app di Windows Phone 8.1 Store, vedere la [versione per Windows Store di questo argomento](mobile-services-dotnet-backend-windows-store-dotnet-push-notifications-app-users.md).
