...
2.  Aprire questo file di script nella cartella di progetto `\js` e impostare come commento il codice esistente che definisce l'[oggetto MobileServiceClient][oggetto MobileServiceClient] per accedere al servizio mobile in esecuzione su Azure.
