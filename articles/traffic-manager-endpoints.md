<properties 
   pageTitle="Gestire gli endpoint in Gestione traffico"
...
>[AZURE.NOTE] Non è possibile aggiungere i percorsi esterni o i profili di Gestione traffico come endpoint mediante il portale di gestione. È necessario usare l'API REST [Create Definition](http://go.microsoft.com/fwlink/p/?LinkId=400772) oppure Windows PowerShell [Add-AzureTrafficManagerEndpoint](http://go.microsoft.com/fwlink/p/?LinkId=400774).
...
3. Fare clic sull'endpoint da disabilitare, quindi scegliere il comando per **Disabilitarlo** nella parte inferiore della pagina.
...
1. Nel riquadro di Gestione traffico nel portale di gestione individuare il profilo di Gestione traffico in cui sono contenute le impostazioni degli endpoint da modificare, quindi fare clic sulla freccia a destra del nome del profilo. Verrà aperta la pagina delle impostazioni per il profilo.
2. Per visualizzare gli endpoint inclusi nella configurazione, fare clic su **Endpoint** nella parte superiore della pagina.
3. Fare clic sull'endpoint da abilitare, quindi scegliere il comando per **Abilitarlo** nella parte inferiore della pagina.
...
>[AZURE.NOTE] Non è possibile eliminare i percorsi esterni o i profili di Gestione traffico come endpoint mediante il portale di gestione. È necessario usare Windows PowerShell. Per altre informazioni, vedere [Remove-AzureTrafficManagerEndpoint](https://msdn.microsoft.com/library/dn690251.aspx).
