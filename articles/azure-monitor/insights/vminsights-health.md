...
![Esempio di rollup dell'integrità](./media/vminsights-health/health-diagnostics-windows-svc-rollup.png)
...
![Configurazione di un esempio di criteri di integrità](./media/vminsights-health/health-diagnostics-linuxvm-example-03.png)
...
![Configurazione di criteri di integrità per un esempio di monitoraggio unità](./media/vminsights-health/health-diagnostics-linuxvm-example-04.png)
...
![Esempio di selezione dell'istanza monitorata e dei risultati](./media/vminsights-health/health-diagnostics-linuxvm-example-02.png)
