...
Per installare la nuova versione dell'agente, seguire i passaggi descritti nell'articolo [Eseguire l'onboarding del monitoraggio](container-insights-onboard.md?#enable-using-azure-cli) usando l'interfaccia della riga di comando di Azure per completare questo processo.  
