...
1. Se la macchina virtuale non è già connessa a un'area di lavoro Log Analytics, verrà chiesto di selezionarne una. Se in precedenza non è stata [creata un'area di lavoro](../learn/quick-create-workspace.md), è possibile selezionare un valore predefinito per il percorso in cui è distribuita la macchina virtuale o vmss nella sottoscrizione. Questa area di lavoro verrà creata e configurata se non esiste già.
