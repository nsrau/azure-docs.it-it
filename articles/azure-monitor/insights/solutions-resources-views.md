...
Le [soluzioni di gestione](solutions.md) includeranno in genere una o più visualizzazioni per visualizzare i dati.  Questo articolo descrive come esportare una vista creata da [Progettazione viste](../../azure-monitor/platform/view-designer.md) e includerla in una soluzione di gestione.  
