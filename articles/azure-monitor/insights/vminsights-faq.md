...
La funzionalità di integrità è abilitata per tutte le macchine virtuali connesse all'area di lavoro di Log Analytics, anche quando l'operazione viene avviata per una singola macchina virtuale.
