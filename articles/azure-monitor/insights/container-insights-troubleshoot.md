...
Il monitoraggio di Azure per i contenitori dell'agente di contenitori usa l'endpoint cAdvisor nell'agente del nodo per raccogliere le metriche delle prestazioni. Verificare che l'agente in contenitori nel nodo sia configurato in modo `cAdvisor port: 10255` da consentire l'apertura in tutti i nodi del cluster per raccogliere le metriche delle prestazioni.
