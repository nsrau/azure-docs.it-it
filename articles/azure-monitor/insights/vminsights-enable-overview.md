...
Il Management Pack è denominato *Microsoft. IntelligencePacks. ApplicationDependencyMonitor*. Viene scritto nella cartella%Programfiles%\Microsoft Monitoring Agent\Agent\Health Service State\management Packs Packs \. L'origine dati usata dal management pack è %Program files%\Microsoft Monitoring Agent\Agent\Health Service State\Resources\<AutoGeneratedID>\Microsoft.EnterpriseManagement.Advisor.ApplicationDependencyMonitorDataSource.dll.
