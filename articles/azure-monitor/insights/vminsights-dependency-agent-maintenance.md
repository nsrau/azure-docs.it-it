...
3. Per verificare che l'aggiornamento sia stato completato correttamente `install.log` , controllare per informazioni dettagliate sulla configurazione. La directory dei log è *%Programfiles%\Microsoft Dependency Agent\logs*.
