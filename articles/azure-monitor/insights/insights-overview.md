...
Vedere [Panoramica di Monitoraggio di Azure per contenitori](./container-insights-overview.md).
...
Vedere [Monitorare i gruppi di risorse con Monitoraggio di Azure (anteprima)](./resource-group-insights.md).
