...
## <a name="enable-for-new-azure-red-hat-openshift-v3-cluster"></a>Abilitazione per un nuovo cluster di Azure Red Hat OpenShift v3
...
## <a name="enable-for-existing-azure-red-hat-openshift-v3-cluster"></a>Abilitazione per un cluster di Azure Red Hat OpenShift v3 esistente
...
* [Altre informazioni su Monitoraggio di Azure per i contenitori](../insights/container-insights-overview.md).
