...
Per creare un'impostazione di diagnostica, aggiungere una risorsa di tipo <resource namespace>/providers/diagnosticSettings al modello. Questo articolo fornisce esempi per due diversi tipi di risorse, ma è possibile applicare lo stesso modello ad altri tipi di risorse. La raccolta di metriche e log consentiti può variare per ogni tipo di risorsa.

[!INCLUDE [azure-monitor-samples](../../../includes/azure-monitor-resource-manager-samples.md)]


## <a name="diagnostic-setting-for-azure-key-vault"></a>Impostazione di diagnostica per Azure Key Vault 
L'esempio seguente aggiunge due query su log a un'istanza di Azure Key Vault.
...
L'esempio seguente aggiunge due query su log a un database SQL di Azure.
### <a name="template-file"></a>File modello
