...
Seguire [le istruzioni dettagliate](./java-in-process-agent.md) per tutti gli ambienti, anche quelli locali.

 ## <a name="next-steps"></a>Passaggi successivi

* [Ottenere le istruzioni per scaricare l'agente Java](./java-in-process-agent.md)
