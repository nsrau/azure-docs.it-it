...
![Fare clic su Nuovo, Application Insights](./media/windows-services/01-new-asp.png)
...
![Fare clic su Proprietà, selezionare il tasto e premere CTRL+C](./media/windows-services/02-props-asp.png)
...
1. In Visual Studio fare clic con il pulsante destro del mouse sul progetto e scegliere **Gestisci pacchetti NuGet**.
    ...
    ![Fare clic con il pulsante destro del mouse sul progetto e selezionare Gestisci pacchetti NuGet](./media/windows-services/03-nuget.png)
2. Installare il pacchetto Application Insights per le app di Windows Server, "Microsoft.ApplicationInsights.WindowsServer".
   
    ![Cercare "Application Insights"](./media/windows-services/04-ai-nuget.png)
...
È utile impostare la chiave di strumentazione nel codice se si vuole [cambiare la chiave per configurazioni della build diverse](../../azure-monitor/app/separate-resources.md). Se si imposta la chiave nel codice, non è necessario impostarla nel file `.config`.
...
![Conteggio degli eventi in Visual Studio](./media/windows-services/appinsights-09eventcount.png)
...
![Fare clic per visualizzare altri dati.](./media/windows-services/12-first-perf.png)

Fare clic su qualsiasi grafico per visualizzare metriche più dettagliate. [Altre informazioni sulle metriche.](../../azure-monitor/app/web-monitor-performance.md)
...
* Vedere [Domande su Application Insights per ASP.NET](../../azure-monitor/app/troubleshoot-faq.md).
...
![Utilizzare Visual Studio per pubblicare l'app](./media/windows-services/15-publish.png)
