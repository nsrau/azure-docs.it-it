...
Per un elenco completo dei parametri di configurazione, vedere la [pagina GitHub](https://github.com/microsoft/applicationinsights-js#configuration). Alcuni parametri disponibili includono:
