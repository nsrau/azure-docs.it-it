...
La funzionalità di campionamento predefinito può essere disabilitata durante l'aggiunta del servizio Application Insights, nel metodo ```ConfigureServices```, usando ```ApplicationInsightsServiceOptions```:
