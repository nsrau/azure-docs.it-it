...
2. Creare una nuova risorsa di Application Insights e configurare il tipo di applicazione su applicazione Web Java.
    ...
    ![Inserire un nome, scegliere l'app Web Java e fare clic su Crea](./media/java-live/02-create.png)
...
4. Aprire la nuova risorsa e ottenere la rispettiva chiave di strumentazione. Questa chiave dovrà a breve essere incollata nel progetto di codice.
    ...
    ![Nella panoramica della nuova risorsa, fare clic su Proprietà e copiare la chiave di strumentazione](./media/java-live/03-key.png)
...
Potrebbe essere necessario [impostare le eccezioni per l'invio dei dati in uscita](../../azure-monitor/app/ip-addresses.md).
...
![dati di esempio](./media/java-live/5-results.png)
...
[Altre informazioni sulle metriche.](../../azure-monitor/app/metrics-explorer.md)

## <a name="next-steps"></a>Passaggi successivi
* [Aggiungere la telemetria alle pagine Web](javascript.md) per monitorare le visualizzazioni pagina e le metriche utente.
* [Configurare i test Web](../../azure-monitor/app/monitor-web-app-availability.md) in modo da assicurarsi che l'applicazione sia disponibile e reattiva.
* [Acquisire le tracce dei log](java-trace-logs.md)
* [Cercare eventi e log](../../azure-monitor/app/diagnostic-search.md) per facilitare la diagnosi dei problemi.
