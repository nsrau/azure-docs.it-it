...
* [Computer virtuali o fisici locali](snapshot-debugger-vm.md?toc=/azure/azure-monitor/toc.json) che eseguono Windows Server 2012 R2 o versione successiva
...
> [!NOTE]
> Per ulteriori informazioni sulle diverse opzioni dei simboli disponibili, vedere la [documentazione](https://docs.microsoft.com/visualstudio/ide/reference/advanced-build-settings-dialog-box-csharp?view=vs-2019#output
)di Visual Studio. Per ottenere risultati ottimali, è consigliabile usare "full", "Portable" o "embedded".
