...
1. Nella casella **Frequenza** selezionare **Giorno** e nella casella **Intervallo** immettere **1**.
    ...
    ![Finestra di dialogo del trigger di Microsoft Flow](./media/automate-with-flow/flow1.png)
...
1. Fare clic su **Application Insights - Visualize Analytics query Preview** (Application Insights - Visualizza query di Analisi Anteprima).
    ...
    ![Finestra di esecuzione della query di Analisi](./media/automate-with-flow/flow2.png)
...
![ID applicazione nel portale di Azure](./media/automate-with-flow/appid.png) 

- Specificare un nome per la connessione, con l'ID applicazione e la chiave API.

    ![Finestra di connessione di Microsoft Flow](./media/automate-with-flow/flow3.png)
...
- Aggiungere la query di Analisi seguente e quindi selezionare il tipo di grafico di tabella HTML. 
    ...
    ![Finestra di configurazione della query di Analisi](./media/automate-with-flow/flow4.png)
...
1. Fare clic su **Office 365 Outlook - Send an email** (Office 365 Outlook - Invia un messaggio di posta elettronica).
    ...
    ![Finestra di selezione di Office 365 Outlook](./media/automate-with-flow/flow2b.png)
...
1. Nella finestra **Invia un messaggio di posta elettronica** seguire questa procedura:
   ...
   d. Fare clic su **Mostra opzioni avanzate**.
    ...
    ![Configurazione di Office 365 Outlook](./media/automate-with-flow/flow5.png)
...
1. Nel menu di contenuto dinamico seguire questa procedura:
    ...
    ![Finestra di configurazione della posta elettronica di Office 365](./media/automate-with-flow/flow7.png)
...
- Nella casella **Nome flusso** aggiungere un nome per il flusso e quindi fare clic su **Crea flusso**.
    ...
    ![Finestra di creazione del flusso](./media/automate-with-flow/flow8.png)
