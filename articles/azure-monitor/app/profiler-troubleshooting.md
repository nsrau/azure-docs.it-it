...
* La profilatura per le applicazioni ASP.NET Core 3. x non è ancora supportata.
  * Se è necessario disporre di Profiler in, una soluzione alternativa consiste nell'usare [Application Insights Profiler per ASP.NET Core](https://github.com/microsoft/ApplicationInsights-Profiler-AspNetCore). Il profiler è contrassegnato per Linux, ma funziona anche con le applicazioni .NET Core 3.0 e in Windows. Per informazioni dettagliate, vedere [versioni supportate](https://github.com/microsoft/ApplicationInsights-Profiler-AspNetCore#supported-versions).
