...
1. Accedere al progetto [Azure DevOps Services](https://azure.microsoft.com/services/devops/).
...
![Selezionare un'organizzazione di Azure DevOps e quindi installare.](./media/annotations/1-install.png)
...
1. Accedi per il [portale di Microsoft Azure](https://portal.azure.com) e aprire la risorsa di Application Insights che monitora l'applicazione. o [crearne una nuova](../../azure-monitor/app/app-insights-overview.md), se necessario.
2. Aprire il **l'accesso all'API** scheda e copiare la **ID di Application Insights**.
   
    ![In portal.azure.com, aprire la risorsa di Application Insights e scegliere Settings. Aprire API Access. Copiare l'ID applicazione](./media/annotations/2-app-id.png)
...
4. In una finestra del browser separata aprire (o creare) il modello di versione che gestisce le distribuzioni da Azure DevOps Services.
   ...
   ![Fare clic sul segno più per aggiungere attività e selezionare l'annotazione sulla versione di Application Insights. Incollare l'ID di Application Insights.](./media/annotations/3-add-task.png)

    Incollare il **ID applicazione** copiato dalla scheda accesso all'API.
...
5. Nella finestra di Azure creare una nuova chiave API e richiedere una copia.
    ...
    ![Nella scheda accesso all'API nella finestra di Azure, fare clic su Crea chiave API.](./media/annotations/5-create-api-key.png)

    ![Nella scheda chiavi API di creazione fornire un commento, controllare le annotazioni di scrittura e fare clic su Genera chiave. Copiare la nuova chiave.](./media/annotations/6-create-api-key.png)
...
6. Aprire la scheda Configurazione del modello di versione.
    ...
    ![Nella finestra di servizi di Azure DevOps, selezionare la scheda variabile e fare clic su Aggiungi. Impostare il nome su ApiKey e nel valore, incollare la chiave generata e fare clic sull'icona di blocco.](./media/annotations/7-paste-api-key.png)
1. Infine fare clic su **Salva** per salvare la pipeline di versione.
...
Fare clic su un marcatore di annotazione (freccia di colore grigio chiaro) per aprire i dettagli sulla versione, tra cui richiedente, ramo di controllo di origine, versione della pipeline, l'ambiente e altro ancora.

![Fare clic su un marcatore di annotazione della versione.](./media/annotations/8-release.png)
...
2. Ottenere l'ID applicazione e creare una chiave API nella scheda accesso all'API.
