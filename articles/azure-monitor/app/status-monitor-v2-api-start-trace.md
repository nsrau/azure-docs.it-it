...
ms.locfileid: "67478992"
---
# <a name="status-monitor-v2-api-start-applicationinsightsmonitoringtrace-v031-alpha"></a>API v2 di Status Monitor: Start-ApplicationInsightsMonitoringTrace (v0.3.1-alpha)
