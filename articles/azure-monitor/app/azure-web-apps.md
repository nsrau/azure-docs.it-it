...
description: Monitoraggio delle prestazioni applicative per i servizi app di Azure. Chart load and response time, dependency information, and set alerts on performance.
...
2. Dopo aver specificato la risorsa da usare, è possibile scegliere il modo in cui Application Insights deve raccogliere i dati per ogni piattaforma per l'applicazione. ASP.NET app monitoring is on-by-default with two different levels of collection.
...
|Problem Value|Spiegazione|Correzione
|---- |----|---|
