...
**App J2EE** aggiungere il codice seguente al tag `<TelemetryModules>` all'interno di ApplicationInsights.xml
...
**App Spring Boot** aggiungere le proprietà seguenti:
