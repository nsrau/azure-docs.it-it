---
title: Esplorare i log di traccia Java in applicazione Azure Insights (2.5.0-BETA) | Microsoft Docs
description: Eseguire ricerche nelle tracce Log4J o Logback in Application Insights (2.5.0-BETA)
...
ms.locfileid: "68298360"
---
# <a name="explore-java-trace-logs-in-application-insights-250-beta"></a>Esplorare i log di traccia Java in Application Insights (2.5.0-BETA)
...
## <a name="note-if-you-are-using-the-application-insights-java-agent"></a>Nota: se si usa l'agente Java Application Insights

È possibile configurare l'agente Java Application Insights per acquisire automaticamente i log, abilitando la funzionalità nel `AI-Agent.xml` file:
