...
![Tendenze di Application Insights](./media/release-notes-vsix/Trends.png)
...
![Eccezioni in CodeLens](./media/release-notes-vsix/ExceptionsCodeLens.png)
...
![Supporto di ASP.NET Core](./media/release-notes-vsix/NetCoreSupport.png)
...
![Supporto degli strumenti di diagnostica](./media/release-notes-vsix/DiagnosticTools.png)
...
![Menu contestuale del progetto per le app di Windows universale](./media/release-notes-vsix/UniversalContextMenu.png)
...
![Finestra di dialogo di caricamento per le app di Windows universale](./media/release-notes-vsix/UniversalUploadDialog.png)
...
![Notifica di caricamento completato](./media/release-notes-vsix/UploadComplete.png)
...
![Portale di HockeyApp](./media/release-notes-vsix/HockeyAppPortal.png)
...
![Menu contestuale del progetto per le app Windows Form](./media/release-notes-vsix/WinFormContextMenu.png)

Viene aperta la finestra di dialogo di caricamento di HockeyApp, simile a quella di un'app di Windows universale.

![Finestra di dialogo di caricamento per le app di Windows Form](./media/release-notes-vsix/WinFormsUploadDialog.png)
...
![Caricamento completato](./media/release-notes-vsix/LocalSearch.png)
...
![Notifica di registrazione](./media/release-notes-vsix/LoggingToast.png)
...
![Tracce](./media/release-notes-vsix/Traces.png)
...
![Ricerca della corrispondenza](./media/release-notes-vsix/FindMatch.png)
...
![Finestra di ricerca](./media/release-notes-vsix/SearchWindow.png)
...
![Elementi correlati](./media/release-notes-vsix/RelatedItems.png)
...
![Tornare alla schermata precedente](./media/release-notes-vsix/GoBAck.png)
...
![Fare clic sui dettagli dell'eccezione](./media/release-notes-vsix/jumptocode.png)
...
![Eseguire la ricerca in Esplora soluzioni](./media/release-notes-vsix/searchentry.png)
...
![Notifica di pubblicazione completata](./media/release-notes-vsix/publishtoast.png)
...
![Finestra di ricerca](./media/release-notes-vsix/search.png)
...
![Pagina Strumenti di diagnostica](./media/release-notes-vsix/diagtools.png)
...
![Finestra di dialogo Nuovo progetto](./media/release-notes-vsix/newproject.png)
