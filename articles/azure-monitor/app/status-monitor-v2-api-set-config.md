...
ms.locfileid: "67807075"
---
# <a name="status-monitor-v2-api-set-applicationinsightsmonitoringconfig-v040-alpha"></a>API v2 di Status Monitor: Set-ApplicationInsightsMonitoringConfig (v0.4.0-alpha)
