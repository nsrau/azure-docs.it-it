...
Il primo oggetto visualizzato dopo l'accesso al portale di Microsoft Azure è un [dashboard](../../azure-portal/azure-portal-dashboards.md).<br> ![Dashboard del portale di Azure](media/tutorial-logs-dashboards/log-analytics-portal-dashboard.png)
...
Per creare un dashboard, selezionare il pulsante **Nuovo dashboard** accanto al nome del dashboard corrente.<br> ![Creare un nuovo dashboard nel portale di Azure](media/tutorial-logs-dashboards/log-analytics-create-dashboard-01.png)
