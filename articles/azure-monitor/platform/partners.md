...
![Logo di monitoraggio per la logica](./media/partners/logicmonitor.png)
...
Serverless360 è uno strumento di un'unica piattaforma per funzionare, gestire e monitorare i componenti di Azure senza server. Facilità di gestione è una delle sfide principali con implementazioni senza server. Centinaia di servizi senza server di piccole dimensioni, discreti è sparse in diverse posizioni: la gestione e il funzionamento di tali soluzioni è complessa. Serverless360 risolve questi problemi grazie a un set completo di strumenti sofisticati. È possibile monitorare i servizi senza server, ad esempio funzioni di Azure, App per la logica, griglie di eventi, le code del Bus di servizio, argomenti, inoltri, hub eventi, archiviazione code, file, blob e tabelle. Serverless360 è disponibile in Azure Marketplace. Queste funzionalità sono disponibili su SaaS e hosting privato (ospitati nell'ambiente).  
...
![Logo di sumo per la logica](./media/partners/SumoLogic.png)
...
[influxdata-doc]: ./../../azure-monitor/platform/collect-custom-metrics-linux-telegraf.md "Dati di Azure Monitor infrequente Telegraf integrazione."
...
[serverless360-doc]: https://docs.serverless360.com/docs/associating-service-principals "Documentazione di Serverless360."
