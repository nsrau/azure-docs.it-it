...
2. Nel riquadro delle sottoscrizioni di Log Analytics fare clic si **Aggiungi**.  
    ...
    ![Elenco di aree di lavoro](./media/manage-access/workspace-link-existing-01.png)
...
3. In **Piano tariffario** selezionare un piano tariffario e quindi fare clic su **Seleziona**.  
    ![Piano tariffario selezionato](./media/manage-access/workspace-pricing-tier-info.png)
...
4. Fare clic su **Save**.  
    ...
    ![Sottoscrizione e piani di dati](./media/manage-access/subscription-tab.png)
...
![Barra multifunzione di OMS](./media/manage-access/data-plan-changed.png)
