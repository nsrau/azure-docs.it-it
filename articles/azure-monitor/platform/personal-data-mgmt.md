...
> [!IMPORTANT]
>  Sebbene ci si aspetta che la maggior parte delle operazioni di eliminazione vengano completate più rapidamente rispetto al nostro contratto di manutenzione, a causa del loro forte effetto sulla piattaforma dati usata da Log Analytics, **il contratto di lavoro formale per il completamento delle operazioni di ripulitura viene impostato su 30 giorni**. 
...
> [!IMPORTANT]
>  Sebbene la maggior parte delle operazioni di ripulitura possa essere completata molto più rapidamente rispetto al contratto di manutenzione, a causa del loro forte effetto sulla piattaforma dati usata da Application Insights, **il contratto di contratto formale per il completamento delle operazioni di ripulitura viene impostato su 30 giorni**.
