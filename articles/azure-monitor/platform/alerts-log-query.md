...
Le [query in Log Analytics](../log-query/log-query-overview.md) iniziano con una tabella oppure un operatore [search](/azure/kusto/query/searchoperator) oppure [union](/azure/kusto/query/unionoperator).
