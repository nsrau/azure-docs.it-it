...
## <a name="configuring-log-analytics-to-collect-azure-diagnostics-from-storage"></a>Configurazione di Log Analitica per raccogliere dati di diagnostica Azure dall'archiviazione
