...
| connessione |sì |Il valore deve essere vuoto {} o può contenere coppie chiave-valore |
...
| Campo | Obbligatorio? | Descrizione |
| --- | --- | --- |
| stato |sì |Stato che indica che è stata generata un'azione di scalabilità automatica |
