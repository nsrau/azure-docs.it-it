...
### <a name="q-can-i-still-use-advanced-analytics-portal"></a>Q. È ancora possibile utilizzare il portale di Analisi avanzata? 
...
### <a name="q-why-cant-i-see-query-explorer-and-save-buttons-in-the-new-logs-experience"></a>Q. Perché non è possibile vedere i pulsanti Esplora query e Salva nella nuova esperienza Log?
...
### <a name="q-how-do-i-extract-custom-fields-in-the-new-logs-experience"></a>Q. Come è possibile estrarre Campi personalizzati nella nuova esperienza Log? 

R: L'estrazione di Campi personalizzati è attualmente supportata nell'esperienza Log classica. 

### <a name="q-where-do-i-find-list-view-in-the-new-logs"></a>Q. Dove si trova la visualizzazione elenco nella nuova esperienza Log? 
...
### <a name="q-after-running-a-query-a-list-of-suggested-filters-are-available-how-can-i-see-filters"></a>Q. Dopo aver eseguito una query, è disponibile un elenco di filtri suggeriti. Come è possibile visualizzare i filtri? 
...
### <a name="q-why-am-i-getting-the-error-register-resource-provider-microsoftinsights-for-this-subscription-to-enable-this-query-in-logs-after-drilling-in-from-vm"></a>Q. Perché viene visualizzato l'errore "Registrare il provider di risorse 'Microsoft.Insights' per questa sottoscrizione per abilitare questa query" in Log, dopo l'eplorazione dalla macchina virtuale? 

R: Per impostazione predefinita, molti provider di risorse sono registrati automaticamente. Tuttavia, potrebbe essere necessario registrare alcuni provider di risorse manualmente. La registrazione di un provider di risorse configura la sottoscrizione per l'utilizzo del provider di risorse. L'ambito per la registrazione è sempre la sottoscrizione. Per altre informazioni, vedere [Provider e tipi di risorse](../../azure-resource-manager/management/resource-providers-and-types.md#azure-portal).

### <a name="q-why-am-i-am-getting-no-access-error-message-when-accessing-logs-from-a-vm-page"></a>Q. Perché viene visualizzato un messaggio di errore di accesso quando si accede a Log da una pagina della macchina virtuale? 
...
### <a name="q-why-can-i-can-access-my-workspace-in-oms-portal-but-i-get-the-error-you-have-no-access-in-the-azure-portal"></a>Q. Perché è possibile accedere alla propria area di lavoro nel portale di OMS, ma viene visualizzato un errore di accesso nel portale di Azure?  
...
### <a name="q-why-cant-i-cant-see-view-designer-entry-in-logs"></a>Q. Perché non è presente la voce Progettazione viste in Log?
...
### <a name="q-can-i-still-use-the-analytics-portal-outside-of-azure"></a>Q. È possibile usare il portale di Log Analytics all'esterno di Azure?
...
### <a name="q-how-can-i-see-my-views-and-solutions-in-azure-portal"></a>Q. Come è possibile visualizzare le proprie viste e soluzioni nel portale di Azure? 
...
### <a name="q-does-log-analytics-use-the-same-agent-as-azure-security-center"></a>Q. Log Analytics usa lo stesso agente del Centro sicurezza di Azure?
...
### <a name="q-what-checks-are-performed-by-the-ad-and-sql-assessment-solutions"></a>Q. Quali controlli vengono eseguiti dalle soluzioni di valutazione SQL e AD?
...
### <a name="q-why-do-i-see-something-different-than-oms-in-the-system-center-operations-manager-console"></a>Q. Perché non viene visualizzato OMS nella console di System Center Operations Manager?
...
### <a name="q-how-can-i-be-notified-when-data-collection-stops"></a>Q. Come inviare una notifica all'utente quando la raccolta dati si interrompe?
...
### <a name="q-can-i-change-the-name-of-the-tableblob-container-used-to-read-from-azure-diagnostics-wad"></a>Q. È possibile modificare il nome del contenitore di tabelle/BLOB usato per leggere da Diagnostica di Azure?

R. No, non è attualmente possibile leggere da tabelle o contenitori arbitrari in Archiviazione di Azure.

### <a name="q-what-ip-addresses-does-the-log-analytics-service-use-how-do-i-ensure-that-my-firewall-only-allows-traffic-to-the-log-analytics-service"></a>Q. Quali indirizzi IP usa il servizio Log Analytics? Come assicurarsi che il firewall consenta solo il traffico ai servizi di Log Analytics?
...
### <a name="q-i-use-expressroute-for-connecting-to-azure-does-my-log-analytics-traffic-use-my-expressroute-connection"></a>Q. Si usa ExpressRoute per connettersi ad Azure. Il traffico di Log Analytics userà la connessione ExpressRoute?
...
### <a name="q-is-there-a-simple-and-easy-way-to-move-an-existing-log-analytics-workspace-to-another-log-analytics-workspaceazure-subscription"></a>Q. Esiste un modo semplice per spostare un'area di lavoro Log Analytics esistente in un'altra area di lavoro Log Analytics/della sottoscrizione di Azure?
...
### <a name="q-how-much-data-can-i-send-through-the-agent-to-log-analytics-is-there-a-maximum-amount-of-data-per-customer"></a>Q. Quanti dati è possibile inviare tramite l'agente a Log Analytics? È prevista una quantità massima di dati per ogni cliente?
...
### <a name="q-how-much-network-bandwidth-is-used-by-the-microsoft-management-agent-mma-when-sending-data-to-log-analytics"></a>Q. Quanta larghezza di banda di rete viene usata da Microsoft Management Agent (MMA) quando si inviano dati a Log Analytics?
...
### <a name="q-how-much-data-is-sent-per-agent"></a>Q. Quanti dati vengono inviati per ogni agente?
