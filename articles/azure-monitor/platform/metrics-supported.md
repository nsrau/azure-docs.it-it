...
|tempdb_data_size<sup>2</sup> |Tempdb Data File Size Kilobytes (Dimensioni file dati tempdb in kilobyte)|Conteggio|Massimo|Dimensioni del file di dati tempdb.|nessuno|
|tempdb_log_size<sup>2</sup> |Tempdb Log File Size Kilobytes (Dimensioni file di log tempdb in kilobyte)|Conteggio|Massimo|Kilobyte dimensioni file di log tempdb.|nessuno|
|tempdb_log_used_percent<sup>2</sup> |Tempdb Percent Log Used (Percentuale log utilizzata tempdb)|Percentuale|Massimo|Log percentuale tempdb utilizzato.|nessuno|
