...
3. Per il `metricName` parametro, vedere le metriche disponibili in [monitoraggio di Azure metriche supportate](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported).
