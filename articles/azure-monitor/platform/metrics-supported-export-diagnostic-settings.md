...
Per le metriche della piattaforma che possono essere esportate tramite le impostazioni di diagnostica, sono disponibili alcune metriche per cui il monitoraggio di Azure interpreta ' 0' come ' null '. Ciò ha causato una certa confusione tra' 0' reale (emesso dalla risorsa) è 0' interpretato (null). Presto si verificherà una modifica e le metriche della piattaforma esportate tramite le impostazioni di diagnostica non esporteranno più' 0', a meno che non siano state effettivamente emesse dalla risorsa sottostante. La modifica è stata pianificata per il 1 ° aprile 2020, ma è stata ritardata a causa di turni di priorità dovuti a COVID-19. 
...
| Esportabili tramite le impostazioni di diagnostica?  | Sono già presenti valori NULL |  ResourceType  |  Metrica  |  MetricDisplayName  |  Unità  |  AggregationType | 
|---|---| ---- | ----- | ------ | ---- | ---- | 
...
| **Sì**  | No |  Microsoft.Compute/virtualMachines  |  Profondità coda per un disco dati  |  Profondità coda del disco dati (anteprima)  |  Conteggio  |  Media | 
...
| **Sì**  | No |  Microsoft.Compute/virtualMachines  |  Profondità coda per un disco del sistema operativo  |  Profondità coda del disco del sistema operativo (anteprima)  |  Conteggio  |  Media | 
...
| **Sì**  | No |  Microsoft.Compute/virtualMachineScaleSets  |  Profondità coda per un disco dati  |  Profondità coda del disco dati (anteprima)  |  Conteggio  |  Media | 
...
| **Sì**  | No |  Microsoft.Compute/virtualMachineScaleSets  |  Profondità coda per un disco del sistema operativo  |  Profondità coda del disco del sistema operativo (anteprima)  |  Conteggio  |  Media | 
...
| **Sì**  | No |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  Profondità coda per un disco dati  |  Profondità coda del disco dati (anteprima)  |  Conteggio  |  Media | 
...
| **Sì**  | No |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  Profondità coda per un disco del sistema operativo  |  Profondità coda del disco del sistema operativo (anteprima)  |  Conteggio  |  Media | 
...
| No  | No |  Microsoft. EnterpriseKnowledgeGraph/Services  |  FailureCount  |  Failure Count  |  Conteggio  |  Conteggio | 
| No  | No |  Microsoft. EnterpriseKnowledgeGraph/Services  |  SuccessCount  |  Success Count  |  Conteggio  |  Conteggio | 
...
| **Sì**  | **Sì** |  Microsoft. EventGrid/domini  |  PublishFailCount  |  Pubblica eventi non riusciti  |  Conteggio  |  Totale | 
| **Sì**  | **Sì** |  Microsoft. EventGrid/domini  |  PublishSuccessCount  |  Eventi pubblicati  |  Conteggio  |  Totale | 
| **Sì**  | **Sì** |  Microsoft. EventGrid/domini  |  PublishSuccessLatencyInMs  |  Latenza pubblicazione riuscita  |  Conteggio  |  Totale | 
...
| No  | No |  Microsoft.EventHub/namespaces  |  Dimensioni  |  Dimensioni  |  Byte  |  Media | 
...
| No  | No |  Microsoft.Insights/Components  |  availabilityResults/conteggio  |  Test della disponibilità  |  Conteggio  |  Conteggio | 
...
| **Sì**  | No |  Microsoft. Media/MediaServices/le entità streamingendpoint  |  Requests  |  Requests  |  Conteggio  |  Totale | 
...
| **Sì**  | No |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. Disk sec/Read  |  Media letture disco/sec  |  Conteggio  |  Media | 
| **Sì**  | No |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. Disk sec/Transfer  |  Media sec/trasferimento disco  |  Conteggio  |  Media | 
...
| No  | No |  Microsoft.ServiceBus/namespaces  |  Dimensioni  |  Dimensioni  |  Byte  |  Media | 
...
| **Sì**  | **Sì** |  Microsoft.Web/sites  |  Thread  |  Thread Count  |  Conteggio  |  Media | 
...
| **Sì**  | **Sì** |  Microsoft.Web/sites/slots  |  Thread  |  Thread Count  |  Conteggio  |  Media | 
