...
L'esempio seguente mostra due set di dati per un'ipotetica metrica denominata _Velocità effettiva di rete_. Il primo set di dati non ha dimensioni. Nel secondo set di dati vengono visualizzati i valori con due dimensioni, _indirizzo IP_ e _direzione_:
