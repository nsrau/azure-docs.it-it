...
| Livello | Description | Metodo di raccolta |
|:---|:---|:---|
...
| Destinazione | Description | Riferimenti |
|:---|:---|:---|
...
| Memoria VM | Monitoraggio di Azure per le macchine virtuali usa l'agente Log Analytics per archiviare le informazioni sullo stato di integrità in un percorso personalizzato. Per altre informazioni, vedere la sezione seguente.  |
...
| Destinazione | Metodo | Description | Riferimenti |
|:---|:---|:---|:---|
...
| Servizio | Destinazione | Description | Riferimenti |
|:---|:---|:---|:---|
...
| [Azure Sentinel](/azure/sentinel/) | Log di Monitoraggio di Azure | Azure Sentinel archivia i dati raccolti da origini dati diverse in un'area di lavoro Log Analytics che consente di analizzarli con altri dati di log raccolti da monitoraggio di Azure.  | [Connetti origini dati](/azure/sentinel/quickstart-onboard) |
