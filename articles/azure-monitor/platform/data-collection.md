...
- Configurazione di una [regola di avviso per la metrica](../../monitoring-and-diagnostics/alert-metric.md) che invia una notifica o esegue un'[operazione automatica](../../monitoring-and-diagnostics/monitoring-action-groups.md) quando la metrica supera una soglia.
...
- Agenti in macchine virtuali [Windows](../../log-analytics/log-analytics-windows-agent.md) e [Linux](../../log-analytics/log-analytics-quick-collect-linux-computer.md) che inviano dati di telemetria dal sistema operativo guest e dalle applicazioni a Log Analytics in base alle [origini dati](../../azure-monitor/platform/agent-data-sources.md) configurate.
...
![Componenti di Log Analytics](media/data-collection/logs-overview.png)
...
- Creazione di un flusso di lavoro basato su dati in Log Analytics usando [App per la logica](~/articles/logic-apps/index.yml).
