...
![Dashboard di esempio](./media/dashboards/oms-dashboards-example-dash.png)
...
* [App OMS per dispositivi mobili in Microsoft Store](https://www.windowsphone.com/store/app/operational-insights/4823b935-83ce-466c-82bb-bd0a3f58d865)
...
![dashboard mobile](./media/dashboards/oms-search-mobile.png)
...
![Panoramica](./media/dashboards/oms-dashboards-overview.png)
...
![Illustrazione](./media/dashboards/oms-dashboards-pictorial01.png)
...
![Aggiunta di riquadri 1](./media/dashboards/oms-dashboards-pictorial02.png)

Quando si fa clic sul segno **più** viene visualizzato un nuovo riquadro nella visualizzazione Dashboard.

![Aggiunta di riquadri 2](./media/dashboards/oms-dashboards-pictorial03.png)
...
![Modifica di un riquadro](./media/dashboards/oms-dashboards-pictorial04.png)

![Modifica di un riquadro](./media/dashboards/oms-dashboards-pictorial05.png)
...
| --- | --- |
| ![Grafico a barre](./media/dashboards/oms-dashboards-bar-chart.png) |Visualizza una sequenza temporale dei risultati della ricerca log salvata sotto forma di grafico a barre o un elenco dei risultati per campo, a seconda che i risultati vengano aggregati o meno in base a un campo. |
| ![metrica](./media/dashboards/oms-dashboards-metric.png) |Il risultato totale della ricerca nei log viene visualizzato sotto forma di numero in un riquadro. È possibile impostare un valore soglia che, quando viene raggiunto, determina l'evidenziazione del riquadro. |
| ![line](./media/dashboards/oms-dashboards-line.png) |Visualizza una sequenza temporale dei risultati della ricerca log salvata con i relativi valori sotto forma di grafico a linee. |
...
![Organizzazione del dashboard](./media/dashboards/oms-dashboards-organize.png)
...
![Rimozione di un riquadro](./media/dashboards/oms-dashboards-remove-tile.png)

## <a name="next-steps"></a>Passaggi successivi
* Creare [avvisi](../../azure-monitor/platform/alerts-overview.md) in Log Analytics per generare notifiche e risolvere i problemi.
