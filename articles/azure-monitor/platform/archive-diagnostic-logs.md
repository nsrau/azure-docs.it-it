...
* [Trasmettere log di diagnostica di Azure a uno spazio di nomi di Hub eventi](../../monitoring-and-diagnostics/monitoring-stream-diagnostic-logs-to-event-hubs.md)
