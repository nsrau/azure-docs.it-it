...
Configurare i registri eventi di Windows [nel menu dati in impostazioni avanzate](agent-data-sources.md#configuring-data-sources) per l'area di lavoro log Analytics.
