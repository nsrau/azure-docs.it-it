...
<a href="/it-it/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-validate-modify-data/" title="Windows Store C#">Windows Store C#</a>
...
<a href="/it-it/documentation/articles/mobile-services-dotnet-backend-windows-phone-validate-modify-data/" title="Windows Phone" class="current">Windows Phone</a>
...
<div class="dev-center-tutorial-subselector">
    <a href="/it-it/documentation/articles/mobile-services-dotnet-backend-windows-phone-validate-modify-data/" title=".NET backend" class="current">Back-end .NET</a> | 
    <a href="/it-it/develop/mobile/tutorials/validate-modify-and-augment-data-wp8"  title="JavaScript backend">Back-end JavaScript</a>
</div>
...
4.  [Aggiunta di un timestamp per CompleteDate][]
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [Back-end .NET]: /it-it/documentation/articles/mobile-services-dotnet-backend-windows-phone-validate-modify-data/ ".NET backend"
  [Back-end JavaScript]: /it-it/develop/mobile/tutorials/validate-modify-and-augment-data-wp8 "JavaScript backend"
  ...
  [Aggiunta di un timestamp per CompleteDate]: #add-timestamp
