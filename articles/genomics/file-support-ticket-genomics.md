---
title: Come presentare una richiesta di supporto
titleSuffix: Microsoft Genomics
description: In questo articolo viene descritto come inviare una richiesta di supporto per contattare Genomica di Microsoft se non si è in grado di risolvere il problema con la guida alla risoluzione dei problemi o domande frequenti.
...
Questa panoramica descrive come inoltrare una richiesta di supporto per contattare Genomica di Microsoft. Ciò può essere utile se non si è in grado di risolvere il problema utilizzando la [guida alla risoluzione dei problemi](troubleshooting-guide-genomics.md) o le domande [frequenti](frequently-asked-questions-genomics.md). 
...
![Contattare il supporto nel portale di AzureContact support on Azure portal](./media/file-support-ticket/genomics-contact-support.png "Contattare il supporto nel portale di AzureContact support on Azure portal") 
...
![Nozioni di base sulle richieste di supporto](./media/file-support-ticket/support-request-basics.png "Nozioni di base sulle richieste di supporto")
...
![Problema di richiesta di supporto](./media/file-support-ticket/support-request-problem.png "Problema di richiesta di supporto")
