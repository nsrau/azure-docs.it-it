...
Nel diagramma seguente gli utenti si connettono a Gestione traffico tramite un URL specifico (**http://ATMURL.trafficmanager.net**) che maschera gli URL effettivi del sito (**http://app1URL.cloudapp.net** e **http://app2URL.cloudapp.net**). In base alla modalità di applicazione dei criteri di instradamento configurati per gli utenti, questi verranno indirizzati al sito corretto effettivo, quando necessario. Le opzioni dei criteri sono round robin, prestazioni o failover. Ai fini di questo articolo si esaminerà solo l'opzione di failover.
