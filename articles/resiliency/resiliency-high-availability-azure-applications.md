...
> [!NOTE]
> Nella figura precedente, SQL Server è installato ed eseguito in macchine virtuali. Nella precedente discussione riguardo al database SQL di Azure, invece, il database viene fornito come servizio gestito.
> 
> 
...
2. Provare a eseguire l'operazione che potrebbe causare un errore temporaneo.
3. Se si verifica l'errore temporaneo, richiamare il criterio di ripetizione dei tentativi.
4. Se tutti i tentativi hanno esito negativo, rilevare un'eccezione finale.
...
6. Nodo di calcolo in background: estrazione dei dati transazionali, relativa post-elaborazione se necessaria e invio alla posizione di archiviazione finale nel sistema corrente.
