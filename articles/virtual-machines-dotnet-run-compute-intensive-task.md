...
6. Modificare i segnaposto **your_service_bus_namespace**, **your_service_bus_owner** e **your_service_bus_key** per usare rispettivamente i valori **namespace**, **Default Issuer** e **Default Key** del bus di servizio.
...
5. Modificare i segnaposto **your_service_bus_namespace**, **your_service_bus_owner** e **your_service_bus_key** per usare rispettivamente i valori **namespace**, **Default Issuer** e **Default Key** del bus di servizio.
