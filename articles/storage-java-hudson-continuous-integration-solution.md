...
Informazioni generaliInformazioni generali su Hudson
----------------------------------------------------
...
Per ulteriori informazioni su Hudson, vedere [Meet Hudson](http://wiki.eclipse.org/Hudson-ci/Meet_Hudson).
...
-   Una soluzione di Integrazione continuata Hudson.
    ...
    1.  In un Computer abilitato per Java scaricare il file WAR di Hudson da http://hudson-ci.org/.
    2.  Al prompt dei comandi aperto nella cartella che contiene il file WAR di Hudson eseguire il file. Se, ad esempio, è stata scaricata la versione 3.0.1:
    ...
    5.  Dopo aver completato la configurazione iniziale, annullare l'istanza in esecuzione del file WAR di Hudson, avviarlo nuovamente e riaprire il dashboard di Hudson, `http://localhost:8080/`, che verrà utilizzato per installare e configurare il plug-in di Archiviazione di Azure.
...
Utilizzo di un servizio BLOBUtilizzo del servizio BLOB con l'Integrazione continuata Hudson
-------------------------------------------------------------------------------------------
...
5.  Nella sezione **Artifact Uploaders** selezionare **Azure Storage plugin**.
...
5.  Nella sezione **Post-build Actions** della configurazione del processo fare clic su **Upload artifacts to Azure Blob storage**.
