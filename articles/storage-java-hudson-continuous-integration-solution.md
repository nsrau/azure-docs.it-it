...
## <span id="howtouse"></span></a><span class="short header">Utilizzo di un servizio BLOB</span>Utilizzo del servizio BLOB con l'Integrazione continuata Hudson
...
## <span id="components"></span></a><span class="short header">Componenti del servizio BLOB</span>Componenti utilizzati dal servizio BLOB
...
-   **Formato dell'URL**: I BLOB sono indirizzabili utilizzando il formato di URL seguente:
  ...
  [Utilizzo del servizio BLOB con l'Integrazione continuata Hudson]: #howtouse
