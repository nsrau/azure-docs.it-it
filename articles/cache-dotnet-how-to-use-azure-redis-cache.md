<properties pageTitle="Come usare Cache Redis di Azure" metaKeywords="" description="Informazioni su come creare un uso di una cache in Cache Redis di Azure" metaCanonical="" services="cache" documentationCenter="API Management" title="How to Use Azure Redis Cache" authors="sdanie" solutions="" manager="dwrede" editor="" />
