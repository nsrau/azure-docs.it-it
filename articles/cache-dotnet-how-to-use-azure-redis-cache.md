...
> Per altre informazioni, vedere [Uso di Gruppi di risorse per gestire le risorse di Azure][].
...
> Per altre informazioni, vedere la pagina di github su [StackExchange.Redis][] e la [documentazione del client della cache StackExchange.Redis][].
...
> Avviso: non archiviare mai le credenziali nel codice sorgente. Per semplicità però in questo esempio saranno visibili nel codice sorgente. Vedere il post di blog sull'[uso di stringhe di applicazione e stringhe di connessione in Siti Web di Azure][] per informazioni su come archiviare le credenziali.
...
-   Riferimento in MSDN: [Cache Redis di Azure][]
...
<!-- LINKS -->
  ...
  [Uso di Gruppi di risorse per gestire le risorse di Azure]: http://azure.microsoft.com/en-us/documentation/articles/azure-preview-portal-using-resource-groups/
