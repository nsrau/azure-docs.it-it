...
6. Nella parte inferiore del modulo fare clic su **Creazione rapida**.
	...
	È inoltre possibile visualizzare il codice usato da Azure Media Services SDK per eseguire le attività seguenti: caricare, codificare e pubblicare video. È inoltre possibile fare clic su uno dei collegamenti disponibili nella sezione SCRIVI CODICE, copiare il codice e usarlo nella propria applicazione. 
