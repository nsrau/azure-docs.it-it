...
- Scopri di più sulla [nuova sintassi delle espressioni Time Series](https://docs.microsoft.com/rest/api/time-series-insights/preview#time-series-expression-and-syntax).
