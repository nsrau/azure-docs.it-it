---
title: Autenticazione di Azure Time Series Insights - Come eseguire l'autenticazione e l'autorizzazione tramite l'API in Azure Time Series Insights | Microsoft Docs
...
> [Creare un'entità servizio](../active-directory/develop/howto-create-service-principal-portal.md)
