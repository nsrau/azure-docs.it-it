...
--- 
# <a name="azure-time-series-insights-documentation"></a>Documentazione di Azure Time Series Insights 
 
Informazioni su come configurare l'ambiente di Time Series Insights, esplorare e analizzare i dati delle serie temporali delle soluzioni IoT o dei dispositivi connessi. La documentazione illustra i prerequisiti, le procedure, i riferimenti alle API e altra documentazione utile per velocizzare le operazioni iniziali. 
        ...
        <div class="cardSize"> 
            <div class="cardPadding"> 
                <div class="card"> 
                    ...
                    <div class="cardText"> 
                        <h3>Informazioni su Time Series Insights</h3> 
                    </div> 
                </div> 
            </div> 
        </div> 
        ...
        <div class="cardSize"> 
            <div class="cardPadding"> 
                <div class="card"> 
                    ...
                    <div class="cardText"> 
                        <h3>Catalogo video di Time Series Insights</h3> 
                    </div> 
                </div> 
            </div> 
        </div> 
        ...
        <div class="cardSize"> 
            <div class="cardPadding"> 
                <div class="card"> 
                    ...
                    <div class="cardText"> 
                        <h3>Inizia a usare Time Series Insights</h3> 
                    </div> 
                </div> 
            </div> 
        </div> 
        ...
        <div class="cardSize"> 
            <div class="cardPadding"> 
                <div class="card"> 
                    ...
                    <div class="cardText"> 
                        <h3>Provare Time Series Insights in un set di dati di esempio</h3> 
                    </div> 
                </div> 
            </div> 
        </div> 
