---
title: Piano di Azure Time Series Insights - Pianificare la scalabilità dell'ambiente Azure Time Series Insights | Microsoft Docs
...
Per impostazione predefinita l'hub IoT di Azure e gli hub eventi dispongono del ripristino integrato.

Per altre informazioni sui criteri di BCDR dell'hub IoT, vedere [qui](https://docs.microsoft.com/azure/iot-hub/iot-hub-ha-dr).  

Per altre informazioni sui criteri di BCDR dell'hub eventi, vedere [qui](https://docs.microsoft.com/azure/event-hubs/event-hubs-geo-dr).
