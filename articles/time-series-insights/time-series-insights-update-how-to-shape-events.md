...
> [!IMPORTANT]
> * Azure Time Series Insights anteprima usa i caratteri di sottolineatura (`_`) per la delineatura della colonna.
...
Nell'esempio precedente, la proprietà `data["flow"]` bidimensionale presenta un conflitto di denominazione con la proprietà `data_flow`.
