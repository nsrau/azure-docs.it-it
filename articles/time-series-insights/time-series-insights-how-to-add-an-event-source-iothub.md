---
title: Aggiunta di un hub IoT in Azure Time Series - Come aggiungere un'origine evento dell'hub IoT in Azure Time Series Insights | Microsoft Docs
