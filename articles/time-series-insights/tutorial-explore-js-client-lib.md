...
Questa esercitazione usa la funzionalità "Strumenti di sviluppo" (nota anche come DevTools o F12), disponibile nella maggior parte dei Web browser moderni, come [Microsoft Edge](/microsoft-edge/devtools-guide), [Chrome](https://developers.google.com/web/tools/chrome-devtools/), [FireFox](https://developer.mozilla.org/en-US/docs/Learn/Common_questions/What_are_browser_developer_tools), [Safari](https://developer.apple.com/safari/tools/) e altri. Se non si ha già familiarità con questa funzionalità, potrebbe essere utile esplorarla nel browser prima di continuare.
