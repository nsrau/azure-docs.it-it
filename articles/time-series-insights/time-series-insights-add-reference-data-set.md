...
# Creare un set di dati di riferimento per l'ambiente Time Series Insights usando il portale di Ibiza
...
## Procedura per aggiungere un set di dati di riferimento all'ambiente
