...
<tr>
   ...
   <td valign="middle">
      ...
      <li type=round>Per le applicazioni di SQL Server locale usando il <a href="http://msdn.microsoft.com/library/jj919148.aspx">backup nell'archiviazione di Azure</a> oppure le <a href="http://msdn.microsoft.com/library/azure/jj870962.aspx">repliche AlwaysOn in Macchine virtuali di Azure</a>.
...
**Nota importante:** attualmente, il database SQL Azure non supporta tutte le funzionalità di SQL Server. Per un confronto dettagliato, vedere la pagina relativa alle [linee guida e le limitazioni del Database SQL di Azure](http://msdn.microsoft.com/library/azure/ff394102.aspx). Tenere presente questo quando si vuole spostare un database esistente al Database SQL Azure, poiché potrebbe essere necessario budget aggiuntivo per la riprogettazione del database. Il database SQL Azure è l'offerta di piattaforma distribuita come servizio (PaaS, Platform as a Service) di Microsoft. Quando si esegue la migrazione di un'applicazione SQL Server locale esistente al database SQL Azure, è consigliabile aggiornare l'applicazione per sfruttare tutti i vantaggi di una piattaforma distribuita come servizio. Ad esempio, iniziare a usare [Siti Web di Azure](http://azure.microsoft.com/documentation/services/websites/) o [Servizi cloud di Azure](http://azure.microsoft.com/services/cloud-services/) sul livello dell'applicazione per aumentare i vantaggi in termini di costo. Inoltre, convalidare l'applicazione con diversi livelli di servizio del database SQL di Azure e verificare quale è il più appropriato per le esigenze dell'applicazione. Questo processo consente di ottenere prestazioni migliori e costi ridotti al minimo. Per altre informazioni, vedere [Livelli di servizio e livelli di prestazioni del database SQL di Azure](http://msdn.microsoft.com/library/azure/dn741336.aspx).
...
**Technical Collaboratori tecnici:** Conor Cunningham
