...
Per un esempio di come inviare notifiche push da un back-end WebAPI ASP.NET integrato con Hub di notifica, vedere [Uso di Hub di notifica di Azure per inviare notifiche agli utenti con back-end .NET](./notification-hubs-aspnet-backend-windows-dotnet-notify-users.md).

Per un esempio di invio di notifiche push con le [API REST](https://msdn.microsoft.com/library/azure/dn223264.aspx), vedere [Come usare Hub di notifica da Java](./notification-hubs-java-backend-how-to.md) e [Come usare Hub di notifica da PHP](./notification-hubs-php-backend-how-to.md).
