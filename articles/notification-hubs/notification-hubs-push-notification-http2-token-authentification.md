...
* Fare clic sul pulsante **Salva** per aggiornare le credenziali del servizio APN
...
> [!IMPORTANT]
> L'autenticazione basata su token richiede la versione dell'API **2017-04 o successiva**.
