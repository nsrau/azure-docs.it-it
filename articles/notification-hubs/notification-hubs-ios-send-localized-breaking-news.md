...
Si procederà quindi a verificare che i dispositivi effettuino la registrazione con un modello che faccia riferimento alla proprietà corretta. Per un'app per iOS che deve essere registrata per le notizie in francese, ad esempio, si effettuerà la registrazione nel seguente modo:
...
- [Uso di Hub di notifica per inviare notifiche agli utenti: ASP.NET]
- [Uso di Hub di notifica per inviare notifiche agli utenti: Servizi mobili]
- [Informazioni aggiuntive su Hub di notifica]
