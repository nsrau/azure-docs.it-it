...
1. In **Esplora soluzioni**aprire il file *NotificationsController.cs* nella cartella **Controllers** . Sostituire il metodo `Post` con il codice seguente:
    ...
    Questo codice invia una notifica a tutte le piattaforme nello stesso momento. Non è possibile specificare un payload nativo. Gli hub di notifica creano il payload corretto e lo distribuiscono a tutti i dispositivi con il valore tag specificato, come indicato nei modelli registrati.
