---
title: Notifiche push di iOS con Hub di notifica per app Xamarin | Microsoft Docs
...
[!INCLUDE [Hub di notifica - Abilita notifiche Push di Apple](../../includes/notification-hubs-enable-apple-push-notifications.md)]
