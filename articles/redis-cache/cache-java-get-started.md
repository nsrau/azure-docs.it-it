...
Questo articolo illustra come iniziare a usare Cache Redis di Azure con il client di Cache Redis [Jedis](https://github.com/xetorthio/jedis) per Java.
