...
1. Nella schermata **Esplora dati di Azure (kusto)** compilare il modulo con le informazioni seguenti.
    ...
    **Impostazione** | **Valore** | **Descrizione campo**
    |---|---|---|
    | Cluster | *https://help.kusto.windows.net* | L'URL del cluster della guida. Per gli altri cluster, l'URL è nel formato *https://\<clustername\>.\< Region\>. kusto.Windows.NET*. |
