...
Il linguaggio [`render operator`](/azure/kusto/query/renderoperator) di query kusto offre diverse visualizzazioni, ad esempio tabelle, grafici a torta e grafici a barre, per rappresentare i risultati della query. Le visualizzazioni di query sono utili per il rilevamento e la previsione di anomalie, l'apprendimento automatico e altro ancora.
