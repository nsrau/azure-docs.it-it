...
L'uso dell' [ `join` operatore](/azure/kusto/query/joinoperator), anziché Union, potrebbe richiedere un suggerimento per eseguirlo in un cluster nativo di Azure Esplora dati (e non nel proxy). 
