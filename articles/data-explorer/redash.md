...
1. **Creare** > una**query** per creare una nuova query. Aggiungere un parametro all'oggetto usando le{}parentesi graffe {}. Selezionare **{{}}** per aprire la finestra **Aggiungi parametro** . È anche possibile selezionare l' *icona Impostazioni* per modificare gli attributi di un parametro esistente e aprire la finestra di **<parameter_name>** . 
