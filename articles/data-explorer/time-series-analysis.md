---
title: Analizzare i dati di serie temporali usando Azure Data ExplorerAnalyze time series data using Azure Data Explorer
description: Informazioni su come analizzare i dati delle serie temporali nel cloud usando Azure Data Explorer.Learn how to analyze time series data in the cloud using Azure Data Explorer.
author: orspod
ms.author: orspodek
...
- Utilizzare [`make-series`](/azure/kusto/query/make-seriesoperator) l'operatore per creare un set di tre serie temporali, in cui:Use the operator to create a set of three time series, where:
    ...
    - `default=0`: specificare il metodo di riempimento per gli intervalli mancanti per creare serie temporali regolari In alternativa, [`series_fill_forward()`](/azure/kusto/query/series-fill-forwardfunction) [`series_fill_backward()`](/azure/kusto/query/series-fill-backwardfunction) utilizzare [`series_fill_linear()`](/azure/kusto/query/series-fill-linearfunction) [`series_fill_const()`](/azure/kusto/query/series-fill-constfunction), e per le modifiche
...
* Informazioni sul rilevamento e la previsione delle anomalie delle serie temporali in Azure Data Explorer.Learn about [Time series anomaly detection and forecasting](/azure/data-explorer/anomaly-detection) in Azure Data Explorer.
