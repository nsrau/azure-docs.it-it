...
<h2>Funzionamento delle notifiche push</h2>

Le notifiche push vengono recapitate attraverso infrastrutture specifiche della piattaforma denominate PNS (Platform Notification System, sistema di notifica tramite piattaforma). I sistemi PNS offrono funzioni limitate. Non forniscono, ad esempio, il supporto per la trasmissione o la personalizzazione e non offrono un'interfaccia comune. Per inviare una notifica a un'app di Windows Store, ad esempio, uno sviluppatore deve contattare il servizio di notifica Windows (WNS). Per inviare una notifica a un dispositivo iOS, lo stesso sviluppatore deve contattare il servizio di notifica Push di Apple (APNS) e inviare nuovamente il messaggio.
...
<h2>Difficoltà associate alle notifiche push</h2>
...
<h2>Perché usare gli Hub di notifica?</h2>
...
Negli argomenti seguenti sono disponibili altre informazioni su Hub di notifica:

+ **[Uso di Hub di notifica da parte dei clienti]**

+ **[Esercitazioni e guide su HUB di notifica]** 

+ **Esercitazioni introduttive su Hub di notifica** ([iOS], [Android], [Windows Universal], [Windows Phone], [Kindle], [Xamarin.iOS], [Xamarin.Android])
...
+ [Microsoft.ServiceBus.Notifications] 
  ...
  [Windows Phone]: http://azure.microsoft.com/it-it/documentation/articles/notification-hubs-windows-phone-get-started
  [Kindle]: http://azure.microsoft.com/it-it/documentation/articles/notification-hubs-kindle-get-started
  [Xamarin.iOS]: http://azure.microsoft.com/it-it/documentation/articles/partner-xamarin-notification-hubs-ios-get-started
  [Xamarin.Android]: http://azure.microsoft.com/it-it/documentation/articles/partner-xamarin-notification-hubs-android-get-started
  [Microsoft.WindowsAzure.Messaging.NotificationHub]: http://msdn.microsoft.com/it-it/library/microsoft.windowsazure.messaging.notificationhub.aspx
  [Microsoft.ServiceBus.Notifications]: http://msdn.microsoft.com/it-it/library/microsoft.servicebus.notifications.aspx
