...
Mentre il servizio è in distribuzione, è possibile passare all'utilizzo del codice. Clonare l'[app di esempio da GitHub](https://github.com/Azure-Samples/signalr-service-quickstart-serverless-chat), impostare la stringa di connessione del servizio SignalR ed eseguire localmente l'applicazione.
