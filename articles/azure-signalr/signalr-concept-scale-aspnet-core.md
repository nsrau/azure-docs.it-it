...
Attualmente, sono disponibili [due versioni](https://docs.microsoft.com/aspnet/core/signalr/version-differences) di SignalR utilizzabili con le applicazioni Web: SignalR per ASP.NET e ASP.NET Core SignalR, ovvero la versione più recente. Il servizio Azure SignalR è un servizio gestito da Azure basato su ASP.NET Core SignalR.
