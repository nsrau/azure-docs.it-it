...
Figura 1 - Prima del failover ![Prima del failover](media/signalr-disaster-recovery/before-failover.png)

Figura 2 - Dopo il failover ![Dopo il failover](media/signalr-disaster-recovery/after-failover.png)

Figura 3 - Poco dopo il ripristino dell'istanza primaria ![Poco dopo il ripristino dell'istanza primaria](media/signalr-disaster-recovery/after-recover.png)
