...
Il client può "inviare" la logica JavaScript precedente al database per l'esecuzione transazionale tramite POST HTTP. Per altre informazioni sull'utilizzo di metodi HTTP, vedere [Interazioni RESTful con risorse di DocumentDB](documentdb-interactions-with-resources.md).
