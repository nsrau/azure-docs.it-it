...
Per usare Microsoft Azure DocumentDB, è necessario creare un account di database DocumentDB tramite il portale di Azure.
...
- Il portale, come descritto in[Creare un database DocumentDB usando il portale di Azure](documentdb-create-database.md).
