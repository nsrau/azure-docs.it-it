...
Per usare Microsoft Azure DocumentDB, è necessario creare un account DocumentDB.  In questo argomento viene descritto come creare un account DocumentDB nel portale di anteprima di Azure.  
...
-	[Guida all'apprendimento di DocumentDB](documentdb-learning-map.md)
-	[Modello di risorse e concetti relativi a DocumentDB](documentdb-resources.md)
-	[Interazioni RESTful con risorse di DocumentDB](documentdb-interactions-with-resources.md)
