...
# Creare un account database DocumentDB usando il portale di anteprima di Azure
...
Familiarità con DocumentDB? Guardare [questo](http://azure.microsoft.com/documentation/videos/create-documentdb-on-azure/) video di quattro minuti per vedere come completare le attività più comuni nel portale.
