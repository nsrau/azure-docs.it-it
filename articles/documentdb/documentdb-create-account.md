<properties 
	pageTitle="Creare un account di database - versione di valutazione gratuita | Microsoft Azure" 
...
# Creare un account di database di DocumentDB

Per utilizzare Microsoft Azure DocumentDB, è necessario creare un account di database DocumentDB tramite il portale Azure preview.
...
- Portale di anteprima, come descritto in[Creare un database DocumentDB usando il portale di anteprima di Azure](documentdb-create-database.md).
- Esercitazioni complete:[.NET](documentdb-get-started.md)[MVC .NET](documentdb-dotnet-application.md)[Java](documentdb-java-application.md)[Node.js](documentdb-nodejs-application.md)o[Python](documentdb-python-application.md).
