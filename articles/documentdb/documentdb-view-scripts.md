---
title: Esplora script di DocumentDB, un editor JavaScript | Microsoft Docs
...
* Per eseguire una stored procedure, è sufficiente fare clic sul comando **Salva ed esegui** nel riquadro dell'editor di script.
  ...
  > [!NOTE]
  > Il comando **Salva ed esegui** salva la stored procedure prima dell'esecuzione ovvero sovrascrive la versione precedentemente salvata della stored procedure.
  > 
  > 
