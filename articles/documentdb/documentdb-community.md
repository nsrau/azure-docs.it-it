---
title: Community e notizie di DocumentDB | Documentazione Microsoft
...
* [**Azure DocumentDB in production!**](http://blog.nexapp.ca/2015/11/30/azure-documentdb-in-production/) (Azure DocumentDB nell'ambiente di produzione) - *di Alexandre Walsh e Marc-Olivier Duval*
...
* [**Dealing with RequestRateTooLarge errors in Azure DocumentDB and testing performance**](http://blogs.msdn.com/b/bigdatasupport/archive/2015/09/02/dealing-with-requestratetoolarge-errors-in-azure-documentdb-and-testing-documentdb-performance.aspx)(Gestione di errori RequestRateTooLarge in Azure DocumentDB e test delle prestazioni) - *di Azim Uddin*
...
| --- | --- | --- | --- | --- |
| [Wintellect webinar: An Introduction to Azure DocumentDB](http://www.wintellect.com/software-development-training/register/webinar/30) (Webinar Wintellect: Introduzione ad Azure DocumentDB)| [Josh Lane](https://twitter.com/jplane)|Online|15 dicembre 2016 alle 13 EST|n/d|
...
| --- | --- | --- | --- | --- |
| [Connect(); // 2016](https://connectevent.microsoft.com/) |Kirill Gavrylyuk |New York, NY |16-18 novembre 2016 |[Video di Channel 9 Connect();](https://channel9.msdn.com/Events/Connect) |
...
| --- | --- |
| [![Microsoft Virtual Academy](./media/documentdb-community/mva.png)](https://mva.microsoft.com/en-US/training-courses/deploying-web-apps-to-azure-app-service-16629) |[**Microsoft Virtual Academy**](https://mva.microsoft.com/en-US/training-courses/deploying-web-apps-to-azure-app-service-16629) offre formazione a cura delle persone che hanno contribuito a creare Azure DocumentDB. |
...
| Strumento di migrazione dei dati |[azure-documentdb-datamigrationtool](https://github.com/Azure/azure-documentdb-datamigrationtool) |[Area download Microsoft](http://www.microsoft.com/en-us/download/details.aspx?id=46436) |

## <a name="documentdb-wizards"></a>Wizard di DocumentDB
