...
2.  Nel pannello **Account DocumentDB** selezionare l'account in cui aggiungere un database DocumentDB. Se non è elencato alcun account, sarà necessario [creare un account DocumentDB](documentdb-create-account.md).
