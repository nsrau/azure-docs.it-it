---
title: Come creare un database in DocumentDB | Microsoft Docs
...
1. Nel pannello **DocumentDB (NoSQL)** selezionare l'account in cui aggiungere un database NoSQL DocumentDB. Se non è elencato alcun account, sarà necessario [creare un account DocumentDB](documentdb-create-account.md).
2. Nel pannello dell'**account DocumentDB** fare clic sul comando **Aggiungi database**.
...
3. Nel pannello **Aggiungi database** immettere l'ID del nuovo database. Quando il nome viene convalidato, appare un segno di spunta verde nella casella **ID**. Fare quindi clic su **OK**.
...
4. Il nuovo database è ora visualizzato nel filtro **Database** nel pannello **Account DocumentDB**.
