...
In questo articolo viene fornita un'introduzione al funzionamento dell’indicizzazione automatica in DocumentDB tratta dalla carta "indicizzazione senza schema con Azure DocumentDB" che sarà presentata alla[conferenza VLDB 2015](http://www.vldb.org/2015/). Dopo la lettura di questo articolo, si sarà in grado di rispondere alle domande seguenti:
...
- Ulteriori informazioni su come[Eseguire le query con SQL DocumentDB](documentdb-sql-query.md)
