<properties 
	...
	keywords="metodi http, esercitazione servizi restful, esercitazione di servizi web restful, verbi http, documentdb, azure, Microsoft azure"
	services="documentdb" 
	authors="h0n" 
	manager="jhubbard" 
	editor="monicar" 
...
Modalità di connettività|Protocol|Dettagli|SDK di DocumentDB
---|---|---|---
...
Connettività diretta|HTTPS e TCP|Le applicazioni possono accedere direttamente alla tabella di routing ed eseguire il routing lato client per connettersi direttamente con le repliche.|.NET
