<properties
	...
	description="Informazioni su come creare un database e configurare un account Azure DocumentDB. Creare database, raccolte e archiviare documenti JSON all'interno dell'account di database NoSQL."
