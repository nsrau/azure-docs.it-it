...
Questo articolo offre una panoramica della protezione dell'accesso ai dati archiviati in [Microsoft Azure Cosmos DB](https://azure.microsoft.com/services/documentdb/).
...
8. Quando il token delle risorse scade, le richieste successive ricevono un'eccezione 401 Non autorizzato.  A questo punto, l'app per il telefono ristabilisce l'identità e richiede un nuovo token delle risorse.
    ...
    ![Flusso di lavoro dei token delle risorse di Azure Cosmos DB](./media/documentdb-secure-access-to-data/resourcekeyworkflow.png)
...
* Per altre informazioni sulla sicurezza dei database Cosmos DB, vedere [Cosmos DB: Database security](documentdb-nosql-database-security.md) (Cosmos DB: sicurezza dei database).
* Per informazioni sulla gestione delle chiavi master e di sola lettura, vedere [Come gestire un account Azure Cosmos DB](documentdb-manage-account.md#a-idkeysaview-copy-and-regenerate-access-keys).
