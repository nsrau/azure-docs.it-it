<properties 
	pageTitle="Gestione della capacità di DocumentDB | Azure" 
...
È possibile creare qualunque numero di raccolte necessario per soddisfare i requisiti di archiviazione e scalabilità della velocità effettiva dell'applicazione. È possibile creare le raccolte tramite il portale di anteprima di Azure o uno qualsiasi degli SDK di DocumentDB.
...
##<a name="Consistency"></a>Per scegliere il livello di coerenza e la velocità effettiva
...
Per istruzioni sulla modifica del livello di coerenza nel portale di anteprima di Azure, vedere Procedura: gestire le impostazioni di coerenza di DocumentDB in [Come gestire un account di DocumentDB](documentdb-manage-account.md).
...
Per istruzioni sulla gestione dell’account di DocumentDB nel portale di anteprima di Azure, vedere Procedura: gestire le impostazioni di coerenza di DocumentDB in [Come gestire un account di DocumentDB](documentdb-manage-account.md/#consistency).
