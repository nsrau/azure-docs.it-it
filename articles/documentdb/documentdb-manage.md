...
## <a name="database-account"></a>Account di database
...
Con DocumentDB, in caso di esigenza di scalabilità delle applicazioni, sarà possibile creare più raccolte o più database o entrambi. I database possono essere creati tramite il [portale di Azure](documentdb-create-database.md) o con uno degli [SDK di DocumentDB](documentdb-dotnet-samples.md).   

## <a name="database-collections"></a>Raccolte di database
...
Le raccolte possono essere create tramite il [portale di Azure](documentdb-create-collection.md) o con uno degli [SDK di DocumentDB](documentdb-sdk-dotnet.md).   

## <a name="request-units-and-database-operations"></a>Unità di richiesta e operazioni di database
...
> [!IMPORTANT]
> Le raccolte sono entità fatturabili. Il costo è determinato dalla velocità effettiva con provisioning della raccolta, misurata in unità richiesta al secondo, e dallo spazio di archiviazione totale utilizzato, misurato in gigabyte.
>
>
...
> [!NOTE]
> La baseline di 1 unità richiesta per un documento da 1 KB corrisponde a una semplice operazione GET del documento con la [coerenza di sessione](documentdb-consistency-levels.md).
>
>
...
## <a name="choice-of-consistency-level-and-throughput"></a>Scelta del livello di coerenza e velocità effettiva
...
## <a name="provisioned-document-storage-and-index-overhead"></a>Archiviazione documenti con provisioning e sovraccarico dell'indice
