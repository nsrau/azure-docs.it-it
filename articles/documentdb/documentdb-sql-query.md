---
title: Query q sintassi SQL per DocumentDB | Microsoft Docs
...
> [!NOTE]
> Prima del 17/03/2015, DocumentDB supportava le chiamate UDF senza il prefisso "udf.", come SELECT REGEX\_MATCH(). Questo modello di chiamata è stato deprecato.
> 
> 
