...
Questo argomento illustra come usare Visual Studio per distribuire un progetto di applicazione console in un sito Web di Azure come [processo Web Azure](http://go.microsoft.com/fwlink/?LinkId=390226). Un metodo alternativo per distribuire i processi Web consiste nell'usare il portale di gestione di Azure. Per informazioni su tale metodo, vedere [Uso di processi Web per l'esecuzione di attività in background in Siti Web di Microsoft Azure](/it-it/documentation/articles/web-sites-create-web-jobs/).
...
I campi in questa finestra di dialogo corrispondono ai campi presenti nella finestra di dialogo **Nuovo processo** del portale di gestione di Azure. Per altre informazioni, vedere la pagina relativa all'[uso dei processi Web per eseguire le attività in background in Siti Web di Microsoft Azure](/it-it/documentation/articles/web-sites-create-web-jobs/).

Per un processo Web pianificato (non per i processi Web in modalità continua), Visual Studio crea una raccolta di processi dell'[utilità di pianificazione di Azure],(/it-it/services/scheduler/)  non ne esiste ancora una, e crea un processo nella raccolta:
...
>[WACOM.NOTE]
> 
>* Per informazioni sulla distribuzione da riga di comando, vedere il blog relativo all'[abilitazione della riga di comando o del recapito continuo di processi Web Azure](/blog/2014/08/18/enabling-command-line-or-continuous-delivery-of-azure-webjobs/).
