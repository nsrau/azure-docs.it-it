...
Le informazioni sulla creazione di un'API che supporti la sottoscrizione di un webhook sono disponibili [in questo articolo sulla creazione di connettori delle app per la logica](../logic-apps/logic-apps-create-api-app.md).
