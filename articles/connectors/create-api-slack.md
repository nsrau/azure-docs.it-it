...
>[AZURE.NOTE] Questa versione dell'articolo si applica alla versione schema 2015-08-01 di anteprima delle app per la logica. Per la versione schema 2014-12-01 di anteprima, fare clic su [Slack](../app-service-logic/app-service-logic-connector-Slack.md).
...
## Informazioni di riferimento sull'API REST di Slack
