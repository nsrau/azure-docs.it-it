...
>[AZURE.NOTE] Questa versione dell'articolo si applica alla versione schema 2015-08-01 di anteprima delle app per la logica. Per la versione schema 2014-12-01 di anteprima, fare clic su [Yammer](../app-service-logic/app-service-logic-connector-yammer.md).
...
Trigger | Azioni
--- | ---
<ul><li>Quando è presente un nuovo messaggio in un gruppo</li><li>Quando è presente un nuovo messaggio nel feed Following</li></ul>| <ul><li>Recupera tutti i messaggi</li><li>Recupera i messaggi in un gruppo</li><li>Recupera i messaggi dal feed Following</li><li>Pubblica un messaggio</li><li>Quando è presente un nuovo messaggio in un gruppo</li><li>Quando è presente un nuovo messaggio nel feed Following</li></ul>
...
## Informazioni di riferimento sull'API REST di Yammer
...
| ---|---|---|---|---|---|
|older\_then|integer|no|query|nessuno|Restituisce i messaggi meno recenti rispetto all'ID del messaggio specificato come stringa numerica. Risulta utile per l'impaginazione dei messaggi. Ad esempio, se si stanno attualmente visualizzando 20 messaggi e il meno recente è il numero 2912, è possibile aggiungere "?older\_than=2912" alla richiesta per recuperare i 20 messaggi precedenti a quelli visualizzati.|
