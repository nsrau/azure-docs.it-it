---
title: Connettersi a Yammer da App per la logica di AzureConnect to Yammer from Azure Logic Apps
...
1. Se viene richiesto di accedere a Yammer, accedere ora in modo che sia possibile consentire l'accesso.
