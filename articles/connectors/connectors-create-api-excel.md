---
title: Gestire dati, fogli di lavoro e tabelle in Excel Online
description: Gestire i dati nei fogli di lavoro e nelle tabelle in Excel Online per aziende o Excel Online per OneDrive usando le app per la logica di Azure
services: logic-apps
...
Con [le app per](../logic-apps/logic-apps-overview.md) la logica di Azure e il connettore Excel Online for [Business](/connectors/excelonlinebusiness/) o Excel Online [per OneDrive,](/connectors/excelonline/) è possibile creare attività e flussi di lavoro automatizzati in base ai dati in Excel Online per aziende o OneDrive. Questo connettore offre azioni che consentono di eseguire attività sui dati e gestire i fogli di calcolo, ad esempio:
...
1. Nella casella di ricerca digitare "excel" come filtro. Nell'elenco delle azioni selezionare l'azione desiderata.
   ...
   > [!NOTE]
   > Progettazione app per la logica non può caricare tabelle con 100 o più colonne. Se possibile, ridurre il numero di colonne nella tabella selezionata in modo che la finestra di progettazione possa caricare la tabella.

1. Se richiesto, accedere all'account di Office 365.
...
Per dettagli tecnici, ad esempio trigger, azioni e limiti, come descritto dai file OpenAPI (in precedenza Swagger) del connettore, vedere queste pagine di riferimento sul connettore:
