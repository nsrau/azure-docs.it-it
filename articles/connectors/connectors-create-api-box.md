---
title: Aggiungere il connettore Box alle app per la logica | Microsoft Docs
...
> [!INCLUDE [Passaggi per la creazione di una connessione a Box](../../includes/connectors-create-api-box.md)]
> 
> 
