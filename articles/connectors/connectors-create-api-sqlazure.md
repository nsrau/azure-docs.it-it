...
- Usare le azioni per ottenere una riga, inserirla e così via. Queste azioni ottengono una risposta e quindi rendono l'output disponibile per altre azioni. Ad esempio, è possibile ottenere una riga di dati da SQL Azure e quindi aggiungere i dati in Excel. 
