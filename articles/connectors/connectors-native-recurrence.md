...
Con il trigger di ricorrenza è possibile creare potenti flussi di lavoro nel cloud come:
...
1. Specificare i parametri per l'intervallo di ricorrenza
1. L'app per la logica avvierà ora un'esecuzione dopo ogni intervallo di tempo
...
Di seguito sono riportati i dettagli per il trigger di ricorrenza e i parametri configurabili.
...
#### Ricorrenza
Attivare un'app per la logica dopo un intervallo di tempo specificato. L'asterisco (*) indica che il campo è obbligatorio.
...
|Fuso orario|timeZone|Se viene fornito un valore startTime senza un offset UTC, verrà usato tale valore timeZone|
|Ora di inizio|startTime|Ora di inizio nel [formato ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations). Se viene fornito un valore startTime senza un offset UTC, verrà usato tale valore timeZone|
<br>
