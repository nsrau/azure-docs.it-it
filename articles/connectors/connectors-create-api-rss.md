---
title: Connettore RSS per App per la logica di Azure | Microsoft Docs
...
Per visualizzare eventuali azioni e trigger definiti in Swagger ed eventuali limiti, vedere i [dettagli del connettore](/connectors/rss/).
