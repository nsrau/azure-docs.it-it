---
title: Informazioni su come usare il connettore SFTP nelle app per la logica | Microsoft Docs
...
> [!INCLUDE [Passaggi per la creazione di una connessione a SFTP](../../includes/connectors-create-api-sftp.md)]
> 
> 
...
> [!INCLUDE [Passaggi per creare un trigger SFTP](../../includes/connectors-create-api-sftp-trigger.md)]
> 
> 

## Aggiungere una condizione
> [!INCLUDE [Passaggi per aggiungere una condizione](../../includes/connectors-create-api-sftp-condition.md)]
> 
> 
...
> [!INCLUDE [Passaggi per creare un'azione SFTP](../../includes/connectors-create-api-sftp-action.md)]
> 
> 
