...
È consigliabile usare la [pagina del servizio gratuito](https://go.microsoft.com/fwlink/?linkid=859151) per creare nuovi servizi. È anche possibile accedere al [portale di Azure](https://portal.azure.com), selezionare **Tutti i servizi** a sinistra e cercare **servizi gratuiti**.
...
- Informazioni su come [evitare gli addebiti per l'account gratuito di Azure](billing-avoid-charges-free-account.md).
