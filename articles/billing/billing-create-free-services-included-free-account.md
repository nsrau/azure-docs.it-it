---
title: Creare servizi gratuiti con account Azure gratuito
...
È consigliabile usare la [pagina del servizio gratuito](https://go.microsoft.com/fwlink/?linkid=859151) per creare nuovi servizi. Oppure è possibile accedere per il [portale di Azure](https://portal.azure.com), selezionare **tutti i servizi** sulla sinistra e cercare **servizi gratuiti**.
...
## <a name="create-multiple-service-instances-in-allowed-limits"></a>Creare più istanze del servizio nei limiti consentiti
...
- Informazioni su come [evitare gli addebiti per l'account Azure gratuito](billing-avoid-charges-free-account.md).
