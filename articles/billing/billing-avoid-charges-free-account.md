...
L'account gratuito di Azure offre 200 dollari sotto forma di credito di Azure da spendere nei primi 30 giorni e 12 mesi di servizi gratuiti. Per altre informazioni, vedere [Account gratuito di Azure](https://azure.microsoft.com/free/) e [Creare servizi gratuiti con l'account gratuito di Azure](billing-create-free-services-included-free-account.md). In base allo stato del credito, è possibile usarlo o farsi addebitare i costi per l'uso non coperto dai vantaggi dell'account gratuito di Azure.
...
Se il credito Azure non è ancora scaduto, usarlo per pagare eventuali addebiti creati per l'account gratuito di Azure.

## <a name="your-credit-ran-out-or-has-expired"></a>Il credito è esaurito o scaduto
Se il credito è esaurito o scaduto alla fine dei 30 giorni, Azure disabilita la sottoscrizione. I costi non vengono addebitati a meno che l'utente non abiliti la sottoscrizione passando a una sottoscrizione con pagamento a consumo. Per altre informazioni vedere [Aggiornare la versione di valutazione gratuita della sottoscrizione di Azure alla sottoscrizione con pagamento in base al consumo](billing-upgrade-azure-subscription.md). Dopo aver aggiornato la sottoscrizione, vengono addebitate le tariffe di pagamento a consumo per eventuali spese sostenute per l'account gratuito di Azure. 


Ecco alcuni motivi per cui si possono sostenere costi sull'account gratuito di Azure.


### <a name="your-usage-exceeds-the-limits-of-free-services-included-with-azure-free-account"></a>L'uso del servizio supera i limiti di uso gratuito inclusi con l'account gratuito di Azure
