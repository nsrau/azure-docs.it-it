...
Quando si ha accesso alle risorse del cliente, usare PowerShell o l'interfaccia della riga di comando per collegare l'ID Microsoft Partner Network (ID MPN) all'ID utente o all'entità servizio. È necessario collegare l'ID partner per ogni tenant del cliente. 
