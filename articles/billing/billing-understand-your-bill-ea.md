...
In questa sezione non si applica ai clienti di Azure in Australia, Giappone o Singapore. Se trovano in uno dei paesi in questione, vedere [fatture per altri clienti](#invoices-for-other-customers).
