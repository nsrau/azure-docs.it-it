...
## <a name="incorrect-overage-invoice"></a>Fattura per eccedenza non corretta

Se si ritiene di aver ricevuto una fattura per eccedenza errata, vedere [Informazioni sulla fattura del contratto Enterprise di Azure](billing-understand-your-bill-ea.md) per riconciliare gli addebiti di utilizzo di Azure. Se si ritiene che vi sia un errore nell'eccedenza addebitata da Microsoft, contattare il supporto tecnico.
...
Azure EA Portal genera automaticamente un numero di ordine di acquisto predefinito, a meno che l'amministratore della registrazione EA non ne imposti uno prima della data della fattura. Un amministratore della registrazione EA può aggiornare il numero di ordine di acquisto in Azure EA Portal eseguendo l'accesso e passando a **Report**. Un amministratore EA può aggiornare il numero di ordine di acquisto. Nella sezione in alto a destra, che mostra il numero di ordine di acquisto, fare clic sul simbolo della matita e aggiornare le informazioni.

Un amministratore EA può aggiornare il numero di ordine di acquisto durante il trimestre di fatturazione corrente prima della creazione di una fattura. Può farlo anche fino a sette giorni dopo la ricezione di un messaggio di posta elettronica automatico di notifica della fattura.

Se l'amministratore EA non ha aggiornato il numero di ordine di acquisto ed è necessario un nuovo numero di ordine di acquisto, l'unica opzione consiste nel completare un credito e rifatturare. Se un cliente deve aggiornare il numero di ordine di acquisto, contattare il proprio partner per assistenza.
...
Tutti i crediti o le rettifiche applicate alla registrazione sono visibili all'indirizzo [https://ea.azure.com](https://ea.azure.com) nella sezione **Report**. Per domande specifiche su un importo di credito effettivo, contattare il [Supporto per il portale di Azure EA](https://support.microsoft.com/supportrequestform/cf791efa-485b-95a3-6fad-3daf9cd4027c).
...
Gli _addebiti fatturati separatamente_ e i _servizi di Azure Marketplace_ sono servizi di terze parti distribuiti dalla piattaforma Azure Marketplace. La differenza principale tra i due servizi è il modo in cui vengono fatturati, in base alla struttura del contratto stabilita con editori di terze parti.

L'utilizzo di servizi di terze parti viene visualizzato nella fattura in **Addebiti fatturati separatamente**. L'utilizzo usa il saldo dell'impegno monetario di Azure. Per visualizzare l'elenco dei servizi di terze parti, vedere [I servizi per rivenditori di terze parti di Azure Marketplace usano ora l'impegno monetario di Azure](https://azure.microsoft.com/updates/azure-marketplace-third-party-reseller-services-now-use-azure-monetary-commitment/).

L'utilizzo visualizzato in **Azure Marketplace** nella fattura viene addebitato separatamente. Non è coperto da alcun impegno monetario. Tuttavia tutti gli addebiti, compresi Marketplace, eccedenza e addebiti fatturati separatamente, vengono raggruppati in un'unica fattura.

Si riceve una sola fattura per l'eccedenza dei sevizi proprietari di Azure e per gli acquisti di servizi di terze parti in Azure Marketplace.

Quando l'impegno monetario viene utilizzato completamente, l'utilizzo viene fatturato su base mensile o trimestrale. Se la registrazione è iniziata prima del maggio 2018, viene applicata una regola di soglia dell'impegno monetario del 150% e le eccedenze vengono addebitate trimestralmente. Se la registrazione è iniziata dopo il maggio 2018, tutte le eccedenze vengono fatturate mensilmente.
