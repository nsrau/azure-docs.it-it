...
Per altre informazioni sull'aggiunta di un reparto, vedere Creare un reparto EA di Azure.
...
![Esempio di aggiunta di un contatto ](./media/billing-ea-portal-administration/create-ea-manage-partner-notification.png)
