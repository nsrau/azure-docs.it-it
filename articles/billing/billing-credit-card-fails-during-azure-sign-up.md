...
---
<a id="your-debit-card-or-credit-card-is-declined-at-azure-sign-up" class="xliff"></a>

# La carta di debito o credito viene rifiutata al momento dell'iscrizione ad Azure
...
<a id="representing-a-business-that-doesnt-want-to-pay-by-card-set-up-invoicing" class="xliff"></a>

## L'utente rappresenta un'azienda che non desidera pagare con carta? Impostare la fatturazione
...
<a id="update-your-credit-card-or-debit-card-information" class="xliff"></a>

## Aggiornare le informazioni sulla carta di credito o debito
...
<a id="need-more-help-contact-support" class="xliff"></a>
