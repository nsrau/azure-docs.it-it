...
Questo esempio è abbreviato; vedere [List usage details](https://docs.microsoft.com/rest/api/consumption/usagedetails/listbybillingperiod#usagedetailslistresult) (Dettagli dell'elenco di utilizzo) per una descrizione completa di ogni campo di risposta. 
