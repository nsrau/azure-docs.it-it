...
### <a name="can-notifications-be-sent-to-a-different-email-address-other-than-the-account-administrator-email-address-associated-with-my-account"></a>È possibile inviare le notifiche a un indirizzo di posta elettronica diverso da quello dell'amministratore account associato all'account?
