...
### <a name="a-namestep2astep-2-change-the-directory-associated-with-the-azure-subscription"></a><a name="Step2"></a>Passaggio 2: Cambiare la directory associata alla sottoscrizione di Azure
