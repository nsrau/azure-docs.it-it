...
- Richiedere un invito per l'anteprima del [Lab di sviluppo/test di Azure](https://azure.microsoft.com/campaigns/devtest-lab/). Consente di gestire ambienti lab di sviluppo e test usando i modelli e di configurare le quote e i criteri da usare nell'organizzazione.
