...
- [Archiviazione con ridondanza locale](#locally-redundant-storage)
- [Archiviazione con ridondanza della zona](#zone-redundant-storage)
- [Archiviazione con ridondanza geografica](#geo-redundant-storage)
- [Archiviazione con ridondanza geografica e accesso in lettura](#read-access-geo-redundant-storage)
...
|Replication Strategy|Archiviazione con ridondanza locale|ZRS|Archiviazione con ridondanza geografica|RA-GRS 
|--------------------|---|---|---|------
