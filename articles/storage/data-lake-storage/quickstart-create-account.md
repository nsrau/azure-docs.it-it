...
A tale scopo, usando Cloud Shell o una shell locale, immettere il comando seguente per eseguire questa operazione: `az extension add --name storage-preview`
