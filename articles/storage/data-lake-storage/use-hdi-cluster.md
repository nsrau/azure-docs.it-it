...
> [!NOTE]
> Durante l'anteprima pubblica di Archiviazione di Data Lake Gen2 è supportato solo `--type LRS`. Opzioni di ridondanza aggiuntive saranno rese disponibili in tutto il programma di anteprima.
...
&lt;FileSystem&gt; identifica il percorso del file system di Archiviazione di Azure Data Lake.
&lt;AccountName&gt; identifica il nome dell'account di Archiviazione di Azure. È necessario specificare un nome di dominio completo (FQDN).

Se non sono stati specificati i valori di &lt;FileSystem&gt; e &lt;AccountName&gt;, viene usato il file system predefinito. Per i file presenti nel file system predefinito è possibile usare un percorso relativo o un percorso assoluto. Ad esempio, è possibile fare riferimento al file *hadoop-mapreduce-examples.jar* incluso nei cluster HDInsight usando uno dei percorsi seguenti:
