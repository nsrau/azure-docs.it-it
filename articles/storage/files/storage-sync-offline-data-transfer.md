...
Durante la sincronizzazione della condivisione, la sincronizzazione unirà tutti gli attributi, le autorizzazioni o i timestamp di file mancanti dalle varianti di file nel server locale, combinandole con le relative controparti di file dalla condivisione DataBox. In questo modo ogni file e cartella arriva con tutta la fedeltà possibile dei file nella condivisione file di Azure.This ensures each file and folder a arrives with all possible file fidelity in the Azure file share.
