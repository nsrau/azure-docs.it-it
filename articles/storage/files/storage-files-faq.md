...
Questo articolo illustra alcune domande frequenti sulle caratteristiche e funzionalità di File di Azure, tra cui Sincronizzazione file di Azure. Se non è presente la risposta a una domanda specifica, contattare Microsoft tramite i seguenti canali (in ordine di escalation):

1. Nella sezione dei commenti di questo articolo.
...
* <a id="why-files-useful"></a>**Perché File di Azure è utile?**  
...
* <a id="file-access-options"></a>**Quali sono i vari modi per accedere ai file in File di Azure?**  
    È possibile montare la condivisione file nel computer locale usando il protocollo SMB 3.0 o usare strumenti come [Storage Explorer](http://storageexplorer.com/) per accedere ai file nella condivisione file. Dall'applicazione è possibile usare le librerie client di archiviazione, le API REST, PowerShell o l'interfaccia della riga di comando per accedere ai file nella condivisione File di Azure.

* <a id="what-is-afs"></a>**Che cos'è Sincronizzazione file di Azure?**  
...
* <a id="files-versus-blobs"></a>**Perché usare una condivisione file di Azure rispetto all'archiviazione BLOB di Azure per i dati?**  
...
* <a id="files-versus-disks"></a>**Perché usare una condivisione file di Azure rispetto a Dischi di Azure?**  
...
* <a id="get-started"></a>**Come iniziare a usare File di Azure?**  
...
* <a id="redundancy-options"></a>**Quali opzioni di ridondanza di archiviazione sono supportate da File di Azure?**  
...
* <a id="tier-options"></a>**Quali livelli di archiviazione sono attualmente supportati da File di Azure?**  
    File di Azure supporta attualmente solo il livello di archiviazione standard. Non sono attualmente disponibili sequenze temporali per il supporto ad accesso sporadico e Premium. Si noti che non è possibile creare condivisioni file di Azure dagli account di archiviazione solo BLOB o dagli account di archiviazione Premium.

* <a id="give-us-feedback"></a>**È possibile aggiungere la funzionalità *x* a File di Azure?**  
...
* <a id="afs-region-availability"></a>**Quali sono le aree attualmente supportate per Sincronizzazione file di Azure (anteprima)?**  
...
* <a id="cross-domain-sync"></a>**È possibile avere server aggiunti a un dominio e server non inclusi nel dominio nello stesso gruppo di sincronizzazione?**  
...
* <a id="afs-storage-redundancy"></a>**L'archiviazione con ridondanza geografica è supportata per Sincronizzazione file di Azure?**  
...
* <a id="sizeondisk-versus-size"></a>**Perché la proprietà *Dimensioni su disco* per un file non corrisponde alla proprietà *Dimensioni* dopo l'uso di Sincronizzazione file di Azure?**  
...
* <a id="is-my-file-tiered"></a>**Come stabilire se un file è a livelli?**  
...
* <a id="afs-recall-file"></a>**Un file che si vuole usare è stato suddiviso in livelli. In che modo è possibile richiamarlo su disco per l'uso in locale?**  
...
* <a id="afs-force-tiering"></a>**Come è possibile forzare la suddivisione in livelli di un file o una directory?**  
...
* <a id="afs-os-support"></a>**Sincronizzazione file di Azure supporta Windows Server 2008 R2, Linux o i dispositivi NAS?**
...
* <a id="ad-support"></a>**L'autenticazione basata su Active Directory e il controllo di accesso sono supportati da File di Azure?**  
...
* <a id="encryption-at-rest"></a>**Come è possibile garantire che la condivisione file di Azure disponga della crittografia dei dati inattivi?**  
    L'abilitazione della crittografia dei dati inattivi è in corso per impostazione predefinita in tutte le aree. Per queste aree non è necessario eseguire alcuna operazione per abilitare la crittografia. Per altre regioni, vedere la [crittografia lato server](../common/storage-service-encryption.md?toc=%2fazure%2fstorage%2ffiles%2ftoc.json).

* <a id="access-via-browser"></a>**Come è possibile fornire accesso a un file specifico tramite un Web browser?**  
...
* <a id="file-level-permissions"></a>**È possibile specificare autorizzazioni di sola lettura o di sola scrittura per le cartelle all'interno della condivisione?**  
...
* <a id="ip-restrictions"></a>**È possibile implementare le restrizioni IP per una condivisione di File di Azure?**  
    Sì, l'accesso alla condivisione di File di Azure può essere limitato a un livello di account di archiviazione. Per altre informazioni, vedere [Configurare i firewall e le reti virtuali di Archiviazione di Azure](../common/storage-network-security.md?toc=%2fazure%2fstorage%2ffiles%2ftoc.json).

* <a id="data-compliance-policies"></a>**Quali sono i criteri di conformità dei dati supportati per File di Azure?**  
   L'esecuzione di File di Azure si basa sulla stessa architettura di archiviazione di altri servizi di Archiviazione di Azure e applica gli stessi criteri di conformità dei dati. Altre informazioni sulla conformità dei dati di Archiviazione di Azure sono disponibili per il download; fare riferimento al [documento di Protezione dati di Microsoft Azure](http://go.microsoft.com/fwlink/?LinkID=398382&clcid=0x409) e al [Centro protezione Microsoft](https://www.microsoft.com/TrustCenter/default.aspx).

## <a name="on-premises-access"></a>Accesso locale
* <a id="expressroute-not-required"></a>**È necessario usare Azure ExpressRoute per connettersi a File di Azure o per usare Sincronizzazione file di Azure in locale?**  
...
* <a id="mount-locally"></a>**Come è possibile montare una condivisione file di Azure nel computer locale?**  
...
* <a id="backup-share"></a>**Come è possibile eseguire il backup nella condivisione file di Azure?**  
    È possibile usare [snapshot di condivisione periodici (anteprima)](storage-how-to-use-files-snapshots.md) per la protezione da eliminazioni accidentali. È possibile usare AzCopy, RoboCopy o uno strumento di backup di terze parti per eseguire il backup di una condivisione di file montati. 

## <a name="share-snapshots"></a>Snapshot di condivisione
### <a name="share-snapshots---general"></a>Snapshot di condivisione - Generale
* <a id="what-are-snaphots"></a>**Che cos'è uno snapshot di condivisione file?**  
...
* <a id="where-are-snapshots-stored"></a>**Dove vengono archiviati gli snapshot di condivisione?**  
    Gli snapshot di condivisione vengono archiviati nello stesso account di archiviazione della condivisione file.

* <a id="snapshot-perf-impact"></a>**Ci sono implicazioni per le prestazioni?**  
    Gli snapshot di condivisione non comportano alcun overhead delle prestazioni.

* <a id="snapshot-consistency"></a>**Gli snapshot di condivisione sono coerenti con l'applicazione?**  
...
* <a id="snapshot-limits"></a>**Esistono limiti al numero degli snapshot di condivisione?**  
...
* <a id="geo-redundant-snaphsots"></a>**Gli snapshot di condivisione hanno ridondanza geografica?**
...
* <a id="browse-snapshots-linux"></a>**È possibile esplorare gli snapshot di condivisione da Linux?**  
...
* <a id="copy-snapshots-to-other-storage-account"></a>**È possibile copiare gli snapshot di condivisione in un altro account di archiviazione?**  
...
* <a id="promote-share-snapshot"></a>**È possibile alzare di livello uno snapshot di condivisione alla condivisione di base?**  
...
* <a id="restore-snapshotted-file-to-other-share"></a>**È possibile ripristinare dati da uno snapshot di condivisione in un account di archiviazione diverso?**  
...
* <a id="delete-share-keep-snapshots"></a>**È possibile eliminare la condivisione ma non gli snapshot di condivisione?**
...
* <a id="delete-share-with-snapshots"></a>**Cosa accade agli snapshot di condivisione se si elimina l'account di archiviazione?**
...
* <a id="vm-file-share-network-traffic"></a>**Il traffico di rete tra una macchina virtuale di Azure e una condivisione file di Azure viene conteggiato come larghezza di banda esterna e addebitato alla sottoscrizione?**  
...
* <a id="share-snapshot-price"></a>**Qual è il costo degli snapshot di condivisione?**
     ...
     Gli snapshot di condivisione sono di natura incrementale. Lo snapshot di condivisione di base è la condivisione stessa. Tutti gli snapshot di condivisione successivi sono incrementali e archivieranno solo le differenze rispetto allo snapshot di condivisione precedente. È previsto un addebito solo per il contenuto modificato. Se si dispone di una condivisione con 100 GiB di dati, ma solo 5 GiB sono stati modificati dall'ultimo snapshot di condivisione, lo snapshot di condivisione consumerà solo 5 GiB aggiuntivi e verranno addebitati solo 105 GiB. Vedere la [pagina dei prezzi](https://azure.microsoft.com/pricing/details/storage/files/) per altre informazioni sui costi di transazione e di uscita standard.

## <a name="scale-and-performance"></a>Scalabilità e prestazioni
* <a id="files-scale-limits"></a>**Quali sono i limiti di scalabilità di File di Azure?**  
    Per informazioni sugli obiettivi di scalabilità e prestazioni di File di Azure, vedere [Obiettivi di scalabilità e prestazioni di File di Azure](storage-files-scale-targets.md).

* <a id="need-larger-share"></a>**È possibile aumentare la dimensione della condivisione di File di Azure rispetto all'offerta attuale?**  
    No, la dimensione massima di una condivisione di File di Azure è 5 TiB. Attualmente non è possibile modificare questo limite. Microsoft sta lavorando a una soluzione per aumentare la dimensione della condivisione a 100 TiB, ma attualmente non sono disponibili sequenze temporali.

* <a id="open-handles-quota"></a>**Quanti client possono accedere allo stesso file contemporaneamente?**  
...
* <a id="zip-slow-performance"></a>**Le prestazioni sono ridotte quando si prova a decomprimere i file in File di Azure. Cosa devo fare?**  
...
* <a id="slow-perf-windows-81-2012r2"></a>**È stata montata una condivisione file di Azure in Windows Server 2012 R2 o Windows 8.1 e le prestazioni sono ridotte. Perché?**  
...
* <a id="cluster-witness"></a>**È possibile usare la condivisione file di Azure in uso come *controllo di condivisione file* per Windows Server Failover Cluster?**  
...
* <a id="containers"></a>**È possibile montare una condivisione file di Azure su un'Istanza di contenitore di Azure**?  
    Sì, le condivisioni file di Azure sono un'opzione molto utile per salvare in modo permanente le informazioni oltre la durata di un'istanza del contenitore. Per altre informazioni vedere [Montare una condivisione file di Azure con Istanze di contenitore di Azure](../../container-instances/container-instances-mounting-azure-files-volume.md).

* <a id="rest-rename"></a>**Esiste un'operazione di ridenominazione nell'API REST?**  
    Attualmente non è possibile.

* <a id="nested-shares"></a>**È possibile usare condivisioni annidate, ovvero una condivisione all'interno di un'altra condivisione?**  
    No. La condivisione file è il driver virtuale che è possibile montare, quindi le condivisioni annidate non sono supportate.

* <a id="ibm-mq"></a>**Uso di File di Azure con IBM MQ**  
