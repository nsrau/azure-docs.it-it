...
* Moduli di PowerShell Az e AzureRM.
...
- [Aggiungere o rimuovere un Endpoint Server di sincronizzazione File di Azure](storage-sync-files-server-endpoint.md)
- [Registrare o annullare la registrazione di un server con sincronizzazione File di Azure](storage-sync-files-server-registration.md)
