...
Per aggiornare le autorizzazioni a livello di condivisione, vedere Assegnare autorizzazioni di [accesso a un'identità.](https://docs.microsoft.com/azure/storage/files/storage-files-identity-auth-active-directory-domain-service-enable#assign-access-permissions-to-an-identity)
