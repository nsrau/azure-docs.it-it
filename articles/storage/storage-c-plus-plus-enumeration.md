...
Specificando il parametro*max_results*del segmento, è possibile bilanciare numero di richieste e utilizzo della memoria per soddisfare le considerazioni sulle prestazioni dell'applicazione.
...
Un’API tipica ad elenco lazy, che utilizza**list_blobs**ad esempio, è simile a quanto segue:
