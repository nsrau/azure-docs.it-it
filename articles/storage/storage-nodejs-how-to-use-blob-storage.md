...
* [Riferimento per le API di Azure Storage SDK per Node.js][Riferimento per le API di Azure Storage SDK per Node.js] (Riferimento per le API di Azure Storage SDK per Node.js)
