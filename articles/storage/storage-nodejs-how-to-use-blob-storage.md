...
* [Riferimento per le API di Azure Storage SDK per Node.js][Riferimento per le API di Azure Storage SDK per Node.js]
* [Blog del team di Archiviazione di Azure][Blog del team di Archiviazione di Azure]
* Repository [Azure Storage SDK for Node][Azure Storage SDK for Node] su GitHub
