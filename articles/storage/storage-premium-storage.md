...
<tr>
    <td>Max. numero di snapshot per BLOB</td>
    <td>100</td>
</tr>
<tr>
...
<tr>
    <td>Min tempo tra snapshot consecutivi</td>
    <td>10 minuti</td>
</tr>
</tbody>
</table>
...
## <a name="create-and-use-a-premium-storage-account-for-a-virtual-machine-data-disk"></a>Creare e usare un account di Archiviazione Premium per un disco dati della macchina virtuale
...
#### <a name="i-create-a-premium-storage-account-in-azure-portal"></a>I. Creare un account di archiviazione Premium nel portale di Azure
...
#### <a name="ii-create-an-azure-virtual-machine-via-azure-portal"></a>II. Creare una macchina virtuale di Azure tramite il portale di Azure
...
#### <a name="iii-attach-a-premium-storage-data-disk-via-azure-portal"></a>III. Collegare un disco dati di archiviazione Premium tramite il portale di Azure
...
#### <a name="iv-change-disk-caching-policy-via-azure-portal"></a>IV. Modificare i criteri di memorizzazione nella cache su disco tramite il portale di Azure
1. Trovare la VM DS, DSv2, GS o Fs nuova o preesistente nel portale di Azure.
...
#### <a name="i-create-a-premium-storage-account-in-azure-powershell"></a>I. Creare un account di archiviazione Premium in Azure PowerShell
...
2. Avviare la console PowerShell, connettersi alla sottoscrizione ed eseguire il cmdlet PowerShell seguente nella finestra della console. Come illustrato in questa istruzione PowerShell, quando si crea un account di Archiviazione Premium è necessario specificare il parametro **Type** come **Premium_LRS**.
   
        New-AzureStorageAccount -StorageAccountName "yourpremiumaccount" -Location "West US" -Type "Premium_LRS"

#### <a name="ii-create-an-azure-virtual-machine-via-azure-powershell"></a>II. Creare una macchina virtuale di Azure con Azure PowerShell
...
#### <a name="iii-attach-a-premium-storage-data-disk-via-azure-powershell"></a>III. Collegare un disco dati di archiviazione Premium con Azure PowerShell
...
#### <a name="iv-change-disk-caching-policy-via-azure-powershell"></a>IV. Modificare i criteri di memorizzazione nella cache su disco con Azure PowerShell
...
#### <a name="i-create-a-premium-storage-account-via-azure-cli"></a>I. Creare un account di archiviazione Premium con l'interfaccia della riga di comando di Azure
````
azure storage account create "premiumtestaccount" -l "west us" --type PLRS
````

#### <a name="ii-create-a-ds-series-virtual-machine-via-azure-cli"></a>II. Creare una macchina virtuale della serie DS con l'interfaccia della riga di comando di Azure
...
#### <a name="iii-attach-a-new-premium-data-disk-via-azure-cli"></a>III. Collegare un nuovo disco dati Premium con l'interfaccia della riga di comando di Azure
...
#### <a name="iv-change-disk-caching-policy"></a>IV. Modificare i criteri di memorizzazione nella cache su disco
