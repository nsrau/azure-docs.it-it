<properties
	...
	description="Informazioni su come creare, gestire o eliminare un account di archiviazione nel portale di Azure classico."
	services="storage"
	documentationCenter=""
	authors="tamram"
	manager="adinah"
...
È possibile visualizzare gli endpoint per l'account di archiviazione nel dashboard di archiviazione nel [portale di Azure classico](manage.windowsazure.com) una volta creato l'account.
...
Nel [portale di Azure classico](manage.windowsazure.com) passare a **Gestisci chiavi** nel dashboard o alla pagina **Archiviazione** per visualizzare, copiare e rigenerare le chiavi di accesso alle risorse di archiviazione usate per accedere ai servizi BLOB, tabelle e di accodamento.
...
1. Nel [portale di Azure classico](manage.windowsazure.com) fare clic su **Archiviazione** e quindi sul nome dell'account di archiviazione per aprire il dashboard.
...
1. Nel [portale di Azure classico](manage.windowsazure.com) fare clic su **Archiviazione**.
