...
L'esempio seguente mostra come includere il file autoloader e fare riferimento alla classe **BlobRestProxy**.
...
Per creare un client del servizio BLOB di Azure, è necessario usare la classe **BlobRestProxy**. È possibile:
