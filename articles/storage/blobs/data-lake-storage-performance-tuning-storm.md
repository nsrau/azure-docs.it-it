...
1. In **Ambari** > **storm** > **config** > **Advanced Storm-Worker-log4j**, modificare **&lt;root level = "info"&gt;** per&lt;**root level = "debug"&gt;** . Riavviare tutti i nodi o servizi per rendere effettiva la nuova configurazione.
