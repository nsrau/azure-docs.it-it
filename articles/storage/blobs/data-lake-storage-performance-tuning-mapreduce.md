---
title: 'Ottimizzare le prestazioni: MapReduce, HDInsight & Azure Data Lake Storage Gen2 . Documenti Microsoft'
...
* Un **cluster Azure HDInsight** con accesso a un account Data Lake Storage Gen2. Vedere [Usare Azure Data Lake Storage Gen2 con i cluster di Azure HDInsightSee Use Azure Data Lake Storage Gen2 with Azure HDInsight clusters](https://docs.microsoft.com/azure/hdinsight/hdinsight-hadoop-use-data-lake-storage-gen2)
...
* **Linee guida per l'ottimizzazione delle prestazioni in Data Lake Storage Gen2**.  Per informazioni generali sulle prestazioni, vedere Indicazioni per l'ottimizzazione delle prestazioni di [Data Lake Storage Gen2For](data-lake-storage-performance-tuning-guidance.md) For general performance concepts, see Data Lake Storage Gen2 Performance Tuning Guidance
...
**Mapreduce.job.maps / Mapreduce.job.reduces**: determina il numero massimo di mapper o riduttori da creare.  Il numero di suddivisioni determinerà la quantità di mapper creati per il processo MapReduce.  Pertanto, se ci sono meno suddivisioni rispetto ai mapper richiesti, si potrebbero ottenere meno mapper.       
...
**Passaggio 1: Determinare il numero di processi in esecuzioneStep 1: Determine number of jobs running**
...
**Passaggio 4: Calcolare il numero di contenitori YARNStep 4: Calculate number of YARN containers**
