...
description: Informazioni sulle linee guida per l'ottimizzazione delle prestazioni dei processi di riduzione della mappa in Azure Data Lake Storage Gen2.
author: normesta
...
* **Un account Azure Data Lake storage Gen2**. Per istruzioni su come crearne uno, vedere [Guida introduttiva: creare un account di archiviazione Azure Data Lake storage Gen2](data-lake-storage-quickstart-create-account.md).
...
La memoria totale del cluster è di 8 nodi * 96 GB di memoria YARN per D14 = 768GB
