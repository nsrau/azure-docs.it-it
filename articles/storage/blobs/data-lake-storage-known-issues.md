...
| **Ricerca di Azure** |Supportato solo se si registra l'accesso con più [protocolli in data Lake storage](data-lake-storage-multi-protocol-access.md) anteprima.|
...
| **Registrazione diagnostica** |Supportato solo se si registra l'accesso con più [protocolli in data Lake storage](data-lake-storage-multi-protocol-access.md) anteprima.|
