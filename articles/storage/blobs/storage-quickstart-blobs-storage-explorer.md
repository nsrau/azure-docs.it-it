...
![Screenshot che mostra la finestra Connetti di Microsoft Azure Storage Explorer.](media/storage-quickstart-blobs-storage-explorer/connect.png)
...
![Screenshot che mostra dove selezionare un contenitore in Microsoft Azure Storage Explorer.](media/storage-quickstart-blobs-storage-explorer/listblobs.png)
...
Azure Storage Explorer consente di creare e gestire [snapshot](./snapshots-overview.md) dei BLOB. Per creare uno snapshot di un BLOB, fare clic con il pulsante destro del mouse e scegliere **Crea snapshot**. Per visualizzare gli snapshot per un BLOB, fare clic con il pulsante destro del mouse sul BLOB e scegliere **Manage Snapshots** (Gestisci gli snapshot). Nella scheda corrente viene mostrato un elenco degli snapshot per il BLOB.

![Screenshot che mostra un elenco di BLOB in Microsoft Azure Storage Explorer.](media/storage-quickstart-blobs-storage-explorer/snapshots.png)
...
> [Procedura relativa alle operazioni di archiviazione BLOB](./storage-quickstart-blobs-powershell.md)