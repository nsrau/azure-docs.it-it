...
|Ricerca di Azure (anteprima)| [Ricerca nell'archivio BLOB tramite Ricerca di Azure](https://docs.microsoft.com/azure/search/search-blob-storage-integration)|
