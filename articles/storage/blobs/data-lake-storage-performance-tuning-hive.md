---
title: 'Ottimizzare le prestazioni: Hive, HDInsight & Azure Data Lake Storage Gen2 . Documenti Microsoft'
...
* **Un account di Data Lake Storage Gen2**. Per istruzioni su come crearne uno, vedere Guida introduttiva: Creare un account di archiviazione di Azure Data Lake Storage Gen2For instructions on how to create one, see [Quickstart: Create an Azure Data Lake Storage Gen2 storage account](data-lake-storage-quickstart-create-account.md)
