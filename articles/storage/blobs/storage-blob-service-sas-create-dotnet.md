...
description: Informazioni su come creare una firma di accesso condiviso (SAS) del servizio per un contenitore o un BLOB usando la libreria client .NET o JavaScript V12 SDK
services: storage
author: tamram
ms.service: storage
ms.topic: how-to
