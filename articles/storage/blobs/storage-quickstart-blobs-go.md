...
- Esplorare gli [esempi per Archiviazione BLOB](https://godoc.org/github.com/Azure/azure-storage-blob-go/2016-05-31/azblob#pkg-examples) scritti con la libreria client Go.
