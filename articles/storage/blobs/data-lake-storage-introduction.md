...
| [Hadoop](https://hadoop.apache.org/) | 2.7+ | [Archivio di versioni di Apache Hadoop](https://hadoop.apache.org/release.html) |
...
| [Azure Databricks](https://azure.microsoft.com/services/databricks/) | 4.2+ | [Versioni del runtime di Databricks](https://docs.databricks.com/release-notes/runtime/databricks-runtime-ver.html) |
|[Hortonworks](https://hortonworks.com/)| 2.6+ | [Documentazione di Hortonworks](https://docs.hortonworks.com/) |
...
-   [Creare un cluster HDInsight con Data Lake Storage Gen2](data-lake-storage-quickstart-create-connect-hdi-cluster.md)
