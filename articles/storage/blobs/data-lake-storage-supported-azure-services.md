...
|Acquisizione di Hub eventi di AzureAzure Event Hubs capture| Disponibile a livello generale|[Acquisire eventi tramite Hub eventi di Azure in Archiviazione BLOB di Azure o Azure Data Lake Storage](https://docs.microsoft.com/azure/event-hubs/event-hubs-capture-overview)|
