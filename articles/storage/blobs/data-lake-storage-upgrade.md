...
Questa tabella descrive i set di API disponibili per le applicazioni personalizzate. Per rendere le cose un po' più chiare, sono stati separati questi set di API in 2 tipi: gestione API di file system e le API.

Le API di gestione consentono di gestire gli account, mentre il sistema di file che le API utili per eseguire operazioni su file e cartelle.
...
| .NET SDK-sistema di file                  | [Collegamento](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/client?view=azure-dotnet)                                                                                                                                                                                                                     | *Non ancora disponibile*                                                | *Non ancora disponibile*                                                                                                                                             |
...
| Java SDK: sistema di file                  | [Collegamento](https://docs.microsoft.com/java/api/overview/azure/datalake)                                                                                                                                                                                                                                         | *Non ancora disponibile*                                                | *Non ancora disponibile*                                                                                                                                             |
| Node.js - Gestione                   | [Collegamento](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | Non supportate                                                      | *Ora disponibile -* [Collegamento](https://azure.github.io/azure-storage-node/)                                                                                            |
| Node. js - sistema di file                   | [Collegamento](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | *Non ancora disponibile*                                                | *Non ancora disponibile*                                                                                                                                             |
...
| Python – sistema di file                    | [Collegamento](https://azure-datalake-store.readthedocs.io/en/latest/)                                                                                                                                                                                                                                                                 | *Non ancora disponibile*                                                | *Non ancora disponibile*                                                                                                                                             |
| API REST - gestione                  | [Collegamento](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Non supportato*                                                      | *Ora disponibile -*                                                                                                                                               |
| API REST - sistema di file                  | [Collegamento](https://docs.microsoft.com/rest/api/datalakestore/webhdfs-filesystem-apis)                                                                                                                                                                                                                                       | *Ora disponibile*                                                    | *Ora disponibile -* [Collegamento](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2)                                                      |
| PowerShell - gestione e file system | [Collegamento](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | Gestione: non supportato system File - *non è ancora disponibile*        | Gestione: *ora disponibile -* [Collegamento](https://docs.microsoft.com/powershell/module/az.storage) <br><br>File system: *non è ancora disponibile* |
...
| CLI - sistema di file                       | [Collegamento](https://docs.microsoft.com/cli/azure/dls/fs?view=azure-cli-latest)                                                                                                                                                                                                                                               | *Non ancora disponibile*                                                | *Non ancora disponibile*                                                                                                                                             |
...
| Consumo          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Non ancora disponibile*                                                                                                                                                          | *Non ancora disponibile*                                                                                                                             |
...
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Trasferimento in modalità lift-and-shift**                 | [Data factory di Azure](https://docs.microsoft.com/azure/data-factory/load-azure-data-lake-storage-gen2-from-gen1) | Servizio cloud gestito                                                                                                                | I dati e gli ACL possono essere copiati su attualmente.                                                                                                                                                                                                                                                                      |
...
| **Copia singola e copia incrementale** | Data factory di Azure                                                                                                    | Servizio cloud gestito                                                                                                                | I dati e gli ACL possono essere copiati su attualmente. Per supportare la copia incrementale in Azure Data Factory, i dati devono essere organizzati in serie temporali. L'intervallo più breve tra copie incrementali è di [15 minuti](https://docs.microsoft.com/azure/data-factory/how-to-create-tumbling-window-trigger). |
...
Tenere presente che alcune terze parti possono gestire l'aggiornamento da Data Lake Storage Gen1 a Data Lake Storage Gen2 senza usare gli strumenti di copia di dati/metadati indicati sopra (ad esempio: [Cloudera](https://blog.cloudera.com/blog/2017/08/use-amazon-s3-with-cloudera-bdr/)). Forniscono un'esperienza "centralizzata" che esegue la migrazione dei dati, nonché la migrazione del carico di lavoro. Potrebbe essere necessario eseguire un aggiornamento fuori programma per eventuali strumenti non compresi nell'ecosistema.
...
In questo caso l'attività principale viene usata per convertire un URI che hanno un prefisso `adl://` in un URI che hanno un `abfss://` prefisso.
...
Viene illustrato lo schema URI per l'accesso ai file di Data Lake Storage Gen2 [in questo caso](../../hdinsight/hdinsight-hadoop-use-data-lake-storage-gen2.md) in modo dettagliato, ma parlando in generale, è `abfss://<FILE_SYSTEM_NAME>@<ACCOUNT_NAME>.dfs.core.widows.net/<PATH>`.
...
Dopo aver completato l'operazione di transizione, i passaggi finali comporteranno una verifica completa, Questo sarebbe includono ma non sono limitate per la verifica dei dati è stato copiato in modo affidabile, ACL di verifica per determinare se sono state impostate correttamente, le pipeline end-to-end di verifica per determinare se stiano funzionando correttamente e così via. Dopo aver completato le verifiche, è possibile disattivare le pipeline precedenti, eliminare gli account Data Lake Storage Gen1 di origine e passare velocemente alle soluzioni basate su Data Lake Storage Gen2.
