...
Questa tabella descrive i set di API disponibili per le applicazioni personalizzate. Per rendere le cose più chiare, abbiamo separato questi set di API in 2 tipi: API di gestione e API file system.

Le API di gestione consentono di gestire gli account, mentre file system API consentono di operare sui file e sulle cartelle.
...
| Java SDK-file system                  | [Collegamento](https://docs.microsoft.com/java/api/overview/azure/datalake)                                                                                                                                                                                                                                         | *Non ancora disponibile*                                                | *Non ancora disponibile*                                                                                                                                             |
...
| file system Python                    | [Collegamento](https://azure-datalake-store.readthedocs.io/en/latest/)                                                                                                                                                                                                                                                                 | *Non ancora disponibile*                                                | *Non ancora disponibile*                                                                                                                                             |
| API REST - gestione                  | [Collegamento](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Non supportato*                                                      | *Ora disponibile -*                                                                                                                                               |
| API REST-file system                  | [Collegamento](https://docs.microsoft.com/rest/api/datalakestore/webhdfs-filesystem-apis)                                                                                                                                                                                                                                       | *Ora disponibile*                                                    | *Ora disponibile -* [Collegamento](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2)                                                      |
| PowerShell-gestione e file system | [Collegamento](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | Gestione: file System non supportato- *non ancora disponibile*        | Gestione: *ora disponibile -* [Collegamento](https://docs.microsoft.com/powershell/module/az.storage) <br><br>File System- *non ancora disponibile* |
