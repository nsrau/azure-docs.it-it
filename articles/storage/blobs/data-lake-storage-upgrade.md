...
| Node.js - Gestione                   | [Collegamento](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | Supporto non disponibile                                                      | *Ora disponibile -* [Collegamento](https://azure.github.io/azure-storage-node/)                                                                                            |
...
Lo schema URI per l'accesso ai [file di data Lake storage Gen2 viene illustrato in](../../hdinsight/hdinsight-hadoop-use-data-lake-storage-gen2.md) dettaglio, ma in generale è `abfss://<FILE_SYSTEM_NAME>@<ACCOUNT_NAME>.dfs.core.windows.net/<PATH>`.
