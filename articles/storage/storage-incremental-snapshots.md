...
1. Identificare il momento a cui si desidera ripristinare il disco premium. Si supponga di archiviare lo snapshot *mybackupstdpageblob_ss2* nell'account di archiviazione di backup *mybackupstdaccount*.
