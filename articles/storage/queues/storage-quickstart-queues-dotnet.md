...
1. Aggiornare la dichiarazione del metodo `Main` per [supportare codice asincrono](https://docs.microsoft.com/dotnet/csharp/whats-new/csharp-7#async-main)
