...
Per rimuovere tutte le risorse create in questo esercizio, rimuovere il gruppo di risorse. Questa operazione elimina anche tutte le risorse contenute all'interno del gruppo. In questo caso, rimuove l'account di archiviazione creato e il gruppo di risorse stesso.
