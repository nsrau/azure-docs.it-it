...
Per ottenere l'ora dell'ultima sincronizzazione per l'account di archiviazione con PowerShell, installare una versione del modulo AZ. storage che supporta il recupero delle statistiche di replica geografica. Per esempio:
