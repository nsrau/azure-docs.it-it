...
|**/bk:<BitLockerKey\>**|Facoltativa. Specificare la chiave BitLocker se si desidera che lo strumento sblocchi un oggetto crittografato in cui sono archiviati i file esportati.|  
