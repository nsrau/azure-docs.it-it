...
Nelle proprietà dell'account di archiviazione, il nome dell'impostazione è _supportsHttpsTrafficOnly_. È possibile abilitarlo con API REST, strumenti o raccolte:

* [API REST](https://docs.microsoft.com/en-us/rest/api/storagerp/storageaccounts) (versione: 2016-12-01)
...
* [CLI](https://pypi.python.org/pypi/azure-cli-storage/2.0.11) (versione: 2.0.11)
