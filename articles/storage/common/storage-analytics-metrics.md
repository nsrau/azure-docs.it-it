...
- **Capacity**: la quantità di spazio di archiviazione usata dal servizio BLOB dell'account di archiviazione, in byte.  
- **ContainerCount**: numero di contenitori BLOB nel servizio BLOB dell'account di archiviazione.  
- **ObjectCount**: numero di BLOB di pagine o blocchi sottoposte a commit e di cui non è stato eseguito il commit nel servizio BLOB dell'account di archiviazione.  
