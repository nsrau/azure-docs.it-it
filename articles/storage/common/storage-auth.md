...
|---------|---------|---------|---------|---------|
|BLOB di Azure     |[Supportato](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Supportato](storage-dotnet-shared-access-signature-part-1.md)         |[Supportato](storage-auth-aad.md)         |[Supportato](../blobs/storage-manage-access-to-resources.md)         |
...
|File di Azure (REST)     |[Supportato](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Supportato](storage-dotnet-shared-access-signature-part-1.md)         |Non supportate         |Non supportate         |
|Code di Azure     |[Supportato](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Supportato](storage-dotnet-shared-access-signature-part-1.md)         |[Supportato](storage-auth-aad.md)         |Non supportate         |
|Tabelle di Azure     |[Supportato](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Supportato](storage-dotnet-shared-access-signature-part-1.md)         |Non supportate         |Non supportate         |
