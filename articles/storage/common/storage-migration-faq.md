...
Gli account di archiviazione con domini personalizzati attualmente non supportano l'autenticazione TLS/SSL.
...
## <a name="access-to-storage"></a>Accesso alle risorse di archiviazione
