...
### <a name="export-table-to-json-or-csv-data-file-format"></a>Esportare la tabella nel formato di file di dati JSON o CSV
...
### <a name="export-table-to-blob"></a>Esportare una tabella in un BLOB
...
### <a name="import-entities-to-table-using-blobs"></a>Importare entità nella tabella usando i BLOB
...
Per la proprietà "AzureStorageUseV1MD5" • True: valore predefinito, AzCopy usa l'implementazione di .NET MD5.
• False: AzCopy usa l'algoritmo MD5 conforme a FIPS.
