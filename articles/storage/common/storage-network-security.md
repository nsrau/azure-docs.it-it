...
1. Installare [Azure PowerShell](/powershell/azure/install-azurerm-ps) e [accedere](/powershell/azure/authenticate-azureps).
...
|Griglia di eventi di Azure|Microsoft.EventGrid|Abilitare la pubblicazione di eventi di Archiviazione BLOB. [Altre informazioni](/azure/event-grid/overview)|
