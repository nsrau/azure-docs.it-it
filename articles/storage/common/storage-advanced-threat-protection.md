...
1. Cercare il criterio **Distribuisci Advanced Threat Protection in account di archiviazione** .
     ...
     ![Cerca criterio](./media/storage-advanced-threat-protection/storage-atp-policy-definitions.png)
