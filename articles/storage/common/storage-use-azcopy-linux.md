...
## <a name="blob-upload"></a>BLOB: Caricamento
...
Quando si copia un BLOB senza l'opzione --sync-copy, viene eseguita un'operazione di [copia sul lato server](https://blogs.msdn.com/b/windowsazurestorage/archive/2012/06/12/introducing-asynchronous-cross-account-copy-blob.aspx).
...
`--sync-copy` potrebbe generare costi aggiuntivi in uscita rispetto alla copia asincrona. Per evitare costi in uscita, si consiglia quindi di usare questa opzione in una macchina virtuale di Azure che si trova nella stessa area dell'account di archiviazione di origine.
...
## <a name="file-upload"></a>File: Caricamento
### <a name="upload-single-file"></a>Caricare un singolo file
...
azcopy \
    ...
    --recursive
```
Quando si copia un file dal BLOB alla condivisione file, viene eseguita un'operazione di [copia sul lato server](https://blogs.msdn.com/b/windowsazurestorage/archive/2012/06/12/introducing-asynchronous-cross-account-copy-blob.aspx).
...
* [Come usare l'archivio BLOB da C++](../blobs/storage-c-plus-plus-how-to-use-blobs.md)
...
* [Come usare archiviazione Blob da Python](../blobs/storage-python-how-to-use-blob-storage.md)

### <a name="azure-storage-blog-posts"></a>Post del blog di Archiviazione di Azure:
* [Annuncio di AzCopy in Linux anteprima](https://azure.microsoft.com/blog/announcing-azcopy-on-linux-preview/)
