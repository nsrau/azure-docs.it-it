...
AzCopy in Linux richiede il framework .NET Core, versione 1.1.x, sulla piattaforma. Vedere le istruzioni per l'installazione nella pagina di [.NET Core](https://www.microsoft.com/net/download/linux).
