...
| **Operazione completata** | Transactions con dimensione **ResponseType** equivalente a **Success** |
...
* [Metriche di archiviazione in monitoraggio di Azure](./storage-metrics-in-azure-monitor.md)
