...
Se non è un Key Vault, è possibile crearne uno dal portale, Powershell o CLI:
...
Se si utilizza un insieme di credenziali chiave esistente, è necessario abilitare l'eliminazione temporanea e l'eliminazione dell'insieme di credenziali eseguendo i comandi di PowerShell o CLI di Azure seguenti:
...
È necessario disporre di un insieme di credenziali delle chiavi e una chiave nell'insieme di credenziali. Per specificare la chiave da un insieme di credenziali delle chiavi, seguire questi passaggi:
