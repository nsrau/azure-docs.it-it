...
[!INCLUDE [risoluzione dei problemi-diagnosi-monitoraggio-portale-selettore-archiviazione](../../includes/storage-selector-portal-monitoring-diagnosing-troubleshooting.md)]
...
> [!NOTE]
> Per gli account di archiviazione con un tipo di replica di archiviazione con ridondanza della zona (ZRS) al momento non sono abilitate le funzionalità di metrica e registrazione. Inoltre, il servizio File di Azure attualmente non supporta la registrazione.
> 
> 
...
> [!NOTE]
> È inoltre possibile visualizzare i valori **E2ELatency** e **ServerLatency** per le singole operazioni di archiviazione nei dati dei file di log della registrazione dell'archiviazione.
> 
> 
