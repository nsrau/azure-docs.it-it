...
2. Fare clic su **Monitor**.
   ...
   > [!NOTE]
   > Valutare i costi quando si selezionano le metriche. Sono previsti costi di transazione e di uscita associati all'aggiornamento delle visualizzazioni del monitoraggio. Per altre informazioni, vedere [Analisi archiviazione e fatturazione](http://msdn.microsoft.com/library/azure/hh360997.aspx).
   > 
   > 
...
1. Nel [portale di Azure](https://portal.azure.com)fare clic su **Archiviazione**e quindi sul nome dell'account di archiviazione per aprire il dashboard.
2. Fare clic su **Configure** e usare freccia GIÙ per scorrere fino a **logging**.
