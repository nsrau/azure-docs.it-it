...
Usare il cmdlet di PowerShell [Set-AzureRmStorageAccount](https://docs.microsoft.com/powershell/module/azurerm.storage/Set-AzureRmStorageAccount) e specificare una stringa vuota (`""`) per il valore dell'argomento `-CustomDomainName` per rimuovere la registrazione di un dominio personalizzato.
