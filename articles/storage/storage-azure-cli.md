<properties 
    ...
    description="Imparare a utilizzare l'interfaccia della riga di comando multipiattaforma di Azure (Azure CLI) con l'archiviazione di Azure per creare e gestire gli account di archiviazione e utilizzo di file e BLOB di Azure." 
    services="storage" 
