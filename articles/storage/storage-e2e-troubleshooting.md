...
Per configurare la registrazione e le metriche per l'account di archiviazione tramite il [portale di Azure](https://portal.azure.com), seguire le istruzioni in [Monitorare un account di archiviazione nel portale di Azure](storage-monitor-storage-account.md).
