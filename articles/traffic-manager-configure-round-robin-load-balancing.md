<properties
   ...
   description="Informazioni su come configurare il bilanciamento del caricoround robin per gli endpoint di Gestione traffico."
...
5. Per le **impostazioni del metodo di bilanciamento del carico**, verificare che il metodo di bilanciamento del carico sia **Round robin**. In caso contrario, fare clic su **Round robin** nell'elenco a discesa.
