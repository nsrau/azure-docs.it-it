---
title: Studio del modello di soluzione Cortana Intelligence per la previsione della domanda di energia
...
È importante notare che una trattazione approfondita del processo di analisi scientifica dei dati e dei relativi aspetti matematici e tecnici non rientra nelle finalità di questo documento. Tali informazioni dettagliate sono reperibili nella [documentazione ](https://azure.microsoft.com/services/machine-learning/) e nei [blog](https://blogs.microsoft.com/blog/tag/azure-machine-learning/) del servizio Azure Machine Learning.
...
I piani tariffari correnti della suite Cortana Intelligence e di Azure ML sono disponibili [qui](https://azure.microsoft.com/pricing/details/machine-learning/).
...
È importante notare che l'intero ciclo è completamente automatizzato e viene eseguito in base a una pianificazione. L'intera orchestrazione del ciclo dei dati può essere eseguita con strumenti come [Azure Data Factory](https://azure.microsoft.com/services/data-factory/).
