...
In entrambi gli schemi è possibile identificare gli eventi di raccomandazione di Advisor **eventSource** cercando EventSource `Recommendation` è e **OperationName** è `Microsoft.Advisor/recommendations/available/action`.
