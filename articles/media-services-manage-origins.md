...
1.  Nel [portale di gestione][portale di gestione] fare clic su **Media Services**. Fare quindi clic sul nome del servizio multimediale.
...
5.  Se si desidera configurare l'origine, fare clic sul nome dell'origine.
    ...
    ![Pagina relativa all'origine][Pagina relativa all'origine]
...
3.  Specificare una configurazione per l'autenticazione dell'intestazione firma Akamai.
    ...
    ![Configurazione dell'origine][Configurazione dell'origine]
