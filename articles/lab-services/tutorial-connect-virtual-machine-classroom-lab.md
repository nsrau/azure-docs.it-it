...
1. Passare all'URL di registrazione ricevuto dal professore/docente. 

    ![Creare un lab per le classi](./media/tutorial-connect-vm-in-classroom-lab/access-labs.png)
