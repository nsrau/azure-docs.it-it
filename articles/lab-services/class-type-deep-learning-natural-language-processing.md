...
description: Informazioni su come configurare un lab focalizzato sull'apprendimento avanzato nell'elaborazione del linguaggio naturale (PNL) con Azure Lab Services.
ms.topic: article
ms.date: 06/26/2020
