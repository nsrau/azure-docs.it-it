...
description: Elenco di definizioni di criteri predefiniti di Criteri di Azure per Azure Arc per server. Queste definizioni di criteri predefiniti forniscono approcci comuni alla gestione delle risorse di Azure.
ms.date: 05/05/2020
ms.topic: sample
...
ms.locfileid: "82836572"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-arc-for-servers"></a>Definizioni di criteri predefiniti di Criteri di Azure per Azure Arc per server
