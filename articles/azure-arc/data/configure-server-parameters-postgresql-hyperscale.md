...
## <a name="show-the-current-custom-values-of-the-parameters-settings"></a>Mostra i valori personalizzati correnti delle impostazioni dei parametri

## <a name="with-azdata-cli-command"></a>Con comando CLI azdata
...
### <a name="1-retrieve-the-kind-of-custom-resource-definition-for-your-server-group"></a>1. recuperare il tipo di definizione di risorsa personalizzata per il gruppo di server
...
Cercare il campo "Kind" e riservare il valore, ad esempio: `postgresql-12` .

### <a name="2-describe-the-kubernetes-custom-resource-corresponding-to-your-server-group"></a>2. descrivere la risorsa personalizzata Kubernetes corrispondente al gruppo di server 
...
Se non sono stati impostati valori personalizzati per nessuna delle impostazioni del motore, la sezione impostazioni del motore del set di risultati sarà vuota, ad esempio:
...
## <a name="set-custom-values-for-the-engine-settings"></a>Impostare i valori personalizzati per le impostazioni del motore
