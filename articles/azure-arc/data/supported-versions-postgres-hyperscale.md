...
---
# <a name="supported-versions-of-postgres-with-azure-arc-enabled-postgresql-hyperscale"></a>Versioni supportate di Postgres con Azure Arc abilitata per l'iperscalabilità di PostgreSQL
