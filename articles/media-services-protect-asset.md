...
Procedura: Proteggere un asset con la tecnologia di protezione PlayReady
========================================================================

Questo articolo fa parte di una serie di articoli dedicati alla programmazione in Servizi multimediali di Azure. L'argomento precedente è [Procedura: Controllare lo stato dei processi](http://go.microsoft.com/fwlink/?LinkID=301737&clcid=0x409).
...
Dopo avere acquisito i concetti relativi alla protezione di asset con Servizi multimediali, è possibile passare all'argomento [Come gestire gli asset](http://go.microsoft.com/fwlink/?LinkID=301943&clcid=0x409).
