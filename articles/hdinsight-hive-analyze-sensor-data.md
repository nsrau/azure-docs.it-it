<properties title="Analizzare i dati del sensore usando Hive con HDInsight" pageTitle="Analizzare i dati del sensore usando Hive e Microsoft Azure HDInsight (Hadoop)" description="Informazioni su come usare Hive ed Excel per analizzare e visualizzare i dati del sensore con HDInsight (Hadoop)" metaKeywords="Azure hdinsight hive, Azure hdinsight hive sensor, azure hadoop hive, azure hadoop sensor, azure hadoop excel, azure hdinsight excel" services="hdinsight" solutions="" documentationCenter="big-data" authors="larryfr" videoId="" scriptId="" />
...
![Diagramma dell'architettura della soluzione][Diagramma dell'architettura della soluzione]

## Prerequisiti:

-   Un cluster HDInsight (Hadoop). Per informazioni sulla creazione di un cluster vedere [Provisioning di cluster Hadoop in HDInsight][Provisioning di cluster Hadoop in HDInsight]

-   Microsoft Excel 2013

    > [WACOM.NOTE] Microsoft Excel viene usato per la visualizzazione dei dati con [Power View][Power View], attualmente disponibile solo in Windows.
