...
>[AZURE.NOTE] Se si desidera visualizzare il codice sorgente dell'app completata, andare <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures/GettingStarted/Android" target="_blank">qui</a>.
...
4. Se è stata scaricata la versione 2.0 dell'SDK, è necessario aggiornare il codice con l'URL e la chiave del servizio mobile:
	...
	- 	Per altre informazioni, vedere l'esercitazione <a href="http://azure.microsoft.com/ documentation/articles/mobile-services-android-get-started-data/">Aggiunta di Servizi mobili a un'app esistente</a>. 
