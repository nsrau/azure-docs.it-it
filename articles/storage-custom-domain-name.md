...
<table border="1" cellspacing="0" cellpadding="5" style="border: 1px solid #000000;">
    <tbody>
        <tr>
            ...
            <td><strong>Formato degli URL</strong></td>
        </tr>
        <tr>
            <td>Account di archiviazione</td>
            <td><strong>URL predefinito:</strong> http://accountarchiviazionepersonale.blob.core.windows.net<br />
            <strong>URL di dominio personalizzato:</strong> http://www.contoso.com</td>
        </tr>
        <tr>
            <td>BLOB</td>
        ...
        <tr>
            ...
            <td><strong>URL predefinito:</strong> http://accountarchiviazionepersonale.blob.core.windows.net/myblob 
            <br/>oppure<br />
            http://accountarchiviazionepersonale.blob.core.windows.net/$root/myblob<br />
            <strong>URL di dominio personalizzato:</strong> http://www.contoso.com/myblob
            <br/>oppure<br />
...
## <a name="register-asverify"></a>Registrazione di un dominio personalizzato per l'account di archiviazione utilizzando il sottodominio intermedio asverify
