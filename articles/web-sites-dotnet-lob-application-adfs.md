...
- [Creare un'applicazione line-of-business ASP.NET MVC in Siti Web di Azure che esegue l'autenticazione con Azure Active Directory](../web-sites-dotnet-lob-application-azure-ad/)
