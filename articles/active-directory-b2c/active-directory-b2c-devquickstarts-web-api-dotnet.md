...
---
# <a name="azure-ad-b2c-call-a-web-api-from-a-net-web-app"></a>Azure AD B2C: Chiamare un'API Web da un'app Web .NET
...
## <a name="get-access-tokens-and-call-the-task-api"></a>Ottenere i token di accesso e chiamare le API dell'attività
...
### <a name="save-the-sign-in-token"></a>Salvare il token di accesso
...
### <a name="get-a-token-in-the-controllers"></a>Ottenere un token nei controller
