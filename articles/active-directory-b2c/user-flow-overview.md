...
Il framework dei criteri estensibile di Azure Active Directory B2C (Azure AD B2C) è il punto di forza fondamentale del servizio. I criteri descrivono in modo completo le esperienze per le identità, ad esempio iscrizione, accesso o modifica del profilo. Per poter configurare le attività di gestione delle identità più comuni, il portale di Azure AD B2C include criteri predefiniti configurabili chiamati **flussi utente**.
...
Per creare i flussi utente consigliati, seguire le istruzioni in [Esercitazione: Creare un flusso utente.](tutorial-create-user-flows.md)
