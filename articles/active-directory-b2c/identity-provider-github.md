...
Per usare un account GitHub come provider di [identità](authorization-code-flow.md) in Azure Active Directory B2C (Azure AD B2C), è necessario creare un'applicazione nel tenant che lo rappresenta. Se non si dispone già di un account GitHub, è possibile iscriversi a [https://www.github.com/](https://www.github.com/).
...
1. Per **L'ID client**immettere l'ID client dell'applicazione GitHub creata in precedenza.
