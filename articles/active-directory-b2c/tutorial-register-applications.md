...
Per registrare un'applicazione Web nel tenant di Azure AD B2C, è possibile usare la nuova esperienza unificata **Registrazioni app** oppure l'esperienza legacy **Applicazioni (legacy)** . [Altre informazioni sulla nuova esperienza](https://aka.ms/b2cappregtraining).
...
Per un'applicazione Web è necessario creare un segreto dell'applicazione, che verrà usato dall'applicazione per scambiare un codice di autorizzazione con un token di accesso.
