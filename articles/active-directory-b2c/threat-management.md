...
1. Immettere le impostazioni di protezione password desiderate e quindi selezionare **Salva**.
    ...
    ![portale di Azure pagina di protezione della password in impostazioni Azure AD](./media/threat-management/portal-02-password-protection.png)
