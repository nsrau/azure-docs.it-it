...
1. In **URL sito**immettere l'indirizzo del sito Web, ad esempio `https://contoso.com` . Immettere un URL per l'**URL dell'Informativa sulla privacy**, ad esempio `http://www.contoso.com/privacy`. L'URL del criterio è una pagina da mantenere per fornire informazioni sulla privacy per l'applicazione.
...
1. Selezionare **Impostazioni** sotto **Facebook Login** (Accesso a Facebook).
