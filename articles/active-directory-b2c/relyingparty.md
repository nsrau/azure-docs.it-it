...
| --------- | -------- | ----------- |
| ReferenceId | Yes | Identificatore del percorso utente nei criteri. Per altre informazioni, vedere [Percorsi utente](userjourneys.md) |
...
| Attributo | Obbligatoria | DESCRIZIONE |
| --------- | -------- | ----------- |
| NOME | Yes | Nome della coppia chiave-valore. |
