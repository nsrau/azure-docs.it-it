...
Per usare Twitter come provider di identità in Azure AD B2C, è necessario creare un'applicazione Twitter. Se non hai già un account Twitter, puoi [https://twitter.com/signup](https://twitter.com/signup)registrarti all'indirizzo .
...
1. Seleziona Provider di **identità**, quindi **Twitter**.
1. Immettere un **Nome**. Ad esempio, *Twitter*.
1. Per **ID client**immettere la chiave API consumer dell'applicazione Twitter creata in precedenza.
1. Per il **segreto client**, immettere la chiave segreta DELL'API consumer registrata.
1. Selezionare **Salva**.
