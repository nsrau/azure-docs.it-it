...
Questo articolo illustra come abilitare l'accesso per gli utenti con un account Google usando [criteri personalizzati](active-directory-b2c-overview-custom.md) in Azure Active Directory B2C (Azure ad B2C).
