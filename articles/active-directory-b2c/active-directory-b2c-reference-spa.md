...
![Diagramma di Swimlane-stile di visualizzazione che mostra il flusso implicito di OpenID Connect](../media/active-directory-v2-flows/convergence_scenarios_implicit.png)
