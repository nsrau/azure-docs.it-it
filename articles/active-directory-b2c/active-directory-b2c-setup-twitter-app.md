...
Per usare Twitter come provider di identità in Azure AD B2C, è necessario creare un'applicazione Twitter. Se non si ha già un account Twitter, è possibile iscriversi all' [https://twitter.com/signup](https://twitter.com/signup).
