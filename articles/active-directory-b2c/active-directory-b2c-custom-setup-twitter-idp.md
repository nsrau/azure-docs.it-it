---
title: Aggiungere Twitter come provider di identità OAuth1 tramite criteri predefiniti in Azure Active Directory B2C | Microsoft Docs
description: Usare Twitter come provider di identità tramite il protocollo OAuth1.
