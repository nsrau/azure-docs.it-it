...
1. [Seguire questa procedura per passare al pannello delle funzionalità B2C nel portale di Azure](active-directory-b2c-app-registration.md#navigate-to-the-b2c-features-blade).
2. Fare clic su **Sign-up or sign-in policies** (Criteri di registrazione o accesso).
3. Fare clic su **+Aggiungi** nella parte superiore del pannello.
...
1. [Seguire questa procedura per passare al pannello delle funzionalità B2C nel portale di Azure](active-directory-b2c-app-registration.md#navigate-to-the-b2c-features-blade).
2. Fare clic su **Password reset policies** (Criteri di reimpostazione password).
3. Fare clic su **+Aggiungi** nella parte superiore del pannello.
4. **Nome** indica il nome dei criteri di reimpostazione delle password usati dall'applicazione. Ad esempio, immettere "SSPR".
5. Fare clic su **Provider di identità** e selezionare "Reset password using email address" (Reimposta la password tramite l'indirizzo di posta elettronica). Fare clic su **OK**.
...
7. Fare clic su **Create**. Si noti che il criterio appena creato viene visualizzato come "**B2C\_1\_SSPR**" (il frammento **B2C\_1\_** viene aggiunto automaticamente) nel pannello **Password reset policies** (Criteri di reimpostazione password).
