...
1. Nel progetto `AADB2C.UserMigration.API` aprire il file *appsettings.json*. Sostituire l'impostazione con quella configurata nel [passaggio 2.2](#step-22-configure-the-application-settings):
