...
Questo articolo è una continuazione dell'articolo sulla migrazione degli utenti ed è incentrato sulla migrazione di identità di social networking. Prima di iniziare, leggere [Migrazione degli utenti](user-migration.md).
...
https://graph.windows.net/tenant-name.onmicrosoft.com/users **post**
...
5. Eseguire la richiesta GET seguente. Sostituire userObjectId con l'ID utente copiato. **Ottenere** https://graph.windows.net/tenant-name.onmicrosoft.com/users/userObjectId
...
https://graph.windows.net/tenant-name.onmicrosoft.com/users/userObjectId **patch**
...
Per altre informazioni su come usare l'app di esempio, vedere [Azure Active Directory B2C: migrazione degli utenti](user-migration.md)
