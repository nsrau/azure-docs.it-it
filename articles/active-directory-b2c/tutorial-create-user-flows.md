...
1. Nella scheda **Consigliati** selezionare il flusso utente **Iscrizione e accesso**.

    ![Pagina Selezionare un tipo di flusso utente con il flusso Iscrizione e accesso evidenziato](./media/tutorial-create-user-flows/signup-signin-type.png)
...
1. Per **Provider di identità** selezionare **Iscrizione posta elettronica**.
    ...
    ![Pagina Crea un flusso utente nel portale di Azure con proprietà evidenziate](./media/tutorial-create-user-flows/signup-signin-properties.png)
...
1. Selezionare il flusso utente **Modifica del profilo** nella scheda **Consigliati**.
