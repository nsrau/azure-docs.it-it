...
1. Aprire il file di base dei criteri, Ad esempio, <em> `SocialAndLocalAccounts/` </em>. Questo file di base è uno dei file di criteri inclusi nello Starter Pack del criterio personalizzato, che è necessario ottenere nel prerequisito, [Introduzione ai criteri personalizzati](https://docs.microsoft.com/azure/active-directory-b2c/active-directory-b2c-get-started-custom).
...
Nella definizione del contenuto modificare il valore di `LoadUri` in. `https://<app_name>.azurewebsites.net/home/unified` Il criterio `ContentDefinition` personalizzato dovrebbe essere simile al frammento di codice seguente:
