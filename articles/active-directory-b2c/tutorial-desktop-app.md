...
3. Il flusso di lavoro per l'iscrizione presenta una pagina per raccogliere e verificare l'identità dell'utente usando un indirizzo e-mail. Il flusso di lavoro per l'iscrizione raccoglie anche la password dell'utente e gli attributi richiesti definiti nel flusso utente.
    ...
    ![Pagina di iscrizione visualizzata nel flusso di lavoro di accesso/iscrizione](./media/tutorial-desktop-app/azure-ad-b2c-sign-up-workflow.png)
...
![Dettagli del token visualizzati nel riquadro inferiore dell'applicazione desktop WPF](./media/tutorial-desktop-app/desktop-app-01-post-signin.png)
