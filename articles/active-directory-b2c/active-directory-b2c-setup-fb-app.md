...
8. Copiare il valore di **ID App**. Fare clic su **Mostra** e copiare il valore di **App segreta**. Sono necessari entrambi per configurare Facebook come provider di identità nel tenant. Nota: il **segreto app** è un'importante credenziale di sicurezza.
...
10. Per rendere l'applicazione Facebook utilizzabile da AD B2C di Azure, è necessario renderla pubblicamente disponibile. Per eseguire questa operazione, fare clic su **Stato e verifica** a sinistra e inviare l'applicazione per la revisione facendo clic sul pulsante **Inizia il tuo invio**. Quando l'applicazione è stata approvata da Facebook, è possibile renderla pubblica impostando l'opzione nella parte superiore della pagina su **SÌ**. Fare clic su **Conferma**.
