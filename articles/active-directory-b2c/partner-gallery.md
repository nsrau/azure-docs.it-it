...
ms.locfileid: "96171000"
---
# <a name="azure-active-directory-b2c-isv-partners"></a>Partner ISV Azure Active Directory B2C

Microsoft ISV partner Network estende le funzionalità della soluzione per facilitare la creazione di esperienze utente finali senza problemi. Con Azure AD B2C, è possibile eseguire l'integrazione con i partner ISV per abilitare i metodi di autenticazione a più fattori, abilitare l'autenticazione del cliente sicuro (SCA), eseguire il controllo degli accessi in base al ruolo e combattere le frodi attraverso la verifica dell'identità e la correzione. Per informazioni su come integrare le app con i partner ISV elencati di seguito, seguire le procedure dettagliate di esempio.
...
## <a name="integration-isv-partners"></a>Partner ISV di integrazione
...
| ![Screenshot di un logo N8 Identity.](./media/partner-gallery/n8identity-logo.png) | [N8 Identity](./partner-n8identity.md) è una piattaforma di governance come servizio che fornisce la soluzione per gestire la migrazione degli account dei clienti e l'amministrazione delle richieste di assistenza clienti (CSR) in esecuzione in Microsoft Azure. |
| ![Screenshot di un logo Nevis.](./media/partner-gallery/nevis-logo.png) | [Nevis](./partner-nevis.md) offre un'esperienza utente finale per dispositivi mobili e completamente personalizzata con l'app di accesso Nevis per offrire un'autenticazione avanzata dei clienti e conforme ai requisiti delle transazioni PSD2 (Payment Services Directive 2). |
...
| ![Screenshot di un logo di strati.](./media/partner-gallery/strata-logo.png) | Gli [strati](./partner-strata.md) proteggono le applicazioni locali applicando criteri di accesso coerenti, mantenendo sincronizzate le identità e semplificando la transizione di applicazioni da sistemi di identità legacy a controlli di accesso e autenticazione basati su standard forniti da Azure ad B2C. |
...
Selezionare un partner nella tabella precedente per informazioni su come integrare la soluzione con Azure AD B2C.

Altre informazioni:

- [Sito della community B2C su GitHub](https://azure-ad-b2c.github.io/azureadb2ccommunity.io/)
- [Criteri personalizzati su Azure AD B2C](custom-policy-overview.md)
