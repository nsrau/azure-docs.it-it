---
title: Aggiungere l'accesso a un'app Web Node.js in Azure Active Directory B2C | Microsoft Docs
description: Come compilare un'app Web Node.js che esegua l'accesso degli utenti con Azure Active Directory B2C.
...
Per Azure Active Directory (Azure AD) è possibile installare questo modulo e aggiungere il plug-in `passport-azure-ad` di Azure Active Directory.
...
Il codice per questa esercitazione è [disponibile in GitHub](https://github.com/AzureADQuickStarts/B2C-WebApp-OpenIDConnect-NodeJS). Per seguire la procedura, è possibile [scaricare la struttura dell'app come file ZIP](https://github.com/AzureADQuickStarts/B2C-WebApp-OpenIDConnect-NodeJS/archive/master.zip). È anche possibile clonare la struttura:
