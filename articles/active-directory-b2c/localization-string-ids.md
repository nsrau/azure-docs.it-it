...
| **countryList** | Vedere [l'elenco dei paesi](#countries-list). |
...
## <a name="countries-list"></a>Elenco paesi

Di seguito sono riportati i valori dei paesi usati da autenticazione a più fattori.
