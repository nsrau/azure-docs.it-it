...
2.  Fare clic con il pulsante destro del mouse sul database school appena creato, selezionare **Tasks** e quindi fare clic su **Deploy Database to SQL Azure**.

3.  In Deployment Settings immettere un nome per il database, ad esempio *school*.

4.  Fare clic su **Connect**.

5.  In Server name immettere il nome del server composto da 10 caratteri, seguito da .database.windows.net.
