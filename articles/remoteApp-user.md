...
Azure RemoteApp offre due metodi di distribuzione: cloud e ibrido. Entrambi supportano l'uso di diverse identità utente per l'accesso utente alle applicazioni.
...
|Provider di identità di terze parti supportati da Azure (ad esempio Ping) |Sì |No|	
