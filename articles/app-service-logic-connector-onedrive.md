...
Per usare OneDrive Connector, è necessario innanzitutto creare un'istanza dell'app per le API OneDrive Connector. Attenersi alla procedura riportata di seguito:

1.	Aprire Azure Marketplace con l'opzione + NUOVO in basso a sinistra nel portale di Azure.
2.	Andare a "Web e dispositivi mobili > App per le API" e cercare "OneDrive Connector".
3.	Configurare OneDrive Connector nel modo seguente:
 
	![][1] 
	- **Name**: assegnare un nome a OneDrive Connector
...
4. Fare clic su Create. Verrà creato un nuovo OneDrive Connector.
...
## Usare OneDrive Connector nell'app per la logica ##
...
3.	OneDrive Connector verrà visualizzato nella sezione "API Apps in this resource group" della raccolta a destra.
	...
	![][2]
4.	È possibile trascinare l'app per le API OneDrive Connector nell'editor facendo clic su "OneDrive Connector". Fare clic sul pulsante Authorize. Fornire le credenziali di Microsoft (se non è stata eseguita la connessione automatica). Fare clic su "Sì" per consentire l'accesso.
...
6.	Di seguito viene descritto l'uso dell'azione "Upload File". L'azione "Upload File" di OneDrive consente di caricare un file nell'account OneDrive.
 ...
 - **Overwrite**: specificare "true" per sovrascrivere il file, se già esistente. Si tratta di una proprietà avanzata.
...
9. Per dettagli sulle API, vedere l'articolo relativo alla [definizione delle API di OneDrive Connector].
...
[Definizione delle API di OneDrive]: https://msdn.microsoft.com/it-it/library/dn974227.aspx
