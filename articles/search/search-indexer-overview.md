...
Un indicizzatore esegue il pull dei dati da un'**origine dati** che contiene informazioni come la stringa di connessione. Attualmente sono supportate le origini dati seguenti:
...
Sia [.NET SDK](https://msdn.microsoft.com/library/azure/microsoft.azure.search.iindexersoperations.aspx) che l'[API REST del servizio](https://msdn.microsoft.com/library/azure/dn946891.aspx) supportano la gestione degli indicizzatori e delle origini dati. In alternativa, è anche possibile configurare un indicizzatore nel portale quando si usa la procedura guidata **Importa dati**.
