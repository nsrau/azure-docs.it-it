...
- [Archivio tabelle di Azure](search-howto-indexing-azure-tables.md), attualmente in anteprima.
...
In alternativa, è anche possibile configurare un indicizzatore nel portale quando si usa la procedura guidata **Importa dati**. Per un'esercitazione rapida che usa dati di esempio e l'indicizzatore DocumentDB per creare e caricare un indice con la procedura guidata, vedere [Introduzione a Ricerca di Azure nel portale](search-get-started-portal).
