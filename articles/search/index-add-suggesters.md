...
+ Usare l'analizzatore Lucene standard predefinito`"analyzer": null`() o un [analizzatore del linguaggio](index-add-language-analyzers.md) ( `"analyzer": "en.Microsoft"`ad esempio,) nel campo
