...
description: Comandi HTTP e codice dell'API REST per creare una query di ricerca in Ricerca di Azure. Aggiungere i parametri di ricerca per filtrare e ordinare i risultati.
author: brjohnstmsft
manager: jlembicz
ms.author: brjohnst
services: search
