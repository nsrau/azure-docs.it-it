...
È possibile impostare i criteri di conservazione per i dati su un valore compreso tra 1 e 365 giorni. Per conservare i dati a tempo indeterminato, impostare Conservazione (giorni) su 0.
