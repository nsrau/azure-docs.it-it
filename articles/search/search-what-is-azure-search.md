...
È possibile creare uno schema nel portale di Azure o a livello di codice usando [.NET SDK](search-howto-dotnet-sdk.md) o l'[API REST](https://msdn.microsoft.com/library/azure/dn798941.aspx).
