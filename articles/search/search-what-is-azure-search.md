...
| Ricerca&nbsp;di base&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  | database elastico |
|-------------------|----------|
...
| Contenuto memorizzato nella cache | L' [**arricchimento incrementale (anteprima)** ](cognitive-search-incremental-indexing-conceptual.md) limita l'elaborazione ai soli documenti modificati dalla modifica specifica alla pipeline, usando il contenuto memorizzato nella cache per le parti della pipeline che non cambiano. |

| Importazione/indicizzazione di&nbsp;dati | database elastico |
|----------------------------------|----------|
...
| Livello di&nbsp;piattaforma&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;| database elastico |
|-------------------|----------|
