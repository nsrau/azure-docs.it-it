---
title: Come usare i profili di punteggio in Ricerca di Azure | Microsoft Docs
...
---
# <a name="how-to-use-scoring-profiles-in-azure-search"></a>Come usare i profili di assegnazione dei punteggi in Ricerca di Azure
...
## <a name="edit-appconfig"></a>Modificare il file app.config
...
Altre informazioni sulla sintassi di ricerca e sui parametri di query. Per informazioni dettagliate, vedere [Eseguire ricerche nei documenti (API REST per Ricerca di Azure)](http://msdn.microsoft.com/library/azure/dn798927.aspx) .
