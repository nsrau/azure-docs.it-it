...
**Esempio 2**: fare clic con il pulsante destro del mouse sul frammento di query seguente per fare una prova. Questa query cerca business\_title che contengono il termine senior ma non junior:
