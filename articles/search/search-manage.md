...
+ [Monitorare l'uso delle risorse](#sub-5)
+ [Aumentare o ridurre la quantità di risorse](#sub-6)
+ [Avviare o arrestare il servizio](#sub-7)
+ [Impostare i ruoli per il controllo dell'accesso amministrativo](#sub-8)

<h2 id="sub-1">Aggiungere un servizio di ricerca alla sottoscrizione</h2>
...
<h2 id="sub-3">URL del servizio</h2>
...
<!---->
<h2 id="sub-4">Gestire le chiavi API</h2>
...
<!---->
<h2 id="sub-5">Monitorare l'uso delle risorse</h2>
...
<!---->
<h2 id="sub-6">Aumentare o ridurre la quantità di risorse</h2>
...
Per quei casi in cui è richiesto un numero maggiore di documenti, è possibile aggiungere partizioni. Si noti che le partizioni vengono aggiunte in multipli di 12 (ossia 1, 2, 3, 4, 6 o 12). Si tratta di un elemento del partizionamento orizzontale: un indice viene creato in 12 sottopartizioni, tutte archiviabili a propria volta in un'unica partizione o equamente distribuibili in 2, 3, 4, 6 o 12 partizioni (in quest'ultimo caso, una per partizione).

<h3>Rimuovere repliche </h3>
...
<!---->
<h2 id="sub-7">Avviare o arrestare il servizio</h2>
