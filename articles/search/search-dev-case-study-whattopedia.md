---
title: 'Case study sugli sviluppatori di Ricerca di Azure: in che modo WhatToPedia ha creato un portale di informazioni multimediale in Microsoft Azure | Documentazione Microsoft'
...
---
# <a name="azure-search-developer-case-study"></a>Case study per gli sviluppatori di Ricerca di Azure
## <a name="how-whattopediacomhttpwhattopediacom-built-an-infomedia-portal-on-microsoft-azure"></a>In che modo [WhatToPedia.com](http://whattopedia.com/) ha creato un portale di informazioni multimediale in Microsoft Azure
 ![][6]  &nbsp;&nbsp;&nbsp;  <font size="9">L'idea</font> 
...
## <a name="what-we-built"></a>La nostra creazione
...
## <a name="how-we-did-it"></a>Il processo di creazione
...
### <a name="how-we-use-microsoft-azure"></a>In che modo utilizziamo Microsoft Azure
...
### <a name="authentication-permissions-and-sensitive-data"></a>Autenticazione, autorizzazioni e dati sensibili
...
Abbiamo optato per un modello di autenticazione basato sull'autenticazione basata su form .NET. La scelta di questo approccio è legata alla semplicità. Non era necessario utilizzare ruoli, supporto di interfaccia utente e altre funzionalità estranee associate ad altri approcci. 
...
1. Chiamata del servizio Ricerca di Azure per ottenere tutti i documenti dalla ricerca (vedere: http://msdn.microsoft.com/library/azure/dn798927.aspx)
...
## <a name="what-we-learned"></a>Cosa abbiamo imparato
...
### <a name="webjobs-for-scheduling-tasks"></a>Processi Web per la pianificazione di attività
...
## <a name="appendix-search-indexer-webjob"></a>Appendice: Processo Web indicizzatore di ricerca
