...
> [!Note]
> Un esempio di codice che illustra l'utilizzo della chiave di query è reperibile in [eseguire C#query su un indice di ricerca di Azure in ](search-query-dotnet.md).
