...
1. Selezionare **chiave** come metodo di autenticazione e specificare la chiave dell'account di archiviazione. Selezionare **privato** come livello di privacy. Fare clic su Accedi e iniziare il processo di caricamento.
...
[Concetti di base per le finestre di progettazione nel servizio Power BI](https://docs.microsoft.com/power-bi/service-basic-concepts)