...
+ Per le operazioni di [**`2019-05-06-Preview`**](https://docs.microsoft.com/rest/api/searchservice/index-2019-05-06-preview) ricerca, è la versione di anteprima corrente.
+ Per le operazioni di [**`2019-10-01-Preview`**](https://docs.microsoft.com/rest/api/searchmanagement/index-2019-10-01-preview) gestione, è la versione di anteprima corrente.
...
|||
|-|-|
| [Indicizzatore di Cosmos DB](search-howto-index-cosmosdb.md) | Supporto per l'API MongoDB (anteprima), l'API Gremlin (anteprima) e i tipi di API API Cassandra (anteprima). | 
...
| Restrizione di accesso IP | Usando [`api-version=2019-10-01-Preview`](https://docs.microsoft.com/rest/api/searchmanagement/index-2019-10-01-preview) l'API REST di gestione, è possibile creare un servizio con restrizioni per gli indirizzi IP a cui è consentito l'accesso. |
