...
Ci si potrebbe chiedere come Azure ricerca cognitiva .NET SDK sia in grado di caricare le istanze di una classe definita dall'utente `Hotel` come nell'indice. è possibile esaminare la classe `Hotel`:
