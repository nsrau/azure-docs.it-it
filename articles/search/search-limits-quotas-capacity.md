...
| --- | --- | --- | --- | --- | --- | --- |
| Numero massimo di campi per indice |1000 |100 <sup>1</sup> |1000 |1000 |1000 |1000 |
...
| Risorsa | Gratuito | Basic | S1 | S2 | S3 | S3 HD |
| --- | --- | --- | --- | --- | --- | --- |
| Carico di indicizzazione massimo per chiamata |10.000 documenti |Limitato solo da numero massimo di documenti |Limitato solo da numero massimo di documenti |Limitato solo da numero massimo di documenti |Limitato solo da numero massimo di documenti |N/D <sup>1</sup> |
| Tempo massimo di esecuzione | 1-3 minuti <sup>2</sup> |24 ore |24 ore |24 ore |24 ore |N/D <sup>1</sup> |
| Indicizzatore BLOB: dimensioni massime per un BLOB, MB |16 |16 |128 |256 |256 |N/D <sup>1</sup> |
| Indicizzatore BLOB: numero massimo di caratteri di contenuto estratti da un BLOB |32.000 |64.000 |4 milioni |4 milioni |4 milioni |N/D <sup>1</sup> |

<sup>1</sup> S3 HD attualmente non supporta gli indicizzatori. In caso di esigenze urgenti per questa funzionalità, contattare il supporto tecnico di Azure.

<sup>2</sup> Il tempo massimo di esecuzione degli indicizzatori per il livello gratuito è di 3 minuti per le origini BLOB e di 1 minuto per tutte le altre origini dati.
