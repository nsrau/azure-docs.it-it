...
2. Eseguire:
    ...
    ```
    **Output previsto** ![ Testo di output dopo la rimozione di una raccolta di spostamento](./media/remove-move-resources/remove-collection.png)
