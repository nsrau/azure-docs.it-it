<properties title="Come creare una distribuzione cloud di RemoteApp" pageTitle="Come creare una distribuzione cloud di RemoteApp" description="Informazioni su come creare una distribuzione di RemoteApp che salva i dati nel cloud Azure." metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo" manager="kathyw" />
...
-   Effettuare l'iscrizione per l'anteprima di RemoteApp all'indirizzo <http://azure.microsoft.com/it-it/services/remoteapp/>.
...
-   Per offrire app personalizzate o programmi line-of-business, creare una nuova [immagine del modello personalizzato][immagine del modello personalizzato] e usarla nella distribuzione cloud.
...
5.  Scegliere il modello da usare per il servizio.
    ...
    **Suggerimento:** la sottoscrizione per RemoteApp include un'immagine modello che contiene le applicazioni Office 2013, alcune pubblicate (ad esempio Word) e altre pronte per la pubblicazione. È anche possibile creare una nuova [immagine modello personalizzata][immagine del modello personalizzato] e usarla nella distribuzione cloud.
...
La procedura è stata completata e la distribuzione cloud RemoteApp è stata creata e distribuita. Il passaggio successivo consiste nel chiedere agli utenti di scaricare e installare il client Desktop remoto. L'URL del client è indicato nella pagina Avvio rapido di RemoteApp. Quindi, chiedere agli utenti di connettersi al client e di accedere ai programmi RemoteApp pubblicati.
  ...
  [immagine del modello personalizzato]: http://azure.microsoft.com/it-it/documentation/articles/remoteapp-create-custom-image/
