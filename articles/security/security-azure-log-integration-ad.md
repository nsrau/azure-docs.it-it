...
>[!NOTE]
È necessario esaminare l'articolo [introduttivo](security-azure-log-integration-get-started.md) e completare la procedura in esso descritta prima di eseguire la procedura descritta in questo articolo.
...
>[!NOTE]
È necessario contattare il fornitore SIEM per istruzioni specifiche su come includere le informazioni dei file JSON nella soluzione SIEM.

L'assistenza della community è disponibile tramite il [forum MSDN di Integrazione log di Azure](https://social.msdn.microsoft.com/Forums/office/home?forum=AzureLogIntegration). Questo forum offre ai membri della community di AzLog la possibilità di supporto reciproco con domande, risposte, suggerimenti e trucchi su come ottenere i massimi risultati dall'integrazione dei log di Azure. Inoltre, il team di Integrazione log di Azure monitora questo forum e offrirà il suo contributo quando possibile.
