...
[Log Analytics](https://docs.microsoft.com/azure/operations-management-suite/operations-management-suite-overview) offre una registrazione completa delle attività di sistema e degli utenti, nonché dell'integrità del sistema. La soluzione [Log Analytics](https://azure.microsoft.com/services/log-analytics/) raccoglie e analizza i dati generati dalle risorse in Azure e negli ambienti locali.
...
Anche le seguenti soluzioni di gestione di Log Analytics sono incluse come parte di questa architettura:
