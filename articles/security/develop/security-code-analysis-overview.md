...
Microsoft Security Risk Detection (MSRD) è un servizio basato sul cloud per i test fuzzy. Identifica i bug di sicurezza sfruttabili nel software. Questo servizio richiede un processo di onboarding separato. Per ulteriori informazioni, vedere il [centro per sviluppatori MSRD](https://docs.microsoft.com/security-risk-detection/).
