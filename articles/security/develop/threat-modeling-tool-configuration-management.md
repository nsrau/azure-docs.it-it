...
## <a name="configure-a-windows-firewall-for-database-engine-access"></a><a id="firewall-db"></a>Configurazione di Windows Firewall per l'accesso al Motore di database
