...
| --------------- | ------- |
| **WCF** | <ul><li>[WCF- Non includere il nodo serviceDebug nel file di configurazioneWCF- Do not include serviceDebug node in configuration file](#servicedebug)</li><li>[WCF- Non includere il nodo serviceMetadata nel file di configurazioneWCF- Do not include serviceMetadata node in configuration file](#servicemetadata)</li></ul> |
| **Web API** | <ul><li>[Assicurarsi che venga eseguita la corretta gestione delle eccezioni nellASP.NETAPI Web](#exception)</li></ul> |
| **Applicazione Web** | <ul><li>[Non esporre i dettagli di sicurezza nei messaggi di errore](#messages)</li><li>[Implementare la pagina di gestione degli errori predefinitaImplement Default error handling page](#default)</li><li>[Impostare il metodo di distribuzione su Vendita al dettaglio in IISSet Deployment Method to Retail in IIS](#deployment)</li><li>[Le eccezioni devono avere esito negativo in modo sicuro](#fail)</li></ul> |
...
Controllare i collegamenti nella sezione riferimenti per ulteriori dettagli sulla gestione eccezionale e la convalida del modello in ASP.NETAPI Web 
