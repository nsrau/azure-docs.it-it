...
description: Informazioni sulla convalida dell'input nel Threat Modeling Tool. Vedere le informazioni di mitigazione e gli esempi di codice di visualizzazione.
services: security
...
| **Riferimenti**              | [Sicurezza XSLT ](/previous-versions/windows/desktop/ms763800(v=vs.85)), [Proprietà XsltSettings.EnableScript](/dotnet/api/system.xml.xsl.xsltsettings.enablescript) |
...
| **Tecnologie applicabili** | Generico |
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [Espansione di entità XML](https://capec.mitre.org/data/definitions/197.html), [Attacchi Denial of Service e difese in XML](/archive/msdn-magazine/2009/november/xml-denial-of-service-attacks-and-defenses), [Cenni preliminari sulla sicurezza MSXML](/previous-versions/windows/desktop/ms754611(v=vs.85)), [Procedure consigliate per la protezione del codice MSXML](/previous-versions/windows/desktop/ms759188(v=vs.85)), [Informazioni di riferimento sul protocollo NSXMLParserDelegate](https://developer.apple.com/library/ios/#documentation/cocoa/reference/NSXMLParserDelegate_Protocol/Reference/Reference.html), [Risoluzione di riferimenti esterni](/dotnet/standard/data/xml/resolving-external-resources) |
...
| **Tecnologie applicabili** | Generico |
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [Unrestricted File Upload](https://owasp.org/www-community/vulnerabilities/Unrestricted_File_Upload) (Caricamento di file senza restrizioni), [File Signature Table](https://www.garykessler.net/library/file_sigs.html) (Tabella delle firme dei file) |
...
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [Adding Validation](https://www.asp.net/mvc/overview/getting-started/introduction/adding-validation) (Aggiunta della convalida), [Validating Model Data in an MVC Application](/previous-versions/dd410404(v=vs.90)) (Convalida dei dati del modello in un'applicazione MVC), [Principi guida per le applicazioni ASP.NET MVC](/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
...
| **Tecnologie applicabili** | Generico |
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [Encode Unsafe Input](/previous-versions/msp-n-p/ff647397(v=pandp.10)#paght000003_step3) (Codificare l'input non sicuro), [HtmlSanitizer](https://github.com/mganss/HtmlSanitizer) |
...
| **Tecnologie applicabili** | Generico, MVC 5, MVC 6 |
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [Validating Model Data in an MVC Application](/previous-versions/dd410404(v=vs.90)) (Convalida dei dati del modello in un'applicazione MVC), [Principi guida per le applicazioni ASP.NET MVC](/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
...
| **Tecnologie applicabili** | Generico, Web Form, MVC 5, MVC 6  |
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [Proprietà DefaultRegexMatchTimeout](/dotnet/api/system.web.configuration.httpruntimesection.defaultregexmatchtimeout) |
...
| **Tecnologie applicabili** | MVC 5, MVC 6 |
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [Convalida dei modelli in un'API Web ASP.NET](https://www.asp.net/web-api/overview/formats-and-model-binding/model-validation-in-aspnet-web-api) |
...
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [MSDN](/previous-versions/msp-n-p/ff647820(v=pandp.10)) |
...
| **Tecnologie applicabili** | Generico, NET Framework 3 |
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [MSDN](/previous-versions/msp-n-p/ff647875(v=pandp.10)) |
