...
| Azure SQL (istanza gestita di database) | Sì                | Anteprima, RSA a 2048 bit  | Sì                |
...
| Apache Kafka per HDInsight       | Sì                | Anteprima, tutte le lunghezze RSA | -                  |
