...
## <a name="a-iddisable-xsltadisable-xslt-scripting-for-all-transforms-using-untrusted-style-sheets"></a><a id="disable-xslt"></a>Disabilitare gli script XSLT per tutte le trasformazioni con fogli di stile non attendibili
...
## <a name="a-idout-sniffingaensure-that-each-page-that-could-contain-user-controllable-content-opts-out-of-automatic-mime-sniffing"></a><a id="out-sniffing"></a>Verificare che ogni pagina che potrebbe includere contenuti controllabili dall'utente rifiuti esplicitamente l'analisi MIME automatica
...
## <a name="a-idxml-resolutionaharden-or-disable-xml-entity-resolution"></a><a id="xml-resolution"></a>Applicare la protezione avanzata o la disabilitazione della risoluzione di entità XML
...
## <a name="a-idapp-verificationaapplications-utilizing-httpsys-perform-url-canonicalization-verification"></a><a id="app-verification"></a>Verifica della canonizzazione degli URL nelle applicazioni che utilizzano http.sys
...
## <a name="a-idcontrols-usersaensure-appropriate-controls-are-in-place-when-accepting-files-from-users"></a><a id="controls-users"></a>Verificare la presenza dei controlli appropriati quando si accettano file dagli utenti
...
## <a name="a-idtypesafeaensure-that-type-safe-parameters-are-used-in-web-application-for-data-access"></a><a id="typesafe"></a>Verificare che nell'applicazione Web vengano usati parametri indipendenti dai tipi per l'accesso ai dati
...
## <a name="a-idbinding-mvcause-separate-model-binding-classes-or-binding-filter-lists-to-prevent-mvc-mass-assignment-vulnerability"></a><a id="binding-mvc"></a>Usare classi di associazione di modelli separate o elenchi di filtri di associazione per prevenire la vulnerabilità dell'assegnazione di massa in MVC
...
## <a name="a-idrenderingaencode-untrusted-web-output-prior-to-rendering"></a><a id="rendering"></a>Codificare l'output Web non attendibile prima del rendering
...
## <a name="a-idtypemodelaperform-input-validation-and-filtering-on-all-string-type-model-properties"></a><a id="typemodel"></a>Eseguire la convalida dell'input e applicare filtri a tutte le proprietà del modello di tipo stringa
...
## <a name="a-idrichtextasanitization-should-be-applied-on-form-fields-that-accept-all-characters-eg-rich-text-editor"></a><a id="richtext"></a>Applicazione della purificazione nei campi modulo che accettano tutti i caratteri, ad esempio un editor di testo RTF
...
## <a name="a-idinbuilt-encodeado-not-assign-dom-elements-to-sinks-that-do-not-have-inbuilt-encoding"></a><a id="inbuilt-encode"></a>Non assegnare elementi DOM a sink senza codifica incorporata
...
## <a name="a-idredirect-safeavalidate-all-redirects-within-the-application-are-closed-or-done-safely"></a><a id="redirect-safe"></a>Convalidare come chiusi o sicuri tutti i reindirizzamenti nell'applicazione
...
## <a name="a-iddos-expressionaset-upper-limit-timeout-for-regular-expression-processing-to-prevent-dos-due-to-bad-regular-expressions"></a><a id="dos-expression"></a>Impostare il limite massimo di timeout per l'elaborazione di espressioni regolari per impedire attacchi DoS causati da espressioni regolari errate
...
## <a name="a-idhtml-razoraavoid-using-htmlraw-in-razor-views"></a><a id="html-razor"></a>Evitare di usare Html.Raw nelle visualizzazioni Razor
...
## <a name="a-idstored-procado-not-use-dynamic-queries-in-stored-procedures"></a><a id="stored-proc"></a>Non usare query dinamiche nelle stored procedure
...
## <a name="a-idvalidation-apiaensure-that-model-validation-is-done-on-web-api-methods"></a><a id="validation-api"></a>Verificare l'esecuzione della convalida dei modelli nei metodi di API Web
...
## <a name="a-idstring-apiaimplement-input-validation-on-all-string-type-parameters-accepted-by-web-api-methods"></a><a id="string-api"></a>Implementare la convalida dell'input in tutti i parametri di tipo stringa accettati dai metodi di API Web
...
## <a name="a-idtypesafe-apiaensure-that-type-safe-parameters-are-used-in-web-api-for-data-access"></a><a id="typesafe-api"></a>Verificare che nell'API Web vengano usati parametri indipendenti dai tipi per l'accesso ai dati
...
## <a name="a-idsql-docdbause-parametrized-sql-queries-for-documentdb"></a><a id="sql-docdb"></a>Usare query SQL con parametri per DocumentDB
...
## <a name="a-idschema-bindingawcf-input-validation-through-schema-binding"></a><a id="schema-binding"></a>WCF: convalida dell'input tramite l'associazione allo schema
...
## <a name="a-idparametersawcf--input-validation-through-parameter-inspectors"></a><a id="parameters"></a>WCF: convalida dell'input tramite controlli parametro
