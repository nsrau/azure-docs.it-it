...
-   [Log di monitoraggio di Azure per i gruppi di sicurezza di rete (gruppi)](https://docs.microsoft.com/azure/virtual-network/virtual-network-nsg-manage-log)
