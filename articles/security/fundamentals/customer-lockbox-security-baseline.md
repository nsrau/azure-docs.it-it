...
La baseline per questo servizio è tratta dal [benchmark di sicurezza di Azure versione 1.0](../benchmarks/overview.md), che fornisce raccomandazioni su come proteggere le soluzioni cloud in Azure seguendo le indicazioni delle procedure consigliate Microsoft.

Per altre informazioni, vedere la [Panoramica delle baseline di sicurezza di Azure](../benchmarks/security-baselines-overview.md).

## <a name="network-security"></a>Sicurezza di rete

*Per altre informazioni, vedere [Controllo di sicurezza: sicurezza di rete](../benchmarks/security-control-network-security.md).*
...
*Per altre informazioni, vedere [Controllo di sicurezza: Registrazione e monitoraggio](../benchmarks/security-control-logging-monitoring.md).*
...
* [Log di controllo per Customer Lockbox](./customer-lockbox-overview.md#auditing-logs)
...
*Per altre informazioni, vedere [Controllo di sicurezza: gestione delle identità e controllo di accesso](../benchmarks/security-control-identity-access-control.md).*
...
**Indicazioni**: usare una workstation con accesso con privilegi (Paw) con Azure ad multi-factor authentication (multi-factor authentication) abilitata per l'accesso e la configurazione delle richieste di Customer Lockbox.
...
* [Come creare e configurare un'istanza di Azure Active Directory](../../active-directory/fundamentals/active-directory-access-create-new-tenant.md)
...
* [Informazioni sulla creazione di report Azure Active Directory](../../active-directory/reports-monitoring/index.yml)

* [Come usare le verifiche di accesso Azure Active Directory](../../active-directory/governance/access-reviews-overview.md)
...
* [Come visualizzare Azure Active Directory l'accesso rischioso](../../active-directory/identity-protection/overview-identity-protection.md)
...
*Per altre informazioni, vedere [Controllo di sicurezza: protezione dei dati](../benchmarks/security-control-data-protection.md).*
...
* [Informazioni sulla protezione dei dati dei clienti in Azure](./protection-customer-data.md)
...
* [Informazioni sulla crittografia in transito con Azure](./encryption-overview.md#encryption-of-data-in-transit)
...
*Per altre informazioni, vedere [Controllo di sicurezza: gestione della vulnerabilità](../benchmarks/security-control-vulnerability-management.md).*
...
*Per altre informazioni, vedere [Controllo di sicurezza: gestione di asset e inventario](../benchmarks/security-control-inventory-asset-management.md).*
...
*Per altre informazioni, vedere [Controllo di sicurezza: configurazione sicura](../benchmarks/security-control-secure-configuration.md).*
...
*Per altre informazioni, vedere [Controllo di sicurezza: difesa da malware](../benchmarks/security-control-malware-defense.md).*
...
*Per altre informazioni, vedere [Controllo di sicurezza: ripristino dei dati](../benchmarks/security-control-data-recovery.md).*
...
*Per altre informazioni, vedere [Controllo di sicurezza: risposta agli eventi imprevisti](../benchmarks/security-control-incident-response.md).*
...
*Per altre informazioni, vedere [Controllo di sicurezza: test di penetrazione ed esercizi Red Team](../benchmarks/security-control-penetration-tests-red-team-exercises.md).*
...
- Vedere [Azure Security Benchmark](../benchmarks/overview.md)
- Altre informazioni su [Baseline di sicurezza di Azure](../benchmarks/security-baselines-overview.md)