---
title: Documentazione sui concetti fondamentali della sicurezza di Azure
description: Informazioni sulla sicurezza di Azure.
services: security
author: arob98
manager: angrobe
layout: LandingPage
...
ms.locfileid: "70148898"
---
# <a name="azure-security-fundamentals-documentation"></a>Documentazione sui concetti fondamentali della sicurezza di Azure

Informazioni sulla sicurezza di Azure.
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">L'organizzazione sta valutando Azure. Quali sono le funzionalità per la sicurezza offerte da Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="https://aka.ms/sharedresponsibility">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">In che modo Microsoft condivide le responsabilità relative alla sicurezza con l'organizzazione?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/fundamentals/infrastructure">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">In che modo Microsoft protegge l'infrastruttura di Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-storage-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Panoramica della sicurezza dell'archiviazione</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-network-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Panoramica della sicurezza di rete</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-azure-encryption-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Panoramica della crittografia dei dati</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/develop">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Sviluppare e distribuire applicazioni sicure</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/fundamentals/encryption-atrest">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">In che modo Azure protegge i dati inattivi?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Come crittografare le macchine virtuali di Azure</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/develop/secure-dev-overview">Procedure consigliate per lo sviluppo sicuro</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/threat-detection">Rilevamento delle minacce avanzato in Azure</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/abstract-network-security">Sicurezza della rete di Azure</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/abstract-develop-secure-apps">Sviluppare applicazioni sicure in Azure</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/network-best-practices">Sicurezza di rete</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/data-encryption-best-practices">Sicurezza dei dati</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-security-best-practices-vms">Sicurezza delle macchine virtuali</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/identity-management-best-practices">Identità e accesso</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/iaas">Sicurezza IaaS</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/security-paas-deployments">Proteggere le distribuzioni PaaS</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/global-admin">Proteggere gli account amministratore di Azure</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Conformità</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Risorse &amp; servizi</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps?search=security&page=1">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Partner di sicurezza di Azure</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/fundamentals/cyber-services">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Consulenza sulla cybersecurity</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/fundamentals/pen-testing">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Test di penetrazione</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security-center/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Centro sicurezza di Azure</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Crittografia del disco</p>
                        </div>
                    </div>
                </div>
            </div>
