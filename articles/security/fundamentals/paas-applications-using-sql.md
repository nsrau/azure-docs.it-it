...
In questo articolo vengono illustrate varie procedure consigliate per la protezione delle applicazioni Web e per dispositivi mobili in PaaS (piattaforma distribuita come servizio) mediante il [database SQL di Azure](../../azure-sql/database/sql-database-paas-overview.md) e [SQL Data Warehouse](../../synapse-analytics/sql-data-warehouse/sql-data-warehouse-overview-what-is.md). Le procedure consigliate si basano sull'esperienza di tecnici e clienti con Azure.
...
- Supporta le connessioni da SQL Server Management Studio che utilizzano l'autenticazione universale di Active Directory, che include l'autenticazione [MFA (Multi-Factor Authentication)](/azure/active-directory/authentication/multi-factor-authentication). L'MFA include funzionalità avanzate di autenticazione con una serie di semplici opzioni di verifica, tra cui: chiamata telefonica, SMS, smart card con pin o notifica tramite app per dispositivi mobili. Per altre informazioni, vedere [Autenticazione universale con database SQL e SQL Data Warehouse](../../azure-sql/database/authentication-mfa-ssms-overview.md).

Per altre informazioni sull'autenticazione di Azure AD, vedere:

- [Usare Azure Active Directory per l'autenticazione al database SQL, a Istanza gestita e a SQL Data Warehouse](../../azure-sql/database/authentication-aad-overview.md)
...
- [Controllo di accesso per il database SQL di Azure e SQL Data Warehouse](../../azure-sql/database/logins-create-manage.md)
- [Regole del firewall per il database SQL di Azure e SQL Data Warehouse](../../azure-sql/database/firewall-configure.md)
