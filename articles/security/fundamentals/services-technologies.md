...
|[Lab di sviluppo/test di Azure](/azure/lab-services/devtest-lab-overview)|Servizio che consente agli sviluppatori e ai tester di creare rapidamente ambienti in Azure riducendo al minimo gli sprechi e i costi di controllo.  |
...
| [Gateway applicazione di Azure](/azure/application-gateway/application-gateway-introduction)|Servizio di bilanciamento del carico avanzato per applicazioni Web, in grado di eseguire il routing in base a URL e che supporta l'offload SSL. |
...
| [Azure Load Balancer](/azure/load-balancer/load-balancer-overview)|Servizio di bilanciamento del carico di rete per applicazioni TCP/UDP. |
...
|[Endpoint del servizio rete virtuale](/azure/virtual-network/virtual-network-service-endpoints-overview)|Estende lo spazio di indirizzi privato della rete virtuale e l'identità della rete virtuale ai servizi di Azure tramite una connessione diretta.|