...
description: Baseline della sicurezza di Azure per protezione DDoS di Azure standard
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 06/22/2020
...
La linea di base di sicurezza di Azure per la protezione DDoS di Azure standard contiene raccomandazioni che consentono di migliorare il comportamento di sicurezza della distribuzione.
...
**Linee guida**: non applicabile; Il servizio DDoS di Azure è progettato per essere abilitato nelle reti virtuali che ospitano altri servizi. si tratta di un'offerta di base di Azure e l'infrastruttura sottostante, inclusa la rete, è completamente gestita da Microsoft.
...
**Linee guida**: non applicabile; Microsoft gestisce l'origine dell'ora usata per le risorse di Azure, ad esempio la protezione DDoS di Azure.
...
* [Come configurare gli avvisi per le metriche di protezione DDoS](https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection#configure-alerts-for-ddos-protection-metrics)
...
**Linee guida**: non applicabile; Protezione DDoS di Azure non elabora o produce log correlati all'anti-malware.
...
**Linee guida**: non applicabile; Protezione DDoS di Azure non elabora o produce log correlati a DNS.
...
* [Informazioni sulle autorizzazioni per la protezione DDoS di Azure](https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection#permissions)
...
* [Informazioni sull'API di protezione DDos di Azure](https://docs.microsoft.com/rest/api/virtual-network/)
...
**Linee guida**: usare una workstation con accesso con privilegi (Paw) con Azure multi-factor authentication (multi-factor authentication) abilitata per l'accesso e la configurazione delle richieste di Customer Lockbox di Azure.
...
* [Come usare le verifiche di accesso Azure AD](https://docs.microsoft.com/azure/active-directory/governance/access-reviews-overview)
...
**Linee guida**: questa raccomandazione non è applicabile alla protezione DDoS di Azure.
...
**Linee guida**: non applicabile; verrà eseguito il provisioning del piano di protezione DDoS nel gruppo di risorse definito. Nessun endpoint pubblico da proteggere o isolare.
...
**Linee guida**: Microsoft gestisce l'infrastruttura sottostante per la protezione DDoS di Azure e ha implementato severi controlli per impedire la perdita o l'esposizione dei dati del cliente.
...
**Linee guida**: non applicabile; Protezione DDoS di Azure non tiene i dati dei clienti inattivi.
...
**Linee guida**: non applicabile; Protezione DDoS di Azure non tiene i dati dei clienti.
...
**Linee guida**: per lavorare con i piani di protezione DDoS, l'account deve essere assegnato al ruolo Collaboratore rete o a un ruolo personalizzato a cui sono assegnate azioni specifiche.

* [Gestire il controllo degli accessi in base al ruolo in protezione DDoS di Azure](https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection)
...
**Indicazioni**: non applicabile; questa raccomandazione riguarda le risorse di calcolo. Microsoft gestisce l'infrastruttura sottostante per la protezione DDoS di Azure e ha implementato severi controlli per impedire la perdita o l'esposizione dei dati del cliente.
...
**Linee guida**: non applicabile; Microsoft esegue la gestione delle vulnerabilità nei sistemi sottostanti che supportano la protezione DDoS di Azure.
...
**Linee guida**: non applicabile; per lavorare con i piani di protezione DDoS, l'account deve essere assegnato al ruolo Collaboratore rete o a un ruolo personalizzato a cui sono assegnate le azioni appropriate. Non sono necessarie password, segreti o chiavi per accedere alla protezione DDoS.
...
**Linee guida**: non applicabile; Protezione DDoS di Azure non usa le identità gestite.
...
**Indicazioni**: non applicabile; queste linee guida sono destinate alle risorse di calcolo. Microsoft anti-malware è abilitato nell'host sottostante che supporta i servizi di Azure, ad esempio la protezione DDoS di Azure, ma non viene eseguito sui contenuti dei clienti.
...
**Linee guida**: non applicabile; La protezione DDoS di Azure non archivia i dati dei clienti.
