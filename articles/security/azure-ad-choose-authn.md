...
* Requisiti dell'agente di autenticazione pass-through, usando due agenti per la ridondanza:
...
> [!NOTE] 
> Controlli personalizzati nell'accesso condizionale di Azure AD non supporta attualmente la registrazione dispositivi.
