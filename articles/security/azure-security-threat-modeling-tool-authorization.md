...
<a id="security-frame-authorization--mitigations" class="xliff"></a>
...
| Azure Cosmos DB | <ul><li>[Usare i token delle risorse per la connessione ad Azure Cosmos DB, quando possibile](#resource-docdb)</li></ul> |
