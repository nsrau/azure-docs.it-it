...
|[Analisi archiviazione di Azure](https://docs.microsoft.com/en-us/rest/api/storageservices/Storage-Analytics)| Tecnologia per la registrazione e la generazione di metriche per i dati nell'account di archiviazione. |
...
| [Transparent Data Encryption&nbsp;SQL di&nbsp;Azure](https://docs.microsoft.com/en-us/sql/relational-databases/security/encryption/transparent-data-encryption-azure-sql?view=azuresqldb-current)| Funzionalità di sicurezza del database che crittografa l'archivio di un intero database. |
