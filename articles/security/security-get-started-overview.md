...
La sicurezza è la priorità principale nel cloud ed è importante che l'utente trovi informazioni accurate e tempestive sulla sicurezza di Azure. Uno dei principali vantaggi dell'uso di Azure per le applicazioni e i servizi è poter sfruttare l'ampia gamma di strumenti e funzionalità di sicurezza a disposizione dell'utente per creare soluzioni sicure sulla piattaforma Azure protetta.

Questa pagina e questo sito continueranno a evolversi nel tempo, man mano che vengono pubblicati online nuovi servizi di Azure e che vengono rapidamente aggiornati quelli esistenti. Le offerte sulla sicurezza vengono costantemente migliorate e in questo sito verranno illustrati i dettagli tecnici di tali miglioramenti. Si consiglia di visitare regolarmente questo sito per scoprire le novità.

## Uso del sito di informazioni sulla sicurezza di Azure
Sul lato sinistro della pagina verrà visualizzato un insieme di categorie di argomenti relativi alla sicurezza. Fare clic o toccare l'argomento per visualizzare gli articoli disponibili per tale categoria.
...
> [AZURE.NOTE] Tutti gli articoli presenti nel sito di informazioni sulla sicurezza di Azure vengono visualizzati nel riquadro di navigazione sul lato sinistro della pagina. Per visualizzare tutti gli articoli, fare clic o toccare **Vedi altri** nella parte inferiore dell'elenco delle categorie.
