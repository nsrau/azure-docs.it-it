...
Se si desidera creare una rete virtuale solo cloud, vedere [Esercitazione: creare una rete virtuale solo cloud in Azure](create-virtual-network.md). Se si desidera creare una rete VPN da punto a sito utilizzando certificati e un client VPN, vedere [Configurare una VPN da punto a sito utilizzando la procedura guidata del portale di gestione](http://go.microsoft.com/fwlink/p/?LinkId=296653).
...
-  [Aggiungere una macchina virtuale a Rete virtuale](virtual-machines-create-custom.md)
