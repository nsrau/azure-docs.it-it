---
title: Ambienti di sviluppo e test | Microsoft Docs
...
4. Con un editor di testo o JSON modificare il file di parametri per l'ambiente di sviluppo creato nel passaggio 3, sostituendo i valori elencati a destra dei valori dei parametri nel file con i *valori* elencati a destra dei **parametri** seguenti:
...
5. Con un editor di testo o JSON modificare il file di parametri per l'ambiente di test creato nel passaggio 3, sostituendo i valori elencati a destra dei valori dei parametri nel file con i *valori* elencati a destra dei **parametri** seguenti:
...
6. Con un editor di testo o JSON modificare il file di parametri per l'ambiente di pre-produzione creato nel passaggio 3. Sostituire l'intero contenuto del file con il codice seguente:
