<properties 
	pageTitle="Usare gli script del server per convalidare e modificare i dati (JavaScript) | Mobile Dev Center" 
	description="Informazioni su come convalidare e modificare i dati inviati tramite script del server dall'app JavaScript per Windows Store." 
