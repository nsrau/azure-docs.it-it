...
1.  [Aggiornamento dell'applicazione per consentire gli aggiornamenti]
2.  [Abilitazione del rilevamento dei conflitti nell'applicazione]
...
5.  Eseguire l'app **todolist** in entrambi i computer. Modificare la proprietà `text` dell'ultimo elemento nell'istanza 2, quindi fare clic su un'altra casella di testo in modo che il gestore dell'evento `LostFocus` aggiorni il database.
...
6.  Nell'istanza 1 dell'app immettere un valore diverso per l'ultima proprietà text. Fare quindi clic su un'altra casella di testo in modo che il gestore dell'evento `LostFocus` tenti di aggiornare il database con una proprietà `__version` errata.
