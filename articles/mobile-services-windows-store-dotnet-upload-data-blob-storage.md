<properties pageTitle="Uso di Servizi mobili per caricare immagini nell'archiviazione BLOB (Windows Store) | Servizi mobili" metaKeywords="" description="Informazioni su come usare Servizi mobili per caricare immagini in archiviazione BLOB di Azure e accedere alle immagini da app di Windows Store." metaCanonical="" services="mobile-services,storage" documentationCenter="Mobile" title="Upload images to Azure Storage by using Mobile Services" authors="glenga" solutions="mobile" manager="dwrede" editor="" />
