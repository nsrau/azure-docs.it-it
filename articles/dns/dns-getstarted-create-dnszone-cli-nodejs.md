---
title: Creare una zona DNS con l&quot;interfaccia della riga di comando di Azure 1.0 | Microsoft Docs
description: Informazioni su come creare le zone DNS in DNS di Azure. Si tratta di una guida dettagliata per creare e gestire la prima zona DNS usando l&quot;interfaccia della riga di comando di Azure 1.0.
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>Creare una zona DNS di Azure con l'interfaccia della riga di comando di Azure 1.0
