...
DNS di Azure consente di ospitare una zona DNS e quindi gestire i record DNS per un dominio in Azure. Tenere presente che DNS di Azure non è il registrar.
