...
> [!NOTE]
> Il servizio DNS di Azure fornisce un servizio DNS autorevole.  Non fornisce un servizio DNS ricorsivo.
>
...
### <a name="to-set-up-delegation"></a>Per configurare la delega
...
### <a name="to-verify-name-resolution-is-working"></a>Per verificare che la risoluzione dei nomi funzioni
...
## <a name="delegating-sub-domains-in-azure-dns"></a>Delega di sottodomini in DNS di Azure
...
### <a name="to-delegate-a-sub-domain"></a>Per delegare un sottodominio
...
#### <a name="step-1-create-the-parent-and-child-zones"></a>Passaggio 1. Creare le zone padre e figlio
...
#### <a name="step-2-retrieve-ns-records"></a>Passaggio 2. Recuperare i record NS
