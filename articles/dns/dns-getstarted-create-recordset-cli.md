...
*Sintassi: network dns record-set create <resource-group> <dns-zone-name> <name> <type> <ttl>*
...
*Sintassi: network dns record-set add-record <resource-group> <dns-zone-name> <record-set-name> <type>*
