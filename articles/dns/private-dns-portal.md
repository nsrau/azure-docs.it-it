---
title: Creare una zona privata di DNS di Azure tramite il portale di Azure
description: In questa esercitazione verranno creati e testati una zona privata e un record DNS in DNS di Azure. Guida dettagliata che descrive come creare e gestire la prima zona DNS privata e il primo record DNS usando il portale di Azure.
services: dns
author: vhorne
ms.service: dns
ms.topic: tutorial
...
ms.locfileid: "67147850"
---
# <a name="tutorial-create-an-azure-dns-private-zone-using-the-azure-portal"></a>Esercitazione: Creare una zona privata di DNS di Azure tramite il portale di Azure

Questa esercitazione descrive i passaggi necessari per creare la prima zona DNS privata e il primo record DNS tramite il portale di Azure.
...
Se si preferisce, è possibile completare questa esercitazione usando [Azure PowerShell](private-dns-getstarted-powershell.md) o l'[interfaccia della riga di comando di Azure](private-dns-getstarted-cli.md).
