...
I set di record vengono creati utilizzando il comando `azure network record-set create`. È necessario specificare il nome, la zona, il Time-to-Live (TTL) e il tipo di record del set di record.
