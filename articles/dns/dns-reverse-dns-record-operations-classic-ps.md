...
## Aggiungere un record DNS inverso a un servizio cloud esistente
È possibile aggiungere un DNS inverso a un servizio cloud esistente utilizzando il cmdlet "Set-AzureService".

	PS C:\> Set-AzureService –ServiceName “contosoapp1” –Description “App1 with Reverse DNS” –ReverseDnsFqdn “contosoapp1.cloudapp.net.”

## Creare un nuovo servizio cloud con un record DNS inverso 
...
## Visualizzare un record DNS inverso per un servizio cloud esistente
...
## Rimuovere un record DNS inverso da un servizio cloud esistente
