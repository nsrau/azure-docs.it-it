---
title: Importare ed esportare un file di zona di dominio - Interfaccia della riga di comando di AzureImport and export a domain zone file - Azure CLI
