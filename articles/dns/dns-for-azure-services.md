...
| Gestione traffico di Azure |Nome pubblico |È possibile creare un record alias che esegua il mapping al nome trafficmanager.net assegnato al profilo di Gestione traffico. Per altre informazioni, vedere [Esercitazione: Configurare un record di alias per supportare i nomi di dominio di apex con gestione traffico](tutorial-alias-tm.md). |
