---
title: Come gestire i record DNS inversi per i servizi tramite l’interfaccia della riga di comando di Azure in Gestione risorse | Microsoft Docs
...
[!INCLUDE [DOMANDE FREQUENTI](../../includes/dns-reverse-dns-record-operations-faq-arm-include.md)]
