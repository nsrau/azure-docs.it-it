...
## Aggiungere un record DNS inverso a un indirizzo IP pubblico esistente
È possibile aggiungere un DNS inverso a un indirizzo IP pubblico usando azure network public-ip set.

	azure network public-ip set -n PublicIp -g NRP-DemoRG-PS -f contosoapp1.westus.cloudapp.azure.com.

## Creare un nuovo indirizzo IP pubblico con un record DNS inverso
È possibile aggiungere un nuovo indirizzo IP pubblico con la proprietà DNS inverso specificata utilizzando azure network public-ip create.

	azure network public-ip create -n PublicIp3 -g NRP-DemoRG-PS -l westus -d contosoapp3 -f contosoapp3.westus.cloudapp.azure.com. "
 
## Visualizzare un record DNS inverso per un indirizzo IP pubblico esistente
...
- Il valore “ReverseFqdn” si risolve in avanti nel nome o IP dell’indirizzo IP pubblico per cui è stato specificato o nel valore “Fqdn” o IP di qualsiasi indirizzo IP pubblico nella stessa sottoscrizione, ad esempio “ReverseFqdn” è “app1.contoso.com.”, un alias CName per “contosoapp1.northus.cloudapp.azure.com.” Controlli di convalida vengono eseguiti solo quando la proprietà DNS inverso per un indirizzo IP pubblico viene impostata o modificata. La convalida non viene ripetuta periodicamente.

[AZURE.INCLUDE [DOMANDE FREQUENTI](../../includes/dns-reverse-dns-record-operations-faq-include.md)]
