...
Per trovare l'indirizzo IP per l'app Web, seguire i passaggi in [Configurare un nome di dominio personalizzato nel servizio app di Azure](../app-service-web/web-sites-custom-domain-name.md#Find-the-virtual-IP-address).
