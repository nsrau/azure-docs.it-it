...
È possibile aggiungere un DNS inverso a un indirizzo IP pubblico esistente usando il cmdlet “Set-AzureRmPublicIpAddress”.
...
## Rimuovere un record DNS inverso da un indirizzo IP pubblico esistente
