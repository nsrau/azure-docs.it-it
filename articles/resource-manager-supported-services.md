...
| App remota | No | - | - |
| Servizi cloud (classico) | Parziale (vedere di seguito) | - | - | - |
...
Azure Active Directory funziona con Gestione risorse per l'abilitazione del controllo di accesso basato sul ruolo per la sottoscrizione. Per altre informazioni sull'uso del controllo degli accessi in base al ruolo e su Active Directory, vedere [Controllo degli accessi in base al ruolo di Azure](./active-directory/role-based-access-control-configure.md).
