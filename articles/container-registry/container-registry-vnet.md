...
* [Le attività di ACR](container-registry-tasks-overview.md) operazioni non sono attualmente supportate in un registro contenitori si accede in una rete virtuale.
