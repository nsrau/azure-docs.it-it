...
Se l'immagine di base specificata nell'istruzione `FROM` si trova in uno di questi percorsi, l'attività ACR aggiunge un hook per assicurarsi che l'immagine venga ricompilata ogni volta che viene aggiornata la base.
