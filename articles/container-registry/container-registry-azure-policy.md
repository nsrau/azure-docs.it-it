...
1. Usare i filtri per limitare gli Stati di conformità o per cercare ![la conformità dei criteri](./media/container-registry-azure-policy/azure-policy-compliance.png)nel portale.
