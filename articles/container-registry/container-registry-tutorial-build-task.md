...
Quando viene eseguito dall'utente, il comando `az acr build-task run` per impostazione predefinita trasmette l'output di log alla console. L'output seguente mostra che la compilazione **eastus2** è stata inserita in coda e compilata.
