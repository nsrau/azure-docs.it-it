...
Il comando seguente usa i parametri minimi per creare il registro di contenitori `myRegistry1` nel gruppo di risorse `myResourceGroup` nell'area South Central US:
