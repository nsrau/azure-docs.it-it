...
In questo documento viene presa in considerazione una soluzione ottimizzata che prevede l'uso del bus di servizio di Azure: si tratta di un modello argomento/sottoscrizione in grado di ridurre la complessità assicurando al tempo stesso la scalabilità della soluzione. 
...
2. **ReceiveAndSendNotification**
	...
	e. Per pubblicare questo elemento come **processo Web**, in Visual Studio fare clic con il pulsante destro del mouse sulla soluzione e selezionare **Publish as WebJob**.
...
2. Eseguire **EnterprisePushMobileApp**, cha avvierà l'app di Windows Store. 
