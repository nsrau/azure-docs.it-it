...
È possibile [estendere la durata del lease](../how-tos/session-rest-api.md#update-a-session) di una sessione attiva nel caso in cui sia necessario più tempo.
