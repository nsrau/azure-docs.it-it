...
* [Classe trama C#](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering.texture)
...
* [Classe trama C++](https://docs.microsoft.com/cpp/api/remote-rendering/texture)
