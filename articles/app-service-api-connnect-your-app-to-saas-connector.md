...
1. Passare alla home page del [portale di anteprima di Azure] e fare clic su **Marketplace**.
	...
	![Marketplace nel portale di anteprima di Azure](./media/app-service-api-connect-your-app-to-saas-connector/marketplace.png)

2. Cercare Dropbox e quindi fare clic sull'icona **Connettore Dropbox**.

	![Fare clic su Connettore Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/searchdb.png)
 
3. Fare clic su **Crea**.

	![Fare clic su Crea](./media/app-service-api-connect-your-app-to-saas-connector/clickcreate.png)
...
9. <a id="gateway"></a>Mantenere il valore predefinito "DropboxConnector" come **Nome** del connettore e quindi fare clic su **Crea**.
	...
	![Fare clic su Crea](./media/app-service-api-connect-your-app-to-saas-connector/createdropbox.png)
...
3. Quando Azure completa la creazione del connettore, fare clic su **Sfoglia > Gruppi di risorse > DropboxRG**.
	...
	![Diagramma Gruppo di risorse](./media/app-service-api-connect-your-app-to-saas-connector/rgdiagram.png)
...
1. Passare al [portale per sviluppatori Dropbox](https://www.dropbox.com/developers/apps), fare clic su **App Console** e infine su **Create App**.
	...
	![Creare un'app Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/dbappcreate.png)
...
3. Fare clic su **Create app**.
	...
	![Creare un'app Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/dbapiapp.png)
	...
	![Creare un'app Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/dbappsettings.png)
...
4. Fare clic su **Impostazioni** e nel pannello **Impostazioni** fare clic su **Autenticazione**.
	...
	![Fare clic su Impostazioni](./media/app-service-api-connect-your-app-to-saas-connector/clicksettings.png)

	![Fare clic su Autenticazione](./media/app-service-api-connect-your-app-to-saas-connector/clickauth.png)

5. Nel pannello Autenticazione immettere l'ID client e il segreto client dal sito Dropbox e quindi fare clic su **Salva**.

	![Immettere le impostazioni e fare clic su Salva](./media/app-service-api-connect-your-app-to-saas-connector/authblade.png)
...
3. Copiare l'**URI di reindirizzamento** (casella grigia sopra l'ID client e il segreto client) e aggiungere il valore alla pagina lasciata aperta nel passaggio precedente.
	...
	![Ottenere l'URI di reindirizzamento](./media/app-service-api-connect-your-app-to-saas-connector/redirecturi.png)

	![Creare un'app Dropbox](./media/app-service-api-connect-your-app-to-saas-connector/dbappsettings2.png)
...
2. Nel pannello **Impostazioni applicazione** impostare **Livello di accesso** su **Pubblico (autenticato)** e quindi fare clic su **Salva**.
	...
	![Impostare su Pubblico (autenticato)](./media/app-service-api-connect-your-app-to-saas-connector/pubauth.png)
...
2. Passare all'URL di accesso per il gateway e il provider di autenticazione configurati. L'URL usa il modello seguente: 
	...
	![URL del gateway](./media/app-service-api-connect-your-app-to-saas-connector/gatewayurl.png)
...
1. Nella finestra del browser in cui è visualizzato un messaggio analogo ad "Accesso completato" passare agli strumenti per sviluppatori del browser e individuare il cookie `x-zumo-auth`. Mantenere aperta questa finestra in modo da copiare il valore del cookie nel passaggio successivo.
	...
	![Copiare il token](./media/app-service-api-connect-your-app-to-saas-connector/copytoken.png)
...
4. In una nuova scheda o finestra del browser creare e inviare una richiesta HTTP Post al gateway per richiedere un URL di autorizzazione. Includere il token `x-zumo-auth` come intestazione HTTP.
	...
	![Inviare l'URL di autorizzazione](./media/app-service-api-connect-your-app-to-saas-connector/sendforconsent.png)
	...
	![URL di autorizzazione](./media/app-service-api-connect-your-app-to-saas-connector/getconsenturl.png)
...
4. Fare clic sull'icona **Definizione API** per visualizzare i metodi API disponibili nel connettore.
	...
	![Pannello App per le API](./media/app-service-api-connect-your-app-to-saas-connector/apiappblade.png)

	![Definizione dell'API](./media/app-service-api-connect-your-app-to-saas-connector/apidef.png)
...
3. Ad esempio, se l'URL del connettore è https://dropboxrg784237ad3e7.azurewebsites.net e si vogliono visualizzare i file nella cartella del blog, l'URL sarà:
	...
	![Ottenere la risposta alla richiesta della cartella](./media/app-service-api-connect-your-app-to-saas-connector/dbresponse.png)

## Passaggi successivi

È stato illustrato come installare, configurare e testare un connettore SaaS. Per altre informazioni, vedere [Uso dei connettori](app-service-logic-use-biztalk-connectors.md).
