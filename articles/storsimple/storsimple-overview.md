<properties 
   ...
   description="Vengono descritti il processo di suddivisione in livelli, il dispositivo, il dispositivo virtuale, i servizi e la gestione dell'archiviazione di StorSimple e vengono introdotti termini chiave utilizzati nella soluzione." 
   services="storsimple" 
...
![icona video](./media/storsimple-overview/video_icon.png) Guarda il video per una rapida introduzione a Microsoft Azure StorSimple.
...
|Supporto per altri provider di servizi cloud |StorSimple serie 8000 con aggiornamento del software 1 o seguenti supporta Amazon S3 con RRS, HP, e i servizi cloud di OpenStack, nonché Microsoft Azure. (È comunque necessario un account di archiviazione di Microsoft Azure per la gestione dei dispositivi) Per ulteriori informazioni, vedere [Novità introdotta nell’aggiornamento 1.2](storsimple-update1-release-notes.md#whats-new-in-update-12).|
|Continuità aziendale | L’aggiornamento 1.2 fornisce inoltre una nuova funzionalità di migrazione che consente agli utenti della serie StorSimple 5000-7000 di eseguire la migrazione dei dati in un dispositivo serie StorSimple 8000.|
|Disponibilità nel portale di Azure Government | StorSimple è ora disponibile nel portale di Azure Government. Per ulteriori informazioni, vedere [Distribuire un dispositivo StorSimple locale nel portale di Azure Government](storsimple-deployment-walkthrough-gov.md).|
|Supporto per l'archiviazione con ridondanza della zona (ZRS) | Con l'aggiornamento alla versione più recente delle API di archiviazione, StorSimple serie 8000 supporta l'archiviazione con ridondanza della zona (ZRS) oltre all'archiviazione con ridondanza locale (LRS) e all'archiviazione con ridondanza geografica (GRS). Fare riferimento a questo [articolo sulle opzioni di ridondanza di archiviazione di Azure](https://azure.microsoft.com/documentation/articles/storage-redundancy/) per i dettagli sull’archiviazione ZRS.

![icona video](./media/storsimple-overview/video_icon.png) Guardare [questo video](http://azure.microsoft.com/documentation/videos/guru-pangals-welcome-to-wpc--july-2015) per un’introduzione ai vantaggi e alle funzionalità della serie StorSimple 8000.
...
![icona video](./media/storsimple-overview/video_icon.png) Guarda [questo video](https://www.youtube.com/watch?v=4MhJT5xrvQw&feature=youtu.be) per un'introduzione al dispositivo StorSimple, al dispositivo virtuale StorSimple e al servizio StorSimple Manager.
...
- Consente di simulare ambienti locali in scenari di ripristino di emergenza e sviluppo o test ed è in grado di aiutare nel recupero a livello di elementi dai backup. 

Un dispositivo virtuale StorSimple si distingue da un dispositivo StorSimple fisico per le seguenti caratteristiche:
