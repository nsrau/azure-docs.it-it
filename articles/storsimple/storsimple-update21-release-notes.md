...
Per altre informazioni su come installare gli aggiornamenti per driver, Storport, Spaceport e firmware del disco, vedere [Installare l'aggiornamento 2.2](./storsimple-8000-install-update-5.md) nel dispositivo StorSimple.
...
Informazioni su come [Installare l'aggiornamento 2.2](./storsimple-8000-install-update-5.md) nel dispositivo StorSimple.