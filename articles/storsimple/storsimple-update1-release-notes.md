...
| 2 |Ripristino delle impostazioni predefinite |In alcuni casi, quando si esegue una reimpostazione di fabbrica, il dispositivo StorSimple si blocca e visualizza il messaggio: **Ripristino delle impostazioni predefinite è in corso (fase 8)** . Ciò si verifica se si preme CTRL + C durante l'esecuzione del cmdlet. Il bug è stato corretto. |Aggiornamento 1 |Yes |No |
