...
* **È necessario portare offline il volume**: portare offline il volume sia nel dispositivo che nell'host prima di avviare l'operazione di ripristino. Anche se l'operazione di ripristino riporta automaticamente online il volume nel dispositivo, è necessario portare il dispositivo online manualmente nell'host. È possibile portare online il volume nell'host non appena il volume è online sul dispositivo Non è necessario attendere il completamento dell'operazione di ripristino. Per le procedure, vedere [portare un volume offline](storsimple-8000-manage-volumes-u2.md#take-a-volume-offline).
...
* Data di **creazione** : data e ora di creazione dei backup. 
...
4. Tornare alla scheda **Catalogo di backup** e selezionare un set di backup. Fare clic con il pulsante destro del mouse e scegliere **Ripristina** dal menu di scelta rapida.
    ...
    ![Elenco set di backup 2](./media/storsimple-8000-restore-from-backup-set-u2/restorebu1.png)
...
7. Fare clic su **Ripristina**. In questo modo viene avviato un processo di ripristino che è possibile visualizzare accedendo alla pagina **Processi**.
   ...
   ![Pagina di conferma 2](./media/storsimple-8000-restore-from-backup-set-u2/restorebu5.png)
