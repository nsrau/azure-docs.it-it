<properties 
   ...
   description="Descrizione delle procedure per creare ed eliminare il servizio StorSimple Manager nel portale di Azure e per gestire la chiave di registrazione del servizio."
   services="storsimple"
   documentationCenter=""
   authors="SharS"
   manager="carolz"
