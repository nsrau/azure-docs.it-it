<properties 
   pageTitle="Modificare le impostazioni dell'interfaccia di rete DATI 0 sul dispositivo StorSimple"
   description="Informazioni su come riconfigurare l'interfaccia di rete DATI 0 sul dispositivo StorSimple"
   services="storsimple"
   documentationCenter=""
   authors="alkohli"
   manager="carolz"
