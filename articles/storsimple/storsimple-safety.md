<properties 
   pageTitle="Sicurezza per il dispositivo StorSimple"
   description="Rivedere le linee guida di sicurezza per la distribuzione e il funzionamento del dispositivo StorSimple"
   services="storsimple"
   documentationCenter=""
   authors="alkohli"
   manager="carolz"
