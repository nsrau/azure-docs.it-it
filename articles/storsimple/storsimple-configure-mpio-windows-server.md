...
3. Nella finestra di dialogo **Individua portale destinazione** , effettuare le operazioni seguenti:
   ...
   * Fare clic su **OK** per tornare alla finestra di dialogo **iSCSI Initiator Properties** (Proprietà iniziatore iSCSI).
