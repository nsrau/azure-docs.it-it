...
4. Accettare i **Termini del contratto** e quindi fare clic su **Avanti**.
...
3. Fare clic su **Nuovo** &gt; **Servizi app** &gt; **Automazione** &gt; **Runbook** &gt; **Da raccolta** per importare tutti i runbook richiesti nell'account di automazione.
...
6. Nell'account di automazione passare alla scheda **Asset**, fare clic su **Aggiungi impostazione** &gt; **Aggiungi credenziali** e aggiungere le credenziali di Azure (denominare l'asset AzureCredential).
...
9. Selezionare la scheda **Piani di ripristino** e creare un nuovo piano di ripristino come segue:
   ...
   d. Selezionare **Arresto di tutti i gruppi**, fare clic su **Script** e scegliere **Aggiungi script lato primario prima dell'operazione di arresto di tutti i gruppi**.
