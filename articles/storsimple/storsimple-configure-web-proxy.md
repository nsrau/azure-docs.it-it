...
1. Scorrere verso il basso la pagina **Configura** fino alla sezione **Impostazioni proxy Web**. È possibile visualizzare le impostazioni proxy Web configurate sul dispositivo StorSimple, come illustrato di seguito.
