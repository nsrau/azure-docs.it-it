...
[!INCLUDE [storsimple-Aggiungi-volume-contenitore](../../includes/storsimple-add-volume-container.md)]

## Modificare un contenitore di volumi
Eseguire i passaggi seguenti per modificare un contenitore del volume.

[!INCLUDE [storsimple-modifica-volume-container](../../includes/storsimple-modify-volume-container.md)]
...
[!INCLUDE [eliminazione di storsimple-contenitore di volumi](../../includes/storsimple-delete-volume-container.md)]
