...
11. Nella finestra di dialogo **Impostazioni avanzate** :                                        
    ...
    * Viene visualizzata la finestra di dialogo Dettagli**. Nella scheda **MPIO** è possibile selezionare le impostazioni **Criterio di bilanciamento del carico** appropriate. È anche possibile visualizzare il tipo di percorso **Attivo** o **Standby**.
