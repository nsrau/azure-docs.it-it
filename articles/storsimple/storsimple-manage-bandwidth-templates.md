...
Per gestire i modelli di larghezza di banda, è possibile utilizzare la pagina la pagina **Configura** del servizio StorSimple Manager presente nel portale di gestione. Le attività più comuni relative ai modelli di larghezza di banda che possono essere eseguite in questa pagina sono:
