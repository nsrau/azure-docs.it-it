...
> [!NOTE]
> Gli indirizzi IP (di origine) del dispositivo devono essere sempre impostati su tutte le interfacce di rete abilitate. Gli indirizzi IP di destinazione devono essere impostati sugli [intervalli IP dei data center di Azure](https://www.microsoft.com/it-IT/download/confirmation.aspx?id=41653).
> 
> 

#### Modelli di URL per il portale di Azure
...
#### Modelli di URL per il portale di Azure Government
| Modello URL | Componente/funzionalità | Indirizzi IP dispositivo |
| --- | --- | --- |
