<properties 
   ...
   description="Viene illustrato come utilizzare la comunicazione remota di Windows PowerShell e HTTP o HTTPS per la connessione remota al dispositivo StorSimple."
   services="storsimple"
   documentationCenter=""
   authors="alkohli"
   manager="carolz"
...
Per ulteriori informazioni sull'utilizzo della comunicazione remota di Windows PowerShell per gestire il dispositivo, andare a [Amministrazione del dispositivo tramite Windows PowerShell per StorSimple](storsimple-windows-powershell-administration.md).
...
Per configurare la gestione remota, è possibile utilizzare il portale di gestione o la console seriale. Selezionare una delle seguenti procedure:

- [Utilizzo del portale di gestione per abilitare la gestione remota su HTTP](#use-the-management-portal-to-enable-remote-management-over-http)
...
### Utilizzo del portale di gestione per abilitare la gestione remota su HTTP 

Eseguire i passaggi seguenti nel portale di gestione per abilitare la gestione remota su HTTP.

#### Per abilitare la gestione remota tramite il portale di gestione:
...
5. Verificare che il campo **RemoteManagementMode** mostri **HttpsAndHttpEnabled**. Nella figura seguente vengono illustrate queste impostazioni in PuTTY.
     ...
     ![HTTPS e HTTP seriali abilitati](./media/storsimple-remote-connect/HCS_SerialHttpsAndHttpEnabled.png)
...
7. Avviare una sessione di Windows PowerShell sul dispositivo digitando questo comando:
    ...
    ![Comunicazione remota PS tramite HTTP](./media/storsimple-remote-connect/HCS_PSRemotingUsingHTTP.png)
...
- [Utilizzo del portale di gestione per abilitare la gestione remota su HTTPS](#use-the-management-portal-to-enable-remote-management-over-https)
...
### Utilizzo del portale di gestione per abilitare la gestione remota su HTTPS

Eseguire i passaggi seguenti nel portale di gestione per abilitare la gestione remota su HTTPS.

#### Per abilitare la gestione remota su HTTPS dal portale di gestione:
...
3. Verificare che HTTPS sia abilitato digitando:
    ...
    Assicurarsi che il campo **RemoteManagementMode** mostri **Https Enabled**. Nella figura seguente vengono illustrate queste impostazioni in PuTTY.

     ![HTTPS seriale abilitato](./media/storsimple-remote-connect/HCS_SerialHttpsEnabled.png)
...
6. Sarà necessario attendere alcuni minuti, quindi verrà effettuata la connessione al dispositivo tramite HTTPS su SSL. Verrà visualizzato un messaggio indicante che è stata effettuata la connessione al dispositivo.
    ...
    ![Comunicazione remota PS tramite HTTPS e SSL](./media/storsimple-remote-connect/HCS_PSRemotingUsingHTTPSAndSSL.png)
