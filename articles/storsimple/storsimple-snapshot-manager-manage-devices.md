...
6. Fare clic con il pulsante destro del mouse sul nodo di livello superiore nel riquadro **Ambito** (Gestione snapshot StorSimple nell'esempio), quindi fare clic su **Visualizza/Nascondi importazioni**.
