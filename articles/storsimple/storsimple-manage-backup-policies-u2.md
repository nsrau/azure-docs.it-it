...
---
# <a name="use-the-storsimple-manager-service-to-manage-backup-policies-update-2"></a>Per gestire i criteri di backup è possibile usare il servizio StorSimple Manager (aggiornamento 2)
