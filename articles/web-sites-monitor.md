...
#<a name="howtomonitor"></a>Monitoraggio delle app Web in Servizio app di Azure 
...
> [AZURE.NOTE]Se il comando **azure**non è installato, vedere [Come utilizzare gli strumenti da riga di comando di Azure](virtual-machines-command-line-tools.md) per informazioni sull'installazione e la configurazione.
