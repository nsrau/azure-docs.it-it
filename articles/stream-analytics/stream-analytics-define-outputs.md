...
| Funzioni di Azure   | | Le dimensioni batch predefinite sono pari a 256 KB. </br> Il numero di eventi predefinito per ogni batch è 100. </br> Le dimensioni batch sono configurabili e possono essere aumentate o ridotte nelle [opzioni di output](#azure-functions) di Analisi di flusso. 
