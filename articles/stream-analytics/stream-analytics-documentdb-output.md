...
Le [raccolte partizionate](../documentdb/documentdb-partition-data.md#single-partition-and-partitioned-collections) di Cosmos DB sono l'approccio consigliato per il partizionamento dei dati. 
