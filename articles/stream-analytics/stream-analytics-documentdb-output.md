<properties 
	pageTitle="Dettagli dell'output di DocumentDB | Microsoft Azure" 
	description="DocumentDB come output di Analisi di flusso di Azure"
	keywords="output di documentdb, docdb output, analisi di flusso e documentdb"
	documentationCenter=""
...
-   **Chiave account Key**: chiave di accesso condiviso per l'account DocumentDB.  
