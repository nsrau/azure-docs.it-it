---
title: 'Esercitazione: Creare e gestire un processo di Analisi di flusso con il portale di Azure | Microsoft Docs'
...
4. Fare clic su **Salva** per salvare la query.  
   ...
   ![Definire la query di Analisi di flusso](media/stream-analytics-manage-job/define-query.png)
