...
Per informazioni dettagliate sulla struttura e sul contenuto dei file JSON, vedere la sezione relativa alla [creazione di input in Analisi di flusso di Azure][msdn-rest-api-create-stream-analytics-input] nella raccolta di informazioni di riferimento sulle [API REST di Analisi di flusso][stream.analytics.rest.api.reference].
...
Per informazioni dettagliate sulla struttura e sul contenuto dei file JSON, vedere la sezione relativa alla [creazione di processi di Analisi di flusso di Azure][msdn-rest-api-create-stream-analytics-job] nella raccolta di informazioni di riferimento sulle [API REST di Analisi di flusso][stream.analytics.rest.api.reference].
...
Per informazioni dettagliate sulla struttura e sul contenuto dei file JSON, vedere la sezione relativa alla [creazione di output in Analisi di flusso di Azure][msdn-rest-api-create-stream-analytics-output] nella raccolta di informazioni di riferimento sulle [API REST di Analisi di flusso][stream.analytics.rest.api.reference].
...
Per informazioni dettagliate sulla struttura e sul contenuto dei file JSON, vedere la sezione relativa alla [creazione di trasformazioni in Analisi di flusso di Azure][msdn-rest-api-create-stream-analytics-transformation] nella raccolta di informazioni di riferimento sulle [API REST di Analisi di flusso][stream.analytics.rest.api.reference].
