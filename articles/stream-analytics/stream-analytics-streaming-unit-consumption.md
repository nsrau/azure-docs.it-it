...
> L'uso di una unità di streaming non è consigliato per i processi di produzione. È in genere consigliato usare una unità di streaming solo per processi di creazione di prototipi e test.
