...
Ai fini della dimostrazione, viene usato un modello lineare descritto da Darryl Shen nel [suo documento](https://docplayer.net/23038840-Order-imbalance-based-strategy-in-high-frequency-trading.html).
...
![Definizione di squilibrio negli ordini di volumi](./media/stream-analytics-high-frequency-trading/volume-order-imbalance-formula.png)
...
![Formula matematica di regressione lineare](./media/stream-analytics-high-frequency-trading/linear-regression-formula.png)
...
![Trading dell'oggetto visivo del grafico Power BI](./media/stream-analytics-high-frequency-trading/trades-power-bi-chart.png)
