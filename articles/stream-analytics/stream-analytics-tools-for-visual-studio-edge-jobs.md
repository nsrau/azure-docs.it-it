...
|**Categoria**  | **Comando**  |
|---------|---------|
|Altri operatori | <ul><li>PARTITION BY</li><li>TIMESTAMP BY OVER</li><li>Funzione definita dall'utente JavaScript</li><li>Funzioni di aggregazione definite dall'utente (UDA)</li><li>GetMetadataPropertyValue</li><li>Uso di più di 14 aggregazioni in un singolo passaggio</li></ul>   |
