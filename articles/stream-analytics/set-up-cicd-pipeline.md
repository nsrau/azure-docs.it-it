...
Questo articolo illustra come creare pipeline di [compilazione](/devops/pipelines/get-started-designer) e rilascio di Azure DevOps usando gli strumenti di integrazione continua e [distribuzione](/devops/pipelines/release/define-multistage-release-process) continua di analisi di flusso di Azure.
