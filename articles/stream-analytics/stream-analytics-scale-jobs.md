...
## <a name="configuring-streaming-units"></a>Configurazione delle unità di streaming
...
## <a name="embarrassingly-parallel-job"></a>Processo perfettamente parallelo
...
### <a name="multi-step-query-with-grouping-key"></a>Query a più passaggi con chiave di raggruppamento
Input: Hub eventi con 8 partizioni. Output: Hub eventi con 8 partizioni
...
### <a name="not-using-event-hubs-or-blobs-as-output"></a>Uso di un output diverso da Hub eventi o BLOB
...
### <a name="examples-of-scale"></a>Esempi di scalabilità
...
## <a name="configure-stream-analytics-job-partition"></a>Configurare la partizione del processo di Analisi dei flussi
