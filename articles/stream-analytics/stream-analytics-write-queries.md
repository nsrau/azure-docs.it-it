<properties 
	...
	description="Scrivere query in Analisi di flusso | segmento del percorso di apprendimento."
	documentationCenter=""
...
1. Nel processo dell’analisi di flusso nel portale di Azure classico, fare clic su **Query**.
