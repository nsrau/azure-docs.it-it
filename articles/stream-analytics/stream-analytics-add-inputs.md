<properties 
	...
	description="Segmento del percorso di apprendimento relativo all’aggiunta di input."
	documentationCenter=""
...
1. Nel processo di analisi dei flussi fare clic su **Input** e poi scegliere **Aggiungi un input**.
...
3. Se si crea un input del flusso di dati, specificare il tipo di origine per l'input. Questa schermata viene ignorata durante la creazione dei dati di riferimento poiché è supportato soltanto l’archivio BLOB.
