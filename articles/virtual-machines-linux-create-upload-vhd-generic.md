...
Quindi, ricreare l'immagine initrd con i moduli kernel `hv_vmbus` e `hv_storvsc`:
...
L'[agente Linux di Azure](virtual-machines-linux-agent-user-guide.md) (waagent) è necessario per effettuare correttamente il provisioning di una macchina virtuale Linux in Azure. È possibile scaricare la versione più recente, inviare problemi o inviare richieste pull al [repository GitHub dell'agente Linux](https://github.com/Azure/WALinuxAgent).
