...
-   Selezione dell'opzione relativa ai log in streaming nel blade del sito Web
...
La diagnostica viene abilitata a livello di sito Web individuale. Dall'interno del [portale](https://portal.azure.com) fare clic sul pulsante **Browse** nella barra dei menu visualizzata a sinistra, quindi scegliere **Websites** per visualizzare un elenco di tutti i siti Web.
...
Per visualizzare i log in streaming dall'interno del portale, fare clic sulla parte **STREAMING LOGS** nel blade del sito Web. Se il sito sta scrivendo attivamente istruzioni di traccia, queste dovrebbero essere visibili nella finestra risultante in tempo quasi reale.
