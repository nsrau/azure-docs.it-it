...
![Architettura](./media/bastion-nsg/nsg-architecture.png)
...
Un esempio di regola NSG è disponibile per riferimento in questo [modello di avvio rapido](https://github.com/Azure/azure-quickstart-templates/tree/master/101-azure-bastion-nsg).
