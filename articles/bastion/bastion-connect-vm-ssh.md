...
1. Nel [portale di Azure](https://aka.ms/BastionHost) per l'anteprima Bastion, passare alla macchina virtuale che si desidera connettersi, quindi fare clic su **Connect**. La macchina virtuale deve essere una macchina virtuale Linux quando si usa una connessione SSH.
