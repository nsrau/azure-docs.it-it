<properties 
	pageTitle="" 
	description="Utilizzo di Servizi mobili in progetti Cordova" 
...
1. Nel progetto Cordova di Visual Studio 2015 Preview aprire Config.xml e nella scheda **Plug-in** abilitare il plug-in **Servizi mobili di Azure**.<br/> ![][1]

2. Nel file index.html eliminare le righe che fanno riferimento al file **MobileServices.Web-1.2.2.min.js**.<br/>
