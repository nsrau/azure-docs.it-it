...
###<a name="<a-name="gradle-build"></a>update-the-gradle-build-file"></a><a name="gradle-build"></a>Aggiornare il file di compilazione Gradle
...
###<a name="<a-name="enable-internet"></a>enable-internet-permission"></a><a name="enable-internet"></a>Abilitare l'autorizzazione per Internet
...
###<a name="<a-name="data-object"></a>define-client-data-classes"></a><a name="data-object"></a>Definire le classi di dati client
...
###<a name="<a-name="create-client"></a>how-to:-create-the-client-context"></a><a name="create-client"></a>Procedura: Creare il contesto client
...
###<a name="<a-name="binding"></a>how-to:-bind-data-to-the-user-interface"></a><a name="binding"></a>Procedura: Associare dati all'interfaccia utente
...
#### <a name="<a-name="layout"></a>how-to:-define-the-layout"></a><a name="layout"></a>Procedura: Definire il layout
...
#### <a name="<a-name="adapter"></a>how-to:-define-the-adapter"></a><a name="adapter"></a>Procedura: Definire l'adattatore
...
### <a name="<a-name="api"></a>the-api-structure"></a><a name="api"></a>Struttura dell'API
...
#### <a name="<a-name="use-adapter"></a>how-to:-use-the-adapter"></a><a name="use-adapter"></a>Procedura: Usare l'adattatore
...
##<a name="<a-name="querying"></a>how-to:-query-data-from-your-mobile-app-backend"></a><a name="querying"></a>Procedura: Eseguire query sui dati dal back-end di app per dispositivi mobili
...
### <a name="<a-name="showall"></a>how-to:-return-all-items-from-a-table"></a><a name="showAll"></a>Procedura: Restituire tutti gli elementi di una tabella
...
### <a name="<a-name="chaining"></a>how-to:-concatenate-query-methods"></a><a name="chaining"></a>Procedura: Concatenare metodi di query
...
##<a name="<a-name="inserting"></a>how-to:-insert-data-into-the-backend"></a><a name="inserting"></a>Procedura: Inserire dati nel back-end
...
##<a name="<a-name="updating"></a>how-to:-update-data-in-a-mobile-app"></a><a name="updating"></a>Procedura: Aggiornare dati in un'app per dispositivi mobili
...
##<a name="<a-name="deleting"></a>how-to:-delete-data-in-a-mobile-app"></a><a name="deleting"></a>Procedura: Eliminare dati in un'app per dispositivi mobili
...
##<a name="<a-name="lookup"></a>how-to:-look-up-a-specific-item"></a><a name="lookup"></a>Procedura: Cercare un elemento specifico
...
##<a name="<a-name="untyped"></a>how-to:-work-with-untyped-data"></a><a name="untyped"></a>Procedura: Usare dati non tipizzati
...
### <a name="<a-name="json_instance"></a>how-to:-create-an-instance-of-an-untyped-table"></a><a name="json_instance"></a>Procedura: Creare un'istanza di una tabella non tipizzata
...
### <a name="<a-name="json_insert"></a>how-to:-insert-into-an-untyped-table"></a><a name="json_insert"></a>Procedura: Eseguire insert in una tabella non tipizzata
...
### <a name="<a-name="json_delete"></a>how-to:-delete-from-an-untyped-table"></a><a name="json_delete"></a>Procedura: Eliminare un'istanza da una tabella non tipizzata
...
### <a name="<a-name="json_get"></a>how-to:-return-all-rows-from-an-untyped-table"></a><a name="json_get"></a>Procedura: Restituire tutte le righe di una tabella non tipizzata
...
##<a name="<a-name="custom-api"></a>how-to:-call-a-custom-api"></a><a name="custom-api"></a>Procedura: Chiamare un'API personalizzata
...
##<a name="<a-name="authentication"></a>how-to:-add-authentication-to-your-app"></a><a name="authentication"></a>Procedura: Aggiungere l'autenticazione all'app
...
### <a name="<a-name="caching"></a>how-to:-add-authentication-code-to-your-app"></a><a name="caching"></a>Procedura: Aggiungere codice di autenticazione all'app
...
### <a name="<a-name="caching"></a>how-to:-cache-authentication-tokens"></a><a name="caching"></a>Procedura: Memorizzare nella cache i token di autenticazione
...
## <a name="<a-name="adal"></a>how-to:-authenticate-users-with-the-active-directory-authentication-library"></a><a name="adal"></a>Procedura: Autenticare gli utenti con Active Directory Authentication Library
...
* Sostituire **INSERT-REDIRECT-URI-HERE** con l'endpoint _/.auth/login/done_ del sito, usando lo schema HTTPS. Questo valore deve essere simile a _https://contoso.azurewebsites.net/.auth/login/done_.
...
##<a name="<a-name="customizing"></a>how-to:-customize-the-client"></a><a name="customizing"></a>Procedura: Personalizzare il client
...
### <a name="<a-name="serialization"></a>how-to:-customize-serialization"></a><a name="serialization"></a>Procedura: Personalizzare la serializzazione
...
### <a name="<a-name="columns"></a>how-to:-map-different-client-and-server-names"></a><a name="columns"></a>Procedura: Eseguire il mapping di nomi di client e di server diversi
...
### <a name="<a-name="table"></a>how-to:-map-different-table-names-between-the-client-and-the-backend"></a><a name="table"></a>Procedura: Eseguire il mapping di nomi di tabella diversi tra il client e il back-end
...
### <a name="<a-name="conversions"></a>how-to:-automate-column-name-mappings"></a><a name="conversions"></a>Procedura: Automatizzare i mapping dei nomi di colonna
...
### <a name="<a-name="complex"></a>how-to:-store-an-object-or-array-property-into-a-table"></a><a name="complex"></a>Procedura: Archiviare una proprietà di oggetto o di matrice in una tabella
