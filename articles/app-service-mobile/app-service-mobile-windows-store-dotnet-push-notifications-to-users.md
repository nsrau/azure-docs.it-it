...
<!-- URLs. -->
[Introduzione all'autenticazione]: app-service-mobile-windows-store-dotnet-get-started-users.md
[Introduzione alle notifiche push]: app-service-mobile-windows-store-dotnet-get-started-push.md
