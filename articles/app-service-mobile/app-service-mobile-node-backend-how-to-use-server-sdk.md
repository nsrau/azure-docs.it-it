...
1. Eseguire l'applicazione in locale, ovvero l'API viene eseguita in http://localhost:3000), o pubblicarla in Azure.
...
### <a name="send-push"></a>Inviare notifiche push
