...
### [Autenticazione e autorizzazione in App per dispositivi mobili di Azure](app-service-mobile-auth.md)
### [Sincronizzazione di dati offline nelle app per dispositivi mobili di Azure](app-service-mobile-offline-data-sync.md)
### [Procedure consigliate per il servizio app di Azure](../app-service-web/app-service-best-practices.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Servizio app di Azure e i servizi di Azure esistenti](../app-service-web/app-service-changes-existing-services.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Panoramica approfondita dei piani del servizio app](../app-service/azure-web-sites-web-hosting-plans-in-depth-overview.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Hosting ad alta densità](../app-service/app-service-high-density-hosting.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Uso di Processi Web nel servizio app di Azure](../app-service/app-service-webjobs-readme.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Ambiente del servizio app](../app-service-web/app-service-app-service-environment-intro.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Documentazione relativa agli ambienti del servizio app](../app-service/app-service-app-service-environments-readme.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
#### [Aggiunta di notifiche push](app-service-mobile-android-get-started-push.md)
#### [Usare l'SDK del client](app-service-mobile-android-how-to-use-client-library.md)

### Cordova
#### [Abilitare la sincronizzazione offline](app-service-mobile-cordova-get-started-offline-data.md)
#### [Aggiungere l'autenticazione](app-service-mobile-cordova-get-started-users.md)
#### [Aggiunta di notifiche push](app-service-mobile-cordova-get-started-push.md)
#### Usare l'SDK del client
...
### iOS
#### [Abilitare la sincronizzazione offline](app-service-mobile-ios-get-started-offline-data.md)
#### [Aggiungere l'autenticazione](app-service-mobile-ios-get-started-users.md)
...
#### [Usare l'SDK del client](app-service-mobile-dotnet-how-to-use-client-library.md)

### Xamarin.Android
#### [Abilitare la sincronizzazione offline](app-service-mobile-xamarin-android-get-started-offline-data.md)
#### [Aggiungere l'autenticazione](app-service-mobile-xamarin-android-get-started-users.md)
#### [Aggiunta di notifiche push](app-service-mobile-xamarin-android-get-started-push.md)
#### [Usare l'SDK del client](app-service-mobile-dotnet-how-to-use-client-library.md)

### Xamarin.Forms
#### [Abilitare la sincronizzazione offline](app-service-mobile-xamarin-forms-get-started-offline-data.md)
#### [Aggiungere l'autenticazione](app-service-mobile-xamarin-forms-get-started-users.md)
#### [Aggiunta di notifiche push](app-service-mobile-xamarin-forms-get-started-push.md)
#### [Usare l'SDK del client](app-service-mobile-dotnet-how-to-use-client-library.md)

### Xamarin.iOS
#### [Abilitare la sincronizzazione offline](app-service-mobile-xamarin-ios-get-started-offline-data.md)
#### [Aggiungere l'autenticazione](app-service-mobile-xamarin-ios-get-started-users.md)
#### [Aggiunta di notifiche push](app-service-mobile-xamarin-ios-get-started-push.md)
#### [Usare l'SDK del client](app-service-mobile-dotnet-how-to-use-client-library.md)

### Usare l'SDK del server
...
### Processi Web
#### [Che cos'è Azure WebJobs SDK](../app-service-web/websites-dotnet-webjobs-sdk.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Creare un processo Web .NET nel servizio app di Azure](../app-service-web/websites-dotnet-webjobs-sdk-get-started.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Come usare il servizio di archiviazione BLOB di Azure con WebJobs SDK](../app-service-web/websites-dotnet-webjobs-sdk-storage-blobs-how-to.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Come usare il servizio di archiviazione di accodamento di Azure con WebJobs SDK](../app-service-web/websites-dotnet-webjobs-sdk-storage-queues-how-to.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Come usare il bus di servizio di Azure con WebJobs SDK](../app-service-web/websites-dotnet-webjobs-sdk-service-bus.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
## [Distribuire](../app-service/app-service-deployment-readme.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Distribuire nel servizio app](../app-service-web/web-sites-deploy.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Distribuzione della sincronizzazione cloud](../app-service-web/app-service-deploy-content-sync.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Distribuzione continua](../app-service-web/app-service-continuous-deployment.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Ambienti di gestione temporanea](../app-service-web/web-sites-staged-publishing.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Distribuzione Git locale](../app-service-web/app-service-deploy-local-git.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Distribuzione di processi Web usando Visual Studio](../app-service-web/websites-dotnet-deploy-webjobs.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)

## [Ridimensionare](../app-service/app-service-scale-readme.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Aumentare le prestazioni di un'app](../app-service-web/web-sites-scale.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
#### [Scalabilità distribuita a livello geografico con ambienti del servizio app](../app-service-web/app-service-app-service-environment-geo-distributed-scale.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
#### [Ridimensionamento automatico e ambiente del servizio app](../app-service/app-service-environment-auto-scale.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
#### [Impostazioni di configurazione personalizzate](../app-service-web/app-service-app-service-environment-custom-settings.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Come controllare il traffico in ingresso](../app-service-web/app-service-app-service-environment-control-inbound-traffic.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Panoramica dell'architettura di rete](../app-service-web/app-service-app-service-environment-network-architecture-overview.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
#### [Dettagli della configurazione di rete con ExpressRoute](../app-service-web/app-service-app-service-environment-network-configuration-expressroute.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
#### [Autenticazione di Google](app-service-mobile-how-to-configure-google-authentication.md)
#### [Autenticazione di account Microsoft](app-service-mobile-how-to-configure-microsoft-authentication.md)
#### [Autenticazione di Twitter](app-service-mobile-how-to-configure-twitter-authentication.md)
### [Eseguire l'autenticazione con l'istanza locale di Active Directory](../app-service-web/web-sites-authentication-authorization.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
## Backup
### [Eseguire il backup dell'app in Azure](../app-service-web/web-sites-backup.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Ripristinare un'app in Azure](../app-service-web/web-sites-restore.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
### [Usare REST per eseguire il backup e il ripristino di app del servizio app](../app-service-web/websites-csm-backup.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
### [Esportare in PowerApps e Microsoft Flow](../app-service/app-service-export-api-to-powerapps-and-flow.md?toc=%2fazure%2fapp-service-mobile%2ftoc.json)
...
# Risorse correlate
## [Repository GitHub](https://github.com/Azure/azure-mobile-apps)
...
### [Sincronizzazione di dati strutturati](https://azure.microsoft.com/resources/samples/app-service-mobile-dotnet-todo-list-files/)
### Avvio rapido completato
