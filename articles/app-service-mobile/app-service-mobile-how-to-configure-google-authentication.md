...
2. Fare clic su **Impostazioni**, **Autenticazione utente** e quindi fare clic su **Google**. Copiare l’**URI di reindirizzamento**. Verrà usato per configurare l'app Google.
...
9. Tornare al [portale di gestione di Azure], nel pannello delle impostazioni di Google per l'app per dispositivi mobili, incollare i valori relativi all'ID client e alla chiave privata client ottenuti in precedenza. Fare quindi clic su **Salva**.
