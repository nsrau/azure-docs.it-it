---
title: Creare una piattaforma UWP (Universal Windows Platform) per app per dispositivi mobili | Microsoft Docs
...
4. Nell'app digitare un testo significativo, ad esempio *Complete the tutorial* nella casella di testo **Insert a TodoItem**, quindi fare clic su **Save**.
...
## Passaggi successivi
* [Aggiungere l'autenticazione all'app Xamarin.Forms](app-service-mobile-windows-store-dotnet-get-started-users.md): informazioni sull'autenticazione degli utenti dell'app con un provider di identità.
