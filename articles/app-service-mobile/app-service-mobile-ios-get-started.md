...
## <a name="step-i-create-a-new-azure-mobile-app-backend"></a>Passaggio ricerca per categorie: Creare un nuovo back-end dell'app per dispositivi mobili di Azure
