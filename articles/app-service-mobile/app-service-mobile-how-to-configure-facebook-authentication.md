...
> [AZURE.NOTE]
Se si usa il gateway del servizio app, ignorare questa sezione e accedere al gateway nel portale. Selezionare **Impostazioni**, **Identità**, e quindi **Facebook**. Incollare i valori ottenuti nel passaggio precedente e fare clic su **Salva**.
