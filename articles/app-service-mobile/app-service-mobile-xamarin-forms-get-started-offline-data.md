---
title: Abilitare la sincronizzazione offline per l'app per dispositivi mobili di Azure (Xamarin.Forms) | Microsoft Docs
...
1. In Esplora soluzioni aprire il file di progetto Constants.cs dal progetto **Portatile** e modificare il valore di `ApplicationURL` in modo che punti a un URL non valido, come di seguito:
