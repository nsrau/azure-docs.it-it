...
La diagnostica per le applicazioni Node.js ospitate in Azure viene fornita da [IISNode][IISNode]. In questo articolo vengono illustrate le impostazioni più comuni per la raccolta delle informazioni di diagnostica; non sono invece incluse informazioni dettagliate sull'uso di IISNode. Per altre informazioni sull'uso di IISNode, vedere il [file Readme di IISNode][file Readme di IISNode] su GitHub.

## <span id="enablelogging"></span></a>Abilitazione della registrazione
...
<strong>Nota</strong>
<p>devErrorsEnabled &egrave; utile per diagnosticare problemi che si verificano durante lo sviluppo, tuttavia se viene abilitato in un ambiente di produzione &egrave; possibile che gli eventuali errori di sviluppo vengano inviati agli utenti finali.</p>
</div>
...
<div class="dev-callout">
<strong>Nota</strong>
<p>Se il sito Web &egrave; stato creato con gli strumenti da riga di comando di Azure o i cmdlet di Azure PowerShell, verr&agrave; creato automaticamente un file <strong>IISNode.yml</strong> predefinito.</p>
</div>

Per riavviare il sito Web, selezionarlo nel [portale di gestione di Azure][portale di gestione di Azure], quindi scegliere il pulsante **RIAVVIA**:

![Pulsante Riavvia][Pulsante Riavvia]
...
<div class="dev-callout">
<strong>Nota</strong>
<p>Anche se loggingEnabled e devErrorsEnabled sono le opzioni di configurazione pi&ugrave; usate di IISNode.yml per acquisire informazioni diagnostiche, &egrave; possibile usare IISNode.yml per configurare numerose opzioni per l'ambiente host. Per un elenco completo delle opzioni di configurazione, vedere il file <a href="https://github.com/tjanczuk/iisnode/blob/master/src/config/iisnode_schema.xml">iisnode_schema.xml</a>.</p>
</div>

## <span id="viewlogs"></span></a>Accesso ai log
...
<div class="dev-callout">
<strong>Nota</strong>
<p>Se in precedenza non sono stati configurati nome utente e password per FTP o per la distribuzione, &egrave; possibile effettuare questa operazione nella pagina di gestione <strong>Avvio rapido</strong> selezionando <strong>Imposta credenziali di distribuzione</strong>.</p>
</div>
...
Per informazioni sull'uso di moduli in Azure, vedere [Uso di moduli Node.js con applicazioni Azure][Uso di moduli Node.js con applicazioni Azure].

Per informazioni sulla specifica di una versione di Node.js per l'applicazione, vedere [Specifica di una versione di Node.js in un'applicazione Azure][Specifica di una versione di Node.js in un'applicazione Azure].
