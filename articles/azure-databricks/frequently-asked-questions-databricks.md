...
Per ulteriori informazioni, vedere [utilizzare Azure Data Lake storage con Azure Databricks](https://docs.azuredatabricks.net/spark/latest/data-sources/azure/azure-datalake.html).
