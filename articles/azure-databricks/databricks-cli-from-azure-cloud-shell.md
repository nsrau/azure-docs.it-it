...
* Per un elenco di comandi per l'interfaccia della riga di comando di Azure, vedere [CLI reference](https://docs.microsoft.com/cli/azure/?view=azure-cli-latest) (Informazioni di riferimento sull'interfaccia della riga di comando)
