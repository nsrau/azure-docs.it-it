...
1. Sul lato superiore sinistro della schermata nella portale di Azure selezionare **Crea una risorsa** > **Databases** > database di**Azure per MySQL**.
...
1. In **database di Azure per MySQL** fornire queste informazioni:
    ...
    |Version  | Selezionare la versione del database del server MySQL richiesta.|
...
4. In **nuova connessione**immettere o selezionare queste informazioni:
    ...
    | Nome utente | Immettere username ( username@servername nome utente) come specificato durante la creazione del server MySQL. |
