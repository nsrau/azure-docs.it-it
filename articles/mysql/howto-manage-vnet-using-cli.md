---
title: Gestire gli endpoint della rete virtuale - interfaccia della riga di comando di Azure - Database di Azure per MySQLManage VNet endpoints - Azure CLI - Azure Database for MySQL
