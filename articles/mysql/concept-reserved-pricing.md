...
| Area geografica | Area di Azure coperta dalla prenotazione di capacità riservata del database di Azure per MySQL.
...
## <a name="need-help--contact-us"></a>Serve aiuto? Contattaci
