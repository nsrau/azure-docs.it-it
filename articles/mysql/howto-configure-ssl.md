...
Per specifici programmazione language le stringhe di connessione, vedere la [esempi di codice](howto-configure-ssl.md#sample-code) sotto.
...
```
### <a name="php-using-pdo"></a>PHP (PDO tramite)
```phppdo
$options = array(
