---
title: Gestire il server - Portale di Azure - Database di Azure per MySQLManage server - Azure portal - Azure Database for MySQL
description: Informazioni su come gestire un database di Azure per il server MySQL dal portale di Azure.Learn how to manage an Azure Database for MySQL server from the Azure portal.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "80062412"
---
# <a name="manage-an-azure-database-for-mysql-server-using-the-azure-portal"></a>Gestire un database di Azure per il server MySQL tramite il portale di AzureManage an Azure Database for MySQL server using the Azure portal
Questo articolo illustra come gestire il database di Azure per i server MySQL.This article shows you how to manage your Azure Database for MySQL servers. Le attività di gestione includono il ridimensionamento dell'archiviazione e del calcolo, la reimpostazione della password di amministratore e la visualizzazione dei dettagli del server.

## <a name="sign-in"></a>Accesso
Accedere al [portale](https://portal.azure.com)di Azure .

## <a name="create-a-server"></a>Creare un server
Visitare la [guida introduttiva](quickstart-create-mysql-server-database-using-azure-portal.md) per informazioni su come creare e iniziare a usare un database di Azure per il server MySQL.Visit the quickstart to learn how to create and get started with an Azure Database for MySQL server.
...
- Informazioni sulle opzioni di [ottimizzazione e monitoraggio in Azure Database for MySQLLearn](concepts-monitoring.md) about tuning and monitoring options in Azure Database for MySQL
