...
description: Questa guida di avvio rapida illustra come usare il portale di Azure per creare un server di esempio di Database di Azure per MySQL in circa cinque minuti.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.custom: mvc
