---
title: Configurare avvisi per le metriche per Database di Azure per MySQL nel portale di Azure | Microsoft Docs
...
4. Verrà aperta la pagina **Aggiungi regola**, come illustrato di seguito.  Specificare le informazioni necessarie:
   ...
   | Sottoscrizione | Questo campo viene pre-popolato con la sottoscrizione che ospita Database di Azure per MySQL. |
   | Gruppo di risorse | Questo campo viene pre-popolato con il gruppo di risorse di Database di Azure per MySQL. |
   | Risorsa | Questo campo viene pre-popolato con il nome dell'istanza di Database di Azure per MySQL. |
