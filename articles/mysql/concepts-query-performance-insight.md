...
description: Questo articolo descrive la funzionalità Informazioni dettagliate sulle prestazioni delle query in Database di Azure per MySQLThis article describes the Query Performance Insight feature in Azure Database for MySQL
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
ms.locfileid: "79537058"
---
# <a name="query-performance-insight-in-azure-database-for-mysql"></a>Informazioni dettagliate sulle prestazioni delle query nel Database di Azure per MySQL
...
Nella pagina del portale del database di Azure per il server MySQL selezionare **Informazioni dettagliate** sulle prestazioni delle query nella sezione **Prestazioni intelligenti** della barra dei menu.
