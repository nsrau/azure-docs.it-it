...
| **Lingua** | **Platform** | **Risorse aggiuntive** | **Scaricare** |
| :----------- | :------------| :-----------------------| :------------|
...
| C | Windows, Linux, Mac OS X | [Guida per sviluppatori di MySQL Connector/C](https://dev.mysql.com/doc/refman/8.0/en/c-api.html) | [Scaricare](https://dev.mysql.com/downloads/connector/c/)
...
[Php](./connect-php.md)  |  [Java](./connect-java.md)  |   [.NET (C#)](./connect-csharp.md)  |  [Python](./connect-python.md)  |  [Node.JS](./connect-nodejs.md)  |  [Ruby](./connect-ruby.md)  |  [C++](connect-cpp.md)  |  [Vai](./connect-go.md)
