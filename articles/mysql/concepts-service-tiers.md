...
- [Manage a single server with Azure portal](quickstart-create-mysql-server-database-using-azure-portal.md) (Gestire un server singolo con il portale di Azure)
- [Manage a single server with Azure CLI](quickstart-create-mysql-server-database-using-azure-cli.md) (Gestire un server singolo con l'interfaccia della riga di comando di Azure)
