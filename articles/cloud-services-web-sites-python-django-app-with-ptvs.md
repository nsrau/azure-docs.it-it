<properties urlDisplayName="Django with Python Tools for Visual Studio 2.0" pageTitle="Creazione di applicazioni Django con Python Tools per Visual Studio 2.0" metaKeywords="" description="Informazioni su come usare Python Tools per Visual Studio per creare un'applicazione Django che archivia i dati in un'istanza del database MySQL o del database SQL e che può essere distribuita in un sito Web o in un servizio cloud." metaCanonical="" services="web-sites,cloud-services" documentationCenter="Python" title="Creating Django applications with Python Tools 2.0 for Visual Studio" authors="huvalo" solutions="" manager="wpickett" editor="" />
