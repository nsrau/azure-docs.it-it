<properties 
 ...
 editor=""
 manager="jefco" 
 pageTitle="Gestione: timeout di inattività del servizio di bilanciamento di carico" 
...
Gli sviluppatori possono configurare la distribuzione del servizio di bilanciamento del carico utilizzando l'API di gestione del servizio. Assicurarsi di aggiungere l'intestazione x-ms-version impostata sulla versione 01/06/2014 o successiva.
