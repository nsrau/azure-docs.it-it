...
Usare l'interfaccia della riga di comando di Azure per completare molti dei passaggi di questo avvio rapido. Azure IoT ha un'estensione per abilitare funzionalità aggiuntive.
