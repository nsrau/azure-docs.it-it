...
* [Strumenti di Azure](https://marketplace.visualstudio.com/items?itemName=vsciot-vscode.azure-iot-tools) per la Visual Studio Code
...
1. In Esplora VS Code espandere la sezione **dispositivi dell'hub Azure** .
