...
3. Installare [Python su Windows][lnk-python] e assicurarsi di usare il comando pip. Questa esercitazione è stata testata con Python a partire dalle versioni 2.7.9 e 3.5.4.  
