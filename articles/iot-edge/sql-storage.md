...
3. Sostituire `<docker registry address>` con l'indirizzo inserito nell'esercitazione completata [Distribuire Funzioni di Azure come modulo IoT Edge](tutorial-deploy-function.md).
