...
* Eseguire il caricamento BLOB completo ( `Put Blob` operazione using) e il caricamento a livello `Put Block`di `Put Block List` blocco `Append Block` (usando le operazioni e).
