---
title: Centro sicurezza di Azure per i prerequisiti IoT Documenti Microsoft
...
Questo articolo fornisce una spiegazione dei diversi blocchi predefiniti del Servizio sicurezza di Azure per il servizio IoT, gli elementi da iniziare e illustra i concetti di base per comprendere meglio il servizio. 
...
1. Aprire l'hub IoT. 
2. Fare clic su **Overview**. 
3. Verificare che il percorso elencato corrisponda a una delle [aree](#supported-service-regions)di servizio supportate. 
