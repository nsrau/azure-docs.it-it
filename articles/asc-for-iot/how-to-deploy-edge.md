...
1. Modificare il nome della **URI dell'immagine** a **mcr.microsoft.com/ascforiot/azureiotsecurity:0.0.1**
...
1. Modifica il **immagine** sotto **Hub di Edge** al **mcr.microsoft.com/ascforiot/edgehub:1.05-preview**.
