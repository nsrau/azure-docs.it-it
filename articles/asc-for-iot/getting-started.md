...
Per funzionalità di sicurezza avanzate, la distribuzione del Centro sicurezza di Azure per gli agenti Internet, oltre ad abilitare la sicurezza dell'hub Internet, fornisce la raccolta di eventi basata su agente, l'analisi e il rilevamento delle minacce per i dati di sicurezza principali dei dispositivi Internet e le funzionalità di gestione delle condizioni di sicurezza complete.
