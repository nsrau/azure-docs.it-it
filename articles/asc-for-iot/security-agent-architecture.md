---
title: La comprensione di Centro sicurezza di AZURE per l'architettura dell'agente di sicurezza IoT Preview | Microsoft Docs
...
Centro sicurezza di AZURE per IoT offre l'architettura di riferimento per gli agenti di protezione di log, elaborano, aggregano e inviino i dati di sicurezza tramite l'hub IoT.
