...
L'inserimento di Log Analytics nell'hub IoT è disattivato per impostazione predefinita nella soluzione Centro sicurezza di Azure per IoT. Per abilitarlo per l'uso del modulo di sicurezza per Azure RTOS, seguire questa procedura: 
