...
description: In questa esercitazione per la soluzione Azure VMware (AVS) verrà creato un peering con Copertura globale ExpressRoute a un cloud privato in una soluzione Azure VMware.
ms.topic: tutorial
ms.date: 07/16/2020
...
## <a name="create-an-expressroute-authorization-key-in-the-avs-private-cloud"></a>Creare una chiave di autorizzazione ExpressRoute nel cloud privato AVS
