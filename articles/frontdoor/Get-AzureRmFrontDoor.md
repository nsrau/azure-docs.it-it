...
ms.locfileid: "47046296"
---
# Get-AzureRmFrontDoor
Ottenere la configurazione per Frontdoor
...
## DESCRIZIONE
**Get-AzureRmFrontDoor** cmdletGet recupera tutti i Frontdoor esistenti nella sottoscrizione corrente che corrispondano alle informazioni fornite.

## ESEMPI

### Esempio 1: recuperare tutti i Frontdoor nella sottoscrizione corrente.
```powershell
...
Recuperare tutti i Frontdoor nella sottoscrizione corrente.

### Esempio 2: recuperare tutti i Frontdoor nel gruppo di risorse "rg1" nella sottoscrizione corrente.
```powershell
...
Recuperare tutti i Frontdoor nel gruppo di risorse "rg1" nella sottoscrizione corrente.

### Esempio 3: recuperare tutti i Frontdoor nel gruppo di risorse "rg1" con nome "frontdoor1" nella sottoscrizione corrente.
```powershell
...
Recuperare tutti i Frontdoor nel gruppo di risorse "rg1" con nome "frontdoor1" nella sottoscrizione corrente.
