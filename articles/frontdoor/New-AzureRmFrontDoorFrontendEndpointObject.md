...
ms.locfileid: "47046067"
---
# New-AzureRmFrontDoorFrontendEndpointObject

Creare un oggetto PSFrontendEndpoint per la creazione della frontdoor
...
### -CertificateType
Tipo del certificato usato per le connessioni sicure a un frontendEndpoint
...
### -HostName
Nome host del frontendEndpoint.
Deve essere un nome di dominio.
...
### -ProtocolType
Protocollo con estensione TLS usato per il recapito sicuro
...
TTL in secondi da usare per l'affinità di sessione, se applicabile. Il valore predefinito è 0
...
### -WebApplicationFirewallPolicyLink
ID risorsa dei criteri del firewall applicazione Web per ogni host (se applicabile)
