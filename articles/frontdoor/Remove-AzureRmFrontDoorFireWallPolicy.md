...
ms.locfileid: "47046163"
---
# Remove-AzureRmFrontDoorFireWallPolicy
Rimuovere criteri di web application firewall
...
## DESCRIZIONE
Il cmdlet **Remove-AzureRmFrontDoor** rimuove un criterio WAF nella sottoscrizione corrente
...
Rimuovere un criterio di Web Application Firewall chiamato $name in $resourceGroup.
...
Rimuovere un criterio di Web Application Firewall in $resourceGroup.
...
### -InputObject
L'oggetto criterio di Web Application firewall da eliminare.
...
### -Name
Il nome del criterio di Web Application firewall da eliminare.
...
### -ResourceGroupName
Il gruppo di risorse a cui appartiene il criterio di Web application firewall.
...
### -ResourceId
L’ID risorsa del criterio di Web Application firewall da eliminare
