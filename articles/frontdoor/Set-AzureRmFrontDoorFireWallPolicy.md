...
ms.locfileid: "47046169"
---
# Set-AzureRmFrontDoorFireWallPolicy
aggiornare criteri di Web Application Firewall (WAF)
...
## DESCRIZIONE
Il cmdlet **Set-AzureRmFrontDoor** aggiorna un criterio WAF esistente. Se non sono specificati i parametri di input, saranno usati i parametri precedenti impostati per i criteri WAF esistenti.

## ESEMPI

### Esempio 1: aggiornare un criterio WAF esistente
```powershell
...
aggiornare un criterio WAF esistente

### Esempio 2: aggiornare un criterio WAF esistente
```powershell
...
### Esempio 3: aggiornare un criterio WAF esistente
```powershell
...
### Esempio 4: aggiornare tutti i criteri WAF in $resourceGroup
```powershell
...
aggiornare tutti i criteri WAF in $resourceGroup
...
### -ResourceGroupName
Il gruppo di risorse a cui appartiene il FireWallPolicy.
...
### -ResourceId
L'ID risorsa del FireWallPolicy da aggiornare.
