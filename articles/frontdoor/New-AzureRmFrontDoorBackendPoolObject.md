...
ms.locfileid: "47045995"
---
# New-AzureRmFrontDoorBackendPoolObject

Creare un oggetto PSBackendPool per la creazione del Frontdoor
...
### -Backend
Il set di back-end per questo pool.
...
### -FrontDoorName
Nome della frontdoor a cui appartiene questa regola di routing.
...
Il nome delle impostazioni di probe di integrità per questo pool di back-end
...
Il nome delle impostazioni di bilanciamento del carico per questo pool di back-end
...
### -ResourceGroupName
Nome del gruppo di risorse in cui verrà creata la regola di routing.
