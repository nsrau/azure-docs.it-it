...
| ------------- | ------------- |
| Via |  *Via: 1.1 azure* </br> Porta d'ingresso aggiunge la versione del client HTTP seguita da 'Azure' come valore dell'intestazione Via. Questo viene aggiunto per indicare la versione del client HTTP e tale porta principale di Azure è stato un destinatario intermedio per la richiesta tra client e il back-end.  |
