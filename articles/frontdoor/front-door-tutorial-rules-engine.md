---
title: Configurare il motore regole - Frontdoor di Azure
description: Questo articolo descrive come configurare i motori delle regole per Frontdoor di Azure
services: frontdoor
documentationcenter: ''
author: megan-beatty
editor: ''
