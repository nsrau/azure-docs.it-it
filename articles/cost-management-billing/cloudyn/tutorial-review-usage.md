...
Gestione costi di Azure fornisce anche gli elementi consigliati di ottimizzazione dei costi per i servizi di Azure. Per altre informazioni, vedere [Esercitazione: Ottimizzare i costi grazie agli elementi consigliati](../costs/tutorial-acm-opt-recommendations.md).
...
> [Prevedere la spesa futura](../../cost-management/tutorial-forecast-spending.md)
