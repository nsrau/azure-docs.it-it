...
description: Questo articolo illustra nei dettagli il processo di registrazione necessario per creare una sottoscrizione di valutazione di Cloudyn e accedere al relativo portale.
author: bandersmsft
ms.author: banders
ms.date: 03/12/2020
ms.topic: quickstart
