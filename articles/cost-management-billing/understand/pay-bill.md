...
description: Informazioni su come pagare una fattura nel portale di Azure. Per eseguire pagamenti nel portale di Azure, è necessario avere il ruolo di proprietario del profilo di fatturazione, collaboratore o responsabile della gestione fatture.
...
Questo articolo si applica ai clienti con un Contratto del cliente Microsoft che hanno effettuato l'iscrizione ad Azure tramite il sito Web di Azure. [Verificare l'accesso a un contratto cliente Microsoft](#check-access-to-a-microsoft-customer-agreement).
