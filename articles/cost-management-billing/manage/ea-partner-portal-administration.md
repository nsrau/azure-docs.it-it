---
title: Amministrazione di Azure EA Portal per i partner
description: Descrive gli argomenti sull’amministrazione del portale relativi ai partner
author: bandersmsft
...
ms.locfileid: "88689950"
---
# <a name="azure-ea-portal-administration-for-partners"></a>Amministrazione di Azure EA Portal per i partner

Questo articolo illustra le attività comuni eseguite da un amministratore EA partner in Azure EA Portal (https://ea.azure.com).
...
![Esempio che mostra la casella Aggiunta di un contatto ](./media/ea-partner-portal-administration/create-ea-manage-partner-notification.png)
...
- Per informazioni introduttive su Azure EA Portal, vedere l'articolo [Introduzione ad Azure EA Portal](ea-portal-get-started.md).
