...
1. Scaricare il file di utilizzo seguendo le istruzioni disponibili in [Scaricare l'utilizzo nel portale di Azure](./download-azure-invoice-daily-usage-date.md#download-usage-in-azure-portal).
