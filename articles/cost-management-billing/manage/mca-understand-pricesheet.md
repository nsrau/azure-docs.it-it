---
title: Termini nell'elenco prezzi del contratto clienti Microsoft-Azure
...
| Prodotto  | Nome del prodotto che ha accumulato i costi. Esempio: database SQL di base e database SQL standard  |
...
| serviceFamily  | Tipo di servizio di Azure. Esempio: calcolo, analisi, sicurezza |
