...
Prima di utilizzare i servizi Twilio, è necessario  [iscriversi per creare un account][signup]. Per i clienti di Microsoft Azure è disponibile uno sconto speciale  [effettuando l'iscrizione qui][signup]!
...
* [Documentazione ufficiale del modulo][documenti]
...
* [Programmazione in coppia nel browser Con Node.js][coppia]
