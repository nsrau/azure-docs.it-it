---
title: Carta di debito o credito rifiutata al momento dell&quot;iscrizione | Documentazione Microsoft
...
Se la carta di debito o credito viene rifiutata o non accettata al momento dell'iscrizione ad Azure, è possibile che si debba risolvere uno dei problemi seguenti.
...
* **La carta è inattiva o bloccata.** Contattare la banca e verificare che la carta sia attiva e non bloccata.
* **Si sta tentando di attivare una seconda versione di valutazione gratuita.** L'offerta di valutazione gratuita di Azure è limitata all'attivazione di una versione di prova gratuita per ogni utente. Se in precedenza era già stata attivata una versione di valutazione gratuita con questa carta di credito o in passato si disponeva di una sottoscrizione di Azure collegata a questa carta di credito, non è possibile attivare una versione di valutazione gratuita. Scegliere un altro piano per Azure da [Dettagli delle offerte per Microsoft Azure](https://azure.microsoft.com/support/legal/offer-details/). 

Dopo aver aggiornato le informazioni di pagamento, provare a eseguire nuovamente l'iscrizione.

## <a name="business-that-doesnt-want-to-pay-by-card-set-up-invoicing"></a>Azienda che non desidera pagare con carta Impostare la fatturazione
