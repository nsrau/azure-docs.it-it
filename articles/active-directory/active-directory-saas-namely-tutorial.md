...
3. **[Creazione di un utente test di Namely](#creating-a-namely-test-user)** - per avere una controparte di Britta Simon in Namely collegata alla relativa rappresentazione in Azure AD.
...
2. Nella finestra di dialogo **Add New Person** seguire questa procedura:
