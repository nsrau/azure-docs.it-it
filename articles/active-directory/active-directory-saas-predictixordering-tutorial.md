<properties
	pageTitle="Esercitazione: Integrazione di Azure Active Directory con Predictix Ordering | Microsoft Azure"
...
- È possibile abilitare gli utenti per l'accesso automatico a Predictix Ordering (Single Sign-On) con i propri account Azure AD
...
## Aggiunta di Predictix Ordering dalla raccolta
...
La relazione di collegamento viene stabilita assegnando al valore di **nome utente** in Azure AD lo stesso valore di **nome utente** in Predictix Ordering.
...
In questa sezione viene abilitato l'accesso Single Sign-On di Azure AD nel portale classico e viene configurato l'accesso Single Sign-On nell'applicazione Predictix Ordering.
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
    ...
    a. Nella casella di testo **URL di accesso** digitare l'URL usato dagli utenti per accedere all'applicazione Predictix Ordering usando il modello seguente: **https://\<nome società-prezzi>.predictix.com/sso/request**.
...
6.  Nella pagina **Profilo utente** seguire questa procedura: ![Creazione di un utente test di Azure AD](./media/active-directory-saas-predictix-ordering-tutorial/create_aaduser_06.png)
...
### Creazione di un utente test di Predictix Ordering
