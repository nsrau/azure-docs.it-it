...
Pubblicare l'applicazione proxy come qualsiasi altra applicazione e assegnare agli utenti l'accesso all'applicazione. Per altre informazioni, vedere [Pubblicare applicazioni mediante il proxy di applicazione](manage-apps/application-proxy-publish-azure-portal.md).
...
Ottenere informazioni su come configurare [l'accesso Single Sign-On per il proxy di applicazione](manage-apps/application-proxy-single-sign-on.md)
