---
title: Controllo e segnalazione di un utente di collaborazione B2B - Azure ADAuditing and reporting a B2B collaboration user - Azure AD
...
![Screenshot che mostra ed esempio di output del log di controllo](./media/auditing-and-reporting/audit-log.png)
...
![Screenshot che mostra l'esempio di output dei dettagli dell'attività](./media/auditing-and-reporting/activity-details.png)
