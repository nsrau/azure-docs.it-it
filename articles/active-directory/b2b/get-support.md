---
title: Ottenere assistenza per collaborazione B2B - Azure Active Directory | Microsoft Docs
...
1. Nel [ portale di Azure](https://portal.azure.com) passare al pannello Guida e supporto e selezionare Nuova richiesta di supporto:
   ...
   ![Screenshot che illustra una nuova richiesta di supporto](media/get-support/new-support-request.png)
...
2. Descrivere il problema:
   ...
   ![Screenshot che mostra una descrizione del problema di ticket di supporto](media/get-support/problem-description.png)
