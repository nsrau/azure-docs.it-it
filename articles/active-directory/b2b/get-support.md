...
1. Nel [ portale di Azure](https://portal.azure.com) passare al pannello Guida e supporto e selezionare Nuova richiesta di supporto:
  ...
  ![Nuova richiesta di supporto](media/get-support/new-support-request.png)
...
2. Descrivere il problema:
  ...
  ![descrizione del problema del ticket di supporto](media/get-support/problem-description.png)
