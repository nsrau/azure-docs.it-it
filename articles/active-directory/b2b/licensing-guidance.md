---
title: Linee guida per le licenze per la collaborazione B2B - Azure Active Directory Documenti Microsoft
...
- Si desidera invitare 100 utenti guest alle app o ai servizi di Azure AD e fornire la gestione e il provisioning degli accessi. Per 50 di questi utenti guest, si vuole anche richiedere l'autenticazione a più fattori e l'accesso condizionale, pertanto per tali funzionalità sono necessarie 10 licenze di Azure AD Premium P1. Se si prevede di usare le funzionalità di Identity Protection con gli utenti guest, per includerli saranno necessarie le licenze P2 di Azure AD Premium con lo stesso rapporto 1:5.
