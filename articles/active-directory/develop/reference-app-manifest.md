...
| `homepage` | String | L'URL della home page dell'applicazione. <br><br> _Nota: È disponibile solo nell'esperienza delle App per le registrazioni (Legacy). Sostituito da `signInUrl` nella [registrazioni per l'App](https://go.microsoft.com/fwlink/?linkid=2083908) esperienza._ | `"https://MyRegisteredApp"` |
