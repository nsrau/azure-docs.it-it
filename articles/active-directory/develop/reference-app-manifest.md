...
| `availableToOtherTenants` | Boolean | true se l'applicazione viene condivisa con altri tenant; in caso contrario, false. <br><br> _Nota: È stato sostituito da `signInAudience` nella [registrazioni per l'App (anteprima)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) esperienza._ | |
...
| `displayName` | String | Nome visualizzato dell'app. <br><br> _Nota: È stato sostituito da `name` nella [registrazioni per l'App (anteprima)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) esperienza._ | `"MyRegisteredApp"` |
...
| `homepage` | String | URL della home page dell'applicazione. <br><br> _Nota: È stato sostituito da `signInUrl` nella [registrazioni per l'App (anteprima)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) esperienza._ | `"https://MyRegisteredApp"` |
| `objectId` | String | Identificatore univoco per l'app nella directory. <br><br> _Nota: È stato sostituito da `id` nella [registrazioni per l'App (anteprima)](https://developer.microsoft.com/en-us/graph/blogs/new-app-registration/) esperienza._ | `"f7f9acfc-ae0c-4d6c-b489-0a81dc1652dd"` |
...
1. Se il flusso di lavoro richiede di salvare i manifesti nel repository del codice sorgente per un uso futuro, è consigliabile la riassegnazione i manifesti salvati nel repository con quella presenti il **registrazioni per l'App (anteprima)** esperienza.
