...
| Chiave  | Tipo di valore | Description  | Valore di esempio |
|---------|---------|---------|---------|
...
| `errorUrl` | string | Non supportata. | |
