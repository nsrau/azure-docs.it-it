...
Viene restituito un errore quando si tenta di usare un metodo non interattivo per acquisire un token (ad esempio, `acquireTokenSilent`) e MSAL non è stato in grado di eseguire l'operazione in modo invisibile all'utente. 
