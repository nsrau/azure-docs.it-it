...
Configurare quindi il codice dell'app per l'uso della registrazione dell'app creata nei passaggi precedenti: [configurazione del codice dell'app](scenario-spa-app-configuration.md).