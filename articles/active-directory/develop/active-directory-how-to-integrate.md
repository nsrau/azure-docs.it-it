---
title: L'integrazione con Azure Active Directory | Microsoft Docs
description: Scopri i vantaggi dell'integrazione dell'applicazione con Azure Active Directory e Ottieni risorse per le funzionalità, ad esempio semplificato effettuato l'accesso, gestione delle identità, multi-factor authentication e controllo di accesso.
...
ms.locfileid: "59359892"
---
# <a name="integrating-with-azure-active-directory"></a>Integrazione con Azure Active Directory

[!INCLUDE [active-directory-devguide](../../../includes/active-directory-devguide.md)]

In questo articolo si Scopri i vantaggi dell'integrazione dell'applicazione con Azure Active Directory (Azure AD) e ottenere risorse per l'integrazione. Azure AD consente alle organizzazioni di gestione delle identità di livello aziendale per le applicazioni cloud. L'integrazione di Azure AD offre agli utenti un'esperienza di accesso semplificata e favorisce la conformità delle applicazioni ai criteri IT.
...
### <a name="promote-your-application-in-the-azure-and-office-365-marketplaces"></a>Promuovi la tua applicazione in Azure e Office 365 Marketplace

**Promuovi la tua applicazione a milioni di organizzazioni che già usano Azure AD.**   Gli utenti che esplorano questi Marketplace usano già uno o più servizi cloud, di conseguenza rappresentano il pubblico di destinazione ideale per l'applicazione. Altre informazioni sulla promozione dell'applicazione in [Azure Marketplace](https://azure.microsoft.com/marketplace/partner-program/).

**Quando gli utenti l'iscrizione per l'applicazione, verrà visualizzato nel proprio pannello di accesso di Azure AD e l'avvio di app di Office 365.**   Questo consente tornare all'applicazione in modo facile e veloce, migliorando così il coinvolgimento degli utenti. Altre informazioni sul [pannello di accesso di Azure AD](../user-help/active-directory-saas-access-panel-introduction.md).

### <a name="secure-device-to-service-and-service-to-service-communication"></a>Proteggere le comunicazioni di servizio a dispositivo e servizio-a-service

**Uso di Azure AD per la gestione delle identità dei servizi e dispositivi riduce il codice che necessario per scrivere e consente al reparto IT per gestire l'accesso.**   I servizi e i dispositivi ricevono token tramite OAuth da Azure AD e li usano per accedere alle API Web. L'uso di Azure AD consente di evitare la scrittura di codice di autenticazione complesso. Poiché le identità di servizi e dispositivi sono archiviate in Azure AD, il reparto IT può gestire le chiavi e le revoche in una posizione centralizzata, anziché in una posizione separata all'interno dell'applicazione.
