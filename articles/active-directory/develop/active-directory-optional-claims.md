...
ms.locfileid: "58882801"
---
# <a name="how-to-provide-optional-claims-to-your-azure-ad-app-preview"></a>Procedura: Fornire attestazioni facoltative per l'app di Azure AD (anteprima)
...
Per l'elenco di attestazioni standard e sul loro uso nei token, vedere la [nozioni di base dei token emessi da Azure AD](v1-id-and-access-tokens.md).
...
|                | `include_externally_authenticated_upn_without_hash` | Come sopra, ad eccezione del fatto che contrassegna l'hash (`#`) vengono sostituiti con caratteri di sottolineatura (`_`), ad esempio `foo_hometenant.com_EXT_@resourcetenant.com` |
