---
title: Accedere e chiamare Microsoft Graph da iOS | Azure
...
ms.locfileid: "76703780"
---
# <a name="quickstart-sign-in-users-and-call-the-microsoft-graph-api-from-an-ios-app-v10"></a>Avvio rapido: Accesso utenti e chiamata dell'API Microsoft Graph da un'app iOS (v1.0)
...
Per le nuove applicazioni macOS e iOS, è consigliabile usare Microsoft Identity Platform (v 2.0) e MSAL per acquisire i token e accedere alle API Web protette: [Avvio rapido: Accesso utenti e chiamata dell'API Microsoft Graph da un'app iOS o macOS](quickstart-v2-ios.md).
