...
1. Dopo aver verificato che l'applicazione usa il codice precedente, aprire il file **Web. config** e passare al blocco **\<IssuerNameRegistry >** , cercando in modo specifico le seguenti righe:
   ```
