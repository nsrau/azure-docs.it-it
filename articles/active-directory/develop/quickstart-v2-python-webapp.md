...
ms.locfileid: "77160490"
---
# <a name="quickstart-add-sign-in-with-microsoft-to-a-python-web-app"></a>Avvio rapido: Aggiungere l'accesso con Microsoft a un'app Web Python
