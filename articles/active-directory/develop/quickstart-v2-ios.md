...
> Per far funzionare l'esempio di codice di questo argomento di avvio rapido, è necessario aggiungere un URL di risposta come `msal<AppId>://auth`, dove msal\<AppId> è l'ID di questa applicazione.
