...
| `client_secret` | Obbligatoria | The client secret that you generated for your app in the app registration portal. Prima di essere inviato, il segreto client deve essere codificato come URL. |
