...
Per informazioni su tutti i tipi di token e attestazioni disponibili per un'app, vedere le [informazioni di riferimento sui token 2.0](v2-id-and-access-tokens.md).
...
![Flusso di autenticazione dell'API Web](/media/v2-protocols-oidc/convergence_scenarios_webapi.png)
