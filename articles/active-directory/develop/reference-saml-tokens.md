...
* Per altre informazioni sulla gestione dei criteri di durata dei token tramite l'API Microsoft Graph, vedere la [risorsa dei criteri](/graph/api/resources/policy?view=graph-rest-beta).
