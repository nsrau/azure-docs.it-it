...
Azure Active Directory (Azure AD) offre diversi modi per proteggere l'app e un servizio. Una di queste funzionalità uniche è l'accesso condizionale. L'accesso condizionale consente agli sviluppatori e ai clienti aziendali di proteggere i servizi in molti modi, tra cui:
