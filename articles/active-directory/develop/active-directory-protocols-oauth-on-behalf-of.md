...
> [!IMPORTANT]
> I client pubblici che usano la [concessione implicit OAuth 2.0](active-directory-dev-understanding-oauth2-implicit-grant.md) non possono utilizzare il flusso OBO. Questi client devono passare il token di accesso a un client riservato di livello intermedio per eseguire i flussi OBO. Per ulteriori informazioni sui client che possono eseguire chiamare OBO, è possibile consultare[limitazioni Client](#client-limitations).
