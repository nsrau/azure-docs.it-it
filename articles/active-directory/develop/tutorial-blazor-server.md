...
Blazor Server fornisce il supporto per ospitare componenti Razor nel server in un'app ASP.NET Core. Questa esercitazione spiega come implementare l'autenticazione e recuperare i dati da Microsoft Graph in un'app Blazor Server con Microsoft Identity Platform.
