...
>
> Nella cartella *JavaScriptSPA* modificare *authConfig.js* e impostare i valori `clientID` e `authority` presenti nella sezione `msalConfig`.
> ```javascript
>
