...
Se si prevede di usare l'autenticazione interattiva o flusso del codice di dispositivo, come nell'esempio precedente, si desidera utilizzare il `.WithRedirectUri` modificatore:
