...
| redirect_uri |obbligatorio | @No__t_0registered nell'applicazione client. |
...
| Codice di stato HTTP | Codice di errore | Description | Azione client |
| --- | --- | --- | --- |
