...
| redirect_uri |obbligatorio | Oggetto `redirect_uri`registrata nell'applicazione client. |
...
| Risorsa |L'URI ID app dell'API Web (risorsa protetta). |
