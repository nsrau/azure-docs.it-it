...
Seguire le istruzioni per [registrare una nuova applicazione a pagina singola](https://docs.microsoft.com/zure/active-directory/develop/scenario-spa-app-registration).
