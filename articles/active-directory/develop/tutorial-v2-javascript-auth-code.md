...
| | |
|---|---|
|[msal.js](https://github.com/AzureAD/microsoft-authentication-library-for-js/tree/dev/lib/msal-browser)|Pacchetto del browser di Microsoft Authentication Library per JavaScript 2.0|
| | |
