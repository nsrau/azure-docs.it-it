...
4.    Fare clic su `Add Platforms`, quindi selezionare `Web`
...
6.    Impostare il valore di SSL abilitato su `True`:<br/><br/>![Proprietà del progetto](media/active-directory-serversidewebapp-aspnetwebappowin-configure/vsprojectproperties.png)<br />
