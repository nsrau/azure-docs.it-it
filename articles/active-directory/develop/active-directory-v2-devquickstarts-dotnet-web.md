---
title: Aggiungere informazioni di accesso a un&quot;app Web .NET MVC usando l&quot;endpoint&2;.0 di Azure AD | Documentazione Microsoft
...
* Aggiungere al progetto una classe OWIN Startup denominata `Startup.cs`. Fare clic con il pulsante destro del mouse sul progetto, scegliere **Aggiungi** --> **Nuovo elemento** e quindi cercare "OWIN".  Il middleware OWIN richiamerà il metodo `Configuration(...)` all'avvio dell'app.
