...
## <a name="scenario-sign-in-users-from-work-and-school-accounts-in-your-aspnet-app"></a>Scenario: consentire l'accesso degli utenti di account aziendali e dell'istituto di istruzione nell'app ASP.NET
