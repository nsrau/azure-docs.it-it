...
### [Visualizzare SAML restituito da Controllo di accesso](active-directory-java-view-saml-returned-by-access-control.md)
...
### [Che cosa è successo al progetto MVC?](Visual Studio Azure Active Directory connected service.md)
...
# [Endpoint 2.0](active-directory-appmodel-v2-overview.md)
