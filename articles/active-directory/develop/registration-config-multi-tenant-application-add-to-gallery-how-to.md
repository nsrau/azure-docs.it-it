...
2. Inviare la richiesta come descritto in [Inserimento dell'applicazione nella raccolta di applicazioni di Azure Active Directory](../azuread-dev/howto-app-gallery-listing.md).
...
Informazioni su come [inserire l'applicazione nella raccolta di applicazioni Azure Active Directory](../azuread-dev/howto-app-gallery-listing.md).