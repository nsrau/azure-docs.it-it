...
Vedere gli esempi di codice per gli scenari Da Web Browser ad applicazione Web. Consultare spesso questa pagina perché vengono aggiunti regolarmente nuovi esempi: [Applicazione Web](sample-v1-code.md#web-applications).
...
![Diagramma Applicazione a singola pagina (SPA)](./media/authentication-scenarios/single_page_app.png)
...
Vedere gli esempi di codice per gli scenari di applicazioni a singola pagina (SPA). Consultare spesso questa pagina perché vengono aggiunti regolarmente nuovi esempi: [Applicazione a singola pagina (SPA)](sample-v1-code.md#single-page-applications).
...
[Esempi di codice di Azure Active Directory](sample-v1-code.md)
