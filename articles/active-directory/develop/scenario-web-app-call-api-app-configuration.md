...
| ![MSAL Python](media/sample-v2-code/logo_python.png) <br/> MSAL Python | Supporto per le applicazioni Web Python |
| ![MSAL Java](media/sample-v2-code/logo_java.png) <br/> MSAL Java | Supporto per le applicazioni Web Java |
