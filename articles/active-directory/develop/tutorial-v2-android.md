---
title: Introduzione ad Android per Azure Active Directory v2.0 | Microsoft Docs
description: Informazioni su come un'app Android può ottenere un token di accesso e chiamare l'API Microsoft Graph o API che richiedono token di accesso da un endpoint di Azure Active Directory v2.0.
