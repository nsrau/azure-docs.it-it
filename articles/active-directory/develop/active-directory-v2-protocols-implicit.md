...
Per altre informazioni sulle attestazioni presenti nel token di accesso, vedere le [informazioni di riferimento sui token dell'endpoint v2.0](active-directory-v2-tokens.md)
