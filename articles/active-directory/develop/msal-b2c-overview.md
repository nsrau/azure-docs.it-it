...
Per proteggere l'API Web con Azure AD B2C, prima di tutto è necessario registrarla. Per istruzioni dettagliate, vedere [Registrare l'applicazione](../../active-directory-b2c/add-web-application.md).
