...
![Registrazione delle app](./media/app-objects-and-service-principals/app-registration.png)
...
- È possibile accedere all'oggetto applicazione di un'applicazione usando l'API Microsoft Graph, l'editor del manifesto dell'applicazione [portale di Azure][AZURE-Portal] o [Azure ad i cmdlet di PowerShell](https://docs.microsoft.com/powershell/azure/?view=azureadps-2.0), come rappresentato dall' [entità dell'applicazione][MS-Graph-App-Entity]OData.
- È possibile accedere all'oggetto entità servizio di un'applicazione tramite l'API Microsoft Graph o [Azure ad cmdlet di PowerShell](https://docs.microsoft.com/powershell/azure/?view=azureadps-2.0), come rappresentato dall' [entità ServicePrincipal][MS-Graph-Sp-Entity]di OData.
