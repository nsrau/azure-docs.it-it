...
ms.locfileid: "57213484"
---
# <a name="azure-active-directory-graph-api"></a>API Graph di Azure Active Directory

> [!IMPORTANT]
>
> A partire da febbraio 2019, abbiamo avviato il processo di deprecare alcune versioni precedenti di Active Directory API Graph di Azure con l'API Microsoft Graph. 
>
> Per ulteriori informazioni, aggiornamenti e gli intervalli di tempo, vedere [Microsoft Graph o Azure AD Graph](https://dev.office.com/blogs/microsoft-graph-or-azure-ad-graph) in Office Dev Center.
>
