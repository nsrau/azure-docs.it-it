...
* [Guida introduttiva per l'API Graph di Azure AD](./microsoft-graph-intro.md)
* [Documentazione di riferimento all'API REST Graph di Azure AD](/previous-versions/azure/ad/graph/api/api-catalog)