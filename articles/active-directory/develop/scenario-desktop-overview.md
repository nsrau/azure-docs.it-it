...
Se non è già stato fatto, creare la prima applicazione seguendo la Guida introduttiva per desktop .NET o la Guida introduttiva di UWP:
...
- È possibile usare l'acquisizione di token interattivo:
  ...
  - Se l'applicazione desktop supporta i controlli grafici, ad esempio se si tratta di un'applicazione Windows. Form o di un'applicazione WPF.
