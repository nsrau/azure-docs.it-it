...
| ![MSAL.js](media/sample-v2-code/logo_js.png) <br/>[MSAL.js (anteprima)](https://github.com/AzureAD/microsoft-authentication-library-for-js)| Framework JavaScript/TypeScript come AngularJS, Ember.js o Durandal.js|
