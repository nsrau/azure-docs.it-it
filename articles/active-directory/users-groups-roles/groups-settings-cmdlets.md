...
|  <ul><li>AllowAddGuests<li>Tipo: booleano<li>Predefinito: True | Valore booleano che indica se è consentito o meno aggiungere utenti guest a questa directory.|
