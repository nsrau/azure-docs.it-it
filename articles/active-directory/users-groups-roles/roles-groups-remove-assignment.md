...
1. Selezionare **ruoli e amministratori**  >  ***nome ruolo***.

1. Selezionare il gruppo da cui si desidera rimuovere l'assegnazione di ruolo e selezionare **Rimuovi assegnazione**.

   ![Rimuovere un'assegnazione di ruolo da un gruppo selezionato.](./media/roles-groups-remove-assignment/remove-assignment.png)
