...
Per informazioni dettagliate, vedere [creare e assegnare un ruolo personalizzato](roles-create-custom.md) e [assegnare ruoli personalizzati con ambito di risorse usando PowerShell](roles-assign-powershell.md).
...
Creare un ruolo personalizzato usando l'esempio fornito nell'API Microsoft Graph. Per informazioni dettagliate, vedere [creare e assegnare un ruolo personalizzato](roles-create-custom.md) e [assegnare ruoli di amministratore personalizzati usando l'API Microsoft Graph](roles-assign-graph.md).
