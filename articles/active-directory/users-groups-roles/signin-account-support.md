...
La pagina di accesso di Microsoft 365 per Azure Active Directory (Azure AD) supporta una o entrambe di lavoro o dell'istituto di istruzione e gli account Microsoft, a seconda della situazione, per supportare:
...
[Opzioni di accesso aggiuntive valide solo per gli account Microsoft personali](index.yml) ma non può essere usato per l'accesso all'azienda o dell'istituto di istruzione le risorse dell'account.
