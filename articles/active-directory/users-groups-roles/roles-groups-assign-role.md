...
1. Nella pagina ***nome ruolo*** selezionare > **Aggiungi assegnazione**.

   ![Aggiungere la nuova assegnazione di ruolo](./media/roles-groups-assign-role/add-assignment.png)

1. Selezionare il gruppo. Vengono visualizzati solo i gruppi che possono essere assegnati ai ruoli Azure AD.

    [![Per una nuova assegnazione di ruolo vengono visualizzati solo i gruppi assegnabili.](media/roles-groups-assign-role/eligible-groups.png "Per una nuova assegnazione di ruolo vengono visualizzati solo i gruppi assegnabili.")](media/roles-groups-assign-role/eligible-groups.png#lightbox)
