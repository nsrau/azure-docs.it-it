...
description: Rimuovere i membri del gruppo nelle operazioni bulk nell'interfaccia di amministrazione di Azure.
...
![Foglio di calcolo per il caricamento e la chiamata che spiega lo scopo e i valori per ogni riga e colonna](./media/groups-bulk-remove-members/template-example.png)
...
1. Nella pagina **rimozione in blocco dei membri del gruppo** selezionare **download** per ottenere il modello di file CSV con le proprietà obbligatorie del membro del gruppo.
...
1. Nella pagina **rimozione in blocco dei membri del gruppo** , in **caricare il file CSV**, selezionare il file. Quando si seleziona il file, viene avviata la convalida del file CSV.
