...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Configure Single Sign-On](./media/active-directory-saas-zscaler-two-tutorial/tutorial_zscalertwo_samlbase.png)

3. Nella sezione **URL e dominio Zscaler Two** seguire questa procedura:

    ![Configure Single Sign-On](./media/active-directory-saas-zscaler-two-tutorial/tutorial_zscalertwo_url.png)
...
4. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Configure Single Sign-On](./media/active-directory-saas-zscaler-two-tutorial/tutorial_zscalertwo_certificate.png) 

5. Fare clic sul pulsante **Salva** .

    ![Configure Single Sign-On](./media/active-directory-saas-zscaler-two-tutorial/tutorial_general_400.png)
...
6. Nella sezione **Configurazione di Zscaler Two** fare clic su **Configura Zscaler Two** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**
    ...
    ![Configure Single Sign-On](./media/active-directory-saas-zscaler-two-tutorial/tutorial_zscalertwo_configure.png) 
...
2. Nell'elenco delle applicazioni selezionare **Zscaler Two**.
    ...
    ![Configure Single Sign-On](./media/active-directory-saas-zscaler-two-tutorial/tutorial_zscalertwo_app.png) 
