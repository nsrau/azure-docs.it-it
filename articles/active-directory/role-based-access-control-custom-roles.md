...
* Per un elenco di operazioni disponibili, vedere [Operazioni di provider di risorse con Azure Resource Manager](role-based-access-control-resource-provider-operations.md).
