...
## <a name="restrictions-on-apps"></a>Restrizioni relative alle app
...
## <a name="restrictions-for-work-&-school-accounts"></a>Restrizioni per gli account di lavoro e dell'istituto di istruzione
Alcune funzionalità specifiche per gli utenti Microsoft aziendali non sono ancora supportate dall'endpoint 2.0.

##### <a name="device-based-conditional-access,-native-and-mobile-apps,-and-the-microsoft-graph"></a>Accesso condizionale basato su dispositivo, applicazioni native e per dispositivi mobili e Microsoft Graph
