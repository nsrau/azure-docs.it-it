...
![Criteri di rischio di accesso](./media/overview/1014.png "Criteri di rischio di accesso")
...
* Impostare gli utenti e i gruppi a cui vengono applicati i criteri:
    ...
    ![Criteri di rischio di accesso](./media/overview/1015.png "Criteri di rischio di accesso")
* Impostare la soglia del livello di rischio di accesso, bassa, media o alta, che attiva il criterio:

    ![Criteri di rischio di accesso](./media/overview/1016.png "Criteri di rischio di accesso")
* Impostare i controlli da applicare quando viene attivato il criterio:  

    ![Criteri di rischio di accesso](./media/overview/1017.png "Criteri di rischio di accesso")
* Cambiare lo stato dei criteri:

    ![Registrazione MFA](./media/overview/403.png "Registrazione MFA")
* Esaminare e valutare l'impatto di una modifica prima di attivarla:

    ![Criteri di rischio di accesso](./media/overview/1018.png "Criteri di rischio di accesso")
...
- Nel pannello **Azure AD Identity Protection** fare clic su **Criteri di rischio di accesso** nella sezione **Configura**.
    ...
    ![Criteri di rischio utente](./media/overview/1014.png "Criteri di rischio utente")



## <a name="users-flagged-for-risk"></a>Utenti contrassegnati per il rischio

Tutti gli [eventi di rischio](../reports-monitoring/concept-risk-events.md) attivi rilevati da Azure Active Directory per un utente rientrano nel concetto logico del rischio utente. Un utente contrassegnato per il rischio è indicativo di un account utente che potrebbe essere stato compromesso.

![Utenti contrassegnati per il rischio](./media/overview/1200.png)
...
![Rischi utente](./media/overview/1031.png "Rischi utente")
...
![Azioni](./media/overview/34.png "Azioni")
...
1. Nel pannello **Azure AD Identity Protection** fare clic su **Eventi di rischio** in **Ricerca causa**.
    ...
    ![Reimpostazione manuale della password](./media/overview/1002.png "Reimpostazione manuale della password")
2. Nell'elenco **Eventi di rischio** fare clic su un rischio.

    ![Reimpostazione manuale della password](./media/overview/1003.png "Reimpostazione manuale della password")
3. Nel pannello dei rischi fare clic con il pulsante destro del mouse su un utente.

    ![Reimpostazione manuale della password](./media/overview/1004.png "Reimpostazione manuale della password")
...
![Azioni](./media/overview/2222.png "Azioni")
...
![Criteri](./media/overview/1005.png "Criteri")

**Per aprire la relativa finestra di dialogo di configurazione**:

1. Nel pannello **Azure AD Identity Protection** fare clic su **Utenti contrassegnati per il rischio**.

    ![Reimpostazione manuale della password](./media/overview/1006.png "Reimpostazione manuale della password")
2. Dall'elenco di utenti selezionare un utente con almeno un evento di rischio.

    ![Reimpostazione manuale della password](./media/overview/1007.png "Reimpostazione manuale della password")
3. Nel pannello dell'utente fare clic su **Reimposta password**.

    ![Reimpostazione manuale della password](./media/overview/1008.png "Reimpostazione manuale della password")
...
![Criteri di rischio utente](./media/overview/1009.png "Criteri di rischio utente")
...
* Impostare gli utenti e i gruppi a cui vengono applicati i criteri:
    ...
    ![Criteri di rischio utente](./media/overview/1010.png "Criteri di rischio utente")
* Impostare la soglia del livello di rischio utente, bassa, media o alta, che attiva il criterio:

    ![Criteri di rischio utente](./media/overview/1011.png "Criteri di rischio utente")
* Impostare i controlli da applicare quando viene attivato il criterio:

    ![Criteri di rischio utente](./media/overview/1012.png "Criteri di rischio utente")
* Cambiare lo stato dei criteri:

    ![Criteri di rischio utente](./media/overview/403.png "Registrazione MFA")
* Esaminare e valutare l'impatto di una modifica prima di attivarla:

    ![Criteri di rischio utente](./media/overview/1013.png "Criteri di rischio utente")
...
![Criteri di rischio utente](./media/overview/1019.png "Criteri di rischio utente")
...
* Impostare gli utenti e i gruppi a cui vengono applicati i criteri:
    ...
    ![Criteri MFA](./media/overview/1020.png "Criteri MFA")
* Impostare i controlli da applicare quando viene attivato il criterio:  

    ![Criteri MFA](./media/overview/1021.png "Criteri MFA")
* Cambiare lo stato dei criteri:

    ![Criteri MFA](./media/overview/403.png "Criteri MFA")
* Visualizzare lo stato di registrazione corrente:

    ![Criteri MFA](./media/overview/1022.png "Criteri MFA")
...
- Nel pannello **Azure AD Identity Protection** fare clic su **Criteri di registrazione per l'autenticazione a più fattori** nella sezione **Configura**.
    ...
    ![Criteri MFA](./media/overview/1019.png "Criteri MFA")
...
* [Vulnerabilità rilevate da Azure Active Directory Identity Protection](vulnerabilities.md)

* [Eventi di rischio di Azure Active Directory](../active-directory-identity-protection-risk-events.md)

* [Notifiche di Azure Active Directory Identity Protection](notifications.md)

* [Studio di Azure Active Directory Identity Protection](playbook.md)

* [Glossario di Azure Active Directory Identity Protection](glossary.md)

* [Esperienze di accesso con Azure AD Identity Protection](flows.md)

* [Azure Active Directory Identity Protection: come sbloccare gli utenti](howto-unblock-user.md)

* [Introduzione ad Azure Active Directory Identity Protection e a Microsoft Graph](graph-get-started.md)
