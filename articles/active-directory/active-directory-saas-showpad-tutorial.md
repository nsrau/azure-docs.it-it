...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura e quindi fare clic su **Avanti**:
    ...
    b. Nella casella di testo **Identificatore** digitare l'URL usando il modello seguente: `https://<company name>.showpad.biz`

    c. Fare clic su **Avanti**


1. Nella pagina **Configura accesso Single Sign-On in Showpad** seguire questa procedura e quindi fare clic su **Avanti**:
