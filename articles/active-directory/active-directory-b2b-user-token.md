---
title: Informazioni sui token utente in Collaborazione B2B di Azure Active Directory | Documentazione Microsoft
...
# <a name="understand-user-tokens-in-azure-active-directory-b2b-collaboration"></a>Informazioni sui token utente in Collaborazione B2B di Azure Active Directory

Se si è interessati a conoscere l'aspetto del token per un utente di Collaborazione B2B, di seguito sono riportati i dettagli del token di connessione e del contenuto del token per AAD Guest e MSA Guest nel tenant delle risorse per tenantid:04dcc6ab-388a-4559-b527-fbec656300ea. È possibile usare [https://jwt.io/](https://jwt.io/) o [http://calebb.net](http://calebb.net/)/ per visualizzare il contenuto del token JWT.

## <a name="azure-ad-guest-user-token"></a>Token dell'utente guest di Azure AD
```
...
## <a name="microsoft-account-guest"></a>Token dell'utente guest dell'account Microsoft
```
