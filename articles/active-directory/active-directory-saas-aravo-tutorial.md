...
Questa sezione descrive come configurare e testare l'accesso Single Sign-On di Azure AD con Aravo in base a un utente test di nome "Britta Simon".
...
In questa sezione viene abilitato l'accesso Single Sign-On di Azure AD nel portale di Azure classico e viene configurato l'accesso Single Sign-On nell'applicazione Aravo.

**Per configurare l'accesso Single Sign-On di Azure AD con Aravo, seguire questa procedura:**
...
2. Nella pagina **Stabilire come si desidera che gli utenti accedano a Aravo**, selezionare **Single Sign-On di Azure AD** e quindi fare clic su **Avanti**.
