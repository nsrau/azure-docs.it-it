...
![Visualizzazione degli attributi del token SAML nell'interfaccia utente](media/active-directory-b2b-claims-mapping/view-claims-in-saml-token.png)
...
- Per informazioni sulle proprietà degli utenti di Collaborazione B2B, vedere [Proprietà di un utente di Collaborazione B2B di Azure Active Directory](active-directory-b2b-user-properties.md).
- Per informazioni sui token utente per gli utenti di Collaborazione B2B, vedere [Informazioni sui token utente in Collaborazione B2B di Azure AD](active-directory-b2b-user-token.md).
