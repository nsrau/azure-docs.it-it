...
L'obiettivo di questa esercitazione è illustrare come integrare Fuse con Azure Active Directory (Azure AD).<br>L'integrazione di Fuse con Azure AD offre i vantaggi seguenti:
...
6. Nella casella di ricerca digitare **Fuse**.<br><br> ![Creazione di un utente test di Azure AD](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_01.png)<br>
7. Nel riquadro dei risultati selezionare **Fuse** e quindi fare clic su **Completa** per aggiungere l'applicazione. <br><br>
...
Per il funzionamento dell'accesso Single Sign-On, Azure AD deve conoscere qual è l'utente di Fuse che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Fuse.<br> La relazione di collegamento viene stabilita assegnando il valore di **nome utente** in Azure AD come valore di **Username** in Fuse.
...
1. Nella pagina di integrazione dell'applicazione **Fuse** del portale di Azure classico fare clic su **Configura accesso Single Sign-On** per aprire la finestra di dialogo **Configura accesso Single Sign-On**. <br><br> ![Configura accesso Single Sign-On][6] <br>

2. Nella pagina **Stabilire come si desidera che gli utenti accedano a Fuse** selezionare **Single Sign-On di Azure AD** e quindi fare clic su **Avanti**. <br><br> ![Configura accesso Single Sign-On](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_03.png) <br>

3. Nella pagina della finestra di dialogo **Configurare le impostazioni dell'app** seguire questa procedura: <br><br>![Configura accesso Single Sign-On](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_04.png) <br>

    a. Nella casella di testo URL di accesso, digitare l'URL usato dagli utenti per accedere all'applicazione Fuse adottando il modello seguente: **"https://azuresso.fusion-universal.com/"**.
...
4. Nella pagina **Configura accesso Single Sign-On in Fuse** seguire questa procedura. <br><br>![Configura accesso Single Sign-On](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_05.png) <br>
...
5. Per ottenere SSO configurato per l'applicazione, contattare il team di supporto Fuse all’indirizzo * ***support@fusion-universal.com**, allegare il file di certificato scaricato e includere **URL autorità di certificazione**, **URL servizio Single Sign-On** e **URL servizio Single Sign-Out**.
...
1. Nel **portale di Azure classico** fare clic su **Active Directory** nel riquadro di spostamento sinistro. <br><br>![Creazione di un utente test di Azure AD](./media/active-directory-saas-fuse-tutorial/create_aaduser_09.png) <br>

2. Nell'elenco **Directory** selezionare la directory per la quale si desidera abilitare l'integrazione delle directory.

3. Per visualizzare l'elenco di utenti, nel menu in alto fare clic su **Utenti**. <br><br> ![Creazione di un utente test di Azure AD](./media/active-directory-saas-fuse-tutorial/create_aaduser_03.png) <br>

4. Per aprire la finestra di dialogo **Aggiungi utente**, nella barra degli strumenti in basso fare clic su **Aggiungi utente**. <br><br> ![Creazione di un utente test di Azure AD](./media/active-directory-saas-fuse-tutorial/create_aaduser_04.png) <br>

5. Nella pagina della finestra di dialogo **Informazioni sull'utente** seguire questa procedura: <br><br> ![Creazione di un utente test di Azure AD](./media/active-directory-saas-fuse-tutorial/create_aaduser_05.png) <br>
...
6.  Nella pagina **Profilo utente** seguire questa procedura: <br><br>![Creazione di un utente test di Azure AD](./media/active-directory-saas-fuse-tutorial/create_aaduser_06.png) <br>
...
7. Nella pagina della finestra di dialogo **Ottieni password temporanea**, fare clic su **crea**. <br><br> ![Creazione di un utente test di Azure AD](./media/active-directory-saas-fuse-tutorial/create_aaduser_07.png) <br>

8. Nella pagina della finestra di dialogo **Ottieni password temporanea** seguire questa procedura: <br><br>![Creazione di un utente test di Azure AD](./media/active-directory-saas-fuse-tutorial/create_aaduser_08.png) <br>
...
L'obiettivo di questa sezione consiste nell'abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Fuse. <br><br>![Assegna utente][200] <br>
...
2. Nell'elenco delle applicazioni selezionare **Fuse**. <br><br>![Configura accesso Single Sign-On](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_50.png) <br>
...
Questa sezione descrive come testare la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.<br> Quando si fa clic sul riquadro Fuse nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Fuse.
