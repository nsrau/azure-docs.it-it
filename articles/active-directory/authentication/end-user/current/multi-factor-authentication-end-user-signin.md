...
Informazioni su come [Gestire le impostazioni della verifica in due passaggi](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-manage-settings.md).

Altre informazioni sull'[introduzione all'app Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) per poter effettuare l'accesso tramite notifiche, invece che con messaggi e telefonate.
