---
title: Configurare la verifica in due passaggi - Azure AD | Microsoft Docs
...
5. Se si usano queste app, copiare la password dell'app fornita e incollare la password nell'applicazione, al posto della password regolare. È possibile usare la stessa password dell'app per più app. Per altre informazioni, vedere [Che cosa sono le password per le app?](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-app-passwords.md).
6. Fare clic su **Done**.
...
* Impostare [password di app](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-app-passwords.md) per tutte le app di dispositivo native che non supportano la verifica in due passaggi.
* Estrarre l'[app Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) per eseguire un'autenticazione sicura e veloce, anche in assenza di copertura di rete.
