...
1. Il software proxy di Azure AD Password Protection include un nuovo modulo di `AzureADPasswordProtection`PowerShell,. I passaggi seguenti eseguono diversi cmdlet da questo modulo di PowerShell.
