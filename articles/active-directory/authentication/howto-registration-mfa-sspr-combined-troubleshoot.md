...
* [Altre informazioni sulla registrazione combinata per la reimpostazione della password self-service e Azure Multi-Factor Authentication](concept-registration-mfa-sspr-combined.md)
