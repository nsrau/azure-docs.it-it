...
> Consentire ai criteri che usano solo l'app Authenticator (per i criteri a 1 Gate) o l'app Authenticator e un solo metodo aggiuntivo (per i criteri a 2-Gates) potrebbe impedire agli utenti di registrarsi per SSPR fino a quando non sono stati configurati per l'uso della nuova esperienza di registrazione.
...
Quando la richiesta di registrazione è disabilitata, gli utenti possono eseguire la registrazione manualmente. Possono visitare [https://aka.ms/ssprsetup](https://aka.ms/ssprsetup) o selezionare il collegamento **registra per la reimpostazione della password** nella scheda **profilo** nel pannello di accesso.
...
* Se è impostato su **No**, gli utenti saranno in grado di eseguire solo operazioni di reimpostazione della password e sblocco dell'account combinate.
