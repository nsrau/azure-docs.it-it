...
![Impostazioni del portale utenti](./media/howto-mfaserver-deploy-userportal/portalsettings.png)
...
![SMS del portale utenti](./media/howto-mfaserver-deploy-userportal/text.png)
