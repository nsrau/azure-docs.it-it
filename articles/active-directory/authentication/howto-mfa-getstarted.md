...
Per visualizzare rapidamente Azure Multi-Factor Authentication in azione e quindi tornare a comprendere ulteriori considerazioni sulla distribuzione:
...
1. Nella nuova scheda che consente di visualizzare **le impostazioni del servizio**.
...
Eseguire questo PowerShell in una finestra ISE o salvarlo come `.PS1` file per eseguirlo localmente.
...
1. In **Concedi**verificare che sia selezionato il pulsante di opzione **Concedi accesso** .
    * Selezionare la casella **Richiedi autenticazione**a più fattori.
    * Fare clic su **Seleziona**.
1. Ignorare la sezione della **sessione** .
1. Impostare l'opzione **Abilita criteri** **su**attivato.
1. Fare clic su **Crea**.
...
| La chiave è impostata su false o true | Enrolled | Eseguire l'autenticazione con l'autenticazione a più fattori |
...
Per visualizzare Multi-Factor Authentication di Azure in azione, completare l'esercitazione seguente:
