...
ms.locfileid: "77505612"
---
# <a name="complete-a-passwordless-authentication-deployment-in-azure-active-directory"></a>Completare una distribuzione di autenticazione con password in Azure Active Directory

La maggior parte di attacchi cibernetici inizia con un nome utente e una password rubati da qualcuno in un'organizzazione. Le organizzazioni provano a contrastare la minaccia richiedendo agli utenti di usare uno degli approcci seguenti:
...
- Migliore esperienza utente. Offri agli utenti un modo pratico per accedere ai dati da qualsiasi luogo e ti permette di accedere facilmente ad applicazioni e servizi, come Outlook, OneDrive o Office mentre per dispositivi mobili.
...
Con password, la password viene sostituita con un elemento più simile a quello che si sta usando o un elemento noto. Ad esempio, in Windows Hello for business, un movimento biometrico, ad esempio una faccia o un'impronta digitale, o un PIN specifico del dispositivo che non viene trasmesso in rete.
...
Per abilitare l'accesso a Windows 10 con le chiavi di sicurezza di FIDO2, è necessario abilitare la funzionalità del provider di credenziali in Windows 10 in uno dei modi seguenti:
