...
1. Usare le istruzioni in [Scaricare il server Azure Multi-Factor Authentication](howto-mfaserver-deploy.md#download-the-mfa-server) per ottenere la versione più recente del server Azure MFA.
