...
4. **[Creazione di un utente di test di GaggleAMP](#creating-a-GaggleAMP-test-user)** : per avere una controparte di Britta Simon in GaggleAMP collegata alla relativa rappresentazione in Azure AD.
