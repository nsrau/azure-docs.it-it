...
Questa esercitazione illustra come integrare GaggleAMP con Azure Active Directory (Azure AD).<br>L'integrazione di GaggleAMP con Azure AD offre i vantaggi seguenti:
...
Per il funzionamento dell'accesso Single Sign-On, Azure AD deve conoscere qual è l'utente di GaggleAMP che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in GaggleAMP.<br> La relazione di collegamento viene stabilita assegnando al valore di **nome utente** in Azure AD lo stesso valore di **Username** in GaggleAMP.
...
Questa sezione descrive come abilitare Britta Simon per l'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a GaggleAMP. <br><br>![Assegna utente][200] <br>
...
Questa sezione descrive come testare la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.<br> Quando si fa clic sul riquadro GaggleAMP nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione GaggleAMP.
