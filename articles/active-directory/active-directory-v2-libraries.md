<properties
   pageTitle="Librerie 2.0 di Azure Active Directory | Microsoft Azure"
...
## Librerie client con supporto di Microsoft
...
## Contenuti correlati
Per altre informazioni sull'endpoint 2.0 di Azure AD, vedere il [Panoramica del Modello app 2.0 di Azure AD][AAD-App-Model-V2-Overview].
