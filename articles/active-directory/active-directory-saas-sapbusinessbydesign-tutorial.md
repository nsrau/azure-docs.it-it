...
La relazione di collegamento viene stabilita assegnando al valore di **Nome utente** in Azure AD lo stesso valore di **Username** (Nome utente) in SAP Business ByDesign.
...
6. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
    ...
    a. Nella casella di testo **URL di accesso** digitare l'URL usato dagli utenti per accedere all'applicazione SAP Business ByDesign nel formato seguente: `https://<servername>.sapbydesign.com`
...
### <a name="creating-an-sap-business-bydesign-test-user"></a>Creazione di un utente test SAP Business ByDesign
