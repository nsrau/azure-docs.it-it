<properties
	...
	description="Come creare un'API Web NodeJS che accetta token da account Microsoft personali, aziendali e dell'istituto di istruzione."
...
<tags
  ...
  # Anteprima di Modello app 2.0: Proteggere un'API Web NodeJS
