...
- [Guida introduttiva: Richiedere MFA per app specifiche con l'accesso condizionale di Azure Active Directory](app-based-mfa.md) - per acquisire familiarità con la configurazione dei criteri di accesso condizionale. 
...
Con l'approccio descritto in questo articolo, è ora possibile configurare un criterio di accesso condizionale per i percorsi non attendibili. È sempre consigliabile testare i criteri prima di distribuirli nell'ambiente di produzione per assicurarsi che funzionino come previsto. Idealmente, è necessario eseguire i test iniziali in un tenant di test se possibile. Per altre informazioni, vedere [Come distribuire un nuovo criterio](best-practices.md#how-should-you-deploy-a-new-policy). 
