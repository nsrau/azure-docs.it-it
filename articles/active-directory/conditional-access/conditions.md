...
![Configurazione delle app client](./media/conditions/160.png)  
...
- Per informazioni su come configurare criteri di accesso condizionale, vedere [Guida introduttiva: Richiedere MFA per app specifiche con l'accesso condizionale di Azure Active Directory](app-based-mfa.md).
