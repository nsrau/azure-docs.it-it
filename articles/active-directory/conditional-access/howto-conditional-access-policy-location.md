...
1. In **app Cloud o azioni** > **Includi**Selezionare **tutte le app Cloud**, quindi **fare**clic su fine.
1. In **condizioni** > **percorso**.
   ...
   1. Fare clic su **Select** > **done** > **done**.
