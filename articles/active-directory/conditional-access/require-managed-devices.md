...
:::image type="content" source="./media/require-managed-devices/32.png" alt-text="Screenshot del riquadro del dispositivo in Azure A D. gli elementi abilitati e disabilitati sono evidenziati." border="false":::
