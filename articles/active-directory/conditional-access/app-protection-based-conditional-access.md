...
1. In **controllo** > di accesso**concedere**selezionare le opzioni seguenti:
...
1. In **controllo** > di accesso**concedere**selezionare **Concedi accesso**, **Richiedi criteri di protezione delle app**e selezionare **Seleziona**.
1. Confermare le impostazioni e impostare **Abilita criterio** **su on**.
1. Selezionare **Crea** per creare e abilitare i criteri.
