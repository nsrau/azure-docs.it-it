...
- Se viene distribuito Active Directory Federation Services, i server in cui verrà installato ADFS devono essere Windows Server 2012 R2 o versione successiva.
