...
4. Digitare **Reward Gateway** nella casella di ricerca.
...
5. Nel pannello dei risultati selezionare **Reward Gateway** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
3. Nella sezione **URL e dominio Reward Gateway**  seguire questa procedura:
