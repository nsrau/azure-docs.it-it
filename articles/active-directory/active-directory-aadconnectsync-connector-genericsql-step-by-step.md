<properties
   pageTitle="Procedura dettagliata relativa al servizio di sincronizzazione Azure AD Connect: connettore Generic SQL | Microsoft Azure"
...
12. Il file di configurazione ODBC dovrebbe adesso essere visibile in DSN su file. ![ODBC11](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\odbc11.png)

Il file necessario è ora disponibile e si può iniziare a creare il connettore.

## Creare il connettore Generic SQL

1. Nell’interfaccia utente di Synchronization Service Manager selezionare **Connettori** e **Crea**. Selezionare **Generic SQL (Microsoft)** e assegnargli un nome descrittivo. ![Connector1](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\connector1.png)
...
10. In **Seleziona tipi di oggetto** e **Seleziona attributi** selezionare entrambi i tipi di oggetto e tutti gli attributi. Nella pagina **Configura ancoraggi** fare clic su **Fine**.

## Creare i profili di esecuzione

1. Nell’interfaccia utente di Synchronization Service Manager selezionare **Connettori** e **Configura profili di esecuzione**. Fare clic su **Nuovo profilo**. Si inizierà con **Importazione completa**. ![Runprofile1](.\media\active-directory-aadconnectsync-connector-genericsql-step-by-step\runprofile1.png)
...
Immettere alcuni dati di prova nel database di esempio. Quando si è pronti, selezionare **Esegui** e **Importazione completa**.
