---
title: 'Esercitazione: Integrazione di Azure Active Directory con WORKS MOBILE | Documentazione Microsoft'
...
In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con WORKS MOBILE in base a un utente test di nome "Britta Simon".
...
In questa sezione viene abilitato l'accesso Single Sign-On di Azure AD nel portale di gestione di Azure e viene configurato l'accesso Single Sign-On nell'applicazione WORKS MOBILE.
...
3. Nella sezione **URL e dominio WORKS MOBILE** seguire questa procedura:
    ...
    a. Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://<your-subdomain>.worksmobile.com/jp/myservice`

    b. Nella casella di testo **Identificatore** digitare il valore `worksmobile.com`.

    > [!NOTE] 
    > Si noti che questi non sono i valori reali. È necessario aggiornare questi valori con l'identificatore e l'URL di accesso effettivi. In questo caso, è consigliabile di usare il valore univoco della stringa nell'identificatore. Per ottenere questi valori, contattare il [team di supporto di WORKS MOBILE](mailto:dl_ssoinfo@worksmobile.com). 
...
10. Per ottenere l'accesso Single Sign-On configurato per l'applicazione, contattare il [team di supporto di WORKS MOBILE](mailto:dl_ssoinfo@worksmobile.com) e fornire i valori seguenti: 
