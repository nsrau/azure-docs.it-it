...
![Screenshot che mostra la schermata per la connessione di Active Directory con un valore di directory specificato.](media/how-to-install/install-3.png)</br>
