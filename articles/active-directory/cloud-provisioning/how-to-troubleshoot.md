...
1. Nel server in cui è installato l'agente, aprire **Servizi** passando a esso o **avviando** > **eseguire** > **Services. msc**.
...
1. Sostituire la sezione `<system.diagnostics>` esistente con il codice seguente e tutti i messaggi di traccia andranno al file *ProvAgentTrace. log*.
