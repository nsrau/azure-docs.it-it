---
title: Consentire o bloccare gli inviti agli utenti B2B da organizzazioni specifiche - Azure Active Directory | Microsoft Docs
...
- Per informazioni sull'accesso condizionale e la collaborazione B2B, vedere [Accesso condizionale per gli utenti di Collaborazione B2B](active-directory-b2b-mfa-instructions.md).
