...
La relazione di collegamento viene stabilita assegnando il valore di **user name** in Azure AD come valore di **Username** (Nome utente) in Tidemark.
...
4. **[Creazione di un utente test Tidemark](#creating-a-tidemark-test-user)** : per avere una controparte di Britta Simon in Tidemark collegata alla relativa rappresentazione in Azure AD.
