...
2. Fare clic su **Users**, quindi fare clic su **Add New User**.
   ...
   > [!NOTE]
   > L’opzione **Add new User** viene visualizzata solo se **Mozy** è selezionato come provider in **Authentication policy**. Se è configurata l'autenticazione SAML gli utenti vengono aggiunti automaticamente al primo accesso tramite Single Sign-On.
   > 
   > 
