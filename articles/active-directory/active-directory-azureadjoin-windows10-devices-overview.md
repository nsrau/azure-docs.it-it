<properties 
	...
	description="Panoramica della distribuzione di dispositivi Windows 10 per le aziende e informazioni sull'integrazione con Azure Active Directory per il cloud Windows, con confronti tra i modi diversi in cui è possibile eseguire il provisioning di un dispositivo e usarlo in un'azienda tramite il portale di Azure."
...
Windows 10 fornisce la possibilità di utilizzare Azure Active Directory. I dispositivi Windows 10 possono essere connessi ad Azure AD e gli utenti possono accedere a Windows con gli account di Azure AD o aggiungere il proprio ID di Azure per accedere alle risorse e alle app aziendali.
...
I seguenti argomenti forniscono informazioni sulle diverse funzionalità con i dispositivi Windows 10 nell'organizzazione. Windows
