...
**R:** In alcuni casi, l'elaborazione dell'aggiunta o della rimozione di uno o più membri dell'unità amministrativa potrebbe richiedere alcuni minuti per essere riflessa nella pagina **unità amministrative** . In alternativa, è possibile passare direttamente alle proprietà della risorsa associata e verificare se l'azione è stata completata. Per altre informazioni su utenti e gruppi in AUs, vedere [elencare le unità amministrative per un utente](admin-units-add-manage-users.md) ed [elencare le unità amministrative per un gruppo](admin-units-add-manage-groups.md).
