...
Ad esempio, la delega del ruolo [Amministratore supporto tecnico](permissions-reference.md#helpdesk-administrator) agli specialisti del supporto locale limita la gestione ai soli utenti dell'area che supportano.
...
- [Creare, rimuovere, popolare e aggiungere ruoli alle unità amministrative](admin-units-manage.md): completare le procedure dettagliate
...
- [Gestione delle unità amministrative](admin-units-manage.md)
