...
1. Dalla pagina **Azure AD > Gruppi**
    ...
    ![assegnare un gruppo singolarmente a un'unità amministrativa](./media/admin-units-add-manage-groups/assign-to-group-1.png)
...
1. Dalla pagina **Azure AD > Unità amministrative > Tutti i gruppi**
    ...
    ![selezionare un'unità amministrativa e quindi Aggiungi membro](./media/admin-units-add-manage-groups/assign-to-admin-unit.png)
...
![Elencare i gruppi in un'unità amministrativa](./media/admin-units-add-manage-groups/list-groups-in-admin-units.png)
...
![Elencare le unità amministrative per un gruppo](./media/admin-units-add-manage-groups/list-group-au.png)
...
- Panoramica di Rimuovi da un gruppo
  ...
  1. Selezionare **Unità amministrative** nel pannello sinistro per elencare tutte le unità amministrative di cui il gruppo è membro. Selezionare l'unità amministrativa da cui si vuole rimuovere il gruppo, quindi selezionare **Rimuovi da unità amministrativa**.
    ...
    ![Rimuovere un gruppo da un'unità amministrativa](./media/admin-units-add-manage-groups/group-au-remove.png)
