...
Al termine dell'esercitazione, gli utenti di Azure AD assegnati a SuccessFactors potranno accedere all'applicazione tramite il sito aziendale di SuccessFactors (accesso avviato dal provider di servizi) o seguendo le istruzioni riportate in [Introduzione al Pannello di accesso](active-directory-saas-access-panel-introduction.md).
