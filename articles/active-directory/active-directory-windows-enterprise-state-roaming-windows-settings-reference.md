...
|**Cortana**: nome utente |sincronizzazione |sync |Interne|
...
|**Lingua**: cinese (QWERTY), Pinyin fuzzy|sync |sync |Linguaggio|
|**Lingua**: cinese (QWERTY), coppie fuzzy|sync |sync |Linguaggio|
...
|**Lingua**: Bopomofo cinese, inclusione di CJK, estensione A|sync |X |Linguaggio|
