...
[![Verificare lo stato nella pagina Risultati dell'operazione in blocco](./media/groups-bulk-remove-members/bulk-center.png)](./media/groups-bulk-remove-members/bulk-center.png#lightbox)
