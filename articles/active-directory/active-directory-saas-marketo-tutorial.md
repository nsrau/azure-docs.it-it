<properties
	pageTitle="Esercitazione: Integrazione di Azure Active Directory con Marketo | Microsoft Azure"
...
## Aggiunta di Marketo dalla raccolta
...
La relazione di collegamento viene stabilita assegnando al valore del **nome utente** in Azure AD lo stesso valore di **Username** (Nome utente ) in Marketo.
...
### Creazione di un utente di test Marketo
