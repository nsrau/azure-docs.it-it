...
4. **[Creazione di un utente test di Asset Bank](#creating-a-asset-bank-test-user)**: per avere una controparte di Britta Simon in Asset Bank collegata alla relativa rappresentazione in Azure AD.
...
2. Nella pagina **Stabilire come si desidera che gli utenti accedano ad Asset Bank** selezionare **Single Sign-On di Azure AD** e quindi fare clic su **Avanti**.
