...
La relazione di collegamento viene stabilita assegnando il valore di **nome utente** in Azure AD come valore di **nome utente** in Qlik Sense Enterprise.
...
2. Nella pagina **How would you like users to sign on to Qlik Sense Enterprise** (Stabilire come si desidera che gli utenti accedano a Qlik Sense Enterprise) selezionare **Single Sign-On di Microsoft Azure AD** e quindi fare clic su **Avanti**.
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
    ...
    a. Nella casella di testo **URL di accesso** digitare l'URL usato dagli utenti per accedere all'applicazione Qlik Sense Enterprise adottando il modello seguente: **https://\<nome host completo Qlik Sense Enterprise\>:443/<prefisso proxy virtuale\>/samlauthn/**.
...
6. Nella pagina **Profilo utente** seguire questa procedura:
    ...
    ![Creazione di un utente test di Azure AD](./media/active-directory-saas-qliksense-enterprise-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-qlik-sense-enterprise-test-user"></a>Creazione di un utente test di Qlik Sense Enterprise
