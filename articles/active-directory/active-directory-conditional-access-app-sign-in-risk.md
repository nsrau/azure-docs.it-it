...
Per mantenere l'ambiente protetto, è possibile bloccare l'accesso alle attività di utenti sospetti. [Azure Active Directory (Azure AD) Identity Protection](active-directory-identityprotection.md) analizza ciascun accesso e calcola la probabilità che un tentativo di accesso non venga eseguito dal proprietario legittimo di un account utente. La probabilità (bassa, media, elevata) è indicata in forma di valore calcolato denominato [livelli di rischio di accesso](active-directory-conditional-access-conditions.md#sign-in-risk). Impostando la condizione di rischio di accesso, è possibile configurare i criteri di accesso condizionale per rispondere ai livelli di rischio di accesso specifico. 
...
![Crea criteri](./media/active-directory-conditional-access-app-sign-in-risk/1000.png)
...
- **Identity Protection**: lo scenario in questa guida introduttiva richiede l'abilitazione di Identity Protection. Per scoprire come abilitare Identity Protection, vedere [Abilitazione di Azure Active Directory Identity Protection](active-directory-identityprotection-enable.md).

- **Tor Browser**: [Tor Browser](https://www.torproject.org/projects/torbrowser.html.en) è progettato per salvaguardare la privacy online. Identity Protection rileva un accesso da un Tor Browser come **accesso da indirizzi IP anonimi**, con un livello di rischio medio. Per altre informazioni, vedere [Eventi di rischio di Azure Active Directory](active-directory-reporting-risk-events.md).  

- **Account di test denominato Alain Charon**: se non si conosce la procedura per creare un account di test, vedere [Aggiungere gli utenti basati su cloud](fundamentals/add-users-azure-active-directory.md#add-cloud-based-users).
...
3. Nella sezione **Gestisci** della pagina **Azure Active Directory** fare clic su **Accesso condizionale**.
    ...
    ![Accesso condizionale](./media/active-directory-conditional-access-app-sign-in-risk/03.png)
...
6. Nella sezione **Assegnazioni** fare clic su **Utenti e gruppi**.
    ...
    ![Utenti e gruppi](./media/active-directory-conditional-access-app-sign-in-risk/06.png)

7. Nella pagina **Utenti e gruppi**:

    ![Accesso condizionale](./media/active-directory-conditional-access-app-sign-in-risk/107.png)
...
8. Fare clic su **App cloud**.
    ...
    ![App cloud](./media/active-directory-conditional-access-app-sign-in-risk/08.png)

9. Nella pagina **App cloud**:

    ![Accesso condizionale](./media/active-directory-conditional-access-app-sign-in-risk/109.png)
...
10. Nella sezione **Controlli di accesso** fare clic su **Concedi**.
    ...
    ![Controlli di accesso](./media/active-directory-conditional-access-app-sign-in-risk/10.png)

11. Nella pagina **Concedi**:

    ![Accesso condizionale](./media/active-directory-conditional-access-app-sign-in-risk/105.png)
...
12. Nella sezione **Attiva criterio** fare clic su **Sì**.
    ...
    ![Abilitare i criteri](./media/active-directory-conditional-access-app-sign-in-risk/18.png)
...
![Utente](./media/active-directory-conditional-access-app-sign-in-risk/117.png)
...
2. Fare clic su **Utente**, selezionare **Alan Charon** dalla pagina **Utenti**, quindi fare clic su **Seleziona**.
    ...
    ![Utente](./media/active-directory-conditional-access-app-sign-in-risk/116.png)

3. Selezionare **Medio** come **Rischio di accesso**.

    ![Utente](./media/active-directory-conditional-access-app-sign-in-risk/119.png)
...
![Autenticazione a più fattori](./media/active-directory-conditional-access-app-sign-in-risk/118.png)
...
- Per eliminare i criteri, selezionarli e quindi fare clic su **Elimina** nella barra di accesso rapido.
    ...
    ![Autenticazione a più fattori](./media/active-directory-conditional-access-app-sign-in-risk/33.png)
...
> [Richiedere MFA per app specifiche](./active-directory-conditional-access-app-based-mfa.md)
