---
title: Configurare le identità gestite in Macchine virtuali di Azure usando REST - Azure ADConfigure managed identities on Azure VMSS using REST - Azure AD
