---
title: Assegnare un accesso di identità gestita a una risorsa usando l'interfaccia della riga di comando di Azure - Azure ADAssign a managed identity access to a resource using Azure CLI - Azure AD
