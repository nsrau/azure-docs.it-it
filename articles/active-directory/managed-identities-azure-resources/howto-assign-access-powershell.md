---
title: Assegnare un accesso di identità gestita a una risorsa usando PowerShell - Azure ADAssign a managed identity access to a resource using PowerShell - Azure AD
