---
title: Come configurare le identità gestite assegnate dall'utente e di sistema in un set di scalabilità di macchine virtuali di Azure tramite l'interfaccia della riga di comando di Azure
