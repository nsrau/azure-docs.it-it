...
1. Nella pagina **Configure single sign-on at HackerOne** (Configura accesso Single Sign-On in HackerOne) seguire questa procedura e quindi fare clic su **Avanti**:
...
4. Passare ad "**Authentication**" (Autenticazione) e fare clic su "**Add SAML settings**" (Aggiungi impostazioni SAML).
