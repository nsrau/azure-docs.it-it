...
6. Per configurare l'accesso Single Sign-On sul lato **Degreed**, è necessario inviare il file **XML metadati** scaricato al [team di supporto di Degreed](mailTo:admin@degreed.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
2. Nell'elenco delle applicazioni selezionare **Degreed**.
    ...
    ![Configure Single Sign-On](./media/active-directory-saas-degreed-tutorial/tutorial_degreed_app.png) 
