...
5. Inviare il file di metadati scaricato al team di supporto di EmpCenter.
   ...
   > [!NOTE]
   > La configurazione effettiva dell'accesso Single Sign-On deve essere eseguita dal team di supporto di EmpCenter. Una volta completata l'abilitazione dell'accesso Single Sign-On per la sottoscrizione, si riceverà una notifica.
   > 
   > 
