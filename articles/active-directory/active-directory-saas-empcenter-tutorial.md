...
6. Per configurare l'accesso Single Sign-On sul lato **EmpCenter**, è necessario inviare il file **XML di metadati** scaricato al [team di supporto di EmpCenter](http://www.workforcesoftware.com/services/customer-support/). Questa impostazione viene configurata in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
