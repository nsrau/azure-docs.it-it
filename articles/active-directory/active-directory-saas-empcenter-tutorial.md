<properties pageTitle="Esercitazione: Integrazione di Azure Active Directory con EmpCenter | Microsoft Azure" description="Informazioni su come usare EmpCenter con Azure Active Directory per abilitare l'accesso Single Sign-On, il provisioning automatizzato e altro ancora." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Esercitazione: Integrazione di Azure Active Directory con EmpCenter
>[AZURE.TIP]Per inviare commenti e suggerimenti, fare clic [qui](http://go.microsoft.com/fwlink/?LinkId=615281).
...
Al termine dell'esercitazione, gli utenti di Azure AD assegnati a EmpCenter potranno accedere all'applicazione tramite il sito aziendale di EmpCenter (accesso avviato dal provider di servizi) o seguendo le istruzioni riportate in [Introduzione al Pannello di accesso](https://msdn.microsoft.com/library/dn308586).
...
1.  Nella pagina di integrazione dell'applicazione **EmpCenter** del portale di Azure AD fare clic su **Configura accesso Single Sign-On** per aprire la finestra di dialogo **Configura accesso Single Sign-On**.
