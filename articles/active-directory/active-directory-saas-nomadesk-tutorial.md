...
* È possibile abilitare gli utenti per l'accesso Single Sign-On automatico a Nomadesk (SSO) con i propri account Azure AD
...
* Sottoscrizione di Nomadesk abilitata per l'accesso Single Sign-On (SSO)
...
## <a name="add-nomadesk-from-the-gallery"></a>Aggiungere Nomadesk dalla raccolta
...
Questa sezione descrive come abilitare l'accesso Single Sign-On di Azure AD nel portale di Azure classico e come configurare l'accesso Single Sign-On nell'applicazione Nomadesk.
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
  ...
  * Nella casella di testo URL di accesso digitare l'URL usato dagli utenti per accedere all'applicazione Nomadesk adottando il modello seguente: **"https://mynomadesk.com/logon/saml/IDTENANT"**. Quando si fa riferimento a un nome generico, **IDTENANT** deve essere sostituito da un ID tenant effettivo.
...
### <a name="create-a-nomadesk-test-user"></a>Creare un utente di test Nomadesk
