...
I controlli e le funzionalità LDAP seguenti devono essere disponibili nel server LDAP per il funzionamento corretto del connettore: `1.3.6.1.4.1.4203.1.5.3` Filtri True/False
...
Se si usa una directory in cui un identificatore univoco è l'ancoraggio, dovrà essere disponibile anche quanto segue. Per altre informazioni, vedere la sezione [Configurare gli ancoraggi](#configure-anchors) più avanti in questo articolo: `1.3.6.1.4.1.4203.1.5.1` Tutti gli attributi operativi
...
**Opzione 1:** `1.2.840.113556.1.4.319` pagedResultsControl

**Opzione 2:** `2.16.840.1.113730.3.4.9` VLVControl `1.2.840.113556.1.4.473` SortControl
