...
- **Amministratore del servizio**: gestisce le richieste di servizio e monitora l'integrità del servizio.
    > [AZURE.NOTE]
    > Per assegnare il ruolo di amministratore del servizio a un utente, l'amministratore globale deve prima assegnare le autorizzazioni amministrative all'utente all'interno del servizio, ad esempio Exchange Online, e quindi assegnare il ruolo di amministratore del servizio nel portale di gestione di Azure.
