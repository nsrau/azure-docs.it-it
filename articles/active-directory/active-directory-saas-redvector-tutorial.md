...
* È possibile abilitare gli utenti per l'accesso Single Sign-On automatico a RedVector (SSO) con i propri account Azure AD
...
* Sottoscrizione di **RedVector** abilitata per l'accesso Single Sign-On (SSO)
...
## <a name="add-redvector-from-the-gallery"></a>Aggiungere RedVector dalla raccolta
...
In questa sezione viene configurato e testato l'accesso SSO di Azure AD con RedVector con un utente test di nome "Britta Simon".

Per il funzionamento dell'accesso SSO, Azure AD deve conoscere qual è l'utente di RedVector che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in RedVector.
...
Questa sezione descrive come abilitare l'accesso Single Sign-On di Azure AD nel portale di Azure classico e come configurare l'accesso Single Sign-On nell'applicazione RedVector.

**Per configurare l'accesso SSO di Azure AD con RedVector, seguire questa procedura:**
...
4. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura: 
 ...
 1. Nella casella di testo URL accesso digitare un URL corrispondente al modello seguente: `https://sso2.redvector.com/adfs/<Companyname>`. Potrebbe essere necessario contattare il supporto di Redvector all'indirizzo <sso@redvector.com> per ottenere i valori corretti per l'ambiente.
 2. Fare clic su **Avanti**.

5. Nella pagina **Configura accesso Single Sign-On in RedVector** fare clic su **Scarica certificato** e quindi salvare il file nel computer. Copiare il valore di URL servizio Single Sign-On. È necessario condividere queste informazioni con il supporto di RedVector per ottenere la configurazione di SSO.
   
    ![Configura accesso Single Sign-On](./media/active-directory-saas-redvector-tutorial/tutorial_redvector_08.png)
6. Per ottenere l'accesso Single Sign-On configurato per l'applicazione, contattare il team di supporto RedVector all'indirizzo <mailto:sso@redvector.com>. Il canale appropriato fornirà l'aiuto richiesto per configurare l'accesso SSO. Nel messaggio di posta elettronica fornire le informazioni seguenti: 
...
### <a name="create-a-redvector-test-user"></a>Creare un utente test RedVector
...
In questa sezione Britta Simon viene abilitata per l'uso dell'accesso SSO di Azure, concedendole così accesso a RedVector.
