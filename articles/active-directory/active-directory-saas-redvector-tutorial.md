...
4. Nella casella di ricerca digitare **RedVector**.

    ![Creazione di un utente test di Azure AD](./media/active-directory-saas-redvector-tutorial/tutorial_redvector_search.png)

5. Nel pannello dei risultati selezionare **RedVector** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
Per stabilire la relazione di collegamento, in RedVector assegnare il valore di **nome utente** in Azure AD come valore dell'attributo **Username** (Nome utente).
...
3. **[Creazione di un utente test RedVector](#creating-a-redvector-test-user)**: per avere una controparte di Britta Simon in RedVector collegata alla rappresentazione dell'utente in Azure AD.
4. **[Assegnazione dell'utente test di Azure AD](#assigning-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Testing Single Sign-On](#testing-single-sign-on)** : per verificare se la configurazione funziona.

### <a name="configuring-azure-ad-single-sign-on"></a>Configurazione dell'accesso Single Sign-On di Azure AD

In questa sezione viene abilitato l'accesso Single Sign-On di Azure AD nel portale di Azure e viene configurato l'accesso Single Sign-On nell'applicazione RedVector.

**Per configurare l'accesso Single Sign-On di Azure AD con RedVector, seguire questa procedura:**

1. Nella pagina di integrazione dell'applicazione **RedVector** del portale di Azure fare clic su **Single Sign-On**.
...
3. Nella sezione **URL e dominio RedVector** seguire questa procedura:

    ![Configure Single Sign-On](./media/active-directory-saas-redvector-tutorial/tutorial_redvector_url.png)

    a. Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://sso2.redvector.com/adfs/<Companyname>`

    b. Nella casella di testo **Identificatore** digitare l'URL adottando il modello seguente: `https://<Companyname>.redvector.com/saml2`

    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con l'identificatore e l'URL di accesso effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di RedVector](mailto:sso@redvector.com). 
...
6. Nella sezione **Configurazione di RedVector** fare clic su **Configura RedVector** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**

    ![Configure Single Sign-On](./media/active-directory-saas-redvector-tutorial/tutorial_redvector_configure.png) 

7. Per configurare l'accesso Single Sign-On sul lato **RedVector**, è necessario inviare il **certificato (Base64)** scaricato e l'**URL del servizio Single Sign-On SAML** al [team di supporto di RedVector](mailto:sso@redvector.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
In questa sezione viene creato un utente chiamato Britta Simon in RedVector. Se non si sa come aggiungere Britta Simon in RedVector, rivolgersi al [team di supporto di RedVector](mailto:sso@redvector.com) per aggiungere l'utente test e abilitare SSO.
