...
* È possibile abilitare gli utenti per l'accesso automatico Single Sign-On (SSO) a 8x8 Virtual Office con i propri account Azure AD
...
* Sottoscrizione di 8x8 Virtual Office abilitata per l'accesso Single Sign-On (SSO)
...
Per il funzionamento dell'accesso SSO, Azure AD deve conoscere qual è l'utente di 8x8 Virtual Office che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in 8x8 Virtual Office.
...
In questa sezione viene abilitato l'accesso SSO di Microsoft Azure AD nel portale di Azure classico e viene configurato l'accesso Single Sign-On nell'applicazione 8x8 Virtual Office.
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura e fare clic su **Avanti**:
  ...
  1. Nella casella di testo **URL di risposta** digitare: `https://sso.8x8.com/saml2`
...
12. Fare clic sul pulsante **Browser** per caricare il certificato scaricato da Azure AD e sul pulsante **Salva**.
...
### <a name="create-a-8x8-virtual-office-test-user"></a>Creare un utente test per 8x8 Virtual Office
...
Questa sezione descrive come abilitare Britta Simon all'uso dell'accesso SSO di Azure concedendole l'accesso a 8x8 Virtual Office.
