---
title: Gestire l'accesso guest con le verifiche di accesso - Azure ADManage guest access with access reviews - Azure AD
...
> [!NOTE]
> Questo documento è incentrato sulla verifica dell'accesso degli utenti guest. Se si vuole controllare l'accesso di tutti gli utenti, non solo dei guest, vedere l'argomento su come [gestire l'accesso utente con le verifiche di accesso](manage-user-access-with-access-reviews.md). Se si desidera verificare l'appartenenza degli utenti a ruoli amministrativi, ad esempio amministratore globale, vedere Avviare una verifica di [accesso in Gestione delle identità con privilegi](../privileged-identity-management/pim-how-to-start-security-review.md)di Azure AD .

## <a name="prerequisites"></a>Prerequisiti

- Azure AD Premium P2

Per ulteriori informazioni, [requisiti di licenza](access-reviews-overview.md#license-requirements).

## <a name="create-and-perform-an-access-review-for-guests"></a>Creare ed eseguire una verifica di accesso per i guest

In primo luogo, in qualità di amministratore globale o amministratore utente, passare alla [pagina Governance identità](https://portal.azure.com/#blade/Microsoft_AAD_ERM/DashboardBlade/) per assicurarsi che le verifiche di accesso siano pronte per l'organizzazione.
...
1. Per creare una verifica di accesso per il gruppo, selezionare la revisione per includere solo i membri degli utenti guest e che i membri rivedano se stessi. Per ulteriori informazioni, consultate [Creare una verifica di accesso di gruppi o applicazioni.](create-access-review.md)

2. Chiedere a ogni guest di verificare la propria appartenenza. Per impostazione predefinita, ogni guest che ha accettato un invito riceverà un messaggio di posta elettronica da Azure AD con un collegamento alla verifica di accesso. Azure AD include istruzioni per gli ospiti su come [esaminare l'accesso a gruppi o applicazioni.](perform-access-review.md)

3. Dopo che i revisori avranno espresso il proprio giudizio, interrompere la verifica di accesso e applicare le modifiche. Per ulteriori informazioni, consultate [Completare una verifica di accesso di gruppi o applicazioni.](complete-access-review.md)
...
1. Per creare una verifica di accesso per il gruppo, selezionare la revisione per includere solo i membri degli utenti guest. Specificare quindi uno o più revisori. Per ulteriori informazioni, consultate [Creare una verifica di accesso di gruppi o applicazioni.](create-access-review.md)

2. Chiedere ai revisori di esprimere il proprio giudizio. Per impostazione predefinita, ognuno di essi riceve un messaggio di posta elettronica da Azure AD con un collegamento al pannello di accesso, in cui [esamina l'accesso a gruppi o applicazioni.](perform-access-review.md)
...
1. Per creare una verifica di accesso per l'applicazione, selezionare la recensione per includere solo gli ospiti e che gli utenti esaminino il proprio accesso. Per ulteriori informazioni, consultate [Creare una verifica di accesso di gruppi o applicazioni.](create-access-review.md)
...
1. Per creare una verifica di accesso per l'applicazione, selezionare la recensione per includere solo gli ospiti. Specificare quindi uno o più utenti come revisori. Per ulteriori informazioni, consultate [Creare una verifica di accesso di gruppi o applicazioni.](create-access-review.md)
...
2. Per creare una verifica di accesso per il gruppo, selezionare i revisori come membri stessi. Per ulteriori informazioni, consultate [Creare una verifica di accesso di gruppi o applicazioni.](create-access-review.md)

3. Chiedere a ogni guest di verificare la propria appartenenza. Per impostazione predefinita, ogni guest che ha accettato un invito riceverà un messaggio di posta elettronica da Azure AD con un collegamento alla verifica di accesso nel pannello di accesso dell'organizzazione. Azure AD include istruzioni per gli ospiti su come [esaminare l'accesso a gruppi o applicazioni.](perform-access-review.md)  I guest che non hanno accettato l'invito verranno visualizzati nei risultati della verifica come "Senza notifica".

4. Dopo che i revisori avranno espresso il proprio giudizio, interrompere la verifica di accesso. Per ulteriori informazioni, consultate [Completare una verifica di accesso di gruppi o applicazioni.](complete-access-review.md)
