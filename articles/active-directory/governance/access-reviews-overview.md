...
| --- | --- | --- |
| Un amministratore crea una verifica di accesso del gruppo A con 500 utenti.<br/>Assegna 3 proprietari del gruppo come revisori. | 1 amministratore + 3 proprietari del gruppo | 4 |
| Un amministratore crea una verifica di accesso del gruppo A con 500 utenti.<br/>Consente di riesaminare autonomamente. | 1 amministratore + 500 utenti come revisori | 501 |
| Un amministratore crea una verifica di accesso del gruppo A con 5 utenti e 25 utenti guest.<br/>Consente di riesaminare autonomamente. | 1 amministratore + 5 utenti come revisori<br/>(gli utenti Guest sono coperti dal rapporto 1:5 richiesto) | 6 |
| Un amministratore crea una verifica di accesso del gruppo A con 5 utenti e 28 utenti guest.<br/>Consente di riesaminare autonomamente. | 1 amministratore + 5 utenti come revisori autonomi + 1 utente per coprire gli utenti guest nel rapporto 1:5 richiesto | 7 |
