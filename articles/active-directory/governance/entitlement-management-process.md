...
| Scaduto | Se non gli approvatori approvare una richiesta entro il timeout della richiesta di approvazione, la richiesta scade. Per riprovare, l'utente dovrà eseguire nuovamente la richiesta. |
| Negato | Responsabile approvazione rifiuta una richiesta. |
...
### <a name="access-request-emails"></a>Messaggi di richiesta di accesso
...
I richiedenti ricevono una notifica quando la richiesta di accesso è approvata e disponibili per l'accesso o quando la richiesta di accesso è negata. Quando un responsabile approvazione riceve una richiesta di accesso presentata da un richiedente, essi possono approvare o rifiutare la richiesta di accesso. Il responsabile approvazione deve aggiungere una motivazione aziendale per la propria decisione.
