...
![Attività principali per PIM - Screenshot](./media/pim-getting-started/PIM_Tasks_New.png)
...
- **Approva richieste (anteprima)** visualizza un elenco di richieste per l'attivazione di ruoli idonei della directory Azure AD da parte degli utenti della directory, che l'utente ha designato all'approvazione. [Altre informazioni.](./azure-ad-pim-approval-workflow.md)
...
La [panoramica di Azure AD Privileged Identity Management](pim-configure.md) include altri dettagli su come gestire l'accesso amministrativo nell'organizzazione.
