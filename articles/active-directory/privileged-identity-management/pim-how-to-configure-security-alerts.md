...
![Schermata Avvisi di sicurezza del dashboard di PIM](./media/pim-how-to-configure-security-alerts/PIM_security_dash.png)
...
2. Selezionare **Managed privileged roles (Ruoli con privilegi gestiti)** > **Impostazioni** > **Impostazioni degli avvisi**.
    ...
    ![Passare a impostazioni degli avvisi di sicurezza](./media/pim-how-to-configure-security-alerts/PIM_security_settings.png)
