...
1. In Gestisci, fare clic su **verifiche di accesso**.
    ...
    ![Le risorse di Azure - elenco che mostra lo stato di tutte le verifiche di verifiche di accesso](./media/pim-resource-roles-start-access-review/access-reviews.png)
...
![Elenco che mostra lo stato della revisione introduttiva delle verifiche di accesso](./media/pim-resource-roles-start-access-review/access-reviews-list.png)
...
![Pagina di panoramica che mostra i dettagli della verifica delle verifiche di accesso](./media/pim-resource-roles-start-access-review/access-review-overview.png)
