---
title: Estendere o rinnovare le assegnazioni di ruolo delle risorse di Azure in PIM-Azure Active Directory | Microsoft Docs
...
Passare alla pagina **richieste in sospeso** nel riquadro a sinistra per visualizzare lo stato della richiesta o per annullarla.
...
![Risorse di Azure-pagina membri che elenca i ruoli idonei con collegamenti da estendere](media/pim-resource-roles-renew-extend/aadpim-rbac-extend-admin-extend.png)
