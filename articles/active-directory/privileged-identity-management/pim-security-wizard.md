...
> [!Important]
> La procedura guidata di sicurezza è temporaneamente non disponibile. Grazie per la pazienza dimostrata.
...
> [!WARNING]
> È importante avere almeno un amministratore globale e più di un amministratore del ruolo con privilegi con un account aziendale o dell'Istituto di istruzione (non un account Microsoft). Se è presente un solo amministratore del ruolo con privilegi, l'organizzazione non può gestire Privileged Identity Management se tale account viene eliminato.
