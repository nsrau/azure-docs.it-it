...
## Richiesta di consenso per un intero tenant
...
## Ambiti riservati all'amministratore
...
| redirect\_uri | Obbligatoria | URI di reindirizzamento in cui si desidera che venga inviata la risposta per la gestione da parte dell'app. Deve corrispondere esattamente a uno degli URI di reindirizzamento registrati nel portale. |
