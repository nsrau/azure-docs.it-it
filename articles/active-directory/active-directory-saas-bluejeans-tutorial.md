...
* Sottoscrizione di BlueJeans abilitata per l'accesso Single Sign-On (SSO)
...
## <a name="enable-the-application-integration-for-bluejeans"></a>Abilitare l'integrazione dell'applicazione per BlueJeans
