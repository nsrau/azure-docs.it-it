...
4. Nella casella di ricerca digitare **Atomic Learning**.
...
5. Nel pannello dei risultati selezionare **Atomic Learning** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
3. Nella sezione **URL e dominio Atomic Learning** eseguire i passaggi descritti di seguito:
