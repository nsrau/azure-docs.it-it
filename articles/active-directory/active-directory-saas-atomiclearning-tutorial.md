...
3. **[Creazione di un utente test di Atomic Learning](#creating-an-atomic-learning-test-user)**: per avere una controparte di Britta Simon in Atomic Learning collegata alla relativa rappresentazione in Azure AD.
