...
3.  Nella pagina **Configura URL app** nella casella di testo **Clever Sign On URL** (URL di accesso a Clever) digitare l'URL usato dagli utenti per accedere all'applicazione Clever (ad esempio: *https://clever.com/in/azsandbox*) e fare clic su **Avanti**.
