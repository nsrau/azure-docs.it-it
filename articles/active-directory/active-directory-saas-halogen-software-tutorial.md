...
8. Nella pagina **SAML Configuration** seguire questa procedura: ![Cos'è Azure AD Connect][14]
    ...
    b. Come **Unique Identifier Maps To** selezionare **Username**.

    c. Per caricare il file di metadati fare clic su **Browse** per selezionare il file e quindi fare clic su **Upload File**.
