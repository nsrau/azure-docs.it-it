...
8. Nella pagina **Configurazione SAML** seguire la procedura seguente:  ![Cos'è Azure AD Connect][14]
    ...
    > [AZURE.NOTE] È necessario attendere la visualizzazione del messaggio"*The SAML test is complete. Please close this window*". chiudere quindi la ginestra del browser aperta. La casella di controllo **Enable SAML** (Abilita SAML) è selezionata solo se il test è stato completato.
