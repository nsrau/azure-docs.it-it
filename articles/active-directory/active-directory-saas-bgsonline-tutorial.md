...
4. Nella casella di ricerca digitare **BGS Online**.

    ![Creazione di un utente test di Azure AD](./media/active-directory-saas-bgsonline-tutorial/tutorial_bgsonline_search.png)

5. Nel pannello dei risultati selezionare **BGS Online** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
3. **[Creazione di un utente di test di BGS Online](#creating-a-bgs-online-test-user)**: per avere una controparte di Britta Simon in BGS Online collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **URL e dominio BGS Online** seguire questa procedura:
...
6. Nella sezione **Configurazione di BGS Online** fare clic su **Configura BGS Online** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**

    ![Configure Single Sign-On](./media/active-directory-saas-bgsonline-tutorial/tutorial_bgsonline_configure.png) 

7. Per configurare l'accesso Single Sign-On sul lato **BGS Online**, è necessario inviare il file **XML metadati** scaricato e il valore dell'**URL del servizio Single Sign-On SAML** al [team di supporto di BGS Online](mailto:bgsdashboardteam@millwardbrown.com). 
