...
Azure Active Directory Identity Protection analizza la configurazione e rileva le vulnerabilità che possono avere effetto sulle identità dell'utente. Per altri dettagli, vedere [Vulnerabilità rilevate da Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md).
...
È possibile collegare le attività di analisi alle [notifiche](identity-protection/notifications.md) che Azure Active Directory Protection invia per posta elettronica.
...
* [Ripristino di un accesso rischioso](identity-protection/flows.md#risky-sign-in-recovery)
* [Accesso rischioso bloccato](identity-protection/flows.md#risky-sign-in-blocked)  
* [Esperienze di accesso con Azure AD Identity Protection](identity-protection/flows.md)  
...
* [Flusso di ripristino di account compromessi](identity-protection/flows.md#compromised-account-recovery).  
* [Flusso di account compromessi bloccati](identity-protection/flows.md#compromised-account-blocked).  
...
* [Flusso di registrazione per l'autenticazione a più fattori](identity-protection/flows.md#multi-factor-authentication-registration).  
* [Esperienze di accesso con Azure AD Identity Protection](identity-protection/flows.md).  
...
* [Vulnerabilità rilevate da Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md)

* [Eventi di rischio di Azure Active Directory](active-directory-identity-protection-risk-events.md)

* [Notifiche di Azure Active Directory Identity Protection](identity-protection/notifications.md)

* [Studio di Azure Active Directory Identity Protection](identity-protection/playbook.md)

* [Glossario di Azure Active Directory Identity Protection](identity-protection/glossary.md)

* [Esperienze di accesso con Azure AD Identity Protection](identity-protection/flows.md)

* [Azure Active Directory Identity Protection: come sbloccare gli utenti](identity-protection/howto-unblock-user.md)

* [Introduzione ad Azure Active Directory Identity Protection e a Microsoft Graph](identity-protection/graph-get-started.md)
