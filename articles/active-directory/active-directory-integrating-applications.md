...
Per concedere l'accesso mediante il framework di consenso, l'applicazione client deve richiedere l'autorizzazione con OAuth 2.0. [Esempi di codice](https://github.com/AzureADSamples) sono disponibili per indicare in che modo un'applicazione Web, un'applicazione nativa o un'applicazione server/daemon richiede i codici di autorizzazione e i token di accesso per chiamare le API Web.
...
Parametri aggiuntivi verranno restituiti all'app se sono stati specificati come parte dell'URL codificato ConsentReturnUrl. Di seguito viene illustrata una risposta di esempio a una richiesta di concessione dell'accesso che indica che l'applicazione è stata autorizzata e che include un ContextID fornito nella richiesta: `https://adatum.com/ExpenseReport.aspx?ContextID=123456&Consent=Granted&TenantId=f03dcba3-d693-47ad-9983-011650e64134`.
