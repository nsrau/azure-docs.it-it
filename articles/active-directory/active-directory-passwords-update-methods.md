<properties
	pageTitle="Procedura: Metodi di reimpostazione della password di Azure AD | Microsoft Azure"
...
* [**Mantenere l'accesso all'account**](active-directory-passwords-update-your-own-password.md)
