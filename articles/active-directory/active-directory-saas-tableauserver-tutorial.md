...
1. Per configurare l'accesso SSO sull'applicazione, è necessario accedere al tenant di Tableau Server come amministratore.
    ...
    > [AZURE.NOTE] Per assistenza nella configurazione SAML in Tableau Server, fare riferimento a questo articolo: [Configure SAML](http://onlinehelp.tableau.com/current/server/en-us/config_saml.htm) (Configurazione di SAML) 
