...
![Pannello Applicazioni aziendali](./media/configure-single-sign-on-portal/enterprise-apps-blade.png)
...
![Pannello Risorsa applicazione](./media/configure-single-sign-on-portal/enterprise-apps-sso-blade.png)
...
Per altre informazioni su queste modalità, vedere [Come funziona Single Sign-On con Azure Active Directory (PHP)?](what-is-single-sign-on.md#how-does-single-sign-on-with-azure-active-directory-work).
...
![Linked sign-on (Accesso collegato)](./media/configure-single-sign-on-portal/enterprise-apps-blade-linked-sso.png)
