...
|Elemento di configurazione|Descrizione|ADFS|Azure AD|
|---|---|---|---|
...
#### <a name="example-support-for-multiple-idps"></a>Esempio: Supporto per più IdP
