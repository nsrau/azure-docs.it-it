...
description: Come risolvere i problemi relativi a un'applicazione raccolta Azure AD configurata per la Single Sign-On delle password.
documentationcenter: ''
author: kenwith
manager: celestedg
ms.assetid: ''
...
Per usare la Single Sign-On basata su password (SSO) nel pannello di accesso, è necessario installare l'estensione del pannello di accesso nel browser. L'estensione viene scaricata automaticamente quando si seleziona un'app configurata per l'accesso SSO basato su password.
