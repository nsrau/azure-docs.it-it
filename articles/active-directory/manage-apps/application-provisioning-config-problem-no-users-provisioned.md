...
[Servizio di sincronizzazione Azure AD Connect: informazioni sul provisioning dichiarativo](../connect/active-directory-aadconnectsync-understanding-declarative-provisioning.md)
