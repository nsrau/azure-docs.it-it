...
| [Ottenere tutte le app dell'applicazione proxy Azure AD pubblicate senza certificato caricato](scripts/powershell-get-all-custom-domain-no-cert.md) | Elenca tutte le app proxy di applicazione che usano domini personalizzati ma che non dispongono di un certificato TLS/SSL valido caricato. |
