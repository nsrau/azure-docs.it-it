---
title: Accesso collegato per le app di Azure AD - Piattaforma di identità Microsoft
description: Configurare l'accesso Single Sign-On (SSO) collegato alle applicazioni aziendali di Azure AD nella piattaforma di identità Microsoft (Azure AD)Configure linked single sign-on (SSO) to your Azure AD enterprise applications in Microsoft identity platform (Azure AD)
...
### <a name="open-the-app-and-select-linked-sign-on"></a>Aprire l'app e selezionare l'accesso collegato
...
1. Passare ad **Applicazioni Azure Active Directory** > **Enterprise**. Viene visualizzato un esempio casuale delle applicazioni del tenant di Azure AD. 
...
1. È possibile assegnare utenti e gruppi all'applicazione, in modo che l'applicazione venga visualizzata nell'icona di avvio delle app di [Office 365](https://blogs.office.com/2014/10/16/organize-office-365-new-app-launcher-2/) o nel pannello di accesso di [Azure AD](end-user-experiences.md) per tali utenti.
