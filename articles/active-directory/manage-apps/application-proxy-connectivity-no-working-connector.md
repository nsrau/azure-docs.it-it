---
title: Nessun gruppo di connettori di lavoro trovato per un'app proxy di applicazione
...
-   Se il gruppo non contiene connettori, è possibile:
    ...
    -   Scaricare un nuovo connettore sul server locale e assegnarlo a questo gruppo
