...
In questo argomento di avvio rapido si usa il portale di Azure per eliminare un'applicazione che è stata aggiunta al tenant di Azure AD.
...
1. Nel portale di Azure AD selezionare **Applicazioni aziendali** e quindi trovare e selezionare l'applicazione da eliminare. In questo caso è stata l'applicazione GitHub_test aggiunta nell'argomento di avvio rapido precedente.
2. Nella sezione Gestisci del riquadro di spostamento selezionare **Proprietà**.
3. Selezionare Elimina e quindi fare clic su Sì per confermare che si vuole eliminare l'app dal tenant di Azure AD.
