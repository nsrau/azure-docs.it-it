---
title: Come aprire le porte del firewall necessarie per un'app proxy di applicazione
...
-   Assicurarsi che qualsiasi proxy o firewall applicabile per il connettore venga applicato anche a questa pagina. Questo può essere fatto in Internet Explorer andando a **Impostazioni**  - &gt; **Internet Options**  - &gt; **Connections**  - &gt; **LAN Impostazioni**. In questa pagina viene visualizzato il campo "Usa un server di proxy per la rete LAN". Selezionare questa casella e inserire l'indirizzo del proxy nel campo "Indirizzo".
