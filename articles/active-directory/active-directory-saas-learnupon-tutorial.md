...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
    ...
    a. Nella casella di testo **URL di risposta** digitare l'URL del servizio consumer di asserzione usando il modello seguente: `https://\<companyname\>.learnupon.com/saml/consumer`

    b. Fare clic su **Avanti**. 


1. Nella pagina **Configura accesso Single Sign-On in LearnUpon** seguire questa procedura:
    ...
    b. Fare clic su **Avanti**.
2. Aprire un'altra istanza del browser e accedere a LearnUpon con un account amministratore. 
...
4. Fare clic su **Single Sign On - SAML** e quindi fare clic su **General Settings** (Impostazioni generali) per configurare le impostazioni SAML.
...
5. Nella sezione **General Settings** (Impostazioni generali), seguire questa procedura:
    ...
    g. Nel portale di Azure classico copiare il valore di **URL servizio Single Sign-Out** e quindi incollarlo nella casella di testo **Sign out URL** (URL di disconnessione).
...
6. Fare clic su **User Settings**(Impostazioni utente), e seguire questa procedura:
    ...
    b. Nella casella di testo **Last Name Identifier Format** (Formato identificatore cognome) digitare il valore che indica la posizione del nome degli utenti dell'asserzione SAML, ad esempio **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/    surname**.
