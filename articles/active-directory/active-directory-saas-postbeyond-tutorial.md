...
3. **[Creazione di un utente test di PostBeyond](#creating-a-PostBeyond-test-user)**: per avere una controparte di Britta Simon in PostBeyond collegata alla relativa rappresentazione in Azure AD.
