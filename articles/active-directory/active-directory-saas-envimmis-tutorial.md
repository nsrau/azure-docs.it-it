...
4. Nella casella di ricerca digitare **Envi MMIS**, selezionare **Envi MMIS** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![Envi MMIS nell'elenco risultati](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_addfromgallery.png)
...
3. **[Creare un utente test di Envi MMIS](#create-an-envi-mmis-test-user)**: per avere una controparte di Britta Simon in Envi MMIS collegata alla rappresentazione dell'utente in Azure AD.
...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_samlbase.png)

3. Nella sezione **URL e dominio Envi MMIS** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:

    ![Informazioni sull'accesso Single Sign-On per URL e dominio di Envi MMIS](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_url.png)
...
4. Selezionare **Mostra impostazioni URL avanzate** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni sull'accesso Single Sign-On per URL e dominio di Envi MMIS](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_url1.png)
...
5. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_certificate.png) 

6. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/active-directory-saas-envimmis-tutorial/tutorial_general_400.png)

7. In un'altra finestra del Web browser accedere al sito aziendale di Envi MMIS come amministratore.

8. Fare clic sulla scheda **My Domain** (Dominio personale).

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/active-directory-saas-envimmis-tutorial/configure1.png)

9. Fare clic su **Modifica**.

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/active-directory-saas-envimmis-tutorial/configure2.png)

10. Selezionare la casella di controllo **Use remote authentication** (Usa autenticazione remota) e quindi selezionare **HTTP Redirect** (Reindirizzamento HTTP) dall'elenco a discesa **Authentication Type** (Tipo di autenticazione).

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/active-directory-saas-envimmis-tutorial/configure3.png)

11. Selezionare la scheda **Resources** (Risorse) e quindi fare clic su **Upload Metadata** (Carica metadati).

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/active-directory-saas-envimmis-tutorial/configure4.png)

12. Nel popup **Upload Metadata** (Carica metadati) seguire questa procedura:

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/active-directory-saas-envimmis-tutorial/configure5.png)
...
13. Dopo avere caricato il file di metadati scaricato, i campi verranno popolati automaticamente. Fare clic su **Update** (Aggiorna).

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/active-directory-saas-envimmis-tutorial/configure6.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/active-directory-saas-envimmis-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/active-directory-saas-envimmis-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/active-directory-saas-envimmis-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/active-directory-saas-envimmis-tutorial/create_aaduser_04.png)
...
2. Fare clic sulla scheda **User Access** (Accesso utente).
    ...
    ![Aggiungere un dipendente](./media/active-directory-saas-envimmis-tutorial/user1.png)

3. Fare clic sul pulsante **Add User** (Aggiungi utente).

    ![Aggiungere un dipendente](./media/active-directory-saas-envimmis-tutorial/user2.png)

4. Nella sezione **Add User** seguire questa procedura:

    ![Aggiungere un dipendente](./media/active-directory-saas-envimmis-tutorial/user3.png)
...
2. Nell'elenco delle applicazioni selezionare **Envi MMIS**.
    ...
    ![Collegamento di Envi MMIS nell'elenco delle applicazioni](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_app.png)  
