...
3. Nella pagina **Configura URL app** seguire questa procedura e quindi fare clic su **Avanti**.
   ...
   > [!NOTE]
   > L'URL di risposta deve disporre di un sottodominio (ad esempio: www, wd2, wd3, wd3-impl, wd5, wd5-impl). Un URL simile a "*http://www.myworkday.com*" funziona; un URL simile a "*http://myworkday.com*" non funziona.
   > 
   > 
