...
3. Nella pagina della finestra di dialogo **Configurare le impostazioni dell'app**, se si desidera configurare l'applicazione in **modalità iniziata da IDP**,seguire la procedura seguente:
...
1. Nella pagina della finestra di dialogo **Configurare le impostazioni dell'app**, se si desidera configurare l'applicazione in **modalità iniziata da SP**, seguire la procedura seguente:
...
1. Nella pagina **Configura accesso Single Sign-On in BetterWorks** seguire la procedura seguente e fare clic su **Avanti**:
