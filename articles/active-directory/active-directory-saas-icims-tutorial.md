...
3. **[Creare un utente test di ICIMS](#create-an-icims-test-user)**: per avere una controparte di Britta Simon in ICIMS collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **URL e dominio ICIMS** seguire questa procedura:
