...
|[Eseguire il backup e il ripristino delle credenziali dell'account con l'app Microsoft Authenticator](microsoft-authenticator-app-backup-and-recovery.md)| Offre informazioni su come eseguire il backup e il ripristino 
|[Accedere con il telefono, non con la password](microsoft-authenticator-app-phone-signin-faq.md)|Offre risposte a domande frequenti relative all'accesso telefonico.|
