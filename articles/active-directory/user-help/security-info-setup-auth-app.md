...
Per scaricare l'app Microsoft Authenticator e ottenere altre informazioni, vedere [Introduzione all'app Microsoft Authenticator](user-help-auth-app-download-install.md).
