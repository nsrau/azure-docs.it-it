---
title: Organizzare le app usando le aree di lavoro del portale App personali (anteprima) - Azure Active Directory | Microsoft Docs
description: Informazioni su come accedere e usare le aree di lavoro per le app basate sul cloud dell'organizzazione nel portale App personali (anteprima).
...
ms.locfileid: "76705038"
---
# <a name="access-and-use-workspaces-on-the-my-apps-preview-portal"></a>Accedere e usare le aree di lavoro nel portale App personali (anteprima)
...
## <a name="access-apps-using-workspaces"></a>Accedere alle app usando le aree di lavoro
...
![Area di lavoro individuale e set di app con ambito nel portale App personali](media/my-applications-portal-workspaces/my-apps-workspace.png)
