...
1. Accedere all'account aziendale o dell'istituto di istruzione normalmente. 
    ...
    ![Casella per l'approvazione dell'accesso](media/microsoft-authenticator-app-phone-signin-faq/microsoft-auth-app-sign-in.png)
...
3. Toccare lo stesso numero visualizzato nella schermata **Approvare l'accesso?**. Usare il PIN del telefono o la chiave biometrica per completare l'autenticazione.
    ...
    ![Casella per l'approvazione dell'accesso con il numero da selezionare](media/microsoft-authenticator-app-phone-signin-faq/microsoft-auth-app-sign-in-numbers.png)
