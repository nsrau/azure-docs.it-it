...
1. Sul computer, annotarsi il **Codice** e le informazioni dell'**Url** sulla pagina **Configura app per dispositivi mobili**. Tenere aperta questa pagina per visualizzare il codice e l'URL.
    ...
    ![Schermata contenente il codice a matrice](./media/microsoft-authenticator-app-add-account-manual/auth-app-barcode.png)
...
3. Selezionare **O IMMETTERE IL CODICE MANUALMENTE**.
    ...
    ![Schermata per la scansione di un codice a matrice](./media/microsoft-authenticator-app-add-account-manual/auth-app-manual-code.png)
   
4. Immettere il **Codice** e l'**URL** del passaggio 1, quindi selezionare **Fine**.

    ![Schermata per l'immissione del codice e dell'URL](./media/microsoft-authenticator-app-add-account-manual/auth-app-code-url.png)
...
6. Nella pagina Quasi terminato, decidere se rendere il PC un dispositivo attendibile e quindi selezionare **Ho capito. Attivare la verifica in due passaggi**.
...
- Dopo aver aggiunto gli account all'app, è possibile accedere usando l'app Microsoft Authenticator nel dispositivo. Per altre informazioni, consultare [Accedere con l'app](microsoft-authenticator-app-phone-signin-faq.md).
