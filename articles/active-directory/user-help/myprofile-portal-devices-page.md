...
- Dopo aver visualizzato i dispositivi connessi, è possibile scegliere di visualizzare o gestire le [informazioni di sicurezza](user-help-security-info-overview.md), le [organizzazioni](myprofile-portal-organizations-page.md)o visualizzare il modo in cui l'organizzazione [Usa i dati](myprofile-portal-privacy-page.md).
