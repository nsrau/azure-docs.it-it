---
title: Aggiungere l'account non Microsoft personale all'app Microsoft Authenticator - Azure Active Directory | Microsoft Docs
description: Come aggiungere gli account non Microsoft personali, ad esempio per Google, Facebook o GitHub, all'app Microsoft Authenticator per la verifica a due fattori.
...
ms.locfileid: "55459146"
---
# <a name="add-your-personal-non-microsoft-accounts"></a>Aggiungere gli account non Microsoft personali
Aggiungere gli account non Microsoft personali, ad esempio per Google, Facebook o GitHub, all'app Microsoft Authenticator per la verifica a due fattori.
...
2. Aggiungere l'account all'app Microsoft Authenticator.
