...
La relazione di collegamento viene stabilita assegnando il valore di **nome utente** in Azure AD come valore di **Username** in Alcumus Info Exchange.
...
3. **[Creazione di un utente test di Alcumus Info Exchange](#creating-a-alcumus-info-exchange-test-user)** : per avere una controparte di Britta Simon in Alcumus Info Exchange collegata alla relativa rappresentazione in Azure AD.
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura: 
   ...
   > [!NOTE]
   > Se non si conosce il valore corretto, contattare il team di supporto di Alcumus Info Exchange tramite [helpdesk@alcumusgroup.com](mailto:helpdesk@alcumusgroup.com).
   > 
   > 
...
2. Nella pagina **Ottieni password temporanea** seguire questa procedura:
