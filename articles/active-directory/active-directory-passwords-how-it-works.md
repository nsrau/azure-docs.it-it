---
title: Funzionamento della gestione delle password di Azure AD | Documentazione Microsoft
...
Passando alla scheda **Report** e cercando nella sezione **Log attività** vengono visualizzati due report di gestione delle password: **Attività di reimpostazione password** e **Attività di registrazione reimpostazione password**.  Usando questi due report, è possibile ottenere una visualizzazione degli utenti registrati per la reimpostazione della password o che usano questo servizio nell'organizzazione. Ecco come appaiono i report nel [portale di gestione di Azure](https://manage.windowsazure.com):
