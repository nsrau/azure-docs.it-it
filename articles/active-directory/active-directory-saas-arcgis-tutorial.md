...
* Sottoscrizione ArcGIS abilitata per l'accesso Single Sign-On (SSO)
...
## <a name="enable-the-application-integration-for-arcgis"></a>Abilitare l'integrazione dell'applicazione per ArcGIS
