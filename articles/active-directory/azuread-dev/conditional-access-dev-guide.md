...
Si presuppone la conoscenza delle app [Single e multi-tenant](../develop/howto-convert-app-to-be-multi-tenant.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json) e dei [modelli di autenticazione comuni](v1-authentication-scenarios.md) .
