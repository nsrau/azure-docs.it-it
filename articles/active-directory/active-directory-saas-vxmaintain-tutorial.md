...
* È possibile abilitare gli utenti per l'accesso Single Sign-On automatico a vxMaintain (SSO) con i propri account Azure AD
...
* Sottoscrizione di vxMaintain abilitata per l'accesso Single Sign-On (SSO)
...
In questa sezione viene configurato e testato l'accesso SSO di Azure AD con vxMaintain in base a un utente test di nome "Britta Simon".

Per il funzionamento dell'accesso SSO, Azure AD deve conoscere qual è l'utente di vxMaintain che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in vxMaintain.
...
In questa sezione viene abilitato l'accesso SSO di Azure AD nel portale di Azure classico e viene configurato l'accesso SSO nell'applicazione vxMaintain.
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
  ...
  1. Nella casella di testo **Identificatore** digitare l'URL adottando il modello seguente: **https://\<nome azienda\>.verisae.com**
  2. Nella casella di testo **URL di risposta** digitare l'URL adottando il modello seguente: **https://\<nome azienda\>.verisae.com/DataNett/action/ssoConsume/mobile?_log=true** 
  3. click **Avanti**
...
5. Nella pagina **Informazioni sull'utente** seguire questa procedura:
 ...
 ![Creazione di un utente test di Azure AD](./media/active-directory-saas-vxmaintain-tutorial/create_aaduser_05.png) 
  1. In Tipo di utente selezionare Nuovo utente nell'organizzazione.
  2. Nella casella di testo **Nome utente** digitare **BrittaSimon**.
  3. Fare clic su **Avanti**.
6. Nella pagina **Profilo utente** seguire questa procedura:

 ![Creazione di un utente test di Azure AD](./media/active-directory-saas-vxmaintain-tutorial/create_aaduser_06.png)   
...
### <a name="create-an-vxmaintain-test-user"></a>Creare un utente test vxMaintain
...
In questa sezione Britta Simon viene abilitata per l'uso dell'accesso SSO di Azure, concedendole così accesso a vxMaintain.
