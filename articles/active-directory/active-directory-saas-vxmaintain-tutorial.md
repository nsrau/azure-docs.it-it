...
---
# Esercitazione: Integrazione di Azure Active Directory con vxMaintain
...
La relazione di collegamento viene stabilita assegnando al valore del **nome utente** in Azure AD lo stesso valore di **Username** in vxMaintain.
...
### Creazione di un utente test vxMaintain
