...
4. Selezionare la casella di controllo per fare in modo che tutti gli amministratori del tenant globali ricevano notifiche di posta elettronica.
5. Se si desidera ricevere notifiche di posta elettronica ad altri indirizzi di posta elettronica, è possibile specificarli nelle caselle Destinatari di posta elettronica aggiuntivi. Per rimuovere un indirizzo di posta elettronica da questo elenco, fare clic con il pulsante destro del mouse sulla voce e scegliere Elimina.
