...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
    ...
    a. Nella casella di testo URL di accesso digitare l'URL utilizzato dagli utenti per accedere all'applicazione Yardi eLearning adottando il modello seguente: **"https://\<nome società\>.yardielearning.com/login"**.

    b. Fare clic su **Avanti**.


1. Nella pagina **Configura accesso Single Sign-On in Yardi eLearning** seguire questa procedura:
    ...
    b. Fare clic su **Avanti**.
2. Per ottenere la configurazione dell'accesso SSO per l'applicazione, contattare il team di supporto di Yardi eLearning all'indirizzo [elearning@yardi.com](mailto:elearning@yardi.com) allegando al messaggio di posta elettronica il file di metadati scaricato.
