...
* È possibile abilitare gli utenti per l'accesso Single Sign-On (SSO) automatico a Yardi eLearning con i propri account Azure AD
...
* Sottoscrizione di Yardi eLearning abilitata per l'accesso Single Sign-On (SSO)
...
## <a name="add-yardi-elearning-from-the-gallery"></a>Aggiungere Yardi eLearning dalla raccolta
...
Questa sezione descrive come configurare e testare l'accesso SSO di Azure AD con Yardi eLearning con un utente test di nome "Britta Simon".

Per il funzionamento dell'accesso SSO, Azure AD deve conoscere qual è l'utente di Yardi eLearning che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Yardi eLearning.
...
Per configurare e testare l'accesso SSO di Azure AD con Yardi eLearning, è necessario completare i blocchi predefiniti seguenti:

1. **[Configurazione dell'accesso Single Sign-On di Azure AD](#configuring-azure-ad-single-single-sign-on)**: per abilitare gli utenti all'uso di questa funzionalità.
2. **[Creazione di un utente test di Azure AD](#creating-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
3. **[Creazione di un utente test di Yardi eLearning](#creating-a-yardi-elearning-test-user)** per avere una controparte di Britta Simon in Yardi eLearning collegata alla relativa rappresentazione in Azure AD.
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
  ...
  1. Nella casella di testo URL di accesso digitare l'URL utilizzato dagli utenti per accedere all'applicazione Yardi eLearning adottando il modello seguente: **"https://\<nome società\>.yardielearning.com/login"**.
...
### <a name="create-a-yardi-elearning-test-user"></a>Creare un utente test di Yardi eLearning
...
>[!NOTE]
>Per creare un utente manualmente, è necessario contattare il team di supporto di Yardi eLearning. 
> 

### <a name="assign-the-azure-ad-test-user"></a>Assegnare l'utente test di Azure AD
Questa sezione descrive come abilitare Britta Simon per l'uso dell'accesso SSO di Azure concedendole l'accesso a Yardi eLearning.
