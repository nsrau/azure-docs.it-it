<properties pageTitle="Esercitazione: Integrazione di Azure Active Directory con Salesforce Sandbox | Microsoft Azure" description="Informazioni su come usare Salesforce Sandbox con Azure Active Directory per abilitare l'accesso Single Sign-On, il provisioning automatizzato e altro ancora." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
...
2.  Nella pagina **Stabilire come si desidera che gli utenti accedano a Salesforce Sandbox** selezionare **Single Sign-On di Microsoft Azure AD**, quindi fare clic su **Avanti**.

    ![Sandbox Salesforce](./media/active-directory-saas-salesforce-sandbox-tutorial/IC746479.png "Sandbox Salesforce")

3.  Nella pagina **Configura URL app** digitare l'URL nella casella di testo **URL di accesso Salesforce Sandbox** usando il modello seguente "http://company.my.salesforce.com" e fare clic su **Avanti**.

    ![Configura URL app](./media/active-directory-saas-salesforce-sandbox-tutorial/IC781022.png "Configura URL app")

4.  Nella pagina **Configura accesso Single Sign-On in Salesforce Sandbox** fare clic su **Scarica certificato**, quindi salvare il file di certificato nel computer.
...
7.  Nel riquadro di spostamento a sinistra, fare clic su **Controlli di sicurezza** quindi fare clic su **Impostazioni Single Sign-On**.
...
9.  Nella sezione Impostazioni SAML Single Sign-On, eseguire la procedura seguente:
    ...
    3.  Nella casella di testo **ID entità** digitare ****https://test.salesforce.com**.
...
In questa sezione si presuppone che sia già stato creato un dominio. Per ulteriori informazioni, vedere [Definizione del nome di dominio](https://help.salesforce.com/HTViewHelpDoc?id=domain_name_define.htm&language=en_US).

###Per abilitare il dominio, eseguire la procedura seguente:

1.  Nel riquadro di spostamento a sinistra, fare clic su **Gestione dominio** quindi fare clic su **Dominio personale**.
...
8.  Nella pagina **Immettere le credenziali di Salesforce Sandbox per abilitare il provisioning automatico degli utenti**, specificare le impostazioni di configurazione seguenti:
    ...
    1.  Nella casella di testo **Nome utente amministratore di Sandbox Salesforce**, digitare un nome account di Sandbox Salesforce con il profilo **Amministratore di sistema** assegnato in Salesforce.com.

    2.  Nella casella di testo **Password di amministratore Sandbox Salesforce**, digitare la password per questo account.
    ...
    5.  Scegliere il pulsante **Avanti** per aprire la pagina **Conferma**.
