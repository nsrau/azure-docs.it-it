<properties
	pageTitle="Esercitazione: Integrazione di Azure Active Directory con Tableau Online | Microsoft Azure"
...
4. **[Creazione di un utente test di Tableau Online](#creating-a-Tableau-Online-test-user)**: per avere una controparte di Britta Simon in Tableau Online collegata alla relativa rappresentazione in Azure AD.
...
4. Scegliere **Utenti** dal menu in alto.
