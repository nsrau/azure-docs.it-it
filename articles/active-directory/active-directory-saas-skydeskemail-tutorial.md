<properties
	pageTitle="Esercitazione: Integrazione di Azure Active Directory con Skydesk Email | Microsoft Azure"
...
- È possibile gestire gli account da una posizione centrale, ossia il portale di Azure Active classico
...
5. Per abilitare l'accesso Single Sign-On in **Skydesk Email**, seguire questa procedura:
...
6. Nella pagina della finestra di dialogo **SAML Authentication** seguire questa procedura:
	...
	> [AZURE.NOTE] Per usare l'autenticazione basata su SAML, è necessario che il **dominio sia verificato** e l'**URL del portale** sia impostato. È possibile impostare l'URL del portale usando un nome univoco.
