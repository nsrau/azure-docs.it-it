...
![Utenti, icona](./media/role-based-access-control-configure/users_icon.png)
...
![Aggiungi, icona](./media/role-based-access-control-configure/add_icon.png)  
...
![Rimuovi, icona](./media/role-based-access-control-configure/remove_icon.png)
