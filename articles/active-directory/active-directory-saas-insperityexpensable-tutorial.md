...
3. **[Creazione di un utente test di Insperity ExpensAble](#creating-a-insperityexpensable-test-user)**: per avere una controparte di Britta Simon in Insperity ExpensAble collegata alla relativa rappresentazione in Azure AD.
