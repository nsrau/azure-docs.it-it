...
---
# <a name="rapidly-respond-to-secure-identities-with-azure-ad"></a>Rispondi rapidamente a identità sicure con Azure AD
...
| [Disabilitare il consenso dell'utente finale per le applicazioni](../manage-apps/configure-user-consent.md) | Il flusso di lavoro di consenso dell'amministratore offre agli amministratori un modo sicuro per concedere l'accesso alle applicazioni che richiedono l'approvazione dell'amministratore, in modo che gli utenti finali non espongano dati aziendali. Microsoft consiglia di disabilitare le future operazioni di consenso utente per ridurre la superficie di attacco e mitigare questo rischio. |
