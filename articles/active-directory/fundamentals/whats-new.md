...
### <a name="users-removed-from-synchronization-scope-no-longer-switch-to-cloud-only-accounts"></a>Gli utenti rimossi dall'ambito di sincronizzazione non passano più ad account di tipo solo cloud
