...
### <a name="unmanaged-azure-active-directory-accounts-in-b2b-update-for-march-2021"></a>Account di Azure Active Directory non gestiti nell'aggiornamento B2B per marzo 2021Unmanaged Azure Active Directory accounts in B2B update for March, 2021

**Tipo:** Modifica pianificata  
**Categoria di servizio:** B2B  
**Funzionalità del prodotto:** B2B/B2C
 
**A partire dal 31 marzo 2021,** Microsoft non supporterà più il riscatto degli inviti creando account e tenant di Azure Active Directory (Azure AD) non gestiti per scenari di collaborazione B2B. In preparazione a questo, vi invitiamo a optare per [e-mail di autenticazione passcode monouso](https://docs.microsoft.com/azure/active-directory/b2b/one-time-passcode).
...
Nel prossimo futuro, gli utenti con account Azure AD non saranno più in grado di registrare e gestire le applicazioni convergenti tramite il portale di registrazione delle applicazioni (apps.dev.microsoft.com) né di registrare e gestire le applicazioni nell'esperienza di registrazione app (legacy) nel portale di Azure.In the near future, users with Azure AD accounts will no longer be able to register and manage converged applications using the Application Registration Portal (apps.dev.microsoft.com) or register and manage applications in the App registrations (legacy) experience in the Azure portal.
