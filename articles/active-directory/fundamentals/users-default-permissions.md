...
Gruppi | <ul><li>Creazione di gruppi di sicurezza<li>Creazione di gruppi di Office 365<li>Lettura di tutte le proprietà dei gruppi<li>Lettura delle appartenenze a gruppi non nascoste<li>Lettura delle appartenenze a gruppi di Office 365 nascoste per il gruppo aggiunto<li>Gestione delle proprietà, della titolarità e dell'appartenenza a gruppi dell'utente<li>Aggiunta di utenti guest ai gruppi con proprietario<li>Gestire delle impostazioni di appartenenza dinamica<li>Eliminazione dei gruppi con proprietario<li>Ripristino dei gruppi di Office 365 con proprietario</li></ul> | <ul><li>Leggere le proprietà di tutti i gruppi non nascosti, incluse l'appartenenza e la proprietà (anche gruppi non aggiunti)<li>Lettura delle appartenenze a gruppi di Office 365 nascoste per i gruppi aggiunti<li>Cerca i gruppi in base al nome visualizzato o ObjectId (se consentito)</li></ul> | Nessuna autorizzazione
...
Directory | <ul><li>Lettura di tutte le informazioni aziendali<li>Lettura di tutti i domini<li>Lettura di tutti i contratti dei partner</li></ul> | <ul><li>Lettura del nome visualizzato e dei domini verificati</li></ul> | <ul><li>Lettura del nome visualizzato e dei domini verificati</li></ul>
