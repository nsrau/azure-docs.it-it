...
1. Creare l'oggetto credenziali di Windows PowerShell eseguendo il comando seguente. Sostituire *\<username\>* e *\<password\>* con il nome utente e la password per la directory:
