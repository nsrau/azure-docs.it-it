...
description: Viene illustrato come utilizzare i gruppi dinamici di Azure AD con la collaborazione B2B di Azure Active Directory
...
![Mostra Abilita il gruppo di tutti gli utenti impostato su Sì](media/active-directory-b2b-dynamic-groups/enable-all-users-group.png)
...
![Mostra regole in cui il tipo di utente non è uguale a guest](media/active-directory-b2b-dynamic-groups/exclude-guest-users.png)
...
![Mostra regole in cui il tipo di utente è uguale a guest](media/active-directory-b2b-dynamic-groups/only-guest-users.png)
