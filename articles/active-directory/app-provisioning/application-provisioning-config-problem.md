...
- È **stato configurato un filtro di ambito** **che filtra l'utente in base a un valore di attributo**. Per altre informazioni, vedere [provisioning di applicazioni basate su attributi con filtri di ambito](../app-provisioning/define-conditional-rules-for-provisioning-user-accounts.md).
