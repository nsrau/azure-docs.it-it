...
![Immagine 2](./media/plan-auto-user-provisioning/cloudprovisioning.png)
...
![Immagine 2](./media/plan-auto-user-provisioning/workdayprovisioning.png)
...
* [Problemi di configurazione del provisioning utenti in un'applicazione raccolta Azure AD](../app-provisioning/application-provisioning-config-problem.md)
...
* [Il provisioning degli utenti in un'applicazione della raccolta Azure AD richiede ore o più](../app-provisioning/application-provisioning-when-will-provisioning-finish.md)
...
* [Nessun utente di cui è in corso il provisioning in un'applicazione raccolta Azure AD](../app-provisioning/application-provisioning-config-problem-no-users-provisioned.md)

* [È in corso il provisioning di un set errato di utenti in un'applicazione raccolta Azure AD](../app-provisioning/application-provisioning-config-problem-wrong-users-provisioned.md)
