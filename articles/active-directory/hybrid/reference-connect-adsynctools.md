...
In caso di esecuzione come amministratore di dominio non è necessario l'input manuale del limite per le credenziali di AD al posto del file XML, ad esempio $ADwatermark = "TVNEUwMAAAAXyK9ir1zSAQAAAAAAAAAA(...)"
