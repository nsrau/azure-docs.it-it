...
## <a name="install-the-adsynctools-powershell-module"></a>Installare il modulo ADSyncTools di PowerShell
Per installare il modulo ADSyncTools di PowerShell, eseguire le operazioni seguenti:

1.  Aprire Windows PowerShell con privilegi amministrativo
