...
**D: quali applicazioni sfruttano i `domain_hint` vantaggi `login_hint` o la funzionalità dei parametri di seamless SSO?**
...
**D: l'accesso SSO facile `Alternate ID` è supportato come nome utente, `userPrincipalName`anziché?**
