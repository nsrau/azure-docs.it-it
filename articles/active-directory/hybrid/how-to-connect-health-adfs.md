...
![portale di Azure AD Connect Health](./media/how-to-connect-health-adfs/report1.png)
...
| --- | --- |
| Tutte | Mostra il conteggio del numero totale di richieste elaborate da tutti i server AD FS.|
