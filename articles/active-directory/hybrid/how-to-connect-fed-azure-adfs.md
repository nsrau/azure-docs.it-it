...
![Configurare il probe del servizio di bilanciamento del carico interno](./media/how-to-connect-fed-azure-adfs/ilbdeployment4.png)
...
* [Configurazione e gestione di AD FS con Azure AD Connect](how-to-connect-fed-whatis.md)
