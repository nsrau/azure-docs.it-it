...
| Nome attributo (Active Directory locale) | Nome attributo (interfaccia utente di Azure AD Connect) | Utente | Contatto | Gruppo | Comment |
| --- |:---:|:---:|:---:| --- |---|
