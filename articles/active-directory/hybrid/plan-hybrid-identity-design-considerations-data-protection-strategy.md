...
3. Accesso condizionale per applicazioni di Office 365 con Microsoft Intune:  Gli amministratori IT possono effettuare il provisioning di criteri dei dispositivi di accesso condizionale per proteggere le risorse aziendali, allo stesso tempo che consente agli information worker su dispositivi conformi di accedere ai servizi. 
