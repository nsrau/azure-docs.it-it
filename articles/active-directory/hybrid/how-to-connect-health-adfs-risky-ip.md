...
## <a name="faq"></a>FAQ
**Perché vengono visualizzati gli intervalli di indirizzi IP privati nel report?**  <br />
...
**Perché vengono visualizzati gli indirizzi IP del servizio di bilanciamento del carico nel report?**  <br />
...
**Cosa devo fare per bloccare l'indirizzo IP?**  <br />
È consigliabile aggiungere l'indirizzo IP dannoso identificato al firewall o al blocco in Exchange.   <br />

**Perché non vengono visualizzati elementi in questo report?** <br />
...
**Perché non viene visualizzato alcun accesso al report?**  <br />
