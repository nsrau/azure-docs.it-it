...
Azure Active Directory offre autenticazione Single Sign-On e sicurezza avanzata per l'accesso alle applicazioni a migliaia di applicazioni SaaS e di applicazioni Web locali. Per ulteriori informazioni, vedere [integrazione di applicazioni con Azure Active Directory](../develop/quickstart-register-app.md)
...
* Gli amministratori possono fornire l'accesso condizionale in base alle risorse dell'applicazione, al dispositivo e all'identità utente, al percorso di rete e all'autenticazione a più fattori.
* Gli utenti possono sfruttare la propria identità comune tramite gli account in Azure AD per Microsoft 365, Intune, app SaaS e applicazioni di terze parti.
