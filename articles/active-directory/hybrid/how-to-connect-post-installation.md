...
Ora che gli utenti sono stati sincronizzati con il cloud, è necessario assegnare loro una licenza in modo che possano iniziare a usare app cloud come Microsoft 365.
...
Per ulteriori informazioni sull'utilità di pianificazione della sincronizzazione Azure AD Connect, vedere [Azure ad Connect utilità di pianificazione](how-to-connect-sync-feature-scheduler.md).
...
| --- | --- |
|**impostazioni del profilo**|Visualizzare i dati di telemetria condivisi con Microsoft.|
