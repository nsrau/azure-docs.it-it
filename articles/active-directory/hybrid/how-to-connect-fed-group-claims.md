...
Vedere i metodi del documento per l'assegnazione di [utenti e gruppi a un'app](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups) per informazioni dettagliate sulla gestione dell'assegnazione di gruppi alle applicazioni.
...
[Metodi per l'assegnazione di utenti e gruppi a un'app](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups)

[Configurare le attestazioni di ruolo](../../active-directory/develop/active-directory-enterprise-app-role-management.md)