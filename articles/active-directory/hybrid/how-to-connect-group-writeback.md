...
9. Aprire Windows PowerShell nel server Azure Active Directory Connect ed eseguire i comandi seguenti.
...
Per ulteriori informazioni sulla configurazione dei gruppi di Office 365, vedere [Configure Microsoft 365 groups with on-premises Exchange Hybrid](https://docs.microsoft.com/exchange/hybrid-deployment/set-up-office-365-groups#enable-group-writeback-in-azure-ad-connect).
