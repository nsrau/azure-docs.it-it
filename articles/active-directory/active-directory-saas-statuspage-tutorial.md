...
1. Nella pagina **Configura accesso Single Sign-On in StatusPage** seguire questa procedura:
...
2. In un'altra finestra del browser accedere al sito aziendale di StatusPage come amministratore.
3. Nella barra degli strumenti principale scegliere **Manage Account**.
   
    ![Configura accesso Single Sign-On](./media/active-directory-saas-statuspage-tutorial/tutorial_statuspage_06.png) 
4. Fare clic sulla scheda **Single Sign-on** . 
