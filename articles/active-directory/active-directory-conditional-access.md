...
| Scenario | Articoli |
|------------------------------------------------------|----------|
| Proteggere le risorse in base all'utente o al livello di autenticazione |[Introduzione all'accesso condizionale alle app SaaS di Azure AD con autenticazione MFA ed Extranet](active-directory-conditional-access-azuread-connected-apps.md)<br><br>[Applicazioni supportate](active-directory-conditional-access-supported-apps.md)|
