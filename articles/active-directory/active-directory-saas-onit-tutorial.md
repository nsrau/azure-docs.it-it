...
## <a name="enable-the-application-integration-for-onit"></a>Abilitare l'integrazione dell'applicazione per Onit
Questa sezione descrive come abilitare l'integrazione dell'applicazione per Onit.

**Per abilitare l'integrazione dell'applicazione per Onit, seguire questa procedura:**
...
4. Fare clic su **Add** nella parte inferiore della pagina.
   ...
   ![Aggiungere un'applicazione](./media/active-directory-saas-onit-tutorial/IC749321.png "Aggiungere un'applicazione")
...
Per configurare l'accesso SSO per Onit è necessario recuperare un valore di identificazione personale da un certificato.
...
5. Fare clic su **Configura accesso Single Sign-On** per aprire la finestra di dialogo **Configura accesso Single Sign-On**.
   ...
   ![Configurare l'accesso Single Sign-On](./media/active-directory-saas-onit-tutorial/IC791170.png "Configurare l'accesso Single Sign-On")
6. Nella pagina **Stabilire come si desidera che gli utenti accedano a Onit** selezionare **Single Sign-On di Microsoft Azure AD**, quindi fare clic su **Avanti**.
   ...
   ![Configurare l'accesso Single Sign-On](./media/active-directory-saas-onit-tutorial/IC791171.png "Configurare l'accesso Single Sign-On")
7. Nella pagina **Configura URL app**, nella casella di testo **Onit Sign On URL** (URL di accesso a Onit) digitare l'URL usato dagli utenti per accedere all'applicazione Onit, ad esempio: "*https://ms-sso-test.onit.com*", quindi fare clic su **Avanti**.
   ...
   ![Configurare l'URL dell'app](./media/active-directory-saas-onit-tutorial/IC791172.png "Configurare l'URL dell'app")
8. Nella pagina **Configura accesso Single Sign-On in Onit** fare clic su **Scarica certificato** per scaricare il file del certificato, quindi salvarlo localmente nel computer.
   
   ![Configurare l'accesso Single Sign-On](./media/active-directory-saas-onit-tutorial/IC791173.png "Configurare l'accesso Single Sign-On")
...
13. Nella scheda **Sicurezza** eseguire la procedura seguente:
   ...
   7. Selezionare **Login with SSO: Required for the following domains/users** (Accesso SSO: necessario per i seguenti domini/utenti), digitare l'indirizzo di posta elettronica di un utente test nella relativa casella di testo, quindi fare clic su **Update** (Aggiorna).
       ...
       ![Modificare l'azienda](./media/active-directory-saas-onit-tutorial/IC791178.png "Modificare l'azienda")  
14. Nel portale di Azure classico selezionare la conferma della configurazione dell'accesso Single Sign-On e quindi fare clic su **Complete** per chiudere la finestra di dialogo **Configura accesso Single Sign-On**.
    ...
    ![Configurare l'accesso Single Sign-On](./media/active-directory-saas-onit-tutorial/IC791179.png "Configurare l'accesso Single Sign-On")
...
**Per assegnare gli utenti a Onit, seguire questa procedura:**

1. Nel portale di Azure classico creare un account di test.
2. Nella pagina di integrazione dell'applicazione **Onit** fare clic su **Assegna utenti**.
   
   ![Assegnare utenti](./media/active-directory-saas-onit-tutorial/IC791182.png "Assegnare utenti")
