...
Per raggiungere il pannello di accesso, un utente deve essere autenticato con un account aziendale in Azure AD. <br> Un utente può essere autenticato direttamente in Azure AD. <br> In alternativa, se in un'organizzazione è stata configurata la federazione con ADFS o altre tecnologie, gli utenti possono essere autenticati da Windows Server Active Directory.
...
## Suggerimenti per testare l'esperienza utente finale
