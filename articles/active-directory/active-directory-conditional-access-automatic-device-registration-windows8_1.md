...
## Annullare la registrazione dei dispositivi appartenenti a un dominio di Windows 8.1
...
* Opzione 1: **Annullare la registrazione di un dispositivo Windows 8.1 appartenente al dominio con le impostazioni del PC**
  ...
  2. Selezionare **Esci**. Questa procedura deve essere ripetuta per ogni utente di dominio che ha eseguito l'accesso al computer ed è stato aggiunto automaticamente all'area di lavoro.
