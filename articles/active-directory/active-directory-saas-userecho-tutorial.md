...
4. **[Creazione di un utente test per UserEcho](#creating-a-userecho-test-user)** - per avere una controparte di Britta Simon in UserEcho collegata alla relativa rappresentazione in Azure AD.
