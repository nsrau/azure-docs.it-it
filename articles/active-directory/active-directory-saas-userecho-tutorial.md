...
* È possibile abilitare gli utenti per l'accesso Single Sign-On automatico a UserEcho (SSO) con i propri account Azure AD
...
* Sottoscrizione di UserEcho abilitata per l'accesso Single Sign-On (SSO)
...
## <a name="add-userecho-from-the-gallery"></a>Aggiungere UserEcho dalla raccolta
...
Questa sezione descrive come configurare e testare l'accesso Single Sign-On di Azure AD con UserEcho in base a un utente test di nome "Britta Simon".
...
Questa sezione descrive come abilitare l'accesso Single Sign-On di Azure AD nel portale di Azure classico e come configurare l'accesso Single Sign-On nell'applicazione UserEcho. 
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
  ...
  1. Nella casella di testo **URL di accesso** digitare l'URL usato dagli utenti per accedere all'applicazione UserEcho, ad esempio *https://fabrikam.UserEcho.com/*.
...
9. Nella pagina **Single sign-on (SAML)** seguire questa procedura:
  ...
  1. Per **SAML-enabled** (Abilitato per SAML) selezionare **Sì**. 
  2. Nella pagina Configura accesso Single Sign-On in UserEcho del portale di Azure classico copiare il valore di **URL servizio Single Sign-On** e quindi incollarlo nella casella di testo **URL SSO SAML**.
  3. Nella finestra di dialogo Configura accesso Single Sign-On in UserEcho del portale di Azure classico copiare il valore di **URL disconnessione remota** e incollarlo nella casella di testo **URL disconnessione remota**. 
  4. Aprire il certificato scaricato nel Blocco note, copiarne il contenuto e incollarlo nella casella di testo **X.509 Certificate** .    
  5. Fare clic su **Save**.
...
### <a name="create-a-userecho-test-user"></a>Creare un utente test per UserEcho
...
6. Nella finestra di dialogo **Invita un nuovo utente** seguire questa procedura:
  ...
  1. Nella casella di testo **Name** (Nome) digitare **Britta Simon**.
  2. Nella casella di testo **Posta elettronica** digitare l'indirizzo di posta elettronica di Britta Simon nel portale di Azure classico.
  3. Fare clic su **Invita**.

A Britta viene inviato un invito che le permette di iniziare a usare UserEcho. 

### <a name="assign-the-azure-ad-test-user"></a>Assegnare l'utente test di Azure AD
Questa sezione descrive come abilitare Britta Simon a usare l'accesso Single Sign-On di Azure concedendole l'accesso a UserEcho.
