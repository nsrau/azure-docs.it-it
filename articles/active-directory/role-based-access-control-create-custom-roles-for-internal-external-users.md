...
![Screenshot del ruolo personalizzato importato nel portale di Azure](./media/role-based-access-control-create-custom-roles-for-internal-external-users/18.png)

![Screenshot dell'assegnazione del ruolo importato personalizzato all'utente nella stessa directory](./media/role-based-access-control-create-custom-roles-for-internal-external-users/19.png)

![Screenshot delle autorizzazioni per il ruolo importato personalizzato](./media/role-based-access-control-create-custom-roles-for-internal-external-users/20.png)

Gli utenti con questo ruolo personalizzato possono ora creare nuove richieste di supporto.

![Screenshot del ruolo personalizzato che crea richieste di supporto](./media/role-based-access-control-create-custom-roles-for-internal-external-users/21.png)
...
![Screenshot del ruolo personalizzato che non può creare macchine virtuali](./media/role-based-access-control-create-custom-roles-for-internal-external-users/22.png)

![Screenshot del ruolo personalizzato che non può creare nuovi gruppi di risorse](./media/role-based-access-control-create-custom-roles-for-internal-external-users/23.png)
...
![Screenshot del portale di Azure del ruolo personalizzato creato usando l'interfaccia della riga di comando 1.0](./media/role-based-access-control-create-custom-roles-for-internal-external-users/26.png)
