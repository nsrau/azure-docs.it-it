...
- È possibile abilitare gli utenti per l'accesso automatico a KnowBe4 Security Awareness Training (Single Sign-On) con i propri account Azure AD
...
4. Nella casella di ricerca, digitare **KnowBe4 Security Awareness Training**.

    ![Creazione di un utente test di Azure AD](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_search.png)

5. Nel pannello dei risultati selezionare **KnowBe4 Security Awareness Training** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
3. **[Creazione di un utente di test KnowBe4 Security Awareness Training](#creating-a-knowbe4-security-awareness-training-test-user)**: per avere una controparte di Britta Simon in KnowBe4 Security Awareness Training collegata alla relativa rappresentazione in Azure AD.
...
3. Nella sezione **KnowBe4 Security Awareness Training Domain and URLs** (URL e dominio KnowBe4 Security Awareness Training) seguire questa procedura:
    ...
    Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://<companyname>.KnowBe4.com/auth/saml/<instancename>`

    > [!NOTE] 
    > Il valore non è reale. Aggiornarlo con l'URL di accesso effettivo. Contattare il [team di supporto client di KnowBe4 Security Awareness Training](mailto:support@KnowBe4.com) per ottenere il valore. 
