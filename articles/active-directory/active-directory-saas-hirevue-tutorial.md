...
1. Nella pagina **Configura accesso Single Sign-On in HireVue** seguire questa procedura:
...
2. Per ottenere SSO configurato per l'applicazione, contattare il team di supporto di HireVue all'indirizzo [samlsupport@hirevue.com](mailTo:samlsupport@hirevue.com) e fornire gli elementi seguenti:
...
### <a name="creating-an-hirevue-test-user"></a>Creazione di un utente test di HireVue
