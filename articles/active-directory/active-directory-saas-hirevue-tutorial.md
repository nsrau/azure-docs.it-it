...
# Esercitazione: Integrazione di Azure Active Directory con HireVue
...
## Aggiunta di HireVue dalla raccolta
...
In questa sezione viene abilitato l'accesso Single Sign-On di Azure AD nel portale di Azure classico e viene configurato l'accesso Single Sign-On nell'applicazione HireVue.
...
5. Per ottenere SSO configurato per l'applicazione, contattare il team di supporto di HireVue all'indirizzo [support@hirevue.com](mailTo:samlsupport@hirevue.com) e fornire gli elementi seguenti:
...
5. Nella pagina **Informazioni sull'utente** seguire questa procedura: ![Creazione di un utente test di Azure AD](./media/active-directory-saas-hirevue-tutorial/create_aaduser_05.png)
...
6.  Nella pagina **Profilo utente** seguire questa procedura: ![Creazione di un utente test di Azure AD](./media/active-directory-saas-hirevue-tutorial/create_aaduser_06.png)
...
### Creazione di un utente test di HireVue
