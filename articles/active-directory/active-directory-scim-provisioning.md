...
9. In **Strumenti** fare clic su **Riavvia provisioning account** per avviare il processo di provisioning.
...
1. Nella schermata risultante selezionare il secondo pulsante **Configura provisioning account**.
2. Nella finestra di dialogo immettere l'URL esposto a Internet e la porta dell'endpoint SCIM. Questi valori saranno analoghi a http://testmachine.contoso.com:9000 o http://<ip-address>:9000/, dove <ip-address> è l'indirizzo IP esposto a Internet.  
...
8. In **Strumenti** fare clic su **Riavvia provisioning account** per avviare il processo di provisioning.
