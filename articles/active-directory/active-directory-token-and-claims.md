...
| `scp` | Scope | Indica le autorizzazioni di rappresentazione concesse all'applicazione client. L'autorizzazione predefinita è `user_impersonation`. Il proprietario della risorsa protetta può registrare valori aggiuntivi in Azure AD. <br><br> **Valore del token JWT di esempio**: <br> `"scp": "user_impersonation"`|
