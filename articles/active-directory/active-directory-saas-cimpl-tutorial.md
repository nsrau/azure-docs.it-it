...
4. Nella casella di ricerca digitare **Cimpl**.

    ![Creazione di un utente test di Azure AD](./media/active-directory-saas-cimpl-tutorial/tutorial_cimpl_search.png)

5. Nel pannello dei risultati selezionare **Cimpl** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
3. **[Creazione di un utente test di Cimpl](#creating-a-cimpl-test-user)**: per avere una controparte di Britta Simon in Cimpl collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **URL e dominio Cimpl** seguire questa procedura:
...
6. Nella sezione **Configurazione di Cimpl** fare clic su **Configura Cimpl** per aprire la finestra **Configura accesso**. Copiare i valori **SAML Entity ID (ID entità SAML) e SAML Single Sign-On Service URL (URL servizio Single Sign-On SAML)** dalla sezione **Quick Reference** (Riferimento rapido).

    ![Configura accesso Single Sign-On](./media/active-directory-saas-cimpl-tutorial/tutorial_cimpl_configure.png) 

7. Per configurare l'accesso Single Sign-On sul lato **Cimpl** è necessario inviare il **Certificato (Base64)** scaricato e i valori **SAML Entity ID (ID entità SAML) e SAML Single Sign-On Service URL (URL servizio Single Sign-On SAML)** al supporto Cimpl, contattabile al **+1 866-982-8250**.
