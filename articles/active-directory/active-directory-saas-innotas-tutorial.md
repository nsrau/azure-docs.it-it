...
ms.date: 06/29/2017
ms.author: jeedes
ms.openlocfilehash: 702130c8e8230c44726d416db251d6d24e1e9b04
ms.sourcegitcommit: b6319f1a87d9316122f96769aab0d92b46a6879a
ms.translationtype: HT
ms.contentlocale: it-IT
ms.lasthandoff: 05/20/2018
ms.locfileid: "34339934"
---
...
4. Nella casella di ricerca digitare **Innotas**.

    ![Creazione di un utente test di Azure AD](./media/active-directory-saas-innotas-tutorial/tutorial_innotas_search.png)

5. Nel pannello dei risultati selezionare **Innotas** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
3. **[Creazione di un utente di test di Innotas](#creating-an-innotas-test-user)**: per avere una controparte di Britta Simon in Innotas collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **URL e dominio Innotas** seguire questa procedura:
...
6. Per configurare l'accesso Single Sign-On sul lato **Innotas**, è necessario inviare il file **XML metadati** scaricato al [team di supporto di Innotas](https://www.innotas.com/contact). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
2. Nell'elenco di applicazioni selezionare **Innotas**.
