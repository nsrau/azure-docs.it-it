...
* È possibile abilitare gli utenti per l'accesso automatico Single Sign-On (SSO) ad Anaplan con i propri account Azure AD
...
* Sottoscrizione di Anaplan abilitata per l'accesso Single Sign-On (SSO)
...
Questa sezione descrive come configurare e testare l'accesso SSO di Azure AD con Anaplan in base a un utente test di nome "Britta Simon".

Per il funzionamento dell'accesso SSO, Azure AD deve conoscere qual è l'utente di Anaplan che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Anaplan.
...
Per configurare e testare l'accesso SSO di Azure AD con Anaplan, è necessario completare i blocchi predefiniti seguenti:
...
In questa sezione viene abilitato l'accesso SSO di Azure AD nel portale di Azure classico e viene configurato l'accesso SSO nell'applicazione Anaplan.

**Per configurare l'accesso SSO di Azure AD con Anaplan, seguire questa procedura:**
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura e fare clic su **Avanti**:
  ...
  1. Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://sdp.anaplan.com/frontdoor/saml/<tenant name>`
  2. Fare clic su **Avanti**.

    > [!NOTE] 
    > Il valore dell'URL di accesso in questa esercitazione è solo un segnaposto. Per ottenere il valore effettivo per l'ambiente, contattare il team di supporto di Anaplan.
    > 
...
### <a name="create-a-anaplan-test-user"></a>Creare un utente test per Anaplan
...
Questa sezione descrive come abilitare Britta Simon a usare l'accesso SSO di Azure concedendole l'accesso ad Anaplan.
