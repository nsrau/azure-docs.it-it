...
8. Configurare le autorizzazioni per l'applicazione: nel menu Impostazioni scegliere la sezione "Autorizzazioni necessarie", fare clic su **Aggiungi**, quindi **Selezionare un'API** e selezionare "Windows Azure Active Directory" (questa è l'API AADGraph). Fare clic su **Selezionare le autorizzazioni** e selezionare **Access the directory as the signed-in user** (Accedi alla directory come utente connesso). In questo modo l'applicazione potrà cercare gli utenti nell'API Graph.
...
* Ritornare nella scheda **Configura** dell'applicazione nel Portale di Azure, sostituire il valore di **RedirectUri** con questo valore.  
