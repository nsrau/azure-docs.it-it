...
1. Pubblicare l'applicazione seguendo le istruzioni contenute in [Pubblicare le applicazioni con il proxy di applicazione](manage-apps/application-proxy-publish-azure-portal.md).
...
* [Abilitare Single Sign-On](manage-apps/application-proxy-single-sign-on.md) per le applicazioni che non sono in grado di riconoscere attestazioni
