---
title: Problemi di configurazione dell'accesso condizionale a una delle applicazioni
description: Problemi di configurazione dell'accesso condizionale a una delle applicazioni
...
## <a name="ive-set-up-conditional-access-but-something-isnt-working"></a>L'accesso condizionale è stato configurato, ma qualcosa non funziona
  I documenti seguenti possono aiutare a risolvere alcuni dei problemi più comuni in questa categoria.
  * [L'accesso condizionale non funziona perché il cliente non ha soddisfatto i prerequisiti di registrazione del dispositivo](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)
  * [Il tenant è bloccato a causa dell'impostazione non corretta dei criteri di accesso condizionale](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-device-remediation/?/?WT.mc_id=DMC_AAD_Manage_Apps_Troubleshooting_Nav)
