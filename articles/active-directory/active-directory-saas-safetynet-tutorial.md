...
4. Nella casella di ricerca digitare **SafetyNet**, selezionare **SafetyNet** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![SafetyNet nell'elenco risultati](./media/active-directory-saas-safetynet-tutorial/tutorial_safetynet_addfromgallery.png)
...
3. **[Creare un utente di test di SafetyNet](#create-a-safetynet-test-user)**: per avere una controparte di Britta Simon in SafetyNet collegata alla rappresentazione dell'utente in Azure AD.
...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/active-directory-saas-safetynet-tutorial/tutorial_safetynet_samlbase.png)

3. Nella sezione **URL e dominio SafetyNet** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di SafetyNet](./media/active-directory-saas-safetynet-tutorial/tutorial_safetynet_url.png)
...
4. Selezionare **Mostra impostazioni URL avanzate** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di SafetyNet](./media/active-directory-saas-safetynet-tutorial/tutorial_safetynet_url1.png)
...
5. Fare clic sul pulsante **Salva** .
    ...
    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/active-directory-saas-safetynet-tutorial/tutorial_general_400.png)
...
6. Per generare l'**URL dei metadati**, seguire questa procedura:
    ...
    d. Passare ora alla pagina delle proprietà di **SafetyNet**, copiare il valore di **ID applicazione** usando il pulsante **Copia** e incollarlo nel Blocco note.
...
7. Per configurare l'accesso Single Sign-On sul lato **SafetyNet**, è necessario inviare l'**URL dei metadati** generato al [team di supporto di SafetyNet](mailto:dev@predictivesolutions.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/active-directory-saas-safetynet-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/active-directory-saas-safetynet-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/active-directory-saas-safetynet-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/active-directory-saas-safetynet-tutorial/create_aaduser_04.png)
...
2. Nell'elenco delle applicazioni selezionare **SafetyNet**.

    ![Collegamento di SafetyNet nell'elenco delle applicazioni](./media/active-directory-saas-safetynet-tutorial/tutorial_safetynet_app.png)  
