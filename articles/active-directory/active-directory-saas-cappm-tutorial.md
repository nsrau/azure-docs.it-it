...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
    ...
    a. Nella casella di testo **Identificatore** digitare l'URL utilizzato dagli utenti per accedere all'applicazione CA PPM usando il modello seguente: **https://ca.ondemand.saml.20.post.\<nome società\>**.
...
6.  Nella pagina **Profilo utente** seguire questa procedura: ![Creazione di un utente test di Azure AD](./media/active-directory-saas-cappm-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-ca-ppm-test-user"></a>Creazione di un utente test di CA PPM
