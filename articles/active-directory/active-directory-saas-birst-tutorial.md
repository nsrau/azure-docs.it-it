...
* È possibile abilitare gli utenti per l'accesso automatico a Birst Agile Business Analytics (SSO) con i propri account Azure AD
...
* Sottoscrizione di Birst Agile Business Analytics abilitata all'accesso Single Sign-On (SSO)
...
## <a name="add-birst-agile-business-analytics-from-the-gallery"></a>Aggiungere Birst Agile Business Analytics dalla raccolta
...
Questa sezione descrive come configurare e testare l'accesso SSO di Azure AD con Birst Agile Business Analytics in base a un utente test di nome "Britta Simon".

Per il funzionamento dell'accesso SSO, Azure AD deve conoscere qual è l'utente di Birst Agile Business Analytics che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Birst Agile Business Analytics.
...
3. **[Creazione di un utente test di Birst Agile Business Analytics](#creating-a-birst-agile-business-analytics-test-user)** : per avere una controparte di Britta Simon in Birst Agile Business Analytics collegata alla relativa rappresentazione in Azure AD.
4. **[Assegnazione dell'utente test di Azure AD](#assigning-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Test dell'accesso Single Sign-On](#testing-single-sign-on)**: per verificare se la configurazione funziona.

### <a name="configure-azure-ad-sso"></a>Configurare l'accesso SSO di Azure AD
Questa sezione descrive come abilitare l'accesso SSO di Azure AD nel portale di Azure classico e configurare l'accesso SSO nell'applicazione Birst Agile Business Analytics.

**Per configurare l'accesso SSO di Azure AD con Birst Agile Business Analytics, seguire questa procedura:**
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura:
  ...
  1. Nella casella di testo URL di accesso digitare l'URL usato dagli utenti per accedere all'applicazione Birst Agile Business Analytics adottando il modello seguente: "https://login.bws.birst.com/SAMLSSO/Services.aspx?birst.idpid=TENANTIDPID".
   L'URL è dipendente dal data center in cui si trova l'account Birst. Per i data center negli Stati Uniti, usare "https://login.bws.birst.com/SAMLSSO/Services.aspx?birst.idpid=TENANTIDPID" e per i data center in Europa usare "https://login.eu1.birst.com/SAMLSSO/Services.aspx?birst.idpid=TENANTIDPID".
...
### <a name="create-a-birst-agile-business-analytics-test-user"></a>Creare un utente test per Birst Agile Business Analytics
...
>[!NOTE]
>Per creare un utente manualmente, è necessario contattare il team di supporto di Birst Agile Business Analytics.
> 

### <a name="assign-the-azure-ad-test-user"></a>Assegnare l'utente test di Azure AD
Questa sezione descrive come abilitare Britta Simon all'uso dell'accesso SSO di Azure concedendole l'accesso a Birst Agile Business Analytics.
