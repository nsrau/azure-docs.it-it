...
Prima di poter usare gli esempi contenuti in questo articolo, è necessario completare i [prerequisiti di accesso all'API di creazione report di Azure AD](active-directory-reporting-api-prerequisites.md).  
