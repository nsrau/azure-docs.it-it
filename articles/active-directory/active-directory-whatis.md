...
Per altre informazioni sulle funzionalità di Azure Active Directory seguire i collegamenti.


- [Accesso Single Sign-On](https://msdn.microsoft.com/library/azure/dn510976.aspx)
- [Creazione report + analisi](active-directory-view-access-usage-reports.md)
- [Self-service](http://aka.ms/ssproverview)
- [Applicazioni locali](active-directory-application-proxy-configure.md)
- [Contratto di servizio](https://msdn.microsoft.com/library/azure/dn532272.aspx)
- [Gestione delle identità](fundamentals-identity.md)
- [Gestione degli accessi](https://msdn.microsoft.com/library/azure/dn906873.aspx)
