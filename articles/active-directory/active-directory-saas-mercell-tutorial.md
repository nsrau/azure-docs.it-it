...
5. Per generare l'**URL dei metadati**, seguire questa procedura:
    ...
    d. Passare ora alla pagina delle proprietà di **Mercell**, copiare l'**ID applicazione** usando il pulsante **Copia** e incollarlo nel Blocco note.
...
6. Per configurare l'accesso Single Sign-On sul lato **Mercell** è necessario inviare l'**URL dei metadati** generato al [team di supporto di Mercell](mailto:webmaster@mercell.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
