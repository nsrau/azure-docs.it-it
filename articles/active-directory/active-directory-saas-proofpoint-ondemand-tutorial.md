...
4. Nella casella di ricerca digitare **Proofpoint on Demand**.
...
5. Nel pannello dei risultati selezionare **Proofpoint on Demand** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
La relazione di collegamento viene stabilita assegnando il valore di **nome utente** in Azure AD come valore di **Username** (Nome utente) in Proofpoint on Demand.
...
3. **[Creazione di un utente di test di Proofpoint on Demand](#creating-a-proofpoint-on-demand-test-user)**: per avere una controparte di Britta Simon in Proofpoint on Demand collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **URL e dominio Proofpoint on Demand** seguire questa procedura:
    ...
    Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://<hostname>.pphosted.com/ppssamlsp_hostname`
...
6. Nella sezione **Configurazione di Proofpoint on Demand** fare clic su **Configura Proofpoint on Demand** per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido**.
...
7. Per configurare l'accesso Single Sign-On sul lato **Proofpoint on Demand**, è necessario inviare il file **Certificato (Base 64)** scaricato, l'**ID di entità SAML** e l'**URL del servizio Single Sign-On SAML** al [team di supporto di Proofpoint on Demand](https://www.proofpoint.com/us/support-services).
...
2. Poiché questi non sono i valori reali, è necessario aggiornarli con quelli effettivi.
...
### <a name="creating-a-proofpoint-on-demand-test-user"></a>Creazione di un utente di test di Proofpoint on Demand
