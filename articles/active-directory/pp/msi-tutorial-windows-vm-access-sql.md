...
- [Autenticazione universale con database SQL e SQL Data Warehouse (supporto SSMS per MFA)](~/articles/sql-database/sql-database-ssms-mfa-authentication.md)
- [Configurare e gestire l'autenticazione di Azure Active Directory con il database SQL oppure con SQL Data Warehouse](~/articles/sql-database/sql-database-aad-authentication-configure.md)
...
- Altre informazioni sul [supporto di SQL di Azure per l'autenticazione di Azure AD](~/articles/sql-database/sql-database-aad-authentication.md).
- Altre informazioni sulla [supporto alla configurazione di SQL di Azure per l'autenticazione di Azure AD](~/articles/sql-database/sql-database-aad-authentication-configure.md).
