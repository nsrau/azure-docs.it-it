---
title: 'Esercitazione: Integrazione di Azure Active Directory con Bonus.ly | Microsoft Docs'
...
8. Nella pagina della finestra di dialogo **SAML** eseguire la procedura seguente:
   ...
   1. Nella finestra di dialogo **Configure single sign-on at Bonus.ly** (Configura accesso Single Sign-On in Bonus.ly) del portale di Azure classico copiare il valore di **URL accesso remoto** e incollarlo nella casella di testo **IdP SSO target URL** (URL di destinazione SSO IdP).
   2. Nella finestra di dialogo **Configure single sign-on at Bonus.ly** (Configura accesso Single Sign-On in Bonus.ly) del portale di Azure classico copiare il valore di **ID autorità di certificazione** e incollarlo nella casella di testo **IdP Issuer** (Autorità di certificazione IdP).
   3. Nella finestra di dialogo **Configure single sign-on at Bonus.ly** (Configura accesso Single Sign-On in Bonus.ly) del portale di Azure classico copiare il valore di **URL accesso remoto** e incollarlo nella casella di testo **IdP Login URL** (URL di accesso IdP).
...
6. Nella finestra di dialogo **Aggiungi utente** seguire la procedura seguente:
   ...
   1. Per **E-mail**, **Nome** e **Cognome** digitare i dati di un account AAD valido di cui eseguire il provisioning.
   2. Fare clic su **Save**.
