...
6. Per configurare l'accesso Single Sign-On sul lato **Moxi Engage** è necessario inviare il file **XML dei metadati** scaricato al [team di supporto di Moxi Engage](mailto:support@moxiworks.com). Questa impostazione viene configurata in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
