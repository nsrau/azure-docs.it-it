---
title: Come installare e usare le viste di log analitica per Azure Active Directory | Microsoft Docs
description: Informazioni su come installare e usare le viste di log analitica per Azure Active Directory
