...
3. Nella sezione **Workplace by Facebook Domain and URLs** (URL e dominio Workplace by Facebook) seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On](./media/active-directory-saas-facebook-at-work-tutorial/tutorial_workplacebyfacebook_url.png)

    a. Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://<scim company id>.facebook.com`.

    b. Nella casella di testo **Identificatore** digitare l'URL adottando il modello seguente: `https://www.facebook.com/company/<scim company id>`
...
* [Configura provisioning utenti](active-directory-saas-facebook-at-work-provisioning-tutorial.md)
