...
Questa esercitazione descrive l'integrazione di Trakstar con Azure Active Directory (Azure AD).  
...
Per il funzionamento dell'accesso Single Sign-On, Azure AD deve conoscere qual è l'utente di Trakstar che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Trakstar.  
...
1. Nella pagina **Configura accesso Single Sign-On in Trakstar** seguire la procedura seguente:
    ...
    b. Fare clic su **Avanti**.
2. Per ottenere l'accesso Single Sign-On configurato per l'applicazione, contattare il team di supporto di Trakstar all'indirizzo [integrations@trakstar.com](mailto:integrations@trakstar.com) e specificare gli elementi seguenti:
...
> [!NOTE]
> Per creare un utente manualmente, è necessario contattare il team di supporto di Trakstar.
> 
> 
