...
9.  Nella pagina della finestra di dialogo **Configura i parametri di SAML Single Sign-On** procedere come descritto di seguito e quindi fare clic su **Fatto**:
    ...
    1.  Nella pagina della finestra di dialogo **Configura accesso Single Sign-On in Zscaler ZSCloud** del portale di Azure, copiare il valore **URL richiesta di autenticazione** e quindi incollarlo nella casella di testo **URL del portale SAML al quale si reindirizzano gli utenti per l’autenticazione**.
