<properties pageTitle="Esercitazione: Integrazione di Azure Active Directory con Zscaler ZSCloud| Microsoft Azure" description="Informazioni su come usare Zscaler ZSCloud con Azure Active Directory per abilitare l'accesso Single Sign-On, il provisioning automatizzato e altro ancora." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Esercitazione: Integrazione di Azure Active Directory con Zscaler ZSCloud
>[AZURE.TIP]Per inviare commenti e suggerimenti, fare clic [qui](http://go.microsoft.com/fwlink/?LinkId=614878).
...
Al termine dell'esercitazione, gli utenti di Azure AD assegnati a Zscaler ZSCloud potranno accedere all'applicazione tramite il sito aziendale di Zscaler ZSCloud (accesso avviato dal provider di servizi) o seguendo le istruzioni riportate in [Introduzione al Pannello di accesso](https://msdn.microsoft.com/library/dn308586)
...
1.  Nella pagina di integrazione dell'applicazione **Zscaler ZSCloud** del portale di Azure AD fare clic su **Configura accesso Single Sign-On** per aprire la finestra di dialogo **Configura accesso Single Sign-On**.
...
9.  Nella pagina della finestra di dialogo **Configure SAML Single Sign-On Parameters** procedere come descritto di seguito e quindi fare clic su **Done**:
    ...
    1.  Nella pagina della finestra di dialogo **Configura accesso Single Sign-On in Zscaler ZSCloud** del portale di Azure copiare il valore **URL richiesta di autenticazione** e quindi incollarlo nella casella di testo **URL of the SAML Portal to which users are sent for authentication**.
...
11. Nella pagina della finestra di dialogo **Configura accesso Single Sign-On in Zscaler ZSCloud** del portale di Azure selezionare la conferma della configurazione dell'accesso Single Sign-On e quindi fare clic su **Completa**.
