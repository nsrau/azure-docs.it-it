...
12. Fare clic su **Completa** per chiudere la finestra di dialogo. Fare quindi clic su **Attributi** nella parte superiore della pagina.
    
    ![Fare clic su Attributi.][17]
13. Fare clic su **Aggiungi attributo utente**.
    
    ![Fare clic su Aggiungi attributo utente.][18]
14. Nel campo **Nome attributo** immettere `account`. Nel campo **Valore attributo** immettere l'ID dell'account NetSuite. Per istruzioni su come individuare l'ID dell'account, vedere di seguito:
