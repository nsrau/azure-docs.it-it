...
[Configurazione del join di Azure AD ibrido per i dispositivi Windows aggiunti a un dominio che sono federati mediante ADFS](manage-stale-devices.md)
