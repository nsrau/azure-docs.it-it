...
### <a name="highlevel-steps-for-upgrading-from-dirsync-to-azure-ad-connect"></a>Passaggi generali per l'aggiornamento da DirSync ad Azure AD Connect
...
## <a name="inplace-upgrade"></a>Aggiornamento sul posto
...
2. Leggere e accettare le condizioni di licenza e l'informativa sulla privacy.
   ![Schermata iniziale di Azure AD](./media/active-directory-aadconnect-dirsync-upgrade-get-started/Welcome.png)
3. Fare clic su Avanti per avviare l'analisi dell'installazione di DirSync esistente.
   ![Analisi dell'installazione della sincronizzazione della directory esistente](./media/active-directory-aadconnect-dirsync-upgrade-get-started/Analyze.png)
4. Al termine dell'analisi vengono visualizzate indicazioni su come procedere.  
   ...
   * Se si usa una versione completa di SQL Server per DirSync, viene invece visualizzata questa pagina: ![Analisi completata. È possibile eseguire l'aggiornamento da DirSync](./media/active-directory-aadconnect-dirsync-upgrade-get-started/AnalysisReadyFullSQL.png)  
   ...
   * Se sono presenti più di 50.000 oggetti, viene invece visualizzata questa pagina: ![Analisi completata. È possibile eseguire l'aggiornamento da DirSync](./media/active-directory-aadconnect-dirsync-upgrade-get-started/AnalysisRecommendParallel.png)  
...
6. Fornire un account amministratore dell'organizzazione per Active Directory.
   ![Immissione delle credenziali di ADDS](./media/active-directory-aadconnect-dirsync-upgrade-get-started/ConnectToADDS.png)
...
4. Dall'installazione locale di Azure AD Connect (percorso predefinito: C:\Programmi\Microsoft Azure Active Directory Connect) eseguire il comando seguente:  `AzureADConnect.exe /migrate`.
    Viene avviata l'installazione guidata di Azure AD Connect e viene visualizzata la schermata seguente: ![Immettere le credenziali di Azure AD](./media/active-directory-aadconnect-dirsync-upgrade-get-started/ImportSettings.png)
...
6. Configurare tutte le opzioni avanzate, tra cui:
   ...
   * Un account di servizio usato per connettersi a SQL Server (se il database di SQL Server è remoto, deve essere un account di servizio del dominio).
     È possibile visualizzare queste opzioni nella schermata seguente: ![Immissione delle credenziali di Azure AD](./media/active-directory-aadconnect-dirsync-upgrade-get-started/advancedsettings.png)
7. Fare clic su **Next**.
...
| Eseguire l'aggiornamento da una versione precedente di Connect |
