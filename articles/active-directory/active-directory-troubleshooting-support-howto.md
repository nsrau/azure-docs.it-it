---
title: Come ottenere supporto per Azure Active Directory | Microsoft Docs
description: Come ottenere supporto per Azure Active Directory
...
---
# <a name="how-to-get-support-for-azure-active-directory"></a>Come ottenere supporto per Azure Active Directory
...
5. Nel pannello **Problema** selezionare la [gravità](https://azure.microsoft.com/support/plans/response/)).
...
3. Nella pagina **Panoramica supporto** selezionare **Gestione delle identità** o **Gestione di utenti e domini**: ![screenshot delle categorie supporto per Azure AD](./media/active-directory-troubleshooting-support-howto/select-identity.png)
