...
1. Nella pagina di integrazione dell'applicazione [Symantec Web Security Service (WSS)](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
