...
Per configurare e testare l'accesso Single Sign-On di Azure AD con IQNavigator VMS, è necessario completare le procedure di base seguenti:
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    d. Nella casella di testo **Stato dell'inoltro** digitare un URL usando il modello seguente: `https://<subdomain>.iqnavigator.com`
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a IQNavigator VMS.
...
2. Nell'elenco delle applicazioni selezionare **IQNavigator VMS**.
