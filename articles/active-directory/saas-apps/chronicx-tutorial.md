...
1. **[Creare un utente di test di ChronicX®](#create-a-chronicx®-test-user)**: per avere una controparte di Britta Simon in ChronicX® collegata alla rappresentazione dell'utente in Azure AD.
