...
3. **[Creare un utente di test di ChronicX®](#create-a-chronicx®-test-user)**: per avere una controparte di Britta Simon in ChronicX® collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **URL e dominio ChronicX®** seguire questa procedura:
...
6. Per configurare l'accesso Single Sign-On sul lato **ChronicX®**, è necessario inviare il file **XML metadati** scaricato al [Team di supporto di ChronicX®](https://www.casebank.com/contact-us/). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
