...
4. Nella casella di ricerca digitare **Innovation Hub**, selezionare **Innovation Hub** dal pannello dei risultati quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
3. **[Creare un utente test di Innovation Hub](#create-an-innovation-hub-test-user)**: per avere una controparte di Britta Simon in Innovation Hub collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **URL e dominio Innovation Hub** seguire questa procedura:
...
4. L'applicazione Innovation Hub prevede che le asserzioni SAML abbiano un formato specifico. Configurare le attestazioni seguenti per questa applicazione. È possibile gestire i valori di questi attributi dalla sezione "**Attributi utente**" nella pagina di integrazione dell'applicazione. La schermata seguente illustra un esempio relativo a questa operazione.
...
2. Nell'elenco di applicazioni selezionare **Innovation Hub**.
