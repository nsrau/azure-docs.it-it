...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Skillport con gli account Azure AD personali.
...
* Skillport supporta l'accesso SSO avviato da **SP**
...
4. Nella casella di ricerca digitare **Skillport**, selezionare **Skillport** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Skillport nell'elenco risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Skillport.
...
2. **[Configurare l'accesso Single Sign-On di Skillport](#configure-skillport-single-sign-on)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente di test di Skillport](#create-skillport-test-user)** : per avere una controparte di Britta Simon in Skillport collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Skillport** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per Single Sign-On di Skillport](common/sp-identifier-reply.png)

    a. Nella casella di testo **URL di accesso** digitare l'URL:
...
6. Nella sezione **Configura Skillport** copiare gli URL appropriati in base alle proprie esigenze.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Skillport**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Skillport**.

    ![Collegamento di Skillport nell'elenco delle applicazioni](common/all-applications.png)
...
Quando si fa clic sul riquadro di Skillport nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Skillport per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
