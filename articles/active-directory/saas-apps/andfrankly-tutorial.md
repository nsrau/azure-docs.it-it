...
4. Nella casella di ricerca digitare **&frankly**.

    ![Creazione di un utente test di Azure AD](./media/andfrankly-tutorial/tutorial_andfrankly_search.png)

5. Nel pannello dei risultati selezionare **&frankly** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/andfrankly-tutorial/tutorial_andfrankly_addfromgallery.png)
...
Per stabilire la relazione di collegamento, in &frankly assegnare il valore di **nome utente** di Azure AD come valore dell'attributo **Username** (Nome utente).
...
3. Nella sezione **URL e dominio &frankly** per configurare l'applicazione in modalità avviata da **IDP**:
...
4. Selezionare **Mostra impostazioni URL avanzate** se si desidera configurare l'applicazione in modalità avviata da **SP**:
    ...
    Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://andfrankly.com/saml/okta/?saml_sso=<tenant id>`
    > [!NOTE] 
    > Poiché questi non sono i valori reali, è necessario aggiornarli con identificatore, Sign-On e URL di risposta effettivi. Per ottenere questi valori contattare il [team di supporto di andfrankly](mailto:help@andfrankly.com).
...
7. Per configurare l’accesso Single Sign-On sul lato **&frankly**, è necessario inviare il file di **XML metadati** scaricato al [team di supporto di andfrankly](mailto:help@andfrankly.com). 
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/andfrankly-tutorial/create_aaduser_01.png) 

2. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/andfrankly-tutorial/create_aaduser_02.png) 

3. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/andfrankly-tutorial/create_aaduser_03.png) 

4. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/andfrankly-tutorial/create_aaduser_04.png) 
...
In questa sezione viene creato un utente chiamato Britta Simon in &frankly. Collaborare con il [team di supporto di andfrankly](mailto:help@andfrankly.com) per aggiungere gli utenti alla piattaforma &frankly.

### <a name="assigning-the-azure-ad-test-user"></a>Assegnazione dell'utente test di Azure AD

In questa sezione Britta Simon viene abilitata per l'uso dell'accesso Single Sign-On di Azure concedendo l'accesso a &frankly.
