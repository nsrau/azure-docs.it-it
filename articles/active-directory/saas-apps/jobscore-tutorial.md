---
title: 'Esercitazione: Integrazione di Azure Active Directory con JobScore | Microsoft Docs'
...
1. Nella casella di ricerca digitare **JobScore**.

    ![Creazione di un utente test di Azure AD](./media/jobscore-tutorial/tutorial_jobscore_search.png)

1. Nel pannello dei risultati selezionare **JobScore** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/jobscore-tutorial/tutorial_jobscore_addfromgallery.png)
...
1. **[Creazione di un utente test di JobScore](#creating-a-jobscore-test-user)**: per avere una controparte di Britta Simon in JobScore collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio JobScore** seguire questa procedura:
...
1. Per configurare l'accesso Single Sign-On sul lato **JobScore** è necessario inviare il file **XML metadati** scaricato al [team di supporto di JobScore](mailto:support@jobscore.com). 
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/jobscore-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/jobscore-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/jobscore-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/jobscore-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco delle applicazioni selezionare **JobScore**.
