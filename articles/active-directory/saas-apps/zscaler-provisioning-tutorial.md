...
3. Per aggiungere Zscaler, scegliere il **nuova applicazione** pulsante nella parte superiore della finestra di dialogo.

    ![Pulsante Nuova applicazione][3]

4. Nella casella di ricerca digitare **Zscaler**.

    ![Il Provisioning di Zscaler](./media/zscaler-provisioning-tutorial/app-search.png)

5. Nel pannello dei risultati, selezionare **Zscaler**, quindi fare clic sul **Add** pulsante per aggiungere Zscaler al proprio elenco di applicazioni SaaS.

    ![Il Provisioning di Zscaler](./media/zscaler-provisioning-tutorial/app-search-results.png)

    ![Il Provisioning di Zscaler](./media/zscaler-provisioning-tutorial/app-creation.png)
...
2. Selezionare nell'elenco di applicazioni SaaS Zscaler.

    ![Il Provisioning di Zscaler](./media/zscaler-provisioning-tutorial/app-instance-search.png)
