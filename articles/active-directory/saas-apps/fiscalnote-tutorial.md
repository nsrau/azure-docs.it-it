...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a FiscalNote con gli account Azure AD personali.
...
4. Nella casella di ricerca digitare **FiscalNote**, selezionare **FiscalNote** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![FiscalNote nell'elenco risultati](common/search-new-app.png)
...
Per configurare l'accesso Single Sign-On di Azure AD con FiscalNote, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **FiscalNote** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
7. Nella pagina **Configura l'accesso Single Sign-On con SAML**, nella sezione **Certificato di firma SAML**, fare clic su **Scarica** per scaricare il file **Certificato (base)** definito dalle opzioni specificate in base ai propri requisiti e salvarlo nel computer in uso.

    ![Collegamento di download del certificato](common/certificateraw.png)

8. Nella sezione **Configura FiscalNote** copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-fiscalnote-single-sign-on"></a>Configurare l'accesso Single Sign-On per FiscalNote
