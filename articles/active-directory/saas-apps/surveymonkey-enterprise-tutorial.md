...
In questa sezione viene creato un utente di nome B.Simon in SurveyMonkey Enterprise. Collaborare con il  [team di supporto di SurveyMonkey Enterprise](mailto:support@selerix.com) per aggiungere gli utenti nella piattaforma SurveyMonkey Enterprise. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
