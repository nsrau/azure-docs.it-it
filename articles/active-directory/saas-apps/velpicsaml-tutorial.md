...
1. Nella casella di ricerca digitare **Velpic SAML**.

    ![Creazione di un utente test di Azure AD](./media/velpicsaml-tutorial/tutorial_velpicsaml_search.png)

1. Nel pannello dei risultati selezionare **Velpic SAML** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/velpicsaml-tutorial/tutorial_velpicsaml_addfromgallery.png)
...
1. **[Creazione di un utente test di Velpic SAML](#creating-a-velpic-saml-test-user)** : per avere una controparte di Britta Simon in Velpic SAML collegata alla relativa rappresentazione in Azure AD.
...
1. Immettere i dettagli nella sezione **URL e dominio Velpic SAML**.
...
1. Nella sezione Configurazione Velpic SAML scegliere Configura Velpic SAML per aprire la finestra di dialogo Configura accesso. Copiare l'ID di entità SAML dalla sezione Riferimento rapido.

1. In un'altra finestra del Web browser accedere al sito aziendale di Velpic SAML come amministratore.

1. Fare clic sulla scheda **Manage** (Gestisci), passare alla sezione **Integration** (Integrazione) e qui scegliere **Plugins** per creare un nuovo plug-in per l'accesso.

    ![Plug-in](./media/velpicsaml-tutorial/velpic_1.png)

1. Fare clic sul pulsante **Add plugin** (Aggiungi plug-in).
    
    ![Plug-in](./media/velpicsaml-tutorial/velpic_2.png)

1. Fare clic sul riquadro **SAML** nella pagina Add plugin (Aggiungi plug-in).
    
    ![Plug-in](./media/velpicsaml-tutorial/velpic_3.png)

1. Immettere il nome del nuovo plug-in SAML e scegliere il pulsante **Add** (Aggiungi).
...
1. Nel **portale di gestione di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/velpicsaml-tutorial/create_aaduser_01.png) 

1. Andare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/velpicsaml-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/velpicsaml-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/velpicsaml-tutorial/create_aaduser_04.png) 
...
1. Nella finestra di dialogo **Create New User** (Crea nuovo utente) effettuare le operazioni seguenti.
