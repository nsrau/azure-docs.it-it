...
## <a name="configure-and-test-azure-ad-single-sign-on-for-adobe-identity-management"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per Adobe Identity Management
...
Per configurare e testare l'accesso SSO di Azure AD con Adobe Identity Management, completare le procedure di base seguenti:
...
1. Nella pagina di integrazione dell'applicazione **Adobe Identity Management** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
Per configurare l'accesso Single Sign-On sul lato **Adobe Identity Management**, è necessario inviare il file **XML dei metadati della federazione** scaricato e gli URL appropriati, copiati dal portale di Azure, al [team di supporto di Adobe Identity Management](mailto:identity@adobe.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.

### <a name="create-adobe-identity-management-test-user"></a>Creare l'utente di test di Adobe Identity Management

In questa sezione viene creato un utente di nome B.Simon in Adobe Identity Management. Collaborare con il  [team di supporto di Adobe Identity Management](mailto:identity@adobe.com) per aggiungere gli utenti alla piattaforma Adobe Identity Management. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.

## <a name="test-sso"></a>Testare l'accesso SSO 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di Adobe Identity Management nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Adobe Identity Management per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Provare Adobe Identity Management con Azure AD](https://aad.portal.azure.com/)
