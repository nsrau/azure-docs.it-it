...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a FreshGrade con gli account Azure AD personali.
...
* FreshGrade supporta l'accesso SSO avviato da **SP**

## <a name="adding-freshgrade-from-the-gallery"></a>Aggiunta di FreshGrade dalla raccolta

Per configurare l'integrazione di FreshGrade in Azure AD, è necessario FreshGrade dalla raccolta all'elenco di app SaaS gestite.
...
In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con FreshGrade usando un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in FreshGrade.

Per configurare e testare l'accesso Single Sign-On di Azure AD con FreshGrade, è necessario completare le procedure di base seguenti:

1. **[Configurare l'accesso Single Sign-On di Azure AD](#configure-azure-ad-single-sign-on)**: per consentire agli utenti di usare questa funzionalità.
2. **[Configurare l'accesso Single Sign-On per FreshGrade](#configure-freshgrade-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di FreshGrade](#create-freshgrade-test-user)**: per avere una controparte di Britta Simon in FreshGrade collegata alla rappresentazione dell'utente in Azure AD.
...
Per configurare l'accesso Single Sign-On di Azure AD con FreshGrade, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **FreshGrade** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella pagina **Configura l'accesso Single Sign-On con SAML** eseguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di FreshGrade](common/sp-identifier.png)
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a FreshGrade.
...
2. Nell'elenco delle applicazioni selezionare **FreshGrade**.
    ...
    ![Collegamento di FreshGrade nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-freshgrade-test-user"></a>Creare l'utente di test di FreshGrade

In questa sezione viene creato un utente chiamato Britta Simon in FreshGrade. Collaborare con il  [team di supporto di FreshGrade](mailto:support@freshgrade.com) per aggiungere gli utenti alla piattaforma FreshGrade. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.

### <a name="test-single-sign-on"></a>Testare l'accesso Single Sign-On 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di FreshGrade nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione FreshGrade per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
