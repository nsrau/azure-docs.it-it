...
1. Nella pagina di integrazione dell'applicazione [ Veritas Enterprise Vault.cloud SSO](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
