...
1. Aprire Palo Alto Networks Firewall GlobalProtect come amministratore in un'altra finestra del browser.
...
1. Fare clic su **Test this application** (Testa questa applicazione) nel portale di Azure. Verrà eseguito il reindirizzamento all'URL di accesso di Palo Alto Networks - GlobalProtect, in cui è possibile avviare il flusso di accesso. 
