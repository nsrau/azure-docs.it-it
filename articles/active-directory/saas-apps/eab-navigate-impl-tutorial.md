---
title: "Esercitazione: Integrazione dell'accesso Single Sign-On (SSO) di Azure Active Directory con EAB Navigate IMPL | Microsoft Docs"
description: Informazioni su come configurare l'accesso Single Sign-On tra Azure Active Directory ed EAB Navigate IMPL.
...
* Sottoscrizione di EAB Navigate IMPL abilitata per l'accesso Single Sign-On (SSO).

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* EAB Navigate IMPL supporta l'accesso SSO avviato da **SP**

> [!NOTE]
> Dal momento che l'identificatore di questa applicazione è un valore stringa fisso, è possibile configurare una sola istanza in un solo tenant.

## <a name="adding-eab-navigate-impl-from-the-gallery"></a>Aggiunta di EAB Navigate IMPL dalla raccolta

Per configurare l'integrazione di EAB Navigate IMPL in Azure AD, è necessario aggiungere EAB Navigate IMPL dalla raccolta all'elenco di app SaaS gestite.

1. Accedere al [portale di Azure](https://portal.azure.com) con un account aziendale o dell'istituto di istruzione oppure con un account Microsoft personale.
1. Nel riquadro di spostamento a sinistra selezionare il servizio **Azure Active Directory**.
1. Passare ad **Applicazioni aziendali** e quindi selezionare **Tutte le applicazioni**.
1. Per aggiungere una nuova applicazione, selezionare **Nuova applicazione**.
1. Nella sezione **Aggiungi dalla raccolta** digitare **EAB Navigate IMPL** nella casella di ricerca.
1. Selezionare **EAB Navigate IMPL** nel pannello dei risultati e quindi aggiungere l'app. Attendere alcuni secondi che l'app venga aggiunta al tenant.
...
1. Nella pagina di integrazione dell'applicazione **EAB Navigate IMPL** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
1. Nell'elenco delle applicazioni selezionare **EAB Navigate IMPL**.
...
Quando si fa clic sul riquadro di EAB Navigate IMPL nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di EAB Navigate IMPL per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Provare EAB Navigate IMPL con Azure AD](https://aad.portal.azure.com/)