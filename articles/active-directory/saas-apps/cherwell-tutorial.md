---
title: 'Esercitazione: Integrazione di Azure Active Directory con Cherwell | Microsoft Docs'
...
4. Nella casella di ricerca digitare **Cherwell**, selezionare **Cherwell** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Cherwell nell'elenco risultati](common/search-new-app.png)
...
2. **[Configurare l'accesso Single Sign-On di Cherwell](#configure-cherwell-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Creare un utente di test di Cherwell](#create-cherwell-test-user)**: per avere una controparte di Britta Simon in Cherwell collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Cherwell** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** eseguire il passaggio seguente:
    ...
    Nella casella di testo **URL accesso** digitare un URL nel formato seguente: `https://<companyname>.cherwellondemand.com/cherwellclient`

    > [!NOTE]
    > Poiché non è reale, è necessario aggiornare questo valore con l'URL di accesso effettivo. Per ottenere il valore, contattare il [team di supporto clienti di Cherwell](https://csm.cherwell.com/contact). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
### <a name="configure-cherwell-single-sign-on"></a>Configurare l'accesso Single Sign-On per Cherwell

Per configurare l'accesso Single Sign-On sul lato **Cherwell**, è necessario inviare il file **Certificato (Base64)** scaricato e gli URL appropriati, copiati dal portale di Azure, al [team di supporto di Cherwell](https://csm.cherwell.com/contact). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Cherwell.

1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Cherwell**.

    ![Pannello Applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Cherwell**.

    ![Collegamento di Cherwell nell'elenco Applicazioni](common/all-applications.png)
...
Per consentire agli utenti di Azure AD di accedere a Cherwell, è necessario effettuarne il provisioning in Cherwell. Nel caso di Cherwell, gli account utente devono essere creati dal [team di supporto di Cherwell](https://csm.cherwell.com/contact).
