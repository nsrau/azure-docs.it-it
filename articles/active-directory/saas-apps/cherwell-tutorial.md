...
1. Nella casella di ricerca digitare **Cherwell**.

    ![Creazione di un utente test di Azure AD](./media/cherwell-tutorial/tutorial_cherwell_search.png)

1. Nel pannello dei risultati selezionare **Cherwell** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/cherwell-tutorial/tutorial_cherwell_addfromgallery.png)
...
1. **[Creazione di un utente di test di Cherwell](#creating-a-cherwell-test-user)**: per avere una controparte di Britta Simon in Cherwell collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Cherwell** seguire questa procedura:
...
1. Nella sezione **Configurazione di Cherwell** fare clic su **Configura Cherwell** per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido.**

    ![Configure Single Sign-On](./media/cherwell-tutorial/tutorial_cherwell_configure.png) 

1. Per configurare l'accesso Single Sign-On sul lato **Cherwell**, è necessario inviare il file **Certificato (Base64)** scaricato, l'**URL del servizio Single Sign-On SAML** e l'**ID di entità SAML** al [team di supporto di Cherwell](https://csm.cherwell.com/contact). 
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/cherwell-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/cherwell-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/cherwell-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/cherwell-tutorial/create_aaduser_04.png) 
