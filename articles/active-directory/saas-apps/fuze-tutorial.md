...
1. Nella casella di ricerca digitare **Fuze**.

    ![Creazione di un utente test di Azure AD](./media/fuze-tutorial/tutorial_fuze_000.png)

1. Nel pannello dei risultati selezionare **Fuze** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/fuze-tutorial/tutorial_fuze_0001.png)
...
1. **[Creazione di un utente test Fuze](#creating-a-fuze-test-user)** : per avere una controparte di Britta Simon in Fuze collegata alla relativa rappresentazione in Azure AD.
...
1. Nella sezione **URL e dominio Fuze** seguire questa procedura:
...
1. Per configurare l’accesso Single Sign-On sul lato **Fuze**, è necessario inviare il file di **XML metadati** scaricato al [team di supporto di Fuze](https://www.fuze.com/support). Tale accesso verrà configurato in modo che la connessione SAML SSO sia impostata correttamente su entrambi i lati.
...
1. Nel **portale di gestione di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/fuze-tutorial/create_aaduser_01.png) 

1. Andare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/fuze-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/fuze-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/fuze-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco delle applicazioni selezionare **Fuze**.
