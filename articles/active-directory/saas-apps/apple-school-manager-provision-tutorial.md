...
Questa esercitazione descrive i passaggi da eseguire sia in Apple School Manager che in Azure Active Directory (Azure AD) per configurare il provisioning utenti automatico. Se configurato, Azure AD effettua automaticamente il provisioning e il deprovisioning degli utenti in [Apple School Manager](https://school.apple.com/) usando il servizio di provisioning Azure ad. Per informazioni dettagliate sul funzionamento di questo servizio e domande frequenti, vedere [Automatizzare il provisioning e il deprovisioning utenti in applicazioni SaaS con Azure Active Directory](../manage-apps/user-provisioning.md). 
...
Aggiungere Apple School Manager dalla raccolta di applicazioni Azure AD per iniziare a gestire il provisioning in Apple School Manager. Se in precedenza è stato configurato Apple School Manager per SSO, è possibile usare la stessa applicazione. È tuttavia consigliabile creare un'app separata per il test iniziale dell'integrazione. Per altre informazioni su come aggiungere un'applicazione dalla raccolta, fare clic [qui](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app).
...
* [Esaminare i requisiti di SCIM per Apple School Manager](URL=https://support.apple.com/guide/apple-school-manager/apdd88331cd6)
* [Modalità di utilizzo di un ID persona in Apple School Manager](URL=https://support.apple.com/guide/apple-school-manager/apd69e1e48e9)
* [Usare SCIM per importare gli utenti in Apple School Manager](URL=https://support.apple.com/guide/apple-school-manager/apd3ec7b95ad)
* [Risolvere i conflitti di account utente di SCIM in Apple School Manager](URL=https://support.apple.com/guide/apple-school-manager/apd313013d12)
