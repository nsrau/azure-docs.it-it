...
* CyberArk SAML Authentication supporta l'accesso SSO avviato da **SP e IDP**
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-cyberark-saml-authentication"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per CyberArk SAML Authentication
...
Quando si fa clic sul riquadro di CyberArk SAML Authentication nel Pannello di accesso, si dovrebbe accedere automaticamente all'istanza di CyberArk SAML Authentication per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Provare CyberArk SAML Authentication con Azure AD](https://aad.portal.azure.com/)