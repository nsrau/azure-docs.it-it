...
1. Nella casella di ricerca digitare **OnTrack**, selezionare **OnTrack** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![OnTrack nell'elenco risultati](./media/ontrack-tutorial/tutorial_ontrack_addfromgallery.png)
...
1. **[Creare un utente di test di OnTrack](#create-an-ontrack-test-user)**: per avere una controparte di Britta Simon in OnTrack collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/ontrack-tutorial/tutorial_ontrack_samlbase.png)

1. Nella sezione **URL e dominio OnTrack** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di OnTrack](./media/ontrack-tutorial/tutorial_ontrack_url.png)
...
1. Fare clic sul pulsante **Salva** .
    ...
    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/ontrack-tutorial/tutorial_general_400.png)

1. Per configurare l'accesso Single Sign-On sul lato **OnTrack**, è necessario inviare il file **XML metadati** scaricato al [team di supporto di OnTrack](mailto:CustomerService@insigniagroup.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/ontrack-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/ontrack-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/ontrack-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/ontrack-tutorial/create_aaduser_04.png)
...
In questa sezione viene creato un utente di nome Britta Simon in OnTrack. Per aggiungere utenti alla piattaforma OnTrack, collaborare con il  [team di supporto di OnTrack](mailto:CustomerService@insigniagroup.com) . Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
...
1. Nell'elenco di applicazioni selezionare **OnTrack**.

    ![Collegamento di OnTrack nell'elenco delle applicazioni](./media/ontrack-tutorial/tutorial_ontrack_app.png)  
