...
1. Nella pagina di integrazione dell'applicazione [Autotask Endpoint Backup](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
