...
1. **[Configurare l'accesso Single Sign-On di FortiGate SSL VPN](#configure-fortigate-ssl-vpn-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    1. **[Creare l'utente di test di FortiGate SSL VPN](#create-fortigate-ssl-vpn-test-user)** : per avere una controparte di B.Simon in FortiGate SSL VPN collegata alla rappresentazione dell'utente in Azure AD.
...
Per configurare l'accesso Single Sign-On sul lato **FortiGate SSL VPN**, vedere [questo](https://aka.ms/AA9avum) documento.

> [!NOTE]
> Per altre informazioni sulla configurazione di FortiGate SSL VPN, fare clic su [questo](https://docs.fortinet.com/document/fortigate/6.4.0/new-features/558169/saml-sp-for-vpn-authentication) collegamento.

### <a name="create-fortigate-ssl-vpn-test-user"></a>Creare l'utente di test di FortiGate SSL VPN

In questa sezione viene creato un utente di nome B.Simon in FortiGate SSL VPN. Collaborare con il [team di supporto di FortiGate SSL VPN](mailto:tac_amer@fortinet.com) per aggiungere gli utenti alla piattaforma FortiGate SSL VPN. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
