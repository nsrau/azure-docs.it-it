---
title: 'Esercitazione: Provisioning degli utenti per LucidChart - Azure ADTutorial: User provisioning for LucidChart - Azure AD'
...
4. Impostare la **modalità di provisioning** su **Automatico**.
    ...
    ![Provisioning di LucidChart](./media/lucidchart-provisioning-tutorial/LucidChart1.png)
...
5. Nella sezione **Credenziali amministratore** immettere il **Token segreto** generato dall'account di LucidChart. È possibile trovare il token nell'account: **Team** > **App Integration** > **SCIM** (Team, Integrazione app, SCIM).
    ...
    ![Provisioning di LucidChart](./media/lucidchart-provisioning-tutorial/LucidChart2.png)
