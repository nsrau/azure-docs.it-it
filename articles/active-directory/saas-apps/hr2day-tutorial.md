...
1. Nella casella di ricerca, digitare **HR2day by Merces**.

    ![Creazione di un utente test di Azure AD](./media/hr2day-tutorial/tutorial_hr2daybymerces_search.png)

1. Nel pannello dei risultati selezionare **HR2day by Merces** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/hr2day-tutorial/tutorial_hr2daybymerces_addfromgallery.png)
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Configura accesso Single Sign-On](./media/hr2day-tutorial/tutorial_hr2daybymerces_samlbase.png)

1. Nella sezione **URL e dominio HR2day by Merces** seguire questa procedura:

    ![Configura accesso Single Sign-On](./media/hr2day-tutorial/tutorial_hr2daybymerces_url.png)
...
1. Nella sezione **Certificato di firma SAML** selezionare **Certificato (Base64)** e quindi salvare il file del certificato nel computer.

    ![Configura accesso Single Sign-On](./media/hr2day-tutorial/tutorial_hr2daybymerces_certificate.png) 

1. Questa sezione descrive come consentire agli utenti di eseguire l'autenticazione a HR2day by Merces con il proprio account in Azure AD. A tale scopo, viene usata la federazione basata sul protocollo SAML.
    ...
    ![Configura accesso Single Sign-On](./media/hr2day-tutorial/tutorial_hr2day_00.png)
...
1. Nella sezione **Attributi utente** della finestra di dialogo **Single Sign-On** configurare l'attributo del token SAML come illustrato nell'immagine seguente. Seguire quindi questa procedura.
    ...
    ![Configura accesso Single Sign-On](./media/hr2day-tutorial/tutorial_attribute_04.png)

    ![Configura accesso Single Sign-On](./media/hr2day-tutorial/tutorial_attribute_05.png)
...
1. Fare clic sul pulsante **Salva**.
    ...
    ![Configura accesso Single Sign-On](./media/hr2day-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di HR2day by Merces** fare clic su **Configura HR2day by Merces** per aprire la finestra **Configura accesso**. Copiare **URL di accesso**, **ID di entità SAML** e **URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido**.

    ![Configura accesso Single Sign-On](./media/hr2day-tutorial/tutorial_hr2daybymerces_configure.png) 

1. Per configurare SSO per l'applicazione, contattare il [team di supporto clienti di HR2day by Merces](mailTo:servicedesk@merces.nl). Allegare il file del **certificato (Base64)** scaricato al messaggio di posta elettronica. Specificare anche **URL di disconnessione**, **ID di entità SAML** e **URL del servizio Single Sign-On SAML** per consentirne la configurazione per l'integrazione SSO.
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/hr2day-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/hr2day-tutorial/create_aaduser_02.png) 

1. Per aprire la finestra di dialogo **Utente**, selezionare **Aggiungi** nella parte superiore della finestra di dialogo.
 
    ![Creazione di un utente test di Azure AD](./media/hr2day-tutorial/create_aaduser_03.png) 

1. Nella finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/hr2day-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco delle applicazioni, selezionare **HR2day by Merces**.

    ![Configura accesso Single Sign-On](./media/hr2day-tutorial/tutorial_hr2daybymerces_app.png) 
