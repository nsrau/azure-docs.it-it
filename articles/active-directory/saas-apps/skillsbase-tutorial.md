...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Skills Base con gli account Azure AD personali.
...
Per configurare l'integrazione di Skills Base in Azure AD, è necessario aggiungere Skills Base dalla raccolta all'elenco di app SaaS gestite.
...
In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Skills Base con un utente di test di nome **Britta Simon**.
...
Per configurare e testare l'accesso Single Sign-On di Azure AD con Skills Base, è necessario completare le procedure di base seguenti:
...
5. **[Creare l'utente di test di Skills Base](#create-skills-base-test-user)**: per avere una controparte di Britta Simon in Skills Base collegata alla rappresentazione dell'utente in Azure AD.
...
Per configurare l'accesso Single Sign-On di Azure AD con Skills Base, seguire questa procedura:
...
6. Nella sezione **Configura Skills Base** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Skills Base.
...
2. Nell'elenco delle applicazioni selezionare **Skills Base**.
...
### <a name="create-skills-base-test-user"></a>Creare l'utente di test di Skills Base

In questa sezione viene creato un utente di nome Britta Simon in Skills Base. Skills Base supporta il provisioning utenti JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in Skills Base, ne viene creato uno nuovo dopo l'autenticazione.
