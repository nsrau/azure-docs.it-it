...
4. Nella pagina **Authentication** (Autenticazione) seguire questa procedura:
    ...
    ![Screenshot che mostra la pagina Authentication in cui è possibile immettere i valori descritti.](./media/skillsbase-tutorial/tutorial_skillsbase_save.png)
