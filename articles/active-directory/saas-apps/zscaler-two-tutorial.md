...
1. Nella pagina di integrazione dell'applicazione [Zscaler Two](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
...
6. Nella pagina della finestra di dialogo **Configure User Authentication** seguire questa procedura:
    ...
    ![Amministrazione](./media/zscaler-two-tutorial/ic800207.png)
