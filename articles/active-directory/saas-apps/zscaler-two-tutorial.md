...
4. Nella casella di ricerca digitare **Zscaler Two**, selezionare **Zscaler Two** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![Zscaler Two nell'elenco risultati](./media/zscaler-two-tutorial/tutorial_zscalertwo_addfromgallery.png)
...
3. **[Creazione di un utente di test di Zscaler Two](#creating-a-zscaler-two-test-user)**: per avere una controparte di Britta Simon in Zscaler Two collegata alla rappresentazione dell'utente in Azure AD.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni sull'accesso Single Sign-On per URL e dominio di Zscaler Two](./media/zscaler-two-tutorial/tutorial_zscalertwo_url.png)
...
7. Nella pagina **Certificato di firma SAML**, nella sezione **Certificato di firma SAML** fare clic su **Scarica** per scaricare **Certificato (Base64)** e salvare il file di certificato nel computer in uso.
    ...
    ![Collegamento di download del certificato](./media/zscaler-two-tutorial/tutorial_zscalertwo_certificate.png) 

8. Nella sezione **Configura Zscaler Two** copiare l'URL appropriato in base alle proprie esigenze.
    ...
    ![Configurazione di Zscaler Two](common/configuresection.png)

9. In un'altra finestra del Web browser accedere al sito aziendale di Zscaler Two come amministratore.
...
L'obiettivo di questa sezione consiste nel creare un utente chiamato Britta Simon in Zscaler Two. Zscaler Two supporta il provisioning just-in-time, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Durante un tentativo di accesso a Zscaler Two viene creato un nuovo utente, se non esiste già.
>[!Note]
>Se è necessario creare manualmente un utente contattare il  [team di supporto di Zscaler Two](https://www.zscaler.com/company/contact).
