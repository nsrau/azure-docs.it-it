...
4. Nella casella di ricerca digitare **Aravo**.
    ...
    ![Creazione di un utente test di Azure AD](./media/aravo-tutorial/tutorial_aravo_search.png)

5. Nel pannello dei risultati selezionare **Aravo** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/aravo-tutorial/tutorial_aravo_addfromgallery.png)
...
3. Nella sezione **URL e dominio Aravo** eseguire i passaggi descritti di seguito:
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore e l'URL di risposta effettivi. Per ottenere questi valori, contattare il [team di supporto di Aravo](https://www.aravo.com/about-us/contact/).
...
7. Per configurare l'accesso Single Sign-On sul lato **Aravo**, è necessario inviare il file di **Certificato (Base64)** scaricato, **l'URL di disconnessione, l'ID entità SAML e l'URL del servizio Single Sign-On SAML** al [team di supporto di Aravo](https://www.aravo.com/about-us/contact/). 
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/aravo-tutorial/create_aaduser_01.png) 

2. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/aravo-tutorial/create_aaduser_02.png) 

3. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/aravo-tutorial/create_aaduser_03.png) 

4. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/aravo-tutorial/create_aaduser_04.png) 
...
L'obiettivo di questa sezione consiste nel creare un utente chiamato Britta Simon in Aravo. Collaborare con il [team di supporto di Aravo](https://www.aravo.com/about-us/contact/) per aggiungere gli utenti nell'account Aravo.
