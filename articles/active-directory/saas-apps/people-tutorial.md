...
1. Nella casella di ricerca digitare **People**.

    ![Creazione di un utente test di Azure AD](./media/people-tutorial/tutorial_people_search.png)

1. Nel pannello dei risultati selezionare **People** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/people-tutorial/tutorial_people_addfromgallery.png)
...
1. **[Creazione di un utente test di People](#creating-a-people-test-user)**: per avere una controparte di Britta Simon in People collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio People** seguire questa procedura:
...
1. In **Upload 'Single Sign On' SAML meta-data file** (Carica il file dei metadati SAML "Single Sign-On") fare clic su **Browse** (Sfoglia) per caricare il file di metadati scaricato.
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/people-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/people-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/people-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/people-tutorial/create_aaduser_04.png) 
