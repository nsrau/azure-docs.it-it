...
Per configurare l'integrazione di ADP Globalview in Azure AD è necessario aggiungere ADP Globalview dalla raccolta all'elenco di app SaaS gestite.
...
Quando si fa clic sul riquadro di ADP Globalview nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di ADP Globalview per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
