...
4. Nella sezione **Impostazioni Single Sign-on (SSO)** eseguire questa procedura:
    ...
    ![Impostazioni per l'accesso Single Sign-On](./media/logicmonitor-tutorial/ic790054.png "Single Sign-On Settings")
...
4. Nella sezione **Aggiungi un account** eseguire la procedura seguente:
    ...
    ![Aggiungere un account](./media/logicmonitor-tutorial/ic790057.png "Aggiungi un account")
