...
* Al momento, le richieste GET a Azure Databricks ' API SCIM per gli utenti fanno distinzione tra maiuscole e minuscole. Se si esegue una query per USER@contoso.com, verranno restituiti 0 risultati durante l'archiviazione come user@contoso.com.
