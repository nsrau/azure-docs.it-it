...
1. Nella sezione **URL e dominio Jostle** seguire questa procedura:
    ...
    a. Nella casella di testo **URL di accesso** inserire: `https://login-prod.jostle.us`

    b. Nella casella di testo **Identificatore** inserire: `https://jostle.us`

    c. Selezionare la casella **Mostra impostazioni URL avanzate**
