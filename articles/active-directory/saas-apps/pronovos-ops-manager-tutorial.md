...
1. Nella pagina di integrazione dell'applicazione **ProNovos Ops Manager** del [portale di Azure](https://portal.azure.com/) trovare la sezione **Gestione** e selezionare **Single Sign-On**.
...
### <a name="configure-pronovos-ops-manager-sso"></a>Configurare l'accesso SSO di ProNovos Ops Manager
...
Quando si fa clic sul riquadro di ProNovos Ops Manager nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione ProNovos Ops Manager per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
