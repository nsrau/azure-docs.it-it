...
1. Nella casella di ricerca digitare **Leapsome**, selezionare **Leapsome** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
1. **[Creare un utente test di Leapsome](#create-a-leapsome-test-user)**: per avere una controparte di Britta Simon in Leapsome collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Leapsome** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:
...
1. Nella sezione **Configurazione di Leapsome** fare clic su **Configura Leapsome** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**
