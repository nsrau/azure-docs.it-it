...
1. Nella casella di ricerca digitare **CylancePROTECT**, selezionare **CylancePROTECT** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![CylancePROTECT nell'elenco dei risultati](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_addfromgallery.png)
...
1. **[Creare un utente di test di CylancePROTECT](#create-a-cylanceprotect-test-user)**: per definire una controparte di Britta Simon in CylancePROTECT collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_samlbase.png)

1. Nella sezione **URL e dominio CylancePROTECT** eseguire queste operazioni:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On per CylancePROTECT](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Collegamento di download del certificato](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/cylanceprotect-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di CylancePROTECT** fare clic su **Configura CylancePROTECT** per aprire la finestra **Configura accesso**. Copiare l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**

    ![Configurazione di CylancePROTECT](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_configure.png) 
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/cylanceprotect-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/cylanceprotect-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/cylanceprotect-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/cylanceprotect-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **CylancePROTECT**.
    ...
    ![Collegamento CylancePROTECT nell'elenco delle applicazioni](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_app.png)  
