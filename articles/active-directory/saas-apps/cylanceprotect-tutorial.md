...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a CylancePROTECT con gli account Azure AD personali.
...
Per configurare l'accesso Single Sign-On di Azure AD con CylancePROTECT, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **CylancePROTECT** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
In questa sezione viene creato un utente di nome Britta Simon in CylancePROTECT. Collaborare con l'amministratore della console per aggiungere gli utenti alla piattaforma CylancePROTECT. Il titolare dell'account Azure Active Directory riceverà un messaggio di posta elettronica con un collegamento da selezionare per confermare l'account e attivarlo.
