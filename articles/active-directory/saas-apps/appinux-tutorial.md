...
* È possibile consentire agli utenti l'accesso automatico (Single Sign-On) ad Appinux con i rispettivi account Azure AD.
...
* Sottoscrizione di Appinux abilitata per l'accesso Single Sign-On
...
4. Nella casella di ricerca digitare **Appinux**, selezionare **Appinux** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Appinux nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Appinux con un utente di test di nome **Britta Simon**.
Per il funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Appinux.
...
2. **[Configurare l'accesso Single Sign-On di Appinux](#configure-appinux-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente di test di Appinux](#create-appinux-test-user)**: per avere una controparte di Britta Simon in Appinux collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Appinux** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
8. Nella sezione **Configura Appinux** copiare gli URL appropriati in base alle proprie esigenze.
...
### <a name="configure-appinux-single-sign-on"></a>Configurare l'accesso Single Sign-On di Appinux
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Appinux**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco di applicazioni selezionare **Appinux**.

    ![Collegamento di Appinux nell'elenco delle applicazioni](common/all-applications.png)
...
Facendo clic sul riquadro Appinux nel pannello di accesso si dovrebbe accedere automaticamente all'applicazione Appinux per cui è stato configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
