...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a 15Five con gli account Azure AD.
...
* 15Five supporta l'accesso SSO avviato da **SP**
...
4. Nella casella di ricerca digitare **15Five**, selezionare **15Five** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![15Five nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con 15Five usando un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in 15Five.

Per configurare e testare l'accesso Single Sign-On di Azure AD con 15Five, è necessario completare le procedure di base seguenti:
...
1. Nella pagina di integrazione dell'applicazione **15Five** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di 15Five](common/sp-identifier.png)

    a. Nella casella di testo **URL di accesso** digitare un URL usando il modello seguente: `https://<companyname>.15five.com`
...
6. Nella sezione **Set up 15Five** (Configura 15Five) copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-15five-single-sign-on"></a>Configurare l'accesso Single Sign-On per 15Five

Per configurare l'accesso Single Sign-On sul lato **15Five**, è necessario inviare il file di **XML metadati federazione** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di 15Five](https://www.15five.com/contact/). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **15Five**.
...
### <a name="create-15five-test-user"></a>Creare l'utente di test di 15Five
...
2. Passare a **Manage Company** (Gestisci società).
...
4. Nella sezione **Add New Person** (Aggiungi nuova persona) seguire questa procedura:
    ...
    a. Digitare il **nome**, il **cognome**, il **titolo**, l'**indirizzo di posta elettronica** di un account utente Azure Active Directory valido di cui si vuole eseguire il provisioning.

    b. Fare clic su **Done** (Fine).
...
Quando si fa clic sul riquadro di 15Five nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione 15Five per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
