...
*   JIRA supporta anche le versioni 6.0 e 7.8. Per informazioni dettagliate, fare clic su [JIRA SAML SSO by Microsoft](jiramicrosoft-tutorial.md)
...
3. **[Creare un utente test di JIRA SAML SSO by Microsoft (V5.2)](#create-a-jira-saml-sso-by-microsoft-v52-test-user)**: per avere una controparte di Britta Simon in JIRA SAML SSO by Microsoft (V5.2) collegata alla rappresentazione dell'utente in Azure AD.
...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/jira52microsoft-tutorial/tutorial_singlesign-onforjira5.2_samlbase.png)
...
3. Nella sezione **JIRA SAML SSO by Microsoft Domain and URLs** (URL e dominio di JIRA SAML SSO by Microsoft) seguire questa procedura:
    ...
    ![Informazioni sull'accesso Single Sign-On per il dominio e l'URL di JIRA SAML SSO by Microsoft](./media/jira52microsoft-tutorial/tutorial_singlesign-onforjira5.2_url.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/jira52microsoft-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/jira52microsoft-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/jira52microsoft-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/jira52microsoft-tutorial/create_aaduser_04.png)
...
**Per assegnare Britta Simon a JIRA SAML SSO by Microsoft (V5.2), seguire questa procedura:**
...
2. Nell'elenco delle applicazioni selezionare **JIRA SAML SSO by Microsoft (V5.2)**.
    ...
    ![Il collegamento JIRA SAML SSO by Microsoft (V5.2) nell'elenco delle applicazioni](./media/jira52microsoft-tutorial/tutorial_singlesign-onforjira5.2_app.png)
