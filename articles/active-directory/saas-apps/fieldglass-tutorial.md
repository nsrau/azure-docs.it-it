...
1. Nella casella di ricerca digitare **FieldGlass**.

    ![Creazione di un utente test di Azure AD](./media/fieldglass-tutorial/tutorial_fieldglass_search.png)

1. Nel pannello dei risultati selezionare **Fieldglass** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/fieldglass-tutorial/tutorial_fieldglass_addfromgallery.png)
...
1. **[Creazione di un utente test di Fieldglass](#creating-a-fieldglass-test-user)**: per avere una controparte di Britta Simon in Fieldglass collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Fieldglass** seguire questa procedura:
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore e l'URL di risposta effettivi. Per ottenere questi valori contattare il [team di supporto clienti di Fieldglass](https://www.fieldglass.com/customer-support).
...
1. Nella sezione **Configurazione di Fieldglass** fare clic su **Configura Fieldglass** per aprire la finestra **Configura accesso**. Copiare i valori **Sign-Out URL (URL di disconnessione) e SAML Entity ID (ID entità SAML)** dalla **sezione Quick Reference** (Riferimento rapido).

    ![Configure Single Sign-On](./media/fieldglass-tutorial/tutorial_fieldglass_configure.png) 

1. Per configurare l'accesso Single Sign-On sul lato **Fieldglass** è necessario inviare il file **Certificato (Base64)** scaricato e i valori **Sign-Out URL (URL di disconnessione) e SAML Entity ID (ID entità SAML)** al [team di supporto di Fieldglass](https://www.fieldglass.com/customer-support). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/fieldglass-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/fieldglass-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/fieldglass-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/fieldglass-tutorial/create_aaduser_04.png) 
...
Questa sezione descrive come creare un utente chiamato Britta Simon in Fieldglass. Collaborare con il [team di supporto di Fieldglass](https://www.fieldglass.com/customer-support) per aggiungere gli utenti nell'account Fieldglass.
...
1. Nell'elenco delle applicazioni, selezionare **FieldGlass**.
