...
4. Nella casella di ricerca digitare **RightAnswers**.

    ![Creazione di un utente test di Azure AD](./media/rightanswers-tutorial/tutorial_rightanswers_search.png)

5. Nel pannello dei risultati selezionare **RightAnswers** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
3. **[Creazione di un utente di test di RightAnswers](#creating-a-rightanswers-test-user)**: per avere una controparte di Britta Simon in RightAnswers collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **URL e dominio RightAnswers** seguire questa procedura:
...
6. Per configurare l'accesso Single Sign-On sul lato **RightAnswers**, è necessario inviare il file **XML metadati** scaricato al [team di supporto di RightAnswers](https://www.rightanswers.com/contact-us/).
