...
- È possibile abilitare gli utenti per l'accesso automatico a RightAnswers (Single Sign-On) con gli account Azure AD personali
...
1. Aggiunta di RightAnswers dalla raccolta
...
1. Nella casella di ricerca digitare **RightAnswers**.

    ![Creazione di un utente test di Azure AD](./media/rightanswers-tutorial/tutorial_rightanswers_search.png)

1. Nel pannello dei risultati selezionare **RightAnswers** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/rightanswers-tutorial/tutorial_rightanswers_addfromgallery.png)
...
Per il funzionamento dell'accesso Single Sign-On, Azure AD deve conoscere l'utente controparte di RightAnswers corrispondente a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in RightAnswers.

Per stabilire la relazione di collegamento, in RightAnswers assegnare il valore del **nome utente** in Azure AD come valore di **Username** (Nome utente).
...
1. **[Creazione di un utente di test di RightAnswers](#creating-a-rightanswers-test-user)**: per avere una controparte di Britta Simon in RightAnswers collegata alla rappresentazione dell'utente in Azure AD.
1. **[Assegnazione dell'utente test di Azure AD](#assigning-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
1. **[Testing Single Sign-On](#testing-single-sign-on)** : per verificare se la configurazione funziona.

### <a name="configuring-azure-ad-single-sign-on"></a>Configurazione dell'accesso Single Sign-On di Azure AD

In questa sezione viene abilitato l'accesso Single Sign-On di Azure AD nel portale di Azure e viene configurato l'accesso Single Sign-On nell'applicazione RightAnswers.

**Per configurare l'accesso Single Sign-On di Azure AD con RightAnswers, seguire questa procedura:**

1. Nella pagina di integrazione dell'applicazione **RightAnswers** del portale di Azure fare clic su **Single Sign-On**.
...
1. Nella sezione **URL e dominio RightAnswers** seguire questa procedura:

    ![Configure Single Sign-On](./media/rightanswers-tutorial/tutorial_rightanswers_url.png)

    a. Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://<subdomain>.rightanswers.com/portal/ss/`

    b. Nella casella di testo **Identificatore** digitare l'URL adottando il modello seguente: `https://<subdomain>.rightanswers.com:<identifier>/portal`

    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con l'identificatore e l'URL di accesso effettivi. Per ottenere questi valori, contattare il [team di supporto di RightAnswers](https://www.rightanswers.com/contact-us/). 
...
1. Per configurare l'accesso Single Sign-On sul lato **RightAnswers**, è necessario inviare il file **XML metadati** scaricato al [team di supporto di RightAnswers](https://www.rightanswers.com/contact-us/).
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/rightanswers-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/rightanswers-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/rightanswers-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/rightanswers-tutorial/create_aaduser_04.png) 
...
### <a name="creating-a-rightanswers-test-user"></a>Creazione di un utente di test di RightAnswers
...
**Per assegnare Britta Simon a RightAnswers, seguire questa procedura:**

1. Nel portale di Azure aprire la visualizzazione delle applicazioni e quindi la visualizzazione delle directory e passare ad **Applicazioni aziendali**, quindi fare clic su **Tutte le applicazioni**.

    ![Assegna utente][201] 

1. Nell'elenco delle applicazioni selezionare **RightAnswers**.
...
Per testare le impostazioni di SSO, aprire il pannello di accesso. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/active-directory-saas-access-panel-introduction.md).
