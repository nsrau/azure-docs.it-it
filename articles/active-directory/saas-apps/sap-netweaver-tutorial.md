...
1. Nella casella di ricerca digitare **SAP NetWeaver**.

    ![Creazione di un utente test di Azure AD](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_search.png)

1. Nel pannello dei risultati selezionare **SAP NetWeaver** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_addfromgallery.png)
...
1. **[Creazione di un utente test di SAP NetWeaver](#creating-an-sap-netweaver-test-user)**: per avere una controparte di Britta Simon in SAP NetWeaver collegata alla relativa rappresentazione in Azure AD.
...
1. Nella sezione **URL e dominio SAP NetWeaver** seguire questa procedura:
...
1. Nella sezione **Configurazione di SAP NetWeaver** fare clic su **Configura SAP NetWeaver** per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML** dalla **sezione di riferimento rapido.**

    ![Configure Single Sign-On](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_configure.png) 

1. Per configurare l'accesso Single Sign-On sul lato **SAP NetWeaver**, è necessario inviare il file **XML metadati** e l'**ID di entità SAML** al [team di supporto di SAP NetWeaver](https://www.sap.com/support.html). 
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/sap-netweaver-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/sap-netweaver-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/sap-netweaver-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/sap-netweaver-tutorial/create_aaduser_04.png) 
