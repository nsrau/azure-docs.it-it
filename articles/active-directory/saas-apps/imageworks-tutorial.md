...
1. Nella casella di ricerca digitare **IMAGE WORKS**, selezionare **IMAGE WORKS** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![IMAGE WORKS nell'elenco dei risultati](./media/imageworks-tutorial/tutorial_imageworks_addfromgallery.png)
...
1. **[Creare un utente di test di IMAGE WORKS](#create-a-image-works-test-user)**: per avere una controparte di Britta Simon in IMAGE WORKS collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/imageworks-tutorial/tutorial_imageworks_samlbase.png)

1. Nella sezione **URL e dominio IMAGE WORKS** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di IMAGE WORKS](./media/imageworks-tutorial/tutorial_imageworks_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Collegamento di download del certificato](./media/imageworks-tutorial/tutorial_imageworks_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/imageworks-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di IMAGE WORKS** fare clic su **Configura IMAGE WORKS** per aprire la finestra **Configura accesso**. Copiare **l'URL di disconnessione, l'ID entità SAML e l'URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido**.

    ![Configurazione di IMAGE WORKS](./media/imageworks-tutorial/tutorial_imageworks_configure.png) 
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/imageworks-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/imageworks-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/imageworks-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/imageworks-tutorial/create_aaduser_04.png)
...
In questa sezione viene creato un utente di nome Britta Simon in IMAGE WORKS. Collaborare con il  [team di supporto di IMAGE WORKS](mailto:iw-sd-support@fujifilm.com) per aggiungere gli utenti alla piattaforma IMAGE WORKS. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
...
1. Nell'elenco delle applicazioni selezionare **IMAGE WORKS**.

    ![Collegamento di IMAGE WORKS nell'elenco delle applicazioni](./media/imageworks-tutorial/tutorial_imageworks_app.png)  
