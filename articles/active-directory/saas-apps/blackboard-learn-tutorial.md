...
## <a name="configure-and-test-azure-ad-single-sign-on-for-blackboard-learn"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per Blackboard Learn
...
Per configurare e testare l'accesso SSO di Azure AD con Blackboard Learn, completare le procedure di base seguenti:
...
1. Nella pagina di integrazione dell'applicazione **Blackboard Learn** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
Quando si fa clic sul riquadro di Blackboard Learn nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Blackboard Learn per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Provare Blackboard Learn con Azure AD](https://aad.portal.azure.com/)