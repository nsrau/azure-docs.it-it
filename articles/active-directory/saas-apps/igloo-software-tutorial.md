...
Per configurare l'integrazione di Igloo Software in Azure AD è necessario aggiungere Igloo Software dalla raccolta all'elenco di app SaaS gestite.
...
Per configurare e testare l'accesso Single Sign-On di Azure AD con Igloo Software è necessario completare le procedure di base seguenti:
...
5. **[Creare l'utente di test di Igloo Software](#create-igloo-software-test-user)** : per avere una controparte di Britta Simon in Igloo Software collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella scheda **Membership** (Appartenenza) fare clic su **Sign In Settings** (Impostazioni di accesso).
...
4. Nella sezione relativa alla configurazione SAML fare clic su **Configure SAML Authentication**.
    ...
    ![Configurazione SAML](./media/igloo-software-tutorial/ic783969.png "SAML Configuration")

5. Nella sezione **General Configuration** (Configurazione generale) seguire questa procedura:
...
6. In **Response and Authentication Configuration** (Configurazione risposta e autenticazione) seguire questa procedura:
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Igloo Software.
...
### <a name="create-igloo-software-test-user"></a>Creare l'utente di test di Igloo Software
