...
In questa sezione viene creato un utente di nome B.Simon in Cloudmore. Collaborare con il [team di supporto di Cloudmore](mailto:platformsupport@cloudmore.com) per aggiungere gli utenti alla piattaforma Cloudmore. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
