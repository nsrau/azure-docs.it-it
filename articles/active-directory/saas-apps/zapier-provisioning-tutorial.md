...
Aggiungere Zapier dalla raccolta di applicazioni Azure AD per iniziare a gestire il provisioning in Zapier. Se in precedenza è stato configurato Zapier per SSO, è possibile usare la stessa applicazione. È tuttavia consigliabile creare un'app separata per il test iniziale dell'integrazione. Per altre informazioni su come aggiungere un'applicazione dalla raccolta, fare clic [qui](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
