...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) ad AppNeta Performance Monitor con gli account Azure AD personali.
...
4. Nella casella di ricerca digitare **AppNeta Performance Monitor**, selezionare **AppNeta Performance Monitor** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![AppNeta Performance Monitor nell'elenco risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in AppNeta Performance Monitor.
...
2. **[Configurare l'accesso Single Sign-On per AppNeta Performance Monitor](#configure-appneta-performance-monitor-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
...
1. Nella pagina di integrazione dell'applicazione **AppNeta Performance Monitor** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di AppNeta Performance Monitor](common/sp-identifier.png)

    a. Nella casella di testo **URL di accesso** digitare un URL usando il modello seguente: `https://<subdomain>.pm.appneta.com`
...
8. Nella sezione **Set up AppNeta Performance Monitor** (Configura AppNeta Performance Monitor) copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-appneta-performance-monitor-single-sign-on"></a>Configurare l'accesso Single Sign-On per AppNeta Performance Monitor
