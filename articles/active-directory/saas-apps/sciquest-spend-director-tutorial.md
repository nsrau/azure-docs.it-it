...
1. Nella casella di ricerca digitare **SciQuest Spend Director**, selezionare **SciQuest Spend Director** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![SciQuest Spend Director nell'elenco dei risultati](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_addfromgallery.png)
...
1. **[Creare un utente di test di SciQuest Spend Director](#create-a-sciquest-spend-director-test-user)**: per avere una controparte di Britta Simon in SciQuest Spend Director collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_samlbase.png)

1. Nella sezione **URL e dominio SciQuest Spend Director** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di SciQuest Spend Director](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/sciquest-spend-director-tutorial/tutorial_general_400.png)

1. Per configurare l'accesso Single Sign-On sul lato **SciQuest Spend Director**, è necessario inviare il file **XML metadati** scaricato al [team di supporto di SciQuest Spend Director](https://www.jaggaer.com/contact-us/).
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/sciquest-spend-director-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/sciquest-spend-director-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/sciquest-spend-director-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/sciquest-spend-director-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **SciQuest Spend Director**.

    ![Collegamento di SciQuest Spend Director nell'elenco delle applicazioni](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_app.png)  
