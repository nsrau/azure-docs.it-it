...
1. Nella pagina **Configura l'accesso Single Sign-On con SAML** eseguire questa procedura:
    ...
    a. Nella casella di testo **Identificatore** digitare un URL nel formato seguente: `https://<SUBDOMAIN>.otsuka-shokai.co.jp/S000000100`

    b. Nella casella di testo **URL di risposta** digitare un URL nel formato seguente: `https://<SUBDOMAIN>.otsuka-shokai.co.jp/ResponseOffice365`

    > [!NOTE]
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore e l'URL di risposta effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di Otsuka Shokai](mailto:Tatsuya.Satoh@otsuka-shokai.co.jp). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
1. Nella sezione **Configura Otsuka Shokai** copiare gli URL appropriati in base alle esigenze.

   ![Copiare gli URL di configurazione](common/copy-configuration-urls.png)

### <a name="configure-otsuka-shokai"></a>Configurare Otsuka Shokai

Per configurare l'accesso Single Sign-On sul lato **Otsuka Shokai**, è necessario inviare l'**URL dei metadati di federazione dell'app** al [team di supporto di Otsuka Shokai](mailto:Tatsuya.Satoh@otsuka-shokai.co.jp). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
In questa sezione viene creato un utente di nome Britta Simon in Otsuka Shokai. Collaborare con il [team di supporto di Otsuka Shokai](mailto:Tatsuya.Satoh@otsuka-shokai.co.jp) per aggiungere gli utenti alla piattaforma Otsuka Shokai. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
