---
title: 'Esercitazione: Integrazione di Azure Active Directory con Euromonitor Passport | Microsoft Docs'
...
Questa esercitazione descrive come integrare Euromonitor Passport con Azure Active Directory (Azure AD).
...
Per configurare l'integrazione di Azure AD con Euromonitor Passport, sono necessari gli elementi seguenti:

* Una sottoscrizione di Azure AD. Se non si dispone di un ambiente Azure AD, è possibile ottenere una versione di valutazione di un mese [qui](https://azure.microsoft.com/pricing/free-trial/)
* Sottoscrizione di Euromonitor Passport abilitata per l'accesso Single Sign-On
...
Per configurare l'accesso Single Sign-On di Azure AD con Euromonitor Passport, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **Euromonitor Passport** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Euromonitor Passport**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Euromonitor Passport**.

    ![Collegamento di Euromonitor Passport nell'elenco delle applicazioni](common/all-applications.png)
