...
5. **[Creare un utente di test di iProva](#create-iprova-test-user)**: per avere una controparte di Britta Simon in iProva collegata alla rappresentazione dell'utente in Azure AD.
...
In questa sezione verranno recuperate alcune informazioni essenziali da iProva.
Queste informazioni saranno necessarie per configurare l'accesso Single Sign-On di Azure AD

1. Aprire un Web browser e passare alla **pagina delle informazioni SAML2** in iProva, usando il modello di URL seguente:
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    a. Compilare il campo **Identificatore** con il valore visualizzato con l'etichetta **EntityID** nella **pagina delle informazioni SAML2 in iProva** (aperta nell'altra scheda del browser).

    b. Compilare il campo **URL di risposta** con il valore visualizzato con l'etichetta **Reply URL** (URL di risposta) nella **pagina delle informazioni SAML2 in iProva** (aperta nell'altra scheda del browser).

    c. Compilare il campo **URL di accesso** con il valore visualizzato con l'etichetta **Sign-on URL** (URL di accesso) nella **pagina delle informazioni SAML2 in iProva** (aperta nell'altra scheda del browser).
...
1. Accedere a iProva usando l'account di **amministratore**.

2. Aprire il menu **Go to** (Vai a).

3. Fare clic su **Application management** (Gestione applicazione).

4. Fare clic su **General** (Generale) nel pannello **System settings** (Impostazioni di sistema).
...
7. Individuare l'impostazione **Users are automatically logged on with their network accounts** (Gli utenti vengono connessi automaticamente con i propri account di rete) e modificarla in **Yes, authentication via SAML** (Sì, autenticazione tramite SAML). Verranno visualizzate le opzioni aggiuntive.

8. Fare clic sul pulsante **Setup** (Configurazione).

9. Fare clic sul pulsante **Next** (Avanti).

10. A questo punto, iProva richiederà se si vuole scaricare i dati della federazione da un URL oppure caricarli da un file. Selezionare l'opzione **from URL** (da URL).

    ![Scaricare i metadati di Azure AD](media/iprova-tutorial/iprova-download-metadata.png)

11. Incollare l'URL dei metadati salvato nell'ultimo passaggio del capitolo **Configurare l'accesso Single Sign-On di Azure AD**.

12. Fare clic sul pulsante a forma di freccia per scaricare i metadati da Azure AD.
...
14. Fare clic sul pulsante **Next** (Avanti).

15. Per il momento, ignorare l'opzione **Test login** (Accesso di test) e fare clic sul pulsante **Next** (Avanti).

16. Nell'elenco a discesa denominato **Claim to use** (Attestazione per l'uso) selezionare **windowsaccountname**.

17. Fare clic sul pulsante **Fine**.

18. Tornare alla schermata **Edit general settings** (Modifica impostazioni generali). **Scorrere verso il basso** fino alla parte inferiore della pagina e fare clic sul pulsante **OK** per salvare la configurazione.
...
3. In Proprietà utente seguire questa procedura.
    ...
    a. Nel campo **Nome** immettere il nome come **BrittaSimon**.
  
    b. Nel campo **Nome utente** digitare **yourname@yourcompanydomain.extension**  
...
4. Fare clic su **Users** (Utenti) nel pannello **Users and user groups** (Utenti e gruppi di utenti).

5. Fare clic su **Add** .

6. Nel campo **Username** (Nome utente) digitare **brittasimon@yourcompanydomain.extension**  
    Ad esempio: BrittaSimon@contoso.com

7. Nel campo **Full name** (Nome completo) immettere il nome completo come **BrittaSimon**.

8. Selezionare l'opzione **No password (use single sign-on)** (Nessuna password - usa Single Sign-On).

9. Nel campo **E-mail address** (Indirizzo di posta elettronica) digitare **yourname@yourcompanydomain.extension**, ad esempio BrittaSimon@contoso.com

10. Scorrere fino alla fine della pagina e fare clic sul pulsante **Finish** (Fine).
