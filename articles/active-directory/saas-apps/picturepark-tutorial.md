...
Quando si fa clic sul riquadro Picturepark nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Picturepark. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/active-directory-saas-access-panel-introduction.md).
