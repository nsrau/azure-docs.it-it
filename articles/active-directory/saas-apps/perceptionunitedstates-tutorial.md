...
1. Nella casella di ricerca digitare **Perception United States (Non-UltiPro)**, selezionare **Perception United States (Non-UltiPro)** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Perception United States (Non-UltiPro) nell'elenco risultati](./media/perceptionunitedstates-tutorial/tutorial_perceptionunitedstates_addfromgallery.png)
...
1. **[Creare un utente di test di Perception United States (Non-UltiPro)](#create-a-perception-united-states-non-ultipro-test-user)**: per avere una controparte di Britta Simon in Perception United States (Non-UltiPro) collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/perceptionunitedstates-tutorial/tutorial_perceptionunitedstates_samlbase.png)

1. Nella sezione **URL e dominio Perception United States (Non-UltiPro)** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Perception United States (Non-UltiPro)](./media/perceptionunitedstates-tutorial/tutorial_perceptionunitedstates_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/perceptionunitedstates-tutorial/tutorial_perceptionunitedstates_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/perceptionunitedstates-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di Perception United States (Non-UltiPro)** fare clic su **Configura Perception United States (Non-UltiPro)** per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML** dalla **sezione di riferimento rapido.**
    ...
    ![Configurazione di Perception United States (Non-UltiPro)](./media/perceptionunitedstates-tutorial/tutorial_perceptionunitedstates_configure.png) 
...
1. Sulla barra degli strumenti principale fare clic su **Account Settings** (Impostazioni account).
...
1. Nella pagina **Account Settings** (Impostazioni account) seguire questa procedura:
...
1. Nella pagina **SSO Configuration** (Configurazione SSO) seguire questa procedura:
    ...
    d. Nelle **casella di testo SAML Domain**, immettere il dominio, ad esempio  **\@contoso.com**.
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/perceptionunitedstates-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/perceptionunitedstates-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/perceptionunitedstates-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/perceptionunitedstates-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **Perception United States (Non-UltiPro)**.

    ![Collegamento di Perception United States (Non-UltiPro) nell'elenco delle applicazioni](./media/perceptionunitedstates-tutorial/tutorial_perceptionunitedstates_app.png)  
