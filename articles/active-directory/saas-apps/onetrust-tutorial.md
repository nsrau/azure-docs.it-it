...
* È possibile controllare in Azure AD chi può accedere a OneTrust Privacy Management Software.
...
Per configurare l'integrazione di OneTrust Privacy Management Software in Azure AD, è necessario aggiungere OneTrust Privacy Management Software dalla raccolta all'elenco di app SaaS gestite.
...
4. Nella casella di ricerca digitare **OneTrust Privacy Management Software**, selezionare **OneTrust Privacy Management Software** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![OneTrust Privacy Management Software nell'elenco risultati](common/search-new-app.png)
...
Per configurare e testare l'accesso Single Sign-On di Azure AD con OneTrust Privacy Management Software, è necessario completare le procedure di base seguenti:
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di OneTrust Privacy Management Software](common/idp-intiated.png)
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di OneTrust Privacy Management Software](common/metadata-upload-additional-signon.png)
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a OneTrust Privacy Management Software.
