---
title: 'Esercitazione: Integrazione di Azure Active Directory con OneTrust Privacy Management Software | Microsoft Docs'
...
1. Nella casella di ricerca digitare **OneTrust Privacy Management Software**, selezionare **OneTrust Privacy Management Software** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![OneTrust Privacy Management Software nell'elenco dei risultati](./media/onetrust-tutorial/tutorial_onetrust_addfromgallery.png)
...
1. **[Creare un utente di test di OneTrust Privacy Management Software](#create-a-onetrust-privacy-management-software-test-user)**: per avere una controparte di Britta Simon in OneTrust Privacy Management Software collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/onetrust-tutorial/tutorial_onetrust_samlbase.png)

1. Nella sezione **URL e dominio OneTrust Privacy Management Software** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:

    ![Informazioni sull'accesso Single Sign-On a URL e dominio di OneTrust Privacy Management Software](./media/onetrust-tutorial/tutorial_onetrust_url.png)
...
1. Selezionare **Mostra impostazioni URL avanzate** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni sull'accesso Single Sign-On a URL e dominio di OneTrust Privacy Management Software](./media/onetrust-tutorial/tutorial_onetrust_url1.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/onetrust-tutorial/tutorial_onetrust_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/onetrust-tutorial/tutorial_general_400.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/onetrust-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/onetrust-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/onetrust-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/onetrust-tutorial/create_aaduser_04.png)
...
>[!Note]
>Per creare un utente manualmente, contattare il  [team di supporto di OneTrust Privacy Management Software](mailto:support@onetrust.com).
...
1. Nell'elenco delle applicazioni, selezionare **OneTrust Privacy Management Software**.
    ...
    ![Collegamento di OneTrust Privacy Management Software nell'elenco delle applicazioni](./media/onetrust-tutorial/tutorial_onetrust_app.png)  
