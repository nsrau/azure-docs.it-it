...
1. Nella pagina di integrazione dell'applicazione [OneTrust Privacy Management Software](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
