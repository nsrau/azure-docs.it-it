...
1. Nella casella di ricerca digitare **Versal**, selezionare **Versal** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Versal nell'elenco risultati](./media/versal-tutorial/tutorial_versal_addfromgallery.png)
...
1. **[Creare un utente di test di Versal](#create-a-versal-test-user)**: per avere una controparte di Britta Simon in Versal collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/versal-tutorial/tutorial_versal_samlbase.png)

1. Nella sezione **URL e dominio Versal** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Versal](./media/versal-tutorial/tutorial_versal_url.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/versal-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/versal-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/versal-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/versal-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **Versal**.
    ...
    ![Collegamento di Versal nell'elenco delle applicazioni](./media/versal-tutorial/tutorial_versal_app.png)  
