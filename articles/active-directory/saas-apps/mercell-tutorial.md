...
4. Nella casella di ricerca digitare **Mercell**, selezionare **Mercell** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![Mercell nell'elenco risultati](./media/mercell-tutorial/tutorial_mercell_addfromgallery.png)
...
Per il funzionamento dell'accesso Single Sign-On, Azure AD deve sapere qual è l'utente di Mercell che corrisponde a un utente di Azure AD. In altre parole, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Mercell.
...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/mercell-tutorial/tutorial_mercell_samlbase.png)

3. Nella sezione **URL e dominio Mercell** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Mercell](./media/mercell-tutorial/tutorial_mercell_url.png)
...
5. Fare clic sul pulsante **Salva** .
    ...
    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/mercell-tutorial/tutorial_general_400.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/mercell-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/mercell-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/mercell-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/mercell-tutorial/create_aaduser_04.png)
...
>[!Note]
>Per creare un utente manualmente, contattare il  [team di supporto di Mercell](mailto:webmaster@mercell.com).
...
2. Nell'elenco delle applicazioni selezionare **Mercell**.
    ...
    ![Collegamento a Mercell nell'elenco delle applicazioni](./media/mercell-tutorial/tutorial_mercell_app.png)  
...
Quando si fa clic sul riquadro Mercell nel pannello di accesso, verrà eseguito automaticamente l'accesso all'applicazione Mercell.
