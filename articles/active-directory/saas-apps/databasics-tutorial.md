...
1. Nella casella di ricerca digitare **DATABASICS**, selezionare **DATABASICS** dal pannello dei risultati, quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![DATABASICS nell'elenco risultati](./media/databasics-tutorial/tutorial_databasics_addfromgallery.png)
...
1. **[Creare un utente di test di DATABASICS](#create-a-databasics-test-user)**: per avere una controparte di Britta Simon in DATABASICS collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/databasics-tutorial/tutorial_databasics_samlbase.png)

1. Nella sezione **URL e dominio DATABASICS** seguire questa procedura:

    ![Informazioni sull'accesso Single Sign-On per URL e dominio di DATABASICS](./media/databasics-tutorial/tutorial_databasics_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/databasics-tutorial/tutorial_databasics_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/databasics-tutorial/tutorial_general_400.png)

1. Per configurare l'accesso Single Sign-On sul lato DATABASICS, completare il modulo usando l'URL riportato di seguito. Dopo avere inoltrato il modulo, si verrà contattati dal [team di supporto client DATABASICS](https://www.data-basics.com/support/).
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/databasics-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/databasics-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/databasics-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/databasics-tutorial/create_aaduser_04.png)
...
In questa sezione viene creato un utente di nome Britta Simon in DATABASICS. Per aggiungere utenti alla piattaforma DATABASICS, collaborare con il  [team di supporto di DATABASICS](https://www.data-basics.com/support/) . Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
...
1. Nell'elenco di applicazioni selezionare **DATABASICS**.

    ![Collegamento DATABASICS nell'elenco delle applicazioni](./media/databasics-tutorial/tutorial_databasics_app.png)  
