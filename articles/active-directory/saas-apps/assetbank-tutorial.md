...
1. Nella casella di ricerca digitare **Asset Bank**.

    ![Creazione di un utente test di Azure AD](./media/assetbank-tutorial/tutorial_assetbank_search.png)

1. Nel pannello dei risultati selezionare **Asset Bank** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/assetbank-tutorial/tutorial_assetbank_addfromgallery.png)
...
1. **[Creazione di un utente test di Asset Bank](#creating-an-asset-bank-test-user)** : per avere una controparte di Britta Simon in Asset Bank collegata alla relativa rappresentazione in Azure AD.
...
1. Nella sezione **URL e dominio Asset Bank** seguire questa procedura:
...
1. Per configurare l'accesso Single Sign-On sul lato **Asset Bank**, è necessario inviare il file di **XML metadati** scaricato al [team di supporto di Asset Bank](mailto:support@assetbank.co.uk). 
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/assetbank-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/assetbank-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/assetbank-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/assetbank-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco di applicazioni selezionare **Asset Bank**.
