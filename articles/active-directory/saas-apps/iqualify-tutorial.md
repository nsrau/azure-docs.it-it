...
4. Nella casella di ricerca digitare **iQualify LMS**, nel pannello dei risultati selezionare **iQualify LMS** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![iQualify LMS nell'elenco risultati](common/search-new-app.png)
...
9. Nella sezione **Configura iQualify LMS** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a iQualify LMS.
...
In questa sezione viene creato un utente di nome Britta Simon in iQualify LMS. iQualify LMS supporta il provisioning utenti JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in iQualify LMS, ne viene creato uno nuovo dopo l'autenticazione.
