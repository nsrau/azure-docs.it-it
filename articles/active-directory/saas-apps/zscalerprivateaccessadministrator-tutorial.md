...
1. Nella pagina di integrazione dell'applicazione [Zscaler Private Access Administrator](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
