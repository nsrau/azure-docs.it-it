...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Condeco con gli account Azure AD.
...
4. Nella casella di ricerca digitare **Condeco** , selezionare **Condeco** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Condeco nell'elenco risultati](common/search-new-app.png)
...
5. **[Creare l'utente di test di Condeco](#create-condeco-test-user)** : per avere una controparte di Britta Simon in Condeco collegata alla rappresentazione dell'utente in Azure AD.
...
Per configurare l'accesso Single Sign-On di Azure AD con Condeco, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **Condeco** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On** .
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Condeco](common/sp-signonurl.png)
...
### <a name="configure-condeco-single-sign-on"></a>Configurare l'accesso Single Sign-On per Condeco
...
1. Nel portale di Azure selezionare **Applicazioni aziendali** , quindi **Tutte le applicazioni** e infine **Condeco** .

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Condeco** .

    ![Collegamento di Condeco nell'elenco delle applicazioni](common/all-applications.png)
...
Questa sezione descrive come creare un utente chiamato Britta Simon in Condeco. Condeco supporta il provisioning **JIT** , che è abilitato per impostazione predefinita.
...
Quando si fa clic sul riquadro di Condeco nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Condeco per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
