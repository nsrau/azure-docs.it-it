...
6. Per configurare l'accesso Single Sign-On sul lato **Condeco** è necessario inviare il file **XML metadati** scaricato al [team di supporto di Condeco](mailTo:supportna@condecosoftware.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
