...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    a. Nella casella di testo **URL di accesso** digitare un URL: `https://home.tigertext.com`

    b. Nella casella di testo **Identificatore (ID entità)** digitare un URL usando il modello seguente: `https://saml-lb.tigertext.me/v1/organization/<instance Id>`
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a TigerText Secure Messenger.
