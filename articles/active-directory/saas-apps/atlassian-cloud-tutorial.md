...
1. **[Configurare l'accesso Single Sign-On per Atlassian Cloud](#configure-atlassian-cloud-sso)** : per configurare le impostazioni dell'accesso Single Sign-On sul lato applicazione.
