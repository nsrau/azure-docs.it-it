...
1. Nella casella di ricerca digitare **Qualtrics**, selezionare **Qualtrics** dal pannello dei risultati quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Qualtrics nell'elenco risultati](./media/qualtrics-tutorial/tutorial_qualtrics_addfromgallery.png)
...
1. **[Creare un utente test di Qualtrics](#create-a-qualtrics-test-user)**: per avere una controparte di Britta Simon in Qualtrics collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/qualtrics-tutorial/tutorial_qualtrics_samlbase.png)

1. Nella sezione **URL e dominio Qualtrics** seguire questa procedura:

    ![Informazioni sull'accesso Single Sign-On per URL e dominio di Qualtrics](./media/qualtrics-tutorial/tutorial_qualtrics_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/qualtrics-tutorial/tutorial_qualtrics_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/qualtrics-tutorial/tutorial_general_400.png)

1. Per configurare l'accesso Single Sign-On sul lato **Qualtrics**, è necessario inviare il file **XML dei metadati** scaricato al [team di supporto di Qualtrics](https://www.qualtrics.com/support/). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/qualtrics-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/qualtrics-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/qualtrics-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/qualtrics-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **Qualtrics**.

    ![Collegamento Qualtrics nell'elenco delle applicazioni](./media/qualtrics-tutorial/tutorial_qualtrics_app.png)  
