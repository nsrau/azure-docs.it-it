...
## <a name="adding-sap-qualtrics-from-the-gallery"></a>Aggiunta di SAP Qualtrics dalla raccolta
...
1. Selezionare **SAP Qualtrics** nel pannello dei risultati e quindi aggiungere l'app. Attendere alcuni secondi che l'app venga aggiunta al tenant.
...
1. **[Configurare l'accesso Single Sign-On di SAP Qualtrics](#configure-sap-qualtrics-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    1. **[Creare l'utente di test di SAP Qualtrics](#create-sap-qualtrics-test-user)** : per avere una controparte di B.Simon in SAP Qualtrics collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **SAP Qualtrics** del [portale di Azure](https://portal.azure.com/) trovare la sezione **Gestione** e selezionare **Single Sign-On**.
...
Per configurare l'accesso Single Sign-On sul lato **SAP Qualtrics**, è necessario inviare l'**URL dei metadati di federazione dell'app** copiato dal portale di Azure al [team di supporto di SAP Qualtrics](https://www.qualtrics.com/support/). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.

### <a name="create-sap-qualtrics-test-user"></a>Creare l'utente di test di SAP Qualtrics

In questa sezione viene creato un utente di nome Britta Simon in SAP Qualtrics. SAP Qualtrics supporta il provisioning utenti JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in SAP Qualtrics, ne viene creato uno nuovo dopo l'autenticazione.

## <a name="test-sso"></a>Testare l'accesso SSO 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di SAP Qualtrics nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di SAP Qualtrics per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Come proteggere SAP Qualtrics con visibilità e controlli avanzati](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
