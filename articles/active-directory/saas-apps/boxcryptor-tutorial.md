...
1. Nella casella di ricerca digitare **Boxcryptor**, selezionare **Boxcryptor** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Boxcryptor nell'elenco dei risultati](./media/boxcryptor-tutorial/tutorial_boxcryptor_addfromgallery.png)
...
1. **[Creare un utente di test di Boxcryptor](#create-a-boxcryptor-test-user)**: per avere una controparte di Britta Simon in Boxcryptor collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/boxcryptor-tutorial/tutorial_boxcryptor_samlbase.png)

1. Nella sezione **URL e dominio Boxcryptor** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Boxcryptor](./media/boxcryptor-tutorial/tutorial_boxcryptor_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Collegamento di download del certificato](./media/boxcryptor-tutorial/tutorial_boxcryptor_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/boxcryptor-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di Boxcryptor** fare clic su **Configura Boxcryptor** per aprire la finestra **Configura accesso**. Copiare l'**URL del servizio Single Sign-On SAML** e l'**ID di entità SAML** dalla **sezione di riferimento rapido.**

    ![Configurazione di Andromeda SCM](./media/boxcryptor-tutorial/tutorial_boxcryptor_configure.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/boxcryptor-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/boxcryptor-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/boxcryptor-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/boxcryptor-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **Boxcryptor**.

    ![Collegamento di Boxcryptor nell'elenco delle applicazioni](./media/boxcryptor-tutorial/tutorial_boxcryptor_app.png)  
