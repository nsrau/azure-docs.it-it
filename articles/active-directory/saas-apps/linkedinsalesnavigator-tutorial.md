---
title: 'Esercitazione: Integrazione di Azure Active Directory con LinkedIn Sales Navigator | Microsoft Docs'
...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a LinkedIn Sales Navigator con gli account Azure AD personali.
...
4. Nella casella di ricerca digitare **LinkedIn Sales Navigator**, selezionare **LinkedIn Sales Navigator** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![LinkedIn Sales Navigator nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con LinkedIn Sales Navigator usando un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in LinkedIn Sales Navigator.
...
1. Nella pagina di integrazione dell'applicazione **LinkedIn Sales Navigator** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di LinkedIn Sales Navigator](common/idp-intiated.png)
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di LinkedIn Sales Navigator](common/metadata-upload-additional-signon.png)
...
6. L'applicazione LinkedIn Sales Navigator richiede le asserzioni SAML in un formato specifico. È quindi necessario aggiungere mapping di attributi personalizzati alla configurazione degli attributi del token SAML. La schermata seguente illustra l'elenco degli attributi predefiniti in cui **nameidentifier** è associato a **user.userprincipalname**. L'applicazione LinkedIn Sales Navigator prevede il mapping di nameidentifier a **user.mail**, di conseguenza per modificare il mapping degli attributi, è necessario fare clic sull'icona Modifica.

    ![image](common/edit-attribute.png)

7. Oltre quelli elencati in precedenza, l'applicazione LinkedIn Sales Navigator prevede il passaggio di qualche altro attributo nella risposta SAML. Nella sezione Attestazioni utente della finestra di dialogo **Attributi utente** eseguire la procedura seguente per aggiungere l'attributo del token SAML come illustrato nella tabella seguente:
...
9. Nella sezione **Configura LinkedIn Sales Navigator** copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-linkedin-sales-navigator-single-sign-on"></a>Configurare l'accesso Single Sign-On di LinkedIn Sales Navigator
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **LinkedIn Sales Navigator**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **LinkedIn Sales Navigator**.

    ![Collegamento di LinkedIn Sales Navigator nell'elenco delle applicazioni](common/all-applications.png)
