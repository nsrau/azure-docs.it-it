...
ms.openlocfilehash: 92826a05de6695aaed6ad5289a5ef06495cc7635
ms.sourcegitcommit: 0b1a4101d575e28af0f0d161852b57d82c9b2a7e
ms.translationtype: HT
ms.contentlocale: it-IT
ms.lasthandoff: 10/30/2019
ms.locfileid: "73153333"
---
...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) ad Allocadia con gli account Azure AD personali.
...
4. Nella casella di ricerca digitare **Allocadia**, selezionare **Allocadia** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Allocadia nell'elenco risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Allocadia.
...
2. **[Configurare l'accesso Single Sign-On per Allocadia](#configure-allocadia-single-sign-on)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
...
Per configurare l'accesso Single Sign-On di Azure AD con Allocadia, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **Allocadia** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella pagina **Configura l'accesso Single Sign-On con SAML** eseguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Allocadia](common/idp-intiated.png)
...
5. L'applicazione Allocadia si aspetta che le asserzioni SAML abbiano un formato specifico. Configurare le attestazioni seguenti per questa applicazione. È possibile gestire i valori di questi attributi dalla sezione **Attributi utente** nella pagina di integrazione dell'applicazione. Nella pagina **Configura l'accesso Single Sign-On con SAML** fare clic sul pulsante **Modifica** per aprire la finestra di dialogo **Attributi utente**.
...
8. Nella sezione **Set up Allocadia** (Configura Allocadia) copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-allocadia-single-sign-on"></a>Configurare l'accesso Single Sign-On per Allocadia
...
2. Nell'elenco delle applicazioni selezionare **Allocadia**.
    ...
    ![Collegamento di Allocadia nell'elenco delle applicazioni](common/all-applications.png)
...
In questa sezione viene creato un utente di nome Britta Simon in Allocadia. Allocadia supporta il provisioning utenti JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in Allocadia, ne viene creato uno nuovo dopo l'autenticazione.
