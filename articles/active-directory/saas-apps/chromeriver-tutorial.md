...
1. Nella casella di ricerca digitare **Chromeriver**.

    ![Creazione di un utente test di Azure AD](./media/chromeriver-tutorial/tutorial_chromeriver_search.png)

1. Nel pannello dei risultati selezionare **Chromeriver** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/chromeriver-tutorial/tutorial_chromeriver_addfromgallery.png)
...
1. **[Creazione di un utente di test di Chromeriver](#creating-a-chromeriver-test-user)**: per avere una controparte di Britta Simon in Chromeriver collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Chromeriver** seguire questa procedura:
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/chromeriver-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/chromeriver-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/chromeriver-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/chromeriver-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco delle applicazioni selezionare **Chromeriver**.
...
Quando si fa clic sul riquadro Canvas nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Chromeriver. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/active-directory-saas-access-panel-introduction.md).
