...
1. Nella casella di ricerca digitare **Cornerstone OnDemand**.

    ![Creazione di un utente test di Azure AD](./media/cornerstone-ondemand-tutorial/tutorial_cornerstoneondemand_search.png)

1. Nel pannello dei risultati selezionare **Cornerstone OnDemand** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/cornerstone-ondemand-tutorial/tutorial_cornerstoneondemand_addfromgallery.png)
...
1. **[Creazione di un utente test di Cornerstone OnDemand](#creating-a-cornerstone-ondemand-test-user)**: per avere una controparte di Britta Simon in Cornerstone OnDemand collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Cornerstone OnDemand** seguire questa procedura:
...
1. Nella sezione **Configurazione di Cornerstone OnDemand** fare clic su **Configura Cornerstone OnDemand** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML e l'URL di disconnessione** dalla sezione **Riferimento rapido**.
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/cornerstone-ondemand-tutorial/create_aaduser_01.png)

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.

    ![Creazione di un utente test di Azure AD](./media/cornerstone-ondemand-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.

    ![Creazione di un utente test di Azure AD](./media/cornerstone-ondemand-tutorial/create_aaduser_03.png)

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:

    ![Creazione di un utente test di Azure AD](./media/cornerstone-ondemand-tutorial/create_aaduser_04.png) 
...
L'obiettivo di questa sezione consiste nel creare un utente chiamato Britta Simon in Cornerstone OnDemand. Cornerstone OnDemand supporta il provisioning utenti automatico, che è abilitato per impostazione predefinita. È possibile scoprire più dettagli [qui](cornerstone-ondemand-provisioning-tutorial.md) su come configurare il provisioning utenti automatico.
...
* [Configura provisioning utenti](cornerstone-ondemand-provisioning-tutorial.md)
