...
1. Accedere a SolarWinds Orion e passare a **Settings** -> **All Settings** (Impostazioni -> Tutte le Impostazioni).
    ...
    ![ Configurazione di SolarWinds Orion ](./media/solarwinds-orion-tutorial/settings.png)

1. Nella sezione **USER ACCOUNTS** (Account utente) selezionare **SAML Configuration** (Configurazione di SAML).

    ![ Configurazione di SolarWinds Orion ](./media/solarwinds-orion-tutorial/configure-user-accounts.png)

1. Fare clic su **ADD IDENTITY PROVIDER** (Aggiungi provider di identità).

    ![ Configurazione di SolarWinds Orion ](./media/solarwinds-orion-tutorial/configure-add-identity-provider.png)

1. Seguire questa procedura nella pagina **Add Identity Provider** (Aggiungi provider di identità):

    ![ Configurazione di SolarWinds Orion ](./media/solarwinds-orion-tutorial/configure-solarwinds.png)
...
1. Accedere al sito Web di SolarWinds Orion e passare a **Settings** -> **All Settings** (Impostazioni -> Tutte le Impostazioni).
    ...
    ![ Creazione di un utente di test di SolarWinds Orion ](./media/solarwinds-orion-tutorial/settings.png)

1. Nella sezione **USER ACCOUNTS** (Account utente) selezionare **Manage Accounts** (Gestisci account).

    ![ Creazione di un utente di test di SolarWinds Orion ](./media/solarwinds-orion-tutorial/user-accounts.png)

1. Nella scheda **INDIVIDUAL ACCOUNTS** (Account individuali) fare clic su **ADD NEW ACCOUNT** (Aggiungi nuovo account).

    ![ Creazione di un utente di test di SolarWinds Orion ](./media/solarwinds-orion-tutorial/create-user.png)

1. Selezionare il tipo di account. Questo passaggio è necessario per creare singoli utenti o gruppi di SAML.

    ![ Creazione di un utente di test di SolarWinds Orion ](./media/solarwinds-orion-tutorial/create-user-new-account.png)
...
1.  Fare clic su **Next** (Avanti) e quindi inviare la pagina.
    ...
    ![ Creazione di un utente di test di SolarWinds Orion ](./media/solarwinds-orion-tutorial/create-user-name-id.png)
...
- [Come proteggere SolarWinds Orion con visibilità e controlli avanzati](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
