...
1. Nella pagina di integrazione dell'applicazione [ArcGIS Enterprise](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
