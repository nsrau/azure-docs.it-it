...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Reflektive con gli account Azure AD personali.
...
* Reflektive supporta l'accesso SSO avviato da **SP** e **IDP**
...
4. Nella casella di ricerca digitare **Reflektive**, selezionare **Reflektive** dal pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Reflektive nell'elenco risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Reflektive.
...
2. **[Configurare l'accesso Single Sign-On di Reflektive](#configure-reflektive-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di Reflektive](#create-reflektive-test-user)**: per avere una controparte di Britta Simon in Reflektive collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione [Reflektive](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Reflektive](common/idp-identifier.png)
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    Nella casella di testo **URL di accesso** digitare un URL: `https://www.reflektive.com/app`

    > [!NOTE]
    > Per la modalità SP è necessario ottenere l'ID di posta elettronica registrato con il [team di supporto di Reflektive](https://support@reflektive.com). Quando si immette l'ID nella casella di testo **Posta elettronica** l'opzione Single Sign-On viene abilitata. È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
7. Nella sezione **Configura Reflektive** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Reflektive.

1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Reflektive**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Reflektive**.

    ![Collegamento di Reflektive nell'elenco delle applicazioni](common/all-applications.png)
...
Quando si fa clic sul riquadro di Reflektive nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Reflektive per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
