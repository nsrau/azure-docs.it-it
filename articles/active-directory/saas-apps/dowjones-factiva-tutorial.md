...
1. Nella casella di ricerca digitare **Dow Jones Factiva**.

    ![Creazione di un utente test di Azure AD](./media/dowjones-factiva-tutorial/tutorial_dowjonesfactiva_search.png)

1. Nel pannello dei risultati selezionare **Dow Jones Factiva** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/dowjones-factiva-tutorial/tutorial_dowjonesfactiva_addfromgallery.png)
...
1. **[Creazione di un utente test di Dow Jones Factiva](#creating-a-dow-jones-factiva-test-user)**: per avere una controparte di Britta Simon in Dow Jones Factiva collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Dow Jones Factiva** l'utente non deve eseguire alcuna operazione perché l'applicazione è già preintegrata in Azure.
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/dowjones-factiva-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/dowjones-factiva-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/dowjones-factiva-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/dowjones-factiva-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco di applicazioni, selezionare **Dow Jones Factiva**.
