...
1. Nella casella di ricerca digitare **Insignia SAML SSO**, selezionare **Insignia SAML SSO** dal pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Insignia SAML SSO nell'elenco risultati](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_addfromgallery.png)
...
1. **[Creare un utente test Insignia SAML SSO](#create-an-insignia-saml-sso-test-user)**: per avere una controparte di Britta Simon in Insignia SAML SSO collegata alla relativa rappresentazione in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_samlbase.png)

1. Nella sezione **URL e dominio Insignia SAML SSO** seguire questa procedura:

    ![Informazioni sull'accesso Single Sign-On per il l'URL e il dominio di Insignia SAML SSO](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Collegamento di download del certificato](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/insigniasamlsso-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione Insignia SAML SSO** fare clic su **Configura Insignia SAML SSO** per aprire la finestra **Configura accesso**. Copiare i valori **Sign-Out URL (URL di disconnessione) e SAML Single Sign-On Service URL (URL servizio Single Sign-On SAML)** dalla sezione **Quick Reference** (Riferimento rapido).
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/insigniasamlsso-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/insigniasamlsso-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/insigniasamlsso-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/insigniasamlsso-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **Insignia SAML SSO**.

    ![Collegamento a Insignia SAML SSO nell'elenco delle applicazioni](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_app.png)  
