...
1. Nella casella di ricerca digitare **Pluralsight**, selezionare **Pluralsight** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Pluralsight nell'elenco dei risultati](./media/pluralsight-tutorial/tutorial_pluralsight_addfromgallery.png)
...
1. **[Creare un utente di test Pluralsight](#create-a-pluralsight-test-user)**: per avere una controparte di Britta Simon in Pluralsight collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/pluralsight-tutorial/tutorial_pluralsight_samlbase.png)

1. Nella sezione **URL e dominio Pluralsight** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Pluralsight](./media/pluralsight-tutorial/tutorial_pluralsight_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/pluralsight-tutorial/tutorial_pluralsight_certificate.png) 

1. Questa sezione descrive come abilitare l'accesso Single Sign-On di Azure AD nel portale di Azure e configurare l'accesso SSO nell'applicazione Pluralsight.
...
1. Per ottenere l'accesso Single Sign-On configurato per l'applicazione, contattare il team dei [servizi professionali](mailTo:professionalservices@pluralsight.com) di Pluralsight e comunicare il file di metadati scaricato.
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/pluralsight-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/pluralsight-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/pluralsight-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/pluralsight-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **Pluralsight**.
    ...
    ![Collegamento di Pluralsight nell'elenco delle applicazioni](./media/pluralsight-tutorial/tutorial_pluralsight_app.png)  
