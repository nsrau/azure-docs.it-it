...
1. Nella casella di ricerca digitare **Tangoe Command Premium Mobile**, selezionare **Tangoe Command Premium Mobile** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Aggiungere Tangoe Command Premium Mobile dalla raccolta](./media/tangoe-tutorial/tutorial_tangoe_addfromgallery.png)
...
1. **[Creare un utente di test di Tangoe Command Premium Mobile](#create-a-tangoe-command-premium-mobile-test-user)**: per avere una controparte di Britta Simon in Tangoe Command Premium Mobile collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Accesso basato su SAML](./media/tangoe-tutorial/tutorial_tangoe_samlbase.png)

1. Nella sezione **URL e dominio Tangoe Command Premium Mobile** seguire questa procedura:

    ![URL e dominio Tangoe Command Premium Mobile](./media/tangoe-tutorial/tutorial_tangoe_url.png)
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con URL di risposta e URL di accesso effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di Tangoe Command Premium Mobile](https://www.tangoe.com/contact-us/). 

1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.

    ![Sezione Certificato di firma SAML](./media/tangoe-tutorial/tutorial_tangoe_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante per il salvataggio](./media/tangoe-tutorial/tutorial_general_400.png)
    
1. Nella sezione **Configurazione di Tangoe Command Premium Mobile** fare clic su **Configura Tangoe Command Premium Mobile** per aprire la finestra **Configura accesso**. Copiare l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**

    ![Sezione di configurazione di Tangoe Command Premium Mobile](./media/tangoe-tutorial/tutorial_tangoe_configure.png) 

1. Per configurare l'accesso SSO per l'applicazione, contattare il [team di supporto clienti di Tangoe Command Premium Mobile](https://www.tangoe.com/contact-us/) e fornire quanto segue:
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/tangoe-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Utenti e gruppi -> Tutti gli utenti](./media/tangoe-tutorial/create_aaduser_02.png) 
...
1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
    ...
    ![Finestra di dialogo Utente](./media/tangoe-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco delle applicazioni selezionare **Tangoe Command Premium Mobile**.

    ![Tangoe Command Premium Mobile nell'elenco delle app](./media/tangoe-tutorial/tutorial_tangoe_app.png) 
