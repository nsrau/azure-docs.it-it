...
1. Nella pagina di integrazione dell'applicazione [Bridgeline Unbound](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
