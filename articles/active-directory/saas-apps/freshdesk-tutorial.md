...
1. Nella casella di ricerca digitare **Freshdesk**.

    ![Creazione di un utente test di Azure AD](./media/freshdesk-tutorial/tutorial_freshdesk_search.png)

1. Nel pannello dei risultati selezionare **FreshDesk** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
1. **[Creazione di un utente test di FreshDesk](#creating-a-freshdesk-test-user)**: per avere una controparte di Britta Simon in FreshDesk collegata alla relativa rappresentazione in Azure AD.
...
1. Nella sezione **FreshDesk Domain and URLs** (Dominio e URL FreshDesk), immettere un valore per **URL di accesso** come: `https://<tenant-name>.freshdesk.com` o qualsiasi altro valore suggerito da FreshDesk.
...
1. Nella sezione **SAML Signing Certificate** (Certificato di firma SAML) fare clic su **Certificate** e quindi salvare il certificato nel computer.
...
1. Nella sezione **FreshDesk Configuration** (Configurazione di FreshDesk) fare clic su **Configure FreshDesk** (Configura FreshDesk) per aprire la finestra Configura accesso. Copiare l’URL servizio Single Sign-On SAML e l’URL Sign-Out dalla sezione **Quick Reference** (Riferimento rapido).
...
1. Nel menu in alto fare clic su **Admin**.
   ...
   ![Amministratore](./media/freshdesk-tutorial/IC776768.png "Amministratore")

1. Nella scheda **General Settings** fare clic su **Security**.
   
   ![Sicurezza](./media/freshdesk-tutorial/IC776769.png "Sicurezza")
...
1. Nella scheda **General Settings** fare clic su **Agents**.
...
1. Nella finestra di dialogo Agent Information seguire questa procedura:
