---
title: 'Esercitazione: Integrazione di Azure Active Directory con Trakopolis | Microsoft Docs'
...
1. Nella casella di ricerca digitare **Trakopolis**.

    ![Creazione di un utente test di Azure AD](./media/trakopolis-tutorial/tutorial_trakopolis_search.png)

1. Nel pannello dei risultati selezionare **Trakopolis** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/trakopolis-tutorial/tutorial_trakopolis_addfromgallery.png)
...
1. **[Creazione di un utente di test di Trakopolis](#creating-a-trakopolis-test-user)**: per avere una controparte di Britta Simon in Trakopolis collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Trakopolis** seguire questa procedura:
...
1. Nella sezione **Configurazione di Trakopolis** fare clic su **Configura Trakopolis** per aprire la finestra **Configura accesso**. Copiare l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/trakopolis-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/trakopolis-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/trakopolis-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/trakopolis-tutorial/create_aaduser_04.png) 
...
1. Nell’elenco delle applicazioni selezionare **Trakopolis**.
