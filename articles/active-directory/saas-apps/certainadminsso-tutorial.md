...
1. Nella pagina di integrazione dell'applicazione [Certain Admin SSO](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
