...
4. Nella casella di ricerca digitare **GoToMeeting**, selezionare **GoToMeeting** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![GoToMeeting nell'elenco risultati](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_addfromgallery.png)
...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_samlbase.png)

3. Nella sezione **URL e dominio GoToMeeting** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di GoToMeeting](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_url.png)
...
5. Fare clic sul pulsante **Salva** .
    ...
    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/citrix-gotomeeting-tutorial/tutorial_general_400.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/citrix-gotomeeting-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/citrix-gotomeeting-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/citrix-gotomeeting-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/citrix-gotomeeting-tutorial/create_aaduser_04.png)
...
2. Nell'elenco delle applicazioni selezionare **GoToMeeting**.
    ...
    ![Collegamento di GoToMeeting nell'elenco delle applicazioni](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_app.png)  
