...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione nella modalità avviata da **SP**:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di iDiD Manager](common/both-preintegrated-signon.png)

    a. Fare clic su **Impostare URL aggiuntivi**.

    b. Nella casella di testo **URL accesso** digitare un URL nel formato seguente: `https://idid2.fi/saml/login/<domain>`
