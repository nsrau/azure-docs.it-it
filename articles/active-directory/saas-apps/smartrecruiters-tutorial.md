...
1. Nella pagina di integrazione dell'applicazione [SmartRecruiters](https://portal.azure.com/) del **portale di Azure** fare clic su **Single Sign-On**.
