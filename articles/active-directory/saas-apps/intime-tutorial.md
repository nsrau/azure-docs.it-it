...
1. Nella casella di ricerca digitare **InTime**, selezionare **InTime** dal pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![InTime nell'elenco risultati](./media/intime-tutorial/tutorial_intime_addfromgallery.png)
...
1. **[Creare un utente di test di InTime](#create-a-intime-test-user)**: per avere una controparte di Britta Simon in InTime collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/intime-tutorial/tutorial_intime_samlbase.png)

1. Nella sezione **URL e dominio InTime** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di InTime](./media/intime-tutorial/tutorial_intime_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/intime-tutorial/tutorial_intime_certificate.png) 

1. L'applicazione InTime si aspetta che le asserzioni SAML abbiano un formato specifico, quindi è necessario aggiungere mapping di attributi personalizzati alla configurazione degli attributi del token SAML. La schermata seguente illustra un esempio relativo a questa operazione. Il valore predefinito dell'**ID utente** è **user.userprincipalname** ma InTime si aspetta che venga mappato all'indirizzo e-mail dell'utente. A tale scopo, è possibile usare l'attributo **user.mail** dall'elenco oppure usare il valore di attributo appropriato in base alla configurazione dell'organizzazione 

    ![Configurazione dell'attributo](./media/intime-tutorial/tutorial_intime_attribute.png)

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/intime-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di InTime** fare clic su **Configura InTime** per aprire la finestra **Configura accesso**. Copiare i valori **Sign-Out URL (URL di disconnessione) e SAML Single Sign-On Service URL (URL servizio Single Sign-On SAML)** dalla sezione **Quick Reference** (Riferimento rapido).

    ![Configurazione di InTime](./media/intime-tutorial/tutorial_intime_configure.png) 
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/intime-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/intime-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/intime-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/intime-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **InTime**.

    ![Collegamento di InTime nell'elenco delle applicazioni](./media/intime-tutorial/tutorial_intime_app.png)  
