...
1. Nella casella di ricerca digitare **Soonr Workplace**.

    ![Creazione di un utente test di Azure AD](./media/soonr-tutorial/tutorial_soonr_search.png)

1. Nel pannello dei risultati selezionare **Soonr Workplace** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/soonr-tutorial/tutorial_soonr_addfromgallery.png)
...
1. **[Creazione di un utente test di Soonr Workplace](#creating-a-soonr-workplace-test-user)**: per avere una controparte di Britta Simon in Soonr Workplace collegata alla relativa rappresentazione in Azure AD.
...
1. Nella sezione **Soonr Workplace Domain and URLs** (URL e dominio Soonr Workplace) seguire questa procedura:
...
1. Nella sezione **URL e dominio Soonr Workplace** se si vuole configurare l'applicazione in **Modalità avviata da SP**, seguire questa procedura:
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/soonr-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/soonr-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/soonr-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/soonr-tutorial/create_aaduser_04.png) 
...
1. Selezionare **Soonr Workplace**dall'elenco di applicazioni.
