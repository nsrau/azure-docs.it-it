...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a N2F - Expense reports con gli account Azure AD personali.
...
4. Nella casella di ricerca digitare **N2F - Expense reports**, selezionare **N2F - Expense reports** dal pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![N2F - Expense reports nell'elenco risultati](common/search-new-app.png)
...
5. **[Creare l'utente di test di N2F - Expense reports](#create-n2f---expense-reports-test-user)**: per avere una controparte di Britta Simon in N2F - Expense reports collegata alla rappresentazione dell'utente in Azure AD.
...
7. Nella sezione **Configura myPolicies** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a N2F - Expense reports.
