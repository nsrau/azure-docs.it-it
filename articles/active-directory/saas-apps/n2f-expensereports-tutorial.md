...
1. Nella pagina di integrazione dell'applicazione [N2F - Expense reports](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
