...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP** :
    ...
    ![Screenshot che mostra la sezione "Configurazione SAML di base" con il campo "Identificatore (ID entità)" e il pulsante "Salva" evidenziati.](common/both-identifier.png)
...
In questa sezione viene creato un utente di nome Britta Simon in Convercent. Collaborare con il [team di supporto di Convercent](http://support.convercent.com/) per aggiungere gli utenti nella piattaforma Convercent. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
