---
title: 'Esercitazione: Integrazione di Azure Active Directory con Convercent | Microsoft Docs'
...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Convercent con gli account Azure AD.
...
* Convercent supporta l'accesso SSO avviato da **SP** e **IDP**
...
4. Nella casella di ricerca digitare **Convercent**, selezionare **Convercent** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Convercent nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Convercent usando un utente di test di nome **Britta Simon**. Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Convercent.

Per configurare e testare l'accesso Single Sign-On di Azure AD con Convercent, è necessario completare le procedure di base seguenti:
...
1. Nella pagina di integrazione dell'applicazione **Convercent** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione nella modalità avviata da **IDP**:
    ...
    Nella casella di testo **Identificatore** digitare un URL nel formato seguente: `https://<instancename>.convercent.com/`

5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Convercent](common/both-advanced-urls.png)
...
7. Nella sezione **Set up Convercent** (Configura Convercent) copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-convercent-single-sign-on"></a>Configurare l'accesso Single Sign-On per Convercent

Per configurare l'accesso Single Sign-On sul lato **Convercent**, è necessario inviare il file di **XML metadati federazione** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di Convercent](http://support.convercent.com/). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Convercent**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Convercent**.

    ![Collegamento di Convercent nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-convercent-test-user"></a>Creare l'utente di test di Convercent

In questa sezione viene creato un utente di nome Britta Simon in Convercent. Collaborare con il  [team di supporto di Convercent](http://support.convercent.com/) per aggiungere gli utenti alla piattaforma Convercent. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.

### <a name="test-single-sign-on"></a>Testare l'accesso Single Sign-On 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di Convercent nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Convercent per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
