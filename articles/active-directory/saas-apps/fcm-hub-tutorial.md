...
* FCM HUB supporta l'accesso Single Sign-On avviato da **SP e IDP**
...
## <a name="adding-fcm-hub-from-the-gallery"></a>Aggiunta di FCM HUB dalla raccolta
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-fcm-hub"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per FCM HUB
...
Per configurare e testare l'accesso SSO di Azure AD con FCM HUB, completare le procedure di base seguenti:
...
1. **[Configurare l'accesso Single Sign-On di FCM HUB](#configure-fcm-hub-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    * **[Creare l'utente di test di FCM HUB](#create-fcm-hub-test-user)** : per avere una controparte di B.Simon in FCM HUB collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **FCM HUB** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On** .
...
Quando si fa clic sul riquadro di FCM HUB nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di FCM HUB per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Provare FCM HUB con Azure AD](https://aad.portal.azure.com/)

- [Informazioni sul controllo sessioni in Microsoft Cloud App Security](/cloud-app-security/proxy-intro-aad)

- [Come proteggere FCM HUB con visibilità e controlli avanzati](/cloud-app-security/proxy-intro-aad)