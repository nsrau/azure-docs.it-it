...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per Single Sign-On di Peoplecart](common/sp-identifier.png)
...
2. Nell'elenco delle applicazioni, selezionare **Peoplecart**.
    ...
    ![Collegamento Peoplecart nell'elenco Applicazioni](common/all-applications.png)
