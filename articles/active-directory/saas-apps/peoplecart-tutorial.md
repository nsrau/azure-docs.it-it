...
1. Nella casella di ricerca digitare **Peoplecart**, selezionare **Peoplecart** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Peoplecart nell'elenco risultati](./media/peoplecart-tutorial/tutorial_peoplecart_addfromgallery.png)
...
1. **[Creare un utente test di Peoplecart](#create-a-peoplecart-test-user)**: per avere una controparte di Britta Simon in Peoplecart collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Peoplecart** seguire questa procedura:

    ![Informazioni su URL e dominio per Single Sign-On di Peoplecart](./media/peoplecart-tutorial/tutorial_peoplecart_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/peoplecart-tutorial/tutorial_peoplecart_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/peoplecart-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di Peoplecart** fare clic su **Configura Peoplecart** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**

    ![Configurazione di Peoplecart](./media/peoplecart-tutorial/tutorial_peoplecart_configure.png) 
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/peoplecart-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/peoplecart-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Pulsante Aggiungi](./media/peoplecart-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Finestra di dialogo Utente](./media/peoplecart-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco delle applicazioni, selezionare **Peoplecart**.

    ![Collegamento Peoplecart nell'elenco Applicazioni](./media/peoplecart-tutorial/tutorial_peoplecart_app.png) 
