...
| Logo | Esercitazione di applicazione per Single Sign-On | Esercitazione di applicazione per il provisioning utente |
| :--- | :--- | :--- |
| ![Console di Amazon Web Services logo (AWS)](./media/tutorial-list/active-directory-saas-amazon-web-service-tutorial.png)| [Console di Amazon Web Services (AWS)](amazon-web-service-tutorial.md)| [Console di Amazon Web Services (AWS)-provisioning del ruolo](amazon-web-service-tutorial.md#configure-azure-ad-sso) |
...
| :--- | :--- |
| ![logo-8x8 Virtual](./media/tutorial-list/active-directory-saas-8x8-virtual-office-tutorial.png)| [8X8](8x8virtualoffice-tutorial.md)|
...
| ![logo-ampiezza](./media/tutorial-list/active-directory-saas-amplitude-tutorial.png)| [Amplitude](amplitude-tutorial.md)|
| ![logo-valutato](./media/tutorial-list/active-directory-saas-appraisd-tutorial.png)| [Appraisd](appraisd-tutorial.md)|
...
| ![logo-cloud Atlassian](./media/tutorial-list/active-directory-saas-atlassian-cloud-tutorial.png)| [Atlassian Cloud](atlassian-cloud-tutorial.md)|
| ![logo-backup dell'endpoint Carbonite](./media/tutorial-list/active-directory-saas-carbonite-endpoint-backup-tutorial.png)| [Carbonite Endpoint Backup](carbonite-endpoint-backup-tutorial.md)|
...
| ![logo-Visualizzatore](./media/tutorial-list/active-directory-saas-displayr-tutorial.png)| [Displayr](displayr-tutorial.md)|
...
| ![logo-Dome9 Arc Arc](./media/tutorial-list/active-directory-saas-dome9arc-tutorial.png)| [Dome9 Arc](dome9arc-tutorial.md)|
...
| ![logo-inviato](./media/tutorial-list/active-directory-saas-envoy-tutorial.png)| [Envoy](envoy-tutorial.md)|
| ![logo-Evernote](./media/tutorial-list/active-directory-saas-evernote-tutorial.png)| [Evernote](evernote-tutorial.md)|
| ![logo-Spesein](./media/tutorial-list/active-directory-saas-expensein-tutorial.png)| [ExpenseIn](expensein-tutorial.md)|
...
| ![logo-alimento](./media/tutorial-list/active-directory-saas-foodee-tutorial.png)| [Foodee](foodee-tutorial.md)|
...
| ![logo-persone](./media/tutorial-list/active-directory-saas-people-tutorial.png)| [People](people-tutorial.md)|
...
| ![logo-Soloinsight-SSO CloudGate](./media/tutorial-list/active-directory-saas-soloinsight-cloudgate-sso-tutorial.png)| [Soloinsight-CloudGate SSO](soloinsight-cloudgate-sso-tutorial.md)|
...
| ![logo-Guarda per colori](./media/tutorial-list/active-directory-saas-watch-by-colors-tutorial.png)| [Watch by Colors](watch-by-colors-tutorial.md)|
| ![logo-modalità](./media/tutorial-list/active-directory-saas-waywedo-tutorial.png)| [Way We Do](waywedo-tutorial.md)|
| ![logo-area di lavoro per Facebook](./media/tutorial-list/active-directory-saas-workplacebyfacebook-tutorial.png)| [Workplace by Facebook](workplacebyfacebook-tutorial.md)|
...
| ![logo-zScaler tre](./media/tutorial-list/active-directory-saas-zscaler-three-tutorial.png)| [Zscaler Three](zscaler-three-tutorial.md)|
| ![logo-zScaler due](./media/tutorial-list/active-directory-saas-zscaler-two-tutorial.png)| [Zscaler Two](zscaler-two-tutorial.md)|  
