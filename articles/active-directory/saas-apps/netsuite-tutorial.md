...
4. Nella casella di ricerca digitare **Netsuite**.
    ...
    ![Creazione di un utente test di Azure AD](./media/netsuite-tutorial/tutorial_netsuite_search.png)

5. Nel pannello dei risultati selezionare **Netsuite** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/netsuite-tutorial/tutorial_netsuite_addfromgallery.png)
