...
* Raketa supporta l'accesso SSO avviato da **SP**
...
1. Nella sezione **Aggiungi dalla raccolta** digitare **Raketa** nella casella di ricerca.
1. Selezionare **Raketa** nel pannello dei risultati e quindi aggiungere l'app. Attendere alcuni secondi che l'app venga aggiunta al tenant.
...
1. Nella pagina di integrazione dell'applicazione **Raketa** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
1. Nella sezione **Configurazione SAML di base** immettere i valori per i campi seguenti:
    ...
    a. Nella casella di testo **URL di accesso** digitare l'URL: `https://raketa.travel/`

    b. Nella casella di testo **URL di risposta** digitare un URL nel formato seguente: `https://raketa.travel/sso/acs?clientId=<CLIENT_ID>`
...
1. Nell'elenco delle applicazioni selezionare **Raketa**.
...
In questa sezione viene creato un utente di nome B.Simon in Raketa. Collaborare con il [team di supporto di Raketa](mailto:help@raketa.travel) per aggiungere gli utenti alla piattaforma Raketa. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
