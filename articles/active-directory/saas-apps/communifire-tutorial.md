...
1. Nella casella di ricerca digitare **Communifire**, selezionare **Communifire** dal riquadro dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Communifire nell'elenco risultati](./media/communifire-tutorial/tutorial_communifire_addfromgallery.png)
...
1. **[Creare un utente di test di Communifire](#create-a-communifire-test-user)**: per avere una controparte di Britta Simon in Communifire collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/communifire-tutorial/tutorial_communifire_samlbase.png)

1. Nella sezione **URL e dominio Communifire** eseguire la procedura seguente se si vuole configurare l'applicazione in modalità avviata da IdP:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On in Communifire](./media/communifire-tutorial/tutorial_communifire_url.png)
...
1. Selezionare **Mostra impostazioni URL avanzate** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On in Communifire](./media/communifire-tutorial/tutorial_communifire_url1.png)

    Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://<subdomain>.communifire.com/login`
     
    > [!NOTE] 
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore, l'URL di risposta e l'URL di accesso effettivi. Per ottenere questi valori, contattare il [team di assistenza per il client Communifire](https://my.axerosolutions.com/spaces/77/communifire-support/help/welcome). 

1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.

    ![Collegamento di download del certificato](./media/communifire-tutorial/tutorial_communifire_certificate.png) 

1.  Selezionare **Mostra impostazioni avanzate per la firma di certificati** e quindi selezionare **Opzione di firma** come **Firma asserzione e risposta SAML**.

    ![Opzione certificato](./media/communifire-tutorial/tutorial_communifire_certificateoption.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/communifire-tutorial/tutorial_general_400.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/communifire-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/communifire-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/communifire-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/communifire-tutorial/create_aaduser_04.png)
...
>[!Note]
>Per creare un utente manualmente, contattare il  [team di supporto di Communifire](https://my.axerosolutions.com/spaces/77/communifire-support/help/welcome).
...
1. Nell'elenco delle applicazioni selezionare **Communifire**.

    ![Collegamento di Communifire nell'elenco delle applicazioni](./media/communifire-tutorial/tutorial_communifire_app.png)  
