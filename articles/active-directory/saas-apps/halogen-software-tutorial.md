...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Halogen Software con gli account Azure AD personali.
...
* Halogen Software supporta l'accesso SSO avviato da **SP**
...
4. Nella casella di ricerca digitare **Halogen Software**, selezionare **Halogen Software** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Halogen Software nell'elenco risultati](common/search-new-app.png)
...
Per configurare l'accesso Single Sign-On di Azure AD con Halogen Software, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **Halogen Software** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
6. Nella sezione **Configura Halogen Software** copiare gli URL appropriati in base alle esigenze.
...
2. Scegliere la scheda **Options (Opzioni)** .
    ...
    ![Cos'è Azure AD Connect](./media/halogen-software-tutorial/tutorial_halogen_12.png)

3. Nel riquadro di spostamento a sinistra fare clic su **SAML Configuration**.
  
    ![Cos'è Azure AD Connect](./media/halogen-software-tutorial/tutorial_halogen_13.png)

4. Nella pagina **Configurazione SAML** seguire la procedura seguente:

    ![Cos'è Azure AD Connect](./media/halogen-software-tutorial/tutorial_halogen_14.png)
...
### <a name="create-halogen-software-test-user"></a>Creare l'utente di test di Halogen Software
...
2. Fare clic sulla scheda **User Center** (Centro utenti) e quindi su **Create User** (Crea utente).
    ...
    ![Cos'è Azure AD Connect](./media/halogen-software-tutorial/tutorial_halogen_300.png)  

3. Nella pagina **Nuovo utente** eseguire la procedura seguente:

    ![Cos'è Azure AD Connect](./media/halogen-software-tutorial/tutorial_halogen_301.png)
