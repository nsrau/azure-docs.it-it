...
1. Nella pagina di integrazione dell'applicazione [ProMaster (by Inlogik)](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
