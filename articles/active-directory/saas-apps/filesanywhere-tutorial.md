...
1. Nella pagina di integrazione dell'applicazione [FilesAnywhere](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
