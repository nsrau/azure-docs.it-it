...
1. Nella casella di ricerca digitare **Flock**, selezionare **Flock** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
1. **[Creare un utente di test di Flock](#create-a-flock-test-user)**: per avere una controparte di Britta Simon in Flock collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Flock** seguire questa procedura:
...
1. Nella sezione **Configurazione di Flock** fare clic su **Configura Flock** per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**
...
1. Selezionare la scheda di **Autenticazione** dal pannello di navigazione a sinistra e quindi selezionare **Autenticazione SAML**.
...
1. Fare clic su **Gestisci team** dal pannello di navigazione a sinistra.

    ![Aggiungere un dipendente](./media/flock-tutorial/user1.png)

1. Fare clic su **Aggiungi membro** e quindi selezionare **Membri del team**.

    ![Aggiungere un dipendente](./media/flock-tutorial/user2.png)

1. Immettere l'indirizzo di posta elettronica dell'utente, ad esempio **Brittasimon@contoso.com** e quindi selezionare **Aggiungi utenti**.
...
1. Nell'elenco delle applicazioni, selezionare **Flock**.
