...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Vibe HCM con gli account Azure AD personali.
...
* Sottoscrizione di Vibe HCM abilitata per l'accesso Single Sign-On

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* Vibe HCM supporta l'accesso SSO avviato da **SP** e **IDP**
...
4. Nella casella di ricerca digitare **Vibe HCM** , selezionare **Vibe HCM** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Vibe HCM nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Vibe HCM usando un utente di test di nome **Britta Simon** .
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Vibe HCM.
...
2. **[Configurare l'accesso Single Sign-On di Vibe HCM](#configure-vibe-hcm-single-sign-on)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente di test di Vibe HCM](#create-vibe-hcm-test-user)** : per avere una controparte di Britta Simon in Vibe HCM collegata alla rappresentazione dell'utente in Azure AD.
...
Per configurare l'accesso Single Sign-On di Azure AD con Vibe HCM, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione [Vibe HCM](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On** .
...
4. Nella sezione **Configurazione SAML di base** , se si vuole configurare l'applicazione in modalità avviata da **IDP** , non è necessario eseguire alcun passaggio, perché l'app è già preintegrata in Azure.
    ...
    ![Screenshot che mostra la sezione Configurazione SAML di base con il collegamento Carica file di metadati.](common/preintegrated.png)
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP** :
    ...
    Nella casella di testo **URL accesso** digitare un URL nel formato seguente: `https://<companyName>.vibehcm.com/portal.jsp`

    > [!NOTE]
    > Poiché non è reale, è necessario aggiornare questo valore con l'URL di accesso effettivo. Per ottenere il valore, contattare il [team di supporto clienti di Vibe HCM](mailto:support@vibehcm.com). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
### <a name="configure-vibe-hcm-single-sign-on"></a>Configurare l'accesso Single Sign-On di Vibe HCM

Per configurare l'accesso Single Sign-On sul lato **Vibe HCM** , è necessario inviare l' **URL dei metadati di federazione dell'app** al [team di supporto di Vibe HCM](mailto:support@vibehcm.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali** , quindi **Tutte le applicazioni** e infine **Vibe HCM** .

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco di applicazioni selezionare **Vibe HCM** .

    ![Collegamento di Vibe HCM nell'elenco delle applicazioni](common/all-applications.png)
...
Quando si fa clic sul riquadro di Vibe HCM nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Vibe HCM per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
