...
* È possibile consentire agli utenti l'accesso automatico (Single Sign-On) ad Achieve3000 con i rispettivi account Azure AD.
...
4. Nella casella di ricerca digitare **Achieve3000**, selezionare **Achieve3000** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Achieve3000 nell'elenco dei risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Achieve3000 con un utente di test di nome **Britta Simon**.
Per il funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Achieve3000.
...
1. Nella pagina di integrazione dell'applicazione **Achieve3000** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
8. Nella sezione **Configura Achieve3000** copiare gli URL appropriati in base alle proprie esigenze.
...
### <a name="configure-achieve3000-single-sign-on"></a>Configurare l'accesso Single Sign-On di Achieve3000
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Achieve3000**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Achieve3000**.

    ![Collegamento di Achieve3000 nell'elenco delle applicazioni](common/all-applications.png)
...
In questa sezione viene creato un utente di nome Britta Simon in Achieve3000. Per aggiungere utenti nella piattaforma Achieve3000, rivolgersi al  [team di supporto di Achieve3000](https://www.achieve3000.com/contact-us/). Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
