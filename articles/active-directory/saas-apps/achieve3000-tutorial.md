...
4. Nella casella di ricerca digitare **Achieve3000**, selezionare **Achieve3000** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![Achieve3000 nell'elenco dei risultati](./media/achieve3000-tutorial/tutorial_achieve3000_addfromgallery.png)
...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/achieve3000-tutorial/tutorial_achieve3000_samlbase.png)

3. Nella sezione **URL e dominio Achieve3000** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Achieve3000](./media/achieve3000-tutorial/tutorial_achieve3000_url.png)
...
4. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/achieve3000-tutorial/tutorial_achieve3000_certificate.png) 
...
5. Nell'attestazione dell'identificatore del nome l'applicazione Achieve3000 richiede un valore **studentID** univoco. Il cliente può eseguire il mapping del valore corretto per l'attestazione dell'identificatore del nome. In questo caso è stato eseguito il mapping di **user.mail** a scopo dimostrativo. Tuttavia, in base all'identificatore univoco è necessario eseguire il mapping del valore corretto.   
    ...
    ![Configurare l'attributo Single Sign-On](./media/achieve3000-tutorial/tutorial_achieve3000_attribute.png)
...
6. Nella sezione **Attributi utente** della finestra di dialogo **Single Sign-On** configurare l'attributo del token SAML come illustrato nell'immagine e seguire questa procedura:
    ...
    ![Configurare l'aggiunta del Single Sign-On](./media/achieve3000-tutorial/tutorial_officespace_04.png)

    ![Configurare l'aggiunta attributo Single Sign-On](./media/achieve3000-tutorial/tutorial_attribute_05.png)
...
7. Fare clic sul pulsante **Salva** .
    ...
    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/achieve3000-tutorial/tutorial_general_400.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/achieve3000-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/achieve3000-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/achieve3000-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/achieve3000-tutorial/create_aaduser_04.png)
...
In questa sezione viene creato un utente di nome Britta Simon in Achieve3000. Collaborare con il  [team di supporto di withAchieve3000](https://www.achieve3000.com/contact-us/) per aggiungere gli utenti alla piattaforma Achieve3000. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On. 
...
2. Nell'elenco delle applicazioni selezionare **Achieve3000**.
    ...
    ![Collegamento di Achieve3000 nell'elenco delle applicazioni](./media/achieve3000-tutorial/tutorial_achieve3000_app.png)  
