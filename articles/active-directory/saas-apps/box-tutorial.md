...
1. Nella sezione **Configurazione SAML di base** immettere i valori per i campi seguenti:
    ...
    c. Nella casella di testo **URL di risposta** digitare un URL: `https://sso.services.box.net/sp/ACS.saml2`
...
Quando si fa clic sul riquadro di Box nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Box per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Come proteggere Box con visibilità e controlli avanzati](/cloud-app-security/protect-box)