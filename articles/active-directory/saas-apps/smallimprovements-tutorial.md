...
1. Nella pagina di integrazione dell'applicazione [Small Improvements](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
