...
1. Nella pagina di integrazione dell'applicazione [Sauce Labs - Mobile and Web Testing](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
