...
* Sottoscrizione di Uberflip abilitata per l'accesso Single Sign-On

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* Uberflip supporta l'accesso SSO avviato da **SP** e **IDP**

* Uberflip supporta il provisioning utenti **JIT**
...
In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con U usando un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Uberflip.
...
2. **[Configurare l'accesso Single Sign-On di Uberflip](#configure-uberflip-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente di test di Uberflip](#create-uberflip-test-user)**: per avere una controparte di Britta Simon in Uberflip collegata alla rappresentazione dell'utente in Azure AD.
...
Per configurare l'accesso Single Sign-On di Azure AD con Uberflip, seguire questa procedura:
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    > [!NOTE]
    > Poiché non è reale, è necessario aggiornare questo valore con l'URL di risposta effettivo. Per ottenere questo valore, contattare il [team di supporto clienti di Uberflip](mailto:support@uberflip.com). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    Nella casella di testo **URL di accesso** digitare un URL: `https://app.uberflip.com/users/login`
...
7. Nella sezione **Configura Uberflip** copiare gli URL appropriati in base alle esigenze.
...
Per configurare l'accesso Single Sign-On sul lato **Uberflip**, è necessario inviare il file di **XML metadati federazione** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di Uberflip](mailto:support@uberflip.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Uberflip**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco di applicazioni selezionare **Uberflip**.

    ![Collegamento di Uberflip nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-uberflip-test-user"></a>Creare un utente di test di Uberflip

In questa sezione viene creato un utente di nome Britta Simon in Uberflip. Uberflip supporta il provisioning utenti JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in Uberflip, ne viene creato uno nuovo dopo l'autenticazione.
...
Quando si fa clic sul riquadro di Uberflip nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Uberflip per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
