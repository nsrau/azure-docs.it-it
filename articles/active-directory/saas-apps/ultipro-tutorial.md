...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a UltiPro con gli account Azure AD personali.
...
4. Nella casella di ricerca digitare **UltiPro**, selezionare **UltiPro** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![UltiPro nell'elenco risultati](common/search-new-app.png)
...
5. **[Creare l'utente di test di UltiPro](#create-ultipro-test-user)**: per avere una controparte di Britta Simon in UltiPro collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **UltiPro** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
### <a name="configure-ultipro-single-sign-on"></a>Configurare l'accesso Single Sign-On di UltiPro
...
2. Nell'elenco delle applicazioni digitare e selezionare **UltiPro**.

    ![Collegamento a UltiPro nell'elenco delle applicazioni](common/all-applications.png)
...
Quando si fa clic sul riquadro di UltiPro nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione UltiPro per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
