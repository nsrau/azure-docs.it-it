...
3. Determinare quali dati eseguire il [mapping tra Azure ad e Webroot Security Awareness Training](../app-provisioning/customize-application-attributes.md). 
...
Aggiungere Webroot Security Awareness Training dalla raccolta di applicazioni Azure AD per iniziare a gestire il provisioning in Webroot Security Awareness Training. Per altre informazioni su come aggiungere un'applicazione dalla raccolta, fare clic [qui](../manage-apps/add-application-portal.md). 
...
9. Esaminare gli attributi utente sincronizzati da Azure AD a Webroot Security Awareness Training nella sezione **attribute-mapping** . Gli attributi selezionati come proprietà **corrispondenti** vengono usati per trovare le corrispondenze con gli account utente in Webroot Security Awareness Training per le operazioni di aggiornamento. Se si sceglie di modificare l' [attributo di destinazione corrispondente](../app-provisioning/customize-application-attributes.md), è necessario assicurarsi che l'API Webroot Security Awareness Training supporti il filtraggio degli utenti in base a tale attributo. Selezionare il pulsante **Salva** per eseguire il commit delle modifiche.
