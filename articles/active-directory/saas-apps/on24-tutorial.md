...
1. Nella pagina di integrazione dell'applicazione [ON24 Virtual Environment SAML Connection](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
