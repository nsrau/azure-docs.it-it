...
1. Nella pagina di integrazione dell'applicazione [eDigitalResearch](https://portal.azure.com/) del **portale di Azure** selezionare **Single sign-on**.
