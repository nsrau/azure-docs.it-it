...
1. Nella pagina di integrazione dell'applicazione [Lifesize Cloud](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
