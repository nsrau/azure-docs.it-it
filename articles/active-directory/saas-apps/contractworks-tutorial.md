...
Per configurare l'accesso Single Sign-On di Azure AD con ContractWorks, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **ContractWorks** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    Nella casella di testo **URL di accesso** digitare un URL: `https://login.securedocs.com/saml/hint`

6. L'applicazione ContractWorks si aspetta che le asserzioni SAML abbiano un formato specifico. Configurare le attestazioni seguenti per questa applicazione. È possibile gestire i valori di questi attributi dalla sezione **Attributi utente** nella pagina di integrazione dell'applicazione. Nella pagina **Configura l'accesso Single Sign-On con SAML** fare clic sul pulsante **Modifica** per aprire la finestra di dialogo **Attributi utente**.
...
### <a name="configure-contractworks-single-sign-on"></a>Configurare l'accesso Single Sign-On per ContractWorks
...
2. Nell'elenco delle applicazioni selezionare **ContractWorks**.
    ...
    ![Collegamento ContractWorks nell'elenco delle applicazioni](common/all-applications.png)
...
In questa sezione viene creato un utente di nome Britta Simon in ContractWorks. Collaborare con il  [team di supporto di ContractWorks](mailto:support@contractworks.com) per aggiungere gli utenti alla piattaforma ContractWorks. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
