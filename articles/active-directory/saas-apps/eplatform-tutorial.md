...
Per configurare e testare l'accesso Single Sign-On di Azure AD con ePlatform, è necessario completare le procedure di base seguenti:
...
5. **[Creare l'utente di test di ePlatform](#create-eplatform-test-user)**: per avere una controparte di Britta Simon in ePlatform collegata alla rappresentazione dell'utente in Azure AD.
...
9. Nella sezione **Configura ePlatform** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a ePlatform.
