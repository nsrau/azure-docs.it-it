...
4. **[Creare un utente di test di Folloze](#create-folloze-test-user)**: per avere una controparte di Britta Simon in Folloze collegata alla rappresentazione dell'utente in Azure AD.
