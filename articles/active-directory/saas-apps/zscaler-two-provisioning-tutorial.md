...
3. Per aggiungere Zscaler Two, scegliere il **nuova applicazione** pulsante nella parte superiore della finestra di dialogo.

    ![Pulsante Nuova applicazione][3]

4. Nella casella di ricerca digitare **Zscaler Two**.

    ![Il Provisioning di Zscaler Two](./media/zscaler-two-provisioning-tutorial/app-search.png)

5. Nel pannello dei risultati, selezionare **Zscaler Two**, quindi fare clic sul **Add** pulsante per aggiungere Zscaler Two al proprio elenco di applicazioni SaaS.

    ![Il Provisioning di Zscaler Two](./media/zscaler-two-provisioning-tutorial/app-search-results.png)

    ![Il Provisioning di Zscaler Two](./media/zscaler-two-provisioning-tutorial/app-creation.png)
...
2. Selezionare nell'elenco delle applicazioni SaaS di Zscaler Two.

    ![Il Provisioning di Zscaler Two](./media/zscaler-two-provisioning-tutorial/app-instance-search.png)
