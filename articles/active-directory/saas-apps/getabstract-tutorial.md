...
1. Nella casella di ricerca digitare **Getabstract**, selezionare **Getabstract** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Getabstract nell'elenco risultati](./media/getabstract-tutorial/tutorial_getabstract_addfromgallery.png)
...
1. **[Creare un utente di test di Getabstract](#create-a-getabstract-test-user)**: per avere una controparte di Britta Simon in Getabstract collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/getabstract-tutorial/tutorial_getabstract_samlbase.png)

1. Nella sezione **URL e dominio Getabstract** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:

    ![Informazioni su URL e dominio per Single Sign-On di Getabstract](./media/getabstract-tutorial/tutorial_getabstract_url.png)
...
1. Selezionare **Mostra impostazioni URL avanzate** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per Single Sign-On di Getabstract](./media/getabstract-tutorial/tutorial_getabstract_url1.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/getabstract-tutorial/tutorial_getabstract_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/getabstract-tutorial/tutorial_general_400.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/getabstract-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/getabstract-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/getabstract-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/getabstract-tutorial/create_aaduser_04.png)
...
1. Nell'elenco di applicazioni selezionare **Getabstract**.
    ...
    ![Collegamento di Getabstract nell'elenco delle applicazioni](./media/getabstract-tutorial/tutorial_getabstract_app.png)  
