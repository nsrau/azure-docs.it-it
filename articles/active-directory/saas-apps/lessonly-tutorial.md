...
1. **[Creazione di un utente di test di Lessonly.com](#creating-a-lessonly-test-user)**: per avere una controparte di Britta Simon in Lessonly.com collegata alla rappresentazione dell'utente in Azure AD.
