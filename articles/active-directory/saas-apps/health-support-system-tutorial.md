---
title: "Esercitazione: Integrazione dell'accesso Single Sign-On (SSO) di Azure Active Directory con Health Support System | Microsoft Docs"
...
ms.locfileid: "76991883"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-health-support-system"></a>Esercitazione: Integrazione dell'accesso Single Sign-On (SSO) di Azure Active Directory con Health Support System
...
- [Come proteggere Health Support System con visibilità e controlli avanzati](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)