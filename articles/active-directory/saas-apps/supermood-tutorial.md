...
Per configurare l'integrazione di Supermood in Azure AD, è necessario aggiungere Supermood dalla raccolta all'elenco di app SaaS gestite.
...
1. Nell'elenco delle applicazioni selezionare **Supermood**.
...
### <a name="create-supermood-test-user"></a>Creare l'utente di test di Supermood
...
Quando si fa clic sul riquadro di Supermood nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Supermood per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
