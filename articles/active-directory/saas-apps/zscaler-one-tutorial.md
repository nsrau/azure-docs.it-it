...
1. Nella pagina di integrazione dell'applicazione [Zscaler One](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
...
6. Nella pagina della finestra di dialogo **Configure User Authentication** seguire questa procedura:
    ...
    ![Amministrazione](./media/zscaler-one-tutorial/ic800207.png)
