...
4. Nella casella di ricerca digitare **Zscaler One**.

    ![Creazione di un utente test di Azure AD](./media/zscaler-one-tutorial/tutorial_zscalerone_search.png)

5. Nel pannello dei risultati selezionare **Zscaler One** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
4. **[Creazione di un utente di test di Zscaler One](#creating-a-zscaler-one-test-user)**: per avere una controparte di Britta Simon in Zscaler One collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **URL e dominio Zscaler One** seguire questa procedura:
...
6. Nella sezione **Configurazione di Zscaler One** fare clic su **Configura Zscaler One** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**

    ![Configure Single Sign-On](./media/zscaler-one-tutorial/tutorial_zscalerone_configure.png) 

7. In un'altra finestra del Web browser accedere al sito aziendale di Zscaler One come amministratore.
