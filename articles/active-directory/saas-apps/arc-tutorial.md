...
## <a name="configure-and-test-azure-ad-single-sign-on-for-arc-publishing---sso"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per Arc Publishing - SSO
...
1. Nella pagina di integrazione dell'applicazione **Arc Publishing - SSO** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On** .
...
- [Provare Arc Publishing - SSO con Azure AD](https://aad.portal.azure.com/)