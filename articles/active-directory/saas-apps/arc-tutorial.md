...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) ad Arc Publishing - SSO con gli account Azure AD.
...
* Sottoscrizione di Arc Publishing - SSO abilitata per l'accesso Single Sign-On
...
4. Nella casella di ricerca digitare **Arc Publishing - SSO**, selezionare **Arc Publishing - SSO** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Arc Publishing - SSO nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Arc Publishing - SSO usando un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Arc Publishing - SSO.
...
2. **[Configurare l'accesso Single Sign-On per Arc Publishing - SSO](#configure-arc-publishing---sso-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di Arc Publishing - SSO](#create-arc-publishing---sso-test-user)**: per avere una controparte di Britta Simon in Arc Publishing - SSO collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Arc Publishing - SSO** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Arc Publishing - SSO](common/idp-intiated.png)
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Arc Publishing - SSO](common/metadata-upload-additional-signon.png)
...
9. Nella sezione **Configura Arc Publishing - SSO** copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-arc-publishing---sso-single-sign-on"></a>Configurare l'accesso Single Sign-On per Arc Publishing - SSO
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso ad Arc Publishing - SSO.

1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Arc Publishing - SSO**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Arc Publishing - SSO**.

    ![Collegamento di Arc Publishing - SSO nell'elenco delle applicazioni](common/all-applications.png)
