...
1. Nella pagina di integrazione dell'applicazione [Yonyx Interactive Guides](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    b. Nella casella di testo **Identificatore (ID entità)** digitare un URL nel formato seguente: `https://<company name>.yonyx.com`
