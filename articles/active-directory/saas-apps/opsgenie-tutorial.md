...
## <a name="configure-and-test-azure-ad-single-sign-on-for-opsgenie"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per OpsGenie
...
Per configurare e testare l'accesso SSO di Azure AD con OpsGenie, completare le procedure di base seguenti:
...
1. **[Configurare l'accesso Single Sign-On di OpsGenie](#configure-opsgenie-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    * **[Creare l'utente di test di OpsGenie](#create-opsgenie-test-user)** : per avere una controparte di B.Simon in OpsGenie collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **OpsGenie** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
- [Provare OpsGenie con Azure AD](https://aad.portal.azure.com/)
