...
4. Nella casella di ricerca digitare **Apptio**, selezionare **Apptio** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![Apptio nell'elenco risultati](./media/apptio-tutorial/tutorial_apptio_addfromgallery.png)
...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/apptio-tutorial/tutorial_apptio_samlbase.png)
...
3. Nella sezione **URL e dominio Apptio** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da IDP:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Apptio](./media/apptio-tutorial/tutorial_apptio_url.png)

    Nella casella di testo **Identificatore** digitare il valore: `urn:federation:apptio`

4. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.

    ![Collegamento di download del certificato](./media/apptio-tutorial/tutorial_apptio_certificate.png) 
...
8. Fare clic sul pulsante **Salva** .
    ...
    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/apptio-tutorial/tutorial_general_400.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/apptio-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/apptio-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/apptio-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/apptio-tutorial/create_aaduser_04.png)
...
In questa sezione viene creato un utente di nome Britta Simon in Apptio. Per aggiungere utenti alla piattaforma Apptio, collaborare con il  [team di supporto di Apptio](https://www.apptio.com/about/contact) . Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
...
2. Nell'elenco delle applicazioni, selezionare **Apptio**.
    ...
    ![Collegamento di Apptio nell'elenco delle applicazioni](./media/apptio-tutorial/tutorial_apptio_app.png)  
