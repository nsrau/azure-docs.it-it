...
ms.date: 03/20/2020
ms.author: jeedes
ms.openlocfilehash: 2043a14b2da58cf47c6920fce00df9bbf480ae29
ms.sourcegitcommit: 9b8425300745ffe8d9b7fbe3c04199550d30e003
ms.translationtype: HT
ms.contentlocale: it-IT
ms.lasthandoff: 10/23/2020
ms.locfileid: "92460453"
---
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-icims"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per ICIMS
...
Per configurare e testare l'accesso SSO di Azure AD con ICIMS, completare le procedure di base seguenti:
...
1. Nella pagina di integrazione dell'applicazione **ICIMS** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On** .
...
1. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    b. Nella casella di testo **Identificatore** digitare un URL: `icims.com`

    c. Nella casella di testo **URL di risposta** digitare un URL: `https://.icims.com/`
...
Quando si fa clic sul riquadro di ICIMS nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione ICIMS per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Provare ICIMS con Azure AD](https://aad.portal.azure.com/)
