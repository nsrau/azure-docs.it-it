...
1. Nella pagina di integrazione dell'applicazione [Trisotech Digital Enterprise Server](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
