...
1. Nella pagina di integrazione dell'applicazione [SAML 1.1 Token enabled LOB App](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
