...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni sull'accesso Single Sign-On per gli URL e il dominio di SAML 1.1 Token enabled LOB App](common/sp-identifier.png)

    a. Nella casella di testo **URL di accesso** digitare un URL usando il modello seguente: `https://your-app-url`

    b. Nella casella di testo **Identificatore (ID entità)** digitare un URL usando il modello seguente: `https://your-app-url`
