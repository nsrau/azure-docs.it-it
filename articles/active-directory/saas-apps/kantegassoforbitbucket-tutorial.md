...
1. Nella pagina di integrazione dell'applicazione [Kantega SSO for Bitbucket](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
