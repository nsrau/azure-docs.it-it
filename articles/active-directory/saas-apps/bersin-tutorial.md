...
* Bersin supporta l'accesso SSO avviato da **SP e IDP**
...
In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Bersin usando un utente di test di nome **Britta Simon**. Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Bersin.
...
2. **[Configurare l'accesso Single Sign-On di Bersin](#configure-bersin-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente di test di Bersin](#create-bersin-test-user)**: per avere una controparte di Britta Simon in Bersin collegata alla rappresentazione dell'utente in Azure AD.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione nella modalità avviata da **IDP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Bersin](common/idp-identifier-relay.png)

    a. Nella casella di testo **Identificatore** digitare un URL nel formato seguente: `https://www.bersin.com/shibboleth`

    b. Fare clic su **Impostare URL aggiuntivi**.

    c. Nella casella di testo **Stato dell'inoltro** digitare un URL usando il modello seguente: `https://www.bersin.com/secure/`

5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Bersin](common/metadata-upload-additional-signon.png)
...
7. Nella sezione **Configura Bersin** copiare gli URL appropriati in base alle esigenze.
...
Per configurare l'accesso Single Sign-On sul lato **Bersin**, è necessario inviare il file **XML metadati federazione** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di Bersin](mailto:ramansabde@gmail.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
2. Nell'elenco delle applicazioni selezionare **Bersin**.
    ...
    ![Collegamento di Bersin nell'elenco delle applicazioni](common/all-applications.png)
