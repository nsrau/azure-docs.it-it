...
1. Nella pagina di integrazione dell'applicazione [Flatter Files](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
