...
Per configurare l'integrazione di Lynda.com in Azure AD, è necessario aggiungere Lynda.com dalla raccolta all'elenco di app SaaS gestite.
...
4. Nella casella di ricerca digitare **Lynda.com**, selezionare **Lynda.com** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Lynda.com nell'elenco risultati](common/search-new-app.png)
...
Per configurare e testare l'accesso Single Sign-On di Azure AD con Lynda.com, è necessario completare le procedure di base seguenti:
...
5. **[Creare l'utente di test di Lynda.com](#create-lyndacom-test-user)**: per avere una controparte di Britta Simon in Lynda.com collegata alla rappresentazione dell'utente in Azure AD.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    Nella casella di testo **URL di accesso** digitare un URL nel formato seguente: `https://<subdomain>.lynda.com/Shibboleth.sso/InCommon?providerId=<url>&target=<url>`
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Lynda.com.
...
### <a name="create-lyndacom-test-user"></a>Creare l'utente di test di Lynda.com
