...
3.  Contattare il team di supporto matthew.hunt@ringcentral.com di RingCentral all'indirizzo per un **token di autenticazione scim**. Questo valore verrà immesso nel campo token segreto nella scheda provisioning dell'applicazione RingCentral nel portale di Azure.
