...
1. Nella pagina di integrazione dell'applicazione [EFI Digital StoreFront](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
...
In questa sezione viene creato un utente chiamato Britta Simon in EFI Digital StoreFront. Collaborare con il  [team di supporto di EFI Digital StoreFront](https://www.efi.com/products/productivity-software/ecommerce-web-to-print/efi-digital-storefront/support/) per aggiungere gli utenti alla piattaforma EFI Digital StoreFront. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
