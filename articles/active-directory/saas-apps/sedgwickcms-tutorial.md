...
In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure con Sedgwick CMS usando un utente di test di nome **Britta Simon**.
...
1. Nella pagina di integrazione dell'applicazione [Sedgwick CMS](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
