...
1. Nella casella di ricerca digitare **Sedgwick CMS**, selezionare **Sedgwick CMS** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Sedgwick CMS nell'elenco risultati](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_addfromgallery.png)
...
1. **[Creare un utente di test di Sedgwick CMS](#create-a-sedgwick-cms-test-user)** per avere una controparte di Britta Simon in Sedgwick CMS collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_samlbase.png)

1. Nella sezione **URL e dominio Sedgwick CMS** eseguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Sedgwick CMS](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_url.png)
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore e l'URL di risposta effettivi. Per ottenere questi valori, contattare il [team di supporto di Sedgwick CMS](https://www.sedgwick.com/help).
 

1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.

    ![Collegamento di download del certificato](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_certificate.png) 
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/sedgwickcms-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/sedgwickcms-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/sedgwickcms-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/sedgwickcms-tutorial/create_aaduser_04.png)
...
1. Nell'elenco di applicazioni selezionare **Sedgwick CMS**.

    ![Collegamento a Sedgwick CMS nell'elenco delle applicazioni](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_app.png)  
