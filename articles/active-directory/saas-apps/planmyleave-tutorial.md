...
Per configurare l'integrazione di PlanMyLeave in Azure AD, è necessario aggiungere PlanMyLeave dalla raccolta all'elenco di app SaaS gestite.
...
Per configurare e testare l'accesso Single Sign-On di Azure AD con PlanMyLeave, è necessario completare le procedure di base seguenti:
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a PlanMyLeave.
...
2. Nell'elenco delle applicazioni selezionare **PlanMyLeave**.
