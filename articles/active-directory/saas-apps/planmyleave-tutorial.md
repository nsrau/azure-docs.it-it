---
title: 'Esercitazione: Integrazione di Azure Active Directory con PlanMyLeave | Microsoft Docs'
...
1. Nella casella di ricerca digitare **PlanMyLeave**, selezionare **PlanMyLeave** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![PlanMyLeave nell'elenco risultati](./media/planmyleave-tutorial/tutorial_planmyleave_addfromgallery.png)
...
1. **[Creare un utente test di PlanMyLeave](#create-a-planmyleave-test-user)**: per avere una controparte di Britta Simon in PlanMyLeave collegata alla rappresentazione in Azure AD dell'utente.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/planmyleave-tutorial/tutorial_planmyleave_samlbase.png)

1. Nella sezione **URL e dominio PlanMyLeave** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di PlanMyLeave](./media/planmyleave-tutorial/tutorial_planmyleave_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/planmyleave-tutorial/tutorial_planmyleave_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/planmyleave-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di PlanMyLeave** fare clic su **Configura PlanMyLeave** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**

    ![Configurazione di PlanMyLeave](./media/planmyleave-tutorial/tutorial_planmyleave_configure.png) 
1. In un'altra finestra del browser Web accedere al tenant di PlanMyLeave come amministratore.

1. Passare a **System Setup**. Quindi nella sezione **Gestione sicurezza** fare clic su **Company SAML settings** (Impostazioni SAML azienda).

    ![Configurazione accesso Single Sign-On sul lato app](./media/planmyleave-tutorial/tutorial_planmyleave_002.png) 

1. Nella sezione **SAML Settings** (Impostazioni SAML) fare clic sull'icona dell'editor.

    ![Configurazione accesso Single Sign-On sul lato app](./media/planmyleave-tutorial/tutorial_planmyleave_003.png)

1. Nella sezione **Update SAML Settings** (Aggiorna impostazioni SAML) eseguire i seguenti passaggi:
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/planmyleave-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/planmyleave-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/planmyleave-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/planmyleave-tutorial/create_aaduser_04.png)
...
1. Nell'elenco di applicazioni selezionare **PlanMyLeave**.

    ![Collegamento di PlanMyLeave nell'elenco delle applicazioni](./media/planmyleave-tutorial/tutorial_planmyleave_app.png)  
