...
8. Nella pagina **SAML configuration assistant** seguire questa procedura:
    ...
    d. Nella casella di testo **User name attribute** (Attributo nome utente) digitare `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress`.
