...
## <a name="configure-and-test-azure-ad-single-sign-on-for-boomi"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per Boomi
...
1. Nella pagina di integrazione dell'applicazione **Boomi** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On** .
...
1. Dopo aver effettuato l'accesso, passare a **Gestione utenti** e scegliere **Utenti** .
    ...
    ![Screenshot che mostra la pagina User Management con l'opzione Users selezionata.](./media/boomi-tutorial/tutorial_boomi_001.png "Utenti")

1. Fare clic sull'icona **+** . Si aprirà la finestra di dialogo **Add/Maintain User Roles** (Aggiungi/Gestisci ruoli utente).

    ![Screenshot che mostra l'icona + selezionata.](./media/boomi-tutorial/tutorial_boomi_002.png "Utenti")

    ![Screenshot che mostra la schermata Add / Maintain User Roles in cui configurare un utente.](./media/boomi-tutorial/tutorial_boomi_003.png "Utenti")
...
Quando si fa clic sul riquadro di Boomi nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Boomi per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
