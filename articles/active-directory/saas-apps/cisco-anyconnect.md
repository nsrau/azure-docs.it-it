...
## <a name="configure-and-test-azure-ad-single-sign-on-for-cisco-anyconnect"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per Cisco AnyConnect
...
Per configurare e testare l'accesso SSO di Azure AD con Cisco AnyConnect, completare le procedure di base seguenti:
...
1. Nella pagina di integrazione dell'applicazione **Cisco AnyConnect** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
- [Provare Cisco AnyConnect con Azure AD](https://aad.portal.azure.com/)

- [Informazioni sul controllo sessioni in Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Come proteggere Cisco AnyConnect con visibilità e controlli avanzati](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
