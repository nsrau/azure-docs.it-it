...
1. Nella casella di ricerca digitare **Gigya**.

    ![Creazione di un utente test di Azure AD](./media/gigya-tutorial/tutorial_gigya_search.png)

1. Nel pannello dei risultati selezionare **Gigya** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/gigya-tutorial/tutorial_gigya_addfromgallery.png)
...
1. **[Creazione di un utente test di Gigya](#creating-a-gigya-test-user)**: per avere una controparte di Britta Simon in Gigya collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Gigya** seguire questa procedura:
...
1. Nella sezione**Configurazione di Gigya** fare clic su **Configura Gigya** per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido.**
...
1. Passare a **Impostazioni \> SAML Login (Accesso a SAML)**, quindi fare clic sul pulsante **Aggiungi**.
   
    ![Login SAML](./media/gigya-tutorial/ic789532.png "Login SAML")

1. Nella sezione **SAML Login** seguire questa procedura:
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/gigya-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/gigya-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/gigya-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/gigya-tutorial/create_aaduser_04.png) 
...
1. Passare a **Amministratore \> Gestisci utenti**  e quindi fare clic su **Invita utenti**.
   
    ![Gestione utenti](./media/gigya-tutorial/ic789535.png "Gestione utenti")

1. Nella finestra di dialogo Invite Users seguire questa procedura:
