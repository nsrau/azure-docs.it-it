...
ms.locfileid: "68931814"
---
# <a name="tutorial-integrate-iwellnessnow-with-azure-active-directory"></a>Esercitazione: Integrare iWellnessNow con Azure Active Directory

Questa esercitazione descrive come integrare iWellnessNow con Azure Active Directory (Azure AD). Integrando iWellnessNow con Azure AD, è possibile:

* Controllare in Azure AD chi può accedere a iWellnessNow.
* Abilitare gli utenti per l'accesso automatico a iWellnessNow con gli account Azure AD personali.
...
* Sottoscrizione di iWellnessNow abilitata per l'accesso Single Sign-On (SSO).

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* iWellnessNow supporta l'accesso SSO avviato da **SP e IDP**
...
1. Nella sezione **Aggiungi dalla raccolta** digitare **iWellnessNow** nella casella di ricerca.
1. Selezionare **iWellnessNow** nel pannello dei risultati e quindi aggiungere l'app. Attendere alcuni secondi che l'app venga aggiunta al tenant.

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

Configurare e testare l'accesso SSO di Azure AD con iWellnessNow usando un utente di test di nome **B.Simon**. Per consentire il funzionamento dell'accesso Single Sign-On, è necessario stabilire una relazione di collegamento tra un utente di Azure AD e l'utente correlato in iWellnessNow.

Per configurare e testare l'accesso SSO di Azure AD con iWellnessNow, completare le procedure di base seguenti:

1. **[Configurare l'accesso Single Sign-On di Azure AD](#configure-azure-ad-sso)** : per consentire agli utenti di usare questa funzionalità.
2. **[Configurare l'accesso Single Sign-On di iWellnessNow](#configure-iwellnessnow-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
...
5. **[Creare l'utente di test di iWellnessNow](#create-iwellnessnow-test-user)** : per avere una controparte di B. Simon in iWellnessNow collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **iWellnessNow** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
1. Per configurare l'applicazione in modalità avviata da **IDP** se non si dispone del **file di metadati del provider di servizi**, seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di iWellnessNow](common/idp-intiated.png)
...
1. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    Nella casella di testo **URL accesso** digitare un URL nel formato seguente: `https://<CustomerName>.iwellnessnow.com/`

    > [!NOTE]
    > Poiché questi non sono i valori reali, aggiornarli con l'URL di accesso, l'identificatore e l'URL di risposta effettivi. Per ottenere questi valori contattare il [team di supporto clienti di iWellnessNow](mailto:info@iwellnessnow.com). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
1. Nella sezione **Configura iWellnessNow** copiare gli URL appropriati in base alle esigenze.

    ![Copiare gli URL di configurazione](common/copy-configuration-urls.png)

### <a name="configure-iwellnessnow-sso"></a>Configurare l'accesso Single Sign-On di iWellnessNow

Per configurare l'accesso Single Sign-On sul lato **iWellnessNow**, è necessario inviare il file **XML dei metadati della federazione** scaricato e gli URL appropriati, copiati dal portale di Azure, al [team di supporto di iWellnessNow](mailto:info@iwellnessnow.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
In questa sezione si abiliterà B.Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a iWellnessNow.
...
### <a name="create-iwellnessnow-test-user"></a>Creare l'utente di test di iWellnessNow
