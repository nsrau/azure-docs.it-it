...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Overdrive con gli account Azure AD personali.
...
* Overdrive supporta l'accesso SSO avviato da **SP**

* Overdrive supporta il provisioning utenti **JIT**
...
**Per aggiungere Overdrive dalla raccolta, seguire questa procedura:**
...
4. Nella casella di ricerca digitare **Overdrive**, selezionare **Overdrive** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Overdrive nell'elenco risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Overdrive.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Overdrive](common/sp-signonurl.png)
...
### <a name="configure-overdrive-single-sign-on"></a>Configurare l'accesso Single Sign-On di Overdrive
...
2. Nell'elenco delle applicazioni selezionare **Overdrive**.
    ...
    ![Collegamento di Overdrive nell'elenco delle applicazioni](common/all-applications.png)
