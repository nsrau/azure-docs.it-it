...
description: Informazioni sui passaggi da eseguire in Jive e Azure AD per effettuare automaticamente il provisioning e il deprovisioning degli account utente da Azure AD a Jive.
...
1. Impostare **Modalità di provisioning** su **Automatico**. 
    ...
    ![Screenshot mostra la pagina di provisioning di Jive, con la modalità di provisioning impostata su automatico e altri valori che è possibile impostare.](./media/jive-provisioning-tutorial/provisioning.png)
...
1. Nella sezione **Credenziali di amministratore** specificare le impostazioni di configurazione seguenti:
    ...
    c. Nella casella di testo **URL tenant Jive** digitare l'URL del tenant Jive.
      ...
      > In genere, l'URL ha il formato seguente: **www. \<organization\> . jive.com**.          
...
* [Configura accesso Single Sign-on](jive-tutorial.md)