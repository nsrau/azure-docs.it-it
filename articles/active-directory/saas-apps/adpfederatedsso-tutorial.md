...
5. Nella casella di ricerca digitare **ADP**, selezionare **ADP** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![ADP nell'elenco dei risultati](./media/adpfederatedsso-tutorial/tutorial_adp_addfromgallery.png)
...
3. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/adpfederatedsso-tutorial/tutorial_adp_samlbase.png)

4. Nella sezione **URL e dominio ADP** eseguire i passaggi descritti di seguito:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di ADP](./media/adpfederatedsso-tutorial/tutorial_adp_url.png)
...
7. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/adpfederatedsso-tutorial/tutorial_adp_certificate.png) 
...
4. Nella casella di ricerca digitare **ADP**, selezionare **ADP** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![ADP nell'elenco dei risultati](./media/adpfederatedsso-tutorial/tutorial_adp_addservicegallery.png)
...
5. Nel portale di Azure, nella pagina di integrazione dell'applicazione **ADP** fare clic sulla scheda **Proprietà** e seguire questa procedura:  
    ...
    ![Proprietà collegate Single Sign-On](./media/adpfederatedsso-tutorial/tutorial_adp_linkedproperties.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/adpfederatedsso-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/adpfederatedsso-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/adpfederatedsso-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/adpfederatedsso-tutorial/create_aaduser_04.png)
...
2. Nell'elenco delle applicazioni selezionare **ADP**.
    ...
    ![Collegamento di ADP nell'elenco delle applicazioni](./media/adpfederatedsso-tutorial/tutorial_adp_app.png)  
