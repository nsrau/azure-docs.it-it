...
1. Nella casella di ricerca digitare **Asana** selezionare **Asana** dal pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/asana-tutorial/tutorial_asana_addfromgallery.png)
...
1. **[Creare un utente di test di Asana](#create-an-asana-test-user)**: per avere una controparte di Britta Simon in Asana collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/asana-tutorial/tutorial_asana_samlbase.png)

1. Nella sezione **URL e dominio Asana** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Asana](./media/asana-tutorial/tutorial_asana_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Collegamento di download del certificato](./media/asana-tutorial/tutorial_asana_certificate.png)

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/asana-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di Asana** fare clic su **Configura Asana** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**

    ![Configurazione di Asana](./media/asana-tutorial/tutorial_asana_configure.png)
...
1. Nella finestra **Organization settings** (Impostazioni organizzazione) fare clic su **Administation** (Amministrazione). Fare clic su **Members must log in via SAML** (I membri devono accedere tramite SAML) per abilitare la configurazione di SSO. Eseguire quindi questa procedura:
...
1. Fare clic su **Save**. Per altre informazioni e assistenza, vedere la [guida di Asana per la configurazione di SSO](https://asana.com/guide/help/premium/authentication#gl-saml) .
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/asana-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/asana-tutorial/create_aaduser_02.png)

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.

    ![Creazione di un utente test di Azure AD](./media/asana-tutorial/create_aaduser_03.png)

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:

    ![Pulsante Aggiungi](./media/asana-tutorial/create_aaduser_04.png)
...
1. Digitare l'indirizzo di posta elettronica britta.simon@contoso.com nella casella di testo e quindi selezionare **Invite**(Invita).

1. Fare clic su **Send Invite** (Invia invito). Il nuovo utente riceverà un messaggio di posta elettronica nel proprio account di posta elettronica e dovrà creare e convalidare l'account.
...
1. Nell'elenco delle applicazioni selezionare **Asana**.
    ...
    ![Collegamento di Asana nell'elenco delle applicazioni](./media/asana-tutorial/tutorial_asana_app.png)
