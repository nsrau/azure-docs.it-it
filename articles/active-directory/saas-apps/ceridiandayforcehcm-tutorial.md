...
1. Nella pagina di integrazione dell'applicazione [Ceridian Dayforce HCM](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
