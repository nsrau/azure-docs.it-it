...
1. Nella casella di ricerca, digitare **Ceridian Dayforce HCM**, selezionare **Ceridian Dayforce HCM** dal pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Ceridian Dayforce HCM nell'elenco risultati](./media/ceridiandayforcehcm-tutorial/tutorial_ceridiandayforcehcm_addfromgallery.png)
...
1. **[Creare un utente di test di Ceridian Dayforce HCM](#create-a-ceridian-dayforce-hcm-test-user)**: per avere una controparte di Britta Simon in Ceridian Dayforce HCM collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/ceridiandayforcehcm-tutorial/tutorial_ceridiandayforcehcm_samlbase.png)

1. Nella sezione **URL e dominio Ceridian Dayforce HCM** seguire questa procedura:
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore, l'URL di risposta e l'URL di accesso effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di Ceridian Dayforce HCM](https://www.ceridian.com/support).

1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.

    ![Collegamento di download del certificato](./media/ceridiandayforcehcm-tutorial/tutorial_ceridiandayforcehcm_certificate.png) 

1. L'applicazione Ceridian Dayforce HCM si aspetta che le asserzioni SAML abbiano un formato specifico. Collaborare con il [team di supporto di Ceridian Dayforce HCM](https://www.ceridian.com/support) per individuare l'identificatore utente corretto. Microsoft consiglia di utilizzare l'attributo **"name"** come identificatore utente. È possibile gestire i valori di questi attributi dalla sezione **Attributi utente** nella pagina di integrazione dell'applicazione. La schermata seguente illustra un esempio relativo a questa operazione.  
...
1. Fare clic sul pulsante **Salva** .
    ...
    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/ceridiandayforcehcm-tutorial/tutorial_general_400.png)
    
1. Nella sezione **Configurazione di Ceridian Dayforce HCM** fare clic su **Configura Ceridian Dayforce HCM** per aprire la finestra **Configura accesso**. Copiare l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**

    ![Configurazione Ceridian Dayforce HCM](./media/ceridiandayforcehcm-tutorial/tutorial_ceridiandayforcehcm_configure.png) 

1. Per configurare l'accesso Single Sign-On sul lato **Ceridian Dayforce HCM**, è necessario inviare il file **XML metadati** scaricato, l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** al [team di supporto di Ceridian Dayforce HCM](https://www.ceridian.com/support).
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/ceridiandayforcehcm-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/ceridiandayforcehcm-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/ceridiandayforcehcm-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/ceridiandayforcehcm-tutorial/create_aaduser_04.png)
...
Questa sezione descrive come creare un utente chiamato Britta Simon in Ceridian Dayforce HCM. Collaborare con il [team di supporto di Ceridian Dayforce HCM](https://www.ceridian.com/support) per aggiungere gli utenti all'applicazione Ceridian Dayforce HCM. 
...
1. Nell'elenco delle applicazioni, selezionare **Ceridian Dayforce HCM**.
    ...
    ![Il collegamento Ceridian Dayforce HCM nell'elenco delle applicazioni](./media/ceridiandayforcehcm-tutorial/tutorial_ceridiandayforcehcm_app.png)  
