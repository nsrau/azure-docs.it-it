...
1. Nella casella di ricerca digitare **ScaleX Enterprise**.

    ![Creazione di un utente test di Azure AD](./media/scalexenterprise-tutorial/tutorial_scalexenterprise_search.png)

1. Nel pannello dei risultati selezionare **ScaleX Enterprise** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/scalexenterprise-tutorial/tutorial_scalexenterprise_addfromgallery.png)
...
1. **[Creazione di un utente test di ScaleX Enterprise](#creating-a-scalex-enterprise-test-user)**: per avere una controparte di Britta Simon in ScaleX Enterprise collegata alla relativa rappresentazione in Azure AD.
...
1. Nella sezione **URL e dominio ScaleX Enterprise**, se si vuole configurare l'applicazione in modalità avviata da **IDP**, seguire questa procedura:
...
1. Selezionare **Mostra impostazioni URL avanzate**, se si desidera configurare l'applicazione in modalità avviata da **SP**:
    ...
    > [!NOTE] 
    > Questi non sono i valori reali. Aggiornare questi valori con l'identificatore, l'URL di risposta o l'URL di accesso effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di ScaleX Enterprise](https://info.rescale.com/contact_sales). 

1. L'applicazione ScaleX prevede un formato specifico per le asserzioni SAML. È quindi necessario modificare mapping di attributi personalizzati alla configurazione degli attributi del token SAML. Fare clic sulla casella di controllo **Visualizza e modifica tutti gli altri attributi utente** per aprire le impostazioni degli attributi personalizzati.
...
1. Nella sezione **Configurazione di ScaleX Enterprise** fare clic su **Configura ScaleX Enterprise** per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML** e l'**URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido**.

    ![Configure Single Sign-On](./media/scalexenterprise-tutorial/tutorial_scalexenterprise_configure.png) 

1. Per configurare l'accesso Single Sign-On sul lato **ScaleX Enterprise**, accedere al sito Web aziendale di ScaleX Enterprise come amministratore.
...
1. Selezionare **Integrations** (Integrazioni) nel menu superiore e selezionare **Single Sign-On**.
...
1. Compilare il modulo come segue:
    ...
    d. **Identity Provider EntityDescriptor Entity ID** (ID entità EntityDescriptor del provider di identità): incollare il valore **ID entità SAML** copiato dal portale di Azure.
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/scalexenterprise-tutorial/create_aaduser_01.png) 

1. Andare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/scalexenterprise-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/scalexenterprise-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/scalexenterprise-tutorial/create_aaduser_04.png) 
...
Quando si fa clic sul riquadro ScaleX Enterprise nel pannello di accesso, si accede automaticamente all'applicazione ScaleX Enterprise. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/active-directory-saas-access-panel-introduction.md).
