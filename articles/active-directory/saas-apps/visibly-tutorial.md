...
1. Passare all'opzione **settings** (impostazioni) nel menu di spostamento.
    ...
    ![Configurazione](./media/visibly-tutorial/settings.png)

1. Fare clic su **Integrations** (Integrazioni) in Settings (Impostazioni).

    ![Configurazione](./media/visibly-tutorial/integrations.png)

1. In **Integrations** (Integrazioni) selezionare **SSO**.

    ![Configurazione](./media/visibly-tutorial/sso.png)

1. Nella pagina successiva seguire questa procedura.

    ![Configurazione](./media/visibly-tutorial/configuration.png)
...
Quando si fa clic sul riquadro di Visibly nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Visibly per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
