...
3. **[Creare un utente di test di ForeSee CX Suite](#create-a-foresee-cx-suite-test-user)**: per avere una controparte di Britta Simon in ForeSee CX Suite collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **gruppo di dominio e gli URL di ForeSee CX**, se si dispone di un **file di metadati di un provider di servizi**, seguire questa procedura:
...
4. Se non si dispone del **file di metadati del provider di servizi**, seguire questa procedura:
