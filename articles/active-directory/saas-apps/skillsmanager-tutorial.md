...
1. Nella casella di ricerca digitare **Skills Manager**, selezionare **Skills Manager** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Skills Manager nell'elenco risultati](./media/skillsmanager-tutorial/tutorial_skillsmanager_addfromgallery.png)
...
1. **[Creare un utente di test di Skills Manager](#create-a-skills-manager-test-user)**: per avere una controparte di Britta Simon in Skills Manager collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/skillsmanager-tutorial/tutorial_skillsmanager_samlbase.png)

1. Nella sezione **URL e dominio Skills Manager** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Skills Manager](./media/skillsmanager-tutorial/tutorial_skillsmanager_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Collegamento di download del certificato](./media/skillsmanager-tutorial/tutorial_skillsmanager_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/skillsmanager-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di Skills Manager** fare clic su **Configura Skills Manager** per aprire la finestra **Configura accesso**. Copiare l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**

    ![Configurazione di Skills Manager](./media/skillsmanager-tutorial/tutorial_skillsmanager_configure.png) 
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/skillsmanager-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/skillsmanager-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/skillsmanager-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/skillsmanager-tutorial/create_aaduser_04.png)
...
1. Nell'elenco di applicazioni selezionare **Skills Manager**.

    ![Collegamento di Skills Manager nell'elenco delle applicazioni](./media/skillsmanager-tutorial/tutorial_skillsmanager_app.png)  
