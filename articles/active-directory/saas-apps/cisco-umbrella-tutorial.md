...
4. **[Creare un utente di test di Cisco Umbrella](#create-cisco-umbrella-test-user)**: per avere una controparte di Britta Simon in Cisco Umbrella collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella pagina **Account**, fare clic su **Aggiungi** in alto a destra e attenersi ai passaggi seguenti.
    ...
    d. Nel campo **Indirizzo e-mail** immettere l'indirizzo e-mail dell'utente, ad esempio **brittasimon@contoso.com**.
