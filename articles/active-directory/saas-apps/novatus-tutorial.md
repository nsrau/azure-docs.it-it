...
4. Nella casella di ricerca digitare **Novatus**.

    ![Creazione di un utente test di Azure AD](./media/novatus-tutorial/tutorial_novatus_search.png)

5. Nel pannello dei risultati selezionare **Novatus** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
3. Nella sezione **URL e dominio Novatus** seguire questa procedura:
...
6. Nella sezione **Configurazione di Novatus** fare clic su **Configura Novatus** per aprire la finestra **Configura accesso**. Copiare l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**
