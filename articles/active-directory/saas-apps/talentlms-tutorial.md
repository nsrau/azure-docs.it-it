...
1. Nella pagina della finestra di dialogo **Add User** seguire questa procedura:
    ...
    c. Nel **indirizzo di posta elettronica** casella di testo immettere l'indirizzo di posta elettronica dell'utente, ad esempio **brittasimon\@contoso.com**.
