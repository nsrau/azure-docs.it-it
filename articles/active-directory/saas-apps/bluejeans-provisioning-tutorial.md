...
4. Nella casella di ricerca digitare **BlueJeans**.
    ...
    ![Provisioning per BlueJeans](./media/bluejeans-provisioning-tutorial/BluejeansAppSearch.png)
...
5. Nel pannello dei risultati selezionare **BlueJeans** e quindi fare clic sul pulsante **Aggiungi** per aggiungere BlueJeans al proprio elenco di applicazioni SaaS.
    ...
    ![Provisioning per BlueJeans](./media/bluejeans-provisioning-tutorial/BluejeansAppSearchResults.png)

    ![Provisioning per BlueJeans](./media/bluejeans-provisioning-tutorial/BluejeansAppCreate.png)
...
2. Selezionare BlueJeans nell'elenco delle applicazioni SaaS.
    ...
    ![Provisioning per BlueJeans](./media/bluejeans-provisioning-tutorial/Bluejeans2.png)
