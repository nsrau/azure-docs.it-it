...
3. Per aggiungere Atlassian Cloud, scegliere il **nuova applicazione** pulsante nella parte superiore della finestra di dialogo.

    ![Pulsante Nuova applicazione][3]

4. Nella casella di ricerca digitare **Atlassian Cloud**.

    ![Il Provisioning di Atlassian Cloud](./media/atlassian-cloud-provisioning-tutorial/app-search.png)

5. Nel pannello dei risultati, selezionare **Atlassian Cloud**, quindi fare clic sul **Aggiungi** pulsante per aggiungere Atlassian Cloud al proprio elenco di applicazioni SaaS.

    ![Il Provisioning di Atlassian Cloud](./media/atlassian-cloud-provisioning-tutorial/app-create.png)

    ![Il Provisioning di Atlassian Cloud](./media/atlassian-cloud-provisioning-tutorial/app-instance.png)
...
2. Selezionare Atlassian Cloud nell'elenco delle applicazioni SaaS.
 
    ![Il Provisioning di Atlassian Cloud](./media/atlassian-cloud-provisioning-tutorial/application-instance-search.png)
...
5. Sotto il **credenziali di amministratore** sezione di input il **URL del Tenant** e **Token segreto** dell'account di Atlassian Cloud. Ecco alcuni esempi di questi valori:
   ...
   * Nel **URL Tenant** campo, specificare l'endpoint tenant specifico si riceve da Atlassian, come descritto nel passaggio 6. Per esempio: **https://api.atlassian.com/scim/directory/{directoryId}**
