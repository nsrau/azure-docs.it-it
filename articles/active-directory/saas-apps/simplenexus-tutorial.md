...
1. Nella casella di ricerca digitare **SimpleNexus**.

    ![Creazione di un utente test di Azure AD](./media/simplenexus-tutorial/tutorial_simplenexus_search.png)

1. Nel pannello dei risultati selezionare **SimpleNexus** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/simplenexus-tutorial/tutorial_simplenexus_addfromgallery.png)
...
1. **[Creazione di un utente test di SimpleNexus](#creating-a-simplenexus-test-user)**: per avere una controparte di Britta Simon in SimpleNexus collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio SimpleNexus** seguire questa procedura:
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, Aggiornare questi valori con l'identificatore e l'URL di accesso effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di SimpleNexus](https://simplenexus.com/sn/contact-us/). 
...
1. Per configurare l'accesso Single Sign-On sul lato **SimpleNexus**, è necessario inviare il file **XML dei metadati** scaricato al [team di supporto di SimpleNexus](https://simplenexus.com/sn/contact-us/). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/simplenexus-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/simplenexus-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/simplenexus-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/simplenexus-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco di applicazioni selezionare **SimpleNexus**.
