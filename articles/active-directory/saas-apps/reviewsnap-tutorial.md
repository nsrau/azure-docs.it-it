...
3. **[Creare un utente di test di Reviewsnap](#create-a-reviewsnap-test-user)**: per avere una controparte di Britta Simon in Reviewsnap collegata alla rappresentazione dell'utente in Azure AD.
...
3. Nella sezione **Dominio e URL di Reviewsnap** , seguire la procedura seguente se si desidera configurare l'applicazione in modalità iniziata **IDP**:
...
7. Nella sezione **Configurazione di Reviewsnap** fare clic su **Configura Reviewsnap** per aprire la finestra **Configura accesso**. Copiare l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**
