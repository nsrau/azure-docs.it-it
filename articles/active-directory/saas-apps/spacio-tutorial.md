...
4. Nella casella di ricerca digitare **Spacio** , selezionare **Spacio** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Spacio nell'elenco dei risultati](common/search-new-app.png)
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio di Spacio per l'accesso Single Sign-On](common/sp-identifier.png)
...
Quando si fa clic sul riquadro di Spacio nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Spacio per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
