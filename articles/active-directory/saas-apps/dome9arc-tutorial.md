...
6. Nella sezione **Attributi utente** della finestra di dialogo **Single Sign-On** configurare l'attributo del token SAML come indicato nell'immagine precedente e seguire questa procedura:
    ...
    ![Configurare l'attributo di aggiunta dell'accesso Single Sign-On](./media/dome9arc-tutorial/tutorial_dome9_04.png)

    ![Configurare l'attributo di modifica dell'accesso Single Sign-On](./media/dome9arc-tutorial/tutorial_attribute_05.png)
