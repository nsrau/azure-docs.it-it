---
title: "Esercitazione: Integrazione dell'accesso Single Sign-On (SSO) di Azure Active Directory con Terraform Enterprise | Microsoft Docs"
...
ms.locfileid: "88541783"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-terraform-enterprise"></a>Esercitazione: Integrazione dell'accesso Single Sign-On (SSO) di Azure Active Directory con Terraform Enterprise
...
* Terraform Enterprise supporta il provisioning utenti **JIT**

## <a name="adding-terraform-enterprise-from-the-gallery"></a>Aggiunta di Terraform Enterprise dalla raccolta
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-terraform-enterprise"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per Terraform Enterprise
...
1. Nella pagina di integrazione dell'applicazione **Terraform Enterprise** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
Quando si fa clic sul riquadro di Terraform Enterprise nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Terraform Enterprise per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Provare Terraform Enterprise con Azure AD](https://aad.portal.azure.com/)