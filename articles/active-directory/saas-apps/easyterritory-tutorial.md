...
- È possibile abilitare gli utenti per l'accesso automatico a EasyTerritory (Single Sign-On) con gli account Azure AD personali.
...
1. Nella casella di ricerca digitare **EasyTerritory**, selezionare **EasyTerritory** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![EasyTerritory nell'elenco risultati](./media/easyterritory-tutorial/tutorial_easyterritory_addfromgallery.png)
...
Per stabilire la relazione di collegamento, in EasyTerritory assegnare il valore del **nome utente** in Azure AD come valore di **Username** (Nome utente).
...
1. **[Creare un utente di test di EasyTerritory](#create-a-easyterritory-test-user)**: per avere una controparte di Britta Simon in EasyTerritory collegata alla rappresentazione dell'utente in Azure AD.
1. **[Assegnare l'utente test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
1. **[Testare l'accesso Single Sign-On](#test-single-sign-on)** per verificare se la configurazione funziona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurare l'accesso Single Sign-On di Azure AD

In questa sezione viene abilitato l'accesso Single Sign-On di Azure AD nel portale di Azure e viene configurato l'accesso Single Sign-On nell'applicazione EasyTerritory.

**Per configurare l'accesso Single Sign-On di Azure AD con EasyTerritory, seguire questa procedura:**

1. Nella pagina di integrazione dell'applicazione **EasyTerritory** del portale di Azure fare clic su **Single Sign-On**.

    ![Collegamento Configura accesso Single Sign-On][4]

1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
 
    ![Finestra di dialogo Single Sign-On](./media/easyterritory-tutorial/tutorial_easyterritory_samlbase.png)

1. Nella sezione **URL e dominio EasyTerritory** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da IDP:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di EasyTerritory](./media/easyterritory-tutorial/tutorial_easyterritory_url.png)
...
1. Selezionare **Mostra impostazioni URL avanzate** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di EasyTerritory](./media/easyterritory-tutorial/tutorial_easyterritory_url1.png)

    Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://<company name>.easyterritory.com/`
     
    > [!NOTE] 
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore, l'URL di risposta e l'URL di accesso effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di EasyTerritory](mailto:sales@easyterritory.com). 

1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.

    ![Collegamento di download del certificato](./media/easyterritory-tutorial/tutorial_easyterritory_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/easyterritory-tutorial/tutorial_general_400.png)

1. Per configurare l'accesso Single Sign-On sul lato **EasyTerritory**, è necessario inviare il file **XML metadati** scaricato al [team di supporto di EasyTerritory](mailto:sales@easyterritory.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/easyterritory-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/easyterritory-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/easyterritory-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/easyterritory-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **EasyTerritory**.

    ![Collegamento di EasyTerritory nell'elenco delle applicazioni](./media/easyterritory-tutorial/tutorial_easyterritory_app.png)  
