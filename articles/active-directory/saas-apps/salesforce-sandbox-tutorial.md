...
- [Informazioni sul controllo sessioni in Microsoft Cloud App Security](/cloud-app-security/protect-salesforce)

- [Configura provisioning utenti](salesforce-sandbox-provisioning-tutorial.md)

- [Come proteggere Salesforce Sandbox con visibilità e controlli avanzati](/cloud-app-security/proxy-intro-aad)