...
4. Nella casella di ricerca digitare **ClearCompany**, nel pannello dei risultati selezionare **ClearCompany** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![ClearCompany nell'elenco dei risultati](./media/clearcompany-tutorial/tutorial_clearcompany_addfromgallery.png)
...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/clearcompany-tutorial/tutorial_clearcompany_samlbase.png)
...
3. Nella sezione **URL e dominio ClearCompany** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da IDP:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di ClearCompany](./media/clearcompany-tutorial/tutorial_clearcompany_url1.png)

    Nella casella di testo **Identificatore** digitare l'URL: `https://api.clearcompany.com`

4. Selezionare **Mostra impostazioni URL avanzate** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di ClearCompany](./media/clearcompany-tutorial/tutorial_clearcompany_url2.png)

    Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://<companyname>.clearcompany.com`
    
    > [!NOTE] 
    > Poiché questo non è un valore reale, è necessario aggiornare questo valore con l'URL di accesso Sign-On effettivo. Per ottenere questo valore, contattare il [team di supporto clienti di ClearCompany](https://www.clearcompany.com/support). 
...
5. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Collegamento di download del certificato](./media/clearcompany-tutorial/tutorial_clearcompany_certificate.png) 

6. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/clearcompany-tutorial/tutorial_general_400.png)
...
7. Nella sezione **Configurazione di ClearCompany** fare clic su **Configura ClearCompany** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**
    ...
    ![Configurazione di ClearCompany](./media/clearcompany-tutorial/tutorial_clearcompany_configure.png) 

8. Per configurare l'accesso Single Sign-On sul lato **ClearCompany**, è necessario inviare il file **Certificato (Base64)** e l'**URL del servizio Single Sign-On SAML** scaricati al [team di supporto di ClearCompany](https://www.clearcompany.com/support). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/clearcompany-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/clearcompany-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/clearcompany-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/clearcompany-tutorial/create_aaduser_04.png)
...
2. Nell'elenco delle applicazioni selezionare **ClearCompany**.
    ...
    ![Collegamento di ClearCompany nell'elenco delle applicazioni](./media/clearcompany-tutorial/tutorial_clearcompany_app.png)  
