...
7. Nella sezione **Configurazione di BitaBIZ** fare clic su **Configura BitaBIZ** per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido.**
