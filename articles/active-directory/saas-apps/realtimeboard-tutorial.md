...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a RealtimeBoard con gli account Azure AD personali.
...
* RealtimeBoard supporta l'accesso SSO avviato da **SP** e **IDP**

* RealtimeBoard supporta il provisioning utenti **JIT**
...
4. Nella casella di ricerca digitare **RealtimeBoard**, selezionare **RealtimeBoard** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![RealtimeBoard nell'elenco risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in RealtimeBoard.
...
2. **[Configurare l'accesso Single Sign-On di RealtimeBoard](#configure-realtimeboard-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di RealtimeBoard](#create-realtimeboard-test-user)**: per avere una controparte di Britta Simon in RealtimeBoard collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione [RealtimeBoard](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di RealtimeBoard](common/idp-identifier.png)

    Nella casella di testo **Identificatore** digitare un URL: `https://realtimeboard.com`

5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:

    ![image](common/both-preintegrated-signon.png)

    Nella casella di testo **URL di accesso** digitare un URL: `https://realtimeboard.com/sso/saml`
...
7. Nella sezione **Configura RealtimeBoard** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a RealtimeBoard.

1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **RealtimeBoard**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **RealtimeBoard**.

    ![Collegamento di RealtimeBoard nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-realtimeboard-test-user"></a>Creare l'utente di test di RealtimeBoard

In questa sezione viene creato un utente di nome Britta Simon in RealtimeBoard. RealtimeBoard supporta il provisioning utenti JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in RealtimeBoard, ne viene creato uno nuovo dopo l'autenticazione.

### <a name="test-single-sign-on"></a>Testare l'accesso Single Sign-On 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di RealtimeBoard nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione RealtimeBoard per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
