...
* Controllare in Azure AD chi può accedere a GitHub Enterprise Cloud - Enterprise Account.
* Abilitare gli utenti per l'accesso automatico a GitHub Enterprise Cloud - Enterprise Account con gli account Azure AD personali.
...
* Sottoscrizione di GitHub Enterprise Cloud - Enterprise Account abilitata per l'accesso Single Sign-On (SSO).
...
1. **[Configurare l'accesso Single Sign-On di GitHub Enterprise Cloud - Enterprise Account](#configure-github-enterprise-cloud-enterprise-account-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    1. **[Creare l'utente di test di GitHub Enterprise Cloud - Enterprise Account](#create-github-enterprise-cloud-enterprise-account-test-user)** : per avere una controparte di B.Simon in GitHub Enterprise Cloud - Enterprise Account collegata alla rappresentazione dell'utente in Azure AD.
...
1. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    > [!NOTE]
    > Poiché questi non sono i valori reali, aggiornarli con i valori effettivi di URL di accesso, URL di risposta e identificatore. Per ottenere questi valori, contattare il [team di supporto clienti di GitHub Enterprise Cloud - Enterprise Account](mailto:support@github.com). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
In questa sezione si abiliterà B.Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a GitHub Enterprise Cloud - Enterprise Account.
...
## <a name="configure-github-enterprise-cloud-enterprise-account-sso"></a>Configurare l'accesso Single Sign-On di GitHub Enterprise Cloud - Enterprise Account

Per configurare l'accesso Single Sign-On sul lato **GitHub Enterprise Cloud - Enterprise Account**, è necessario inviare il **certificato (Base64)** scaricato e gli URL appropriati, copiati dal portale di Azure, al [team di supporto di GitHub Enterprise Cloud - Enterprise Account](mailto:support@github.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.

### <a name="create-github-enterprise-cloud-enterprise-account-test-user"></a>Creare l'utente di test di GitHub Enterprise Cloud - Enterprise Account

In questa sezione viene creato un utente di nome B.Simon in GitHub Enterprise Cloud - Enterprise Account. GitHub Enterprise Cloud - Enterprise Account supporta il provisioning utenti JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in GitHub Enterprise Cloud - Enterprise Account, ne viene creato uno nuovo dopo l'autenticazione.

## <a name="test-sso"></a>Testare l'accesso SSO 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di GitHub Enterprise Cloud - Enterprise Account nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di GitHub Enterprise Cloud - Enterprise Account per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Come proteggere GitHub Enterprise Cloud - Enterprise Account con visibilità e controlli avanzati](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)