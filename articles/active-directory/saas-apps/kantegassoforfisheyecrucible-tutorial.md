...
1. Nella pagina di integrazione dell'applicazione [Kantega SSO for FishEye/Crucible](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
