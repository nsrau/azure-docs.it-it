---
title: "Esercitazione: Integrazione dell'accesso Single Sign-On (SSO) di Azure Active Directory con Smart Global Governance | Microsoft Docs"
...
* Controllare in Azure AD chi può accedere a Smart Global Governance.
...
* Smart Global Governance supporta l'accesso SSO avviato da **SP e IDP**
...
## <a name="adding-smart-global-governance-from-the-gallery"></a>Aggiunta di Smart Global Governance dalla raccolta
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-smart-global-governance"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per Smart Global Governance

Configurare e testare l'accesso SSO di Azure AD con Smart Global Governance usando un utente di test di nome **B.Simon**. Per consentire il funzionamento dell'accesso Single Sign-On, è necessario stabilire una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Smart Global Governance.
...
1. **[Configurare l'accesso Single Sign-On di Smart Global Governance](#configure-smart-global-governance-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    1. **[Creare l'utente di test di Smart Global Governance](#create-smart-global-governance-test-user)** : per avere una controparte di B.Simon in Smart Global Governance collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Smart Global Governance** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
1. Nella sezione **Configurazione SAML di base** immettere i valori per i campi seguenti se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    a. Nella casella di testo **Identificatore** usare uno degli URL seguenti:
    ...
    b. Nella casella di testo **URL di risposta** usare uno degli URL seguenti:
...
1. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    Nella casella di testo **URL di accesso** usare uno degli URL seguenti:
...
1. Nella sezione **Configura Smart Global Governance** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abiliterà B.Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Smart Global Governance.
...
Per configurare l'accesso Single Sign-On sul lato **Smart Global Governance** è necessario inviare il **certificato (base)** scaricato e gli URL appropriati, copiati dal portale di Azure, al [team di supporto di Smart Global Governance](mailto:support.tech@smartglobal.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.

### <a name="create-smart-global-governance-test-user"></a>Creare l'utente di test di Smart Global Governance

In questa sezione viene creato un utente di nome Britta Simon in Smart Global Governance. Collaborare con il [team di supporto di Smart Global Governance](mailto:support.tech@smartglobal.com) per aggiungere gli utenti alla piattaforma Smart Global Governance. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.

## <a name="test-sso"></a>Testare l'accesso SSO 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di Smart Global Governance nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Smart Global Governance per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
