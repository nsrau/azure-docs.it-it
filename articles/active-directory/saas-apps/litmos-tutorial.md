...
5. La procedura di configurazione prevede la personalizzazione degli **Attributi token SAML** per l'applicazione Litmos.
    ...
    ![Aggiungi attributo](./media/litmos-tutorial/tutorial_attribute_04.png)

    ![Finestra di dialogo Aggiungi attributo](./media/litmos-tutorial/tutorial_attribute_05.png)
