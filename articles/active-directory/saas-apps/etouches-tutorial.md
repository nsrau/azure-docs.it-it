...
1. Nella casella di ricerca digitare **etouches**, selezionare **etouches** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![etouches nell'elenco risultati](./media/etouches-tutorial/tutorial_etouches_addfromgallery.png)
...
1. **[Creare un utente di test di etouches](#create-an-etouches-test-user)**: per avere una controparte di Britta Simon in etouches collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/etouches-tutorial/tutorial_etouches_samlbase.png)

1. Nella sezione **URL e dominio etouches** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di etouches](./media/etouches-tutorial/tutorial_etouches_url.png)
...
1. Nella sezione **Attributi utente** della finestra di dialogo **Single Sign-On** configurare l'attributo del token SAML come illustrato nell'immagine e seguire questa procedura:
    ...
    ![Aggiungi attributo](./media/etouches-tutorial/tutorial_attribute_04.png)

    ![Finestra di dialogo Aggiungi attributo](./media/etouches-tutorial/tutorial_attribute_05.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/etouches-tutorial/tutorial_etouches_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/etouches-tutorial/tutorial_general_400.png)
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/etouches-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/etouches-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Pulsante Aggiungi](./media/etouches-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Finestra di dialogo Utente](./media/etouches-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco delle applicazioni selezionare **etouches**.
    ...
    ![Collegamento di etouches nell'elenco delle applicazioni](./media/etouches-tutorial/tutorial_etouches_app.png) 
