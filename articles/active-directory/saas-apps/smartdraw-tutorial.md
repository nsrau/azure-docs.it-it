...
1. **[Configurare l'accesso Single Sign-On di SmartDraw](#configure-smartdraw-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    1. **[Creare l'utente di test di SmartDraw](#create-smartdraw-test-user)** : per avere una controparte di B.Simon in SmartDraw collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nell'elenco delle applicazioni selezionare **SmartDraw**.
...
Quando si fa clic sul riquadro di SmartDraw nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di SmartDraw per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
