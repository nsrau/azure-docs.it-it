...
6. Nella sezione **Configurazione di Insperity ExpensAble** fare clic su **Configura Insperity ExpensAble** per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido.**
