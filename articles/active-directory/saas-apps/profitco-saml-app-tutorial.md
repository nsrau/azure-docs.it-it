...
## <a name="add-profitco-saml-app-from-the-gallery"></a>Aggiungere Profit.co SAML App dalla raccolta
...
Configurare e testare l'accesso SSO di Azure AD con Profit.co SAML App usando un utente di test di nome **B.Simon**. Per consentire il funzionamento dell'accesso Single Sign-On, stabilire una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Profit.co SAML App.

Ecco la procedura generale per configurare e testare l'accesso SSO di Azure AD con Profit.co SAML App:
...
1. **[Configurare l'accesso Single Sign-On di Profit.co SAML App](#configure-profitco-saml-app-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    1. **[Creare l'utente di test di Profit.co SAML App](#create-a-profitco-saml-app-test-user)** : per avere una controparte di B.Simon in Profit.co SAML App. Tale controparte è collegata alla rappresentazione dell'utente in Azure AD.
...
### <a name="create-a-profitco-saml-app-test-user"></a>Creare l'utente di test di Profit.co SAML App

In questa sezione viene creato un utente di nome B.Simon in Profit.co SAML App. Collaborare con il [team di supporto di Profit.co SAML App](mailto:support@profit.co) per aggiungere gli utenti alla piattaforma Profit.co SAML App. Prima di poter usare l'accesso Single Sign-On, è necessario creare e attivare gli utenti.

## <a name="test-sso"></a>Testare l'accesso SSO

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di Profit.co SAML App nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Profit.co SAML App per cui si è configurato l'accesso SSO. Per altre informazioni, vedere l'[introduzione al pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
