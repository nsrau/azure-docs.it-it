...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a ZenQMS con gli account Azure AD personali.
...
* Sottoscrizione abilitata per l'accesso Single Sign-On di ZenQMS

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* ZenQMS supporta l'accesso SSO avviato da **SP** e **IDP**
...
4. Nella casella di ricerca digitare **ZenQMS**, selezionare **ZenQMS** dal pannello dei risultati quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![ZenQMS nell'elenco risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in ZenQMS.
...
2. **[Configurare l'accesso Single Sign-On di ZenQMS](#configure-zenqms-single-sign-on)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente di test di ZenQMS](#create-zenqms-test-user)** : per avere una controparte di Britta Simon in ZenQMS collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione [ZenQMS](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    ![Informazioni sul Single Sign-On di URL e dominio di ZenQMS](common/idp-intiated.png)

    a. Nella casella di testo **Identificatore** digitare un URL nel formato seguente: `urn:zenqms:<INSTANCE>`

    b. Nella casella di testo **URL di risposta** digitare un URL nel formato seguente: `https://<INSTANCE>.zenqms.com/SAML/AssertionConsumerService`

5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:

    ![Informazioni sul Single Sign-On di URL e dominio di ZenQMS](common/metadata-upload-additional-signon.png)
...
### <a name="configure-zenqms-single-sign-on"></a>Configurare l'accesso Single Sign-On di ZenQMS

Per configurare l'accesso Single Sign-On sul lato **ZenQMS**, è necessario inviare l'**URL dei metadati di federazione dell'app** al [team di supporto di ZenQMS](mailto:help@zenqms.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **ZenQMS**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni, selezionare **ZenQMS**.

    ![Collegamento ZenQMS nell'elenco Applicazioni](common/all-applications.png)
...
### <a name="create-zenqms-test-user"></a>Creare un utente di test di ZenQMS
...
Quando si fa clic sul riquadro di ZenQMS nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione ZenQMS per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
