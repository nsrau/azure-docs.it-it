...
1. Nella casella di ricerca digitare **TextMagic**, nel pannello dei risultati selezionare **TextMagic** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
Per stabilire la relazione di collegamento, in TextMagic assegnare il valore di **nome utente** in Azure AD come valore **Username** (Nome utente).
...
1. **[Creare un utente di test di TextMagic](#create-a-textmagic-test-user)**: per avere una controparte di Britta Simon in TextMagic collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/textmagic-tutorial/tutorial_textmagic_samlbase.png)

1. Nella sezione **URL e dominio TextMagic** se si vuole configurare l'applicazione in modalità avviata da **IDP**, seguire questa procedura:
...
1. Selezionare **Mostra impostazioni URL avanzate** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di TextMagic](./media/textmagic-tutorial/url1.png)

    Nella casella di testo **URL di accesso** digitare l'URL: `https://my.textmagic.com/login/sso`
...
1. Fare clic sul pulsante **Salva** .
    ...
    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/textmagic-tutorial/tutorial_general_400.png)
    
1. Nella sezione **Configurazione di TextMagic** fare clic su **Configura TextMagic** per aprire la finestra **Configura accesso**. Copiare l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**

    ![Configurazione di TextMagic](./media/textmagic-tutorial/tutorial_textmagic_configure.png) 

1. In un'altra finestra del Web browser accedere al sito aziendale di TextMagic come amministratore.

1. Selezionare **Account settings** (Impostazioni account) sotto il nome utente.

    ![Configurazione di TextMagic](./media/textmagic-tutorial/config1.png) 
1. Fare clic sulla scheda **"Single Sign-On (SSO)"** e compilare i campi seguenti:  
    ...
    b. Nella casella di testo **Identity provider SSO URL** (URL SSO provider di identità) incollare il valore **URL servizio Single Sign-On** copiato dal portale di Azure.

    c. Nella casella di testo **Identity provider SLO URL** (URL SLO provider di identità) incollare il valore dell'**URL di disconnessione** copiato dal portale di Azure.
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/textmagic-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/textmagic-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/textmagic-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/textmagic-tutorial/create_aaduser_04.png)
...
### <a name="create-a-textmagic-test-user"></a>Creare un utente di test TextMagic

L'applicazione supporta il provisioning dell'utente just-in-time e dopo l'autenticazione gli utenti verranno automaticamente creati nell'applicazione. È necessario compilare le informazioni una sola volta al primo accesso per attivare l'account secondario nel sistema.
...
**Per assegnare Britta Simon a TextMagic, seguire questa procedura:**
...
1. Nell'elenco delle applicazioni selezionare **TextMagic**.
    ...
    ![Collegamento di TextMagic nell'elenco delle applicazioni](./media/textmagic-tutorial/tutorial_textmagic_app.png)  
