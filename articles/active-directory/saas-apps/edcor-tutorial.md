...
4. Nella casella di ricerca digitare **Edcor**, selezionare **Edcor** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![Edcor nell'elenco risultati](./media/edcor-tutorial/tutorial_edcor_addfromgallery.png)
...
2. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/edcor-tutorial/tutorial_edcor_samlbase.png)

3. Nella sezione **URL e dominio Edcor** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Edcor](./media/edcor-tutorial/tutorial_edcor_url1.png)
...
4. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/edcor-tutorial/tutorial_edcor_certificate.png) 

5. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/edcor-tutorial/tutorial_general_400.png)
...
6. Nella sezione **Configurazione di Edcor** fare clic su **Configura Edcor** per aprire la finestra **Configura accesso**. Copiare i valori **Sign-Out URL (URL di disconnessione) e SAML Entity ID (ID entità SAML)** dalla **sezione Quick Reference** (Riferimento rapido).
    ...
    ![Configurazione di Edcor](./media/edcor-tutorial/tutorial_edcor_configure.png) 
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/edcor-tutorial/create_aaduser_01.png)

2. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/edcor-tutorial/create_aaduser_02.png)

3. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/edcor-tutorial/create_aaduser_03.png)

4. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/edcor-tutorial/create_aaduser_04.png)
...
2. Nell'elenco delle applicazioni selezionare **Edcor**.
    ...
    ![Collegamento di Edcor nell'elenco delle applicazioni](./media/edcor-tutorial/tutorial_edcor_app.png)  
