...
1. Nella casella di ricerca digitare **Greenhouse**, selezionare **Greenhouse** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Greenhouse nell'elenco dei risultati](./media/greenhouse-tutorial/tutorial_greenhouse_addfromgallery.png)
...
1. **[Creare un utente di test di Greenhouse](#create-a-greenhouse-test-user)**: per avere una controparte di Britta Simon in Greenhouse collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/greenhouse-tutorial/tutorial_greenhouse_samlbase.png)

1. Nella sezione **URL e dominio Greenhouse** seguire questa procedura:

    ![Informazioni su URL e dominio per Single Sign-On di Greenhouse](./media/greenhouse-tutorial/tutorial_greenhouse_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/greenhouse-tutorial/tutorial_greenhouse_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/greenhouse-tutorial/tutorial_general_400.png)

1. Per configurare l'accesso Single Sign-On sul lato **Greenhouse**, è necessario inviare il file **XML di metadati** scaricato al [team di supporto di Greenhouse](https://www.greenhouse.io/contact).
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/greenhouse-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/greenhouse-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/greenhouse-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/greenhouse-tutorial/create_aaduser_04.png)
...
1. Nel menu in alto fare clic su **Configure** (Configura) e quindi su **Users** (Utenti).
   
   ![Utenti](./media/greenhouse-tutorial/ic790791.png "Utenti")

1. Fare clic su **Nuovi utenti**.
...
1. Nell'elenco di applicazioni selezionare **Greenhouse**.
    ...
    ![Collegamento Greenhouse nell'elenco Applicazioni](./media/greenhouse-tutorial/tutorial_greenhouse_app.png)  
