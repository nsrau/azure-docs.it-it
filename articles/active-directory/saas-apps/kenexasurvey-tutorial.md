...
1. Nella pagina di integrazione dell'applicazione [IBM Kenexa Survey Enterprise](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
