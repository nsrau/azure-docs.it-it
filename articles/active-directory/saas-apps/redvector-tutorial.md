---
title: 'Esercitazione: Integrazione di Azure Active Directory con RedVector | Microsoft Docs'
...
1. Nella casella di ricerca digitare **RedVector**.

    ![Creazione di un utente test di Azure AD](./media/redvector-tutorial/tutorial_redvector_search.png)

1. Nel pannello dei risultati selezionare **RedVector** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/redvector-tutorial/tutorial_redvector_addfromgallery.png)
...
1. **[Creazione di un utente test RedVector](#creating-a-redvector-test-user)**: per avere una controparte di Britta Simon in RedVector collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio RedVector** seguire questa procedura:
...
1. Nella sezione **Configurazione di RedVector** fare clic su **Configura RedVector** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/redvector-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/redvector-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/redvector-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/redvector-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco di applicazioni, selezionare **RedVector**.
