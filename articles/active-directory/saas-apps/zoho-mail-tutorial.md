...
5. **[Creare l'utente di test di Zoho](#create-zoho-test-user)**: per avere una controparte di Britta Simon in Zoho collegata alla rappresentazione dell'utente in Azure AD.
...
6. Nella sezione **Configura Zoho** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Zoho.
...
### <a name="create-zoho-test-user"></a>Creare l'utente di test di Zoho
