...
1. Nella casella di ricerca digitare **Zoho**, selezionare **Zoho** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Zoho nell'elenco risultati](./media/zoho-mail-tutorial/tutorial_zoho_addfromgallery.png)
...
1. **[Creare un utente di test di Zoho](#create-a-zoho-test-user)**: per avere una controparte di Britta Simon in Zoho collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/zoho-mail-tutorial/tutorial_zoho_samlbase.png)

1. Nella sezione **URL e dominio Zoho** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Zoho](./media/zoho-mail-tutorial/tutorial_zoho_url.png)

    a. Nella casella di testo **URL di accesso** digitare l'URL usando il modello seguente: `https://<company name>.zohomail.com`

    > [!NOTE] 
    > Poiché non è reale, è necessario aggiornare questo valore con l'URL di accesso Sign-On effettivo. Per ottenere questo valore, contattare il [team di supporto clienti di Zoho](https://www.zoho.com/mail/contact.html). 
 
1. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.

    ![Collegamento di download del certificato](./media/zoho-mail-tutorial/tutorial_zoho_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/zoho-mail-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di Zoho** fare clic su **Configura Zoho** per aprire la finestra **Configura accesso**. Copiare **URL di disconnessione, URL di modifica password e URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido**.

    ![Configurazione di Zoho](./media/zoho-mail-tutorial/tutorial_zoho_configure.png) 
...
1. Passare a **Control panel**.
    ...
    ![Pannello di controllo](./media/zoho-mail-tutorial/ic789607.png "Pannello di controllo")

1. Fare clic sulla scheda **SAML Authentication** .
   
    ![Autenticazione SAML](./media/zoho-mail-tutorial/ic789608.png "Autenticazione SAML")

1. Nella sezione **SAML Authentication Details** seguire questa procedura:
   
    ![Dettagli dell'autenticazione SAML](./media/zoho-mail-tutorial/ic789609.png "Dettagli dell'autenticazione SAML")
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/zoho-mail-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/zoho-mail-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/zoho-mail-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/zoho-mail-tutorial/create_aaduser_04.png)
...
1. Passare a **User Details \> Add User** (Dettagli utente > Aggiungi utente).
    ...
    ![Aggiungere un utente](./media/zoho-mail-tutorial/ic789611.png "Aggiungere un utente")

1. Nella finestra di dialogo **Add users** seguire questa procedura:
   
    ![Aggiungere un utente](./media/zoho-mail-tutorial/ic789612.png "Aggiungere un utente")
...
1. Nell'elenco delle applicazioni selezionare **Zoho**.
    ...
    ![Collegamento di Zoho nell'elenco delle applicazioni](./media/zoho-mail-tutorial/tutorial_zoho_app.png)  
