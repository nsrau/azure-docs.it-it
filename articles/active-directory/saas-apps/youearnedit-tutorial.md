...
1. Nella casella di ricerca digitare **YouEarnedt**, selezionare **YouEarnedt** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![YouEarnedIt nell'elenco risultati](./media/youearnedit-tutorial/tutorial_youearnedit_addfromgallery.png)
...
1. **[Creare un utente di test di YouEarnedIt](#create-a-youearnedit-test-user)**: per avere una controparte di Britta Simon in YouEarnedIt collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/youearnedit-tutorial/tutorial_youearnedit_samlbase.png)

1. Nella sezione **URL e dominio YouEarnedIt** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di YouEarnedIt](./media/youearnedit-tutorial/tutorial_youearnedit_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Collegamento di download del certificato](./media/youearnedit-tutorial/tutorial_youearnedit_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/youearnedit-tutorial/tutorial_general_400.png)

1. Nella sezione **Configurazione di YouEarnedIt** fare clic su **Configura YouEarnedIt** per aprire la finestra **Configura accesso**. Copiare l'**URL servizio Single Sign-On SAML** dalla **sezione Riferimento rapido.**

    ![Configurazione di YouEarnedIt](./media/youearnedit-tutorial/tutorial_youearnedit_configure.png) 
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/youearnedit-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/youearnedit-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/youearnedit-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/youearnedit-tutorial/create_aaduser_04.png)
...
1. Nell'elenco delle applicazioni selezionare **YouEarnedIt**.

    ![Collegamento di YouEarnedIt nell'elenco delle applicazioni](./media/youearnedit-tutorial/tutorial_youearnedit_app.png)  
