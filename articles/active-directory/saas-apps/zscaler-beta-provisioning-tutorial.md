...
3. Per aggiungere Zscaler Beta, scegliere il **nuova applicazione** pulsante nella parte superiore della finestra di dialogo.
...
5. Nel pannello dei risultati, selezionare **Zscaler Beta**, quindi fare clic sul **Add** pulsante per aggiungere Zscaler Beta al proprio elenco di applicazioni SaaS.
...
2. Selezionare nell'elenco di applicazioni SaaS Zscaler Beta.
