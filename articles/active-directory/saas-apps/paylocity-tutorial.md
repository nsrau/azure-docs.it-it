...
In questa esercitazione si apprenderà come integrare Paylocity con Azure Active Directory (Azure AD). Integrando Paylocity con Azure AD, è possibile:

* Controllare in Azure AD chi può accedere a Paylocity.
* Abilitare gli utenti per l'accesso automatico a Paylocity con i rispettivi account Azure AD.
...
Per configurare l'integrazione di Paylocity in Azure AD, è necessario aggiungere Paylocity dalla raccolta al proprio elenco di app SaaS gestite.
...
Configurare e testare l'accesso SSO di Azure AD con Paylocity usando un utente di test di nome **B.Simon**. Per il corretto funzionamento dell'accesso Single Sign-On, è necessario stabilire una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Paylocity.
...
1. **[Configurare l'accesso Single Sign-On per Paylocity](#configure-paylocity-sso)** : per configurare le impostazioni dell'accesso Single Sign-On sul lato applicazione.
    * **[Creare un utente di test di Paylocity](#create-paylocity-test-user)** : per avere una controparte di B.Simon in Paylocity collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **Configurazione SAML di base** l'utente non deve eseguire alcuna operazione perché l'app è già preintegrata in Azure.
    ...
    ![Informazioni su URL e dominio di Paylocity per l'accesso Single Sign-On](common/preintegrated.png)
...
### <a name="create-paylocity-test-user"></a>Creare un utente di test di Paylocity
...
Quando si fa clic sul riquadro di Paylocity nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Paylocity per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
