---
title: 'Esercitazione: Integrazione di Azure Active Directory con Kronos | Microsoft Docs'
...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Kronos con gli account Azure AD personali.
...
* Sottoscrizione di Kronos abilitata per l'accesso Single Sign-On
...
4. Nella casella di ricerca digitare **Kronos**, selezionare **Kronos** dal pannello dei risultati quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Kronos nell'elenco dei risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Kronos.
...
1. Nella pagina di integrazione dell'applicazione **Kronos** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella finestra di dialogo **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Kronos](common/idp-intiated.png)
...
### <a name="configure-kronos-single-sign-on"></a>Configurare l'accesso Single Sign-On di Kronos
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Kronos**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Kronos**.

    ![Collegamento di Kronos nell'elenco Applicazioni](common/all-applications.png)
