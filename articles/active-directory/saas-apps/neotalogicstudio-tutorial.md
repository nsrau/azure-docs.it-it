...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Neota Logic Studio con gli account Azure AD personali.
...
* Neota Logic Studio supporta l'accesso SSO avviato da **SP**
...
4. Nella casella di ricerca digitare **Neota Logic Studio** , selezionare **Neota Logic Studio** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Neota Logic Studio nell'elenco risultati](common/search-new-app.png)
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    b. Nella casella di testo **Identificatore (ID entità)** digitare un URL nel formato seguente: `https://<sub domain>.neotalogic.com/wb`
...
6. Nella sezione **Configura Neota Logic Studio** copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-neota-logic-studio-single-sign-on"></a>Configurare l'accesso Single Sign-On per Neota Logic Studio
...
In questa sezione si crea un utente di nome Britta Simon in Neota Logic Studio. Collaborare con il [team di supporto di Neota Logic Studio](https://www.neotalogic.com/contact-us/) per aggiungere gli utenti alla piattaforma Neota Logic Studio. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.

### <a name="test-single-sign-on"></a>Testare l'accesso Single Sign-On 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di Neota Logic Studio nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Neota Logic Studio per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
