...
description: Informazioni su come configurare l'accesso Single Sign-On tra Azure Active Directory e Percolate.
...
L'integrazione di Percolate con Azure AD offre i vantaggi seguenti:

* È possibile controllare in Azure AD chi può accedere a Percolate.
...
## <a name="adding-percolate-from-the-gallery"></a>Aggiunta di Percolate dalla raccolta
...
**Per aggiungere Percolate dalla raccolta, seguire questa procedura:**
...
4. Nella casella di ricerca digitare **Percolate**, selezionare **Percolate** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Percolate nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Percolate usando un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Percolate.

Per configurare e testare l'accesso Single Sign-On di Azure AD con Percolate, è necessario completare le procedure di base seguenti:

1. **[Configurare l'accesso Single Sign-On di Azure AD](#configure-azure-ad-single-sign-on)**: per consentire agli utenti di usare questa funzionalità.
2. **[Configurare l'accesso Single Sign-On di Percolate](#configure-percolate-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di Percolate](#create-percolate-test-user)**: per avere una controparte di Britta Simon in Percolate collegata alla rappresentazione dell'utente in Azure AD.
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    Nella casella di testo **URL di accesso** digitare un URL: `https://percolate.com/app/login`
...
1. In un'altra finestra del Web browser accedere a Percolate come amministratore.

2. Sul lato sinistro della home page fare clic su **Settings** (Impostazioni).
    
    ![Configure Single Sign-On](./media/percolate-tutorial/configure01.png)

3. Sul lato sinistro della barra dei menu fare clic su **SSO** in **Organization** (Organizzazione).
    ...
    e. Il campo **Identity provider metadata URL** (URL metadati provider di identità) è facoltativo e se si dispone dell'**URL dei metadati di federazione dell'app** copiato dal portale di Azure, incollarlo nella casella di testo **Identity provider metadata URL**.

    f. Rispondere **No** a **Should AuthNRequests be signed?** (Le N richieste di autorizzazione devono essere firmate?).

    g. Selezionare **No** per **Enable SSO auto-Provisioning** (Abilita provisioning automatico SSO).
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Percolate.
...
2. Nell'elenco delle applicazioni selezionare **Percolate**.
    ...
    ![Collegamento di Percolate nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-percolate-test-user"></a>Creare l'utente di test di Percolate

Per consentire agli utenti di Azure AD di accedere a Percolate, è necessario effettuarne il provisioning in Percolate. In Percolate il provisioning è un'attività manuale.

**Per eseguire il provisioning di un account utente, seguire questa procedura:**

1. Accedere Percolate come amministratore.

2. Sul lato sinistro della barra dei menu fare clic su **Users** (Utenti) in **Organization** (Organizzazione) e passare a **New users** (Nuovi utenti).
