...
## <a name="configure-and-test-azure-ad-single-sign-on-for-whosoffice"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per WhosOffice
...
Per configurare e testare l'accesso Single Sign-On di Azure AD con WhosOffice, completare le procedure di base seguenti:
...
1. **[Configurare l'accesso Single Sign-On di WhosOffice](#configure-whosoffice-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    * **[Creare l'utente di test di WhosOffice](#create-whosoffice-test-user)** : per avere una controparte di B.Simon in WhosOffice collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **WhosOffice** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
