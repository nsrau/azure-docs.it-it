...
1. Nella pagina di integrazione dell'applicazione [EthicsPoint Incident Management (EPIM)](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
