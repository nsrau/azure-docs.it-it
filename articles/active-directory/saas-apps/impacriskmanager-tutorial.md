...
1. Nella pagina di integrazione dell'applicazione [IMPAC Risk Manager](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
