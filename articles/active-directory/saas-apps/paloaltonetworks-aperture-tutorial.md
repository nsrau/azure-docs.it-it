...
1. Nella casella di ricerca digitare **Palo Alto Networks - Aperture**, selezionare **Palo Alto Networks - Aperture** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Palo Alto Networks - Aperture nell'elenco dei risultati](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_addfromgallery.png)
...
1. **[Creare un utente di test di Palo Alto Networks - Aperture](#create-a-palo-alto-networks---aperture-test-user)**: per avere una controparte di Britta Simon in Palo Alto Networks - Aperture collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_samlbase.png)

1. Nella sezione **URL e dominio Palo Alto Networks - Aperture** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Palo Alto Networks - Aperture](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_url.png)
...
1. Selezionare **Mostra impostazioni URL avanzate** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Palo Alto Networks - Aperture](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_url1.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **Certificato (Base64)** e quindi salvare il file del certificato nel computer.
    ...
    ![Collegamento di download del certificato](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/paloaltonetworks-aperture-tutorial/tutorial_general_400.png)


1. Nella sezione **Configurazione di Palo Alto Networks - Aperture** fare clic su **Configure Palo Alto Networks - Aperture** (Configurare Palo Alto Networks - Aperture) per aprire la finestra **Configura accesso**. Copiare l'**ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido.**

    ![Collegamento di configurazione](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_configure.png)

1. In un'altra finestra del Web browser accedere a Palo Alto Networks - Aperture come amministratore.

1. Nella barra dei menu superiore fare clic su **SETTINGS** (IMPOSTAZIONI).

    ![Scheda Settings (Impostazioni)](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_settings.png)

1. Passare alla sezione **APPLICATION** (APPLICAZIONE) e fare clic sul modulo **Authentication** (Autenticazione) dal menu a sinistra.

    ![Scheda di autenticazione](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_auth.png)
    
1. Nella pagina **Authentication** (Autenticazione) seguire questa procedura:
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/paloaltonetworks-aperture-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/paloaltonetworks-aperture-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/paloaltonetworks-aperture-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/paloaltonetworks-aperture-tutorial/create_aaduser_04.png)
...
In questa sezione viene creato un utente di nome Britta Simon in Palo Alto Networks - Aperture. Collaborare con il  [team di supporto clienti di Palo Alto Networks - Aperture](https://live.paloaltonetworks.com/t5/custom/page/page-id/Support)  per aggiungere gli utenti alla piattaforma Palo Alto Networks - Aperture. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On. 
...
1. Nell'elenco delle applicazioni selezionare **Palo Alto Networks - Aperture**.
    ...
    ![Collegamento di Palo Alto Networks - Aperture nell'elenco delle applicazioni](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_app.png)  
