...
4. Nella casella di ricerca digitare **Palo Alto Networks - Aperture**, selezionare **Palo Alto Networks - Aperture** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Palo Alto Networks - Aperture nell'elenco dei risultati](common/search-new-app.png)
...
1. Nella pagina di integrazione dell'applicazione [Palo Alto Networks - Aperture](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
