...
1. Nella casella di ricerca digitare **SumTotalCentral**, selezionare **SumTotalCentral** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![SumTotalCentral nell'elenco risultati](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_addfromgallery.png)
...
1. **[Creare un utente di test di SumTotalCentral](#create-a-sumtotalcentral-test-user)**: per avere una controparte di Britta Simon in SumTotalCentral collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella finestra di dialogo **Single Sign-On** selezionare **Accesso basato su SAML** per **Modalità** per abilitare l'accesso Single Sign-On.
    ...
    ![Finestra di dialogo Single Sign-On](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_samlbase.png)

1. Nella sezione **URL e dominio SumTotalCentral** seguire questa procedura:

    ![Informazioni su URL e dominio per l'accesso Single Sign-On di SumTotalCentral](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_url.png)
...
1. Nella sezione **Certificato di firma SAML** fare clic su **XML di metadati** e quindi salvare il file dei metadati nel computer.
    ...
    ![Collegamento di download del certificato](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_certificate.png) 

1. Fare clic sul pulsante **Salva** .

    ![Pulsante Salva per la configurazione dell'accesso Single Sign-On](./media/sumtotalcentral-tutorial/tutorial_general_400.png)
...
1. Nel portale di Azure fare clic sul pulsante **Azure Active Directory** nel riquadro sinistro.
    ...
    ![Pulsante Azure Active Directory](./media/sumtotalcentral-tutorial/create_aaduser_01.png)

1. Per visualizzare l'elenco di utenti, passare a **Utenti e gruppi** e quindi fare clic su **Tutti gli utenti**.

    ![Collegamenti "Utenti e gruppi" e "Tutti gli utenti"](./media/sumtotalcentral-tutorial/create_aaduser_02.png)

1. Per aprire la finestra di dialogo **Utente** fare clic su **Aggiungi** nella parte superiore della finestra di dialogo **Tutti gli utenti**.

    ![Pulsante Aggiungi](./media/sumtotalcentral-tutorial/create_aaduser_03.png)

1. Nella finestra di dialogo **Utente** seguire questa procedura:

    ![Finestra di dialogo Utente](./media/sumtotalcentral-tutorial/create_aaduser_04.png)
...
In questa sezione viene creato un utente di nome Britta Simon in SumTotalCentral. Collaborare con il [team di supporto di SumTotalCentral](http://www.sumtotalsystems.com/support/) per aggiungere gli utenti nella piattaforma SumTotalCentral. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.  
...
1. Nell'elenco delle applicazioni selezionare **SumTotalCentral**.
    ...
    ![Collegamento di SumTotalCentral nell'elenco delle applicazioni](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_app.png)  
