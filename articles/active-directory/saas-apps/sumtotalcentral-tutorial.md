...
4. Nella casella di ricerca digitare **SumTotalCentral**, selezionare **SumTotalCentral** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![SumTotalCentral nell'elenco risultati](common/search-new-app.png)
...
2. **[Configurare l'accesso Single Sign-On di SumTotalCentral](#configure-sumtotalcentral-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di SumTotalCentral](#create-sumtotalcentral-test-user)**: per avere una controparte di Britta Simon in SumTotalCentral collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **SumTotalCentral** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
### <a name="configure-sumtotalcentral-single-sign-on"></a>Configurare l'accesso Single Sign-On di SumTotalCentral
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a SumTotalCentral.

1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **SumTotalCentral**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **SumTotalCentral**.

    ![Collegamento di SumTotalCentral nell'elenco delle applicazioni](common/all-applications.png)
