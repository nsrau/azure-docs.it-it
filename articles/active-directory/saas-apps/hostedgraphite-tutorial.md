...
1. Nella pagina di integrazione dell'applicazione [Hosted Graphite](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
