...
3. Per aggiungere Zscaler One, scegliere il **nuova applicazione** pulsante nella parte superiore della finestra di dialogo.

    ![Pulsante Nuova applicazione][3]

4. Nella casella di ricerca digitare **Zscaler One**.

    ![Il Provisioning di Zscaler One](./media/zscaler-one-provisioning-tutorial/app-search.png)

5. Nel pannello dei risultati, selezionare **Zscaler One**, quindi fare clic sul **Add** pulsante per aggiungere Zscaler One al proprio elenco di applicazioni SaaS.

    ![Il Provisioning di Zscaler One](./media/zscaler-one-provisioning-tutorial/app-search-results.png)

    ![Il Provisioning di Zscaler One](./media/zscaler-one-provisioning-tutorial/app-creation.png)
...
2. Selezionare nell'elenco delle applicazioni SaaS di Zscaler One.

    ![Il Provisioning di Zscaler One](./media/zscaler-one-provisioning-tutorial/app-instance-search.png)
