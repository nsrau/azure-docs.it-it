...
1. Nella casella di ricerca digitare **RolePoint**.

    ![Creazione di un utente test di Azure AD](./media/rolepoint-tutorial/tutorial_rolepoint_search.png)

1. Nel pannello dei risultati selezionare **RolePoint** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/rolepoint-tutorial/tutorial_rolepoint_addfromgallery.png)
...
1. **[Creazione di un utente test RolePoint](#creating-a-rolepoint-test-user)**: per avere una controparte di Britta Simon in RolePoint collegata alla relativa rappresentazione in Azure AD.
...
1. Nella sezione **URL e dominio RolePoint** eseguire i passaggi descritti di seguito:

    ![Configura accesso Single Sign-On](./media/rolepoint-tutorial/tutorial_rolepoint_url.png)
...
1. Per configurare l'accesso Single Sign-On sul lato **RolePoint**, è necessario inviare il file **XML metadati** scaricato al [team di supporto di RolePoint](mailto:info@rolepoint.com).
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/rolepoint-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/rolepoint-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/rolepoint-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/rolepoint-tutorial/create_aaduser_04.png) 
...
1. Nell'elenco di applicazioni selezionare **RolePoint**.
