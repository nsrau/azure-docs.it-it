...
Per configurare l'integrazione di Skyhigh Networks in Azure AD, è necessario aggiungere Skyhigh Networks dalla raccolta all'elenco di app SaaS gestite.
...
Per configurare e testare l'accesso Single Sign-On di Azure AD con Skyhigh Networks, è necessario completare le procedure di base seguenti:
...
5. **[Creare l'utente di test di Skyhigh Networks](#create-skyhigh-networks-test-user)**: per avere una controparte di Britta Simon in Skyhigh Networks collegata alla rappresentazione dell'utente in Azure AD.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Skyhigh Networks](common/idp-intiated.png)
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Skyhigh Networks](common/metadata-upload-additional-signon.png)
...
7. Nella sezione **Configura Skyhigh Networks** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Skyhigh Networks.
...
### <a name="create-skyhigh-networks-test-user"></a>Creare l'utente di test di Skyhigh Networks
