...
1. Nella pagina di integrazione dell'applicazione [Infor Retail – Information Management](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
