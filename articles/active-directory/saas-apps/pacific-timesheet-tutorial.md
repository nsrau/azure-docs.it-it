...
1. Nella pagina di integrazione dell'applicazione [Pacific Timesheet](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
