...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Pacific Timesheet con gli account Azure AD personali.
...
Per configurare l'integrazione di Pacific Timesheet in Azure AD, è necessario aggiungere Pacific Timesheet dalla raccolta all'elenco di app SaaS gestite.
...
Per configurare e testare l'accesso Single Sign-On di Azure AD con Pacific Timesheet è necessario completare le procedure di base seguenti:
...
4. Nella pagina **Configura l'accesso Single Sign-On con SAML** eseguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Pacific Timesheet](common/idp-intiated.png)
...
6. Nella sezione **Configura Pacific Timesheet** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Pacific Timesheet.
...
2. Nell'elenco delle applicazioni selezionare **Pacific Timesheet**.

    ![Collegamento Pacific Timesheet nell'elenco delle applicazioni](common/all-applications.png)
...
In questa sezione viene creato un utente di nome Britta Simon in Pacific Timesheet. Collaborare con il [team di supporto di Pacific Timesheet](https://www.pacifictimesheet.com/support) per aggiungere gli utenti nella piattaforma Pacific Timesheet. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
