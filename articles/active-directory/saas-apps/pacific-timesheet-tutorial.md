---
title: 'Esercitazione: Integrazione di Azure Active Directory con Pacific Timesheet | Microsoft Docs'
...
1. Nella casella di ricerca digitare **Pacific Timesheet**.

    ![Creazione di un utente test di Azure AD](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_search.png)

1. Nel pannello dei risultati selezionare **Pacific Timesheet** e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Creazione di un utente test di Azure AD](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_addfromgallery.png)
...
1. **[Creazione di un utente test di Pacific Timesheet](#creating-a-pacific-timesheet-test-user)**: per avere una controparte di Britta Simon in Pacific Timesheet collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Pacific Timesheet** seguire questa procedura:
    ...
    > [!NOTE] 
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore e l'URL di risposta effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di Pacific Timesheet](https://www.pacifictimesheet.com/support).
...
1. Nella sezione **Configurazione Pacific Timesheet** fare clic su **Configure Pacific Timesheet** (Configura Pacific Timesheet) per aprire la finestra **Configure sign-on** (Configura accesso sign-on). Copiare l'**ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla **sezione di riferimento rapido.**

    ![Configure Single Sign-On](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_configure.png) 

1. Per configurare l'accesso Single Sign-On sul lato **Pacific Timesheet**, è necessario inviare il file **Certificato (Base64)** scaricato, l'**URL del servizio Single Sign-On SAML** e l'**ID di entità SAML** al [team di supporto di Pacific Timesheet](https://www.pacifictimesheet.com/support). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel **portale di Azure** fare clic sull'icona di **Azure Active Directory** nel riquadro di spostamento sinistro.
    ...
    ![Creazione di un utente test di Azure AD](./media/pacific-timesheet-tutorial/create_aaduser_01.png) 

1. Passare a **Utenti e gruppi** e fare clic su **Tutti gli utenti** per visualizzare l'elenco di utenti.
    
    ![Creazione di un utente test di Azure AD](./media/pacific-timesheet-tutorial/create_aaduser_02.png) 

1. Nella parte superiore della finestra di dialogo fare clic su **Aggiungi** per aprire la finestra di dialogo **Utente**.
 
    ![Creazione di un utente test di Azure AD](./media/pacific-timesheet-tutorial/create_aaduser_03.png) 

1. Nella pagina della finestra di dialogo **Utente** seguire questa procedura:
 
    ![Creazione di un utente test di Azure AD](./media/pacific-timesheet-tutorial/create_aaduser_04.png) 
...
In questa sezione viene creato un utente di nome Britta Simon in Pacific Timesheet. Collaborare con il [team di supporto di Pacific Timesheet](https://www.pacifictimesheet.com/support) per creare un utente nell'applicazione.
...
1. Nell'elenco di applicazioni selezionare **Pacific Timesheet**.
