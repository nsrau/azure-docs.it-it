...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) ad Accredible con gli account Azure AD personali.
...
Per configurare l'integrazione di Accredible in Azure AD, è necessario aggiungere Accredible dalla raccolta all'elenco di app SaaS gestite.
...
Per configurare e testare l'accesso Single Sign-On di Azure AD con Accredible, è necessario completare le procedure di base seguenti:
...
4. Nella pagina **Configura l'accesso Single Sign-On con SAML** eseguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Accredible](common/idp-intiated.png)
...
6. Nella sezione **Configura Accredible** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso ad Accredible.
