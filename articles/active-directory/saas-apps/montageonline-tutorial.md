...
* Montage Online supporta l'accesso SSO avviato da **SP**
...
1. Nella pagina di integrazione dell'applicazione [Montage Online](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
...
6. Nella sezione **Configura Montage Online** copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-montage-online-single-sign-on"></a>Configurare l'accesso Single Sign-On per Montage Online
...
2. Nell'elenco delle applicazioni selezionare **Montage Online**.
    ...
    ![Collegamento di Montage Online nell'elenco delle applicazioni](common/all-applications.png)
...
Quando si fa clic sul riquadro di Montage Online nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Montage Online per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
