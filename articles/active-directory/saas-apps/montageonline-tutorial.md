...
1. Nella casella di ricerca digitare **Montage Online** selezionare **Montage Online** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
1. **[Creare un utente di test di Montage Online](#create-a-montage-online-test-user)**: per avere una controparte di Britta Simon in Montage Online collegato alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **URL e dominio Montage Online** seguire questa procedura:
...
1. Nella sezione **Configurazione di Montage Online** fare clic su **Configura Montage Online** per aprire la finestra **Configura accesso**. Copiare l'**URL di disconnessione, l'ID di entità SAML e l'URL del servizio Single Sign-On SAML** dalla sezione **Riferimento rapido.**
...
1. Nell'elenco delle applicazioni selezionare **Montage Online**.
