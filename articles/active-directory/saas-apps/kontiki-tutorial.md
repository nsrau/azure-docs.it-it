...
1. Nella casella di testo **URL di accesso** del riquadro **Configurazione SAML di base** immettere un URL con il formato seguente: `https://<companyname>.mc.eval.kontiki.com`
    ...
    > [!NOTE]
    > Per ottenere il valore corretto, contattare il [team di supporto clienti di Kontiki](https://kollective.com/support/). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
