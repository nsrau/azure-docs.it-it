...
* Kontiki supporta l'accesso SSO avviato da **SP**
* Kontiki supporta il provisioning utenti **JIT**
...
4. Nella casella di ricerca digitare **Kontiki** selezionare **Kontiki** dal pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Kontiki.
...
2. **[Configurare l'accesso Single Sign-On di Kontiki](#configure-kontiki-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)**: per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente test di Azure AD](#assign-the-azure-ad-test-user)**: per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente test di Kontiki](#create-kontiki-test-user)**: per avere una controparte di Britta Simon in Kontiki collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Kontiki** del [portale di Azure](https://portal.azure.com/) selezionare **Single sign-on**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    Nella casella di testo **URL accesso** digitare un URL nel formato seguente: `https://<companyname>.mc.eval.kontiki.com`

    > [!NOTE]
    > Poiché non è reale, è necessario aggiornare questo valore con l'URL di accesso effettivo. Per ottenere tale valore, contattare il [team di supporto clienti di Kontiki](https://customersupport.kontiki.com/enterprise/contactsupport.html). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.

5. Nella pagina **Configura l'accesso Single Sign-On con SAML**, nella sezione **Certificato di firma SAML**, fare clic su **Scarica** per scaricare il file **XML metadati federazione** definito dalle opzioni specificate in base ai propri requisiti e salvarlo in questo computer.

    ![Collegamento di download del certificato](common/metadataxml.png)

6. Nella sezione **Configura Kontiki** copiare gli URL appropriati in base alle proprie esigenze.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Kontiki**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Kontiki**.

    ![Collegamento di Kontiki nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-kontiki-test-user"></a>Creare un utente test di Kontiki
...
Quando si fa clic sul riquadro di Kontiki nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Kontiki per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
