...
1. Nella pagina di integrazione dell'applicazione [Autotask Workplace](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
