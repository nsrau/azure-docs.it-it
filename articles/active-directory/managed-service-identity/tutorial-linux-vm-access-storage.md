---
title: Usare un'identità gestita per una macchina virtuale Linux per accedere ad Archiviazione di Azure
description: Questa esercitazione illustra come usare un'identità gestita assegnata dal sistema su una macchina virtuale Linux per accedere ad Archiviazione di Azure.
...
Questa esercitazione illustra come creare e usare un'identità gestita per una macchina virtuale Linux per accedere ad Archiviazione di Azure. Si apprenderà come:

> [!div class="checklist"]
> * Creare una macchina virtuale Linux in un nuovo gruppo di risorse
> * Abilitare l'identità gestita in una macchina virtuale (VM) Linux
...
In questa sezione si crea una macchina virtuale Linux a cui, in un secondo momento, viene concessa un'identità gestita.
...
Un'identità gestita per una macchina virtuale consente di ottenere i token di accesso da Azure AD senza dover inserire le credenziali nel codice. Dietro le quinte, l'abilitazione dell'identità gstita in una macchina virtuale tramite il portale di Azure esegue due operazioni: registra la macchina virtuale in Azure AD per creare un'identità gestita e configura l'identità nella macchina virtuale.
...
2. Nella categoria **Impostazioni** fare clic su **Configurazione**.
3. Per abilitare l'identità gestita, selezionare **Sì**.
...
7. In **Seleziona**, scegliere la macchina virtuale e quindi fare clic su **Salva**.
    ...
    ![Assegnare autorizzazioni](~/articles/active-directory/managed-service-identity/media/tutorial-linux-vm-access-storage/access-storage-perms.png)
...
Questa esercitazione ha illustrato come abilitare un'identità gestita per la macchina virtuale Linux per accedere ad Archiviazione di Azure.  Per altre informazioni su Archiviazione di Azure, vedere:
