...
ms.locfileid: "33929044"
---
# <a name="configure-a-vmss-managed-service-identity-msi-using-the-azure-portal"></a>Configurare un'identità del servizio gestita (MSI) di un set di scalabilità di macchine virtuali tramite il portale di Azure
