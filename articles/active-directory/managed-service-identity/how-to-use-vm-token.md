---
title: Come usare le identità gestite per risorse di Azure in una macchina virtuale per acquisire un token di accesso
...
Richiesta di esempio che usa l'endpoint dell'estensione della macchina virtuale delle identità gestite per risorse di Azure *(da deprecare)*:
