...
# Esercitazione: Integrazione di Azure Active Directory con FieldGlass
...
## Aggiunta di FieldGlass dalla raccolta
...
La relazione di collegamento viene stabilita assegnando al valore di **nome utente** in Azure AD lo stesso valore di **Username** (Nome utente) in FieldGlass.
...
3. Nella pagina **Configurare le impostazioni dell'app** seguire questa procedura e fare clic su **Avanti**:
	...
	> [AZURE.NOTE] Si noti che questi non sono i valori reali. È necessario aggiornare i valori con l'identificatore e l'URL di risposta effettivi. Per ottenere questi valori, contattare [FieldGlass](http://www.fieldglass.com/solutions/support).
...
### Creazione di un utente test di FieldGlass
