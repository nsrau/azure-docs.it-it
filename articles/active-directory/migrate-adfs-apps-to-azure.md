...
- Attestazioni nelle funzionalità per i token
    ...
    - Regole di trasformazione per il rilascio di attestazioni complesse. Per informazioni sui mapping di attestazioni supportati, vedere questo [documento](https://docs.microsoft.com/azure/active-directory/active-directory-claims-mapping) e questo [documento](https://docs.microsoft.com/azure/active-directory/develop/active-directory-saml-claims-customization)
