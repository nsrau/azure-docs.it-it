...
> [!NOTE]
> È possibile utilizzare qualsiasi altro strumento di creazione di account utente di OfficeSpace Software o le API fornite da OfficeSpace Software per eseguire il provisioning degli account utente di AAD.
> 
> 
