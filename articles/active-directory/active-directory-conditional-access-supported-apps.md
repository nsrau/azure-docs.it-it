...
---
title: Accesso condizionale - Applicazioni supportate | Microsoft Docs
...
---
# <a name="conditional-access-support-for-applications"></a>Supporto dell'accesso condizionale per le applicazioni
...
## <a name="applications-using-modern-authentication"></a>Applicazioni che utilizzano l'autenticazione moderna
...
### <a name="example-ad-fs-rules"></a>Regole di AD FS di esempio
Le seguenti regole consentono di impedire ai protocolli legacy di accedere ad AD FS in due configurazioni comuni.

### <a name="option-1:-allow-exchange-activesync-and-only-allow-legacy-apps-on-the-intranet"></a>Opzione 1: consentire Exchange ActiveSync e solo le applicazioni legacy nella intranet
...
### <a name="option-2:-allow-exchange-activesync-and-block-legacy-apps"></a>Opzione 2: consentire Exchange ActiveSync e bloccare le applicazioni legacy
