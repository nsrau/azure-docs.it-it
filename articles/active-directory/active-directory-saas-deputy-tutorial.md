<properties
	pageTitle="Esercitazione: Integrazione di Azure Active Directory con Deputy | Microsoft Azure"
...
## Aggiunta di Deputy dalla raccolta
...
La relazione di collegamento viene stabilita assegnando il valore di **nome utente** in Azure AD come valore di **Username** in Deputy.
...
4. Se si vuole desidera l'applicazione in **SP initiated mode** (Modalità iniziata dal provider di servizi) nella finestra di dialogo **Configurare le impostazioni dell'app** fare clic su **"Mostra opzioni avanzate (facoltativo)"**, quindi digitare l'**URL di accesso** e fare clic su **Avanti**.
	...
	> [AZURE.NOTE] Il suffissi della dell'area di Deputy è facoltativo oppure usare uno dei seguenti: au | na | eu |as |la |af |an |ent-au |ent-na |ent-eu |ent-as | ent-la | ent-af | ent-an
...
### Creazione di un utente test di Deputy
