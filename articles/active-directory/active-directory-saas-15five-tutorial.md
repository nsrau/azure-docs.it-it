...
1.  Nella pagina di integrazione dell'applicazione **15Five** del portale di Azure AD fare clic su **Configura accesso Single Sign-On** per aprire la finestra di dialogo **Configura accesso Single Sign-On**.
...
3.  Nella casella di testo **URL accesso 15Five** della pagina **Configura URL app** digitare l'URL usando il modello seguente "**https://company.15Five.com*" e fare clic su **Avanti**.
...
>[AZURE.NOTE]È possibile usare qualsiasi altro strumento o API di creazione di account utente fornita da 15Five per eseguire il provisioning degli account utente di Azure AD.
