...
-	Per iniziare, aprire il file `config.js` nella radice del progetto e immettere i valori di configurazione dell'app nella sezione `exports.creds`.
    ...
    - `realm` rappresenta l'**URI di reindirizzamento** immesso nel portale senza la route (esempio: http//localhost:3000).
    - `issuer` indica la posizione in cui aggiungere l'**ID applicazione**, ad esempio: https://sts.windows.net/96702724-991f-4576-bc90-be9862749ac5/

- Aprire quindi il file `app.js` nella radice del progetto e aggiungere la chiamata seguente per richiamare la strategia `OIDStrategy` fornita con `passport-azure-ad`.
