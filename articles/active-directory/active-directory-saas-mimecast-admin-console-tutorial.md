...
In questa sezione viene descritto come abilitare l'integrazione dell'applicazione per Mimecast Admin Console.

###Per abilitare l'integrazione dell'applicazione per Mimecast Admin Console, eseguire la procedura seguente:
...
9.  Nella sezione **Profilo di autenticazione**, eseguire la procedura seguente:
    ...
    2.  Selezionare **Imponi l'autenticazione SAML per Mimecast Admin Console**.
    3.  Come **Provider** selezionare **Azure Active Directory**.
    4.  Nella pagina della finestra di dialogo **Configura accesso Single Sign-On in Mimecast Admin Console** del portale di Azure, copiare il valore **URL autorità di certificazione** e incollarlo nella casella di testo **URL autorità di certificazione**.
    5.  Nella pagina della finestra di dialogo **Configura accesso Single Sign-On in Mimecast Admin Console** del portale di Azure, copiare il valore **URL accesso remoto** e incollarlo nella casella di testo **URL di accesso**.
    6.  Nella pagina della finestra di dialogo **Configura accesso Single Sign-On in Mimecast Admin Console** del portale di Azure, copiare il valore **URL accesso remoto** e incollarlo nella casella di testo **URL disconnessione**.  

        >[AZURE.NOTE]Il valore dell’URL di accesso e il valore dell'URL disconnessione per Mimecast Admin Console sono identici.
...
###Per assegnare gli utenti a Mimecast Admin Console, eseguire la procedura seguente:
