<properties pageTitle="Informazioni su Azure Multi-Factor Authentication" description="Informazioni su Multi-Factor Authentication, un metodo di autenticazione che richiede più di un metodo di verifica e con il quale viene aggiunto un secondo livello di sicurezza critico agli accessi e alle transazioni degli utenti." services="active-directory, multi-factor-authentication" documentationCenter="" authors="blackmist" manager="wpickett" editor=""/>
...
* Pagina delle funzionalità relative alle [macchine virtuali](http://www.windowsazure.com/it-it/documentation/services/virtual-machines/)
