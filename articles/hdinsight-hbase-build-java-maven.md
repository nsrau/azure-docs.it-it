...
* [Un cluster HDInsight di Azure con HBase](hdinsight-hbase-get-started.md#create-hbase-cluster)
...
> [AZURE.NOTE]Ci sono molti modi per caricare un file nel cluster HDInsight, come descritto nella sezione [Caricare dati per processi Hadoop in HDInsight](hdinsight-upload-data.md). La procedura seguente usa [Azure PowerShell](install-configure-powershell.md).
