<properties title="How to use the queue service (PHP) - Azure feature guide" pageTitle="Come usare il servizio di accodamento (PHP) | Microsoft Azure" metaKeywords="Azure Queue Service messaging PHP" description="Learn how to use the Azure Queue service to create and delete queues, and insert, get, and delete messages. Samples written in PHP." documentationCenter="PHP" services="storage" authors="tamram" manager="adinah" />
...
* [Configurare l'applicazione per l'utilizzo del Servizio di accodamento](#configure-app)
...
<h2><a id="configure-app"></a>Configurare l'applicazione per accedere al Servizio di accodamento</h2>
...
<h2><a id="connection-string"></a>Configurazione di una connessione di Archiviazione di Azure</h2>
...
Per aggiungere un messaggio a una coda, usare **QueueRestProxy->createMessage**. Il metodo accetta il nome della coda, il testo del messaggio e le opzioni messaggio (facoltative).
