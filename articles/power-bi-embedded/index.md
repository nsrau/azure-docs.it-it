...
ms.locfileid: "32182409"
---
# <a name="power-bi-embedded-documentation"></a>Documentazione di Power BI Embedded

Informazioni su come aggiungere visualizzazioni di dati e report interattivi alle applicazioni con Power BI Embedded. Esercitazioni, informazioni di riferimento sulle API e altri documenti mostrano come incorporare facilmente report e dashboard di Power BI nelle app.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni su Power BI Embedded</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Catalogo video di Azure Power BI Embedded</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introduzione a Power BI Embedded</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://docs.microsoft.com/rest/api/power-bi-embedded/">Informazioni di riferimento sull'API REST di Azure Resource Manager</a></p>
