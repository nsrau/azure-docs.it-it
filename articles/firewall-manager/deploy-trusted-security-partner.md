...
Sono ora disponibili partner integrati per la sicurezza di terze parti come servizio (SECas): 

- **Zscaler**
- **[Punto di controllo](check-point-overview.md)**
- **iboss**
...
1. Per completare l'installazione, seguire le istruzioni fornite dal partner. Questo include l'invio di informazioni di AAD per rilevare e connettersi all'hub, aggiornare i criteri in uscita e controllare lo stato e i log di connettività.
   ...
   - [Check Point: configurare Microsoft Azure integrazione WAN virtuale](https://sc1.checkpoint.com/documents/Infinity_Portal/WebAdminGuides/EN/CloudGuard-Connect-Azure-Virtual-WAN/Default.htm).
   - [iboss: configurare Microsoft Azure integrazione WAN virtuale](https://www.iboss.com/blog/securing-microsoft-azure-with-iboss-saas-network-security). 
