---
title: Come eseguire la migrazione delle configurazioni del firewall di Azure ai criteri del firewall di Azure (anteprima)
...
ms.locfileid: "73516331"
---
# <a name="how-to-migrate-azure-firewall-configurations-to-azure-firewall-policy-preview"></a>Come eseguire la migrazione delle configurazioni del firewall di Azure ai criteri del firewall di Azure (anteprima)
...
Lo script `AZFWMigrationScript.ps1` crea una FirewallPolicy con tre oggetti RuleCollectionGroup rispettivamente per ApplicationRuleCollections, NetworkRuleCollections e NatRuleCollections. 
