...
> [!NOTE]
> Se si esegue la distribuzione in Azure per enti pubblici, usare il file di installazione per distribuire il dispositivo di replica.
...
Il dispositivo di replica deve accedere a questi URL nel cloud pubblico di Azure.
