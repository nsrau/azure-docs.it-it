...
2. Nella pagina inizialefare clic su **Avanti**. Nella pagina **Condizioni di licenza** fare clic su **Accetto** per accettare la licenza.
...
2. Installare il bundle tramite l'argomento --install.
