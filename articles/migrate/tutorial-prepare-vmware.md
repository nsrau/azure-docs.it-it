...
5. Notare i requisiti per [URL di accesso](migrate-appliance.md#url-access) e [Accesso porta](migrate-support-matrix-vmware-migration.md#agentless-ports).
