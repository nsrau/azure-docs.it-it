...
- **Macchine virtuali VMware**: esaminare le [aree geografiche Azure migrate supportate](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-vmware) per le macchine virtuali VMware.
- **Macchine virtuali Hyper-v**: esaminare le [aree geografiche supportate](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-hyper-v) Azure migrate per le macchine virtuali Hyper-v.
