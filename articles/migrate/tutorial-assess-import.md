...
**Totale operazioni di lettura dischi** | No | Numero totale di tutte le operazioni di lettura al secondo relativo a tutti i dischi. <br/> Usare questo campo se non si riescono a fornire dati a livello di disco. 
**Totale operazioni di scrittura dischi** | No | Numero totale di tutte le operazioni di scrittura al secondo relativo a tutti i dischi. <br/> Usare questo campo se non si riescono a fornire dati a livello di disco.
**Totale velocità effettiva lettura da dischi** | No | Dati letti da tutti i dischi, in MB al secondo. <br/> Usare questo campo se non si riescono a fornire dati a livello di disco. 
**Totale velocità effettiva scrittura da dischi** | No | Dati scritti su tutti i dischi, in MB al secondo. <br/> Usare questo campo se non si riescono a fornire dati a livello di disco.
...
Se non si riescono a fornire dati a livello di disco, è possibile fornire i dati a livello di prestazioni del disco per server usando i campi seguenti. Per informazioni dettagliate su ogni campo, vedere [questa](#add-server-information) sezione.
- Totale operazioni di lettura dischi
- Totale operazioni di scrittura dischi
- Totale velocità effettiva lettura da dischi
- Totale velocità effettiva scrittura da dischi
