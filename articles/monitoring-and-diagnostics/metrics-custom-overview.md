...
Usare le metriche personalizzate da servizi diversi: 
 - [Macchine virtuali](metrics-store-custom-guestos-resource-manager-vm.md)
 - [Set di scalabilità di macchine virtuali](metrics-store-custom-guestos-resource-manager-vmss.md)
 - [Macchine virtuali di Azure (classico)](metrics-store-custom-guestos-classic-vm.md)
 ...
 - [Servizi cloud classici](metrics-store-custom-guestos-classic-cloud-service.md)
