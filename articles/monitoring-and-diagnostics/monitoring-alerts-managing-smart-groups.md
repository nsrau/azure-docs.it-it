...
1.  Per visualizzare i gruppi intelligenti creati per le istanze di avviso è possibile
    ...
    ![Monitoraggio](./media/monitoring-alerts-managing-smart-groups/sg-alerts-summary.jpg)
     2. Fare clic Avvisi per gruppi intelligenti dalla pagina Tutti gli avvisi   
     ![Monitoraggio](./media/monitoring-alerts-managing-smart-groups/sg-all-alerts.jpg)
...
![Monitoraggio](./media/monitoring-alerts-managing-smart-groups/sg-list.jpg)
...
![Monitoraggio](./media/monitoring-alerts-managing-smart-groups/sg-details.jpg)
