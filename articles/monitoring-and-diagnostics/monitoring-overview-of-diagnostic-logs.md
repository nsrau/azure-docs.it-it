...
* Analizzarli con [Log Analytics](../log-analytics/log-analytics-azure-storage.md)
...
> [!NOTE]
>  Non è al momento possibile archiviare i dati in un account di archiviazione che risiede dietro a una rete virtuale protetta.
