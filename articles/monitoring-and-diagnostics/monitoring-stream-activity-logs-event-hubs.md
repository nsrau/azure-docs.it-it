...
1. Passare al pannello **Log attività** usando la casella di ricerca Tutti i servizi sul lato sinistro del portale.
   
    ![Passare al log attività nel portale](./media/monitoring-stream-activity-logs-event-hubs/activity.png)
2. Fare clic sul pulsante **Esporta** nella parte superiore del pannello del log attività.
   
    ![Pulsante Esporta nel portale](./media/monitoring-stream-activity-logs-event-hubs/export.png)
3. Nel pannello visualizzato è possibile selezionare le aree per cui trasmettere gli eventi e lo spazio dei nomi del bus di servizio in cui creare un hub eventi per la trasmissione degli eventi. Selezionare **Tutte le aree**.
   
    ![Pannello Esporta log di controllo](./media/monitoring-stream-activity-logs-event-hubs/export-audit.png)
4. Fare clic su **Salva** per salvare le impostazioni. Le impostazioni vengono applicate immediatamente alla sottoscrizione.
5. Se si hanno più sottoscrizioni, è consigliabile ripetere questa azione e inviare tutti i dati allo stesso hub eventi.
