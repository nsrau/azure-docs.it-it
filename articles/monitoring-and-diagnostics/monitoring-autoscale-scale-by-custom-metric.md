...
Questo articolo presuppone che l'utente abbia un'app Web configurata con Application Insights configurato. Se non è già stato fatto, è possibile [configurare Application Insights per il sito Web ASP.NET][1].
