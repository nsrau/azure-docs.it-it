<properties 
	pageTitle="Aggiungere paging ai dati (Android) | Mobile Dev Center" 
	description="Informazioni su come usare il paging per gestire la quantità di dati restituiti all'app per Android da Servizi mobili." 
