...
Per trovare i connettori per protocolli nel portale di Microsoft Azure, fare clic su **Nuovo** > **Web e dispositivi mobili** > **Azure Marketplace** > immettere la parola chiave di ricerca **protocollo** > premere invio
...
Di seguito è riportata una breve descrizione di ciascuno dei connettori per protocolli. 
...
È possibile creare un connettore usando il portale di Azure oppure le API REST [Creare i connettori con le API REST](http://go.microsoft.com/fwlink/p/?LinkId=529766)
...
<tr><td>Località</td> <td>La località geografica che ospita il servizio di Azure.</th> </td>
...
1. Nella schermata iniziale del portale di Azure (la home page) passare a **Marketplace** e cercare la propria app per la logica, mobile o Web. 
	...
	Se si sta creando una nuova app, cercare un'app per la logica, un'app mobile o un'app Web. Selezionare l'app e nel nuovo pannello selezionare **Crea**. [Creare un'app per la logica](app-service-logic-create-a-logic-app.md) elenca i passaggi. 
