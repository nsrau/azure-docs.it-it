<properties pageTitle="Soluzioni di sicurezza per Macchine virtuali di Azure" description="Panoramica rapida delle funzionalità di sicurezza principali per le macchine virtuali di Azure e collegamenti a informazioni dettagliate" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
...
Gli elenchi di controllo di accesso di rete consentono di autorizzare o negare selettivamente il traffico in entrata su un endpoint della macchina virtuale. Questa funzionalità di filtro per i pacchetti garantisce un ulteriore livello di sicurezza. Per informazioni dettagliate sul funzionamento e per collegamenti a istruzioni, vedere [Informazioni sugli elenchi di controllo di accesso di rete (ACL)](http://go.microsoft.com/fwlink/?LinkId=506655).

##Risorse aggiuntive
[Risorse](http://azure.microsoft.com/it-it/support/trust-center/resources/) sul Centro protezione di Microsoft Azure
