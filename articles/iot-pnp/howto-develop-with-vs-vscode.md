...
1. Creare una `cmake` sottodirectory nella cartella contenente lo stub del codice generato e passare alla cartella seguente:
...
1. Installare [Visual Studio 2019 (community, Professional o Enterprise)](https://visualstudio.microsoft.com/downloads/) : assicurarsi di includere il componente **Gestione pacchetti NuGet** e il carico di lavoro **sviluppo di applicazioni desktop con C++** .
...
1. Creare una cartella denominata `cmake` nella cartella che contiene il codice generato e passare a tale cartella.
