...
La soluzione può usare l'API [get device Twin](https://docs.microsoft.com/rest/api/iothub/service/twin/getdevicetwin) per recuperare l'ID modello del dispositivo Plug and Play.
