---
title: 'Esercitazione: Connettere il codice C# di un dispositivo Plug and Play IoT di esempio con componenti a un hub IoT di Azure | Microsoft Docs'
