---
title: Interagire con un dispositivo Plug and Play IoT (anteprima) connesso alla soluzione - Node.js | Microsoft Docs
...
1. Questa finestra del terminale verrà ora usata come terminale del _dispositivo_. Passare alla cartella del repository clonato e quindi alla cartella **/azure-iot-samples-node/digital-twins/Quickstarts/Device**. Installare tutte le dipendenze eseguendo il comando seguente:
