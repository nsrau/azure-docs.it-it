...
![Scegliere Nuovo, quindi Servizi per gli sviluppatori, Application Insights.](./media/app-insights-web-track-usage/16-page-views.png)
...
![Scegliere Nuovo, quindi Servizi per gli sviluppatori, Application Insights.](./media/app-insights-web-track-usage/01-create.png)
...
![Nel pannello di panoramica delle app, scegliere Avvio rapido, quindi ottenere il codice per monitorare le pagine Web. Copiate lo script.](./media/app-insights-web-track-usage/02-monitor-web-page.png)
