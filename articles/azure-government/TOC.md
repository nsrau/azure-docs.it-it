...
# Attività iniziali
## [Guida per sviluppatori](documentation-government-developer-guide.md)
## [Accedere al portale di Azure per enti pubblici](documentation-government-get-started-connect-with-portal.md)
## [Effettuare il provisioning di un'app Web](documentation-government-howto-deploy-webandmobile.md)
## [Connettersi con PowerShell](documentation-government-get-started-connect-with-ps.md)
## [Connettersi con l'interfaccia della riga di comando](documentation-government-get-started-connect-with-cli.md)
## [Configurare Visual Studio per Azure per enti pubblici](documentation-government-get-started-connect-with-vs.md)
## [Servizi disponibili](documentation-government-services.md)
...
# Riferimento
## [Immagini](documentation-government-image-gallery.md)
...
### [Web e dispositivi mobili](documentation-government-services-webandmobile.md)
### [Servizi multimediali](documentation-government-services-media.md)
