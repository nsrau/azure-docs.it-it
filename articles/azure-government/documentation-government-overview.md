---
title: Panoramica della documentazione di Azure per enti pubblici | Documentazione Microsoft
...
---
# <a name="azure-government-documentation-overview"></a>Panoramica della documentazione di Azure per enti pubblici
## <a name="introduction-to-azure-government-documentation"></a>Introduzione alla documentazione di Azure per enti pubblici
...
### <a name="a-nameoverviewaencryption-at-rest"></a><a name="Overview"></a>Crittografia dei dati inattivi
...
### <a name="a-nameoverviewastorage-service-encryption"></a><a name="Overview"></a>Crittografia del servizio di archiviazione
...
### <a name="a-nameoverviewaazure-disk-encryption"></a><a name="Overview"></a>Crittografia dischi di Azure
...
### <a name="a-nameoverviewaclient-side-encryption"></a><a name="Overview"></a>Crittografia lato client
...
### <a name="a-nameoverviewaencryption-in-transit"></a><a name="Overview"></a>Crittografia in transito
...
### <a name="a-nameoverviewabest-practices-for-encryption"></a><a name="Overview"></a>Procedure consigliate per a crittografia
...
### <a name="a-nameoverviewabest-practices-for-managing-secrets"></a><a name="Overview"></a>Procedure consigliate per la gestione dei segreti
...
### <a name="a-nameoverviewaenvironment-isolation"></a><a name="Overview"></a>Isolamento dell'ambiente
...
#### <a name="a-nameoverviewaper-customer-isolation"></a><a name="Overview"></a>Isolamento per ogni cliente
