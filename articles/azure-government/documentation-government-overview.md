...
### <a name="<a-name="overview"></a>encryption-at-rest"></a><a name="Overview"></a>Crittografia dei dati inattivi
...
### <a name="<a-name="overview"></a>storage-service-encryption"></a><a name="Overview"></a>Crittografia del servizio di archiviazione
...
### <a name="<a-name="overview"></a>azure-disk-encryption"></a><a name="Overview"></a>Crittografia dischi di Azure
...
### <a name="<a-name="overview"></a>client-side-encryption"></a><a name="Overview"></a>Crittografia lato client
...
### <a name="<a-name="overview"></a>encryption-in-transit"></a><a name="Overview"></a>Crittografia in transito
...
### <a name="<a-name="overview"></a>best-practices-for-encryption"></a><a name="Overview"></a>Procedure consigliate per a crittografia
...
### <a name="<a-name="overview"></a>best-practices-for-managing-secrets"></a><a name="Overview"></a>Procedure consigliate per la gestione dei segreti
...
### <a name="<a-name="overview"></a>environment-isolation"></a><a name="Overview"></a>Isolamento dell'ambiente
...
#### <a name="<a-name="overview"></a>per-customer-isolation"></a><a name="Overview"></a>Isolamento per ogni cliente
