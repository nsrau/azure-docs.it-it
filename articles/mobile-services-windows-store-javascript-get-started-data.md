...
-   Visual Studio 2013, che facilita la connessione dell'app di Windows Store a Servizi mobili. Per completare la stessa procedura di base in Visual Studio 2012, eseguire le operazioni descritte nell'argomento [Introduzione ai dati in Servizi mobili tramite Visual Studio 2012][Introduzione ai dati in Servizi mobili tramite Visual Studio 2012].
...
1.  Scaricare la versione JavaScript dell'app di esempio GetStartedWithData dal [sito degli esempi di codice di Developer Network][app GetStartedWithMobileServices].
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [versione di valutazione gratuita di Azure]: http://azure.microsoft.com/it-it/pricing/free-trial/?WT.mc_id=A0E0E5C02&returnurl=http%3A%2F%2Fazure.microsoft.com%2Fit-it%2Fdocumentation%2Farticles%2Fmobile-services-windows-store-javascript-get-started-data%2F
