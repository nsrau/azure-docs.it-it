...
<ol start="7">
<li><p>In Esplora soluzioni espandere le cartelle **services**, **mobile services**, **&lt;servizio_utente&gt;**, aprire il file di script service.js e osservare la nuova variabile globale, che presenta un aspetto simile al seguente:</p> 
...
6. Nel file di progetto default.js sostituire la funzione **RefreshTodoItems** esistente con il codice seguente che consente di filtrare gli elementi completati:
...
7. Nell'app selezionare un altro elemento nell'elenco e quindi fare clic sul pulsante **Refresh**.
