...
---
# <a name="add-a-git-artifact-repository-to-a-lab-in-azure-devtest-labs"></a>Aggiungere un repository di elementi Git a un lab in Azure DevTest Labs
...
![Esempio di archivio elementi GitHub](./media/devtest-lab-add-artifact-repo/devtestlab-github-artifact-repo-home.png)
...
## <a name="connect-your-lab-to-the-artifact-repository"></a>Connettere il lab al repository di elementi
