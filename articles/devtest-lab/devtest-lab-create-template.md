---
title: Gestire immagini personalizzate di Azure DevTest Labs per creare macchine virtuali | Microsoft Docs
...
14. Nella scheda **Configurazione sistema operativo** selezionare **Windows** o **Linux**.
...
2. Il pannello successivo visualizzerà le istruzioni per la modifica e l'esecuzione di uno script di PowerShell che carica un file VHD nella sottoscrizione di Azure. **Nota:** questo processo può richiedere molto tempo a seconda delle dimensioni del file VHD e della velocità della connessione.
