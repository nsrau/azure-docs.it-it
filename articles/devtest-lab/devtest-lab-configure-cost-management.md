---
title: Visualizzare la tendenza dei costi mensili stimati per il lab in Azure DevTest Labs | Microsoft Docs
...
5. Nel pannello **Cost settings** (Impostazioni dei costi) del lab selezionare **Tendenza costo lab**.
