<properties
    pageTitle="Domande frequenti su Azure DevTest Labs | Microsoft Azure"
...
## <a name="ci/cd-integration-&-automation"></a>Integrazione e automazione CI/CD 
...
### <a name="what-if-my-question-isn't-answered-here?"></a>Cosa fare se non è disponibile una risposta alla domanda?
...
### <a name="does-azure-devtest-labs-integrate-with-my-ci/cd-toolchain?"></a>Azure DevTest Labs si integra con la toolchain CI/CD? 
...
### <a name="why-can't-i-see-certain-vms-in-the-azure-virtual-machines-blade-that-i-see-within-azure-devtest-labs?"></a>Perché nel pannello Macchine virtuali di Azure non è possibile visualizzare alcune VM che vengono visualizzate in Azure DevTest Labs?
...
1. [Creare l'immagine personalizzata](devtest-lab-create-template.md) nel lab di Azure DevTest Labs. 
...
### <a name="why-isn't-my-existing-virtual-network-saving-properly?"></a>Perché la rete virtuale esistente non viene salvata correttamente?  
