...
* [AzCopy per Azure](../storage/common/storage-use-azcopy.md#blob-upload) per copiare o caricare i file VHD nell'account di archiviazione associato al lab.
...
Per informazioni su come ottenere i log relativi all'elemento che presenta l'errore, vedere [Come diagnosticare gli errori di elemento in DevTest Labs](devtest-lab-troubleshoot-artifact-failure.md).
