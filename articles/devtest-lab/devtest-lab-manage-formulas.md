...
5. Nel pannello **Formule lab** selezionare **+ Aggiungi**.
...
6. Nel pannello **Crea formula** immettere un **Nome** e una **Descrizione** della nuova formula.
...
6. Apportare le modifiche nel pannello **Aggiorna formula** e selezionare **Aggiorna**.
...
2. Selezionare **Altri servizi** e quindi **DevTest Labs** dall'elenco.
3. Nell'elenco dei lab selezionare il lab desiderato.
4. Nel pannello **Impostazioni** del lab selezionare **Formule**.
