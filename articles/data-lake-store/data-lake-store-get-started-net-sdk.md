---
title: Usare .NET SDK con Data Lake Store per sviluppare applicazioni | Microsoft Docs
...
## Autenticazione
### Se si usa l'autenticazione dell'utente finale (consigliata per questa esercitazione)
