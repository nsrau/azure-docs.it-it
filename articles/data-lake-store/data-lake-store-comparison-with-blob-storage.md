...
|  | Archiviazione Azure Data Lake di prima generazione | Archiviazione BLOB di Azure |
| --- | --- | --- |
| Finalità |Archiviazione ottimizzata per carichi di lavoro di analisi dei Big Data |Archivio di oggetti generico per un'ampia gamma di scenari di archiviazione, tra cui analisi per Big Data. |
...
| API SmartBear Ready! |API REST su HTTPS |API REST su HTTP/HTTPS |
