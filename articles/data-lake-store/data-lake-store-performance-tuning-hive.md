...
* **Esecuzione di Hive in HDInsight**.  Per informazioni sull'esecuzione di processi Hive in HDInsight, vedere [utilizzare Hive in HDInsight] (https://docs.microsoft.com/azure/hdinsight/hdinsight-use-hive)
