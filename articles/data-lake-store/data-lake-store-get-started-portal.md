...
## <a name="createfolder"></a>Creazione di cartelle
...
2. Nel pannello dell'account Data Lake Storage Gen1 fare clic su **Esplora dati**.
    ...
    ![Creazione di cartelle in un account Data Lake Storage Gen1](./media/data-lake-store-get-started-portal/ADL.Create.Folder.png "Creare cartelle in un account Data Lake Storage Gen1")
3. Nel pannello Esplora dati fare clic su **Nuova cartella**, immettere un nome per la nuova cartella e quindi fare clic su **OK**.

    ![Creazione di cartelle in un account Data Lake Storage Gen1](./media/data-lake-store-get-started-portal/ADL.Folder.Name.png "Creare cartelle in un account Data Lake Storage Gen1")
...
## <a name="uploaddata"></a>Caricare i dati
