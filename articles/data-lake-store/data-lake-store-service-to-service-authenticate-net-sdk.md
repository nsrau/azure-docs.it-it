...
Il frammento di codice precedente usa una funzione di supporto `GetCreds_SPI_SecretKey`. Il codice per questa funzione helper è disponibile [qui su GitHub](https://github.com/Azure-Samples/data-lake-analytics-dotnet-auth-options#getcreds_spi_secretkey).
...
Il frammento di codice precedente usa una funzione di supporto `GetCreds_SPI_Cert`. Il codice per questa funzione helper è disponibile [qui su GitHub](https://github.com/Azure-Samples/data-lake-analytics-dotnet-auth-options#getcreds_spi_cert).
