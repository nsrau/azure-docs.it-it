...
# [Passare alla documentazione di Data Lake Storage Gen2](https://docs.microsoft.com/azure/storage/data-lake-storage/introduction)
...
### [Integrazione della rete virtuale](data-lake-store-network-security.md)
...
## [Python (gestione del file system)](https://azure-datalake-store.readthedocs.io/en/latest)
## [REST](/rest/api/datalakestore)
## [Modello di Resource Manager](/azure/templates/microsoft.datalakestore/allversions)
...
## [Forum di Stack Overflow](https://stackoverflow.com/questions/tagged/azure-data-lake)
