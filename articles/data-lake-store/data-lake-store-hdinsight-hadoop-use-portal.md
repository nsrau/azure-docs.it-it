...
3. Nel pannello **Archiviazione**, in **Tipo di archiviazione primario** selezionare **Azure Data Lake Storage Gen1** e quindi immettere le informazioni seguenti:
    ...
    ![Aggiungere un'entità servizio al cluster HDInsight](./media/data-lake-store-hdinsight-hadoop-use-portal/hdi.adl.1.adls.storage.png "Aggiungere entità servizio a cluster HDInsight")
...
3. Nel pannello **Archiviazione**, in **Tipo di archiviazione primario** selezionare **Archiviazione di Azure** e quindi immettere le informazioni seguenti:
    ...
    ![Aggiungere un'entità servizio al cluster HDInsight](./media/data-lake-store-hdinsight-hadoop-use-portal/hdi.adl.1.png "Aggiungere entità servizio a cluster HDInsight")
    ...
    * Accesso **Data Lake Store** : configurare l'accesso tra l'account data Lake storage Gen1 e il cluster HDInsight. Per istruzioni, vedere [Configurare l'accesso a Data Lake Storage Gen1](#configure-data-lake-storage-gen1-access).
...
1. Scaricare il certificato se si decide di usarlo ancora in futuro. Il download del certificato è un'operazione utile se in futuro si vorrà usare la stessa entità servizio per creare altri cluster HDInsight.
    ...
    ![Aggiungere un'entità servizio al cluster HDInsight](./media/data-lake-store-hdinsight-hadoop-use-portal/hdi.adl.2.png "Aggiungere entità servizio a cluster HDInsight")
...
1. Caricare il certificato (file PFX) associato all'entità servizio selezionata e quindi immettere la password del certificato.
    ...
    ![Aggiungere un'entità servizio al cluster HDInsight](./media/data-lake-store-hdinsight-hadoop-use-portal/hdi.adl.5.png "Aggiungere entità servizio a cluster HDInsight")
...
1. Passare il mouse (non fare clic) sul nome dell'account Data Lake Storage Gen1 per rendere visibile la casella di controllo e selezionarla.
    ...
    ![Aggiungere un'entità servizio al cluster HDInsight](./media/data-lake-store-hdinsight-hadoop-use-portal/hdi.adl.3.png "Aggiungere entità servizio a cluster HDInsight")
...
* Per verificare che la risorsa di archiviazione associata per il cluster sia l'account Data Lake Storage Gen1 specificato, selezionare **account di archiviazione** nel riquadro sinistro.
    ...
    ![Aggiungere un'entità servizio al cluster HDInsight](./media/data-lake-store-hdinsight-hadoop-use-portal/hdi.adl.6-1.png "Aggiungere entità servizio a cluster HDInsight")
...
* Per verificare che l'entità servizio sia associata correttamente al cluster HDInsight, selezionare **Data Lake storage Gen1 accesso** nel riquadro sinistro.
    ...
    ![Aggiungere un'entità servizio al cluster HDInsight](./media/data-lake-store-hdinsight-hadoop-use-portal/hdi.adl.6.png "Aggiungere entità servizio a cluster HDInsight")
