...
- Supporto per la registrazione manuale di tipi di origini dati conosciuti. Gli utenti possono immettere manualmente le informazioni sulle origini dati usando il portale di **Catalogo dati di Azure** per tutti i tipi di origini dati supportati da **Catalogo dati di Azure**.
- Supporto per l'autorizzazione di gruppi di sicurezza di Azure Active Directory. Gli amministratori del catalogo possono concedere l'accesso al catalogo ai gruppi di sicurezza e agli account utente, rendendo più semplice la gestione dell'accesso a **Catalogo dati di Azure**.
- Supporto per l'apertura di origini dati Hive in Excel dal portale del **Catalogo dati di Azure**.
...
- Supporto per il rilevamento a livello di codice dell'API di catalogo, rendendo più semplice l'integrazione delle applicazioni con **Catalogo dati di Azure**.
