...
## Piano di adozione di Catalogo dati di Azure
Un piano di adozione di **Catalogo dati di Azure** descrive come comunicare a stakeholder e utenti i vantaggi derivanti dall'uso del servizio Catalogo dati, oltre al tipo di training che si fornirà agli utenti del servizio. Un elemento chiave del successo nell'adozione di Catalogo dati è la capacità di comunicare in modo efficace il valore del servizio a utenti e stakeholder. I principali destinatari in un piano di adozione iniziale sono gli utenti del servizio. Indipendentemente dall'adesione da parte degli stakeholder, se gli utenti, ovvero i clienti, dell'offerta relativa a Catalogo dati non la incorporano, l'adozione non avrà successo. Questo articolo presuppone quindi che l'utente abbia l'adesione degli stakeholder e si concentra sulla creazione di un piano per l'adozione di Catalogo dati da parte degli utenti. Un piano di adozione efficace incoraggia le persone a considerare ciò che è possibile fare con Catalogo dati e offre informazioni e indicazioni per riuscirci. È necessario che gli utenti comprendano il valore di Catalogo dati per eseguire correttamente i vari processi. Quando le persone capiscono l'utilità di Catalogo dati per ottenere risultati migliori con i dati, il valore dell'adozione di Catalogo dati diventa estremamente chiaro. Il cambiamento non è semplice, quindi un piano efficace deve tenere in considerazione le difficoltà derivanti da questo cambiamento.

Un piano di adozione consente di comunicare ciò che è essenziale alle persone per raggiungere i propri obiettivi. Un piano tipico spiega come Catalogo dati faciliterà le normali operazioni quotidiane dell'utente e include le parti seguenti:
...
-	**Team pilota e influencer**: confrontarsi con un team pilota e con gli influencer consentirà di perfezionare il modo di presentare Catalogo dati ai team e agli utenti. Gli influencer possono occuparsi del peer coaching dei colleghi. In questo modo è anche possibile identificare le persone contrarie e quelle favorevoli all'adozione.
...
-	**Essere precisi e chiari**: una conoscenza precisa della visione farà in modo che tutti si trovino d'accordo sul valore conferito da Catalogo dati all'organizzazione e su come la visione supporti gli obiettivi dell'organizzazione.
...
-	**Determinare obiettivi e una sequenza temporale specifici**: in questo modo sarà possibile assicurarsi che il piano di adozione preveda risultati finali specifici e raggiungibili. Una sequenza temporale fa in modo che tutti rimangano concentrati e consente ai checkpoint di valutare la riuscita.
...
**Catalogo dati di Azure** consentirà al team Finanza di Adventure Works di collaborare alle origini dati chiave, in modo che ogni membro del team possa trovare e usare facilmente i dati necessari e condividere le proprie conoscenze con l'intero team.

Una volta ottenuta una precisa dichiarazione della visione, è consigliabile identificare un progetto pilota per Catalogo dati. Poiché gli scenari per Catalogo dati saranno in genere più di uno, la prossima sezione offre alcuni suggerimenti per identificare i casi d'uso pertinenti.

## Identificare i casi d'uso di business di Catalogo dati
...
-	**Registrare le origini dati basate sul team**: diversi team hanno origini dati line-of-business utili. Iniziare a usare **Catalogo dati di Azure** identificando e registrando le origini dati chiave usate da più team diversi e acquisire le conoscenze di base di ogni team nelle annotazioni di **Catalogo dati di Azure**.
...
## Scegliere un progetto pilota di Catalogo dati
Una fattore di successo chiave è semplificare e iniziare in piccolo. Un progetto pilota ben definito con un ambito limitato eviterà che il progetto possa crescere fino a diventare troppo complesso o a includere troppi partecipanti. È importante anche includere tipi diversi di utenti, dai primi utenti agli scettici. Gli utenti che hanno accolto la soluzione aiuteranno a perfezionare il futuro piano di comunicazione e di buzz. Gli scettici saranno d'aiuto per identificare e affrontare gli utenti non favorevoli. Quando gli scettici diventano promotori, è possibile basarsi sul loro feedback per identificare i fattori di successo.
...
### Individuare il team appropriato
...
### Identificare gli utenti principali dei dati
...
### Iniziare con un progetto piccolo e mirato
...
> [AZURE.NOTE] Abbiamo scritto uno strumento di esempio che usa l'API di **Catalogo dati di Azure** per eseguire la migrazione di una cartella di lavoro di Excel a Catalogo dati. Per altre informazioni sull'API di Catalogo dati e sullo strumento di esempio, è possibile [scaricare il codice di esempio della cartella di lavoro ad hoc](https://azure.microsoft.com/documentation/samples/data-catalog-dotnet-excel-register-data-assets/) e vedere la documentazione sull'[API REST di Catalogo dati di Azure](https://msdn.microsoft.com/library/azure/mt267593.aspx).
...
-	**Creare entusiasmo**: gli utenti business saranno entusiasti se penseranno che **Catalogo dati di Azure** semplificherà il loro lavoro. Cercare di orientare la discussione sulla soluzione e sui vantaggi offerti, non sulla tecnologia.
...
-	**Formare i primi utenti**: i primi utenti sono utenti business che si appassionano a ciò che fanno e sono entusiasti di far conoscere i vantaggi di **Catalogo dati di Azure** ai colleghi.
...
## Altre informazioni su Catalogo dati di Azure
