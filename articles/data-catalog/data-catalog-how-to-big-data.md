...
---
# <a name="how-to-work-with-big-data-sources-in-azure-data-catalog"></a>Come utilizzare origini dati di tipo Big Data in Azure Data Catalog
...
In questo schema la registrazione di singoli file con **Azure Data Catalog** probabilmente non ha senso. Registrare invece le directory che rappresentano i set di dati che sono significativi per gli utenti che utilizzano i dati.
