...
-   **Sviluppatori**: gli sviluppatori sono i clienti che compilano applicazioni usando le API. Agli amministratori viene concesso di accedere al [portale per sviluppatori][Portale per sviluppatori] e di creare applicazioni che chiamano le operazioni di un'API.
...
È possibile personalizzare l'aspetto del portale per sviluppatori aggiungendo contenuto personalizzato, personalizzando gli stili e aggiungendo il proprio logo.
  ...
  [Come creare o invitare gli sviluppatori]: ../api-management-howto-create-or-invite-developers
  [Come associare i gruppi agli sviluppatori]: ../api-management-howto-create-groups/#associate-group-developer
  [Riferimenti per i criteri]: ../api-management-policy-reference
  [Criteri di Gestione API]: ../api-management-howto-policies
  [Come creare e configurare impostazioni di prodotto avanzate]: ../api-management-howto-product-with-rules
