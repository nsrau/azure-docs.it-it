...
Creare un'applicazione Node.js vuota. Per istruzioni sulla creazione di un'applicazione Node.js, vedere [Creazione e distribuzione di un sito Web Node.js in Azure], [Creazione e distribuzione di un'applicazione Node.js a un servizio cloud di Azure][Node.js Cloud Service] (con Windows PowerShell) o [Creare e distribuire un sito Web Node.js in Azure con WebMatrix].
...
Quando chiama **createTopicIfNotExists** sull'oggetto **ServiceBusService** , viene restituito l'argomento specificato, se esiste, oppure viene creato un nuovo argomento con il nome specificato. Nel codice seguente viene usato **createTopicIfNotExists** per creare o connettersi all'argomento denominato 'MyTopic':
...
**createServiceBusService** supporta anche opzioni aggiuntive che permettono di sostituire le impostazioni degli argomenti predefinite, come ad esempio la durata dei messaggi o la dimensione massima dell'argomento. L'esempio seguente illustra come impostare la dimensione massima dell'argomento su 5 GB e una durata di 1 minuto:
...
In Azure SDK per Node.js sono inclusi due filtri che implementano la logica di ripetizione dei tentativi, **ExponentialRetryPolicyFilter** e **LinearRetryPolicyFilter**. Il codice seguente consente di creare un oggetto **ServiceBusService** che usa **ExponentialRetryPolicyFilter**:
...
Nell'esempio seguente viene illustrato come impostare cinque messaggi di test su 'MyTopic'. Si noti che il valore della proprietà **messagenumber** di ogni messaggio varia nell'iterazione del ciclo, determinando le sottoscrizioni che lo riceveranno:
...
Nell'esempio seguente viene illustrato come ricevere ed elaborare messaggi usando la modalità **receiveSubscriptionMessage**. Nell'esempio viene prima ricevuto ed eliminato un messaggio dalla sottoscrizione 'LowMessages' e quindi viene ricevuto un messaggio dalla sottoscrizione 'HighMessages' con **isPeekLock** impostato su true. Il messaggio viene quindi eliminato usando il metodo **deleteMessage**:
...
-   Visitare il repository per [Azure SDK per Node] su GitHub.
  ...
  [Creare e distribuire un sito Web Node.js in Azure con WebMatrix]: /it-it/develop/nodejs/tutorials/web-site-with-webmatrix/
  ...
  [Creazione e distribuzione di un sito Web Node.js in Azure]: /it-it/develop/nodejs/tutorials/create-a-website-(mac)/
  [Creazione e distribuzione di un'applicazione Node.js a un servizio cloud di Azure]: /it-it/develop/nodejs/tutorials/web-app-with-storage/
