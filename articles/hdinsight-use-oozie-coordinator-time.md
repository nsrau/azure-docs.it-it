...
Informazioni su come definire i flussi di lavoro e i coordinatori e come attivare i processi del coordinatore in base al tempo. Prima di procedere è utile consultare [Usare Oozie con HDInsight][hdinsight-use-oozie]. 
...
1. Creare un file di testo con il contenuto seguente:
	...
	| ------------------|------------ |
	| ${coordFrequency} | Job pause time. La frequenza è sempre espressa in minuti. |
...
2. Salvare il file come **C:\Tutorials\UseOozie\coordinator.xml** usando la codifica ANSI (ASCII) (se l'editor di testo in uso non offre questa opzione, usare il Blocco note).
