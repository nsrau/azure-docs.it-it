<properties title="How to debug with events" pageTitle="Come eseguire il debug con eventi" description="Learn how to see events in Azure." authors="hanikn" manager="kamrani" />
