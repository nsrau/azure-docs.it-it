...
# Come inviare messaggi di posta elettronica usando SendGrid da Java in una distribuzione Azure
...
![Modulo per la posta elettronica][Modulo per la posta elettronica]

Il messaggio di posta elettronica finale dovrebbe essere simile a quello riportato nella schermata seguente.

![Messaggio di posta elettronica][Messaggio di posta elettronica]
...
Per poter inviare i messaggi di posta elettronica è inoltre necessario disporre di un nome utente e una password di SendGrid. Per iniziare a utilizzare SendGrid, vedere [Come inviare messaggi di posta elettronica utilizzando SendGrid da Java][Come inviare messaggi di posta elettronica utilizzando SendGrid da Java].

Se non si utilizza Eclipse, è inoltre consigliabile consultare l'argomento [Creazione di un'applicazione Hello World per Azure in Eclipse][Creazione di un'applicazione Hello World per Azure in Eclipse] o acquisire familiarità con altre tecniche per l'hosting di applicazioni Java in Azure.
...
![Risultato invio posta elettronica][Risultato invio posta elettronica]
...
-   Anziché utilizzare un modulo Web, è possibile utilizzare l'archiviazione BLOB o un database SQL di Azure per l'archiviazione di indirizzi e-mail e messaggi di posta elettronica. Per informazioni sull'utilizzo dei BLOB di archiviazione di Azure in Java, vedere [Come utilizzare il servizio di archiviazione BLOB da Java][Come utilizzare il servizio di archiviazione BLOB da Java]. Per informazioni sull'utilizzo dei database SQL in Java, vedere [Utilizzo di database SQL in Java][Utilizzo di database SQL in Java].
-   È possibile usare `RoleEnvironment.getConfigurationSettings` per recuperare il nome utente e la password di SendGrid dalle impostazioni di configurazione della distribuzione, anziché usare il modulo Web per recuperare questi valori. Per informazioni sulla classe `RoleEnvironment`, vedere l'argomento relativo all'[Uso della libreria di runtime del servizio Azure in JSP][Uso della libreria di runtime del servizio Azure in JSP] e la documentazione sul pacchetto della libreria di runtime del servizio Azure all'indirizzo <http://dl.windowsazure.com/javadoc>.
-   Per ulteriori informazioni sull'utilizzo di SendGrid in Java, vedere [Come inviare messaggi di posta elettronica utilizzando SendGrid da Java][Come inviare messaggi di posta elettronica utilizzando SendGrid da Java].
  ...
  [Come inviare messaggi di posta elettronica utilizzando SendGrid da Java]: ../store-sendgrid-java-how-to-send-email
  [Creazione di un'applicazione Hello World per Azure in Eclipse]: http://msdn.microsoft.com/it-it/library/windowsazure/hh690944
  [Risultato invio posta elettronica]: ./media/store-sendgrid-java-how-to-send-email-example/SendGridJavaResult.jpg
  [Come utilizzare il servizio di archiviazione BLOB da Java]: http://www.windowsazure.com/it-it/develop/java/how-to-guides/blob-storage/
  [Utilizzo di database SQL in Java]: http://www.windowsazure.com/it-it/develop/java/how-to-guides/using-sql-azure-in-java/
  [Uso della libreria di runtime del servizio Azure in JSP]: http://msdn.microsoft.com/it-it/library/windowsazure/hh690948
