...
Se è stata usata una versione precedente dell'API Batch per intelligenza artificiale, questo articolo illustra come modificare il codice e gli script per usare la nuova API. 
