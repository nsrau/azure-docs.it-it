...
> Per ulteriori informazioni sulla gestione dei certificati mediante l'API REST di Gestione API, vedere [Entità certificato dell'API REST di Gestione API di Azure][].

## Contenuto dell'argomento

-   [Prerequisiti][]
-   [Caricamento di un certificato client][]
-   [Eliminazione di un certificato client][]
-   [Configurazione di un'API per l'utilizzo di un certificato reciproco per l'autenticazione proxy][]
...
![Criteri dei certificati][]
  ...
  [Certificati client]: ./media/api-management-howto-mutual-certificates/api-management-security-client-certificates.png
  [Caricamento del certificato]: ./media/api-management-howto-mutual-certificates/api-management-upload-certificate.png
  [1]: ./media/api-management-howto-mutual-certificates/api-management-upload-certificate-form.png
  [Certificato caricato]: ./media/api-management-howto-mutual-certificates/api-management-certificate-uploaded.png
  [Eliminazione di un certificato]: ./media/api-management-howto-mutual-certificates/api-management-certificate-delete.png
  [Conferma dell'eliminazione]: ./media/api-management-howto-mutual-certificates/api-management-confirm-delete.png
  [2]: ./media/api-management-howto-mutual-certificates/api-management-confirm-delete-policy.png
  [Sicurezza API]: ./media/api-management-howto-mutual-certificates/api-management-api-security.png
  [Certificati reciproci]: ./media/api-management-howto-mutual-certificates/api-management-mutual-certificates.png
  [Selezione del certificato]: ./media/api-management-howto-mutual-certificates/api-management-select-certificate.png
  [Salvataggio delle modifiche API]: ./media/api-management-howto-mutual-certificates/api-management-save-api.png
  [Criteri dei certificati]: ./media/api-management-howto-mutual-certificates/api-management-certificate-policy.png
