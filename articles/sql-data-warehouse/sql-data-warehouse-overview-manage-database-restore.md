...
Questo articolo descrive le opzioni per il ripristino di un database in SQL Data Warehouse di Azure. Sono inclusi il ripristino di un data warehouse in tempo reale e di un data eliminato. I data warehouse in tempo reale ed eliminati vengono ripristinati dagli snapshot automatici creati da tutti i data warehouse.
