<properties
   pageTitle="Eseguire il backup e il ripristino in Azure SQL Data Warehouse (REST) | Microsoft Azure"
...
# Eseguire il backup e il ripristino di un database in Azure SQL Data Warehouse (REST)
...
Come eseguire il backup e il ripristino di un database in SQL Data Warehouse tramite le API REST.
