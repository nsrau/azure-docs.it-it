...
Per altre informazioni sull'autenticazione a un database SQL, vedere [Protezione del database SQL: gestire l'accesso al database e la sicurezza degli account di accesso][] e [Connessione a SQL Data Warehouse con l'autenticazione di Azure Active Directory][].
...
[Connessione a SQL Data Warehouse con l'autenticazione di Azure Active Directory]: ./sql-data-warehouse-aad-authentication.md
...
[Protezione del database SQL: gestire l'accesso al database e la sicurezza degli account di accesso]: https://msdn.microsoft.com/library/ee336235.aspx
