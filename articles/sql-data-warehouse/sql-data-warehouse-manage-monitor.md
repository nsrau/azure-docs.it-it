...
ms.locfileid: "76721150"
---
# <a name="monitor-your-workload-using-dmvs"></a>Monitoraggio del carico di lavoro mediante DMV
Questo articolo descrive come usare le viste a gestione dinamica (DMV) per monitorare il carico di lavoro. Viene analizzata l'esecuzione di una query in Azure SQL Data Warehouse.
...
Tutti gli accessi a SQL Data Warehouse vengono registrati in [sys.dm_pdw_exec_sessions](https://msdn.microsoft.com/library/mt203883.aspx).  Questa DMV contiene gli ultimi 10.000 accessi.  L'elemento session_id è la chiave primaria e viene assegnato in sequenza per ogni nuovo accesso.
