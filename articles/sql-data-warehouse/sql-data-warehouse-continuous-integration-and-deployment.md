...
- Esplorare l'[architettura di Azure SQL Data Warehouse](massively-parallel-processing-mpp-architecture.md)
- [Creare rapidamente un'istanza di SQL Data Warehouse](create-data-warehouse-portal.md)
