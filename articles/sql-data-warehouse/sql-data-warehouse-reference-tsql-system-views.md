...
## Viste a gestione dinamica (DMV) di SQL Server applicabili a SQL Data Warehouse
...
> [!NOTE]
> Per usare queste viste, inserire 'pdw\_nodes\_' nel nome, come mostrato nella tabella seguente.
> 
> 
...
| sys.dm\_pdw\_nodes\_exec\_sessions |[sys.dm\_exec\_sessions](https://msdn.microsoft.com/it-IT/library/ms176013.aspx) |
...
| sys.dm\_pdw\_nodes\_os\_spinlock\_stats |La documentazione Transact-SQL non è disponibile. |
