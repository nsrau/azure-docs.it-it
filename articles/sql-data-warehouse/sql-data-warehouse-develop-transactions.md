...
| [DWU](sql-data-warehouse-overview-what-is.md) | Limite per ogni distribuzione (GB) | Numero di distribuzioni | Dimensioni MAX delle transazioni (GB) | Numero di righe per distribuzione | Righe max per transazione |
| --- | --- | --- | --- | --- | --- |
