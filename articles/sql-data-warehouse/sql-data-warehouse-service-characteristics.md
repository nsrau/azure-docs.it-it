...
| :---------------- | :------------------------------------------- | :----------------- |
| Sessione | Sessioni simultanee aperte | 1024<br/><br/>È supportato un massimo di 1024 connessioni attive che possono inviare richieste al data warehouse contemporaneamente. Si noti che sono previsti limiti per il numero di query effettivamente eseguibili contemporaneamente. Quando un limite viene superato, la richiesta viene inviata a una coda interna in cui resta in attesa di elaborazione.|
