...
Vedere anche [gestire le statistiche delle tabelle][Manage table statistics], [CREATE STATISTICS][CREATE STATISTICS], [UPDATE STATISTICS][UPDATE STATISTICS]
...
Vedere anche [informazioni sulle transazioni][Understanding transactions], [Optimizing transactions][Optimizing transactions], [partizionamento delle tabelle][partizionamento delle tabelle], [TRUNCATE TABLE][TRUNCATE TABLE] , [ALTER TABLE][ALTER TABLE], [Creare una tabella come select (CTAS)][crea una tabella come select (CTAS)]
...
Vedere anche [panoramica delle tabelle][Table overview], [Table data types][Table data types], [CREATE TABLE][CREATE TABLE]
...
Vedere anche [Table indexes][Table indexes], [Columnstore indexes guide][Columnstore indexes guide], [ricompilazione degli indici columnstore][ricompilazione degli indici columnstore]
...
Vedere anche [le classi di risorse per la gestione del carico di lavoro](resource-classes-for-workload-management.md), [DM pdw_waits][sys.dm_pdw_waits]
...
Vedere anche [monitorare il carico di lavoro mediante DMV][Monitor your workload using DMVs], [LABEL][LABEL], [opzione][opzione], [Sys. dm _][sys.dm_exec_sessions], [sys.dm_pdw_exec_requests][sys.dm_pdw_exec_requests], [DM pdw_request_steps][DM pdw_request_steps], [DM pdw_sql_requests][sys.dm_pdw_sql_requests], [DM pdw_dms_workers], [DBCC PDW_SHOWEXECUTIONPLAN][DBCC PDW_SHOWEXECUTIONPLAN], [sys.dm_pdw_waits][sys.dm_pdw_waits]
