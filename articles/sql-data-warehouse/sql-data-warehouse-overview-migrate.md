...
## Passaggi successivi
Il team CAT (Customer Advisory Team) dispone anche di utili istruzioni su SQL Data Warehouse che pubblica tramite blog. Per ulteriori istruzioni sulla migrazione, fare riferimento all'articolo [Migrazione dei dati in SQL Data Warehouse di Azure in pratica][Migrazione dei dati in SQL Data Warehouse di Azure in pratica].
