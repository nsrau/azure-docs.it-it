...
Visitare l'articolo seguente per alcuni [esempi di ADF][esempi di ADF].
...
Per altre informazioni e dati relativi ai prezzi, vedere la [documentazione relativa a ExpressRoute][documentazione relativa a ExpressRoute].
...
## Passaggi successivi
Per altre informazioni sulla migrazione, vedere l'articolo relativo alla [migrazione di una soluzione in SQL Data Warehouse][migrazione di una soluzione in SQL Data Warehouse]. Per altri suggerimenti sullo sviluppo, vedere la [panoramica dello sviluppo][panoramica dello sviluppo].
