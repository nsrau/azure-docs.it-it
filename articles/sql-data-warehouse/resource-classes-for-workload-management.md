...
Solo le query che dipendono da una risorsa usano tutti gli slot di concorrenza. Le query di sistema e alcune semplici query non utilizzano slot. Il numero esatto di slot di concorrenza usati è determinato dalla classe di risorse della query.
