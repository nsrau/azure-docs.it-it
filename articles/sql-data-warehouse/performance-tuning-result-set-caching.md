...
description: Panoramica delle funzionalità di memorizzazione nella cache dei set di risultati per analisi SQL in Azure sinapsi Analytics
...
> [!IMPORTANT]
> Le operazioni per creare la cache dei set di risultati e recuperare i dati dalla cache avvengono nel nodo di controllo di un'istanza di SQL Analytics.
