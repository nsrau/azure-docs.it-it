...
description: Elenchi di partner business intelligence di terze parti con soluzioni che supportano Azure SQL Data Warehouse.
...
| ![Dundas][4] |**Dundas BI**<br>Dundas Data Visualization è un importante fornitore globale di software per business intelligence e visualizzazione dei dati.  I dashboard, i report e le analisi visuali dei dati di Dundas offrono un'integrazione semplificata nelle applicazioni aziendali, permettendo di ottenere decisioni migliori e approfondimenti più rapidi.|[Pagina del prodotto][dundas_bi_website]<br>[Azure Marketplace][dundas_bi_marketplace]<br> |
| ![IBM Cognos][3] |**Analisi Cognos IBM**<br>L'analisi Cognos include funzionalità self-service intelligenti che rendono semplice, chiaro e facile da usare se si è un analista aziendale esperto che esamina i nodi in un'ampia supply chain o un marketer che ottimizza una singola campagna. Cognos Analytics usa l'intelligenza artificiale e altre funzionalità intelligenti per eseguire il lavoro più pesante per guidare l'esplorazione dei dati e rendere più semplice per gli utenti ottenere le risposte necessarie|[Pagina del prodotto][cognosanalytics_website]<br>|
| ![Generatori di informazioni][13] |**Generatori di informazioni (WebFOCUS)**<br>WebFOCUS business intelligence aiuta le aziende a usare i dati in modo più strategico oltre l'azienda. Consente agli utenti e agli amministratori di creare rapidamente dashboard che combinano contenuto da più origini dati e formati e fornisce una solida sicurezza e una governance completa che consente di creare in modo semplice e sicuro la condivisione e la condivisione di qualsiasi BI e analisi contenuto|[Pagina del prodotto][informationbuilders_website]<br> |
![Jinfonet][5] |**JReport Jinfonet**<br>JReport è una soluzione di business intelligence incorporabile per le aziende. La soluzione permette agli utenti di creare report, dashboard e analisi di dati sul cloud, Big Data e origini dati transazionali. La visualizzazione dei dati permette di creare report personalizzati e individuare personalmente i dati per ottenere un processo decisionale agile e rapido. |[Pagina del prodotto][jinfonet_website]<br> |
| ![LogiAnalytics][6] |**Logi Analytics**<br>L'uso combinato di Logi Analytics e Azure SQL Data Warehouse consente alle organizzazioni di raccogliere, analizzare e prendere decisioni immediate in base ai set di dati più grandi e più diversificati al mondo. |[Pagina del prodotto][logianalytics_website]<br>|
| ![Looker][7] |**Looker BI**<br>Looker offre a tutti gli utenti nell'azienda la possibilità di esplorare e comprendere i dati essenziali per l'attività aziendale, fornendo al tempo stesso all'analista dei dati un livello di modellazione flessibile e riusabile per controllare e gestire i dati.  Molte aziende hanno trasformato radicalmente la propria cultura usando Looker come catalizzatore.|[Pagina del prodotto][looker_website]<br> [Azure Marketplace][looker_marketplace]<br> |
| ![MicroStrategy][14] |**MicroStrategy**<br>La piattaforma di microstrategia offre un set completo di funzionalità di business intelligence e analisi che consentono alle organizzazioni di ottenere valore dai dati aziendali. Il potente motore analitico della microstrategia, set di strumenti completi, diversi connettori di dati e architettura scalabile e aperta, ti permette di ottenere tutti gli elementi necessari per estendere l'accesso alle funzionalità di analisi in ogni team e funzione aziendale |[Pagina del prodotto][microstrategy_website]<br> [Azure Marketplace][microstrategy_marketplace]<br> |
| ![Qlik][8] |**Qlik Sense Enterprise**<br>Informazioni approfondite sull'app di visualizzazione dei dati che chiunque può usare. Con Qlik Sense, tutti i dipendenti dell'organizzazione possono creare facilmente visualizzazioni interattive e flessibili e prendere decisioni importanti. |[Pagina del prodotto][qlik_website]<br> |
| ![SiSense][9] |**SiSense**<br>SiSense è un software di business intelligence completo che include gli strumenti necessari alle aziende per analizzare e visualizzare i dati, ovvero un database analitico a prestazioni elevate, la possibilità di unire più origini, l'estrazione semplice dei dati (ETL) e la visualizzazione dei dati basata sul Web. È possibile iniziare subito ad analizzare e visualizzare set di dati di grandi dimensioni con SiSense BI and Analytics. |[Pagina del prodotto][sisense_website]<br> |
| ![Tableau][10] |**Tableau**<br>Le analisi self-service di Tableau permettono a chiunque di visualizzare e comprendere i propri dati, di qualsiasi tipo essi siano, da file flat a database. Tableau offre un connettore nativo e ottimizzato per Microsoft Azure SQL Data Warehouse, che supporta le analisi dei dati in tempo reale e in memoria. |[Pagina del prodotto][tableau_website]<br> [Azure Marketplace][tableau_marketplace]<br>|
| ![Targit][11] |**TARGIT (Decision Suite)**<br>Targit Decision Suite offre una piattaforma di business intelligence e analisi che fornisce dashboard in tempo reale, analisi self-service, report semplici da usare, straordinarie capacità mobili e una semplice tecnologia per il rilevamento di dati in un'unica soluzione coerente. Targit offre alle aziende il coraggio di agire. |[Pagina del prodotto][targit_website]<br> [Azure Marketplace][targit_marketplace]<br> |
| ![Albacora][12] |**Albacora**<br>Albacora è un fornitore di business intelligence cloud più votato per la creazione di report e dashboard ad hoc di BARC; Sondaggio BI. È possibile connettersi ad Azure SQL Data Warehouse, quindi creare e condividere report e dashboard straordinari con funzionalità collaborative avanzate di business intelligence e location intelligence. |[Pagina del prodotto][yellowfin_website]<br> [Azure Marketplace][yellowfin_marketplace] |
