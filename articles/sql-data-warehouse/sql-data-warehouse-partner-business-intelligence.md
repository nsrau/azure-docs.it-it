...
| ![LogiAnalytics][6] |**Logi Analytics**<br>L'uso combinato di Logi Analytics e Azure SQL Data Warehouse consente alle organizzazioni di raccogliere, analizzare e prendere decisioni immediate in base ai set di dati più grandi e più diversificati al mondo. |[Sito Web][logianalytics_website]<br>[Foglio dati][logianalytics_datasheet]<br>[Twitter][logianalytics_twitter]<br>[YouTube][logianalytics_youtube] |[![video di logianalytics](./media/sql-data-warehouse-partner-business-intelligence/logianalytics_video.jpg)](https://www.youtube.com/watch?v=7U0Sfi3Ndpk) |
