---
title: Gestire i database in Azure SQL Data Warehouse | Microsoft Docs
...
Per un'introduzione al portale di Azure, vedere [Creare un SQL Data Warehouse][Creare un SQL Data Warehouse] \(portale di Azure).
...
Per iniziare a usare SSDT in Visual Studio, vedere [Eseguire query su Azure SQL Data Warehouse con Visual Studio][Eseguire query su Azure SQL Data Warehouse con Visual Studio].
...
Le viste a gestione dinamica sono alla base della gestione di SQL Data Warehouse. Quasi tutte le informazioni che emergono nel portale si basano sulle viste a gestione dinamica. Per visualizzare un elenco di viste a gestione dinamica di SQL Data Warehouse, vedere [Viste di sistema][Viste di sistema] di SQL Data Warehouse.

Per iniziare, vedere [Connettersi ed eseguire query con SQLCMD][Connettersi ed eseguire query con SQLCMD] e [Creare un database (PowerShell)][Creare un database (PowerShell)].
...
Per altre informazioni sulla scalabilità delle DWU, vedere la sezione [Scalare le prestazioni][Scalare le prestazioni].
...
Per altre informazioni, vedere le sezioni [Sospendere il calcolo][Sospendere il calcolo] e [Riprendere il calcolo][Riprendere il calcolo].
...
Per vedere molti riepiloghi delle considerazioni più importanti nello sviluppo di un carico di lavoro, vedere [Procedure consigliate per SQL Data Warehouse][Procedure consigliate per SQL Data Warehouse].
