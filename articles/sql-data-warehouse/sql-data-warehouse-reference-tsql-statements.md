...
Per altre informazioni di riferimento su TSQL, vedere [Elementi del linguaggio T-SQL di SQL Data Warehouse](sql-data-warehouse-reference-tsql-language-elements.md).
