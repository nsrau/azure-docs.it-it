...
* [Crea funzione di classificazione del carico di lavoro](/sql/t-sql/statements/create-workload-classifier-transact-sql) (anteprima)
...
* [CLASSIFICAZIONE del carico di lavoro di rilascio](/sql/t-sql/statements/drop-workload-classifier-transact-sql) (anteprima)
