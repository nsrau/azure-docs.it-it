...
### <a name="memory-allocations-per-distribution-mb"></a>Allocazioni di memoria per ogni distribuzione (MB)
...
## <a name="change-a-user-resource-class-example"></a>Esempio di modifica della classe di risorse di un utente
