...
>[AZURE.NOTE] Vedere [Progettazione di tabelle][] o la [sintassi di CREATE TABLE][] per altre informazioni sulla creazione di una tabella in SQL Data Warehouse e sulle opzioni disponibili con la clausola WITH.
