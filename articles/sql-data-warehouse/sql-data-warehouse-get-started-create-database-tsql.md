...
- **Ambiente per l'esecuzione di T-SQL**: è possibile usare [Visual Studio][Installing Visual Studio and SSDT], [sqlcmd][] o [SSMS][] per eseguire T-SQL.
