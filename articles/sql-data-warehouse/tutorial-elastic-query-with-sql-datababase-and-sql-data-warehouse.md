...
4. Inviare la query seguente per creare una definizione di tabella esterna che punta al **OrderInformation** tabella nell'istanza del data warehouse.
