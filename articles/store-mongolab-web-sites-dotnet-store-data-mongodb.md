...
1. Selezionare **Calcolo > App Web > Creazione rapida**. <!-- ![CreateWebApp][screen-mongolab-newwebsite] -->
...
1. In Visual Studio fare clic con il pulsante destro del mouse sul progetto **mongoNotes** in Esplora soluzioni, quindi selezionare **Pubblica**. Viene visualizzata la finestra di dialogo Pubblica: <!-- ![Publish][dialog-mongolab-vspublish] -->
