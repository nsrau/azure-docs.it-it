...
In caso di problemi con il dominio gestito, verificare se è possibile risolvere il problema seguendo la procedura descritta nella [Guida alla risoluzione dei problemi](troubleshoot.md) . Se non è possibile risolvere il problema in questo modo, contattare Microsoft.

È possibile inviare un'e-mail all'indirizzo: [Feedback di Azure AD Domain Services](mailto:aaddsfb@microsoft.com).
