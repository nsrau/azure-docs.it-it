---
title: Creare una. File PFX con il certificato LDAP (LDAPS) sicuro per un dominio di Azure AD Domain Services
...
Completare l'[Attività 1: Ottenere un certificato per l'accesso LDAP sicuro](configure-ldaps.md).
