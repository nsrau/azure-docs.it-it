...
| --- | --- |
| **Account utente sincronizzati da una directory locale** |**&#x2713;** [Seguire le istruzioni in questo articolo](active-directory-ds-getting-started-password-sync-synced-tenant.md#install-or-update-azure-ad-connect) |
| **Account utente cloud creati in Azure AD** |**&#x2713;** [Sincronizzare le password per gli account utente solo cloud con il dominio gestito](tutorial-create-instance.md#enable-user-accounts-for-azure-ad-ds) |
...
Le istruzioni per l'installazione di Azure AD Connect sono disponibili nell'articolo [Introduzione ad Azure AD Connect](../active-directory/hybrid/whatis-hybrid-identity.md)
...
> [!NOTE]
> La **sincronizzazione dell'hash delle password** è un processo diverso rispetto alla sincronizzazione di utenti/oggetti. È necessario disabilitare o abilitare la sincronizzazione dell'hash delle password per ottenere la sincronizzazione completa delle password. gli aggiornamenti dell'hash delle password batch vengono visualizzati nel registro eventi dell'applicazione.

* [Abilitare la sincronizzazione password in Servizi di dominio Azure AD per una directory di Azure AD solo cloud](tutorial-create-instance.md#enable-user-accounts-for-azure-ad-ds)
