...
Sì. Azure AD Domain Services può essere abilitato in una rete virtuale di Azure Resource Manager. Reti virtuali di Azure classiche non sono più supportate per la creazione di nuovi domini gestiti.
