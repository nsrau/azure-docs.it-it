...
*Un'entità servizio necessaria per il corretto funzionamento di Azure AD Domain Services è stata eliminata dalla directory Azure AD. Questa configurazione influisca sulla capacità di Microsoft di monitorare, gestire, applicare patch e sincronizzare il dominio gestito.*
...
Se nell'Azure AD directory manca l'ID applicazione *443155a6-77f3-45e3-882b-22b3a8d431fb*, *abba844e-BC0E-44b0-947A-dc74e5d09022*o *d87dcbc6-A371-462E-88e3-28ad15ec4e64* , completare i passaggi seguenti per registrare nuovamente il provider di risorse *Microsoft. AAD* :
