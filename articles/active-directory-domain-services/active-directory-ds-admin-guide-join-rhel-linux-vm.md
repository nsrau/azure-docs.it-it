---
title: 'Anteprima di Servizi di dominio Active Directory di Azure: Guida all''amministrazione | Microsoft Docs'
...
3. **Installare kerberos**: nel terminale PuTTY digitare il comando seguente.
