...
1. A questo punto `Migrate-Aadds` , eseguire il cmdlet con il parametro *-Prepare* . Fornire *-ManagedDomainFqdn* per il dominio gestito di Azure AD DS, ad esempio *aaddscontoso.com*:
...
Eseguire il `Migrate-Aadds` cmdlet con il parametro *-commit* . Specificare *-ManagedDomainFqdn* per il dominio gestito Azure AD DS preparato nella sezione precedente, ad esempio *aaddscontoso.com*:
...
Eseguire il `Migrate-Aadds` cmdlet con il parametro *-Abort* . Specificare *-ManagedDomainFqdn* per il dominio gestito di Azure AD DS preparato in una sezione precedente, ad esempio *aaddscontoso.com*, e il nome della rete virtuale classica, ad esempio *myClassicVnet*:
