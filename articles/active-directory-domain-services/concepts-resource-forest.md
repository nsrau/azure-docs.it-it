...
Per rispondere a queste esigenze e restrizioni, è possibile creare un dominio gestito Azure AD DS che usa una foresta di risorse. Questo articolo concettuale illustra le foreste e il modo in cui considera attendibili le altre risorse per fornire un metodo di autenticazione protetto. Le foreste di risorse Azure AD Domain Services sono attualmente disponibili in anteprima.
