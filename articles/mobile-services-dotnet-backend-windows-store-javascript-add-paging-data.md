<properties 
	...
	description="Informazioni su come usare il paging per gestire la quantità di dati.ata returned to your Windows Store JavaScript app from Mobile Services." 
