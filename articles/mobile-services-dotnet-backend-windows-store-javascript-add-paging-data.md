<properties pageTitle="Aggiungere paging ai dati (JavaScript) - Servizi mobili di Azure" description="Informazioni su come usare il paging per gestire la quantità di dati.ata returned to your Windows Store JavaScript app from Mobile Services." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
