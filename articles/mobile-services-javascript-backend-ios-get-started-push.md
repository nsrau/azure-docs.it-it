...
5. [Aggiungere notifiche push all'app]
6. [Aggiornare gli script per l'invio di notifiche push]
7. [Inserire dati per la ricezione di notifiche]
...
* [Riferimento per i concetti e le procedure di Servizi mobili con Objective-C]
  <br/>Informazioni su come usare Servizi mobili con Objective-C e iOS.
