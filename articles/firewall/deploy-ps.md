---
title: Distribuire e configurare Firewall di Azure tramite Azure PowerShellDeploy and configure Azure Firewall using Azure PowerShell
...
---
# <a name="deploy-and-configure-azure-firewall-using-azure-powershell"></a>Distribuire e configurare Firewall di Azure tramite Azure PowerShellDeploy and configure Azure Firewall using Azure PowerShell
...
Questa rete virtuale ha tre subnet:This virtual network has three subnets:
...
```
A questo punto, creare la rete virtuale:Now, create the virtual network:
...
A scopo di test in questa procedura, configurare gli indirizzi DNS primari o secondari del server. Questo non è un requisito generale di Firewall di Azure.
