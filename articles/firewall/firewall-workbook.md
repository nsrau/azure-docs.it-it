...
:::image type="content" source="./media/firewall-workbook/firewall-workbook-application-rule.png" alt-text="Panoramica di cartella di lavoro del firewall di Azure":::
...
:::image type="content" source="./media/firewall-workbook/firewall-workbook-network-rule.png" alt-text="Panoramica di cartella di lavoro del firewall di Azure":::

È anche possibile filtrare i log in base all'intervallo di tempo:

:::image type="content" source="./media/firewall-workbook/firewall-workbook-network-rule-time.png" alt-text="Panoramica di cartella di lavoro del firewall di Azure":::
...
:::image type="content" source="./media/firewall-workbook/firewall-workbook-investigation.png" alt-text="Panoramica di cartella di lavoro del firewall di Azure":::
