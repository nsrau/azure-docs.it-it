...
Per informazioni sulle modalità di reindirizzamento e proxy di SQL, vedere [Architettura della connettività del database SQL di Azure](../sql-database/sql-database-connectivity-architecture.md).