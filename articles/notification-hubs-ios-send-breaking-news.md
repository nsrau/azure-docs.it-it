...
Questo argomento si basa sull'app creata nell'esercitazione [Introduzione ad Hub di notifica](/en-us/manage/services/notification-hubs/get-started-notification-hubs-ios/). Prima di iniziare questa esercitazione, è necessario completare le procedure illustrate in [Introduzione ad Hub di notifica](/en-us/manage/services/notification-hubs/get-started-notification-hubs-ios/).
...
11. Aggiungere il metodo seguente in BreakingNewsAppDelegate.m:
    ...
    Questo metodo gestisce le notifiche ricevute quando l'app viene eseguita visualizzando un semplice  **UIAlert**.
