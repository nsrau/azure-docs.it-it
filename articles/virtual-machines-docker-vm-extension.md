<properties 
	pageTitle="Come usare l'estensione della macchina virtuale Docker per Linux in Azure" 
...
| :------------- |-------------| ----------- |
| Isolamento del processo | Più o meno completo | Se si ottiene la radice, l'host del contenitore potrebbe risultare compromesso |
| Memoria su disco necessaria | Sistema operativo completo e app | Solo requisiti delle app |
