...
1.	Questi quattro passaggi nella pagina della procedura dettagliata devono essere completati e di colore verde.
...
3. Nella pagina di seguito, fare clic sull'opzione **Richiedi approvazione per push in produzione**. Una volta effettuata la richiesta, il team di approvazione esegue una verifica finale e quindi l'offerta sarà resa pubblicamente disponibile in Azure Marketplace. Lo stato dell'offerta verrà modificato in **Elencata**.
