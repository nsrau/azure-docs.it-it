<properties
   pageTitle="Come risolvere i problemi di supporto comuni degli editori | Microsoft Azure"
...
In questo articolo viene spiegato come risolvere o ottenere supporto per alcuni scenari comuni relativi al Marketplace, come indicato di seguito:

## Crediti e rimborsi

In alcuni casi, potrebbe essere necessario richiedere un credito o un rimborso per conto di un cliente. Il supporto Microsoft può assicurare che le richieste di credito e/o di rimborso del cliente vengano prese in considerazione e che venga fornita una risposta a tempo debito*.
...
* [AZURE.NOTE]Se un cliente o un rivenditore di Azure contatta Microsoft per richiedere un rimborso o un credito, Microsoft applicherà le stesse politiche usate per la fornitura dei servizi di Azure. Se tali politiche stabiliscono che è dovuto un rimborso o un credito, Microsoft emetterà in modo proattivo, e l'utente autorizza Microsoft all'emissione per suo conto, un rimborso o un credito per il cliente o il rivenditore di Azure, come applicabile. Se le politiche non stabiliscono che è dovuto un rimborso o un credito, Microsoft potrà invitare il cliente o il rivenditore di Azure a contattare direttamente l'utente.
  ...
  2. Selezionare **Gestione clienti**
  3. Selezionare **Approvare o richiedere un rimborso per un cliente**
  4. Fare clic su **Avvia richiesta**

  ![2\_RequestRefund][2]

5. Fornire informazioni di contatto
6. Completare la sezione "Qual è il problema?" e immettere le informazioni seguenti:
...
- Si potrebbe non sapere come verificare che il cliente è idoneo per tale offerta
...
Se si desidera aggiornare il proprio profilo di pubblicazione, è possibile eseguire questa operazione tramite il dashboard venditori

**1. Accedere al dashboard venditori**
...
- Passare a http://sellerdashboard.microsoft.com.

![inprivate][4]

**2. Accedere con l'account Microsoft di registrazione dell'azienda** (ad esempio, AzureStore@yourcompany.com)
...
Per i seguenti problemi, registrare un problema all'indirizzo https://portal.azure.com
...
Per i seguenti problemi, creare una richiesta di supporto all'indirizzo http://go.microsoft.com/fwlink/?LinkId=272975
