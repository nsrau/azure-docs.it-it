...
- Se si compila un'applicazione aziendale e l'azienda USA Azure AD come sistema di identità, è possibile usare l'autenticazione Azure AD basata sull'utente nell'app e concedere l'accesso agli account di ancoraggio spaziali usando i gruppi di sicurezza Azure AD esistenti o direttamente agli utenti dell'organizzazione.
...
> [!div class="nextstepaction"]
> [Novell (Android)](../quickstarts/get-started-xamarin-android.md)

> [!div class="nextstepaction"]
> [Novell (iOS)](../quickstarts/get-started-xamarin-ios.md)
