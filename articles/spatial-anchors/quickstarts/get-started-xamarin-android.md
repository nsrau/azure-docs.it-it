...
![Screenshot che mostra il menu per selezionare il progetto e il dispositivo in Windows.](./media/get-started-xamarin-android/visual-studio-windows-configuration.png)
