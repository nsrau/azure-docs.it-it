---
title: Guida di riferimento all'API di ricerca aziendale locale di Bing v7
titleSuffix: Azure Cognitive Services
description: In questo articolo vengono forniti dettagli tecnici sugli oggetti risposta e sui parametri di query e le intestazioni che influiscono sui risultati della ricerca.
...
L'API Local Business Search invia una query di ricerca a Bing per ottenere risultati che includono ristoranti, hotel o altre attività commerciali locali. Per le località, la query può specificare il nome dell'attività commerciale locale o una categoria, ad esempio ristoranti nelle vicinanze. I risultati relativi all'entità includono persone, località o cose. Inserisci in questo contesto le entità aziendali, gli stati, i paesi e così via.  
...
|----------|-----------|----------|--------------|
|<a name="count" />count|Numero di risultati da restituire, a partire `offset` dall'indice specificato dal parametro .|string|No|   
...
|Oggetto|Descrizione|  
|------------|-----------------|  
|[Posto](#place)|Definisce le informazioni su un'attività commerciale locale, ad esempio un ristorante o un hotel.|  
