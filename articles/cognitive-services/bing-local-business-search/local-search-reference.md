...
La richiesta può includere i parametri di query seguenti. Vedere i parametri obbligatori nella colonna corrispondente. È necessario eseguire la codifica URL dei parametri di query.  
...
|Nome|Valore|digitare|  
|----------|-----------|----------|  
|Nome|Il nome della licenza.|String|  
...
|Elemento|DESCRIZIONE|digitare|  
|-------------|-----------------|----------|  
|adultIntent|Valore booleano che indica se la query specificata ha finalità per adulti. Il valore è **true** se la query ha finalità per adulti; in caso contrario, è **false** .|Booleano|  
