---
title: Avvio rapido di C# per Servizi cognitivi di Azure, API Ricerca entità Bing | Microsoft Docs
...
ms.locfileid: "35377388"
---
# <a name="quickstart-for-microsoft-bing-entity-search-api-with-c"></a>Avvio rapido per l'API Ricerca entità Microsoft Bing con C# 
<a name="HOLTop"></a>
...
Per eseguire questo codice in Windows è necessario [Visual Studio 2017](https://www.visualstudio.com/downloads/). (La Community Edition funzionerà.)
