...
ms.date: 10/04/2017
ms.author: v-jerkin
ms.openlocfilehash: 68c6b5ca974e8ffca30113a928c26d987900ea84
...
Qui è riportato il codice sorgente completo descritto nell'[esercitazione sull'app a pagina singola](tutorial-bing-image-search-single-page-app.md) per l'API Ricerca immagini Bing. Per eseguire l'app, copiare il codice sorgente nel Blocco note o un altro editor di testo e salvarlo come `bing.html`. Quindi aprire il file salvato in Microsoft Edge o un altro browser comune.
