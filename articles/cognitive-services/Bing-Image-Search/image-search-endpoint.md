---
title: Endpoint di Ricerca immagini | Microsoft Docs
description: Riepilogo degli endpoint dell'API Ricerca immagini.
...
ms.locfileid: "35372761"
---
# <a name="image-search-endpoints"></a>Endpoint di Ricerca immagini
...
Per ottenere risultati immagini tramite l'API Bing, inviare una richiesta a uno degli endpoint seguenti. Usare le intestazioni e i parametri URL per definire ulteriori specifiche.
