---
title: Panoramica dell'API Analisi del testo - Servizi cognitivi di Azure | Microsoft Docs
description: API Analisi del testo nei Servizi cognitivi di Azure per l'analisi del sentiment, l'estrazione di frasi chiave e il rilevamento della lingua.
...
ms.locfileid: "35377817"
---
# <a name="what-is-text-analytics-api-version-20"></a>Informazioni sull'API Analisi del testo versione 2.0
...
|[**Entity Linking (anteprima)**](how-tos/text-analytics-how-to-entity-linking.md) | Identifica le entità note nel testo e collega ad altre informazioni sul Web. Entity Linking riconosce quando un termine viene usato come uno dei verbi, delle entità e delle altre forme distinguibili separatamente e crea una distinzione. | [REST](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/5ac4251d5b4ccd1554da7634) | 
