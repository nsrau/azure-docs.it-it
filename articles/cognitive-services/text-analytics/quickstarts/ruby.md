...
4. Sostituire il percorso in `uri` (attualmente `westus`) nell'area dell'iscrizione.
...
**Risposta Analisi del sentiment**
...
**Risposta estrazione frasi chiave**
...
**Risposta collegamento delle entità**
