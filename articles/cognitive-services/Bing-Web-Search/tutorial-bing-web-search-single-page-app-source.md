---
title: Ricerca Web Bing in un'app Web a pagina singola (codice sorgente)| Microsoft Docs
description: Codice sorgente per un'esercitazione che illustra come usare l'API Ricerca Web Bing in un'applicazione Web a pagina singola.
...
ms.locfileid: "35373137"
---
# <a name="tutorial-single-page-web-app"></a>Esercitazione: app Web a pagina singola

Qui è riportato il codice sorgente completo descritto nell'[esercitazione sull'app a pagina singola](tutorial-bing-web-search-single-page-app.md) per l'API Ricerca Web Bing. Per eseguire l'app, copiare il codice sorgente nel Blocco note o un altro editor di testo e salvarlo come `bing.html`. Quindi aprire il file salvato in Microsoft Edge o un altro browser comune.
