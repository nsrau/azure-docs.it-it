---
title: Contenuti in primo piano generati dagli utenti per l'API Rilevamento anomalie
titleSuffix: Azure Cognitive Services
description: Leggere questo articolo per scoprire contenuti in primo piano e conoscere cosa pensano gli altri utenti dell'API Rilevamento anomalie e come la usano.
...
Leggere questo articolo per scoprire cosa pensano altri clienti dell'API Rilevamento anomalie e come la usano. Le risorse seguenti sono state create dalla community di utenti di Rilevamento anomalie. Queste includono blog tecnici, progetti open source e altri contributi creati da Microsoft e utenti di terze parti. Alcuni dei collegamenti seguenti sono ospitati in siti Web esterni a Microsoft. L'azienda non è responsabile del contenuto in tali siti. Prestare attenzione quando si fa riferimento a queste risorse.

## <a name="demos"></a>Demo

* [Demo interattiva con animazione](https://aka.ms/adDemo)
* [Demo di Azure notebook](https://aka.ms/adNotebook)
...
* [Prova del Servizio cognitivo: API Rilevamento anomalie (in giapponese)](https://azure-recipe.kc-cloud.jp/2019/04/cognitive-service-anomaly-detector-api/)

## <a name="open-source-projects"></a>Progetti open source

* [Esempi ufficiali di codice per l'API e l'SDK Rilevamento anomalie](https://github.com/Azure-Samples/AnomalyDetector)
