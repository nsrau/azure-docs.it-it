...
|[Servizio visione artificiale personalizzato](https://docs.microsoft.com/azure/cognitive-services/Custom-Vision-Service/home "servizio visione artificiale personalizzato")|Il Servizio visione artificiale personalizzato consente di creare classificatori di immagini personalizzati.|
...
|[Formare riconoscimento](https://docs.microsoft.com/azure/cognitive-services/form-recognizer/ "formano riconoscimento") (anteprima)|Riconoscimento modulo identifica ed estrae coppie chiave-valore e i dati della tabella da documenti di formato. quindi restituisce i dati strutturati tra cui le relazioni nel file originale.|
|[Input penna per il riconoscimento](https://docs.microsoft.com/azure/cognitive-services/ink-recognizer/ "dell'input penna per il riconoscimento") (anteprima)|Input penna per il riconoscimento consente di riconoscere e analizzare i dati di traccia di input penna, le forme e contenuto scritto a mano e restituire una struttura del documento con tutte le entità riconosciute.|
...
|Nome servizio|Descrizione del servizio|
|:-----------|:------------------|
|[Servizi di riconoscimento vocale](https://docs.microsoft.com/azure/cognitive-services/speech-service/ "servizi di riconoscimento vocale")|Il Servizio di riconoscimento vocale aggiunge funzionalità abilitate al riconoscimento vocale alle applicazioni.|
...
|[Riconoscimento vocale Bing](https://docs.microsoft.com/azure/cognitive-services/speech/home "riconoscimento vocale Bing") (fase di ritiro)|L'API Riconoscimento vocale Bing offre un modo semplice per creare funzionalità abilitate al riconoscimento vocale nelle applicazioni.|
|[Traduzione vocale Microsoft Translator](https://docs.microsoft.com/azure/cognitive-services/translator-speech/ "traduzione vocale Microsoft Translator") (fase di ritiro)|Traduzione vocale è un servizio di traduzione automatica.|
...
|[Ricerca di attività commerciali locali Bing](https://docs.microsoft.com/azure/cognitive-services/bing-local-business-search/ "ricerca Bing aziendale locale")| API di ricerca Bing locale Business consente alle applicazioni di trovare informazioni di contatto e la posizione di attività commerciali locali basate su query di ricerca.|
...
## <a name="decision-apis"></a>API delle decisioni

|Nome servizio|Descrizione del servizio|
|:-----------|:------------------|
|[Rilevatore di anomalie](https://docs.microsoft.com/azure/cognitive-services/anomaly-detector/ "rilevatore di anomalie") (anteprima)|Rilevatore di anomalie consente di monitorare e rilevare le anomalie nei dati delle serie temporali.|
...
|[Personalizer](https://docs.microsoft.com/azure/cognitive-services/personalizer/ "Personalizer") (anteprima)|Personalizer consente di scegliere la migliore esperienza per mostrare agli utenti, come imparare dal proprio comportamento in tempo reale.|
...
## <a name="certifications-and-compliance"></a>Le certificazioni e conformità

Servizi cognitivi ha ottenuto le certificazioni come certificazione STAR CSA, fedramp di livello moderato e HIPAA BAA.

È possibile [scaricare](https://gallery.technet.microsoft.com/Overview-of-Azure-c1be3942) le certificazioni per i controlli e le verifiche di sicurezza personalizzati.

Per informazioni sulla privacy e la gestione dei dati, vedere la [Centro protezione](https://servicetrust.microsoft.com/).
