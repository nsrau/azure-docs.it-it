---
title: Identificare visi nelle immagini con l'API Viso | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Usare l'API Viso in Servizi cognitivi per identificare i visi nelle immagini.
...
ms.locfileid: "35378081"
---
# <a name="how-to-identify-faces-in-images"></a>Come identificare visi nelle immagini
...
## <a name="step2"></a> Passaggio 2: Creare il PersonGroup
...
### <a name="step2-1"></a> 2.1 Definire le persone per il PersonGroup
...
## <a name="step3"></a> Passaggio 3: Eseguire il training di PersonGroup
...
## <a name="step4"></a> Passaggio 4: Identificare un viso in base a un PersonGroup definito
...
## <a name="step5"></a> Passaggio 5: Richiesta su larga scala
