...
Aggiungere il metodo seguente alla classe **Program**. Formatta l'input JSON in modo da renderlo più facilmente leggibile. L'app scriverà i dati stringa nella console.
