---
title: Flusso di lavoro del Servizio decisionale personalizzato
titlesuffix: Azure Cognitive Services
description: Questo articolo fornisce il flusso di lavoro consigliato per il Servizio decisionale personalizzato di Azure.
...
Aggiungere una [stringa di connessione di Archiviazione di Azure](https://docs.microsoft.com/azure/storage/common/storage-configure-connection-string).
