---
title: 'Guida introduttiva: API Recommendations di Machine Learning | Microsoft Docs'
...
> [!NOTE]
> Per usare le metriche offline è necessario avere il timestamp nei dati di utilizzo. I dati temporali sono infatti necessari per suddividere correttamente l'utilizzo tra i set di dati di training e quello di test.
> 
