...
> [!IMPORTANT]
> Questo argomento di avvio rapido usa l'API Riconoscimento modulo v1.0. Se la sottoscrizione si trova nell'area `West US 2` o `West Europe`, è invece necessario seguire l'[argomento di avvio rapido sull'API v2.0](./python-train-extract.md).
...
> [Documentazione di riferimento delle API REST](https://westus2.dev.cognitive.microsoft.com/docs/services/form-recognizer-api/operations/AnalyzeWithCustomModel)