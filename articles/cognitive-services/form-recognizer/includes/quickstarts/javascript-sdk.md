...
Questa funzione si avvale di una funzione helper `optionalToString`. Definire questa funzione alla radice dello script:
...
Si userà il metodo **beginRecognizeFormsFromUrl**. Il valore restituito è una raccolta di oggetti **RecognizedForm**, uno per ogni pagina del documento inviato.
