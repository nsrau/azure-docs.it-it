...
2. Fare clic su Undo Step (Annulla passaggio).
    - L'ultima voce viene rimossa, e si ritorna a 'Would you like anything else?'  (screenshot di seguito)
...
3. Fare clic su Branch (Dirama).
    - "no" viene rimosso e l'intero dialogo fino a quel punto viene copiato in un nuovo dialogo. 
