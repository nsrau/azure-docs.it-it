...
Nella classe **Program** modificare le variabili relative a chiave e endpoint verso l'inizio del file di codice sostituendole con la chiave e l'endpoint di Azure della risorsa. 
