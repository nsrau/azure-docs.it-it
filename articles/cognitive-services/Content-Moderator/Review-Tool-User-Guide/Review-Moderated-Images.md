...
In questa guida si è appreso come configurare e usare le revisioni dallo [strumento content moderator Review](https://contentmoderator.cognitive.microsoft.com). Vedere quindi la [Guida dell'API REST](../try-review-api-review.md) o la [Guida di .NET SDK](../moderation-reviews-quickstart-dotnet.md) per informazioni su come creare recensioni a livello di codice.