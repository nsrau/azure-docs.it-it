...
L'algoritmo per la generazione delle anteprime funziona nel modo seguente:
...
3. Modifica le proporzioni in base alle dimensioni dell'anteprima di destinazione.
