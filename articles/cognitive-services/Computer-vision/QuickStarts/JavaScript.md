...
ms.openlocfilehash: 800b081bdd77c7193e4a6eaa0e16e590ffb81d99
ms.contentlocale: it-it
ms.lasthandoff: 06/20/2017

---

# <a name="computer-vision-javascript-quick-starts"></a>Computer Vision JavaScript Quick Starts
...
### <a name="analyze-an-image-javascript-example-request"></a>Analyze an image JavaScript example request
...
### <a name="landmark-javascript-example-request"></a>Landmark JavaScript example request
...
### <a name="get-a-thumbnail-javascript-example-request"></a>Get a thumbnail JavaScript example request
...
### <a name="ocr-javascript-example-request"></a>OCR JavaScript example request
...
### <a name="handwriting-recognition-java-example"></a>Handwriting recognition Java example
...
### <a name="handwriting-example-response"></a>Handwriting example response
