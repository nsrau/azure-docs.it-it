---
title: API Visione artificiale - Guida introduttiva all'analisi di un'immagine locale con C# | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: In questa guida introduttiva si analizza un'immagine locale usando Visione artificiale con C# in Servizi cognitivi.
...
ms.locfileid: "43771974"
---
# <a name="quickstart-analyze-a-local-image---rest-c35"></a>Guida introduttiva: Analizzare un'immagine locale - REST, C&#35;

In questa guida introduttiva si analizza un'immagine locale per estrarre le caratteristiche visive usando Visione artificiale.
...
> [Usare Visione artificiale con C#](../Tutorials/CSharpTutorial.md)
