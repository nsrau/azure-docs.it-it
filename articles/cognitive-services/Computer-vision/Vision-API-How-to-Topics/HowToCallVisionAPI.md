...
1. Quando si usa la libreria client, la chiave di sottoscrizione viene passata tramite il costruttore di ComputerVisionClient e l'area viene specificata in una proprietà del client:
