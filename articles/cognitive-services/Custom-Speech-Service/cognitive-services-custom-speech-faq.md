...
**Domanda:** In caso di errore, come è possibile annullare l'importazione dei dati o la creazione del modello in corso? 
...
**Domanda:** È possibile aggiornare un modello esistente (stacking di modelli)?
...
**Domanda:** È possibile comprimere i file di testo per caricare file di dimensioni maggiori? 

**Risposta:** No, attualmente sono ammessi solo file di testo non compressi.
...
**Domanda:** Che cos'è la percentuale di parole errate e come viene calcolata?

**Risposta:** La percentuale di parole errate è la metrica di valutazione per il riconoscimento vocale. Viene calcolata come numero totale di errori, inclusi inserimenti, eliminazioni e sostituzioni, diviso per il numero totale di parole nella trascrizione di riferimento.
...
**Domanda:** Come è possibile rilevare la percentuale di parole errate nei modelli di base per verificare se c'è stato un miglioramento? 
...
**Risposta:** Il caricamento di un elenco di parole consente di inserire le parole nel vocabolario, ma non di istruire il sistema sull'uso delle parole stesse.
