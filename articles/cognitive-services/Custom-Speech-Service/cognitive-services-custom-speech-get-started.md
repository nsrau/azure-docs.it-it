...
ms.openlocfilehash: cb9e71d41ecbaa1c52371b2f136a031e64cd1595
...
## <a name="creating-a-custom-acoustic-model"></a>Creating a custom acoustic model
...
## <a name="creating-a-custom-speech-to-text-endpoint"></a>Creating a custom speech-to-text endpoint
...
## <a name="using-a-custom-speech-endpoint"></a>Using a custom speech endpoint
