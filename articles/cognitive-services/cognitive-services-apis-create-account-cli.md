...
Per accedere all'installazione locale dell'interfaccia Command-Line (CLI), usare il comando [AZ login](https://docs.microsoft.com/cli/azure/reference-index?view=azure-cli-latest#az-login) .
