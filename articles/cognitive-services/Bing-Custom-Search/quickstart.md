...
ms.openlocfilehash: fedfa53d8de71753f6d621cb14ce6adaf271dbe7
...
# <a name="build-a-custom-search-and-retrieve-custom-search-results"></a>Build a custom search and retrieve custom search results
...
## <a name="create-a-custom-search-instance"></a>Create a custom search instance 
...
## <a name="define-the-slices-of-the-web-to-search-over"></a>Define the slices of the web to search over
...
### <a name="add-first-slice"></a>Add first slice
...
### <a name="extend-the-slices-to-search-over"></a>Extend the slices to search over
...
### <a name="using-standard-bing-search"></a>Using standard Bing search
...
### <a name="using-site-suggestions"></a>Using Site Suggestions
...
## <a name="adjust-the-ranking"></a>Adjust the ranking
...
### <a name="creating-pins"></a>Creating pins
...
### <a name="using-pins"></a>Using pins
...
## <a name="track-custom-search-settings"></a>Track custom search settings
...
### <a name="understanding-quota"></a>Understanding quota
...
## <a name="use-published-search-settings"></a>Use published search settings
...
## <a name="programmatically-retrieve-custom-search-results"></a>Programmatically retrieve custom search results
