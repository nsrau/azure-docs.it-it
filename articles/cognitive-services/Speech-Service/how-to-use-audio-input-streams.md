...
L'API Flusso di **input audio** di Speech SDK consente di trasmettere l'audio nei sistemi di riconoscimento anziché usare il microfono o le API del file di input.
