...
Per passare direttamente al codice di esempio, vedere gli esempi di [avvio rapido in C#](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/csharp/dotnet/translate-speech-to-text) su GitHub.
