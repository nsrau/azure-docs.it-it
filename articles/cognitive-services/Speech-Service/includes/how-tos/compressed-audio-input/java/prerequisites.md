...
Di seguito viene fornito un esempio di `Android.mk` e `Application.mk` file. Per creare il `gstreamer` oggetto condiviso, attenersi alla procedura seguente:`libgstreamer_android.so`.
