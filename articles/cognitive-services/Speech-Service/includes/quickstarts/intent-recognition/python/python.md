...
ms.locfileid: "75660509"
---
## <a name="prerequisites"></a>Prerequisites

Prima di iniziare:

* Se si tratta del primo progetto Python, usare questa guida per <a href="../quickstarts/create-project.md" target="_blank">creare un progetto di esempio vuoto</a>.
* <a href="../quickstarts/setup-platform.md" target="_blank">Installare Speech SDK per l'ambiente di sviluppo</a>.
