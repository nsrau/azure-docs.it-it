...
A questo punto, è necessario creare un oggetto `AudioConfig` che punti a input devic3. Inserire questo codice nel metodo `startIntentRecognizeAsyncButton.addEventListener()`, immediatamente sotto la configurazione di Voce.
