...
ms.locfileid: "75660508"
---
## <a name="prerequisites"></a>Prerequisites

Prima di iniziare:

* Se si tratta del primo progetto C#, usare questa guida per <a href="../quickstarts/create-project.md?tabs=dotnet" target="_blank">creare un progetto di esempio vuoto</a>.
* <a href="../quickstarts/setup-platform.md?tabs=dotnet" target="_blank">Installare Speech SDK per l'ambiente di sviluppo</a>.
