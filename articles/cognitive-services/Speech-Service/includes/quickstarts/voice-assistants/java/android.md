---
title: 'Avvio rapido: Creare un assistente vocale personalizzato, Java (Android) - Servizio Voce'
...
> * [Configurare l'ambiente di sviluppo e creare un progetto vuoto](~/articles/cognitive-services/speech-service/quickstarts/setup-platform.md?tabs=android&pivots=programming-language-java)
...
![Screenshot del modo in cui deve essere configurata l'interfaccia utente di interazione con il bot.](~/articles/cognitive-services/speech-service/media/sdk/qs-java-android-assistant-designer-ui.png)
