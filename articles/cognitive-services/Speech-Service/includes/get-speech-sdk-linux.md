...
ms.locfileid: "80656678"
---
:::row:::
    :::column span="3":::
        Speech SDK supporta solo **Ubuntu 16.04/18.04**, **Debian 9,** **Red Hat Enterprise Linux (RHEL) 8**e **CentOS 7/8** sulle seguenti architetture di destinazione quando vengono utilizzate con Linux:
        - x86
        - x64
        - ARM32
        - ARM64
