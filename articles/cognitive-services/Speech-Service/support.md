---
title: Opzioni di supporto e assistenza - Servizio di riconoscimento vocale
...
> [!div class="checklist"]
> * Rimani informato sui nuovi sviluppi in *Servizi cognitivi*di Azure o trova le ultime notizie relative al *servizio di riconoscimento vocale.*
...
Le novità su Servizi cognitivi sono raccolte nel[blog sui Servizi cognitivi](https://azure.microsoft.com/blog/topics/cognitive-services/). Per informazioni aggiornate sul servizio di riconoscimento vocale, tenere traccia del blog del [servizio di riconoscimento vocale.](https://azure.microsoft.com/blog/tag/speech-service/)

## <a name="release-notes"></a>Note sulla versione

Le [note sulla versione](https://aka.ms/csspeech/whatsnew) vengono aggiornate non appena è disponibile una nuova versione. Le note contengono informazioni sulle nuove funzionalità, miglioramenti e correzioni di bug.
...
È possibile creare una segnalazione di bug, una richiesta di funzionalità o porre una domanda generale e condividere le procedure consigliate. Per i report sui bug seguire il modello fornito:
...
**Altre informazioni di contesto**
 ...
 - Se si segnala un errore per un'interazione del servizio specifica, segnalare il SessionId e l'ora (incl. fuso orario) degli eventi imprevisti segnalati. Il valore di SessionId è indicato in tutti i callback e gli eventi ricevuti.
...
Se non è possibile trovare una risposta al problema tramite la ricerca, inviare una nuova domanda a Stack Overflow utilizzando tag [ \[microsoft-cognitive\]\[speech\]](https://stackoverflow.com/questions/tagged/microsoft-cognitive+speech).
...
> * [Come creare un esempio minimo, completo e verificabileHow to create a Minimal, Complete, and Verifiable example](https://stackoverflow.com/help/mcve)
...
[UserVoice (Voce utente)](https://cognitive.uservoice.com/)
