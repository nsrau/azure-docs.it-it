...
1. Nella finestra di dialogo **Opzioni progetto**:
    ...
    ![Impostazioni del progetto](media/sdk/qs-objectivec-project-settings.png)
...
1. Selezionare la directory di progetto:
   ...
   1. Modificare i percorsi nell'SDK nella schermata di impostazioni del progetto.
      ...
      ![Impostazione dei percorsi di ricerca framework](media/sdk/qs-objectivec-framework-search-paths.png)
