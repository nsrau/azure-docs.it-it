...
Sono disponibili guide di avvio rapido anche per il [riconoscimento vocale](quickstart-objectivec-ios.md).
...
1. Sostituire il contenuto del file `AppDelegate.m` generato automaticamente con: [!code-objectivec[Quickstart Code](~/samples-cognitive-services-speech-sdk/quickstart/text-to-speech/objectivec-ios/helloworld/helloworld/AppDelegate.m#code)]
...
1. Compilare ed eseguire l'esempio di codice nel simulatore iOS selezionando **Prodotto** > **Esegui** dal menu o facendo clic sul pulsante **Riproduci**.
   ...
   ![App iOS simulata](media/sdk/qs-objectivec-simulated-app-tts.png)
