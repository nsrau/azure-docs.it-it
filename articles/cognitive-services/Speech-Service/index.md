...
ms.locfileid: "74840800"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Documentazione del servizio Voce</h1>
        <ul class="pivots">
            <li>
                <a href="#start">Introduzione</a>
                <ul id="start">
                    <li>
                        <a href="#speechtotext">Riconoscimento vocale</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Riconoscimento vocale con un microfono</h3>
                                                    <p>Usare Speech SDK per riconoscere la voce generata da un microfono e trascrivere l'output.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Riconoscimento vocale da un file audio</h3>
                                                    <p>Usare Speech SDK per riconoscere la voce generata da un singolo file e trascrivere l'output.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Riconoscimento asincrono da BLOB</h3>
                                                    <p>Usare il servizio REST per riconoscere in modo asincrono la voce dai file archiviati in archiviazione BLOB di Azure.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prezzi</h3>
                                                    <p>Altre informazioni sui costi associati al riconoscimento vocale.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Informazioni su come aggiungere il riconoscimento vocale ad app, strumenti e prodotti. Sono inclusi concetti, esercitazioni, informazioni di riferimento sulle API e note sulla versione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <li>
                            <a href="#texttospeech">Sintesi vocale</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sintetizzare la voce in un altoparlante</h3>
                                                    <p>Usare Speech SDK per sintetizzare la voce in un output audio, come un altoparlante.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sintetizzare la voce in un file audio</h3>
                                                    <p>Usare Speech SDK per sintetizzare la voce in un file audio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Usare il linguaggio di markup di sintesi vocale per ottimizzare il tono, la prosodia e la velocità del parlato dell'output audio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prezzi</h3>
                                                    <p>Altre informazioni sui costi associati alla sintesi vocale.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Leggere la documentazione</h3>
                                                    <p>Informazioni su come aggiungere la sintesi vocale ad app, strumenti e prodotti. Sono inclusi concetti, esercitazioni, informazioni di riferimento sulle API e note sulla versione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#intentrecognition">Riconoscimento delle finalità</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Riconoscere la voce, le finalità e le entità</h3>
                                                    <p>Usare Speech SDK e Language Understanding (LUIS) per riconoscere la voce, le finalità e le entità.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Documentazione di Language Understanding (LUIS)</h3>
                                                    <p>Altre informazioni su LUIS (Language Understanding Service) e PNL (Natural Language Processing).</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Portale di Language Understanding (LUIS)</h3>
                                                    <p>Inserire il linguaggio naturale in app, bot e dispositivi IoT.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#speechtranslation">Traduzione vocale</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Tradurre la voce in testo scritto dal microfono</h3>
                                                    <p>Usare Speech SDK per tradurre la voce in testo scritto da un microfono.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Tradurre la voce in più lingue di destinazione</h3>
                                                    <p>Usare Speech SDK per tradurre la voce in più output di lingue di destinazione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Tradurre la voce in voce</h3>
                                                    <p>Usare Speech SDK per tradurre la voce in voce.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prezzi</h3>
                                                    <p>Altre informazioni sui costi associati alla traduzione vocale.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Leggere la documentazione</h3>
                                                    <p>Informazioni su come aggiungere la traduzione vocale ad app, strumenti e prodotti. Sono inclusi concetti, esercitazioni, informazioni di riferimento sulle API e note sulla versione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Trascrivere una conversazione in tempo reale</h3>
                                                    <p>Informazioni su come trascrivere una conversazione in tempo reale.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Trascrivere le conversazioni in modo asincrono</h3>
                                                    <p>Informazioni su come trascrivere le conversazioni in modo asincrono, eseguire il polling dello stato e scaricare gli output.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prezzi</h3>
                                                    <p>Altre informazioni sui costi associati alla trascrizione conversazione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integrazione con Bot Framework</h3>
                                                    <p>Altre informazioni su Bot Framework, sul canale Direct Line Speech e altro ancora.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Informazioni su come creare iterazioni di comandi e controlli semplici e affidabili con la comprensione della lingua e la correzione degli errori.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Problemi di GitHub</h3>
                                                    <p>Esplorare i problemi aperti e/o crearne di nuovi per Speech SDK in GitHub.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Porre domande e ottenere assistenza dalla community del servizio Voce in Stack Overflow.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Condividere idee, suggerire miglioramenti o richiedere nuove funzionalità per il servizio Voce.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#customization">Personalizzazione</a>
                <ul id="customization">
                    <li>
                        <a href="#speech-to-text-customization">Riconoscimento vocale</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migliorare l'accuratezza con l'elenco frasi</h3>
                                                    <p>Usare gli elenchi di frasi in Speech SDK per migliorare l'accuratezza del riconoscimento.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migliorare l'accuratezza con i modelli di tenant</h3>
                                                    <p>Generare modelli personalizzati usando i dati di Office 365 per ottimizzare l'accuratezza del riconoscimento vocale per termini specifici dell'organizzazione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migliorare l'accuratezza con Riconoscimento vocale personalizzato</h3>
                                                    <p>Un set di strumenti online che consentono di valutare e migliorare l'accuratezza del riconoscimento vocale di Microsoft per app, strumenti e prodotti.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prezzi</h3>
                                                    <p>Altre informazioni sui costi associati a Riconoscimento vocale personalizzato.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <li>
                        <a href="#text-to-speech-customization">Sintesi vocale</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migliorare la sintesi con SSML</h3>
                                                    <p>Usare il linguaggio di markup di sintesi vocale per ottimizzare il tono, la prosodia e la velocità del parlato dell'output audio.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migliorare la sintesi con Riconoscimento vocale personalizzato</h3>
                                                    <p>Creare un'unica voce riconoscibile per le app di sintesi vocale con i dati della lingua disponibili.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migliorare la sintesi con la creazione di contenuto audio</h3>
                                                    <p>Usare lo strumento di creazione di contenuto audio per ottimizzare gli output vocali sintetizzati.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Ottenere accesso a voci neurali personalizzate</h3>
                                                    <p>Si tratta di una funzionalità gestita che consente di creare una sintesi vocale neurale. Altre informazioni su accesso e restrizioni.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prezzi</h3>
                                                    <p>Altre informazioni sui costi associati a Voce personalizzata.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
