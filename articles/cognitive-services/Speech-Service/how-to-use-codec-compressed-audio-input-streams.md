...
Si supponga di disporre di una classe di flusso di input denominata `myPushStream` e di usare OPUS/OGG. Il codice potrebbe essere simile al seguente:
