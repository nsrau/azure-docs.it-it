---
title: 'Guida introduttiva: Riconoscimento vocale, JavaScript (Browser) - Servizio Voce'
...
L'applicazione si basa su Speech SDK per JavaScript ([scaricare la versione 1.6.0](https://aka.ms/csspeech/jsbrowserpackage)).
