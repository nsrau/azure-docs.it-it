...
Java SDK | :heavy_check_mark: | :heavy_check_mark: | Servizi vocali supporta dispositivi Android e vocali.
...
Riconoscimento delle intenzioni tramite sintesi vocale | Richiede una chiamata separata all'API LUIS | Integrato, con SDK |  È possibile usare una chiave LUIS con il servizio Voce.
