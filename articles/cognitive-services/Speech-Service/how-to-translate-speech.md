...
1. Creare una factory di riconoscimento vocale e fornire una chiave di sottoscrizione al servizio Voce o un token di autorizzazione. A questo punto si configura la lingua di partenza e la lingua di arrivo della traduzione e si specifica se si desidera un testo o una sintesi vocale.
