...
## <a name="speech-devices-sdk-160"></a>Dispositivi Speech SDK 1.6.0:

*   Supporto tecnico [Azure Kinect DK](https://azure.microsoft.com/services/kinect-dk/) in Windows e Linux con i comuni [applicazione di esempio](https://aka.ms/sdsdk-download)
*   Aggiornato il [Speech SDK](https://docs.microsoft.com/azure/cognitive-services/speech-service/speech-sdk-reference) componente alla versione 1.6.0. Per altre informazioni, vedere le relative [Note sulla versione](https://aka.ms/csspeech/whatsnew).
