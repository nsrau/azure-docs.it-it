...
Sono disponibili guide di avvio rapido anche per la [sintesi vocale](quickstart-text-to-speech-objectivec-macos.md).
...
1. Nella finestra di dialogo **Opzioni progetto**:
    ...
    ![Impostazioni del progetto](media/sdk/qs-objectivec-macos-project-settings.png)
