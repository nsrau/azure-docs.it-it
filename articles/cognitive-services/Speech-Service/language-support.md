...
-------|----------|---------|----------|----------
<sup>&dagger;</sup>`ar-EG` | Arabo (Egitto) | Femmina | "Microsoft Server Speech Text to Speech Voice (ar-EG, Hoda)" | "ar-EG-un".
