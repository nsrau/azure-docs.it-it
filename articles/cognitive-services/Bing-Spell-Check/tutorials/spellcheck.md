...
Per proseguire con l'esercitazione è necessaria una chiave di sottoscrizione per l'API Controllo ortografico Bing. Se non è disponibile, è necessario avere:

* Una sottoscrizione di Azure: [creare un account gratuitamente](https://azure.microsoft.com/free/cognitive-services/)
* [Una risorsa di Controllo ortografico Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSpellCheck-v7)
