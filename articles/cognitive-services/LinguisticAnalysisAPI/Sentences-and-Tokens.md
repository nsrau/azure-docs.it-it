...
Microsoft si avvale della specifica di [Penn Treebank](https://www.cis.upenn.edu/~treebank/). Per altri dettagli, vedere qui: (https://www.cis.upenn.edu/~treebank/tokenization.html).
