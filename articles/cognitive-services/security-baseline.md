...
* [Panoramica delle reti virtuali di Azure](https://docs.microsoft.com/azure/virtual-network/virtual-networks-overview)
...
* [Gruppi di sicurezza delle applicazioni](https://docs.microsoft.com/azure/virtual-network/security-overview#application-security-groups)
...
* [Uso delle impostazioni di diagnostica per servizi cognitivi di Azure](https://docs.microsoft.com/azure/cognitive-services/diagnostic-logging)
...
* [Informazioni sull'API REST dei servizi cognitivi di Azure](https://docs.microsoft.com/rest/api/cognitiveservices/)
...
* [Informazioni su Transport Layer Security per servizi cognitivi di Azure](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-security)
...
**Linee guida**: usare il controllo degli accessi in base al ruolo Azure Active Directory (Azure ad) per controllare l'accesso al piano di controllo dei servizi cognitivi di Azure, ad esempio portale di Azure.
...
* [Elenco di servizi che crittografano le informazioni inattive](https://docs.microsoft.com/azure/cognitive-services/encryption/cognitive-services-encryption-keys-portal)
