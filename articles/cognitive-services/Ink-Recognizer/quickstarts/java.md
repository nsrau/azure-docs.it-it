...
description: Questo argomento di avvio rapido illustra come usare l'API Riconoscimento input penna e Java per avviare il riconoscimento di tratti input penna.
