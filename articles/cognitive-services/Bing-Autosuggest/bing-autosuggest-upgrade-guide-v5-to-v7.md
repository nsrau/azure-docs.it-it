...
- Il numero di versione dell'endpoint è stato modificato da v5 a v7. Ad esempio, https:\//api.cognitive.microsoft.com/bing/\*\*v7.0 * * / suggerimenti.
