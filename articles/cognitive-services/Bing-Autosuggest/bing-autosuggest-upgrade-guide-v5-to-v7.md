...
ms.locfileid: "55178478"
---
# <a name="autosuggest-api-upgrade-guide"></a>Guida all'aggiornamento dell'API Suggerimenti automatici

Questa guida all'aggiornamento indica le differenze tra la versione 5 e la versione 7 dell'API Suggerimenti automatici Bing. Usare questa guida per identificare le parti dell'applicazione da aggiornare per usare la versione 7.
