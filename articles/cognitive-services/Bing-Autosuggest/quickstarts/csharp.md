---
title: Avvio rapido per l'API Suggerimenti automatici Bing con C# | Microsoft Docs
...
---
# <a name="quickstart-for-bing-autosuggest-api-with-c"></a>Avvio rapido per l'API Suggerimenti automatici Bing con C\#
<a name="HOLTop"></a>
