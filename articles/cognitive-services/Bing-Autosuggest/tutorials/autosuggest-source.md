...
description: Codice sorgente per un'esercitazione che illustra come usare l'API Suggerimenti automatici Bing in un'applicazione Web a pagina singola.
