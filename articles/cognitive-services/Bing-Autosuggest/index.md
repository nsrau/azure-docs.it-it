...
ms.openlocfilehash: f23cf513db3c572941c9a011186c00291a485450
ms.contentlocale: it-it
ms.lasthandoff: 05/10/2017

---
<div class="content">
    <h1>Bing Autosuggest API Documentation</h1>
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>Learn how to use Bing's Autosuggest API to support an auto-suggest search box feature.</p>
        </div>
...
<p style="margin-top: 6px; margin-bottom: 6px;">Create an API to auto populate a drop-down box</p>
<div class="ico48Case">
    <div class="ico48Link">
        <a href="#">
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Top Topics</h3>
                        <p><a href="/azure/cognitive-services/Bing-Autosuggest/Overview">Overview</a></p>
                        <p><a href="/azure/cognitive-services/Bing-Autosuggest/UseAndDisplayRequirements">Use and Display Requirements</a></p>
                    </div>
                </div>
            </div>
        </div>
