---
title: "Esercitazione: Ricerca notizie Bing in un'app Web a pagina singola (codice sorgente)"
titlesuffix: Azure Cognitive Services
description: Codice sorgente per un'esercitazione che illustra come usare l'API Ricerca notizie Bing in un'applicazione Web a pagina singola.
...
ms.locfileid: "48804294"
---
# <a name="tutorial-single-page-news-search-app"></a>Esercitazione: App Ricerca notizie a pagina singola

Qui è riportato il codice sorgente completo descritto nell'[esercitazione sull'app a pagina singola](tutorial-bing-news-search-single-page-app.md) per l'API Ricerca notizie Bing. Per eseguire l'app, copiare il codice sorgente nel Blocco note o un altro editor di testo e salvarlo come `bing.html`. Quindi aprire il file salvato in Microsoft Edge o un altro browser comune.
