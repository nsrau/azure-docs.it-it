---
title: 'Raccolta dei dati per eseguire il training del modello: API Consigli di Machine Learning | Microsoft Docs'
...
---
# <a name="collecting-data-to-train-your-model"></a>Raccolta dei dati per eseguire il training del modello
...
## <a name="catalog-data"></a>Dati del catalogo
### <a name="catalog-file-format"></a>Formato del file di catalogo
Il file di catalogo contiene informazioni sugli elementi che si offrono al cliente.
...
#### <a name="format-details"></a>Dettagli relativi al formato
| Name | Mandatory | Tipo | Description |
|:--- |:--- |:--- |:--- |
...
| Description |No, a meno che siano presenti funzionalità (può essere vuoto) |Qualsiasi carattere alfanumerico <br>  Lunghezza massima: 4000 |Descrizione dell'elemento. |
...
#### <a name="uploading-a-catalog-file"></a>Caricamento di un file di catalogo
...
> Il numero massimo di elementi supportato nel catalogo è 100.000.
> 
> 

## <a name="why-add-features-to-the-catalog"></a>Motivazioni dell'aggiunta di funzionalità al catalogo
...
### <a name="features-are-categorical"></a>Le funzionalità sono di tipo categorico
...
### <a name="how-manywhich-features-should-i-use"></a>Quante e quali funzionalità è necessario usare
...
### <a name="when-are-features-actually-used"></a>Quando vengono effettivamente usate le funzionalità
...
### <a name="using-product-features"></a>Uso delle funzionalità del prodotto
...
#### <a name="usage-format-details"></a>Dettagli relativi al formato del file di dati di utilizzo
Il file di dati di utilizzo presenta il formato CSV (valori delimitati da virgola) in cui ogni riga del file rappresenta un'interazione tra un utente e un elemento. Ogni riga è formattata come illustrato di seguito:<br>
...
| Evento |No |Uno dei seguenti:<br>• Click<br>• RecommendationClick<br>•    AddShopCart<br>• RemoveShopCart<br>• Acquisto |Tipo di transazione. |

#### <a name="sample-rows-in-a-usage-file"></a>Righe di esempio in un file di dati di utilizzo
...
#### <a name="uploading-a-usage-file"></a>Caricamento di un file di dati di utilizzo
Per caricare file di dati di utilizzo, vedere il [riferimento all'API](https://westus.dev.cognitive.microsoft.com/docs/services/Recommendations.V4.0/operations/56f316efeda5650db055a3e2) .
Si noti che è necessario passare il contenuto del file di dati di utilizzo come corpo della chiamata HTTP.
...
## <a name="how-much-data-do-you-need"></a>Quanti dati sono necessari?
La qualità del modello dipende fortemente dalla qualità e dalla quantità dei dati.
Il sistema apprende quando gli utenti acquistano elementi diversi (denominiamoli co-occorrenze). Per le compilazioni FBT, è importante anche sapere quali elementi vengono acquistati nelle stesse transazioni. 
