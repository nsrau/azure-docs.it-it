...
Sono disponibili tre portali per la creazione di LUIS, in base all'area. La creazione e la pubblicazione devono avvenire nella stessa area.

|LUIS|Regione di creazione|Nome dell'area di Azure|
|--|--|--|
|[www.luis.ai][www.luis.ai] |U.S.<br>non Europa<br>non Australia| `westus`|
...
| America del Nord |`westus`<br>[www.luis.ai][www.luis.ai] | West US 2<br>`westus2`    |  `https://westus2.api.cognitive.microsoft.com/luis/v2.0/apps/YOUR-APP-ID?subscription-key=YOUR-SUBSCRIPTION-KEY`  |
