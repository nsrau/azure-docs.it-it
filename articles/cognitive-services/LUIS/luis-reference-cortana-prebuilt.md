---
title: Informazioni di riferimento sull'app Cortana predefinita | Microsoft Docs
description: Informazioni di riferimento per l'assistente personale Cortana, un'applicazione predefinita fornita da LUIS (Language Understanding Intelligent Services).
...
---
# <a name="cortana-prebuilt-app-reference"></a>Informazioni di riferimento sull'app Cortana predefinita
In questo riferimento sono elencate le finalità e le entità riconosciute dall'app Cortana predefinita.

## <a name="cortana-prebuilt-intents"></a>Finalità dell'app Cortana predefinita
L'applicazione assistente personale predefinita è in grado di identificare le finalità seguenti:
...
Di seguito sono riportati alcuni esempi di entità che l'applicazione assistente personale predefinita è in grado di identificare:

|Entità |Esempio di entità in un'espressione |
|-------|------------------|
