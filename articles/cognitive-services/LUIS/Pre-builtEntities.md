...
2. Nella pagina **Entità** fare clic su **Manage prebuilt entities** (Gestisci entità predefinite).
    ...
    ![Pagina Entità - Manage prebuilt entities (Gestisci entità predefinite)](./media/luis-use-prebuilt-entity/add-prebuilt-entity-button.png)
...
1. Aggiungere un'entità **numero** all'app, quindi [eseguire il training](interactive-test.md) e [pubblicare](PublishApp.md) l'app.
...
1. Aggiungere un'entità **datetimeV2** all'app, quindi [eseguire il training](interactive-test.md) e [pubblicare](PublishApp.md) l'app.
2. Fare clic sull'URL dell'endpoint nella pagina **Pubblica app** per aprire l'endpoint LUIS in un Web browser. 
