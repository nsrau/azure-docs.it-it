...
| Comunicazioni | Invio di messaggi e chiamate telefoniche.| it-IT <br/> zh-CN |
...
| Modalità di gioco | Gestisce le richieste relative a una partita in un gioco multiplayer.| it-IT |
...
| Nota | Il dominio Note (Nota) offre finalità ed entità correlate alla creazione, alla modifica e alla ricerca di note.| it-IT<br/> zh-CN |
...
| Promemoria | Gestione delle richieste correlate alla creazione, alla modifica e alla ricerca di promemoria.| it-IT<br/> zh-CN |
...
| Trasla | Traduzione del testo nella lingua di destinazione.| it-IT<br/> zh-CN |
...
| ---------------- |-----------------------|----|
| Aggiungi | Aggiungere una voce singola al calendario.| Prendi un appuntamento con Lisa per le 14.00 di domenica <br/><br/>Voglio pianificare una riunione<br/><br/>Ho bisogno di organizzare una riunione|
...
| Modificare | Richiedere di modificare una riunione o una voce del calendario esistente.| Sposta la riunione delle 9.00 alle 10.00.<br/><br/>Voglio aggiornare la mia pianificazione.<br/><br/>Modificare la pianificazione della riunione con Ryan.|
| Trova | Visualizzare il calendario settimanale personale.| Trova l'appuntamento di controllo dal dentista. <br/><br/>Mostra il mio calendario<br/>|
...
| Conferma| Confermare un'azione.|Sì<br/>OK<br/>Va bene<br/>Confermo di voler inviare questo messaggio di posta elettronica.<br/>|
...
| FindSpeedDial| Trovare il numero di connessioni velocità che un numero di telefono è impostato sulla e viceversa.|A quale numero corrisponde il numero 5?<br/>È impostato il numero rapido?<br/>Qual è il numero rapido per 941-5555-333?|
...
| Riga | Linea che l'utente vuole usare per effettuare una chiamata o da cui inviare un messaggio di testo o un messaggio di posta elettronica.| Linea ufficio<br/>Cella inglese<br/>Skype|
...
| MessageType | Nome di un contatto o del destinatario del messaggio.| Text<br/>Posta|
| OrderReference | Posizione ordinale o relativa in un elenco che identifica un elemento da recuperare. Ad esempio, "ultimo" o "recente" in "Qual è l'ultimo messaggio inviato?"| Ultima<br/>Recenti|
...
| Parola chiave| Parola chiave di ricerca generica che specifica un attributo non presente negli slot multimediali più specifici.|Colonne sonore<br/>Moon River<br/>Amelia Earhart|
| Lingua | Linguaggio usato nei supporti, ad esempio lingua parlata del brano o del filmato.|Francese<br/>Inglese<br/>Coreano|
...
| Persona| Attore, regista, produttore, musicista o artista associato a un film, un'app, un gioco o un programma televisivo.|Madonna<br/>Stanley Kubrick|
| Ruolo| Ruolo svolto nella creazione di un contenuto multimediale.|Cantante<br/>Regista<br/>Per|
...
| Misurazione| Tipo di misura per tempo, distanza o peso da usare in un app per il benessere o il fitness.|Chilometri<br/>Miglia<br/>Minuti<br/>Chilogrammi|
...
| Operazione | Stato del dispositivo da impostare.|lock<br/>apri<br/>sì<br/>no|
| Sala riunioni | Posizione o locale in cui si trova il dispositivo.|soggiorno<br/>camera da letto<br/>cucina|
...
| Nome della finalità | Descrizione | Esempi |
| ---------------- |-----------------------|----|
| Book | Acquistare biglietti del cinema.|Prenota due biglietti per I tre moschettieri<br/>Voglio acquistare un biglietto per il film di domani<br/>Desidera che un ticket per Captain Omar parte 2 mercoledì successivo|
...
| Pausa | Sospendere la musica in riproduzione.|Pausa<br/>Sospendi musica<br/>Sospendi brano|
...
| Cancella | Cancellare tutte le voci da una nota preesistente.|Rimuovi tutte le voci dalla lista delle vacanze<br/>Cancella tutto dalla lista delle letture|
| Conferma | Confermare un'azione relativa a una nota.|OK per me<br/>sì<br/>Confermo di tenere tutte le voci nelle liste|
...
| ShowNext | Visualizzare la voce successiva di un elenco di note.|Mostra la prossima<br/>Pagina successiva<br/>Successivo|
...
|?| Richiedere aiuto.|Aiuto<br/>Salve<br/>Cosa fare<br/>Serve aiuto| 
...
|PowerOff | Spegnere il dispositivo.|Spegni computer<br/>Arresto<br/>Spegni telefono cellulare|
...
|Riavvia|Riavviare il dispositivo.|Riavvia.|
...
|TurnOnSetting|Attivare un'impostazione del dispositivo.|Attivata <br/> Off|
...
|Conferma|Confermare un'azione relativa a un luogo.|Confermare la prenotazione al ristorante.|
...
|GetReviews|Chiedere le recensioni di un luogo.|Visualizza le revisioni per Cheesecake Factory<br/>Leggi recensioni di Cineplex in Yelp|
...
| Distanza | Distanza per un luogo.|15 miglia<br/>5 miglia<br/>10 miglia|
| MealType | Tipo di pasto come colazione o pranzo. |colazione<br/>pasto principale<br/>pranzo<br/>cena|
| OpenStatus | Indica se un luogo è aperto o chiuso.|Aperte<br/>closed<br/>apertura|
...
| Nome della finalità | DESCRIZIONE | Esempi |
| ---------------- |-----------------------|----|
| Cambia| Modificare un promemoria.|Sposta il mio colloquio alle 9.00 di domani<br/>Sposta promemoria assegnazione a domani|
...
| Trova | Trovare un promemoria.|C'è un promemoria per l'anniversario?<br/>Controlla se c'è un promemoria per il compleanno di Christine|
...
| Nome della finalità | DESCRIZIONE | Esempi |
| ---------------- |-----------------------|----|
| Trasla| Tradurre un testo in un'altra lingua.|Traduci in francese<br/>Traduci ciao in tedesco|
...
| Conferma | Confermare un'azione.|Sì, confermo<br/>Bene, confermo<br/>OK, confermo|
| FinishTask | Completare un'attività iniziata dall'utente.|Ho finito<br/>Ho completato<br/>Fatto|
| GoBack | Tornare indietro di un passaggio o tornare al passaggio precedente.|Torna a Twitter<br/>Torna indietro di un passaggio<br/>Indietro|
| ? | Richiedere aiuto.|Aiuto<br/>apri aiuto<br/>help|
