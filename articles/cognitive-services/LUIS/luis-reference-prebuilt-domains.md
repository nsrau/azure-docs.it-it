...
|ToDo_IPA|Basato su dominio ToDo, ToDo_IPA è una versione personalizzata per espandere le entità in ToDo. La versione di file IPA fornisce finalità ed entità per supportare il riconoscimento di un tipo di elenco todo. Il modello definisce tre tipi di elenchi di attività: elenco di alimentari, elenco della spesa e to do list che copre gli altri casi.|
