---
title: Esercitazione su come chiamare un'app di Language Understanding (LUIS) tramite Node.js | Microsoft Docs
...
ms.locfileid: "36265405"
---
# <a name="tutorial-call-a-luis-endpoint-using-javascript"></a>Esercitazione: Chiamare un endpoint di Language Understanding usando JavaScript
...
4. Accedere nuovamente al sito Web di [Language Understanding](luis-reference-regions.md) con il proprio account di Azure. 
    ...
    [![](media/luis-get-started-node-get-intent/app-list.png "Screenshot dell'elenco Crea app")](media/luis-get-started-node-get-intent/app-list.png)
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-javascript"></a>usare un risultato di Language Understanding tramite l'API per endpoint con JavaScript 

È possibile usare JavaScript per accedere agli stessi risultati illustrati nella finestra del browser nel passaggio precedente. 
...
2. Sostituire `"YOUR SUBSCRIPTION KEY"` con la chiave di sottoscrizione in questa riga di codice: `xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key","YOUR SUBSCRIPTION KEY");`

3. Aprire il file salvato tramite un Web browser.  Dovrebbe comparire una finestra di avviso che indica `Detected the following intent: TurnOn`.

![Finestra popup che indica TurnOn](./media/luis-get-started-node-get-intent/popup-turn-on.png)
