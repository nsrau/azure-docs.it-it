---
title: Guida alla migrazione di API da v1 a v2 | Microsoft Docs
titleSuffix: Azure
...
Le API chiavi di sottoscrizione sono deprecate e viene restituito l'errore 410 GONE.
...
LUIS suggerisce espressioni da [espressioni endpoint](label-suggested-utterances.md) esistenti che potrebbero migliorare il modello. Nella versione precedente il nome era **sample**. Nella nuova versione il nome è **suggest**. Si tratta della **[revisione delle espressioni endpoint](https://docs.microsoft.com/azure/cognitive-services/LUIS/label-suggested-utterances)** nel sito Web LUIS.
...
Le [entità predefinite](Pre-builtEntities.md) sono cambiate. Assicurarsi di usare entità predefinite V2. È incluso l'uso di [datetimeV2](pre-builtentities.md?#use-a-prebuilt-datetimev2-entity) anziché datetime. 
