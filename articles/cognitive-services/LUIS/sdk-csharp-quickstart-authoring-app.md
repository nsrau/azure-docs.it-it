---
title: 'Avvio rapido: Libreria client di creazione di Language Understanding (LUIS) per .NET'
titleSuffix: Azure Cognitive Services
description: Questo argomento di avvio rapido illustra come usare la libreria client di LUIS per .NET. Seguire questi passaggi per installare il pacchetto e provare il codice di esempio per le attività di base.
