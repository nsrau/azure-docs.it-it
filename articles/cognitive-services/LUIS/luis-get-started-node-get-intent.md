---
title: Esercitazione su come chiamare un'app di Language Understanding Intelligent Service (LUIS) tramite Node.js | Microsoft Docs
description: Questa esercitazione illustra come chiamare un'app di Language Understanding con Node.js.
...
ms.locfileid: "36263653"
---
# <a name="tutorial-call-a-luis-endpoint-using-nodejs"></a>Esercitazione: Chiamare un endpoint di Language Understanding usando Node.js
...
Per effettuare chiamate all'app LUIS di esempio usata in questa procedura dettagliata è necessaria una chiave API per Servizi cognitivi. 
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-nodejs"></a>Usare un risultato di Language Understanding tramite l'API per endpoint con Node.js
...
2. Impostare la variabile di ambiente `LUIS_APP_ID` come descritto nei commenti al codice. 

3. Impostare la variabile di ambiente `LUIS_SUBSCRIPTION_KEY` sulla chiave di sottoscrizione di Servizi cognitivi.

4. Eseguire il codice. Vengono visualizzati gli stessi valori illustrati in precedenza nella finestra del browser.
<!-- 
