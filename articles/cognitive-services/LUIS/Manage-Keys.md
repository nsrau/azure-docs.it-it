---
title: Gestire le chiavi in LUIS | Microsoft Docs
...
ms.locfileid: "36266023"
---
# <a name="manage-your-luis-keys"></a>Gestire le chiavi di LUIS
...
1. Creare una chiave LUIS sul [portale di Azure](https://portal.azure.com). Per ulteriori istruzioni, vedere [Creazione di una chiave di sottoscrizione utilizzando Azure](luis-how-to-azure-subscription.md).
...
Usare la chiave per pubblicare l'app nella pagina **Publish app** (Pubblica app). Per istruzioni sulla pubblicazione, vedere [Pubblicare app](PublishApp.md).
