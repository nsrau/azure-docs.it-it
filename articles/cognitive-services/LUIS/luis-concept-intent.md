...
Una finalità rappresenta un'attività o un'azione che l'utente desidera eseguire. Si tratta di uno scopo o obiettivo espresso in un [enunciato](luis-concept-utterance.md)dell'utente.
...
<a name="how-do-intents-relate-to-entities"></a>
 ...
 Creare una finalità quando l'_intenzione_ dell'utente avvierebbe un'azione nell'applicazione client, ad esempio una chiamata alla funzione checkweather(). Quindi creare entità per rappresentare i parametri necessari per eseguire l'azione.
