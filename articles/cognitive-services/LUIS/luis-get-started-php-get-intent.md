---
title: Chiamare un'app di Language Understanding (LUIS) tramite PHP | Microsoft Docs
...
ms.locfileid: "36265127"
---
# <a name="tutorial-call-a-luis-endpoint-using-php"></a>Esercitazione: Chiamare un endpoint di Language Understanding tramite PHP
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-php"></a>Usare un risultato di Language Understanding tramite l'API per endpoint con PHP 
...
3. Eseguire l'applicazione PHP. Verrà visualizzato lo stesso JSON illustrato in precedenza nella finestra del browser.
