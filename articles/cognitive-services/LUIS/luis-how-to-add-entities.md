...
|--|--|
|[Entità elenco](#add-list-entities-for-exact-matches)|elenco di nomi canonici insieme a sinonimi come form alternativi|
...
In questa procedura aggiungere `origin` i ruoli `destination` e a un'entità geographyV2 predefinita.
