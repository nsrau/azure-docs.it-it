...
# <a name="how-to-call-the-text-analytics-rest-api"></a>How to call the Text Analytics REST API
...
## <a name="json-schema-definition"></a>JSON schema definition
...
## <a name="set-up-a-request-in-postman"></a>Set up a request in Postman
