...
ms.openlocfilehash: 70b035dcd4778e8c3b0d1bbfbf9a2ce5a45baf21
ms.contentlocale: it-it
ms.lasthandoff: 05/10/2017

---

# <a name="use-the-prediction-endpoint-to-test-images-programmatically"></a>Use the Prediction Endpoint to Test Images Programmatically

After you train your model, you can obtain a URL that you can use to test images programmatically.

## <a name="obtain-the-prediction-endpoint-url-for-a-specific-iteration"></a>Obtain the prediction endpoint URL for a specific iteration:
...
### <a name="test-an-image-in-c"></a>Test an image in C#
...
## <a name="obtain-the-default-prediction-endpoint-url-for-your-project"></a>Obtain the default prediction endpoint URL for your project:
