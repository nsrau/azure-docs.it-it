---
title: Uso dell'endpoint di stima del Servizio visione artificiale personalizzato - Servizi cognitivi di Azure | Microsoft Docs
...
Dalla [pagina Web di Visione personalizzata](https://customvision.ai) selezionare il progetto e quindi selezionare la scheda __Performance__ (Prestazioni). Per visualizzare informazioni sull'uso dell'API Prediction, selezionare __Prediction URL__. Copiare le informazioni seguenti da usare nell'applicazione:
