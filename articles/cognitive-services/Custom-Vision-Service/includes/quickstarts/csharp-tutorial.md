...
Per scrivere un'app di analisi immagini con Visione personalizzata per .NET, sono necessari i pacchetti NuGet di Visione personalizzata. Questi pacchetti sono inclusi nel progetto di esempio che si scaricherà, ma è possibile accedervi singolarmente qui.
...
Questo script, l'immagine di test viene caricata nel metodo **LoadImagesFromDisk** e l'output delle stime del modello deve essere visualizzato nella console. Il valore della variabile `publishedModelName` deve corrispondere al valore di "Pubblicata come" disponibile nella scheda **Prestazioni** del sito Web di Visione personalizzata. 
