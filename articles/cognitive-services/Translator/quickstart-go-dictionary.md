...
Creare una funzione per ottenere traduzioni alternative. Questa funzione accetta un singolo argomento, la chiave di sottoscrizione del servizio Traduzione testuale.
...
>[!NOTE]
> Per altre informazioni su endpoint, route e parametri della richiesta, vedere [API Traduzione testuale 3.0: Dictionary Lookup](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-dictionary-lookup).
