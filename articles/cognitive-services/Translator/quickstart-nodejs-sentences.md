...
ms.locfileid: "49644909"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-nodejs"></a>Guida introduttiva: Ottenere la lunghezza delle frasi con l'API REST Traduzione testuale (Node.js)
