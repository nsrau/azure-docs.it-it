...
ms.locfileid: "50086132"
---
# <a name="quickstart-use-the-translator-text-api-to-determine-sentence-length-using-python"></a>Guida introduttiva: Usare l'API Traduzione testuale per determinare la lunghezza delle frasi con Python
...
Attualmente, è disponibile un solo endpoint per Traduzione testuale e viene impostato come `base_url`. `path` imposta la route `breaksentence` e identifica che si vuole usare la versione 3 dell'API.
