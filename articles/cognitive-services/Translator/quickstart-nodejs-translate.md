...
ms.locfileid: "49648480"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-nodejs"></a>Guida introduttiva: Tradurre un testo con l'API REST Traduzione testuale (Node.js)
