---
title: 'Avvio rapido: Ottenere la lunghezza delle frasi, Ruby - API Traduzione testuale'
...
ms.locfileid: "55975450"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-ruby"></a>Avvio rapido: Ottenere la lunghezza delle frasi con l'API REST Traduzione testuale (Ruby)
