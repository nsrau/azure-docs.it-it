...
L'endpoint globale di Traduzione testuale viene impostato come `endpoint`. `path` imposta la route `breaksentence` e identifica che si vuole usare la versione 3 dell'API.
