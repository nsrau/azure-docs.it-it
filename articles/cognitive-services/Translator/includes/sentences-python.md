...
L'endpoint globale di Translator viene impostato come `endpoint`. `path` imposta la route `breaksentence` e identifica che si vuole usare la versione 3 dell'API.
...
>[!NOTE]
> Per altre informazioni su endpoint, route e parametri della richiesta, consultare [Translator 3.0: Lingue](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-break-sentence).
