...
L'endpoint globale di Translator viene impostato come `endpoint`. `path` imposta la route `dictionary/lookup` e identifica che si vuole usare la versione 3 dell'API.
