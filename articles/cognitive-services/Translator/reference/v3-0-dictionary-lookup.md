---
title: Metodo di ricerca nei dizionari dell'API Traduzione testuale Microsoft | Microsoft Docs
description: Usare il metodo di ricerca nei dizionari dell'API Traduzione testuale Microsoft.
