...
|Proprietà della richiesta HTTP|Name|Tipo|Scopo|
|--|--|--|--|
|Parametro di route URL|ID Knowledge base|stringa|L'identificatore univoco globale della Knowledge Base.|
