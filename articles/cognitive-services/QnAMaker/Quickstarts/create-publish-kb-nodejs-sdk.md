...
|`QNAMAKER_HOST`|`endpoint`|`https://your-resource-name.api.cognitive.microsoft.com`: sostituire il valore `your-resource-name` del sottodominio con il valore del nome della risorsa|
||||
