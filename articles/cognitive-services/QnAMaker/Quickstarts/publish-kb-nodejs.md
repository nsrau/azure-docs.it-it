...
* `QNAMAKER_RESOURCE_KEY`: la **chiave** è una stringa di caratteri 32 ed è disponibile nella portale di Azure, nella risorsa QnA Maker, nella pagina **avvio rapido** . Non è la stessa chiave dell'endpoint di previsione.
