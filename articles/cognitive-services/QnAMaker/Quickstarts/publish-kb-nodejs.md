---
title: 'Avvio rapido: QnA Maker con API REST per Node.js'
...
ms.locfileid: "77109515"
---
# <a name="quickstart-qna-maker-rest-apis-for-nodejs"></a>Avvio rapido: API REST di QnA Maker per Node.js
...
* `QNAMAKER_RESOURCE_KEY` - La **chiave** è una stringa di 32 caratteri ed è disponibile nella risorsa QnA Maker, nella pagina Avvio rapido del portale di Azure. Non è la stessa chiave dell'endpoint di previsione.
