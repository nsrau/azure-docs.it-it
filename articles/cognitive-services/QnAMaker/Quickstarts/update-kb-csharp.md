---
title: Guida introduttiva all'aggiornamento di una knowledge base in C# - Servizi cognitivi di Azure | Microsoft Docs
description: Come aggiornare una knowledge base in C# per QnA Maker.
...
ms.locfileid: "43771417"
---
# <a name="update-a-knowledge-base-in-c"></a>Aggiornare una knowledge base in C#
...
Dopo aver aggiornato la knowledge base, è possibile visualizzarla nella pagina [My knowledge bases](https://www.qnamaker.ai/Home/MyServices) (Knowledge base personali) del portale di QnA Maker. Si noti che il nome della knowledge base è cambiato, ad esempio QnA Maker FAQ o il nome della knowledge base preesistente, è ora New KB Name.

Per modificare altri elementi della knowledge base, fare riferimento allo [schema JSON](https://westus.dev.cognitive.microsoft.com/docs/services/5a93fcf85b4ccd136866eb37/operations/5ac266295b4ccd1554da7600) di QnA Maker e modificare la stringa `new_kb`.
