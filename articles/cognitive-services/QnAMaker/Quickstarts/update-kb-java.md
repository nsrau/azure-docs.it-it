...
1. È necessaria la libreria [apache httpclient](http://hc.apache.org/downloads.cgi). Scaricare ad esempio il file binario 4.x.x.tar.gz di HttpClient per trovare tutti i file con estensione jar da importare nel progetto.
