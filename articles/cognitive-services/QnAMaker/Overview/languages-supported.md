---
title: Lingue supportate - QnA Maker - Servizi cognitivi di Azure | Microsoft Docs
description: Informazioni su quali lingue sono supportate per QnA Maker.
...
QnA Maker dipende dagli [analizzatori del linguaggio](https://docs.microsoft.com/en-us/rest/api/searchservice/language-support) in ricerca di Azure per fornire i risultati. Sono disponibili funzionalità speciali di riclassificazione per lingua En-* che consentono una migliore pertinenza.
