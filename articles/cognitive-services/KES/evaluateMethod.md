---
title: Metodo Evaluate nell'API Knowledge Exploration Service | Microsoft Docs
description: Informazioni su come usare il metodo Evaluate nell'API Knowledge Exploration Service (KES) in Servizi cognitivi.
