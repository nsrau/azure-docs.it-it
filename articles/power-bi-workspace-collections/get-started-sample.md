...
* [Power BI .NET SDK](https://go.microsoft.com/fwlink/?LinkId=746472) (disponibili tramite NuGet)
...
Attività\<ActionResult > Report (stringa ID report)
