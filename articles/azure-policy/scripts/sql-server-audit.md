---
title: "Esempio JSON di Criteri di Azure: controllare l'impostazione di controllo di SQL Server | Microsoft Docs"
description: Questo criterio di esempio json consente di controllare le impostazioni di controllo di SQL server.
