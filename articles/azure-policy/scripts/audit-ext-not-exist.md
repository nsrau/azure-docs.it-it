---
title: "Esempio JSON di Criteri di Azure: controllare se un'estensione non esiste | Microsoft Docs"
description: Questo criterio di esempio JSON controlla se un'estensione non viene distribuita con una macchina virtuale.
