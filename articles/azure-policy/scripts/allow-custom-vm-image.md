---
title: "Esempio JSON di Criteri di Azure: consentire un'immagine di macchina virtuale personalizzata da un gruppo di risorse | Microsoft Docs"
description: Questo criterio di esempio JSON richiede che le immagini personalizzate provengano da un gruppo di risorse approvato.
...
Questo criterio di esempio JSON richiede che le immagini personalizzate provengano da un gruppo di risorse approvato. Si specifica il nome del gruppo di risorse approvato.
...
Altri esempi di modelli di Criteri di Azure sono disponibili nella documentazione di Criteri di Azure
