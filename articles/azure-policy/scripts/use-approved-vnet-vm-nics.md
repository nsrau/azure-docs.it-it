---
title: 'Esempio JSON di Criteri di Azure: usare una rete virtuale approvata per le interfacce di rete della macchina virtuale | Microsoft Docs'
description: Questo criterio di esempio JSON richiede che le interfacce di rete usino una rete virtuale approvata.
