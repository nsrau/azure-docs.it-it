---
title: "Esempio JSON di Criteri di Azure: controllare l'impostazione del controllo a livello di SQL Server | Microsoft Docs"
description: Questo criterio di esempio JSON controlla le impostazioni di controllo di SQL Server se tali impostazioni non corrispondono a un'impostazione specificata.
