---
title: 'Esempio JSON di Criteri di Azure: SKU del gateway applicazione consentiti | Microsoft Docs'
description: Questo criterio di esempio JSON richiede che i gateway applicazione usino uno SKU approvato.
...
ms.locfileid: "34601888"
---
# <a name="allowed-application-gateway-skus"></a>SKU del gateway applicazione consentiti

Questo criterio richiede che i gateway applicazione usino uno SKU approvato. Si specifica una matrice di SKU approvati.
