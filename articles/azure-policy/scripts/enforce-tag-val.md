---
title: 'Esempio JSON di Criteri di Azure: applicare un tag e il relativo valore | Microsoft Docs'
description: Questo criterio di esempio JSON richiede il nome e il valore specifici di un tag.
