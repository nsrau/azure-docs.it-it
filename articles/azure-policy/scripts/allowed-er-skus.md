---
title: 'Esempio JSON di Criteri di Azure: SKU di Express Route consentiti | Microsoft Docs'
description: Questo criterio di esempio JSON richiede che Express Route usi uno SKU approvato.
...
ms.author: banders
ms.custom: mvc
ms.openlocfilehash: 9b7c1806e0ae1ebe8487ea492039c8fdafc968ab
ms.sourcegitcommit: 3df3fcec9ac9e56a3f5282f6c65e5a9bc1b5ba22
ms.translationtype: HT
ms.contentlocale: it-IT
ms.lasthandoff: 11/04/2017
---
# <a name="allowed-express-route-skus"></a>SKU di Express Route consentiti

Questo criterio richiede che Express Route usi uno SKU approvato. Si specifica una matrice di SKU consentiti.
