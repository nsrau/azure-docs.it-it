---
title: "Esempio JSON di Criteri di Azure: controllare se Network Watcher non è abilitato per l'area | Microsoft Docs"
description: Questo criterio di esempio JSON controlla se Network Watcher non è abilitato per un'area specificata
