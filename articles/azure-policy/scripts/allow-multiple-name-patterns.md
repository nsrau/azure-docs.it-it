---
title: 'Esempio JSON di Criteri di Azure: modelli nome multipli | Documentazione Microsoft'
description: Questo criterio di esempio JSON richiede che le risorse corrispondano a uno dei modelli nome forniti.
