---
title: Esempio JSON dei Criteri di Azure - SKU degli account di archiviazione consentiti | Microsoft Docs
description: Questi criteri dell'esempio JSON richiedono che gli account di archiviazione usino uno SKU approvato.
...
ms.locfileid: "34602908"
---
# <a name="allowed-storage-account-skus"></a>SKU degli account di archiviazione consentiti

Questi criteri richiedono che gli account di archiviazione usino uno SKU approvato. Si specifica una matrice di SKU approvati.
