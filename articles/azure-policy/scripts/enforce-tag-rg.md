---
title: 'Esempio JSON di Criteri di Azure: applicare un tag e il relativo valore a gruppi di risorse | Microsoft Docs'
description: Questo criterio di esempio JSON richiede un tag e un valore in un gruppo di risorse.
