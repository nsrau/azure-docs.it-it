...
description: Questo criterio richiede che solo le immagini personalizzate approvate vengano distribuite nell'ambiente in uso.
...
- Vedere altri [esempi di Criteri di Azure](../json-samples.md)
- Vedere [Struttura delle definizioni di Criteri di Azure](../policy-definition.md)
- Vedere esempi di Criteri di Azure per macchine virtuali in [Applicare criteri alle macchine virtuali Windows](../../virtual-machines/windows/policy.md)