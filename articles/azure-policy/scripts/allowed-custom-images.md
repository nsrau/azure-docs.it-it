...
- Altri esempi di Criteri di Azure per macchine virtuali in [Applicare criteri alle macchine virtuali Windows](../../virtual-machines/windows/policy.md).