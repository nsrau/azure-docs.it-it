---
title: 'Esempio JSON di Criteri di Azure: applicare il modello di corrispondenza | Documentazione Microsoft'
description: Questo criterio di esempio JSON richiede che tutte le risorse soddisfino il modello di corrispondenza per le convenzioni di denominazione.
