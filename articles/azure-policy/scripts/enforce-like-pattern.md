---
title: 'Esempio JSON di Criteri di Azure: applicare il modello like | Microsoft Docs'
description: Questo criterio di esempio JSON richiede che tutte le risorse soddisfino il modello like per le convenzioni di denominazione.
