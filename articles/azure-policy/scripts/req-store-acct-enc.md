---
title: Esempio JSON di Criteri di Azure - Richiedere la crittografia dell'account di archiviazione | Microsoft Docs
description: Questo esempio di criterio JSON richiede l'uso della crittografia dei BLOB da parte dell'account di archiviazione.
