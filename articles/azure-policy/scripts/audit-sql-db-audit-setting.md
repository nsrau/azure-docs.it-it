---
title: "Esempio JSON di Criteri di Azure: controllare l'impostazione del controllo a livello del database SQL | Microsoft Docs"
description: Questo criterio di esempio JSON controlla le impostazioni di controllo del database SQL se tali impostazioni non corrispondono a un'impostazione specificata.
...
ms.author: dacoulte
ms.custom: mvc
ms.openlocfilehash: 2afbe2f7e25bd67efab16e4d2e410a1f9c70ea1a
ms.sourcegitcommit: 266fe4c2216c0420e415d733cd3abbf94994533d
ms.translationtype: HT
ms.contentlocale: it-IT
ms.lasthandoff: 06/01/2018
ms.locfileid: "34601752"
---
# <a name="audit-sql-db-level-audit-setting"></a>Controllare l'impostazione di controllo a livello di database SQL

Questo criterio controlla le impostazioni di controllo del database SQL nell'eventualità che tali impostazioni non corrispondano a un'impostazione specificata. Si specifica un valore che indica se le impostazioni di controllo devono essere abilitate o disabilitate.
