---
title: 'Esempio JSON di Criteri di Azure: SKU di bilanciamento del carico consentiti | Microsoft Docs'
description: Questo criterio di esempio JSON richiede che i servizi di bilanciamento del carico usino uno SKU approvato.
...
ms.locfileid: "34600963"
---
# <a name="allowed-load-balancer-skus"></a>SKU di bilanciamento del carico consentiti

Questo criterio richiede che i servizi di bilanciamento del carico usino uno SKU approvato. Si specifica una matrice di SKU consentiti.
