---
title: 'Esempio JSON di Criteri di Azure: assicurare la crittografia dei file di archiviazione | Microsoft Docs'
description: Questo criterio di esempio JSON richiede che la crittografia dei file sia abilitata per gli account di archiviazione.
...
ms.locfileid: "34602211"
---
# <a name="ensure-storage-file-encryption"></a>Assicurare la crittografia dei file di archiviazione

Questo criterio richiede che la crittografia dei file sia abilitata per gli account di archiviazione.
