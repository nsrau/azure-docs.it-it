---
title: 'Esempio JSON di Criteri di Azure: tipi di risorse non consentiti | Microsoft Docs'
description: Questo criterio di esempio JSON impedisce la distribuzione dei tipi di risorse specificati.
