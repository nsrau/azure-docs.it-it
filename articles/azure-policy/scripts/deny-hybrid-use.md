---
title: 'Esempio JSON di Criteri di Azure: negare il vantaggio Azure Hybrid Use | Microsoft Docs'
description: Questo criterio di esempio JSON impedisce di usare il vantaggio Azure Hybrid Use.
