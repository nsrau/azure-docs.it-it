---
title: 'Esempio JSON di Criteri di Azure: nessun peering reti per la rete ER | Microsoft Docs'
description: Questo criterio di esempio JSON impedisce a un peering reti di essere associato a una rete in un gruppo di risorse specificato.
