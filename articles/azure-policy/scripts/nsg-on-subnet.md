---
title: 'Esempio JSON di Criteri di Azure: NSG X in ogni subnet | Microsoft Docs'
description: Questo criterio di esempio JSON richiede che con ogni subnet virtuale venga usato uno specifico gruppo di sicurezza di rete.
