---
title: Esempi di Criteri di Azure
...
ms.locfileid: "34602612"
---
# <a name="azure-policy-samples"></a>Esempi di Criteri di Azure

La tabella seguente include collegamenti ad esempi JSON per Criteri di Azure. Questi esempi sono disponibili anche nel [repository degli esempi di Criteri di Azure](https://github.com/Azure/azure-policy).
...
- Vedere la [struttura delle definizioni dei criteri](policy-definition.md).
