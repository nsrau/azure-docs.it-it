...
L'API di Azure per FHIR è supportata da Cosmos DB come provider di persistenza. Per questo motivo, il RPO per il servizio è uguale [Cosmos DB (area singola)](../cosmos-db/consistency-levels.md) e è < 240 minuti.
