...
Se si dispone di un utente con nome utente `myuser@contoso.com` , è possibile individuare gli utenti `ObjectId` usando il comando PowerShell seguente:
