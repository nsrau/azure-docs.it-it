...
Il [repository di GitHub](https://github.com/Microsoft/fhir-server) per il server Microsoft FHIR per Azure contiene un modello che distribuirà tutte le risorse necessarie. Il processo di distribuzione richiede diversi minuti, in quanto vengono create e configurate le risorse di Azure necessarie. Distribuirlo con:
...
> [!NOTE]
> Se non è già stato effettuato l'accesso, eseguire prima i comandi seguenti.
...
Per usare un gruppo di risorse esistente, modificare i valori $rg nella riga della definizione della variabile $rg e nella riga di comando di distribuzione del modello di Azure Resource Manager, come illustrato nel codice.
