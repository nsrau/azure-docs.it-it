---
title: Ecosistema di partner intorno all'API di Azure per FHIR
description: Questo articolo illustra alcuni partner che forniscono servizi IP o di consulenza univoci per creare una soluzione end-to-end con l'API di Azure per FHIR
...
Quando si crea una soluzione end-to-end basata sull'API di Azure per FHIR, è possibile richiedere l'assistenza di un partner per il proprio indirizzo IP univoco o per aiutare a unire tutti gli elementi. Ci siamo impegnati a lavorare in crescita in questo ecosistema di partner diversi e desidero presentarne alcuni.


| Partner          | Funzionalità                               | Paesi/aree geografiche supportati         | Contatto                                                                                                                                |
|------------------|--------------------------------------------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
