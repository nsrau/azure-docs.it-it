<properties urlDisplayName="Get Started" pageTitle="Configurare tabelle HBase su cui eseguire query usando Hive in HDInsight | Azure" metaKeywords="" description="Introduzione all'uso di HBase con Hadoop in HDInsight. Informazioni sulla creazione di tabelle HBase e sull'esecuzione di query sulle tabelle mediante Hive." metaCanonical="" services="hdinsight" documentationCenter="" title="Set up HBase clusters and query them using Hive on Hadoop in HDInsight" authors="bradsev" solutions="big-data" manager="paulettm" editor="cgronlun" />
