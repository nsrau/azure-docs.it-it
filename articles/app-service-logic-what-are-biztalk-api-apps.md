...
![Marketplace app per le API](./media/app-service-learn-about-flows-preview/Marketplace.png)
...
## Connettori Standard
Il servizio app include un set completo di connettori che forniscono una soluzione chiavi in mano per connettere le app Web, per la logica e per dispositivi mobili ad alcune delle più importanti realtà SaaS odierne, tra cui Office 365, SalesForce, Sugar CRM, OneDrive, Dropbox, Marketo, Facebook e molte altre. È incluso anche un set di connettori per la comunicazione con i servizi esterni tramite FTP, SFTP, POP3/IMAP, SMTP e SOAP, semplici da usare quanto l'esecuzione di una chiamata HTTP.

## Connettori Premium 
I connettori Premium estendono ulteriormente la copertura dei Servizi app nell'azienda con connettività per SAP, Oracle, DB2, Informix e WebSphere MQ.
