<properties
    pageTitle="Soluzione Gestione aggiornamenti in OMS | Microsoft Azure"
...
-   Gli agenti Windows devono essere configurati per comunicare con un server Windows Server Update Services (WSUS) o avere accesso a Microsoft Update.  
    ...
    >[AZURE.NOTE] L'agente Windows non può essere gestito contemporaneamente da System Center Configuration Manager.  
