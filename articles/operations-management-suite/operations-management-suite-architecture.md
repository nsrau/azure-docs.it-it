...
ms.locfileid: "26683266"
---
# <a name="oms-architecture"></a>Architettura di OMS
[Operations Management Suite (OMS)](https://azure.microsoft.com/documentation/services/operations-management-suite/) è una raccolta di servizi basati sul cloud per la gestione di ambienti locali e cloud.  Questo articolo descrive i diversi componenti locali e cloud di OMS e la relativa architettura di cloud computing generale.  Per altre informazioni, è possibile fare riferimento alla documentazione relativa a ogni servizio.
...
* Un agente installato in un computer [Windows](../log-analytics/log-analytics-windows-agent.md) o [Linux](../log-analytics/log-analytics-linux-agents.md) connesso direttamente a OMS.
...
![Architettura generale di Log Analytics](media/operations-management-suite-architecture/log-analytics.png)
...
![Architettura generale di Automazione di Azure](media/operations-management-suite-architecture/automation.png)
...
* System Center Data Protection Manager (DPM) o server di Backup di Microsoft Azure. Questo scenario consente di sfruttare DPM o il server di Backup di Microsoft Azure per eseguire il backup di file e cartelle, oltre che dei carichi di lavoro di applicazioni come SQL e SharePoint, nella risorsa di archiviazione locale e quindi di eseguire la replica nell'insieme di credenziali di backup di Azure.
...
![Architettura generale di Backup di Azure](media/operations-management-suite-architecture/backup.png)
...
![Architettura generale di Azure Site Recovery](media/operations-management-suite-architecture/site-recovery.png)
