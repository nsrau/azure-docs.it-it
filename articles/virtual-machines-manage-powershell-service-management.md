<properties
   pageTitle="Attività comuni di macchina virtuale utilizzando la modalità di gestione dei servizi in Azure PowerShell"
...
# Attività comuni di macchina virtuale utilizzando Azure PowerShell in modalità di gestione del servizio
