...
Per ulteriori informazioni, vedere la pagina relativa ai [concetti relativi al provisioning](concepts-auto-provisioning.md) automatico e all' [attestazione TPM](concepts-tpm-attestation.md). 
