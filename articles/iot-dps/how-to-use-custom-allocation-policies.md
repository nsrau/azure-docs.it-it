...
In questa sezione viene aggiornato un esempio di provisioning denominato **prov\_dev\_client\_Sample** presente nell'SDK di Azure per le cose che è stato configurato in precedenza.
