...
---
# <a name="create-and-provision-an-x509-simulated-device-using-iot-hub-device-provisioning-service"></a>Creare un dispositivo simulato X.509 ed effettuarne il provisioning usando il servizio Device Provisioning in hub IoT
