---
title: Creare un'istanza di Load Balancer Standard - Portale di Azure | Microsoft Docs
description: Informazioni su come un'istanza di Load Balancer Standard con il portale di Azure.
...
---
# <a name="create-a-standard-load-balancer-to-load-balance-vms-using-the-azure-portal"></a>Creare un'istanza di Load Balancer Standard per bilanciare il carico delle macchine virtuali con il portale di Azure
