...
<properties
   pageTitle="Introduzione alla configurazione del servizio di bilanciamento del carico con connessione Internet | Microsoft Azure"
...
# Introduzione alla configurazione del bilanciamento del carico con connessione Internet
...
I servizi di bilanciamento del carico in Microsoft Azure funzionano con tutti i tipi di tenant (IaaS o PaaS) e tutti i sistemi operativi supportati (Windows o qualsiasi sistema operativo basato su Linux).
...
## Configurazione del servizio di bilanciamento del carico Internet per i servizi cloud
