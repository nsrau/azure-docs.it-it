...
# <a name="option-1-default-create-a-public-load-balancer-standard-sku"></a>[Opzione 1 (predefinita): Crea un servizio di bilanciamento del carico pubblico (SKU Standard)](#tab/option-1-create-load-balancer-standard)
...
```
Creare l'host bastion con [New-AzBastion](/powershell/module/az.network/new-azbastion):

* **myBastionHost** denominato.
* IP pubblico di **myBastionIP**.
...
```
La distribuzione dell'host bastion nella rete virtuale richiederà qualche minuto.
...
# <a name="option-2-create-a-public-load-balancer-basic-sku"></a>[Opzione 2: Creare un servizio di bilanciamento del carico pubblico (SKU Basic)](#tab/option-1-create-load-balancer-basic)
...
2. Selezionare **Tutti i servizi** nel menu a sinistra, quindi **Tutte le risorse** e infine nell'elenco di risorse selezionare **myVM1**, che si trova nel gruppo di risorse **myResourceGroupLB**.
...
9. Ripetere i passaggi da 1 a 8 per installare IIS e il file iisstart.htm aggiornato in **myVM2** e **myVM3**.

## <a name="test-the-load-balancer"></a>Testare il servizio di bilanciamento del carico

1. Nel portale di Azure trovare l'indirizzo IP pubblico per il servizio di bilanciamento del carico nella schermata **Panoramica**. Selezionare **Tutti i servizi** nel menu a sinistra, quindi **Tutte le risorse** e infine selezionare **myPublicIP**.
...
* Per altre informazioni su Azure Bastion, vedere [Informazioni su Azure Bastion](https://docs.microsoft.com/azure/bastion/bastion-overview).
