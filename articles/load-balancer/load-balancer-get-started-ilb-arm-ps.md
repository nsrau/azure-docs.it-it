...
Vedere il documento [Creare una VM Windows con Resource Manager e PowerShell](../virtual-machines/virtual-machines-windows-ps-create.md) per le istruzioni dettagliate su come creare una macchina virtuale e assegnare una scheda di interfaccia di rete.
