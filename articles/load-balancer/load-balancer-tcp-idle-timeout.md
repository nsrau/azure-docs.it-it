...
- Configurare il timeout TCP su un endpoint in una macchina virtuale tramite PowerShell o l'API di gestione servizi
- Configurare il timeout TCP per i set di endpoint con carico bilanciato tramite PowerShell o l'API di gestione servizi
- Configurare il timeout TCP per l'IP pubblico a livello di istanza
