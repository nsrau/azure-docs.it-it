...
4. Selezionare **Verifica + crea**
    ...
    > [!IMPORTANT]
    > Il resto di questa Guida introduttiva presuppone che lo SKU **standard** venga scelto durante il processo di selezione dello SKU.
...
3. Usare questi valori per configurare le regole in uscita:
    ...
    | Ripristino TCP | Selezionare **Enabled**.|
