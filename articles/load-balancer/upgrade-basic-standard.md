...
3. Creare una regola in uscita per il servizio di bilanciamento del carico per la connessione in uscita
...
* Lo script supporta solo l'aggiornamento di Load Balancer pubblici. Per l'aggiornamento interno Load Balancer di base, creare una Load Balancer interna standard se non si desidera la connettività in uscita e creare un Load Balancer interno standard e un Load Balancer pubblico standard se è necessaria la connettività in uscita.
