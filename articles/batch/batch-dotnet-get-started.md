...
2. Aggiungere questo codice a Main per impostare le credenziali per le chiamate al servizio Azure Batch:
	...
	Sostituire i valori tra parentesi quadre con quelli associati all'account Batch, disponibili nel [portale di Azure](https://portal.azure.com). Per individuare questi valori, accedere al [portale di Azure](https://portal.azure.com) e:
