---
title: 'Esercitazione: Introduzione alla libreria Azure Batch .NET | Microsoft Docs'
...
> [!TIP]
> [How to use Blob Storage from .NET](../storage/storage-dotnet-how-to-use-blobs.md) fornisce un'utile panoramica dell'uso dei contenitori e dei BLOB di Archiviazione di Azure, quindi è consigliabile prenderne visione quando si inizia a usare Batch.
> 
> 
