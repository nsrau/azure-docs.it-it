---
title: Evento Azure Batch attività non riuscita
description: Riferimento per l'evento di fallimento dell'attività batch. Questo evento verrà generato in aggiunta a un evento di completamento dell'attività e può essere utilizzato per rilevare quando un'attività ha avuto esito negativo.
services: batch
author: LauraBrenner
manager: evansma
ms.assetid: ''
