...
**Guida**: Non disponibile; Customer Lockbox non ancora supportato per Azure Batch. Elenco dei servizi supportati da Customer Lockbox:https://docs.microsoft.com/azure/security/fundamentals/customer-lockbox-overview#supported-services-and-scenarios-in-general-availability
...
Anche se le risorse di Azure classiche possono essere individuate tramite Azure Resource Graph Explorer, è consigliabile creare e usare le risorse di Azure Resource Manager (ARM) in futuro.


Come creare query con Azure Resource Graph Explorer:How to create queries with Azure Resource Graph Explorer:
...
Come creare query con Azure Resource Graph Explorer:How to create queries with Azure Resource Graph Explorer:https://docs.microsoft.com/azure/governance/resource-graph/first-query-portal
...
- Le subnet devono essere associate a un gruppo di sicurezza di rete - Gli account di archiviazione devono usare un endpoint del servizio di rete virtualeSubnets should be associated with a Network Security Group - Storage Accounts should use a virtual network service endpoint
