...
| Dimensioni | Funzionalità | Sistemi operativi | Requisiti software | Impostazioni pool |
| -------- | -------- | ----- |  -------- | ----- |
...
<sup>*</sup>Anche le dimensioni della serie N con supporto per RDMA includono GPU NVIDIA Tesla
