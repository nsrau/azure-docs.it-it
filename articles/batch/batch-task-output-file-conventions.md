...
Nel frammento di codice seguente viene usato [SaveTrackedAsync][net_savetrackedasync] per eseguire `stdout.txt` l'aggiornamento in archiviazione di Azure ogni 15 secondi durante l'esecuzione dell'attività:
