...
|`startTime`|Data e ora|Data e ora in cui è stato avviato il ridimensionamento del pool.|
|`endTime`|Data e ora|Date e ora in cui è stato completato il ridimensionamento del pool.|
