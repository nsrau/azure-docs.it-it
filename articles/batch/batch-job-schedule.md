...
Per gestire un processo usando l'interfaccia della riga di comando di Azure, vedere [Processo batch AZ - Pianificazione](https://docs.microsoft.com/cli/azure/batch/job-schedule?view=azure-cli-latest).
