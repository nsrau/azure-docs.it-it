...
| Comando | Note |
|---|---|
| [az role assignment create](/cli/azure/role#az-role-assignment-create) | Crea una nuova assegnazione di ruolo per un utente, un gruppo o un'entità servizio. |
