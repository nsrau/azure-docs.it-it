...
- [Criteri di WAF sul gateway applicazione](https://docs.microsoft.com/cli/azure/network/application-gateway/waf-policy?view=azure-cli-latest) 

- [Criteri di WAF sulla porta anteriore](https://docs.microsoft.com/cli/azure/ext/front-door/network/front-door/waf-policy?view=azure-cli-latest)
...
- [Connettere i dati da Microsoft web application firewall ad Azure Sentinel](/azure/sentinel/connect-microsoft-waf)
...
- [Come abilitare le impostazioni di diagnostica per il log attività di Azure](/azure/azure-monitor) 
