...
$exclusion2 = New-AzApplicationGatewayFirewallExclusionConfig `
   ...
   -Selector "user"
```
Se quindi l'URL **http://www.contoso.com/?user%281%29=fdafdasfda** viene passato a WAF, non valuterà la stringa **fdafdasfda**, ma valuterà comunque il nome del parametro **User %281 %29**. 
