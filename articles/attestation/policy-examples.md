---
title: Esempi di un criterio di Attestazione di Azure
description: Esempi di criteri di Attestazione di Azure.
...
## <a name="signed-policy-for-an-sgx-enclave-with-policyformatjwt"></a>Criterio firmato per un'enclave SGX con PolicyFormat=JWT
