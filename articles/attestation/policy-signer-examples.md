...
## <a name="policy-signer-certificate-content"></a>Contenuto del certificato del firmatario di criteri
...
## <a name="policy-signer-certificates-file-content"></a>Contenuto del file di certificati del firmatario di criteri
