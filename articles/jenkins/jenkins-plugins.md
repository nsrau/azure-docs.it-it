...
|------------------------------------------------------------------------------|
| [Plug-in Servizio app di Azure](https://plugins.jenkins.io/azure-app-service)     | Plug-in Jenkins per distribuire un servizio app Azure (attualmente supporta solo app Web). | 
| [Plug-in di Azure AD](https://plugins.jenkins.io/azure-ad)                       | Plug-in Jenkins che supporta l'autenticazione & autorizzazione tramite Azure Active Directory. | 
...
| [Plug-in di Azure Service Fabric](https://plugins.jenkins.io/service-fabric)     | Plug-in Jenkins per i progetti di Service Fabric Azure per Linux. |
