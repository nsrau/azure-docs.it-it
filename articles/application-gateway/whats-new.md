...
|---------|---------|---------|
| Nomi host con caratteri jolly nei listener (anteprima) | È ora possibile definire nomi host con caratteri jolly in un listener multisito e fino a cinque nomi host per ogni listener. Per altre informazioni, vedere [Nomi host con caratteri jolly nel listener (anteprima)](multiple-site-overview.md#wildcard-host-names-in-listener-preview) | Luglio 2020 |
