...
Nell'esempio precedente è stato creato un gruppo di risorse denominato "appgw-RG" con la località "West US".
...
### <a name="step-2"></a>Passaggio 2
Configurare i pool di indirizzi IP back-end denominati "pool01"e "pool2" con gli indirizzi IP "10.0.1.100, 10.0.1.101,10.0.1.102" per "pool1" e "10.0.1.103, 10.0.1.104, 10.0.1.105" per "pool2".
