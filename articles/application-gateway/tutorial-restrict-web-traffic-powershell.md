...
ms.locfileid: "34356274"
---
# <a name="restrict-web-traffic-with-a-web-application-firewall-using-azure-powershell"></a>Limitare il traffico Web con un web application firewall tramite Azure PowerShell
