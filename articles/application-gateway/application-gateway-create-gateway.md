...
---
# <a name="create-start-or-delete-an-application-gateway"></a>Creare, avviare o eliminare un gateway applicazione
...
> [!NOTE]
> Il cmdlet **Start-AzureApplicationGateway** potrebbe impiegare fino a 15-20 minuti.
> 
> 
