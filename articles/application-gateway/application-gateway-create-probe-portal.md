---
title: Creare un probe personalizzato per un gateway applicazione con il portale | Microsoft Docs
...
> [!IMPORTANT]
> Il nome host non è il nome del server. È il nome dell'host virtuale in esecuzione nel server applicazioni. Il probe viene inviato a http://(host nome):(porta da impostazioni HTTP)/percorsoURL
> 
> 
