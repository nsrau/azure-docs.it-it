...
Per ulteriori informazioni, vedere [terminazione SSL con Key Vault Certificates](key-vault-certs.md).
...
```
> [!NOTE]
> Per il corretto funzionamento della terminazione SSL, è necessario usare il flag-EnableSoftDelete.
