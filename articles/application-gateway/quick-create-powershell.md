...
1. Creare un'interfaccia di rete con [New-AzNetworkInterface](/powershell/module/Az.network/new-Aznetworkinterface). 
2. Creare una configurazione di macchina virtuale con [New-AzVMConfig](/powershell/module/Az.compute/new-Azvmconfig).
3. Creare la macchina virtuale con [New-AzVM](/powershell/module/Az.compute/new-Azvm).
