...
# Creare un probe personalizzato per il gateway applicazione con PowerShell per Gestione risorse di Azure
...
I passaggi seguenti creano una rete virtuale e una subnet per il gateway applicazione.
