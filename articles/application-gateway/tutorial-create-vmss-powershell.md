---
title: Creare un gateway applicazione con un set di scalabilità di macchine virtuali - Azure PowerShell
...
Creare il pool back-end denominato *appGatewayBackendPool* per il gateway applicazione usando [New-AzApplicationGatewayBackendAddressPool](/powershell/module/az.network/new-azapplicationgatewaybackendaddresspool). Configurare le impostazioni per il pool di indirizzi back-end tramite [New-AzApplicationGatewayBackendHttpSettings](/powershell/module/az.network/new-azapplicationgatewaybackendhttpsettings).
...
Ora che è stato creato le risorse di supporto necessarie, specificare i parametri per il gateway applicazione usando [New-AzApplicationGatewaySku](/powershell/module/az.network/new-azapplicationgatewaysku)e quindi crearlo usando [New-AzApplicationGateway](/powershell/module/az.network/new-azapplicationgateway).
...
![Testare l'URL di base nel gateway applicazione](./media/tutorial-create-vmss-powershell/tutorial-iistest.png)
