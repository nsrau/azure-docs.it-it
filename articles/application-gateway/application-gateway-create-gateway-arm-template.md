...
---
title: Creare un gateway applicazione usando il modello di Gestione risorse di Azure | Microsoft Docs
...
1. Controllare il contenuto in **resources** e prendere nota di quanto segue:
...
2. Tornare a [https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create/](https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create).
3. Fare clic su **azuredeploy-parameters.json** e quindi su **RAW**.
4. Salvare il file in una cartella locale nel computer.
5. Aprire il file salvato e modificare i valori dei parametri. Usare i valori riportati di seguito per la distribuzione del gateway applicazione descritto in questo scenario.
...
6. Salvare il file. È possibile testare il modello JSON e il modello di parametri usando strumenti online di convalida di JSON come [JSlint.com](http://www.jslint.com/).
