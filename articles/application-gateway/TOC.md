...
# Procedure
## Creare un gateway applicazione con VMSS
### [Azure PowerShell](tutorial-create-vmss-powershell.md)
### [Interfaccia della riga di comando di Azure](tutorial-create-vmss-cli.md)
## [Usare un modello](application-gateway-create-gateway-arm-template.md)
...
### [Interfaccia della riga di comando di Azure](application-gateway-create-url-route-cli.md)
