<properties title="Elenco di controllo di prestazioni e scalabilit&agrave; per Archiviazione di Microsoft Azure" pageTitle="Elenco di controllo di prestazioni e scalabilit&agrave; per Archiviazione di Microsoft Azure" description="Obbligatorio" metaKeywords="Optional" services="Optional" solutions="Optional" documentationCenter="Optional" authors="Tamra Myers" videoId="Optional" scriptId="Optional" />
...
Il servizio File di Azure è attualmente in Anteprima, ma in futuro è prevista l'aggiunta di procedure comprovate.
...
<thead>
<tr class="header">
<th align="left">Operazione completata</th>
...
<tr class="odd">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Obiettivi di scalabilità</td>
<td align="left"><a href="#subheading1">L'applicazione è progettata per evitare di raggiungere gli obiettivi di scalabilità?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Rete</td>
<td align="left"><a href="#subheading2">I dispositivi sul lato client hanno una larghezza di banda sufficientemente alta e una latenza sufficientemente bassa per raggiungere le prestazioni richieste?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Rete</td>
<td align="left"><a href="#subheading3">I dispositivi sul lato client hanno un collegamento di qualità adeguata?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Rete</td>
<td align="left"><a href="#subheading4">L'applicazione client è &quot;accanto&quot; all'account di archiviazione?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Distribuzione del contenuto</td>
<td align="left"><a href="#subheadin5">Viene usata una rete CDN per la distribuzione del contenuto?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Accesso client diretto</td>
<td align="left"><a href="#subheading6">Si stanno usando le firme di accesso condiviso (SAS) e la condivisione risorse tra le origini (CORS) al posto del proxy per consentire l'accesso diretto all'archiviazione?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Memorizzazione nella cache</td>
<td align="left"><a href="#subheading7">L'applicazione sta memorizzando nella cache i dati usati di frequente e modificati raramente?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Memorizzazione nella cache</td>
<td align="left"><a href="#subheading8">L'applicazione sta creando batch di aggiornamenti (memorizzandoli nella cache sul lato client e caricandoli in set più grandi)?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Configurazione .NET</td>
<td align="left"><a href="#subheading9">Il client è stato configurato per usare un numero sufficiente di connessioni simultanee?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Configurazione .NET</td>
<td align="left"><a href="#subheading10">.NET è stato configurato per usare un numero sufficiente di thread?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Configurazione .NET</td>
<td align="left"><a href="#subheading11">Si sta usando .NET 4.5 o versione successiva, che dispone di una funzionalità migliorata di Garbage Collection?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Parallelismo</td>
<td align="left"><a href="#subheading12">È stata verificata la corretta associazione del parallelismo in modo da non sovraccaricare le capacità del client o gli obiettivi di scalabilità?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Strumenti</td>
<td align="left"><a href="#subheading13">Si sta usando l'ultima versione delle librerie e degli strumenti client forniti da Microsoft?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Tentativi</td>
<td align="left"><a href="#subheading14">Si sta usando un criterio per l'esecuzione di nuovi tentativi per il backoff esponenziale per gli errori di limitazione e i timeout?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tutti i servizi</td>
<td align="left">Tentativi</td>
<td align="left"><a href="#subheading15">L'applicazione sta evitando nuovi tentativi in caso di errori irreversibili?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">BLOB</td>
<td align="left">Obiettivi di scalabilità</td>
<td align="left"><a href="#subheading16">L'applicazione sta restando all'interno della larghezza di banda o dell'obiettivo di scalabilità delle operazioni per un singolo BLOB?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">BLOB</td>
<td align="left">Copia dei BLOB</td>
<td align="left"><a href="#subheading17">La copia dei BLOB sta avvenendo in modo efficace?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">BLOB</td>
<td align="left">Copia dei BLOB</td>
<td align="left"><a href="#subheading18">Si sta usando AzCopy per le copie bulk dei BLOB?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">BLOB</td>
<td align="left">Copia dei BLOB</td>
<td align="left"><a href="#subheading19">Si sta usando Importazione/Esportazione di Azure per trasferire volumi di dati molto grandi?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">BLOB</td>
<td align="left">Usare i metadati</td>
<td align="left"><a href="#subheading20">Si stanno archiviando i metadati usati di frequente relativi ai BLOB nei rispettivi metadati?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">BLOB</td>
<td align="left">Caricamento rapido</td>
<td align="left"><a href="#subheading21">Quando si tenta di caricare rapidamente un BLOB, i blocchi vengono caricati in parallelo?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">BLOB</td>
<td align="left">Caricamento rapido</td>
<td align="left"><a href="#subheading22">Quando si tenta di caricare rapidamente più BLOB, i BLOB vengono caricati in parallelo?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">BLOB</td>
<td align="left">Tipo di BLOB corretto</td>
<td align="left"><a href="#subheading23">Si stanno usando BLOB di pagine o in blocchi quando appropriato?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Obiettivi di scalabilità</td>
<td align="left"><a href="#subheading24">Si stanno raggiungendo gli obiettivi di scalabilità per le entità al secondo?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Configurazione</td>
<td align="left"><a href="#subheading25">Si sta usando JSON per le richieste della tabella?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Configurazione</td>
<td align="left"><a href="#subheading26">Nagle è stato disattivato per migliorare le prestazioni per le piccole richieste?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Tabelle e partizioni</td>
<td align="left"><a href="#subheading27">I dati sono stati partizionati correttamente?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Partizioni critiche</td>
<td align="left"><a href="#subheading28">Si stanno evitando i modelli Solo accodamenti e Solo anteposizioni?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Partizioni critiche</td>
<td align="left"><a href="#subheading29">Gli inserimenti/aggiornamenti sono distribuiti in più partizioni?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Ambito delle query</td>
<td align="left"><a href="#subheading30">Lo schema è stato progettato per consentire l'uso delle query di tipo punto nella maggior parte dei casi e delle query sulle tabelle solo in casi limitati?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Densità delle query</td>
<td align="left"><a href="#subheading31">Le query in genere analizzano e restituiscono solo le righe usate dall'applicazione?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Limitazione dei dati restituiti</td>
<td align="left"><a href="#subheading32">Vengono usati dei filtri per evitare che vengano restituite entità non necessarie?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Limitazione dei dati restituiti</td>
<td align="left"><a href="#subheading33">Viene usata la proiezione per evitare che vengano restituite proprietà non necessarie?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Denormalizzazione</td>
<td align="left"><a href="#subheading34">I dati sono stati denormalizzati in modo da evitare query non efficaci o più richieste di lettura quando si tenta di ottenere i dati?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Inserimento/aggiornamento/eliminazione</td>
<td align="left"><a href="#subheading35">Si stanno creando dei batch per le richieste che devono essere transazionali o che possono essere eseguite simultaneamente per ridurre i round-trip?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Inserimento/aggiornamento/eliminazione</td>
<td align="left"><a href="#subheading36">Si sta evitando di recuperare un'entità solo per determinare se chiamare un inserimento o un aggiornamento?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Inserimento/aggiornamento/eliminazione</td>
<td align="left"><a href="#subheading37">È stata considerata l'archiviazione di serie di dati che vengono spesso recuperate insieme in una singola entità sotto forma di proprietà invece che in più entità?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Tabelle</td>
<td align="left">Inserimento/aggiornamento/eliminazione</td>
<td align="left"><a href="#subheading38">Per le entità recuperate sempre insieme e che possono essere scritte in batch (ad esempio, dati di serie temporali) è stato valutato l'uso di BLOB invece che di tabelle?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Code</td>
<td align="left">Obiettivi di scalabilità</td>
<td align="left"><a href="#subheading39">Si stanno raggiungendo gli obiettivi di scalabilità per i messaggi al secondo?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Code</td>
<td align="left">Configurazione</td>
<td align="left"><a href="#subheading40">Nagle è stato disattivato per migliorare le prestazioni per le piccole richieste?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Code</td>
<td align="left">Dimensioni del messaggio</td>
<td align="left"><a href="#subheading41">I messaggi vengono compattati per migliorare le prestazioni della coda?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Code</td>
<td align="left">Recupero bulk</td>
<td align="left"><a href="#subheading41">Si stanno recuperando più messaggi con un'unica operazione &quot;Get&quot;?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Code</td>
<td align="left">Frequenza di polling</td>
<td align="left"><a href="#subheading42">Il polling viene eseguito abbastanza di frequente per ridurre la latenza percepita dell'applicazione?</a></td>
</tr>
<tr class="even">
<td align="left"></td>
<td align="left">Code</td>
<td align="left">Aggiornamento del messaggio</td>
<td align="left"><a href="#subheading43">Si sta usando UpdateMessage per archiviare lo stato di elaborazione dei messaggi senza dover rielaborare l'intero messaggio in caso di errori?</a></td>
</tr>
<tr class="odd">
<td align="left"></td>
<td align="left">Code</td>
<td align="left">Architettura</td>
<td align="left"><a href="#subheading44">Si stanno usando delle code per rendere più scalabile l'intera applicazione tenendo i carichi di lavoro con esecuzione prolungata fuori dal percorso critico e scalandoli indipendentemente?</a></td>
</tr>
</tbody>
</table>
...
-   [Larghezza di banda BLOB e richieste al secondo][L'applicazione sta restando all'interno della larghezza di banda o dell'obiettivo di scalabilità delle operazioni per un singolo BLOB?]
-   [Entità di tabella al secondo][Si stanno raggiungendo gli obiettivi di scalabilità per le entità al secondo?]
-   [Messaggi della coda al secondo][Si stanno raggiungendo gli obiettivi di scalabilità per i messaggi al secondo?]

#### <a name="sub1bandwidth"></a>Obiettivo di scalabilità della larghezza di banda per tutti i servizi

Al momento della redazione di questo documento, gli obiettivi di larghezza di banda negli Stati Uniti per un account di archiviazione con ridondanza geografica (GRS) sono di 10 gigabit al secondo (Gbps) in ingresso (dati inviati all'account di archiviazione) e di 20 Gbps in uscita (dati inviati dall'account di archiviazione). Per un account di archiviazione con ridondanza locale (LRS), i limiti sono più alti: 20 Gbps in ingresso e 30 Gbps in uscita. I limiti di larghezza di banda internazionali possono essere inferiori e possono essere visualizzati nella [pagina degli obiettivi di scalabilità][pagina degli obiettivi di scalabilità]. Per altre informazioni sulle opzioni di ridondanza dell'archiviazione, vedere i collegamenti nella sezione seguente [Risorse utili][Risorse utili].

#### Cosa fare quando si raggiunge un obiettivo di scalabilità
...
-   Se l'applicazione raggiunge gli obiettivi di scalabilità, assicurarsi di usare un backoff esponenziale per i nuovi tentativi (vedere [Tentativi][Si sta usando un criterio per l'esecuzione di nuovi tentativi per il backoff esponenziale per gli errori di limitazione e i timeout?]). È meglio cercare di non raggiungere mai gli obiettivi di scalabilità (usando uno dei metodi descritti), tuttavia questo comporta che l'applicazione non riprende a eseguire rapidamente nuovi tentativi, peggiorando così la limitazione.

#### Risorse utili

I seguenti collegamenti forniscono ulteriori dettagli sugli obiettivi di scalabilità:

-   È possibile visualizzare gli obiettivi di scalabilità correnti nella pagina [Obiettivi di scalabilità e prestazioni di Azure in MSDN][pagina degli obiettivi di scalabilità].
-   Per altre informazioni sulle opzioni di ridondanza dell'archiviazione, vedere il post del blog relativo alle [opzioni di ridondanza e all'archiviazione ridondante con accesso in lettura e ridondanza geografica del servizio di archiviazione di Microsoft Azure][opzioni di ridondanza e all'archiviazione ridondante con accesso in lettura e ridondanza geografica del servizio di archiviazione di Microsoft Azure]. Vedere la sezione seguente per altri dettagli.
-   Per informazioni correnti sui prezzi dei servizi Azure, vedere [Panoramica dei prezzi di Azure][Panoramica dei prezzi di Azure].
...
Per altre informazioni sulle dimensioni delle macchine virtuali e sulla larghezza di banda allocata, vedere [Procedure consigliate per la progettazione di servizi su larga scala nei servizi cloud di Azure][Procedure consigliate per la progettazione di servizi su larga scala nei servizi cloud di Azure] in MSDN.
...
Per altre informazioni sulla rete CDN di Azure, vedere [rete CDN di Azure][rete CDN di Azure].
...
Per altre informazioni sulle firme di accesso condiviso, vedere [Firme di accesso condiviso, parte 1: informazioni sul modello di firma di accesso condiviso][Firme di accesso condiviso, parte 1: informazioni sul modello di firma di accesso condiviso].

Per altre informazioni sulla condivisione risorse tra le origini, vedere [Supporto della condivisione delle risorse tra le origini (CORS) per i servizi di archiviazione Azure in MSDN][Supporto della condivisione delle risorse tra le origini (CORS) per i servizi di archiviazione Azure in MSDN].
...
Per un esempio di come recuperare le proprietà di un BLOB per individuare la data dell'ultima modifica con .NET, vedere [Impostare e recuperare proprietà e metadati][Impostare e recuperare proprietà e metadati] in MSDN. Per altre informazioni sui download condizionali, vedere [Aggiornare una copia locale di un Blob in modo condizionale][Aggiornare una copia locale di un Blob in modo condizionale] in MSDN.
...
#### <a name="subheading9"></a>Aumentare il limite di connessione predefinito
...
Per altre informazioni, vedere il post [Servizi Web: connessioni simultanee][Servizi Web: connessioni simultanee] in MSDN.
...
Per altre informazioni, vedere il [metodo ThreadPool.SetMinThreads][metodo ThreadPool.SetMinThreads] in MSDN.

#### <a name="subheading11"></a>Sfruttare la funzionalità Garbage Collection di .NET 4.5
...
Per altre informazioni, vedere l'articolo [Panoramica dei miglioramenti delle prestazioni in .NET 4.5][Panoramica dei miglioramenti delle prestazioni in .NET 4.5] in MSDN.
...
Per altre informazioni sui codici di errore di archiviazione, vedere [Codici ed errori di stato][Codici ed errori di stato] nel sito Web di Microsoft Azure.

## BLOB

Oltre alle procedure comprovate per [Tutti i servizi][Tutti i servizi] descritte prima, le seguenti procedure comprovate si applicano specificamente al servizio BLOB.
...
Per altre informazioni sulla velocità effettiva da raggiungere per i BLOB, vedere [Obiettivi di scalabilità e prestazioni di Azure][pagina degli obiettivi di scalabilità] in MSDN.

### Copia e spostamento dei BLOB

#### <a name="subheading17"></a>Copiare i BLOB
...
Per un esempio su come recuperare i metadati di un BLOB con .NET, vedere [Impostare e recuperare proprietà e metadati][Impostare e recuperare proprietà e metadati] in MSDN.

### Caricamento rapido

Per caricare rapidamente i BLOB, la prima domanda a cui rispondere è: si sta caricando un solo BLOB o più di uno? Usare le indicazioni seguenti per determinare il metodo corretto da usare a seconda dello scenario.
...
Per altre informazioni, vedere [Informazioni sui Blob in blocchi e sui Blob di pagine][Informazioni sui Blob in blocchi e sui Blob di pagine] in MSDN.

## Tabelle

Oltre alle procedure comprovate per [Tutti i servizi][Tutti i servizi] descritte prima, le seguenti procedure comprovate si applicano specificamente al servizio tabelle.
...
Per altre informazioni, vedere il post sulle [tabelle di Microsoft Azure: introduzione di JSON][tabelle di Microsoft Azure: introduzione di JSON] e [Formato di payload per le operazioni del servizio tabelle][Formato di payload per le operazioni del servizio tabelle] in MSDN.
...
Per altre informazioni, vedere il post del blog relativo al [comportamento dell'algoritmo Nagle nei confronti delle piccole richieste][comportamento dell'algoritmo Nagle nei confronti delle piccole richieste] che spiega il motivo per cui l'algoritmo Nagle interagisce in modo poco efficace con le richieste relative a tabelle e code e che mostra come disabilitarlo nell'applicazione client.
...
You can view the current scalability targets on the page [Azure Storage Scalability and Performance Targets][pagina degli obiettivi di scalabilità] on MSDN.
...
Per altre informazioni, vedere l'articolo [Procedura: Cambiare il contenuto di un messaggio in coda][Procedura: Cambiare il contenuto di un messaggio in coda].

### <a name=subheading45"></a>Architettura dell'applicazione</h3> <p>Usare le code per rendere scalabile l'architettura dell'applicazione. Di seguito vengono elencati alcuni modi con cui le code possono essere usate per rendere più scalabile l'applicazione:</p> <ul> <li>Le code possono essere usate per creare backlog di lavoro per l'elaborazione e il contenimento dei carichi di lavoro nell'applicazione. Ad esempio, è possibile accodare le richieste degli utenti per eseguire un lavoro che prevede un utilizzo intensivo del processore, ad esempio il ridimensionamento delle immagini caricate.</li> <li>È possibile usare le code per separare i componenti dell'applicazione in modo da eseguirne la scalabilità in modo indipendente. Ad esempio, un front-end Web può inserire i risultati di un sondaggio degli utenti in una coda per l'analisi e l'archiviazione successive. È possibile aggiungere più istanze del ruolo di lavoro per elaborare i dati della coda come richiesto.</li> </ul> <h2 id="conclusion">Conclusioni</h2> <p>In questo articolo sono state descritte alcune delle procedure comprovate più comuni per l'ottimizzazione delle prestazioni durante l'uso dell'archiviazione di Azure. Si consiglia a tutti gli sviluppatori di applicazioni di valutare la propria applicazione in base alle procedure descritte sopra e di prendere in considerazione l'attuazione di alcune misure per migliorare le prestazioni delle applicazioni che usano l'archiviazione di Azure.</p>

  [Si sta usando un criterio per l'esecuzione di nuovi tentativi per il backoff esponenziale per gli errori di limitazione e i timeout?]: #subheading14
  [L'applicazione sta restando all'interno della larghezza di banda o dell'obiettivo di scalabilità delle operazioni per un singolo BLOB?]: #subheading16
  [Si sta usando AzCopy per le copie bulk dei BLOB?]: #subheading18
  [Si stanno raggiungendo gli obiettivi di scalabilità per le entità al secondo?]: #subheading24
  [Lo schema è stato progettato per consentire l'uso delle query di tipo punto nella maggior parte dei casi e delle query sulle tabelle solo in casi limitati?]: #subheading30
  [I dati sono stati denormalizzati in modo da evitare query non efficaci o più richieste di lettura quando si tenta di ottenere i dati?]: #subheading34
  [Si stanno raggiungendo gli obiettivi di scalabilità per i messaggi al secondo?]: #subheading39
  [pagina degli obiettivi di scalabilità]: http://msdn.microsoft.com/it-it/library/azure/dn249410.aspx
  [Risorse utili]: #sub1useful
  [opzioni di ridondanza e all'archiviazione ridondante con accesso in lettura e ridondanza geografica del servizio di archiviazione di Microsoft Azure]: http://blogs.msdn.com/b/windowsazurestorage/archive/2013/12/11/introducing-read-access-geo-replicated-storage-ra-grs-for-windows-azure-storage.aspx
  [Panoramica dei prezzi di Azure]: http://azure.microsoft.com/it-it/pricing/overview/
  [obiettivi di scalabilità della larghezza di banda]: #sub1bandwidth
  [Procedure consigliate per la progettazione di servizi su larga scala nei servizi cloud di Azure]: http://msdn.microsoft.com/it-it/library/dn197896.aspx
  [rete CDN di Azure]: http://azure.microsoft.com/it-it/services/cdn/
  [Firme di accesso condiviso, parte 1: informazioni sul modello di firma di accesso condiviso]: http://azure.microsoft.com/it-it/documentation/articles/storage-dotnet-shared-access-signature-part-1/
  [Supporto della condivisione delle risorse tra le origini (CORS) per i servizi di archiviazione Azure in MSDN]: http://msdn.microsoft.com/library/azure/dn535601.aspx
  [Impostare e recuperare proprietà e metadati]: http://msdn.microsoft.com/it-it/library/hh225342.aspx
  [Aggiornare una copia locale di un Blob in modo condizionale]: http://msdn.microsoft.com/it-it/library/azure/dd179371.aspx
  [Servizi Web: connessioni simultanee]: http://blogs.msdn.com/b/darrenj/archive/2005/03/07/386655.aspx
  [metodo ThreadPool.SetMinThreads]: http://msdn.microsoft.com/it-it/library/system.threading.threadpool.setminthreads(v=vs.110).aspx
  [Panoramica dei miglioramenti delle prestazioni in .NET 4.5]: http://msdn.microsoft.com/it-it/magazine/hh882452.aspx
  [Codici ed errori di stato]: http://msdn.microsoft.com/it-it/library/azure/dd179382.aspx
  [Tutti i servizi]: #allservices
  [Copy Blob in MSDN]: http://msdn.microsoft.com/it-it/library/dd894037.aspx
  [qui]: http://azure.microsoft.com/it-it/documentation/articles/storage-use-azcopy/
  [2]: http://azure.microsoft.com/it-it/documentation/articles/storage-import-export-service/
  [Informazioni sui Blob in blocchi e sui Blob di pagine]: http://msdn.microsoft.com/it-it/library/azure/ee691964.aspx
  [tabelle di Microsoft Azure: introduzione di JSON]: http://blogs.msdn.com/b/windowsazurestorage/archive/2013/12/05/windows-azure-tables-introducing-json.aspx
  [Formato di payload per le operazioni del servizio tabelle]: http://msdn.microsoft.com/it-it/library/azure/dn535600.aspx
  ...
  [Storage Pricing Details]: http://azure.microsoft.com/it-it/pricing/details/storage/
  [Procedura: Cambiare il contenuto di un messaggio in coda]: http://azure.microsoft.com/it-it/documentation/articles/storage-dotnet-how-to-use-queues/#change-contents
