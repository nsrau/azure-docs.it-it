...
2.	Andare a "Web e dispositivi mobili > App per le API" e cercare "Twilio Connector".
3.	Configurare Twilio Connector nel modo seguente:
	...
	- **Name** - Assegnare un nome per Twilio Connector
	- **Impostazioni pacchetto**
		- **Account SID** - Identificatore univoco dell'account. È possibile recuperare il SID del proprio account da https://www.twilio.com/user/account/settings 
...
4.	Fare clic su Create. Verrà creato un nuovo Twilio Connector.
...
## Usare Twilio Connector nell'app per la logica ##
...
5.	È ora possibile usare Twilio Connector nel flusso. È possibile usare l'azione "Send Message" nel flusso per inviare un messaggio. Configurare le proprietà di input per l'azione "Send Message" nel modo indicato di seguito:
	...
	- **To Phone Number** - Numero di telefono di destinazione. Il formato accettato è: +, seguito dal codice del paese, quindi dal numero di telefono. Ad esempio, +16175551212. Se si omette il segno +, Twilio utilizzerà il codice paese immesso in  'From Phone Number'.
