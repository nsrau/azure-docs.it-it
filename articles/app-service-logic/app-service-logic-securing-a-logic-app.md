---
title: Protezione di un&quot;app per la logica di Azure | Microsoft Docs
description: Proteggere input, accesso e controllo di un&quot;app per la logica di Azure
services: logic-apps
...
Se si usa un [modello di distribuzione](app-service-logic-create-deploy-template.md) per automatizzare le distribuzioni, le impostazioni dell'intervallo IP possono essere configurate nel modello risorsa.  
...
[Creare un modello di distribuzione](app-service-logic-create-deploy-template.md)  
[Gestione delle eccezioni](app-service-logic-exception-handling.md)  
[Monitorare le app per la logica](app-service-logic-monitor-your-logic-apps.md)  
[Diagnosi degli errori delle app per la logica](app-service-logic-diagnosing-failures.md)  
