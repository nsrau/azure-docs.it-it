...
Dopo aver selezionato uno dei modelli, completare la distribuzione. La procedura è analoga a quella per la distribuzione di una app per la logica creata dall'utente.  Vedere l'articolo relativo alla [creazione di un'app per la logica](app-service-logic-create-a-logic-app.md).
