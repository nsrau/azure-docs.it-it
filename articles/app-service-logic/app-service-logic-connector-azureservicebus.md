---
title: Uso del connettore Azure Service Bus nelle app per la logica | Microsoft Docs
...
> [!NOTE]
> Questa versione dell'articolo si applica alla versione dello schema 2014-12-01-preview delle app per la logica. Per la versione dello schema 2015-08-01-preview, fare clic su [API del bus di servizio](../connectors/connectors-create-api-servicebus.md).
> 
> 
