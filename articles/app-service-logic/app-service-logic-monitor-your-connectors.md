---
title: Gestire e monitorare le app per le API e i connettori nel servizio app | Microsoft Docs
...
> [!NOTE]
> Gestione connessione ibrida è necessario solo se ci si connette a una risorsa locale protetta da un firewall. Se non ci si connette a un sistema locale, Gestione connessione ibrida potrebbe non essere presente nel pannello del connettore.
> 
> 
...
> [!IMPORTANT]
> Quando si visualizzano le proprietà dell'app per le API, in **Informazioni di base** sono presenti i collegamenti **Host** e **Gateway** che aprono nuovi pannelli:
> 
> ![][host]
> 
