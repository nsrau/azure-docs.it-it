...
1. Esecuzione di un'azione **For Each** sugli output **Matrice filtrata**.  Verrà così eseguita un'azione *per ogni* risultato di azione non riuscita precedentemente filtrato.
