...
* Per usare il connettore Decode X12 Message, è necessario un account di integrazione. Vedere i dettagli su come creare un [account di integrazione](app-service-logic-enterprise-integration-create-integration-account.md), [partner](app-service-logic-enterprise-integration-partners.md) e un [contratto X12](app-service-logic-enterprise-integration-x12.md)
