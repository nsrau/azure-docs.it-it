<properties urlDisplayName="Call a custom API from the client" pageTitle="Chiamata di un'API personalizzata da un client di Windows Store - Servizi mobili" metaKeywords="" description="Informazioni su come definire un'API personalizzata e quindi chiamarla da un'app di Windows Store che usa Servizi mobili di Azure." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Call a custom API from the client" authors="glenga" solutions="" manager="dwrede" editor="" />
