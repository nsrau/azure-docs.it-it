...
-   [Definizione di un'API personalizzata che supporta le notifiche periodiche](/en-us/documentation/articles/mobile-services-windows-store-dotnet-create-pull-notifications)
