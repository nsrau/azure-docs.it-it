...
description: Creare una pianificazione ed eseguire processi automatizzati che chiamano servizi all'interno o all'esterno di AzureCreate schedule, and run automated jobs that call services inside or outside Azure
services: scheduler
...
Per creare, pianificare, gestire, aggiornare o eliminare processi e raccolte di [processi,](../scheduler/scheduler-concepts-terms.md)è possibile utilizzare il codice, [l'API REST](https://docs.microsoft.com/rest/api/scheduler/)dell'utilità di pianificazione o i [cmdlet PowerShell dell'utilità](scheduler-powershell-reference.md)di pianificazione di Azure.
