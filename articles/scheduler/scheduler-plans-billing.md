...
Se si dispone di una raccolta di processi standard e premium di un processo insieme, sono fatturate un'unità di fatturazione standard *e* un'unità di fatturazione premium. Gli effetti del servizio Utilità di pianificazione in base al numero di raccolte di processi attivi impostati su standard o premium; questo viene illustrato più dettagliatamente in due sezioni successive.
