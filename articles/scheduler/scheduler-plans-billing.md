...
Le raccolte di processi sono sempre attive, a meno che l'intera sottoscrizione entri in uno stato di disabilitazione temporanea a causa di problemi di fatturazione. È l'unico modo per assicurarsi che non viene addebitata una raccolta di processi per impostarlo sul _Free_ piano o di eliminare la raccolta di processi.
