...
Raccolte di processi sono entità fatturabili nell'utilità di pianificazione di Azure. Le raccolte di processi contengono numerosi processi e sono disponibili in tre piani descritti di seguito: Standard, P10 Premium e P20 Premium.
...
È possibile aggiornare o effettuare il downgrade di un piano di una raccolta di processi in qualsiasi momento tra i piani Standard, P10 Premium e P20 Premium.

## <a name="billing-and-azure-plans"></a>Piani di fatturazione e Azure
Se si dispone di più di 100 raccolte di processi standard (10 unità fatturazione standard), è un ottimo affare affinché tutte le raccolte di processi nel piano premium.
