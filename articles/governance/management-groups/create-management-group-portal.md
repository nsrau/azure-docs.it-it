---
title: 'Avvio rapido: Creare un gruppo di gestione con il portale'
...
1. Selezionare **+ Aggiungi gruppo di gestione**.
   ...
   :::image type="content" source="./media/main.png" alt-text="Pagina per l'uso dei gruppi di gestione" border="false":::
...
1. Lasciare selezionata l'opzione **Crea nuovo** e compilare il campo ID gruppo di gestione.
   ...
   :::image type="content" source="./media/create_context_menu.png" alt-text="Riquadro di opzioni per la creazione di un nuovo gruppo di gestione":::
