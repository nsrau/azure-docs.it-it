...
Il primo passaggio per usare Azure Resource Graph richiede di assicurarsi che il modulo per Azure PowerShell sia installato. Questa guida introduttiva illustra il processo di aggiunta del modulo all'installazione di Azure PowerShell.
...
Per consentire ad Azure PowerShell di eseguire query su Azure Resource Graph, il modulo deve essere aggiunto. Questo modulo può essere usato con Windows PowerShell e PowerShell Core installati in locale e anche l'[immagine Docker di Azure PowerShell](https://hub.docker.com/r/azuresdk/azure-powershell/).
...
- PowerShellGet. Se non è installato o aggiornato, seguire [queste istruzioni](/powershell/gallery/installing-psget).
...
1. Verificare che il modulo sia stato importato e che la versione sia corretta, ovvero sia la 0.2.0:
...
1. Verificare che il modulo sia stato importato e che la versione sia corretta, ovvero sia la 0.1.0 anteprima:
