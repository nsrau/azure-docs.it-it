---
title: Esempio - Progetto ISO 27001 - Procedura per la distribuzione
description: Procedura per la distribuzione dell'esempio di progetto ISO 27001.
author: DCtheGeek
ms.author: dacoulte
ms.date: 07/22/2019
ms.topic: sample
...
Dopo aver esaminato la procedura per la distribuzione dell'esempio di progetto ISO 27001, vedere gli articoli seguenti per informazioni sull'architettura e sul mapping dei controlli:
