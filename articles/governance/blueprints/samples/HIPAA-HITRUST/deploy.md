...
Per distribuire l'esempio di progetto HIPAA HITRUST, seguire questa procedura:
...
Dopo aver esaminato la procedura per la distribuzione dell'esempio di progetto HITRUST HIPAA, vedere gli articoli seguenti per informazioni generali e sul mapping dei controlli:

> [!div class="nextstepaction"]
> [Progetti HITRUST HIPAA - Panoramica](./index.md)
> [Progetti HITRUST HIPAA - Mapping dei controlli](./control-mapping.md)
