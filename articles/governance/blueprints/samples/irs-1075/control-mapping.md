...
description: Mapping dei controlli dell'esempio di progetto IRS 1075. Ogni controllo è mappato a una o più definizioni di Criteri di Azure che assistono nella valutazione.
ms.date: 08/19/2020
ms.topic: sample
