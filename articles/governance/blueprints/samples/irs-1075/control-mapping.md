---
title: Esempio - Progetto IRS 1075 - Mapping dei controlli
description: Mapping dei controlli dell'esempio di progetto IRS 1075 in Criteri di Azure.
author: DCtheGeek
ms.author: dacoulte
ms.date: 08/07/2019
ms.topic: sample
...
## <a name="9321-ac-2-account-management"></a>9.3.2.1 AC-2 Gestione degli account
...
## <a name="9321-ac-2-7-account-management--role-based-schemes"></a>9.3.2.1 AC-2 (7) Gestione degli account | Schemi basati sui ruoli
...
## <a name="9321-ac-2-12-account-management--account-monitoring--atypical-usage"></a>9.3.2.1 AC-2 (12) Gestione degli account | Monitoraggio/Utilizzo atipico degli account
...
## <a name="9314-ac-4-information-flow-enforcement"></a>9.3.1.4 AC-4 Imposizione del controllo dei flussi di informazioni
...
## <a name="9315-ac-5-separation-of-duties"></a>9.3.1.5 AC-5 Separazione dei compiti
...
## <a name="9316-ac-6-7-least-privilege--review-of-user-privileges"></a>9.3.1.6 AC-6 (7) Privilegi minimi | Revisione dei privilegi degli utenti
...
## <a name="93112-ac-17-1-remote-access--automated-monitoring--control"></a>9.3.1.12 AC-17 (1) Accesso remoto | Monitoraggio/Controllo automatico
...
## <a name="9313-au-3-2-content-of-audit-records--centralized-management-of-planned-audit-record-content"></a>9.3.1.3 AU-3 (2) Contenuto dei record di controllo | Gestione centralizzata del contenuto dei record di controllo pianificati
...
## <a name="9335-au-5-response-to-audit-processing-failures"></a>9.3.3.5 AU-5 Risposta a errori di elaborazione di controllo
...
## <a name="9336-au-6-4-audit-review-analysis-and-reporting--central-review-and-analysis"></a>9.3.3.6 AU-6 (4) Verifica, analisi e report di controllo | Verifica e analisi centralizzate
...
## <a name="93311-au-12-audit-generation"></a>9.3.3.11 AU-12 Generazione di controlli
...
## <a name="9366-cp-7-alternate-processing-site"></a>9.3.6.6 CP-7 Sito di elaborazione alternativo
...
## <a name="9372-ia-2-1-identification-and-authentication-organizational-users--network-access-to-privileged-accounts"></a>9.3.7.2 IA-2 (1) Identificazione e autenticazione (utenti dell'organizzazione) | Accesso alla rete per gli account con privilegi
...
## <a name="9372-ia-2-2-identification-and-authentication-organizational-users--network-access-to-non-privileged-accounts"></a>9.3.7.2 IA-2 (2) Identificazione e autenticazione (utenti dell'organizzazione) | Accesso alla rete per gli account senza privilegi
...
## <a name="9375-ia-5-authenticator-management"></a>9.3.7.5 IA-5 Gestione degli autenticatori
...
## <a name="9375-ia-5-1-authenticator-management--password-based-authentication"></a>9.3.7.5 IA-5 (1) Gestione autenticatori | Autenticazione basata su password
...
## <a name="93143-ra-5-vulnerability-scanning"></a>9.3.14.3 RA-5 Analisi delle vulnerabilità
...
## <a name="93164-sc-5-denial-of-service-protection"></a>9.3.16.4 SC-5 Protezione da attacchi Denial of Service
...
## <a name="93165-sc-7-boundary-protection"></a>9.3.16.5 SC-7 Protezione dei limiti
...
## <a name="93165-sc-7-3-boundary-protection--access-points"></a>9.3.16.5 SC-7 (3) Protezione dei limiti | Punti di accesso
...
## <a name="93165-sc-7-4-boundary-protection--external-telecommunications-services"></a>9.3.16.5 SC-7 (4) Protezione dei limiti | Servizi di telecomunicazione esterni
...
## <a name="96163-sc-8-1-transmission-confidentiality-and-integrity--cryptographic-or-alternate-physical-protection"></a>9.6.16.3 Riservatezza e integrità delle trasmissioni SC-8 (1) | Protezione crittografica o fisica in alternativa
...
## <a name="93166-sc-28-1-protection-of-information-at-rest--cryptographic-protection"></a>9.3.16.6 SC-28 (1) Protezione delle informazioni inattive | Protezione crittografica
...
## <a name="93172-si-2-flaw-remediation"></a>9.3.17.2 SI-2 Correzione degli errori
...
## <a name="93173-si-3-malicious-code-protection"></a>9.3.17.3 SI-3 Protezione dal malware
...
## <a name="93173-si-3-1-malicious-code-protection--central-management"></a>9.3.17.3 SI-3 (1) Protezione dal malware | Gestione centrale
...
## <a name="93174-si-4-information-system-monitoring"></a>9.3.17.4 SI-4 Monitoraggio dei sistemi informativi
...
## <a name="93174-si-4-18-information-system-monitoring--analyze-traffic--covert-exfiltration"></a>9.3.17.4 SI-4 (18) Monitoraggio dei sistemi informativi | Analizzare il traffico/esfiltrazioni nascoste
...
Dopo aver esaminato il mapping dei controlli del progetto IRS 1075, vedere gli articoli seguenti per informazioni sul progetto e su come distribuire questo esempio:
