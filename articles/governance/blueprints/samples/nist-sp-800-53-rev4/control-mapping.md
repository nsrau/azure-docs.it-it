...
description: Mapping dei controlli dell'esempio di progetto NIST SP 800-53 R4 in Criteri di Azure e in Controllo degli accessi in base al ruolo.
author: DCtheGeek
ms.author: dacoulte
ms.date: 06/24/2019
ms.topic: sample
...
- [Anteprima]: Audit external accounts with read permissions on a subscription
...
- [Anteprima]: Audit CORS resource access restrictions for a Web Application
...
- [Anteprima]: Audit remote debugging state for a Function App
- [Anteprima]: Audit remote debugging state for a Web Application
- [Anteprima]: Audit remote debugging state for an API App
- [Anteprima]: Audit that Linux VMs do not allow remote connections from accounts without passwords
- [Anteprima]: Deploy VM extension to audit that Linux VMs do not allow remote connections from accounts without passwords
...
- [Anteprima]: Deploy Log Analytics Agent for Linux VM Scale Sets (set di scalabilità di macchine virtuali)
- [Anteprima]: Deploy Log Analytics Agent for Linux VMs
- [Anteprima]: Deploy Log Analytics Agent for Windows VM Scale Sets (set di scalabilità di macchine virtuali)
...
- [Anteprima]: Monitor unaudited SQL servers in Azure Security Center
...
- [Anteprima]: Audit that Linux VMs do not have accounts without passwords
- [Anteprima]: Deploy VM extension to audit that Linux VMs do not have accounts without passwords
- [Anteprima]: Audit that Linux VMs have the passwd file permissions set to 0644
- [Anteprima]: Audit that Windows VMs store passwords using reversible encryption
- [Anteprima]: Deploy VM extension to audit that Linux VMs have the passwd file permissions set to 0644
...
- [Anteprima]: Audit that Windows VMs cannot re-use the previous 24 passwords
- [Anteprima]: Audit that Windows VMs have a maximum password age of 70 days
- [Anteprima]: Audit that Windows VMs have a minimum password age of 1 day
- [Anteprima]: Audit that Windows VMs have the password complexity setting enabled
- [Anteprima]: Audit that Windows VMs restrict the minimum password length to 14 characters
- [Anteprima]: Audit that Windows VMs store passwords using reversible encryption
- [Anteprima]: Deploy VM extension to audit that Windows VMs cannot re-use the previous 24 passwords
- [Anteprima]: Deploy VM extension to audit that Windows VMs have a maximum password age of 70 days
- [Anteprima]: Deploy VM extension to audit that Windows VMs have a minimum password age of 1 day
- [Anteprima]: Deploy VM extension to audit that Windows VMs have the password complexity setting enabled
- [Anteprima]: Deploy VM extension to audit that Windows VMs restrict the minimum password length to 14 characters
- [Anteprima]: Deploy VM extension to audit that Windows VMs store passwords using reversible encryption
...
- Controlla server SQL senza Sicurezza dei dati avanzata
- Distribuisci Sicurezza dei dati avanzata nei server SQL
- [Anteprima]: Audit OS vulnerabilities on your virtual machine scale sets in Azure Security Center
...
- [Anteprima]: Audit standard tier of DDoS protection is enabled for a virtual network
...
- [Anteprima]: Monitor Internet-facing virtual machines for Network Security Group traffic hardening recommendations
...
- [Anteprima]: Monitor unencrypted SQL databases in Azure Security Center
...
- [Anteprima]: Audit any missing system updates on virtual machine scale sets in Azure Security Center
- [Anteprima]: Audit OS vulnerabilities on your virtual machine scale sets in Azure Security Center
...
- [Anteprima]: Audit the endpoint protection solution on virtual machine scale sets in Azure Security Center
