---
title: Distribuire l'esempio di progetto Azure Security Benchmark
description: Procedura di distribuzione per l'esempio di progetto Azure Security Benchmark, inclusi i dettagli dei parametri degli artefatti del progetto.
ms.date: 05/01/2020
ms.topic: sample
...
ms.locfileid: "82702672"
---
# <a name="deploy-the-azure-security-benchmark-blueprint-sample"></a>Distribuire l'esempio di progetto Azure Security Benchmark
...
|-|-|-|-|
|Controlla le raccomandazioni per Azure Security Benchmark e distribuisce le estensioni di VM di supporto specifiche|Assegnazione di criteri|
Elenco di utenti esclusi dal gruppo di Administrators della macchina virtuale Windows|Elenco delimitato da punto e virgola con i membri da escludere dal gruppo locale Administrators, ad esempio Administrator; utente1; utente2|
...
Dopo aver esaminato i passaggi per distribuire l'esempio di progetto Azure Security Benchmark, leggere gli articoli seguenti per informazioni sul progetto e sul mapping dei controlli:

> [!div class="nextstepaction"]
> [Progetto Azure Security Benchmark - Panoramica](./index.md)
> [Progetto Azure Security Benchmark - Mapping dei controlli](./control-mapping.md)
