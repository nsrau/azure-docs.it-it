---
title: Esempio - Progetto Servizi condivisi ISO 27001 - Mapping dei controlli
description: Mapping dei controlli dell'esempio di progetto Servizi condivisi ISO 27001 in Criteri di Azure e nel controllo degli accessi in base al ruolo.
author: DCtheGeek
ms.author: dacoulte
ms.date: 03/14/2019
ms.topic: sample
...
L'articolo seguente descrive il mapping dell'esempio di progetto Servizi condivisi di ISO 27001 di Azure Blueprints ai controlli ISO 27001. Per altre informazioni sui controlli, vedere [ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).
...
Questo progetto consente di gestire le vulnerabilità dei sistemi informativi assegnando cinque definizioni di [Criteri di Azure](../../../policy/overview.md) che monitorano gli aggiornamenti di sistema mancanti, oltre alle vulnerabilità del sistema operativo, di SQL e delle macchine virtuali. Queste informazioni dettagliate forniscono dati in tempo reale sullo stato di sicurezza delle risorse distribuite e consentono di assegnare priorità alle azioni correttive.
...
Dopo aver esaminato il mapping dei controlli del progetto Servizi condivisi ISO 27001, vedere gli articoli seguenti per informazioni sull'architettura e su come distribuire questo esempio:
