...
description: Questa definizione di criteri di esempio impedisce l'uso di estensioni specificate definite in un parametro nelle macchine virtuali.
ms.date: 01/23/2019
ms.topic: sample
