---
title: 'Esempio: SKU del gateway applicazione consentiti'
description: Questa definizione di criteri di esempio richiede che i gateway applicazione usino uno SKU approvato definito in un parametro.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463757"
---
# <a name="sample---allowed-application-gateway-skus"></a>Esempio: SKU del gateway applicazione consentiti
