...
description: Questa definizione di criteri di esempio garantisce la distribuzione dei soli tipi di risorse approvati definiti in un parametro.
ms.date: 01/23/2019
ms.topic: sample
