...
description: Questa definizione di criteri di esempio verifica le impostazioni di controllo di SQL Server definite in un parametro con auditIfNotExists.
ms.date: 01/23/2019
ms.topic: sample
