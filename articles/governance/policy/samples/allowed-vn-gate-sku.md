---
title: 'Esempio di Criteri di Azure: SKU del gateway di rete virtuale consentiti'
description: Questo esempio di criteri richiede che i gateway di rete virtuale usino uno SKU e un tipo di gateway approvati.
