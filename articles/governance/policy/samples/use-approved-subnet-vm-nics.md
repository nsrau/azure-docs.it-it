---
title: Esempio - Usare una subnet approvata per le schede di interfaccia di rete delle macchine virtuali
description: Questa definizione di criteri di esempio richiede che le interfacce di rete usino una subnet approvata definita in un parametro.
ms.date: 01/23/2019
ms.topic: sample
