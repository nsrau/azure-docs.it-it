---
title: Esempio - Controllare le aree senza Network Watcher
description: Questa definizione di criteri di esempio verifica se Network Watcher non è abilitato per un'area specifica definita in un parametro.
ms.date: 01/23/2019
ms.topic: sample
