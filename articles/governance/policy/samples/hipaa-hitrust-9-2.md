...
### <a name="passwords-are-not-displayed-when-entered"></a>La password immesse non vengono visualizzate.

**ID**: 1002.01d1System.1 - 01.d **Proprietà**: Customer
...
### <a name="electronic-signatures-based-upon-biometrics-are-designed-to-ensure-that-they-cannot-be-used-by-any-individual-other-than-their-genuine-owners"></a>Le firme elettroniche basate su biometrica sono progettate per assicurare che non possano essere usate da qualsiasi altro utente diverso dai proprietario autentici.

**ID**: 11209.01q2Organizational.9 - 01.q **Proprietà**: Non applicabile
...
### <a name="unique-ids-that-can-be-used-to-trace-activities-to-the-responsible-individual-are-required-for-all-types-of-organizational-and-non-organizational-users"></a>Gli ID univoci che possono essere usati per trovare l'utente responsabile di specifiche attività sono necessari per tutti i tipi di utenti dell'organizzazione ed esterni.

**ID**: 1122.01q1System.1 - 01.q **Proprietà**: Customer
...
### <a name="sharedgroup-and-generic-user-ids-are-only-used-in-exceptional-circumstances-where-there-is-a-clear-business-benefit-when-user-functions-do-not-need-to-be-traced-additional-accountability-controls-are-implemented-and-after-approval-by-management"></a>Gli ID utente condivisi/di gruppo e generici vengono usati solo in circostanze eccezionali per cui si ottiene un evidente vantaggio aziendale, quando non è necessario tracciare le funzioni utente, se vengono implementati controlli di responsabilità aggiuntivi e dopo l'approvazione del management.

**ID**: 1124.01q1System.34 - 01.q **Proprietà**: Customer
...
### <a name="help-desk-support-requires-user-identification-for-any-transaction-that-has-information-security-implications"></a>Il supporto tecnico richiede l'identificazione dell'utente per qualsiasi transazione che abbia implicazioni sulla sicurezza delle informazioni.

**ID**: 1128.01q2System.5 - 01.q **Proprietà**: Customer
...
### <a name="information-collected-from-multiple-sources-shall-be-aggregated-for-review"></a>Le informazioni raccolte da più origini dovranno essere aggregate per la revisione.

**ID**: 12103.09ab1Organizational.5 - 09.ab **Proprietà**: Customer
...
### <a name="automated-systems-support-near-real-time-analysis-and-alerting-of-events-eg-malicious-code-potential-intrusions-and-integrate-intrusion-detection-into-access-and-flow-control-mechanisms"></a>I sistemi automatizzati supportano l'analisi quasi in tempo reale degli eventi e l'invio di avvisi, ad esempio per codice dannoso o potenziali intrusioni, e integrano il rilevamento delle intrusioni nei meccanismi di controllo dell'accesso e del flusso.

**ID**: 1218.09ab3System.47 - 09.ab **Proprietà**: Customer
...
### <a name="security-is-maintained-through-all-aspects-of-the-transaction"></a>La sicurezza viene mantenuta in tutti gli aspetti della transazione.

**ID**: 0944.09y1Organizational.2 - 09.y **Proprietà**: Non applicabile
