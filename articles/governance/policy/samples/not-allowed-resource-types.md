...
description: Questa definizione di criteri di esempio impedisce la distribuzione di tipi di risorse specifici definiti in un parametro.
ms.date: 01/23/2019
ms.topic: sample
