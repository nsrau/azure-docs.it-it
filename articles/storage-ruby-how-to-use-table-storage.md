<properties urlDisplayName="Table Service" pageTitle="Come usare il servizio di archiviazione tabelle (Ruby) | Microsoft Azure" metaKeywords="Azure table storage service, Azure table service Ruby, table storage Ruby" description="Informazioni su come usare il servizio di archiviazione tabelle in Azure. Gli esempi di codice sono scritti usando l'API Ruby." metaCanonical="" services="storage" documentationCenter="Ruby" title="Come usare il Servizio tabelle da Ruby" authors="guayan" solutions="" manager="wpickett" editor="" />
...
## <span id="create-a-windows-azure-storage-account"></span></a>Creare un account di archiviazione di Azure
...
## <span id="how-to-work-with-groups-of-entities"></span></a>Procedura: Usare i gruppi di entità
