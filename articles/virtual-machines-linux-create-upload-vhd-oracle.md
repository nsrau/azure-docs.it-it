...
-   [Preparazione di una macchina virtuale Oracle Linux per Azure 6.4+][Preparazione di una macchina virtuale Oracle Linux per Azure 6.4+]
-   [Preparazione di una macchina virtuale Oracle Linux per Azure 7.0+][Preparazione di una macchina virtuale Oracle Linux per Azure 7.0+]

## Prerequisiti

In questo articolo si presuppone che l'utente abbia già installato un sistema operativo Oracle Linux in un disco rigido virtuale. Sono disponibili vari strumenti per la creazione di file .vhd, ad esempio una soluzione di virtualizzazione come Hyper-V. Per istruzioni, vedere [Installare il ruolo Hyper-V e configurare una macchina virtuale][Installare il ruolo Hyper-V e configurare una macchina virtuale].
...
15. Fare clic su **Azione -\> Arresta** nella console di gestione di Hyper-V. Il file VHD Linux è ora pronto per il caricamento in Azure.
  ...
  [Preparazione di una macchina virtuale Oracle Linux per Azure 6.4+]: #oracle6
  [Preparazione di una macchina virtuale Oracle Linux per Azure 7.0+]: #oracle7
