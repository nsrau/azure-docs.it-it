...
3.  In Visual Studio 2012 Express per Windows 8 aprire il progetto creato dopo aver completato l'esercitazione [Introduzione a Servizi mobili][Introduzione a Servizi mobili].
...
7.  Passare alla pagina [Applicazioni personali][Applicazioni personali] nel Centro sviluppatori Live Connect e fare clic sull'app nell'elenco **Applicazioni personali**.
...
-   Autenticazione di base. Questo metodo, che supporta diversi provider di autenticazione, richiede che gli utenti eseguano l'accesso ogni volta che l'app viene avviata. Per ulteriori informazioni, vedere [Introduzione all'autenticazione in Servizi mobili][Introduzione all'autenticazione in Servizi mobili].
