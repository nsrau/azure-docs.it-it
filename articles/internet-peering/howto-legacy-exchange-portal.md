...
È possibile convertire le connessioni peering legacy usando la pagina relativa alla [creazione di un peering]( https://go.microsoft.com/fwlink/?linkid=2129593).

####  <a name="configure-basic-settings"></a>Configurare le impostazioni di base
>   ![Registrare il Servizio di peering](./media/setup-basics-tab.png)
