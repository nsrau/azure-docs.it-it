...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [Back-end JavaScript]: /it-it/documentation/articles/mobile-services-android-authorize-users-in-scripts/ "JavaScript backend"
