...
<div  class="dev-center-tutorial-subselector"><a href="/it-it/documentation/articles/web-sites-custom-domain-name/" title="Siti Web" class="current">Sito Web</a> | <a href="/it-it/documentation/articles/web-sites-traffic-manager-custom-domain-name/" title="Sito Web che utilizza Gestione traffico">Sito Web che utilizza Gestione traffico</a></div>
