<properties 
	...
	description="Aprenda a configurar extremos nel portale classico per consentire la comunicación con una máquina virtual en Azure." 
...
1.	Accedere al [portale di anteprima di Azure](http://manage.windowsazure.com/) se questa operazione non è già stata eseguita.
...
3.	Fare clic su **Endpoint**. Nella pagina Endpoint sono elencati tutti gli endpoint correnti per la macchina virtuale.
	...
	![Endpoint](./media/virtual-machines-set-up-endpoints-classic-portal/endpointswindows.png)
...
![Creazione dell'endpoint completata](./media/virtual-machines-set-up-endpoints-classic-portal/endpointwindowsnew.png)
...
3.	Fare clic su **Endpoint**. Nella pagina Endpoints sono elencati tutti gli endpoint disponibili per la macchina virtuale.
    ...
    ![Elenco di controllo di accesso](./media/virtual-machines-set-up-endpoints-classic-portal/EndpointsShowsDefaultEndpointsForVM.png)
...
5.	Nella barra delle applicazioni, fare clic su **Gestisci ACL**. Verrà visualizzata la finestra di dialogo **Specify ACL details**.
    ...
    ![Immissione dei dettagli sull'elenco di controllo di accesso](./media/virtual-machines-set-up-endpoints-classic-portal/EndpointACLdetails.png)
