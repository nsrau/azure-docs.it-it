...
Questo articolo fa parte di una serie di articoli dedicati alla programmazione in Servizi multimediali di Azure. L'argomento precedente è [Procedura: Gestire gli asset][].
...
In questo argomento è stato illustrato il download di un asset da Archiviazione di Azure. Per informazioni su altri modi per distribuire asset, vedere la [procedura relativa alla distribuzione di contenuti in streaming][].

  [Procedura: Gestire gli asset]: http://go.microsoft.com/fwlink/?LinkID=301815&clcid=0x409
  ...
  [procedura relativa alla distribuzione di contenuti in streaming]: http://go.microsoft.com/fwlink/?LinkID=301942
