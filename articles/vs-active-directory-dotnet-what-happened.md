<properties title="Introduzione all'autenticazione di Active Directory - Risultati" pageTitle="Introduzione all'autenticazione di Active Directory - Risultati" metaKeywords="Azure, Getting Started, Active Directory" description="" services="active-directory" documentationCenter="" authors="ghogen, kempb" />
