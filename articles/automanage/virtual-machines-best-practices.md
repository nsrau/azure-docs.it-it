...
Questi servizi di Azure vengono automaticamente caricati quando si usa la gestione automatica per le macchine virtuali. Sono essenziali per le procedure consigliate white paper, che è possibile trovare nel [Framework di adozione del cloud](https://docs.microsoft.com/azure/cloud-adoption-framework/manage/azure-server-management).
