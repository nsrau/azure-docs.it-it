...
## <a name="use-devops-projects-to-create-an-aspnet-core-app-and-deploy-it-to-service-fabricc"></a>Usare DevOps Projects per creare un'app ASP.NET Core e distribuirla in Service Fabric
