---
title: Creare una pipeline di CI/CD per Java con il progetto DevOps di Azure | Guida introduttiva
...
ms.locfileid: "47404912"
---
# <a name="create-a-cicd-pipeline-for-java-with-the-azure-devops-project"></a>Creare una pipeline di CI/CD per Java con il progetto DevOps di Azure

Il progetto DevOps di Azure offre un'esperienza semplificata per la creazione di risorse di Azure e la configurazione di una pipeline di integrazione continua (CI, Continuous Integration) e recapito continuo (CD, Continuous Delivery) per l'app Java in Azure DevOps Services.  
...
1. Il framework di esempio predefinito è **Spring**. Lasciare l'impostazione predefinita e quindi scegliere **Avanti**.  
...
Il progetto DevOps di Azure configura automaticamente un trigger di compilazione e di versione di integrazione continua.  A questo punto, si è pronti per collaborare con un team a un'app Java con un processo di CI/CD che distribuisce automaticamente il lavoro più recente nel sito Web.
...
1. Sul lato sinistro del browser passare al file **src/main/webapp/index.html**.
