---
title: Gestire le mappe di Azure Power BI Visual all'interno dell'organizzazione | Mappe Microsoft Azure
description: In questo articolo si apprenderà come gestire le mappe Microsoft Azure Power BI Visual all'interno dell'organizzazione.
author: rbrundritt
ms.author: richbrun
ms.date: 06/26/2020
ms.topic: conceptual
...
Power BI consente ai progettisti e agli amministratori tenant di gestire l'uso dell'oggetto visivo Maps di Azure. Di seguito viene descritta la procedura valida per ogni ruolo.
