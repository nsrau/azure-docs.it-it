...
| `render`            | <p>Generato ogni volta che la mappa viene disegnata sullo schermo, come risultato di:<ul><li>Una modifica alla posizione, allo zoom, al passo o al cuscinetto della mappa.</li><li>Modifica dello stile della mappa.</li><li>Una modifica a un' `DataSource` origine.</li><li>Il caricamento di un riquadro vettoriale, di un file GeoJSON, di un glifo o di uno sprite.</li></ul></p>|
