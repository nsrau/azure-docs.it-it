...
Questo articolo illustra come aggiungere controlli a una mappa. Si apprenderà anche come creare una mappa con tutti i controlli e un [selettore di stile](./choose-map-style.md).
