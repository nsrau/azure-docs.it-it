...
- GeoJSON MultiPoint Geometry: questo oggetto contiene le coordinate di più punti e nient'altro. È possibile utilizzare la classe helper `atlas.data.MultiPoint` per creare facilmente questi oggetti.
