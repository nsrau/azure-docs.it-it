...
**Modificare lo stile della mappa** Non tutti gli sviluppatori vorranno che tutti gli stili di mapping possibili siano disponibili nell'applicazione. Lo sviluppatore può impostare a livello di codice e modificare lo stile della mappa nel modo desiderato. Se lo sviluppatore Visualizza il controllo selezione stile mappa, l'utente sarà in grado di modificare lo stile della mappa usando il mouse, il tocco o la tastiera usando i tasti Tab/invio. Lo sviluppatore può specificare gli stili della mappa che si desidera rendere disponibili nel controllo selezione stile mappa. 
