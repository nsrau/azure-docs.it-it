...
description: Informazioni su come usare Mappe di Azure per trovare gli itinerari per modalità di viaggio specifiche verso i punti di interesse. Vedere come visualizzare più itinerari sulle mappe.
author: anastasia-ms
ms.author: v-stharr
ms.date: 01/14/2020
ms.topic: tutorial
