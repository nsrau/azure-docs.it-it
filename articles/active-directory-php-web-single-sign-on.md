...
-   [Codice di esempio PHP per Azure Active Directory][Codice di esempio PHP per Azure Active Directory]
...
-   [Passaggio 1: Creare un'applicazione PHP][Passaggio 1: Creare un'applicazione PHP]
...
## <a name="createapp"></a>Passaggio 1: Creare un'applicazione PHP
