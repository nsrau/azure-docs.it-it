...
- **Workstation con Azure PowerShell**. Vedere [Installare Azure PowerShell 1.0 e versioni successive](data-lake-analytics-manage-use-powershell.md#install-azure-powershell-10-and-greater).
