---
title: Informazioni su Data Lake Analytics e U-SQL usando le esercitazioni interattiva del portale di Azure | Microsoft Docs
...
> [!NOTE]
> Se si desidera eseguire la stessa esercitazione usando Visual Studio, vedere [Analizzare i log del sito Web mediante Data Lake Analytics](data-lake-analytics-analyze-weblogs.md). Al portale verranno aggiunte altre esercitazioni interattive.
> 
> 
...
7. Immettere o selezionare le informazioni seguenti:
...
6. Fare clic su **1 Introduction** e quindi seguire le istruzioni.
