---
title: Introduzione ad Analisi di Azure Data Lake con il portale di Azure | Microsoft Docs
...
6. Nella parte superiore del pannello dell'account di Analisi Data Lake fare clic su **Esplora dati**.
...
7. Nel pannello relativo all'account di Archivio Data Lake fare clic su **Esempi** per espandere la cartella e quindi su **Dati** per espandere la cartella. Verranno visualizzati i file e le cartelle seguenti:
...
1. Fare clic su **Invia processo** nel menu in alto. Viene visualizzato un nuovo pannello Dettagli processo. Sulla barra del titolo viene visualizzato lo stato del processo.
2. Attendere finché lo stato del processo non viene modificato in **Riuscito**. Al termine del processo, viene aperto un nuovo pannello con i dettagli del processo:
...
3. Nella parte inferiore del pannello **Dettagli processo** fare clic sul nome del processo: **SearchLog-from-Data-Lake.csv**. Sarà possibile visualizzare in anteprima, scaricare, rinominare ed eliminare il file di output.
...
4. Fare clic su **Anteprima** per visualizzare il file di output.
