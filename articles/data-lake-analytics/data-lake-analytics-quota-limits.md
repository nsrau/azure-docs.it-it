...
**Numero massimo di unità di analisi (CU) per account:** 250, valore predefinito 32
...
3. Selezionare **l'abbonamento** (assicurarsi che non si tratti di un abbonamento di "prova").
