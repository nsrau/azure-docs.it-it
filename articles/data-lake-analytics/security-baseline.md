...
**Indicazioni**: data Lake Analytics non ha il concetto di password predefinite perché l'autenticazione viene fornita con Azure Active Directory e protetta da controlli di accesso in base al ruolo (RBAC).
