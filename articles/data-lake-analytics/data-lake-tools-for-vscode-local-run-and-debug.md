...
1. Premere CTRL + MAIUSC + P per aprire il riquadro comandi e immettere **ADL: Scaricare il pacchetto** di esecuzione locale per scaricare i pacchetti.  
...
1. Premere CTRL + MAIUSC + P per aprire il riquadro comandi e immettere **ADL: Avviare il servizio**di esecuzione locale.   
...
4. Premere CTRL + MAIUSC + P per aprire il riquadro comandi, immettere **ADL: Inviare il**processo e quindi selezionare **local (locale** ) per inviare il processo all'account locale.
...
1. Premere CTRL + MAIUSC + P per aprire il riquadro comandi e immettere **ADL: Avviare il servizio**di esecuzione locale. Viene aperta la console dei comandi. Assicurarsi che **DataRoot** sia impostata.
