...
Gli Strumenti Azure Data Lake per VS Code supportano Windows, Linux e MacOS.  
...
È possibile usare i comandi correlati ad Azure Data Lake Store per:
 ...
 - [Caricare il file direttamente in Azure Data Lake Store in VS Code](#upload-file-or-folder)
 - [Scaricare il file direttamente da Azure Data Lake Store in VS Code](#download-file)
