...
Abilitare il carico di lavoro **Sviluppo di Azure**, come illustrato: ![Abilitare il carico di lavoro di sviluppo di Azure](./media/data-lake-analytics-data-lake-tools-get-started/data-lake-tools-for-vs-2017-install-02.png)
