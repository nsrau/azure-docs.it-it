<properties 
	...
	description="Informazioni su come convalidare, modificare e aumentare i dati per l'app JavaScript per Windows Store con i servizi mobili di back-end .NET di Azure." 
