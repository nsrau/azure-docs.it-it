...
## <a name="resources"></a>1. Creare la risorsa
...
## <a name="state"></a>2. Modificare lo stato di amministratore di collegamenti
...
## <a name="circuit"></a>3. Creare un circuito
...
Altre larghezze di banda sono: 1.0, 2.0, 5.0, 10.0 e 40.0
