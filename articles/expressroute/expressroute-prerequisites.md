...
- È possibile collaborare con un [partner per la connettività a ExpressRoute](expressroute-locations.md#partners) per connettersi a Microsoft Cloud. È possibile configurare una connessione tra la rete locale e Microsoft in [tre modi](expressroute-introduction.md#howtoconnect) diversi. 
- Se il provider non è un partner per la connettività a ExpressRoute, è comunque possibile connettersi a Microsoft Cloud tramite un [provider Cloud Exchange](expressroute-locations.md#nonpartners).
...
- [URL di CRM Online](https://support.microsoft.com/kb/2655102) e [Intervalli di indirizzi IP](https://support.microsoft.com/kb/2728473)
