...
Le tabelle in questo articolo forniscono informazioni sulle località ExpressRoute, i provider di connettività ExpressRoute, la copertura geografica ExpressRoute, i servizi cloud Microsoft supportati tramite ExpressRoute e gli integratori di sistemi di ExpressRoute (SIs).
...
ExpressRoute è supportato in tutte le aree e le località di Azure.
...
| **Europa** | 1 |Francia centrale, Francia meridionale, Europa settentrionale, Europa occidentale, Regno Unito occidentale, Regno Unito meridionale |Amsterdam, Amsterdam2, Copenaghen, Dublino, Francoforte, Londra, London2, Marsiglia, Newport (Galles), Parigi, Zurigo |
...
| **China Telecom Global** |Supportato |Non supportata |RAS di Hong Kong |
