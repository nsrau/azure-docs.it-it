...
[Programma Microsoft Cloud Solution Provider](https://partner.microsoft.com/it-IT/Solutions/cloud-reseller-overview). [Preparati alle transazioni come Cloud Solution Provider](https://partner.microsoft.com/it-IT/solutions/cloud-reseller-pre-launch). [Risorse Microsoft Cloud Solution Provider](https://partner.microsoft.com/it-IT/solutions/cloud-reseller-resources).
