...
## <a name="a-namegwacreate-the-gateway"></a><a name="gw"></a>Creare il gateway
...
## <a name="a-nameconfigaconfigure-an-existing-classic-vnet-for-expressroute"></a><a name="config"></a>Configurare una rete virtuale classica esistente per ExpressRoute
