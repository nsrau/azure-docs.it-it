...
5. È ora possibile gestire i collegamenti al circuito ExpressRoute usando i comandi del modello di distribuzione classica per le reti virtuali classiche e i comandi di Resource Manager per le reti virtuali di Resource Manager. Gli articoli seguenti illustrano in modo dettagliato come gestire i collegamenti al circuito ExpressRoute:
