<properties
   pageTitle="Come configurare il routing per un circuito ExpressRoute tramite il portale di Azure| Microsoft Azure"
...
6. Una volta che la configurazione è stata accettata, verrà visualizzata una schermata simile all'esempio seguente.
