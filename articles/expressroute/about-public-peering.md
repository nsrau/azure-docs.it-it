...
## <a name="compare"></a>Confronto tra i peering
...
## <a name="powershell"></a>Passaggi Azure PowerShell
...
## <a name="cli"></a>Procedura CLI di Azure
...
## <a name="portal"></a>Passaggi portale di Azure
...
### <a name="get"></a>Per visualizzare i dettagli relativi al peering pubblico di Azure

Visualizzare le proprietà del peering pubblico di Azure selezionando il peering nel portale.

### <a name="update"></a>Per aggiornare la configurazione del peering pubblico di Azure

Selezionare la riga per il peering, quindi modificare le proprietà del peering.

### <a name="delete"></a>Per eliminare un peering pubblico di Azure
