...
4. Configurare il peering privato di Azure per il circuito.
  ...
  * Un hash MD5, se si sceglie di usarne uno. **Facoltativo**.
  ...
  Per configurare il peering privato di Azure per il circuito, è possibile eseguire il cmdlet seguente:
  ...
  Se si sceglie di usare un hash MD5, è possibile eseguire il cmdlet seguente:
...
Per configurare il peering pubblico di Azure per il circuito, è possibile eseguire il cmdlet seguente:
  ...
  Se si sceglie di usare un hash MD5, è possibile seguire l'esempio seguente:
