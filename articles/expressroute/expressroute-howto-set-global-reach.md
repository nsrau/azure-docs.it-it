...
* La versione più recente di Azure PowerShell è installata. Per altre informazioni, vedere [Installare e configurare Azure PowerShell](/powershell/azure/install-azurerm-ps).
