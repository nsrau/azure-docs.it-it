...
È possibile modificare il file XML del profilo scaricato e aggiungere la **route\<>\<includeroutes >\<destinazione >\<mask > \</route >\</includeroutes >\</Destionation** >\</Mask > Tag
