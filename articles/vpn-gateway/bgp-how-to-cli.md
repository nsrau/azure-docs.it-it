---
title: Configurare BGP nel gateway VPN di Azure:CLIConfigure BGP on Azure VPN Gateway:CLI
...
#### <a name="3-obtain-the-azure-bgp-peer-ip-address"></a>3. Ottenere l'indirizzo IP peer BGP di Azure
