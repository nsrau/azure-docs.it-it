---
title: 'Configurare connessioni VPN da sito a sito active-active per gateway VPN: Azure Resource Manager: PowerShell | Microsoft Docs'
...
## <a name ="aaupdate"></a>Aggiornare un gateway VPN esistente
