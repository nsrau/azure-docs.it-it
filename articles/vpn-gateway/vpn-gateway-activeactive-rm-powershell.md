---
title: Come configurare connessioni VPN S2S active-active con i gateway VPN di Azure tramite Azure Resource Manager e PowerShell | Documentazione Microsoft
...
## <a name="a-name-aagatewayapart-1---create-and-configure-active-active-vpn-gateways"></a><a name ="aagateway"></a>Parte 1: creare e configurare gateway VPN active-active
...
## <a name="a-name-aacrosspremapart-2---establish-an-active-active-cross-premises-connection"></a><a name ="aacrossprem"></a>Parte 2: stabilire una connessione cross-premise active-active
...
## <a name="a-name-aav2vapart-3---establish-an-active-active-vnet-to-vnet-connection"></a><a name ="aav2v"></a>Parte 3: stabilire una connessione da rete virtuale a rete virtuale active-active
...
## <a name="a-name-aaupdateapart-4---update-existing-gateway-between-active-active-and-active-standby"></a><a name ="aaupdate"></a>Parte 4: aggiornare il gateway esistente tra modalità active-active e active-standby
