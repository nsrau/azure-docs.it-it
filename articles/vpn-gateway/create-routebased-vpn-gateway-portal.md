...
description: Usare il portale di Azure per creare rapidamente un gateway VPN di Azure basato su Route, per una connessione VPN alla rete locale o per la connessione di reti virtuali.
