---
title: Configurare una connessione gateway VPN da punto a sito a una rete virtuale usando il modello di distribuzione Resource Manager | Microsoft Docs
...
## <a name="<a-name="declare"></a>part-1---log-in-and-set-variables"></a><a name="declare"></a>Parte 1: Accedere e impostare le variabili
...
## <a name="part-2---configure-a-vnet"></a>Parte 2: Configurare una rete virtuale
...
## <a name="part-3---add-trusted-certificates"></a>Parte 3: Aggiungere certificati attendibili
...
## <a name="part-4---create-the-vpn-gateway"></a>Parte 4: Creare il gateway VPN
...
## <a name="part-5---download-the-vpn-client-configuration-package"></a>Parte 5: Scaricare il pacchetto di configurazione del client VPN
...
## <a name="<a-name="cc"></a>part-6---generate-the-client-certificate"></a><a name="cc"></a>Parte 6: Generare il certificato client
...
## <a name="part-7---install-the-client-certificate"></a>Parte 7: Installare il certificato client
...
## <a name="part-8---connect-to-azure"></a>Parte 8: Connettersi ad Azure
...
## <a name="part-9---verify-your-connection"></a>Parte 9: Verificare la connessione
...
## <a name="to-add-or-remove-a-trusted-root-certificate"></a>Per aggiungere o rimuovere un certificato radice attendibile
...
1. Creare e preparare il nuovo certificato che sarà aggiunto in Azure. Esportare la chiave pubblica come file CER con codifica Base 64 X.509 e aprirla con un editor di testo. Copiare solo la sezione seguente. 
    ...
    ![certificato](./media/vpn-gateway-howto-point-to-site-rm-ps/copycert.png "certificate")
...
## <a name="to-manage-the-list-of-revoked-client-certificates"></a>Per gestire l'elenco dei certificati client revocati
