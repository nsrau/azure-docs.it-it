...
### <a name="deployment-model"></a><a name="models"></a>Modello di distribuzione
...
## <a name="connection-topology-diagrams"></a><a name="diagrams"></a>Diagrammi delle topologie di connessione
