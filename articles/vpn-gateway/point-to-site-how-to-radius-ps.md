...
3. Aggiungere il pool di indirizzi client VPN e le informazioni sul server RADIUS.
   ...
   Per specificare **due** server RADIUS **(anteprima)** , usare la sintassi seguente. Modificare il valore **-VpnClientProtocol** in base alle esigenze
