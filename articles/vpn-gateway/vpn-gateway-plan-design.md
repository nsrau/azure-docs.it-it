...
### <a name="a-namecompareacross-premises-connectivity-options"></a><a name="compare"></a>Opzioni di connettività di più sedi locali
...
### <a name="a-namegwrequireagateway-requirements-by-vpn-type-and-sku"></a><a name="gwrequire"></a>Requisiti del gateway per tipo di VPN e SKU
...
#### <a name="aggregate-throughput-by-sku-and-vpn-type"></a>Velocità effettiva aggregata stimata per tipo di VPN e SKU
...
### <a name="a-namewfaworkflow"></a><a name="wf"></a>Flusso di lavoro
...
### <a name="a-nametopologiesaconnection-topologies"></a><a name="topologies"></a>Topologie di connessione
...
### <a name="a-namedesignbasicsadesign-basics"></a><a name="designbasics"></a>Nozioni di base sulla progettazione
...
#### <a name="a-namesubnetsaabout-subnets"></a><a name="subnets"></a>Informazioni sulle subnet
...
#### <a name="a-namelocalaabout-local-network-gateways"></a><a name="local"></a>Informazioni sui gateway di rete locali
...
#### <a name="a-namegwtypeaabout-gateway-types"></a><a name="gwtype"></a>Informazioni sui tipi di gateway
...
#### <a name="a-nameconnectiontypeaabout-connection-types"></a><a name="connectiontype"></a>Informazioni sui tipi di connessione
...
#### <a name="a-namevpntypeaabout-vpn-types"></a><a name="vpntype"></a>Informazioni sui tipi di VPN
...
### <a name="a-namedevicesavpn-devices-for-site-to-site-connections"></a><a name="devices"></a>Dispositivi VPN per connessioni da sito a sito
...
### <a name="a-nameforcedtunnelaconsider-forced-tunnel-routing"></a><a name="forcedtunnel"></a>Prendere in considerazione il routing con tunneling forzato
