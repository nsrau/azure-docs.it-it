---
title: Pianificazione e progettazione per il gateway VPN | Microsoft Docs
...
### <a name="<a-name="compare"></a>cross-premises-connectivity-options"></a><a name="compare"></a>Opzioni di connettività di più sedi locali
...
### <a name="<a-name="gwrequire"></a>gateway-requirements-by-vpn-type-and-sku"></a><a name="gwrequire"></a>Requisiti del gateway per tipo di VPN e SKU
...
<br>
 La tabella seguente illustra i tipi di gateway e la velocità effettiva aggregata stimata. La velocità effettiva aggregata stimata può essere un fattore determinante per la progettazione.
I prezzi variano a seconda dello SKU del gateway. Per informazioni sui prezzi, vedere [Gateway VPN Prezzi](https://azure.microsoft.com/pricing/details/vpn-gateway/). La tabella è valida per entrambi i modelli di distribuzione classica e di Gestione risorse.

[!INCLUDE [vpn-gateway-table-gwtype-aggtput](../../includes/vpn-gateway-table-gwtype-aggtput-include.md)]

### <a name="<a-name="wf"></a>workflow"></a><a name="wf"></a>Flusso di lavoro
...
### <a name="<a-name="topologies"></a>connection-topologies"></a><a name="topologies"></a>Topologie di connessione
...
### <a name="<a-name="designbasics"></a>design-basics"></a><a name="designbasics"></a>Nozioni di base sulla progettazione
Le sezioni seguenti illustrano le nozioni di base del gateway VPN. Inoltre, è importante prendere in considerazione le [limitazioni dei servizi di rete](../azure-subscription-service-limits.md#networking-limits).

#### <a name="<a-name="subnets"></a>about-subnets"></a><a name="subnets"></a>Informazioni sulle subnet
...
#### <a name="<a-name="local"></a>about-local-network-gateways"></a><a name="local"></a>Informazioni sui gateway di rete locali
...
#### <a name="<a-name="gwtype"></a>about-gateway-types"></a><a name="gwtype"></a>Informazioni sui tipi di gateway
...
#### <a name="<a-name="connectiontype"></a>about-connection-types"></a><a name="connectiontype"></a>Informazioni sui tipi di connessione
...
#### <a name="<a-name="vpntype"></a>about-vpn-types"></a><a name="vpntype"></a>Informazioni sui tipi di VPN
...
### <a name="<a-name="devices"></a>vpn-devices-for-site-to-site-connections"></a><a name="devices"></a>Dispositivi VPN per connessioni da sito a sito
...
### <a name="<a-name="forcedtunnel"></a>consider-forced-tunnel-routing"></a><a name="forcedtunnel"></a>Prendere in considerazione il routing con tunneling forzato
