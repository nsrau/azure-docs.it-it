---
title: 'Come configurare OpenVPN nel gateway VPN di Azure: PowerShellHow to configure OpenVPN on Azure VPN Gateway: PowerShell'
...
---
# <a name="configure-openvpn-for-azure-point-to-site-vpn-gateway"></a>Configurare OpenVPN per il gateway VPN da punto a sito di AzureConfigure OpenVPN for Azure point-to-site VPN Gateway

Questo articolo illustra il protocollo OpenVPN® nel gateway VPN di Azure.This article helps you set up **OpenVPN® Protocol** on Azure VPN Gateway. L'articolo presuppone che si disponga già di un ambiente di lavoro da punto a sito. In caso contrario, usare le istruzioni nel passaggio 1 per creare una VPN da punto a sito.
