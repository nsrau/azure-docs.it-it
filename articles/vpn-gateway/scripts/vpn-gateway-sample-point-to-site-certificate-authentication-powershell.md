...
| [Add-AzureRmVpnClientRootCertificate](/powershell/module/azurerm.network/add-azurermvpnclientrootcertificate) | Carica le informazioni sulla chiave pubblica del certificato radice nel gateway VPN.|
...
| [New-SelfSignedCertificate](/powershell/module/azurerm.resources/new-selfsignedcertificate) | Crea un nuovo certificato radice autofirmato. |
