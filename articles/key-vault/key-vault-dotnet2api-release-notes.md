...
Le note e le linee guida seguenti sono destinate agli sviluppatori che usano la libreria .NET / C# dell'insieme di credenziali delle chiavi di Azure. Nel passaggio dalla versione 1.0 alla versione 2.0 sono state apportate alcune modifiche. Per poter però usufruire dei miglioramenti funzionali e delle nuove funzionalità, ad esempio la funzionalità Certificati dell'insieme di credenziali delle chiavi di Azure, è necessaria un'operazione di migrazione nel codice.
