...
1. In **Esplora soluzioni**fare clic con il pulsante destro del mouse sul progetto a cui si vuole aggiungere il supporto di Key Vault e scegliere **Aggiungi** > **servizio connesso**.
...
1. Selezionare la scheda `Program.cs` e sostituire la classe Program con il codice seguente:
...
1. Aprire quindi `About.cshtml.cs` file e scrivere il codice seguente:
   1. Includere un riferimento a `Microsoft.Extensions.Configuration` mediante questa istruzione using:
