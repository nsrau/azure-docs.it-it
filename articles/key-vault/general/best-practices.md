...
* [Certificato di backup](/powershell/module/azurerm.keyvault/Backup-AzureKeyVaultCertificate?view=azurermps-6.13.0)
* [Chiave di backup](/powershell/module/azurerm.keyvault/Backup-AzureKeyVaultKey?view=azurermps-6.13.0)
* [Segreto di backup](/powershell/module/azurerm.keyvault/Backup-AzureKeyVaultSecret?view=azurermps-6.13.0)

### <a name="azure-cli-backup-commands"></a>Comandi di backup di Azure CLI

* [Certificato di backup](/cli/azure/keyvault/certificate?view=azure-cli-latest#az-keyvault-certificate-backup)
* [Chiave di backup](/cli/azure/keyvault/key?view=azure-cli-latest#az-keyvault-key-backup)
* [Segreto di backup](/cli/azure/keyvault/secret?view=azure-cli-latest#az-keyvault-secret-backup)
