...
## <a name="app-identity-and-service-principals"></a>Identità e entità servizio delle app
...
## <a name="authorize-a-service-principal-to-access-key-vault"></a>Autorizzare un'entità servizio per l'accesso a Key Vault
