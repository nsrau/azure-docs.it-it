...
Per altre informazioni sull'indirizzo di rete dell'insieme di credenziali delle chiavi di Azure, vedere Gli endpoint del servizio di rete virtuale per l'insieme di credenziali delle chiavi di AzurePer more information on Azure Key Vault network address review [Virtual network service endpoints for Azure Key Vault](overview-vnet-service-endpoints.md))
...
- Endpoint del servizio di rete virtuale per l'insieme di credenziali delle chiavi di [Azure)](overview-vnet-service-endpoints.md)
