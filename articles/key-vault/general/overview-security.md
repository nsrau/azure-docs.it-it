...
Per ulteriori informazioni sugli [endpoint del servizio rete virtuale](overview-vnet-service-endpoints.md)Azure Key Vault verifica indirizzo di rete per Azure Key Vault)
