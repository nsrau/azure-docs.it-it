...
1. Verificare l'accesso immettendo *AZ account Get-Access-token- https://vault.azure.net-Resource *. Se viene visualizzato un errore, verificare che la versione corretta dell'interfaccia della riga di comando di Azure sia installata correttamente.
