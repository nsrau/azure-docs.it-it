...
| `RunAs=App` | [Identità gestite per le risorse di AzureManaged identities for Azure resources](../active-directory/managed-identities-azure-resources/index.yml) | `AzureServiceTokenProvider`utilizza un'identità gestita per ottenere il token. |
