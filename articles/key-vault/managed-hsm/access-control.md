...
| Piano dati | **Globale:**<br> &lt;HSM-Name &gt; . Vault.Azure.NET:443<br> | **Chiavi**: decrittografare, crittografare,<br> annullamento del wrapping, wrapping, verifica, firma, recupero, elenco, aggiornamento, creazione, importazione, eliminazione, backup, ripristino, eliminazione<br/><br/> **Gestione dei ruoli del piano dati (RBAC locale del modulo di protezione hardware gestito) * * *: elencare le definizioni dei ruoli, assegnare ruoli, <br/> <br/> eliminare assegnazioni di ruolo, definire ruoli personalizzati** Backup/ripristino **: backup, ripristino, verifica stato backup/ripristino operazioni <br/> <br/> **di sicurezza dominio * *: scaricare e caricare il dominio di sicurezza | RBAC locale HSM gestito |
|||||
