...
È prima di tutto necessario abilitare la registrazione per l'insieme di credenziali delle chiavi. Usare i comandi di PowerShell seguenti. (È possibile visualizzare i dettagli completi in [questo articolo sulla registrazione di key-vault](../general/logging.md).)
