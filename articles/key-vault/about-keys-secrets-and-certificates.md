...
-   Crittografia della chiave **RSA1_5** -RSAES-PKCS1-V1_5 [RFC3447]  
...
La chiave indirizzabile diventa maggiormente pertinente con certificati KV non esportabili. Le operazioni della chiave KV indirizzabile sono mappate dal campo *utilizzo* chiavi del criterio di certificato KV usato per creare il certificato kV.  
