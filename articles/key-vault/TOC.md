...
## Node.js
### [Gestione dell'insieme di credenziali](https://docs.microsoft.com/javascript/api/azure-keyvault/index?view=azure-node-latest)
### [Gestione dei contenuti dell'insieme di credenziali](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/index?view=azure-node-latest)
...
#### [Usare il servizio connesso Key Vault](vs-key-vault-add-connected-service.md)
#### [Introduzione ai progetti ASP.NET](vs-key-vault-aspnet-get-started.md)
#### [Cosa è successo al progetto ASP.NET?](vs-key-vault-aspnet-what-happened.md)
#### [Introduzione ai progetti ASP.NET Core](vs-key-vault-aspnet-core-get-started.md)
#### [Cosa è successo al progetto ASP.NET Core?](vs-key-vault-aspnet-core-what-happened.md)
...
## [Funzionalità dei dati del cliente](key-vault-customer-data.md)
...
## [Esempi di codice](https://github.com/Azure-Samples?utf8=%E2%9C%93&q=key+vault&type=&language=)
