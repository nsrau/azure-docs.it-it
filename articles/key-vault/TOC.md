...
## [Eseguire la lettura da Key Vault - Node.js](quick-create-node.md)
# Esercitazioni
...
## Node.js
### [Gestione dell'insieme di credenziali](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/)
### [Libreria client dell'insieme di credenziali](https://docs.microsoft.com/javascript/api/azure-keyvault/)
## Sviluppo
