...
AKS usa Windows Server 2019 come versione del sistema operativo host e supporta solo l'isolamento dei processi. Le immagini del contenitore compilate con altre versioni di Windows Server non sono supportate. [Compatibilità delle versioni dei contenitori Windows][windows-container-compat]
...
1. Aggiornare il [piano di controllo del cluster][upgrade-cluster-cp]. Questa operazione aggiornerà l'offerta e l'autore dell'immagine.
