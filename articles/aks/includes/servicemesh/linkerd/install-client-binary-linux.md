...
In una shell basata su bash in Linux o nel [sottosistema Windows per Linux][install-wsl], `curl` usare per scaricare la versione di Linkerd come indicato di seguito:
