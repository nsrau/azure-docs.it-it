...
Se non si usa il RBAC Kubernetes, è possibile eseguire il comando come segue:
...
Se nel cluster è abilitato il controllo degli accessi in base al ruolo Kubernetes, è possibile pulire il `ClusterRoleBinding` dopo aver eseguito lo strumento usando il comando seguente:

```bash
kubectl delete -f https://raw.githubusercontent.com/Azure/kube-advisor/master/sa.yaml
```

Se lo strumento viene eseguito in un cluster che non è abilitato per RBAC Kubernetes, non è necessaria alcuna pulizia.
