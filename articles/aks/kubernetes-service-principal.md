...
Quando si crea un cluster AKS nel portale di Azure o si usa il comando [AZ AKS create][az-aks-create] , Azure può generare automaticamente un'entità servizio.
