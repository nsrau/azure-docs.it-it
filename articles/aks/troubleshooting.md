...
*Questa assistenza per la risoluzione dei problemi è indirizzata da https://aka.ms/aks-cluster-failed*
...
1. Fino a quando il cluster non si trova nello stato @no__t 0, le operazioni `upgrade` e `scale` non riusciranno. I problemi e le soluzioni principali comuni includono:
...
*Questa assistenza per la risoluzione dei problemi è indirizzata da https://aka.ms/aks-pending-upgrade*
