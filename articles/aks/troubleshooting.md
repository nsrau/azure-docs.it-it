...
Se il dashboard di Kubernetes non viene visualizzato, verificare se il Pod `kube-proxy` è in esecuzione nello spazio dei nomi `kube-system`. Se non è esecuzione, eliminare il pod in modo che venga riavviato.
