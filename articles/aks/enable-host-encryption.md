...
Esaminare le [procedure consigliate per la sicurezza del cluster AKS][best-practices-security] leggere altre informazioni sulla [crittografia basata su host](/azure/virtual-machines/linux/disk-encryption#host-based-encryption).
