---
title: 'Esercitazione su Kubernetes in Azure: distribuire un cluster | Microsoft Docs'
...
> [Distribuire un'applicazione in Kubernetes](./tutorial-kubernetes-deploy-application.md)
