...
Per accedere all'applicazione, aprire un web browser all'indirizzo e alla porta specificata nel `draft connect` output, ad esempio `http://localhost:49804`. 
