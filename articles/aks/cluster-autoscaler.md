...
> [!NOTE]
> Se è già stata installata il *aks-preview* estensione, installare le aggiorna usando il il `az extension update --name aks-preview` comando.
