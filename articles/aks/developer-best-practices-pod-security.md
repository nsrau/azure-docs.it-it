...
:::image type="content" source="media/developer-best-practices-pod-security/basic-pod-identity.svg" alt-text="Flusso di lavoro semplificato per l'identità gestita del pod in Azure":::
