...
3. Creare il messaggio e assegnare i valori relativi ai campi **A**, **Da**, **Oggetto** e contenuto. Come illustrato nel [How To: Creare un messaggio di posta elettronica](#how-to-create-an-email) sezione.
4. Inviare il messaggio tramite un oggetto *javax.mail.Transport* . Come illustrato nel [How To: Sezione [procedura &-send-an-email] invia un messaggio di posta elettronica].
...
## <a name="how-to-use-filters-to-enable-footers-tracking-and-analytics"></a>Procedura: Usare i filtri per abilitare piè di pagina, monitoraggio e analitica
...
## <a name="how-to-use-additional-sendgrid-services"></a>Procedura: Usare altri servizi forniti da SendGrid
...
* Esempio che illustra l'uso di SendGrid in una distribuzione di Azure: [Come inviare e-mail usando SendGrid da Java in una distribuzione di Azure](store-sendgrid-java-how-to-send-email-example.md)
