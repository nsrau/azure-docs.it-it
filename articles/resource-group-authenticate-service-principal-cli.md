...
1. Accedere al proprio account.
        ...
        azure login
2. Creare un'entità servizio per l'applicazione. Specificare il nome visualizzato, l'URI di una pagina che descrive l'applicazione, gli URI che identificano l'applicazione e la password per l'identità dell'applicazione. Questo comando crea l'applicazione AD e l'entità servizio.
...
2. Accedere come entità servizio.
...
4. Accedere al proprio account.
        ...
        azure config mode arm
        azure login
5. Creare un'entità servizio per l'applicazione. Specificare il nome visualizzato, l'URI di una pagina che descrive l'applicazione, gli URI che identificano l'applicazione e i dati del certificato copiati. Questo comando crea l'applicazione AD e l'entità servizio.
