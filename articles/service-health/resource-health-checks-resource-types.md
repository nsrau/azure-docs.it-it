...
## <a name="microsoftcomputehostgroupshosts"></a>Microsoft. Compute/gruppi host/hosts
|Controlli eseguiti|
|---|
|<ul><li>L'host è attivo e in esecuzione</li><li>L'hardware host è danneggiato?</li><li>L'host è deallocato?</li><li>Il servizio hardware host è stato risanato in hardware diverso?</li></ul>|
