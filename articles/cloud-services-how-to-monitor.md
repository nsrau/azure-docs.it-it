...
1. Copiare una chiave di accesso alle risorse di archiviazione per l'account di archiviazione da usare per l'archiviazione dei dati del monitoraggio dettagliato. Nel [portale di gestione di Azure](https://manage.windowsazure.com/) è possibile usare **Gestisci chiavi** nella pagina **Account di archiviazione**. Per altre informazioni, vedere [Come gestire Servizi cloud](cloud-services-how-to-manage.md) o la pagina **Account di archiviazione** della Guida. 
