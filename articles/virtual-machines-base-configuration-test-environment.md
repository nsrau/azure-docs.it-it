...
- L’[ambiente cloud ibrido simulato](virtual-networks-setup-simulated-hybrid-cloud-environment-testing.md).
...
La configurazione di base in Microsoft Azure è ora pronta per lo sviluppo di applicazioni e il test o per ambienti di test aggiuntivi, ad esempio, l’[ambiente cloud ibrido simulato](virtual-networks-setup-simulated-hybrid-cloud-environment-testing.md).

## Risorse aggiuntive

[Ambienti di test basati su cloud ibrido](virtual-networks-setup-hybrid-cloud-environment-testing.md)
