...
1. Creare un nuovo asset nell'account di archiviazione predefinito.
1. Creare un asset di output del processo di codifica nell'account di archiviazione specificato.
