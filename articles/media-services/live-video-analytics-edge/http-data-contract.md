---
title: Contratto di dati dell'estensione HTTP - Azure
description: Questo articolo spiega come usare il protocollo HTTP per inviare messaggi tra il modulo Analisi video live e il modulo di intelligenza artificiale o CV.
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88701926"
---
# <a name="http-extension-data-contract"></a>Contratto di dati dell'estensione HTTP

Questo articolo spiega come usare il protocollo HTTP per inviare messaggi tra il modulo Analisi video live e il modulo di intelligenza artificiale o CV.
...
![gerarchia di classi](./media/http-data-contract/class-hierarchy.png)
