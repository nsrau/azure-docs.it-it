...
|Versione di prova gratuita|Stati Uniti orientali|Non disponibile|
|Disponibilità a livello di area|Stati Uniti orientali 2, Stati Uniti centro-meridionali, Stati Uniti occidentali 2, Europa settentrionale, Europa occidentale, Asia sud-orientale, Asia orientale e Australia orientale.  Per gli aggiornamenti più recenti, visitare il [prodotti in base all'area](https://azure.microsoft.com/global-infrastructure/services/?products=cognitive-services) pagina.|Vedere [Stato di Azure](https://azure.microsoft.com/global-infrastructure/services/?products=media-services).|
