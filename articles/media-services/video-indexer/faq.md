...
### <a name="how-do-i-upload-a-media-file-into-video-indexer-and-what-are-the-limitations"></a>Ricerca per categorie caricare un file multimediale in Video Indexer e quali sono le limitazioni?
...
* Il nome del video non può superare i 80 caratteri.
* Se si carica un video con una matrice di byte, le dimensioni del video sono limitate a 2 GB (e 30 GB quando si usa l'URL). 

Per l'elenco completo, vedere [caricamento di considerazioni e limitazioni](upload-index-videos.md#uploading-considerations-and-limitations).
...
Sì. Premere il pulsante **modifica video** dalla visualizzazione libreria o il pulsante **Apri in Editor** dalla visualizzazione del lettore per accedere alla scheda **progetti** . È possibile creare un nuovo progetto e aggiungere altri video dalla libreria per modificarli insieme. al termine, è possibile eseguire il rendering del video e scaricarlo. 

Per ottenere informazioni approfondite sul nuovo video, indicizzarlo con Video Indexer che verrà visualizzato nella libreria con le informazioni dettagliate.
...
### <a name="what-are-the-login-options-to-video-indexer-developer-portal"></a>Quali sono le opzioni di accesso per Video Indexer portale per sviluppatori?
