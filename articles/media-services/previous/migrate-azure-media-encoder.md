...
Questo articolo illustra i passaggi per eseguire la migrazione dal processore di contenuti multimediali legacy Azure Media Encoder (AME), che è in fase di ritiro il 31 marzo 2020, al processore di contenuti multimediali Media Encoder Standard.  
