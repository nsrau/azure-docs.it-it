...
ms.locfileid: "55984223"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>Caricare file in un account di Servizi multimediali mediante .NET (legacy)
