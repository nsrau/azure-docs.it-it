...
description: Questo argomento fornisce una panoramica del set di impostazioni di attività **Codec video H.264 a bitrate singolo con risoluzione 4x3 SD**.
author: Juliako
manager: femila
editor: ''
