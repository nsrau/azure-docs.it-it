...
ms.locfileid: "55976793"
---
# <a name="upload-files-to-a-media-services-account-in-the-azure-portal-legacy"></a>Caricare file in un account Servizi multimediali nel portale di Azure (legacy)
