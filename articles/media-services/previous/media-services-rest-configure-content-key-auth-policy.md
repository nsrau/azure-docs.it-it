...
ms.locfileid: "56003627"
---
# <a name="dynamic-encryption-configure-a-content-key-authorization-policy-legacy"></a>Crittografia dinamica: Configurare i criteri di autorizzazione di una chiave simmetrica (legacy)
...
#### <a id="ContentKeyAuthorizationPolicyOptions"></a>Creare ContentKeyAuthorizationPolicyOptions
Richiesta:
...
#### <a id="LinkContentKeyAuthorizationPoliciesWithOptions"></a>Collegare ContentKeyAuthorizationPolicies con opzioni
Richiesta:
