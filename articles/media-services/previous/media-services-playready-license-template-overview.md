...
Per un esempio dei livelli di protezione supportati da Silverlight, vedere [Supporto Silverlight per la protezione dell'output](/previous-versions/windows/silverlight/dotnet-windows-silverlight/cc838192(v=vs.95)).
