...
Per altre informazioni, vedere [eseguire la migrazione da Azure Media Indexer V1 e Azure Media Indexer V2 a servizi multimediali di Azure video Indexer](migrate-indexer-v1-v2.md).
