...
* [Usare il servizio di archiviazione di accodamento di Azure per monitorare le notifiche dei processi di Servizi multimediali](media-services-dotnet-check-job-progress-with-queues.md)
