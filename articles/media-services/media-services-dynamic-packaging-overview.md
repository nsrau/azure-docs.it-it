---
title: Panoramica della creazione dinamica dei pacchetti | Microsoft Docs
...
1. [Convalidare i file precodificati](media-services-static-packaging.md#validating-adaptive-bitrate-mp4s-encoded-with-external-encoders).
2. [Trasmettere i contenuti in streaming](media-services-deliver-content-overview.md).
