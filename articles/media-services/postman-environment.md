 ---
title: Importare l'ambiente Postman per le chiamate REST di Servizi multimediali di Azure description: Questo argomento fornisce una definizione dell'ambiente Postman per le chiamate REST di Servizi multimediali di Azure.
