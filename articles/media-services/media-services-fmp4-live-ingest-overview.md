...
## <a name="2-service-diagram"></a>2. Diagramma di servizio
...
## <a name="4-protocol-format--http"></a>4. Formato protocollo – HTTP
...
## <a name="9-encoder-redundancy"></a>9. Ridondanza dell'encoder
...
## <a name="11-special-types-of-ingestion-formats"></a>11. Tipi speciali di formati di ingestione
...
1. Nella **finestra Manifesto server attivo** come definito nella Sezione 6 in [1], utilizzare il parametro *parentTrackName* per specificare il nome della traccia padre. Per ulteriori informazioni, vedere la sezione 4.2.1.2.1.2 in [1].
1. Nella **casella Manifesto server attivo** **manifestdeve manifestOutput** deve essere impostato su **true**.
...
1. Usare flussi distinti per inviare le due velocità in bit video più basse. Ognuno di questi flussi dovrebbe anche contenere una copia di ogni traccia audio univoca. Ad esempio, quando sono supportate più lingue, questi flussi DOVREBBERO contenere tracce audio per ogni lingua.
