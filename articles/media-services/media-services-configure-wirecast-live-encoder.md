...
1. Fare clic su **Create Channel**. ![wirecast](./media/media-services-wirecast-live-encoder/media-services-wirecast2.png)
...
> [!IMPORTANT]
> Prima di fare clic su **flusso**, ci si **deve** assicurare che il canale sia pronto. Assicurarsi inoltre di non lasciare il canale in uno stato pronto senza un feed per l’input/contributo per più di 15 minuti.
> 
> 
