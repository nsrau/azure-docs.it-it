---
title: Come eseguire lo streaming live con codificatori locali tramite il portale di Azure | Microsoft Docs
...
2. Fare clic su **Creazione rapida** per creare un canale pass-through con il protocollo di inserimento RTMP.
   
    Verrà visualizzata la finestra **CREATE A NEW CHANNEL** (CREA UN NUOVO CANALE).
3. Assegnare un nome al nuovo canale e fare clic su **Crea**.
