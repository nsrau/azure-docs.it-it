...
###Risultato dell'anteprima video
...
||||
---|---|---|---|---
Durata del video|d < 3 min|3 minuti. < d < 15 minuti|15 minuti. < d < 30 minuti| 30 min < d
Durata dell'anteprima|15 sec (2-3 scene)| 30 sec (3-5 scene)|60 sec (5-10 scene)|90 sec (10-15 scene)
...
1. Creare un processo con un'attività di anteprima video in base al file di configurazione che contiene il set di impostazioni JSON seguente.
