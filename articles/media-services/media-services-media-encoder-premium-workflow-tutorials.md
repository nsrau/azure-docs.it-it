<properties 
	pageTitle="Esercitazioni avanzate del flusso di lavoro Premium del codificatore multimediale" 
...
- [Codifica di un file MXF in un MP4 a velocità in bit multipla - Progetto avanzato](media-services-media-encoder-premium-workflow-tutorials.md#MXF_to__multibitrate_MP4)
	...
	- [Convenzioni di denominazione dei file](vMXF_to__multibitrate_MP4_file_naming)
...
>[AZURE.NOTE]Per visualizzare un file di output del processo di codifica in Azure, è necessario specificare un valore nell'editor espressioni.
