...
Il codice C# seguente illustra come creare un localizzatore di streaming e `StreamingLocator.Filters`specificare. Si tratta `IList<string>` di una proprietà facoltativa che accetta i nomi dei filtri.
