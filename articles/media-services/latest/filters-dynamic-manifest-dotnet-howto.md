...
Il codice C# seguente illustra come creare un localizzatore di streaming e specificare `StreamingLocator.Filters`. Si tratta di una proprietà facoltativa che accetta un `IList<string>` di nomi di filtro.
