...
|Codifica del contenuto|Dopo aver caricato i file multimediali digitali di alta qualità in asset, è possibile codificarli in formati che possono essere riprodotti in un'ampia gamma di browser e dispositivi. <br/>Per eseguire la codifica con servizi multimediali V3, è necessario creare **trasformazioni** e **processi**.|[Trasformazioni e processi](transforms-jobs-concept.md)<br/><br/>[Codifica con servizi multimediali](encoding-concept.md)|
