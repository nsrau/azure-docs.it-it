...
1. Aprire il `App.java` file in `src\main\java\com\azure\ams` e verificare che il pacchetto sia incluso nella parte superiore:
...
- [Riferimenti per Java](https://aka.ms/ams-v3-java-ref)
