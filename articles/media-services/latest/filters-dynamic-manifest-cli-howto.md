...
description: Questo articolo illustra come usare l'interfaccia della riga di comando per creare filtri con Servizi multimediali di Azure 3.This article shows how to use CLI to create filters with Azure Media Services v3.
...
Il codice CLI seguente mostra come creare `filters`un localizzatore di flusso e specificare . Si tratta di una proprietà facoltativa che accetta un elenco separato da spazi di nomi di filtri di asset e/o nomi di filtri account.
