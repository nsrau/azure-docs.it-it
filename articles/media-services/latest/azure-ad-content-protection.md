...
![Screenshot che mostra l'analisi dei token JWT.](media/aad-ams-content-protection/parsing-jwt-tokens.png)
...
![Screenshot che mostra i test di contenuto protetto con diverse combinazioni di DRM/AES, protocolli di streaming e formato contenitore](media/aad-ams-content-protection/testing-protected-content.png)
-->
...
### <a name="azure-role-based-access-control-azure-rbac-for-license-delivery-via-azure-ad-group-membership"></a>Controllo degli accessi in base al ruolo di Azure per la distribuzione delle licenze tramite l'appartenenza ai gruppi di Azure AD
