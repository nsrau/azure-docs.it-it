...
| **Dimensione**<br />Necessario |Dimensioni del file di asset in byte.  <br /><br />Esempio: `"Size": 75739259`|
...
| Nome | Descrizione |
| --- | --- |
| **key**<br />Necessario |La chiave nella coppia chiave-valore. |
| **value**<br /> Necessario |Il valore nella coppia chiave-valore. |
