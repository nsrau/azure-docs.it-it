...
1. Fare clic su **Create Channel**. ![tricaster](./media/media-services-tricaster-live-encoder/media-services-tricaster2.png)
...
9. Incollare le informazioni nel campo **Posizione** sotto **Flash Server** all'interno del progetto Tricaster. Assegnare un nome di flusso nel campo **ID flusso**.
