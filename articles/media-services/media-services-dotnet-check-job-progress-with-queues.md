<properties 
	pageTitle="Usare l'archiviazione code di Azure per monitorare le notifiche dei processi di Servizi multimediali con .NET | Microsoft Azure" 
...
Servizi multimediali di Microsoft Azure può inviare messaggi di notifica all'[archiviazione di accodamento di Azure](../storage-dotnet-how-to-use-queues.md#what-is) durante l'elaborazione di processi multimediali. Questo argomento illustra come ricevere questi messaggi di notifica dal servizio di archiviazione code.
...
1. Crea la coda che riceve i messaggi di notifica relativi al processo di codifica.
