...
1. Specificare un nome di canale. Il campo della descrizione è facoltativo. In Impostazioni canale selezionare **Standard** per l'opzione Codifica live con Protocollo di input impostato su **RTP (MPEG-TS)**. È possibile confermare tutte le altre impostazioni predefinite.

Assicurarsi che l'opzione **Avvia ora il nuovo canale** sia selezionata.

1. Fare clic su **Create Channel**. ![Elemental](./media/media-services-elemental-live-encoder/media-services-elemental12.png)
...
> [!IMPORTANT]
> Prima di scegliere **Avvia** nell'interfaccia Web di Elemental Live, è **necessario** verificare che il canale sia pronto. Assicurarsi inoltre di non lasciare il canale in uno stato pronto senza un evento per più di 15 minuti.
> 
> 
