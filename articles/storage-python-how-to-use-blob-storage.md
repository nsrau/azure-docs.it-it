...
servizio di archiviazione BLOB di Azure. Gli esempi sono scritti con
l'API Python. Gli scenari presentati includono **caricamento**, **visualizzazione dell'elenco**,
...
Dopo questa modifica, i BLOB in un contenitore pubblico saranno visibili a tutti gli utenti di Internet,
tuttavia solo l'utente che li ha creati sarà in grado di modificarli o eliminarli.
...
codice seguente consente di inviare alla console il valore di **name** e **url** di ogni BLOB in un contenitore alla
console.
