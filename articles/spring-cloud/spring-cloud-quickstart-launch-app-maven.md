...
1. Nella sezione **Repository predefinito** impostare **URI** su **https://github.com/Azure-Samples/piggymetrics-config** e quindi selezionare **Applica** per salvare le modifiche.
