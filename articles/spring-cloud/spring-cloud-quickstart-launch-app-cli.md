...
Azure Spring Cloud consente di eseguire facilmente un'applicazione di microservizi basata su Spring Boot in Azure.  Prima di eseguire questo esempio, è possibile provare la [guida di avvio rapido di base](spring-cloud-quickstart.md).
...
3. Passare all'URL specificato dal comando precedente per eseguire l'applicazione PiggyMetrics.
    ![PiggyMetrics in esecuzione](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. Selezionare **gateway**
    ...
    ![Passaggio a PiggyMetrics](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. Trovare l'URL nella pagina della **panoramica di gateway** ![Passaggio a PiggyMetrics 2](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
