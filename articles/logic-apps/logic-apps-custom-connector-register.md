...
1. Scegliere **Crea una risorsa** dal menu principale di Azure nel portale di Azure. Nella casella di ricerca immettere "connettore app per la logica" come filtro e premere INVIO.
