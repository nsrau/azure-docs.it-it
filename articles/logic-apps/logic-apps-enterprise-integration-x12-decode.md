---
title: Informazioni sul connettore Decode X12 Message ed Enterprise Integration Pack | Documentazione Microsoft
...
---
# <a name="get-started-with-decode-x12-message"></a>Introduzione a Decode X12 Message
...
### <a name="connect-to-decode-x12-message-using-the-following-steps"></a>Connettersi a Decode X12 Message usando questa procedura:
...
## <a name="x12-decode-does-following"></a>X12 Decode esegue queste operazioni
