...
* [Rilevamento dei messaggi B2B in log di monitoraggio di Azure](logic-apps-track-b2b-messages-omsportal.md "altre informazioni sul rilevamento dei messaggi B2B in log di monitoraggio di Azure")
