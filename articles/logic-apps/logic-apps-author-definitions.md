...
*   La [`intersection()`](../logic-apps/logic-apps-workflow-definition-language.md) funzione controlla se la categoria corrisponde a una categoria definita nota.
