...
description: Questa panoramica descrive in che modo gli ambienti del servizio di integrazione (ISE) per aiutano le app per la logica ad accedere alle reti virtuali di Azure
services: logic-apps
