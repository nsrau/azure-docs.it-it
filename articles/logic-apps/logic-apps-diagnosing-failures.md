---
title: Diagnosi degli errori in App per la logica di Azure | Documentazione Microsoft
...
---
# <a name="diagnosing-logic-app-failures"></a>Diagnosi degli errori delle app per la logica
...
#### <a name="starting-a-trigger-manually"></a>Avviare manualmente un trigger
...
> [!NOTE]
> Potrebbe essere utile comprendere il modo in cui le app per la logica [gestiscono diversi tipi di contenuto](../logic-apps/logic-apps-content-type.md) , se si notano contenuti poco chiari.
> 
> 
...
## <a name="debugging-workflow-runtime"></a>Debug del runtime del flusso di lavoro
