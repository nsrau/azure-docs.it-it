        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni sulle app per la logica</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Catalogo video di app per la logica</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introduzione alla creazione di una nuova app per la logica che connette servizi SaaS</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introduzione alla creazione di un'app per la logica mediante un modello</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Schemi</h3>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-definition-language">Linguaggio di definizione del flusso di lavoro</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-workflow-actions-triggers">Azioni e trigger del flusso di lavoro</a></p>
                   </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Cronologia degli schemi</h3>
                        <p><a href="/azure/logic-apps/logic-apps-schema-2016-04-01">Disponibilità generale</a></p>
                        <p><a href="/azure/logic-apps/logic-apps-schema-2015-08-01">Anteprima</a></p>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/logic/">Informazioni di riferimento sulle API REST</a></p>
                    </div>
                </div>
            </div>
        </div>
