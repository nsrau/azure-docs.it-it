...
1. Nel Portale di Azure aprire l'app per la logica per cui si desidera aggiungere limitazioni per l'indirizzo IP.
2. Fare clic sulla voce di menu **Access control configuration** (Configurazione controllo di accesso) in **Impostazioni**.
3. Specificare l'elenco di intervalli di indirizzi IP per l'accesso al contenuto
