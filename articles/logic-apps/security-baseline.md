...
* [Informazioni sui connettori per le app per la logica](https://docs.microsoft.com/azure/connectors/apis-list)

* [Informazioni sui tag del servizio in Azure](https://docs.microsoft.com/azure/virtual-network/service-tags-overview)

* [Informazioni sull'accesso alle risorse della rete virtuale di Azure da app per la logica di Azure tramite gli ambienti di Integration Services (ISEs)](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment-overview)
...
* [Informazioni sull'accesso all'endpoint ISE](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment-overview#ise-endpoint-access)
...
* [Come abilitare l'accesso per ISE](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment#enable-access-for-ise)
...
* [Come proteggere le chiamate in ingresso alle app per la logica](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-request-based-triggers)

* [Come limitare gli indirizzi IP in ingresso](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#restrict-inbound-ip-addresses)
...
* [Come comprendere i log di accesso di WAF](https://docs.microsoft.com/azure/web-application-firewall/ag/web-application-firewall-logs#access-log)
...
* [Informazioni su come integrare Gestione API in una VNET interna con un gateway applicazione](https://docs.microsoft.com/azure/api-management/api-management-howto-integrate-internal-vnet-appgateway)
...
* [Elenco di definizioni di criteri di Azure per app per la logica](https://docs.microsoft.com/azure/logic-apps/policy-samples)
...
* [Come configurare i log di monitoraggio di Azure e raccogliere i dati di diagnostica per le app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/monitor-logic-apps-log-analytics)
...
* [Come monitorare lo stato di esecuzione, rivedere la cronologia dei trigger e configurare gli avvisi per le app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/monitor-logic-apps)
...
* [Come raccogliere e analizzare i log attività di Azure in Log Analytics di monitoraggio di Azure](https://docs.microsoft.com/azure/azure-monitor/platform/activity-log-collect)
...
* [Autenticare l'accesso alle risorse di Azure usando identità gestite in App per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/create-managed-service-identity)
...
* [Come proteggere l'accesso e i dati in app per la logica di Azure con SAS](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-request-based-triggers)
...
* [Come proteggere e accedere ai dati nelle app per la logica](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app)

* [Come impostare e recuperare un segreto da Azure Key Vault](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-portal)
...
* [Informazioni API dei trigger del flusso di lavoro](https://docs.microsoft.com/rest/api/logic/workflowtriggers)

* [Informazioni sulla configurazione del connettore](https://docs.microsoft.com/azure/connectors/apis-list])
...
* [Informazioni su come limitare gli indirizzi IP in ingresso nelle app per la logica](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#restrict-inbound-ip-addresses)
...
* [Accedere alle risorse di Rete virtuale di Azure da App per la logica di Azure usando ambienti del servizio di integrazione (ISE)](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment-overview)
...
* [Proteggere l'accesso e i dati in App per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app)

* [Ricevere e rispondere alle richieste HTTPS in ingresso in App per la logica di Azure](https://docs.microsoft.com/azure/connectors/connectors-native-reqres#tls-support)

* [Chiamare gli endpoint di servizio su HTTP o HTTPS da App per la logica di Azure](https://docs.microsoft.com/azure/connectors/connectors-native-http#tls-support)
...
* [Informazioni sulla crittografia dei dati inattivi con Azure](https://docs.microsoft.com/azure/security/fundamentals/encryption-atrest)

* [Configurare chiavi gestite dal cliente per la crittografia dei dati inattivi per gli ambienti di Integration Services (ISEs) in app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/customer-managed-keys-integration-service-environment)
...
* [Proteggere l'accesso ai dati della cronologia di esecuzione](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-run-history-data)
...
* [Proteggere l'accesso alle operazioni di app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-logic-app-operations)
...
* [Crittografare i dati inattivi per gli ambienti di Integration Services in app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/customer-managed-keys-integration-service-environment)
...
* [Elenco di tutti i connettori di app per la logica](https://docs.microsoft.com/connectors/connector-reference/connector-reference-logicapps-connectors)

* [Informazioni sui problemi e sulle limitazioni per i connettori Gmail](https://docs.microsoft.com/connectors/gmail/#known-issues-and-limitations)

* [Altre informazioni sull'informativa sulla privacy di Google](https://docs.microsoft.com/azure/connectors/connectors-google-data-security-privacy-policy)
...
* [Come proteggere l'accesso alle app per la logica tramite RBAC](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-logic-app-operations)
...
* [Blocca le connessioni create dai connettori nelle app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/block-connections-connectors)
...
* [Come distribuire modelli di Azure Resource Manager per app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/logic-apps-deploy-azure-resource-manager-templates)

* [Informazioni sui parametri di azione protetti](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#secure-action-parameters)

* [Raccomandazioni sulla sicurezza per i parametri](https://docs.microsoft.com/azure/azure-resource-manager/templates/template-best-practices#security-recommendations-for-parameters)
...
* [Proteggere l'accesso agli input e agli output della cronologia di esecuzione](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#obfuscate)

* [Proteggere l'accesso agli input di parametri](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#secure-action-parameters)
...
* [Proteggere gli input e gli output nella cronologia di esecuzione in app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#obfuscate)

* [Raccomandazioni sulla sicurezza per i parametri](https://docs.microsoft.com/azure/azure-resource-manager/templates/template-best-practices#security-recommendations-for-parameters)

* [Proteggere l'accesso agli input di parametri in app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-parameter-inputs)

* [Passare i valori di parametro protetti durante la distribuzione usando Azure Key Vault](https://docs.microsoft.com/azure/azure-resource-manager/templates/key-vault-parameter)
...
* [Come autenticare l'accesso alle risorse di Azure usando identità gestite in app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/create-managed-service-identity)
...
* [Informazioni su Microsoft anti-malware per servizi cloud e macchine virtuali di Azure](https://docs.microsoft.com/azure/security/fundamentals/antimalware)
...
* [Altre informazioni sulla continuità aziendale e il ripristino di emergenza per app per la logica di Azure](https://docs.microsoft.com/azure/logic-apps/business-continuity-disaster-recovery-guidance)

* [Come automatizzare la distribuzione per app per la logica di Azure usando modelli di Azure Resource Manager](https://docs.microsoft.com/azure/logic-apps/logic-apps-azure-resource-manager-templates-overview)
