...
Per altri dettagli sulla sintassi supportata, vedere la [sezione retryPolicy in MSDN][retryPolicyMSDN].
...
* [Informazioni su come un cliente ha implementato una solida gestione delle eccezioni con App per la logica](../logic-apps/logic-apps-scenario-error-and-exception-handling.md)
* [Altri esempi e scenari di app per la logica](../logic-apps/logic-apps-examples-and-scenarios.md)
* [Informazioni su come creare distribuzioni automatizzate delle app per la logica](../logic-apps/logic-apps-create-deploy-template.md)
* [Progettare e distribuire app per la logica in Visual Studio](logic-apps-deploy-from-vs.md)
