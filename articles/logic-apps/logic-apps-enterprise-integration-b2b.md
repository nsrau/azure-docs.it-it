...
Questo documento fa parte di Enterprise Integration Pack per le App per la logica. Per altre informazioni sulle [funzionalità di Enterprise Integration Pack](logic-apps-enterprise-integration-overview.md), vedere la panoramica.

## <a name="prerequisites"></a>Prerequisiti
Per usare le azioni AS2 e X12 è necessario un account Enterprise Integration

[Come creare un account Enterprise Integration](../logic-apps/logic-apps-enterprise-integration-accounts.md)
...
1. Creare una nuova app per la logica e [collegarla all'account di integrazione](../logic-apps/logic-apps-enterprise-integration-accounts.md).  
