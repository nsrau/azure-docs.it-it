...
5.  [Aggiornamento dei token scaduti][]
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [guarda l'esercitazione]: http://channel9.msdn.com/Series/Windows-Azure-Mobile-Services/Android-Getting-Started-with-Authentication-in-Windows-Azure-Mobile-Services
