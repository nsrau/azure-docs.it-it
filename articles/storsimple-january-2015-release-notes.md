<properties 
    pageTitle="Note sulla versione di StorSimple - Gennaio 2015"
...
# Note sulla versione di StorSimple - Gennaio 2015

## Panoramica

Le seguenti note sulla versione identificano i problemi critici aperti per la versione di gennaio 2015 di StorSimple di Microsoft Azure. Contengono inoltre un elenco degli aggiornamenti software e firmware di StorSimple inclusi in questa versione. Questa è la seconda versione dopo la versione di disponibilità generale \(GA\) di Microsoft Azure StorSimple.
...
|9|	Proxy Web|Se nella configurazione del proxy Web è specificato il protocollo HTTPS, la comunicazione tra dispositivo e servizio ne sarà interessata e il dispositivo passerà offline. Nel processo, inoltre, verranno generati pacchetti di supporto, consumando risorse significative sul dispositivo.|Assicurarsi che l'URL del proxy Web abbia HTTP come protocollo specificato. Ulteriori informazioni su come [Configurare il proxy Web per il dispositivo](https://msdn.microsoft.com/library/azure/dn764937.aspx).|Sì |No
|10|Proxy Web|	Se il proxy Web viene configurato e abilitato su un dispositivo registrato, è necessario riavviare il controller attivo sul dispositivo.||	Sì |No
