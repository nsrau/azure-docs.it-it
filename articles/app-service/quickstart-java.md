...
1. Quando viene visualizzata l'opzione **App Web**, accettare l'opzione predefinita `<create>` premendo INVIO.
1. Quando viene visualizzata l'opzione **Sistema operativo**, selezionare **windows** immettendo `2`.
