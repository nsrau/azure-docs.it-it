---
title: 'Esercitazione: App Node.js Linux con MongoDB'
description: Informazioni su come usare un'app Node.js Linux in Servizio app di Azure, con connessione a un database MongoDB in Azure (Cosmos DB). MEAN.js verrà usato nell'esercitazione.
