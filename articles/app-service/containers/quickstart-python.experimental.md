---
title: "Guida introduttiva: Creare un'app Python in Linux - Servizio app di Azure"
...
## <a name="run-the-sample-app-locally"></a>Eseguire l'app di esempio in locale
