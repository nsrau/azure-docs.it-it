...
Il server Rails deve essere in esecuzione per consentire il funzionamento dell'applicazione. Passare alla directory `hello-world` e usare il comando `rails server` per avviare il server.
