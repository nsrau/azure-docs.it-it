---
title: 'Esercitazione: Linux ASP.NET Core con database SQL'
description: Informazioni su come usare un'app ASP.NET Core Linux basata sui dati da usare in Servizio app di Azure, con connessione al database SQL.
...
* [Installare .NET Core SDK 2.2](https://dotnet.microsoft.com/download/dotnet-core/2.2)
...
L'app si connette attualmente a un database SQLite locale. Ora che è stato configurato un database di Azure, creare di nuovo la migrazione iniziale per usarlo come destinazione.
