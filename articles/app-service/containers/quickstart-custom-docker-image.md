...
# <a name="run-a-custom-docker-hub-image-in-azure-web-apps-for-containers"></a>Eseguire un'immagine Docker Hub personalizzata in App Web di Azure per contenitori #
