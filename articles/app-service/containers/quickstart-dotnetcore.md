---
title: Creare un'app .NET Core in Linux - Servizio app di Azure | Microsoft Docs
...
ms.locfileid: "53633931"
---
# <a name="create-a-net-core-app-in-app-service-on-linux"></a>Creare un'app .NET Core nel Servizio app in Linux
