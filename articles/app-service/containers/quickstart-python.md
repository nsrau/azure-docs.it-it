...
L'immagine Python predefinita nel Servizio app di Azure in Linux è attualmente in anteprima. È possibile invece creare app Python di produzione usando un contenitore personalizzato.
