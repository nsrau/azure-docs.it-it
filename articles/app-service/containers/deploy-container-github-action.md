...
3. A questo punto, nel file del flusso di `.github/workflows/workflow.yml` lavoro nel ramo, sostituire il segreto nell'azione di accesso di Azure con il segreto.
