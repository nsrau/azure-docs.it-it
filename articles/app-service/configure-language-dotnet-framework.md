...
È possibile aggiungere messaggi di diagnostica nel codice dell'applicazione usando [System. Diagnostics. Trace](https://docs.microsoft.com/dotnet/api/system.diagnostics.trace). Ad esempio: 
