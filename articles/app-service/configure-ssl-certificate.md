...
Dopo aver caricato il certificato, copiare l'identificazione personale del certificato e vedere [Rendere accessibile il certificato](configure-ssl-certificate-in-code.md#load-the-certificate).
