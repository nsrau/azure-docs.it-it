...
:::image type="content" source="./media/tutorial-php-mysql-app/php-mysql-in-azure.png" alt-text="Screenshot di un esempio di app PHP denominato Elenco attività.":::
