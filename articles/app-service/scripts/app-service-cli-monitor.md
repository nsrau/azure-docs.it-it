...
Questo script di esempio crea un gruppo di risorse, il piano di servizio app e app web e configura l'app web per abilitare i registri del server web. Quindi scarica i file di log per la revisione.
...
| [`az webapp log config`](/cli/azure/webapp/log?view=azure-cli-latest#az_webapp_log_config) | Consente di configurare i log persiste un'app web di Azure. |
