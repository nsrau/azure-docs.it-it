...
| [`az webapp log config`](/cli/azure/webapp/log?view=azure-cli-latest#az_webapp_log_config) | Configura i log che devono essere mantenuti da un'app Web di Azure. |
| [`az webapp log download`](/cli/azure/webapp/log?view=azure-cli-latest#az_webapp_log_download) | Scarica i log di un'app Web di Azure nel computer locale. |
