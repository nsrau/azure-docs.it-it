...
| [`az webapp deployment list-publishing-profiles`](/cli/azure/webapp/deployment?view=azure-cli-latest#az-webapp-deployment-list-publishing-profiles) | Ottenere i dettagli dei profili disponibili per la distribuzione dell'app Web. |
