...
* **Testare in ambiente di produzione**. Creare senza problemi ambienti di preproduzione e gestire la quantità di traffico diretta a tali ambienti. Eseguire il debug nel cloud quando necessario ed eseguire il rollback se vengono rilevati problemi.
...
Nel complesso le funzionalità del Servizio app consentono agli sviluppatori di concentrarsi sul codice e raggiungere rapidamente uno stato di produzione stabile e scalabile. Con le funzionalità delle app per le API e per la logica, gli sviluppatori possono compilare applicazioni aziendali reali che superano le barriere tra le soluzioni aziendali e favoriscono l'integrazione tra locale e cloud.  
