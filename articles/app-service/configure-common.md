...
Nella [portale di Azure]cercare e selezionare **Servizi app**e quindi selezionare l'app. Nel menu a sinistra dell'app selezionare **configurazione** > **Impostazioni applicazione**.
...
Nella [portale di Azure]cercare e selezionare **Servizi app**e quindi selezionare l'app. Nel menu a sinistra dell'app selezionare **configurazione** > **Impostazioni generali**.
...
Nella [portale di Azure]cercare e selezionare **Servizi app**e quindi selezionare l'app. Nel menu a sinistra dell'app selezionare **Configuration** > **Default Documents**.
...
Nella [portale di Azure]cercare e selezionare **Servizi app**e quindi selezionare l'app. Nel menu a sinistra dell'app selezionare**mapping dei percorsi**di **configurazione** > .
