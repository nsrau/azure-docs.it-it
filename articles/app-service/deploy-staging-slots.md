---
title: Configurare ambienti di gestione temporanea per le app Web - Servizio app di Azure | Microsoft Docs
...
Il completamento dell'operazione di scambio talvolta richiede tempo, ad esempio quando l'app scambiata presenta un lungo tempo di riscaldamento. È possibile visualizzare altre informazioni sulle operazioni di scambio nel [log attività](../azure-monitor/platform/activity-logs-overview.md) nel [portale di Azure](https://portal.azure.com).
...
[Blocco dell'accesso Web agli slot di distribuzione non di produzione nell'app Web del servizio app di Azure](https://ruslany.net/2014/04/azure-web-sites-block-web-access-to-non-production-deployment-slots/)  
