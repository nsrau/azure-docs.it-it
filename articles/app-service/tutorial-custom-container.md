...
:::image type="content" source="media/tutorial-custom-container/enable-container-orchestration.png" alt-text="Screenshot della finestra Esplora soluzioni che mostra il progetto CustomFontSample con le voci di menu Aggiungi e Container Orchestrator Support (Supporto orchestrazione contenitori) selezionate.":::
...
:::image type="content" source="media/tutorial-custom-container/open-publish-wizard.png" alt-text="Screenshot di Esplora soluzioni che mostra il progetto CustomFontSample con Pubblica selezionato.":::
...
:::image type="content" source="media/tutorial-custom-container/create-registry.png" alt-text="Screenshot della pubblicazione guidata che mostra Registro contenitori, Crea nuovo Registro Azure Container e il pulsante Pubblica selezionato.":::
...
> [!NOTE]
> Docker Hub prevede [quote sul numero di pull anonimi per indirizzo IP e sul numero di pull autenticati per ogni utente gratuito (vedere **Trasferimento dei dati**)](https://www.docker.com/pricing). Se si nota che i pull da Docker Hub sono limitati, provare `docker login`, se non si è già connessi.
> 
