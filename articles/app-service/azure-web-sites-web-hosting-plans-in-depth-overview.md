...
Nel [portale di Azure](https://portal.azure.com) fare clic su **Nuovo** > 
**Web e dispositivi mobili** e quindi selezionare **App Web** o un altro tipo di app del servizio app.
...
> [!IMPORTANT]
> Vengono visualizzati solo i piani validi, nello stesso gruppo di risorse e nella stessa località geografica.
