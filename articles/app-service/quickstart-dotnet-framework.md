---
title: "Avvio rapido: Creare un'app ASP.NET in C#"
...
## <a name="create-an-aspnet-web-app"></a>Creare un'app Web ASP.NET<a name="create-and-publish-the-web-app"></a>
...
3. In **Configura il nuovo progetto** assegnare all'applicazione il nome _myFirstAzureWebApp_ e quindi selezionare **Crea**.
   ...
   ![Configurare il progetto di app Web](./media/quickstart-dotnet-framework/configure-web-app-project-framework.png)
...
5. Verificare che l'autenticazione sia impostata su **Nessuna autenticazione**. Selezionare **Crea**.
   ...
   ![Creare un'applicazione Web ASP.NET](./media/quickstart-dotnet-framework/select-mvc-template-vs2019.png)

6. Nel menu di Visual Studio selezionare **Debug** > **Avvia senza eseguire debug** per eseguire l'app Web in locale.

   ![Eseguire l'app in locale](./media/quickstart-dotnet-framework/local-web-app.png)

## <a name="publish-your-web-app"></a>Pubblicare l'app Web<a name="launch-the-publish-wizard"></a>
...
1. Selezionare **Servizio app di Azure (Windows)** e fare clic su **Avanti**.
...
1. Le opzioni disponibili variano a seconda che sia già stato eseguito l'accesso ad Azure e che si abbia un account di Visual Studio collegato a un account di Azure. Selezionare **Aggiungi un account** o **Accedi** per accedere alla sottoscrizione di Azure. Se è già stato effettuato l'accesso, selezionare l'account da usare.
   ...
   ![Accedere ad Azure](./media/quickstart-dotnet-framework/sign-in-azure-framework-vs2019.png)

   [!INCLUDE [resource group intro text](../../includes/resource-group.md)]

1. A destra di **Istanze di Servizio app** fare clic su **+** .

   ![Nuova app del servizio app](./media/quickstart-dotnet-framework/publish-new-app-service.png)
...
1. Nella finestra di dialogo **Piano di hosting** immettere i valori della tabella seguente, quindi selezionare **OK**.

   | Impostazione | Valore consigliato | Descrizione |
   |-|-|-|
   | Piano di hosting| myAppServicePlan | Nome del piano di servizio app. |
   ...
   ![Creare un piano di servizio app](./media/quickstart-dotnet-framework/app-service-plan-framework-vs2019.png)
...
2. Selezionare **Crea** per creare le risorse di Azure.
   ...
   ![Configurare il nome dell'app](./media/quickstart-dotnet-framework/web-app-name-framework-vs2019.png)
...
3. Nella pagina **Pubblica** fare clic su **Pubblica**. Visual Studio compila, crea il pacchetto e pubblica l'app in Azure, quindi la avvia nel browser predefinito.

    ![App Web ASP.NET pubblicata in Azure](./media/quickstart-dotnet-framework/published-azure-web-app.png)

Il nome dell'app specificato nella pagina **Servizio app - Crea nuovo** viene usato come prefisso dell'URL nel formato `http://<app-name>.azurewebsites.net`.
...
1. Per la ridistribuzione in Azure, fare clic con il pulsante destro del mouse sul progetto **myFirstAzureWebApp** in **Esplora soluzioni** e selezionare **Pubblica**. Scegliere quindi **Pubblica**.
    ...
    ![App Web ASP.NET aggiornata in Azure](./media/quickstart-dotnet-framework/updated-azure-web-app.png)
...
1. Per gestire l'app Web, passare al [portale di Azure](https://portal.azure.com), quindi cercare e selezionare **Servizi app**.
   ...
   ![Selezionare Servizi app](./media/quickstart-dotnet-framework/app-services.png)

2. Nella pagina **Servizi app** selezionare il nome dell'app Web.

   ![Passaggio all'app di Azure nel portale](./media/quickstart-dotnet-framework/access-portal-framework-vs2019.png)
   ...
   ![Panoramica del servizio app nel portale di Azure](./media/quickstart-dotnet-framework/web-app-general-framework-vs2019.png)
