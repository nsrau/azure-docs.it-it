...
È consigliabile usare la cache locale insieme alla funzionalità degli [ambienti di gestione temporanea](../app-service/web-sites-staged-publishing.md) .
...
* Al termine, eseguire un' [operazione di scambio](../app-service/web-sites-staged-publishing.md#Swap) tra lo slot di gestione temporanea e lo slot di produzione.  
