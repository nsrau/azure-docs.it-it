...
1. Nel menu a sinistra del [portale di Azure](https://portal.azure.com)selezionare **Servizi** > **\<app any_app>**  > **Dashboard** > **FTP** > del **centro distribuzione**.
    ...
    In alternativa, se è già stata configurata la distribuzione git, selezionare **Servizi** > **&lt;app any_app>**  >  > **FTP/credenziali**del **centro distribuzione**.
...
1. Nel menu a sinistra del [portale di Azure](https://portal.azure.com)selezionare **Servizi** > **&lt;app any_app>**  >  **centro** > distribuzione**FTP/credenziali**.
