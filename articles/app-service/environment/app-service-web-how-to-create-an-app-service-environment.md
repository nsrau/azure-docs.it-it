...
Per informazioni dettagliate sul ridimensionamento manuale, sulla gestione e sul monitoraggio degli ambienti del servizio app, vedere qui: [come configurare un ambiente del servizio app][ASEConfig] 

Per informazioni sulla scalabilità automatica, vedere la sezione [come configurare la scalabilità automatica per un ambiente del servizio app][ASEAutoscale]
