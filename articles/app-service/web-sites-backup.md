...
Le soluzioni di database seguenti sono supportate con funzionalità di backup: 
   ...
   - [Database di Azure per PostgreSQL (anteprima)](https://azure.microsoft.com/services/postgresql)
...
Caricare il file `_backup.filter` nella directory `D:\home\site\wwwroot\` del sito usando [ftp](app-service-deploy-ftp.md) o qualsiasi altro metodo. È anche possibile creare il file direttamente usando il comando `DebugConsole` in Kudu e inserire i contenuti nel file.
