...
- Sostituire *\<username>* e *\<password>* con le credenziali generate anch'esse automaticamente dal comando. L'argomento `DBUSER` deve essere specificato nel formato `<username>@<postgres-server-name>`.
