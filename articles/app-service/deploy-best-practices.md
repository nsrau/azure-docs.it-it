...
È anche possibile automatizzare la distribuzione del contenitore [con le azioni di GitHub](containers/deploy-container-github-action.md).  Il file del flusso di lavoro seguente consente di compilare e contrassegnare il contenitore con l'ID commit, eseguirne il push in un registro contenitori e aggiornare lo slot del sito specificato con il nuovo tag di immagine.
