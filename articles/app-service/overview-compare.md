---
title: Confrontare Servizio app, Macchine virtuali, Service Fabric e Servizi cloud - Azure | Microsoft Docs
...
| Installazione di qualsiasi MSI personalizzato | |X |X |X |Service Fabric consente di ospitare qualsiasi file eseguibile come [eseguibile guest](../service-fabric/service-fabric-guest-executables-introduction.md) o di installare qualsiasi app nelle macchine virtuali. |
...
* Creare rapidamente un'[app per dispositivi mobili](../app-service-mobile/app-service-mobile-value-prop.md) o un'app per le API per ospitare il servizio Web HTTP in uno dei data center di Azure distribuiti a livello globale.
