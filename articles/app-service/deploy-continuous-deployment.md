...
1. Selezionare l'app Web che si vuole distribuire.
...
1. Nella [portale di Azure](https://portal.azure.com)cercare e selezionare **Servizi app**e quindi selezionare l'app Web che si vuole distribuire. 
