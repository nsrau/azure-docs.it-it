...
Clonare il repository di esempio usando il comando seguente, quindi passare alla cartella. [Installare Git](https://git-scm.com/downloads) se non si è già presente.
