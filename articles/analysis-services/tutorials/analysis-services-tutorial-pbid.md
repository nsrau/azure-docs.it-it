...
author: minewiskan
description: Informazioni su come ottenere un nome di server di Analysis Services dal portale di Azure e quindi connettersi al server con Power BI Desktop.
