...
> [!TIP]
> Prima di distribuire, assicurarsi che sia possibile elaborare i dati nelle tabelle. In Visual Studio fare clic su **modello** > **elabora** > **tutto**. Se l'elaborazione ha esito negativo, la distribuzione non potrà essere eseguita.
> 
> 
...
1. In Visual Studio > **Esplora soluzioni**fare clic con il pulsante destro del mouse sul progetto > **Proprietà**. Quindi, in**server** di **distribuzione** > incollare il nome del server.   
