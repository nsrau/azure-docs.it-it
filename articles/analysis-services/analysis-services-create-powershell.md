...
Accedere alla sottoscrizione di Azure usando il comando [Connect-AzAccount](/powershell/module/az.profile/connect-azaccount). Seguire le istruzioni visualizzate sullo schermo.
