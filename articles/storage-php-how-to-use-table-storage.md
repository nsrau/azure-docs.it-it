...
##<a id="ConnectionString"></a>Configurazione di una connessione di Archiviazione di Azure
...
A questo punto, dopo avere appreso le nozioni di base del Servizio tabelle di Azure, usare i collegamenti seguenti per altre informazioni su come eseguire attività di archiviazione più complesse.
...
[table-service-timeouts]: http://msdn.microsoft.com/it-it/library/windowsazure/dd894042.aspx
