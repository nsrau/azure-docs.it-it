...
-   [Procedura: Recuperare un subset di entità in una partizione][Procedura: Recuperare un subset di entità in una partizione]
-   [Procedura: Recuperare un subset di proprietà di entità][Procedura: Recuperare un subset di proprietà di entità]
-   [Procedura: Aggiornare un'entità][Procedura: Aggiornare un'entità]
-   [Procedura: Operazioni batch su tabella][Procedura: Operazioni batch su tabella]
...
Per informazioni sulle restrizioni ai nomi delle tabelle, vedere [Informazioni sul modello di dati del servizio tabelle][Informazioni sul modello di dati del servizio tabelle].
...
-   Blog del team di Archiviazione di Azure: <http://blogs.msdn.com/b/windowsazurestorage/>
  ...
  [Esecuzione di transazioni di gruppi di entità]: http://msdn.microsoft.com/it-it/library/windowsazure/dd894038.aspx
