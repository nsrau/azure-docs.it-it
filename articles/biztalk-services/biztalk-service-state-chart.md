...
Le tabelle seguenti elencano le operazioni o le azioni che possono essere eseguite quando il servizio BizTalk è in uno stato specifico. Il simbolo ✔ indica che l'operazione è consentita in quel determinato stato. Uno spazio vuoto indica che l'operazione non può essere eseguita in quel determinato stato.
...
* [Operazioni eseguibili nelle schede Dashboard, Monitoraggio e Scalabilità nei servizi BizTalk](https://go.microsoft.com/fwlink/p/?LinkID=302281)<br/>
* [Funzionalità e contenuti delle edizioni Developer, Basic, Standard e Premium nei servizi BizTalk](https://go.microsoft.com/fwlink/p/?LinkID=302279)<br/>
* [Come eseguire il backup e il ripristino di un servizio BizTalk](https://go.microsoft.com/fwlink/p/?LinkID=329873)<br/>
* [Le limitazioni spiegate nei servizi BizTalk](https://go.microsoft.com/fwlink/p/?LinkID=302282)<br/>
* [Recuperare il bus di servizio e il nome e la chiave dell'autorità emittente del Controllo di accesso per il servizio BizTalk](https://go.microsoft.com/fwlink/p/?LinkID=303941)<br/>
