...
| 8. |Amministratore |Tramite [REST](https://msdn.microsoft.com/library/azure/dn232347.aspx) monitorare l'integrità del servizio BizTalk, comprese le metriche delle prestazioni. |[Servizi BizTalk: Schede dashboard, monitoraggio e scalabilità](https://go.microsoft.com/fwlink/p/?LinkID=302281) |
