<properties urlDisplayName="Push Notifications to Users (WP8)" pageTitle="Notifiche push agli utenti (Windows Phone) | Mobile Developer Center" metaKeywords="deprecated" description="Informazioni su come usare Servizi mobili per inviare notifiche push agli utenti dell'app per Windows Phone." metaCanonical="" services="mobile-services,notification-hubs" documentationCenter="" title="Push notifications to users by using Mobile Services" authors="glenga" solutions="" manager="dwrede" editor="" />
