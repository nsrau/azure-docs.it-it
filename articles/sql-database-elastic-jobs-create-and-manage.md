...
* Installazione dei componenti del servizio relativo ai processi elastici di database. Vedere l'articolo sull'[installazione del servizio relativo ai processi elastici di database](vsql-database-elastic-jobs-service-installation.md).
