...
- **Terraform**: [installare e configurare Terraform](terraform-install-configure.md).
...
![Risultati del test](media/terraform-vscode-extension/tf-end-to-end-test-results.png)
