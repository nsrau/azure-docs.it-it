...
4.  Nella finestra *Maven Projects* specificare la cartella che contiene il progetto (la cartella contenente il file POM.XML), fare clic su *Select All* e quindi su *Finish*.
