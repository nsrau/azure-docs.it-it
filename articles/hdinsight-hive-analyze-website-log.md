...
- È necessario avere completato il provisioning di un **cluster HDInsight**. Per ottenere istruzioni, vedere [Effettuare il provisioning di cluster HDInsight][hdinsight-provision]. 
