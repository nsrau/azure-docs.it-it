...
Eliminare una riga in una tabella dati. Chiamare il metodo [done][done] sull'oggetto [Promise][done] restituito per ottenere una copia dell'oggetto inserito e gestire eventuali errori.
