---
title: Guida introduttiva alle soluzioni VMware di Azure (AVS)-creare macchine virtuali VMware in Azure
description: Informazioni su come creare e configurare macchine virtuali VMware da portale di Azure usando le soluzioni VMware di Azure (AVS)
...
---
# <a name="quickstart---create-vmware-vms-on-azure"></a>Guida introduttiva-creare macchine virtuali VMware in Azure

Per creare una macchina virtuale nella portale di Azure, usare i modelli di macchina virtuale abilitati dall'amministratore AVS per la sottoscrizione. I modelli di macchina virtuale sono disponibili nell'infrastruttura VMware.

## <a name="avs-vm-creation-on-azure-requires-a-vm-template"></a>Per la creazione di macchine virtuali AVS in Azure è necessario un modello di macchina virtuale

Creare una macchina virtuale nel cloud privato AVS dall'interfaccia utente di vCenter. Per creare un modello, seguire le istruzioni in [clonare una macchina virtuale in un modello nel client Web vSphere](https://docs.vmware.com/en/VMware-vSphere/6.7/com.vmware.vsphere.vm_admin.doc/GUID-FE6DE4DF-FAD0-4BB0-A1FD-AFE9A40F4BFE.html). Archiviare il modello di macchina virtuale in AVS private cloud vCenter.
...
4. Immettere le informazioni di base e fare clic su **Next: size**.
    ...
    | Campo | Description |
    | ------------ | ------------- |
    | Sottoscrizione | Sottoscrizione di Azure associata al cloud privato AVS. |
    ...
    | Cloud privato AVS | AVS private cloud in cui si vuole creare la macchina virtuale. |
...
6. Configurare le interfacce di rete e i dischi come descritto nelle tabelle seguenti e fare clic su **Verifica + crea**.
    ...
    | Rete | Consente di selezionare nell'elenco del gruppo di porte distribuite configurato in AVS private cloud vSphere. |
...
* [Visualizza l'elenco delle macchine virtuali AVS](azure-create-vm.md#view-list-of-avs-virtual-machines)
* [Gestire la macchina virtuale AVS da Azure](azure-manage-vm.md)
