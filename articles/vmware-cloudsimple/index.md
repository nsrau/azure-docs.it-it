---
title: Soluzioni VMware in Azure (AVS)
description: Portale della documentazione per Soluzioni VMware in Azure (AVS).
author: sharaths-cs
ms.author: b-mashar
ms.date: 08/20/2019
ms.topic: article
...
---
# <a name="azure-vmware-solution-by-avs"></a>Soluzione Azure VMware di AVS

Benvenuti nel portale unico che contiene informazioni sulla soluzione Azure VMware di AVS.
Nel sito della documentazione è possibile ottenere informazioni sugli argomenti seguenti:

## <a name="overview"></a>Panoramica

Altre informazioni su Soluzioni VMware in Azure (AVS)

* Per informazioni su funzionalità, vantaggi e scenari di utilizzo, vedere [Informazioni sulla soluzione Azure VMware di AVS](cloudsimple-vmware-solutions-overview.md)
...
* Per informazioni su come creare un nuovo ambiente VMware, vedere [Configurare un ambiente cloud privato AVS](quickstart-create-private-cloud.md)
...
* Un [servizio AVS](cloudsimple-service.md) (noto anche come "Soluzioni VMware in Azure (AVS) - Servizio"). Questa risorsa deve essere creata una sola volta per ogni area.
* Acquistare capacità per l'ambiente creando una o più risorse di tipo [Nodo AVS](cloudsimple-node.md). Queste risorse vengono definite anche come "Soluzione Azure VMware di AVS - Nodo".
* Inizializzare e configurare l'ambiente VMware usando i [cloud privati AVS](cloudsimple-private-cloud.md).
* Unificare la gestione usando [macchine virtuali AVS](cloudsimple-virtual-machines.md) (note anche come "Soluzioni VMware in Azure (AVS) - Macchina virtuale").
...
* [Creare un servizio AVS](create-cloudsimple-service.md), una sola volta per ogni area in cui si intende distribuire ambienti VMware.
* Gestire la funzionalità di base del servizio nel [portale di AVS](access-cloudsimple-portal.md).
* Abilitare la capacità e ottimizzare la fatturazione per l'infrastruttura [acquistando nodi AVS](create-nodes.md).
* Gestire le configurazioni dell'ambiente VMware con cloud privati AVS. È possibile [creare](create-private-cloud.md), [gestire](manage-private-cloud.md), [espandere](expand-private-cloud.md) o [ridurre](shrink-private-cloud.md) i cloud privati AVS.
...
* Visualizzare gli [utenti](users.md) che hanno eseguito l'accesso al portale di AVS.
