...
| Inventario macchina virtuale |  Crea da esistente<br>Creazione di un nuovo sito<br>Sposta<br>Rimuovere | 
...
2. Selezionare **Infrastructure** > **endpoint dell'** > infrastruttura**endpoint.**
