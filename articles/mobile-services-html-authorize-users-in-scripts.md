<properties pageTitle="Autorizzazione lato servizio (HTML) | Mobile Dev Center" metaKeywords="" description="Informazioni su come autorizzare gli utenti nel back-end JavaScript di Servizi mobili di Azure." metaCanonical="" services="" documentationCenter="Mobile" title="Service-side authorization of Mobile Services users" authors="glenga" solutions="" manager="dwrede" editor="" />
...
* [Riferimento per i concetti e le procedure di HTML/JavaScript per Servizi mobili]
  <br/>Informazioni su come usare Servizi mobili con HTML/JavaScript.
