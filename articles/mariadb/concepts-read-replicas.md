...
* Disponibilità a livello di area: database di Azure per MariaDB è disponibile negli Stati Uniti occidentali 2, Francia centrale, Emirati Arabi Uniti settentrionali e Germania centrale. Tuttavia, le aree abbinate non sono disponibili.
...
Per aggiornare uno dei parametri precedenti nel server master, eliminare i server di replica, aggiornare il valore del parametro nel database master e ricreare le repliche.
