...
ms.locfileid: "49317603"
---
# <a name="azure-database-for-mariadb-use-mysql-workbench-to-connect-and-query-data"></a>Database di Azure per MariaDB: usare MySQL Workbench per connettersi ed eseguire query sui dati
