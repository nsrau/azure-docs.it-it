...
1. Selezionare il pulsante **Crea una risorsa** (+) nell'angolo superiore sinistro del portale. Digitare **Database di Azure per MariaDB** nella casella di ricerca per trovare il servizio.
