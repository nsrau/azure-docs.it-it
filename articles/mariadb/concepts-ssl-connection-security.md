...
>
> Attualmente le versioni di TLS supportate dal database di Azure per MariaDB sono TLS 1,0, 1,1 e 1,2. Una volta applicata una versione minima specifica di TLS, non è possibile modificarla in disabilitata.
