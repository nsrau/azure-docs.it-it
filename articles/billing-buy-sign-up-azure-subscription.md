...
Nell'elenco seguente vengono fornite informazioni dettagliate sulle offerte comuni

- **Versione di valutazione gratuita**
  - [Iscrizione e guida dettagliata](#SignupFreeTrial)
  - [Vantaggi](https://azure.microsoft.com/pricing/free-trial/)
  - [DOMANDE FREQUENTI](https://azure.microsoft.com/pricing/free-trial-faq/)
  - [Aggiornamento della versione di valutazione gratuita a Pagamento in base al consumo](#UpgradeFreeToPYG)
- **Pagamento in base al consumo**
   - [Iscrizione](https://azure.microsoft.com/pricing/purchase-options/)
   - [Prezzi](https://azure.microsoft.com/pricing/)
- **MPN** (Microsoft Partner Network): i membri ricevono crediti mensili di Azure a costo zero  
  - [Benefici di Azure per i partner](https://azure.microsoft.com/offers/ms-azr-0025p/)
  - [Registrazione come partner](http://go.microsoft.com/fwlink/?linkid=309258&clcid=0x409) o [Sottoscrizione a Microsoft Action pack](http://go.microsoft.com/fwlink/?linkid=525768&clcid=0x409)
  - Usare i crediti di Azure: accedere al [portale MPN](https://mspartner.microsoft.com/Pages/Locale.aspx), verificare lo stato di idoneità e attenersi alle istruzioni nella sezione relativa a chiavi software e i vantaggi. Se non è possibile verificare la propria idoneità, contattare il [supporto tecnico di MPN](https://mspartner.microsoft.com/Pages/Support/Premium/contact-support.aspx).
- **Sottoscrittore di MSDN e Visual Studio**
  - [Vantaggi di sviluppo e test MSDN.](https://azure.microsoft.com/offers/ms-azr-0023p/) [Vantaggi per sottoscrittori di Visual Studio.](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/)
  - [Attivare credito Azure mensile per sottoscrittori di Visual Studio](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/)
  - [Attivare i vantaggi MSDN Azure in tre semplici passaggi](https://www.youtube.com/watch?v=SN2CA71uOEI&feature=youtu.be). Accedere alla [pagina dell'account MSDN](https://msdn.microsoft.com/subscriptions/manage/default.aspx), verificare l'idoneità e fare clic sull'opzione per attivare il vantaggio Azure. Se non è possibile verificare la propria idoneità, contattare i [centri del Servizio clienti per abbonamenti MSDN](https://msdn.microsoft.com/subscriptions/contactus.aspx)
- **BizSpark**
  - [Vantaggi BizSpark](https://www.microsoft.com/bizspark/default.aspx#start-two). Per informazioni dettagliate, vedere [Credito Azure mensile per sottoscrittori di Visual Studio Enterprise](https://azure.microsoft.com/offers/ms-azr-0064p/)
  - [Aderisci al programma BizSpark](https://www.microsoft.com/bizspark/signup/default.aspx) Se si verificano problemi, contattare il [team di BizSpark](mailto:bizspark@microsoft.com?subject=BizSpark%20Support&body=Thank%20you%20for%20contacting%20BizSpark.%20Please%20provide%20as%20much%20of%20the%20following%20information%20as%20possible,%20as%20it%20will%20help%20expedite%20our%20response%20to%20you.%0aContact%20name:%0aStartup%20name:%0aMicrosoft%20Account/Live%20ID:%0aSpecific%20description%20of%20issue%20experienced%20or%20question:%0a%0aThank%20you,%0a%0aThe%20BizSpark%20Team).
- **BizSpark Plus**
   - [Informazioni su BizSpark Plus](https://www.microsoft.com/bizspark/plus/default.aspx). Per informazioni dettagliate, vedere [Vantaggi BizSpark Plus](https://azure.microsoft.com/offers/ms-azr-0149p/)
   - [Aderisci al programma BizSpark](https://www.microsoft.com/bizspark/signup/default.aspx) e quindi usa il contatto del partner per eseguire l'aggiornamento a BizSpark Plus. Se si verificano problemi, contattare il [team di BizSpark](mailto:bizspark@microsoft.com?subject=BizSpark%20Support&body=Thank%20you%20for%20contacting%20BizSpark.%20Please%20provide%20as%20much%20of%20the%20following%20information%20as%20possible,%20as%20it%20will%20help%20expedite%20our%20response%20to%20you.%0aContact%20name:%0aStartup%20name:%0aMicrosoft%20Account/Live%20ID:%0aSpecific%20description%20of%20issue%20experienced%20or%20question:%0a%0aThank%20you,%0a%0aThe%20BizSpark%20Team).
- **Rivenditori** (programmi Open Volume License)
  - [Attivare chiave del servizio Online: guida dettagliata](#activateKey)
  - [Acquisto, vantaggi, attivazione](https://azure.microsoft.com/offers/ms-azr-0111p/)
- **EA (Enterprise Agreement)**
  - [Licenze di Azure per l'azienda](https://azure.microsoft.com/pricing/enterprise-agreement/)
  - Per attivare e iniziare a sfruttare i vantaggi oggi stesso, contattare l'account manager o il rivenditore Microsoft
 ...
 **Non è possibile completare l'operazione. Riprovare più tardi o ricaricare la pagina Web** </br>
 ...
 In questo caso, provare a usare un altro browser per completare il processo di iscrizione. Se il problema si verifica ancora, contattare il [supporto tecnico di Azure](https://ms.portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade) per ricevere assistenza.</br> 7. Quando la sottoscrizione è pronta, selezionare **Inizia a gestire il servizio** per iniziare.</br> ![Avvio del servizio](./media/billing-buy-sign-up-azure-subscription/startservice.png)
