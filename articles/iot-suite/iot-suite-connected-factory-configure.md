...
Come passaggio successivo, si consiglia di imparare a [distribuire un gateway in Windows o Linux per l'acceleratore di soluzioni Fabbrica connessa](iot-suite-connected-factory-gateway-deployment.md).