...
description: Scegliere la modalità di implementazione della soluzione IoT con gli acceleratori di soluzioni Azure IoT, Azure IoT Central o hub IoT di Azure.
services: iot-suite
suite: iot-suite
author: dominicbetts
manager: timlt
