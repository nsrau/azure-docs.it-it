...
### <a name="what-sdks-can-i-use-to-develop-device-clients-for-the-preconfigured-solutions"></a>Quali SDK è possibile usare per sviluppare i client di dispositivi per le soluzioni preconfigurate?
