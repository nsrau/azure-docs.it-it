...
Vedere anche le[Domande frequenti specifiche per Connected Factory](iot-suite-faq-cf.md) e le [Domande frequenti specifiche per il monitoraggio remoto](iot-suite-faq-rm-v2.md).
...
* [Panoramica dell'acceleratore di soluzioni di connected factory](iot-suite-connected-factory-overview.md)
