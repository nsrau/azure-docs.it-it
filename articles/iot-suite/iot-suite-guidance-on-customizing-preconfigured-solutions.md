...
## <a name="finding-the-source-code"></a>Ricerca del codice sorgente
...
### <a name="building-and-using-your-own-physical-device"></a>Compilazione e uso del proprio dispositivo (fisico)
...
## <a name="modifying-dashboard-limits"></a>Modifica dei limiti del dashboard
...
## <a name="manually-setting-up-application-roles"></a>Configurazione manuale dei ruoli dell’applicazione
