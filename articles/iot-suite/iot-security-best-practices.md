<properties
 pageTitle="Procedure consigliate per la sicurezza IoT | Microsoft Azure"
...
# Procedure consigliate per la sicurezza di Internet of Things (IoT)
...
- **Produttore/integratore di hardware IoT**: in genere si tratta dei produttori dell'hardware IoT da distribuire, integratori di hardware che si occupano dell'assemblaggio di hardware da produttori diversi, oppure fornitori hardware per la distribuzione IoT prodotta o integrata da altri fornitori.
...
- **Operatore di soluzioni IoT**: una volta distribuita, la soluzione IoT richiede operazioni, monitoraggio, aggiornamenti e manutenzione sul lungo termine. Questa operazione può essere eseguita da un team interno che comprende esperti di tecnologie informatiche, team per le operazioni hardware e team di manutenzione, nonché specialisti di dominio che monitorano il corretto funzionamento dell'intera infrastruttura IoT. 
