...
[Informazioni su Blitline][Informazioni su Blitline]
[Operazioni NON eseguite da Blitline][Operazioni NON eseguite da Blitline]
[Creazione di un account Blitline][Creazione di un account Blitline]
[Come creare un processo di Blitline][Come creare un processo di Blitline]
[Come salvare un'immagine nell'account di archiviazione di Azure][Come salvare un'immagine nell'account di archiviazione di Azure]
[Passaggi successivi][Passaggi successivi]

## <span id="whatis"></span></a>Informazioni su Blitline
...
Per ulteriori informazioni, visitare il sito [][]<http://www.blitline.com></a>.

## <span id="whatisnot"></span></a>Operazioni NON eseguite da Blitline
...
Il codice informa che Blitline ha ricevuto la richiesta, l'ha inserita in una coda di elaborazione e al termine dell'operazione l'immagine sarà disponibile all'indirizzo:
...
## <span id="saveazure"></span></a>Come salvare un'immagine nell'account di archiviazione di Azure
...
È anche possibile leggere l'ultima edizione dei documenti sull'archiviazione di Azure di Blitline [qui][qui].
