<properties 
	pageTitle="Siti Web di Python con Flask - Esercitazione di Azure" 
...
Verrà visualizzata una finestra di dialogo che elenca le applicazioni disponibili nella raccolta. Fare clic sulla categoria **FRAMEWORK APP** a sinistra e selezionare **Flask**.
...
Il sito verrà configurato rapidamente. È possibile fare clic sul pulsante **SFOGLIA** dalla barra degli strumenti inferiore per visualizzare la nuova applicazione Flask in esecuzione su Azure.
...
<!--Link references-->
[Flask e MongoDB in Azure con Python Tools 2.1 per Visual Studio]: ../web-sites-python-ptvs-flask-table-storage
[Flask e Archiviazione tabelle di Azure con Python Tools 2.1 per Visual Studio]: ../web-sites-python-ptvs-flask-mongodb
