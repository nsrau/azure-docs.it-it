...
> [!IMPORTANT]
> I [database con iperscalabilità (anteprima)](sql-database-hyperscale.md) sono disponibili solo con il modello di acquisto basato su vCore per database singoli con un server logico o all'interno di un'istanza gestita. 
