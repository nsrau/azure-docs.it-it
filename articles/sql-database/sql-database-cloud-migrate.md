...
Se si rilevano problemi di compatibilità, è necessario risolverli prima di procedere con la migrazione del database SQL Server. Usare gli strumenti di migrazione del database seguenti:
