...
- È previsto un limite di 280 file per istanza e quindi di un massimo di 280 file per database. I file di dati e i file di log vengono conteggiati per il limite.  
