...
---
# <a name="when-should-an-elastic-database-pool-be-used"></a>Quando usare un pool di database elastici
...
## <a name="elastic-database-pools"></a>Pool di database elastici
