...
3. Creare un database dell'istanza per il server di pubblicazione.

   Negli script di esempio seguenti sostituire `<Publishing_DB>` con il nome del database dell'istanza.
