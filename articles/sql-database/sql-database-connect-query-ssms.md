---
title: Connettersi a un database SQL - SQL Server Management Studio | Microsoft Docs
...
[!INCLUDE [Installazione di SSMS](../../includes/sql-server-management-studio-install.md)]

[!INCLUDE [Connessione a SSMS](../../includes/sql-database-sql-server-management-studio-connect-server-principal.md)]
