...
- Determinare la compatibilità del database e quindi selezionare il metodo di migrazione appropriato in base alle esigenze. Seguire le linee guida e le opzioni disponibili nella pagina relativa alla migrazione di un database di SQL Server.
