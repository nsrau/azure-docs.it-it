...
- La migrazione delle destinazioni al livello radice che sono server e database verrà eseguita in un nuovo gruppo di destinazione denominato "(\<nomeServer\>, \<nomeDatabase\>)" che contiene solo la destinazione del livello radice.
...
- I processi con più trigger con pianificazioni diverse sono suddivisi in più processi con lo schema di denominazione: "\<nomeProcesso\> (\<nomePianificazione\>)".
