<properties
	pageTitle="Connettersi al database SQL tramite Node.js con Tedious in Mac OS X"
...
[Prerequisiti per l'uso del driver Tedious Node.js per SQL Server](https://msdn.microsoft.com/library/mt652094.aspx#Mac)
