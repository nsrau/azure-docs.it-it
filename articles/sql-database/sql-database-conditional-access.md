...
Sia il [database SQL](sql-database-technical-overview.md) di Azure che [SQL Data Warehouse](../sql-data-warehouse/sql-data-warehouse-overview-what-is.md) supportano l'accesso condizionale Microsoft. 
