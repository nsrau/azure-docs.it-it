...
description: "Informazioni su come eseguire l&quot;aggiornamento al database SQL V12 di Azure, nonché su come eseguire l&quot;aggiornamento dei database Web e Business e come aggiornare un server V11 migrandone i database direttamente in un pool elastico usando PowerShell."
...
È possibile seguire i passaggi descritti in questo articolo per migrare facilmente i database dai server della versione 11 direttamente in pool elastici.
...
Per aggiornare un server alla versione 12 con PowerShell, è necessario che la versione più recente di Azure PowerShell sia installata e in esecuzione. Per informazioni dettagliate, vedere [Come installare e configurare Azure PowerShell](/powershell/azureps-cmdlets-docs).
...
Per altre informazioni, vedere [Creare un pool elastico](sql-database-elastic-pool-create-portal.md) e [Indicazioni sul piano tariffario del database SQL di Azure](sql-database-service-tier-advisor.md).
...
Se le indicazioni non sono appropriate per il server e il caso aziendale, è possibile scegliere la modalità di aggiornamento dei database ed è possibile eseguirne il mapping a database autonomi o a pool elastici.
...
Oltre al monitoraggio dei singoli database, è possibile monitorare i pool elastici [tramite il portale](sql-database-elastic-pool-manage-portal.md) o con [PowerShell](sql-database-elastic-pool-manage-powershell.md)
...
* [Creare un pool elastico](sql-database-elastic-pool-create-portal.md) e aggiungervi alcuni o tutti i database.
