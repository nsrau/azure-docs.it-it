...
- [5. Modulo web App in azione, 0:05:55](#anchor-image-wtip-min00555)
- [6. Costo per tenant (scalabilità, isolamento, ripristino), 0:09:31](#anchor-image-wtip-min00931)
- [7. Modelli di database per multi-tenant: pro e contro, 0:11:59](#anchor-image-wtip-min01159)
- [8. Il modello ibrido unisce i vantaggi di MT/ST, 0:13:01](#anchor-image-wtip-min01301)
- [9. Single-tenant vs multi-tenant: pro e contro, 0:16:44](#anchor-image-wtip-min01644)
- [10. I pool sono convenienti per carichi di lavoro imprevedibili, 0:19:36](#anchor-image-wtip-min01936)
- [11. Demo del database per tenant e ibrido ST/MT, 0:20:08](#anchor-image-wtip-min02008)
- [12. Modulo dell'app live che mostra Dojo, 0:20:29](#anchor-image-wtip-min02029)
- [13. MYOB e non un DBA in vista, 0:28:54](#anchor-image-wtip-min02854)
- [14. Esempio di utilizzo della piscina elastica MYOB, 0:29:40](#anchor-image-wtip-min02940)
- [15. Apprendimento da MYOB e altri ISV, 0:31:36](#anchor-image-wtip-min03136)
- [16. I modelli si compongono nello scenario E2E SaaS, 0:43:15](#anchor-image-wtip-min04315)
- [17. App SaaS ibrido ibrido canonica, 0:47:33](#anchor-image-wtip-min04733)
- [18. Wingtip SaaS esempio app, 0:48:10](#anchor-image-wtip-min04810)
- [19. Scenari e modelli esplorati nei tutorial, 0:49:10](#anchor-image-wtip-min04910)
- [20. Demo di tutorial e repository GitHub, 0:50:18](#anchor-image-wtip-min05018)
- [21. GitHub repo Microsoft/WingtipSaaS, 0:50:38](#anchor-image-wtip-min05038)
- [22. Esplorare i modelli, 0:56:20](#anchor-image-wtip-min05620)
- [23. Provisioning tenant e onboarding, 0:57:44](#anchor-image-wtip-min05744)
- [24. Provisioning tenant e connessione dell'applicazione, 0:58:58](#anchor-image-wtip-min05858)
- [25. Dimostrazione degli script di gestione di provisioning di un singolo tenant, 0:59:43](#anchor-image-wtip-min05943)
...
- [29. Monitoraggio piscina elastica, 1:06:39](#anchor-image-wtip-min10639)
- [30. Generazione del carico e monitoraggio delle prestazioni, 1:09:42](#anchor-image-wtip-min10942)
- [31. Gestione dello schema su larga scala, 1:10:33](#anchor-image-wtip-min11033)
- [32. Query distribuita tra database tenant, 1:12:21](#anchor-image-wtip-min11221)
- [33. Demo della generazione dei biglietti, 1:12:32](#anchor-image-wtip-min11232)
- [34. Analisi ad hoc SSMS, 1:12:46](#anchor-image-wtip-min11246)
- [35. Estrarre i dati del tenant in SQL DW, 1:16:32](#anchor-image-wtip-min11632)
- [36. Grafico della distribuzione giornaliera delle vendite, 1:16:48](#anchor-image-wtip-min11648)
- [37. Avvolgere e chiamare all'azione, 1:19:52](#anchor-image-wtip-min11952)
- [38. Risorse per maggiori informazioni, 1:20:42](#anchor-image-wtip-min12042)
...
#### <a name="5-app-web-form-in-action-00539"></a>5. Modulo web App in azione, 0:05:39
...
#### <a name="6-per-tenant-cost-scale-isolation-recovery-00658"></a>6. Costo per tenant (scalabilità, isolamento, ripristino), 0:06:58
...
#### <a name="7-database-models-for-multi-tenant-pros-and-cons-00952"></a>7. Modelli di database per multi-tenant: pro e contro, 0:09:52
[![Modelli di database per multi-tenant: pro e contro][image-wtip-min01159-db-models-pros-cons]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=592)


&nbsp; <a name="anchor-image-wtip-min01301"/>
#### <a name="8-hybrid-model-blends-benefits-of-mtst-01229"></a>8. Il modello ibrido unisce i vantaggi di MT/ST, 0:12:29
[![Il modello ibrido unisce i vantaggi di MT/ST][image-wtip-min01301-hybrid]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=749)


&nbsp; <a name="anchor-image-wtip-min01644"/>
#### <a name="9-single-tenant-vs-multi-tenant-pros-and-cons-01311"></a>9. Single-tenant vs multi-tenant: pro e contro, 0:13:11
...
#### <a name="11-demo-of-database-per-tenant-and-hybrid-stmt-01959"></a>11. Demo del database per tenant e ibrido ST/MT, 0:19:59
[![Demo di ST/MT ibrido e database per tenant][image-wtip-min02008-demo-st-hybrid]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1199)


&nbsp; <a name="anchor-image-wtip-min02029"/>
#### <a name="12-live-app-form-showing-dojo-02010"></a>12. Modulo app dal vivo che mostra Dojo, 0:20:10
[![Modulo dell'app dal vivo che mostra Dojo][image-wtip-min02029-live-app-form-dojo]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1210)
...
#### <a name="14-myob-elastic-pool-usage-example-02930"></a>14. Esempio di utilizzo della piscina elastica MYOB, 0:29:30
...
#### <a name="15-learning-from-myob-and-other-isvs-03125"></a>15. Apprendimento da MYOB e altri ISV, 0:31:25
...
#### <a name="16-patterns-compose-into-e2e-saas-scenario-03142"></a>16. I modelli si compongono nello scenario E2E SaaS, 0:31:42
...
#### <a name="18-wingtip-saas-sample-app-04801"></a>18. Wingtip SaaS esempio app, 0:48:01
...
#### <a name="19-scenarios-and-patterns-explored-in-the-tutorials-04900"></a>19. Scenari e modelli esplorati nei tutorial, 0:49:00
[![Scenari e modelli esplorati nelle esercitazioniScenarios and patterns explored in the tutorials][image-wtip-min04910-scenarios-tutorials]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=2940)


&nbsp; <a name="anchor-image-wtip-min05018"/>
#### <a name="20-demo-of-tutorials-and-github-repository-05012"></a>20. Demo di tutorial e repository GitHub, 0:50:12
[![Esercitazioni dimostrativi e repository GitHub][image-wtip-min05018-demo-tutorials-github]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3012)
...
#### <a name="22-exploring-the-patterns-05615"></a>22. Esplorare i modelli, 0:56:15
[![Esplorare i modelli][image-wtip-min05620-exploring-patterns]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3375)


&nbsp; <a name="anchor-image-wtip-min05744"/>
#### <a name="23-provisioning-tenants-and-onboarding-05619"></a>23. Provisioning tenant e onboarding, 0:56:19
[![Provisioning tenant e onboarding][image-wtip-min05744-provisioning-tenants-onboarding-1]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3379)


&nbsp; <a name="anchor-image-wtip-min05858"/>
#### <a name="24-provisioning-tenants-and-application-connection-05752"></a>24. Provisioning tenant e connessione dell'applicazione, 0:57:52
[![Provisioning dei tenant e della connessione all'applicazione][image-wtip-min05858-provisioning-tenants-app-connection-2]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3472)


&nbsp; <a name="anchor-image-wtip-min05943"/>
#### <a name="25-demo-of-management-scripts-provisioning-a-single-tenant-05936"></a>25. Dimostrazione degli script di gestione di provisioning di un singolo tenant, 0:59:36
[![Demo degli script di gestione che esegue il provisioning di un singolo tenant][image-wtip-min05943-demo-management-scripts-st]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3576)
...
#### <a name="27-t-sql-select--from-tenantsextended-10325"></a>27. T-SQL SELECT - DA TenantsExtended, 1:03:25
...
#### <a name="29-elastic-pool-monitoring-10632"></a>29. Monitoraggio piscina elastica, 1:06:32
[![Monitoraggio del pool elastico][image-wtip-min10639-elastic-pool-monitoring]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3992)


&nbsp; <a name="anchor-image-wtip-min10942"/>
#### <a name="30-load-generation-and-performance-monitoring-10937"></a>30. Generazione del carico e monitoraggio delle prestazioni, 1:09:37
[![Generazione del carico e monitoraggio delle prestazioni][image-wtip-min10942-load-generation]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4117)


&nbsp; <a name="anchor-image-wtip-min11033"/>
#### <a name="31-schema-management-at-scale-10940"></a>31. Gestione dello schema su larga scala, 1:09:40
...
#### <a name="32-distributed-query-across-tenant-databases-11118"></a>32. Query distribuita tra database tenant, 1:11:18
[![Query distribuita tra database tenantDistributed query across tenant databases][image-wtip-min11221-distributed-query]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4278)


&nbsp; <a name="anchor-image-wtip-min11232"/>
#### <a name="33-demo-of-ticket-generation-11228"></a>33. Demo della generazione dei biglietti, 1:12:28
[![Demo della generazione dei biglietti][image-wtip-min11232-demo-ticket-generation]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4348)
...
#### <a name="35-extract-tenant-data-into-sql-dw-11546"></a>35. Estrarre i dati del tenant in SQL DW, 1:15:46
[![Estrarre i dati del tenant in SQL DWExtract tenant data into SQL DW][image-wtip-min11632-extract-tenant-data-sql-dw]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4546)


&nbsp; <a name="anchor-image-wtip-min11648"/>
#### <a name="36-graph-of-daily-sale-distribution-11638"></a>36. Grafico della distribuzione giornaliera delle vendite, 1:16:38
[![Grafico della distribuzione giornaliera delle vendite][image-wtip-min11648-graph-daily-sale-distribution]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4598)


&nbsp; <a name="anchor-image-wtip-min11952"/>
#### <a name="37-wrap-up-and-call-to-action-11743"></a>37. Avvolgere e chiamare all'azione, 1:17:43
...
#### <a name="38-resources-for-more-information-12035"></a>38. Risorse per maggiori informazioni, 1:20:35
...
- Repository GitHub per esplorare l'applicazione tenancy SaaS Wingtip Ticket:
    - [GitHub repo per - Modello][github-wingtip-standaloneapp]di applicazione autonoma .
    - [GitHub repo per - DB Per Tenant modello][github-wingtip-dbpertenant].
    - [GitHub repo per - Modello DB multi-tenant][github-wingtip-multitenantdb].
...
[image-wtip-min05018-demo-tutorials-github]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min05018-demo-saas-tutorials-github-repo.png "Demo di esercitazioni e repo GitHub"
