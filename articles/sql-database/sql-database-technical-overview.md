...
Il database SQL offre una gamma di [funzionalità di sicurezza e conformità incorporate](sql-database-security-overview.md) che consentono all'applicazione di soddisfare i diversi requisiti di sicurezza e conformità.
...
- [Rilevamento minacce](sql-database-threat-detection.md):
