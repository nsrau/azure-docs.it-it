...
- Il [database singolo](sql-database-single-database.md) rappresenta un database isolato completamente gestito, ideale per le applicazioni cloud moderne e i microservizi che necessitano di una singola origine dati affidabile. Un database singolo è simile a un [database indipendente](https://docs.microsoft.com/sql/relational-databases/databases/contained-databases?toc=/azure/sql-database/toc.json) nel [motore di database Microsoft SQL Server](https://docs.microsoft.com/sql/sql-server/sql-server-technical-documentation?toc=/azure/sql-database/toc.json).
