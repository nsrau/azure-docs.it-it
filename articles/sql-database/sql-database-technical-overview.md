...
- Vedere la [pagina dei prezzi](http://azure.microsoft.com/pricing/details/sql-database/) per i prezzi e i calcoli del singolo database e del database elastico.
