...
Gli esempi usano le [stored procedure](#job-stored-procedures) e le [viste](#job-views) disponibili nel [*database dei processi*](elastic-jobs-overview.md#job-database).
...
Connettersi al [*database dei processi*](elastic-jobs-overview.md#job-database) ed eseguire il comando seguente:
...
Le stored procedure seguenti sono disponibili nel [database dei processi](elastic-jobs-overview.md#job-database).
...
[ **@target_group_id =** ] target_group_id OUTPUT Numero di identificazione del gruppo di destinazione assegnato al processo se viene creato correttamente. target_group_id è una variabile di output di tipo uniqueidentifier e il valore predefinito è NULL.
...
## <a name="resources"></a>Risorse
 ...
 - ![Icona collegamento argomento](https://docs.microsoft.com/sql/database-engine/configure-windows/media/topic-link.gif "Icona collegamento argomento") [Convenzioni della sintassi Transact-SQL](/sql/t-sql/language-elements/transact-sql-syntax-conventions-transact-sql.md)  
