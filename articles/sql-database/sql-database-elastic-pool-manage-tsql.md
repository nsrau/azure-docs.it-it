...
>[AZURE.NOTE] Attualmente service\_objective\_column per i database nei pool elastici restituisce un token interno della stringa obiettivo del servizio. Verrà sostituito dalla stringa "ElasticPool".
>
...
## Monitorare l'utilizzo delle risorse dei pool elastici
