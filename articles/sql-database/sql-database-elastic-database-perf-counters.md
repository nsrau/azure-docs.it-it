---
title: Contatori delle prestazioni per tenere traccia di Gestione mappe partizioni
...
---
# <a name="create-performance-counters-to-track-performance-of-shard-map-manager"></a>Creare contatori delle prestazioni per tenere traccia delle prestazioni di Gestione mappe partizioni

I contatori delle prestazioni vengono utilizzati per tenere traccia delle prestazioni delle operazioni di [routing dipendenti dai dati.](sql-database-elastic-scale-data-dependent-routing.md) Questi contatori sono accessibili in Performance Monitor, sotto la categoria "Database elastico: Gestione di partizioni".
