...
## <a name="create-a-pool-and-populate-it-with-multiple-new-databases"></a>Creare un pool e popolarlo con più database nuovi
...
## <a name="example-create-a-pool-using-powershell"></a>Esempio: Creare un pool con PowerShell
