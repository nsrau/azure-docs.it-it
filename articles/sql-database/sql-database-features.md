...
| [Tipi di dati](https://docs.microsoft.com/sql/t-sql/data-types/data-types-transact-sql) | Sì |Yes |
...
Il database SQL di Azure supporta diversi strumenti di dati che consentono a è di gestire i dati.
