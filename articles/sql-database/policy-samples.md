...
description: Elenco di definizioni di criteri predefiniti di Criteri di Azure per il database SQL di Azure. Queste definizioni di criteri predefiniti forniscono approcci comuni alla gestione delle risorse di Azure.
ms.date: 05/13/2020
ms.topic: sample
author: stevestein
ms.author: sstein
...
ms.locfileid: "83657792"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-sql-database"></a>Definizioni di criteri predefiniti di Criteri di Azure per il database SQL di Azure
