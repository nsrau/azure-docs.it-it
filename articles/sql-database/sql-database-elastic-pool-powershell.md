...
Per selezionare la sottoscrizione, è necessario l’ID sottoscrizione o il nome della sottoscrizione (**-SubscriptionName**), che può essere copiato dal passaggio precedente o, se si dispone di più sottoscrizioni, è possibile eseguire il cmdlet **Get-Subscription** e copiare le informazioni di sottoscrizione desiderate dal gruppo di risultati. Una volta acquisita la sottoscrizione, eseguire il cmdlet seguente:
