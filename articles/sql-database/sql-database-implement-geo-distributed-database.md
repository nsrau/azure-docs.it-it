...
Usando Azure PowerShell, creare un [gruppo di failover](sql-database-auto-failover-group.md) tra il server SQL di Azure esistente e il nuovo server SQL di Azure vuoto in un'area di Azure e quindi aggiungere il database di esempio al gruppo di failover.
