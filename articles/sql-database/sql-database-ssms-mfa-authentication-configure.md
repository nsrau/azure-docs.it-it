i--- title: Configurare Multi-Factor Authentication - Azure SQL | Documentazione Microsoft description: Usare Multi-Factor Authentication con SSMS per database SQL e SQL Data Warehouse.
