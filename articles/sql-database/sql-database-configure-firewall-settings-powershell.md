---
title: 'PowerShell: configurare le regole del firewall per il database SQL di Azure | Documentazione Microsoft'
description: Come configurare le regole del firewall a livello di server per gli indirizzi IP che accedono a database SQL di Azure usando PowerShell.
