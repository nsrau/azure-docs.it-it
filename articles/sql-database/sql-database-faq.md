...
## <a name="whatis-the-new-vcore-based-purchasing-model-preview-for-azure-sql-database"></a>Qual è il nuovo modello di acquisto basato su vCore (anteprima) per il database SQL di Azure?
