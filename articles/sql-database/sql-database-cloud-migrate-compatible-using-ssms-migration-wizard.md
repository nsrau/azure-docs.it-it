---
title: Migrare il database del server SQL Server al database SQL tramite la procedura guidata Distribuire il database nel database di Microsoft Azure | Microsoft Docs
