...
## Procedura: effettuare la connessione al database SQL in Azure tramite Management Studio
...
1. In Management Studio verificare, in Connetti al server, che Motore di database sia selezionato, quindi immettere il nome del server logico usando il seguente formato: *nomeserver*.database.widnows.net
...
1. In Management Studio verificare, in Connetti al server, che Motore di database sia selezionato, quindi immettere il nome di un'istanza locale usando il seguente formato: *nomeserver**nomeistanza*. Se il server è locale e l'istanza è predefinita, immettere *localhost*.
...
Sono stati ora creati e testati diversi account di accesso. Per ulteriori informazioni, vedere [Gestione di database e account di accesso in database SQL][] e [Monitoraggio di database SQL mediante le viste a gestione dinamica][].

[Gestione di database e account di accesso in database SQL]: http://msdn.microsoft.com/library/windowsazure/ee336235.aspx
[Monitoraggio di database SQL mediante le viste a gestione dinamica]: http://msdn.microsoft.com/library/windowsazure/ff394114.aspx
[Gestione di database SQL tramite Management Studio]: http://www.windowsazure.com/develop/net/common-tasks/sql-azure-management/
