---
title: 'Panoramica: strumenti di gestione per database SQL'
...
> [!IMPORTANT]
> Usare sempre la versione più aggiornata di SQL Server Management Studio e SQL Server Data Tools per Visual Studio per restare sincronizzati con gli aggiornamenti di Microsoft Azure e del database SQL. Le versioni precedenti di questi strumenti non funzionano correttamente con il database SQL.
> 
> 
