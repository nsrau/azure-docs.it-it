...
### <a name="enable-subscription-access-to-a-region"></a><a id="other"></a>Abilitare l'accesso alla sottoscrizione a un'area
...
## <a name="managed-instance-quota-type"></a><a id="sqlmiquota"></a>Tipo di quota istanza gestita
...
Il passaggio finale consiste nel compilare i dettagli rimanenti della richiesta di quota del database SQL. Quindi selezionare **Avanti: rivedere + crea>>** e, dopo aver esaminato i dettagli della richiesta, fare clic su **Crea** per inviare la richiesta.
