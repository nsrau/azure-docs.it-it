---
title: Introduzione al rilevamento delle minacce nel database SQL
...
---
# <a name="get-started-with-sql-database-threat-detection"></a>Introduzione al rilevamento delle minacce nel database SQL
