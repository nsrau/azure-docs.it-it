...
- Per informazioni dettagliate sulle dimensioni di calcolo specifiche e sulle opzioni di archiviazione disponibili per i pool elastici, vedere [limiti delle risorse basate su vCore del database SQL per i pool elastici](sql-database-vcore-resource-limits-elastic-pools.md).
