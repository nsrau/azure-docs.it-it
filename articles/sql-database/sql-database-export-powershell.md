...
# Creare ed esportare un file BACPAC di un database SQL tramite PowerShell
...
In questo articolo viene illustrato come esportare manualmente un file BACPAC del database SQL con PowerShell.
