...
## <a name="troubleshooting-sync"></a>Risoluzione dei problemi di sincronizzazione
...
## <a name="troubleshooting-the-client-agent"></a>Risoluzione dei problemi dell'agente client
...
-   Creare un nuovo agente nello stesso data center del gruppo di sincronizzazione. Registrare quindi il database con tale agente.
...
## <a name="troubleshooting-setup-and-maintenance"></a>Risoluzione dei problemi di installazione e manutenzione
...
Se si ripristina un database perso o danneggiato da un backup, è possibile la non convergenza dei dati nei gruppi di sincronizzazione a cui appartiene il database.
