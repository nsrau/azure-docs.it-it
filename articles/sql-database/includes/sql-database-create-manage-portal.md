...
Per accedere alla pagina **risorse SQL di Azure** , dal menu portale di Azure selezionare **Azure SQL** o cercare e selezionare **Azure SQL** in qualsiasi pagina.
...
![Pagina del portale SQL di Azure](../media/sql-database-technical-overview/add-azure-sql-resources.png)
...
![Dettagli riquadro database](../media/sql-database-technical-overview/single-sql-database-deployment-options.png)

Per informazioni dettagliate, vedere:

- [Creare un database singolo](../sql-database-single-database-get-started.md)
