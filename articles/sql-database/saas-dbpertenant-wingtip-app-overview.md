...
|:--|:--|
| [Materiale sussidiario e suggerimenti per l'esempio di app SaaS multi-tenant di database SQL di Azure](saas-dbpertenant-wingtip-app-guidance-tips.md) | **INIZIARE DA QUI.** Scaricare ed eseguire gli script di PowerShell per preparare le parti dell'applicazione. |
...
- [Materiale sussidiario e suggerimenti per l'esempio di app SaaS multi-tenant di database SQL di Azure](saas-dbpertenant-wingtip-app-guidance-tips.md)
