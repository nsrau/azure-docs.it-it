...
3.	Nel pannello Database SQL fare clic sul riquadro **Livello di prezzo**.

    ![riquadro dei prezzi][1]
...
3.	Controllare il riquadro**Livello di prezzo** e verificare che sia impostato il livello corretto.
