...
>[AZURE.NOTE] Il ritardo causato da una chiamata alla procedura **sp_wait_for_database_copy_sync** può essere considerevole. Il ritardo dipende dalle dimensioni della lunghezza del log delle transazioni corrente e non termina finché non viene replicato l'intero log. Chiamare quindi la procedura solo quando strettamente necessario.
