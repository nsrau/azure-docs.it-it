...
- L'importazione in un database in un pool elastico non è supportata. È possibile importare i dati in un database singleton e quindi spostare quest'ultimo in un pool.
