...
Installare la versione di anteprima più recente del modulo **AzureRM.Sql** per ottenere i cmdlet del processo elastico. Eseguire i comandi seguenti da un prompt dei comandi con privilegi elevati (tramite Esegui come amministratore).
