...
- Oltre al modulo in anteprima **AzureRM.Sql** 4.8.1, questa esercitazione richiede anche il modulo *sqlserver* PowerShell. Per i dettagli, vedere [Installare il modulo SQL Server PowerShell](https://docs.microsoft.com/sql/powershell/download-sql-server-ps-module).
...
Il cmdlet **New-AzureRmSqlElasticJobAgent** richiede un database SQL di Azure già esistente, pertanto i parametri *ResourceGroupName*, *ServerName* e *DatabaseName* devono puntare tutti a risorse esistenti.
