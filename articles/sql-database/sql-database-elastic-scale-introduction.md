...
La maggior parte delle applicazioni di database su scala cloud usano una combinazione di questi due strategie. Ad esempio, un'applicazione Software as a Service può usare la scalabilità orizzontale per eseguire il provisioning di nuovi clienti finali e la scalabilità verticale per consentire al database di ogni cliente finale di aumentare o ridurre le risorse in base alle esigenze del carico di lavoro.
