...
Nella [seconda parte](sql-database-tutorial-clustering-model-build.md) si è appreso come creare ed eseguire il training di un modello di clustering K-means in R.
