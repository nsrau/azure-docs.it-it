...
---
# <a name="azure-sql-database-learns-amp-adapts"></a>Il database SQL di Azure apprende e si adatta
## <a name="how-azure-sql-database-learns-adapts-and-grows-with-your-application"></a>In che modo il database SQL di Azure apprende, si adatta e cresce di pari passo con l'applicazione
...
## <a name="threat-detection-and-alerts"></a>Rilevamento delle minacce e avvisi
...
## <a name="insights-when-you-need-them"></a>Informazioni dettagliate quando sono necessarie
...
## <a name="no-administration-required"></a>Nessuna attività di amministrazione
