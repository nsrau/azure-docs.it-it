---
title: Azure SQL Database Advisor tramite il portale di Azure | Microsoft Docs
...
3. Fare clic su **Tutte le impostazioni** > **Raccomandazioni** per visualizzare le **Raccomandazioni** disponibili per il database selezionato.
...
3. Facoltativamente, fare clic su **Annulla eliminazione** per aggiungere nuovamente l'indice all'elenco principale di **Raccomandazioni**.
