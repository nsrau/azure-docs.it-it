<properties
	...
	description="Creare il primo database SQL in pochi minuti nel portale di Azure con dati di esempio e usando il sistema di gestione di database relazionali (RDBMS) di Microsoft."
