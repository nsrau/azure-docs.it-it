...
Per altre informazioni su come stabilire la connessione al database SQL, vedere [Connettersi a SQL Server Management Studio (SSMS)](sql-database-connect-to-database.md)
