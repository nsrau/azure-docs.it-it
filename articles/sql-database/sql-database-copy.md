...
È possibile copiare un database SQL usando il [portale di Azure](sql-database-copy-portal.md), [PowerShell](sql-database-copy-powershell.md) o [T-SQL](sql-database-copy-transact-sql.md). 
