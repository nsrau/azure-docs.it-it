...
ms.locfileid: "52997131"
---
# <a name="azure-sql-database-managed-instance-threat-detection-preview"></a>Rilevamento delle minacce in Istanza gestita di database SQL di Azure (anteprima)
