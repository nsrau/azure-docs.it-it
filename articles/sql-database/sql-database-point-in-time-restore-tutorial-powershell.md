...
È necessario utilizzare l'autenticazione basata su certificati per eseguire i cmdlet seguenti. Per altre informazioni, vedere la sezione  *Use the certificate method* in [Come installare e configurare Azure PowerShell](http://azure.microsoft.com/documentation/articles/install-configure-powershell/#use-the-certificate-method).
