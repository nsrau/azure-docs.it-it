...
## <a name="us-government-and-agency-data"></a>Dati del governo e di enti pubblici degli Stati Uniti
...
| [Incidenti stradali mortali: Fatality Analysis Reporting System (FARS) degli Stati Uniti](http://www.nhtsa.gov/FARS) | "FARS è un censimento a livello nazionale che fornisce a NHTSA, Congresso e pubblico americano dati annuali sugli incidenti stradali mortali nel traffico di veicoli a motore". | "È possibile creare online dati personalizzati sugli incidenti mortali usando il sistema di query FARS oppure scaricare tutti i dati FARS dal 1975 a oggi dal sito FTP". |
