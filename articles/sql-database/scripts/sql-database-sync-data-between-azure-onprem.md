...
Questo esempio di PowerShell consente di configurare la sincronizzazione dei dati (anteprima) per sincronizzare un database SQL di Azure e un database locale di SQL Server. 
