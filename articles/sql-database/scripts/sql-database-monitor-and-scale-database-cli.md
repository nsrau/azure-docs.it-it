...
| [az sql db show-usage](https://docs.microsoft.com/cli/azure/sql/db) | Mostra le informazioni sull'utilizzo delle dimensioni per un database singolo o in pool. |
