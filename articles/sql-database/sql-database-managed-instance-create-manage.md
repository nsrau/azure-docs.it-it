---
title: Informazioni di riferimento sulle API di gestione per l'istanza gestitaManagement API reference for managed instance
...
## <a name="azure-portal-create-a-managed-instance"></a>Portale di Azure: creare un'istanza gestitaAzure portal: Create a managed instance

Per una guida introduttiva che illustra come creare un'istanza gestita del database SQL di Azure, vedere [Guida introduttiva: Creare un'istanza gestita del database SQL](sql-database-managed-instance-get-started.md)di Azure.For a quickstart showing you how to create an Azure SQL Database Managed Instance, see Quickstart: Create an Azure SQL Database Managed Instance .
...
> [!TIP]
> Per gli script di esempio di PowerShell, vedere [Script di avvio rapido: Creare un'istanza gestita SQL di Azure usando la libreria di PowerShell .For PowerShell example scripts, see Quick-start script: Create Azure SQL Managed Instance using PowerShell library](https://blogs.msdn.microsoft.com/sqlserverstorageengine/20../../quick-start-script-create-azure-sql-managed-instance-using-powershell/).
...
|[Rimuovi-AzSqlInstance](https://docs.microsoft.com/powershell/module/az.sql/remove-azsqlinstance)|Rimuove Istanza gestita di database SQL di Azure|
...
|[Rimuovi-AzSqlInstanceDatabase](https://docs.microsoft.com/powershell/module/az.sql/remove-azsqlinstancedatabase)|Rimuove un database dell'istanza gestita di database SQL di Azure|
...
## <a name="azure-cli-create-and-manage-managed-instances"></a>Interfaccia di comando di Azure: Creare e gestire istanze gestiteAzure CLI: Create and manage managed instances
...
## <a name="transact-sql-create-and-manage-instance-databases"></a>Transact-SQLTransact-SQL: Create and manage instance databases
...
> [!TIP]
> Per le guide introduttive che mostrano che è necessario configurare e connettersi a un'istanza gestita usando SQL Server Management Studio in Microsoft Windows, vedere Guida introduttiva: Configurare la macchina virtuale di [Azure per la connessione a un'istanza gestita del database SQL](sql-database-managed-instance-configure-vm.md) di Azure e Guida [introduttiva: Configurare una connessione da punto a sito a un'istanza gestita del database SQL](sql-database-managed-instance-configure-p2s.md)di Azure da locale.
> [!IMPORTANT]
> Non è possibile creare o eliminare Istanza gestita usando Transact-SQL.

| Comando | Descrizione |
| --- | --- |
|[CREA DATABASE](https://docs.microsoft.com/sql/t-sql/statements/create-database-transact-sql?view=azuresqldb-mi-current)|Crea un nuovo database dell'istanza gestita. È necessario essere connessi al database master per creare un nuovo database.|
