...
Nello script *DeployReferenceData.sql* osservare il codice seguente:
...
In SSMS passare al database *contosoconcerthall* nel server *tenants1-dpt-\<utente\>* ed eseguire una query sulla tabella *VenueTypes* per verificare che *Motorcycle Racing* e *Swimming Club* **siano inclusi** nel set di risultati.
...
Nello script *OnlineReindex.sql* osservare il codice seguente:
...
Successivamente, eseguire l'[esercitazione sul reporting ad hoc](saas-tenancy-adhoc-analytics.md).
