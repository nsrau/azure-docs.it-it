...
## <a name="add-alerts-to-all-databases-in-a-pool"></a>Aggiungere avvisi a tutti i database di un pool
...
## <a name="example-retrieve-resource-consumption-metrics-for-a-pool-and-its-databases"></a>Esempio: recuperare le metriche di consumo di risorse per un pool e i relativi database
