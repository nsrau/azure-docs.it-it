<properties
	pageTitle="Connettersi al database SQL tramite Python"
...
In questo argomento viene illustrato come connettersi a un database SQL di Azure ed eseguire query tramite Python. È possibile eseguire questo esempio da piattaforme Windows, Ubuntu Linux o Mac.


## Passaggio 1: Configurare l'ambiente di sviluppo

[Prerequisiti per l'uso del driver pymssql Python per SQL Server](https://msdn.microsoft.com/library/mt694094.aspx)
...
[Modello di verifica della connessione a SQL tramite Python](http://msdn.microsoft.com/library/mt715796.aspx)
