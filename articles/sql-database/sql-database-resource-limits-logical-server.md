...
description: Questo articolo offre una panoramica dei limiti delle risorse del database SQL di Azure per database singoli e database in pool con i pool elastici. Offre anche informazioni su cosa accade quando tali limiti delle risorse vengono raggiunti o superati.
...
ms.locfileid: "48829564"
---
# <a name="sql-database-resource-limits-for-single-and-pooled-databases-on-a-logical-server"></a>Limiti delle risorse del database SQL per database singoli e in pool in un server logico 
