---
title: Limiti delle risorse del database SQL di Azure - Server logico | Microsoft Docs
description: Questo articolo offre una panoramica dei limiti delle risorse del server logico del database SQL di Azure per database singoli e in pool con i pool elastici. Offre anche informazioni su cosa accade quando tali limiti delle risorse vengono raggiunti o superati.
...
ms.locfileid: "51620899"
---
# <a name="sql-database-resource-limits-for-single-and-pooled-databases"></a>Limiti delle risorse del database SQL per database singoli e in pool

Questo articolo offre una panoramica dei limiti delle risorse del database SQL di Azure per database singoli e database in pool in un server logico. Offre anche informazioni su cosa accade quando tali limiti delle risorse vengono raggiunti o superati.
...
| N. max pool per server | Limitato dal numero di DTU o vCore. Se ad esempio ogni pool è da 1000 DTU, un server singolo può supportare 54 pool.|
||||
