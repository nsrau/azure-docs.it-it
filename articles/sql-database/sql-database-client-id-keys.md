...
7. Completare la creazione dell'applicazione, fare clic su **CONFIGURA** e copiare l’**ID CLIENT** (il valore che sarà necessario nel codice).

    ![acquisisci ID client][9]


1. Scorrere verso il basso e fare clic su **Aggiungi applicazione**.
1. Selezionare **App Microsoft**.
1. Selezionare **API di gestione del servizio Microsoft Azure** e quindi completare la procedura guidata.
2. Nella sezione **Autorizzazioni per altre applicazioni** individuare l'**API di gestione del servizio Microsoft Azure** e fare clic su **Autorizzazioni delegate**.
3. Selezionare **Accesso a Gestione dei servizi di Azure...**.

    ![autorizzazioni][2]

2. Fare clic su **SAVE** nella parte inferiore della pagina.
...
5. Fornire un **NOME** per l'applicazione e selezionare **APPLICAZIONE WEB E/O API WEB**.

    ![Aggiunta di un'applicazione][10]

6. Fornire un **URL DI ACCESSO** e un **URI ID APP**. Non è necessario che sia un endpoint effettivo, è sufficiente un URI valido.

    ![Aggiunta di un'applicazione][11]

7. Completare la creazione dell'applicazione, quindi fare clic su **CONFIGURA**.

    ![configure][12]

8. Scorrere fino alla sezione delle **chiavi** e selezionare **1 anno** nell'elenco **Seleziona durata**. Dopo il salvataggio verrà visualizzato il valore della chiave, che sarà copiato in un secondo momento.
...
1. Scorrere verso il basso e fare clic su **Aggiungi applicazione**.
1. Selezionare **App Microsoft**.
1. Individuare e selezionare **API di gestione del servizio Microsoft Azure**, quindi completare la procedura guidata.
2. Nella sezione **Autorizzazioni per altre applicazioni** individuare l'**API di gestione del servizio Microsoft Azure** e fare clic su **Autorizzazioni delegate**.
3. Selezionare **Accesso a Gestione dei servizi di Azure...**.
...
2. Fare clic su **SAVE** nella parte inferiore della pagina.
3. Dopo il salvataggio individuare e salvare l'ID CLIENT e la chiave:
