...
3. Fare clic su **Parameters** per specificare i valori per i parametri del runbook. Se il runbook ha parametri obbligatori, non sarà possibile creare il webhook a meno che non vengono forniti i valori.
