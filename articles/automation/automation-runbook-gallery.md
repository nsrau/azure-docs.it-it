---
title: Raccolte di runbook e moduli per Automazione di Azure | Microsoft Docs
...
8. Il runbook verrà visualizzato nella scheda **Runbook** per l'account di automazione.
