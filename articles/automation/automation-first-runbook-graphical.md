...
3. Creare un nuovo Runbook selezionando **+ Crea Runbook**.
4. Assegnare a Runbook il nome "MyFirstRunbook-Graphical".
...
1. Per impostazione predefinita, il campo **etichetta** è il nome del cmdlet, ma è possibile modificarlo in un modo più semplice. Impostarla su "Write Hello World to output".
...
1. Nel campo **espressione** digitare "Hello World", quindi fare clic su **OK** due volte per tornare all'area di disegno.
...
1. Al termine del processo del Runbook, il PAGN di test Visualizza l'output. In questo caso, viene visualizzato "Hello World".<br> ![Hello World](media/automation-first-runbook-graphical/runbook-test-results.png)
...
1. Scorrere verso destra per visualizzare la pagina relativa a MyFirstRunbook-graphical.
...
1. Viene aperto un riquadro del processo per il processo Runbook creato. Verificare che lo **stato del processo** sia completato.
1. Fare clic su **output** per aprire la pagina output, in cui è possibile visualizzare "Hello World".
1. Chiudere la pagina Output.
1. Fare clic su **Tutti i log** per aprire il riquadro Flussi relativo al processo del runbook. Nel flusso di output dovrebbe essere visualizzato solo "Hello World". 
...
1. Selezionare **+ Aggiungi una variabile**.
...
1. Selezionare **set-AzContext** nell'area di disegno. Nel riquadro controllo configurazione digitare "specifica ID sottoscrizione" nel campo **etichetta** .
...
1. Selezionare il set di parametri **ResourceGroupNameParameterSetName** . I campi **ResourceGroupName** e **Name** hanno punti esclamativi accanto a essi per indicare che sono parametri obbligatori. Si noti che in entrambi i campi sono previsti valori stringa.
1. Selezionare **Name**. Selezionare **espressione PowerShell** per il campo **origine dati** . Per la VM usata per avviare questo Runbook, digitare il nome del computer racchiuso tra virgolette doppie. Fare clic su **OK**.
...
1. Aprire l'editor grafico facendo clic su **modifica** nel riquadro MyFirstRunbook-graphical.
...
1. Aprire MyFirstRunbook-Graphical nell'editor grafico.
...
1. Selezionare **Get-AzVM** e quindi **set di parametri** per visualizzare i set per **Get-AzVM**. 
1. Selezionare il set di parametri GetVirtualMachineInResourceGroupNameParamSet. I campi **ResourceGroupName** e **Name** hanno punti esclamativi accanto a essi, a indicare che specificano i parametri obbligatori. Si noti che in entrambi i campi sono previsti valori stringa.
...
1. Creare un collegamento da **specifica ID sottoscrizione** a **Get-AzVM**.
...
1. Per **InputObject**, modificare l' **origine dati** in **espressione PowerShell**e digitare l'espressione "$VMName avviato correttamente".
...
1. Per **InputObject**, modificare l' **origine dati** in un' **espressione PowerShell**e digitare l'espressione "$VMName non è stato possibile avviare".
