...
Per impostazione predefinita, i runbook vengono eseguiti nel contesto dell'account di sistema locale nel computer locale e devono quindi autenticarsi per le risorse a cui accedono.
