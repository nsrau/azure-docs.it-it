...
**Suggerimenti per la risoluzione dei problemi:** seguire le istruzioni riportate nel post del blog relativo a [limitazioni e problemi noti di DSC](https://msdn.microsoft.com/powershell/wmf/limitation_dsc) per risolvere il problema.
