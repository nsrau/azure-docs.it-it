...
> [AZURE.SELECTOR] - [Grafico](automation-first-runbook-graphical.md) - [PowerShell](automation-first-runbook-textual-powershell.md) - [Flusso di lavoro PowerShell](automation-first-runbook-textual.md)
>
>
