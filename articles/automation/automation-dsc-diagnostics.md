...
- Il modulo [xDscDiagnostics](https://www.powershellgallery.com/packages/xDscDiagnostics/2.7.0.0) , versione 2.7.0.0 o successiva. Per la procedura di installazione, vedere [risolvere i problemi di automazione di Azure desired state Configuration](./troubleshoot/desired-state-configuration.md#steps-to-troubleshoot-desired-state-configuration-dsc).
