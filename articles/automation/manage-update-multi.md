...
ms.locfileid: "86185161"
---
# <a name="manage-updates-for-multiple-vms"></a>Gestire gli aggiornamenti per più macchine virtuali

È possibile usare Gestione aggiornamenti di Automazione di Azure per gestire gli aggiornamenti e le patch per le macchine virtuali Windows e Linux. Dall'account di [Automazione di Azure](./index.yml) è possibile:
