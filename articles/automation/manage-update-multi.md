...
Per informazioni sui requisiti di sistema per Gestione aggiornamenti, vedere [requisiti di gestione aggiornamenti client](automation-update-management.md#clients).
