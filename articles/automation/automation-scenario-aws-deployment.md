---
title: Automazione della distribuzione di una VM in Amazon Web Services | Microsoft Docs
...
4. Dopo avere completato l'immissione delle informazioni necessarie, fare clic su **Crea**.
   ...
   > [!NOTE]
   > Durante l'importazione di un modulo di PowerShell in Automazione di Azure, vengono estratti anche i cmdlet e queste attività verranno visualizzate solo dopo il completamento dell'importazione del modulo e l'estrazione dei cmdlet. Il processo potrebbe richiedere alcuni minuti. <br>
   > 
   > 
