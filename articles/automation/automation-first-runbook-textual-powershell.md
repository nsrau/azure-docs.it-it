...
1.	Fare clic su **Riquadro di test** per aprire il riquadro di test. ![Riquadro Test](media/automation-first-runbook-textual-powershell/automation-testpane.png)  
...
7.	Fare clic sul **Pannello di test** in modo da testare il runbook.
...
1.	Dopo *Add-AzureAccount* digitare *Start-AzureVM -Name 'VMName' -ServiceName 'VMServiceName'* specificando il nome e il nome del servizio della macchina virtuale da avviare. ![StartVM](media/automation-first-runbook-textual-powershell/automation-startvm.png)  
...
1.	Aggiungere al runbook i parametri per *VMName* e *VMServiceName* e usare queste variabili con il cmdlet **Start-AzureVM** come illustrato nell'immagine seguente. ![Aggiungi parametro](media/automation-first-runbook-textual-powershell/automation-add-parameter.png)  
...
6.	Fare clic su **Avvia** per avviare il runbook. Digitare **VMName** e **VMServiceName** per la macchina virtuale da avviare.![Passare i parametri](media/automation-first-runbook-textual-powershell/automation-pass-parameter.png)  
