...
Il primo passaggio della migrazione consiste nello scaricare il [System Center Orchestrator Migration Toolkit](https://www.microsoft.com/download/details.aspx?id=47323&WT.mc_id=rss_alldownloads_all). Questo toolkit include strumenti che facilitano la conversione dei runbook da Orchestrator ad Automazione di Azure.  

## <a name="import-the-standard-activities-module"></a>Importare il modulo delle attività standard

Importare il [modulo delle attività standard](https://docs.microsoft.com/system-center/orchestrator/standard-activities?view=sc-orch-2019) in Automazione di Azure. Questo modulo include versioni convertite di attività standard di Orchestrator che possono essere usate dai runbook grafici convertiti.
...
[Attività di monitoraggio](https://technet.microsoft.com/library/hh403827.aspx) non vengono convertite, in quanto non hanno un equivalente in Automazione di Azure. L'eccezione sono le attività di monitoraggio negli Integration Pack convertiti , che verranno convertite in attività segnaposto.
...
* Per informazioni dettagliate su Orchestrator, vedere [System Center 2012 - Orchestrator](https://technet.microsoft.com/library/hh237242.aspx).
* Altre informazioni sull'automazione della gestione dei servizi in [Service Management Automation](https://technet.microsoft.com/library/dn469260.aspx).
* Per informazioni dettagliate sulle attività di Orchestrator, vedere [Attività standard di Orchestrator](https://technet.microsoft.com/library/hh403832.aspx).
