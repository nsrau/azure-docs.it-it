...
* Solo i moduli `Azure` e `AzureRM.*` sono attualmente supportati. I nuovi [moduli Azure PowerShell Az](/powershell/azure/new-azureps-module-az) non sono ancora supportati.
