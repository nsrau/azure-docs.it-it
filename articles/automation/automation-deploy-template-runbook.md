...
description: Questo articolo descrive come distribuire un modello di Azure Resource Manager archiviato in Archiviazione di Azure da un runbook PowerShell.
services: automation
