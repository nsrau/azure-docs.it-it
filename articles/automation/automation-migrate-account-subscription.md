...
2. Nel riquadro **Sposta risorse** sono presenti le risorse relative all'account di Automazione e ai gruppi di risorse.  Selezionare la **sottoscrizione** e il **gruppo di risorse** dagli elenchi a discesa, oppure selezionare l'opzione **creare un nuovo gruppo di risorse** e immettere il nome di un nuovo gruppo di risorse nel campo corrispondente.  
