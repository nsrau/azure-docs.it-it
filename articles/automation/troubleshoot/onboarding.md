...
Questo errore può essere causato se il piano tariffario non corrisponde a modello di fatturazione della sottoscrizione. Per altre informazioni, vedere [monitoraggio dell'utilizzo e costi stimati in Monitoraggio di Azure](https://aka.ms/PricingTierWarning).
