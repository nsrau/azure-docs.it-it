---
title: Sicurezza in Automazione di Azure | Documentazione Microsoft
...
---
# <a name="azure-automation-security"></a>Sicurezza in Automazione di Azure
...
| --- | --- | --- |
| Account utente di Azure AD |Gestione risorse di Azure e Gestione servizi di Azure |[Autenticare runbook con un account utente di Azure AD](automation-sec-configure-aduser-account.md) |
...
| Credenziali AWS |Amazon Web Services |[Autenticare runbook con Amazon Web Services (AWS)](automation-sec-configure-aws-account.md) |
