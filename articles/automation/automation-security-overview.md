<properties
   ...
   description="Questo articolo offre una panoramica della sicurezza e dei diversi metodi di autenticazione disponibili per gli account di Automazione in Automazione di Azure."
   services="automation"
   documentationCenter=""
   authors="MGoedtel"
   manager="jwhit"
