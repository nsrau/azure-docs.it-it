...
> [!NOTE]
> Non impostare il ruolo "Operatore di automazione" a meno che non si desideri consentire a un operatore di gestire i processi per tutti i runbook nell'account.
