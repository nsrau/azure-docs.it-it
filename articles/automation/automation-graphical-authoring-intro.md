...
L'attività successiva, Connect-AzureRmAccount, aggiunge l'account RunAs autenticato per l'uso con il runbook.<br>
![Set di parametri Connect-AzureRmAccount](media/automation-graphical-authoring-intro/authenticate-conn-to-azure-parameter-set.png)<br>
