...
## <a name="starting-a-runbook-with-the-azure-portal"></a>Avvio di un Runbook con il portale di Azure
...
4. Se il runbook ha parametri, viene chiesto di specificare i valori con una casella di testo per ogni parametro. Per altri dettagli sui parametri, vedere [Parametri di Runbook](#Runbook-parameters) più avanti.
