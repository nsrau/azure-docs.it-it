...
<strong>WebSocket</strong>. Impostare **ATTIVATO** per abilitare il protocollo WebSocket, ad esempio se il sito Web usa [ASP.NET SignalR](http://www.asp.net/signalr) o [socket.io](http://azure.microsoft.com/it-it/documentation/articles/web-sites-nodejs-chat-app-socketio/).
...
In modalità Basic o Standard è possibile caricare certificati SSL per un dominio personalizzato. Per altre informazioni, vedere [Abilitare HTTPS per un sito Web di Azure](http://www.windowsazure.com/it-it/documentation/articles/web-sites-configure-ssl-certificate/). 
...
Se sono stati caricati certificati SSL, è possibile associarli a nomi di dominio personalizzati. Per altre informazioni, vedere [Abilitare HTTPS per un sito Web di Azure](http://www.windowsazure.com/it-it/documentation/articles/web-sites-configure-ssl-certificate/).
...
- Se si sceglie <strong>File system</strong>, i log vengono salvati nel sito FTP indicato in "Registri di diagnostica FTP" nella pagina Dashboard (vedere [Credenziali FTP](http://azure.microsoft.com/it-it/documentation/articles/web-sites-manage#ftp-credentials)). 
...
Per informazioni sulla configurazione del sito Web per l'uso di un nome di dominio personalizzato, vedere [Configurazione di un nome di dominio personalizzato per un sito Web di Azure](http://www.windowsazure.com/it-it/documentation/articles/web-sites-custom-domain-name/).
