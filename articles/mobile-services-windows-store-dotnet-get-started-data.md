...
##<a name="add-table"></a>Aggiungere una nuova tabella per l'archiviazione
...
6. Nel file di progetto MainPage.xaml.cs sostituire il metodo **RefreshTodoItems** esistente con il codice seguente che consente di filtrare gli elementi completati:
...
7. Nell'app selezionare un altro elemento e fare clic sul pulsante **Refresh**.
