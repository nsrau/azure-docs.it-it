...
Per creare una richiesta di supporto, è necessario essere un [proprietario](../../role-based-access-control/built-in-roles.md#owner), un [collaboratore](../../role-based-access-control/built-in-roles.md#contributor) o essere assegnato al ruolo [collaboratore richiesta di supporto](../../role-based-access-control/built-in-roles.md#support-request-contributor) a livello di sottoscrizione. Per creare una richiesta di supporto senza una sottoscrizione, ad esempio Azure Active Directory scenario (AAD), è necessario essere un [amministratore](../../active-directory/users-groups-roles/directory-assign-admin-roles.md).
...
È possibile visualizzare i dettagli e lo stato delle richieste di supporto selezionando **Guida e supporto** >  per**tutte le richieste di supporto**.
