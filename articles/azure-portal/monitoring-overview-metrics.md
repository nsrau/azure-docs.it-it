...
### Visualizzare le metriche dopo aver creato una risorsa
...
Per una procedura ancor più dettagliata con le API REST del monitoraggio di Azure, vedere [Procedura dettagliata relativa alle API REST del monitoraggio di Azure](../monitoring-and-diagnostics/monitoring-rest-api-walkthrough.md).
...
È configurabile tramite i modelli di Resource Manager, [PowerShell](../monitoring-and-diagnostics/insights-powershell-samples.md), [interfaccia della riga di comando](../monitoring-and-diagnostics/insights-cli-samples.md) o [API REST](https://msdn.microsoft.com/library/dn931943.aspx).
...
È possibile visualizzare un elenco dettagliato di tutti i servizi supportati e delle relative metriche in [Metriche del monitoraggio di Azure: metriche supportate per tipo di risorsa](../monitoring-and-diagnostics/monitoring-supported-metrics.md).
...
* [come creare le regole di avviso](../monitoring-and-diagnostics/insights-alerts-portal.md)
