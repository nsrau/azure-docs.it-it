...
![Modello di risorsa di rete](./media/resource-group-networking/Figure1.png)
...
![Modello di risorsa di rete](./media/resource-group-networking/Figure2.png)
...
![Scheda di interfaccia di rete in una macchina virtuale singola](./media/resource-group-networking/Figure3.png)
...
![Scheda di interfaccia di rete in una macchina virtuale singola](./media/resource-group-networking/Figure4.png)
...
![Scheda di interfaccia di rete in una macchina virtuale singola](./media/resource-group-networking/Figure5.png)
...
![Distribuzione del modello di esempio](./media/resource-group-networking/Figure6.png)
