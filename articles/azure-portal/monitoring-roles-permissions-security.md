...
> [AZURE.NOTE] Questo ruolo non concede l'accesso in lettura ai dati del registro che sono stati trasmessi a un hub eventi o archiviati in un account di archiviazione. Per informazioni sulla configurazione dell'accesso a queste risorse, [vedere di seguito](#security-considerations-for-monitoring-data).
