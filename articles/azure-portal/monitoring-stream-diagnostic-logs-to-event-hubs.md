<properties
	pageTitle="Trasmettere log di diagnostica di Azure a Hub eventi | Microsoft Azure"
...
> [AZURE.WARNING] Per abilitare la trasmissione dei log di diagnostica da risorse di calcolo, ad esempio le macchine virtuali o Service Fabric, è necessario [seguire una procedura diversa](../event-hubs/event-hubs-streaming-azure-diags-data.md).
