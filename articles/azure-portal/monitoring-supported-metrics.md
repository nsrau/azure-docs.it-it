...
|Metrica|Nome visualizzato per la metrica|Unità|Tipo di aggregazione|Descrizione|
|---|---|---|---|---|
|INREQS|Richieste in ingresso|Numero|Totale||
|SUCCREQ|Richieste riuscite|Numero|Totale||
|FAILREQ|Richieste non riuscite|Numero|Totale||
|SVRBSY|Errori server occupato|Numero|Totale||
|INTERR|Errori interni server|Numero|Totale||
|MISCERR|Altri errori|Numero|Totale||
...
|Metrica|Nome visualizzato per la metrica|Unità|Tipo di aggregazione|Descrizione|
|---|---|---|---|---|
|Latency|Latency|Secondi|Media|La latenza media per il servizio di ricerca|
...
|Metrica|Nome visualizzato per la metrica|Unità|Tipo di aggregazione|Descrizione|
|---|---|---|---|---|
|CPUXNS|Uso della CPU per spazio dei nomi|Percentuale|Massima||
|WSXNS|Uso delle dimensioni della memoria per spazio dei nomi|Percentuale|Massima||
...
|connection\_successful|Connessioni riuscite|Numero|Totale|Connessioni riuscite|
|connection\_failed|Connessioni non riuscite|Numero|Totale|Connessioni non riuscite|
|blocked\_by\_firewall|Blocco da parte del firewall|Numero|Totale|Blocco da parte del firewall|
|deadlock|Deadlock|Numero|Totale|Deadlock|
|storage\_percent|Percentuale di dimensioni del database|Percentuale|Massima|Percentuale di dimensioni del database|
|xtp\_storage\_percent|Percentuale archiviazione OLTP interna alla memoria (anteprima)|Percentuale|Massima|Percentuale archiviazione OLTP interna alla memoria (anteprima)|
...
|dtu\_limit|Limite DTU|Numero|Massima|Limite DTU|
|dtu\_used|Uso DTU|Numero|Massima|Uso DTU|
|service\_level\_objective|Obiettivo del livello di servizio del database|Numero|Totale|Obiettivo del livello di servizio del database|
|dwu\_limit|Limite DWU|Numero|Massima|Limite DWU|
|dwu\_consumption\_percent|Percentuale DWU|Percentuale|Massima|Percentuale DWU|
|dwu\_used|Uso DWU|Numero|Massima|Uso DWU|
