...
1. Premere F12 o selezionare ![screenshot](media/capture-browser-trace/chromium-icon-settings.png) > dell'icona delle impostazioni del browser**altri strumenti** > strumenti di**sviluppo**.
...
1. Premere F12 o selezionare ![screenshot](media/capture-browser-trace/edge-icon-settings.png) > dell'icona delle impostazioni del browser**altri strumenti** > strumenti di**sviluppo**.
