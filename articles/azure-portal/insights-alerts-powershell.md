...
# Usare PowerShell per creare avvisi per i servizi di Azure 
...
## Creare regole di avviso in PowerShell
...
4. Per creare una regola, per prima cosa è necessario disporre di alcune informazioni importanti.
	...
	È possibile ottenere l'ID della risorsa tramite il portale di Azure. Se la risorsa è già stata creata, selezionarla nel portale. Nel pannello successivo selezionare *Proprietà* nella sezione *Impostazioni*. L'ID RISORSA è un campo del pannello successivo. È anche possibile usare [Esplora risorse di Azure](https://resources.azure.com/).
...
7. Per creare un avviso che viene attivato in seguito al verificarsi di una condizione specifica nel log attività, usare i comandi come indicato di seguito.
...
8. Verificare che gli avvisi siano stati creati correttamente esaminando la singola regola.
...
9. Eliminare gli avvisi. Questi comandi eliminano le regole create in precedenza in questo articolo.
