...
> [!NOTE]
> Il campo properties può essere impostato solo usando l'[API REST di Insights](https://msdn.microsoft.com/library/azure/dn933805.aspx).
> 
> 
