---
title: Tenere traccia dell'integrità del servizio usando Azure Insights | Microsoft Docs
...
1. Fare clic su **Sfoglia** e selezionare **Log di controllo**. ![Hub di esplorazione](./media/insights-service-health/Insights_Browse.png)
2. Si aprirà un pannello contenente tutti gli eventi che hanno avuto effetto sulle sottoscrizioni negli ultimi 7 giorni. Le voci di integrità del servizio vengono visualizzate nell'elenco, ma potrebbe essere difficile individuarle in quanto l'elenco potrebbe essere di grandi dimensioni.
3. Fare clic sul comando **Filtro**.
4. Selezionare **Categoria di eventi** e scegliere **Integrità del servizio**: ![Tutti gli eventi](./media/insights-service-health/Insights_Filter.png)
5. Fare clic su **Aggiornato**.
6. Verranno ora visualizzati tutti gli eventi di integrità del servizio che hanno influito sulla sottoscrizione: ![Gruppi di risorse](./media/insights-service-health/Insights_HealthEvent.png)
7. Da qui è possibile passare al pannello dei dettagli per vedere le specifiche dell'evento.
