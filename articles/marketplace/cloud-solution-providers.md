...
Accedi al [Centro per i partner partner](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv) o al portale per i partner [cloud](https://cloudpartner.azure.com/) per creare e configurare la tua offerta.
