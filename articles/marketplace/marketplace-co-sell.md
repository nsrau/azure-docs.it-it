...
* L'offerta riceverà una notifica di **"soluzioni preferite"** nelle vetrine. Il badge promuove la qualità, le prestazioni e la capacità delle offerte per soddisfare le esigenze dei clienti in una determinata area verticale o della soluzione. Scopri di più [sulle soluzioni preferite in Microsoft AppSource e in Azure Marketplace](preferred-solutions.md).

## <a name="co-sell-publishing-steps-and-requirements"></a>Co-selling di passaggi e requisiti di pubblicazione

La tabella seguente elenca i passaggi e i requisiti per l'offerta del Marketplace co-selling Ready o co-selling incentivate. Non tutti i tipi di offerta del Marketplace commerciale sono configurabili per la co-selling ancora nel centro per i partner. Per le informazioni più recenti, è possibile fare riferimento all' [opzione di co-selling nel centro](https://docs.microsoft.com/azure/marketplace/partner-center-portal/commercial-marketplace-co-sell) per i partner. 
...
1. Verranno esaminati i materiali caricati e verrà determinato se l'offerta è idonea per il programma di co-selling.
