...
| Elemento | Scopo |
| ---------- | -------------------|
| [**Nuova offerta modale**](#new-offer-modal) | Raccoglie le informazioni relative all'identità dell'offerta.  |
| [Pagina installazione offerta](#offer-setup-page) | Consente di acconsentire esplicitamente all'uso delle funzionalità chiave e di scegliere come vendere l'offerta tramite Microsoft.  |
| [Pagina delle proprietà](#properties-page) | Consente di definire le categorie e i settori usati per raggruppare l'offerta nei marketplace, i contratti legali che supportano l'offerta e la versione dell'app. |
| [Pagina di inserzione dell'offerta](#offer-listing-page) | Consente di definire i dettagli dell'offerta da visualizzare nel marketplace, tra cui le descrizioni dell'offerta e gli asset di marketing.|
...
| [**Nuovo piano modale**](#plan-identity-modal) | Raccoglie le informazioni relative all'identità del piano.  |
| [Pagina di elenco del piano](#plan-listing-page)  | Disponibile solo se si sceglie di vendere l'offerta tramite Microsoft. Consente di definire i dettagli usati per la presentazione del piano nel marketplace.  |
| [Pagina prezzi e disponibilità del piano](#plan-pricing-and-availability-page)  | Disponibile solo se si sceglie di vendere l'offerta tramite Microsoft.  Raccoglie le caratteristiche di business (modello di determinazione prezzi), i destinatari e la disponibilità di mercato per ogni piano (versione) dell'offerta.  |
| [Pagina di elenco di test drive](#test-drive-listing-page)  | Disponibile solo se si sceglie di offrire un test drive per l'offerta. Consente di definire i dettagli usati per la presentazione del test drive nel marketplace.  |
...
| [Pagina Revisione e pubblicazione](#review-and-publish-page)  | Consente di selezionare le modifiche da pubblicare, visualizzare lo stato di ogni pagina e specificare note per il team di certificazione.  |
|
...
| Nome del campo | Note |
| ---------------- | -----------|  
| Vendere tramite Microsoft?  | Obbligatorio. Impostazione predefinita: Sì. |
...
| URL dell'offerta  | Obbligatorio se è selezionata l'opzione "Ottieni ora", perché il modo in cui i clienti devono interagire con l'elenco delle offerte. |
...
| URL dell'informativa sulla privacy  | Obbligatoria |
...
| Logo dello Store (Small, medium, large)  | È necessario il logo di grandi dimensioni (da 216 x 216 a 350 x 350 px). Il centro per i partner lo utilizzerà per creare un logo Small (48 x 48 px) e Medium (90 x 90 px). Facoltativamente, è possibile sostituirli con immagini diverse in un secondo momento. Il formato del logo deve essere PNG. |
...
## <a name="plan-pricing-and-availability-page"></a>Pagina prezzi e disponibilità del piano
