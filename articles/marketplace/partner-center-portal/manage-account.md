...
Nel [Dashboard del Marketplace commerciale](https://partner.microsoft.com/dashboard/commercial-marketplace) in centro per i partner selezionare **Impostazioni** (icona a forma di ingranaggio) nell'angolo superiore destro, quindi **Impostazioni sviluppatore**.
