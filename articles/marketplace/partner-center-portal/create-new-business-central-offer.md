---
title: Crea una nuova offerta di Dynamics 365 business Central nel Marketplace commerciale Microsoft
description: Come creare una nuova offerta di Dynamics 365 business Central per elencare o vendere in Azure Marketplace, Microsoft AppSource o tramite il programma Cloud Solution Provider (CSP) usando il portale di Marketplace commerciale nel centro per i partner Microsoft.
author: dsindona
ms.author: dsindona
...
La pagina di presentazione dell'offerta consente di definire i dettagli dell'offerta, ad esempio nome, descrizione, immagini e così via.
...
In questa sezione è possibile fornire logo e immagini che verranno usati quando si mostra l'offerta al cliente. Tutte le immagini devono essere in formato png. Caricare il logo dell'offerta in due dimensioni: **Small (48 x 48)** e **Large (216 x 216)**.
...
Se è stata selezionata l'opzione **Connetti** sopra, fornire l'URL per l'installazione dell'app qui. Per i servizi connessi che non richiedono l'installazione, specificare l'URL per la pagina di destinazione o la pagina di iscrizione del servizio.
...
L'opzione di **elenco del Marketplace** disponibile nella scheda **test drive** è la posizione in cui è possibile definire i dettagli per l'esperienza test drive.
...
È necessario caricare un `.pdf` file che elenca gli scenari di utilizzo chiave dell'offerta elencati in un documento (formato PDF). Tutti gli scenari elencati di seguito possono essere verificati dal team di convalida prima di approvare l'offerta per il Marketplace.
