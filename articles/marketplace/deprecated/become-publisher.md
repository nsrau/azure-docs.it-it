...
| 3 | Creare un account nel Centro per i partner | 15 min | [Creazione di un account nel Centro per i partner](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv) |  
| 4 |  Accedere al portale Cloud Partner | 1-3 giorni | [Accedi portale Cloud Partner](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account#sign-in-with-a-work-account) |  
...
>[!Note]
>Per rinunciare alla tariffa di registrazione del centro per sviluppatori $99, completare il [modulo di registrazione del Marketplace](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv) e si riceverà un messaggio di posta elettronica contenente il codice promozionale. Per ulteriori informazioni, vedere come [creare un account del centro](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account) per i partner.
