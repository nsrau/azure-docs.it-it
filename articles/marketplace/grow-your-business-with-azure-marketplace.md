...
| Impostazione della vetrina | Procedura consigliata |
|:--- |:--- |  
| Settori: solo le app AppSource e i servizi di consulenza | Selezionare i settori se l'offerta è stata progettata per soddisfare i requisiti di settori specifici:<br>Nella descrizione dell'offerta mettere in risalto le funzionalità specifiche per i settori selezionati.<br><br>**Nota**: il numero massimo di opzioni varia in base al tipo di offerta e viene indicato nel portale Cloud Partner. |
| Categorie | Selezionare le categorie che risultano più in linea con l'offerta:<br>Scegliere le categorie con attenzione perché vengono usate dai clienti per cercare le app adatte alle loro esigenze. Nella descrizione sottolineare come l'offerta riesca a soddisfare i requisiti specifici delle categorie selezionate.<br><br> **Nota**: il numero massimo di opzioni varia in base al tipo di offerta e viene indicato nel portale Cloud Partner. |
| Prodotti con cui l'app è compatibile (al massimo&nbsp;3): solo app AppSource | Elencare altri prodotti e tecnologie usati o estesi dalla soluzione offerta:<br>Ad esempio, l'hub IoT di Azure o Azure Machine Learning. |
| Parole chiave di ricerca (al massimo&nbsp;3) | Usare parole chiave di ricerca che consentano agli utenti aziendali di trovare più facilmente un'offerta quando eseguono la ricerca in Azure Marketplace e AppSource o tramite motori di ricerca:<br>Identificare le tre parole chiave di ricerca più significative per l'offerta, includerle nella descrizione e nel riepilogo dell'offerta ed elencarle qui. |
...
| Documenti "Altre informazioni" | Nella sezione "Altre informazioni" includere risorse di supporto per le vendite e il marketing:<br>Ad esempio, white paper, brochure, elenchi di controllo o presentazioni PowerPoint. Salvare tutti i file in formato PDF. L'obiettivo dovrebbe essere informare i clienti, non la vendita.<br><br>Nella pagina di destinazione dell'app inserire un collegamento a tutti i documenti e aggiungere parametri dell'URL per tenere traccia dei visitatori e dell'uso delle versioni di valutazione. |
| Video: solo AppSource, servizi di consulenza e offerte SaaS | I video più efficaci comunicano il valore dell'offerta in forma narrativa:<br>Il protagonista deve essere il cliente e non la società che presenta l'offerta. Il video deve dare risposte riguardo alle sfide e agli obiettivi fondamentali del cliente a cui ci si rivolge.<br><br>Lunghezza consigliata: da 60 a 90 secondi.<br><br>Includere parole chiave di ricerca che usano il nome dei video.<br><br>Valutare l'opportunità di aggiungere altri video, ad esempio per illustrare procedure, fornire una guida introduttiva o presentare la testimonianza di un cliente. |
...
Per ottimizzare i vantaggi dell'inserzione nel marketplace, sono state raccolte le procedure consigliate seguenti per la commercializzazione delle offerte su AppSource e in Azure Marketplace. In primo luogo, assicurarsi di esaminare le procedure consigliate e le risorse di marketing su Microsoft Partner Network (MPN). Da questo sito è possibile accedere a tutte le risorse programmatiche e di marketing correlate alla collaborazione con Microsoft.

Inoltre, la qualità dell'offerta del marketplace e l'impegno dedicato a favorire la generazione delle domanda da parte dei clienti consente di acquisire un numero sempre maggiore per la propria azienda. Il coinvolgimento in queste attività consente a Microsoft di rafforzare l'impegno dedicato a promuovere la commercializzazione e a sviluppare soluzioni efficaci per le vetrine del marketplace.

Dopo aver creato un'inserzione di sicuro effetto, le iniziative di marketing seguenti consentiranno di far crescere l'azienda:

* Creare una proposta di valore sicuro.<br>Identificare il potenziale cliente e i principali fattori di differenziazione della propria soluzione.

* Creare una landing page esclusiva sul proprio sito per mettere in risalto l’inserzione dell’app.<br>Favorire il traffico dal sito all'offerta e fare un'ottima prima impressione. In base all'inserzione dell'offerta, i clienti decidono se vogliono altre informazioni e provare una soluzione.

* Abilitare un test drive o un’altra versione di valutazione.<br>Per gli utenti, è importante avere l'opportunità di provare direttamente l'app. Storicamente gli editori hanno osservato tassi di conversione dei lead molto più alti da inserzioni che offrono un test driver o una versione di valutazione.

* Ottimizzare l'inserzione per migliorarne la visibilità nei risultati dei motori di ricerca.<br>Includere le parole chiave di ricerca nel nome dell'app, nel riepilogo e nell'inserzione. 
...
Se non si è ancora iscritti a Microsoft Partner Network, iscriversi per continuare. Per altre informazioni su MPN, andare alla pagina [Microsoft Partner Network](https://partner.microsoft.com).
