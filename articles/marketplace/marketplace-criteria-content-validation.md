...
|  | Elemento | Requisiti di base | Requisiti ottimali | 
|:--- |:--- |:--- |:--- |
| 1 | Titolo dell'offerta |<br>• Deve contenere solo caratteri alfanumerici minuscoli, trattini o caratteri di sottolineatura. Non può essere modificato dopo la pubblicazione. <br>• Descrive la soluzione offerta.<br>• Corrisponde alla promozione in linea della soluzione nel sito Web del partner. | Contiene parole chiave di ricerca |
...
| 3 | Test drive | Selezionare: Sì o No | Il cliente può immediatamente capire quali sono i passaggi successivi: <br>1. provare la versione di valutazione <br>2. Acquista ora <br>3. contattare via posta elettronica o numero di telefono per disporre di PoC, assessment o briefing. |
