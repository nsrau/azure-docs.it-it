...
1. Accedere con l'account del servizio gestito (account MPN) o AAD (account del Dashboard del Partner); in base l'accesso le credenziali, verrà aperto un modulo di richiesta online: 
