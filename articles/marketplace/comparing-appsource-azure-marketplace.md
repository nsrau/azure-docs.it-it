...
|:--- |:--- |
| Sviluppatori e professionisti IT | Decision maker aziendali |
...
| **Automazione** | Collega fornitori di software indipendenti, integratori di sistemi e provider di servizi gestiti a specifici scenari di implementazione. È possibile vendere in modalità collaborativa a nuovi clienti. | Attualmente non è possibile collegare all'offerta un provider di servizi o partner di distribuzione. È possibile sfruttare il provisioning automatizzato di soluzioni SaaS con componenti aggiuntivi e usare l'opzione di pubblicazione App di Azure: Modello di soluzione per automatizzare gli scenari di distribuzione e raccolta di dati basati su SaaS. |
