...
Nome visualizzato dell'offerta. Si tratta del nome che verrà visualizzato in [AppSource](https://appsource.microsoft.com/). Può contenere massimo 50 caratteri.
...
Selezionare le lingue supportate dall'app. Se l'app supporta lingue aggiuntive non presenti in questo elenco, continuare a pubblicare l'offerta e inviare un messaggio di posta [appsource@microsoft.com](mailto:appsource@microsoft.com) elettronica all'indirizzo: per inviarlo a Microsoft.
