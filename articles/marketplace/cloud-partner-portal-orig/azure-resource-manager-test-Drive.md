...
description: Compilare un test drive di Markeplace tramite Azure Resource Manager
...
Assicurarsi di dedicare una quantità di tempo sufficiente alla valutazione dei modi migliori per mostrare il prodotto. In particolare modo per quanto riguarda le risorse, in quanto rende l'architettura del modello di Resource Manager più semplice.
...
Una volta progettato il pacchetto di risorse desiderato, si procede con la scrittura e la compilazione del modello di Resource Manager del test drive.
