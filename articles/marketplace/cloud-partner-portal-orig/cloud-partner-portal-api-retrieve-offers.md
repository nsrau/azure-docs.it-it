...
|  version        | Versione corrente dell'offerta. La proprietà versione non può essere modificata dal client. Viene incrementata dopo ogni pubblicazione. |
|  Definizione     | Contiene la visualizzazione del riepilogo della definizione stessa del carico di lavoro. Per ottenere una definizione dettagliata, usare l'API [Recupera offerta specifica] ( /cloud-partner-portal-api-retrieve-specific-offer.md) API. |
...
|  WaitingForPublisherReview   | Offerta in attesa di approvazione da parte dell'editore.         |
