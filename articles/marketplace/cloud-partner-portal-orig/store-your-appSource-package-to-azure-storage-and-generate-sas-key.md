...
1.  Passare a <http://azure.microsoft.com> e creare un account di valutazione o di fatturazione gratuito.
...
6.  Se non è già stato fatto, scaricare e installare Microsoft [Azure Storage Explorer](http://storageexplorer.com/).
