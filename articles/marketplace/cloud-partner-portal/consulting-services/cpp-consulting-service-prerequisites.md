---
title: Offerta di servizi di consulenza per Azure e Dynamics 365 - Prerequisiti | Microsoft Docs
description: Guida ai prerequisiti per un'offerta di un servizio di consulenza per Azure o Dynamics 365 nel portale Cloud Partner.
...
ms.locfileid: "60565327"
---
# <a name="consulting-service-prerequisites"></a>Prerequisiti dei servizi di consulenza

Esaminare la descrizione del e digitare i requisiti per questa offerta [servizi di consulenza per Azure Marketplace e AppSource](../../consulting-services.md).  I tipi di servizi consulenza specifici seguenti hanno requisiti aggiuntivi:
...
Dopo avere soddisfatto i requisiti precedenti, si è pronti per [creare un'offerta di servizi di consulenza](./cpp-consulting-service-create-offer.md).
