...
ms.locfileid: "53345502"
---
# <a name="storefront-details-tab"></a>Scheda Dettagli vetrina

Successivamente, è necessario immettere i dati relativi alla vetrina. La scheda **Dettagli vetrina** è costituita dalle sezioni seguenti:
...
![Creazione di una nuova offerta di servizi di consulenza - scheda Dettagli vetrina](media/consultingoffer-storefront-details.png)
...
Immettere in questa casella la descrizione dell'offerta del servizio di consulenza. Una buona descrizione dell'offerta include i dettagli esatti di come sarà l'engagement e quale sarà la consegna finale al cliente. Dovrebbe aiutare i clienti a comprendere in maniera chiara qual'è il risultato finale. La descrizione dell'offerta deve includere anche come l'offerta si rapporta con il prodotto Microsoft per cui si offrono servizi di consulenza.

Non includere collegamenti e-mail o numeri di telefono per essere contattati nella descrizione dell'offerta. L'offerta comprenderà un pulsante **Contattami** per caricare i clienti potenziali nella destinazione di gestione dei clienti potenziali che verrà individuata nell'offerta.

Inserire la descrizione dell'offerta in formato Markdown. Se non si ha familiarità con Markdown o con la formattazione per HTML, è possibile esaminare le risorse in [Come usare Markdown per scrivere articoli di Docs](https://docs.microsoft.com/contribute/how-to-write-use-markdown).
...
Nuovo ID del Centro per i partner, se disponibile.
...
Microsoft si concentra esclusivamente sulle offerte di servizi di consulenza in ambito fisso, con durata fissa, prezzo stimato o fisso (o gratuite) e principalmente pre-vendita per un cliente singolo e sulle offerte di valutazione, implementazione, modello di verifica, briefing o workshop, svolti in loco o virtualmente. Il marketplace dei servizi di consulenza di AppSource non supporta inserzioni per servizi di sottoscrizione o gestiti.
...
Per pubblicare in AppSource, selezionare **Dynamics 365**, **Power BI** o **PowerApps** come prodotto primario. È inoltre possibile selezionare altri prodotti applicabili pertinenti, e l'offerta di servizi di consulenza verrà visualizzata in elenchi associati a ciascuno di questi prodotti in AppSource.
...
Caricare la brochure di marketing che descrive l'offerta del servizio di consulenza in modo dettagliato. In alternativa, è possibile caricare anche la presentazione dell'azienda, schede informative o case study. Assicurarsi che nei documenti vengano usati i nomi correnti dei prodotti presentati e che non siano riportati prodotti concorrenti di Microsoft.
