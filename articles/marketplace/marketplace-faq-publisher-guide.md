...
Per altre informazioni, vedere [Cloud Solution Provider](cloud-solution-providers.md).
...
Per consultare l'elenco delle località, passare a [Dettagli sulle imposte per gli autori del marketplace commerciale](/partner-center/tax-details-marketplace?context=/azure/marketplace/context/context).
...
Per consultare l'elenco delle valute, passare a [Disponibilità geografica e supporto delle valute per il marketplace commerciale](marketplace-geo-availability-currencies.md).
...
Per ulteriori informazioni, vedere [Soglie, metodi e periodi di pagamento](/partner-center/payment-thresholds-methods-timeframes?context=/azure/marketplace/context/context).
...
Per consultare l'elenco completo delle località, passare a [Dettagli sulle imposte per gli autori del marketplace commerciale](/partner-center/tax-details-marketplace?context=/azure/marketplace/context/context).
...
Per altre informazioni, vedere [istruzioni di pagamento](/partner-center/payout-statement?context=/azure/marketplace/context/context).
...
Per altre informazioni, vedere [configurare l'account di pagamento e i moduli fiscali](/partner-center/set-up-your-payout-account?context=/azure/marketplace/context/context).
...
- Informazioni e istruzioni per partecipare al [programma Insider del marketplace commerciale di Microsoft](https://www.microsoftpartnercommunity.com/t5/Microsoft-AppSource-and-Azure/Commercial-Marketplace-Insiders-Program/td-p/13743).
...
- [Documentazione di Gestione dei costi e fatturazione di Azure](../cost-management-billing/index.yml)
- [Informazioni sugli addebiti per i servizi esterni di Azure](../cost-management-billing/understand/understand-azure-marketplace-charges.md)
- [Pagare la sottoscrizione di Azure tramite fattura](../cost-management-billing/manage/pay-by-invoice.md)
...
- [Documentazione di Azure per enti pubblici](../azure-government/index.yml)
- [Marketplace di Azure per enti pubblici](../azure-government/documentation-government-manage-marketplace.md)
- [Conformità di Azure per enti pubblici](../azure-government/documentation-government-plan-compliance.md)
