...
- Un account aziendale o dell'istituto di istruzione. Se non si ha un account aziendale o dell'Istituto di istruzione, seguire il collegamento "iscriversi per ottenere un account gratuito" durante il processo di acquisto.

- Una carta di credito valida nel paese/area geografica in cui si acquista l'offerta.

    > [!Note]
    > Il paese di fatturazione della carta di credito potrebbe essere bloccato nel percorso dell'istanza di Azure Active Directory.
