...
* In primo luogo, se si dispone di un'offerta TRIAL o TRANSACTION, è possibile utilizzare il vantaggio "promozione di categoria" attraverso i vantaggi del [mercato commerciale](https://docs.microsoft.com/azure/marketplace/gtm-your-marketplace-benefits).
...
1. *Assicurati che l'app o il servizio sia categorizzato*in modo appropriato: scegli tre categorie che rappresentano le funzionalità dell'app o del servizio.
