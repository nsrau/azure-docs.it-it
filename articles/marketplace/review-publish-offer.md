...
3. Nella scheda **Panoramica** , in **offerte**, uno degli indicatori di stato seguenti viene visualizzato nella colonna **stato** per ogni offerta.
...
| Approvazione del server di pubblicazione | Ti invieremo un messaggio di posta elettronica con una richiesta per visualizzare in anteprima e approvare l'offerta. |
...
### <a name="to-preview-your-offer-and-sign-off"></a>Per visualizzare in anteprima l'offerta e disconnettersi
...
### <a name="reporting-usage-of-preview-and-other-internal-usage"></a>Segnalazione dell'utilizzo dell'anteprima e di altri utilizzi interni
