...
5. Integrazione di AAD e sponsorizzazione di sviluppo e test: si viene esclusi quando si passa in tempo reale con una transactable (distribuibile e fatturabile offerta). Vedere la sezione successiva per informazioni su come iniziare a usare i vantaggi go-to-market.
...
|:--- |:--- |
| AppSource |  Partner Microsoft Gold <br> Transact offerte – premi di Marketplace <br> Versione di valutazione delle app |
| Azure Marketplace | Transact offerte – premi di Marketplace <br> Offerte di valutazione |
...
## <a name="marketplace-rewards-for-transact-partners"></a>Premi di Marketplace per i partner transact

L'elenco completo dei vantaggi premi marketplace può essere visualizzato nei [programmare diapositive riepilogo](https://onedrive.live.com/view.aspx?resid=1900675C97CA6FE0!630&ithint=file%2cpptx&authkey=!APQ6LSnDenx2FKM).
