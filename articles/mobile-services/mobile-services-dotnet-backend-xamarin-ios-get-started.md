---
title: Introduzione a Servizi mobili per app per Xamarin iOS | Microsoft Docs
...
> [!NOTE]
> È possibile esaminare il codice che accede al servizio mobile per eseguire una query e inserire i dati nel file QSTodoService.cs C#.
> 
> 
