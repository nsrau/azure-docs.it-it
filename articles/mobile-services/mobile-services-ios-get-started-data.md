...
2. Nel portale di gestione di Azure fare clic su **Servizi mobili** e quindi sul servizio mobile in questione. Fare clic sulla scheda **Dati** e quindi su **Sfoglia**. Si noti che la tabella **TodoItem** ora contiene dati, con valori ID generati da Servizi mobili, e che alla tabella sono state aggiunte automaticamente colonne per garantire la corrispondenza con la classe TodoItem nell'app.
