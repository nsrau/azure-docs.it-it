...
4. Immettere un valore univoco per **Nome visualizzato** per l'app, scegliere **Apps for Pages** in **Category**, quindi fare clic su **Create App ID** e infine completare l'esercizio relativo alla sicurezza.
