---
title: Introduzione a Servizi mobili per app JavaScript di Windows Store - Servizi mobili di Azure
...
5. Tornare al [portale di Azure classico], fare clic sulla scheda **Dati** e quindi sulla tabella **TodoItem**.
   
       In questo modo sarà possibile visualizzare i dati inseriti nella tabella dall'app.

> [!NOTE]
> È possibile esaminare il codice che accede al servizio mobile per eseguire una query e inserire i dati, disponibile nel file default.js.
> 
> 
