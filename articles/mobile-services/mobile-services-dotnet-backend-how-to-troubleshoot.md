---
title: Risolvere i problemi del back-end .NET di Servizi mobili | Microsoft Docs
...
> [!NOTE]
> Servizi mobili è attualmente compatibile solo con ASP.NET 5.1, mentre ASP.NET 5.2 non è attualmente supportato. L'aggiornamento dei pacchetti NuGet ASP.NET alla versione 5.2.* può generare un errore dopo la distribuzione.
> 
> 
