---
title: Creare un servizio mobile back-end .NET che usa l'archiviazione tabelle | Microsoft Docs
...
1. Modificare il tipo di dati **TodoItem** in modo che derivi da **StorageData** invece di **EntityData**, come illustrato di seguito.
   ...
   > [!NOTE]
   > Il tipo **StorageData** ha una proprietà ID che richiede una chiave composta, ovvero una stringa con formato *partitionId*,*rowValue*.
   > 
   > 
...
4. Sostituire il metodo **GetAllTodoItems** esistente con il codice seguente.
...
2. Eseguire l'app client introduttiva connessa al servizio mobile.
...
3. Aggiungere nuovi elementi per generare le modifiche del database.
