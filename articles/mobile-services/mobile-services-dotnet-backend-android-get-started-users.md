---
title: Introduzione all'autenticazione (Android) | Microsoft Docs
...
> Per la versione equivalente di questo argomento per le app per dispositivi mobili, vedere [Aggiungere l'autenticazione all'app Android](../app-service-mobile/app-service-mobile-android-get-started-users.md).
> 
> 
...
1. Aprire il progetto creato dopo avere completato l'esercitazione [Introduzione a Servizi mobili].
2. Nel menu **Run** fare clic su **Run app** per eseguire l'app e verificare che dopo l'avvio dell'app venga generata un'eccezione non gestita con codice di stato 401 (Non autorizzato).
