...
13. (Facoltativo) Nel [portale di Azure classico] selezionare il servizio mobile, fare clic su **Configura** > **Database SQL**. Verrà visualizzata la pagina del database SQL per il database del servizio mobile.
