---
title: Aggiungere notifiche push all'app di Servizi mobili (Xamarin.iOS) - Servizi mobili
...
> Per la versione equivalente di questo argomento per le app per dispositivi mobili, vedere [Aggiungere notifiche push all'app Xamarin.iOS](../app-service-mobile/app-service-mobile-xamarin-ios-get-started-push.md).
> 
> 
...
> [!IMPORTANT]
> Considerati i requisiti di configurazione del servizio APN, è necessario distribuire e testare le notifiche push su un dispositivo con iOS (iPhone o iPad) anziché su un emulatore.
> 
> 
...
8. In **QSTodoListViewController** modificare l'azione **OnAdd** in modo da ottenere il token del dispositivo archiviato in **AppDelegeate** e archiviarlo nell'elemento **TodoItem** aggiunto.
