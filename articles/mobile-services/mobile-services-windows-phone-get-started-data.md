---
title: Aggiungere Servizi mobili a un'app esistente (WP8) | Microsoft Docs
...
7. Nel file MainPage.cs aggiungere le istruzioni `using` seguenti o rimuovere il relativo commento:
   
           using Microsoft.WindowsAzure.MobileServices;
        using Newtonsoft.Json;
8. In questa cartella DataModel, sostituire la definizione della classe **TodoItem** con il codice seguente:
