---
title: Aggiungere notifiche push all'app per piattaforma UWP 8.1 | Microsoft Docs
...
> [!NOTE]
> È anche possibile semplificare il codice generato unendo le definizioni con wrapping `#if...#endif` [MobileServiceClient](http://msdn.microsoft.com/library/azure/microsoft.windowsazure.mobileservices.mobileserviceclient.aspx) in un'unica definizione senza wrapping usata da entrambe le versioni dell'app.
> 
> 
...
> [!NOTE]
> Non usare mai un servizio mobile di produzione per operazioni di test e sviluppo. Pubblicare sempre il proprio progetto di servizio mobile in un ambiente di gestione temporanea per i test.
> 
> 
