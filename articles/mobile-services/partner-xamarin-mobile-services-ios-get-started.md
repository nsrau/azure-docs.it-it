...
5. In **Download and run app** fare clic su **Download**.
    ...
    Verrà scaricato il progetto per l'applicazione di esempio *To do list* connessa al servizio mobile e si farà riferimento al componente Servizi mobili di Azure per Xamarin.iOS. Salvare il file del progetto compresso nel computer locale e prendere nota del percorso.
...
3. Nell'app digitare un testo significativo, ad esempio *Complete the tutorial*, quindi fare clic sull'icona con il segno PIÙ (**+**).
   ...
   > 
   > 
4. Tornare al [portale di Azure classico], fare clic sulla scheda **Dati** e quindi sulla tabella **TodoItems**.
