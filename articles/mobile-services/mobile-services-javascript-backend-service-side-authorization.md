---
title: Autorizzazione sul lato servizio degli utenti in un servizio mobile back-end di JavaScript | Microsoft Docs
...
2. Fare clic su **Script**, selezionare l’operazione **Inserisci**, sostituire lo script esistente con la funzione seguente, quindi fare clic su **Salva**.
   ...
   > [!NOTE]
   > Assicurarsi che [lo schema dinamico](https://msdn.microsoft.com/library/azure/jj193175.aspx) sia abilitato. In caso contrario, la colonna *userId* non verrà aggiunta automaticamente. Questa opzione è abilitata per impostazione predefinita per un nuovo servizio mobile.
   > 
   > 
