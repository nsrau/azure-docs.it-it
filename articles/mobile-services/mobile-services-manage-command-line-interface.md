---
title: Amministrazione di un servizio mobile dalla riga di comando | Microsoft Docs
...
> [!NOTE]
> È possibile usare i comandi nell'interfaccia da riga di comando correlati a "list" e "script" solo con il back-end JavaScript.
> 
> 
