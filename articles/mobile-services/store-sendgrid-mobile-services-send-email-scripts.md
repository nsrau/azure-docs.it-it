---
title: Invio di posta elettronica utilizzando SendGrid | Microsoft Docs
...
5. Sostituire i segnaposto nello script precedente con i valori corretti:
   ...
   * ***username* e *password***: le credenziali di SendGrid identificate in [Creare un account SendGrid].
