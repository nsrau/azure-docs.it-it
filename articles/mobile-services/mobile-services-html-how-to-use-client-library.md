---
title: Come usare un client HTML con i Servizi mobili di Azure | Microsoft Docs
...
> [!NOTE]
> Quando si usa l'autenticazione in un'app PhoneGap o Cordova, è anche necessario aggiungere al progetto i plug-in seguenti:
> 
