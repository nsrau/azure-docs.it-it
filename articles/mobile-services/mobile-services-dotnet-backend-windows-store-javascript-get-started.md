...
<li><p>Nell'app digitare un testo significativo, ad esempio <em>Complete the tutorial</em>, in <strong>Insert a TodoItem</strong>, quindi fare clic su <strong>Save</strong>.</p>
