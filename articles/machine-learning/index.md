...
Informazioni su come data scientist e sviluppatori usano Machine Learning per integrare analisi predittive nelle applicazioni. Esercitazioni, video e modelli di esempio in cui viene illustrato come creare e distribuire modelli di machine learning.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni su Azure Machine Learning</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introduzione alla creazione di un esperimento di Azure Machine Learning</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/machine-learning/machine-learning-web-service-error-codes">Codici di errore del servizio Web</a></p>
                    </div>
                </div>
            </div>
        </div>
