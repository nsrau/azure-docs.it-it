...
Azure Machine Learning fornisce gli strumenti per modellare l'analisi predittiva e un servizio completamente gestito che può essere usato per distribuire i modelli predittivi come servizi Web pronti all'uso.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p>Riferimenti all'API REST di Machine Learning</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Net#</h3>
                        <p>Informazioni di riferimento sul linguaggio delle reti neurali Net#</p>
                    </div>
                </div>
            </div>
        </div>
