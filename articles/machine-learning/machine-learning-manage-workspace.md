...
> [AZURE.TIP] Nella scheda **WEB SERVICES** (SERVIZI WEB) di Azure Machine Learning Studio è possibile aggiungere, aggiornare o eliminare un servizio Web di Machine Learning.
