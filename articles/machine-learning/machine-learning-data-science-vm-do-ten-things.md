...
#### <a name="build-a-model-in-r-and-publish-it-in-azure-ml"></a>Compilare un modello in R e pubblicarlo in Azure ML
    library(AzureML)
...
#### <a name="consume-the-model-deployed-in-azure-ml"></a>Utilizzare il modello distribuito in Azure ML
