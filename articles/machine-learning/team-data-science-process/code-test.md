...
3. Inserire il codice del progetto nel repository di codice del progetto di VSTS: 
...
6. Inserire tutte le funzioni di test in uno script Python denominato **test_funcs.py**:

    ![Script Python per le funzioni di test](./media/code-test/create_file_test_func.PNG)


7. Dopo aver preparato i codici di test, è possibile configurare l'ambiente di test in Visual Studio.
...
8. I test possono essere individuati automaticamente se si inserisce **codetest.testCase** dopo il nome della classe. Aprire Esplora test nel riquadro di destra e selezionare **Esegui tutto**. Tutti i test verranno eseguite in sequenza e verrà indicato se il test ha esito positivo o negativo.

    ![Esecuzione dei test](./media/code-test/run_tests.PNG)

9. Archiviare il codice nel repository del progetto usando i comandi GIT. Le ultime operazioni eseguite verranno visualizzate in Visual Studio Team Services.
...
10. Configurare la compilazione automatica e il test in Visual Studio Team Services:
