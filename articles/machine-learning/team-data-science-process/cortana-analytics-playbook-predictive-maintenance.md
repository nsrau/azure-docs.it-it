...
Per i dati statici
- _Record di manutenzione_: i dati di manutenzione non elaborati contengono un identificatore dell'asset e un timestamp con informazioni sulle attività di manutenzione che sono state eseguite in un determinato momento. Trasformare le attività di manutenzione in colonne _categoriche_, in cui ogni descrittore di categoria è associato in modo univoco a una specifica azione di manutenzione. Lo schema per i record di manutenzione includerà l'identificatore dell'asset, l'ora e le azioni di manutenzione.
...
| ID asset | Tempo | \<Colonne di funzionalità > | Etichetta |
| ---- | ---- | --- | --- |
| A123 |Giorno 1 | . . . | . |
| A123 |Giorno 2 | . . . | . |
| ...  |...   | . . . | . |
...
- _Guasti delle porte dei treni_: Per X è possibile scegliere un intervallo di due giorni.
- _Guasti di turbine eoliche_: Per X è possibile scegliere un intervallo di due mesi.
