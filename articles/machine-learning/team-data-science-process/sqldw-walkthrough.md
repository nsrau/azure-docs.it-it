...
1. **Classificazione binaria**: per stimare se è stata pagata o meno una mancia per una corsa, ovvero un *importo di\_Tip* maggiore di $0 è un esempio positivo, mentre un *\_suggerimento* di $0 è un esempio negativo.
...
* **Nome server**: \<nome del server>. database.Windows.NET
* **Nome SQLDW (database)**
* **Nome utente**
* **Password**
