---
title: Eseguire il training e distribuire un modello di apprendimento per rinforzo.
titleSuffix: Azure Machine Learning
description: Informazioni su come usare Reinforcement Learning (RL) di Azure Machine Learning per eseguire il training di un agente RL in modo che giochi a Pong.
...
Questo articolo si basa sull'[esempio RLlib Pong](https://aka.ms/azureml-rl-pong) disponibile nel [repository GitHub](https://aka.ms/azureml-rl-notebooks) del notebook di Azure Machine Learning.
...
Eseguire questo codice in uno degli ambienti seguenti. Si consiglia di provare l'istanza di calcolo di Azure Machine Learning per un'esperienza di avvio più rapida. I notebook di esempio per il rinforzo sono disponibili per una rapida clonazione ed esecuzione in istanze di calcolo di Azure Machine Learning.
 ...
 - Server Jupyter Notebook personale
    ...
    - Installare [Azure Machine Learning SDK](https://docs.microsoft.com/python/api/azureml-contrib-reinforcementlearning/?view=azure-ml-py): `pip install --upgrade azureml-contrib-reinforcementlearning`
...
In questa sezione si apprenderà come usare il [ReinforcementLearningEstimator](https://docs.microsoft.com/python/api/azureml-contrib-reinforcementlearning/azureml.contrib.train.rl.reinforcementlearningestimator?view=azure-ml-py) per inviare un processo di training ad Azure Machine Learning.
...
L'oggetto [Run](https://docs.microsoft.com/python/api/azureml-core/azureml.core.run(class)?view=azure-ml-py) gestisce la cronologia di esecuzione dei processi in corso o completati. 
...
In questo articolo si è appreso come eseguire il training di un agente di apprendimento per rinforzo usando un agente di apprendimento IMPALA. Per altri esempi, vedere il [repository GitHub Azure Machine Learning Reinforcement Learning](https://aka.ms/azureml-rl-notebooks).
