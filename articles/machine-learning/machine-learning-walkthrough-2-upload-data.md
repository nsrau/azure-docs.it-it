---
title: 'Passaggio 2: Caricare dati in un esperimento di Machine Learning | Microsoft Docs'
...
- - -
Per sviluppare un modello predittivo per il rischio di credito, abbiamo bisogno di dati da usare per eseguire il training del modello e quindi testare il modello. Per questa procedura verrà usato il set di dati "UCI Statlog (German Credit Data) Data Set" da UCI Machine Learning Repository, disponibile al seguente indirizzo:  
...
2. Fare clic sulla scheda **Studio** nella parte superiore della finestra.
...
> [!TIP]
> Per gestire i set di dati che sono stati caricati in Studio, fare clic sulla scheda **SET DI DATI** a sinistra della finestra di Studio.
> 
> 
