...
---
# <a name="deploy-and-azure-machine-learning-model-to-an-azure-iot-edge-device"></a>Distribuire un modello di Azure Machine Learning in un dispositivo Azure IoT Edge
...
Rendere operativo il modello seguendo le istruzioni in [Distribuzione di un modello di Machine Learning come un servizio Web](https://docs.microsoft.com/en-us/azure/machine-learning/preview/model-management-service-deploy) per creare un'immagine Docker con il modello.
