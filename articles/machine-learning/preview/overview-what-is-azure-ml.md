...
Oltre ad Azure Machine Learning, sono disponibili diverse opzioni in Azure per la compilazione, la distribuzione e la gestione di modelli di Machine Learning. [Altre informazioni in proposito sono disponibili qui.](overview-more-machine-learning.md)
