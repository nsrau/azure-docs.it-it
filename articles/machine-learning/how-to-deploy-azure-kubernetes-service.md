...
Se si dispone già del cluster AKS nella sottoscrizione di Azure ed è la versione 1,16 o una versione precedente, è possibile usarla per distribuire l'immagine.
