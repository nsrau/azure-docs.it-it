---
title: Accedere a set di dati mediante la libreria client Python di Azure Machine Learning | Microsoft Docs
...
9. Selezionare il frammento di codice dalla finestra che viene visualizzata e copiarlo negli Appunti.
   
    ![Codice di accesso][intermediate-dataset-access-code]
10. Incollare il codice nel blocco appunti.
    
     ![Blocco appunti][ipython-intermediate-dataset]
11. È possibile visualizzare i dati usando matplotlib. In questo caso, viene creato un istogramma per la colonna dell'età.
