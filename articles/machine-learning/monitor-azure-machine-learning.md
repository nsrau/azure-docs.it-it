...
> [!TIP]
> Le informazioni contenute in questo documento sono destinate principalmente agli amministratori, come descritto nel monitoraggio del Azure Machine Learning. Se si è un esperto di dati o uno sviluppatore e si desidera monitorare le informazioni specifiche per le esecuzioni di training del modello, vedere i documenti seguenti:
>
...
> * [Tenere traccia degli esperimenti con MLflow](how-to-use-mlflow.md)
