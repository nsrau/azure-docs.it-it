...
### [Configurare le macchine virtuali](machine-learning-data-science-virtual-machines.md)
...
#### [Creare](machine-learning-create-workspace.md)
#### [Gestire](machine-learning-manage-workspace.md)
#### [Risolvere i problemi](machine-learning-troubleshooting-creating-ml-workspace.md)
#### [Eseguire la distribuzione usando ARM](machine-learning-deploy-with-resource-manager-template.md)
#### [Creare un'altra area](machine-learning-multi-geo.md)

## Analizzare le esigenze aziendali
### [Esigenze tecniche](machine-learning-data-science-plan-your-environment.md)
### [Identificare lo scenario](machine-learning-data-science-plan-sample-scenarios.md)

## Acquisire e comprendere dati
...
#### Dati di esempio
##### [Panoramica](machine-learning-data-science-sample-data.md)
...
#### [Selezione delle funzioni TDSP](machine-learning-data-science-select-features.md)
...
#### [Preparare la distribuzione](machine-learning-convert-training-experiment-to-scoring-experiment.md)
...
#### [Ridimensionamento](machine-learning-scaling-webservice.md)
...
#### [Usare un pool di Batch](machine-learning-dedicated-capacity-for-bes-jobs.md)
...
## [Informazioni di riferimento sulle API REST](/rest/api/machinelearning)
## [Codici di errore del servizio Web](machine-learning-web-service-error-codes.md)
...
## Soluzioni partner di Cortana Intelligence
### [Guida alla pubblicazione di Cortana Intelligence](cortana-intelligence-appsource-publishing-guide.md)
### [Strumento di valutazione delle soluzioni di Cortana Intelligence](cortana-intelligence-appsource-evaluation-tool.md)

## Cortana Analytics
### API
#### [Rilevamento anomalie](machine-learning-apps-anomaly-detection-api.md)
