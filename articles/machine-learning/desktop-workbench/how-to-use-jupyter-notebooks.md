...
In Azure Machine Learning Workbench è possibile accedere ai notebook tramite la scheda **Notebooks** (Notebook). Il progetto di esempio di _classificazione di Iris_ include un blocco appunti di esempio `iris.ipynb`.
