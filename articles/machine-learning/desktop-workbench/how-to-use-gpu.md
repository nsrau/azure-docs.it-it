...
Aprire il file `my_dsvm.compute`. Modificare `baseDockerImage` in `microsoft/mmlspark:plus-gpu-0.9.9` e aggiungere una nuova riga `nvidiaDocker: true`. Il file presenterà quindi le due righe seguenti:
