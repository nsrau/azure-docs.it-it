...
In questo articolo si apprende come usare Azure Machine Learning Package per la Visione artificiale (AMLPCV) per sottoporre a training, testare e distribuire un modello di classificazione delle immagini. Per una panoramica di questo pacchetto e la relativa documentazione di riferimento dettagliata, [vedere qui](https://aka.ms/aml-packages/vision).
