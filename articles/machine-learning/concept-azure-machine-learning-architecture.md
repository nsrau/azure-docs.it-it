...
1. **Eseguire il training**
    + Sviluppare script di training di Machine Learning in **Python**, **R**o con la finestra di progettazione visiva.
    + Creare e configurare una **destinazione di calcolo**.
    + **Inviare gli script** a una destinazione di calcolo configurata per l'esecuzione in tale ambiente. Durante il training, gli script possono leggere o scrivere negli **archivi dati**. I log e l'output generati durante il training vengono salvati come **esecuzioni** nell' **area di lavoro** e raggruppati in **esperimenti**.
...
+ Automatizzare le attività di Machine Learning con l'interfaccia della riga di comando [Azure Machine Learning](https://docs.microsoft.com/azure/machine-learning/reference-azure-machine-learning-cli).
...
* [Area di lavoro](#workspaces)
    ...
    * [Endpoint](#endpoints)
        ...
        * [Moduli delle cose](#iot-module-endpoints)
...
* Esegui il [training e la registrazione dei modelli di Chainer su larga scala con Azure Machine Learning](how-to-train-ml-models.md).
...
Per altre informazioni, vedere [creare e registrare Azure Machine Learning set](how-to-create-register-datasets.md)di dati.  Per altri esempi di uso dei set di impostazioni, vedere i [notebook di esempio](https://github.com/Azure/MachineLearningNotebooks/tree/master/how-to-use-azureml/work-with-data/datasets-tutorial).
