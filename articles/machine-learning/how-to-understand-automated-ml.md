...
In questo articolo viene illustrato come visualizzare e valutare i risultati degli esperimenti automatici di Machine Learning, Automated ML. Questi esperimenti sono costituiti da più esecuzioni, in cui ogni esecuzione crea un modello. Per semplificare la valutazione di ogni modello, Machine Learning Machine Learning genera automaticamente le metriche delle prestazioni e i grafici specifici del tipo di esperimento. 

Ad esempio, l'automazione di Machine Learning fornisce grafici diversi per i modelli di classificazione e regressione. 
...
Per gli esperimenti SDK, è possibile visualizzare gli stessi risultati durante un'esecuzione quando si usa il `RunDetails` [widget Jupyter](/python/api/azureml-widgets/azureml.widgets?preserve-view=true&view=azure-ml-py).
...
La tabella seguente riepiloga le metriche delle prestazioni del modello calcolate da Machine Learning Machine Learning per ogni modello di classificazione generato per l'esperimento. 
...
Un modello con prestazioni migliori avrà una curva di accuratezza superiore nel grafico e ulteriormente dalla linea di base. 
...
La tabella seguente riepiloga le metriche delle prestazioni del modello calcolate da Machine Learning Machine Learning per ogni modello di regressione o previsione generato per l'esperimento. 
...
### <a name="what-does-a-good-model-look-like"></a>Qual è l'aspetto di un modello valido?
Questo grafico può essere usato per misurare le prestazioni di un modello in quanto più vicino alla riga y = x i valori stimati sono, migliori sono le prestazioni di un modello predittivo.

#### <a name="example-1-a-regression-model-with-low-performance"></a>Esempio 1: modello di regressione con prestazioni ridotte
...
#### <a name="example-2-a-regression-model-with-high-performance"></a>Esempio 2: modello di regressione con prestazioni elevate
...
#### <a name="example-2-a-regression-model-with-a-more-even-distribution-of-errors"></a>Esempio 2: modello di regressione con una distribuzione più uniforme degli errori
