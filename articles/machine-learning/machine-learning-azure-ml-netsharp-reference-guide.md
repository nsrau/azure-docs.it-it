...
description: Sintassi del linguaggio per la specifica Net# delle reti neurali ed esempi sulla creazione di un modello di rete neurale personalizzato in Microsoft Azure ML tramite Net#
