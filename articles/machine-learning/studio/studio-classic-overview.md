...
Per altre informazioni di riferimento sull'ampia libreria di algoritmi di Machine Learning disponibili, vedere [Come scegliere gli algoritmi per Microsoft Machine Learning Studio (versione classica)](algorithm-choice.md).
