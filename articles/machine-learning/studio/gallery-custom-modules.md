---
title: Moduli personalizzati di Azure AI Gallery - Azure Machine Learning Studio | Microsoft Docs
description: Scoprire moduli personalizzati di Machine Learning in Azure AI Gallery. I moduli personalizzati espandono le funzionalità di Azure Machine Learning Studio.
...
ms.locfileid: "53273197"
---
# <a name="machine-learning-studio-discover-custom-machine-learning-modules-in-azure-ai-gallery"></a>Machine Learning Studio: Scoprire moduli personalizzati di Machine Learning in Azure AI Gallery

[Azure AI Gallery](http://gallery.cortanaintelligence.com) offre numerosi [moduli personalizzati](https://gallery.cortanaintelligence.com/customModules) che espandono le funzionalità di Azure Machine Learning Studio. È possibile importare questi moduli per usarli nei propri esperimenti e sviluppare così soluzioni di analisi predittiva ancora più avanzate.
...
![Selezionare Moduli personalizzati dalla home page di Gallery](./media/gallery-custom-modules/select-custom-modules-in-gallery.png)
...
![Selezionare "Visualizza tutto" per visualizzare tutti i moduli personalizzati](./media/gallery-custom-modules/click-see-all-for-all-custom-modules.png)
...
Azure AI Gallery offre due modi per importare la copia di un modulo:
...
2. Selezionare **Apri in Studio**.
    ...
    ![Aprire il modulo personalizzato da Gallery](./media/gallery-custom-modules/open-custom-module-from-gallery.png)
...
3. Spostare il mouse sopra un modulo, quindi selezionare **Importa modulo**. Per ottenere informazioni sul modulo, selezionare **Visualizza in Gallery**. Verrà aperta la pagina di dettagli del modulo in Gallery.
    ...
    ![Importare un modulo personalizzato in Machine Learning Studio](./media/gallery-custom-modules/add-custom-module-in-studio.png)
...
2. Per espandere l'elenco di moduli personalizzati nell'area di lavoro, selezionare **Personalizzato** nella tavolozza dei moduli. La tavolozza si trova a sinistra dell'area di disegno dell'esperimento.
    ...
    ![Elenco di moduli personalizzati nella tavolozza di Studio](./media/gallery-custom-modules/custom-module-in-studio-palette.png)
