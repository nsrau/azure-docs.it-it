---
title: Notebook di Jupyter in Azure AI Gallery - Azure Machine Learning Studio | Microsoft Docs
description: Scoprire notebook Jupyter in Azure AI Gallery. I notebook in Cortana Intelligence Gallery offrono esercitazioni e spiegazioni dettagliate su tecniche e soluzioni avanzate di apprendimento automatico.
...
ms.locfileid: "53268224"
---
# <a name="discover-jupyter-notebooks-in-the-azure-ai-gallery"></a>Scoprire notebook Jupyter in Azure AI Gallery

I **[notebook di Jupyter](https://gallery.cortanaintelligence.com/notebooks)** in [Azure AI Gallery](http://gallery.cortanaintelligence.com) includono codice, visualizzazioni di dati e documentazione in un'unica area di disegno interattiva.
...
## <a name="discover"></a>Scoprire
  Per cercare i blocchi appunti disponibili in Gallery, aprire [Gallery](http://gallery.cortanaintelligence.com) e fare clic su **Blocchi appunti** nella parte superiore della pagina principale di Gallery.

 Nella pagina **[Jupyter Notebooks](https://gallery.cortanaintelligence.com/notebooks)** (Blocchi appunti di Jupiter) è disponibile l'elenco dei blocchi appunti più comuni.
...
3. Selezionare l'area geografica e l'area di lavoro da usare
    ...
    ![Aprire notebook di Jupyter da Gallery](./media/gallery-jupyter-notebooks/open-notebook-from-gallery.png)
...
3. Posizionare il puntatore del mouse su un notebook e selezionare **Open Notebook** (Apri notebook)
    ...
    ![Aprire un notebook di Gallery da Machine Learning Studio](./media/gallery-jupyter-notebooks/open-notebook-from-studio.png)
