---
title: 'Passaggio 4: Eseguire il training di modelli analitici predittivi - Azure Machine Learning Studio | Microsoft Docs'
description: 'Passaggio 4 della procedura dettagliata sullo sviluppo di una soluzione predittiva: eseguire il training, classificare e valutare più modelli in Azure Machine Learning Studio.'
...
ms.locfileid: "53254514"
---
# <a name="walkthrough-step-4-train-and-evaluate-the-predictive-analytic-models-in-machine-learning-studio"></a>Passaggio 4 della procedura dettagliata: Eseguire il training e valutare i modelli analitici predittivi in Machine Learning Studio
Questo argomento contiene il quarto passaggio della procedura dettagliata [Sviluppare una soluzione di analisi predittiva in Azure Machine Learning](walkthrough-develop-predictive-solution.md)

1. [Creare un'area di lavoro di Machine Learning Studio](walkthrough-1-create-ml-workspace.md)
...
3. Connettere l'output del modulo [Execute R Script][execute-r-script] (Esegui script R) a sinistra alla porta di input destra del modulo [Train Model][train-model] (Training modello). Nel [Passo 3](walkthrough-3-create-new-experiment.md) di questa procedura dettagliata è stato deciso di utilizzare i dati riportati a sinistra del modulo Split Data (Divisione dati) per il training.
...
- - -
**Passaggio successivo: [Distribuire il servizio Web](walkthrough-5-publish-web-service.md)**
