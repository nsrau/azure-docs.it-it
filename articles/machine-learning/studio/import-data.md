...
Il modulo **Import data** di Azure Machine Learning Studio supporta le origini dati seguenti:
...
| Provider di feed di dati |Legge dati da un provider di feed supportato. È attualmente supportato solo il formato OData (Open Data Protocol). |<b>Data content type</b> (Tipo di contenuto dei dati): specifica il formato OData.<br/><br/><b>Source URL</b> (URL di origine): specifica l'URL completo per il feed di dati. <br/>Ad esempio, il seguente URL legge dal database di esempio Northwind: https://services.odata.org/northwind/northwind.svc/ |
