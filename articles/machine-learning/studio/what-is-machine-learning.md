 ...
 * [Distribuire i servizi Web](publish-a-machine-learning-web-service.md)
 * [Ripetere il training dei modelli tramite le API](retrain-models-programmatically.md)
 * [Gestire gli endpoint di servizio Web](create-endpoint.md)
 * [Ridimensionare un servizio Web](scaling-webservice.md)
 * [Utilizzare i servizi Web](consume-web-services.md)
