...
Per la documentazione sulla fatturazione dei servizi Web e del piano di impegno, vedere le [informazioni di riferimento sull'API REST di Azure Machine Learning](https://docs.microsoft.com/en-us/rest/api/machinelearning/). 
