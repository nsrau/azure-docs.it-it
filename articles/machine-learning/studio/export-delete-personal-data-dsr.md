...
ms.locfileid: "79251687"
---
# <a name="export-and-delete-in-product-user-data-from-azure-machine-learning-studio-classic"></a>Esportare ed eliminare i dati utente all'in-product da Azure Machine Learning Studio (classico)Export and delete in-product user data from Azure Machine Learning Studio (classic)

[!INCLUDE [Notebook deprecation notice](../../../includes/aml-studio-notebook-notice.md)]

È possibile eliminare o esportare i dati all'in-product archiviati da Azure Machine Learning Studio (classico) usando il portale di Azure, l'interfaccia di Studio (classica), PowerShell e le API REST autenticate. Questo articolo descrive come esportare o eliminare i dati. 
...
Esistono due tipi di dati utente in Machine Learning Studio (classico):There are two kinds of user data in Machine Learning Studio (classic):
...
## <a name="studio-classic-account-types-and-how-data-is-stored"></a>Tipi di account Studio (classici) e modalità di archiviazione dei dati

Esistono tre tipi di account in Machine Learning Studio (classico). Il tipo di account di cui si dispone determina la modalità di archiviazione dei dati e la procedura per eliminarli o esportarli.
...
## <a name="delete-workspace-data-in-studio-classic"></a><a name="delete"></a>Eliminare i dati dell'area di lavoro in Studio (classico)Delete workspace data in Studio (classic) 
...
![Eliminare risorse in Machine Learning Studio (classico)Delete assets in Machine Learning Studio (classic)](./media/export-delete-personal-data-dsr/delete-studio-asset.png)
...
![Eliminare un'area di lavoro gratuita in Machine Learning Studio (classico)Delete a free workspace in Machine Learning Studio (classic)](./media/export-delete-personal-data-dsr/delete-studio-data-workspace.png)
 
## <a name="export-studio-classic-data-with-powershell"></a>Esportare i dati di Studio (classici) con PowerShellExport Studio (classic) data with PowerShell
Usare PowerShell per esportare tutte le informazioni in un formato portatile da Azure Machine Learning Studio (classico) usando i comandi. Per informazioni, vedere l'articolo [Modulo di PowerShell per Azure Machine Learning Studio (classico).](powershell-module.md)

## <a name="next-steps"></a>Passaggi successivi

Per la documentazione relativa ai servizi Web e alla fatturazione del piano di impegno, vedere [Azure Machine Learning Studio (classico) Informazioni di riferimento sull'API REST.](https://docs.microsoft.com/rest/api/machinelearning/) 
