...
> [!TIP]
> Se non si è certi delle esigenze di memoria, CPU o GPU della distribuzione, è possibile usare la profilatura per apprendere queste informazioni. Per ulteriori informazioni, vedere [How and where to deploy a Model](how-to-deploy-and-where.md#prepare-to-deploy).
