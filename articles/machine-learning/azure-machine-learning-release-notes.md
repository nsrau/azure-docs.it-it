...
+ **Correzioni di bug e miglioramenti**
  ...
  + **azureml-core**
    ...
    + Il cliente può usare il servizio collegato SDK per collegare l'area di lavoro sinapsi all'area di lavoro AML. Sono supportate le operazioni CRUD.
