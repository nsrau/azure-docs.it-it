...
description: Informazioni su come attivare l'esecuzione di una pipeline di Azure Machine Learning usando app per la logica di Azure per rispondere ai nuovi dati.
