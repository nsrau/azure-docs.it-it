...
## <a name="a-namescenarioathe-scenario"></a><a name="scenario"></a>Scenario
...
## <a name="a-nameupload-dataa-upload-the-data-to-your-on-premise-sql-server"></a><a name="upload-data"></a> Caricare i dati sul SQL Server locale
...
## <a name="a-namecreate-adfa-create-an-azure-data-factory"></a><a name="create-adf"></a> Creare un data factory di Azure
...
## <a name="a-nameadflinkedservicesacreate-linked-services-to-connect-to-the-data-resources"></a><a name="adflinkedservices"></a>Creare servizi collegati per connettersi alle risorse di dati
...
### <a name="a-nameadf-linked-service-onprem-sqlalinked-service-for-on-premise-sql-server-database"></a><a name="adf-linked-service-onprem-sql"></a>Servizio collegato per il database SQL Server locale
...
### <a name="a-nameadf-linked-service-blob-storealinked-service-for-blob"></a><a name="adf-linked-service-blob-store"></a>Servizi collegati per BLOB
...
### <a name="a-nameadf-linked-service-azure-sqlalinked-service-for-azure-sql-database"></a><a name="adf-linked-service-azure-sql"></a>Servizio collegato per il database SQL Azure
...
## <a name="a-nameadf-tablesadefine-and-create-tables-to-specify-how-to-access-the-datasets"></a><a name="adf-tables"></a>Definire e creare tabelle per specificare la modalità di accesso al set di dati
...
### <a name="a-nameadf-table-onprem-sqlasql-on-premise-table"></a><a name="adf-table-onprem-sql"></a>Tabella SQL locale
...
### <a name="a-nameadf-table-blob-storeablob-table"></a><a name="adf-table-blob-store"></a>Tabella BLOB
...
### <a name="a-nameadf-table-azure-sqasql-azure-table"></a><a name="adf-table-azure-sq"></a>Tabella SQL Azure
...
## <a name="a-nameadf-pipelineadefine-and-create-the-pipeline"></a><a name="adf-pipeline"></a>Definire e creare la pipeline
...
## <a name="a-nameadf-pipeline-startastart-the-pipeline"></a><a name="adf-pipeline-start"></a>Avviare la pipeline
