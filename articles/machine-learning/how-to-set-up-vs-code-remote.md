...
In questo articolo si apprenderà come configurare Visual Studio Code estensione remota in un'istanza di calcolo Azure Machine Learning per poter **eseguire il debug interattivo del codice** da vs code.
...
* Istanza di calcolo abilitata per SSH. Per ulteriori informazioni, [vedere la guida per la creazione di un'istanza di calcolo.](https://docs.microsoft.com/azure/machine-learning/concept-compute-instance#create)
