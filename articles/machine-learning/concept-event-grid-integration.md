...
Azure Machine Learning gestisce l'intero ciclo di vita del processo di Machine Learning, tra cui il training del modello, la distribuzione del modello e il monitoraggio. Azure Machine Learning eventi consentono alle applicazioni di reagire agli eventi durante il ciclo di vita di Machine Learning, ad esempio il completamento delle esecuzioni di training, la registrazione e la distribuzione dei modelli e il rilevamento della deviazione dei dati, usando architetture moderne senza server. 
