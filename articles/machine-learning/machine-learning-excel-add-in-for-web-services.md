...
Distribuire un servizio Web o usarne uno esistente. Per altre informazioni sulla distribuzione di un servizio Web, vedere [Passaggio 5 della procedura dettagliata: Distribuire il servizio Web di Machine Learning](machine-learning-walkthrough-5-publish-web-service.md).
...
1. Distribuire un servizio Web o usarne uno esistente. Per altre informazioni sulla distribuzione di un servizio Web, vedere [Passaggio 5 della procedura dettagliata: Distribuire il servizio Web di Machine Learning](machine-learning-walkthrough-5-publish-web-service.md).
2. Fare clic su **Consume**(Uso).
3. Cercare la sezione **Basic consumption info** (Informazioni di base sull'uso). Copiare e salvare il valore di **Primary Key** (Chiave primaria) e l'URL **Request-Response** (Richiesta-risposta).
