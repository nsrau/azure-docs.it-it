...
* Dopo aver avviato il dashboard di Jupyter Notebook, aprire il notebook **tutorials/regression-part1-data-prep.ipynb**.

Questa esercitazione è disponibile anche in [GitHub](https://github.com/Azure/MachineLearningNotebooks/tree/master/tutorials) se si vuole usarla nel proprio [ambiente locale](how-to-configure-environment.md#local).  Assicurarsi di aver installato il pacchetto `azureml-dataprep` da Azure Machine Learning SDK.
