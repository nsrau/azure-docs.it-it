...
ms.locfileid: "73584761"
---
# <a name="deploy-a-model-to-azure-machine-learning-notebook-vms"></a>Distribuire un modello per le macchine virtuali Azure Machine Learning notebook

[!INCLUDE [applies-to-skus](../../../includes/aml-applies-to-basic-enterprise-sku.md)]

Informazioni su come usare Azure Machine Learning per distribuire un modello come servizio Web nella VM Azure Machine Learning notebook. Usare le macchine virtuali del notebook se si verifica una delle condizioni seguenti:
...
1. Da [Azure Machine Learning Studio](https://ml.azure.com)selezionare le VM Azure Machine Learning notebook.
...
1. Per testare il servizio dalla VM notebook, usare l'URL del `https://localhost:<local_service.port>`. Per eseguire il test da un client remoto, ottenere l'URL pubblico del servizio in esecuzione nella macchina virtuale del notebook. È possibile determinare l'URL pubblico utilizzando la formula seguente. `https://<notebookvm_name>-<local_service_port>.<azure_region_of_notebook>.notebooks.azureml.net/score`. Ad esempio, `https://mynotebookvm-6789.eastus2.notebooks.azureml.net/score`.
