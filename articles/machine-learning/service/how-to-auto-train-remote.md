...
Definito training_data come `TabularDataset`e l'etichetta, che vengono passate a ML automatico in AutoMLConfig. per impostazione predefinita, `from_delimited_files` imposta la `infer_column_types` su true, che dedurrà automaticamente il tipo di colonna. 
