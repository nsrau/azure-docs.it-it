...
## <a name="can-i-use-azure-machine-learning-for-free-during-preview"></a>È possibile usare Azure Machine Learning gratuitamente durante l'anteprima?    
...
## <a name="am-i-charged-based-on-how-many-experiments-i-run"></a>Gli addebiti sono basati sul numero di esperimenti eseguiti?
...
## <a name="am-i-charged-based-on-how-many-times-my-web-services-is-called"></a>Gli addebiti sono basati sul numero di chiamate eseguite ai servizi Web?
...
## <a name="how-can-i-scale-the-units-i-purchase-in-the-azure-machine-learning-model-management"></a>Come si ridimensiona il numero di unità acquistate in Gestione modelli di Azure Machine Learning?
...
## <a name="what-does-a-bill-look-like"></a>Come è fatta una fattura?
