...
In questo esempio viene illustrata la configurazione dell'oggetto [`DataDriftDetector`](/python/api/azureml-datadrift/azureml.datadrift.datadriftdetector.datadriftdetector) :
