...
Nota: Python SDK per la preparazione dei dati non installerà più i pacchetti `numpy` e `pandas`. Vedere [le istruzioni di installazione aggiornate](https://aka.ms/aml-data-prep-installation).
