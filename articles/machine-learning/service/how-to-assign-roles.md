...
> [!IMPORTANT]
> Accesso del ruolo può essere limitato a più livelli in Azure. Ad esempio, un utente con accesso come proprietario a un'area di lavoro potrebbe non avere accesso come proprietario al gruppo di risorse che contiene l'area di lavoro. Per altre informazioni, vedere [funziona come RBAC](/azure/role-based-access-control/overview#how-rbac-works).
