...
|**iterations**|20|Numero di iterazioni. In ogni iterazione, viene eseguito il training di un nuovo modello di machine learning con i dati. Questo è il valore principale che influisce sul runtime totale.|
