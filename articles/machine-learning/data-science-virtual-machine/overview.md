...
description: 'Panoramica di Azure Data Science Virtual Machine: una macchina virtuale semplice da creare e usare nella piattaforma cloud di Azure con librerie e strumenti preinstallati e configurati per scenari di data science e sviluppo di applicazioni intelligenti.'
...
Nelle edizioni per Windows della DSVM sono preinstallati i driver di GPU, i framework e le versioni per GPU dei framework di Deep Learning. Nell'edizione per Linux, il Deep Learning su GPU è abilitato sulle DSVM Ubuntu. 
