...
In Dsvm sono disponibili diverse librerie di Machine Learning, come il popolare pacchetto `scikit-learn` che fa parte della distribuzione di Anaconda Python per Dsvm. Per estrarre l'elenco dei pacchetti disponibili in Python, R e Julia, eseguire i rispettivi strumenti di gestione dei pacchetti.
