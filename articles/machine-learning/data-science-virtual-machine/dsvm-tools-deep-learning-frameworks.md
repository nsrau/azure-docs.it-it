...
> [!NOTE]
> Entrambe le immagini di VM seguenti sono state deprecate:
>
> * Immagine di Windows Server 2016 DSVM
> * Immagine di Ubuntu 16,04 DSVM 
>
> Queste immagini di macchina virtuale sono disponibili solo per i clienti esistenti che usano le distribuzioni ARM. Queste immagini continueranno a ricevere patch di sicurezza critiche fino alla data di ritiro, ma non verranno aggiornate con gli strumenti di data science più recenti in futuro.
> 
> Vedere la pagina relativa alle [deprecazioni di immagini DSVM](./reference-deprecation.md).
...
| ------------- | ------------- |
| Versioni supportate | |
| Edizioni DSVM supportate      | Ubuntu 16,04 (deprecato)    |
...
| Edizioni DSVM supportate      | Windows Server 2019<br>Ubuntu 18.04<br> Windows 2016 (deprecato)<br> Ubuntu 16,04 (deprecato)  |
...
| Edizioni DSVM supportate      | Ubuntu 18.04<br> Ubuntu 16,04 (deprecato)   |
...
| Edizioni DSVM supportate      | Windows 2016 (deprecato)<br> Ubuntu 16,04 (deprecato)   |
...
| Category | Valore |
| ------------- | ------------- |
| Versioni supportate | 1.2.0 (Ubuntu 16,04), 1.4.0 (Ubuntu 18,04, Windows 2019) |
| Edizioni DSVM supportate      | Windows Server 2019<br>Ubuntu 18.04<br> Ubuntu 16,04 (deprecato) |
