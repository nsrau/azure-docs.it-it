...
[Centro architetture di Azure](https://docs.microsoft.com/en-us/azure/architecture/) fornisce un'architettura end-to-end dettagliata e modelli per la compilazione e la gestione dell'infrastruttura di analisi basata sul cloud. 
