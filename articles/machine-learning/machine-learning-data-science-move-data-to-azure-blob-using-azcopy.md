---
title: Spostamento dei dati da e verso l'archiviazione BLOB di Azure utilizzando AzCopy | Microsoft Docs
...
> [!NOTE]
> È possibile aggiungere il percorso di installazione di AzCopy al percorso di sistema ed eseguire i comandi da qualsiasi directory. Per impostazione predefinita, AzCopy viene installato in *% ProgramFiles (x86) %\\Microsoft SDK\\Azure\\AzCopy* o in *%ProgramFiles%\\Microsoft SDK\\Azure\\AzCopy*.
> 
> 
