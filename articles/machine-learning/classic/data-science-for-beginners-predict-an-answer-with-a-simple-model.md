---
title: 'ML Studio (classico): prevedere le risposte con i modelli di regressione-Azure'
...
![Colonne di dati relativi ai diamanti](./media/data-science-for-beginners-predict-an-answer-with-a-simple-model/diamond-data.png)
...
![Grafico a dispersione](./media/data-science-for-beginners-predict-an-answer-with-a-simple-model/scatter-plot.png)
...
![Linea di regressione lineare](./media/data-science-for-beginners-predict-an-answer-with-a-simple-model/linear-regression-line.png)
