...
> [!TIP]
> Per informazioni dettagliate cosa accade quando si converte un esperimento di training in un esperimento predittivo, vedere l'articolo relativo alla [preparazione del modello per la distribuzione in Azure Machine Learning Studio (versione classica)](deploy-a-machine-learning-web-service.md).
...
Per altre informazioni sull'accesso e sull'utilizzo del servizio Web, vedere [Utilizzare un servizio Web di Azure Machine Learning con un modello di app Web](./consume-web-services.md).
