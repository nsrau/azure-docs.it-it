...
description: Informazioni su come usare il modulo DenseNet in progettazione Azure Machine Learning per creare un modello di classificazione delle immagini usando l'algoritmo DenseNet.
