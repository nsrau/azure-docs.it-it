---
title: Converti in valori indicatore
...
ms.locfileid: "77165540"
---
# <a name="convert-to-indicator-values"></a>Converti in valori indicatore
...
1. Selezionare l'opzione **Sovrascrivi colonne categoriche** se si desidera restituire **solo** le nuove colonne booleane. Per impostazione predefinita, questa opzione è disattivata.
...
-   solo le colonne contrassegnate come categoriche possono essere convertite in colonne indicatore Se viene visualizzato l'errore seguente, è probabile che una delle colonne selezionate non sia categorica:  
     ...
     Errore 0056: la colonna con nome \<nome della colonna > non si trova in una categoria consentita.  
