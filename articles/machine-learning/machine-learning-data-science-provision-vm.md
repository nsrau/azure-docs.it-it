---
title: Eseguire il provisioning di una macchina virtuale per l'analisi scientifica dei dati di Microsoft | Microsoft Docs
...
> [!NOTE]
> Per usare Python Tools for Visual Studio in Anaconda Python 2.7 e 3.5, è necessario creare ambienti personalizzati per ogni versione. Per impostare questi percorsi per gli ambienti in Visual Studio 2015 Community Edition, passare a **Strumenti** -> **Python Tools** -> **Python Environments** e quindi fare clic su "**+ Custom**".
> 
> 
