...
Definire l'ambiente Azure ML che incapsula le dipendenze dello script di training.
...
Facoltativamente, Azure ML fornisce ambienti predefiniti e curati se non si vuole creare un'immagine personalizzata. Azure ML dispone di diversi ambienti di CPU e GPU curati per TensorFlow corrispondenti a versioni diverse di TensorFlow. Per altre informazioni, vedere [qui](resource-curated-environments.md).
