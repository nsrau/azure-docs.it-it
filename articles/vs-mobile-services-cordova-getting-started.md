...
Eliminare una riga da una tabella dati usando il metodo **del**. Chiamare il metodo [done][done] sull'oggetto [Promise][done] restituito per ottenere una copia dell'oggetto inserito e gestire eventuali errori.
