...
## <a name="create-function"></a>Creare una funzione attivata dall'archiviazione BLOB
...
2. Nella finestra di dialogo **Carica file** fare clic sul campo **File**. Identificare un file nel computer locale, ad esempio un file di immagine, selezionarlo e fare clic su **Apri** e quindi su **Carica**.   
 
3. Tornare ai log di funzione e verificare che il BLOB sia stato letto. 
