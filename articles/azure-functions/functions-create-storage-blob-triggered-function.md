...
1. Selezionare **Funzioni** e quindi **+ Aggiungi** per aggiungere una nuova funzione.
   ...
   :::image type="content" source="./media/functions-create-storage-blob-triggered-function/function-app-quickstart-choose-template.png" alt-text="App per le funzioni creata correttamente." border="true":::
...
1. Usare le impostazioni specificate nella tabella disponibile sotto l'immagine.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-create-blob-storage-trigger-portal-2.png" alt-text="App per le funzioni creata correttamente." border="true":::
...
1. Selezionare **Crea funzione** per creare la funzione.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-create-blob-storage-trigger-portal-3.png" alt-text="App per le funzioni creata correttamente." border="true":::
...
1. Nella pagina **Panoramica** della funzione selezionare il gruppo di risorse.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-resource-group.png" alt-text="App per le funzioni creata correttamente." border="true":::

1. Cercare e selezionare l'account di archiviazione del gruppo di risorse.

    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-account-access.png" alt-text="App per le funzioni creata correttamente." border="true":::

1. Scegliere **Contenitori** e quindi **+ Contenitore**. 

    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-add-container.png" alt-text="App per le funzioni creata correttamente." border="true":::

1. Nel campo **Nome** digitare `samples-workitems` e quindi selezionare **Crea**.

    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-name-blob-container.png" alt-text="App per le funzioni creata correttamente." border="true":::
...
1. Tornare al portale di Azure, selezionare la funzione, espandere i **log** nella parte inferiore della pagina e assicurarsi che lo streaming dei log non sia stato interrotto.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-log-expander.png" alt-text="App per le funzioni creata correttamente." border="true":::
...
1. Selezionare **Contenitori** e quindi il contenitore **samples-workitems**.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-container.png" alt-text="App per le funzioni creata correttamente." border="true":::

1. Selezionare **Carica** e quindi l'icona della cartella per scegliere un file da caricare.

    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/functions-storage-manager-upload-file-blob.png" alt-text="App per le funzioni creata correttamente." border="true":::
...
1. Tornare ai log di funzione e verificare che il BLOB sia stato letto.
    ...
    :::image type="content" source="./media/functions-create-storage-blob-triggered-function/function-app-in-portal-editor.png" alt-text="App per le funzioni creata correttamente." border="true":::
