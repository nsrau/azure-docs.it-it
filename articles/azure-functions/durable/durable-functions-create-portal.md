...
Se si sta creando Durable Functions JavaScript, sarà necessario installare il [ `durable-functions` pacchetto NPM](https://www.npmjs.com/package/durable-functions).
