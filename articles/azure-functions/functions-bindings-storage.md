---
title: Trigger e associazioni di Archiviazione di Azure in Funzioni di Azure | Documentazione Microsoft
...
---
# <a name="azure-functions-triggers-and-bindings-for-azure-storage"></a>Trigger e associazioni di Archiviazione di Azure in Funzioni di Azure 
...
## <a name="a-idstoragequeuetriggera-azure-storage-queue-trigger"></a><a id="storagequeuetrigger"></a> Trigger della coda di Archiviazione di Azure
#### <a name="functionjson-for-storage-queue-trigger"></a>function.json per trigger della coda di archiviazione
...
#### <a name="queue-trigger-supported-types"></a>Tipi supportati di trigger della coda
...
## <a name="a-idstoragequeueoutputa-azure-storage-queue-output-binding"></a><a id="storagequeueoutput"></a> Associazione di output della coda di Archiviazione di Azure
#### <a name="functionjson-for-storage-queue-output-binding"></a>function.json per associazione di output della coda di archiviazione
Il file *function.json* specifica le proprietà seguenti.
...
#### <a name="queue-output-binding-supported-types"></a>Tipi supportati di associazione di output della coda
...
#### <a name="queue-output-binding-code-examples"></a>Esempi di codice dell'associazione di output della coda
...
## <a name="a-idstorageblobtriggera-azure-storage-blob-trigger"></a><a id="storageblobtrigger"></a> Trigger di BLOB del servizio di archiviazione di Azure
#### <a name="functionjson-for-storage-blob-trigger"></a>function.json per trigger di BLOB di archiviazione
Il file *function.json* specifica le proprietà seguenti.
...
#### <a name="blob-trigger-supported-types"></a>Tipi supportati di trigger dei BLOB
...
#### <a name="blob-trigger-c-code-example"></a>Esempio di codice C# del trigger dei BLOB
...
#### <a name="blob-trigger-name-patterns"></a>Modelli di nome di trigger dei BLOB
...
## <a name="a-idstorageblobbindingsa-azure-storage-blob-input-and-output-bindings"></a><a id="storageblobbindings"></a> Associazioni di input e di output dei BLOB del servizio di archiviazione di Azure
#### <a name="functionjson-for-a-storage-blob-input-or-output-binding"></a>function.json per un'associazione di input o output dei BLOB di archiviazione
Il file *function.json* specifica le proprietà seguenti.
...
#### <a name="blob-input-and-output-supported-types"></a>Tipi supportati di input e di output di BLOB
...
#### <a name="blob-output-c-code-example"></a>Esempio di codice C# di output di BLOB
...
## <a name="a-idstoragetablesbindingsa-azure-storage-tables-input-and-output-bindings"></a><a id="storagetablesbindings"></a> Associazioni di input e di output delle tabelle di Archiviazione di Azure
#### <a name="functionjson-for-storage-tables"></a>function.json per tabelle di archiviazione
Il file *function.json* specifica le proprietà seguenti.
...
#### <a name="storage-tables-input-and-output-supported-types"></a>Tipi di input e output supportati nelle tabelle di archiviazione
...
#### <a name="storage-tables-binding-scenarios"></a>Scenari di associazione delle tabelle di archiviazione
...
#### <a name="storage-tables-example-read-a-single-table-entity-in-c-or-node"></a>Esempio di tabelle di archiviazione: lettura di una singola entità di tabella in C# o in Node
...
#### <a name="storage-tables-example-read-multiple-table-entities-in-c"></a>Esempio di tabelle di archiviazione: lettura di più entità di tabella in C
...
#### <a name="storage-tables-example-create-table-entities-in-c"></a>Esempio di tabelle di archiviazione: creazione di più entità di tabella in C
...
#### <a name="storage-tables-example-create-table-entities-in-f"></a>Esempio di tabelle di archiviazione: creare entità di tabella in F
...
#### <a name="storage-tables-example-create-a-table-entity-in-node"></a>Esempio di tabelle di archiviazione: creazione un'entità di tabella in Node
