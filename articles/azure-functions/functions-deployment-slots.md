...
| ------------------------- | -------------------- |
| Windows Consumption       | Disponibilità generale |
| Windows Premium           | Disponibilità generale  |
| Windows Dedicated         | Disponibilità generale |
| Linux Consumption         | Non supportato          |
| Linux Premium             | Disponibilità generale  |
| Linux Dedicated           | Disponibilità generale |
