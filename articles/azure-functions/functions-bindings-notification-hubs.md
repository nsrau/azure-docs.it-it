...
> [!IMPORTANT]
> Google ha [deprecato Google Cloud Messaging (GCM) a favore di Firebase Cloud Messaging (FCM)](https://developers.google.com/cloud-messaging/faq). Questa associazione di output non supporta FCM. Per inviare notifiche utilizzando FCM, utilizzare [l'API Firebase](https://firebase.google.com/docs/cloud-messaging/server#choosing-a-server-option) direttamente nella funzione o utilizzare [le notifiche modello](../notification-hubs/notification-hubs-templates-cross-platform-push-messages.md).
...
|**hubName (nomehub)** | **NomeHubName** | Nome della risorsa dell'hub di notifica nel portale di Azure. |
