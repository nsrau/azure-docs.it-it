...
Per iniziare a usare questo archetipo, vedere [Avvio rapido Java](./functions-create-first-azure-function-azure-cli.md?pivots=programming-language-java). 
