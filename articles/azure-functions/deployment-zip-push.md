---
title: Distribuzione push con file ZIP per Funzioni di Azure | Microsoft Docs
...
La distribuzione ZIP si integra con questa funzionalità che può essere attivata impostando l'impostazione dell'app per le funzioni `WEBSITE_RUN_FROM_ZIP` su un valore di `1`. Per altre informazioni, vedere [Run your Functions from a deployment package file](run-functions-from-deployment-package.md) (Esecuzione di funzioni da un file di pacchetto di distribuzione).
