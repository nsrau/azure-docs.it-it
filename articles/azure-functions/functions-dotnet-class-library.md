...
Per registrare l'output nei log in streaming in C#, includere un argomento di tipo [ILogger](/dotnet/api/microsoft.extensions.logging.ilogger). Si consiglia di denominarlo `log`, come nell'esempio seguente:  
