...
1. Selezionare **OK** per creare il piano e quindi configurare le rimanenti **app per le funzioni** impostazioni come specificato nella tabella immediatamente dopo lo screenshot seguente:
    ...
    | **Sistema operativo** | Sistema operativo preferito | Selezionare Windows. |
...
1. Selezionare **Aggiungi connessione ibrida**.
   ![](./media/functions-hybrid-powershell/hybrid-connection-overview.png) di connessione ibrida  
1. Immettere le informazioni sulla connessione ibrida, come illustrato immediatamente dopo la schermata seguente. È possibile fare in modo che l'impostazione **host endpoint** corrisponda al nome host del server locale per semplificare la memorizzazione del server in un secondo momento quando si eseguono comandi remoti. La porta corrisponde alla porta predefinita del servizio gestione remota Windows che è stata definita nel server.
  ![aggiungere la connessione ibrida](./media/functions-hybrid-powershell/add-hybrid-connection.png)  
...
programma di installazione di download ![](./media/functions-hybrid-powershell/download-hybrid-connection-installer.png)  
...
![copiare la stringa di connessione ibrida](./media/functions-hybrid-powershell/copy-hybrid-connection.png)  
1. Aprire l'interfaccia utente di Gestione connessione ibrida nel server locale.
![interfaccia utente aperta della connessione ibrida](./media/functions-hybrid-powershell/hybrid-connection-ui.png)  
1. Selezionare il pulsante **Immetti manualmente** e incollare la stringa di connessione negli Appunti.
![incollare la connessione](./media/functions-hybrid-powershell/enter-manual-connection.png)  
...
![aggiungere l'impostazione dell'app per la password](./media/functions-hybrid-powershell/add-appsetting-password.png)  
...
![creare un nuovo trigger HTTP](./media/functions-hybrid-powershell/create-http-trigger-function.png)  
