...
Le associazioni sperimentali supportate dalla versione 1.x del runtime non sono disponibili nella versione 2.x. Per informazioni sul supporto delle associazioni e su altre discrepanze a livello di funzioni nella versione 2.x, vedere l'argomento relativo ai [problemi noti del runtime 2.0](https://github.com/Azure/azure-webjobs-sdk-script/wiki/Azure-Functions-runtime-2.0-known-issues).
