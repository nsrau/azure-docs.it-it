...
È possibile abilitare i log in streaming tramite il [CLI Azure](/cli/azure/install-azure-cli). Usare i comandi seguenti per accedere, scegliere la sottoscrizione e i file di log di flusso:
