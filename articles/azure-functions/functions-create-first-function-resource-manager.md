...
[Creare il progetto per le funzioni locale in Visual Studio Code](functions-create-first-function-vs-code.md#create-an-azure-functions-project)
...
[Creare il progetto per le funzioni locale dalla riga di comando](functions-create-first-azure-function-azure-cli.md#create-a-local-function-project)
