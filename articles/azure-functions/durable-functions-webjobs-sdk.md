...
2. Modificare il codice del metodo `Main` per ottenere la stringa di connessione di archiviazione e la chiave di strumentazione di Application Insights da un file *appsettings.json* usando .NET Core Configuration Framework.  Ad esempio:
