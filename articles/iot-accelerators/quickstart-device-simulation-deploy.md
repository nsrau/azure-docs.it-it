---
title: Distribuire ed eseguire una soluzione di simulazione dei dispositivi in Azure | Microsoft Docs
...
Per informazioni su come usare un hub IoT esistente in una simulazione, vedere la guida pratica:
