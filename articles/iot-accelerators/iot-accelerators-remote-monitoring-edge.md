...
Per altre informazioni sull'installazione del runtime IoT Edge, vedere [Installare il runtime di Azure IoT Edge in Linux (x64)](../iot-edge/how-to-install-iot-edge.md).
