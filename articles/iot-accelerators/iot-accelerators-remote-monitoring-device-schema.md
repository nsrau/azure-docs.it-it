...
Per altre informazioni sul file JavaScript che aggiorna l'oggetto di stato del dispositivo, vedere [Informazioni sul comportamento del modello dei dispositivi](iot-accelerators-remote-monitoring-device-behavior.md).
...
Per altre informazioni sul file JavaScript che implementa il comportamento del dispositivo, vedere [Informazioni sul comportamento del modello dei dispositivi](iot-accelerators-remote-monitoring-device-behavior.md).
