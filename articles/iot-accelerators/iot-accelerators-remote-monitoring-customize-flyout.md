...
Il comando precedente esegue localmente l'interfaccia utente all'indirizzo `http://localhost:3000/dashboard`. Passare alla pagina di **esempio** e fare clic su **Open Flyout** (Apri riquadro a comparsa).
