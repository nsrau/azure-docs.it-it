...
La sezione [Simulation](iot-accelerators-remote-monitoring-device-schema.md#simulation) dello schema del modello di dispositivo definisce lo stato interno di un dispositivo simulato:
...
La sezione [CloudToDeviceMethods](iot-accelerators-remote-monitoring-device-schema.md#cloudtodevicemethods) dello schema del modello di dispositivo definisce i metodi a cui risponde un dispositivo simulato.
...
L'articolo [Creare un nuovo dispositivo simulato](iot-accelerators-remote-monitoring-test.md) illustra come eseguire il servizio di simulazione del dispositivo a livello locale. L'esecuzione del servizio in locale facilita il debug dei dispositivi simulati prima della distribuzione nel cloud.
