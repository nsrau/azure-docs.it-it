...
[Windows Store C\#](/it-it/documentation/articles/notification-hubs-windows-store-aspnet-register-user-push-notifications/ "Windows Store C#")[iOS](/it-it/documentation/articles/notification-hubs-ios-aspnet-register-user-push-notifications/ "iOS")
...
6.  Nel metodo **didFinishLaunchingWithOptions** di PushToUserAppDelegate.m aggiungere il codice seguente:
    ...
    La prima riga inizializza il singleton **DeviceInfo**. La seconda riga avvia la registrazione per le notifiche push, che è già presente se si è completata l'esercitazione [Introduzione ad Hub di notifica](/en-us/manage/services/notification-hubs/get-started-notification-hubs-ios).
