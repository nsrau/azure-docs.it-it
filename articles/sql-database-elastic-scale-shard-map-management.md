<properties title="Shard Map Management" pageTitle="Gestione mappe partizioni" description="Come usare ShardMapManager, l'API Elastic Scale per .NET" metaKeywords="sharding scaling, Azure SQL Database sharding, elastic scale, shardmapmanager" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
