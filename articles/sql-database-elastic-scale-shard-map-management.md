<properties 
	...
	description="Come usare ShardMapManager, l'API Elastic Scale per .NET" 
...
In una **mappa partizioni di tipo intervallo** l'intervallo di chiavi è descritto da una coppia di tipo **[Low Value, High Value)**, dove *Low Value* indica la chiave minima dell'intervallo e *High Value* è il primo valore superiore all'intervallo. 
...
<table>
   <tr>
    <td><b>Intervallo di chiavi</b></td>
...
Il gestore mappe partizioni nelle API di Scalabilità elastica è una raccolta di mappe partizioni. I dati gestiti da un oggetto .NET **ShardMapManager** sono archiviati in tre posizioni: 
