---
title: Viste di database in Azure blockchain Workbench Preview
description: Panoramica delle viste del database SQL di Azure blockchain Workbench Preview.
...
ms.locfileid: "70845032"
---
# <a name="database-views-in-azure-blockchain-workbench-preview"></a>Viste di database in Azure blockchain Workbench Preview
...
| TransactionIsWorkbenchTransaction        | bit           | Yes         | Bit che identifica se la transazione è una transazione di Azure blockchain Workbench |
...
| StateName                          | nvarchar(50)  | Yes         | Se questa proprietà contiene lo stato del contratto, si tratta del nome visualizzato per lo stato. Se non è associata allo stato, il valore sarà null. |
...
| StateValue                         | nvarchar(255) | Yes         | Se questa proprietà contiene lo stato, si tratta del valore di stato. Se non è associata allo stato, il valore sarà null. |
...
| StateName                          | nvarchar(50)  | Yes         | Se questa proprietà contiene lo stato, il nome visualizzato per lo stato. Se non è associata allo stato, il valore sarà null. |
| StateDisplayName                   | nvarchar(255) | No          | Se questa proprietà contiene lo stato, si tratta del nome visualizzato per lo stato. Se non è associata allo stato, il valore sarà null. |
