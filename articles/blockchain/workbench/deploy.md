...
1. Per il manifesto è necessario un GUID. È possibile generare un GUID usando il comando PowerShell `[guid]::NewGuid()` o `New-GUID` cmdlet. Un'altra opzione consiste nell'usare un sito Web di generatori di GUID.
