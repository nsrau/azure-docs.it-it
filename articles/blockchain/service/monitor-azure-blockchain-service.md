...
È possibile analizzare le metriche per il servizio Azure blockchain con Esplora metriche, passare alla scheda metriche nella sezione monitoraggio nel pannello della risorsa ABS. Per informazioni dettagliate sull'uso dello strumento, vedere [Introduzione ad Azure Esplora metriche](../../azure-monitor/platform/metrics-getting-started.md) . Le metriche complete per il servizio Azure blockchain sono disponibili nelle metriche dello spazio dei nomi Azure blockchain Service standard.
...
Di seguito sono riportate alcune query che è possibile immettere nella barra di ricerca dei log per monitorare i membri del servizio blockchain di Azure. Queste query usano il [nuovo linguaggio](../../azure-monitor/log-query/log-query-overview.md).
...
Tutti i log delle risorse condividono uno schema comune di primo livello con poche proprietà univoche specifiche per il servizio blockchain. È possibile fare riferimento all'articolo [schema dei log delle risorse di primo livello](../../azure-monitor/platform/resource-logs-schema.md#top-level-common-schema), informazioni dettagliate sulle proprietà specifiche del servizio Azure blockchain sono descritte di seguito.  
...
Per un elenco di tutte le metriche supportate da monitoraggio di Azure, incluso il servizio Azure blockchain, vedere [metriche supportate di monitoraggio di Azure](../../azure-monitor/platform/metrics-supported.md).
