---
title: Azure Toolkit for Eclipse | Documentazione Microsoft
...
## <a name="getting-started-with-the-azure-toolkit-for-eclipse"></a>Introduzione al Toolkit di Azure per Eclipse
...
## <a name="configuring-azure-project-settings"></a>Configurazione delle impostazioni del progetto di Azure
...
## <a name="using-the-azure-toolkit-for-eclipse"></a>Usare il Toolkit di Azure per Eclipse
...
* [Debug delle applicazione Azure in Eclipse]
* [Usare il plug-in degli strumenti HDInsight per Eclipse per creare applicazioni Spark][plug-in degli strumenti HDInsight per Eclipse]
...
[Debug delle applicazione Azure in Eclipse]: ./azure-toolkit-for-eclipse-debugging-azure-applications.md
...
[Come autenticare gli utenti Web con il Servizio di controllo di accesso di Azure usando Eclipse]: ./active-directory/active-directory-java-authenticate-users-access-control-eclipse.md
