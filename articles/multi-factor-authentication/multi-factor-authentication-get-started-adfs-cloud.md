---
title: Protezione delle risorse cloud con Azure Multi-Factor Authentication e AD FS
...
1. Usare la procedura descritta in [Attivare Multi-Factor Authentication](multi-factor-authentication-get-started-cloud.md#turn-on-multi-factor-authentication-for-users) per consentire agli utenti di abilitare un account.
