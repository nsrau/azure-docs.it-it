<properties 
	pageTitle="Gestire le impostazioni di Azure MFA nel portale di Office 365" 
	description="Questa pagina mostrerà agli utenti da dove gestire nel portale di Office 365 le impostazioni di Azure MFA." 
...
# Gestire le impostazioni di Azure Multi-Factor Authentication nel portale di Office 365
...
## Per accedere alle impostazioni di verifica aggiuntiva di sicurezza nel portale di Office 365

<ol>

<li>Accedere al [portale di Office 365] (https://login.microsoftonline.com/).</li>
