...
>[!NOTE]
>Queste impostazioni sono in anteprima pubblica nel portale di Azure. Per informazioni su come gestire le impostazioni di Azure Multi-Factor Authentication in anteprima, vedere [Configure Azure Multi-Factor Authentication settings (Configurare le impostazioni di Azure Multi-Factor Authentication) - Anteprima pubblica](multi-factor-authentication-whats-next.md).
