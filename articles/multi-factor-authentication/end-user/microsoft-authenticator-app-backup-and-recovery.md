---
title: Eseguire il backup e il ripristino delle informazioni con Microsoft Authenticator - Azure | Microsoft Docs
...
-   Nel dispositivo iOS selezionare **Impostazioni**, selezionare **Backup** e quindi attivare **Backup automatico**.
    ...
    ![Schermata delle impostazioni di iOS, che mostra la posizione delle impostazioni per il backup automatico](./media/authenticator-app-backup-and-recovery/backup-and-recovery-turn-on.png)
...
1.  Nel dispositivo iOS aprire l'app Microsoft Authenticator e selezionare **Inizia il ripristino** nella parte inferiore della schermata.
    ...
    ![App Microsoft Authenticator che mostra dove fare clic su Inizia il ripristino](./media/authenticator-app-backup-and-recovery/backup-and-recovery-begin-recovery.png)
...
1.  Nella schermata **Account** dell'app Microsoft Authenticator selezionare la freccia in giù accanto all'account da ripristinare.
    ...
    ![App Microsoft Authenticator che mostra gli account disponibili con le frecce in giù associate](./media/authenticator-app-backup-and-recovery/backup-and-recovery-arrow.png)
...
2.  Selezionare **Accedi per ripristinare**, digitare la password e quindi confermare l'indirizzo di posta elettronica o il numero di telefono come ulteriore verifica.
    ...
    ![App Microsoft Authenticator che consente di immettere le informazioni di accesso](./media/authenticator-app-backup-and-recovery/backup-and-recovery-sign-in.png)

**Per fornire un'ulteriore verifica per gli account aziendali o dell'istituto di istruzione**
1.  Nella schermata **Account** dell'app Microsoft Authenticator selezionare la freccia in giù accanto all'account da ripristinare.

    ![App Microsoft Authenticator che mostra gli account disponibili con le frecce in giù associate](./media/authenticator-app-backup-and-recovery/backup-and-recovery-additonal-accts.png)
...
2.  Selezionare **Scansione codice QR per ripristinare** e quindi eseguire la scansione del codice a matrice fornito dall'amministratore.
    ...
    ![App Microsoft Authenticator che consente di eseguire la scansione del codice a matrice](./media/authenticator-app-backup-and-recovery/backup-and-recovery-scan-qr-code.png)
