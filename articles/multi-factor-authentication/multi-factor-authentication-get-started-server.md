---
title: Introduzione al server Azure Multi-Factor Authentication
...
---
# <a name="getting-started-with-the-azure-multifactor-authentication-server"></a>Introduzione al server Azure Multi-Factor Authentication
...
## <a name="download-the-azure-multifactor-authentication-server"></a>Scaricare il server Azure Multi-Factor Authentication
...
### <a name="to-download-the-azure-multifactor-authentication-server-from-the-azure-portal"></a>Per scaricare il server Azure Multi-Factor Authentication dal portale Azure
- - -
...
6. Sopra **Genera credenziali di attivazione** fare clic su **Download.**
   ![Download](./media/multi-factor-authentication-get-started-server/download4.png)
7. Salvare il download.

### <a name="to-download-the-azure-multifactor-authentication-server-via-the-service-settings"></a>Per scaricare il server Azure Multi-Factor Authentication con le impostazioni del servizio
1. Accedre al portale di Azure come amministratore.
2. A sinistra selezionare Active Directory.
...
## <a name="install-and-configure-the-azure-multifactor-authentication-server"></a>Installare e configurare il server Azure Multi-Factor Authentication
...
### <a name="azure-multifactor-authentication-server-firewall-requirements"></a>Requisiti del firewall del server Azure Multi-Factor Authentication
- - -
...
### <a name="to-install-and-configure-the-azure-multifactor-authentication-server"></a>Per installare e configurare il server Azure Multi-Factor Authentication
- - -
...
4. Nella schermata iniziale della configurazione guidata inserire un segno di spunta nella casella per **non utilizzare la Configurazione guidata autenticazione** e fare clic su **Avanti**.  Verrà chiusa la procedura guidata e avviato il server.
...
## <a name="send-users-an-email"></a>Inviare agli utenti un messaggio e-mail
...
### <a name="configuring-email-and-email-templates"></a>Configurazione di posta elettronica e modelli di messaggio di posta elettronica
...
## <a name="how-the-azure-multifactor-authentication-server-handles-user-data"></a>Come gestire i dati utente tramite il server Multi-Factor Authentication
...
## <a name="advanced-azure-multifactor-authentication-server-configurations"></a>Configurazioni avanzate del Server Azure Multi-Factor Authentication.
