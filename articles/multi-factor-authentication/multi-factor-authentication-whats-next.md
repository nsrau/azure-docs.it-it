...
1. Quando viene inviata una verifica al telefono, fare clic su di essa per avviare l'app Microsoft Authenticator.
...
> [!WARNING]
> Le password di app non funzioneranno in ambienti ibridi dove i client comunicano con endpoint di individuazione automatica sia locali che nel cloud.
> 
...
> [!NOTE]
> Questa funzionalità è implementata come una cache di cookie del browser. Non funzionerà se i cookie del browser non sono abilitati.
> 
> 
