...
In questa esercitazione si presuppone che l'utente abbia installato [SQL Server Express](http://www.microsoft.com/it-it/download/details.aspx?id=29062) nel computer in modo che sia possibile testare un'applicazione in locale. È tuttavia possibile completare l'esercitazione senza aver installato SQL Server Express. L'applicazione può infatti essere distribuita direttamente sui siti Web di Azure.
