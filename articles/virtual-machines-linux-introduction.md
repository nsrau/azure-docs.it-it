...
In questo argomento viene fornita una panoramica relativa ad alcuni aspetti dell'utilizzo di macchine virtuali Linux nel cloud di Azure. Se si usa un'immagine preesistente nella raccolta, la distribuzione di una macchina virtuale Linux è un processo estremamente semplice.
...
-   [Collegamento di dischi][Collegamento di dischi]

## <span id="authentication"></span></a>Autenticazione: nomi utente, password e chiavi SSH
...
-   Vedere [Come usare SSH con Linux in Azure][Come usare SSH con Linux in Azure]

### <span id="keygeneration"></span></a>Generazione di chiavi SSH
...
## <span id="hostnamechanges"></span></a>Modifica del nome host
...
-   [Guida dell'utente dell'agente Linux di Azure][Guida dell'utente dell'agente Linux di Azure]
...
-   Vedere: [Come acquisire un'immagine di una macchina virtuale che esegue Linux][Come acquisire un'immagine di una macchina virtuale che esegue Linux]

## <span id="attachingdisks"></span></a>Collegamento di dischi
...
-   Vedere anche la pagina relativa alla [Configurazione dei RAID software in Linux][Configurazione dei RAID software in Linux]
  ...
  [Come acquisire un'immagine di una macchina virtuale che esegue Linux]: ../virtual-machines-linux-capture-image/
  [Come collegare un disco dati a una macchina virtuale]: ../virtual-machines-linux-how-to-attach-disk/
  [Configurazione dei RAID software in Linux]: ../virtual-machines-linux-configure-raid/
