...
-   [Configurazione di Servizi mobili][Configurazione di Servizi mobili]
-   [Aggiungere notifiche push all'app][Aggiungere notifiche push all'app]
-   [Aggiornamento degli script per l'invio di notifiche push][Aggiornamento degli script per l'invio di notifiche push]
-   [Inserimento di dati per la ricezione di notifiche][Inserimento di dati per la ricezione di notifiche]
...
8.  Scaricare e decomprimere [Mobile Services Android SDK][Mobile Services Android SDK], aprire la cartella **notifications**, copiare il file **notifications-1.0.1.jar** nella cartella *libs* del progetto Eclipse, quindi aggiornare la cartella *libs*.
...
3.  Sostituire la funzione insert con il codice seguente, quindi fare clic su **Save**:
    ...
    Verrà registrato un nuovo script insert, che utilizza l'[oggetto gcm][oggetto gcm] per inviare una notifica push (il testo inserito) al dispositivo specificato nella richiesta insert.
