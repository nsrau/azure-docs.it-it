...
* Per iniziare rapidamente la distribuzione, usare i comandi seguenti per distribuire un modello locale con parametri inline:
  ...
  Per il completamento della distribuzione sarà necessario attendere alcuni minuti. Al termine, viene visualizzato un messaggio simile a:
...
I comandi seguenti configurano un contenitore dell'account di archiviazione privato e caricano un modello:
