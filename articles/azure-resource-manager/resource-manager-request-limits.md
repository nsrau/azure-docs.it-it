...
Per ogni sottoscrizione e tenant, Resource Manager definisce un limite di 15.000 richieste di lettura e 1.200 richieste di scrittura al giorno. Se l'applicazione o script raggiunge questi limiti, è necessario restringere le richieste. In questo argomento viene illustrato come determinare il numero di richieste rimanenti prima di raggiungere il limite e come rispondere in caso di raggiungimento.
...
Vengono così restituite numerose informazioni, tra cui il valore di risposta seguente:
...
Vengono così restituite numerose informazioni, tra cui l'oggetto seguente:
