...
Per installare e usare l'interfaccia della riga di comando in locale, vedere [Installare l'interfaccia della riga di comando di Azure](/cli/azure/install-azure-cli).
