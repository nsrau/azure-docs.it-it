...
Se non si conosce Resource Manager, è opportuno vedere prima la terminologia definita in [Panoramica di Azure Resource Manager](overview.md).
...
| Elemento | Classico | Azure Resource Manager |
| --- | --- | --- |
