---
title: Spostare le risorse di Rete di Azure in una nuova sottoscrizione o gruppo di risorseMove Azure Networking resources to new subscription or resource group
description: Usare Azure Resource Manager per spostare reti virtuali e altre risorse di rete in un nuovo gruppo di risorse o in una nuova sottoscrizione.
ms.topic: conceptual
ms.date: 10/16/2019
...
---
# <a name="move-guidance-for-networking-resources"></a>Spostare le linee guida per le risorse di reteMove guidance for networking resources

In questo articolo viene descritto come spostare reti virtuali e altre risorse di rete per scenari specifici.
...
## <a name="peered-virtual-network"></a>Rete virtuale con peered
...
## <a name="subnet-links"></a>Collegamenti di subnet
