...
3. Selezionare la risorsa che si vuole aprire.
    ...
    ![Schermata che evidenzia la risorsa selezionata.](./media/manage-resources-portal/manage-azure-resources-portal-open-resource.png)

    Un account di archiviazione ha un aspetto simile al seguente:

    ![Screenshot che mostra l'aspetto di un account di archiviazione.](./media/manage-resources-portal/manage-azure-resources-portal-open-resource-storage.png)
