...
![Account di archiviazione crittografato creato in base alle informazioni di riferimento sui modelli di Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-tutorial-deploy-encrypted-storage-account.png)
...
1. Da Visual Studio Code comprimere il modello a livello di radice. Verrà visualizzata la struttura più semplice, con gli elementi seguenti:
    ...
    ![Struttura più semplice del modello di Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-simplest-structure.png)
...
2. Espandere **resources**, in cui è definita una risorsa `Microsoft.Storage/storageAccounts`. Il modello crea un account di archiviazione non crittografato.
    ...
    ![Definizione di un account di archiviazione nel modello di Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resource.png)
...
3. Selezionare **Riferimento/Riferimento al modello/Archiviazione/&lt;Versione>/Account di archiviazione** come illustrato nello screenshot seguente:
    ...
    ![Account di archiviazione di riferimento al modello di Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts.png)
...
4. Trovare le informazioni della definizione correlate alla crittografia.
    ...
    ![Crittografia dell'account di archiviazione nelle informazioni di riferimento sui modelli di Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption.png)
    ...
    ![Oggetto encryption per l'account di archiviazione nelle informazioni di riferimento sui modelli di Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption-object.png)
...
![Account di archiviazione crittografato del modello di Resource Manager - risorse](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resources.png)
...
![Account di archiviazione crittografato di Azure Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-account.png)
