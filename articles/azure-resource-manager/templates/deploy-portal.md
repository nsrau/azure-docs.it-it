...
Informazioni su come usare la [portale di Azure](https://portal.azure.com) con [Azure Resource Manager](overview.md) per distribuire le risorse di Azure. Per informazioni sulla gestione delle risorse, vedere [gestire le risorse di Azure usando il portale di Azure](../management/manage-resources-portal.md).
...
- Per esportare un modello da una distribuzione o un gruppo di risorse, vedere [esportare Azure Resource Manager modelli](export-template-portal.md).
