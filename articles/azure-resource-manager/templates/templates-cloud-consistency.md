...
Per un'introduzione ai modelli di Azure Resource Manger, vedere [Distribuzione modelli](overview.md).
...
* [Procedure consigliate per i modelli di Azure Resource Manager](template-syntax.md)
