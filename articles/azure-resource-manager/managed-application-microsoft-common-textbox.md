...
Controllo che è possibile usare per modificare il testo non formattato. Usare questo elemento quando si [crea un'applicazione Azure gestita](managed-application-publishing.md).
