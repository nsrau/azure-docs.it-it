...
## <a name="install-the-resource-manager-extension"></a>Installare l'estensione per Resource Manager
...
## <a name="set-up-resource-manager-snippets"></a>Configurare i frammenti di codice di Resource Manager
...
## <a name="work-with-template-in-vs-code"></a>Utilizzare il modello in Visual Studio Code
