---
title: Esplora inventario risorse di Azure | Microsoft Docs
...
---
# <a name="use-azure-resource-explorer-to-view-and-modify-resources"></a>Usare Esplora risorse di Azure per visualizzare e modificare le risorse
...
## <a name="view-resources"></a>Visualizzazione delle risorse
Andare su [https://resources.azure.com](https://resources.azure.com) e accedere con le stesse credenziali usate per il [Portale di Azure](https://portal.azure.com).
...
Dopo avere acquisito familiarità con i modelli di Resource Manager, anche il contenuto del corpo inizierà a sembrare familiare. La sezione **Proprietà** della risposta corrisponde ai valori che è possibile fornire nella sezione **Proprietà** del modello.
...
## <a name="change-resources"></a>Modifica delle risorse
...
## <a name="invoking-the-api-via-powershell"></a>Richiamo dell'API tramite PowerShell
