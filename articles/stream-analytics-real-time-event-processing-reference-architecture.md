<properties 
	pageTitle="Elaborazione di eventi in tempo reale con Analisi dei flussi | Azure" 
...
# Architettura di riferimento: elaborazione di eventi in tempo reale con Analisi dei flussi di Microsoft Azure
