...
Se si vuole eseguire lo strumento da riga di comando su un'altra piattaforma, scaricare Cache Redis di Azure da [http://redis.io/download](https://redis.io/download).
