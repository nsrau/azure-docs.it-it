...
| 10221-10231 |In ingresso |TCP |Comunicazione tra client e cluster Redis, comunicazioni interne per Redis | (Subnet Redis) |(Subnet Redis), Azure Load Balancer, (subnet client) |
