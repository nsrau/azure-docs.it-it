---
title: Documentazione di Cache Redis di Azure - Esercitazioni e informazioni di riferimento sulle API | Microsoft Docs
...
<ul class="panelContent cardsFTitle">
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni sul livello Premium di Cache Redis di Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Catalogo video di Cache Redis di Azure</h3>
                    </div>
                </div>
            </div>
        </div>
   ...
   <li>
        <a href="/azure/azure-cache-for-redis/cache-dotnet-how-to-use-azure-redis-cache">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                    ...
                    <div class="cardText">
                        <h3>Introduzione all'uso di Cache Redis di Azure con .NET</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <a href="/azure/azure-cache-for-redis/cache-web-app-howto">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                    ...
                    <div class="cardText">
                        <h3>Introduzione all'uso di Cache Redis di Azure con ASP.NET MVC</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <a href="/azure/azure-cache-for-redis/cache-nodejs-get-started">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                    ...
                    <div class="cardText">
                        <h3>Introduzione all'uso di Cache Redis di Azure con Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <a href="/azure/azure-cache-for-redis/cache-java-get-started">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                    ...
                    <div class="cardText">
                        <h3>Introduzione all'uso di Cache Redis di Azure con Java</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <a href="/azure/azure-cache-for-redis/cache-python-get-started">
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardImageOuter">
                    ...
                    <div class="cardText">
                        <h3>Introduzione all'uso di Cache Redis di Azure con Python</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3> Ottimizzare le applicazioni Web con la memorizzazione nella cache dei dati di sola lettura con Redis</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Usare dati modificabili e parziali in un'istanza di Cache Redis di Azure</h3>
                    </div>
                </div>
            </div>
        </div>
...
**[Altre risorse di apprendimento interattivo](/learn/browse?products=azure-redis-cache)**
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="http://redis.io/clients">Client Redis</a></p>
                        <p><a href="http://redis.io/commands#">Comandi di Redis</a></p>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://docs.microsoft.com/rest/api/redis/">Informazioni di riferimento sulle API REST</a></p>
                    </div>
                </div>
            </div>
        </div>
