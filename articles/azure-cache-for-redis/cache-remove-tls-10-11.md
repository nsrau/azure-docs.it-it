...
* **ServiceStack.Redis:** Seguire le istruzioni [di ServiceStack.Redis](https://github.com/ServiceStack/ServiceStack.Redis#servicestackredis-ssl-support) e richiede almeno ServiceStack.Redis v5.6.
