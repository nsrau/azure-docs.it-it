...
1. Nella pagina **nozioni di base** configurare le impostazioni per la nuova cache.
    ...
    | **Località** | Selezionare una località. | Selezionare un'[area](https://azure.microsoft.com/regions/) in prossimità di altri servizi che useranno la cache. |
