...
> [!NOTE]
> 
> Archiviazione di Azure crittografa automaticamente i dati quando vengono salvati in modo permanente. È possibile usare le proprie chiavi per la crittografia. Per ulteriori informazioni, vedere [chiavi gestite dal cliente con Azure Key Vault](../storage/common/storage-service-encryption.md).
> 
> 
