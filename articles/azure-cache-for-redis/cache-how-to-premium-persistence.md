...
La persistenza viene configurata nel pannello **Nuova Cache Redis di Azure** durante la creazione della cache e nel **Menu risorse** per le cache premium esistenti.
