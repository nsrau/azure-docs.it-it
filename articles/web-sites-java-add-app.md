<properties urlDisplayName="Add an application to your Java website" pageTitle="Aggiungere un'applicazione a un sito Web Java" metaKeywords="" description="Questa esercitazione illustra come aggiungere una pagina o un'applicazione al sito Web Java in Microsoft Azure." metaCanonical="" services="web-sites" documentationCenter="Java" title="Add an application to your Java website" videoId="" scriptId="" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" />
