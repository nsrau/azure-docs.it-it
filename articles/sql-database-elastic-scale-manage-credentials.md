<properties title="Managing Elastic Scale Credentials" pageTitle="Gestione delle credenziali di scalabilità elastica" description="Come impostare il livello corretto di credenziali, da amministratore a sola lettura, per le app Elastic Scale." metaKeywords="Azure SQL Database, elastic scale, about user credentials in elastic scale" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
