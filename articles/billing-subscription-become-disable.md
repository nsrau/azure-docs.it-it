<properties
	pageTitle="Cosa fare in caso di annullamento della sottoscrizione di Azure | Microsoft Azure"
...
# Cosa fare in caso di annullamento della sottoscrizione di Azure
...
2. Fare clic su **ACCOUNT**, quindi fare clic su **Sottoscrizioni**.
3. Selezionare una sottoscrizione.
4. Se la sottoscrizione è stata disabilitata a causa del raggiungimento del limite di spesa, fare clic sulla notifica "La sottoscrizione ha raggiunto un limite di spesa ed è stata disabilitata per impedire addebiti". In alternativa, fare clic su Rimuovere il limite di spesa nell'area STATO SOTTOSCRIZIONE.
...
- Nel caso di un'azienda, è possibile [passare al metodo di pagamento dell'addebito con fattura](https://azure.microsoft.com/pricing/invoicing/).


## Come abilitare nuovamente la sottoscrizione

Per abilitare nuovamente una sottoscrizione annullata è necessario creare un ticket di supporto. A tale scopo, accedere al [portale di Azure](https://portal.azure.com/), selezionare **Guida e supporto** > **Nuova richiesta di supporto**.
 ...
 * Per inviare un ticket di supporto dal [sito Web del supporto tecnico di Azure](https://azure.microsoft.com/support/options/), fare clic su **Ottenere supporto**.
