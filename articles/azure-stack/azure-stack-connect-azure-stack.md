...
ms.locfileid: "35248687"
---
# <a name="connect-to-azure-stack-development-kit"></a>Connettersi al Kit di sviluppo di Azure Stack
...
* [Rete privata virtuale (VPN)](#connect-with-vpn). Quando ci si connette tramite una VPN, più utenti possono connettersi contemporaneamente dai client di fuori dell'infrastruttura di Azure Stack. Una connessione VPN richiede un programma di installazione.
...
Per testare la connessione del portale, aprire un web browser e passare al portale utenti (https://portal.local.azurestack.external/) o il portale di operatore (https://adminportal.local.azurestack.external/). Eseguire l'accesso e creazione di risorse.  
