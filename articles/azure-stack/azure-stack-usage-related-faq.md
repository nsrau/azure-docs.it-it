 ---
titolo: utilizzo API correlate domande frequenti | Descrizione di Microsoft Docs: metri elenco dello Stack di Azure, confronto con API di Azure-utilizzo, tempo di utilizzo e l'ora di segnalato, codici di errore.
