...
Utilizzare questi passaggi per verificare che Azure Stack sia correttamente registrato con Azure.
...
2. Selezionare **altri servizi** > **Marketplace gestione** > **aggiungere da Azure**.
