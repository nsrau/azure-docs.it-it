...
- Aggiunta del supporto per l'assegnazione di più indirizzi IP per ogni interfaccia di rete.  Per altre informazioni, vedere [assegnare più indirizzi IP alle macchine virtuali usando PowerShell](https://docs.microsoft.com/azure/virtual-network/virtual-network-multiple-ip-addresses-powershell).
...
- Installare l'Hotfix di Stack più recente di Azure per 1808 prima di applicare 1809. Per altre informazioni, vedere [KB 4481066 – Azure Stack hotfix per Azure Stack Hotfix 1.1808.9.117](https://support.microsoft.com/help/4481066/). Anche se Microsoft consiglia l'Hotfix più recente disponibile, la versione minima richiesta per installare 1809 è 1.1808.5.110.
...
- Quando Azure Stack è gestito da System Center Operations Manager (SCOM), assicurarsi di aggiornare il Management Pack per Microsoft Azure Stack alla versione 10.0.3.11 prima di applicare 1809.
