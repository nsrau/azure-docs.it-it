...
### <a name="to-run-get-azurestacklog-on-azure-stack-integrated-systems-version-1804-and-later"></a>Per l'esecuzione di Get-AzureStackLog nello Stack di Azure integrata sistemi 1804 e versioni successive
...
### <a name="to-run-get-azurestacklog-on-azure-stack-integrated-systems-version-1803-and-earlier"></a>Per l'esecuzione di Get-AzureStackLog nello Stack di Azure integrata sistemi 1803 e versioni precedenti
...
- Attualmente, è possibile utilizzare il **FilterByRole** parametro alla raccolta di log di filtro per i ruoli seguenti:
   ...
   | AzurePackConnector     | Provider di identità                 | StorageController          |  
   ...
   | Cloud                  | KeyVaultControlPlane             | Macchine virtuali            |
