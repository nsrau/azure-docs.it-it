...
È il numero di build di aggiornamento di Azure Stack 1711 **20171122.1**.
...
In questa sezione contiene i problemi noti di post-installazione con compilazione **20171122.1**.
