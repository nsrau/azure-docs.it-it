...
- Quando Azure Stack è gestito da System Center Operations Manager (SCOM), assicurarsi di aggiornare il Management Pack per Microsoft Azure Stack alla versione 10.0.3.11 prima di applicare 1808.
...
- [KB 4481066 – Azure Stack hotfix per Azure Stack Hotfix 1.1808.9.117](https://support.microsoft.com/help/4481066/)
...
- Vengono visualizzati più volte e quindi non vengono più visualizzati nel sistema Azure Stack, è possibile visualizzare gli avvisi seguenti:
  ...
  Questo problema viene risolto nella versione più recente [versione dell'hotfix 1808](https://support.microsoft.com/help/4481066/), pertanto assicurarsi di installare questo hotfix, se si è verificato il problema.
