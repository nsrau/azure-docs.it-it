...
La scelta di Azure AD o AD FS può essere determinata dalla modalità in cui si distribuisce Azure Stack: 
...
In base al ruolo di controllo di accesso (RBAC) in Azure Stack è coerente con l'implementazione in Microsoft Azure. È possibile gestire l'accesso alle risorse assegnando i ruoli RBAC appropriati a utenti, gruppi e applicazioni. Per informazioni su come usare RBAC con Azure Stack, vedere gli articoli seguenti:
