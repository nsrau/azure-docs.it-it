...
1. Sfoglia il [repository AzureStackGitHub](https://aka.ms/AzureStackGitHub) e trovare il **101-simple-windows-vm** modello. Salvare il modello in questa posizione: `C:\templates\azuredeploy-101-simple-windows-vm.json`.
