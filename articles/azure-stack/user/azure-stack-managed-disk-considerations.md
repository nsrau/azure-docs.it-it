...
## <a name="convert-to-managed-disks"></a>Convertire in dischi gestiti

È possibile usare il seguente script con i propri valori per convertire una macchina virtuale attualmente sottoposte a provisioning da non gestiti a managed disks
