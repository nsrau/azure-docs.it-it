...
![Registrare](media/azure-stack-kv-manage-powershell/image2.png) quando si richiamano i comandi di insieme di credenziali delle chiavi, è possibile ottenere un errore, ad esempio "la sottoscrizione non è registrata per l'utilizzo dello spazio dei nomi 'Microsoft. keyvault'." Se si verifica un errore, verificare di avere [abilitato il provider di risorse di Key Vault](#enable-your-tenant-subscription-for-vault-operations) seguendo le istruzioni indicate in precedenza.
