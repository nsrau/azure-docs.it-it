...
|Dimensione - Size\Name |vCPU     |Memoria | Dimensioni massime per il disco temporaneo | Velocità effettiva del disco max OS: (IOPS) | Velocità effettiva di archiviazione temporanea massima (IOPS) | Velocità effettiva del disco dati max (IOPS) |
|-----------------|-----|---------|---------|-----|------|-----------|
