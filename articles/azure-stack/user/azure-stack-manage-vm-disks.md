...
**[I dischi gestiti](../../virtual-machines/windows/managed-disks-overview.md)**  semplificare la gestione dei dischi per VM IaaS di Azure per gestire gli account di archiviazione associati ai dischi della macchina virtuale. È sufficiente specificare le dimensioni del disco necessario, e Azure Stack crea e gestisce automaticamente il disco.

Dischi non gestiti, è necessario creare un account di archiviazione per archiviare i dischi. I dischi creati vengono definiti dischi di macchine Virtuali e vengono archiviati in contenitori nell'account di archiviazione.
...
5. Nella creazione gestito pannello disco:
   ...
   - Selezionare il **tipo di origine**.
     ...
     Creare un disco da uno snapshot di un altro disco, da un BLOB in un account di archiviazione o creare un disco vuoto.
