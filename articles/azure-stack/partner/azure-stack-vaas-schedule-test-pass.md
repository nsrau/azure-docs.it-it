...
ms.locfileid: "52426928"
---
# <a name="schedule-your-first-test"></a>Pianificare il primo test
...
- [Distribuire l'agente locale](azure-stack-vaas-local-agent.md) (scelta consigliata)
- [Convalida di un concetti chiave di servizio](azure-stack-vaas-key-concepts.md) (scelta consigliata)
