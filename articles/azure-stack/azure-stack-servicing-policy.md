...
ms.locfileid: "34796424"
---
# <a name="azure-stack-servicing-policy"></a>Azure Stack di manutenzione dei criteri
Questo articolo descrive i criteri di manutenzione per i sistemi Azure Stack integrato e cosa è necessario eseguire per mantenere il sistema in uno stato supportato. 
...
Microsoft prevede di rilasciare i pacchetti di aggiornamento software in la cadenza mensile. Tuttavia, è possibile avere nessuna o più versioni di aggiornamento in un mese. I fornitori di hardware OEM rilasciare gli aggiornamenti eseguiti in base alle esigenze. 
...
- [Aggiornamento dello Stack 1805 Azure](azure-stack-update-1805.md)
- [Aggiornamento dello Stack 1804 Azure](azure-stack-update-1804.md)
...
## <a name="keep-your-system-under-support"></a>Mantenere il sistema previsto il supporto
