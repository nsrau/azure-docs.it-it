...
## [Creare una VM con un certificato dell'insieme di credenziali delle chiavi](azure-stack-kv-push-secret-into-vm.md)
...
### [Aggiungere un provider di risorse del servizio app ad Azure Stack](azure-stack-app-service-deploy.md)
