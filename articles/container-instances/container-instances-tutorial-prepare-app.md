...
Il documento Dockerfile nell'applicazione di esempio illustra come viene compilato il contenitore. Viene avviato da un'[immagine Node.js ufficiale][docker-hub-nodeimage] based on [Alpine Linux][alpine-linux], una piccola distribuzione particolarmente indicata per l'uso con i contenitori. Copia quindi i file dell'applicazione nel contenitore, installa le dipendenze usando Node Package Manager e infine avvia l'applicazione.
