<properties urlDisplayName="Web w/ WebMatrix" pageTitle="Sito Web PHP con MySQL e WebMatrix - Esercitazione su Azure" metaKeywords="" description="Un'esercitazione che illustra come usare l'IDE di WebMatrix gratuito per creare e distribuire un sito Web PHP che archivia i dati in MySQL." metaCanonical="" services="web-sites" documentationCenter="PHP" title="Create and deploy a PHP-MySQL Azure Website using WebMatrix" authors="tomfitz" solutions="" manager="wpickett" editor="mollybos" />
