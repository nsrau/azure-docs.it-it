...
<div class="dev-center-tutorial-selector sublanding"> 
    <a href="/it-it/develop/mobile/tutorials/authorize-users-in-scripts-dotnet" title="Windows Store C#">Windows Store C#</a><a href="/it-it/develop/mobile/tutorials/authorize-users-in-scripts-js" title="Windows Store JavaScript">Windows Store JavaScript</a><a href="/it-it/develop/mobile/tutorials/authorize-users-in-scripts-wp8" title="Windows Phone">Windows Phone</a><a href="/it-it/develop/mobile/tutorials/authorize-users-in-scripts-ios" title="iOS">iOS</a><a href="/it-it/develop/mobile/tutorials/authorize-users-in-scripts-android" title="Android">Android</a><a href="/it-it/develop/mobile/tutorials/authorize-users-in-scripts-html" title="HTML">HTML</a><a href="/it-it/develop/mobile/tutorials/authorize-users-in-scripts-xamarin-ios" title="Xamarin.iOS" class="current">iOS C#</a><a href="/it-it/develop/mobile/tutorials/authorize-users-in-scripts-xamarin-android" title="Xamarin.Android">Android C#</a>
</div>

In questo argomento viene illustrato come utilizzare gli script del server per autorizzare gli utenti autenticati per accedere ai dati in Servizi mobili di Azure da un'app di Xamarin.iOS. In questa esercitazione verranno registrati gli script con Servizi Mobili per filtrare le query in base all'ID utente di un utente autenticato, per garantire che ogni utente possa visualizzare solo i relativi dati.
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [Windows Store C#]: /it-it/develop/mobile/tutorials/authorize-users-in-scripts-dotnet "Windows Store C#"
  [Windows Store JavaScript]: /it-it/develop/mobile/tutorials/authorize-users-in-scripts-js "Windows Store JavaScript"
  [Windows Phone]: /it-it/develop/mobile/tutorials/authorize-users-in-scripts-wp8 "Windows Phone"
  [iOS]: /it-it/develop/mobile/tutorials/authorize-users-in-scripts-ios "iOS"
  [Android]: /it-it/develop/mobile/tutorials/authorize-users-in-scripts-android "Android"
  [HTML]: /it-it/develop/mobile/tutorials/authorize-users-in-scripts-html "HTML"
  [iOS C#]: /it-it/develop/mobile/tutorials/authorize-users-in-scripts-xamarin-ios "Xamarin.iOS"
  [Android C#]: /it-it/develop/mobile/tutorials/authorize-users-in-scripts-xamarin-android "Xamarin.Android"
