...
- [Messaggistica negoziata: richiesta/risposta](http://code.msdn.microsoft.com/Brokered-Messaging-Request-2b4ff5d8) 
- [Procedure consigliate per isolare le applicazioni del bus di servizio da interruzioni ed emergenze del servizio](http://sandboxmsdnstage.redmond.corp.microsoft.com/library/azure/jj554355.aspx)
- [Messaggistica negoziata: richiesta/risposta](http://code.msdn.microsoft.com/windowsazure/Brokered-Messaging-Request-2b4ff5d8) 
- [Applicazione multilivello con il bus di servizio di Azure](http://azure.microsoft.com/documentation/articles/cloud-services-dotnet-multi-tier-app-using-service-bus-queues/)
