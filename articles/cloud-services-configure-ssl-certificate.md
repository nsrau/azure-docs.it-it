...
-   [Passaggio 4: Connettersi all'istanza del ruolo utilizzando HTTPS][Passaggio 4: Connettersi all'istanza del ruolo utilizzando HTTPS]
...
Per eseguire delle prove, è possibile creare e utilizzare un certificato autofirmato. Un certificato autofirmato non è autenticato tramite una CA e può usare il dominio cloudapp.net come URL del sito Web. Nell'attività seguente, ad esempio, viene utilizzato un certificato autofirmato in cui il nome comune è **sslexample.cloudapp.net**. Per informazioni dettagliate sulla creazione di un certificato autofirmato utilizzando Gestione IIS, vedere [Come creare un certificato per un ruolo][Come creare un certificato per un ruolo].
...
1.  Nell'ambiente di sviluppo aprire il file di definizione del servizio
    ...
    Nella sezione**Certificates** è definito il nome del certificato, il relativo percorso e il nome dell'archivio in cui è situato. Si è scelto di archiviare il certificato nell'archivio della CA (Autorità di certificazione) ma sono disponibili anche altre opzioni. Per ulteriori informazioni, vedere [Come associare un certificato a un servizio][Come associare un certificato a un servizio].
...
6.  Nella finestra di dialogo **Aggiungi certificato** immettere il percorso del file PFX
    ...
    **Collega certificato**.
    ...
    ![Aggiungi certificato][Aggiungi certificato]
