...
Per completare questa esercitazione, è necessario disporre di [Mobile Services Android SDK][], [Android SDK][] che include l'IDE (Integrated Development Environment) di Eclipse, il plug-in Android Developer Tools (ADT) e Android 4.2 o versione successiva.
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [guarda l'esercitazione]: http://channel9.msdn.com/Series/Windows-Azure-Mobile-Services/Android-Getting-Started-With-Data-Connecting-your-app-to-Windows-Azure-Mobile-Services
  ...
  [versione di valutazione gratuita di Azure]: http://www.windowsazure.com/it-it/pricing/free-trial/?WT.mc_id=AED8DE357
