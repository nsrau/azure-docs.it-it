---
title: Risolvere i problemi relativi alle connessioni-API REST di Azure
...
Per informazioni su come automatizzare le acquisizioni di pacchetti con gli avvisi della macchina virtuale, vedere [creare un'acquisizione di pacchetti attivata da un avviso](network-watcher-alert-triggered-packet-capture.md).
