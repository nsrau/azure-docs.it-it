---
title: Risolvere i problemi relativi alle connessioni - API REST di AzureTroubleshoot connections - Azure REST API
...
Eseguire lo script seguente per restituire la macchina virtuale. Queste informazioni sono necessarie per eseguire la connettività.
...
Poiché questa operazione ha una lunga esecuzione, l'URI per il risultato viene restituito nell'intestazione della risposta, come illustrato nella risposta seguente:
...
Informazioni su come automatizzare le acquisizioni di pacchetti con gli avvisi delle macchine virtuali visualizzando [Creare un avviso attivato dall'acquisizione di pacchetti.](network-watcher-alert-triggered-packet-capture.md)
