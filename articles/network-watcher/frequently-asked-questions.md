...
### <a name="how-do-i-use-nsg-flow-logs-on-a-storage-account-with-a-firewall"></a>Ricerca per categorie usare i log dei flussi di NSG in un account di archiviazione con un firewall?
