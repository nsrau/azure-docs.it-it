...
1. Nella sezione **monitoraggio** del riquadro sinistro selezionare **monitoraggio connessione (anteprima)**.
   ...
   :::image type="content" source="./media/connection-monitor-2-preview/cm-resource-view.png" alt-text="Screenshot che mostra i monitoraggi connessione creati nell'anteprima di monitoraggio connessione.":::
