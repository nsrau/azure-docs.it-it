...
* Endpoint
    ...
    * resourceId: per gli endpoint di Azure, l'ID risorsa fa riferimento all'ID risorsa Azure Resource Manager (ARM) per le macchine virtuali. Per gli endpoint non di Azure, l'ID risorsa fa riferimento all'ID della risorsa ARM per l'area di lavoro di Log Analytics collegata ad agenti non Azure.
