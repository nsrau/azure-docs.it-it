...
- Il servizio secondario che esegue un'attività segnala se l'esecuzione richiede più tempo del previsto. La segnalazione riguarda l'istanza del servizio della proprietà **PendingTasks**. Questo individua l'istanza del servizio che presenta problemi, ma allo scadere dell'istanza non consente di valutare la situazione, in quanto i report vengono eliminati. È possibile creare report sul servizio secondario. Se l'attività viene completata, l'istanza del servizio secondario elimina il report dall'archivio. Questo non permette di valutare la situazione se il messaggio di acknowledgement viene perso e l'attività non viene completata dal punto di vista del master.
