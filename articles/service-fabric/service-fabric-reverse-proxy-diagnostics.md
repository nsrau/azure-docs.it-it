---
title: Diagnostica del proxy inverso di Azure Service FabricAzure Service Fabric reverse proxy diagnostics
description: Informazioni su come monitorare e diagnosticare l'elaborazione delle richieste nel proxy inverso per un'applicazione di Azure Service Fabric.Learn how to monitor and diagnose request processing at the reverse proxy for an Azure Service Fabric application.
author: kavyako
ms.topic: conceptual
ms.date: 08/08/2017
ms.author: kavyako
...
1. Il proxy inverso restituisce il codice di stato della risposta 504 (timeout).
   ...
   Il primo evento di seguito registra i dettagli della richiesta ricevuti nel proxy inverso. 
   Il secondo evento indica che la richiesta ha avuto esito negativo in fase di inoltro al servizio a causa dell'errore: "internal error = ERROR_WINHTTP_TIMEOUT" 
