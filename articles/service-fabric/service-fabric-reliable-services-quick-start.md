...
Creare quindi un progetto di servizio senza stato denominato **HelloWorldStateless** usando *.Net Core 2.0*:
...
Selezionare **.Net Core 2.0 -> Servizio con stato** e assegnare il nome *HelloWorldStateful*. Fare clic su **OK**.
