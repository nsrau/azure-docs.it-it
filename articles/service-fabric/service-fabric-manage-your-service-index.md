...
- [Proteggere il traffico di replica dei servizi con stato](service-fabric-replication-security.md)
...
- [Esercitazione/procedura dettagliata per l'aggiornamento di un'applicazione](service-fabric-application-upgrade-tutorial.md)
