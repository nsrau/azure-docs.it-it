...
---
# <a name="configure-managed-identity-support-for-a-new-service-fabric-cluster-preview"></a>Configurare il supporto di identità gestite per un nuovo cluster di Service Fabric (anteprima)
