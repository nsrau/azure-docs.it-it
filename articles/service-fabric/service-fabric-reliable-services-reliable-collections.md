...
> [!NOTE]
> Alcuni esempi comuni per le operazioni sulla singola entità `IReliableDictionary.TryGetValueAsync` e `IReliableQueue.TryPeekAsync`.
> 
> 
...
> [!NOTE]
> L'aggiunta di un altro valore di checkpoint migliora le prestazioni del ripristino nella maggior parte dei casi. Questo avviene perché i checkpoint contengono solo le versioni più recenti.
> 
> 
