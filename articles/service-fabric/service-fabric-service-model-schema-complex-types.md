---
title: Tipi complessi dello schema XML del modello di servizio di Azure Service FabricAzure Service Fabric service XML schema complex types
...
|---|---|
|name|Immagine|
|type|[Tipo Immagine](#imagetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
