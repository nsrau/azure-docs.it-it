---
title: Elementi dello schema XML del modello di servizio di Azure Service FabricAzure Service Fabric service model XML schema elements
...
|Attributo|valore|
|---|---|
|type|[Tipo Immagine](service-fabric-service-model-schema-complex-types.md#imagetype-complextype)|
|content|0 elementi, 0 attributi|
