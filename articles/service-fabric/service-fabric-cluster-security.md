...
Per i cluster di Azure, per l'autenticazione dei client e dei certificati per la sicurezza da nodo a nodo è consigliabile usare la sicurezza di AAD.

Per i cluster Windows Server autonomi, se sono presenti Windows Server 2012 R2 e Active Directory è consigliabile usare la sicurezza di Windows con account gestiti di gruppo. In caso contrario, usare comunque la sicurezza di Windows con account di Windows.
