...
Nome del manifesto del servizio. Deve corrispondere al nome dichiarato nell'elemento ServiceManifest del manifesto del servizio.
|Attributo|Valore|
|---|---|
...
Versione del manifesto del servizio. Deve corrispondere alla versione dichiarata nel manifesto del servizio.
|Attributo|Valore|
|---|---|
