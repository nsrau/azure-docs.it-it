...
1. Clonare il repository `Vagrantfile`
    ...
    ```
    Questo passaggio scarica il file `Vagrantfile` contenente la configurazione della VM con il percorso da cui viene scaricata la VM.  Il file punta a un'immagine Ubuntu predefinita.
...
## <a name="install-the-necessary-java-artifacts-on-vagrant-optional-if-you-want-to-use-the-java-programming-models"></a>Installare gli elementi Java necessari in Vagrant (facoltativo se si vogliono usare i modelli di programmazione Java)
