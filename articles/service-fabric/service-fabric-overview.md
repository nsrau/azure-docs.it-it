...
Service Fabric viene attualmente usato in numerosi servizi Microsoft, tra cui database SQL di Azure, Azure DocumentDB, Cortana, Power BI, Microsoft Intune, Hub eventi di Azure, Azure IoT, molti servizi di base di Azure e Skype for Business, solo per citarne alcuni.
...
Per altre informazioni sull'approccio ai microservizi, leggere l'articolo [Perché usare un approccio ai microservizi per la compilazione di applicazioni](service-fabric-overview-microservices.md)
...
Perché non usare semplicemente servizi senza stato per tutti gli scopi? I due motivi principali sono:
...
- Sviluppare applicazioni costituite da microservizi tramite il modello di programmazione di Service Fabric o semplicemente ospitare eseguibili e altri framework di applicazioni a scelta, ad esempio ASP.NET, Node.js e così via.
