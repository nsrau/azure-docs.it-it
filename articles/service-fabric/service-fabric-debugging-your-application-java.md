---
title: Eseguire il debug dell&quot;applicazione Azure Service Fabric in Eclipse | Documentazione Microsoft
...
2. Aggiornare l'elemento entryPoint.sh del servizio di cui eseguire il debug in modo che avvii il processo Java con i parametri di debug remoto. Questo file si trova nel percorso seguente: ``ApplicationName\ServiceNamePkg\Code\entrypoint.sh``. La porta 8001 è impostata per il debug in questo esempio.
