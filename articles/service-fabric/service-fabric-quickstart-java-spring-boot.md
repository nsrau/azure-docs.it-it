...
---
# <a name="quickstart-deploy-a-java-spring-boot-application-to-service-fabric"></a>Avvio rapido: Distribuire un'applicazione Java Spring Boot in Service Fabric
