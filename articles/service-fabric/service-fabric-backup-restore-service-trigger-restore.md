...
È possibile monitorare lo stato di un ripristino con [TrackRestoreProgress](service-fabric-backup-restore-service-trigger-restore.md#tracking-restore-progress).
...
È possibile monitorare lo stato del ripristino usando [TrackRestoreProgress](service-fabric-backup-restore-service-trigger-restore.md#tracking-restore-progress).
