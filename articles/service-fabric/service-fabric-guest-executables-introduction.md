---
title: Creare un pacchetto di un eseguibile esistente in Azure Service FabricPackage an existing executable to Azure Service Fabric
...
* *Config*. Questa directory contiene un file Settings.xml (e altri file, se necessario) a cui il servizio può accedere in fase di esecuzione per recuperare impostazioni di configurazione specifiche.
