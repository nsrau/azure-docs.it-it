...
## [Gestire le applicazioni](service-fabric-application-lifecycle.md)
...
## [Creare e gestire i cluster](service-fabric-deploy-anywhere.md)
...
## Usare un ambiente di sviluppo Linux/Eclipse
