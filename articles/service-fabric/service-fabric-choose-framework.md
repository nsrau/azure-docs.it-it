...
|Si intende usare oggetti a thread singolo continuando a garantire scalabilità e coerenza.|Si intende usare Reliable Collections (come ReliableDictionary e ReliableQueue .NET) per archiviare e gestire lo stato.|
