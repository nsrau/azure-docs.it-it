<properties
   pageTitle="Panoramica della configurazione di ReliableDictionaryActorStateProvider per Reliable Actors dell’infrastruttura di servizi di Azure | Microsoft Azure"
   description="Informazioni sulla configurazione di attori con stato di tipo ReliableDictionaryActorStateProvider nell’infrastruttura di servizi di Azure"
