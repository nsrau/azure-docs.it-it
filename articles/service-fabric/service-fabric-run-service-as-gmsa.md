...
3. Configurare l'entità utente e configurare `RunAsPolicy` per fare riferimento all' [utente](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-fabric-settings#runas).
