...
| --- | --- |
| application-id  |ID dell'applicazione in corso di aggiornamento. <br> Si tratta in genere del nome completo dell'applicazione senza lo schema URI "fabric". A partire dalla versione 6.0, i nomi gerarchici sono delimitati con il carattere "\~". Ad esempio, se il nome dell'applicazione è "Fabric:/MyApp/App1", l'identità dell'applicazione sarà "MyApp @ no__t-0app1" in 6.0 + e "MyApp/App1" nelle versioni precedenti.|
