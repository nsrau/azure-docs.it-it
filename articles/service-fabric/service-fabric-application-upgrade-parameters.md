...
| Parametro | Si applica a | Description |
| --- | --- | --- |
...
> | Conferma |PS| I valori consentiti sono **true** e **false**. Richiede la conferma dell'utente prima di eseguire il cmdlet. |
