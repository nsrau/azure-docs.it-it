...
|    health    | Recupera l'integrità di una replica di un servizio con stato o di un'istanza di un servizio senza stato
                   di Service Fabric.|
|    info      | Mostra le informazioni su una replica di una partizione di Service Fabric.|
|    list      | Mostra le informazioni sulle repliche di una partizione del servizio Service Fabric.|
...
Mostra l'integrità di una replica di Service Fabric. Usare EventsHealthStateFilter per filtrare la raccolta di eventi di integrità riportati nella replica in base allo stato di integrità. .
...
Mostra le informazioni su una replica di una partizione di Service Fabric.
...
Mostra le informazioni sulle repliche di una partizione del servizio Service Fabric.

L'endpoint GetReplicas restituisce le informazioni sulla replica della partizione specificata.
La risposta include l'ID, il ruolo, lo stato, l'integrità, il nome del nodo, il tempo di attività e altri dettagli relativi alla replica.
