...
> [!NOTE] 
> La distribuzione di applicazioni Service Fabric con identità gestite è supportata a partire dalla versione `"2019-06-01-preview"`API. È anche possibile usare la stessa versione API per il tipo di applicazione, la versione del tipo di applicazione e le risorse del servizio. Il runtime di Service Fabric minimo supportato è 6,5 CU2.
