...
>
> [Configurare Windows 10 o Windows Server per i contenitori](https://docs.microsoft.com/virtualization/windowscontainers/quick-start/set-up-environment?tabs=Windows-10-Client)
