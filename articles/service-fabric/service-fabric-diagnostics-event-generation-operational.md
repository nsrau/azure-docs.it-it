...
| EventId | Nome | Category | Descrizione |Origine (attività) | Level |
| --- | --- | ---| --- | --- | --- |
| 61701 | ReliableDictionaryOpened | LifeCycle | È stato aperto un dizionario affidabile | DistributedDictionary (informazioni in lingua inglese) | Informativo |
| 61702 | ReliableDictionaryClosed | LifeCycle | Dizionario affidabile chiuso | DistributedDictionary (informazioni in lingua inglese) | Informativo |
| 61703 | ReliableDictionaryCheckpointRecuperate | LifeCycle | Dizionario affidabile ha recuperato il suo checkpoint | DistributedDictionary (informazioni in lingua inglese) | Informativo |
| 61704 | ReliableDictionaryCheckpointFilesSent | LifeCycle | Replica ha inviato file di checkpoint affidabili del dizionario | DistributedDictionary (informazioni in lingua inglese) | Informativo |
| 61705 | ReliableDictionaryCheckpointFilesReceived | LifeCycle | Replica ha ricevuto file di checkpoint affidabili del dizionario | DistributedDictionary (informazioni in lingua inglese) | Informativo |
| 61963 | ReliableQueueOpened | LifeCycle | La coda affidabile si è aperta | Coda distribuita | Informativo |
| 61964 | ReliableQueueClosed | LifeCycle | Coda affidabile chiusa | Coda distribuita | Informativo |
| 61965 | ReliableQueueCheckpointRecuperarecuperato | LifeCycle | La coda affidabile ha ripristinato il checkpoint | Coda distribuita | Informativo |
| 61966 | ReliableQueueCheckpointFilesSent | LifeCycle | La replica ha inviato file di checkpoint affidabili della coda | Coda distribuita | Informativo |
| 63647 | ReliableQueueCheckpointFilesReceived | LifeCycle | La replica ha ricevuto i file del punto di arresto affidabili della coda | Coda distribuita | Informativo |
| 63648 | ReliableConcurrentQueueOpened | LifeCycle | È stata aperta una coda simultanea affidabile | ReliableConcurrentQueue | Informativo |
| 63649 | ReliableConcurrentQueueClosedClosed | LifeCycle | Coda simultanea affidabile chiusa | ReliableConcurrentQueue | Informativo |
| 63650 | ReliableConcurrentQueueCheckpointRecovered | LifeCycle | La coda simultanea affidabile ha ripristinato il checkpoint | ReliableConcurrentQueue | Informativo |
| 61687 | TStoreError (Errore TStore) | Operazioni non riuscite | La raccolta affidabile ha ricevuto un errore imprevisto | TStore | Errore |
| 63831 | PrimaryFullCopyInitiated | LifeCycle | La replica primaria ha avviato una copia completa | TReplicatore | Informativo |
| 63832 | PrimaryPartialCopyInitiated | LifeCycle | La replica primaria ha avviato una copia parziale | TReplicatore | Informativo |
| 16831 | BuildIdleReplicaStarted | LifeCycle | La replica primaria ha avviato la creazione di una replica inattiva | Replica | Informativo |
| 16832 | BuildIdleReplicaCompleted | LifeCycle | La replica primaria ha completato la replica inattiva dell'edificioPrimary replica has completed building idle replica | Replica | Informativo |
| 16833 | BuildIdleReplicaFailed | LifeCycle | Replica primaria non è riuscita a creare una replica inattiva | Replica | Avviso |
| 16834 | PrimaryReplicationQueueFull | Integrità | La coda di replica della replica primaria è piena | Replica | Avviso |
| 16835 | PrimaryReplicationQueueWarning | Integrità | La coda di replica della replica primaria è quasi piena | Replica | Avviso |
| 16836 | PrimaryReplicationQueueWarningMitigated | Integrità | La coda di replica della replica primaria è attiva | Replica | Informativo |
| 16837 | SecondaryReplicationQueueFull | Integrità | La coda di replica della replica secondaria è piena | Replica | Avviso |
| 16838 | SecondaryReplicationQueueWarning | Integrità | La coda di replica della replica secondaria è quasi piena | Replica | Avviso |
| 16839 | SecondaryReplicationQueueWarningMitigated | Integrità | La coda di replica della replica secondaria è attiva | Replica | Informativo |
| 16840 | PrimaryFaultedSlowSecondary | Integrità | Replica primaria ha avuto un errore in una replica secondaria lenta | Replica | Avviso |
| 16841 | ReplicatorFaulted (Errore di Replicatore) | Integrità | La replica ha avuto un errore | Replica | Avviso |
