...
Questa operazione può essere eseguita solo se è noto che non è possibile recuperare le repliche che non sono attive. Un utilizzo non corretto di questa API può causare una perdita di dati.
