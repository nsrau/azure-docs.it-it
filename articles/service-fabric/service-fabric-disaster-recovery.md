...
## <a name="physical-layout-of-service-fabric-clusters-in-azure"></a>Layout fisico dei cluster Service Fabric in Azure
...
### <a name="individual-machine-failures"></a>Errori dei singoli computer
...
### <a name="multiple-concurrent-machine-failures"></a>Diversi errori simultanei dei computer
...
#### <a name="quorum-loss"></a>Perdita del quorum
...
#### <a name="minimizing-the-risk-of-quorum-loss"></a>Riduzione del rischio di perdita del quorum
...
### <a name="data-center-outages-or-destruction"></a>Interruzioni o distruzione del data center
...
### <a name="software-failures-and-other-sources-of-data-loss"></a>Errori software e altre cause di perdita dei dati
