...
* Monitoraggio del cluster con l'agente di diagnostica e i log di [Monitoraggio di AzureCluster](service-fabric-diagnostics-oms-setup.md) monitoring with [Diagnostics Agent](service-fabric-diagnostics-event-aggregation-wad.md) and Azure Monitor logs
...
* Per informazioni introduttive sulla strumentazione delle applicazioni, vedere Generazione di [log e eventi](service-fabric-diagnostics-event-generation-app.md)a livello di applicazione .
...
* Per ulteriori informazioni sul monitoraggio della piattaforma e sugli eventi forniti da Service Fabric, vedere Generazione di [log e eventi](service-fabric-diagnostics-event-generation-infra.md)a livello di piattaforma.
* Configurare l'integrazione dei log di Monitoraggio di Azure con Service Fabric in [Configurare i log di Monitoraggio](service-fabric-diagnostics-oms-setup.md) di Azure per un clusterConfigure the Azure Monitor logs integration with Service Fabric at Set up Azure Monitor logs for a cluster
