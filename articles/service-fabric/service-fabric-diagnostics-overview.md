...
* Completare i passaggi per configurare l'intelligenza artificiale con [Monitorare e diagnosticare un'applicazione ASP.NET Core in Service Fabric](service-fabric-tutorial-monitoring-aspnet.md)
