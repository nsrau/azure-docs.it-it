<properties
   ...
   description="Questo articolo fornisce un'introduzione all'aggiornamento di un'applicazione dell’infrastruttura di servizi, compresa la scelta delle modalità di aggiornamento e dei controlli di integrità eseguiti."
