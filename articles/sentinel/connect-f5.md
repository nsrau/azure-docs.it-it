---
title: Raccogliere i dati di F5 nell'anteprima di Azure Sentinel | Microsoft Docs
description: Informazioni su come raccogliere dati di F5 Sentinel di Azure.
services: sentinel
