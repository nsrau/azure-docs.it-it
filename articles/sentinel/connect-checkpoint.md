...
È necessario distribuire un agente in un computer Linux dedicato (VM o locale) per supportare la comunicazione tra check point e Azure Sentinel. Il diagramma seguente illustra la configurazione in caso di una macchina virtuale Linux in Azure.
...
## <a name="step-2-forward-check-point-logs-to-the-syslog-agent"></a>PASSAGGIO 2: inviare i log dei punti di controllo all'agente syslog
