...
Per usare POP3 Connector, è necessario innanzitutto creare un'istanza dell'app per le API POP3 Connector. Attenersi alla procedura riportata di seguito:

1.	Aprire Azure Marketplace con l'opzione + NUOVO in basso a sinistra nel portale di Azure.
2.	Andare a "Web e dispositivi mobili > App per le API" e cercare "POP3 Connector".
3.	Configurare POP3 Connector nel modo seguente:
	...
	- **Name**: assegnare un nome a POP3 Connector
	- **Impostazioni pacchetto**
		...
		- **Server Address**: specificare il nome o l'indirizzo IP del server POP3
		- **Server Port**: specificare il numero di porta del server POP3
		- **Enable SSL**: specificare true per usare POP3 su un canale SSL/TLS sicuro
4.	Fare clic su Create. Verrà creato un nuovo POP3 Connector.
...
## Usare POP3 Connector nell'app per la logica ##
