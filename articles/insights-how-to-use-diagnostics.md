...
1.  Nel [portale di gestione di Azure][], fare clic su **Browse**, quindi scegliere **Virtual machines**. Selezionare la macchina virtuale che si desidera monitorare.
...
4.  Per abilitare la diagnostica avanzata, fare clic sul pulsante **Settings** per visualizzare il blade **Diagnostics**. Scegliere **ON**:
    ...
    -   **Windows event system logs**: eventi Windows inviati al canale di sistema, inclusi tutti gli eventi [Microsoft Antimalware][]
...
Al momento non vi è modo di tracciare le metriche con più istanze, quali le metriche per processo o per disco. Per ulteriori informazioni sulla personalizzazione dei grafici di monitoraggio, vedere [Come personalizzare il monitoraggio][].
...
Si noti che le metriche visualizzate solo nel portale di gestione non possono essere oggetto di avvisi nel portale completo. Di conseguenza, alcune regole relative agli avvisi del portale di gestione non sono visibili nel portale completo.
  ...
  [Come personalizzare il monitoraggio]: http://go.microsoft.com/fwlink/?LinkID=394523&clcid=0x409
