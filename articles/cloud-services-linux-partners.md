...
Soluzioni dei partner per Linux in Azure
========================================

Contattare i partner elencati in questa pagina per ricevere assistenza nella distribuzione delle soluzioni cloud basate su Linux in Azure. Effettuare inoltre l'iscrizione per ricevere l'[anteprima gratuita](https://account.windowsazure.com/PreviewFeatures).
...
ScaleXtreme offre ai clienti il potere di compilare, lanciare, monitorare, installare patch e gestire i propri server Windows e Linux su Microsoft Azure e di distribuire e scalare rapidamente la propria infrastruttura di server. ScaleXtreme è basato sul cloud ed esegue la distribuzione in pochi minuti, offrendo ai clienti funzionalità di gestione e automazione dei sistemi "istantanee", senza la necessità distribuire infrastrutture locali. Tra le funzionalità del prodotto vi sono modelli di server e provisioning, monitoraggio, controllo dei budget e dei costi, gestione delle patch e automazione.
...
Dopo aver riconosciuto che il cloud computing era il futuro e aver analizzato il significato della sua adozione sia per le organizzazioni IT sia per gli sviluppatori, abbiamo sviluppato Juju, un innovativo set di strumenti di orchestrazione dei servizi che consente di incapsulare le competenze collegate a un'applicazione (configurazione di dipendenze, relazioni e piattaforma) in un charm.

Un charm di Juju è una raccolta di istruzioni già scritte che consentono di eseguire la distribuzione di un servizio cloud. Oltre 50 charm sono già disponibili per servizi quali Hadoop, PostgreSQL e Drupal e, poiché chiunque può inviarne uno, la varietà si amplia continuamente.
