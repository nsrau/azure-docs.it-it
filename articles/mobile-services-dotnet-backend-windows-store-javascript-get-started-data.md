...
2. Nella finestra di dialogo Gestisci pacchetti NuGet cercare **WindowsAzure.MobileServices.WinJS** nella raccolta di pacchetti online e fare clic per installare il pacchetto NuGet Azure Mobile Services. Chiudere la finestra di dialogo.
...
<!-- URLs. -->
[Convalidare e modificare dati mediante script]: /it-it/develop/mobile/tutorials/validate-modify-and-augment-data-js
