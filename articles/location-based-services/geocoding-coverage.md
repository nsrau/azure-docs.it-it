...
| Region             | Punti di indirizzo<sup>1</sup>|Numeri civici<sup>2</sup>| Livello rete stradale | Livello città | Punti d'interesse |
|-----------------------------------------------------|:---------------:|:--------------:|:------------:|:----------:|:------------------:|
| **Americhe**                                            |                 |                |              |            |                    |
| Anguilla                                            |                 |                |              |      ✓     |          ✓         |
| Antartide                                          |                 |                |              |      ✓     |          ✓         |
...
|Termini|Definizioni|
|--- |--- |
|**<sup>1</sup> - Punto di indirizzo**|Ricavato dall'indice degli indirizzi puntuali nella ricerca online. Questo campo è supportato solo quando lo sono anche la ricerca e la geocodifica.|
|**<sup>2</sup> - Numero civico**|Ricavato dell'indice di interpolazione degli indirizzi nella ricerca online. Questo campo è supportato solo quando lo sono anche la ricerca e la geocodifica.|
|**<sup>3</sup> - Codice assegnato dall'utente**|Codice specifico della ricerca online, non un codice ufficiale ISO 3166-1.|
