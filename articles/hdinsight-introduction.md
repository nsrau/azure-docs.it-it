...
-   [Ecosistema di Hadoop su HDInsight][]: HDInsight offre implementazioni di Pig, Hive, Sqoop, Oozie e Ambari e supporta altri strumenti di business intelligence, quali Excel, SQL Server Analysis Services e Reporting Services, integrati con l'archiviazione BLOB o HDFS e il framework di MapReduce mediante Power Query o Microsoft Hive ODBC Driver. In questa sezione vengono illustrati i processi che verranno gestiti da tali programmi nell'ecosistema di Hadoop.

-   [Scenari Big Data per HDInsight][]: In questa sezione vengono esaminati i tipi di processo per cui è consigliabile utilizzare la tecnologia HDInsight.

-   [Risorse per HDInsight][]: In questa sezione viene indicato dove trovare risorse rilevanti per ottenere ulteriori informazioni.
...
-   È possibile scaricare Microsoft Power Query per Excel dall'[Area download Microsoft][].

-   Microsoft Hive ODBC Driver è disponibile per il download da questo [sito per il download][].

-   Per informazioni su Analysis Services, vedere [SQL Server 2012 Analysis Services][].

-   Per informazioni su Reporting Services, vedere [SQL Server 2012 Reporting][].
...
-   [Documentazione relativa a HDInsight][]: pagina relativa alla documentazione per Azure HDInsight. Include collegamenti ad articoli, video e altre risorse.

-   [Note sulla versione di HDInsight][]: note sulle versioni più recenti.

-   [Introduzione ad Azure HDInsight][]: esercitazione che fornisce indicazioni rapide per iniziare a utilizzare HDInsight.

-   [Esecuzione degli esempi relativi a HDInsight][]: esercitazione relativa alle procedure per l'esecuzione degli esempi inclusi in HDInsight.

-   [Big data e Azure][]: scenari relativi a Big Data, che illustrano i risultati che è possibile ottenere con Azure.

-   [Azure HDInsight SDK][]: documentazione di riferimento per HDinsight SDK.

**Microsoft: Windows e database SQL**

-   [Home page di Azure][]: scenari, iscrizione alla versione di valutazione gratuita, strumenti per lo sviluppo e documentazione necessaria per iniziare a creare applicazioni.

-   [Database SQL di Azure][]: documentazione MSDN relativa a database SQL.

-   [Portale di gestione per database SQL][]: uno strumento semplificato e di facile utilizzo per la gestione di database, che consente di gestire database SQL nel cloud.

-   [Adventure Works per database SQL][]: pagina per il download del database di esempio per database SQL.

**Microsoft: business intelligence**

-   [Connettere Excel a HDInsight mediante Power Query][]: informazioni sulle procedure di connessione di Excel all'account di archiviazione di Azure in cui vengono archiviati i dati associati al cluster HDInsight mediante Microsoft Power Query per Excel.

-   [Connettere Excel a HDInsight mediante Microsoft Hive ODBC Driver][]: informazioni sulle procedure di importazione di dati da Azure HDInsight mediante Microsoft Hive ODBC Driver.

-   [PowerPivot per Microsoft BI][]: informazioni sul download e informazioni generali sullo strumento avanzato per il mashup e l'esplorazione dei dati.

-   [SQL Server 2012 Analysis Services][]: informazioni sul download di una copia di valutazione di SQL Server 2012 e informazioni sulle procedure per la creazione di soluzioni analitiche complete e di livello aziendale che consentono di ottenere osservazioni su cui è possibile intervenire.
...
-   [Apache Hadoop][]: ulteriori informazioni sulla raccolta software di Apache Hadoop, un framework che consente l'elaborazione distribuita di set di dati di grandi dimensioni in cluster di computer.

-   [HDFS][]: ulteriori informazioni sull'architettura e la struttura di Hadoop Distributed File System (HDFS), il sistema di archiviazione principale utilizzato da applicazioni Hadoop.

-   [MapReduce][]: ulteriori informazioni sul framework di programmazione per la scrittura di applicazioni Hadoop in grado di elaborare rapidamente quantità elevate di dati in parallelo su cluster di grandi dimensioni di nodi di calcolo.
  ...
  [Home page di Azure]: http://azure.microsoft.com/en-us/
  [Database SQL di Azure]: http://msdn.microsoft.com/en-us/library/windowsazure/ee336279.aspx
  [Portale di gestione per database SQL]: http://msdn.microsoft.com/en-us/library/windowsazure/gg442309.aspx
  ...
  [PowerPivot per Microsoft BI]: http://www.microsoft.com/en-us/bi/PowerPivot.aspx
