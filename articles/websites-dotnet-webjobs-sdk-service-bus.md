...
**Nota:** se si stanno creando messaggi di coda in un'applicazione che non usa WebJobs SDK, impostare [BrokeredMessage.ContentType](http://msdn.microsoft.com/it-it/library/microsoft.servicebus.messaging.brokeredmessage.contenttype.aspx) su "text/plain".
