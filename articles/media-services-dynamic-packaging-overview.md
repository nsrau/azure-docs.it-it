...
![Codifica statica](./media/media-services-dynamic-packaging/media-services-static-packaging.png)

Il diagramma seguente mostra il flusso di lavoro di creazione dinamica dei pacchetti.

![Codifica dinamica](./media/media-services-dynamic-packaging/media-services-dynamic-packaging.png)
...
- File Dolby Digital Plus Smooth. <!--HONumber=52-->
