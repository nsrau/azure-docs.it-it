...
> [AZURE.NOTE] Questo articolo non si applica ai clienti con Contratto Enterprise. Se in qualsiasi punto dell'articolo sono necessarie altre informazioni, è possibile [contattare il supporto tecnico](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade) per ottenere una rapida risoluzione del problema.
...
>[AZURE.NOTE] Le sottoscrizioni di Azure appartengono a singoli utenti nella directory.

>[AZURE.NOTE] Gli abbonamenti a Office 365 appartengono alla directory stessa. Gli utenti all'interno della directory possono agire sulle sottoscrizioni se hanno le autorizzazioni necessarie.
...
> [AZURE.NOTE] Per eventuali domande, è possibile [contattare il supporto tecnico](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade) per ottenere una rapida risoluzione del problema.
