---
title: Importare ed esportare dati con progetti con Azure Notebook PreviewImport and export data with projects with Azure Notebooks Preview
description: Informazioni su come inserire dati in un progetto di anteprima dei blocchi appunti di Azure da origini esterne e su come esportare dati da un progetto.
ms.topic: how-to
ms.date: 12/04/2018
...
---
# <a name="work-with-data-files-in-azure-notebooks-preview-projects"></a>Usare i file di dati nei progetti di anteprima dei blocchi appunti di AzureWork with data files in Azure Notebooks Preview projects
...
1. All'interno di un blocco appunti in esecuzione, selezionare il comando**Caricamento** **file:** > 
...
1. Selezionare il comando di menu**Download** **file:** > 
