...
- **Soluzione**: assicurarsi che il nome usato sia un nome DNS valido per il cluster, che inizi e termini con un carattere alfanumerico e che non contenga caratteri speciali diversi dal trattino '-', quindi riprovare.
...
- **Soluzione**: specificare un nome utente valido per il cluster DNS e riprovare.
...
<h2><a id="resources"></a>Altre risorse di debug</h2> 
