...
>[AZURE.NOTE] **Nota** Non usare il numero di porta del progetto client HTML. È possibile fare clic con il pulsante destro del mouse sul progetto API e selezionare **Debug > Avvia nuova istanza** per visualizzare una finestra del browser che mostri il numero di porta.
