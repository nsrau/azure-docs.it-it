...
2. Passare all'[editor Swagger online]. Fare clic sulla voce di menu **File -> Paste JSON**.
...
5. Selezionare l'opzione di menu **Generate Server -> JAX-RS** per eseguire lo scaffolding del codice lato server che dovrà essere modificato per aggiungere l'implementazione fittizia.
...
9. Usare [Postman] per effettuare una richiesta al metodo API "ottieni un contatto specifico" disponibile in http://localhost:8080/api/contacts/2.
