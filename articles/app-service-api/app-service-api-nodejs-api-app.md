...
4. Un account [GitHub](https://github.com/)
...
4. Passare alla cartella che contiene il codice sottoposto a scaffolding (in questo caso, la sottocartella *ContactList*).
...
4. Nel pannello **Impostazioni** fare clic su **Origine distribuzione > Scegliere l'origine > Repository Git locale** e quindi fare clic su **OK**.
