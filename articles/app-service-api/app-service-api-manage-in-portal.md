...
Usare il pannello **Host gateway** per tutte le attività da eseguire per le app Web. Per altre informazioni, vedere [Gestire le app Web nel portale](../app-service-web/web-sites-manage.md).
