...
* [Installare i comandi di Azure PowerShell più recenti](/powershell/azure/) se si prevede di configurare l'applicazione automatica delle patch con PowerShell.
