...
description: Informazioni su come modificare l'edizione della macchina virtuale di SQL Server in Azure.
...
- Una [VM di SQL Server in Windows](https://docs.microsoft.com/azure/virtual-machines/windows/sql/virtual-machines-windows-portal-sql-server-provision) registrata con il [provider di risorse per VM SQL](sql-vm-resource-provider-register.md).
