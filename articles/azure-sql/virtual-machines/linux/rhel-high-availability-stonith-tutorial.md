...
> [Esercitazione: Configurare il listener del gruppo di disponibilità per SQL Server nelle macchine virtuali RHEL in Azure](rhel-high-availability-listener-tutorial.md)
