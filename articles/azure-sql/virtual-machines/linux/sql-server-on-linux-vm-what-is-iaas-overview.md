...
> [!NOTE]
> Per visualizzare le immagini di macchine virtuali Linux di SQL Server disponibili, vedere [Panoramica di SQL Server in macchine virtuali di Azure (Windows)](../windows/sql-server-on-azure-vm-iaas-what-is-overview.md).
...
* [Panoramica di Macchine virtuali](../../../virtual-machines/linux/overview.md)
...
* [Domande frequenti su SQL Server nelle macchine virtuali Linux di Azure](frequently-asked-questions-faq.md)
