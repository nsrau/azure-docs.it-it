---
title: 'App Saas: monitorare le prestazioni di molti database'
description: Monitorare e gestire le prestazioni del database SQL di Azure in un'app SaaS multi-tenant
...
ms.locfileid: "86042816"
---
# <a name="monitor-and-manage-performance-of-azure-sql-database-in-a-multi-tenant-saas-app"></a>Monitorare e gestire le prestazioni del database SQL di Azure in un'app SaaS multi-tenant
...
1. Aprire *pool1* (in *tenants1-server \<user\> -* Server) nell' [portale di Azure](https://portal.azure.com).
...
Passare a **Pool2** (in *tenants1- \<user\> * Server) per aprire il pool e monitorarne le prestazioni. Se non viene visualizzato, attendere il completamento del provisioning del nuovo pool.
...
1. Nella [portale di Azure](https://portal.azure.com)passare all'elenco dei database in *tenants1-server- \<user\> * server. 
...
* [Pool elastici SQL](elastic-pool-overview.md)
* [Automazione di Azure](../../automation/automation-intro.md)
* [Log di monitoraggio di Azure](../../sql-database/saas-dbpertenant-log-analytics.md) : esercitazione sulla configurazione e l'uso dei log di monitoraggio di Azure
