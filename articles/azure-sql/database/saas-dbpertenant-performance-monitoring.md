---
title: 'App SaaS: monitorare le prestazioni di più database'
...
1. Aprire *Pool1*, nel server *tenants1-dpt-\<user\>* , nel [portale di Azure](https://portal.azure.com).
...
Passare a **Pool2** (nel server *tenants1-dpt-\<user\>* ) per aprire il pool e monitorarne le prestazioni. Se non viene visualizzato, attendere il completamento del provisioning del nuovo pool.
...
1. Impostare **$DemoScenario = 5, Generare un carico normale e un carico elevato in un tenant singolo (circa 95 DTU)** .
...
* [Log di Monitoraggio di Azure](../../sql-database/saas-dbpertenant-log-analytics.md) - Configurazione e uso dell'esercitazione Log di Monitoraggio di Azure
