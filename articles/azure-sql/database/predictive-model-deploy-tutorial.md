...
Nella [seconda parte](predictive-model-build-compare-tutorial.md) si è appreso come creare ed eseguire il training di più modelli di Machine Learning in R e quindi scegliere quello più accurato.

## <a name="prerequisites"></a>Prerequisiti

* Per la terza parte di questa serie di esercitazioni è necessario aver completato la [**prima parte**](predictive-model-prepare-data-tutorial.md) e la [**seconda parte**](predictive-model-build-compare-tutorial.md).
