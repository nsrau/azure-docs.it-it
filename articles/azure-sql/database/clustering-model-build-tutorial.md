...
* Per la seconda parte di questa esercitazione è necessario aver completato la [**prima parte**](clustering-model-prepare-data-tutorial.md) e i relativi prerequisiti.
...
![Grafico a gomito](./media/clustering-model-build-tutorial/elbow-graph.png)
...
Le medie dei quattro cluster si ottengono usando le variabili definite nella [parte uno](clustering-model-prepare-data-tutorial.md#separate-customers):
...
> [Esercitazione: Distribuire un modello di clustering in R con Machine Learning Services del database SQL di Azure (anteprima)](clustering-model-deploy-tutorial.md)
