...
- [Modelli di progettazione per applicazioni SaaS multi-tenant con il database SQL di Azure](../../sql-database/saas-tenancy-app-design-patterns.md)
...
Per domande, Contattaci nella pagina Microsoft domande e risposte [&per il database SQL](https://docs.microsoft.com/answers/topics/azure-sql-database.html). Aggiungere una richiesta di funzionalità nel [forum dei commenti e suggerimenti sul database SQL](https://feedback.azure.com/forums/217321-sql-database/).
