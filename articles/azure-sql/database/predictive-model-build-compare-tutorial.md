...
Nella [prima parte](predictive-model-prepare-data-tutorial.md) si è appreso come importare un database di esempio e quindi preparare i dati da usare per il training di un modello predittivo in R.
...
* Per la seconda parte di questa esercitazione è necessario aver completato la [**prima parte**](predictive-model-prepare-data-tutorial.md) e i relativi prerequisiti.
...
![Confronto tra i due modelli](./media/predictive-model-build-compare-tutorial/compare-models.png)
...
> [Esercitazione: Distribuire un modello predittivo in R con i Machine Learning Services del database SQL di Azure (anteprima)](predictive-model-deploy-tutorial.md)
