...
ms.locfileid: "84024769"
---
# <a name="create-an-elastic-job-agent-using-powershell"></a>Creare un agente processo elastico con PowerShell
[!INCLUDE[appliesto-sqldb](../includes/appliesto-sqldb.md)]

I [processi elastici](job-automation-overview.md#elastic-database-jobs-preview) permettono l'esecuzione di uno o più script di Transact-SQL (T-SQL) in parallelo tra molti database.
...
![Credenziali dei processi elastici](./media/elastic-jobs-powershell-create/job-credentials.png)
...
Dopo il corretto completamento, dovrebbero essere visibili due nuove tabelle in TargetDb1 e solo una nuova tabella in TargetDb2:
   ...
   ![Verifica delle nuove tabelle in SSMS](./media/elastic-jobs-powershell-create/job-execution-verification.png)
...
> [Gestire processi elastici con Transact-SQL](elastic-jobs-tsql-create-manage.md)
