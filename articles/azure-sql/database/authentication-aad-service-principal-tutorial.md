...
2. Sarà inoltre necessario creare un segreto client per l'accesso. Seguire le indicazioni qui per [caricare un certificato o creare un segreto per l'accesso](../../active-directory/develop/howto-create-service-principal-portal.md#upload-a-certificate-or-create-a-secret-for-signing-in).
