...
- [6. costo per tenant (scala, isolamento, ripristino), 0:09:31](#anchor-image-wtip-min00931)
- [7. modelli di database per multi-tenant: vantaggi e svantaggi, 0:11:59](#anchor-image-wtip-min01159)
- [8. il modello ibrido sfrutta i vantaggi di MT/ST, 0:13:01](#anchor-image-wtip-min01301)
- [9. singolo tenant e multi-tenant: vantaggi e svantaggi, 0:16:44](#anchor-image-wtip-min01644)
- [10. i pool sono convenienti per carichi di lavoro imprevedibili, 0:19:36](#anchor-image-wtip-min01936)
- [11. demo di database per ogni tenant e ST/MT ibrido, 0:20:08](#anchor-image-wtip-min02008)
- [12. modulo dell'app Live che mostra Dojo, 0:20:29](#anchor-image-wtip-min02029)
- [13. MYOB e non un DBA in visione, 0:28:54](#anchor-image-wtip-min02854)
...
- [19. scenari e modelli esaminati nelle esercitazioni, 0:49:10](#anchor-image-wtip-min04910)
...
- [25. demo di script di gestione che effettua il provisioning di un singolo tenant, 0:59:43](#anchor-image-wtip-min05943)
...
- [30. monitoraggio delle prestazioni e della generazione del carico, 1:09:42](#anchor-image-wtip-min10942)
- [31. gestione degli schemi su larga scala, 1:10:33](#anchor-image-wtip-min11033)
...
- [35. Estrarre i dati del tenant in Azure sinapsi Analytics, 1:16:32](#anchor-image-wtip-min11632)
- [36. grafico della distribuzione di vendita giornaliera, 1:16:48](#anchor-image-wtip-min11648)
- [37. wrapping e chiamata a Action, 1:19:52](#anchor-image-wtip-min11952)
- [38. resources per ulteriori informazioni, 1:20:42](#anchor-image-wtip-min12042)
...
[![Diapositiva introduttiva][image-wtip-min00003-brk3120-whole-welcome]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1)
...
#### <a name="6-per-tenant-cost-scale-isolation-recovery-00658"></a>6. costo per tenant (scala, isolamento, ripristino), 0:06:58
...
#### <a name="8-hybrid-model-blends-benefits-of-mtst-01229"></a>8. il modello ibrido sfrutta i vantaggi di MT/ST, 0:12:29
[![Vantaggi offerti da MT/ST per i modelli ibridi][image-wtip-min01301-hybrid]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=749)


&nbsp; <a name="anchor-image-wtip-min01644"></a>
#### <a name="9-single-tenant-vs-multi-tenant-pros-and-cons-01311"></a>9. singolo tenant e multi-tenant: vantaggi e svantaggi, 0:13:11
...
#### <a name="11-demo-of-database-per-tenant-and-hybrid-stmt-01959"></a>11. demo di database per ogni tenant e ST/MT ibrido, 0:19:59
[![Demo di database per tenant e ibridi ST/MT][image-wtip-min02008-demo-st-hybrid]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1199)


&nbsp; <a name="anchor-image-wtip-min02029"></a>
#### <a name="12-live-app-form-showing-dojo-02010"></a>12. modulo dell'app Live che mostra Dojo, 0:20:10
[![Modulo dell'app Live che mostra Dojo][image-wtip-min02029-live-app-form-dojo]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1210)

&nbsp; <a name="anchor-image-wtip-min02854"></a>
#### <a name="13-myob-and-not-a-dba-in-sight-02506"></a>13. MYOB e non un DBA in visione, 0:25:06
[![MYOB e non un DBA in visione][image-wtip-min02854-myob-no-dba]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1506)
...
#### <a name="19-scenarios-and-patterns-explored-in-the-tutorials-04900"></a>19. scenari e modelli esaminati nelle esercitazioni, 0:49:00
[![Scenari e modelli esplorati nelle esercitazioni][image-wtip-min04910-scenarios-tutorials]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=2940)
...
[![Esercitazioni demo e repository GitHub][image-wtip-min05018-demo-tutorials-github]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3012)
...
[![Esplorazione dei modelli][image-wtip-min05620-exploring-patterns]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3375)
...
#### <a name="25-demo-of-management-scripts-provisioning-a-single-tenant-05936"></a>25. demo di script di gestione che effettua il provisioning di un singolo tenant, 0:59:36
...
#### <a name="30-load-generation-and-performance-monitoring-10937"></a>30. monitoraggio delle prestazioni e della generazione del carico, 1:09:37
[![Monitoraggio delle prestazioni e della generazione del carico][image-wtip-min10942-load-generation]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4117)


&nbsp; <a name="anchor-image-wtip-min11033"></a>
#### <a name="31-schema-management-at-scale-10940"></a>31. gestione degli schemi su larga scala, 1:09:40
...
#### <a name="35-extract-tenant-data-into-azure-synapse-analytics-11546"></a>35. Estrarre i dati del tenant in Azure sinapsi Analytics, 1:15:46
[![Estrarre i dati del tenant in Azure sinapsi Analytics][image-wtip-min11632-extract-tenant-data-sql-dw]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4546)
...
#### <a name="37-wrap-up-and-call-to-action-11743"></a>37. wrapping e chiamata a Action, 1:17:43
...
#### <a name="38-resources-for-more-information-12035"></a>38. resources per ulteriori informazioni, 1:20:35
...
[image-wtip-min11632-extract-tenant-data-sql-dw]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min11632-extract-tenant-data-analytics-db-dw.png "Estrarre i dati del tenant in Azure sinapsi Analytics"
