...
- **Isolamento tenant:** &nbsp; Isolamento e prestazioni dei dati (se il carico di lavoro di un tenant influisca su altri).
...
| Isolamento dei tenant | Molto alto | Alta | Basso, ad eccezione di eventuali tenant singoli (soli in un database multi-tenant). |
...
- [Introduzione all'app SaaS Wingtip Tickets di esempio del tenancy del database SQL di Azure][docu-saas-tenancy-welcome-wingtip-tickets-app-384w]
