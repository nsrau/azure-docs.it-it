...
- Correggere le potenziali minacce in tempo reale con il [rilevamento delle minacce avanzato](https://docs.microsoft.com/azure/security/fundamentals/threat-detection#advanced-threat-detection-features-other-azure-services) e gli avvisi di valutazione proattiva delle vulnerabilità. 
