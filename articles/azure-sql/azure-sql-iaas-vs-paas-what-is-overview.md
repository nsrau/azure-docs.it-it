...
Se non si ha familiarità con SQL di Azure, vedere la pagina relativa a *che cos'è* il video SQL di Azure della [serie di video di Azure SQL](https://channel9.msdn.com/Series/Azure-SQL-for-Beginners?WT.mc_id=azuresql4beg_azuresql-ch9-niner)approfondita:
