...
| ---                                                                                        | ---                                                                       | ---                                                                                                       | ---   |
| Activity Log Analytics                                                                     | <ul><li>Insight&nbsp;&&nbsp;Analytics</li><li>Log Analytics</li></ul>     | Gratuito<br> Standard<br> Premium&nbsp;(OMS)<br> Per&nbsp;GB&nbsp;(autonomo)<br> Per&nbsp;nodo&nbsp;(OMS)     | Sono disponibili 90 giorni gratuiti di traffico dati<br>Dati non soggetti al limite del livello gratuito |
...
| Integrità agente                                                                                  | <ul><li>Insight&nbsp;&&nbsp;Analytics</li><li>Log Analytics</li></ul>     | Gratuito<br> Standard<br> Premium&nbsp;(OMS)<br> Per&nbsp;GB&nbsp;(autonomo)<br> Per&nbsp;nodo&nbsp;(OMS)     | Dati non soggetti al limite del livello gratuito |
...
| [Conformità dell'aggiornamento](https://technet.microsoft.com/en-us/itpro/windows/manage/update-compliance-get-started) <br>(Anteprima)                                                             | <ul><li>Insight&nbsp;&&nbsp;Analytics</li><li>Log Analytics</li></ul>     | Gratuito<br> Standard<br> Premium&nbsp;(OMS)<br> Per&nbsp;GB&nbsp;(autonomo)<br> Per&nbsp;nodo&nbsp;(OMS)     | Non sono previsti addebiti per i dati o i nodi<br>Dati non soggetti al limite del livello gratuito |
