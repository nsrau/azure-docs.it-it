...
Dopo avere aggiunto una connessione OMS a Configuration Manager e avere installato l'agente nel computer che esegue il ruolo di sistema del sito del punto di connessione del servizio di Configuration Manager, il passaggio successivo consiste nell'importare le raccolte da Configuration Manager a Log Analytics come gruppi di computer.
...
Dopo aver aggiunto una connessione OMS a Configuration Manager e aver installato l'agente nel computer che esegue il ruolo di sistema del sito del punto di connessione del servizio di Configuration Manager, i dati provenienti dall'agente vengono inviati a Log Analytics. In Log Analytics le raccolte di Configuration Manager vengono visualizzate come [gruppi di computer](log-analytics-computer-groups.md). È possibile visualizzare i gruppi dalla pagina **Configuration Manager** in **Impostazioni\Gruppi di computer**.
