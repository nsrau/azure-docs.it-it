<properties
    pageTitle="Panoramica della raccolta dei dati di Archiviazione di Azure in Log Analytics | Microsoft Azure"
...
Log Analytics supporta i servizi di Azure che scrivono dati usando [log di diagnostica di Azure](../azure-portal/monitoring-overview-of-diagnostic-logs.md). Log Analytics supporta inoltre altri servizi che restituiscono log e metriche in diversi formati e posizioni.  

>[AZURE.NOTE] Quando si inviano dati di diagnostica a un account di archiviazione e quando Log Analytics legge i dati da tale account, vengono addebitate le normali tariffe dati di Azure per l'archiviazione e le transazioni.
