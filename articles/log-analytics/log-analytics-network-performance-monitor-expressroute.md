...
6. Selezionare **Salva** per salvare la configurazione. 
   ...
   ![Configurazione del monitoraggio di ExpressRoute](media/log-analytics-network-performance-monitor/expressroute-configure-discovery.png)
...
![Dashboard di monitoraggio delle prestazioni di rete](media/log-analytics-network-performance-monitor/npm-dashboard-expressroute.png) 
...
![Connessioni di rete virtuale di ExpressRoute](media/log-analytics-network-performance-monitor/expressroute-vnet.png)
...
![Utilizzo della larghezza di banda di ExpressRoute](media/log-analytics-network-performance-monitor/expressroute-peak-utilization.png)
