<properties
    pageTitle="Uso dell'archivio BLOB per IIS e dell'archivio tabelle per gli eventi | Microsoft Azure"
...
>[AZURE.NOTE] Il portale non conferma l'esistenza dell'origine nell'account di archiviazione e non verifica se vengono scritti nuovi dati.
