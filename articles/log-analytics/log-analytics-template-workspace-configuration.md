...
<properties
    pageTitle="Usare i modelli di Azure Resource Manager per creare e configurare un'area di lavoro di Log Analytics | Microsoft Azure"
...
È possibile usare [i modelli di Azure Resource Manager] (../azure-resource-manager/resource-group-authoring-templates.md) per creare e configurare le aree di lavoro di Log Analytics. Ecco alcuni esempi di attività eseguibili con i modelli:
