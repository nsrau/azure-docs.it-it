<properties
    pageTitle="Soluzione Insieme di credenziali delle chiavi di Azure in Log Analytics | Microsoft Azure"
...
>[AZURE.NOTE] Si tratta di una [soluzione disponibile in anteprima](log-analytics-add-solutions.md#log-analytics-preview-solutions-and-features).
...
2.  Configurare Log Analytics per la lettura dei log dall'archivio BLOB usando il processo illustrato in [File JSON nell'archivio BLOB](../log-analytics/log-analytics-azure-storage-json.md).
