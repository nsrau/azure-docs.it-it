...
---
Nota: se si sta usando Microsoft Azure Government Cloud, andare invece all'indirizzo https://review.docs.microsoft.com/it-it/azure/azure-government/documentation-government-services-monitoringandmanagement#log-analytics.
