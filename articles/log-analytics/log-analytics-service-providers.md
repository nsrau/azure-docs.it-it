<properties
    pageTitle="Funzionalità di Log Analytics per i provider di servizi | Microsoft Azure"
...
Per i partner e i provider di servizi che fanno parte del programma per i [Provider di soluzioni cloud (CSP)](https://partner.microsoft.com/Solutions/cloud-reseller-overview), Log Analytics è uno dei servizi di Azure disponibili in una sottoscrizione CSP. 
...
>[AZURE.NOTE] Le soluzioni di backup e di Site Recovery per Log Analytics non sono in grado di connettersi a un insieme di credenziali dei servizi di ripristino e non possono essere configurate in una sottoscrizione CSP.
...
Altre informazioni su quando e perché creare più aree di lavoro sono disponibili in [gestire l'accesso a Log Analytics] (log-analytics-manage-access.md#determine-the-number-of-workspaces-you-need).
