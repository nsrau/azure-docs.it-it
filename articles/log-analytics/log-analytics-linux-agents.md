...
>[AZURE.NOTE] La modifica dei file di configurazione per i contatori delle prestazioni e Syslog vengono sovrascritti se è abilitata la configurazione del portale di OMS. È possibile disabilitare la configurazione nel portale di OMS (per tutti i nodi) o per i singoli nodi eseguendo le operazioni seguenti:
...
### <a name="linux-data-doesn't-appear-in-the-oms-portal"></a>I dati di Linux non vengono visualizzati nel portale di OMS
