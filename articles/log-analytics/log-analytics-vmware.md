...
* Aggiungere la soluzione di monitoraggio VMware alla sottoscrizione tramite il processo descritto in [Installazione di una soluzione di gestione](../monitoring/monitoring-solutions.md#install-a-management-solution).
