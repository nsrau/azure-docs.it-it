<properties 
   pageTitle="Messaggi Syslog in Log Analytics | Microsoft Azure"
...
### <a name="changing-the-syslog-port"></a>Modifica della porta Syslog

L'agente OMS rimane in ascolto dei messaggi Syslog nel client locale sulla porta 25224.  È possibile modificare questa porta aggiungendo la sezione seguente al file di configurazione dell'agente OMS che si trova in **/etc/opt/microsoft/omsagent/conf/omsagent.conf**.  Sostituire 25224 nella voce **porta** con il numero di porta desiderato.  Si noti che è necessario anche modificare il file di configurazione per il daemon Syslog in modo da inviare messaggi a questa porta.
...
L'agente OMS rimane in ascolto dei messaggi Syslog nel client locale sulla porta 25224. Il file di configurazione per il daemon Syslog inoltra i messaggi Syslog inviati dall'applicazione a questa porta, dove vengono raccolti da Log Analytics.
