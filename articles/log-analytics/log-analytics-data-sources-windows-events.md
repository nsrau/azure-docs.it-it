...
# Origini dei dati del registro eventi di Windows in Log Analytics
...
## Configurazione dei registri eventi di Windows

Configurare i registri eventi di Windows nel [menu Dati nelle impostazioni di Log Analytics](log-analytics-data-sources.md/configuring-data-sources).
...
## Ricerche nei log con Eventi Windows
