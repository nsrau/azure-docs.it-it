...
Per completare la procedura descritta in questo argomento, è necessario disporre di un account di Facebook con un indirizzo di posta elettronica verificato e un numero di cellulare. Per creare un nuovo account Facebook, passare a [facebook.com].
...
4. Selezionare **Website** come piattaforma. Scegliere un nome univoco per l'app, quindi fare clic su **Create New Facebook App ID**.
...
9. Se non viene visualizzata una sezione "Website" in basso, fare clic su **Add Platform** e selezionare **Website**. Digitare l'URL del gateway del servizio app in **Site URL**, quindi fare clic su **Save Changes**.
...
## <a name="secrets"> </a>Aggiungere le informazioni di Facebook all'app mobile


12. Accedere [portale di gestione di Azure] e passare al gateway dei servizi app.

13. In **Impostazioni**, scegliere **Identità**, quindi selezionare **Facebook**. Incollare i valori relativi all'ID dell'app e al segreto dell'app ottenuti in precedenza. Fare quindi clic su **Salva**.
