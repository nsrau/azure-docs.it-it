...
1.  [Configurare l'applicazione per l'accesso delegato a SharePoint][Configurare l'applicazione per l'accesso delegato a SharePoint]
2.  [Aggiungere le informazioni di SharePoint al servizio mobile][Aggiungere le informazioni di SharePoint al servizio mobile]
3.  [Ottenere un token di accesso e chiamare l'API di SharePoint][Ottenere un token di accesso e chiamare l'API di SharePoint]
4.  [Creare e caricare un documento di Word][Creare e caricare un documento di Word]
5.  [Testare l'applicazione][Testare l'applicazione]

Per completare questa esercitazione, è necessario:

-   Disporre di Visual Studio 2013 in esecuzione in Windows 8.1
-   Disporre di una sottoscrizione attiva a [SharePoint Online][SharePoint Online]
-   Aver completato l'esercitazione [Autenticare l'app tramite il Single Sign-On di Active Directory Authentication Library][Autenticare l'app tramite il Single Sign-On di Active Directory Authentication Library]. Usare il tenant fornito dalla sottoscrizione a SharePoint.
...
4.  Impostare SP\_Authority come endpoint dell'autorità del tenant AAD. Questo valore deve essere identico a quello usato per l'app client ed è espresso nel formato seguente: <https://login.windows.net/contoso.onmicrosoft.com>

5.  Impostare SP\_ClientSecret specificando il valore del segreto client ottenuto in precedenza.

6.  Impostare SP\_SharePointURL specificando l'URL del sito di SharePoint nel formato <https://contoso-my.sharepoint.com>
...
2.  Creare ora un metodo per aggiungere il file alla raccolta documenti dell'utente:
