...
* Esempi di utilizzo di [.NET (C#) SDK](/dotnet/api/overview/azure/digitaltwins/client?view=azure-dotnet-preview&preserve-view=true) (disponibili in *CommandLoop.cs* )
