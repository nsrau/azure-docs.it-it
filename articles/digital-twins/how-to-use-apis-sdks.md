...
* È attualmente possibile accedere ad SDK per le API di controllo in...
  - [.NET (C#)](https://www.nuget.org/packages/Microsoft.Azure.Management.DigitalTwins/1.0.0-preview.1) ([origine](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/digitaltwins/Microsoft.Azure.Management.DigitalTwins))
  - [Java](https://search.maven.org/artifact/com.microsoft.azure.digitaltwins.v2020_03_01_preview/azure-mgmt-digitaltwins) ([origine](https://github.com/Azure/azure-sdk-for-java/tree/master/sdk/digitaltwins))
...
* È possibile usare .NET (C#) SDK. Attualmente, questo è l'unico SDK pubblicato per interagire con queste API. Per utilizzare .NET SDK...
   - è possibile visualizzare il pacchetto in NuGet: [Azure. DigitalTwins. Core](https://www.nuget.org/packages/Azure.DigitalTwins.Core). 
...
Per usare l'SDK, includere il pacchetto NuGet **Azure. DigitalTwins. Core** con il progetto. Sarà anche necessario il pacchetto **Azure. Identity** .
...
* L'SDK sottostante è `Azure.Core` . Per informazioni di riferimento sull'infrastruttura e sui tipi SDK, vedere la [documentazione dello spazio dei nomi di Azure](https://docs.microsoft.com/dotnet/api/azure?view=azure-dotnet-preview) .
...
:::image type="content" source="media/how-to-use-apis-sdks/metrics.png" alt-text="Pagina metrica di un'istanza di dispositivi gemelli digitali di Azure nel portale di Azure":::
