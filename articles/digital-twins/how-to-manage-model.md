...
Lo stato di rimozione delle autorizzazioni di un modello è incluso nei `DigitalTwinsModelData` record restituiti dalle API per il recupero del modello.
