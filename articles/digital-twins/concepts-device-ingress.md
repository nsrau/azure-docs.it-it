...
### <a name="telemetry-properties"></a>Proprietà di telemetria
 ...
 Il contenuto del payload di un **messaggio** può essere costituito da dati arbitrari con dimensioni massime di 256 KB. Sono previsti alcuni requisiti per le [`Message.Properties`](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices.client.message.properties?view=azure-dotnet) proprietà del tipo. La tabella mostra le proprietà obbligatorie e facoltative supportate dal sistema.
...
- Per informazioni sulle funzionalità di elaborazione dei dati e funzioni definite dall'utente di Azure Digital gemelle, vedere l'articolo relativo all' [elaborazione dei dati e alle funzioni definite dall'utente di Azure Digital Twins](concepts-user-defined-functions.md).
