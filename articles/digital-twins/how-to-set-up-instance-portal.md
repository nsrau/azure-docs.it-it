...
* **URI di reindirizzamento**: *URL di risposta dell'applicazione Azure ad* per l'applicazione Azure ad. È possibile utilizzare `http://localhost` .
