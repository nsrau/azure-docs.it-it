<properties 
	...
	description="Usare Azure PowerShell o API REST per spostare le risorse in un nuovo gruppo di risorse per Gestione risorse di Azure." 
	services="" 
	documentationCenter="" 
	authors="tfitzmac" 
	manager="wpickett" 
...
2. Una risorsa non condivide più lo stesso ciclo di vita delle risorse con cui era stata precedentemente raggruppata. Si desidera spostare la risorsa in un nuovo gruppo di risorse in modo da poterla gestire separatamente rispetto alle altre risorse.
...
I servizi che supportano lo spostamento in un nuovo gruppo di risorse, ma non in una nuova sottoscrizione sono:
...
Sostituire **{source-subscription-id}** e **{source-resource-group-name}** con la sottoscrizione o il gruppo di risorse che attualmente contengono le risorse che si desidera spostare. Usare **2015-01-01** per {api-version}.
