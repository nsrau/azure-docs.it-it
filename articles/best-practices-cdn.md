---
title: Indicazioni sulla rete per la distribuzione di contenuti (CDN) | Documentazione Microsoft
...
---
# <a name="content-delivery-network-cdn-guidance"></a>Indicazioni sulla rete per la distribuzione di contenuti (CDN)
...
È consigliabile limitare l'accesso al contenuto della rete CDN in base al paese. La rete CDN di Azure consente di filtrare le richieste in base al paese di origine e limitare il contenuto recapitato. Per altre informazioni, vedere [Limitare l'accesso al contenuto in base al paese](cdn/cdn-restrict-access-by-country.md).
...
### <a name="search-engine-optimisation"></a>Ottimizzazione motore di ricerca
...
### <a name="url-rewriting"></a>Riscrittura URL
