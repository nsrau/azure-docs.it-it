...
# Come aggiungere unità di codifica mediante l'SDK per .NET
...
Per cambiare il tipo di unità riservata e il numero di unità riservate di codifica mediante l'SDK per .NET, effettuare le seguenti operazioni:
...
Per impostazione predefinita, ogni account di Servizi multimediali può includere un massimo di 25 unità di codifica riservate e cinque unità riservate di streaming su richiesta. È possibile richiedere l'applicazione di un limite superiore mediante l'apertura di un ticket di supporto.
...
10. Attenersi alle istruzioni visualizzate nella pagina successiva, quindi specificare il numero di unità riservate di codifica o di streaming su richiesta necessarie.
