...
> [!TIP]
> Per la versione aggiornata di questo avvio rapido che usa il servizio Azure Kubernetes, vedere [Avvio rapido: Distribuire un cluster di servizio Azure Kubernetes](../../aks/kubernetes-walkthrough.md).
