...
Vedere la [Documentazione su Log Analytics](../../log-analytics/log-analytics-queries.md) per istruzioni dettagliate sulla creazione di query e sull'analisi dei dati di monitoraggio.
