...
Dopo essersi connessi al cluster del servizio contenitore di Azure, è possibile accedere al controller di dominio/sistema operativo e alle API\/Rest correlate tramite http:/localhost: Local-Port. Gli esempi riportati in questo documento presuppongono il tunneling sulla porta 80. Ad esempio, gli endpoint Marathon possono essere raggiunti in URI a partire da http\/:/localhost/Marathon/V2/. 
