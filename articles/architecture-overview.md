...
### [Segregazione delle responsabilità di query e comandi][]
...
Per informazioni sui modelli di progettazione più comuni in Azure, vedere l'argomento relativo ai [modelli di progettazione per il cloud][].
