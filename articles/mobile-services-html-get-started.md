...
## <h2><span class="short-header">Creare una nuova app</span>Creare una nuova app HTML</h2>
...
4. In **Scaricare ed eseguire l'applicazione** fare clic su **Scarica**. 
  	...
  	Vengono scaricati i file del sito Web per l'applicazione _To do list_ di esempio connessa al servizio mobile. Salvare il file compresso nel computer locale e prendere nota del percorso.
...
4. Nel portale di gestione fare clic sulla scheda **Dati** e quindi sulla tabella **TodoItems**.
...
[Introduzione all'autenticazione]: /it-it/develop/mobile/tutorials/get-started-with-data-html
