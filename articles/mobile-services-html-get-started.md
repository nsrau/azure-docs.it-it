...
<p>In questa esercitazione viene illustrato come aggiungere un servizio back-end basato su cloud a un'app HTML mediante Servizi mobili di Azure. In questa esercitazione si creeranno sia un nuovo servizio mobile che una semplice app <em>To do list</em> che archivia i dati dell'app nel nuovo servizio mobile. &Egrave; inoltre possibile visualizzare una versione video dell'esercitazione facendo clic sul fotogramma a destra.</p>
</div>
...
## <span class="short-header">Creazione di una nuova app</span>Creazione di una nuova app HTML
...
<b>Nota</b> 
<p>&Egrave; possibile esaminare il codice che accede al servizio mobile per eseguire una query e inserire i dati, disponibile nel file app.js.</p> 
</div>
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [Chiamata a un'API personalizzata da un'applicazione HTML]: /it-it/documentation/articles/mobile-services-html-call-custom-api
