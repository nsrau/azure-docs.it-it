---
title: Esempio di script di Azure PowerShell - Sottoscrivere una sottoscrizione di Azure | Microsoft Docs
description: Esempio di script di Azure PowerShell - Sottoscrivere una sottoscrizione di Azure
services: event-grid
