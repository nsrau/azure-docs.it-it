...
* **Microsoft.Storage/storageAccounts**: creare un account di archiviazione di Azure.
* **"Microsoft.Storage/storageAccounts/providers/eventSubscriptions**: creare una sottoscrizione di Griglia di eventi di Azure per l'account di archiviazione. 
...
1. Selezionare il collegamento seguente per accedere ad Azure e aprire un modello. Il modello crea un insieme di credenziali delle chiavi e un segreto.
    ...
    [Distribuzione in Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-event-grid-subscription-and-storage%2Fazuredeploy.json)
