...
2. Nella pagina **Crea regola di avviso** verificare che l'argomento sia selezionato per la risorsa. Quindi, fare clic su **Seleziona condizione**. 
    ...
    :::image type="content" source="./media/monitor-event-delivery/alert-select-condition.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::    
3. Nella pagina **Configura logica di segnalazione** , attenersi alla seguente procedura:
    1. Selezionare una metrica o una voce di log attività. In questo esempio, **gli eventi con lettera non recapitabili** sono selezionati. 
        ...
        :::image type="content" source="./media/monitor-event-delivery/select-dead-lettered-events.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::        
    2. Selezionare dimensioni (facoltativo). 
        
        :::image type="content" source="./media/monitor-event-delivery/configure-signal-logic.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::        
    ...
    3. Scorrere verso il basso. Nella sezione **logica di avviso** selezionare un **operatore**, un **tipo di aggregazione**e immettere un **valore soglia**, quindi **fare**clic su fine. In questo esempio viene generato un avviso quando il numero totale di eventi con messaggi non recapitabili è maggiore di 10. 
        ...
        :::image type="content" source="./media/monitor-event-delivery/alert-logic.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::                
4. Tornare alla pagina **Crea regola di avviso** , fare clic su **Seleziona gruppo di azioni**.

    :::image type="content" source="./media/monitor-event-delivery/select-action-group-button.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::
...
6. Nella pagina **Aggiungi gruppo di azione** , attenersi alla seguente procedura:
    ...
    1. Fare clic su **OK** per chiudere la pagina. 
        ...
        :::image type="content" source="./media/monitor-event-delivery/add-action-group-page.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::                   
7. Tornare alla pagina **Crea regola di avviso** , immettere un nome per la regola di avviso e quindi selezionare **Crea regola di avviso**.
    ...
    :::image type="content" source="./media/monitor-event-delivery/alert-rule-name.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::  
8. A questo punto, nella pagina **avvisi** dell'argomento viene visualizzato un collegamento per gestire le regole di avviso se non sono ancora presenti avvisi. Se sono presenti avvisi, selezionare **Gestione regole di avviso** sulla barra degli strumenti.  
    ...
    :::image type="content" source="./media/monitor-event-delivery/manage-alert-rules.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::
...
:::image type="content" source="./media/set-alerts/delivery-failed-events.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::
...
:::image type="content" source="./media/monitor-event-delivery/metric-page-create-alert-button.png" alt-text="Pagina Avvisi - Pulsante Nuova regola di avviso":::   
