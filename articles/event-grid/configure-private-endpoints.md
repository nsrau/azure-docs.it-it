...
|--|--|--|
| None | In sospeso | La connessione viene creata manualmente ed è in attesa di approvazione dal proprietario della risorsa di collegamento privato. |
| Approva | Approvato | La connessione è stata approvata automaticamente o manualmente ed è pronta per essere usata. |
| Respingi | Rifiutato | La connessione è stata rifiutata dal proprietario della risorsa di collegamento privato. |
...
- per `group-ids`specificare `topic` o `domain`. Nell'esempio precedente viene usato `topic`. 
