---
title: "Guida introduttiva: Inviare eventi personalizzati all'endpoint Web - Griglia di eventi, Portale di Azure"
description: "Guida introduttiva: Usare Griglia di eventi di Azure e il portale di Azure per pubblicare un argomento personalizzato e sottoscrivere gli eventi per tale argomento. Gli eventi sono gestiti da un'applicazione Web."
services: event-grid
keywords: ''
author: spelluru
ms.author: spelluru
