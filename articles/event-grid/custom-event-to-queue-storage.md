...
- Se si usa Azure PowerShell nel computer locale invece di usare Cloud Shell nel portale di Azure, assicurarsi di avere la versione 1.1.0 o successiva di Azure PowerShell. Scaricare l'ultima versione di Azure PowerShell nel computer Windows da [Download di Azure - Strumenti da riga di comando](https://azure.microsoft.com/downloads/). 
