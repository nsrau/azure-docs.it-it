...
description: Esempi di Azure PowerShell per Griglia di eventi
services: event-grid
author: tfitzmac
manager: timlt
...
| [Creare un argomento personalizzato](scripts/event-grid-powershell-create-custom-topic.md) | Crea un disco gestito da un disco rigido virtuale specializzato come un disco del sistema operativo o da un disco rigido virtuale di dati come disco dati.  |
| | |
