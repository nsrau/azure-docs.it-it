...
Come gestire un database SQL
============================

In questo argomento viene illustrato come eseguire semplici attività di gestione in un database SQL di Azure.
...
Procedura: Aggiungere account di accesso e utenti al database SQL in Azure
--------------------------------------------------------------------------
