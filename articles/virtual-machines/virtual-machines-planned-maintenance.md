...
## Coppie di aree
Azure organizza un set di coppie di aree e garantisce che solo un'area della coppia sarà sottoposta a manutenzione pianificata. Azure non implementerà un aggiornamento contemporaneo di coppie di aree durante una manutenzione pianificata. Fare riferimento alla tabella seguente per informazioni relative alle coppie di aree correnti:
