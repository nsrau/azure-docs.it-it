<properties
   pageTitle="Usare Docker Machine con Azure | Microsoft Azure"
   description="Viene illustrato come avviare ed eseguire Docker Machine su Ubuntu in Azure, utilizzando il modello di distribuzione classica."
...
2. Caricare il file .cer del certificato in Azure. Nel [portale di Azure classico](https://manage.windowsazure.com), fare clic su **Impostazioni** in basso a sinistra dell’area di servizio (mostrata sotto)
...
## Passaggi successivi
Consultare il [manuale dell'utente di Docker](https://docs.docker.com/userguide/) e creare alcune applicazioni in Microsoft Azure. In alternativa, giocare con [Docker Swarm su Azure] e vedere come [swarm](https://github.com/docker/swarm) può essere usato con docker e Azure.
...
[Docker Swarm su Azure]: virtual-machines-docker-swarm.md
