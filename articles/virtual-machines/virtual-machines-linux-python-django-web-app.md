...
3. Per impostazione predefinita, la nuova macchina virtuale non dispone di un nome di dominio completo (FQDN). È possibile crearne uno seguendo le istruzioni [qui](virtual-machines-linux-portal-create-fqdn.md). Questo passaggio è facoltativo per completare questa esercitazione.
