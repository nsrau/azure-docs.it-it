---
title: Ottimizzazione della VM Linux su Azure | Microsoft Docs
...
Nelle immagini cloud Ubuntu, è necessario usare cloud-init per configurare la partizione di scambio. Per ulteriori informazioni, vedere la pagina seguente del wiki di Ubuntu: [AzureSwapPartitions](https://wiki.ubuntu.com/AzureSwapPartitions).
...
> [!NOTE]
> Impostare questa opzione solo per /dev/sda è inutile. Deve essere impostata su tutti i dischi dati in cui la modalità I/O sequenziale domina il modello I/O.  
> 
> 
...
* [Ottimizzazione delle prestazioni di MySQL in macchine virtuali Linux di Azure](virtual-machines-linux-classic-optimize-mysql.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)
