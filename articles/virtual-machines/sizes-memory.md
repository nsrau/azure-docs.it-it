...
- [Dv2 e DSv2-serie,](dv2-dsv2-series-memory.md)un follow-on alla serie D originale, dispone di una CPU più potente. La serie Dv2 è circa 35% più veloce rispetto alla serie D. &reg; Funziona sui processori Intel&reg; Xeon 8171M da 2,1&reg; GHz&reg; (Skylake) o Intel Xeon E5-2673&reg; v4&reg; da 2,3 GHz (Broadwell) o Intel Xeon E5-2673 v3 da 2,4 GHz (Haswell) e con Intel Turbo Boost Technology 2.0. La serie Dv2 ha le stesse configurazioni di memoria e disco della serie D.
...
- Il processore [Intel](ev3-esv3-series.md) &reg; &reg; Xeon 8171M 2.1 GHz (Skylake) o Intel&reg; Xeon&reg; E5-2673 v4 da 2,3 GHz (Broadwell) in una configurazione con hyperthreading, fornendo una migliore proposta di valore per la maggior parte dei carichi di lavoro generici e portando l'Ev3 all'allineamento con le VM di uso generale della maggior parte degli altri cloud. La memoria è stata espansa (da 7 GiB/vCPU a 8 GiB/vCPU) mentre i limiti del disco e della rete sono stati regolati su base per core per allinearsi con il passaggio all'hyper-threading. La serie Ev3 rappresenta un passo avanti rispetto alle dimensioni delle macchine virtuali con memoria elevata delle famiglie D/Dv2.
...
- La [serie Mv2](mv2-series.md) offre il numero di vCPU più alto (fino a 416 vCPU) e la memoria più grande (fino a 11,4 TiB) di qualsiasi VM nel cloud. È ideale per database estremamente grandi o altre applicazioni che traggono vantaggio da elevati conteggi vCPU e grandi quantità di memoria.
