...
Per controllare l'accesso all'account di archiviazione, ottenere la chiave di archiviazione con [az storage account key list](/cli/azure/storage/account/key#list) come segue:
