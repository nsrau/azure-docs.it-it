...
| SUSE | SLES 12-SP4 | 12-SP4 | SUSE: SLES: 12-SP4: più recente | Solo il disco dati |
...
Per abilitare la funzionalità Crittografia dischi di Azure, è necessario che le macchine virtuali Linux soddisfino i requisiti di configurazione degli endpoint di rete seguenti:
  - Per ottenere un token per la connessione all'insieme di credenziali delle chiavi, la VM Linux deve essere in grado di connettersi a \[un\]endpoint Azure Active Directory, login.microsoftonline.com.
