...
Per ulteriori informazioni ed esempi, vedere la [procedura dettagliata per creare coppie di chiavi SSH](create-ssh-keys-detailed.md).
...
Il comando seguente crea una coppia di chiavi SSH usando la crittografia RSA e una lunghezza di bit di 4096:
