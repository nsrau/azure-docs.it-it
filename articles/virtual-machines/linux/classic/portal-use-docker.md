...
ms.locfileid: "33945403"
---
# <a name="using-the-docker-vm-extension-with-the-azure-portal"></a>Uso dell'estensione della VM Docker con il portale di Azure
> [!IMPORTANT] 
...
Creare il certificato e i file di chiave per la comunicazione di Docker seguendo le istruzioni di [Eseguire Docker con https], quindi inserirli nella directory **`~/.docker`** sul computer client.
...
È ora possibile passare alla [guida dell'utente di Docker] e usare la VM Docker. Per automatizzare la creazione di host Docker in macchine virtuali di Azure tramite l'interfaccia della riga di comando, vedere [Come usare l'estensione della VM Docker dall'interfaccia della riga di comando di Azure (CLI di Azure)]
...
[Eseguire Docker con https]:http://docs.docker.com/articles/https/
