...
Assegnare a Image Builder l'autorizzazione per creare risorse nel gruppo di risorse immagine. Il valore `--assignee` è l'ID di registrazione dell'app per il servizio Generatore di immagini. 
