---
title: Punteggi di benchmark di calcolo per le macchine virtuali di Azure LinuxCompute benchmark scores for Azure Linux VMs
...
Nota: le macchine virtuali di serie avrompuò possono essere distribuite in diversi tipi di hardware e processori (come illustrato in precedenza). Le macchine virtuali avventate di serie dispongono di configurazioni di memoria e prestazioni della CPU più adatte per carichi di lavoro entry level come sviluppo e test. La dimensione viene limitata per offrire prestazioni del processore relativamente coerenti per l'istanza in esecuzione, indipendentemente dall'hardware in cui viene distribuita; tuttavia, il software che sfrutta specifiche ottimizzazioni del processore più recenti può vedere variazioni più significative tra i tipi di processore.
...
Nota: le macchine virtuali della serie B sono destinate ai carichi di lavoro con requisiti di prestazioni con requisiti di prestazioni con burstable. Le istanze di macchine virtuali accumulano crediti quando si usano meno del basale. Quando la macchina virtuale ha accumulato credito, la macchina virtuale può superare la linea di base usando fino al 100% per soddisfare i requisiti di burst della CPU brevi. Il tempo di burst dipende dai crediti disponibili, che è una funzione delle dimensioni e del tempo della macchina virtuale.  

CoreMark è un test a esecuzione breve che in genere viene completato all'interno dei crediti burst disponibili.  Pertanto i numeri precedenti rappresentano in genere le prestazioni burst della macchina virtuale, che riflettono ciò che le prestazioni brevi e bursty dei carichi di lavoro (tipiche delle serie B) in genere vengono visualizzate.
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - Ottimizzazione della memoria - Archiviazione Premium (isolata)
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 - Ottimizzazione della memoria (isolata)
...
## <a name="lv2---storage-optimized"></a>Lv2 - Ottimizzazione dello storage
(14/03/2019 5:49:04 PM pbi 3897709)

| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | StdDev | Deviazione standard % | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 Processore a 32 core | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 Processore a 32 core | 16 | 2 | 125.9 | 154,829 | 3,708 | 2,40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 Processore a 32 core | 32 | 4 | 251.9 | 310,811 | 7,751 | 2,49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 Processore a 32 core | 64 | 8 | 503.9 | 595,140 | 14,572 | 2,45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 Processore a 32 core | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |

## <a name="ls---storage-optimized"></a>Ls - Con ottimizzazione per l'archiviazione
(3/12/2019 10:22:29 PM 3897709)
...
## <a name="ncsv3---gpu-enabled"></a>NCSv3 - GPU abilitato
(21/03/2019 5:48:37 PM pbi 3897709)

| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | StdDev | Deviazione standard % | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v3 | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 6 | 1 | 110.2 | 106,929 | 353 | 0.33% | 49 |
| Standard_NC12s_v3 | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 12 | 1 | 220.4 | 213,585 | 875 | 0.41% | 42 |
| Standard_NC24rs_v3 | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 24 | 2 | 440.9 | 403,554 | 6,705 | 1.66% | 42 |
| Standard_NC24s_v3 | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 24 | 2 | 440.9 | 403,874 | 7,603 | 1.88% | 42 |

## <a name="ncsv2---gpu-enabled"></a>NCSv2 - GPU abilitato
(3/12/2019 11:19:19 PM pbi 3897709)

| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | StdDev | Deviazione standard % | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v2 | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 6 | 1 | 110.2 | 107,115 | 321 | 0.30% | 63 |
| Standard_NC12s_v2 | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 12 | 1 | 220.4 | 213,814 | 656 | 0.31% | 63 |
| Standard_NC24rs_v2 | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 24 | 2 | 440.9 | 401,728 | 6,995 | 1,74% | 63 |
| Standard_NC24s_v2 | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 24 | 2 | 440.9 | 402,808 | 7,923 | 1.97% | 63 |

## <a name="nc---gpu-enabled"></a>NC - GPU abilitato
(3/12/2019 11:08:03 PM pbi 3897709)

| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | StdDev | Deviazione standard % | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6 | CPU Intel(R) Xeon(R) E5-2690 v3 - 2,60 GHz | 6 | 1 | 55.0 | 102,211 | 658 | 0.64% | 259 |
| Standard_NC12 | CPU Intel(R) Xeon(R) E5-2690 v3 - 2,60 GHz | 12 | 1 | 110.2 | 203,523 | 2,293 | 1,13% | 259 |
| Standard_NC24 | CPU Intel(R) Xeon(R) E5-2690 v3 - 2,60 GHz | 24 | 2 | 220.4 | 382,897 | 8,712 | 2,28% | 259 |
| Standard_NC24r | CPU Intel(R) Xeon(R) E5-2690 v3 - 2,60 GHz | 24 | 2 | 220.4 | 383,171 | 9,166 | 2.39% | 259 |

## <a name="nds--gpu-enabled"></a>ND- GPU abilitato
(3/12/2019 11:19:10 PM 3897709)

| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | StdDev | Deviazione standard % | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_ND6s | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 6 | 1 | 110.2 | 107,095 | 353 | 0.33% | 63 |
| Standard_ND12s | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 12 | 1 | 220.4 | 212,298 | 3,457 | 1,63% | 63 |
| Standard_ND24rs | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 24 | 2 | 440.9 | 402,749 | 7,838 | 1.95% | 56 |
| Standard_ND24s | CPU Intel(R) Xeon(R) E5-2690 v4 - 2,60 GHz | 24 | 2 | 440.9 | 401,822 | 7,776 | 1,94% | 63 |

## <a name="nv---gpu-enabled"></a>NV - GPU abilitato
(3/12/2019 11:08:13 PM pbi 3897709)

| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | StdDev | Deviazione standard % | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NV6 | CPU Intel(R) Xeon(R) E5-2690 v3 - 2,60 GHz | 6 | 1 | 55.0 | 101,728 | 2,094 | 2,06% | 259 |
| Standard_NV12 | CPU Intel(R) Xeon(R) E5-2690 v3 - 2,60 GHz | 12 | 1 | 110.2 | 203,903 | 1,724 | 0.85% | 252 |
| Standard_NV24 | CPU Intel(R) Xeon(R) E5-2690 v3 - 2,60 GHz | 24 | 2 | 220.4 | 379,879 | 8,737 | 2,30% | 259 |
