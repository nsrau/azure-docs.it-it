...
Per usare un listener del gruppo di disponibilità per i server SQL, sarà necessario creare e configurare un servizio di bilanciamento del carico.

> [!div class="nextstepaction"]
> [Esercitazione: Configurare il listener del gruppo di disponibilità per SQL Server nelle macchine virtuali RHEL in Azure](sql-server-linux-rhel-ha-listener-tutorial.md)
