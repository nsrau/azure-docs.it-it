...
* Accedere a Cloud Shell nel Web browser all' [https://shell.azure.com](https://shell.azure.com) indirizzo o nel [portale di Azure](https://portal.azure.com). 
