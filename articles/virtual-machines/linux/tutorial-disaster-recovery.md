...
5. In **Rivedi e avvia replica** verificare le impostazioni:
    ...
    - **Impostazioni estensione**. Indica che Site Recovery gestirà gli aggiornamenti all'estensione Servizio di mobilità di Site Recovery installata nelle macchine virtuali di cui si esegue la replica. L'account di Automazione di Azure indicato gestisce il processo di aggiornamento.
