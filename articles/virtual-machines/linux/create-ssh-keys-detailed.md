...
Per generare chiavi SSH e usarle per connettersi a da un computer **Windows** , vedere [come usare le chiavi SSH con Windows in Azure](ssh-from-windows.md).
