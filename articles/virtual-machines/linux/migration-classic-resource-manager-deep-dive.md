...
description: Approfondimento tecnico sulla migrazione delle risorse supportate dalla piattaforma dal modello di distribuzione classica a Azure Resource ManagerTechnical deep dive on platform-supported migration of resources from the classic deployment model to Azure Resource Manager
author: tanmaygore
manager: vashan
