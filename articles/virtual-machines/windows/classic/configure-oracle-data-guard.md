...
> [!IMPORTANT]
> Questa esercitazione è stata predisposta e testata con la seguente configurazione hardware e software:
> 
...
> [!IMPORTANT]
> Se si usa Oracle Database 12c, esiste un nuovo utente **SYSDG**, che è possibile usare per amministrare Oracle Data Guard. Per altre informazioni, vedere le [modifiche della versione Oracle Database 12c](http://docs.oracle.com/database/121/UNXAR/release_changes.htm#UNXAR404).
> 
> 
...
> [!IMPORTANT]
> Non usare l'autenticazione del sistema operativo perché nella macchina del server di standy non è ancora presente alcun database.
> 
> 
...
[Immagini di macchine virtuali Oracle per Azure](oracle-images.md)
