...
## <a name="optional-generalize-the-vm"></a>Facoltativo: Generalizzare la macchina virtualeOptional: Generalize the VM

Se si vuole usare il disco rigido virtuale come [immagine](tutorial-custom-images.md) per creare altre macchine virtuali, è necessario usare [Sysprep](https://docs.microsoft.com/windows-hardware/manufacture/desktop/sysprep--generalize--a-windows-installation) per generalizzare il sistema operativo. 
...
6. In Opzioni di arresto selezionare **Shutdown**e quindi fare clic su **OK**. 
...
1. L'ora di scadenza predefinita dell'URL è *3600* secondi. Aumentare questo a **36000** per i dischi del sistema operativo Windows.
