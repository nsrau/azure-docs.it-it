...
### <a name="create-a-key-vault-with-azure-cli"></a>Creare un insieme di credenziali delle chiavi con la CLI di Azure
...
### <a name="create-a-key-vault-with-a-resource-manager-template"></a>Creare un insieme di credenziali delle chiavi con un modello di Gestione risorse
...
### <a name="set-up-an-azure-ad-app-and-service-principal-though-the-azure-portal"></a>Configurare un'app Azure AD e un'entità servizio tramite l'portale di Azure
...
## <a name="set-the-key-vault-access-policy-for-the-azure-ad-app"></a>Impostare i criteri di accesso di Key Vault per l'app Azure AD
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-powershell"></a>Impostare i criteri di accesso di Key Vault per l'app Azure AD con Azure PowerShell
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-cli"></a>Impostare i criteri di accesso di Key Vault per l'app Azure AD con l'interfaccia della riga di comando di Azure
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-the-portal"></a>Impostare i criteri di accesso dell'insieme di credenziali delle chiavi per l'app Azure AD con il portale
...
### <a name="set-key-vault-advanced-access-policies-with-azure-powershell"></a>Impostare i criteri di accesso avanzati di Key Vault con Azure PowerShell
...
### <a name="set-key-vault-advanced-access-policies-using-the-azure-cli"></a>Impostare i criteri di accesso avanzati di Key Vault usando l'interfaccia della riga di comando
...
### <a name="set-key-vault-advanced-access-policies-through-the-azure-portal"></a>Impostare i criteri di accesso avanzati di Key Vault tramite il portale di Azure
