...
<sup>1</sup> Mv2-Series non supporta le immagini di macchina virtuale di prima generazione e supporta solo un subset di immagini di generazione 2. Per informazioni dettagliate, vedere la [documentazione della serie Mv2](https://docs.microsoft.com/azure/virtual-machines/mv2-series) .
...
> [!NOTE]
> Le dimensioni specifiche delle macchine virtuali, ad esempio Mv2, possono supportare solo un subset di queste immagini. per informazioni dettagliate, vedere la documentazione relativa alle dimensioni della macchina virtuale pertinente.
