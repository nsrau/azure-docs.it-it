...
> [!IMPORTANT]
> Supporto di Azure per macchine virtuali di generazione 2 è attualmente in anteprima.
> Questa versione di anteprima viene fornita senza un contratto di servizio e non è consigliabile per i carichi di lavoro di produzione. Alcune funzionalità potrebbero non essere supportate o potrebbero presentare funzionalità limitate.
...
* Informazioni su come [preparare un disco rigido virtuale](prepare-for-upload-vhd-image.md) da caricare da sistemi locali in Azure.
