...
* [Procedure consigliate per le prestazioni per SQL Server in Macchine virtuali di AzurePerformance Best Practices for SQL Server in Azure Virtual Machines](sql/virtual-machines-windows-sql-performance.md)
