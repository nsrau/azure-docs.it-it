...
Eventi pianificati è disponibile per VM sia Linux che Windows. Per informazioni su Eventi pianificati in Linux, vedere [Eventi pianificati per macchine virtuali Linux](../linux/scheduled-events.md).
