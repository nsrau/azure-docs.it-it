...
1. Selezionare **Azure SQL** dal menu a sinistra nel portale di Azure. Se **Azure SQL** non è presente nell'elenco, selezionare **Tutti i servizi**, quindi digitare *Azure SQL* nella casella di ricerca.
