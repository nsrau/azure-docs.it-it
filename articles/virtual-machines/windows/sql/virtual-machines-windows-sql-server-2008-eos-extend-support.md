...
- **Backup di SQL Server**: usare backup di Azure per proteggere gli EOS SQL Server 2008 e 2008 R2 rispetto al ransomware, all'eliminazione accidentale e al danneggiamento con RPO 15 minuti e il recupero temporizzato. Per altri dettagli, vedere [questo articolo](https://docs.microsoft.com/azure/backup/sql-support-matrix#scenario-support).
...
* [Fine del supporto](/sql/sql-server/end-of-support/sql-server-end-of-life-overview) & per[aggiornamenti della sicurezza estesi](/sql/sql-server/end-of-support/sql-server-extended-security-updates)