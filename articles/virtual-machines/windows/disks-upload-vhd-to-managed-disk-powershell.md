...
Per generare una firma di accesso condiviso scrivibile del disco gestito vuoto `<yourdiskname>`, `<yourresourcegroupname>`sostituire e, quindi usare i comandi seguenti:
