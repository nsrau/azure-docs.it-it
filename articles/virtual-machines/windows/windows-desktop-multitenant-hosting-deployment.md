...
- Altre informazioni sulla [configurazione di un disco rigido virtuale per Windows 10](https://docs.microsoft.com/en-us/windows/deployment/vda-subscription-activation)
