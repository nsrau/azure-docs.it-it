---
title: Creare una VM di SQL Server classica (PowerShell)
...
Per la versione di Resource Manager di questo argomento, vedere [Effettuare il provisioning di una macchina virtuale di SQL Server con Azure PowerShell (Resource Manager)](../../../azure-sql/virtual-machines/windows/create-sql-vm-powershell.md).
