...
1. Installare [Java](https://aka.ms/azure-jdks), se non lo si è già fatto.
...
* Altre informazioni sull'uso delle [librerie di Azure per Java](https://docs.microsoft.com/java/azure/java-sdk-azure-overview).
