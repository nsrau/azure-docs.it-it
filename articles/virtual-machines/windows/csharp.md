---
title: Creare e gestire una macchina virtuale di Azure usando C#
...
Per aggiungere un disco dati alla macchina virtuale, aggiungere questo codice al metodo Main. Questo esempio aggiunge un disco dati di dimensioni pari a 2 GB, un LUN pari a 0 e un tipo di memorizzazione nella cache ReadWrite:
