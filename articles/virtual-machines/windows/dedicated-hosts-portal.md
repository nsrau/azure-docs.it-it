---
title: Distribuire host dedicati di Azure tramite il portaleDeploy Azure dedicated hosts using the portal
description: Distribuire macchine virtuali in host dedicati tramite il portale.
author: cynthn
...
- È anche possibile distribuire un host dedicato usando [Azure PowerShell.You](dedicated-hosts-powershell.md)can also deploy a dedicated host using Azure PowerShell .
