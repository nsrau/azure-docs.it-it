...
Se si usa PowerShell e avere installato il modulo di Aure PowerShell possono inoltre connettersi tramite il `Get-AzRemoteDesktopFile` cmdlet, come illustrato di seguito.
