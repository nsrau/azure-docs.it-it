...
* Per informazioni su come copiare una VM generalizzata, vedere [Come creare un'immagine di VM da una VM di Azure esistente](capture-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
* Per caricare un disco rigido virtuale da una VM locale, ad esempio una VM creata mediante Hyper-V, vedere [Caricare l'immagine di una VM Windows in Azure per distribuzioni di Resource Manager](upload-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
* È possibile creare una nuova VM [collegando la copia del disco rigido virtuale a una macchina VM come disco del sistema operativo](create-vm-specialized.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
