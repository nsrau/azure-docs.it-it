---
title: Eseguire la migrazione di macchine virtuali di Azure in dischi gestitiMigrate Azure VMs to Managed Disks
...
|Convertire una singola macchina virtuale dalla versione classica a Resource Manager nei dischi gestitiConvert a single VM from classic to Resource Manager on managed disks     |[Creare una macchina virtuale da un disco rigido virtuale classico](create-vm-specialized-portal.md)         |
|Convertire tutte le macchine virtuali in una rete virtuale da versione classica a Resource Manager nei dischi gestitiConvert all the VMs in a vNet from classic to Resource Manager on managed disks     |[Eseguire la migrazione di risorse IaaS dal modello di distribuzione classico a Resource Manager](migration-classic-resource-manager-ps.md) e quindi [convertire una macchina virtuale da dischi non gestiti in dischi gestiti](convert-unmanaged-to-managed-disks.md)         |
|Aggiornare le macchine virtuali con dischi non gestiti standard a macchine virtuali con dischi Premium gestitiUpgrade VMs with standard unmanaged disks to VMs with managed premium disks     | In primo luogo, [convertire una macchina virtuale Windows da dischi non gestiti in dischi gestiti](convert-unmanaged-to-managed-disks.md). Aggiornare [quindi il tipo di archiviazione di un disco gestito.](convert-disk-storage.md)         |

[!INCLUDE [classic-vm-deprecation](../../../includes/classic-vm-deprecation.md)]

## <a name="next-steps"></a>Passaggi successivi

- Ulteriori informazioni sui [dischi gestiti](managed-disks-overview.md)
