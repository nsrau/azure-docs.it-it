...
Si prega di notare che il pannello di controllo Nvidia è accessibile solo con l'installazione del driver GRID. Se sono stati installati driver CUDA, il pannello di controllo Nvidia non sarà visibile.
