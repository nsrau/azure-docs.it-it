...
description: Panoramica del concetto di unità di calcolo di Azure.Overview of the concept of the Azure compute units. Le unità di calcolo di Azure rappresentano un modo per confrontare le prestazioni della CPU tra gli SKU di Azure.
