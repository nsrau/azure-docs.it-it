...
È importante ricordare che la Tabella M è stata definita nella [Fase 2](virtual-machines-windows-ps-lob-ph2.md) e le Tabelle V, S, ST e A sono state definite nella [Fase 1](virtual-machines-windows-ps-lob-ph1.md).
...
9.	In **Nome account di accesso** digitare *dominio*\\sqladmin (in cui *dominio* è il nome del dominio in cui è stato creato l'account sqladmin nella [Fase 2](virtual-machines-windows-ps-lob-ph2.md)). 
...
1.	Accedere alla macchina virtuale SQL Server primaria con l'account sqladmin creato nella [Fase 2](virtual-machines-windows-ps-lob-ph2.md).
