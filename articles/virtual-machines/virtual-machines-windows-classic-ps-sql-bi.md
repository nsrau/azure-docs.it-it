...
1. Verificare il **Nome server** e fare clic su **Test connessione**.

1. Se il risultato è **Test della connessione completato**, fare clic su **OK** e quindi su **Avanti**.

1. Il nome del database è **ReportServer** e la **Modalità server di report** è **Nativa**. Fare clic su **Avanti**.

1. Fare clic sul pulsante **Avanti** on the **Credenziali** .

1. Fare clic sul pulsante **Avanti** on the **Riepilogo** .

1. Fare clic sul pulsante **Avanti** on the **Continua e termina** .
...
>[AZURE.NOTE] [È possibile inviare commenti e suggerimenti e informazioni di contatto tramite Microsoft SQL Server Connect](https://connect.microsoft.com/SQLServer/Feedback)
