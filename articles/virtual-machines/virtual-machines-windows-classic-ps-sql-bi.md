...
* Creare un disco rigido VHD che contenga i report e quindi caricare e collegare l'unità.
  ...
  3. Caricare il file VHD in Azure utilizzando il cmdlet Add-AzureVHD [Creazione e caricamento di un disco rigido virtuale di Windows Server in Azure](virtual-machines-windows-classic-createupload-vhd.md).
