---
title: Prestazioni delle dimensioni della VM serie HB-macchine virtuali di Azure | Microsoft Docs
...
| Latenza RDMA & larghezza di banda                        | 2.35 USEC, 96,5 GB/s   |
| FIO sull'unità SSD NVMe locale                           | ~ 1,7 GB/s di letture, ~ 1,0 GB/s Scritture      |  
| IOR su 4 * Azure SSD Premium (P30 Managed Disks, RAID0) * *  | ~ 725 MB/s di letture, ~ 780 MB/Scritture   |
...
| #bytes  | Latenza [microsecondi] (MPICH 3,3 + CH4) | Latenza [microsecondi] (OpenMPi 4.0.0) | Latenza [microsecondi] (MVAPICH2 2,3) | Latenza [microsecondi] (Intel MPI 2019) |
|------|----------|----------|----------|----------|
...
Scopri di più sull' [elaborazione ad alte prestazioni](/azure/architecture/topics/high-performance-computing/) in Azure.
