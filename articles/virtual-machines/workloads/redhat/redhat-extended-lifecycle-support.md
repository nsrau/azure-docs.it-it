...
|Dimensioni macchina virtuale|Intervallo di tempo di addebito aggiuntivo|Importo aggiuntivo in dollari (USD)| Note|
|---|---|---|---|
| Guest virtuale piccolo (<= 4 core) | Addebito orario aggiuntivo | TBC | |
|  | Costo aggiuntivo mensile | TBC | Per le istanze riservate |
|  | Costo aggiuntivo annuale | TBC | Per le istanze riservate |
| Guest virtuale di grandi dimensioni (>4 core) | Addebito orario aggiuntivo | TBC | |
|  | Costo aggiuntivo mensile | TBC | Per le istanze riservate |
|  | Costo aggiuntivo annuale | TBC | Per le istanze riservate |
