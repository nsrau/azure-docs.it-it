...
1. Immettere i parametri seguenti:
    ...
    - **Admin Username and Admin Password** (Nome utente e password amministratore): Verrà creato un nuovo utente con cui è possibile accedere alla macchina
