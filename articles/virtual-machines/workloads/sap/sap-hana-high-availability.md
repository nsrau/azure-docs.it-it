...
1. Immettere i parametri seguenti:
    ...
    - **Nome utente amministratore e Password amministratore**: viene creato un nuovo utente che è possibile usare per accedere alla macchina.
