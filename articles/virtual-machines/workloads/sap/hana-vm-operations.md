...
UltraSSD ti offre la possibilità di definire un singolo disco che soddisfa l'intervallo di velocità effettiva delle dimensioni, IOPS e disco. Invece di usare i responsabili di volume logico, ad esempio LVM o MDADM su archiviazione Premium di Azure per creare i volumi che soddisfano i requisiti di velocità effettiva IOPS e di archiviazione. È possibile eseguire una combinazione di configurazione tra UltraSSD e l'archiviazione Premium. Di conseguenza è possibile limitare l'utilizzo di UltraSSD per prestazioni critiche /hana/data e /hana/log volumi e illustrano altri volumi con archiviazione Premium di Azure
