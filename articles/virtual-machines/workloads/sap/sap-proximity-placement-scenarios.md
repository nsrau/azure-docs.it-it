...
- [Anteprima: distribuire le VM nei gruppi di posizionamento con prossimità usando l'interfaccia della riga di comando](https://docs.microsoft.com/azure/virtual-machines/linux/proximity-placement-groups)
- [Anteprima: distribuire le VM nei gruppi di posizionamento di prossimità usando PowerShell](https://docs.microsoft.com/azure/virtual-machines/windows/proximity-placement-groups)
