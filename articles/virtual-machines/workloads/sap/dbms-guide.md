...
---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>SAP NetWeaver in macchine virtuali di Azure - Guida alla distribuzione DBMS
...
* Strumenti di terze parti per una descrizione più completa di Backup e SAP in Azure. Per altre informazioni, vedere [SAP Backup Guide](sap-hana-backup-guide.md) (Guida di Backup SAP).
...
In alternativa, è possibile usare la gestione dei volumi logici o MDADM come illustrato nel capitolo [Software RAID][dbms-guide-2.2] di questo documento per creare un solo dispositivo logico grande su più dischi rigidi virtuali montati.
