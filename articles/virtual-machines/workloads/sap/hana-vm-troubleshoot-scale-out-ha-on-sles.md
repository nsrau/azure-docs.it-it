...
È anche possibile caricare l'output di **hb_report** in Hawk nell'area **History** (Cronologia), come illustrato di seguito. Vedere [Utilità hb_report per la raccolta dei file di log](#hbreport-to-collect-log-files): 
