...
## <a name="storage-structure-of-a-vm-for-rdbms-deployments"></a><a name="65fa79d6-a85f-47ee-890b-22e794f51a64"></a>Struttura di archiviazione di una macchina virtuale per le distribuzioni RDBMS
...
>
> Per la creazione di un RAID software in Linux sono supportati solo MDADM e Logical Volume Manager (LVM). Per altre informazioni, vedi:
>
