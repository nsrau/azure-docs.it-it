...
Per la piattaforma Business Objects BI, la [Nota di supporto sap #2145537](https://launchpad.support.sap.com/#/notes/2145537) fornisce un elenco di prodotti SAP Business Objects supportati in Azure. In caso di domande relative a componenti o combinazioni di versioni di software e versioni del sistema operativo che sembrano non essere elencate o supportate e che sono più recenti delle versioni minime elencate, è necessario aprire una richiesta di supporto SAP per il componente che si chiede supporto per.
...
Il supporto di SAP datahub/Vora Azure Kubernetes Services (AKS) è illustrato in dettaglio nella [Nota del supporto sap #2464722](https://launchpad.support.sap.com/#/notes/2464722)
...
Il supporto per SAP hybris Commerce platform 5. x e 6. x in Azure è descritto in dettaglio in [hybris wiki](https://wiki.hybris.com/display/SUP/Using+the+hybris+Platform+with+the+Cloud)
