...
* [Distribuire le macchine virtuali][sap-high-availability-infrastructure-wsfc-shared-disk].

* [Creare e configurare il servizio di bilanciamento del carico di Azure per SAP ASC][sap-high-availability-infrastructure-wsfc-shared-disk-default-ascs-ilb-rules].

* [Se si usa il server di replica di Accodamento 2 (ERS2), eseguire la configurazione Azure Load Balancer per ERS2 ][sap-high-availability-infrastructure-wsfc-shared-disk-default-ascs-ilb-rules]. 
...
_**Figura 1**: schermata dell'interfaccia utente per Scale-Out modello Gestione risorse file server con Managed Disks_
...
_**Figura 2**: schermata dell'interfaccia utente per il modello di File Server Scale-Out Azure Resource Manager senza dischi gestiti_
