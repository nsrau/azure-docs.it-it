...
In primo luogo, è necessario creare una regola per consentire il traffico HTTP sulla porta TCP 80 come indicato di seguito, immettendo il proprio nome e una descrizione:
...
Successivamente, creare il gruppo di sicurezza di rete e assegnare la regola HTTP appena creata come indicato di seguito, immettendo il nome del gruppo di risorse e il percorso:
...
Ora si assegnerà il gruppo di sicurezza di rete a una subnet. In primo luogo, selezionare la rete virtuale come segue:

```
$vnet = Get-AzureRmVirtualNetwork -ResourceGroupName TestRG -Name TestVNet
```

Associare il gruppo di sicurezza di rete alla subnet nel modo seguente:
