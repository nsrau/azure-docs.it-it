---
title: SAP NetWeaver in macchine virtuali (VM) Windows - Guida alla distribuzione | Documentazione Microsoft
description: SAP NetWeaver in macchine virtuali (VM) Windows - Guida alla distribuzione
...
ms.openlocfilehash: 0762650fe1df040e79d3fb845295d279a34f9f6a


---
# <a name="sap-netweaver-on-windows-virtual-machines-vms--deployment-guide"></a>SAP NetWeaver in macchine virtuali (VM) Windows - Guida alla distribuzione
...
* [SAP NetWeaver in macchine virtuali (VM) Windows - Guida alla distribuzione (questo documento)][deployment-guide]
...
Per usare i modelli descritti sopra, è necessario che l'agente di macchine virtuali sia già installato nel disco del sistema operativo. In caso contrario, la distribuzione avrà esito negativo. Scaricare e installare l'agente di macchine virtuali nella VM come descritto nel capitolo [Scaricare, installare e abilitare l'agente di macchine virtuali di Azure][deployment-guide-4.4] di questo documento.
...
###### <a name="issue"></a>Problema
Il servizio di Windows "AzureEnhancedMonitoring" non esiste. Azperflib.exe: l'output di azperflib.exe restituisce un errore, come illustrato nella [figura seguente][deployment-guide-figure-14].
