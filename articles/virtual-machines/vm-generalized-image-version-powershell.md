...
Quando si dispone di una versione di immagine generalizzata, è possibile creare una o più nuove macchine virtuali. Utilizzando il cmdlet [New-AzVM](https://docs.microsoft.com/powershell/module/az.compute/new-azvm) . 
