...
1.	Creare la rete virtuale nel [portale di Azure](http://manage.windowsazure.com). Per altre informazioni, vedere [Creare una rete virtuale (classica) usando il portale di Azure](../virtual-network/virtual-networks-create-vnet-classic-portal.md).
