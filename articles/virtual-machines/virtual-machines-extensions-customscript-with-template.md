...
# Uso dell'estensione script personalizzata con modelli di Azure Resource Manager
...
- [Panoramica del gruppo di risorse](../resource-group-overview)
- [Distribuire modelli con l'interfaccia della riga di comando di Azure](virtual-machines-deploy-rmtemplates-azure-cli)
- [Distribuire modelli con Azure Powershell](virtual-machines-deploy-rmtemplates-powershell)
...
Dopo aver creato il modello, è possibile distribuirlo usando l'interfaccia della riga di comando di Azure oppure Azure PowerShell.
