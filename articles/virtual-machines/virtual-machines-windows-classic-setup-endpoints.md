---
title: Configurare gli endpoint in una VM Windows classica | Microsoft Docs
...
Nel modello di distribuzione **Resource Manager** gli endpoint vengono configurati tramite **Gruppi di sicurezza di rete**. Per altre informazioni, vedere [Apertura di porte a una VM tramite il portale di Azure](virtual-machines-windows-nsg-quickstart-portal.md).
