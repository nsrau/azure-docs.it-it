...
Il comando `Set-AzureRmVMExtension` consente di distribuire l'estensione macchina virtuale dell'agente Linux di Stackify Retrace a una macchina virtuale esistente. Prima di eseguire il comando, le configurazioni pubbliche e private devono essere archiviate in una tabella hash di PowerShell.
