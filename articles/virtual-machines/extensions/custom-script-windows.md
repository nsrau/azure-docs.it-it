...
Per distribuire l'estensione di script personalizzato in un set di scalabilità, vedere [Add-AzVmssExtension](https://docs.microsoft.com/powershell/module/az.compute/add-azvmssextension?view=azps-3.3.0)
