...
Per un elenco delle versioni di Windows attuali, vedere [Prerequisiti di Crittografia dischi di Azure](../../security/azure-security-disk-encryption.md#prerequisites).
