...
Queste informazioni possono essere visualizzate nel portale di Azure oppure è possibile usare PowerShell.This information can be seen in the [Azure portal](../../automation/automation-dsc-onboarding.md#onboard-vms-by-using-the-azure-portal) or you can use PowerShell.
