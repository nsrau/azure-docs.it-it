...
2. Dal menu Hub, fare clic su **Nuovo** > **Calcolo** > **Ubuntu Server 14.04 LTS**.
	...
	![Scelta dell’immagine di una macchina virtuale](media/virtual-machines-linux-portal-create/chooseubuntuvm.png)
...
4. Quindi fare clic su ![Pulsante Crea](media/virtual-machines-linux-portal-create/createbutton.png).

	![Passaggio allo stack di calcolo di Gestione risorse](media/virtual-machines-linux-portal-create/changetoresourcestack.png)
...
2. Fare clic su **Dimensioni** e selezionare delle dimensioni della macchina virtuale appropriate per le proprie esigenze. Ogni dimensione specifica il numero di core di calcolo, la memoria e altre funzionalità, come il supporto per Archiviazione Premium, che influiranno sul prezzo. Azure consiglia determinate dimensioni automaticamente a seconda dell'immagine scelta. Al termine, fare clic su ![Pulsante Seleziona](media/virtual-machines-linux-portal-create/selectbutton-size.png).
...
3. Fare clic su **Impostazioni** per visualizzare le impostazioni di archiviazione e di rete per la nuova macchina virtuale. Per una prima macchina virtuale è in genere possibile accettare le impostazioni predefinite. Se sono state selezionate delle dimensioni della macchina virtuale che la supportano, è possibile provare l’Archiviazione Premium selezionando **Premium (SSD)** sotto **Tipo di disco**. Al termine, fare clic su ![Pulsante OK](media/virtual-machines-linux-portal-create/okbutton.png).

	![](media/virtual-machines-linux-portal-create/step-3-settings.png)

6. Fare clic su **Riepilogo** per esaminare le scelte di configurazione. Al termine della revisione o dell'aggiornamento delle impostazioni, fare clic su ![Pulsante OK](media/virtual-machines-linux-portal-create/createbutton.png) .

	![Riepilogo creazione](media/virtual-machines-linux-portal-create/summarybeforecreation.png)
...
![Riepilogo creazione avvenuta correttamente](media/virtual-machines-linux-portal-create/successresultwithip.png)
...
> [AZURE.NOTE] È inoltre possibile configurare un nome di dominio completo (FQDN) per la macchina virtuale nel portale. Ulteriori informazioni sulla [creazione di FQDN nel portale](virtual-machines-linux-portal-create-fqdn.md).
...
- [Come usare gli strumenti da riga di comando di Azure per Mac e Linux](azure-cli-arm-commands.md)
