---
title: SAP NetWeaver in macchine virtuali (VM) Windows - Guida alla distribuzione DBMS | Documentazione Microsoft
...
---
# <a name="sap-netweaver-on-windows-virtual-machines-vms--dbms-deployment-guide"></a>SAP NetWeaver in macchine virtuali (VM) Windows - Guida alla distribuzione DBMS
...
* [SAP NetWeaver in macchine virtuali (VM) Windows - Guida alla distribuzione DBMS (questo documento)][dbms-guide]
...
Un altro articolo che riepiloga le procedure consigliate per Archiviazione Standard di Azure e per gli account di Archiviazione Standard di Azure è disponibile qui <https://blogs.msdn.com/b/mast/archive/2014/10/14/configuring-azure-virtual-machines-for-optimal-storage-performance.aspx>
...
* Aggiungere le VM alla stessa rete virtuale Azure (<https://azure.microsoft.com/documentation/services/virtual-network/>)
...
È consigliabile esaminare [questa][virtual-machines-sql-server-infrastructure-services] documentazione prima di continuare.
...
#### <a name="other"></a>Altri
Tutti gli altri argomenti generali sono già stati descritti in [questo][dbms-guide-8.4.4] capitolo specifico su SAP MaxDB. 
