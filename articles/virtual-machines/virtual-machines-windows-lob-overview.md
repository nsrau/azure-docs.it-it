...
- [Fase 1: Configurare Azure](virtual-machines-windows-ps-lob-ph1.md). Creare un account di archiviazione, set di disponibilità e una rete virtuale cross-premise.
