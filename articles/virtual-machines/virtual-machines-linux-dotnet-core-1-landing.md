...
| --- | --- |
| SSHKEYDATA |Dati della chiave SSH usati per proteggere l'accesso alla macchina virtuale. Per informazioni sulla creazione di una coppia di chiavi SSH, vedere [Creare chiavi SSH in Linux e Mac per le VM Linux in Azure](virtual-machines-linux-mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json). |
...
[Passaggio 1: Architettura delle applicazioni con i modelli di Azure Resource Manager](virtual-machines-linux-dotnet-core-2-architecture.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
