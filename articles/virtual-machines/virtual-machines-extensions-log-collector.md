...
Sono disponibili due modalità di raccolta a seconda dei tipi di file da raccogliere. - Solo log di agenti guest di Azure (GA). Questa modalità di raccolta include tutti i log relativi agli agenti guest di Azure e ad altri componenti di Azure. -Tutti i log (Full). Questa modalità di raccolta raccoglierà tutti i file in modalità Agenti guest, oltre a:
