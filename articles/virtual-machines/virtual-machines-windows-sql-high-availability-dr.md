...
Per altre informazioni, vedere l'articolo relativo alla [configurazione di gruppi di disponibilità AlwaysOn in Azure (GUI)](virtual-machines-windows-classic-portal-sql-alwayson-availability-groups.md).
