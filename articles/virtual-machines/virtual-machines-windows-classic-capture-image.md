...
Per informazioni sul modello Resource Manager, vedere [Create a copy of a specialized Windows VM running in Azure](virtual-machines-windows-vhd-copy.md) (Creare una copia di macchina virtuale Windows specializzata in esecuzione in Azure).
...
1. Nel [portale di Azure classico](http://manage.windowsazure.com), **Connetti** alla macchina virtuale. Per informazioni, vedere [Come accedere a una macchina virtuale che esegue Windows Server][Come accedere a una macchina virtuale che esegue Windows Server].
...
4. Verrà visualizzata la finestra di dialogo **Utilità preparazione sistema** . Eseguire le operazioni seguenti:
   ...
   * In **Azione pulizia sistema** selezionare **Passare alla Configurazione guidata** e verificare che l'opzione **Generalizza** sia selezionata. Per ulteriori informazioni sull'utilizzo di Sysprep, vedere il relativo [documento introduttivo][documento introduttivo].
