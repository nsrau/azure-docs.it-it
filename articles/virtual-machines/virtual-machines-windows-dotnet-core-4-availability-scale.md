...
Per informazioni approfondite sui set di disponibilità, vedere [Gestione della disponibilità delle macchine virtuali](virtual-machines-windows-manage-availability.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). 
...
![Servizio di bilanciamento del carico](./media/virtual-machines-windows-dotnet-core/nlb-win.png)
...
![Regola del servizio di bilanciamento del carico di rete](./media/virtual-machines-windows-dotnet-core/lbrule-win.png)
...
![Probe del servizio di bilanciamento del carico di rete](./media/virtual-machines-windows-dotnet-core/lbprobe-win.png)
...
![Regola NAT in ingresso](./media/virtual-machines-windows-dotnet-core/natrule-win.png)

Per informazioni approfondite sul servizio di bilanciamento del carico di rete di Azure, vedere [Bilanciamento del carico per i servizi di infrastruttura di Azure](virtual-machines-windows-load-balance.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
