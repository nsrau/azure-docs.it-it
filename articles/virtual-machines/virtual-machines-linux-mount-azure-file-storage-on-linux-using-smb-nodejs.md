---
title: Montare l&quot;archiviazione file di Azure su VM Linux usando SMB con l&quot;interfaccia della riga di comando di Azure 1.0 | Documentazione Microsoft
...
# <a name="mount-azure-file-storage-on-linux-vms-using-smb-using-the-azure-cli-10"></a>Montare l'archiviazione file di Azure su VM Linux usando SMB con l'interfaccia della riga di comando di Azure 1.0
...
- [Interfaccia della riga di comando di Azure 2.0 (Anteprima)](virtual-machines-linux-mount-azure-file-storage-on-linux-using-smb-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json): l'interfaccia della riga di comando di nuova generazione per il modello di distribuzione per la gestione delle risorse
