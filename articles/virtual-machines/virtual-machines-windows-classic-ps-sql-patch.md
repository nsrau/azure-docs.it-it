<properties
	pageTitle="Applicazione automatica di patch in macchine virtuali di SQL Server | Microsoft Azure"
	description="Viene illustrata la funzionalità di applicazione automatizzata di patch per le macchine virtuali di SQL Server in esecuzione in Azure."
...
![Applicazione automatizzata di patch SQL nel portale di Azure](./media/virtual-machines-windows-classic-ps-sql-patch/IC778484.jpg)
...
![Configurazione dell’applicazione automatizzata di patch nel portale di Azure](./media/virtual-machines-windows-classic-ps-sql-patch/IC792132.jpg)
...
Una funzionalità correlata per Macchine virtuali di SQL Server in Azure è [Backup automatizzato per SQL Server in Macchine virtuali di Azure](virtual-machines-windows-classic-ps-sql-backup.md).
