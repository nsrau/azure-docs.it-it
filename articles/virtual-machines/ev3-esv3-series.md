...
description: Specifiche per le macchine virtuali serie Ev3 ed Esv3.
...
La serie Ev3 ed Esv3 è dotata del processore Intel® Xeon® 8171M 2.1 GHz (Skylake) o Intel® Xeon® E5-2673 v4 da 2,3 GHz (Broadwell) in una configurazione hyperthreading, fornendo una migliore proposta di valore per la maggior parte dei carichi di lavoro generici e portando l'Ev3 allineate con le macchine virtuali di uso generale della maggior parte degli altri cloud.  La memoria è stata estesa (da 7 GiB/vCPU a 8 GiB/vCPU) mentre i limiti di rete e dei dischi sono stati modificati in base al core per consentire l'allineamento con il passaggio all'hyperthreading. La serie Ev3 rappresenta un passo avanti rispetto alle dimensioni delle macchine virtuali con memoria elevata delle famiglie D/Dv2.

## <a name="ev3-series"></a>Serie Ev3

Le istanze della serie Ev3 sono basate sulle funzionalità del processore Intel® Xeon® 8171M 2,1 GHz (Skylake) o Intel® Xeon® E5-2673 v4 (Broadwell) e della tecnologia Intel Turbo Boost 2.0. Le istanze della serie Ev3 sono ideali per applicazioni aziendali a uso intensivo di memoria.
...
Funzionalità intel® tecnologia Hyper-Threading della serie Ev3.
...
<sup>1</sup> dimensioni del core vincolate disponibili.

<sup>2</sup> L'istanza è isolata e prevede hardware dedicato per un singolo cliente.

## <a name="esv3-series"></a>Serie Esv3

Le istanze della serie Esv3 sono basate sulla funzionalità Intel® Xeon® 8171M 2.1 GHz (Skylake) o Intel® Xeon® E5-2673 v4 2.3 GHz (Broadwell), Intel Turbo Boost Technology 2.0 e utilizzano lo storage premium. Le istanze della serie Esv3 sono ideali per applicazioni aziendali che richiedono un uso intensivo della memoria.

Funzionalità della VM serie Esv3 Intel® tecnologia Hyper-Threading.
