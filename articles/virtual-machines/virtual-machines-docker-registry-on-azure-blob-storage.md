...
Per eseguire un'istanza del registro Docker che: * usi l'account di archiviazione di Azure per archiviare le immagini * sia in ascolto sulla porta 5000 della macchina virtuale * non disponga di alcuna autenticazione configurata (non consigliato, vedere la nota seguente)
