...
Per le immagini del Marketplace usare [Set-AzureRmVMPlan](https://docs.microsoft.com/powershell/module/azurerm.compute/set-azurermvmplan?view=azurermps-6.7.0) per impostare le informazioni sul piano
```powershell
