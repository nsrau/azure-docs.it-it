...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Consente di aggiungere l'estensione di script personalizzata alla macchina virtuale che richiama uno script per installare WordPress. |
