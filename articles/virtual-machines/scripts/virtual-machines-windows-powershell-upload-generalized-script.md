---
title: Caricare un disco rigido virtuale generalizzato in un esempio di script di Azure PowerShell
...
| [Add-AzVhd](/powershell/module/az.compute/add-azvhd)                                               | Carica un disco rigido virtuale da una macchina virtuale locale in un BLOB in un account di archiviazione cloud in Azure.                                                                       |
| [New-AzImageConfig](/powershell/module/az.compute/new-azimageconfig)                               | Crea un oggetto dell'immagine configurabile.                                                                                                                                                 |
| [Set-AzImageOsDisk](/powershell/module/az.compute/set-azimageosdisk)                               | Imposta le proprietà del disco del sistema operativo in un oggetto dell'immagine.                                                                                                                        |
| [New-AzImage](/powershell/module/az.compute/new-azimage)                                           | Crea una nuova immagine.                                                                                                                                                                 |
...
| [Set-AzVMSourceImage](/powershell/module/az.compute/set-azvmsourceimage)                           | Specifica un'immagine per una macchina virtuale.                                                                                                                                            |
| [Set-AzVMOSDisk](/powershell/module/az.compute/set-azvmosdisk)                                     | Imposta le proprietà del disco del sistema operativo sulla macchina virtuale.                                                                                                                      |
| [Set-AzVMOperatingSystem](/powershell/module/az.compute/set-azvmoperatingsystem)                   | Imposta le proprietà del disco del sistema operativo sulla macchina virtuale.                                                                                                                      |
