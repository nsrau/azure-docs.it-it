---
title: Esempio di script di Azure PowerShell - Creare una VM Windows completamente configurata
description: Esempio di script di Azure PowerShell - Creare una VM Windows completamente configurata.
