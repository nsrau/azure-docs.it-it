---
title: Esempio di script di Azure PowerShell - Docker | Documentazione Microsoft
...
| [Set-AzureRmVMExtension](https://docs.microsoft.com/powershell/resourcemanager/azurerm.compute/v2.2.0/set-azurermvmextension) | Aggiungere un'estensione di VM alla macchina virtuale. In questo esempio l'estensione Docker viene usata per configurare Docker ed eseguire un contenitore Docker NGINX. |
