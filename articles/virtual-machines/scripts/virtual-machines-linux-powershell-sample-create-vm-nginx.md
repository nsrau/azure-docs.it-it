---
title: Esempio di script di Azure PowerShell - NGINX
...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Aggiungere un'estensione di VM alla macchina virtuale. In questo esempio, l'estensione dello script personalizzato viene usata per installare NGINX. |
