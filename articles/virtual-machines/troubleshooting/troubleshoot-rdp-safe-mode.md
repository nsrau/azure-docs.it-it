...
Per abilitare il log del dump e la console seriale, eseguire lo script seguente.
...
2. Eseguire lo script seguente:
    ...
    In questo script si presuppone che la lettera di unità assegnata al disco del sistema operativo collegato sia F. Sostituirla con il valore appropriato per la specifica VM.
