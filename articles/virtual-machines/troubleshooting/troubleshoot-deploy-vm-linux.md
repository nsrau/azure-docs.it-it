...
Le istruzioni per installare i driver per le macchine virtuali basate su Linux sono disponibili [qui](../sizes-gpu.md#supported-operating-systems-and-drivers).
