...
2.  Connettersi alla macchina virtuale per la risoluzione dei problemi. Aprire **Computer management** > **gestione**computer Gestione disco. Verificare che il disco del sistema operativo sia online e che siano assegnate lettere di unità alle partizioni del disco.
