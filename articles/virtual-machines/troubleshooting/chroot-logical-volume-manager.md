...
![Screenshot che mostra l'output del comando lsblk.](./media/chroot-logical-volume-manager/lsblk-output-mounted.png)
...
![Screenshot che mostra il LVs visibile come partizioni montate.](./media/chroot-logical-volume-manager/chroot-all-mounts.png)

Eseguire una query sul **kernel** installato

![Screenshot che illustra come eseguire una query sul kernel installato.](./media/chroot-logical-volume-manager/rpm-kernel.png)
