...
1.  Per abilitare o disabilitare le regole del firewall, vedere [Abilitare o disabilitare una regola del firewall in un sistema operativo guest di una macchina virtuale di Azure](enable-disable-firewall-rule-guest-os.md).
