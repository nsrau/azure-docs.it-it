...
Problema                           |   Misura di prevenzione
:---------------------------------|:--------------------------------------------|
...
A. Sì. Usare **CTRL**+**MAIUSC**+**C** e **CTRL**+**Shift**MAIUSC+**V** per copiare e incollare nel terminale.
