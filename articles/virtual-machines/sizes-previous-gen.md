...
| Dimensioni | vCPU | Memoria: GiB | Spazio di archiviazione temp (HDD): GiB | Numero massimo di dischi dati | Velocità effettiva del disco di dati max: IOPS | NIC massimo/larghezza di banda di rete prevista (Mbps) |
| --- | --- | --- | --- | --- | --- | --- |
...
| Dimensioni | vCPU | Memoria: GiB | Spazio di archiviazione temp (HDD): GiB | Numero massimo di dischi dati | Velocità effettiva del disco di dati max: IOPS | Schede di interfaccia di rete max|
|---|---|---|---|---|---|---|
...
**Raccomandazione sulle dimensioni più recenti**: [serie dv3](dv3-dsv3-series.md)
...
> [!IMPORTANT]
>
> Le macchine virtuali serie DC sono [macchine virtuali di seconda generazione](./linux/generation-2.md#creating-a-generation-2-vm) e supportano `Gen2` solo le immagini.


### <a name="ds-series"></a>Serie DS  

**Raccomandazione sulle dimensioni più recenti**: [serie Dsv3](dv3-dsv3-series.md)
...
| Dimensioni | vCPU | Memoria (GiB) | Spazio di archiviazione temp (GiB) | Numero massimo di dischi dati | Velocità effettiva massima di archiviazione temporanea (IOPS/MBps) | Numero massimo di velocità effettiva del disco non memorizzato nella cache (IOPS/MBps) | NIC massimo/larghezza di banda di rete prevista (Mbps) |
|---|---|---|---|---|---|---|---|
...
| Dimensioni | vCPU | Memoria: GiB | GiB di archiviazione temp (unità SSD) | Numero massimo di dischi dati | Velocità effettiva massima di archiviazione temporanea e nella cache: IOPS/MBps (dimensioni della cache in GiB) | Numero massimo di velocità effettiva del disco non memorizzato nella cache: IOPS/MBps | NIC massimo/larghezza di banda di rete prevista (Mbps) |
|---|---|---|---|---|---|---|---|
