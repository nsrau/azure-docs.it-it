...
È attualmente supportata solo la chiave RSA SSH. Una chiave SSH multiriga deve iniziare con "---- BEGIN SSH2 PUBLIC KEY ----" e terminare con "---- END SSH2 PUBLIC KEY ----".
...
* Se si desidera trasferire il proprio sistema operativo FreeBSD in Azure, fare riferimento a [Creare e caricare un disco rigido virtuale con FreeBSD in Azure](../virtual-machines-linux-classic-freebsd-create-upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json).
