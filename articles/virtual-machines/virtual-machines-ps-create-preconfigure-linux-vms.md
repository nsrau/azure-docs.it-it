...
Per l'argomento associato per le macchine virtuali basate su Windows, vedere [Utilizzo di Azure PowerShell per creare macchine virtuali basate su Windows](virtual-machines-ps-create-preconfigure-windows-vms.md).
...
Per altre informazioni, vedere [Come usare SSH con Linux in Azure](virtual-machines-linux-use-ssh-key.md).
