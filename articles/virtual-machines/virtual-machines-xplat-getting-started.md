...
Seguire queste istruzioni per installare l'[interfaccia della riga di comando di Azure](../xplat-cli.md#install).

## Connessione ad Azure con l’interfaccia della riga di comando di Azure
...
È possibile visualizzare altri esempi di utilizzo dell'interfaccia della riga di comando di Azure per gestire l'infrastruttura di Azure nella [pagina di riferimento dei comandi dell’interfaccia della riga di comando di Azure](../virtual-machines-command-line-tools.md)
