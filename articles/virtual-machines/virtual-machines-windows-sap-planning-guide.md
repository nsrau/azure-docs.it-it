...
---
# <a name="sap-netweaver-on-azure-windows-virtual-machines-vms--planning-and-implementation-guide"></a>SAP NetWeaver in macchine virtuali (VM) Windows di Azure - Guida alla pianificazione e all'implementazione
