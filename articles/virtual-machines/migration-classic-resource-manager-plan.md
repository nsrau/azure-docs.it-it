...
4. Quali scenari sono supportati con l'API di migrazione?  Esaminare le [funzionalità e configurazioni non supportate](migration-classic-resource-manager-overview.md).
...
- Si presuppone che l'API per la migrazione supportata dalla piattaforma terrà in considerazione tutti gli scenari. Leggere la sezione [funzionalità e configurazioni non supportate](migration-classic-resource-manager-overview.md) per comprendere quali sono gli scenari supportati.
...
Ora che si è in Azure Resource Manager, ottimizzare la piattaforma.  Leggere la sezione [Panoramica di Gestione risorse di Microsoft Azure](../azure-resource-manager/management/overview.md) per scoprire i vantaggi aggiuntivi.
