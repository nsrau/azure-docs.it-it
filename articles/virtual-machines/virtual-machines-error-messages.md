---
title: Messaggi di errore nelle macchine virtuali di Azure
description: 
...
---
# <a name="azure-virtual-machine-error-messages"></a>Messaggi di errore nelle macchine virtuali di Azure
Questo articolo illustra i messaggi e i codici di errore comuni restituiti nella gestione di macchine virtuali di Azure.  

>[!NOTE]
>Per eventuali commenti sui messaggi di errore è possibile usare questa pagina oppure il [forum di commenti e suggerimenti su Azure](https://feedback.azure.com/forums/216843-virtual-machines) tramite #azerrormessage.
>
>
...
Una risposta di errore include sempre un codice di stato e un oggetto error. Ogni oggetto error contiene sempre un codice di errore e una sezione message. Se la distribuzione della macchina virtuale viene creata tramite un modello, l'oggetto error include anche una sezione details, che contiene un livello interno di messaggio e codici di errore. In genere, il livello più interno del messaggio di errore rappresenta l'errore radice. 


## <a name="common-virtual-machine-management-error"></a>Messaggi di errore comuni nella gestione di macchine virtuali

Questa sezione contiene un elenco dei messaggi di errore comuni nella gestione di macchine virtuali.
