...
Questa tabella illustra i limiti che si applicano indipendentemente dalla dimensione della VM, per le VM create con gli strumenti di gestione dei servizi.


[AZURE.INCLUDE [azure-virtual-machines-limits](../../includes/azure-virtual-machines-limits.md)]

Questa tabella illustra i limiti che si applicano indipendentemente dalla dimensione della VM, per le VM create con Gestione risorse.
