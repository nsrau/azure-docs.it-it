---
title: Managed disks-modelli di Azure Resource Manager
description: Informazioni su come usare Managed disks nei modelli Azure Resource Manager per le macchine virtuali di Azure.
documentationcenter: ''
author: jboeshart
manager: ''
