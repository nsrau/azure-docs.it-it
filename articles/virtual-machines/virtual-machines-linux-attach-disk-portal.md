...
Dopo aver aggiunto il disco, è necessario prepararlo per l'uso. Per ulteriori informazioni, vedere [Procedura: inizializzare un nuovo disco dati in Linux](linux/classic/attach-disk.md#initialize-a-new-data-disk-in-linux).
