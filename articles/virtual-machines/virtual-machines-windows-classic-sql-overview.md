...
>[AZURE.NOTE] Se possibile, usare il [portale di Azure](https://portal.azure.com/) più recente per effettuare il provisioning e gestire le macchine virtuali di SQL Server. Utilizza l'archiviazione Premium per impostazione predefinita e offre l'applicazione automatizzata di patch, il backup automatizzato e configurazioni AlwaysOn.
...
- [Configurare i gruppi di disponibilità AlwaysOn in Azure (GUI)](virtual-machines-windows-classic-portal-sql-availability.md)
...
Per ulteriori informazioni sulla disponibilità elevata, vedere [disponibilità elevata e ripristino di emergenza di SQL Server in macchine virtuali Azure](virtual-machines-windows-classic-sql-dr.md).

## Backup e ripristino
Per i database in locale, Azure può fungere da un centro dati secondario per archiviare i file di backup di SQL Server. Per una panoramica delle opzioni di backup e ripristino, vedere [Backup e ripristino per SQL Server in Macchine virtuali di Azure](virtual-machines-windows-classic-sql-br.md).

[Backup di SQL Server nell'URL](https://msdn.microsoft.com/library/dn435916.aspx) archivia i file di backup di Azure nell'archiviazione blob di Azure. [Backup per la gestione di SQL Server](https://msdn.microsoft.com/library/dn449496.aspx) consente di pianificazione di backup e memorizzazione in Azure. Questi servizi sono utilizzabili con istanze di SQL Server locale o SQL Server in esecuzione su macchine virtuali di Azure. Macchine virtuali di Azure possono inoltre sfruttare [Backup automatizzato](virtual-machines-windows-classic-ps-sql-backup.md) e [automatizzata patch](virtual-machines-windows-classic-ps-sql-patch.md) per SQL Server.
...
|Gruppi di disponibilità AlwaysOn|Disponibile in SQL Server 2012 o versione successiva. Richiede [configurazione aggiuntiva](virtual-machines-windows-classic-sql-dr.md)
|Replica|Installato|
...
- [Disponibilità elevata e ripristino di emergenza di SQL Server in Macchine virtuali di Azure](virtual-machines-windows-classic-sql-dr.md)
