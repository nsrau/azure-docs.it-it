...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-include.md)]Questo articolo illustra la creazione di una macchina virtuale Oracle WebLogic Server 12c mediante il modello di distribuzione di Gestione risorse.
...
14.	Nella finestra di dialogo **Crea dominio** selezionare **Avvia server di amministrazione** e quindi fare clic su **Fine**.
...
3.	Nella **Console di amministrazione di WebLogic Server** fare clic su **Blocca e modifica**, **Distribuzioni** e quindi su **Installa**.
...
7.	Nella **Console di amministrazione di WebLogic Server** fare clic su **Salva** e quindi su **Attiva modifiche**.
...
10.	Per creare un endpoint per la macchina virtuale:
	...
	8.	Specificare un nome per l'endpoint.
		...
		2. Usare **80** per la porta pubblica
...
11.	Consentire una connessione in ingresso tramite il firewall alla porta 7001.
	...
	2.	Fare clic su **Start di Windows**, digitare **Windows Firewall con sicurezza avanzata** e quindi fare clic sull'icona di **Windows Firewall con sicurezza avanzata**. Viene aperta la console di gestione di **Windows Firewall con sicurezza avanzata**.
