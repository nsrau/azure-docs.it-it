...
# <a name="build-a-highly-available-application-on-linux-virtual-machines-in-azure"></a>Creare un'applicazione a disponibilità elevata in macchine virtuali Linux in Azure
...
Un approccio largamente usato per personalizzare una VM è **cloud-init**. **cloud-init** consente di installare pacchetti e scrivere file. Dato che **cloud-init** viene eseguito durante la distribuzione iniziale, non sono necessari passaggi aggiuntivi per rendere operativa l'app. Il servizio di bilanciamento del carico inizia a distribuire il traffico quando la distribuzione della VM è completata e l'app è in esecuzione. Per altre informazioni sull'uso di **cloud-init**, vedere [Usare cloud-init per personalizzare una VM Linux durante la creazione](virtual-machines-linux-using-cloud-init.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
![Esecuzione dell'app Node.js](./media/virtual-machines-linux-tutorial-load-balance-nodejs/running-nodejs-app.png)
...
- [Gestire la disponibilità delle macchine virtuali Linux](virtual-machines-linux-manage-availability.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
- [Script di esempio dell'interfaccia della riga di comando di Azure](virtual-machines-linux-cli-samples.md)
