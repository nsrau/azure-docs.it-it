...
Sì. Per istruzioni, vedere [Come creare una copia di una macchina virtuale Windows nel modello di distribuzione Resource Manager](virtual-machines-windows-vhd-copy.md).
...
## <a name="can-i-add-a-nic-to-my-vm-after-it's-created?"></a>È possibile aggiungere un NIC alla VM dopo la sua creazione?
