...
[Distribuire le risorse di Azure utilizzando librerie di calcolo, rete e .NET di archiviazione][]

## Sistema operativo e opzioni dell'immagine

Scegliere un'immagine in base al sistema operativo che si desidera eseguire. Azure e i suoi partner offrono molte immagini, alcune delle quali includono strumenti e applicazioni. In alternativa, è possibile utilizzare una delle immagini personalizzate.
...
[Distribuire le risorse di Azure utilizzando librerie di calcolo, rete e .NET di archiviazione]: virtual-machines-arm-deployment.md
