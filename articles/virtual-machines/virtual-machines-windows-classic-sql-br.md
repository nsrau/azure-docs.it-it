...
Se si prevede comunque di distribuire SQL Server in una VM di Azure, le indicazioni sul provisioning sono disponibili nell'esercitazione relativa al [provisioning di una macchina virtuale di SQL Server in Azure con Azure Resource Manager](virtual-machines-windows-portal-sql-server-provision.md).
