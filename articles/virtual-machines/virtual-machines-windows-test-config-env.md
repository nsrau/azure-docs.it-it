...
- [Aggiungere una nuova macchina virtuale](virtual-machines-windows-create-powershell.md) alla subnet Corpnet, ad esempio una che esegue Microsoft SQL Server.
