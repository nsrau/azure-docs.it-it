...
## <a name="azure-vm-deployment-wizard-tutorial"></a>Esercitazione relativa alla procedura guidata per la distribuzione della macchina virtuale di Azure
...
### <a name="get-latest-version-of-the-deploy-a-sql-server-database-to-a-microsoft-azure-vm-wizard"></a>Ottenimento dell’ultima versione della procedura guidata per la distribuzione di un database di SQL Server a una macchina virtuale di Microsoft Azure
...
### <a name="configure-the-existing-azure-virtual-machine-and-sql-server-instance-(if-applicable)"></a>Configurazione della macchina virtuale di Azure esistente e dell'istanza di SQL Server (se applicabile)
...
### <a name="run-the-use-the-deploy-a-sql-server-database-to-a-microsoft-azure-vm-wizard"></a>Esecuzione della procedura guidata per la distribuzione di un database di SQL Server a una macchina virtuale di Microsoft Azure
...
## <a name="backup-to-file-and-copy-to-vm-and-restore"></a>Backup sul file, copia sulla macchina virtuale e ripristino
...
## <a name="detach-and-copy-to-url-and-attach-from-url"></a>Scollegamento, copia nell’URL e collegamento dall’URL
