...
Una macchina virtuale di Azure esegue il sistema operativo in base all'immagine scelta durante la creazione. Queste immagini vengono archiviate in formato VHD nei file .vhd in un account di archiviazione. Per i dettagli, vedere [Dischi in Azure](virtual-machines-linux-about-disks-vhds.md) e [immagini in Azure](virtual-machines-linux-classic-about-images.md).


Quando si crea una macchina virtuale, è possibile personalizzare le impostazioni del sistema operativo in modo che siano appropriate all'applicazione che si desidera eseguire. Per istruzioni, vedere [Come creare una macchina virtuale personalizzata](virtual-machines-windows-classic-createportal.md).
...
Vedere inoltre le **[note sull'installazione di Linux](virtual-machines-linux-create-upload-generic.md#linuxinstall)** per ulteriori suggerimenti sulla preparazione di immagini Linux per Azure.
