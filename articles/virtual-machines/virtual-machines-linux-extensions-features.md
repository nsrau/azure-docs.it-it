...
## Individuare le estensioni delle macchine virtuali
...
|---|---|---|
|Estensione script personalizzata per Linux | Esegue script su una macchina virtuale di Azure. |[Custom Script Extension for Linux](./virtual-machines-linux-extensions-customscript.md) (Estensione script personalizzata per Linux) |
|Estensione Docker |Installa il daemon Docker per supportare i comandi Docker remoti. | [Docker VM Extension](./virtual-machines-linux-dockerextension.md) (Estensione della macchina virtuale Docker) |
|Estensione dell'accesso alle macchine virtuali | Ripristina l'accesso alle macchine virtuali di Azure. |[VM Access Extension](https://github.com/Azure/azure-linux-extensions/tree/master/VMAccess) (Estensione dell'accesso alle VM) |
