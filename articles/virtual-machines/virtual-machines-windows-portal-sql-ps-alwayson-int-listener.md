...
[AZURE.INCLUDE [Avviare la sessione di PowerShell](../../includes/sql-vm-powershell.md)]
...
- In **Indirizzo IP** fare clic su **Indirizzo IP statico** e impostare l'indirizzo IP statico sullo stesso indirizzo usato quando è stato impostato l'indirizzo IP del servizio di bilanciamento del carico nel portale di Azure.
