---
title: Migrazione tra i modelli di distribuzione per le macchine virtuali Linux in Azure | Documentazione Microsoft
...
## <a name="detailed-guidance-on-migration-at-a-resource-and-feature-level"></a>Linee guida dettagliate sulla migrazione a livello di risorse e funzionalità
...
![Schermata che mostra la rappresentazione classica dopo la preparazione](./media/virtual-machines-windows-migration-classic-resource-manager/classic-migration-prepare-portal.png)
![Schermata che mostra la rappresentazione classica dopo la preparazione](./media/virtual-machines-windows-migration-classic-resource-manager/resourcemanager-migration-prepare-portal.png)
