...
1.  Nei risultati della ricerca trovare **SQL Server AlwaysOn Cluster**.
...
1.  Nel pannello relativo ad **ad-primary-dc** click **Connetti**. Il browser chiederà se si desidera aprire o salvare l'oggetto connessione remota. Fare clic su **Apri**.
