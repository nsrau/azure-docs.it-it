...
## Configurare il backup automatizzato nel portale di Azure
...
![Configurazione del backup automatizzato di SQL nel portale di Azure](./media/virtual-machines-windows-classic-ps-sql-backup/IC778483.jpg)
...
![Configurazione del backup automatizzato nel portale di Azure](./media/virtual-machines-windows-classic-ps-sql-backup/IC792133.jpg)
...
È possibile trovare ulteriori indicazioni sul backup e sul ripristino per SQL Server in macchine virtuali di Azure nell'argomento seguente: [Backup e ripristino per SQL Server in Macchine virtuali di Azure](virtual-machines-windows-classic-sql-br.md).

Una funzionalità correlata per Macchine virtuali di SQL Server in Azure è [Applicazione automatica di patch per SQL Server in Macchine virtuali di Azure](virtual-machines-windows-classic-ps-sql-patch.md).

Esaminare altre [risorse per l'esecuzione di SQL Server in Macchine virtuali di Azure](virtual-machines-windows-classic-sql-overview.md).
