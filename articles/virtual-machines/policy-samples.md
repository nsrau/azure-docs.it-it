...
description: Elenco di definizioni di criteri predefiniti di Criteri di Azure per Macchine virtuali di Azure. Queste definizioni di criteri predefiniti forniscono approcci comuni alla gestione delle risorse di Azure.
ms.date: 05/13/2020
ms.topic: sample
author: cynthn
ms.author: cynthn
...
ms.locfileid: "83651298"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-virtual-machines"></a>Definizioni di criteri predefiniti di Criteri di Azure per Macchine virtuali di Azure
