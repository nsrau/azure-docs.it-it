...
# <a name="different-ways-to-create-a-windows-virtual-machine-with-resource-manager"></a>Diversi modi per creare una macchina virtuale Windows con Gestione risorse
