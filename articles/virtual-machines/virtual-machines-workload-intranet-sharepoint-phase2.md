...
È importante ricordare che le tabelle V, S, ST e A sono state definite nella [Fase 1: Configurare Azure](virtual-machines-workload-intranet-sharepoint-phase1.md).
...
- Seguire la [Fase 3](virtual-machines-workload-intranet-sharepoint-phase3.md) per continuare con la configurazione di questo carico di lavoro.
