...
Utilizzare il comando seguente per abilitare i comandi di gestione risorse dell'interfaccia della riga di comando di Azure.
...
## Azure hdinsight: comandi per gestire i cluster HDInsight
