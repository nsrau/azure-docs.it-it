<properties 
	pageTitle="Note sulla versione: Microsoft HDInsight Emulator per Azure | Azure" 
	description="Informazioni aggiornate sulle versioni più recenti di HDInsight Hadoop Emulator." 
	editor="cgronlun" 
	manager="paulettm" 
	services="hdinsight" 
	authors="mumian" 
...
* [Versioni aggiornate dei componenti di Hadoop](http://azure.microsoft.com/documentation/articles/hdinsight-component-versioning/) corrispondenti alla versione 3.1 del servizio.  È incluso il supporto per Hive 0.13 e Tez.
...
* Per altre informazioni sul servizio HDInsight, vedere [http://azure.microsoft.com/documentation/services/hdinsight/](http://azure.microsoft.com/documentation/services/hdinsight/).
...
* Configurazione di ASV nel cluster locale: 
	...
	3. Accedere a qualsiasi file su tale account usando l'URI completo: asv://{contenitore}@{account}/{percorso} (o asvs:// se si vuole usare HTTPS per l'accesso ai dati). Esempio:
