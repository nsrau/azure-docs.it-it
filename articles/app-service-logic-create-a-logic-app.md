...
Prima di tutto, è necessario creare i due connettori che verranno usati:  **Dropbox Connector** e **Twitter Connector**. A questo scopo:
...
7. Scegliere la **Località** di esecuzione dell'app per la logica.
	...
	![Crea pannello App per le API](./media/app-service-logic-create-a-logic-app/gallery.png)
...
1. Fare clic sul pulsante **+ Nuovo** in basso a sinistra nello schermo, espandere **Web e dispositivi mobili** e quindi fare clic su **App per la logica**. 
	...
	![Crea pannello App per la logica](./media/app-service-logic-create-a-logic-app/createlogicapp.png)
