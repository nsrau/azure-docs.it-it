...
Per altre informazioni sulla messaggistica multipiattaforma con il bus di servizio e AMQP 1.0, vedere la [panoramica di AMQP 1.0 per il bus di servizio](service-bus-amqp-overview.md).
