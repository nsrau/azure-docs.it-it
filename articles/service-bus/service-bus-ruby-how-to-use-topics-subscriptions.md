...
L'oggetto **Azure::ServiceBusService** consente di utilizzare gli argomenti. Il codice seguente consente di creare un oggetto **Azure::ServiceBusService**. Per creare un argomento, utilizzare il metodo **create\_topic()**. Nel seguente esempio viene creato un argomento o stampato l'eventuale errore.
