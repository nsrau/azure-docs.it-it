...
Quando si usa Siti Web o Macchine virtuali di Azure, è consigliabile usare il sistema di configurazione .NET (ad esempio, **Web.config**). Per archiviare la stringa di connessione, usare l'elemento `<appSettings>`:
