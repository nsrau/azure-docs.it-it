...
|[Messaggistica negoziata: Argomento con modello richiesta-risposta](http://code.msdn.microsoft.com/Brokered-Messaging-Request-6759a36e)|Illustra come implementare il modello richiesta-risposta usando gli argomenti e le sottoscrizioni del bus di servizio di Microsoft Azure. L'esempio mostra client e server semplici che comunicano tramite un argomento del bus di servizio.|1\.8|Bus di servizio di Microsoft Azure. Bus di servizio per Windows Server|
