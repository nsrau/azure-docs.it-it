...
-   Completare l'[esercitazione introduttiva][esercitazione introduttiva] per la piattaforma mobile preferita, implementando la parte del backend in Java.
...
Tutto il codice disponibile è incluso nell'[esempio di wrapper REST Java][esempio di wrapper REST Java].
...
Se si vuole, si può anche usare il codice dell'[esempio di wrapper REST Java][esempio di wrapper REST Java] e passare direttamente alla sezione [Completare l'esercitazione][Completare l'esercitazione].

Tutti i dettagli per implementare un wrapper REST completo sono disponibili in [MSDN][MSDN]. In questa sezione viene illustrata l'implementazione Java dei passaggi principali necessari per accedere agli endpoint REST di Hub di notifica:
...
Inizializzare il client di Hub di notifica, sostituendo la stringa di connessione e il nome hub come indicato nell'[esercitazione introduttiva][esercitazione introduttiva]:
         ...
         NotificationHub hub = new NotificationHub("{stringa di connessione}",
        "{nome hub}");
...
-   Scaricare l'intero [esempio di wrapper REST Java][esempio di wrapper REST Java], che contiene tutto il codice sopra indicato oltre alla gestione delle registrazioni.
