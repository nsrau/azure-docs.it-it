...
Vedere i seguenti esempi su GitHub:
...
- [Azure eventi hub Kafka MirrorMaker in esecuzione in un'istanza di contenitore di Azure](https://github.com/djrosanova/EventHubsMirrorMaker)
