---
title: Inviare eventi a Hub eventi di Azure con .NET Standard | Microsoft Docs
...
Per inviare messaggi a un Hub eventi, verrà scritta un'applicazione console C# in Visual Studio.
