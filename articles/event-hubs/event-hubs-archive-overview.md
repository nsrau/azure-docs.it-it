<properties
	pageTitle="Archivio di Hub eventi di Azure? | Microsoft Azure"
...
Dopo la configurazione, l'archivio di Hub eventi crea i file nell'account di archiviazione di Azure e il contenitore specificati nella finestra temporale configurata. È possibile visualizzare questi file con qualsiasi strumento, ad esempio [Azure Storage Explorer][]. È possibile scaricare i file in locale per usarli.
...
Apache Avro ha guide introduttive complete per [Java][] e [Python][]. È anche possibile leggere l'articolo [Getting Started with Event Hubs Archive](event-hubs-archive-python.md) (Introduzione all'archivio di Hub eventi).
