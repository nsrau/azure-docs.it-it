        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni sull'Hub eventi di Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Catalogo video sull'Hub eventi di Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
               <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introduzione alla Guida alla programmazione per Hub eventi</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introduzione a Hub eventi con il portale di Azure</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/event-hubs/event-hubs-messaging-exceptions">Eccezioni</a></p>
                        <p><a href="/azure/event-hubs/event-hubs-quotas">Quote</a></p>
                    </div>
                </div>
            </div>
        </div>
