...
description: Questo articolo include una procedura dettagliata per la creazione di uno spazio dei nomi di Hub eventi di Azure abilitato per Apache Kafka tramite il portale di Azure.
services: event-hubs
