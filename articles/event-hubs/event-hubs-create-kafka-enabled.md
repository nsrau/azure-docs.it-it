...
description: Questo articolo fornisce una procedura dettagliata per la creazione di uno spazio dei nomi di hub eventi di Azure Apache Kafka abilitato usando il portale di Azure.
services: event-hubs
