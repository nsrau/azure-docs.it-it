...
Questo argomento di avvio rapido illustra come creare applicazioni Java per inviare o ricevere eventi da Hub eventi di Azure. 
...
> [!IMPORTANT]
> In questo argomento di avvio rapido viene usato il nuovo pacchetto **azure-messaging-eventhubs**. Per un argomento di avvio rapido sui pacchetti **azure-eventhubs** e **azure-eventhubs-eph** precedenti, vedere [questo articolo](event-hubs-java-get-started-send.md). 
...
- Un account Azure attivo. Se non si ha una sottoscrizione di Azure, creare un [account gratuito](https://azure.microsoft.com/free/) prima di iniziare.
- Ambiente di sviluppo in Java. Questa esercitazione usa [Eclipse](https://www.eclipse.org/). È necessario Java Development Kit (JDK) versione 8 o successiva. 
