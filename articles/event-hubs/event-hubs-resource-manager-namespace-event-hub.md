...
In questa Guida introduttiva Usa un' [modello di Resource Manager esistente](https://raw.githubusercontent.com/Azure/azure-docs-json-samples/master/101-eventhubs-create-namespace-and-eventhub/azuredeploy.json). Per trovare ulteriori esempi di modelli, vedere [Azure Quickstart Templates](https://azure.microsoft.com/resources/templates/?term=eventhub&pageNumber=1&sort=Popular).
