...
Le unità elaborate in Hub eventi vengono fatturate con tariffe orarie, in base al numero massimo di unità selezionate in una determinata ora. È possibile [aumentare automaticamente il numero unità elaborate usando la funzionalità Aumento automatico](event-hubs-auto-inflate.md) man mano che aumenta l'utilizzo.
