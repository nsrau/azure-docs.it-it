...
- [**Token di firma di accesso condiviso**](event-hubs-features.md#sas-tokens): vengono usati per identificare e autenticare l'autore di eventi.
...
- [**Unità elaborate**](event-hubs-features.md#capacity): unità di capacità pre-acquistate. Una singola partizione ha una scala massima di una unità elaborata.
