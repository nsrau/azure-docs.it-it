...
È possibile trovare esempi Node. js per hub eventi di Azure i [azure-sdk-per-js](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/eventhub/event-hubs/samples) repository GitHub.
