<properties 
    pageTitle="Domande frequenti su Hub eventi | Microsoft Azure"
...
## <a name="can-i-use-a-single-amqp-connection-to-send-and-receive-from-event-hubs-and-service-bus-queues/topics?"></a>È possibile usare una singola connessione AMQP per l'invio a e la ricezione da Hub eventi e code/argomenti del bus di servizio?
