...
3.	Nella scheda **Configura** impostare **Abilita regole di accesso** come attivo.
...
5.	Fare clic sull'applicazione per visualizzare le informazioni sugli utenti che accedono ad Azure RemoteApp.
