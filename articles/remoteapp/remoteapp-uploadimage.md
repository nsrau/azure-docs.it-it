...
<properties 
    pageTitle="Caricare un'immagine personalizzata"
    description="Informazioni su come caricare un'immagine personalizzata per RemoteApp" 
    services="remoteapp" 
...
1.      Verificare che l'immagine personalizzata soddisfi i [requisiti per l'immagine](..\remoteapp-imagereqs) e [i requisiti per l'applicazione](..\remoteapp-appreqs).
...
**Avviso:** non modificare in nessun caso lo script di caricamento. Sono stati implementati controlli specifici che assicurano che l'immagine soddisfi i requisiti per l'immagine e per l'applicazione. 
