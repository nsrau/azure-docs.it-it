<properties
   pageTitle="Ottenere la stessa esperienza di Office 365 su qualsiasi dispositivo"
   description="Informazioni su come condividere con gli utenti qualsiasi applicazione di Office 365 tramite RemoteApp."
   services="remoteapp"
   documentationCenter=""
   authors="guscatalano"
   manager="mbaldwin"
...
-------------
Accedere a https://www.remoteapp.windowsazure.com/ e fare clic su "Installa il client" per installare il client Azure RemoteApp nel dispositivo in uso. Le schermate seguenti si riferiscono a Windows.

Dopo l'avvio dell'applicazione verrà chiesto di accedere con il proprio Live ID. Per ora, usare lo stesso dell'account Azure. Dopo avere eseguito l'accesso dovrebbe essere visualizzata una notifica relativa a nuovi inviti. Fare clic sulla notifica per visualizzare un elenco come il seguente. Accettare l'invito corrispondente all'indirizzo di posta elettronica del proprietario dell'account Azure.
