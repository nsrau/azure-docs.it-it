...
<properties 
    pageTitle="Risolvere i problemi delle raccolte cloud - creazione"
...
# Risolvere i problemi delle raccolte cloud - creazione

Errori più frequenti visualizzati nel portale di gestione di Azure:

	Non è stato possibile raggiungere il server DNS
	ProvisioningTimeout
