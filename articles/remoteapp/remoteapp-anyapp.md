...
2. Nella scheda **Pubblicazione** fare clic su **Pubblica** nella parte inferiore della schermata, quindi selezionare **Pubblica programmi del menu Start**.
...
## <a name="configure-access-to-access"></a>Configurare l'accesso ad Access
...
4. Infine aprire Access e quindi il database appena condiviso. I dati saranno visualizzati in Access in esecuzione nel cloud.
   ![Database di Access reale in esecuzione dal cloud](./media/remoteapp-anyapp/ra-anyapprunningaccess.png)
