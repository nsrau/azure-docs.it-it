---
title: Come creare una raccolta cloud di Azure RemoteApp | Microsoft Docs
...
4. Scegliere il piano che da usare: standard o di base.
5. Scegliere la rete virtuale creata. Per informazioni su come eseguire questa operazione, eseguire per ora i passaggi descritti nell'argomento sull'approccio [ibrido](remoteapp-create-hybrid-deployment.md).
