...
5. Accedere di nuovo e passare a **Impostazioni -> Sottoscrizioni**. Selezionare la propria sottoscrizione, quindi fare clic su **Modifica directory**. Selezionare il tenant di Azure AD che si desidera usare.
