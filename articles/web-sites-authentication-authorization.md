<properties 
	pageTitle="Utilizzo di Active Directory per l'autenticazione nel servizio app di Azure" 
...
-	[AD di Azure](web-sites-dotnet-lob-application-azure-ad.md) - È possibile implementare l'autenticazione e l'autorizzazione per l'app Web con AD di Azure. Utilizzando l'AD di Azure come provider di identità, le caratteristiche sono le seguenti:
	...
	-	Fornisce SSO a [tutte le applicazioni supportate dall'AD di Azure](/marketplace/active-directory/), tra cui Azure, Office 365, Dynamics CRM Online, Windows InTune e migliaia di applicazioni cloud non Microsoft. 
...
-	[Servizio token di sicurezza (STS) locale, come AD FS](web-sites-dotnet-lob-application-adfs.md) - È possibile implementare l'autenticazione e l'autorizzazione per l'app Web con un STS locale come AD FS. L'utilizzo di AD FS locale presenta le seguenti caratteristiche:
	...
	-	Solo gli amministratori AD FS possono configurare i [trust e le regole di attestazioni di relying party](http://technet.microsoft.com/library/dd807108.aspx).
	-	Possono gestire le [attestazioni](http://technet.microsoft.com/library/ee913571.aspx) su basi per applicazione.
