...
Se occorre creare un account di archiviazione di Azure in un'area diversa, vedere [Informazioni sugli account di archiviazione di Azure](storage-create-storage-account.md) per istruzioni dettagliate.
