...
| **dependsOn: offset** | Offset del trigger di dipendenza. | Timespan<br/>(hh:mm:ss) |  Valore TimeSpan che deve essere negativo in una dipendenza indipendente. Se non viene specificato alcun valore, la finestra è uguale a quella del trigger. | Auto-dipendenza: Sì<br/>Altro: No  |
