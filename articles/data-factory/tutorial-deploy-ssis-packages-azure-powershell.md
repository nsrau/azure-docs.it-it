---
title: Distribuire pacchetti SSIS in Azure con PowerShell | Microsoft Docs
description: Questo articolo illustra come distribuire pacchetti SSIS in Azure e creare un runtime di integrazione SSIS di Azure con PowerShell.
...
---
# <a name="deploy-sql-server-integration-services-packages-to-azure-with-powershell"></a>Distribuire pacchetti SQL Server Integration Services in Azure con PowerShell
