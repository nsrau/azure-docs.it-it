...
Lo scenario seguente fornisce altri dettagli. Include un esempio per la ripetizione del training e l'aggiornamento dei modelli di Azure Machine Learning Studio da una pipeline di Azure Data Factory.
...
* Dati di training. Dati di input per il servizio Web di training di Azure Machine Learning Studio.
* File iLearner. L'output del servizio Web di training di Azure Machine Learning Studio. È anche l'input per Attività della risorsa di aggiornamento.
...
### <a name="linked-service-for-azure-machine-learning-studio-training-endpoint"></a>Servizio collegato per l'endpoint di training di Azure Machine Learning Studio
...
In **Azure Machine Learning Studio** eseguire queste operazioni per ottenere i valori per **mlEndpoint** e **apiKey**:
...
4. In **Azure Machine Learning studio** fare clic sul collegamento **ESECUZIONE BATCH**.
...
### <a name="linked-service-for-azure-machine-learning-studio-updatable-scoring-endpoint"></a>Servizio collegato per l'endpoint di assegnazione dei punteggi aggiornabile di Azure Machine Learning Studio:
