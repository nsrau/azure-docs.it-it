...
> [!NOTE] 
> Gli intervalli di indirizzi IP sono bloccati per Azure Integration Runtime e vengono usati attualmente solo per lo spostamento dati, la pipeline e le attività esterne, non per i flussi di dati. 
...
* **Azure Integration Runtime**
    ...
    | Archivi dati                  | Meccanismo di sicurezza di rete supportato negli archivi dati         | Servizio attendibile     | Intervallo IP statico | Tag di servizio | Consenti Servizi di Azure |
    |------------------------------|-------------------------------------------------------------|---------------------|-----------------|--------------|----------------------|
    | Archivi dati Azure PaaS       | Azure Cosmos DB                                             | -                   | Sì             | -            | Sì                  |
    ...
    |                              | Archiviazione di Azure (Blog, ADLS Gen2)                             | Sì (solo autenticazione MSI) | Sì             | -            | .                    |
    |                              | Azure SQL DB, SQL DW (Synapse Analytics), SQL   Ml          | -                   | Sì             | -            | Sì                  |
