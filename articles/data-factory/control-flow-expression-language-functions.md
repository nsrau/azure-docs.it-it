...
|vuoto|Restituisce true se la matrice, la stringa o l'oggetto è vuoto. Ad esempio, l'espressione seguente restituisce `true`:<br /><br /> `empty('')`<br /><br /> **Numero parametro**: 1<br /><br /> **Nome**: Collection<br /><br /> **Descrizione**: Richiesto. Raccolta da verificare se l'elemento è vuoto.|  
