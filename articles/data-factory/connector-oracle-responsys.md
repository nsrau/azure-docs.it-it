---
title: Copiare dati da Oracle Responsys tramite Azure Data Factory (anteprima)
...
| Proprietà | Descrizione | Obbligatorio |
|:--- |:--- |:--- |
| type | La proprietà Type del set di dati deve essere impostata su: **ResponsysObject** | Sì |
