...
Per copiare dati da Marketo, impostare la proprietà type del set di dati su **MarketoObject**. Non sono presenti proprietà aggiuntive specifiche per il tipo in questo tipo di set di dati.
