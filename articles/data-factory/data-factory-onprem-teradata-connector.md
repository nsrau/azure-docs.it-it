...
### <a name="sample-copy-data-from-teradata-to-azure-blob"></a>Esempio: Copiare i dati da Teradata a BLOB di Azure
Questo esempio illustra come copiare dati da un database Teradata locale a un archivio BLOB di Azure. Tuttavia, i dati possono essere copiati **direttamente** in qualsiasi sink dichiarato [qui](data-factory-data-movement-activities.md#supported-data-stores-and-formats) usando l'attività di copia in Azure Data Factory.  
...
5. La [pipeline](data-factory-create-pipelines.md) con attività di copia che usa [RelationalSource](data-factory-onprem-teradata-connector.md#teradata-copy-activity-type-properties) e [BlobSink](data-factory-azure-blob-connector.md#azure-blob-copy-activity-type-properties).
...
## <a name="teradata-linked-service-properties"></a>Proprietà del servizio collegato Teradata
...
Vedere [Spostare dati tra origini locali e il cloud con Gateway di gestione dati](data-factory-move-data-between-onprem-and-cloud.md) per informazioni dettagliate sull'impostazione delle credenziali per un'origine dati Teradata locale.

## <a name="teradata-dataset-type-properties"></a>Proprietà del tipo di set di dati Teradata
...
## <a name="teradata-copy-activity-type-properties"></a>Proprietà del tipo di attività di copia Teradata
