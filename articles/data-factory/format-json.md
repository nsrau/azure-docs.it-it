...
```
> [!NOTE]
> Se i flussi di dati generano un errore che indica "corrupt_record" durante l'anteprima dei dati JSON, è probabile che i dati contengano un singolo documento nel file JSON. L'impostazione di "documento singolo" dovrebbe cancellare l'errore.
