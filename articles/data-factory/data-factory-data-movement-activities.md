...
L'attività di copia esegue la copia dei dati da un archivio dati **di origine** a un archivio dati **sink**. Data factory supporta gli archivi dati e le combinazioni origine/sink seguenti. Fare clic su un archivio dati per informazioni su come copiare dati da e verso tale archivio.

| **Origine** | **Sink** |
| ------ | ---- |
| [BLOB di Azure](data-factory-azure-blob-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Azure DocumentDB, File system locale/IaaS di Azure, Archivio Azure Data Lake |
| [Tabella di Azure](data-factory-azure-table-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Azure DocumentDB, Archivio Azure Data Lake |
| [Database SQL di Azure](data-factory-azure-sql-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Azure DocumentDB, Archivio Azure Data Lake |
| [Azure SQL Data Warehouse](data-factory-azure-sql-data-warehouse-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Azure DocumentDB, Archivio Azure Data Lake |
| [Azure DocumentDB](data-factory-azure-documentdb-connector.md) | BLOB di Azure, Tabella di Azure, Azure SQL Database, Azure SQL Data Warehouse, Archivio Azure Data Lake |
| [Archivio Azure Data Lake](data-factory-azure-datalake-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Azure DocumentDB, File system locale/IaaS di Azure, Archivio Azure Data Lake | 
| [SQL Server in IaaS](data-factory-sqlserver-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Archivio Azure Data Lake |
| [File system locale/IaaS di Azure](data-factory-onprem-file-system-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, File system locale/IaaS di Azure, Archivio Azure Data Lake |
| [SQL Server locale/IaaS di Azure](data-factory-sqlserver-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Archivio Azure Data Lake |
| [Database MySQL locale/IaaS di Azure](data-factory-onprem-oracle-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Archivio Azure Data Lake |
| [Database Oracle locale/IaaS di Azure](data-factory-onprem-mysql-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Archivio Azure Data Lake |
| [Database DB2 locale/IaaS di Azure](data-factory-onprem-db2-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Archivio Azure Data Lake |
| [Database Teradata locale/IaaS di Azure](data-factory-onprem-teradata-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Archivio Azure Data Lake |
| [Database Sybase locale/IaaS di Azure](data-factory-onprem-sybase-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Archivio Azure Data Lake |
| [Database PostgreSQL locale/IaaS di Azure](data-factory-onprem-postgresql-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale/IaaS di Azure, Archivio Azure Data Lake |

## Esercitazione
Per un'esercitazione rapida sull'uso dell'attività di copia, vedere [Esercitazione: Utilizzo di attività di copia in una pipeline di Data factory di Azure](data-factory-get-started.md). Nell'esercitazione si userà l'attività di copia per copiare dati da un'archiviazione BLOB di Azure a un database SQL di Azure. Nella sezione seguente sono elencate tutte le origini e i sink supportati dall'attività di copia.
...
Per altre informazioni, vedere l'argomento relativo allo [spostamento dei dati tra un ambiente locale e il cloud](data-factory-move-data-between-onprem-and-cloud.md).
