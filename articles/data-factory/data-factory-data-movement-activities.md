...
| **Origine** | **Sink** |
| ------ | ---- |
| [BLOB di Azure](data-factory-azure-blob-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Azure DocumentDB, File System locale, Archivio Azure Data Lake |
| [Tabella di Azure](data-factory-azure-table-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Azure DocumentDB, Archivio Azure Data Lake |
| [Database SQL di Azure](data-factory-azure-sql-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Azure DocumentDB, Archivio Azure Data Lake |
| [Azure SQL Data Warehouse](data-factory-azure-sql-data-warehouse-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Azure DocumentDB, Archivio Azure Data Lake |
...
| [Archivio Azure Data Lake](data-factory-azure-datalake-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Azure DocumentDB, File System locale, Archivio Azure Data Lake | 
| [SQL Server in IaaS](data-factory-sqlserver-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Archivio Azure Data Lake |
| [File System locale](data-factory-onprem-file-system-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, File System locale, Archivio Azure Data Lake |
| [Server SQL locale](data-factory-sqlserver-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Archivio Azure Data Lake |
| [Database Oracle in locale](data-factory-onprem-oracle-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Archivio Azure Data Lake |
| [Database MySQL in locale](data-factory-onprem-mysql-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Archivio Azure Data Lake |
| [Database DB2 in locale](data-factory-onprem-db2-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Archivio Azure Data Lake |
| [Database Teradata in locale](data-factory-onprem-teradata-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Archivio Azure Data Lake |
| [Database Sybase in locale](data-factory-onprem-sybase-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Archivio Azure Data Lake |
| [Database PostgreSQL in locale](data-factory-onprem-postgresql-connector.md) | BLOB di Azure, Tabella di Azure, Database SQL di Azure, Azure SQL Data Warehouse, Server SQL locale, SQL Server in IaaS, Archivio Azure Data Lake |
