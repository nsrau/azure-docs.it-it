...
ms.locfileid: "37035092"
---
# <a name="load-data-into-azure-data-lake-storage-gen2-preview-with-azure-data-factory"></a>Caricare dati nella versione di anteprima di Azure Data Lake Storage Gen2 con Azure Data Factory
...
Azure Data Factory offre una soluzione scale-out di spostamento dati gestiti in alternativa ad AzCopy, un'utilità di trasferimento dei dati da riga di comando. ADF, grazie all'architettura scale-out, può inserire i dati a una velocità effettiva elevata. Per informazioni, vedere [Prestazioni dell'attività di copia](copy-activity-performance.md).
...
8. Nella pagina **Specify Azure Data Lake Storage connection** (Specifica la connessione ad Azure Data Lake Storage) seguire questa procedura:
   ...
   ![Specificare un account di Azure Data Lake Store](./media/load-azure-data-lake-storage-gen2/specify-adls.png)
...
- Partizionare i file in set di file da 10 TB a 20 TB l'uno.
