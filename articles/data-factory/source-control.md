...
-   **Salvataggi parziali**. Quando si apportano numerose modifiche alla Factory, si renderà conto che nella modalità LIVE normale non è possibile salvare le modifiche come bozza, perché non si è pronti oppure non si desidera perdere le modifiche in caso di arresto anomalo del computer. Grazie all'integrazione con GIT, è possibile continuare a salvare le modifiche in modo incrementale ed eseguire la pubblicazione nella factory solo quando si è pronti. GIT funziona come un punto di gestione temporanea finché le modifiche non sono state testate e risultano soddisfacenti.
