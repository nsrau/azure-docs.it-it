...
Questo connettore Greenplum è supportato per le seguenti attività:
...
| Proprietà | Descrizione | Obbligatoria |
|:--- |:--- |:--- |
| type | La proprietà type del dataset deve essere impostata su: **GreenplumTable** | Sì |
