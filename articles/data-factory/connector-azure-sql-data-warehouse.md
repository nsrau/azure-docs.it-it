...
2. Il **formato di set di dati di origine** è di **ParquetFormat**, **OrcFormat**, oppure **TextFormat**, con le configurazioni seguenti:

   1. `folderPath` e `fileName` non contengono filtro con caratteri jolly.
