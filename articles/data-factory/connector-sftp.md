...
|:--- |:--- |:--- |
| type | La proprietà type deve essere impostata su: **Sftp**. |Yes |
| host | Nome o indirizzo IP del server SFTP. |Yes |
...
| authenticationType | Specificare il tipo di autenticazione.<br/>I valori consentiti sono i seguenti: **Basic**, **SshPublicKey**. Fare riferimento alle sezioni [Uso dell'autenticazione di base](#using-basic-authentication) e [Uso dell'autenticazione con chiave pubblica SSH](#using-ssh-public-key-authentication) rispettivamente per vedere altre proprietà ed esempi JSON. |Yes |
...
| Proprietà | DESCRIZIONE | Obbligatoria |
|:--- |:--- |:--- |
| userName | Utente che ha accesso al server SFTP. |Yes |
...
| folderPath | Percorso della cartella. Il filtro con caratteri jolly non è supportato. Ad esempio: folder/subfolder/ |Yes |
