...
Questo connettore MariaDB è supportato per le attività seguenti:
...
Per copiare dati da MariaDB, impostare la proprietà type del set di dati su **MariaDBTable**. Non sono presenti proprietà aggiuntive specifiche per il tipo in questo tipo di set di dati.
