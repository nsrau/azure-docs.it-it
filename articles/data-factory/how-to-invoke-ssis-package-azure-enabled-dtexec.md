...
Per usare AzureDTExec, scaricare e installare la versione più recente di SSMS, che è la versione 18,3 o successiva. Scaricarlo da [questo sito Web](/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017).
...
La chiamata di AzureDTExec offre opzioni simili a quelle richiamando dtexec. Per altre informazioni, vedere [dtexec Utility](/sql/integration-services/packages/dtexec-utility?view=sql-server-2017). Ecco le opzioni attualmente supportate:
