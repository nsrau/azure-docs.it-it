...
1. Dopo l'accesso al [portale di Azure](https://portal.azure.com/), fare clic su **Altri servizi**, eseguire una ricerca con parole chiave come `data fa` e selezionare **Data factory**.
