...
3.	Installare "<percorso di installazione di ODP.NET>\\11.2.0\\client\_1\\odp.net\\bin\\4\\Oracle.DataAccess.dll" nella Global Assembly Cache (GAC) eseguendo `gacutil /i [provider path]`.
