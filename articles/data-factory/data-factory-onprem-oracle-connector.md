...
potrebbe essere necessario modificare la query come illustrato nell'esempio seguente (usando la funzione to\_date):
...
2. Se viene visualizzato il messaggio di errore anche dopo l'installazione del provider, eseguire questa procedura:
   ...
   2. Cercare **Oracle Data Provider for .NET**. Dovrebbe essere presente una voce come quella indicata nell'esempio seguente in **system.data** -> **DbProviderFactories**: "<add name="Oracle Data Provider for .NET" invariant="Oracle.DataAccess.Client" description="Oracle Data Provider for .NET" type="Oracle.DataAccess.Client.OracleClientFactory, Oracle.DataAccess, Version=2.112.3.0, Culture=neutral, PublicKeyToken=89b483f429c47342" />"
3. Copiare questa voce nel file machine.config nella cartella seguente della versione 4.0: <disco di sistema>:\\Windows\\Microsoft.NET\\Framework64\\v4.0.30319\\Config\\machine.config e cambiare la versione in 4.xxx.x.x.
4. Installare "<percorso di installazione di ODP.NET>\\11.2.0\\client\_1\\odp.net\\bin\\4\\Oracle.DataAccess.dll" nella Global Assembly Cache (GAC) eseguendo `gacutil /i [provider path]`.
