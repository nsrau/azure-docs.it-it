...
## [Indice di tutti gli articoli](data-factory-alltopcat.md)
## Concetti
### [Set di dati](data-factory-create-datasets.md)
### [Pipeline e attività](data-factory-create-pipelines.md)
### [Attività di spostamento dei dati](data-factory-data-movement-activities.md)
### [Attività di trasformazione dei dati](data-factory-data-transformation-activities.md)
...
## [Esercitazione: Spostare i dati da locale al cloud](data-factory-move-data-between-onprem-and-cloud.md)
## [Esercitazione: Creare e usare un'attività personalizzata in una pipeline](data-factory-use-custom-activities.md)

# Procedure
## Spostare dati
### [Copia guidata di data factory](data-factory-copy-wizard.md)
### [Caricare 1 TB in 15 minuti con la Copia guidata](data-factory-load-sql-data-warehouse.md)
### [Attività di copia](data-factory-data-movement-activities.md)
### [Spostamento ibrido di dati](data-factory-move-data-between-onprem-and-cloud.md)
...
### [Tabelle di Azure](data-factory-azure-table-connector.md)
...
## Sviluppare
### [Uso del portale di Azure](data-factory-copy-activity-tutorial-using-azure-portal.md)
### [Uso di Visual Studio](data-factory-copy-activity-tutorial-using-visual-studio.md)
### [Uso di PowerShell](data-factory-copy-activity-tutorial-using-powershell.md)
### [Uso del modello di Azure Resource Manager](data-factory-how-to-use-resource-manager-templates.md)
...
### [Uso del portale di Azure](data-factory-api-change-log.md)
### [Uso dell'app di monitoraggio e gestione](data-factory-monitor-manage-app.md)
