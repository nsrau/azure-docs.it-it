...
Le proprietà seguenti sono supportate per FTP in `location` impostazioni nel set di dati basato su formato:

| Proprietà   | Descrizione                                                  | Obbligatoria |
| ---------- | ------------------------------------------------------------ | -------- |
| type       | La proprietà Type `location` nel set di dati deve essere impostata su **FtpServerLocation**. | Sì      |
