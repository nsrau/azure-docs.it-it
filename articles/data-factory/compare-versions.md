...
Il ruolo Collaboratore di Data Factory versione 1 può essere usato per creare e gestire le risorse di Data Factory versione 2. Per altre informazioni, vedere [Collaboratore Data Factory](../role-based-access-control/built-in-roles.md#data-factory-contributor).
