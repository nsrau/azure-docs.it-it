...
2. Passare alla cartella c:\\adfgetstarted ed eseguire questo comando:
   ...
   > [!NOTE]
   > Questo comando crea un contenitore denominato **adfgetstarted** nell'archiviazione BLOB di Azure e copia il file **input.log** dall'unità locale alla cartella **inputdata** nel contenitore.
   > 
   > 
