...
> [AZURE.IMPORTANT] La parte "__c" del nome dell'API è necessaria per qualsiasi oggetto personalizzato.
...
## <a name="salesforce-linked-service-properties"></a>Proprietà del servizio collegato Salesforce
...
## <a name="salesforce-dataset-properties"></a>Proprietà del set di dati Salesforce
...
## <a name="relationalsource-type-properties"></a>Proprietà del tipo RelationalSource
...
> [AZURE.IMPORTANT] La parte "__c" del nome dell'API è necessaria per qualsiasi oggetto personalizzato.<br>
