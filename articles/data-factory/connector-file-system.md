...
> * [Versione 1 - Disponibilità generale](v1/data-factory-onprem-file-system-connector.md)
> * [Versione 2 - Anteprima](connector-file-system.md)
...
| password | Specificare la password per l'utente (userid). Contrassegnare questo campo come SecureString. | Sì |
...
|:--- |:--- |:--- |
| Cartella locale nel computer del runtime di integrazione: <br/><br/>Esempi: D:\\\* o D:\cartella\sottocartella\\* |D:\\\\ |.\\\\ o cartella\\\\sottocartella |
...
| folderPath | Percorso della cartella. Per ottenere alcuni esempi, vedere [Servizio collegato di esempio e definizioni del set di dati](#sample-linked-service-and-dataset-definitions) . |Sì |
