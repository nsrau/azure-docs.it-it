---
title: Copiare dati da ServiceNow usando Azure Data Factory (beta) | Microsoft Docs
...
| endpoint | Endpoint del server ServiceNow (ovvero, http://ServiceNowData.com).  | Sì |
