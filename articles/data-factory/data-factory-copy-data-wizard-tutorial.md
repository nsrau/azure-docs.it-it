<properties 
    pageTitle="Esercitazione: Creare una pipeline usando la Copia guidata | Microsoft Azure" 
...
3. In Gruppo di risorse eseguire una di queste operazioni: 1. Selezionare **Usa esistente** per scegliere un gruppo di risorse esistente.
...
12. Nella pagina **Distribuzione** fare clic sul collegamento: `Click here to monitor copy pipeline`.
