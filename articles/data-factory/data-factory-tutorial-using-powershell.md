...
6. [Monitorare le pipeline e le sezioni di dati](#monitor-pipelines). In questo passaggio si monitoreranno le pipeline, le tabelle e le sezioni di dati usando il portale di Azure.
