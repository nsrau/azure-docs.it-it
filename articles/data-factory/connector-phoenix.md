...
Per copiare dati da Phoenix, impostare la proprietà type del set di dati su **PhoenixObject**. Non sono presenti proprietà aggiuntive specifiche del tipo in questo tipo di set di dati.
