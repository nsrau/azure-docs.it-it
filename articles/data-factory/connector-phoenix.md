...
Questo connettore Phoenix è supportato per le seguenti attività:
...
| Proprietà | Descrizione | Obbligatoria |
|:--- |:--- |:--- |
| type | La proprietà type del dataset deve essere impostata su: **PhoenixObject** | Sì |
