...
Il gateway di gestione dati offre un driver DB2 integrato che supporta:

- SQLAM 9/10/11
- DB2 per LUW (Linux, Unix, Windows)
- DB2 per z/OS e DB2 per i (ovvero AS/400)

Pertanto, non è più necessario installare manualmente i driver quando si copiano i dati da DB2.
...
Questo esempio illustra come copiare dati da un database DB2 locale a un archivio BLOB di Azure. Tuttavia, i dati possono essere copiati **direttamente** in qualsiasi sink dichiarato [qui](data-factory-data-movement-activities.md#supported-data-stores) usando l'attività di copia in Azure Data Factory.
...
> [AZURE.NOTE] I nomi di schemi e tabelle fanno distinzione tra maiuscole e minuscole. Racchiudere i nomi tra "" (virgolette doppie) nella query.
