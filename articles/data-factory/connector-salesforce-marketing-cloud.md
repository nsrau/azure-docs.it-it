---
title: Copiare dati da Salesforce Marketing Cloud usando Azure Data Factory (Beta) | Microsoft Docs
...
ms.locfileid: "34617930"
---
# <a name="copy-data-from-salesforce-marketing-cloud-using-azure-data-factory-beta"></a>Copiare dati da Salesforce Marketing Cloud usando Azure Data Factory (Beta)
...
Per copiare dati da Salesforce Marketing Cloud, impostare la proprietà type del set di dati su **SalesforceMarketingCloudObject**. Non sono presenti proprietà aggiuntive specifiche del tipo in questo tipo di set di dati.
