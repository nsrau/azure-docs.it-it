...
Il servizio Data factory offre una visione completa dei servizi di archiviazione, elaborazione e spostamento dei dati Il servizio offre un dashboard di monitoraggio che è possibile usare per eseguire le seguenti operazioni:
...
L'uso del portale di Azure consente di eseguire le seguenti operazioni:
...
3. Nel pannello Data factory selezionare la data factory desiderata per visualizzare la relativa home page (pannello **Data factory**).
...
1. Eseguire ora il cmdlet **Get-AzureRmDataFactoryRun** per ottenere i dettagli sull'esecuzione dell'attività per la sezione.
...
1. Si otterrà l'output con informazioni dettagliate sull'errore (simile al seguente):
    ...
    Type                    :
2. È possibile eseguire il cmdlet **Save-AzureRmDataFactoryLog** con il valore ID visualizzato nell'output riportato sopra e scaricare i file di log usando l'opzione **-DownloadLogsoption** del cmdlet.
...
| RunFinished |Failed/Succeeded |Allocazione risorse non riuscita<br/><br/>Riuscito<br/><br/>Esecuzione non riuscita<br/><br/>Scaduto<br/><br/><Annullato<br/><br/>Convalida non riuscita<br/><br/>Abbandonato |
