---
title: Accedere agli archivi dati e alle condivisioni file con l'autenticazione di WindowsAccess data stores and file shares with Windows authentication
...
È possibile usare l'autenticazione di Windows per accedere ad archivi dati, ad esempio SQL Server, condivisioni file, File di Azure e così via da pacchetti SSIS eseguiti in Azure-SSIS Integration Runtime in Azure Data Factory. Gli archivi dati possono essere locali, ospitati in macchine virtuali di Azure o in esecuzione in Azure come servizi gestiti. Se sono in locale, è necessario aggiungere il proprio iR Azure-SSIS a una rete virtuale (rete virtuale di Microsoft Azure) connessa alla rete locale, vedere Aggiungere il componente [di integrazione di Azure-SSIS a una rete virtuale](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network)di Microsoft Azure . Sono disponibili quattro metodi per accedere ad archivi dati con l'autenticazione di Windows da pacchetti SSIS in esecuzione in Azure-SSIS Integration Runtime:
...
> [!WARNING]
> Se non si utilizza uno dei metodi precedenti per accedere agli archivi dati con l'autenticazione di Windows, i pacchetti che dipendono dall'autenticazione di Windows non sono in grado di accedervi e hanno esito negativo in fase di esecuzione. 
...
4. Eseguire i pacchetti SSIS. I pacchetti usano le credenziali fornite per accedere agli archivi dati in locale con l'autenticazione di Windows.The packages use the credentials that you provided to access data stores on premises with Windows authentication.
...
3. Aggiungere il componente di integrazione Azure-SSIS a una rete virtuale di Microsoft Azure connessa a SQL Server in locale.  Per altre informazioni, vedere Aggiungere il rigiunto per Azure-SSIS a una rete virtuale di Microsoft Azure.For more info, see [Join Azure-SSIS IR to a Microsoft Azure Virtual Network](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network).
...
2. Aggiungere il componente di integrazione Azure-SSIS a una rete virtuale di Microsoft Azure connessa alla condivisione file in locale.  Per altre informazioni, vedere Aggiungere il rigiunto per Azure-SSIS a una rete virtuale di Microsoft Azure.For more info, see [Join Azure-SSIS IR to a Microsoft Azure Virtual Network](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network).
...
- Pianificare i pacchetti. Per altre informazioni, vedere [Pianificare i pacchetti SSIS in Azure](https://docs.microsoft.com/sql/integration-services/lift-shift/ssis-azure-schedule-packages-ssms?view=sql-server-ver15).