...
Questo connettore Presto è supportato per le seguenti attività:
...
| Proprietà | Descrizione | Obbligatoria |
|:--- |:--- |:--- |
| type | La proprietà type del dataset deve essere impostata su: **PrestoObject** | Sì |
