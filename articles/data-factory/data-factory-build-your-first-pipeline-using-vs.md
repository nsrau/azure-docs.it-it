---
title: Creare la prima data factory (Visual Studio) | Microsoft Docs
...
2. Nella finestra di dialogo **Aggiungi nuovo elemento** selezionare **Servizio collegato Archiviazione di Azure** dell'elenco e fare clic su **Aggiungi**.
...
3. Sostituire il codice **JSON** con il frammento seguente.
   ...
   > [!NOTE]
   > Per informazioni dettagliate sulle proprietà JSON usate nell'esempio, vedere [Anatomia di una pipeline](data-factory-create-pipelines.md#anatomy-of-a-pipeline).
   > 
   > 
...
1. Accedere al [portale di Azure](http://portal.azure.com/) e seguire questa procedura:
