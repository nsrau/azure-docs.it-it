...
| newClusterInitScripts| un set di script di inizializzazione facoltativa definita dall'utente per il nuovo cluster. Che specifica il percorso DBFS gli script di inizializzazione. | No  |
