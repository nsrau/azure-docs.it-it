...
Per copiare dati da Impala, impostare la proprietà type del set di dati su **ImpalaObject**. Non sono presenti proprietà aggiuntive specifiche per il tipo in questo tipo di set di dati.
