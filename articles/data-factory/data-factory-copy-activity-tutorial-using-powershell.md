...
1.	Creare un file JSON denominato **EmpBlobTable.json** nella cartella **C:\\ADFGetStartedPSH** con i contenuti seguenti:
	...
	- L'oggetto **availability** è impostato su **hourly**, **frequency** è impostato su **hour** e **interval** è impostato su **1**. Il servizio Data Factory cerca quindi i dati di input ogni ora nella cartella radice del contenitore BLOB (**adftutorial**).
