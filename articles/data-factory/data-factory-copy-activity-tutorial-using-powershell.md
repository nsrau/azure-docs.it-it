---
title: 'Esercitazione: Creare una pipeline con l''attività di copia usando Azure PowerShell | Microsoft Docs'
...
---
# <a name="tutorial:-create-a-pipeline-with-copy-activity-using-azure-powershell"></a>Esercitazione: Creare una pipeline con l’attività Copia utilizzando Azure PowerShell
...
Vedere le [informazioni di riferimento ai cmdlet di Data Factory][cmdlet-reference] per la documentazione completa sui cmdlet di Data Factory. 
