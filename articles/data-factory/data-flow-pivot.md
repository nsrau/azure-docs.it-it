---
title: Trasformazione pivot flusso di dati mapping Azure Data Factory
...
![Opzioni pivot](media/data-flow/pivot1.png "pivot 1")
...
![Opzioni pivot](media/data-flow/pivot3.png "pivot 3")
...
![Opzioni pivot](media/data-flow/pivot4.png "pivot 4")
...
Ad esempio, la trasformazione tramite pivot di "Sales" per "Region" comporterebbe la creazione di nuovi valori di colonna da ogni valore di vendita, ovvero "25", "50", "1000" e così via. Tuttavia, se si imposta un valore di prefisso "Sales-", ogni valore di colonna aggiungerebbe "Sales-" all'inizio del valore.

![Opzioni pivot](media/data-flow/pivot5.png "pivot 5")
