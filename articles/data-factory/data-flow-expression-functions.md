...
Calcola un valore inverso del seno* ``acos(1) -> 0.0``
---
### <code>add</code>
...
Riempie a sinistra la stringa in base al riempimento specificato fino a raggiungere una determinata lunghezza. Se la stringa è uguale o maggiore della lunghezza * ``lpad('great', 10, '-') -> '-----great'`` , viene considerata come 
* ``lpad('great', 4, '-') -> 'great'`` 
* '' LPAD (' Great ', 8,' < >')->' < ><great'``
---
### <code>LTrim</code>
...
Riempie a destra la stringa in base al riempimento specificato fino a raggiungere una determinata lunghezza. Se la stringa è uguale o maggiore della lunghezza, viene considerato un RTRIM no-op * ``rpad('great', 10, '-') -> 'great-----'`` 
* ``rpad('great', 4, '-') -> 'great'`` 
* ``rpad('great', 8, '<>') -> 'great<><'`` 
---
