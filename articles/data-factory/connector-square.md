...
Per copiare dati da Square, impostare la proprietà type del set di dati su **SquareObject**. Non sono presenti proprietà aggiuntive specifiche per il tipo in questo tipo di set di dati.
