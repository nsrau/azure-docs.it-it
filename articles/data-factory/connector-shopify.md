...
Per copiare dati da Shopify, impostare la proprietà type del set di dati su **ShopifyObject**. Non sono presenti proprietà aggiuntive specifiche del tipo in questo tipo di set di dati.
