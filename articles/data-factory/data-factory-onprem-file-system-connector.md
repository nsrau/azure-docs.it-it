...
* Un servizio collegato di tipo [OnPremisesFileServer](data-factory-onprem-file-system-connector.md#on-premises-file-server-linked-service-properties).
...
Vedere [Spostare dati tra origini locali e il cloud con Gateway di gestione dati](data-factory-move-data-between-onprem-and-cloud.md) per informazioni dettagliate sull'impostazione delle credenziali per un'origine dati File System locale.
...
1. Avviare [Gestione configurazione del gateway di gestione dati](data-factory-data-management-gateway.md#configuration-manager) sul computer.
2. Passare alla scheda **Guida** .

> [!NOTE]
> È consigliabile [eseguire l'aggiornamento a Gateway di gestione dati versione 2.0 o successive](data-factory-data-management-gateway.md#update) per sfruttare le funzionalità e le correzioni più recenti.
>
>
