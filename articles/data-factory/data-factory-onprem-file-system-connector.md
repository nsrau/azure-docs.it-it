<properties
    pageTitle="Spostare dati da e in un file system | Microsoft Azure"
...
> [AZURE.NOTE] È consigliabile [eseguire l'aggiornamento a Gateway di gestione dati versione 2.0 o successive](data-factory-data-management-gateway.md#update-data-management-gateway) per sfruttare le funzionalità e le correzioni più recenti.
...
> [AZURE.NOTE] Non è possibile usare fileName e fileFilter contemporaneamente.
