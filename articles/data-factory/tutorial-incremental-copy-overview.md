...
## <a name="delta-data-loading-using-a-watermark"></a>Caricamento di dati differenziali usando un limite
...
- [Eseguire la copia incrementale di dati da una tabella del database SQL di Azure all'archiviazione BLOB di Azure](tutorial-incremental-copy-powershell.md)
...
## <a name="delta-data-loading-using-the-change-tracking-technology"></a>Caricamento di dati differenziali tramite la tecnologia Rilevamento modifiche
...
[Eseguire la copia incrementale di dati dal database SQL di Azure all'archiviazione BLOB di Azure tramite la tecnologia Rilevamento modifiche](tutorial-incremental-copy-change-tracking-feature-powershell.md)
