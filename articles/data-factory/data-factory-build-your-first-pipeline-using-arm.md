---
title: Creare la prima data factory (modello di Resource Manager) | Microsoft Docs
...
> [!IMPORTANT]
> Modificare i valori per le variabili **storageAccountName** e **storageAccountKey**. Modificare anche **dataFactoryName** perché il nome deve essere univoco.
> 
> 
...
> [!NOTE]
> Un altro esempio di modello di Resource Manager per la creazione di un'istanza di Azure Data Factory è disponibile in [GitHub](https://github.com/Azure/azure-quickstart-templates/blob/master/101-data-factory-blob-to-sql/azuredeploy.json).
> 
> 
...
3. Nel pannello **Data factory** relativo alla data factory scelta fare clic su **Diagramma**. ![Riquadro Diagramma](./media/data-factory-build-your-first-pipeline-using-arm/DiagramTile.png)
