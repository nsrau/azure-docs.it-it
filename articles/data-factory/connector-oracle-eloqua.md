...
Per copiare dati da Oracle Eloqua, impostare la proprietà type del set di dati su **EloquaObject**. Non sono presenti proprietà aggiuntive specifiche per il tipo in questo tipo di set di dati.
