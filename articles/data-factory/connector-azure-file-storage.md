...
Per copiare dati da e verso **parquet, formato testo o binario delimitato**, vedere l'articolo formato [parquet](format-parquet.md), [formato testo delimitato](format-delimited-text.md) e [formato binario](format-binary.md) su set di dati basato su formato e impostazioni supportate. Le proprietà seguenti sono supportate per archiviazione `location` file di Azure in impostazioni nel set di dati basato sul formato:
...
Per copiare dati da e verso l'archiviazione file di Azure in **formato ORC/avro/JSON**, sono supportate le proprietà seguenti:
...
Per copiare dati da **parquet, formato testo delimitato o binario**, vedere l'articolo formato [parquet](format-parquet.md), [formato testo delimitato](format-delimited-text.md) e [formato binario](format-binary.md) in origine dell'attività di copia basata su formato e impostazioni supportate. Le proprietà seguenti sono supportate per archiviazione `storeSettings` file di Azure in impostazioni in origine copia basata sul formato:
...
Per copiare dati da archiviazione file di Azure in **formato ORC/avro/JSON**, nella sezione **origine** dell'attività di copia sono supportate le proprietà seguenti:
...
Per copiare dati in **parquet, testo delimitato o formato binario**, vedere l'articolo formato [parquet](format-parquet.md), formato [testo delimitato](format-delimited-text.md) e [formato binario](format-binary.md) in sink dell'attività di copia basata su formato e impostazioni supportate. Le proprietà seguenti sono supportate per archiviazione `storeSettings` file di Azure in impostazioni in sink di copia basato sul formato:
...
Per copiare dati in archiviazione file di Azure in **formato ORC/avro/JSON**, nella sezione **sink** sono supportate le proprietà seguenti:
