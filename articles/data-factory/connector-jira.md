...
Per copiare dati da Jira, impostare la proprietà type del set di dati su **JiraObject**. Non sono presenti proprietà aggiuntive specifiche per il tipo in questo tipo di set di dati.
