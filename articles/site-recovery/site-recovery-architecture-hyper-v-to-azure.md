---
title: Funzionamento della replica Hyper-V in Azure in Azure Site Recovery | Documentazione Microsoft
description: Questo articolo fornisce una panoramica dei componenti e dell'architettura usati durante la replica di macchine virtuali Hyper-V locali in Azure con il servizio Azure Site Recovery.
...
Questo articolo illustra i componenti e i processi interessati durante la replica di macchine virtuali Hyper-V locali in Azure usando il servizio [Azure Site Recovery](site-recovery-overview.md).
