...
- Questi log vengono utilizzati per creare i punti di ripristino sui dischi gestiti.
- Quando si verifica il failover, si seleziona il punto di ripristino consente di creare il disco gestito di destinazione.
