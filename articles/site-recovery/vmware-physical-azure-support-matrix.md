...
Avvio EFI/UEFI guest/server | -Supportato durante l'esecuzione di versione del servizio Mobility 9.13 o successiva.<br/> -Supportato durante la migrazione di macchine virtuali VMware o server fisici che eseguono Windows Server 2012 o versioni successive in Azure.<br/> -È possibile replicare le macchine virtuali solo per la migrazione. Non è supportato il failback in locale.<br/> -È supportato solo NTFS. <br/> -Dimensioni del settore disco devono essere di 512 byte per settore fisico.
