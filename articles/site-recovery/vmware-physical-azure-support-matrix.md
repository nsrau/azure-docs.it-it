...
|||
Debian 8 | [9.21][9.21 UR],[9.22][9.22 UR],[9.23][9.23 UR], [9.24][9.24 UR] | Da 3.16.0-4-amd64 a 3.16.0-7-amd64, da 4.9.0-0.bpo.4-amd64 a 4.9.0-0.bpo.8-amd64 |
...
XFSv5 | Le funzionalità di XFSv5 nei file system XFS, ad esempio il checksum dei metadati, sono supportate a partire dalla versione 9.10 del servizio Mobility. Usare l'utilità xfs_info per controllare il superblocco XFS per la partizione. Se `ftype` è impostato su 1, quindi le funzionalità XFSv5 sono in uso.
BTRFS |Da versione 9.22, BTRFS è supportata, salvo per quegli scenari seguenti</br>Se il volume del sistema file BTRFS secondari viene modificato dopo l'abilitazione della protezione, BTRFS non è supportato. </br>Se il file system BTRFS è distribuito tra più dischi, BTRFS non è supportata.</br>Se il file system BTRFS supporta RAID, BTRFS non è supportato.
