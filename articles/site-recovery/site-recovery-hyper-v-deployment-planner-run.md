...
|-Currency|(Facoltativo) Valuta usata per visualizzare il costo nel report generato. Il valore predefinito è il dollaro USA ($) o l'ultima valuta usata. Vedere l'elenco delle [valute supportate](site-recovery-hyper-v-deployment-planner-cost-estimation.md#supported-currencies).|
