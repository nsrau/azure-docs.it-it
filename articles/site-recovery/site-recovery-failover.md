...
1. Nell'insieme di credenziali di Site Recovery selezionare **piani di ripristino** > *recoveryplan_name*.
2. Fare clic su **Failover**.

    ![Failover](./media/site-recovery-failover/Failover.png)

3. In **failover** > **direzione del failover**lasciare l'impostazione predefinita se si esegue la replica in Azure.
