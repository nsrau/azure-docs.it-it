---
title: Matrice di supporto di Azure Site Recovery | Microsoft Docs
...
## <a name="supported-operating-systems-for-virtualization-servers"></a>Sistemi operativi supportati per i server di virtualizzazione
...
| **Host Hyper-V (con VMM)** |Sito VMM secondario |Almeno Windows Server 2012 con gli aggiornamenti più recenti |
| **Host VMware/vCenter** |Azure |vCenter 5.5 o 6.0 (supporto per le sole funzionalità 5.5)  <br/><br/>  vSphere 6.0, 5.5, o 5.1 con gli ultimi aggiornamenti |
| **Host VMware/vCenter** |Sito secondario di VMware |vCenter 5.5 o 6.0 (supporto per le sole funzionalità 5.5)  <br/><br/>  vSphere 6.0, 5.5, o 5.1 con gli ultimi aggiornamenti |

## <a name="supported-requirements-for-replicated-machines"></a>Requisiti supportati per le macchine replicate
| **Origine** | **Ciò che viene replicato** | **Destinazione** | **Sistema operativo host** |
| --- | --- | --- | --- |
| **VM Hyper-V** |Qualsiasi carico di lavoro |Azure |Qualsiasi sistema operativo guest [supportato da Azure](https://technet.microsoft.com/library/cc794868.aspx)<br/><br/> devono soddisfare i [requisiti di Azure](site-recovery-best-practices.md#azure-virtual-machine-requirements) |
| **VM Hyper-V (con VMM)** |Qualsiasi carico di lavoro |Azure |Qualsiasi sistema operativo guest [supportato da Azure](https://technet.microsoft.com/library/cc794868.aspx)<br/><br/> devono soddisfare i [requisiti di Azure](site-recovery-best-practices.md#azure-virtual-machine-requirements) |
| **VM Hyper-V (con VMM)** |Qualsiasi carico di lavoro |Sito VMM secondario |Qualsiasi sistema operativo guest [supportato da Hyper-V](https://technet.microsoft.com/library/mt126277.aspx) |
...
## <a name="provider-versions"></a>Versioni del provider
