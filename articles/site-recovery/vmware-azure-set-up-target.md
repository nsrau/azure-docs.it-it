---
title: Preparare la destinazione di replica della macchina virtuale VMware in Azure Site RecoveryPrepare the VMware VM replication target in Azure Site Recovery
...
- È stato creato un vault dei servizi di ripristino nel portale di [Azure](https://portal.azure.com "Portale di Azure") per proteggere i computer di origine
...
In base al modello di distribuzione scelto, viene eseguita una convalida per assicurarsi di disporre di almeno una rete virtuale nella sottoscrizione di destinazione in cui replicare ed eseguire il failover della macchina virtuale o del server fisico.
