...
Se la VM di Azure non è disponibile per la selezione quando si abilita la replica, la causa potrebbe essere che la configurazione di Site Recovery della VM di Azure non è aggiornata. La configurazione non aggiornata potrebbe rimanere in una VM di Azure nei casi seguenti:
