...
>[!NOTE]
>
> - La replica delle macchine virtuali di Azure da una sottoscrizione a un'altra per scenari di ripristino di emergenza non è supportata.
> - La migrazione di macchine virtuali di Azure tra sottoscrizioni non è supportata.
> - La migrazione di macchine virtuali di Azure nella stessa regione non è supportata.
> - La migrazione di macchine virtuali di Azure dal modello di distribuzione Classic al modello di distribuzione di Resource Manager non è supportata.
