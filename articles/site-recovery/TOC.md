...
# Attività iniziali
## [Replicare le VM di Azure (anteprima)](azure-to-azure-walkthrough-overview.md)
### [Passaggio 1: Esaminare l'architettura](azure-to-azure-walkthrough-architecture.md)
### [Passaggio 2: Prima di iniziare](azure-to-azure-walkthrough-prerequisites.md)
### [Passaggio 3: Pianificare la rete](azure-to-azure-walkthrough-network.md)
### [Passaggio 4: Creare un insieme di credenziali](azure-to-azure-walkthrough-vault.md)
### [Passaggio 5: Abilitare la replica](azure-to-azure-walkthrough-enable-replication.md)
### [Passaggio 6: Eseguire un failover di test](azure-to-azure-walkthrough-test-failover.md)
...
## [Replicare le VM Hyper-V in un sito secondario con VMM](vmm-to-vmm-walkthrough-overview.md)
### [Passaggio 1: Esaminare l'architettura](vmm-to-vmm-walkthrough-architecture.md)
### [Passaggio 2: Esaminare i prerequisiti e le limitazioni](vmm-to-vmm-walkthrough-prerequisites.md)
### [Passaggio 3: Pianificare la rete](vmm-to-vmm-walkthrough-network.md)
### [Passaggio 4: Preparare VMM e Hyper-V](vmm-to-vmm-walkthrough-vmm-hyper-v.md)
### [Passaggio 5: Creare un insieme di credenziali](vmm-to-vmm-walkthrough-create-vault.md)
### [Passaggio 6: Configurare l'origine e la destinazione](vmm-to-vmm-walkthrough-source-target.md)
### [Passaggio 7: Configurare il mapping di rete](vmm-to-vmm-walkthrough-network-mapping.md)
### [Passaggio 8: Creare criteri di replica](vmm-to-vmm-walkthrough-replication.md)
### [Passaggio 9: Abilitare la replica](vmm-to-vmm-walkthrough-enable-replication.md)
### [Passaggio 10: Eseguire un failover di test](vmm-to-vmm-walkthrough-test-failover.md)
