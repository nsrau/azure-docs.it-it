...
1. Nel [portale di Azure](https://portal.azure.com) nel riquadro di spostamento di sinistra fare clic su **Altri servizi** e cercare e selezionare **Insiemi di credenziali dei servizi di ripristino**.
...
1. Nel [portale di Azure](https://portal.azure.com) fare clic su **Nuovo** > **Rete** >
   **Rete virtuale**
...
5. Fare clic con il pulsante destro del mouse su ogni macchina virtuale e scegliere **Completa la migrazione**. Il processo di migrazione viene completato, viene arrestata la replica per la macchina virtuale AWS e viene arrestata la fatturazione di Site Recovery per la macchina virtuale.
    ...
    ![Completare la migrazione](./media/tutorial-migrate-aws-to-azure/complete-migration.png)
