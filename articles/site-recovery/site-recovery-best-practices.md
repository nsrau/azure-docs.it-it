...
**Connettività Internet** | Solo i server VMM hanno bisogno di una connessione Internet | Solo i server host Hyper-V hanno bisogno di una connessione Internet | Solo i server VMM hanno bisogno di una connessione Internet | Non è necessario installare nulla nelle macchine virtuali, che non si connettono direttamente a Internet.
