<properties
	pageTitle="Preparare la distribuzione di Azure Site Recovery"
...
Sistema operativo di hypervisor VMware | Esecuzione di un sistema operativo supportato | [Dettagli](site-recovery-vmware-to-azure/#before-you-start) 
Sistema operativo guest | Per Hyper-V nella replica di Azure, Site Recovery supporta tutti i sistemi operativi [supportati da Azure](https://technet.microsoft.com/library/cc794868%28v=ws.10%29.aspx). <br/><br/> Per la replica di server fisici e VMware, controllare i [prerequisiti](site-recovery-vmware-to-azure/#before-you-start) di Windows e Linux | Il controllo dei prerequisiti avrà esito negativo se non supportato. 
...
- **Pianificazione della capacità**: leggere le informazioni sullo [strumento di pianificazione della capacità](http://www.microsoft.com/en-in/download/details.aspx?id=39057) se si replicano VM Hyper-V.
