...
Configurare un computer locale come server di configurazione per orchestrare le comunicazioni tra il sito locale e Azure. La tabella seguente riporta i requisiti di sistema e del software di una macchina virtuale che può essere configurata come server di configurazione.
...
### <a name="vmware-vcenter-or-vsphere-host-prerequisites"></a>Prerequisiti dell'host VMware vCenter o vSphere
