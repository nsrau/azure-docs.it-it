...
- [Configurare](physical-azure-disaster-recovery.md#set-up-the-source-environment) l'ambiente di origine usando il file del programma di installazione scaricato nel passaggio precedente.
