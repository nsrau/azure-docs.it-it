...
1. Nel portale di Azure > **Crea rete virtuale**, quindi specificare il nome della rete, l'intervallo di indirizzi IP e il nome della subnet.
...
CentOS 6.4, 6.5, 6.6 (solo 64 bit) | Microsoft-ASR\_UA\_9.*.0.0\_RHEL6-64\_*release.tar.gz SUSE Linux Enterprise Server 11 SP3 (64 bit only) | Microsoft-ASR\_UA\_9.*.0.0\_SLES11-SP3-64\_*release.tar.gz
