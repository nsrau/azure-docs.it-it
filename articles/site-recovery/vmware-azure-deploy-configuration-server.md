...
- Consentire a Site Recovery di scaricarlo e installarlo quando viene eseguita la procedura guidata per la gestione del server di configurazione. Non è necessario intraprendere alcuna azione specifica.
