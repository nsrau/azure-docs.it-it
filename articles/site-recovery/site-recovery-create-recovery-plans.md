...
- È possibile estendere i piani di ripristino con script e azioni manuali. Tenere presente quanto segue:
	...
	- Se si usa VMM nella distribuzione, si noti che:
		...
		- Se il percorso della condivisione di libreria è remoto (o locale ma non condiviso con MSCVMMLibrary, configurare la condivisione come segue utilizzando \\libserver2.contoso.com\\share\\ come esempio):
			- Aprire l'editor del Registro di sistema e passare a HKEY\_LOCAL\_MACHINE\\SOFTWARE\\MICROSOFT\\Azure Site Recovery\\Registration.
			-  Modificare il valore ScriptLibraryPath e inserire \\libserver2.contoso.com\\share. Specificare il nome di dominio completo. Fornire le autorizzazioni per il percorso di condivisione.
