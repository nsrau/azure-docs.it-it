...
Sono stati apportati miglioramenti alle versioni di agente di mobilità [9,23](vmware-physical-mobility-service-overview.md#mobility-service-agent-version-923-and-higher) & [9,27](site-recovery-whats-new.md#update-rollup-39) per gestire i comportamenti degli errori di installazione VSS. Assicurarsi di avere le versioni più recenti per informazioni aggiuntive sulla risoluzione dei problemi relativi agli errori del servizio Copia Shadow del volume.
...
**Procedura**: per generare un tag di coerenza dell'applicazione, Azure Site Recovery utilizza il servizio Copia Shadow del volume (VSS) di Microsoft.
Controllare se il servizio provider di Azure Site Recovery VSS è installato o meno. </br>
