...
- **Dall'interfaccia utente**: nel Pannello di controllo della macchina selezionare **Programmi**. Selezionare **Microsoft Azure Site Recovery Disinstalla servizio Mobility/Server** > **Uninstall**di destinazione master.
