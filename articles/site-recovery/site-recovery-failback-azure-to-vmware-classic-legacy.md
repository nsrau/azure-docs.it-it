...
9. Esaminare l'elenco di macchine virtuali che verranno ripristinate e specificare un ordine di ripristino. Si noti che le VM vengono elencate usando il nome host del computer. Potrebbe essere difficile eseguire il mapping del nome host del computer alla macchina virtuale.
