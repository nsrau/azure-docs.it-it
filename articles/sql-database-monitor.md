...
Per altre informazioni, vedere [Monitoraggio di database SQL mediante le viste a gestione dinamica][Monitoraggio di database SQL mediante le viste a gestione dinamica].
