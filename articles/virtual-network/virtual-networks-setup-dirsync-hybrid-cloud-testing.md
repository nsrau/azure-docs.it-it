...
3.	Fare clic su **Getting started with FastTrack**.
4.	Nella pagina Getting Started with FastTrack, sotto **First, sign up for an Office 365 trial**, fare clic su **For enterprises, sign up here**.
5.	Nella pagina Step 1 compilare i campi specificando il nuovo account Microsoft in **Business email address**, quindi fare clic su **Next**.
...
7.	Nella pagina Passaggio 3, digitare il numero di un cellulare o di uno smartphone in grado di ricevere SMS, quindi fare clic su **Text me**.
8.	Dopo aver ricevuto l'SMS sul telefono, digitare il codice di verifica e quindi fare clic su **Create my account**. 
9.	Al termine della creazione dell'account, fare clic su **You're ready to go**.
...
1.	Eseguire Internet Explorer, digitare **http://go.microsoft.com/fwlink/?LinkID=278924** nella barra degli indirizzi, quindi premere INVIO. Quando viene richiesto di eseguire dirsync.exe, fare clic sulla freccia accanto a **Salva**, fare clic su **Salva con nome**, quindi fare clic su **Salva** per salvare il file nella cartella Download. Per altre informazioni sull'installazione dello strumento, vedere [Installare o aggiornare lo Strumento di sincronizzazione della directory](http://technet.microsoft.com/library/jj151800).
2.	Aprire la cartella **Download**, fare clic con il pulsante destro del mouse sul file **dirsync**, quindi fare clic su **Esegui come amministratore**.
3.	Nella pagina iniziale dell'installazione guidata di Sincronizzazione Active Directory, fare clic su **Avanti**. 
4.	Nella pagina Condizioni di licenza, fare clic su **Accetto**, quindi fare clic su **Avanti**.
5.	Nella pagina di selezione della cartella di installazione, fare clic su **Avanti**. Il completamento dell'installazione potrebbe richiedere alcuni minuti.
6.	Nella pagina Operazione completata, deselezionare **Avvia ora configurazione guidata**, quindi fare clic su **Fine**.
...
1.	In CLIENT1, nella pagina dell'**interfaccia di amministrazione di Office 365**, nel riquadro a sinistra, fare clic su **Utenti**, quindi scegliere **Utenti attivi**.
...
10.	Nella pagina Operazione completata fare clic su **Fine**. Quando richiesto, fare clic su **OK**.
...
In CLIENT1, nella pagina **Impostazione e gestione della sincronizzazione di Active Directory**, fare clic sul collegamento **utenti** al passaggio 6 di questa pagina. Se la sincronizzazione della directory è stata eseguita correttamente, verrà visualizzato quanto segue.
...
1.	In CLIENT1, nella pagina **Utenti attivi**, selezionare l'account di **Lynda Meyer**.
2.	Nelle proprietà dell'account di Lynda Meyer, sotto **Licenza assegnata**, fare clic su **Modifica**.
3.	Nella scheda **Assegnazione della licenza** selezionare una località in **Impostazione località utente** (ad esempio Stati Uniti).
...
7.	Accedere con le credenziali di Office 365 di Lynda Meyer. Il suo nome utente sarà lyndam@<*nome fittizio*>.onmicrosoft.com. La password è la password dell'account utente di Active Directory di Lynda Meyer.
8.	Dopo aver eseguito l'accesso correttamente, viene visualizzata la pagina principale del portale di Office 365 con **Let's make a difference today**.
