...
- **[Servizio App di Azure](https://docs.microsoft.com/en-us/azure/app-service/app-service-ip-restrictions)** : Visualizzare in anteprima disponibili in tutte le aree di Azure in cui il servizio App è disponibile.
