...
- [Interfaccia della riga di comando di Azure 1.0](#how-to-create-the-nsg-for-the-front-end-subnet): l'interfaccia della riga di comando per i modelli di distribuzione classica e di gestione delle risorse (questo articolo)
- [Interfaccia della riga di comando di Azure 2.0](virtual-networks-create-nsg-arm-cli.md): interfaccia avanzata per il modello di distribuzione di gestione delle risorse 
