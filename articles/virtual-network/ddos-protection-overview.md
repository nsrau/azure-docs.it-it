...
- Interagire con il client per determinare se il traffico è potenzialmente un pacchetto contraffatto, ad esempio SYN auth o SYN cookie oppure eliminando un pacchetto in modo che venga ritrasmesso dall'origine.
