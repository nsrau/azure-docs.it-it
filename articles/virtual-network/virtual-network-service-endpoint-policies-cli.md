...
L'accesso viene negato e viene visualizzato un errore `mount error(13): Permission denied`, perché questo account di archiviazione non è presente nell'elenco Consenti del criterio dell'endpoint di servizio applicato alla subnet. 
