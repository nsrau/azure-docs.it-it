...
### <a name="delete-cli"></a>Interfaccia della riga di comando di Azure

1. Usare l'interfaccia della riga di comando di Azure per eliminare la rete virtuale (Resource Manager) con il comando seguente:
