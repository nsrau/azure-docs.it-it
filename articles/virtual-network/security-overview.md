...
* **ApiManagement** (solo Resource Manager): Questo tag identifica i prefissi di indirizzo del servizio Azure Api Management. Se si specifica *ApiManagement* per il valore, il traffico è consentito o negato dall'interfaccia di gestione del ApiManagement.  
