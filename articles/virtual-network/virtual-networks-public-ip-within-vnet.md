...
---
# <a name="public-ip-address-space-in-a-virtual-network-vnet"></a>Spazio degli indirizzi IP pubblico in una rete virtuale (VNet)
...
## <a name="how-do-i-add-a-public-ip-address-range"></a>Come è possibile aggiungere un intervallo di indirizzi IP pubblici?
...
## <a name="are-there-any-limitations"></a>Esistono delle limitazioni?
