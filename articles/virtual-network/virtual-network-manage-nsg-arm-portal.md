---
title: Gestire NSG tramite il portale di anteprima in Resource Manager | Microsoft Docs
...
1. Controllare l'elenco di NSG nel pannello **Gruppi di sicurezza di rete**.
...
1. Nell'elenco di risorse, cercare gli elementi che visualizzano l'icona NSG, come illustrato nel pannello **Risorse** riportato di seguito.
...
1. Il pannello **Regole di sicurezza in ingresso** è visualizzato come illustrato di seguito.

![Portale di Azure - Gruppi di sicurezza di rete](./media/virtual-network-manage-nsg-arm-portal/figure6.png)

1. Nella scheda **Impostazioni** fare clic su **Regole di sicurezza in uscita** per visualizzare le regole in uscita.
...
1. Nella scheda **Impostazioni** fare clic su **Interfacce di rete** per visualizzare le NIC associate all'NSG.
...
1. Dopo alcuni secondi, si noti la nuova regola nel pannello **Regole di sicurezza in ingresso**.
...
1. Nel pannello **FrontEnd** fare clic su **Salva**.
