...
---
# <a name="create-a-vm-with-multiple-nics-using-the-azure-cli-10"></a>Creare una VM con più schede di interfaccia di rete usando l'interfaccia della riga di comando 1.0 di Azure
