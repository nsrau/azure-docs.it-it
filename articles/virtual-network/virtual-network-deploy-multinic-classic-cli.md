---
title: Distribuire più macchine virtuali con funzionalità multi-NIC mediante l’interfaccia della riga di comando di Azure nel modello di distribuzione classica | Microsoft Docs
...
Informazioni su come [eseguire questa procedura con il modello di Resource Manager](virtual-network-deploy-multinic-arm-cli.md).
