...
1. Nel [portale di Azure](https://portal.azure.com) fare clic su **Crea una risorsa** > **Calcolo** > **Windows Server 2016 Datacenter**.
2. Fare clic su **Crea**.
...
1. Nel [portale di Azure](https://portal.azure.com) fare clic su **Tutti i servizi**.
2. Digitare *Gruppi di risorse* nella casella che contiene la parola *Filtro*. Quando **Gruppi di risorse** viene visualizzato nell'elenco filtrato, selezionarlo.
