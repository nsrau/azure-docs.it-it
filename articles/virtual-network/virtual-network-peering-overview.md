...
* Il peering tra la rete virtuale nel modello di Resource Manager e il modello di distribuzione classica richiede che le reti virtuali siano nella stessa sottoscrizione.
