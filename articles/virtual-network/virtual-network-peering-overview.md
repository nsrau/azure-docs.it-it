...
* Completare un'esercitazione sul peering reti virtuali. Un peering viene creato tra reti virtuali create tramite modelli di distribuzione uguali o diversi esistenti in sottoscrizioni uguali o diverse. Completare un'esercitazione per uno degli scenari seguenti:
    ...
    |Uno Resource Manager, uno versione classica     |[Uguale](create-peering-different-deployment-models.md)|
...
* Informazioni su tutte le [impostazioni per il peering reti virtuali e su come modificarle](virtual-network-manage-peering.md)
