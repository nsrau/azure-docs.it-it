...
| **ApplicationInsightsAvailability** | Disponibilità Application Insights. | Entrambi | No | No |
...
| **GuestAndHybridManagement** | Automazione di Azure e configurazione Guest. | Entrambi | No | Sì |
