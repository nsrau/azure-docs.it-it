---
title: Distribuire l'applicazione dual stack IPv6 - Load Balancer Standard - PowerShellDeploy IPv6 dual stack application - Standard Load Balancer - PowerShell
titlesuffix: Azure Virtual Network
description: Questo articolo illustra come distribuire un'applicazione dual stack IPv6 con Load Balancer standard nella rete virtuale di Azure usando Azure Powershell.This article shows how deploy an IPv6 dual stack application with Standard Load Balancer in Azure virtual network using Azure Powershell.
...
Creare una rete virtuale con [New-AzVirtualNetwork](/powershell/module/az.network/new-azvirtualnetwork). Nell'esempio seguente viene creata una rete virtuale denominata *dsVnet* con *mySubnet*:
