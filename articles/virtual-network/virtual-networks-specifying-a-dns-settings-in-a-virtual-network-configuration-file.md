<properties 
   pageTitle="Specifica le impostazioni di un DNS in un File di configurazione di rete virtuale"
...
# Specifica le impostazioni di un DNS in un File di configurazione di rete virtuale
