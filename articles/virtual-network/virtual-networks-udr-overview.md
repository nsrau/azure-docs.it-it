...
---
# <a name="what-are-user-defined-routes-and-ip-forwarding"></a>Cosa sono le route definite dall'utente e l'inoltro IP
...
### <a name="system-routes"></a>Le route di sistema
