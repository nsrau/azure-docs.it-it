---
title: Controllare il routing e usare dispositivi virtuali in Gestione risorse mediante PowerShell | Microsoft Docs
...
2. Creare una tabella di route denominata **UDR-FrontEnd** nell'area **westus** contenente la route creata in precedenza.
...
1. Salvare la nuova configurazione di subnet in Azure.
...
1. Creare una route usata per inviare tutto il traffico destinato alla subnet front-end (192.168.1.0/24) da instradare al dispositivo virtuale di rete **FW1** (192.168.0.4).
        ...
        $route = New-AzureRmRouteConfig -Name RouteToFrontEnd `
            ...
            -NextHopIpAddress 192.168.0.4
2. Creare una tabella di route denominata **UDR-BackEnd** nell'area **westus** contenente la route creata in precedenza.
