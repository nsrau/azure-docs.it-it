---
title: Indirizzi IP pubblici e privati (classici) in Azure | Microsoft Docs
...
Informazioni su come [eseguire questa procedura con il modello di distribuzione di Resource Manager](virtual-network-ip-addresses-overview-arm.md).
