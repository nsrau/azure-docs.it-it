...
In questo articolo viene illustrato il modello di distribuzione classica. È possibile anche [controllare il routing e usare dispositivi virtuali di rete nel modello di distribuzione di Gestione risorse](tutorial-create-route-table-cli.md).
