...
description: Associare un indirizzo IP pubblico a una macchina virtuale (VM) usando il portale di Azure o l'interfaccia della riga di comando di Azure.
