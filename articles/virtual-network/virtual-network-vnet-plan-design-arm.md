...
I criteri vengono applicati alla gerarchia seguente: gruppo di gestione, sottoscrizione e gruppo di risorse. Scopri di più sui [criteri di Azure](../governance/policy/overview.md?toc=%2fazure%2fvirtual-network%2ftoc.json) o Distribuisci alcune definizioni di criteri di rete virtuale di [Azure](policy-samples.md).
