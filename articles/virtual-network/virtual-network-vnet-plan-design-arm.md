<properties
   pageTitle="Guida alla progettazione e alla pianificazione di una rete virtuale di Azure | Microsoft Azure"
...
### Comprendere le proprietà della rete virtuale e della subnet
...
|**networkSecurityGroup**|NSG applicato alla subnet|vedere [NSG](resource-groups-networking.md#Network-Security-Group)|
|**routeTable**|Tabella di route applicata alla subnet|vedere [UDR](resource-groups-networking.md#Route-table)|
|**ipConfigurations**|Raccolta di oggetti di configurazione IP usati dalle schede di interfaccia di rete connesse alla subnet|Vedere [configurazione IP](../resource-groups-networking.md#IP-configurations)|

### Risoluzione dei nomi

Per impostazione predefinita, la rete virtuale usa la [risoluzione dei nomi offerta da Azure](virtual-networks-name-resolution-for-vms-and-role-instances.md#Azure-provided-name-resolution) per risolvere i nomi all'interno della rete virtuale e sulla rete Internet pubblica. Tuttavia, se si connettono le reti virtuali ai data center locali, è necessario indicare [il proprio server DNS](virtual-networks-name-resolution-for-vms-and-role-instances.md#Name-resolution-using-your-own-DNS-server) per la risoluzione dei nomi tra le reti.
...
>[AZURE.NOTE] È anche possibile [creare ruoli personalizzati](../active-directory/role-based-access-control-configure.md) per separare le esigenze amministrative.
...
### Modelli di progettazione per sottoscrizioni e reti virtuali
...
|---|---|---|---|
|Singola sottoscrizione, due reti virtuali per app|![Singola sottoscrizione](./media/virtual-network-vnet-plan-design-arm/figure1.png)|Solo una sottoscrizione da gestire.|Massimo 25 app per area di Azure. Oltre questo limite, sono necessarie ulteriori sottoscrizioni.|
...
|Una sottoscrizione per business unit, due reti virtuali per app.|![Singola sottoscrizione](./media/virtual-network-vnet-plan-design-arm/figure3.png)|Equilibrio tra numero di sottoscrizioni e reti virtuali.|Massimo di 25 app per business unit (sottoscrizione).|
...
### Modelli di progettazione di subnet e gruppi di sicurezza di rete
...
|Una subnet per livello dell'applicazione, gruppi di sicurezza di rete per app.|![Subnet per livello](./media/virtual-network-vnet-plan-design-arm/figure7.png)|Equilibrio tra numero di subnet e gruppi di sicurezza di rete.|Massimo 100 gruppi di sicurezza di rete. 50 app se ogni app richiede 2 gruppi di sicurezza di rete distinti.|
