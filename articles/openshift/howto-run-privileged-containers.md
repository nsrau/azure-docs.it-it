...
Durante `oc create -f defender.yaml` il passaggio 2, si verificano errori durante la creazione del ruolo del cluster e dell'associazione di ruoli del cluster.
