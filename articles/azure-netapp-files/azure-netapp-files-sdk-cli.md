---
title: File di Azure NetApp SDK | Microsoft Docs
description: Elenca gli SDK supportati da file di Azure NetApp.
...
ms.locfileid: "65957881"
---
# <a name="azure-netapp-files-sdks"></a>SDK Azure NetApp Files

Questo articolo elenca gli SDK supportati da file di Azure NetApp.

## <a name="supported-sdks"></a>SDK supportati 

La tabella seguente elenca gli SDK supportati.  È possibile trovare informazioni dettagliate sui vari SDK supportate nelle relative posizioni pubblicati in GitHub.  

|    Linguaggio    |    Posizione di pubblicazione di SDK    |
|------------------|--------------------------------------------------------------------------------------------|
