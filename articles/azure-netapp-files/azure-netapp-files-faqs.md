...
La gestione delle chiavi per Azure NetApp Files viene gestita dal servizio.  Attualmente, le chiavi gestite dall'utente (Bring your own key) non sono supportate.
