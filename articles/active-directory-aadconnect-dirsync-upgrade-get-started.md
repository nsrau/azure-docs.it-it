...
8. Nella pagina "Pronto per la configurazione" deselezionare "Avviare il processo di sincronizzazione non appena viene completata la configurazione iniziale".
