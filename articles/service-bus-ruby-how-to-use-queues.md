...
L'oggetto **Azure::ServiceBusService** consente di utilizzare le code. Per creare una coda, utilizzare il metodo **create\_queue()**. Nell'esempio seguente viene creata una coda o stampato l'eventuale errore.
...
Nell'esempio seguente viene illustrato come inviare un messaggio di prova alla coda denominata "test-queue" utilizzando **send\_queue\_message()**:
