...
>[AZURE.NOTE] Questa esercitazione descrive come autenticare gli utenti nelle app di Windows Store e Windows Phone Store 8.1. Per le app per Windows Phone 8.0 o Windows Phone Silverlight 8.1, consultare la sezione [Introduzione all'autenticazione in Servizi mobili](mobile-services-dotnet-backend-windows-phone-get-started-users.md).
...
[Autorizzazione di utenti con script]: mobile-services-dotnet-backend-windows-store-dotnet-authorize-users-in-scripts.md
