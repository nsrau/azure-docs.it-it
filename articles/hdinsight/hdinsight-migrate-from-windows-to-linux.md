...
| `hive` dal desktop remoto |Usare [Beeline](hadoop/apache-hadoop-use-hive-beeline.md) o [Apache Hive da una sessione SSH](hdinsight-hadoop-use-hive-ssh.md) |
