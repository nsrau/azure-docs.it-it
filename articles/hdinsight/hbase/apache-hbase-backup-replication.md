...
Per importare i dati della tabella, connettersi tramite SSH al nodo head del cluster HDInsight di destinazione e quindi `hbase` eseguire il comando seguente:
