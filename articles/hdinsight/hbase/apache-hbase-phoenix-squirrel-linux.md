...
Per altre informazioni, vedere il [manuale di SQLLine](http://sqlline.sourceforge.net/#manual) e la [grammatica di Apache Phoenix](http://phoenix.apache.org/language/index.html).
