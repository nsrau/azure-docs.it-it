...
> [!NOTE]
> Mentre il codice Python in questo documento può essere utilizzato con un cluster HDInsight basato su Windows, i passaggi descritti in questo documento sono specifici di cluster basati su Linux.
> 
> 
...
Sia **mapper.py** che **reducer.py** devono essere contenuti nel nodo head del cluster perché sia possibile eseguirli. Il modo più semplice per caricarli consiste nell'usare **scp** (**pscp**con un client Windows).
