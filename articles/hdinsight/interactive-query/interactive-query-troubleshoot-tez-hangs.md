...
Per impostazione `yarn.scheduler.capacity.maximum-applications` predefinita, controlla il numero massimo di applicazioni in esecuzione o in sospeso e il valore predefinito è `10000`.
