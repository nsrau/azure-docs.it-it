...
Per informazioni su come connettersi a Hive tramite ODBC, vedere [Visualizzare i dati Hive con Microsoft Power BI tramite ODBC in Azure HDInsight](../hadoop/apache-hadoop-connect-hive-power-bi.md). 
