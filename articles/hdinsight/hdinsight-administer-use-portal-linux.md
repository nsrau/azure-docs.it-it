...
1. Usando un editor di testo, salvare il codice seguente come file denominato **changepassword.sh**.
...
3. Nel portale di Azure selezionare il cluster HDInsight e quindi fare clic su **Tutte le impostazioni**. Nel pannello **Impostazioni** selezionare **Azioni script**.
