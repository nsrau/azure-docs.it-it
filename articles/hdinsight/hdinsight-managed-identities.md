...
* [Interfaccia della riga di comando di AzureAzure](../active-directory/managed-identities-azure-resources/how-to-manage-ua-identity-cli.md)
...
I problemi del cluster si verificano quando è necessaria l'identità gestita. Attualmente non è possibile aggiornare o modificare l'identità di gestione dopo la creazione del cluster. È quindi consigliabile assicurarsi che l'identità gestita non venga eliminata durante il runtime del cluster. In alternativa, è possibile ricreare il cluster e assegnare una nuova identità gestita.
