...
3. Dopo aver creato le regole, usare le informazioni seguenti per applicare il nuovo gruppo di sicurezza di rete a una subnet. Sostituire **RESOURCEGROUPNAME** con il nome del gruppo di risorse che contiene la rete virtuale di Azure. Sostituire **VNETNAME** e **SUBNETNAME** con il nome della rete virtuale di Azure e la subnet da usare durante l'installazione di HDInsight.
