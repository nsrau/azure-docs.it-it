...
![Spark: un framework unificato](./media/hdinsight-apache-spark-overview/hdinsight-spark-overview.png)
...
![Confronto tra il framework MapReduce tradizionale e Spark](./media/hdinsight-apache-spark-overview/mapreduce-vs-spark.png)
...
| --- | --- |
| Facilità di creazione dei cluster Spark |È possibile creare un nuovo cluster Spark in HDInsight in pochi minuti usando il portale di Azure, Azure PowerShell o HDInsight .NET SDK. Vedere [Introduzione ai cluster Spark in HDInsight](hdinsight-apache-spark-jupyter-spark-sql.md) |
...
![Architettura del cluster Spark](./media/hdinsight-apache-spark-overview/spark-architecture.png)
...
[Vedere l'esercitazione: Prevedere la temperatura dell'edificio con dati HVAC](hdinsight-apache-spark-ipython-notebook-machine-learning.md)

[Vedere l'esercitazione: stima dei risultati di ispezione del cibo](hdinsight-apache-spark-machine-learning-mllib-ipython.md)
