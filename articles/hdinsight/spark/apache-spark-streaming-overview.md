...
È quindi possibile eseguire periodicamente una query sul frame di dati per visualizzare il set di valori corrente presente nel batch, ad esempio usando questa query SQL:
