---
title: 'Guida introduttiva: Creare un cluster Spark usando un modello - Azure HDInsight'
...
![Il portale di Azure elimina un cluster HDInsight](./media/apache-spark-jupyter-spark-sql/hdinsight-azure-portal-delete-cluster.png "Eliminare un cluster HDInsight")
