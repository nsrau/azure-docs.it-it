...
Twitter consente di recuperare i dati relativi ad ogni tweet come documento JSON (JavaScript Object Notation) attraverso un'API REST. [OAuth](http://oauth.net) .
