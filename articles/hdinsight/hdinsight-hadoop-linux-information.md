...
2. Usare il comando seguente per ottenere l'ID univoco per l'account di archiviazione. Nel comando seguente sostituire **ACCOUNTNAME** con il nome dell'account di archiviazione recuperato da Ambari:

        az storage account list --query "[?name=='ACCOUNTNAME'].id --out list

3. Usare il comando seguente per ottenere una chiave per l'account di archiviazione. Sostituire **STORAGEID** con l'ID account di archiviazione:
