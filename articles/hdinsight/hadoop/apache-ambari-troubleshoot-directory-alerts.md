...
description: Discussione e analisi dei possibili motivi e soluzioni per gli avvisi della directory Apache Ambari in HDInsight.
...
---
# <a name="scenario-apache-ambari-directory-alerts-in-azure-hdinsight"></a>Scenario: Apache Ambari directory alerts in Azure HDInsight
...
Riceverai errori da Apache Ambari simili a:
...
Le directory menzionate dall'avviso Ambari non sono presenti nei nodi di lavoro interessati.

## <a name="resolution"></a>Risoluzione

Creare manualmente le directory mancanti nei nodi di lavoro interessati.

1. SSH al nodo del lavoratore pertinente.

1. Ottenere l'utente root: `sudo su`.

1. Creare in modo ricorsivo le directory necessarie.

1. Modificare il proprietario e il gruppo per queste directory.
...
1. Dall'interfaccia utente di Apache Ambari, disabilitare e quindi abilitare l'avviso.
