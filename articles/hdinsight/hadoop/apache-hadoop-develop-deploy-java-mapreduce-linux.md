---
title: Creare Java MapReduce per Hadoop - Azure HDInsight
...
Sostituire __USERNAME__ con il nome utente SSH per il cluster. Sostituire __CLUSTERNAME__ con il nome del cluster HDInsight.
