...
description: Informazioni su come usare Python nel flusso di processi MapReduce. Apache Hadoop fornisce un'API di flusso per MapReduce per la scrittura in linguaggi diversi da Java.
services: hdinsight
...
* I comandi `ssh` e `scp` oppure [Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview)
...
* **Formato dati**: i dati utilizzati e generati devono essere una coppia chiave/valore, separati da un carattere di tabulazione.
...
4. Usare il seguente comando per avviare il processo MapReduce.
   ...
   * **-files**: aggiunge i file specificati al processo MapReduce.
