---
title: Usare Apache Sqoop con Curl in HDInsight - Azure
...
Informazioni su come usare Curl per l'esecuzione di processi Apache Sqoop in un cluster Apache Hadoop in HDInsight.
