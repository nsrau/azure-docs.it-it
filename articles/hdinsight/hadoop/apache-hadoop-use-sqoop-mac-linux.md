...
* [Analizzare i dati sui ritardi dei voli con HDInsight](../interactive-query/interactive-query-tutorial-analyze-flight-data.md): Usare Interactive Query per analizzare i dati sui ritardi dei voli e quindi usare Sqoop per esportare i dati in un database SQL di Azure.
