...
Il log di Apache Yarn viene aggregato nel formato `IndexFile`, che non è supportato dal parser di file.

## <a name="resolution"></a>Risoluzione

1. Da un Web browser passare a `https://CLUSTERNAME.azurehdinsight.net`, dove `CLUSTERNAME` è il nome del cluster.

1. Dall'interfaccia utente di Ambariri passare a **yarn** > **configs** > **Advanced** > **Advanced Yarn-site**.
