...
## [Iniziare a usare le query interattive](hdinsight-hadoop-use-interactive-hive.md)
...
#### [Usare Azure PowerShell](hdinsight-hadoop-use-hive-powershell.md)
...
#### [Usare Azure PowerShell](hdinsight-hadoop-use-mapreduce-powershell.md)
...
#### [Usare Azure PowerShell](hdinsight-hadoop-use-pig-powershell.md)
...
#### [Elaborare eventi con topologie Java](https://azure.microsoft.com/resources/samples/hdinsight-java-storm-eventhub/)
...
## Usare le query interattive
### [Usare Zeppelin per eseguire le query di Hive](hdinsight-connect-hive-zeppelin.md)
## Sviluppare
...
### [Usare lo strumento VSCode di HDInsight](hdinsight-for-vscode.md)
## Analizzare Big Data
### [Eseguire l'analisi con Power Query](hdinsight-connect-excel-power-query.md)
### [Connettere Power BI ad Hadoop](hdinsight-connect-hive-power-bi.md)
...
#### [Esecuzione con Azure PowerShell](hdinsight-hadoop-use-sqoop-powershell.md)
