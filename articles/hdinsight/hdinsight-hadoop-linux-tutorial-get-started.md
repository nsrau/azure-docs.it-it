...
---
# <a name="hadoop-tutorial-get-started-using-linuxbased-hadoop-in-hdinsight"></a>Esercitazione di Hadoop: Introduzione all'uso di Hadoop basato su Linux in HDInsight
