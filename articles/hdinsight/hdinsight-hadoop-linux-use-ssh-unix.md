---
title: Usare chiavi SSH con Hadoop basato su Linux da Linux, Unix o OS X | Microsoft Docs
...
### Portale di Azure
Quando si usa il [Portale di Azure][preview-portal] per creare un cluster HDInsight basato su Linux, è necessario inserire un **SSH USER NAME** e per accedere selezionare una **PASSWORD** o **SSH PUBLIC KEY**.
...
* **Indirizzo SSH**: per connettersi a un cluster con SSH è possibile usare due indirizzi:
  ...
  * **Connettersi al nodo perimetrale**: se il cluster è Server R in HDInsight, contiene anche un nodo perimetrale a cui è possibile accedere usando **RServer.CLUSTERNAME.ssh.azurehdinsight.net**, dove **CLUSTERNAME** è il nome del cluster.
