...
In questi casi, i pacchetti aggiuntivi possono essere installati con un'azione script dopo la creazione del cluster. Per altre informazioni, vedere l'articolo relativo alla [creazione di un cluster HDInsight con R Server](r-server-get-started.md).   
...
* [Introduzione a R Server su HDInsight](r-server-get-started.md)
* [Aggiungere RStudio Server a HDInsight (se non è stato installato durante la creazione del cluster)](r-server-install-r-studio.md)
