...
---
# <a name="use-azure-toolkit-for-intellij-to-debug-applications-remotely-on-hdinsight-spark"></a>Usare Azure Toolkit for IntelliJ per eseguire il debug delle applicazioni in modalità remota su HDInsight Spark
