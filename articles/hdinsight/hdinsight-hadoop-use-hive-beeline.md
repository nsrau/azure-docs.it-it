<properties
   ...
   description="Informazioni su come usare SSH per connettersi a un cluster Hadoop in HDInsight e quindi inviare query Hive in modo interattivo usando lo strumento Beeline."
   services="hdinsight"
   documentationCenter=""
   authors="Blackmist"
   manager="paulettm"
...
2. Al prompt di `beeline>` usare il comando seguente per connettersi al servizio HiveServer2:
