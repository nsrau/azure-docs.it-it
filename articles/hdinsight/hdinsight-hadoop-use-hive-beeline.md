...
3. Per salvare il file usare __CTRL__+___X__, quindi immettere __Y__ e infine premere __INVIO__.
...
Se Beeline è installato in un client esterno al cluster, è possibile connettersi usando il comando seguente. Sostituire __CLUSTERNAME__ con il nome del cluster HDInsight. Sostituire __PASSWORD__ con la password dell'account amministratore (accesso HTTP).
