...
## <a name="get-information-on-batches-running-on-the-cluster"></a>Ottenere informazioni sui batch in esecuzione nel cluster
...
## <a name="livy-and-high-availability"></a>Livy e la disponibilità elevata
...
## <a name="using-livy-on-hdinsight-35-spark-clusters"></a>Uso di Livy in cluster Spark di HDInsight 3.5 Spark
