---
title: Informazioni sull'uso di Hadoop Tools per Visual Studio per HDInsight | Microsoft Docs
...
* Una workstation con il seguente software:
  ...
  * Visual Studio (una delle versioni seguenti):
    ...
    * Visual Studio 2015 (Community/Enterprise)
    ...
    > [!NOTE]
    > Attualmente, HDInsight Tools per Visual Studio è disponibile solo con la versione in lingua inglese.
    > 
    > 
...
3. Espandere **Azure** e quindi espandere **HDInsight**.
   ...
   > [!NOTE]
   > Si noti che la finestra **Elenco attività HDInsight** è aperta. Se tale finestra non è visualizzata, selezionare **Altre finestre** dal menu **Visualizza** e fare clic su **Finestra elenco attività HDInsight**.
   > 
   > 
...
2. Fare clic con il pulsante destro del mouse su **hivesampletable** e quindi scegliere **Visualizza le prime 100 righe** per elencare le righe. Questa operazione equivale ad eseguire la seguente query Hive mediante il driver ODBC di Hive:
...
5. Fare clic su **Invia** o **Invia (Avanzato)**. L'opzione di invio avanzato consente di configurare i dati relativi a **Nome processo**, **Argomenti**, **Configurazioni aggiuntive** e **Directory stato** per lo script:
...
6. Usare il pulsante **Aggiorna** per aggiornare lo stato del processo finché non risulta **Completato**.
7. Fare clic sui collegamenti presenti nella parte inferiore per visualizzare quanto segue: **Query processo**, **Output processo**, **Log processo** o il **log Yarn**.
