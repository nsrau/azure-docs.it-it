...
* `azure hdinsight cluster delete` -Consente di eliminare un cluster HDInsight esistente
* `azure hdinsight cluster show` -visualizzare informazioni su un cluster esistente
* `azure hdinsight cluster list` -vengono elencati i cluster HDInsight per la sottoscrizione di Azure
...
* `azure hdinsight cluster resize` -modifica in modo dinamico il numero di nodi di lavoro del cluster
* `azure hdinsight cluster enable-http-access` -Abilita l'accesso HTTPs al cluster (in per impostazione predefinita)
* `azure hdinsight cluster disable-http-access` -Disabilita l'accesso HTTPs al cluster
* `azure hdinsight script-action` -fornisce comandi per la creazione/gestione di azioni Script in un cluster
* `azure hdinsight config` -fornisce comandi per la creazione di un file di configurazione che possono essere usata con il `hdinsight cluster create` comando per fornire informazioni di configurazione.
...
* [Eseguire query Apache Hive con Apache Hadoop in HDInsight mediante cURL](hadoop/apache-hadoop-use-hive-curl.md)
* [Eseguire processi Apache Pig con Apache Hadoop in HDInsight mediante cURL](hadoop/apache-hadoop-use-pig-curl.md)
...
* Comando New- `azure hdinsight cluster create myhdicluster -g myresourcegroup --location northeurope --osType linux --clusterType hadoop --defaultStorageAccountName mystorage --defaultStorageAccountKey <storagekey> --defaultStorageContainer mycontainer --userName admin -password mypassword --sshUserName sshuser --sshPassword mypassword`

**Eliminazione di un cluster**

* Comando precedente (ASM): `azure hdinsight cluster delete myhdicluster`
* Comando New- `azure hdinsight cluster delete mycluster -g myresourcegroup`

**Elencare cluster**

* Comando precedente (ASM): `azure hdinsight cluster list`
* Comando New- `azure hdinsight cluster list`
...
**Mostra le informazioni del cluster**

* Comando precedente (ASM): `azure hdinsight cluster show myhdicluster`
* Comando New- `azure hdinsight cluster show myhdicluster -g myresourcegroup`
...
* [Inviare processi Apache Hive](hadoop/apache-hadoop-use-hive-powershell.md)
* [Inviare processi Apache Pig](hadoop/apache-hadoop-use-pig-powershell.md)
* [Inviare processi Apache Sqoop](hadoop/apache-hadoop-use-sqoop-powershell.md)
