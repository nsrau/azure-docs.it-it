---
title: Usare un ambiente sandbox Hadoop per informazioni su Hadoop | Microsoft Docs
...
1. Avviare VirtualBox, selezionare Sandbox di Hortonworks, fare clic su **Avvia** e su **Avvio normale**.
...
1. Dal passaggio **introduttivo** della pagina di Sandbox di Hortonworks, selezionare **Visualizza opzioni avanzate**. Utilizzare le informazioni in questa pagina per accedere a Sandbox con SSH. Utilizzare il nome e la password forniti.
   
   > [!NOTE]
   > Se non è stato installato un client SSH, è possibile utilizzare l'SSH basato sul Web fornito dalla macchina virtuale in \_http://localhost:4200/__.
   > 
   > 
