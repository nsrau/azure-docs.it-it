...
6. Al termine del processo, l'output verrà scaricato nel file __output.txt__ nella directory corrente. Eseguire il comando seguente per visualizzare i risultati:
