...
> [AZURE.NOTE] Questo documento fornisce istruzioni sui diversi modi disponibili per creare un cluster. Per informazioni su un approccio rapido alla creazione di un cluster, vedere [Introduzione ad Azure HDInsight su Linux](hdinsight-hadoop-linux-tutorial-get-started.md).
...
Durante la configurazione sarà possibile selezionare uno di questi tipi di cluster. È possibile aggiungere altre tecnologie, ad esempio Hue o R, a questi tipi di base mediante [Azioni script](#scriptaction).
...
È possibile aggiungere altre tecnologie, ad esempio Hue o R, a questi tipi di base mediante [Azioni script](#scriptaction).
