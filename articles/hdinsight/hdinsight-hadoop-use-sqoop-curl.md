...
* [Eseguire query Hive con Hadoop in HDInsight tramite REST](hdinsight-hadoop-use-hive-curl.md)
* [Eseguire processi MapReduce con Hadoop in HDInsight tramite REST](hdinsight-hadoop-use-mapreduce-curl.md)
