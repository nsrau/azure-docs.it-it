---
title: Installare e usare Giraph in HDInsight basati su Linux (Hadoop) | Microsoft Docs
...
2. Usare la stringa seguente per creare un nuovo file denominato **tiny\_graph.txt**:
...
6. Al termine del processo, i risultati verranno archiviati nella directory **wasbs:///example/out/shotestpaths**. I file creati inizieranno con *_part-m-\*\_ e termineranno con un numero che indica il primo file, il secondo e così via. Usare la stringa seguente per ver visualizzare l'output:
