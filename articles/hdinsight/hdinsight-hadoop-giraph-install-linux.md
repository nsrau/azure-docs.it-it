...
6. Al termine del processo, i risultati verranno archiviati nella directory **wasb:///example/out/shotestpaths**. I file creati inizieranno con **part-m-** e termineranno con un numero che indica il primo file, il secondo e così via. Usare la stringa seguente per ver visualizzare l'output:
