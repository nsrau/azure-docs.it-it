...
2. Dal pannello del cluster Spark, fare clic su **Dashboard**. Quando richiesto, immettere le credenziali di amministratore per il cluster di Spark.
	...
	![Aprire gestione risorse](./media/hdinsight-apache-spark-resource-manager/HDI.Cluster.Launch.Dashboard.png "Avviare gestione risorse")
...
2. Sul dashboard di Spark HDInsight fare clic sulla scheda **Gestione risorse** e specificare i valori per **applicazione core numero predefinito** e **Esecutore memoria predefinito per ogni nodo di lavoro**. Impostare altre proprietà su 0.
