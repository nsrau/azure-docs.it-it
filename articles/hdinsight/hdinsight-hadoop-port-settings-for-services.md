...
| Service | Porta | Protocol | DESCRIZIONE |
| --- | --- | --- | --- |
...
| Service | Porta | Protocol | Tipo di cluster | DESCRIZIONE |
| --- | --- | --- | --- | --- |
...
| Service | Nodi | Porta | Protocol | DESCRIZIONE |
| --- | --- | --- | --- | --- |
...
| Service | Nodi | Porta | Protocol | Percorso URL | DESCRIZIONE |
| --- | --- | --- | --- | --- | --- |
