...
---
# <a name="use-azure-data-lake-store-with-apache-storm-with-hdinsight"></a>Usare Archivio Azure Data Lake con Apache Storm in HDInsight
...
* **ADLStoreBolt**: scrive i dati in Azure Data Lake Store usando il componente [HdfsBolt](http://storm.apache.org/javadoc/apidocs/org/apache/storm/hdfs/bolt/HdfsBolt.html).
...
* **Dal [portale di Azure](https://portal.azure.com)**: selezionare nel portale l'istanza di Azure Data Lake Store usata con HDInsight.
