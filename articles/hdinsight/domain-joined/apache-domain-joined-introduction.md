...
* Per usare VS Code per eseguire un collegamento a un cluster aggiunto al dominio, vedere [Eseguire un collegamento a un cluster aggiunto al dominio con VS Code](../hdinsight-for-vscode.md#linkcluster).
* Per usare IntelliJ per eseguire un collegamento a un cluster aggiunto al dominio, vedere [Eseguire un collegamento a un cluster aggiunto al dominio con IntelliJ](../spark/apache-spark-intellij-tool-plugin.md#linkcluster).
* Per usare Eclipse per eseguire un collegamento a un cluster aggiunto al dominio, vedere [Eseguire un collegamento a un cluster aggiunto al dominio con Eclipse](../spark/apache-spark-eclipse-tool-plugin.md#linkcluster).
