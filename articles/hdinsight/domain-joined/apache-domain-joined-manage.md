...
* Per configurare i criteri Hive ed eseguire le query Hive, vedere [Configurare criteri Hive per i cluster HDInsight con ESP](apache-domain-joined-run-hive.md).
