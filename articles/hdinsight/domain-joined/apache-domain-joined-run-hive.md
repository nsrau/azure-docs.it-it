...
description: Informazioni su come configurare i criteri di Apache Ranger per Hive in un servizio Azure HDInsight aggiunto al dominio.
services: hdinsight
