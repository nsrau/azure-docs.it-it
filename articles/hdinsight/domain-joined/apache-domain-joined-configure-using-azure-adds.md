...
> [!NOTE]  
> ESP è disponibile a livello generale in HDI 3.6 per tipi di cluster: Apache Spark e Interactive e Apache Hadoop. ESP per tipi di cluster Apache HBase e Apache Kafka è disponibile in anteprima.
