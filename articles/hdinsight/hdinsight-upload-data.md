...
* Conoscenza degli articoli seguenti:
    ...
    - [Usare l'anteprima di Archiviazione di Azure Data Lake Gen2 con cluster Azure HDInsight](../storage/blobs/data-lake-storage-use-hdi-cluster.md)  
