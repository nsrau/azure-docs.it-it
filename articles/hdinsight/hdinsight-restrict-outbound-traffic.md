...
1. Fare clic su **Aggiungi** per completare la creazione della raccolta regole di rete.
   ...
   ![Titolo: Immettere i dettagli della raccolta regole dell'applicazione](./media/hdinsight-restrict-outbound-traffic/hdinsight-restrict-outbound-traffic-add-network-rule-collection.png)
