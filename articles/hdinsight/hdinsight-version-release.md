...
* [Guida alla migrazione di HBase](https://docs.microsoft.com/azure/hdinsight/hbase/apache-hbase-migrate-new-version)
* [Guida alla migrazione di hive](https://docs.microsoft.com/azure/hdinsight/interactive-query/apache-hive-migrate-workloads)
* [Guida alla migrazione di Kafka](https://docs.microsoft.com/azure/hdinsight/kafka/migrate-versions)
* [Guida alla migrazione di Spark](https://docs.microsoft.com/azure/hdinsight/spark/migrate-versions)
