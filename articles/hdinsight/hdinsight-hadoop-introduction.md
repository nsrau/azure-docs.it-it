---
title: "Introduzione a Hadoop - Che cos&quot;è Hadoop in HDInsight? | Documentazione Microsoft"
description: Introduzione a Hadoop, all&quot;elaborazione e all&quot;analisi dei Big Data distribuiti e ai componenti dell&quot;ecosistema Hadoop nel cloud in HDInsight.
...
Hadoop fa riferimento a un ecosistema di software open source che funziona come framework per l'elaborazione distribuita, l'archiviazione e l'analisi dei set di Big Data su cluster di computer. Azure HDInsight rende disponibili nel cloud i componenti della distribuzione di **Hortonworks Data Platform (HDP)**, inoltre consente di distribuire e di effettuare il provisioning di cluster gestiti con elevata affidabilità e disponibilità.  

Il progetto open source originale per l'elaborazione dei Big Data era Apache Hadoop, a cui è succeduto lo sviluppo di software e utilità considerati parte dello stack di tecnologie Hadoop, tra cui Apache Hive, Apache HBase, Apache Spark e molti altri. Per informazioni dettagliate, vedere [Panoramica dell'ecosistema Hadoop in HDInsight](#overview) di seguito.
...
## <a name="a-nameoverviewaoverview-of-the-hadoop-ecosystem-in-hdinsight"></a><a name="overview"></a>Panoramica dell'ecosistema Hadoop in HDInsight
HDInsight è una distribuzione cloud su Microsoft Azure dello stack di tecnologie Apache Hadoop in rapida espansione per l'analisi dei Big Data. Fornisce le implementazioni di Apache Spark, HBase, Storm, Pig, Hive, Sqoop, Oozie, Ambari, e così via. HDInsight si integra anche con gli strumenti di business intelligence (BI) come Power BI, Excel, SQL Server Analysis Services e SQL Server Reporting Services.

### <a name="hadoop-hbase-spark-storm-and-customized-clusters"></a>Hadoop, HBase, Spark, Storm e cluster personalizzati
...
* **Hadoop**: fornisce un'affidabile archiviazione dei dati con [HDFS](#hdfs), nonché un semplice modello di programmazione [MapReduce](#mapreduce) per elaborare e analizzare i dati in parallelo.
...
> [!NOTE]
> Per informazioni sui componenti specifici e sulle versioni, vedere [Componenti, versioni e offerte del servizio in HDInsight][component-versioning]
> 
> 
...
### <a name="a-nameavroaavro-microsoft-net-library-for-avro"></a><a name="avro"></a>Avro (Libreria Microsoft .NET per Avro)
...
### <a name="a-namehiveahive-hcatalog"></a><a name="hive"></a>Apache Hive e HCatalog
...
### <a name="hadoopspecific-languages"></a>Linguaggi specifici di Hadoop
...
## <a name="a-nameadvantageaadvantages-of-hadoop-in-the-cloud"></a><a name="advantage"></a>Vantaggi di Hadoop nel cloud
...
* Componenti Hadoop aggiornati. Per informazioni dettagliate, vedere [Componenti, versioni e offerte del servizio in HDInsight][component-versioning].
...
* Altri tipi e dimensioni delle VM per l'esecuzione di cluster HDInsight. Per informazioni dettagliate, vedere [Componenti, versioni e offerte del servizio in HDInsight][component-versioning].
...
## <a name="a-idresourcesaresources-for-learning-more-about-bigdata-analysis-hadoop-and-hdinsight"></a><a id="resources"></a>Risorse per ottenere altre informazioni sull'analisi dei Big Data, Hadoop e HDInsight
