---
title: Creare applicazioni Spark in Scala tramite gli strumenti HDInsight nel Toolkit di Azure per Eclipse | Microsoft Docs
...
3. Fare clic sul nome del contenitore di archiviazione associato al cluster. Nel riquadro a destra verrà visualizzata una cartella denominata **HVACOut**. Fare doppio clic per aprire la cartella. Verranno visualizzati i file **part-***. Aprire uno dei file per visualizzare l'output dell'applicazione.
