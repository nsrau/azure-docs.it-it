...
---
# <a name="use-hive-and-hiveql-with-hadoop-in-hdinsight-to-analyze-a-sample-apache-log4j-file"></a>Usare Hive e HiveQL con Hadoop in HDInsight per analizzare un file Apache log4j di esempio
...
* **CREATE EXTERNAL TABLE**: crea una nuova tabella **external** in Hive. Le tabelle esterne archiviano solo la definizione della tabella in Hive. I dati vengono lasciati nella posizione e nel formato originali.
...
| [Console di query](hdinsight-hadoop-use-hive-query-console.md) |&nbsp; |✔ |Windows |Qualsiasi versione (basata su browser) |
