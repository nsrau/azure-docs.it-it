---
title: Eseguire query sui dati dall'archiviazione BLOB compatibile con HDFS | Microsoft Docs
...
> [!NOTE]
> Nelle versioni di HDInsight precedenti alla 3.0 veniva usato `asv://` al posto di `wasb://`. Non usare `asv://` con i cluster HDInsight 3.0 o versione successiva perché si verificherà un errore.
> 
> 
