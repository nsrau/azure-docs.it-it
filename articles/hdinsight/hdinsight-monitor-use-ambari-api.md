...
Lo script di Azure PowerShell seguente ottiene le informazioni di analisi del processo MapReduce *in un cluster HDInsight 3.1*.  La differenza principale consiste nel fatto che queste informazioni vengono estratte dal servizio YARN (anziché da MapReduce).
