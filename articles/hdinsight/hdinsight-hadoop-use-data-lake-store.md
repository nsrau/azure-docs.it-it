...
Per identificare il percorso completo dell'archivio predefinito configurato, passare a **HDFS** > **configs** e immettere `fs.defaultFS` nella casella filtro input.
