...
##<a name="<a-id="certificate"></a>create-a-management-certificate"></a><a id="certificate"></a>Create a management certificate
...
##<a name="<a-id="subscriptionid"></a>find-your-subscription-id"></a><a id="subscriptionid"></a>Find your subscription ID
...
##<a name="<a-id="create"></a>create-the-application"></a><a id="create"></a>Create the application
