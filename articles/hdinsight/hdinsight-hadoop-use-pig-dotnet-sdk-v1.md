...
> 
> Questo documento contiene anche informazioni sull'uso di HDInsight .NET SDK. I frammenti indicati, che si basano su comandi che usano Azure Service Management (ASM) compatibili con HDInsight, sono **deprecati** e verranno rimossi dall'1 gennaio 2017.
> 
> Per una versione di questo documento che usa il portale di Azure e i frammenti di HDInsight .NET SDK con Azure Resource Manager (ARM), vedere [Eseguire processi Pig con .NET SDK per Hadoop in HDInsight ](hdinsight-hadoop-use-pig-dotnet-sdk.md)
> 
> 
...
> [!NOTE]
> Quando si crea il certificato, assicurarsi di prendere nota del nome descrittivo usato, in quanto sarà utile in un secondo momento.
> 
> 
...
2. Premere **INVIO** per uscire dall'applicazione.
