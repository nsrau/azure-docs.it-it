...
### <a name="deprecate-spark-21-and-22-in-hdinsight-36-spark-cluster"></a>Deprecare Spark 2,1 e 2,2 nel cluster HDInsight 3,6 Spark
A partire dal 1 2020 luglio, i clienti non saranno in grado di creare nuovi cluster Spark con Spark 2,1 e 2,2 su HDInsight 3,6. I cluster esistenti vengono eseguiti così come sono, senza il supporto di Microsoft. Si consiglia di passare a Spark 2,3 in HDInsight 3,6 entro il giugno 30 2020 per evitare potenziali interruzioni di sistema/supporto.

### <a name="deprecate-spark-23-in-hdinsight-40-spark-cluster"></a>Deprecare Spark 2,3 nel cluster HDInsight 4,0 Spark
A partire dal 1 2020 luglio i clienti non saranno in grado di creare nuovi cluster Spark con Spark 2,3 in HDInsight 4,0. I cluster esistenti vengono eseguiti così come sono, senza il supporto di Microsoft. Provare a eseguire il passaggio a Spark 2,4 in HDInsight 4,0 entro il giugno 30 2020 per evitare potenziali interruzioni del sistema o del supporto.

### <a name="deprecate-kafka-11-in-hdinsight-40-kafka-cluster"></a>Deprecare Kafka 1,1 nel cluster HDInsight 4,0 Kafka
A partire dal 1 2020 luglio i clienti non saranno in grado di creare nuovi cluster Kafka con Kafka 1,1 su HDInsight 4,0. I cluster esistenti vengono eseguiti così come sono, senza il supporto di Microsoft. Provare a migrare a Kafka 2,1 in HDInsight 4,0 entro il giugno 30 2020 per evitare potenziali interruzioni di sistema/supporto.

### <a name="hbase-20-to-216"></a>Da HBase 2,0 a 2.1.6
Nella prossima versione di HDInsight 4,0, la versione di HBase verrà aggiornata dalla versione 2,0 a 2.1.6

### <a name="spark-240-to-244"></a>Da Spark 2.4.0 a 2.4.4
Nella prossima versione di HDInsight 4,0, la versione di Spark verrà aggiornata dalla versione 2.4.0 a 2.4.4
