...
> [!IMPORTANT]
> Le topologie C# nei cluster basati su Linux devono usare .NET 4.5 e devono usare Mono per l'esecuzione nel cluster HDInsight. Controllare la [compatibilità Mono](https://www.mono-project.com/docs/about-mono/compatibility/) per potenziali problemi di incompatibilità.
...
* Visual Studio 2013 con Update 4 o [Visual Studio 2013 Community](https://go.microsoft.com/fwlink/?LinkId=517284)
...
Per installare gli strumenti Data Lake per Visual Studio, seguire la procedura in [Introduzione all'uso degli strumenti Data Lake per Visual Studio](../hadoop/apache-hadoop-visual-studio-tools-get-started.md).
...
1. Installare Java Developer Kit (JDK) 7 o versione successiva nell'ambiente di sviluppo. È possibile ottenere Oracle JDK da [Oracle](https://aka.ms/azure-jdks). È inoltre possibile usare [altre distribuzioni Java](https://openjdk.java.net/).
...
* Metodo **TopologyBuilder.SetEventHubSpout**: aggiunge il componente spout Hub eventi alla topologia.
...
* [Distribuzione e monitoraggio di topologie con Apache Storm in HDInsight](apache-storm-deploy-monitor-topology.md)
...
* [Usare Apache Pig con Apache Hadoop su HDInsight](../hadoop/hdinsight-use-pig.md)
* [Usare MapReduce di Apache Hadoop con Apache Hadoop su HDInsight](../hadoop/hdinsight-use-mapreduce.md)

**Apache HBase in HDInsight**

* [Introduzione ad Apache HBase su HDInsight](../hbase/apache-hbase-tutorial-get-started-linux.md)
