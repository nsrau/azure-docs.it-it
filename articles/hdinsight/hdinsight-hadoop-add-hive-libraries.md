...
---
# <a name="add-hive-libraries-during-hdinsight-cluster-creation"></a>Aggiungere librerie Hive durante la creazione del cluster HDInsight
...
> [!NOTE]
> La procedura seguente consente di creare un nuovo cluster HDInsight basato su Linux. Per creare un nuovo cluster basato su Windows, selezionare **Windows** come sistema operativo del cluster durante la creazione del cluster e usare lo script di Windows (PowerShell) invece dello script bash.
>
