...
1. Esaminare l'output e verificare la presenza di file di grandi dimensioni nella cartella `mnt` o in altre cartelle. In genere, le cartelle `usercache`e `appcache` (mnt/Resource/Hadoop/Yarn/local/usercache/hive/AppCache/) contengono file di grandi dimensioni.
