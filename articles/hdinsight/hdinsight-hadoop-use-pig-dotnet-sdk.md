...
2. Nella finestra di dialogo Nuovo progetto digitare o selezionare i seguenti valori:
...
5. Usare il seguente comando nella console per installare i pacchetti di .NET SDK.
