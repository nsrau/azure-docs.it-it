...
* [Configurare criteri Hive in HDInsight con ESP](hdinsight-domain-joined-run-hive.md)
* [Gestire cluster HDInsight con ESP](hdinsight-domain-joined-manage.md)
