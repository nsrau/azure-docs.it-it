...
![kafka con architettura di dischi gestiti](./media/apache-kafka-scalability/kafka-with-managed-disks-architecture.png)
...
2. Nella sezione **Configurazione & prezzi** utilizzare il campo Numero di __nodi__ per configurare il numero di dischi.
    ...
    ![sezione relativa alle dimensioni del cluster con i dischi per nodo di lavoro evidenziato](./media/apache-kafka-scalability/azure-portal-cluster-configuration-pricing-kafka-disks.png)
...
È possibile trovare un modello completo che illustra [https://hditutorialdata.blob.core.windows.net/armtemplates/create-linux-based-kafka-mirror-cluster-in-vnet-v2.1.json](https://hditutorialdata.blob.core.windows.net/armtemplates/create-linux-based-kafka-mirror-cluster-in-vnet-v2.1.json)come configurare i dischi gestiti in .
