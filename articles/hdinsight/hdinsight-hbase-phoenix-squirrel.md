...
* [Configurare la replica HBase in HDInsight](hbase/apache-hbase-replication.md): informazioni su come configurare la replica HBase in due data center di Azure.
