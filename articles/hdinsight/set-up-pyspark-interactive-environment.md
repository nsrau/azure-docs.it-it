...
1. Installare [Python](https://www.python.org/) e [pip](https://pip.pypa.io/en/stable/installing/).
   
   + Installare Python da [https://pip.pypa.io/en/stable/installing](https://www.python.org/).
