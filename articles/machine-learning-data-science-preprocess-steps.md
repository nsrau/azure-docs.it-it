<properties 
	pageTitle="Pre-elaborazione e pulizia dei dati | Azure" 
	description="Pre-elaborazione e pulizia dei dati" 
...
========================================
I dati non elaborati sono fastidiosi, non affidabili e potrebbero non contenere alcuni valori. Utilizzare tali dati per la modellazione può produrre risultati fuorvianti. La pre-elaborazione e la pulizia dei dati rappresentano un passaggio importante che deve essere effettuato prima di utilizzare un set di dati per l'apprendimento automatico. In questo articolo vengono presentate alcune fasi di pre-elaborazione di dati che possono essere effettuate prima dell'inserimento dei dati in Azure Machine Learning. 

----------------

1. **Perché pre-elaborare e pulire i dati?**
	...
	La qualità dei dati è un prerequisito per modelli predittivi di qualità. Per evitare "spazzatura in entrata e in uscita" e migliorare la qualità dei dati e quindi la qualità del modello, è fondamentale condurre un'analisi dell'integrità dei dati per individuare tempestivamente problemi relativi ai dati e prendere decisioni in merito alle fasi di pre-elaborazione e pulizia dei dati corrispondenti.

2. **Quali sono le tipiche analisi dell'integrità dei dati che vengono impiegate?** 
...
3. **Quali sono alcune delle principali attività di pre-elaborazione dei dati?**
	...
	- Discretizzazione dei dati:  convertire gli attributi continui in attributi categorici per facilitare l'uso di alcuni metodi di apprendimento automatico.
	...
	Nelle sezioni seguenti vengono riportati alcuni dei passaggi di pre-elaborazione dei dati.

4. **Come trattare i valori mancanti?**
...
5. **Come normalizzare i dati?**
	...
	- Normalizzazione Min-Max: consente di trasformare in modo lineare i dati in un intervallo, diciamo compreso tra 0 e 1.  Il minimo corrisponde a 0 e il massimo a 1.
...
6. **Come eseguire la discretizzazione dei dati?**  
	...
	- Creazione di contenitori di uguale altezza: si divide l'intervallo di tutti i possibili valori di un attributo in N gruppi contenenti lo stesso numero di istanze, quindi si assegnano i valori che rientrano in un contenitore con il numero di contenitore.  

7. **Come ridurre i dati?**  
	...
	- Campionamento attributi: si selezionano soltanto gli attributi importanti nei dati.  
