...
* ID tenant (GUID) o nome di dominio (stringa) Una volta disponibili questi valori, è possibile ottenere un token di Active Directory, valido per un'ora.
...
## Altre informazioni
Documentazione su Azure SDK per Java: [documenti su Java](http://azure.github.io/azure-sdk-for-java/) Se si rilevano bug nell'SDK, registrare il problema in [Issues](https://github.com/Azure/azure-sdk-for-java/issues) o vedere [StackOverflow per Azure Java SDK](http://stackoverflow.com/questions/tagged/azure-java-sdk).
