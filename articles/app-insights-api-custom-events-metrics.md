...
![Selezionare un'istanza e quindi scegliere '...'](./media/appinsights/appinsights-23-customevents-4.png)


Usare il campo Ricerca per visualizzare le occorrenze di eventi con un valore della proprietà particolare.


![Digitare un termine in Ricerca](./media/appinsights/appinsights-23-customevents-5.png)
...
![Utilizzo di filtri nel pannello Panoramica](./media/appinsights/appinsights-47usage-2.png)
