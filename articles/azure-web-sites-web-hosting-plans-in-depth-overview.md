<properties title="Azure Websites Web Hosting Plans In-Depth Overview" pageTitle="Informazioni dettagliate sui piani di hosting Web di Siti Web di Azure - Guida alle funzionalità di Microsoft Azure" description="Informazioni sul funzionamento dei piani di hosting Web per Siti Web di Azure e sui vantaggi offerti all'esperienza di gestione." metaKeywords="Azure Web Sites, Azure Websites, WHP, Web Hosting Plan, Web Hosting Plans, Resource Groups" services="web-sites" solutions="web" documentationCenter="Infrastructure" authors="Byron Tardif and Yochay Kiryaty" videoId="" scriptId="" manager="wpickett" />
