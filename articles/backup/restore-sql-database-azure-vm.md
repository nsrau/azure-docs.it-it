---
title: Usare backup di Azure per ripristinare i database SQL Server sottoposti a backup in una macchina virtuale di Azure | Microsoft Docs
...
2. In **Seleziona punto di ripristino**selezionare se eseguire [il ripristino a un punto specifico nel tempo](#restore-to-a-specific-point-in-time) o per eseguire [il ripristino a un punto di ripristino specifico](#restore-to-a-specific-restore-point).
