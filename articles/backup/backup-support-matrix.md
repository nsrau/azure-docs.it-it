...
--- | ---
**Backup diretto del computer locale che esegue Linux** | Non supportata. L'agente MARS può essere installato solo nei computer Windows.
...
**Uso di Mab o DPM per eseguire il backup di macchine virtuali Linux di Azure** | Non supportata.
...
--- | --- | ---
**backup diretto di computer Windows locali** | N/D | ![Sì][green]
**Backup di macchine virtuali di Azure con l'estensione VM** | N/D | N/D
...
**Frequenza massima di backup in insieme di credenziali** | **Computer Windows locali o macchine virtuali di Azure che eseguono Mars:** Tre al giorno<br/><br/> **DPM/MAB:** Due al giorno<br/><br/> **Backup delle macchine virtuali di Azure:** Uno al giorno
