...
| ---------------------- | ------------------------------------------------------------ | ----------------- |
| Macchina virtuale di Azure               | Sì.   Supportato per macchine virtuali e macchine virtuali crittografate con dischi inferiori a 4 TB | Tutte le aree pubbliche di Azure.All Azure public regions.  |
