...
| **Versioni del sistema operativo**            | SLES 12 con SP2, SP3 e SP4; SLES 15 con SP0 e SP1 <br><br>   **Anteprima** -RHEL 7,4, 7,6, 7,7 e 8,1  <br>     [Introduzione](./tutorial-backup-sap-hana-db.md) a SAP Hana backup Preview per RHEL (7,4, 7,6, 7,7 e 8,1). Per ulteriori domande, scrivere all'indirizzo [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com).                |                                             |
...
> [!NOTE]
> È ora possibile [monitorare i processi di backup e ripristino](./sap-hana-db-manage.md#monitor-manual-backup-jobs-in-the-portal) nello stesso computer generati da client nativi HANA (SAP HANA Studio/pannello di controllo/pannello di controllo DBA) nel portale di Azure.

## <a name="next-steps"></a>Passaggi successivi

* Informazioni su come [eseguire il backup di database SAP HANA in esecuzione in VM di Azure](./backup-azure-sap-hana-database.md)
* Informazioni su come [ripristinare i database SAP HANA in esecuzione in VM di Azure](./sap-hana-db-restore.md)
