---
title: "Avvio rapido: Eseguire il backup di una macchina virtuale con l'interfaccia della riga di comando di Azure"
description: Questa Guida di avvio rapido illustra come creare un insieme di credenziali di servizi di ripristino, come abilitare la protezione in una macchina virtuale e come creare il punto di ripristino iniziale con l'interfaccia della riga di comando di Azure.
ms.devlang: azurecli
ms.topic: quickstart
ms.date: 01/31/2019
...
[!INCLUDE [azure-cli-prepare-your-environment.md](../../includes/azure-cli-prepare-your-environment.md)]
 ...
 - Questa guida di avvio rapido richiede l'interfaccia della riga di comando di Azure versione 2.0.18 o successiva. Se si usa Azure Cloud Shell, la versione più recente è già installata.
