...
* Verificare che l'utente che esegue l'installazione e la configurazione dell'agente MARS disponga dei privilegi di amministratore locale nel server da proteggere.
