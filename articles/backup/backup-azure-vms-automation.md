...
---
# <a name="deploy-and-manage-backups-for-resource-manager-deployed-vms-using-powershell"></a>Distribuire e gestire i backup per le macchina virtuali distribuite con Resource Manager utilizzando PowerShell
