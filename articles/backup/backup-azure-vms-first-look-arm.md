...
10. Dopo l'abilitazione del backup, viene eseguito un [backup iniziale](#run-the-initial-backup). È possibile avviare il backup iniziale immediatamente o attendere fino a quando non viene avviato in base alla pianificazione dello stesso.
