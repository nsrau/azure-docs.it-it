...
1. Installare la versione più recente dei moduli Az di Azure PowerShell da [questo collegamento](https://docs.microsoft.com//powershell/azure/install-az-ps?view=azps-3.3.0) prima di eseguire lo script.
