...
-   Non è attualmente è possibile spostare insiemi di credenziali contenenti File di Azure, Sincronizzazione file di Azure o SQL in macchine virtuali IaaS tra sottoscrizioni e gruppi di risorse. Il supporto per questi scenari verrà aggiunto nelle versioni future.
...
## <a name="register-the-subscription-to-move-your-recovery-services-vault"></a>Registrare la sottoscrizione per spostare l'insieme di credenziali di Servizi di ripristino

Per registrare la sottoscrizione per **spostare** l'insieme di credenziali di Servizi di ripristino, eseguire i cmdlet seguenti dal terminale di PowerShell:
