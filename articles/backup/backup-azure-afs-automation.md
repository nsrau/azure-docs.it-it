...
1. [Scaricare la versione più recente di PowerShell 'Az'](https://docs.microsoft.com/powershell/azure/install-az-ps?view=azurermps-6.13.0) (la versione minima richiesta è: 1.0.0)
