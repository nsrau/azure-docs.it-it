...
## Ripristino di una macchina virtuale durante un'emergenza del data center di Azure
...
> [!WARNING]
> Per le macchine virtuali del controller di dominio in un ambiente con più controller di dominio, non usare il portale di Azure per il ripristino. È supportato solo il ripristino basato su PowerShell.
> 
> 
