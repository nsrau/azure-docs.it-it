---
title: 'Errore di backup delle VM di Azure: non è stato possibile comunicare con l''agente della macchina virtuale per lo stato dello snapshot a causa del timeout della sottoattività di creazione snapshot della macchina virtuale | Microsoft Docs'
