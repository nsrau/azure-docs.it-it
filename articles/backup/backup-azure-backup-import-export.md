---
title: Seeding del backup offline con il servizio di importazione/esportazione di backup di Azure
...
1. Quando si pianifica un backup per l'agente di Servizi di ripristino di Microsoft Azure, viene visualizzata la schermata seguente.
    ...
    * **Account di archiviazione di Azure Resource Manager**: Nome dell'account di archiviazione del tipo di Gestione risorse (utilizzo generico V1 o utilizzo generico v2) in qualsiasi sottoscrizione di Azure.
