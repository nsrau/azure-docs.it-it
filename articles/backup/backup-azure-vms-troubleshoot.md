...
| Le macchine virtuali con dischi rigidi virtuali archiviati nel servizio di archiviazione Premium non sono supportate per il backup |Nessuna. |
...
| La subnet selezionata non esiste. Selezionare una subnet esistente |None |
