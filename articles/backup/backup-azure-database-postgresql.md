---
title: Backup di database di Azure per PostgreSQL
...
- Accesso basato su RBAC al database tramite l'autenticazione Azure Active Directory e identità del servizio gestita (MSI).
