...
## Creare una nuova macchina virtuale dal punto di ripristino
...
## Usare i modelli per personalizzare una macchina virtuale di ripristino
...
## Ripristino di una macchina virtuale durante un'emergenza nel data center di Azure
...
### Controller di dominio unico in un singolo dominio
...
### Controller di dominio multipli in un singolo dominio
...
### Domini multipli in una foresta
