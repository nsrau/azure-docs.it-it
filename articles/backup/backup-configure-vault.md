---
title: Eseguire il backup di Windows Server o client in Azure con Backup di Azure tramite il modello di distribuzione di Resource Manager| Microsoft Docs
