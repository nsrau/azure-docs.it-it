...
| Comando | Note |
|---|---|
| [creare il gruppo di AZ](https://docs.microsoft.com/cli/azure/group) | Consente di creare un gruppo di risorse in cui sono archiviate tutte le risorse. |
