---
title: Impostare un dominio Internet aziendale in modo che punti a un dominio di Gestione traffico | Microsoft Docs
...
> [!IMPORTANT]
> Non è possibile scegliere un dominio di secondo livello, come *contoso.com*, per il dominio di Gestione traffico. Si tratta del limite del protocollo DNS, che non consente record CNAME per i nomi di dominio di secondo livello.
> 
> 
