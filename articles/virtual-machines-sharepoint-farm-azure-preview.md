...
Dal sito Amministrazione centrale di SharePoint è possibile configurare i siti personali, le applicazioni di SharePoint e altre funzionalità. Per altre informazioni, vedere [Configurare SharePoint 2013][Configurare SharePoint 2013]. Per accedere al sito Amministrazione centrale di SharePoint, è prima necessario ottenere il relativo numero di porta esterna.
...
La funzionalità Farm di SharePoint Server usa Gestione risorse di Azure e script per creare automaticamente le configurazioni dell'infrastruttura e dei server per le farm di SharePoint. Per altre informazioni, vedere [Utilizzo di Windows PowerShell con Gestione risorse][Utilizzo di Windows PowerShell con Gestione risorse].
