<properties pageTitle="Farm di SharePoint Server" description="Descrive la nuova funzionalità Farm di SharePoint Server disponibile nel portale di anteprima di Azure." services="virtual-machines" documentationCenter="" authors="JoeDavies-MSFT" manager="timlt" editor=""/>
...
[Configurazione di una farm Intranet di SharePoint in un cloud ibrido a scopo di test](http://azure.microsoft.com/it-it/documentation/articles/virtual-networks-setup-sharepoint-hybrid-cloud-testing/)
