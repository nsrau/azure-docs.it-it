...
- [Installare e configurare Ansible su Linux per l'uso in Azure](../articles/ansible/ansible-install-configure.md).
- [Creare una macchina virtuale Linux](../articles/ansible/ansible-create-vm.md).
- [Gestire una macchina virtuale Linux](../articles/ansible/ansible-manage-linux-vm.md).
...
- [Installare Chef in Windows e creare macchine virtuali di Azure](../articles/chef/chef-automation.md).
...
- [Installare e configurare Terraform con Azure](/azure/developer/terraform/install-configure).
...
- [Come creare un'infrastruttura di sviluppo in una macchina virtuale Linux in Azure con Jenkins, GitHub e Docker](../articles/jenkins/tutorial-jenkins-github-docker-cicd.md).
