...
In questo articolo viene illustrato come utilizzare [MongoLab] per creare un database MongoDB da [Azure Store]. [MongoLab] è un fornitore di MongoDB come servizio, che consente di eseguire e gestire database MongoDB in data center di Azure e di connettersi a tali database da qualsiasi applicazione.

Per creare un database MongoDB da [Azure Store], eseguire la procedura seguente:
