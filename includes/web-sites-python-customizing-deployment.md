Per stabilire se l'applicazione usa Python, Azure verifica **se entrambe le condizioni seguenti sono vere**:
...
[Interfaccia della riga di comando di Azure]: http://azure.microsoft.com/it-it/downloads/
<!--HONumber=42-->
