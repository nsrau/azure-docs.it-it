In questo scenario si creerà una rete virtuale denominata **TestVNet** con un blocco CIDR riservato di **192.168.0.0./16**. Una rete virtuale conterrà le subnet seguenti:
