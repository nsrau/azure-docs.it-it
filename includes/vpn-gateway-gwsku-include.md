...
> [!NOTE]
> Gli SKU VpnGw (VpnGw1, VpnGw1A, VpnGw2, VpnGw2A, VpnGw3, VpnGw3, VpnGw3, VpnGw4, VpnGwa e VpnGw5A) sono supportati solo per il modello di distribuzione di Resource Manager. Le reti virtuali di tipo classico devono continuare a usare gli SKU di versione precedente.
...
| **Sku**| **Caratteristiche**|
| ---    | ---         |
|**Di base** (sezione )   | **VPN basata su route**: 10 tunnel per connessioni da sito a sito; assenza di autenticazione RADIUS per connessioni da punto a sito; assenza di IKEv2 per connessioni da punto a sito<br>**VPN basata su criteri**: (IKEv1): 1 tunnel per connessioni da sito a sito; nessuna connessione da punto a sito|
| **Tutti gli SKU Generazione1 e Generazione2 ad eccezione di BasicAll Generation1 and Generation2 SKUs except Basic** | **VPN basata su route**: fino a 30 tunnel (\*), P2S, BGP, attivo-attivo, IPsec personalizzato/criteri IKE, coesistenza ExpressRoute/VPN |
|        |             |

(*) È possibile configurare "PolicyBasedTrafficSelectors" per connettere un gateway VPN basato su route a più dispositivi firewall basati su criteri locali. Per informazioni dettagliate, vedere [Connect VPN gateways to multiple on-premises policy-based VPN devices using PowerShell](../articles/vpn-gateway/vpn-gateway-connect-multiple-policybased-rm-ps.md) (Connettere gateway VPN a più dispositivi VPN basati su criteri tramite PowerShell).
...
###  <a name="gateway-skus---production-vs-dev-test-workloads"></a><a name="workloads"></a>SKU del gateway - Carichi di lavoro tra produzione e sviluppo
...
| ---                                | ---                    |
| **Carichi di lavoro critici, di produzione** | Tutti gli SKU Generazione1 e Generazione2 ad eccezione di BasicAll Generation1 and Generation2 SKUs except Basic |
