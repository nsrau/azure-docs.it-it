...
1. Completare la procedura illustrata nell'argomento [Registrazione delle app per l'accesso a Twitter con Servizi mobili](../articles/mobile-services/mobile-services-how-to-register-twitter-authentication.md), se non è ancora stata eseguita. 
...
2. Passare al sito Web per [sviluppatori Twitter](http://go.microsoft.com/fwlink/p/?LinkId=268300), accedere con le credenziali dell'account Twitter e selezionare l'app Twitter.
...
4. Accedere al [portale di Azure classico](https://manage.windowsazure.com/), fare clic su **Servizi mobili** e quindi sul servizio mobile.
...
6. Fare clic sulla scheda **Configura**, scorrere fino a **Impostazioni app** e immettere una coppia **Nome** e **Valore** per ognuno degli elementi seguenti ottenuti dal sito Twitter, quindi fare clic su **Salva**.
