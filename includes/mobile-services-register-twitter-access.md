...
1. Se non è stato già fatto, completare la procedura descritta nell'argomento <a href="../articles/mobile-services-how-to-register-twitter-authentication.md/" target="_blank">Registrare le app per l'autenticazione di Twitter con Servizi mobili</a>. 
...
[Registrare le app per l'autenticazione di Twitter con Servizi mobili]: ../articles/mobile-services-how-to-register-twitter-authentication.md
