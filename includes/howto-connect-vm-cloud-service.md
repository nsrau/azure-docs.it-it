...
> [WACOM.NOTE] Se le VM si trovano nello stesso servizio cloud, sarà anche possibile bilanciarne il carico e gestirne la disponibilità, eseguendo alcuni passaggi aggiuntivi. Per informazioni dettagliate, vedere [Bilanciamento del carico delle macchine virtuali](../../articles/load-balance-virtual-machines/) e [Gestione della disponibilità delle macchine virtuali](../../articles/manage-availability-virtual-machines/). 
