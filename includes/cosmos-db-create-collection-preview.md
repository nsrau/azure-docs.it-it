...
2. Nella pagina **Aggiungi contenitore** immettere le impostazioni per il nuovo contenitore.
    ...
    |**ID contenitore**|Elementi|Immettere *Items* come nome per il nuovo contenitore. Gli ID contenitore prevedono gli stessi requisiti relativi ai caratteri dei nomi di database.|
