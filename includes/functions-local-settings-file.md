...
Il local.settings.jssu file archivia le impostazioni dell'app, le stringhe di connessione e le impostazioni usate dagli strumenti di sviluppo locali. Le impostazioni nel local.settings.jsfile vengono usate solo quando si eseguono progetti localmente. La struttura del file di impostazioni locale è la seguente:
