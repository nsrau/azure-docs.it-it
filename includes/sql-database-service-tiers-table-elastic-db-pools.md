...
| Dimensioni pool (eDTU)  |  **1200** | **1600** | **2000** | **2500** | 
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |
| Spazio di archiviazione massimo per pool* | 1,2 TB | 1,6 TB | 2 TB | 2,4 TB | 
| Numero massimo di database per pool | 500 | 500 | 500 | 500 | 500 | 
| Numero massimo di ruoli di lavoro simultanei per pool |  2400 | 3200 | 4000 | 5000 |
| Numero massimo di accessi simultanei per pool |  2400 | 3200 | 4000 | 5000 | 
...
| Numero massimo di sessioni simultanee per pool | 30000 | 30000 | 30000 | 30000 | 30000 | 
| Numero minimo di eDTU per database | {0,25,50,75,<br>125} | {0,25,50,75,<br>125,250} | {0,25,50,75,<br>125,250,500} | {0,25,50,75,<br>125,250,500,<br>1000} | {0,25,50,75,<br>125,250,500,<br>1000} | 
| Numero massimo di eDTU per database | {25,50,75,<br>125} | {25,50,75,<br>125,250} | {25,50,75,<br>125,250,500} | {25,50,75,<br>125,250,500,<br>1000} | {25,50,75,<br>125,250,500,<br>1000} |  
||||||||

### <a name="premium-elastic-pool-limits-continued"></a>Limiti del pool elastico Premium (continua)

| Dimensioni pool (eDTU)  |  **2000** | **2500** | **3000** | **3500** | 
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |
| Spazio di archiviazione massimo per pool* | 750 GB| 750 GB| 750 GB| 750 GB| 
| Numero massimo di database per pool | 100 | 100 | 100 | 100 | 100 | 
| Numero massimo di ruoli di lavoro simultanei per pool |  3200 | 4000 | 4800 | 5600 | 
| Numero massimo di accessi simultanei per pool |  3200 | 4000 | 4800 | 5600 | 
| Numero massimo di sessioni simultanee per pool | 30000 | 30000 | 30000 | 30000 | 30000 | 
| Numero minimo di eDTU per database | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | 
| Numero massimo di eDTU per database | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | 
||||||||
