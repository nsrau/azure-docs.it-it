...
Per eseguire i passaggi in questo articolo, sarà necessario [installare l'interfaccia della riga di comando di Azure per Mac, Linux e Windows (Azure CLI)](xplat-cli-install.md) e sarà necessario [accedere a Azure](xplat-cli-connect.md).
