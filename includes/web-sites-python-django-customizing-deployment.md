...
È possibile utilizzare il [interfaccia della riga di comando di Azure] [ Azure command-line interface] per creare i file.  Usare questo comando dalla cartella del progetto:
