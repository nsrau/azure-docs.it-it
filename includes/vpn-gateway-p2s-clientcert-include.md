...
- **Certificato aziendale:**
  ...
  - Se si utilizza una soluzione di certificato aziendale, generare un certificato client con il *nome\@* di formato del valore del nome comune yourdomain.com . Usare questo formato anziché il formato *nome dominio\nome utente*.
...
- **Certificato radice autofirmato:** Seguire i passaggi descritti in uno dei seguenti articoli sui certificati P2S in modo che i certificati client creati siano compatibili con le connessioni P2S. I passaggi negli articoli indicati generano un certificato compatibile: 
  ...
  * [Istruzioni MakeCert](../articles/vpn-gateway/vpn-gateway-certificates-point-to-site-makecert.md): Usare MakeCert se non si ha accesso a un computer Windows 10 per la generazione di certificati. Sebbene MakeCert sia deprecato, è comunque possibile usarlo per generare i certificati. È possibile installare i certificati generati in qualsiasi client con connessione da punto a sito supportato.
