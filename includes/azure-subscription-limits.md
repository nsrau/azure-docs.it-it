...
ms.locfileid: "66238381"
---
| Resource | Limite predefinito | Limite massimo |
| --- | --- | --- |
| per ogni Vcpu [abbonamento](../articles/billing-buy-sign-up-azure-subscription.md)<sup>1</sup> |20 |10,000 |
| [Ai coamministratori](../articles/billing-add-change-azure-subscription-administrator.md) per ogni sottoscrizione |200 |200 |
...
| Lunghezza del nome sottoscrizione (caratteri) | 64 | 64 |

<sup>1</sup>conteggio delle istanze piccole aggiuntivi sotto una CPU virtuale per il limite di vCPU nonostante l'uso di un core CPU parziale.
