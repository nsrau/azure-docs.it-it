...
<sup>2</sup>Il limite dell'account di archiviazione include sia l'account di archiviazione Standard che l'account di archiviazione Premium. Se sono necessari più di 200 account di archiviazione in un'unica area, inviare una richiesta tramite il [supporto tecnico di Azure](https://azure.microsoft.com/support/faq/). Il team di Archiviazione di Azure esaminerà il caso aziendale e potrà approvare fino a un massimo di 250 account di archiviazione. 
