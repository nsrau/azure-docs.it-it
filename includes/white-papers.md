<h1>White paper su Azure</h1>


Nei white paper elencati di seguito vengono presentati ulteriori punti di vista e prospettive sui servizi di Azure.
    ...
    <tbody>
      <tr>
        <td  style="width: 200px;">
          <a href="http://go.microsoft.com/?linkid=9751405">Procedure di sicurezza consigliate per lo sviluppo di applicazioni Azure</a>

        </td>

        <td  style="width: 400px;">In questo white paper vengono illustrate le problematiche di sicurezza e gli approcci consigliati per progettare e sviluppare applicazioni più sicure per la piattaforma Microsoft Azure.</td>

      </tr>

      <tr>
        <td  style="width: 200px;">
          <a href="http://download.microsoft.com/download/6/0/2/6028B1AE-4AEE-46CE-9187-641DA97FC1EE/Windows%20Azure%20Security%20Overview%20v1.01.pdf">Panoramica della sicurezza in Azure</a>

        </td>

        <td  style="width: 400px;">In questo white paper vengono descritti i controlli implementati all'interno di Azure per consentire ai clienti di determinare se queste funzionalità e questi controlli sono adatti per i propri requisiti specifici.</td>

      </tr>

      <tr>
        <td  style="width: 200px;">
          <a href="http://download.microsoft.com/download/F/2/6/F26E80C5-C43B-4913-99AB-F2E4DFBFCBBF/Single%20Sign-On%20from%20Active%20Directory%20to%20a%20Windows%20Azure%20Application%20Whitepaper-RTW.pdf">White paper su Single Sign-On da Active Directory a un'applicazione Azure</a>

        </td>

        <td  style="width: 400px;">In questo white paper sono presentate istruzioni dettagliate per l'utilizzo di Windows Identity Foundation, Azure e Active Directory Federation Services (ADFS) 2.0 per implementare SSO nelle applicazioni Web distribuite in locale e nel cloud.</td>

      </tr>

      <tr>
        <td  style="width: 200px;">
          <a href="http://go.microsoft.com/fwlink/?LinkId=153401">Tabella di Azure: programmazione dell'archiviazione di tabelle</a>

        </td>

        <td  style="width: 400px;">In questo white paper viene illustrato Tabella di Azure, l'archivio strutturato fornito dalla piattaforma Azure. Supporta tabelle estremamente scalabili nel cloud, che possono contenere miliardi di entità e terabyte di dati.</td>
