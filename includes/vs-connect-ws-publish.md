...
* Fare clic su **Manage subscriptions** per installare un certificato di gestione che consenta di accedere all'account.
  ...
  Nella finestra di dialogo **Gestisci sottoscrizioni Azure** fare clic sulla scheda **Certificati**, quindi fare clic su **Importa**. Attenersi alle istruzioni per scaricare e importare un file di sottoscrizione (denominato anche file *.publishsettings* ) per l'account Azure.
