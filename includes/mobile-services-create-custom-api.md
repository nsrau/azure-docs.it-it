...
1. Accedere al portale di gestione di Azure, fare clic su **Servizi mobili**, quindi selezionare il servizio mobile.

2. Fare clic sulla scheda **API** e quindi su **Crea**. Verrà visualizzata la finestra di dialogo **Crea nuova API personalizzata**.

3. Digitare _completeall_ in **Nome API**, quindi fare clic sul segno di spunta per creare la nuova API.
