...
Per visualizzare un elenco di gateway di rete locali, usare il comando [az network local-gateway list](https://docs.microsoft.com/cli/azure/network/local-gateway#list).
...
Per trovare l'indirizzo IP pubblico del gateway di rete virtuale, usare il comando [az network public-ip list](https://docs.microsoft.com/cli/azure/network/public-ip#list). Per facilitare la lettura, la formattazione dell'output di questo esempio visualizza l'elenco di IP pubblici in formato tabella.
