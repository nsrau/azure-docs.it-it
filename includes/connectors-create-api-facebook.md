...
1. Per creare una connessione a Facebook, nella finestra di progettazione dell'app per la logica, selezionare **Show Microsoft managed APIs** (Mostra API gestite da Microsoft) nell'elenco a discesa, quindi immettere *Facebook* nella casella di ricerca. Selezionare il trigger o l'azione che si desidera usare: ![facebook passaggio 1](./media/connectors-create-api-facebook/facebook-1.png)
