...
Se si crea un record SRV nella radice della zona, specificare semplicemente *_service* e *_protocol* nel nome del record. Non è necessario include"@" nel nome del record.
