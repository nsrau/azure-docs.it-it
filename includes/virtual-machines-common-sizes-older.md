...
**Raccomandazione sulle dimensioni più recenti**: [serie AV2](../articles/virtual-machines/windows/sizes-general.md#av2-series)
...
| Dimensioni | vCPU | Memoria: GiB | Spazio di archiviazione temp (HDD): GiB | Numero massimo di dischi dati | Velocità effettiva del disco di dati max: IOPS | Schede di interfaccia di rete max/larghezza di banda della rete prevista (Mbps)  |
| --- | --- | --- | --- | --- | --- | --- |
...
<sup>1</sup> Per le applicazioni MPI, la rete back-end RDMA dedicata viene abilitata dalla rete InfiniBand QDR, che offre bassa latenza e larghezza di banda elevata.  

<br>

### <a name="d-series"></a>Serie D  

**Raccomandazione sulle dimensioni più recenti**: [serie dv3](../articles/virtual-machines/windows/sizes-general.md#dv3-series-1)
...
**Raccomandazione sulle dimensioni più recenti**: [serie DSv3](https://docs.microsoft.com/azure/virtual-machines/windows/sizes-general#dsv3-series-1)
