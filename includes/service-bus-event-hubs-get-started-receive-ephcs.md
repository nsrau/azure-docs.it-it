...
7. Fare clic con il pulsante destro del mouse sul progetto **Receiver**, scegliere **Aggiungi** e quindi **Classe**. Assegnare alla nuova classe il nome **SimpleEventProcessor**, quindi fare clic su **OK** per crearla. 
...
9. All'inizio della classe **Program** aggiungere le seguenti istruzioni `using`:
