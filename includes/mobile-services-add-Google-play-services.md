...
7.  In **Destinazione di compilazione progetto** assicurarsi che sia selezionato `Google APIs x86` (o `Google APIs`, a seconda della piattaforma di sviluppo) per il livello di SDK appropriato.
