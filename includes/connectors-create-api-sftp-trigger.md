...
2. Il controllo **Quando viene aggiunto o modificato un file** apre  
   ![Immagine di trigger SFTP 2](./media/connectors-create-api-sftp/trigger-2.png)  
3. Selezionare **...** sul lato destro del controllo per aprire il controllo di selezione della cartella  
