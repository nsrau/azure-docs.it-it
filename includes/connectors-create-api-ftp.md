...
1. Per creare una connessione a FTP, nella finestra di progettazione dell'app per la logica, selezionare **Show Microsoft managed APIs** (Mostra API gestite da Microsoft) nell'elenco a discesa, quindi immettere *FTP* nella casella di ricerca. Selezionare il trigger o l'azione che si desidera usare:  
