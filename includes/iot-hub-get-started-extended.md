...
|----------------------------------------------------------- |------------------------------------|
| [Gestire i messaggi dell'hub IoT](../articles/iot-hub/iot-hub-vscode-iot-toolkit-cloud-device-messaging.md)                  | Estensione dell'hub IoT di Azure di codice VSVS Code Azure IoT Hub extension|
...
| [Gestire un dispositivo IoT](../articles/iot-hub/iot-hub-device-management-iot-toolkit.md)                | Estensione dell'hub IoT di Azure di codice VSVS Code Azure IoT Hub extension|
