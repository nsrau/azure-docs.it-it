1.  Nel [portale di gestione][portale di gestione] di Azure fare clic su **Macchine virtuali**, quindi selezionare la macchina virtuale appena creata (**testlinuxvm**).
