...
Il progetto del servizio mobile scaricato consente di eseguire il nuovo servizio mobile direttamente sul computer locale o sulla macchina virtuale. Questo semplifica l'esecuzione del debug del codice del servizio ancor prima della pubblicazione in Azure.
