...
1. In Android Studio, fare clic su **Strumenti** > **Android** > **SDK Manager**. Se la versione più recente della piattaforma SDK non è installata, fare clic per installarla. Prendere nota del numero di versione.
