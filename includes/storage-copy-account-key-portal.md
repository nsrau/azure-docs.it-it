...
4. Prendere nota del nome dell'account di archiviazione, che dovrà essere specificato per l'autenticazione.   
5. Trovare il valore **Chiave** in **key1** e fare clic sul pulsante **Copia** per copiare la chiave dell'account.
