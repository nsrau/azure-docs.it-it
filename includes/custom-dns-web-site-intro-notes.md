> [WACOM.NOTE] **Le procedure descritte in questo articolo si applicano a Siti Web di Azure**. Per Servizi cloud vedere <a href="/it-it/develop/net/common-tasks/custom-dns/">Configurazione di un nome di dominio personalizzato per un sito Web di Azure</a>.
>
