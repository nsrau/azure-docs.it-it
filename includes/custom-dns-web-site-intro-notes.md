...
> 
> **I nomi di dominio personalizzati non sono abilitati per il livello gratuito**. È necessario [passare a un piano tariffario superiore](../articles/app-service/web-sites-scale.md), che potrebbe modificare le condizioni di addebito per la sottoscrizione. 
