...
1. Passare al portale di [Azure](https://portal.azure.com) per gestire il gruppo di risorse contenente la macchina virtuale da spostare. Cercare e selezionare **Gruppi di risorse**.
...
1. Passare al portale di [Azure](https://portal.azure.com) per gestire il gruppo di risorse contenente la macchina virtuale da spostare. Cercare e selezionare **Gruppi di risorse**.
2. Scegliere il gruppo di risorse contenente la macchina virtuale che si desidera spostare.
3. Nella parte superiore della pagina del gruppo di risorse selezionare **Sposta** e quindi Sposta in un altro gruppo di **risorse.** Si apre la pagina **Sposta risorse**.
4. Selezionare ognuna delle risorse da spostare. Nella maggior parte dei casi, è necessario spostare tutte le risorse correlate elencate.
