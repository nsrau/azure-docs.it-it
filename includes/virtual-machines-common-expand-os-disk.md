...
5. A questo punto, impostare le dimensioni del disco del sistema operativo sul valore desiderato e aggiornare la VM come segue:
   ...
   > [!WARNING]
   > Le nuove dimensioni devono essere maggiori delle dimensioni del disco esistente. Il valore massimo consentito è 1023 GB.
   > 
   > 
...
Per informazioni su come collegare i dischi a una VM di Azure Resource Manager, consultare questo [articolo](../articles/virtual-machines/virtual-machines-windows-attach-disk-portal.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
