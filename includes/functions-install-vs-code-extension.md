...
1. In Visual Studio Code aprire **estensioni** e cercare funzioni di **Azure**oppure selezionare il collegamento seguente in Visual Studio Code: `vscode:extension/ms-azuretools.vscode-azurefunctions` .
