...
[Nella figura 2](#fig2) è illustrata la prima di queste due opzioni, per la quale è necessario solo Azure Active Directory.
...
<a id="fig3"></a>Figura 3: un'organizzazione può federare Windows Server Active Directory con Azure Active Directory per concedere agli utenti l'accesso Single Sign-On alle applicazioni SaaS.
...
<a id="fig4"></a>Figura 4: Controllo di accesso di Azure Active Directory consente alle applicazioni di accettare token di identità emessi da provider di identità diversi.
