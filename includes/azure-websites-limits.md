...
Tempo di CPU (breve)<sup>6</sup>|3 minuti|3 minuti|Illimitato, pagamento con [tariffe](https://azure.microsoft.com/pricing/details/app-service/)</a>standard|Senza limiti, pagamento con tariffe standard|Senza limiti, pagamento con tariffe standard
