...
Se il modello di utilizzo dei dati cambia, è anche possibile passare da uno di questi livelli di accesso all'altro in qualsiasi momento. La modifica del livello di accesso può comportare costi aggiuntivi. Per informazioni dettagliate, vedere [Prezzi e fatturazione per gli account di archiviazione BLOB](../articles/storage/blobs/storage-blob-storage-tiers.md#pricing-and-billing) .
