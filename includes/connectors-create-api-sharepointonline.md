...
1. Nella casella di ricerca digitare SharePoint e attendere che la ricerca restituisca tutti i trigger e le azioni correlati a SharePoint Online: ![Configurare SharePoint][1]
2. Selezionare il trigger **SharePoint Online - Quando un file viene creato**
...
5. Al termine dell'autenticazione si verrà reindirizzati all'app per la logica. A questo punto, la connessione è stata creata. Il messaggio che appare nella parte inferiore indica che si è connessi a SharePoint. ![Configurare SharePoint][4]
