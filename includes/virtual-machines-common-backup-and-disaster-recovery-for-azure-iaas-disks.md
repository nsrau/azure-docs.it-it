...
| --- | --- | --- |
| Dischi di Archiviazione Premium | Locale ([archiviazione con ridondanza locale](../articles/storage/common/storage-redundancy-lrs.md)) | [Backup di Azure](https://azure.microsoft.com/services/backup/) |
