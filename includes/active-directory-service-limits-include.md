...
| Oggetti |<ul><li>Gli utenti dell'edizione gratuita di Azure Active Directory possono usare fino a 500.000 oggetti in una singola directory.</li><li>Un utente non amministratore può creare al massimo 250 oggetti.</li></ul> |
