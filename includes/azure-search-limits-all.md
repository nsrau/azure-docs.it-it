...
---|---|---|---|----
Numero massimo di servizi di ricerca|N/D|---|12 per ogni sottoscrizione di Azure|12 per ogni sottoscrizione di Azure
...
Indice: numero massimo di profili di punteggio per indice|16|16|16|16 
Indice: numero massimo di funzioni per profilo|8|8|8|8 
...
Indicizzatore BLOB: dimensioni massime per un BLOB, MB|16|16|128|256 Indicizzatore BLOB: numero massimo di caratteri di contenuto estratti da un BLOB|32.000|64.000|4 milioni|4 milioni
Query al secondo (QPS, Query Per Second) <sup>2</sup>|N/D|~3 per replica|~15 per replica|~60 per replica Aumento del numero di istanze: numero massimo di unità di ricerca (SU, Search Unit)<sup>3</sup>|N/D|Fino a 3 unità (3 repliche e 1 partizione)|36 unità|36 unità
Prezzi <sup>4</sup>|N/D|$75 per SU al mese|$250 per SU al mese|$1000 per SU al mese
