...
3. Verificare che **Nome**e**Porta pubblica** dell’endpoint del listener che si desidera utilizzare non siano già in uso. Nell'esempio seguente, il nome è "MyEndpoint" e la porta è "1433".
