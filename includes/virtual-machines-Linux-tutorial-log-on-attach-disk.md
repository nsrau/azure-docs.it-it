...
-   Se si usa un computer che esegue un sistema operativo Windows, è possibile usare un client SSH come PuTTY. Per altre informazioni, vedere la pagina [PuTTY Download][PuTTY Download].
-   Se si usa un computer che esegue un sistema operativo Linux, è possibile usare un client SSH come OpenSSH. Per altre informazioni, vedere la pagina [OpenSSH][OpenSSH].
...
8.  È necessario creare il file system nella nuova partizione. Ad esempio, digitare il comando seguente per creare il file system, quindi immettere la password per l'account:
    ...
    > [WACOM.NOTE] I sistemi SUSE Linux Enterprise 11 forniscono solo l'accesso in lettura per i file system ext4. Per questi sistemi si consiglia di formattare il nuovo file system come ext3 invece che come ext4.
...
11. Aggiungere la nuova unità a /etc/fstab:
  ...
  [gestione di dischi e immagini in Azure]: http://msdn.microsoft.com/it-it/library/jj672979.aspx
