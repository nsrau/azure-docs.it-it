...
| Dimensioni di una transazione di gruppi di entità | Una transazione può includere al massimo 100 entità e il payload deve avere una dimensione inferiore a 4 MiB. Una transazione del gruppo di entità può includere un aggiornamento a un'entità una sola volta. |
