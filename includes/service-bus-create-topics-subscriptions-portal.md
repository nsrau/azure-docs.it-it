...
## <a name="create-a-subscription-to-the-topic"></a>Creare una sottoscrizione all'argomento
...
3. Nella pagina **Crea sottoscrizione** immettere un **nome** per la sottoscrizione e quindi selezionare **Crea**. 
