...
|[JavaScript](../articles/azure-functions/functions-reference-node.md#node-version)|GA (nodo 6)|GA (Nodo 8 e 10)| GA (Node 10 e 12) |
...
|[Python](../articles/azure-functions/functions-reference-python.md)#python-version|N/D|GA (Python 3.6 e 3.7)| GA (Python 3.6, 3.7 e 3.8)|
|[TypeScript](../articles/azure-functions/functions-reference-node.md#typescript) |N/D|GA<sup>1</sup>| GA<sup>1</sup> |


<sup>1</sup>Supportato tramite compilazione da sorgente a sorgente di JavaScript.
