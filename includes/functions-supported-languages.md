...
|[JavaScript](../articles/azure-functions/functions-reference-node.md#node-version)|GA (nodo 6)|GA (Nodo 8 e 10)| GA (nodo 10 & 12) |
...
<sup>1 : il</sup> nome del Supportato tramite la transpiling in JavaScript.
