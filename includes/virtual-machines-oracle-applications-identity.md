...
La partnership Microsoft-Oracle consente di configurare un'identità unificata in Azure, OCI e nell'applicazione Oracle. Per JD Edwards EnterpriseOne o PeopleSoft Application Suite, è necessaria un'istanza del server HTTP Oracle (OHS) per configurare Single Sign-On tra Azure AD e Oracle IDC.
