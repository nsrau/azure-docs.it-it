...
| **Modello di distribuzione/Strumento** | **Portale classico** | **Portale di Azure** | **PowerShell** |
|-----------------------|----------------|--------------|------------|
| **Classico** | No | No | [Articolo](../articles/vpn-gateway/vpn-gateway-about-forced-tunneling.md) |
| **Gestione risorse** | No | No | [Articolo](../articles/vpn-gateway/vpn-gateway-forced-tunneling-rm.md) |
