...
2.  Fare clic su **funzionalità di anteprima** per visualizzare le anteprime disponibili.<br /> ![Scheda di anteprima delle funzionalità][1]
3.  Scorrere verso il basso per selezionare la funzionalità da abilitare, quindi fare clic su **Prova subito**.<br /> ![selezionare una funzionalità di anteprima][2]
4.  Selezionare la sottoscrizione e fare clic sul segno di spunta.<br /> ![selezionare la sottoscrizione][3]
