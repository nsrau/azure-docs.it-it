...
|Tipo di chiave|HSM key<br>CREATE key|HSM key<br>Tutte le altre transazioni|Chiave software<br>CREATE key|Chiave software<br>Tutte le altre transazioni|
|:---|---:|---:|---:|---:|
...
| Tipo di transazioni | Maximum transactions allowed in 10 seconds, per vault per region<sup>1</sup> |
| --- | --- |
