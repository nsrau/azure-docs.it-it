...
| Dispositivo gateway | Autorizzazione di *CREAZIONE* per i sensori. Autorizzazione di *lettura* per dispositivi e sensori, che include gli oggetti correlati corrispondenti. | d4c69766-e9bd-4e61-bfc1-d8b6e686c7a8 |