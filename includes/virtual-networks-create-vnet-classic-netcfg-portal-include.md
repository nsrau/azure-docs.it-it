## <a name="how-to-create-a-vnet-using-a-network-config-file-in-the-azure-portal"></a>Come creare una rete virtuale utilizzando un file di configurazione di rete nel portale di Azure
...
9. Nel portale di Azure, nell'angolo inferiore sinistro della pagina, fare clic su **NUOVO**, quindi su **SERVIZI DI RETE**, su **RETE VIRTUALE** e su **IMPORTA CONFIGURAZIONE** come illustrato nell'immagine di seguito.
