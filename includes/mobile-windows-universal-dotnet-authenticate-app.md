...
2. Impostare come commento o eliminare la chiamata al metodo **RefreshTodoItems** nell'override del metodo **OnNavigatedTo** esistente.
...
6. Aprire il file di progetto App.xaml.cs e aggiungere il codice seguente:
