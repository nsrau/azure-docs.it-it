...
9. Nella barra delle applicazioni fare clic su **Start**, scegliere **Tutti i programmi**, **Microsoft SQL Server 2014**, quindi fare clic su **SQL Server Management Studio**.
10. In **Connetti al server**, specificare il nome server completo come *serverName*.database.windows.net. In Azure, il nome del server è una stringa autogenerata composta da caratteri alfanumerici.
