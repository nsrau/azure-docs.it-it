## <a name="wordpress-and-azure-app-service"></a>WordPress e Servizio app di Azure
...
* [Come abilitare Cache Redis](../articles/redis-cache/cache-dotnet-how-to-use-azure-redis-cache.md) tramite il [plug-in Cache Redis](https://wordpress.org/plugins/wp-redis/)
* [Come abilitare Memcached Object Cache per WordPress](../articles/app-service-web/web-sites-connect-to-redis-using-memcache-protocol.md) tramite il [plug-in Memcached](https://wordpress.org/plugins/memcached/)
