...
-->
## <a name="create-a-new-azure-sql-server-level-firewall"></a>Creare un nuovo firewall a livello di server per SQL Azure
...
3. Nel pannello **SQL Server** fare clic sul server per il quale creare la regola firewall.
...
4. Esaminare le proprietà del server e quindi fare clic su **Firewall**.
...
6. Fare clic su **Aggiungi IP client** per fare in modo che Azure inserisca l'indirizzo IP nelle caselle delle regole.
