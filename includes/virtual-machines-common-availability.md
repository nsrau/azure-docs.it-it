...
|----|----|----|
| Modello di configurazione della macchina virtuale| Nessuno VirtualMachineProfile non è definito nel modello del set di scalabilità. | Obbligatoria. VirtualMachineProfile viene popolato nel modello del set di scalabilità. |
