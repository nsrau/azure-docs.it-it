...
ms.locfileid: "85603273"
---
## <a name="create-an-azure-resource"></a>Creare una risorsa di Azure

Per iniziare a usare l'API Ricerca immagini Bing, creare una delle seguenti risorse di Azure.

### <a name="bing-search-v7-resource"></a>[Risorsa Ricerca Bing v7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7)
...
### <a name="multi-service-resource"></a>[Risorsa multi-servizio](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesAllInOne)
   * disponibile tramite il portale di Azure fino a quando la risorsa non viene eliminata.  
