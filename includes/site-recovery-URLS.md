``*.accesscontrol.windows.net``. Usato per il controllo di accesso e la gestione delle identità. L'autenticazione basata su ACS verrà deprecata entro dicembre 2017. <br/><br/>
