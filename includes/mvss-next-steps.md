...
Questa serie di esercitazioni può essere avviata dall'[articolo sul modello di set di scalabilità di base](../articles/virtual-machine-scale-sets/virtual-machine-scale-sets-mvss-start.md).
...
Per altre informazioni al riguardo, vedere la [panoramica sui set di scalabilità](../articles/virtual-machine-scale-sets/virtual-machine-scale-sets-overview.md).
