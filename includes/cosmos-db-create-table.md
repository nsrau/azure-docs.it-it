...
2. Nel pannello Esplora dati fare clic su **Nuova tabella** e quindi compilare i campi della pagina con le informazioni seguenti.
    ...
    UR/min|Off|Usare il valore predefinito. Sarà possibile attivare la funzionalità [UR/min](../articles/cosmos-db/request-units-per-minute.md) in seguito se sarà necessario gestire carichi di lavoro di picco.
