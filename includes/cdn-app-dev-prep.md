...
>
> Quando si arriva al passaggio Configurazione applicazione multi-tenant, selezionare **No**.
>
...
4. Invece di assegnare un'entità servizio al ruolo di **collaboratore profilo di rete CDN** , verranno assegnati singoli utenti o gruppi.  In questo esempio, è possibile vedere che ho assegnato *l'utente demo CDN* al ruolo **Collaboratore profilo CDN.**  
