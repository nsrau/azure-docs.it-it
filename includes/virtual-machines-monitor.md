...
- [Salvarlo in un account di archiviazione per l'](../articles/azure-monitor/platform/archive-activity-log.md) archiviazione o l'ispezione manuale. È possibile specificare il tempo di conservazione (in giorni) tramite il profilo di log.
...
- [Salvarli in un account di archiviazione per il](../articles/azure-monitor/platform/archive-diagnostic-logs.md) controllo o l'ispezione manuale. È possibile specificare il tempo di conservazione (in giorni) tramite le impostazioni di diagnostica delle risorse.
