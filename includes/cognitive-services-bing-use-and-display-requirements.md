Questi requisiti di uso e visualizzazione si applicano all'implementazione del contenuto e alle informazioni associate (ad esempio relazioni, metadati e altri segnali) disponibili tramite chiamate alle API Ricerca Web Bing, Ricerca immagini, Ricerca video, Ricerca notizie, Controllo ortografico Bing e Suggerimenti automatici Bing. I dettagli di implementazione correlati a questi requisiti sono disponibili nella documentazione relativa alle funzionalità e ai risultati specifici.

## <a name="1--bing-spell-check-api-and-bing-autosuggest-api--you-must-not"></a>1.  API CONTROLLO ORTOGRAFICO BING e API SUGGERIMENTI AUTOMATICI BING.  Non si deve:

- copiare, archiviare o memorizzare nella cache i dati ricevuti dalle API Controllo ortografico Bing o Suggerimenti automatici Bing, oppure usare i dati ricevuti dalle API Controllo ortografico Bing o Suggerimenti automatici Bing nell'ambito di attività di Machine Learning o attività algoritmiche simili per il training, la valutazione o il miglioramento di servizi nuovi o esistenti offerti dalla propria azienda o da terzi.
...
## <a name="2--bing-web-search-image-search-news-search-and-video-search-apis-the-search-apis"></a>2.  API RICERCA WEB BING, RICERCA IMMAGINI, RICERCA NOTIZIE e RICERCA VIDEO ("API di ricerca"):

**Definizioni.** Le definizioni seguenti sono applicabili alle sezioni da 2 a 7 di questi requisiti di uso e visualizzazione:
...
**Esperienza di ricerca Internet.** Tutti i dati restituiti nelle risposte possono essere usati solo nelle esperienze di ricerca Internet. In un'esperienza di ricerca Internet, il contenuto visualizzato:
...
## <a name="3-advertising"></a>3. Annunci pubblicitari.
...
## <a name="4-branding"></a>4. Personalizzazione.
Ogni risposta (o parte di essa) visualizzata verrà attribuita a Microsoft come descritto in https://go.microsoft.com/fwlink/?linkid=833278, salvo diversa indicazione scritta di Microsoft per l'uso specifico.


## <a name="5--transferring-responses"></a>5.  Trasferimento delle risposte.
Se si abilita un utente al trasferimento di una risposta a un altro utente, ad esempio tramite un'app di messaggistica o post di social media, si applicano le condizioni seguenti:
...
Non si devono copiare, archiviare o memorizzare nella cache i dati delle risposte. Per consentire tuttavia la continuità dell'accesso al servizio e del rendering dei dati, è possibile conservare i risultati esclusivamente alle condizioni seguenti:
