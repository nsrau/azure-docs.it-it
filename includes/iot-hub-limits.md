...
| Numero massimo di recapiti per i messaggi <br/> messages |100 |
...
| [Dimensioni massime del dispositivo gemello](../articles/iot-hub/iot-hub-devguide-device-twins.md#device-twin-size) | 8 KB per la sezione dei tag e 32 KB per le sezioni delle proprietà desiderate e segnalate ogni |
