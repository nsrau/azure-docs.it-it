...
* Vedere la documentazione di riferimento del servizio BLOB di Azure nella [libreria client di archiviazione per .NET](https://go.microsoft.com/fwlink/?LinkID=390731) per informazioni dettagliate sulle API disponibili.
