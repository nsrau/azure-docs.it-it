...
2. Nel portale per **+** enti pubblici fare clic su e quindi nel marketplace fare clic su **Visualizza tutto**. Cercare _StorSimple Physical_ (Dispositivi fisici StorSimple). Selezionare e fare clic su **Serie di dispositivi fisici StorSimple** e quindi fare clic su **Crea**. In alternativa, nel portale **+** per enti pubblici fare clic su e quindi in **Archiviazione**fare clic su **StorSimple Physical Device Series**.
