...
3. Nel pannello **Gestione dispositivi StorSimple** seguire questa procedura:
   ...
   4. Fornire una **Località** per il servizio. Per Località si intende l'area geografica in cui si desidera distribuire il dispositivo. Selezionare **Governo degli Stati Uniti Iowa** o **Governo degli Stati Uniti Virginia**.
