...
ExpressRoute Direct offre ai clienti la possibilità di connettersi direttamente alla rete globale di Microsoft in località peer distribuite in modo strategico in tutto il mondo. ExpressRoute Direct offre una connettività dual e 10 Gbps, che supporta la connettività attiva/attiva su larga scala. 
...
### <a name="what-locations-currently-support-expressroute-direct"></a>Quali posizioni supportano attualmente ExpressRoute Direct? 

Si prega di verificare la disponibilità sulla pagina della [posizione](../articles/expressroute/expressroute-locations-providers.md). 
...
### <a name="when-does-billing-start-for-the-expressroute-direct-port-pairs"></a>Quando inizia la fatturazione per le coppie di porte ExpressRoute Direct?
