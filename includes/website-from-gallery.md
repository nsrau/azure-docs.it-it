...
3. Selezionare **App Web**. Cercare **WordPress** e scegliere il **WordPress** icona.

	![WordPress nell'elenco][7]
	
5. Dopo aver letto la descrizione dell'app WordPress, selezionare **Crea**.

6. Fare clic su **WEB APP**, e fornire i valori richiesti per la configurazione dell'applicazione web.
