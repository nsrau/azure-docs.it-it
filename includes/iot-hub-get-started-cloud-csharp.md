...
5. Aggiungere le istruzione `using` seguenti all'inizio del file **Program.cs**:
   
        using Microsoft.Azure.Devices;
        using Microsoft.Azure.Devices.Common.Exceptions;
6. Aggiungere i campi seguenti alla classe **Program**, sostituendo i valori dei segnaposto con la stringa di connessione dell'hub IoT creato nella sezione precedente:
...
8. Aggiungere infine le righe seguenti al metodo **Main**:
        ...
        AddDeviceAsync().Wait();
        Console.ReadLine();
9. Eseguire l'applicazione e prendere nota della chiave del dispositivo.
