...
ms.locfileid: "60531094"
---
Se si vuole un dominio, è possibile acquistarlo direttamente nel [portale di gestione di Azure](https://portal.azure.com). Seguire questa procedura per acquistare i nomi di dominio e assegnarli all'app Web.

1. Accedere al [portale di gestione di Azure](https://portal.azure.com) dal browser.
2. Nella scheda **App Web** fare clic sul nome dell'app Web, selezionare **Impostazioni** e quindi **Domini personalizzati ed SSL**.
   
    ![](./media/custom-dns-web-site/dncmntask-cname-6.png)
3. Nel pannello **Domini personalizzati ed SSL** fare clic su **Acquista domini**.
...
7. Se un dominio è stato ordinato correttamente, è possibile gestirlo e assegnarlo all'app Web. Fare clic sui tre puntini (**...**) a destra del dominio. Questa operazione consente di **annullare l'acquisto** o **gestire il dominio**. Fare clic su **Gestisci dominio** per poter associare il **sottodominio** all'app Web nel pannello **Gestisci dominio**.
