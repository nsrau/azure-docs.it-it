...
5.	Dopo aver creato l'account DocumentDB, è pronto per l'utilizzo con le impostazioni predefinite nel portale in linea. Si noti che la coerenza predefinita dell'account DocumentDB è impostata su **Sessione**. È possibile modificare l'impostazione di coerenza predefinita facendo clic sull'icona **Impostazioni** sulla barra dei comandi in alto e scegliendo quindi la voce **Coerenza predefinita** in **Funzionalità** nel pannello **Tutte le impostazioni**.
