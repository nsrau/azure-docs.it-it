...
---
**Requisiti del server di elaborazione e di configurazione**
...
Impostazioni locali del sistema operativo | Italiano (en-z)
...
Tipo di scheda di interfaccia di rete | VMXNET3 (se il server di configurazione è una macchina virtuale VMware)
 |
**Accesso a Internet** (il server deve accedere ai seguenti URL, direttamente o tramite proxy):|
...
*.services.visualstudio.com | Utilizzato per scopi di telemetria (facoltativo)Used for telemetry purposes (optional)
time.nist.gov | Utilizzato per controllare la sincronizzazione dell'ora tra il sistema e l'ora globale
time.windows.com | Utilizzato per controllare la sincronizzazione dell'ora tra il sistema e l'ora globale
| <ul> <li> https:\//login.microsoftonline.com </li><li> https:\//secure.aadcdn.microsoftonline-p.com </li><li> https:\//login.live.com </li><li> https:\//graph.windows.net </li><li> https:\//login.windows.net </li><li> https:\//www.live.com </li><li> https:\//www.microsoft.com </li></ul> | L'installazione di OVF deve accedere a questi URL. Vengono usati per il controllo degli accessi e la gestione delle identità da Azure Active Directory.They'are used for access control and identity management by Azure Active Directory.
https:\//dev.mysql.com/get/Downloads/MySQLInstaller/mysql-installer-community-5.7.20.0.msi  | Per completare il download di MySQL. </br> In alcune aree, il download potrebbe essere reindirizzato all'URL della rete CDN. Assicurarsi che anche l'URL della rete CDN sia nella whitelist, se necessario.
|
...
La tabella seguente riepiloga i requisiti di capacità del server di configurazione. Se si replicano più macchine virtuali VMware, esaminare le [considerazioni sulla pianificazione](../articles/site-recovery/site-recovery-plan-capacity-vmware.md) della capacità ed eseguire [lo strumento Pianificazione distribuzione di Azure Site Recovery.](../articles/site-recovery/site-recovery-deployment-planner.md)
