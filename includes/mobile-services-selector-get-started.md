...
- [(Windows Universal C# | .NET)](mobile-services-dotnet-backend-windows-store-dotnet-get-started.md)
- [(Windows Universal C# | Javascript)](mobile-services-javascript-backend-windows-store-dotnet-get-started.md)
- [(Windows Universal JavaScript | .NET)](mobile-services-dotnet-backend-windows-store-javascript-get-started.md)
- [(Windows Universal JavaScript | Javascript)](mobile-services-javascript-backend-windows-store-javascript-get-started.md)
