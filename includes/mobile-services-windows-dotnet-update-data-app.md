...
3. In MainPage.xaml.cs impostare come commento o eliminare la riga in cui viene definita la raccolta di elementi esistenti, quindi rimuovere il commento o aggiungere le righe seguenti e sostituire _&lt;yourClient&gt;_ con il campo `MobileServiceClient` aggiunto al file App.xaml.cs durante la connessione del progetto al servizio mobile:
