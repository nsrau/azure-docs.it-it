...
ms.locfileid: "55302211"
---
1. Completare la [guida introduttiva Python di Azure Machine Learning](../articles/machine-learning/service/quickstart-create-workspace-with-python.md) per installare l'SDK e creare un'area di lavoro.  Eventualmente, è possibile ignorare la sezione **Usare il notebook**.
