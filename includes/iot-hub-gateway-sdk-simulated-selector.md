...
La procedura dettagliata dell'[esempio di caricamento nel cloud del dispositivo simulato] illustra come usare [Azure IoT SDK per gateway][lnk-sdk] per inviare dati di telemetria dispositivo a cloud all'hub IoT da dispositivi simulati.
...
> [!NOTE]
> I moduli non si scambiano direttamente i messaggi, ma li pubblicano in un broker interno che li invia ad altri moduli usando un meccanismo di sottoscrizione, come mostrato nel diagramma seguente. Per altre informazioni, vedere [Get started with the IoT Gateway SDK][lnk-gw-getstarted] (Introduzione a IoT SDK per gateway).
> 
> 
...
<!-- Links -->
[esempio di caricamento nel cloud del dispositivo simulato]: https://github.com/Azure/azure-iot-gateway-sdk/blob/master/samples/simulated_device_cloud_upload/README.md
