...
4. Sostituire la definizione della classe **ToDoBroadcastReceiver** esistente con la seguente:
    ...
    Nel codice precedente è necessario sostituire *`<PROJECT_NUMBER>`* con il numero di progetto assegnato da Google quando è stato eseguito il provisioning dell'app nel portale per sviluppatori di Google.
