...
3.  Sostituire la funzione **InsertTodoItem** con il codice seguente:
...
4.  Sostituire la funzione **RefreshTodoItems** con il codice seguente:
...
5.  Sostituire la funzione **UpdateCheckedTodoItem** con il codice seguente:
