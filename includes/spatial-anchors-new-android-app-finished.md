...
ms.locfileid: "74276936"
---
## <a name="putting-everything-together"></a>Riunire tutti gli elementi

Ecco come dovrebbe essere il file di classe `MainActivity` completo dopo aver riunito tutti i diversi elementi. È possibile usarlo come riferimento da confrontare con il proprio file e verificare se sono state lasciate differenze.
