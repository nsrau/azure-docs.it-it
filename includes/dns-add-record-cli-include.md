...
Se si crea un record SRV nella radice della zona, è possibile specificare "\_service" e "\_protocol" nel nome del record. Non è necessario includere anche ".@" nel nome del record.
