...
4. Fare clic su **Gruppo di risorse** e selezionare un gruppo di risorse esistente. In alternativa, fare clic su **Crea nuovo** per creare un nuovo gruppo di risorse per questa distribuzione.
5. Se necessario, fare clic su **Località** e selezionare la località di Azure corretta.
