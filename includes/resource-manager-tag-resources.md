...
1. Da qualsiasi elenco di risorse selezionare la casella di controllo per le risorse a cui si vuole assegnare il tag. Quindi, selezionare **Assegna tag**.
...
1. Nel menu portale di Azure cercare **i tag**. Selezionarlo tra le opzioni disponibili.
