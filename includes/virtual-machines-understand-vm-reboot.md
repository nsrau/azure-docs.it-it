...
- [Come pianificare la manutenzione nelle VM di Azure](../articles/virtual-machines/windows/classic/planned-maintenance-schedule.md)
...
Con l'archiviazione Premium di Azure sono previsti limiti di IOPS più elevati, fino a 80.000 IOPS. Per altre informazioni, vedere [Archiviazione Premium con prestazioni elevate](../articles/virtual-machines/windows/premium-storage.md).
