...
1. Nella casella **Filtra per nome** immettere il nome del gruppo di risorse. Per le istruzioni di questa guida introduttiva è stato usato un gruppo di risorse denominato *AppConfigTestResources*.
