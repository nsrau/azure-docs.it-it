...
6. Se si prevede di usare la libreria di connessione PHP, copiare la stringa di etichetta **PHP**.

	![Copiare la stringa di connessione PHP per il database][3-get-connection-string]
