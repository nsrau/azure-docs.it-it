...
1. Nella finestra di dialogo **Nuovo progetto** selezionare **Web** > **Applicazione Web ASP.NET (.NET Framework)**. Nel campo **Nome** specificare **StorageAspNet**. Fare clic su **OK**.
...
1. Dal menu di scelta rapida selezionare **Aggiungi** > **servizio connesso**.
...
1. In **Esplora soluzioni**fare clic con il pulsante destro del mouse su **dipendenze**, scegliere **Gestisci pacchetti NuGet**e aggiungere un riferimento al pacchetto NuGet alla versione più recente di Microsoft. Azure. ConfigurationManager.
