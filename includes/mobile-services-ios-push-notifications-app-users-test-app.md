...
1. Premere il pulsante **Run** per creare il progetto e avviare l'app in un dispositivo con iOS, quindi fare clic su **OK** per accettare le notifiche push. Verificare che l'accesso e l'autenticazione siano eseguiti correttamente.
