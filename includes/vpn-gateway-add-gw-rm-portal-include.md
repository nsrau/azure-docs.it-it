...
2. Nel pannello **Crea gateway di rete virtuale** inserire i valori per il gateway di rete virtuale.
    ...
    ![Creare i campi nel pannello Gateway di rete virtuale](./media/vpn-gateway-add-gw-rm-portal-include/createvng.png "Creare i campi nel pannello Gateway di rete virtuale")
