...
3.  Mantenere l'impostazione predefinita di **Anybody with the application key** per tutte le autorizzazioni, digitare
    *Registrations* in **Table name**, quindi fare clic sul segno di spunta.
