...
In questo articolo viene creato un servizio back-end che aggiunge un dispositivo nel registro delle identità e quindi aggiunge un modulo al dispositivo. Il servizio richiede l'autorizzazione di **scrittura del registro di sistema** . Per impostazione predefinita, ogni hub tutto viene creato con un criterio di accesso condiviso denominato **registryReadWrite** che concede l'autorizzazione.
