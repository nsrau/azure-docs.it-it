...
2. Selezionare il progetto inferiore, ossia il nome dell'app mobile con il suffisso Service. Premere **F5** per scaricare i pacchetti NuGet, creare il progetto e avviare il backend dell'app mobile localmente. Quando si esegue il client dell'app mobile, puntato all'host locale, questo comunicherà con il backend locale. 
