<properties 
   pageTitle="Ottenere il nome qualificato iSCSI di un host di Windows"
   description="Viene illustrato come ottenere il nome qualificato iSCSI (IQN) di un computer che esegue Windows Server 2012."
   services="storsimple"
