...
3. Eseguire il cmdlet **`New-AzureRmResourceGroupDeployment`** per distribuire la nuova rete virtuale usando il modello e i file dei parametri scaricati e modificati in precedenza.
    ...
    Di seguito è riportato l'output previsto per il comando precedente:
        ...
        Outputs           :
4. Eseguire il cmdlet **`Get-AzureRmVirtualNetwork`** per visualizzare le proprietà della nuova rete virtuale, come illustrato di seguito.
