...
Ogni macchina virtuale risiede in un servizio cloud, da sola oppure insieme ad altre macchine virtuali. È possibile inserire le macchine virtuali nello stesso servizio cloud per consentire loro di comunicare, per bilanciare il carico del traffico di rete tra le macchine virtuali e per garantire una disponibilità elevata delle macchine. Per ulteriori informazioni sui servizi cloud e sulle macchine virtuali, vedere la sezione relativa ai modelli di esecuzione in [Introduzione ad Azure][2].

## <a id="custommachine"> </a>Come creare la macchina virtuale

Per creare una macchina virtuale personalizzata nel portale di gestione, viene utilizzato il metodo di creazione **da raccolta**. Tale metodo fornisce un numero maggiore di opzioni per la configurazione della macchina virtuale, ad esempio le risorse connesse, il nome DNS e la connettività di rete, se richiesta.

1.  Accedere al [portale di gestione di Azure][3]. Sulla barra dei comandi fare clic su **New**.
...
* Se si utilizza un computer che esegue un sistema operativo Windows, è possibile utilizzare un client SSH come PuTTY. Per ulteriori informazioni, vedere la pagina [PuTTY Download][6].
* Se si utilizza un computer che esegue un sistema operativo Linux, è possibile utilizzare un client SSH come OpenSSH. Per ulteriori informazioni, vedere la pagina [OpenSSH][7].
...
In Linux il disco risorse è in genere gestito dall'agente Linux di Azure e viene montato automaticamente in **/mnt/resource** (o **/mnt** nelle immagini Ubuntu). Per ulteriori informazioni, vedere [Guida dell'utente dell'agente Linux di Azure][8].
...
Per ulteriori informazioni su Linux in Azure, vedere gli articoli seguenti:
...
[5]: http://www.windowsazure.com/it-it/manage/linux/how-to-guides/setup-endpoints/
[6]: http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html
[7]: http://www.openssh.org/
[8]: http://www.windowsazure.com/it-it/manage/linux/how-to-guides/linux-agent-guide/
[9]: http://www.windowsazure.com/it-it/documentation/articles/introduction-linux/
[10]: http://www.windowsazure.com/it-it/documentation/articles/xplat-cli/