...
-   Se si utilizza un computer che esegue un sistema operativo Windows, è possibile utilizzare un client SSH come PuTTY. Per altre informazioni, vedere la pagina [PuTTY Download][].
-   Se si utilizza un computer che esegue un sistema operativo Linux, è possibile utilizzare un client SSH come OpenSSH. Per altre informazioni, vedere la pagina [OpenSSH][].
...
3.  Sulla barra dei comandi fare clic su **Connetti**, quindi su **Connetti disco vuoto**.
    ...
    ![Definizione dei dettagli del disco][]
...
-   [Come utilizzare gli strumenti da riga di comando di Azure per Mac e Linux][]
  ...
  [Creazione e caricamento di un disco rigido virtuale che contiene il sistema operativo Linux]: /en-us/manage/linux/common-tasks/upload-a-vhd/
  ...
  [Come configurare gli endpoint a una macchina virtuale]: http://azure.microsoft.com/en-us/documentation/articles/virtual-machines-set-up-endpoints/
  ...
  [Guida dell'utente dell'agente Linux di Azure]: http://www.windowsazure.com/en-us/manage/linux/how-to-guides/linux-agent-guide/
  ...
  [Introduzione a Linux in Azure]: http://www.windowsazure.com/en-us/documentation/articles/introduction-linux/
  [Come utilizzare gli strumenti da riga di comando di Azure per Mac e Linux]: http://www.windowsazure.com/en-us/documentation/articles/xplat-cli/
