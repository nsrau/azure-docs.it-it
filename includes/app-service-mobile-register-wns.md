...
5. Passare a [Windows Dev Center](https://dev.windows.com/en-us/overview), accedere con l'account Microsoft, fare clic sulla nuova registrazione di app in **App personali**, quindi espandere **Servizi** > **Notifiche push**.
6. Nella pagina **Notifiche push** fare clic sul **sito dei servizi Live** in **Windows Push Notification Services (WNS) and Microsoft Azure Mobile Apps** (Servizi notifica Push Windows (WNS) e app per dispositivi mobili di Microsoft Azure) e annotare il valore **SID pacchetto** e *Corrente* in **Segreto dell'applicazione**. 
