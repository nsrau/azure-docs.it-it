...
| Gruppi di sincronizzazione per servizio di sincronizzazione archiviazione | 20 gruppi di sincronizzazione | No |
...
| Endpoint server per server | 5-15 endpoint server | Sì, ma variabile a seconda della configurazione |
