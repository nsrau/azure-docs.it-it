...
<!--Image reference-->
   ![Rappresentazione concettuale della configurazione di dominio e di errore update](./media/virtual-machines-common-manage-availability/ud-fd-configuration.png)
