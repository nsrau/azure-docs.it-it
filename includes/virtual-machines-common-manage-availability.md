...
Per gli account di archiviazione usati dai dischi rigidi virtuali nella macchina virtuale, seguire le procedure consigliate. Ogni disco rigido virtuale è un BLOB di pagine in un account di archiviazione di Azure. È importante verificare che siano presenti la ridondanza e l'isolamento negli account di archiviazione per garantire una disponibilità elevata per le macchine virtuali all'interno del set di disponibilità.
