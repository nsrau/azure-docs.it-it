...
* I dati di accesso ad Azure devono includere almeno l'accesso **Collaboratore** al gruppo di risorse di Azure usato durante la creazione di HDInsight e di altre risorse di Azure.
