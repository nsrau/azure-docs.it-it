...
| Lunghezza nomi di proprietà e metriche | 150 | Vedere il commento di seguito per altre informazioni
| Lunghezza stringa valore di proprietà | 8.192 | Vedere il commento di seguito per altre informazioni
| Lunghezza messaggio di traccia e di eccezione | 10.000 | Vedere il commento di seguito per altre informazioni
...
Per altre informazioni sui limiti per i campi dati, vedere gli [schemi per tipo](https://github.com/Microsoft/ApplicationInsights-Home/blob/master/EndpointSpecs/Schemas/Docs/).
