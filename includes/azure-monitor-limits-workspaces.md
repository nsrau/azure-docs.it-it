...
|:---|:---|:---|:---|
| Piano tariffario per GB corrente<br>(introdotto il 2018 aprile) | Nessun limite | 30-730 giorni | La conservazione dei dati oltre i 31 giorni è disponibile per addebiti aggiuntivi. Altre informazioni sui prezzi di Monitoraggio di Azure. |
...
| Livello legacy autonomo per GB<br>(introdotto il 2016 aprile) | Nessun limite | da 30 a 730 giorni | La conservazione dei dati oltre i 31 giorni è disponibile per addebiti aggiuntivi. Altre informazioni sui prezzi di Monitoraggio di Azure. |
| Legacy per nodo (OMS)<br>(introdotto il 2016 aprile) | Nessun limite | da 30 a 730 giorni | La conservazione dei dati oltre i 31 giorni è disponibile per addebiti aggiuntivi. Altre informazioni sui prezzi di Monitoraggio di Azure. |
