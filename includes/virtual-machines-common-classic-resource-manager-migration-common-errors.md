...
| La rete virtuale {nome-rete-virtuale} non esiste. |Questa situazione può verificarsi se la rete virtuale è stata creata nel nuovo portale di Azure. Il nome effettivo della rete virtuale segue il modello "gruppo * \<VNET name >" |
