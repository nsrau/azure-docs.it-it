...
### <a name="azure-backup---storage-redundancy-options"></a>Backup di Azure: opzioni di ridondanza di archiviazione
> [!IMPORTANT]
...
#### <a name="geo-redundant-storage-grs"></a>Archiviazione con ridondanza geografica (GRS)
...
#### <a name="locally-redundant-storage-lrs"></a>Archiviazione con ridondanza locale (LRS)
