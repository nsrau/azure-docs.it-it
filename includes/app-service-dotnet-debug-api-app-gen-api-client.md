## <a name="generate-an-api-app-client"></a>Generare un client app per le API
...
1. In Visual Studio aprire la soluzione che contiene l'app per le API usata nell'argomento [Creare un'app per le API](../articles/app-service-api/app-service-dotnet-create-api-app.md). 
...
## <a name="test-the-api-app-client"></a>Testare il client app per le API
...
3. Dal menu di scelta rapida dell'applicazione console scegliere **Debug > Avvia nuova istanza**. 
