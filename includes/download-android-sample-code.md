...
1. Scaricare il repository  `mobile-services-samples` da gitHub facendo clic <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures" target="blank">qui</a>, quindi fare clic su **Download ZIP**.
