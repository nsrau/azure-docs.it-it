...
4. Selezionare **Open an existing Android Studio project**, passare al percorso del progetto nella cartella  *AndroidStudio* di  *GettingStartedWithData* e quindi fare clic su **OK**. 
