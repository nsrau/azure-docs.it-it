...
Aprire la console di PowerShell e connettersi al proprio account. Per altre informazioni, vedere [Accedi](/powershell/azure/install-az-ps?view=azps-1.4.0#sign-in).
