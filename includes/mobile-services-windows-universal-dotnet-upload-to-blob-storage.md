...
4. Sostituire l'elemento **StackPanel** in **DataTemplate** con il codice seguente:
...
5. Nel progetto di applicazione Windows Phone, aprire il file MainPage. XAML e sostituire l’**elemento ButtonSave** con il codice seguente:
...
6. Sostituire l'elemento **StackPanel** in **DataTemplate** con il codice seguente:
...
7. Nella cartella DataModel condivisa, aprire il file di progetto TodoItem.cs e aggiungere le seguenti proprietà alla classe TodoItem:
...
8. Aprire il file del progetto MainPage.cs condiviso e aggiungere l'istruzione **usando** le seguenti istruzioni:
...
9. Nella classe MainPage aggiungere il codice seguente:
...
10. Sostituire il metodo `InsertTodoItem` esistente con il codice seguente:
...
7. Toccare l'anteprima per acquisire un'immagine, quindi fare clic su**caricare**per inserire il nuovo elemento e caricare l'immagine.
