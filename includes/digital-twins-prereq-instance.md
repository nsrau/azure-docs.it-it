---
author: baanders
description: file di inclusione per Gemelli digitali di Azure - prerequisito per configurare un'istanza
...
Dopo aver configurato l'istanza di Gemelli digitali di Azure, è necessario il *_nome host_* per l'istanza. Il nome è disponibile nel [portale di Azure](../articles/digital-twins/how-to-set-up-instance-portal.md#verify-success-and-collect-important-values). Prendere nota di questo valore in modo da poterlo usare in seguito per connettersi all'istanza.