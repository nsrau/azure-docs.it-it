1. In Project Explorer espandere **app** => **src** => **main** => **java** => **com.example.GetStartedWithData** e quindi aprire il file *ToDoActivity.java*.
...
1. Nel menu **Run** fare clic su **Run app**.
2. Verrà visualizzata la finestra di dialogo **Choose Device**.
...
1. Scegliere un dispositivo connesso oppure *Launch Emulator*.
2. Quando viene visualizzata l'app, digitare un testo significativo, ad esempio *Complete the tutorial* e quindi fare clic su **Add**.
