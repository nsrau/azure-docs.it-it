...
2. Gli oggetti Android standard presenti nel codice che devono essere risolti in base alle istruzioni `import` potrebbero generare messaggi di errore.
