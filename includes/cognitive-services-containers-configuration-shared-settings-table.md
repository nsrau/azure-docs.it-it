...
|--|--|--|
|Sì|[ApiKey (Chiave api)](#apikey-configuration-setting)|Tiene traccia delle informazioni di fatturazione.|
...
|No|HTTP Proxy|Configura un proxy HTTP per le richieste in uscita.|
