...
-->
## <a name="connect-to-the-azure-portal-with-a-subscription"></a>Connettersi al portale di Azure con una sottoscrizione
Per connettersi al portale di Azure, è necessaria una sottoscrizione.

### <a name="get-a-new-account"></a>Ottenere un nuovo account
...
3. Nella **pagina di accesso** specificare le credenziali per la sottoscrizione.
   ...
   ![pagina di accesso](./media/azure-getting-started-portal-login/login.png)
