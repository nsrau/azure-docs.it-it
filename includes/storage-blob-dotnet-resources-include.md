...
- [Documentazione di riferimento per le API](/dotnet/api/overview/azure/storage/client)
...
- [Pacchetto (NuGet) per la versione 12. x-anteprima](https://www.nuget.org/packages/Azure.Storage.Blobs)
