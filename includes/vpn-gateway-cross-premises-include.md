...
| **Protocolli supportati** |SSTP (Secure Sockets Tunneling Protocol) e IPsec |IPsec |Connessione diretta su VLAN, tecnologie VPN del provider (MPLS, VPLS, ecc.) |
