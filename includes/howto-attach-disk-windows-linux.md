Per altre informazioni sui dischi in macchine virtuali di Azure, vedere [Informazioni sui dischi delle macchine virtuali in Azure][Informazioni sui dischi delle macchine virtuali in Azure].
...
2.  Sulla barra dei comandi fare clic su **Connetti**, quindi selezionare **Connetti disco vuoto**.
    ...
    ![Collegare un disco vuoto][Collegare un disco vuoto]

    Verrà visualizzata la finestra di dialogo **Connetti disco vuoto**.

    ![Collegare un nuovo disco vuoto][Collegare un nuovo disco vuoto]
...
4.  Fare clic sul segno di spunta per collegare il disco dati alla macchina virtuale.
    ...
    ![Disco dati correttamente collegato][Disco dati correttamente collegato]
