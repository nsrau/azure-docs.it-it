...
1. Digitare il nome del gruppo di risorse e quindi selezionare **Elimina**.
   ...
   Se viene visualizzato l'errore "Non è possibile eliminare la risorsa se prima non vengono eliminate le risorse annidate", è prima necessario eliminare le risorse annidate. Per informazioni dettagliate, [vedere questa sezione relativa alla risoluzione dei problemi](../articles/machine-learning/desktop-workbench/known-issues-and-troubleshooting-guide.md#cant-delete-experimentation-account). 