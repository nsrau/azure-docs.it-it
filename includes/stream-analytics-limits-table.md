...
| --- | --- | --- |
| Numero massimo di unità di streaming per sottoscrizione per area |200 |Per richiedere un aumento delle unità di streaming per la sottoscrizione a oltre 200, è possibile contattare il [supporto tecnico Microsoft](https://support.microsoft.com/en-us). |
...
| BLOB di dati di riferimento - MB | 300 | Un BLOB di dati di riferimento non può essere maggiore di 300 MB. |
