...
ms.locfileid: "66238797"
---
---
| Identificatore limite | Limite | Commenti |
| --- | --- | --- |
| Numero massimo di unità di streaming per sottoscrizione per area |500 |Per richiedere un aumento delle unità di streaming per la sottoscrizione a oltre 500, contattare [supporto tecnico Microsoft](https://support.microsoft.com/en-us). |
...
| Numero massimo di unità di streaming per processo |192 |È previsto un limite rigido di 192 unità di streaming per il processo di Stream Analitica. |
