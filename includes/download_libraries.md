...
All'interno dell'elemento `<version>` sostituire *n.n.n* con un numero di versione valido, che può essere ottenuto dal [repository delle librerie di Azure in Maven](http://go.microsoft.com/fwlink/?LinkID=286274).
