# <a name="using-cdn-for-azure"></a>Uso della rete CDN per Azure
...
> [!NOTE]
> Per informazioni sull'esecuzione di questa operazione tramite l'API di gestione servizi di Azure, vedere l'argomento di riferimento [Creare un account di archiviazione](http://msdn.microsoft.com/library/windowsazure/hh264518.aspx) .
> 
> 
...
2. Nell'angolo in basso a sinistra della schermata fare clic su **Nuovo**. Nella finestra di dialogo **Nuovo** selezionare **Servizi dati**, fare clic su **Archiviazione** e quindi su **Creazione rapida**.
   ...
   ![Creare un account di archiviazione][create-new-storage-account]
3. Nel campo **URL** immettere un nome di sottodominio. Il nome può contenere tra 3 e 24 lettere minuscole e numeri.
...
2. Sulla barra multifunzione fare clic su **Nuovo**. Nella finestra di dialogo **Nuovo** selezionare **Servizi app**, quindi **Rete CDN** e infine **Creazione rapida**.
...
http://<*SpazioNomiCDN*\>.vo.msecnd.net/<*ContenitorePubblico*\>/<*NomeBLOB*\>
...
Nel portale di gestione di Azure non è attualmente supportata una funzionalità per ripulire immediatamente il contenuto. Se è necessario ripulire immediatamente il contenuto, contattare il [Supporto di Azure](https://azure.microsoft.com/support/options/). 
