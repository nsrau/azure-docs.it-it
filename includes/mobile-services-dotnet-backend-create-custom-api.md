...
2. Espandere **Servizi mobili di Azure** e fare clic su **Controller personalizzato per Servizi mobili di Microsoft Azure** e quindi su **Aggiungi**, specificare come **Nome controller** `CompleteAllController`e infine fare di nuovo clic su **Aggiungi**.
