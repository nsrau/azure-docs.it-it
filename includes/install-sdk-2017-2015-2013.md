...
* Visual Studio 2019 include Azure SDK. Se si usa Visual Studio 2019, non è necessaria alcuna installazione aggiuntiva per l'ambiente di sviluppo.
...
* Se Visual Studio non è installato, usare quanto segue per installare [Visual Studio 2019](https://www.visualstudio.com/) con Azure SDK.
