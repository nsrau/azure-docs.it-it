...
3. Nella pagina **Crea un gateway di rete locale** specificare i valori per il gateway di rete locale.
   ...
   - **Name:** specificare un nome per l'oggetto gateway di rete locale.
   ...
   - **Località:** Il percorso è lo stesso dell' **area** in altre impostazioni. selezionare la località in cui verrà creato questo oggetto. È possibile, ma non necessario, selezionare la stessa località in cui risiede la rete virtuale.
