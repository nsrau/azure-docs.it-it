...
6.  Nella pagina **Virtual machine options** selezionare **(none)** nella casella **Availability Set**. Fare clic sul segno di spunta per continuare.
...
Se si utilizza un computer Windows, connettersi alla macchina virtuale tramite PuTTY, disponibile nell'apposita pagina di [download][4].
...
2.  Immettere "testlinuxvm.cloudapp.net" come nome host**** e "22" per la porta****.
	...
	![Schermata di PuTTY](./media/create-and-configure-opensuse-vm-in-portal/putty.png)
