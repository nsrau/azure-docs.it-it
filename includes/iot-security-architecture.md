...
* Processi (sia quelli sotto il controllo degli utenti sia gli elementi esterni)
...
| **Componente** | **Minaccia** | **Mitigazione** | **Rischio** | **Implementazione** |
| --- | --- | --- | --- | --- |
