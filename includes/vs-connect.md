...
* Immettere le credenziali per accedere all'account Azure.
  ...
  In **Esplora server** fare clic sul pulsante **Connect to Azure** (Connetti ad Azure). In alternativa, fare clic con il pulsante destro del mouse sul nodo **Azure** e scegliere **Connect to Azure** (Connetti ad Azure) dal menu di scelta rapida.
* Installare un certificato di gestione che consente di accedere all'account.
  
  In **Esplora server** fare clic con il pulsante destro del mouse sul nodo **Azure** e quindi scegliere **Gestisci sottoscrizioni**. Nella finestra di dialogo **Gestisci sottoscrizioni Azure** fare clic sulla scheda **Certificati**, quindi fare clic su **Importa**. Attenersi alle istruzioni per scaricare e importare un file di sottoscrizione, denominato anche file *.publishsettings* per l'account Azure.
