...
## <a name="define-an-inferenceconfig"></a>Definire un InferenceConfig
...
## <a name="define-a-deploymentconfiguration"></a>Definire un DeploymentConfiguration
