...
4.	Nella pagina **Crea servizio mobile** selezionare **Crea un database SQL da 20 MB gratuito**, selezionare il runtime **Node.js** quindi immettere il nome di un sottodominio per il nuovo servizio mobile nella casella di testo **URL** e attendere la verifica del nome. Quando la verifica del nome viene completata, fare clic sulla freccia destra per passare alla pagina successiva.	
