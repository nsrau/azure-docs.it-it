# <a name="data-management-and-business-analytics"></a>Gestione dati e analisi business
...
## <a name="a-namesqldbasql-database"></a><a name="sqldb"></a>Database SQL
...
### <a name="a-namedatasyncasql-data-sync"></a><a name="datasync"></a>Sincronizzazione dati SQL
...
## <a name="a-nametblstoratable-storage"></a><a name="tblstor"></a>Archiviazione tabelle
...
Un'applicazione Hadoop, definita in genere *processo*, usa un modello di programmazione noto come *MapReduce*. Come illustrato nella figura, la logica per un processo MapReduce viene eseguita simultaneamente in più macchine virtuali. Grazie all'elaborazione in parallelo dei dati, Hadoop è in grado di analizzare i dati in modo molto più veloce rispetto alle soluzioni basate su una singola macchina.
