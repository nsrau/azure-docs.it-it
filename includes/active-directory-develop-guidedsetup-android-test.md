...
2. Quando si è pronti per eseguire il test dell'applicazione, usare un account Microsoft Azure Active Directory (aziendale o dell'istituto di istruzione) o un account Microsoft (live.com, outlook.com) per accedere. 
