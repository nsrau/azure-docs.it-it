...
Questo articolo presuppone che vengano usati i microservizi .NET. Sono disponibili anche implementazioni Java. Per scaricare la versione più recente delle implementazioni di microservizi Java, eseguire:
