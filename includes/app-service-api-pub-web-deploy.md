1. Fare clic con il pulsante destro del mouse sul progetto in **Esplora soluzioni** e scegliere **Pubblica** per aprire nuovamente la finestra di dialogo di pubblicazione. Il profilo di pubblicazione creato in precedenza deve essere già selezionato. 
2. Fare clic su **Pubblica** per avviare il processo di distribuzione.
...
3. Nel browser passare al [portale di anteprima di Azure](https://portal.azure.com).
4. Individuare il pannello **App per le API** per l'applicazione di API che è stato distribuito.
...
5. Scegliere il collegamento **Gateway**.
6. Nel pannello **Gateway** fare clic su **Riavvia**.
