...
2. Passare alla pagina Swagger aggiungendo `/swagger` alla fine dell'URL di base.
   
   ![](./media/app-service-api-define-api-app/swaggerhome.png)
3. Fare clic su **Contatti > Recupera > Provalo**. Come si può vedere, l'API funziona e restituisce il risultato previsto.
   
    ![](./media/app-service-api-define-api-app/swaggertry.png)
4. In Visual Studio fare clic su **Debug > Interrompi debug**.
