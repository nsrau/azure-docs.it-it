...
4. Fare clic su **Connection Info**. ![ConnectionInfoButton][button-connectioninfo] Verrà visualizzato l'URI MongoLab: ![ConnectionInfoScreen][screen-connectioninfo]  
