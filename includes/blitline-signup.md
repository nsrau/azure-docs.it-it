...
### <a name="to-sign-up-for-a-blitline-account"></a>Per iscriversi a un account Blitline
...
### <a name="to-find-your-blitline-application-id"></a>Per individuare l'ID applicazione di Blitline
