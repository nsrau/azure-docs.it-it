...
Il runtime nel comando seguente è impostato su `NODE|8.1`. Per visualizzare tutti i runtime supportati, eseguire [az webapp list-runtimes](/cli/azure/webapp#list-runtimes). 
