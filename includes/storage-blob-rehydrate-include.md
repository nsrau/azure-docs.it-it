...
* **Priorità alta (anteprima)** : la richiesta di riattivazione verrà classificata in base alle richieste standard e potrebbe terminare tra 1 ora. La priorità alta potrebbe richiedere più di un'ora, a seconda della dimensione del BLOB e della richiesta corrente. Per le richieste con priorità alta è garantita la priorità sulle richieste di priorità standard.
