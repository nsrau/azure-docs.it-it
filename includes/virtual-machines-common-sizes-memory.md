...
* La serie M offre il più alto numero di CPU virtuali (Vcpu fino a 128) e una memoria più grande (fino a 3.8 TiB) di qualsiasi macchina virtuale nel cloud.  È ideale per database molto grandi o altre applicazioni che traggono vantaggio da un elevato numero di vCPU e una grande quantità di memoria.
...
## <a name="esv3-series-sup1sup"></a>Serie di Esv3 <sup>1</sup>
...
| Standard_E32s_v3 <sup>2</sup> | 32     | 256         | 512            | 32             | 64,000 / 512 (800)                                                    | 51.200/768                              | 8/estremamente alta                             |
| Standard_E64s_v3 <sup>2</sup> | 64     | 432         | 864            | 32             | 128,000/1024 (1600)                                                   | 80,000 / 1200                             | 8/estremamente alta                             |

<sup>1</sup> tecnologia Intel® Hyper-Threading di funzionalità della macchina virtuale serie Esv3 <sup>2</sup> vincolata dimensioni core disponibili 

## <a name="ev3-series-sup1sup"></a>Serie di Ev3 <sup>1</sup>
...
<sup>1</sup> tecnologia Intel® Hyper-Threading di funzionalità della macchina virtuale Ev3 serie
...
<sup>1</sup> funzionalità della macchina virtuale serie M tecnologia Intel® Hyper-Threading

<sup>2</sup> più di 64 CPU di virtuali richiedono una di queste guest supportate di sistemi operativi: Windows Server 2016, Ubuntu 16.04 LTS, SLES 12 SP2 e Red Hat Enterprise Linux o 7.3 CentOS con LIS 4.2.1 

<sup>3</sup> vincolata dimensioni core disponibili.
...
<sup>1</sup> la velocità effettiva massima del disco (IOPS o MBps) possibili con una serie di GS VM possono essere limitati dal numero, dimensione e lo striping dei dischi collegati. Per altre informazioni, vedere [Archiviazione Premium: archiviazione ad alte prestazioni per carichi di lavoro delle macchine virtuali di Azure](../articles/virtual-machines/windows/premium-storage.md). 

<sup>2</sup> istanza è isolata all'hardware dedicato a un singolo cliente.
...
<sup>1</sup> la velocità effettiva massima del disco (IOPS o MBps) possibili con una serie di DSv2 VM possono essere limitati dal numero, dimensione e lo striping dei dischi collegati.  Per altre informazioni, vedere [Archiviazione Premium: archiviazione ad alte prestazioni per carichi di lavoro delle macchine virtuali di Azure](../articles/virtual-machines/windows/premium-storage.md).

<sup>2</sup> istanza è un nodo di tipo isolato che garantisce che la macchina virtuale è la macchina virtuale sola in questo nodo Haswalle Intel.

<sup>3</sup> 25000 Mbps con la rete accelerata.
...
<sup>1</sup> istanza è un nodo di tipo isolato che garantisce che la macchina virtuale è la macchina virtuale sola in questo nodo Haswalle Intel.

<sup>2</sup> 25000 Mbps con la rete accelerata.
...
<sup>1</sup> la velocità effettiva massima del disco (IOPS o MBps) possibili con una VM di serie DS possono essere limitata dal numero, dimensione e lo striping dei dischi collegati.  Per altre informazioni, vedere [Archiviazione Premium: archiviazione ad alte prestazioni per carichi di lavoro delle macchine virtuali di Azure](../articles/virtual-machines/windows/premium-storage.md).
