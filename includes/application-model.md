...
* **Risorsa di archiviazione locale**. Consente di allocare nell'istanza del ruolo una sottodirectory a disposizione dell'applicazione. Viene descritta in dettaglio nell'articolo sulle [opzioni disponibili per l'archiviazione dati in Azure][opzioni disponibili per l'archiviazione dati in Azure].
...
Per altre informazioni su distribuzione, aggiornamento e riconfigurazione dei ruoli, vedere l'articolo relativo a [distribuzione e aggiornamento di applicazioni di Azure][distribuzione e aggiornamento di applicazioni di Azure].<a id="Ref" name="Ref"></a>
