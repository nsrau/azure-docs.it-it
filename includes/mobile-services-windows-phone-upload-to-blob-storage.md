...
1. Aprire il file del progetto MainPage.xaml.cs e aggiungere le istruzioni **using** seguenti:
   
        using Microsoft.Phone.Tasks;
        using System.IO;
        using Microsoft.WindowsAzure.Storage.Auth;
        using Microsoft.WindowsAzure.Storage.Blob;
2. Nel file del progetto MainPage.xaml.cs aggiornare la classe TodoItem aggiungendo le proprietà seguenti:
...
3. Nel file del progetto MainPage.xaml.cs aggiornare la classe MainPage. Aggiungere il codice seguente per dichiarare [CameraCaptureTask] e un oggetto stream che fa riferimento all'immagine acquisita:
...
4. Nel file del progetto MainPage.xaml.cs aggiornare la classe MainPage. Aggiungere il codice seguente per aggiornare il costruttore in modo da creare CameraCaptureTask e aggiungere un gestore dell'evento Completed:
...
5. Nel file del progetto MainPage.xaml.cs aggiornare la classe MainPage. Aggiungere il codice seguente che visualizza l'interfaccia utente della fotocamera per consentire all'utente di acquisire un'immagine quando si fa clic sul pulsante **Capture Image**:
   
        private void ButtonCaptureImage_Click(object sender, RoutedEventArgs e)
        {
            cameraCaptureTask.Show();
        }
6. Nel file del progetto MainPage.xaml.cs aggiornare la classe MainPage. Sostituire il metodo `InsertTodoItem` esistente con il codice seguente:
...
6. Il nuovo elemento appare nella visualizzazione elenco insieme all'immagine caricata.
   ...
   > [!NOTE]
   > L'immagine viene scaricata automaticamente dal servizio di archiviazione BLOB quando la proprietà <code>imageUri</code> del nuovo elemento è associata al controllo <strong>Image</strong>.
   > 
   > 
