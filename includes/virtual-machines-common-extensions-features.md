...
Per informazioni dettagliate sugli agenti VM e sul relativo ruolo nel supporto delle estensioni delle macchine virtuali, vedere [Informazioni generali sull'agente VM e sulle estensioni VM](virtual-machines-windows-classic-manage-extensions.md).
...
|---|---|---|
|VMAccessAgent (Windows)|Consente di creare, aggiornare e reimpostare le informazioni utente e le configurazioni delle connessioni RDP e SSH.|[Windows](virtual-machines-windows-classic-extensions-customscript.md)
...
|**SymantecEndpointProtection**|Symantec Endpoint Protection 12.1.4 consente di ottenere sicurezza e prestazioni in sistemi fisici e virtuali.|[Come installare e configurare Symantec Endpoint Protection in una macchina virtuale di Azure](virtual-machines-windows-classic-install-symantec.md)
...
|**HpcVmDrivers**|Installa, configura e mantiene i driver del dispositivo di rete (RDMA) d’accesso alla memoria diretto remoto in una macchina virtuale di dimensioni A8 o A9 che esegue il server di Windows 2012 R2 il server di Windows 2012. Abilita le macchine virtuali A8 o A9 con cluster ad utilizzare la rete RDMA durante l'esecuzione di applicazioni MPI parallele.|[Informazioni sulle istanze A8, A9, A10 e A11 a elevato utilizzo di calcolo](virtual-machines-windows-a8-a9-a10-a11-specs.md)
