...
#### <a name="to-add-a-new-storage-account-in-storsimple-release-version-ga"></a>Per aggiungere un nuovo account di archiviazione nella versione StorSimple Release (GA)
