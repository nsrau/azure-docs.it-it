...
5. Nella finestra **Crea servizio mobile** selezionare la **Sottoscrizione**, il back-end di **JavaScript** in **Runtime** e una **Regione** per il servizio mobile, quindi digitare un **Nome** per il servizio mobile.
