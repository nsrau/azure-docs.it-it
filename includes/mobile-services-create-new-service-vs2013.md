...
4. Nella finestra di dialogo **Crea servizio mobile** selezionare la **Sottoscrizione**, il back-end **JavaScript** in **Runtime** e una **Regione** per il servizio mobile e quindi digitare un **Nome** per il servizio mobile.
...
1. Una volta creato il servizio mobile, selezionarlo dall'apposito elenco in Gestione servizi e fare clic su **OK**.
