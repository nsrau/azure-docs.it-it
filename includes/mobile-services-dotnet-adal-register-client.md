...
1. Passare ad **Active Directory** nel [portale di Azure classico](https://manage.windowsazure.com/), quindi fare clic sulla directory.
...
7. Scorrere in basso nella pagina fino alla sezione **autorizzazioni per altre applicazioni** e fare clic sul pulsante **Aggiungi applicazione**. Scegliere **Altro** dal menu Mostra e cercare todo. Fare clic su **TodoList** per aggiungere il servizio mobile registrato in precedenza e quindi fare clic sul segno di spunta per confermare. Concedere l'accesso all'applicazione del servizio mobile. Fare quindi clic su **Salva**.
