...
![Avanti][button-next] Verrà visualizzata la voce dello Store relativa a MongoLab.  
...
![ProgressButton][button-progress] Al termine del provisioning, viene visualizzato un messaggio che indica il completamento dell'operazione.  
