...
2. Fare clic su **Nuovo**. ![Nuovo][button-new]
3. Selezionare **Store**. ![Store][button-store]
4. Selezionare MongoLab. Il database è disponibile nella categoria **App Services** e in **All**. ![MongoLab][entry-mongolab]
5. Fare clic su **Avanti**. ![Avanti][button-next] Verrà visualizzata la voce dello Store relativa a MongoLab. ![NewMongoLab][screen-newmongolab]
...
9. Fare clic su **Avanti**. ![Avanti][button-next]
10. Verificare le informazioni relative all'acquisto presso il negozio, quindi fare clic su **Purchase** per confermare. ![Avanti][button-purchase]  
11. Sul pulsante di stato della barra degli strumenti viene visualizzato lo stato del provisioning. ![ProgressButton][button-progress] Al termine del provisioning, viene visualizzato un messaggio che indica il completamento dell'operazione. ![SuccessMessage][message-success]
